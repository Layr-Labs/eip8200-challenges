...
def write_score(
    ...
    try:
        if track_name == "blake2f":
            score, metrics = parse_framed_csv(
                csv_path,
                track.vector_count,
                ["vector", "bytes", "rounds", "frame", "status", "gas"],
            )
        elif track.framed:
