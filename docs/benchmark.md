...
This repository is one schema-v2 Yukon challenge with four independently
...
| `blake2f` | `Challenge/Blake2f/Submission` | clean-state gas over 13 vectors |
...
Replace `sha256` with `modexp`, `ripemd160`, or `blake2f` for another track. The four
