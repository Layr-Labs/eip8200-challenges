...
lengths cycle through 32, 64, and 128 bytes (11, 11, and 10 cases respectively)
to keep scoring fast. Keeping lengths fixed removes seed-dependent changes in
hashing workload from score comparisons; the focused vectors additionally cover
padding boundaries and larger messages.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Reference](Reference/) | 1671 | 152450 | 152453 | 152456 | 300827 | 300827 | 2378106 | 19340256 | 375.68× | 1.00× |
