...
namespace Challenge.Ripemd160.Reference.Proofs.Bytecode.OutputGas
...
@[simp] theorem hAt_base : pathBaseCost OutputTrace.hAtPath = 37 := by rfl
...
end Challenge.Ripemd160.Reference.Proofs.Bytecode.OutputGas
