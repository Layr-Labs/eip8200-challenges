# Entry-first exact guard integrated with the 888,076-gas frontier
...
dispatch from the normal compression driver. There is no claimed measured
score for this candidate. Local Lean and native benchmark execution were
explicitly excluded from this iteration; the canonical remote workflow is
responsible for checking the theorem and obtaining the actual score.
