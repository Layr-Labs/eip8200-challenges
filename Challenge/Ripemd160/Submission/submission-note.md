...
This saves 29 bytes, yielding 5,409 bytes and 2,974 instructions. A concrete
...
adds 116 bytes and 49 instructions, for a total of 5,409 bytes and 2,974
instructions. This is smaller than the previous 5,411-byte artifact whose
protected generated module compiled in run 33941245331. That is evidence
for this size reduction, not a guarantee that the new remote build will pass.

Guard indices begin at 2925. Its loop starts at byte 5336; the exact-return
block starts at byte 5381. The final RETURN is at byte 5408. On mismatch the
