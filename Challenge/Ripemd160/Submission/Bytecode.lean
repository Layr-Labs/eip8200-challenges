...
The candidate bytecode has 5324 bytes and SHA-256 `fe28943a365c0894fb330c8c4418c36de0ce66b72497baea69f74ce278a691ff`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5324 := by
