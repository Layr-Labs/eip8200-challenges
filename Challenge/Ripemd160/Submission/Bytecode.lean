...
The candidate bytecode has 5228 bytes and SHA-256 `b7ba64a89df812914f654c6dfe4748f3347e8fc55e4d4a90bd7adbdccd49d8ba`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5228 := by
