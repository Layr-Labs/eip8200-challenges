...
The candidate bytecode has 5203 bytes and raw hex SHA-256
`c4fae632c020f972967a45996565e8bb76c5fd8ad7cb96af15ec64ea363ccadc`.
The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5203 := by
