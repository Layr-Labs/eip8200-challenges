...
The candidate bytecode has 5242 bytes and SHA-256 `af0beaece81e98cd7faead3312265e5e17dcf1f1f2e71d28e2ab5ac92d82821f`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5242 := by
