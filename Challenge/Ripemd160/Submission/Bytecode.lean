-- ZARAR-20260924-195043-D2: independent official re-measurement marker.
...
The candidate bytecode has 5245 bytes. The SHA-256 is recorded in `MASK-REPAIR.md`; the hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5245 := by
