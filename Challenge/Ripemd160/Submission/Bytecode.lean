...
The candidate bytecode has 5235 bytes and SHA-256 `fdc5a8e31d70cb96880c90ca676524e6a231349be576facc432933bfc47da04f`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5235 := by
