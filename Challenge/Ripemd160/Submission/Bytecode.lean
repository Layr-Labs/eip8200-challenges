...
The candidate bytecode has 5213 bytes and SHA-256 `27378139d36c2378f08ebb14d0c6810e7ec6a50751c487c1102760bf09242be2`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5213 := by
