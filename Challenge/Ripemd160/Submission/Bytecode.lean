...
The candidate bytecode has 5256 bytes and SHA-256 `75a20b0cffcc74d479bbc71d9846037b4d87f6271c1885929fc3f0bfd6c9cc27`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5256 := by
