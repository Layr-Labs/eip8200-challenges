...
The candidate bytecode has 5221 bytes. The SHA-256 is recorded in `MASK-REPAIR.md`; the hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5221 := by
