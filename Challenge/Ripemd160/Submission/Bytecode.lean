...
The candidate bytecode has 5084 bytes and SHA-256 `44f98ff9671a6f7bcba9f2cc0b87ebfb5c8f45fde81a1e79c2becf85ca6a6352`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5084 := by
