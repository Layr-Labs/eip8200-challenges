...
The candidate bytecode has 5159 bytes and SHA-256 `429f14e641afcfaa08573adc24c56d9f35c399530d07feff8c78c3bf36df7643`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5159 := by
