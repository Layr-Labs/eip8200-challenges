...
The candidate bytecode has 5239 bytes and SHA-256 `00e454bb9afd8bbef4bfeb4fcbe266716c9a0dd76249099415d70e36e0fffd2e`. The hex file remains the external raw input.
-/
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5239 := by
