...
`submissionBytecode` is the exact H25 packed wrapper/helper artifact. It
retains the verified H25 prefix and appends the exact unchanged H17b helper.
...
set_option maxRecDepth 50000 in
@[simp] theorem referenceBytecode_size : submissionBytecode.size = 5060 := by
