...
namespace Challenge.Ripemd160.Submission.H39Reference.Proofs.Bytecode.PaddingTrace
...
private theorem run_enter (input : ByteArray) :
  ...
  simp [enterPath, Artifact.padEnterPath,
...
private theorem run_paddedLength (input : ByteArray) :
  ...
  simp [paddedLengthPath, Artifact.padLengthPath,
...
private def gasSteps_padPrefix (input : ByteArray) :
  ...
  (Main.gasSteps_bodyInitialization input).trans
...
end Challenge.Ripemd160.Submission.H39Reference.Proofs.Bytecode.PaddingTrace
