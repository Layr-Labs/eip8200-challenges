...
import Challenge.Ripemd160.Submission.H39Reference.Proofs.Bytecode.Output
...
namespace Challenge.Ripemd160.Submission.H39Reference.Proofs.Bytecode.DirectCorrect
...
def outputResult (s : State) (input : ByteArray) : State :=
...
noncomputable def fullTrace (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (Execution.mainStart input)
...
end Challenge.Ripemd160.Submission.H39Reference.Proofs.Bytecode.DirectCorrect
