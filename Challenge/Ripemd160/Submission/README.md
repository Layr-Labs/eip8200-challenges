...
The immediate public source parent is terrapinelf's RIPEMD-160 submission
published in pull request 564. The additional public contribution in
terrapinelf's pull request 583 is also included and credited. Both are
substantial contributions to the package. Existing public contributions carried
by the parent retain their original attribution in the repository history.
