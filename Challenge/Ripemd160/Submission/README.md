...
Public RIPEMD-160 work from fkiene's published `c57dabb` ticket is adapted over
the current accepted tekkac lineage in this package. Both authors are credited
for the corresponding public work. The remaining accepted parent lineage is
retained as the base of the package.
...
| Local layout certificate | Preserved |
| Local execution certificate | Preserved |
...
| Program layout | Existing hierarchy retained |
| Execution trace | Existing hierarchy retained |
...
This package adapts public RIPEMD-160 work from fkiene's published `c57dabb`
ticket over the current accepted tekkac lineage. Their authorship of those
public contributions is acknowledged. This ticket packages the adapted surfaces
together with the retained accepted parent and the accompanying submitted proof
inventory.
