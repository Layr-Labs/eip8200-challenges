> Current derivative: **DriverFold5**, a general-purpose RIPEMD-160 candidate.
> See [DriverFold5.md](DriverFold5.md) for the exact delta, 49-vector measurements,
> attribution, and pending Lean/Comparator verification. Historical notes below
> describe upstream revisions and may refer to the obsolete 17-vector corpus.
