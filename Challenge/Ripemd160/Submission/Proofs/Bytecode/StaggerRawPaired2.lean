...
theorem site_pc : site.startPC = UInt256.ofNat 1241 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 834) = UInt256.ofNat 1241
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1241) template = UInt256.ofNat 1277 := by decide
  rw [hend] at hraw
