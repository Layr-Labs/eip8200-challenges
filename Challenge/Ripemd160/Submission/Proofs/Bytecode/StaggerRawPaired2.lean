...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v7) (UInt256.ofNat 28))),
    ...
    x.v5,
    x.v0,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 342) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v2 x.v7) x.v0) (UInt256.xor x.v2 (UInt256.xor x.v7 x.v4))) x.v6))))) (UInt256.ofNat 23)))),
    x.v8,
    x.v9,
    x.v10,
    x.v11,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 799 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1261 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 799) = UInt256.ofNat 1261
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1261, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1300, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1261) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1261) template = UInt256.ofNat 1300 := by decide
  rw [hend] at hraw
