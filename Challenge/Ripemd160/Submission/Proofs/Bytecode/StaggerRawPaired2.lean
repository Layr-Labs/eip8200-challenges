...
theorem site_pc : site.startPC = UInt256.ofNat 1354 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 842) = UInt256.ofNat 1354
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1354) template = UInt256.ofNat 1389 := by decide
  rw [hend] at hraw
