...
theorem output_eq (memory : ByteArray) (h4 : UInt256) (q right : WordLane) (rho : List UInt256) :
  ...
  have hkb : StaggerAlgorithm.physicalKey 70 = UInt256.ofNat 2840853866 := by decide
  have hka : StaggerAlgorithm.physicalKey 71 = UInt256.ofNat 2840853866 := by decide
