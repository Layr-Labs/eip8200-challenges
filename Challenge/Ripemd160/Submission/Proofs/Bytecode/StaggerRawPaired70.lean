...
theorem site_pc : site.startPC = UInt256.ofNat 4142 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3410) = UInt256.ofNat 4142
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4142) template = UInt256.ofNat 4178 := by decide
  rw [hend] at hraw
