...
theorem site_pc : site.startPC = UInt256.ofNat 4188 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3314) = UInt256.ofNat 4188
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4188) template = UInt256.ofNat 4223 := by decide
  rw [hend] at hraw
