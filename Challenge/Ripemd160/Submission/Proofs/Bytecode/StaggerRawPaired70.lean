...
theorem site_pc : site.startPC = UInt256.ofNat 4195 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3314) = UInt256.ofNat 4195
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4195) template = UInt256.ofNat 4230 := by decide
  rw [hend] at hraw
