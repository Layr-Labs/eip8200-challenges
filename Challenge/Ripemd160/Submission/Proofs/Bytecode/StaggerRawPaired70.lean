...
theorem site_pc : site.startPC = UInt256.ofNat 4178 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3428) = UInt256.ofNat 4178
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4178) template = UInt256.ofNat 4214 := by decide
  rw [hend] at hraw
