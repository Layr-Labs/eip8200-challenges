...
theorem site_pc : site.startPC = UInt256.ofNat 4201 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3311) = UInt256.ofNat 4201
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4201) template = UInt256.ofNat 4236 := by decide
  rw [hend] at hraw
