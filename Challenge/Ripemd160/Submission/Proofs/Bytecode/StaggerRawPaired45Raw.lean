...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mulMod (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 576) (UInt256.add (UInt256.xor x.v11 (UInt256.xor (UInt256.land (UInt256.xor x.v11 x.v9) (UInt256.xor x.v6 (UInt256.land x.v0 x.v9))) x.v0)) x.v8)))) x.v14 x.v12) (UInt256.ofNat 20)))),
    (UInt256.ofNat 23),
    x.v5,
    x.v9,
    x.v10,
