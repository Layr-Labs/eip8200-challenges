...
theorem run_selector_0 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3834 = true :=
...
theorem run_selector_1 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3852 = true :=
...
theorem run_selector_2 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3875 = true :=
...
theorem run_selector_3 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3895 = true :=
