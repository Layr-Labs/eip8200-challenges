...
theorem run_selector_0 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3846 = true :=
...
theorem run_selector_1 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3864 = true :=
...
theorem run_selector_2 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3887 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3117 (by rfl)
  simp (config := { maxSteps := 1000000 })
...
theorem run_selector_3 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3907 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3135 (by rfl)
  simp (config := { maxSteps := 1000000 })
