...
theorem run_selector_0 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3840 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3089 (by rfl)
...
theorem run_selector_1 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3858 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3107 (by rfl)
  simp (config := { maxSteps := 1000000 })
...
theorem run_selector_2 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3881 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3125 (by rfl)
  simp (config := { maxSteps := 1000000 })
...
theorem run_selector_3 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3901 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3143 (by rfl)
  simp (config := { maxSteps := 1000000 })
