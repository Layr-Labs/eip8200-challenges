...
theorem run_selector_0 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3863 = true :=
...
theorem run_selector_1 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3885 = true :=
...
theorem run_selector_2 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3906 = true :=
...
theorem run_selector_3 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3926 = true :=
