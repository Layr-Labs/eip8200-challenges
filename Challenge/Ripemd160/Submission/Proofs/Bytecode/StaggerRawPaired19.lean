...
theorem site_pc : site.startPC = UInt256.ofNat 1988 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1490) = UInt256.ofNat 1988
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1988) template = UInt256.ofNat 2036 := by decide
  rw [hend] at hraw
