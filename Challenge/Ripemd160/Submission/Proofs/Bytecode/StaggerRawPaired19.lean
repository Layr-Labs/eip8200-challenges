...
theorem site_pc : site.startPC = UInt256.ofNat 2019 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1445) = UInt256.ofNat 2019
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2019) template = UInt256.ofNat 2067 := by decide
  rw [hend] at hraw
