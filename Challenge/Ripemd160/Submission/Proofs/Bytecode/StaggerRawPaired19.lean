...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v4,
    (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.add (UInt256.mul (UInt256.ofNat 15) (UInt256.land x.v10 (UInt256.land x.v2 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 684) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v5 x.v0) (UInt256.xor x.v8 x.v3)) x.v0) (UInt256.land x.v8 x.v5)) x.v6)))))) (UInt256.land x.v2 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 684) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v5 x.v0) (UInt256.xor x.v8 x.v3)) x.v0) (UInt256.land x.v8 x.v5)) x.v6)))))) (UInt256.ofNat 29)))),
    x.v0,
    x.v7,
    x.v8,
    x.v9,
...
theorem site_pc : site.startPC = UInt256.ofNat 2032 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1457) = UInt256.ofNat 2032
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2032) template = UInt256.ofNat 2080 := by decide
  rw [hend] at hraw
