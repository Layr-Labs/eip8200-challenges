...
theorem prologue_crypto (memory : ByteArray) (words : Nat → UInt32) (q : CryptoLane)
  ...
  have hm0 : low32 (MachineState.readWord memory 540) = words 5 := hm.scalar 30 (by decide)
  have hm1 : low32 (MachineState.readWord memory 252) = words 14 := hm.scalar 14 (by decide)
  have hm2 : low32 (MachineState.readWord memory 378) = words 7 := hm.scalar 21 (by decide)
  ...
  have p0 := StaggerScalarLow54.project_step true false 4 8 (by decide) (by decide)
    (MachineState.readWord memory 540) (UInt256.ofNat 1352829926) (embed q) hi.2.2.1
  have p1 := StaggerScalarLow54.project_step true false 4 9 (by decide) (by decide)
    (MachineState.readWord memory 252) (UInt256.ofNat 1352829926) (right0 memory (embed q)) h1
  have p2 := StaggerScalarLow54.project_step true false 4 9 (by decide) (by decide)
    (MachineState.readWord memory 378) (UInt256.ofNat 1352829926)
...
theorem epilogue_project (memory : ByteArray) (words : Nat → UInt32) (q : Paired144WordRound.WordLane)
  ...
  have hm1 : low32 (MachineState.readWord memory 1008) = words 15 := hm.scalar 56 (by decide)
  have hm2 : low32 (MachineState.readWord memory 288) = words 13 := hm.scalar 16 (by decide)
  ...
  have p1 := StaggerScalarLow54.project_step false false 4 5 (by decide) (by decide)
    (MachineState.readWord memory 1008) (UInt256.ofNat 2840853838) (left77 memory q) h1
  have p2 := StaggerScalarLow54.project_step false false 4 6 (by decide) (by decide)
    (MachineState.readWord memory 288) (UInt256.ofNat 2840853838)
