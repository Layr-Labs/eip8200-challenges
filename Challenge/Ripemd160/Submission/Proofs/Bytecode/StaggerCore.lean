...
def pcs : Array Nat := #[1059, 1110, 1152, 1187, 1230, 1268, 1310, 1348, 1390, 1428, 1470, 1508, 1551, 1589, 1644, 1702, 1761, 1807, 1865, 1904, 1963, 2003, 2062, 2102, 2147, 2187, 2231, 2271, 2330, 2367, 2422, 2466, 2511, 2553, 2605, 2637, 2673, 2706, 2744, 2777, 2828, 2858, 2909, 2941, 2978, 3010, 3081, 3140, 3184, 3231, 3276, 3316, 3374, 3413, 3471, 3511, 3570, 3609, 3668, 3707, 3771, 3810, 3857, 3897, 3937, 3982, 4025, 4063, 4106, 4143, 4181, 4216, 4258, 4295, 4338, 4376, 4417, 4453]
...
def suffixState (s : State) (h4 : UInt256) (q : WordLane) (rho : List UInt256) : State :=
  {s with pc := UInt256.ofNat 4555, stack := stack s.memory h4 [ .d, .b, .e, .a, .literal 28, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (epilogue s.memory q) q (UInt256.ofNat 2840853838) rho}
