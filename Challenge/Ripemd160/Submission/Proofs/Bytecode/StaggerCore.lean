...
def pcs : Array Nat := #[1043, 1111, 1148, 1186, 1222, 1260, 1301, 1339, 1377, 1415, 1468, 1508, 1558, 1597, 1661, 1714, 1770, 1816, 1868, 1907, 1961, 2001, 2056, 2096, 2151, 2191, 2245, 2285, 2341, 2401, 2441, 2495, 2536, 2593, 2643, 2675, 2706, 2739, 2773, 2806, 2855, 2885, 2932, 2964, 3014, 3069, 3109, 3164, 3205, 3252, 3294, 3334, 3390, 3429, 3485, 3525, 3580, 3619, 3674, 3713, 3769, 3807, 3852, 3892, 3933, 3978, 4029, 4067, 4107, 4144, 4182, 4216, 4268, 4305, 4345, 4383, 4434, 4471]
...
def suffixState (s : State) (h4 : UInt256) (q : WordLane) (rho : List UInt256) : State :=
  {s with pc := UInt256.ofNat 4564, stack := stack s.memory h4 [ .b, .e, .a, .d, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (epilogue s.memory q) q (UInt256.ofNat 2840853838) rho}
