...
def pcs : Array Nat := #[1315, 1366, 1408, 1443, 1486, 1524, 1566, 1604, 1646, 1684, 1726, 1764, 1807, 1845, 1900, 1958, 2017, 2063, 2121, 2160, 2219, 2259, 2318, 2358, 2403, 2443, 2487, 2527, 2586, 2623, 2678, 2722, 2767, 2809, 2861, 2893, 2929, 2962, 3000, 3033, 3074, 3104, 3155, 3187, 3224, 3256, 3327, 3386, 3430, 3477, 3522, 3562, 3610, 3649, 3697, 3737, 3796, 3835, 3894, 3933, 3981, 4020, 4067, 4107, 4147, 4192, 4235, 4273, 4316, 4353, 4391, 4426, 4468, 4505, 4548, 4586, 4627, 4663]
...
def suffixState (s : State) (h4 : UInt256) (q : WordLane) (rho : List UInt256) : State :=
  {s with pc := UInt256.ofNat 4765, stack := stack s.memory h4 [ .d, .b, .e, .a, .literal 28, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (epilogue s.memory q) q (UInt256.ofNat 2840853838) rho}
