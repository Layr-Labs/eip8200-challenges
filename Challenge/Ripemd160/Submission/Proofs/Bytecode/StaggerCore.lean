...
def pcs : Array Nat := #[1045, 1111, 1151, 1186, 1226, 1264, 1305, 1343, 1381, 1419, 1472, 1510, 1563, 1602, 1666, 1719, 1775, 1821, 1873, 1912, 1966, 2006, 2061, 2101, 2156, 2196, 2250, 2290, 2344, 2404, 2447, 2501, 2542, 2599, 2647, 2679, 2713, 2746, 2780, 2813, 2862, 2892, 2939, 2971, 3019, 3074, 3117, 3172, 3213, 3260, 3302, 3342, 3398, 3437, 3493, 3533, 3588, 3627, 3682, 3721, 3777, 3815, 3861, 3901, 3942, 3987, 4038, 4076, 4116, 4153, 4191, 4225, 4277, 4314, 4354, 4392, 4443, 4480]
...
def suffixState (s : State) (h4 : UInt256) (q : WordLane) (rho : List UInt256) : State :=
  {s with pc := UInt256.ofNat 4573, stack := stack s.memory h4 [ .b, .e, .a, .d, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (epilogue s.memory q) q (UInt256.ofNat 2840853838) rho}
