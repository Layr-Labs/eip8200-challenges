...
def pcs : Array Nat := #[1113, 1164, 1206, 1241, 1284, 1322, 1364, 1402, 1444, 1482, 1524, 1562, 1605, 1643, 1698, 1756, 1815, 1861, 1919, 1958, 2017, 2057, 2116, 2156, 2201, 2241, 2285, 2325, 2384, 2421, 2476, 2520, 2565, 2607, 2659, 2691, 2727, 2760, 2798, 2831, 2872, 2902, 2953, 2985, 3022, 3054, 3125, 3184, 3228, 3275, 3320, 3360, 3408, 3447, 3495, 3535, 3594, 3633, 3692, 3731, 3779, 3818, 3865, 3905, 3945, 3990, 4033, 4071, 4114, 4151, 4189, 4224, 4266, 4303, 4346, 4384, 4425, 4461]
...
def suffixState (s : State) (h4 : UInt256) (q : WordLane) (rho : List UInt256) : State :=
  {s with pc := UInt256.ofNat 4563, stack := stack s.memory h4 [ .d, .b, .e, .a, .literal 28, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (epilogue s.memory q) q (UInt256.ofNat 2840853838) rho}
