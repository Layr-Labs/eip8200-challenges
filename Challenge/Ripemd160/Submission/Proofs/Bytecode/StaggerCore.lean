...
def pcs : Array Nat := #[1053, 1104, 1146, 1181, 1224, 1262, 1304, 1342, 1384, 1422, 1464, 1502, 1545, 1583, 1638, 1696, 1755, 1801, 1859, 1898, 1956, 1996, 2054, 2094, 2139, 2179, 2223, 2263, 2322, 2359, 2429, 2473, 2518, 2577, 2628, 2660, 2696, 2729, 2767, 2800, 2851, 2881, 2932, 2964, 3001, 3033, 3103, 3161, 3205, 3252, 3297, 3337, 3395, 3434, 3492, 3532, 3591, 3630, 3688, 3727, 3787, 3826, 3877, 3917, 3957, 4002, 4045, 4083, 4126, 4163, 4201, 4236, 4278, 4315, 4358, 4396, 4437, 4473]
...
def suffixState (s : State) (h4 : UInt256) (q : WordLane) (rho : List UInt256) : State :=
  {s with pc := UInt256.ofNat 4575, stack := stack s.memory h4 [ .d, .b, .e, .a, .literal 28, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (epilogue s.memory q) q (UInt256.ofNat 2840853838) rho}
