...
def sizeFlag (input : ByteArray) : UInt256 :=
  UInt256.isZero (UInt256.lor (UInt256.eq (UInt256.ofNat 56) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 148) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 63) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 64) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 65) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 156) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 147) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 55) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 1) (UInt256.ofNat input.size)) (UInt256.lor (UInt256.eq (UInt256.ofNat 31) (UInt256.ofNat input.size)) (UInt256.eq (UInt256.ofNat 32) (UInt256.ofNat input.size))))))))))))
