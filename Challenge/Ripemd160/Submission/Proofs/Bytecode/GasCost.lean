...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3733 + 138476 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 138476 (blockCount_monotone hle)) 3733)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 142418 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 142421 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 142424 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 280907 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 280907 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 419395 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 696372 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 973350 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 2219754 := by decide
