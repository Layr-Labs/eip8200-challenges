...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3685 + 120620 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 120620 (blockCount_monotone hle)) 3685)
...
@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 245147 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 245147 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 365779 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 607044 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 848310 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1934010 := by decide
