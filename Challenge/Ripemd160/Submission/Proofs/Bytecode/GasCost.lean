...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3698 + 120607 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 120607 (blockCount_monotone hle)) 3698)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 124514 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 124517 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 124520 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 245134 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 245134 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 365753 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 606992 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 848232 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1933815 := by decide
