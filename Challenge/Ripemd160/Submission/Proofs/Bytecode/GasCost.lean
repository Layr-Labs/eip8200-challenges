...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3638 + 120620 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 120620 (blockCount_monotone hle)) 3638)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 124467 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 124470 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 124473 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 245100 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 245100 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 365732 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 606997 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 848263 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1933963 := by decide
