...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3698 + 120604 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 120604 (blockCount_monotone hle)) 3698)
...
@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 245128 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 245128 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 365744 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 606977 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 848211 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1933767 := by decide
