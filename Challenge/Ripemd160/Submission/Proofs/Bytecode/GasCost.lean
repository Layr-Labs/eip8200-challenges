...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3733 + 108140 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 108140 (blockCount_monotone hle)) 3733)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 112082 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 112085 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 112088 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 220235 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 220235 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 328387 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 544692 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 760998 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1734378 := by decide
