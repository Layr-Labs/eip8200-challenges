...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3698 + 123852 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 123852 (blockCount_monotone hle)) 3698)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 127759 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 127762 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 127765 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 251624 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 251624 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 375488 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 623217 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 870947 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1985735 := by decide
