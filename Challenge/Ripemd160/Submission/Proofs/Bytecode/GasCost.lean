...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3698 + 116780 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 116780 (blockCount_monotone hle)) 3698)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 120687 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 120690 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 120693 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 237480 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 237480 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 354272 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 587857 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 821443 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1872583 := by decide
