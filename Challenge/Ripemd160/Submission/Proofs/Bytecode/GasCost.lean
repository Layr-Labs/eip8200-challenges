...
This file records the closed form measured for the current submission bytecode
...
/-- Exact gas consumed by the current RIPEMD-160 submission for `inputSize`
bytes of calldata. -/
def referenceGasForSize (inputSize : Nat) : Nat :=
  3698 + 120586 * blockCount inputSize + 3 * calldataWords inputSize +
...
/-- Larger calldata never makes the exact submission schedule smaller. -/
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 120586 (blockCount_monotone hle)) 3698)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 124493 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 124496 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 124499 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 245092 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 245092 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 365690 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 606887 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 848085 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1933479 := by decide
