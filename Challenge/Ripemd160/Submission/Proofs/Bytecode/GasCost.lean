...
`59 + 2 * blockCount`; the final block's last schedule `MLOAD` reaches one
additional word. -/
...
@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 245144 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 245144 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 365776 := by decide
