...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3698 + 119372 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 119372 (blockCount_monotone hle)) 3698)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 123279 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 123282 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 123285 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 242664 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 242664 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 362048 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 600817 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 839587 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1914055 := by decide
