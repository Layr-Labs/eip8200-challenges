...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3733 + 132716 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 132716 (blockCount_monotone hle)) 3733)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 136658 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 136661 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 136664 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 269387 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 269387 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 402115 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 667572 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 933030 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 2127594 := by decide
