...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3698 + 120460 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 120460 (blockCount_monotone hle)) 3698)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 124367 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 124370 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 124373 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 244840 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 244840 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 365312 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 606257 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 847203 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1931463 := by decide
