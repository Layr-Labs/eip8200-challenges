...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3733 + 111372 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 111372 (blockCount_monotone hle)) 3733)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 115314 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 115317 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 115320 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 226699 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 226699 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 338083 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 560852 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 783622 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1786090 := by decide
