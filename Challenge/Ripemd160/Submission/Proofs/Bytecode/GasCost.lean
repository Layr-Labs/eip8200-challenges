...
def referenceGasForSize (inputSize : Nat) : Nat :=
  3683 + 120300 * blockCount inputSize + 3 * calldataWords inputSize +
...
theorem referenceGasForSize_monotone : Monotone referenceGasForSize := by
  ...
  exact Nat.add_le_add
    (Nat.add_le_add
      (Nat.add_le_add_left
        (Nat.mul_le_mul_left 120300 (blockCount_monotone hle)) 3683)
...
@[simp] theorem referenceGasForSize_zero :
    referenceGasForSize 0 = 124192 := by decide

@[simp] theorem referenceGasForSize_three :
    referenceGasForSize 3 = 124195 := by decide

@[simp] theorem referenceGasForSize_55 :
    referenceGasForSize 55 = 124198 := by decide

@[simp] theorem referenceGasForSize_56 :
    referenceGasForSize 56 = 244505 := by decide

@[simp] theorem referenceGasForSize_64 :
    referenceGasForSize 64 = 244505 := by decide

@[simp] theorem referenceGasForSize_120 :
    referenceGasForSize 120 = 364817 := by decide

@[simp] theorem referenceGasForSize_256 :
    referenceGasForSize 256 = 605442 := by decide
...
@[simp] theorem referenceGasForSize_376 :
    referenceGasForSize 376 = 846068 := by decide

@[simp] theorem referenceGasForSize_1000 :
    referenceGasForSize 1000 = 1928888 := by decide
