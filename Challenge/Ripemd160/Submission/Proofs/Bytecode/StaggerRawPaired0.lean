...
theorem site_pc : site.startPC = UInt256.ofNat 1206 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 769) = UInt256.ofNat 1206
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1206) template = UInt256.ofNat 1271 := by decide
  rw [hend] at hraw
