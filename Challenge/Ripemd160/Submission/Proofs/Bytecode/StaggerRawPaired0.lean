...
theorem site_pc : site.startPC = UInt256.ofNat 1150 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 721) = UInt256.ofNat 1150
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1150) template = UInt256.ofNat 1212 := by decide
  rw [hend] at hraw
