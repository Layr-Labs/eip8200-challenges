...
theorem site_pc : site.startPC = UInt256.ofNat 1064 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 608) = UInt256.ofNat 1064
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1064) template = UInt256.ofNat 1102 := by decide
  rw [hend] at hraw
