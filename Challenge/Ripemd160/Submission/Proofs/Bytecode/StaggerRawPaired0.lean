...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v0 (UInt256.shiftRight (UInt256.mul x.v7 x.v6) (UInt256.ofNat 22))),
    ...
    x.v5,
    (UInt256.land x.v0 (UInt256.add x.v2 (UInt256.shiftRight (UInt256.mul x.v7 (UInt256.land x.v0 (UInt256.add (UInt256.ofNat 1635471027088748134935197149822976) (UInt256.add x.v13 (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v1 x.v6) x.v5) (UInt256.xor x.v1 (UInt256.xor x.v6 x.v3))) x.v4))))) (UInt256.ofNat 21)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 760 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1147 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 760) = UInt256.ofNat 1147
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1147, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1198, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1147) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1147) template = UInt256.ofNat 1198 := by decide
  rw [hend] at hraw
