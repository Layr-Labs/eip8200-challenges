...
theorem site_pc : site.startPC = UInt256.ofNat 1180 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 611) = UInt256.ofNat 1180
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1180) template = UInt256.ofNat 1248 := by decide
  rw [hend] at hraw
