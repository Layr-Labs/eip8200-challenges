...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v0 (UInt256.shiftRight (UInt256.mul x.v7 x.v6) (UInt256.ofNat 28))),
    ...
    (UInt256.ofNat 30169115476673038213297653277143730720156734734729216),
    x.v5,
    (UInt256.land x.v0 (UInt256.add x.v2 (UInt256.shiftRight (UInt256.mul x.v7 (UInt256.land x.v0 (UInt256.add (UInt256.ofNat 30169115476673038213297653277143730720156734734729216) (UInt256.add (MachineState.readWord memory 900) (UInt256.add (UInt256.xor x.v1 (UInt256.xor (UInt256.xor (UInt256.lor x.v5 (UInt256.land x.v1 x.v6)) x.v3) x.v6)) x.v4))))) (UInt256.ofNat 27)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 764 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1246 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 764) = UInt256.ofNat 1246
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1246, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1313, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1246) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1246) template = UInt256.ofNat 1313 := by decide
  rw [hend] at hraw
