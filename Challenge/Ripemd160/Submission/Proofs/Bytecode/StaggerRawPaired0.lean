...
theorem site_pc : site.startPC = UInt256.ofNat 1202 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 767) = UInt256.ofNat 1206
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1202) template = UInt256.ofNat 1267 := by decide
  rw [hend] at hraw
