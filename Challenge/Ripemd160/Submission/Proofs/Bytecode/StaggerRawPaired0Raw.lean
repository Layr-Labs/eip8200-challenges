...
def template : List Instr :=
  [ .push ⟨2, by decide⟩ (UInt256.ofNat 388),
    ...
    .push ⟨22, by decide⟩ (UInt256.ofNat 30169115476673038213297653277143730720156734734729244),
    .op (.Swap ⟨6, by decide⟩),
    .op (.Dup ⟨6, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op (.Dup ⟨6, by decide⟩),
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v0 (UInt256.shiftRight (UInt256.mul x.v7 x.v6) (UInt256.ofNat 23))),
    ...
    x.v5,
    (UInt256.land x.v0 (UInt256.add x.v2 (UInt256.shiftRight (UInt256.mul x.v7 (UInt256.land x.v0 (UInt256.add (UInt256.ofNat 30169115476673038213297653277143730720156734734729244) (UInt256.add (MachineState.readWord memory 54) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.lor x.v5 (UInt256.land x.v1 x.v6)) (UInt256.xor x.v6 x.v1)) x.v3) x.v4))))) (UInt256.ofNat 22)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
