...
theorem site_pc : site.startPC = UInt256.ofNat 805 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 508) = UInt256.ofNat 805
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 805) template = UInt256.ofNat 884 := by decide
  rw [hend] at hraw
