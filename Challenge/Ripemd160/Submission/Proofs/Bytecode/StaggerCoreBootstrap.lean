...
def gasSteps (s : State) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1035, stack := stack s.memory [  ] q right (UInt256.ofNat 1352829926) rho}
      {s with pc := UInt256.ofNat 1010, stack := stack s.memory [ .k, .a, .b, .c, .d, .e, .factor, .lower, .cache 140, .cache 190, .cache 310, .cache 350, .cache 500 ] (StaggerCoreModel.initial s.memory) (right) (UInt256.ofNat 1352829926) rho} := by
