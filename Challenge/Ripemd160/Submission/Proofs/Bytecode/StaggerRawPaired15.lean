...
theorem site_pc : site.startPC = UInt256.ofNat 1735 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1140) = UInt256.ofNat 1735
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1735) template = UInt256.ofNat 1790 := by decide
  rw [hend] at hraw
