...
theorem site_pc : site.startPC = UInt256.ofNat 1817 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1282) = UInt256.ofNat 1817
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1817) template = UInt256.ofNat 1865 := by decide
  rw [hend] at hraw
