...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v4,
    (UInt256.land x.v2 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.add (UInt256.mul (UInt256.ofNat 127) (UInt256.land x.v3 (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.add (MachineState.readWord memory 990) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor (UInt256.land x.v8 x.v3) x.v5) (UInt256.land x.v3 x.v0)) x.v0) x.v8) x.v6)))))) (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.add (MachineState.readWord memory 990) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor (UInt256.land x.v8 x.v3) x.v5) (UInt256.land x.v3 x.v0)) x.v0) x.v8) x.v6)))))) (UInt256.ofNat 30)))),
    x.v0,
    x.v7,
    x.v8,
    x.v9,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 1294).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1294 actual_slice
    (by change 1294 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1830 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1294) = UInt256.ofNat 1830
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1830, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1878, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1830) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1830) template = UInt256.ofNat 1878 := by decide
  rw [hend] at hraw
