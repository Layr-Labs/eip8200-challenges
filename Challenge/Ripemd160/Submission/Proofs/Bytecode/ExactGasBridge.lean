...
adds `26 + 23 + 26 = 75`, producing the schedule's `108140` per block. -/
def compressionWork : Nat := 108065

def blockWork : Nat := 108140
...
theorem fixedWork_eq : paddingWork + framingWork = 3733 := by
  rfl
