...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    (UInt256.ofNat 34535016170389834383797866734609369064725060249452544),
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v15 (UInt256.mod (UInt256.land x.v3 (UInt256.add (UInt256.ofNat 34535016170389834383797866734609369064725060249452544) (UInt256.add (MachineState.readWord memory 1062) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.land x.v4 x.v0) (UInt256.xor (UInt256.land x.v4 x.v9) x.v6)) x.v9) x.v0) x.v5)))) x.v12)) (UInt256.ofNat 25)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
