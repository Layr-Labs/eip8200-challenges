...
def template : List Instr :=
  [ .op (.Swap ⟨6, by decide⟩),
    .push ⟨14, by decide⟩ (UInt256.ofNat 2192977224147683231974490304970662),
    .op .MUL,
    .op (.Swap ⟨4, by decide⟩),
    .op (.Dup ⟨7, by decide⟩),
    .op (.Dup ⟨10, by decide⟩),
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v4,
    (UInt256.mul (UInt256.ofNat 2192977224147683231974490304970662) x.v7),
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v15 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.mul (UInt256.ofNat 2192977224147683231974490304970662) x.v7) (UInt256.add (MachineState.readWord memory 1062) (UInt256.add (UInt256.xor (UInt256.xor x.v0 x.v9) (UInt256.lor (UInt256.land x.v0 x.v4) (UInt256.xor x.v6 (UInt256.land x.v4 x.v9)))) x.v5))) (UInt256.ofNat 72)) (UInt256.add (UInt256.mul (UInt256.ofNat 2192977224147683231974490304970662) x.v7) (UInt256.add (MachineState.readWord memory 1062) (UInt256.add (UInt256.xor (UInt256.xor x.v0 x.v9) (UInt256.lor (UInt256.land x.v0 x.v4) (UInt256.xor x.v6 (UInt256.land x.v4 x.v9)))) x.v5)))))) (UInt256.ofNat 25)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    (UInt256.mul (UInt256.ofNat 2192977224147683231974490304970662) x.v7),
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v15 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.mul (UInt256.ofNat 2192977224147683231974490304970662) x.v7) (UInt256.add (MachineState.readWord memory 1062) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.land x.v4 x.v0) (UInt256.xor (UInt256.land x.v4 x.v9) x.v6)) x.v9) x.v0) x.v5))) (UInt256.ofNat 72)) (UInt256.add (UInt256.mul (UInt256.ofNat 2192977224147683231974490304970662) x.v7) (UInt256.add (MachineState.readWord memory 1062) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.land x.v4 x.v0) (UInt256.xor (UInt256.land x.v4 x.v9) x.v6)) x.v9) x.v0) x.v5)))))) (UInt256.ofNat 25)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
