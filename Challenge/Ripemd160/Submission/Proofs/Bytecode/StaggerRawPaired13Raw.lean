...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23))),
    ...
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mulMod (UInt256.land x.v3 (UInt256.add (UInt256.mul (UInt256.ofNat 2192977224147683231974490304970662) x.v7) (UInt256.add (MachineState.readWord memory 1062) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.land x.v4 x.v0) (UInt256.xor (UInt256.land x.v4 x.v9) x.v6)) x.v9) x.v0) x.v5)))) x.v15 x.v12) (UInt256.ofNat 25)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
