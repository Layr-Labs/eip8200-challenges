...
theorem site_pc : site.startPC = UInt256.ofNat 2771 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2117) = UInt256.ofNat 2771
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2771) template = UInt256.ofNat 2804 := by decide
  rw [hend] at hraw
