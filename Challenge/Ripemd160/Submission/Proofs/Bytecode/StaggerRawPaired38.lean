...
theorem site_pc : site.startPC = UInt256.ofNat 2766 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2117) = UInt256.ofNat 2766
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2766) template = UInt256.ofNat 2799 := by decide
  rw [hend] at hraw
