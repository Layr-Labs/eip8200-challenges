...
theorem site_pc : site.startPC = UInt256.ofNat 2777 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2200) = UInt256.ofNat 2777
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2777) template = UInt256.ofNat 2811 := by decide
  rw [hend] at hraw
