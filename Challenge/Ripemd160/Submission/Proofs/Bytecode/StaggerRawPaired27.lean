...
theorem site_pc : site.startPC = UInt256.ofNat 2273 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1704) = UInt256.ofNat 2273
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2273) template = UInt256.ofNat 2328 := by decide
  rw [hend] at hraw
