...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 28))),
    ...
    x.v2,
    x.v3,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.add (UInt256.mul (UInt256.ofNat 15) (UInt256.land (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 90) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v0 x.v4) (UInt256.xor x.v2 x.v7)) x.v0) (UInt256.land x.v4 x.v7)) x.v5)))) x.v2)) (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 90) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v0 x.v4) (UInt256.xor x.v2 x.v7)) x.v0) (UInt256.land x.v4 x.v7)) x.v5)))))) (UInt256.ofNat 29)))),
    x.v0,
    x.v6,
    x.v7,
    x.v8,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 1772).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1772 actual_slice
    (by change 1772 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 2382 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1772) = UInt256.ofNat 2382
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2382) template = UInt256.ofNat 2429 := by decide
  rw [hend] at hraw
