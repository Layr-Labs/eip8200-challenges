...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 22))),
    ...
    x.v2,
    x.v3,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.add (UInt256.mul (UInt256.ofNat 15) (UInt256.land x.v2 (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 50) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v0 x.v4) (UInt256.xor x.v2 x.v7)) x.v0) (UInt256.land x.v4 x.v7)) x.v5)))))) (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 50) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v0 x.v4) (UInt256.xor x.v2 x.v7)) x.v0) (UInt256.land x.v4 x.v7)) x.v5)))))) (UInt256.ofNat 23)))),
    x.v0,
    x.v6,
    x.v7,
    x.v8,
...
theorem site_pc : site.startPC = UInt256.ofNat 2299 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1791) = UInt256.ofNat 2299
