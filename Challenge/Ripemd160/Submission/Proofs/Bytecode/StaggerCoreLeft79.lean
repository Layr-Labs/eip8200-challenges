...
def input (memory : ByteArray) (h4 : UInt256) (q right : WordLane) (k : UInt256) : StaggerRaw.Input :=
  ⟨word memory h4 (.d) q right k, word memory h4 (.c) q right k, word memory h4 (.a) q right k, word memory h4 (.e) q right k, word memory h4 (.literal 23) q right k, word memory h4 (.cachedMessage 360) q right k, word memory h4 (.k) q right k, word memory h4 (.b) q right k, word memory h4 (.er) q right k, word memory h4 (.cr) q right k, word memory h4 (.ar) q right k, word memory h4 (.dr) q right k, word memory h4 (.br) q right k, word memory h4 (.factor) q right k, word memory h4 (.lower) q right k, word memory h4 (.cache 140) q right k, word memory h4 (.cache 350) q right k, word memory h4 (.cache 310) q right k, word memory h4 (.cache 190) q right k, word memory h4 (.cache 500) q right k⟩
theorem output_eq (memory : ByteArray) (h4 : UInt256) (q right : WordLane) (rho : List UInt256) :
    StaggerRawLeft79.outputStack memory (input memory h4 q right (UInt256.ofNat 2840853866)) rho =
      stack memory h4 [ .b, .e, .a, .d, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (StaggerCoreModel.left79 memory q) (right) (UInt256.ofNat 2840853866) rho := by
...
def gasSteps (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4583, stack := stack s.memory h4 [ .d, .c, .a, .e, .ar, .cachedMessage 360, .k, .b, .er, .cr, .literal 23, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] q right (UInt256.ofNat 2840853866) rho}
      {s with pc := UInt256.ofNat 4613, stack := stack s.memory h4 [ .b, .e, .a, .d, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (StaggerCoreModel.left79 s.memory q) (right) (UInt256.ofNat 2840853866) rho} := by
  have h := StaggerRawLeft79.gasSteps s (input s.memory h4 q right (UInt256.ofNat 2840853866)) rho hs hr ha hcode hfork hnp
  rw [output_eq] at h
  exact h
