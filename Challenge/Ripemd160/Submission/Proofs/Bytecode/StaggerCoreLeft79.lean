...
def gasSteps (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4800, stack := stack s.memory h4 [ .d, .c, .a, .e, .ar, .cachedMessage 360, .k, .b, .er, .cr, .literal 23, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] q right (UInt256.ofNat 2840853838) rho}
      {s with pc := UInt256.ofNat 4830, stack := stack s.memory h4 [ .b, .e, .a, .d, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (StaggerCoreModel.left79 s.memory q) (right) (UInt256.ofNat 2840853838) rho} := by
