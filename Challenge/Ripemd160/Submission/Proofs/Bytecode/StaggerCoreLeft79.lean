...
def input (memory : ByteArray) (q right : WordLane) (k : UInt256) : StaggerRaw.Input :=
  ⟨word memory (.d) q right k, word memory (.c) q right k, word memory (.a) q right k, word memory (.e) q right k, word memory (.k) q right k, word memory (.b) q right k, word memory (.er) q right k, word memory (.cr) q right k, word memory (.ar) q right k, word memory (.dr) q right k, word memory (.br) q right k, word memory (.factor) q right k, word memory (.lower) q right k, word memory (.cache 140) q right k, word memory (.cache 190) q right k, word memory (.cache 310) q right k, word memory (.cache 350) q right k, word memory (.cache 500) q right k, word memory (.cache 230) q right k, UInt256.ofNat 0⟩
theorem output_eq (memory : ByteArray) (q right : WordLane) (rho : List UInt256) :
    StaggerRawLeft79.outputStack memory (input memory q right (UInt256.ofNat 2840853838)) rho =
      stack memory [ .d, .b, .e, .a, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 190, .cache 310, .cache 350, .cache 500, .cache 230 ] (StaggerCoreModel.left79 memory q) (right) (UInt256.ofNat 2840853838) rho := by
...
def gasSteps (s : State) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4552, stack := stack s.memory [ .d, .c, .a, .e, .k, .b, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 190, .cache 310, .cache 350, .cache 500, .cache 230 ] q right (UInt256.ofNat 2840853838) rho}
      {s with pc := UInt256.ofNat 4579, stack := stack s.memory [ .d, .b, .e, .a, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 190, .cache 310, .cache 350, .cache 500, .cache 230 ] (StaggerCoreModel.left79 s.memory q) (right) (UInt256.ofNat 2840853838) rho} := by
