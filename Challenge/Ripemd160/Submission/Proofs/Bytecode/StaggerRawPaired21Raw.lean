...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 10141204804187018453417038184450) (UInt256.mod (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 684) (UInt256.add (UInt256.lor (UInt256.land x.v9 x.v6) (UInt256.xor (UInt256.land (UInt256.xor x.v4 x.v9) (UInt256.lor x.v6 x.v0)) x.v0)) x.v7)))) x.v12)) (UInt256.ofNat 24)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 10141204804187018453417038184450) (UInt256.mod (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 684) (UInt256.add (UInt256.lor (UInt256.land x.v6 x.v9) (UInt256.xor (UInt256.land (UInt256.xor x.v4 x.v9) (UInt256.lor x.v6 x.v0)) x.v0)) x.v7)))) x.v12)) (UInt256.ofNat 24)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
