...
def gasSteps (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3909, stack := stack s.memory h4 [ .d, .a, .cachedMessage 360, .pair, .upper, .k, .c, .literal 23, .e, .b, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] q right (StaggerAlgorithm.physicalKey 62) rho}
      {s with pc := UInt256.ofNat 3950, stack := stack s.memory h4 [ .d, .e, .cachedMessage 360, .pair, .upper, .cachedMessage 360, .b, .literal 23, .a, .c, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (eval s.memory q) right (StaggerAlgorithm.physicalKey 63) rho} := by
