...
theorem site_pc : site.startPC = UInt256.ofNat 2581 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1955) = UInt256.ofNat 2581
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2581) template = UInt256.ofNat 2632 := by decide
  rw [hend] at hraw
