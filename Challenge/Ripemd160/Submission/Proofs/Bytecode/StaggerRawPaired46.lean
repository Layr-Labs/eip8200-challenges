...
def template : List Instr :=
  [ .op (.Swap ⟨6, by decide⟩),
    ...
    .op (.Dup ⟨10, by decide⟩),
    .op .MUL,
    .push ⟨1, by decide⟩ (UInt256.ofNat 33),
    .op .SHR,
    .op (.Dup ⟨5, by decide⟩),
    .op .ADD,
    .op (.Dup ⟨3, by decide⟩),
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v0,
    x.v8,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.add (UInt256.mul (UInt256.ofNat 3) (UInt256.land x.v11 (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 1080) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor x.v6 x.v4) (UInt256.xor x.v9 (UInt256.land x.v0 x.v6))) x.v0) x.v6)) x.v7)))))) (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 1080) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor x.v6 x.v4) (UInt256.xor x.v9 (UInt256.land x.v0 x.v6))) x.v0) x.v6)) x.v7)))))) (UInt256.ofNat 33)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v0,
    x.v8,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.add (UInt256.mul (UInt256.ofNat 3) (UInt256.land x.v11 (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 1080) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.lor (UInt256.xor x.v4 x.v6) (UInt256.xor (UInt256.land x.v0 x.v6) x.v9)) (UInt256.xor x.v0 x.v6))) x.v7)))))) (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 1080) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.lor (UInt256.xor x.v4 x.v6) (UInt256.xor (UInt256.land x.v0 x.v6) x.v9)) (UInt256.xor x.v0 x.v6))) x.v7)))))) (UInt256.ofNat 33)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 2485).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 2485 actual_slice
    (by change 2485 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 3243 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2485) = UInt256.ofNat 3243
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3243, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3291, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3243) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3243) template = UInt256.ofNat 3291 := by decide
  rw [hend] at hraw
