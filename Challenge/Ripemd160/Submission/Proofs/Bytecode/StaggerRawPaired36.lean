...
theorem site_pc : site.startPC = UInt256.ofNat 2690 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2124) = UInt256.ofNat 2690
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2690) template = UInt256.ofNat 2724 := by decide
  rw [hend] at hraw
