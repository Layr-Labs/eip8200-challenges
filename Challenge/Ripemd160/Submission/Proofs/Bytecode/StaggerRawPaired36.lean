...
theorem site_pc : site.startPC = UInt256.ofNat 2856 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2151) = UInt256.ofNat 2856
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2856) template = UInt256.ofNat 2889 := by decide
  rw [hend] at hraw
