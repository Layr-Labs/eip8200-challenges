...
theorem site_pc : site.startPC = UInt256.ofNat 2797 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2106) = UInt256.ofNat 2797
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2797) template = UInt256.ofNat 2831 := by decide
  rw [hend] at hraw
