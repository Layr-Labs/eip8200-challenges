...
theorem site_pc : site.startPC = UInt256.ofNat 2929 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2042) = UInt256.ofNat 2929
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2929) template = UInt256.ofNat 2962 := by decide
  rw [hend] at hraw
