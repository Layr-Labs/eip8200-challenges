...
theorem site_pc : site.startPC = UInt256.ofNat 2791 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2100) = UInt256.ofNat 2791
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2791) template = UInt256.ofNat 2825 := by decide
  rw [hend] at hraw
