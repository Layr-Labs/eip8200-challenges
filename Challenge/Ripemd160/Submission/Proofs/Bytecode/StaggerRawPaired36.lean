...
theorem site_pc : site.startPC = UInt256.ofNat 2700 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2053) = UInt256.ofNat 2700
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2700) template = UInt256.ofNat 2733 := by decide
  rw [hend] at hraw
