...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 23))),
    ...
    (UInt256.ofNat 23),
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 162) (UInt256.add (UInt256.xor x.v9 (UInt256.land (UInt256.xor (UInt256.lor x.v4 x.v9) x.v6) (UInt256.xor (UInt256.land x.v9 x.v4) x.v0))) x.v8))))) (UInt256.ofNat 25)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
