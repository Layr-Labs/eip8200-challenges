...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v7) (UInt256.ofNat 22))),
    ...
    x.v5,
    x.v0,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.add x.v15 (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v2 x.v7) x.v0) (UInt256.xor x.v2 (UInt256.xor x.v7 x.v4))) x.v6))))) (UInt256.ofNat 26)))),
    x.v8,
    x.v9,
    x.v10,
    x.v11,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1207 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1652 := by
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1652, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1688, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1652) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1652) template = UInt256.ofNat 1688 := by decide
  rw [hend] at hraw
