...
theorem site_pc : site.startPC = UInt256.ofNat 1666 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1166) = UInt256.ofNat 1666
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1666) template = UInt256.ofNat 1705 := by decide
  rw [hend] at hraw
