...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v8) (UInt256.ofNat 28))),
    ...
    x.v6,
    x.v0,
    (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.land x.v2 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 414) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v3 x.v8) x.v0) (UInt256.xor x.v3 (UInt256.xor x.v5 x.v8))) x.v7))))) (UInt256.ofNat 32)))),
    x.v9,
    x.v10,
    x.v11,
    x.v12,
...
theorem site_pc : site.startPC = UInt256.ofNat 1673 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1172) = UInt256.ofNat 1673
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1673) template = UInt256.ofNat 1712 := by decide
  rw [hend] at hraw
