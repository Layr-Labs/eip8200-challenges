...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 2889).take actualTemplate.length = actualTemplate := by rfl
def actualSite : GenericRoundSite Artifact.submissionArtifact .Osaka actualTemplate :=
  StackSiteBuilder.ofSlice actualTemplate 2889 actual_slice
...
theorem actual_pc : actualSite.startPC = UInt256.ofNat 3487 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2889) = UInt256.ofNat 3487
