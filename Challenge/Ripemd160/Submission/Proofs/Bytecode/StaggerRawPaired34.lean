...
theorem site_pc : site.startPC = UInt256.ofNat 2659 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1994) = UInt256.ofNat 2659
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2659) template = UInt256.ofNat 2691 := by decide
  rw [hend] at hraw
