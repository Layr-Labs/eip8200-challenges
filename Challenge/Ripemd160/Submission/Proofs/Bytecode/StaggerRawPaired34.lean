...
theorem site_pc : site.startPC = UInt256.ofNat 2764 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2078) = UInt256.ofNat 2764
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2764) template = UInt256.ofNat 2797 := by decide
  rw [hend] at hraw
