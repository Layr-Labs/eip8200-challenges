...
theorem site_pc : site.startPC = UInt256.ofNat 2787 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2086) = UInt256.ofNat 2787
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2787) template = UInt256.ofNat 2820 := by decide
  rw [hend] at hraw
