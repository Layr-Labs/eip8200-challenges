...
theorem site_pc : site.startPC = UInt256.ofNat 2664 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2081) = UInt256.ofNat 2664
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2664) template = UInt256.ofNat 2695 := by decide
  rw [hend] at hraw
