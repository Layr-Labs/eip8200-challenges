...
theorem site_pc : site.startPC = UInt256.ofNat 2743 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2034) = UInt256.ofNat 2743
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2743) template = UInt256.ofNat 2777 := by decide
  rw [hend] at hraw
