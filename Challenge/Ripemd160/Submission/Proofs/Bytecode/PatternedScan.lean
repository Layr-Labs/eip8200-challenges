...
def loopPath : List Located :=
  [opAt 2864 .JUMPDEST,
   ...
   pushAt 2866 1 251, opAt 2867 .DIV,
   ...
   pushAt 2890 2 1000, opAt 2891 .LT,
...
@[simp] private theorem pc2866 : Artifact.submissionArtifact.instructionPC 2866 = 4935 := by rfl
@[simp] private theorem pc2867 : Artifact.submissionArtifact.instructionPC 2867 = 4937 := by rfl
@[simp] private theorem pc2868 : Artifact.submissionArtifact.instructionPC 2868 = 4938 := by rfl
...
@[simp] private theorem pc2871 : Artifact.submissionArtifact.instructionPC 2871 = 4942 := by rfl
...
@[simp] private theorem pc2874 : Artifact.submissionArtifact.instructionPC 2874 = 4946 := by rfl
@[simp] private theorem pc2875 : Artifact.submissionArtifact.instructionPC 2875 = 4948 := by rfl
@[simp] private theorem pc2876 : Artifact.submissionArtifact.instructionPC 2876 = 4949 := by rfl
...
@[simp] private theorem pc2887 : Artifact.submissionArtifact.instructionPC 2887 = 4961 := by rfl
...
@[simp] private theorem pc2890 : Artifact.submissionArtifact.instructionPC 2890 = 4965 := by rfl
@[simp] private theorem pc2891 : Artifact.submissionArtifact.instructionPC 2891 = 4968 := by rfl
@[simp] private theorem pc2892 : Artifact.submissionArtifact.instructionPC 2892 = 4969 := by rfl
...
@[simp] private theorem pc2895 : Artifact.submissionArtifact.instructionPC 2895 = 4974 := by rfl
@[simp] private theorem pc2896 : Artifact.submissionArtifact.instructionPC 2896 = 4977 := by rfl
@[simp] private theorem pc2897 : Artifact.submissionArtifact.instructionPC 2897 = 4978 := by rfl
...
@[simp] private theorem pc2900 : Artifact.submissionArtifact.instructionPC 2900 = 5001 := by rfl
@[simp] private theorem pc2901 : Artifact.submissionArtifact.instructionPC 2901 = 5003 := by rfl
@[simp] private theorem pc2902 : Artifact.submissionArtifact.instructionPC 2902 = 5004 := by rfl
...
/-- One 50-iteration slice. The 1000-a path uses `iterateBounded 29`;
    a single `iterateBounded 999` is the `dfbd6640` bomb. -/
private def gasSteps_loop_slice (input : ByteArray) (hsize : input.size = 1000)
...
private def gasSteps_loop (input : ByteArray) (hsize : input.size = 1000) :
  ...
  let s (k : Nat) := gasSteps_loop_slice input hsize (50 * k) 50
  ((((s 0 (by decide)).trans (s 1 (by decide))).trans (s 2 (by decide))).trans
    (s 3 (by decide))).trans
    (((((s 4 (by decide)).trans (s 5 (by decide))).trans (s 6 (by decide))).trans
      (s 7 (by decide))).trans
      (((((s 8 (by decide)).trans (s 9 (by decide))).trans (s 10 (by decide))).trans
        (s 11 (by decide))).trans
        (((((s 12 (by decide)).trans (s 13 (by decide))).trans (s 14 (by decide))).trans
          (s 15 (by decide))).trans
          (((((s 16 (by decide)).trans (s 17 (by decide))).trans (s 18 (by decide))).trans
            (gasSteps_loop_slice input hsize 950 49 (by decide))).trans
