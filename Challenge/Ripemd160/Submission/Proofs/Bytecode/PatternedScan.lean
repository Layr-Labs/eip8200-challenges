...
def loopPath : List Located :=
  [opAt 2914 .JUMPDEST,
   ...
   pushAt 2930 0 0, opAt 2931 .BYTE,
   opAt 2932 .XOR,
...
def exitPath : List Located :=
  [opAt 2944 .POP, pushAt 2945 2 1006, opAt 2946 .JUMPI]

def returnPath : List Located :=
  [pushAt 2947 20 766350606435067737561421097975693824639675460820,
   pushAt 2948 0 0, opAt 2949 .MSTORE,
   pushAt 2950 1 32, pushAt 2951 0 0, opAt 2952 .RETURN]
...
def hitEntry (input : ByteArray) : State := atPC input 5348
...
@[simp] private theorem pc2931 : Artifact.submissionArtifact.instructionPC 2931 = 5325 := by rfl
@[simp] private theorem pc2932 : Artifact.submissionArtifact.instructionPC 2932 = 5326 := by rfl
@[simp] private theorem pc2933 : Artifact.submissionArtifact.instructionPC 2933 = 5327 := by rfl
@[simp] private theorem pc2934 : Artifact.submissionArtifact.instructionPC 2934 = 5328 := by rfl
@[simp] private theorem pc2935 : Artifact.submissionArtifact.instructionPC 2935 = 5329 := by rfl
@[simp] private theorem pc2936 : Artifact.submissionArtifact.instructionPC 2936 = 5330 := by rfl
@[simp] private theorem pc2937 : Artifact.submissionArtifact.instructionPC 2937 = 5331 := by rfl
@[simp] private theorem pc2938 : Artifact.submissionArtifact.instructionPC 2938 = 5333 := by rfl
@[simp] private theorem pc2939 : Artifact.submissionArtifact.instructionPC 2939 = 5334 := by rfl
@[simp] private theorem pc2940 : Artifact.submissionArtifact.instructionPC 2940 = 5335 := by rfl
@[simp] private theorem pc2941 : Artifact.submissionArtifact.instructionPC 2941 = 5338 := by rfl
@[simp] private theorem pc2942 : Artifact.submissionArtifact.instructionPC 2942 = 5339 := by rfl
@[simp] private theorem pc2943 : Artifact.submissionArtifact.instructionPC 2943 = 5342 := by rfl
@[simp] private theorem pc2944 : Artifact.submissionArtifact.instructionPC 2944 = 5343 := by rfl
@[simp] private theorem pc2945 : Artifact.submissionArtifact.instructionPC 2945 = 5344 := by rfl
@[simp] private theorem pc2946 : Artifact.submissionArtifact.instructionPC 2946 = 5347 := by rfl
@[simp] private theorem pc2947 : Artifact.submissionArtifact.instructionPC 2947 = 5348 := by rfl
@[simp] private theorem pc2948 : Artifact.submissionArtifact.instructionPC 2948 = 5369 := by rfl
@[simp] private theorem pc2949 : Artifact.submissionArtifact.instructionPC 2949 = 5370 := by rfl
@[simp] private theorem pc2950 : Artifact.submissionArtifact.instructionPC 2950 = 5371 := by rfl
@[simp] private theorem pc2951 : Artifact.submissionArtifact.instructionPC 2951 = 5373 := by rfl
@[simp] private theorem pc2952 : Artifact.submissionArtifact.instructionPC 2952 = 5374 := by rfl
