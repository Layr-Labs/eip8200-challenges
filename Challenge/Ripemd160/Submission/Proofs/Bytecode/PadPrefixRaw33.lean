...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw33
...
def template : List Instr :=
  [ .op (.Swap ⟨7, by decide⟩),
    ...
    .op (.Dup ⟨12, by decide⟩),
    .op .AND,
    .push ⟨13, by decide⟩ (UInt256.ofNat 10141204804187018453477167726608),
    .op .MUL,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 10141204804187018453477167726608) (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 306) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8))) (UInt256.ofNat 72)) (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 306) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8)))))) (UInt256.ofNat 23)))),
    x.v7,
    x.v0,
    x.v9,
    x.v10,
...
private theorem run_generated (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
  ...
  have hz306 : MachineState.readWord s.memory 306 = UInt256.ofNat 0 :=
    PadPrefixContract.read_zero s hz ⟨17, by decide⟩ (by decide)
  ...
  simp (discharger := omega) [template, inputStack, actualOutput, hz306,
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw33
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 5213).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 5213 actual_slice
    (by change 5213 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 6529 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 5213) = UInt256.ofNat 6529
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 6529, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 6575, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 6529) x rho hstack hrun hactive hz
  have hend : pcAfter (UInt256.ofNat 6529) template = UInt256.ofNat 6575 := by decide
  rw [hend] at hraw
