...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80CoreRound77
...
#print axioms output_eq
 ...
 def gasSteps (s : State) (q : WordLane) (k : UInt256) (rho : List UInt256)
     ...
     Challenge.EvmProof.GasSteps {s with pc := UInt256.ofNat 4490, stack := stack [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] q k rho}
       {s with pc := UInt256.ofNat 4533, stack :=
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80CoreRound77
