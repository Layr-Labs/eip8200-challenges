import Challenge.Ripemd160.Submission.Proofs.Bytecode.PersistentSerialize
...
private theorem packedHash_eq_pack5 (h : Compression.HashState) :
    PersistentOutput.packedHash h = PackedOutputMath.pack5 h.h0 h.h1 h.h2 h.h3 h.h4 := by
  simp only [PersistentOutput.packedHash, PackedOutputMath.pack5, PackedOutputMath.append32,
    Word.lor_comm]
...
theorem returned_spec (s : State) (input : ByteArray) (off limit : UInt256)
  ...
  rw [result, PersistentReturn.returned_bytes]
