...
private theorem mulMod_comm_local (a b n : UInt256) : UInt256.mulMod a b n = UInt256.mulMod b a n := by
  unfold UInt256.mulMod; rw [Nat.mul_comm]
def template : List Instr :=
  [ .op (.Swap ⟨1, by decide⟩),
    ...
    .op (.Dup ⟨4, by decide⟩),
    .op .AND,
    .push ⟨13, by decide⟩ (UInt256.ofNat 9982748479121596290078236213249),
    .op .MULMOD,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mulMod (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 72) (UInt256.add (UInt256.lor (UInt256.land x.v6 x.v9) (UInt256.xor (UInt256.land (UInt256.xor x.v9 x.v4) (UInt256.lor x.v6 x.v0)) x.v0)) x.v7)))) (UInt256.ofNat 9982748479121596290078236213249) x.v12) (UInt256.ofNat 26)))),
    (UInt256.ofNat 23),
    x.v8,
    x.v9,
    x.v10,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mulMod (UInt256.ofNat 9982748479121596290078236213249) (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 72) (UInt256.add (UInt256.lor (UInt256.land x.v6 x.v9) (UInt256.xor (UInt256.land (UInt256.xor x.v9 x.v4) (UInt256.lor x.v6 x.v0)) x.v0)) x.v7)))) x.v12) (UInt256.ofNat 26)))),
    (UInt256.ofNat 23),
    x.v8,
    x.v9,
    x.v10,
