...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan31
...
def gasSteps_last (input : ByteArray) (hsize : input.size = 31) :
...
def gasSteps_scan (input : ByteArray) (hsize : input.size = 31) :
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan31
#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan31.gasSteps_scan
