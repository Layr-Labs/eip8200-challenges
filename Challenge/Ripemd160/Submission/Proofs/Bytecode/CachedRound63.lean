...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3159).take actualTemplate.length = actualTemplate := by rfl
def actualSite : GenericRoundSite Artifact.submissionArtifact .Osaka actualTemplate :=
  StackSiteBuilder.ofSlice actualTemplate 3159 actual_slice
...
theorem actual_pc : actualSite.startPC = UInt256.ofNat 3787 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3159) = UInt256.ofNat 3787
