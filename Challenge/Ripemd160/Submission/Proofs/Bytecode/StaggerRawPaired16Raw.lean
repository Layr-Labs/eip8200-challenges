...
def template : List Instr :=
  [ .op (.Swap ⟨4, by decide⟩),
    .push ⟨4, by decide⟩ (UInt256.ofNat 1518500277),
    .op .ADD,
    .op (.Swap ⟨7, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op (.Dup ⟨10, by decide⟩),
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 23))),
    ...
    x.v6,
    (UInt256.ofNat 23),
    (UInt256.add (UInt256.ofNat 1518500277) x.v5),
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add (UInt256.add (UInt256.ofNat 1518500277) x.v5) (UInt256.add (MachineState.readWord memory 252) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.xor x.v6 x.v4) (UInt256.lor x.v9 x.v0)) x.v0) (UInt256.land x.v9 x.v6)) x.v8))))) (UInt256.ofNat 26)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
