...
theorem site_pc : site.startPC = UInt256.ofNat 1118 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 711) = UInt256.ofNat 1118
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 1118) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1118) template = UInt256.ofNat 1172 := by decide
  rw [hend] at hraw
