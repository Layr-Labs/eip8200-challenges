...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 711 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1118 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 711) = UInt256.ofNat 1197
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1118, stack := inputStack x rho}
  ...
  have hend : pcAfter (UInt256.ofNat 1118) template = UInt256.ofNat 1144 := by decide
  rw [hend] at hraw
