...
def resultMemory (memory : ByteArray) (i : Nat) : ByteArray :=
  let h := knownAfter i
  let m0 := writeWord memory 0x340 (Word.ofUInt32 h[0]!)
  let m1 := writeWord m0 0x360 (Word.ofUInt32 h[1]!)
  let m2 := writeWord m1 0x380 (Word.ofUInt32 h[2]!)
  let m3 := writeWord m2 0x3a0 (Word.ofUInt32 h[3]!)
  writeWord m3 0x3c0 (Word.ofUInt32 h[4]!)

def resultActiveWords (s : State) : UInt256 :=
  let a0 := s.activeWordsAfterUInt256 0x340 32
  let a1 := UInt256.ofNat (MachineState.activeWordsAfter a0.toNat 0x360 32)
  let a2 := UInt256.ofNat (MachineState.activeWordsAfter a1.toNat 0x380 32)
  let a3 := UInt256.ofNat (MachineState.activeWordsAfter a2.toNat 0x3a0 32)
  UInt256.ofNat (MachineState.activeWordsAfter a3.toNat 0x3c0 32)
...
@[simp] private theorem resultMemory_h0 (memory : ByteArray) (i : Nat) :
    MachineState.readWord (resultMemory memory i) 0x340 =
...
@[simp] private theorem resultMemory_h1 (memory : ByteArray) (i : Nat) :
    MachineState.readWord (resultMemory memory i) 0x360 =
...
@[simp] private theorem resultMemory_h2 (memory : ByteArray) (i : Nat) :
    MachineState.readWord (resultMemory memory i) 0x380 =
...
@[simp] private theorem resultMemory_h3 (memory : ByteArray) (i : Nat) :
    MachineState.readWord (resultMemory memory i) 0x3a0 =
...
@[simp] private theorem resultMemory_h4 (memory : ByteArray) (i : Nat) :
    MachineState.readWord (resultMemory memory i) 0x3c0 =
