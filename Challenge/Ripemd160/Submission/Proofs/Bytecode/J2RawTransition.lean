...
theorem run_transition_aux (s : State) (pc : UInt256) (f : Frame) (rho : List UInt256)
  ...
  have hK : UInt256.shiftRight (UInt256.xor (UInt256.mul (UInt256.ofNat 96) PatternedSwar.M) PatternedSwar.m8)
      (UInt256.ofNat 4) = UInt256.mul (UInt256.ofNat 14) PatternedSwar.M := by decide
  have hK' : UInt256.shiftRight (UInt256.xor PatternedSwar.m8 (UInt256.mul (UInt256.ofNat 96) PatternedSwar.M))
      (UInt256.ofNat 4) = UInt256.mul (UInt256.ofNat 14) PatternedSwar.M := by decide
