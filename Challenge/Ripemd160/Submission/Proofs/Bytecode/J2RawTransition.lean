...
def transitionATemplate : List Instr := transitionTemplate.take 17
def transitionBTemplate : List Instr := transitionTemplate.drop 17
...
theorem run_transition (s : State) (pc : UInt256) (f : Frame) (rho : List UInt256)
  ...
  have ht : transitionATemplate ++ transitionBTemplate = transitionTemplate := List.take_append_drop 17 _
