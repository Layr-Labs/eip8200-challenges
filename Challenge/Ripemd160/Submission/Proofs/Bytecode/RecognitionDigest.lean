...
def payload : ByteArray := ByteArray.mk #[
  ...
  0x4b, 0xc4, 0xc1, 0x79, 0x09, 0x06, 0xf7, 0x77, 0x41, 0x05, 0xd3, 0x64,
...
theorem payload_read (n : Nat) (hn : Allowed n) :
    MachineState.writeBytes ByteArray.empty
      (MachineState.readPadded payload (20 * ((345007677684 / n) % 16)) 20) 12 = paddedDigest n := by
  rcases hn with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
  all_goals
