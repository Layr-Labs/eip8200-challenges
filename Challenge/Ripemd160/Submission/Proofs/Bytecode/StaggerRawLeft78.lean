...
theorem site_pc : site.startPC = UInt256.ofNat 4511 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3605) = UInt256.ofNat 4511
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4511) template = UInt256.ofNat 4540 := by decide
  rw [hend] at hraw
