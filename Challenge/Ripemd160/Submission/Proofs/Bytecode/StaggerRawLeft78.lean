...
theorem site_pc : site.startPC = UInt256.ofNat 4450 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3543) = UInt256.ofNat 4450
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4450) template = UInt256.ofNat 4479 := by decide
  rw [hend] at hraw
