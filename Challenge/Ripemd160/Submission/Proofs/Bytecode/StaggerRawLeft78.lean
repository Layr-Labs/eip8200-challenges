...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3513).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4523 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3513) = UInt256.ofNat 4523
