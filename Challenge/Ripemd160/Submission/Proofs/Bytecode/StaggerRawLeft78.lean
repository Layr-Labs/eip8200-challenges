...
theorem site_pc : site.startPC = UInt256.ofNat 4452 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3324) = UInt256.ofNat 4452
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4452) x rho hstack haliasR hrun hactive
