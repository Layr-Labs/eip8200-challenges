...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v13 x.v7) (UInt256.ofNat 28)),
    ...
    x.v5,
    x.v6,
    (UInt256.add x.v2 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v14 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 1008) (UInt256.add (UInt256.xor x.v1 (UInt256.lor x.v7 (UInt256.lnot x.v0))) x.v3))))) (UInt256.ofNat 33))),
    x.v8,
    x.v9,
    x.v10,
    x.v11,
...
theorem site_pc : site.startPC = UInt256.ofNat 4505 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3606) = UInt256.ofNat 4505
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4505) template = UInt256.ofNat 4534 := by decide
  rw [hend] at hraw
