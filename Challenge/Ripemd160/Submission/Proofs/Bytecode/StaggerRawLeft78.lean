...
theorem site_pc : site.startPC = UInt256.ofNat 4532 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3422) = UInt256.ofNat 4532
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4532) x rho hstack haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4532) template = UInt256.ofNat 4560 := by decide
  rw [hend] at hraw
