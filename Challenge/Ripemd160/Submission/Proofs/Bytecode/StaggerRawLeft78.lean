...
theorem site_pc : site.startPC = UInt256.ofNat 4491 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3537) = UInt256.ofNat 4491
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4491) template = UInt256.ofNat 4520 := by decide
  rw [hend] at hraw
