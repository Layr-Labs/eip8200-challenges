...
theorem site_pc : site.startPC = UInt256.ofNat 4492 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3534) = UInt256.ofNat 4492
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4492) template = UInt256.ofNat 4520 := by decide
  rw [hend] at hraw
