...
theorem site_pc : site.startPC = UInt256.ofNat 4503 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3530) = UInt256.ofNat 4503
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4503) template = UInt256.ofNat 4531 := by decide
  rw [hend] at hraw
