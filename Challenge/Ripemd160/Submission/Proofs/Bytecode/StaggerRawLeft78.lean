...
theorem site_pc : site.startPC = UInt256.ofNat 4521 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3737) = UInt256.ofNat 4521
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4521) template = UInt256.ofNat 4552 := by decide
  rw [hend] at hraw
