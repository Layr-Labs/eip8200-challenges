...
theorem site_pc : site.startPC = UInt256.ofNat 4526 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3471) = UInt256.ofNat 4526
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4526) x rho hstack haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4526) template = UInt256.ofNat 4554 := by decide
  rw [hend] at hraw
