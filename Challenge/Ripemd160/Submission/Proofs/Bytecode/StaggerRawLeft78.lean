...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v11 x.v5) (UInt256.ofNat 28)),
    x.v1,
    x.v2,
    x.v0,
    x.v4,
    (UInt256.add x.v2 (UInt256.shiftRight (UInt256.mul x.v11 (UInt256.land x.v12 (UInt256.add x.v4 (UInt256.add (MachineState.readWord memory 144) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v0) x.v5) x.v1) x.v3))))) (UInt256.ofNat 33))),
    x.v6,
    x.v7,
    x.v8,
    x.v9,
...
theorem site_pc : site.startPC = UInt256.ofNat 4614 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3684) = UInt256.ofNat 4614
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4614) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4614) template = UInt256.ofNat 4643 := by decide
  rw [hend] at hraw
