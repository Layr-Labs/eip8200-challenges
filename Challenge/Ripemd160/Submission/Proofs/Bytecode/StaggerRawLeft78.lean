...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3603).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4517 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3603) = UInt256.ofNat 4517
