...
theorem dispatch_pc : dispatchSite.startPC = UInt256.ofNat 531 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 302) = UInt256.ofNat 556
...
theorem prefix_pc : prefixSite.startPC = UInt256.ofNat 404 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 243) = UInt256.ofNat 450
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem valid_pad (s : State) (hcode : s.executionEnv.code = Artifact.submissionArtifact.code) :
  ...
  have hpc : Artifact.submissionArtifact.instructionPC 243 = 450 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
def gasSteps_miss (s : State) (ptr ret off : UInt256) (rho : List UInt256)
  ...
  have hp : pcAfter (UInt256.ofNat 531) (PadDispatch.template 404) = UInt256.ofNat 510 := by rfl
  rw [hp] at h
  exact h
