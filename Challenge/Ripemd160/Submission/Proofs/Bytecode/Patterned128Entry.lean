...
private theorem guard_fallback_dest : Decode.isValidJumpDest submissionBytecode 453 = true :=
...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 253 .JUMPDEST,
   DirectGuard.pushAt 254 0 0,
   DirectGuard.opAt 255 .CALLDATALOAD,
   DirectGuard.pushAt 256 0 0,
   DirectGuard.opAt 257 .BYTE,
   DirectGuard.pushAt 258 1 7,
   DirectGuard.opAt 259 .XOR,
   DirectGuard.pushAt 260 2 5157]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 262 0 0,
   DirectGuard.pushAt 263 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 264 .CALLDATASIZE,
   DirectGuard.opAt 265 .SHR,
   DirectGuard.pushAt 266 1 1,
   DirectGuard.opAt 267 .AND,
   DirectGuard.pushAt 268 1 106]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 270 .POP,
   DirectGuard.pushAt 271 2 453,
   DirectGuard.opAt 272 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 400 []) =
      some (PatternedScan.stS input 411 [5157, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 253 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 253 400 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 400 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 254 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 254 401 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 401 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 255 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 255 402 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 402 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 256 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 256 403 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 403 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 257 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 257 404 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 404 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 258 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 258 405 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 405 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 259 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 259 407 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 407 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 260 2 5157
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 260 408 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 408 2 5157 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 262 = 412 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 263 = 413 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 264 = 431 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 265 = 432 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 266 = 433 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 267 = 435 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 268 = 436 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 269 = 438 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 270 = 439 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 271 = 440 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 272 = 443 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 412 []) =
      some (PatternedScan.stS input 438 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 261 .JUMPI] (PatternedScan.stS input 411 [5157, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 261 .JUMPI)
    (PatternedScan.pcFactS input 261 411 [5157, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 411 5157 5157 (byteValue input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 5157) (byteValue_true input hbyte) AbcArm.arm_dest)

private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 261 .JUMPI] (PatternedScan.stS input 411 [5157, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 412 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 261 .JUMPI)
    (PatternedScan.pcFactS input 261 411 [5157, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 411 5157 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 269 .JUMPI]
      (PatternedScan.stS input 438 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 269 .JUMPI)
    (PatternedScan.pcFactS input 269 438 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 438 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 269 .JUMPI]
      (PatternedScan.stS input 438 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 439 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 269 .JUMPI)
    (PatternedScan.pcFactS input 269 438 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 438 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 439 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 270 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 270 439 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 439 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 271 2 453
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 271 440 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 440 2 453 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 272 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 272 443 [453] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 443 453 453 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 412 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 412 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 412 []) (PatternedScan.patternedEntry input) := by
...
def gasSteps_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    (hgen : input ≠ Gen01InputData.gen01Input) :
...
def gasSteps_miss (input : ByteArray) (hfit : CalldataFits input)
  ...
  exact (Execution.gasSteps_start input).trans
    ((sound (DirectGuard.sizeDispatchPath input)
        (DirectGuard.run_size_fail input hfit h1000 h376 h256)).trans
      (gasSteps_fail input hfit hnabc hbad hgen))

/-- Reaching the `abc` arm: the entry size classifier misses (3 is not 256, 376 or 1000)
and the byte-0 gate misses ('a' = 0x61 ≠ 7), so the byte-0 `JUMPI` lands on the arm (pc 5157). -/
...
/-- Reaching the `generated #01` arm: the entry size classifier misses (32 is
not 256, 376 or 1000), the byte-0 gate misses (`0x73 ≠ 7`), the `abc` arm's
size test misses (32 ≠ 3), so the size-miss `JUMPI` lands on the gen01 arm
(pc 5206). -/
def gasSteps_gen01_entry (input : ByteArray) (hfit : CalldataFits input)
    (heq : input = Gen01InputData.gen01Input) :
    GasSteps (initialState submissionBytecode input 0) (Gen01Arm.armEntry input) := by
  have hsize : input.size = 32 := by rw [heq]; rfl
  have h1000 : input.size ≠ 1000 := by omega
  have h376 : input.size ≠ 376 := by omega
  have h256 : input.size ≠ 256 := by omega
  have hne3 : input.size ≠ 3 := by omega
  have hbyte : DirectGuard.firstByte input ≠ 7 := by
    intro h7
    have h := firstByte_eq_byteAt input
    rw [heq, Gen01Recognition.readWord_gen01Input] at h
    rw [heq] at h7
    rw [h7] at h
    revert h; decide
  exact (Execution.gasSteps_start input).trans
    ((sound (DirectGuard.sizeDispatchPath input)
      ...
      ((gasSteps_byte_fail input hbyte).trans
        (AbcArm.gasSteps_size_miss input hfit hne3)))
