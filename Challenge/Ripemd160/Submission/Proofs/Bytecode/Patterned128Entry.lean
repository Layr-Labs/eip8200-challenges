...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3695 = 4830 := J2EntryWindow.pc 0
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3696 = 4831 := J2EntryWindow.pc 1
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3702 = 4856 := J2EntryWindow.pc 7
private theorem packedPC3735 : Artifact.submissionArtifact.instructionPC 3703 = 4857 := J2EntryWindow.pc 8
private theorem packedPC3736 : Artifact.submissionArtifact.instructionPC 3704 = 4860 := J2EntryWindow.pc 9
private theorem packedPC3737 : Artifact.submissionArtifact.instructionPC 3705 = 4866 := J2EntryWindow.pc 10
private theorem packedPC3738 : Artifact.submissionArtifact.instructionPC 3706 = 4867 := J2EntryWindow.pc 11
private theorem packedPC3739 : Artifact.submissionArtifact.instructionPC 3707 = 4869 := J2EntryWindow.pc 12
private theorem packedPC3740 : Artifact.submissionArtifact.instructionPC 3708 = 4870 := J2EntryWindow.pc 13
private theorem packedPC3741 : Artifact.submissionArtifact.instructionPC 3709 = 4871 := J2EntryWindow.pc 14
private theorem packedPC3742 : Artifact.submissionArtifact.instructionPC 3710 = 4872 := J2EntryWindow.pc 15
private theorem packedPC3743 : Artifact.submissionArtifact.instructionPC 3711 = 4873 := J2EntryWindow.pc 16
private theorem packedPC3744 : Artifact.submissionArtifact.instructionPC 3712 = 4874 := J2EntryWindow.pc 17
private theorem packedPC3745 : Artifact.submissionArtifact.instructionPC 3713 = 4876 := J2EntryWindow.pc 18

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3697 = 4833 :=
  J2EntryWindow.pc 2
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3698 = 4851 :=
  J2EntryWindow.pc 3
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3699 = 4852 :=
  J2EntryWindow.pc 4
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3700 = 4853 :=
  J2EntryWindow.pc 5
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3701 = 4854 :=
  J2EntryWindow.pc 6

/-! ## The size mask -/

private def maskEntry : List Located :=
  [DirectGuard.opAt 3695 .JUMPDEST (by exact J2EntryWindow.get 0)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3696 1 1 (by exact J2EntryWindow.get 1),
   DirectGuard.pushAt 3697 17 342276208914615837337402008677671501826 (by exact J2EntryWindow.get 2),
   DirectGuard.opAt 3698 .CALLDATASIZE (by exact J2EntryWindow.get 3),
   DirectGuard.opAt 3699 .SHR (by exact J2EntryWindow.get 4),
   DirectGuard.opAt 3700 .AND (by exact J2EntryWindow.get 5),
   DirectGuard.pushAt 3701 1 110 (by exact J2EntryWindow.get 6)]

private def maskJump : List Located :=
  [DirectGuard.opAt 3702 .JUMPI (by exact J2EntryWindow.get 7)]
...
private theorem run_mask_entry (input : ByteArray) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3695 4830 [] (by norm_num) pc3836)
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4831 []) =
      some (PatternedScan.stS input 4856 [110, sizeBit input]) := by
  have hpc : Artifact.submissionArtifact.instructionPC 3696 = 4831 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4856 [110, sizeBit input]) =
      some (PatternedScan.stS input 110 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3702 4856 [110, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_taken input 4856 110 110 (sizeBit input) []
...
private theorem run_mask_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3702 4856 [110, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_fall input 4856 110 (sizeBit input) []
...
private def gasSteps_mask_prefix (input : ByteArray) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4856 [110, sizeBit input]) :=
...
private def lengthPrefix : List Located :=
  [DirectGuard.pushAt 3703 2 1016 (by exact J2EntryWindow.get 8),
   DirectGuard.pushAt 3704 5 6308489473 (by exact J2EntryWindow.get 9),
   DirectGuard.opAt 3705 .CALLDATASIZE (by exact J2EntryWindow.get 10),
   DirectGuard.pushAt 3706 1 24 (by exact J2EntryWindow.get 11),
   DirectGuard.opAt 3707 .AND (by exact J2EntryWindow.get 12),
   DirectGuard.opAt 3708 .SHR (by exact J2EntryWindow.get 13),
   DirectGuard.opAt 3709 .AND (by exact J2EntryWindow.get 14),
   DirectGuard.opAt 3710 .CALLDATASIZE (by exact J2EntryWindow.get 15),
   DirectGuard.opAt 3711 .EQ (by exact J2EntryWindow.get 16),
   DirectGuard.pushAt 3712 1 110 (by exact J2EntryWindow.get 17)]

private def lengthJump : List Located :=
  [DirectGuard.opAt 3713 .JUMPI (by exact J2EntryWindow.get 18)]

private theorem run_length_prefix (input : ByteArray) :
    DirectGuard.run lengthPrefix (PatternedScan.stS input 4857 []) =
      some (PatternedScan.stS input 4876 [110, lengthCond input]) := by
...
private def gasSteps_length_match (input : ByteArray)
  ...
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4876 [110, lengthCond input]) =
      some (PatternedScan.stS input 110 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3713 4876 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_taken input 4876 110 110 (lengthCond input) []
...
private def gasSteps_length_fail (input : ByteArray) (hfit : CalldataFits input)
  ...
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4876 [110, lengthCond input]) =
    ...
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3713 4876 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_fall input 4876 110 (lengthCond input) []
