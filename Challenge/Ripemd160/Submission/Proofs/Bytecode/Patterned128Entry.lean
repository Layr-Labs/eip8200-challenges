...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 4025 .JUMPDEST,
   DirectGuard.pushAt 4026 0 0,
   DirectGuard.opAt 4027 .CALLDATALOAD,
   DirectGuard.pushAt 4028 0 0,
   DirectGuard.opAt 4029 .BYTE,
   DirectGuard.pushAt 4030 1 7,
   DirectGuard.opAt 4031 .XOR,
   DirectGuard.pushAt 4032 2 5180]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 4034 0 0,
   DirectGuard.pushAt 4035 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 4036 .CALLDATASIZE,
   DirectGuard.opAt 4037 .SHR,
   DirectGuard.pushAt 4038 1 1,
   DirectGuard.opAt 4039 .AND,
   DirectGuard.pushAt 4040 1 98]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 4042 .POP,
   DirectGuard.pushAt 4043 2 268,
   DirectGuard.opAt 4044 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4811 []) =
      some (PatternedScan.stS input 4822 [5180, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 4025 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4025 4811 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4811 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4026 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4026 4812 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4812 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4027 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4027 4813 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4813 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 4028 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4028 4814 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4814 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4029 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4029 4815 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4815 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4030 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4030 4816 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4816 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4031 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4031 4818 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4818 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4032 2 5180
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4032 4819 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4819 2 5180 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 4034 = 4823 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 4035 = 4824 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 4036 = 4842 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 4037 = 4843 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 4038 = 4844 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 4039 = 4846 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 4040 = 4847 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 4041 = 4849 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 4042 = 4850 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 4043 = 4851 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 4044 = 4854 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4823 []) =
      some (PatternedScan.stS input 4849 [98, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 4033 .JUMPI] (PatternedScan.stS input 4822 [5180, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4033 .JUMPI)
    (PatternedScan.pcFactS input 4033 4822 [5180, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4822 5180 5180 (byteValue input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 5180) (byteValue_true input hbyte) AbcArm.arm_dest)

private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 4033 .JUMPI] (PatternedScan.stS input 4822 [5180, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4823 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4033 .JUMPI)
    (PatternedScan.pcFactS input 4033 4822 [5180, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4822 5180 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4041 .JUMPI]
      (PatternedScan.stS input 4849 [98, sizeBit input, 0]) =
      some (PatternedScan.stS input 98 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4041 .JUMPI)
    (PatternedScan.pcFactS input 4041 4849 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4849 98 98 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4041 .JUMPI]
      (PatternedScan.stS input 4849 [98, sizeBit input, 0]) =
      some (PatternedScan.stS input 4850 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4041 .JUMPI)
    (PatternedScan.pcFactS input 4041 4849 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4849 98 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4850 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 4042 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4042 4850 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4850 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4043 2 268
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4043 4851 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4851 2 268 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4044 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4044 4854 [268] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4854 268 268 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4823 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4823 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4823 []) (PatternedScan.patternedEntry input) := by
