...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 4064 .JUMPDEST,
   DirectGuard.pushAt 4065 0 0,
   DirectGuard.opAt 4066 .CALLDATALOAD,
   DirectGuard.pushAt 4067 0 0,
   DirectGuard.opAt 4068 .BYTE,
   DirectGuard.pushAt 4069 1 7,
   DirectGuard.opAt 4070 .XOR,
   DirectGuard.pushAt 4071 2 5156]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 4073 0 0,
   DirectGuard.pushAt 4074 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 4075 .CALLDATASIZE,
   DirectGuard.opAt 4076 .SHR,
   DirectGuard.pushAt 4077 1 1,
   DirectGuard.opAt 4078 .AND,
   DirectGuard.pushAt 4079 1 98]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 4081 .POP,
   DirectGuard.pushAt 4082 2 268,
   DirectGuard.opAt 4083 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4788 []) =
      some (PatternedScan.stS input 4799 [5156, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 4064 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4064 4788 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4788 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4065 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4065 4789 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4789 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4066 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4066 4790 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4790 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 4067 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4067 4791 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4791 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4068 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4068 4792 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4792 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4069 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4069 4793 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4793 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4070 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4070 4795 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4795 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4071 2 5156
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4071 4796 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4796 2 5156 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 4073 = 4800 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 4074 = 4801 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 4075 = 4819 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 4076 = 4820 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 4077 = 4821 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 4078 = 4823 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 4079 = 4824 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 4080 = 4826 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 4081 = 4827 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 4082 = 4828 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 4083 = 4831 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4800 []) =
      some (PatternedScan.stS input 4826 [98, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 4072 .JUMPI] (PatternedScan.stS input 4799 [5156, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4072 .JUMPI)
    (PatternedScan.pcFactS input 4072 4799 [5156, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4799 5156 5156 (byteValue input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 5156) (byteValue_true input hbyte) AbcArm.arm_dest)

private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 4072 .JUMPI] (PatternedScan.stS input 4799 [5156, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4800 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4072 .JUMPI)
    (PatternedScan.pcFactS input 4072 4799 [5156, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4799 5156 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4080 .JUMPI]
      (PatternedScan.stS input 4826 [98, sizeBit input, 0]) =
      some (PatternedScan.stS input 98 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4080 .JUMPI)
    (PatternedScan.pcFactS input 4080 4826 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4826 98 98 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 4080 .JUMPI)
    (PatternedScan.pcFactS input 4080 4826 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4826 98 (sizeBit input) [0]
...
private theorem run_fallback_suffix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 4081 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4081 4827 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4827 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4082 2 268
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4082 4828 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4828 2 268 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4083 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4083 4831 [268] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4831 268 268 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
