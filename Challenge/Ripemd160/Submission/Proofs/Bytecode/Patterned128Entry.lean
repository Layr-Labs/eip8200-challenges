...
@[simp] private theorem entryPC4146 : Artifact.submissionArtifact.instructionPC 4088 = 5060 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4147 : Artifact.submissionArtifact.instructionPC 4089 = 5061 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4148 : Artifact.submissionArtifact.instructionPC 4090 = 5062 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4149 : Artifact.submissionArtifact.instructionPC 4091 = 5063 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4150 : Artifact.submissionArtifact.instructionPC 4092 = 5064 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4151 : Artifact.submissionArtifact.instructionPC 4093 = 5066 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4152 : Artifact.submissionArtifact.instructionPC 4094 = 5067 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4153 : Artifact.submissionArtifact.instructionPC 4094 = 5067 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4154 : Artifact.submissionArtifact.instructionPC 4095 = 5068 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4155 : Artifact.submissionArtifact.instructionPC 4096 = 5071 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4156 : Artifact.submissionArtifact.instructionPC 4097 = 5072 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4157 : Artifact.submissionArtifact.instructionPC 4098 = 5073 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4158 : Artifact.submissionArtifact.instructionPC 4099 = 5075 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
@[simp] private theorem entryPC4168 : Artifact.submissionArtifact.instructionPC 4083 = 5054 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4169 : Artifact.submissionArtifact.instructionPC 4084 = 5055 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4170 : Artifact.submissionArtifact.instructionPC 4085 = 5056 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4171 : Artifact.submissionArtifact.instructionPC 4086 = 5058 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4172 : Artifact.submissionArtifact.instructionPC 4087 = 5059 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4173 : Artifact.submissionArtifact.instructionPC 4087 = 5059 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4174 : Artifact.submissionArtifact.instructionPC 4087 = 5059 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4175 : Artifact.submissionArtifact.instructionPC 4087 = 5059 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4176 : Artifact.submissionArtifact.instructionPC 4087 = 5059 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4177 : Artifact.submissionArtifact.instructionPC 4087 = 5059 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4178 : Artifact.submissionArtifact.instructionPC 4087 = 5059 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private def guardSizePath : List Located :=
  [DirectGuard.opAt 4081 .JUMPDEST,
   DirectGuard.pushAt 4082 17 341611594916723379400914076344069914624,
   DirectGuard.opAt 4083 .CALLDATASIZE,
   DirectGuard.opAt 4084 .SHR,
   DirectGuard.pushAt 4085 1 1,
   DirectGuard.opAt 4086 .AND,
   DirectGuard.opAt 4087 .ISZERO]

private def guardBytePrefix : List Located :=
  [DirectGuard.pushAt 4088 0 0,
   DirectGuard.opAt 4089 .CALLDATALOAD,
   DirectGuard.pushAt 4090 0 0,
   DirectGuard.opAt 4091 .BYTE,
   DirectGuard.pushAt 4092 1 7,
   DirectGuard.opAt 4093 .XOR,
   DirectGuard.opAt 4094 .OR,
   DirectGuard.pushAt 4095 2 360]

private def guardBytePath : List Located := guardBytePrefix ++ [DirectGuard.opAt 4096 .JUMPI]
...
private def guardMatchSuffix : List Located :=
  [DirectGuard.pushAt 4097 0 0,
   DirectGuard.pushAt 4098 1 98,
   DirectGuard.opAt 4099 .JUMP]
...
private def byteEntry (input : ByteArray) (flag : UInt256) : State :=
  PatternedScan.stS input 5060 [flag]
private def byteDone (input : ByteArray) : State := PatternedScan.stS input 5072 []
...
private theorem run_guard_size (input : ByteArray) :
  ...
  let l1 : Located := DirectGuard.pushAt 4082 17 341611594916723379400914076344069914624
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4082 5036 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5036 17 341611594916723379400914076344069914624 [] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := DirectGuard.opAt 4083 .CALLDATASIZE
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4083 5054 [m] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldatasize input 5054 [m] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.opAt 4084 .SHR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4084 5055 [x, m] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shr input 5055 x m [] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.pushAt 4085 1 1
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4085 5056 [shifted] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5056 1 1 [shifted] (by simp) (by decide) (by decide) (by norm_num))
  let l7 : Located := DirectGuard.opAt 4086 .AND
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4086 5058 [1, shifted] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_and input 5058 1 shifted [] (by simp) (by norm_num))
  let l8 : Located := DirectGuard.opAt 4087 .ISZERO
  have h8 := PatternedScan.blockOfS l8
    (PatternedScan.pcFactS input 4087 5059 [bit] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_iszero input 5059 bit [] (by simp) (by norm_num))
...
private theorem run_guard_byte_prefix (input : ByteArray) (flag : UInt256) :
    DirectGuard.run guardBytePrefix (byteEntry input flag) =
      some (PatternedScan.stS input 5071 [360, byteFlag input flag]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let z := UInt256.xor 7 b
  let f := UInt256.lor z flag
  let l0 : Located := DirectGuard.pushAt 4088 0 0
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4088 5060 [flag] (by norm_num) entryPC4146)
    (PatternedScan.stepS_push0 input 5060 [flag] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.opAt 4089 .CALLDATALOAD
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4089 5061 [0, flag] (by norm_num) entryPC4147)
    (PatternedScan.stepS_calldataload input 5061 0 [flag] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 4090 0 0
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4090 5062 [w, flag] (by norm_num) entryPC4148)
    (PatternedScan.stepS_push0 input 5062 [w, flag] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.opAt 4091 .BYTE
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4091 5063 [0, w, flag] (by norm_num) entryPC4149)
    (PatternedScan.stepS_byte input 5063 0 w [flag] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.pushAt 4092 1 7
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4092 5064 [b, flag] (by norm_num) entryPC4150)
    (PatternedScan.stepS_push input 5064 1 7 [b, flag] (by simp) (by decide) (by decide) (by norm_num))
  let l5 : Located := DirectGuard.opAt 4093 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4093 5066 [7, b, flag] (by norm_num) entryPC4151)
    (PatternedScan.stepS_xor input 5066 7 b [flag] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4094 .OR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4094 5067 [z, flag] (by norm_num) entryPC4152)
    (PatternedScan.stepS_or input 5067 z flag [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4095 2 360
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4095 5068 [f] (by norm_num) entryPC4154)
    (PatternedScan.stepS_push input 5068 2 360 [f] (by simp) (by decide) (by decide) (by norm_num))
...
private theorem run_guard_byte_fail (input : ByteArray) (flag : UInt256)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4096 .JUMPI)
    (PatternedScan.pcFactS input 4096 5071 [360, byteFlag input flag] (by norm_num) entryPC4155)
    (PatternedScan.stepS_jumpi_taken input 5071 360 360 (byteFlag input flag) []
  ...
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4096 .JUMPI] _ _ _ (run_guard_byte_prefix input flag) rfl hj
...
private theorem run_guard_byte_match (input : ByteArray)
  ...
  have hprefix : DirectGuard.run guardBytePrefix (byteEntry input (UInt256.ofNat 0)) =
      some (PatternedScan.stS input 5071 [360, UInt256.ofNat 0]) := by
    simpa only [hf] using run_guard_byte_prefix input (UInt256.ofNat 0)
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4096 .JUMPI)
    (PatternedScan.pcFactS input 4096 5071 [360, UInt256.ofNat 0] (by norm_num) entryPC4155)
    (PatternedScan.stepS_jumpi_fall input 5071 360 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))
  have h0 := PatternedScan.blockOfS (DirectGuard.pushAt 4097 0 0)
    (PatternedScan.pcFactS input 4097 5072 [] (by norm_num) entryPC4156)
    (PatternedScan.stepS_push0 input 5072 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4098 1 98)
    (PatternedScan.pcFactS input 4098 5073 [0] (by norm_num) entryPC4157)
    (PatternedScan.stepS_push input 5073 1 98 [0] (by simp) (by decide) (by decide) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4099 .JUMP)
    (PatternedScan.pcFactS input 4099 5075 [98, 0] (by norm_num) entryPC4158)
    (PatternedScan.stepS_jump input 5075 98 98 [0] (by simp) (by norm_num)
  ...
  have hpj := Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4096 .JUMPI] _ _ _ hprefix rfl hj
  have h01 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4097 0 0] [DirectGuard.pushAt 4098 1 98] _ _ _ h0 rfl h1
  have hs := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4097 0 0, DirectGuard.pushAt 4098 1 98]
    [DirectGuard.opAt 4099 .JUMP] _ _ _ h01 rfl h2
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
