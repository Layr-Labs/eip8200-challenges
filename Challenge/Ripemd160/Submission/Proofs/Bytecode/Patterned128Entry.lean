...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3849 .JUMPDEST (by exact GuardInstructionWindow.get 181),
   DirectGuard.pushAt 3850 0 0 (by exact GuardInstructionWindow.get 182),
   DirectGuard.opAt 3851 .CALLDATALOAD (by exact GuardInstructionWindow.get 183),
   DirectGuard.pushAt 3852 0 0 (by exact GuardInstructionWindow.get 184),
   DirectGuard.opAt 3853 .BYTE (by exact GuardInstructionWindow.get 185),
   DirectGuard.pushAt 3854 1 7 (by exact GuardInstructionWindow.get 186),
   DirectGuard.opAt 3855 .XOR (by exact GuardInstructionWindow.get 187),
   DirectGuard.pushAt 3856 2 5178 (by exact GuardInstructionWindow.get 188)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3858 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 190),
   DirectGuard.opAt 3859 .CALLDATASIZE (by exact GuardInstructionWindow.get 191),
   DirectGuard.opAt 3860 .SHR (by exact GuardInstructionWindow.get 192),
   DirectGuard.pushAt 3861 1 1 (by exact GuardInstructionWindow.get 193),
   DirectGuard.opAt 3862 .AND (by exact GuardInstructionWindow.get 194),
   DirectGuard.pushAt 3863 1 107 (by exact GuardInstructionWindow.get 195)]

private def fallbackSuffix : List Located :=
  [DirectGuard.pushAt 3865 2 351 (by exact GuardInstructionWindow.get 197),
   DirectGuard.opAt 3866 .JUMP (by exact GuardInstructionWindow.get 198)]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4842 []) =
      some (PatternedScan.stS input 4853 [5178, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3849 .JUMPDEST (by exact GuardInstructionWindow.get 181)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3849 4842 [] (by norm_num) (GuardInstructionWindow.pc 181))
    (PatternedScan.stepS_jumpdest input 4842 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3850 0 0 (by exact GuardInstructionWindow.get 182)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3850 4843 [] (by norm_num) (GuardInstructionWindow.pc 182))
    (PatternedScan.stepS_push0 input 4843 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3851 .CALLDATALOAD (by exact GuardInstructionWindow.get 183)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3851 4844 [0] (by norm_num) (GuardInstructionWindow.pc 183))
    (PatternedScan.stepS_calldataload input 4844 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3852 0 0 (by exact GuardInstructionWindow.get 184)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3852 4845 [w] (by norm_num) (GuardInstructionWindow.pc 184))
    (PatternedScan.stepS_push0 input 4845 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3853 .BYTE (by exact GuardInstructionWindow.get 185)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3853 4846 [0, w] (by norm_num) (GuardInstructionWindow.pc 185))
    (PatternedScan.stepS_byte input 4846 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3854 1 7 (by exact GuardInstructionWindow.get 186)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3854 4847 [b] (by norm_num) (GuardInstructionWindow.pc 186))
    (PatternedScan.stepS_push input 4847 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3855 .XOR (by exact GuardInstructionWindow.get 187)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3855 4849 [7, b] (by norm_num) (GuardInstructionWindow.pc 187))
    (PatternedScan.stepS_xor input 4849 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3856 2 5178 (by exact GuardInstructionWindow.get 188)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3856 4850 [v] (by norm_num) (GuardInstructionWindow.pc 188))
    (PatternedScan.stepS_push input 4850 2 5178 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3858 = 4854 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3858 = 4854 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3859 = 4872 := by
  exact GuardInstructionWindow.pc 191

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3860 = 4873 := by
  exact GuardInstructionWindow.pc 192

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3861 = 4874 := by
  exact GuardInstructionWindow.pc 193

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3862 = 4876 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3863 = 4877 := by
  exact GuardInstructionWindow.pc 195

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3864 = 4879 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3865 = 4880 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3865 = 4880 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3866 = 4883 := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3857 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 4853 [5178, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3857 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3857 4853 [5178, byteValue input] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_taken input 4853 5178 5178 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3857 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 4853 [5178, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4854 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3857 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3857 4853 [5178, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_fall input 4853 5178 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3864 .JUMPI (by exact GuardInstructionWindow.get 196)]
      (PatternedScan.stS input 4879 [107, sizeBit input]) =
      some (PatternedScan.stS input 107 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3864 .JUMPI (by exact GuardInstructionWindow.get 196))
    (PatternedScan.pcFactS input 3864 4879 [107, sizeBit input] (by norm_num) sizeHitPC4111)
...
private theorem run_fallback_suffix (input : ByteArray) :
  ...
  let l1 : Located := DirectGuard.pushAt 3865 2 351 (by exact GuardInstructionWindow.get 197)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3865 4880 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4880 2 351 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3866 .JUMP (by exact GuardInstructionWindow.get 198)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3866 4883 [351] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4883 351 351 [] (by simp) (by norm_num) rfl guard_fallback_dest)
