...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 4048 .JUMPDEST,
   DirectGuard.pushAt 4049 0 0,
   DirectGuard.opAt 4050 .CALLDATALOAD,
   DirectGuard.pushAt 4051 0 0,
   DirectGuard.opAt 4052 .BYTE,
   DirectGuard.pushAt 4053 1 7,
   DirectGuard.opAt 4054 .XOR,
   DirectGuard.pushAt 4055 2 5162]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 4057 0 0,
   DirectGuard.pushAt 4058 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 4059 .CALLDATASIZE,
   DirectGuard.opAt 4060 .SHR,
   DirectGuard.pushAt 4061 1 1,
   DirectGuard.opAt 4062 .AND,
   DirectGuard.pushAt 4063 1 106]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 4065 .POP,
   DirectGuard.pushAt 4066 2 276,
   DirectGuard.opAt 4067 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4794 []) =
      some (PatternedScan.stS input 4805 [5162, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 4048 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4048 4794 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4794 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4049 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4049 4795 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4795 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4050 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4050 4796 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4796 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 4051 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4051 4797 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4797 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4052 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4052 4798 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4798 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4053 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4053 4799 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4799 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4054 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4054 4801 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4801 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4055 2 5162
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4055 4802 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4802 2 5162 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 4057 = 4806 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 4058 = 4807 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 4059 = 4825 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 4060 = 4826 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 4061 = 4827 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 4062 = 4829 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 4063 = 4830 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 4064 = 4832 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 4065 = 4833 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 4066 = 4834 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 4067 = 4837 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4806 []) =
      some (PatternedScan.stS input 4832 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 4056 .JUMPI] (PatternedScan.stS input 4805 [5162, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4056 .JUMPI)
    (PatternedScan.pcFactS input 4056 4805 [5162, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4805 5162 5162 (byteValue input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 5162) (byteValue_true input hbyte) AbcArm.arm_dest)

private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 4056 .JUMPI] (PatternedScan.stS input 4805 [5162, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4806 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4056 .JUMPI)
    (PatternedScan.pcFactS input 4056 4805 [5162, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4805 5162 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4064 .JUMPI]
      (PatternedScan.stS input 4832 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4064 .JUMPI)
    (PatternedScan.pcFactS input 4064 4832 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4832 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4064 .JUMPI]
      (PatternedScan.stS input 4832 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4833 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4064 .JUMPI)
    (PatternedScan.pcFactS input 4064 4832 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4832 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4833 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 4065 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4065 4833 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4833 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4066 2 276
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4066 4834 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4834 2 276 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4067 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4067 4837 [276] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4837 276 276 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4806 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4806 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4806 []) (PatternedScan.patternedEntry input) := by
...
def gasSteps_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    (hne27 : input ≠ Gen27InputData.gen27Input)
  ...
  · exact (gasSteps_byte_fail input hbyte).trans (AbcArm.gasSteps_miss input hfit hnabc hne27)
...
def gasSteps_miss (input : ByteArray) (hfit : CalldataFits input)
  ...
  exact (Execution.gasSteps_start input).trans
    ((sound (DirectGuard.sizeDispatchPath input)
        (DirectGuard.run_size_fail input hfit h1000 h376 h256)).trans
      (gasSteps_fail input hfit hnabc hne27 hbad))
...
(3 is not 256, 376 or 1000) and the byte-0 gate misses (0x91 ≠ 7), so the
byte-0 `JUMPI` lands on the `abc` arm, whose word test then forwards to the
appended arm (pc 5211). -/
def gasSteps_gen27_entry (input : ByteArray) (hfit : CalldataFits input)
  ...
  have hbyte : DirectGuard.firstByte input ≠ 7 := by
    intro h7
    have h := firstByte_eq_byteAt input
    rw [heq, Gen27Recognition.readWord_gen27Input] at h
    rw [heq] at h7
    rw [h7] at h
    revert h; decide
  exact (Execution.gasSteps_start input).trans
    ((sound (DirectGuard.sizeDispatchPath input)
      ...
      ((gasSteps_byte_fail input hbyte).trans
        (AbcArm.gasSteps_word_miss input hfit heq)))
