...
@[simp] private theorem entryPC62 : Artifact.submissionArtifact.instructionPC 66 = 108 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private theorem guard_fallback_dest : Decode.isValidJumpDest submissionBytecode 497 = true :=
  Artifact.submissionArtifact.isValidJumpDest_index 227 (by rfl)
...
private def guardJumpState (input : ByteArray) : State :=
  { DirectGuard.guardEntry input with pc := UInt256.ofNat 107, stack := [] }

private def bytePrefix : List Located :=
  [DirectGuard.opAt 3833 .JUMPDEST (by exact GuardInstructionWindow.get 181),
   DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 182),
   DirectGuard.opAt 3835 .CALLDATALOAD (by exact GuardInstructionWindow.get 183),
   DirectGuard.pushAt 3836 0 0 (by exact GuardInstructionWindow.get 184),
   DirectGuard.opAt 3837 .BYTE (by exact GuardInstructionWindow.get 185),
   DirectGuard.pushAt 3838 1 7 (by exact GuardInstructionWindow.get 186),
   DirectGuard.opAt 3839 .XOR (by exact GuardInstructionWindow.get 187),
   DirectGuard.pushAt 3840 2 5380 (by exact GuardInstructionWindow.get 188)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3842 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 190),
   DirectGuard.opAt 3843 .CALLDATASIZE (by exact GuardInstructionWindow.get 191),
   DirectGuard.opAt 3844 .SHR (by exact GuardInstructionWindow.get 192),
   DirectGuard.pushAt 3845 1 1 (by exact GuardInstructionWindow.get 193),
   DirectGuard.opAt 3846 .AND (by exact GuardInstructionWindow.get 194),
   DirectGuard.pushAt 3847 1 107 (by exact GuardInstructionWindow.get 195)]

private def fallbackSuffix : List Located :=
  [DirectGuard.pushAt 3849 2 497 (by exact GuardInstructionWindow.get 197),
   DirectGuard.opAt 3850 .JUMP (by exact GuardInstructionWindow.get 198)]

private def guardMatchTail : List Located :=
  [DirectGuard.opAt 65 .JUMPDEST]

private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 5044 []) =
      some (PatternedScan.stS input 5055 [5380, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3833 .JUMPDEST (by exact GuardInstructionWindow.get 181)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3833 5044 [] (by norm_num) (GuardInstructionWindow.pc 181))
    (PatternedScan.stepS_jumpdest input 5044 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 182)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3834 5045 [] (by norm_num) (GuardInstructionWindow.pc 182))
    (PatternedScan.stepS_push0 input 5045 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3835 .CALLDATALOAD (by exact GuardInstructionWindow.get 183)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3835 5046 [0] (by norm_num) (GuardInstructionWindow.pc 183))
    (PatternedScan.stepS_calldataload input 5046 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3836 0 0 (by exact GuardInstructionWindow.get 184)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3836 5047 [w] (by norm_num) (GuardInstructionWindow.pc 184))
    (PatternedScan.stepS_push0 input 5047 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3837 .BYTE (by exact GuardInstructionWindow.get 185)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3837 5048 [0, w] (by norm_num) (GuardInstructionWindow.pc 185))
    (PatternedScan.stepS_byte input 5048 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3838 1 7 (by exact GuardInstructionWindow.get 186)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3838 5049 [b] (by norm_num) (GuardInstructionWindow.pc 186))
    (PatternedScan.stepS_push input 5049 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3839 .XOR (by exact GuardInstructionWindow.get 187)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3839 5051 [7, b] (by norm_num) (GuardInstructionWindow.pc 187))
    (PatternedScan.stepS_xor input 5051 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3840 2 5380 (by exact GuardInstructionWindow.get 188)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3840 5052 [v] (by norm_num) (GuardInstructionWindow.pc 188))
    (PatternedScan.stepS_push input 5052 2 5380 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3842 = 5056 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3842 = 5056 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3843 = 5074 := by
  exact GuardInstructionWindow.pc 191

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3844 = 5075 := by
  exact GuardInstructionWindow.pc 192

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3845 = 5076 := by
  exact GuardInstructionWindow.pc 193

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3846 = 5078 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3847 = 5079 := by
  exact GuardInstructionWindow.pc 195

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3848 = 5081 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3849 = 5082 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3849 = 5082 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3850 = 5085 := by
  exact GuardInstructionWindow.pc 198
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 5056 []) =
      some (PatternedScan.stS input 5081 [107, sizeBit input]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 5055 [5380, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3841 5055 [5380, byteValue input] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_taken input 5055 5380 5380 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 5055 [5380, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 5056 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3841 5055 [5380, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_fall input 5055 5380 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3848 .JUMPI (by exact GuardInstructionWindow.get 196)]
      (PatternedScan.stS input 5081 [107, sizeBit input]) =
      some (PatternedScan.stS input 107 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3848 .JUMPI (by exact GuardInstructionWindow.get 196))
    (PatternedScan.pcFactS input 3848 5081 [107, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 5081 107 107 (sizeBit input) []
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3848 .JUMPI (by exact GuardInstructionWindow.get 196)]
      (PatternedScan.stS input 5081 [107, sizeBit input]) =
      some (PatternedScan.stS input 5082 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3848 .JUMPI (by exact GuardInstructionWindow.get 196))
    (PatternedScan.pcFactS input 3848 5081 [107, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 5081 107 (sizeBit input) []
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 5082 []) =
      some (DirectGuard.fallbackState input) := by
  let l1 : Located := DirectGuard.pushAt 3849 2 497 (by exact GuardInstructionWindow.get 197)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3849 5082 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 5082 2 497 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3850 .JUMP (by exact GuardInstructionWindow.get 198)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3850 5085 [497] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 5085 497 497 [] (by simp) (by norm_num) rfl guard_fallback_dest)
  exact Stepper.runLocatedBlock_append [l1] [l2] _ _ _ h1 rfl h2
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 5056 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 5056 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 5056 []) (PatternedScan.patternedEntry input) := by
...
and the byte-0 gate misses ('a' = 0x61 ≠ 7), so the byte-0 `JUMPI` lands on the arm (pc 5369). -/
