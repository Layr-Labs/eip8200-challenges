...
@[simp] private theorem entryPC61 : Artifact.submissionArtifact.instructionPC 67 = 111 := by
...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3681 = 4831 := J2EntryWindow.pc 0
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3682 = 4832 := J2EntryWindow.pc 1
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3688 = 4857 := J2EntryWindow.pc 7
private theorem packedPC3735 : Artifact.submissionArtifact.instructionPC 3689 = 4858 := J2EntryWindow.pc 8
private theorem packedPC3736 : Artifact.submissionArtifact.instructionPC 3690 = 4861 := J2EntryWindow.pc 9
private theorem packedPC3737 : Artifact.submissionArtifact.instructionPC 3691 = 4867 := J2EntryWindow.pc 10
private theorem packedPC3738 : Artifact.submissionArtifact.instructionPC 3692 = 4868 := J2EntryWindow.pc 11
private theorem packedPC3739 : Artifact.submissionArtifact.instructionPC 3693 = 4870 := J2EntryWindow.pc 12
private theorem packedPC3740 : Artifact.submissionArtifact.instructionPC 3694 = 4871 := J2EntryWindow.pc 13
private theorem packedPC3741 : Artifact.submissionArtifact.instructionPC 3695 = 4872 := J2EntryWindow.pc 14
private theorem packedPC3742 : Artifact.submissionArtifact.instructionPC 3696 = 4873 := J2EntryWindow.pc 15
private theorem packedPC3743 : Artifact.submissionArtifact.instructionPC 3697 = 4874 := J2EntryWindow.pc 16
private theorem packedPC3744 : Artifact.submissionArtifact.instructionPC 3698 = 4875 := J2EntryWindow.pc 17
private theorem packedPC3745 : Artifact.submissionArtifact.instructionPC 3699 = 4877 := J2EntryWindow.pc 18

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3683 = 4834 :=
  J2EntryWindow.pc 2
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3684 = 4852 :=
  J2EntryWindow.pc 3
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3685 = 4853 :=
  J2EntryWindow.pc 4
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3686 = 4854 :=
  J2EntryWindow.pc 5
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3687 = 4855 :=
  J2EntryWindow.pc 6

/-! ## The size mask -/

private def maskEntry : List Located :=
  [DirectGuard.opAt 3681 .JUMPDEST (by exact J2EntryWindow.get 0)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3682 1 1 (by exact J2EntryWindow.get 1),
   DirectGuard.pushAt 3683 17 342276208914615837337402008677671501826 (by exact J2EntryWindow.get 2),
   DirectGuard.opAt 3684 .CALLDATASIZE (by exact J2EntryWindow.get 3),
   DirectGuard.opAt 3685 .SHR (by exact J2EntryWindow.get 4),
   DirectGuard.opAt 3686 .AND (by exact J2EntryWindow.get 5),
   DirectGuard.pushAt 3687 1 111 (by exact J2EntryWindow.get 6)]

private def maskJump : List Located :=
  [DirectGuard.opAt 3688 .JUMPI (by exact J2EntryWindow.get 7)]
...
private theorem run_mask_entry (input : ByteArray) :
    DirectGuard.run maskEntry (PatternedScan.stS input 4831 []) =
      some (PatternedScan.stS input 4832 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3681 4831 [] (by norm_num) pc3836)
    (PatternedScan.stepS_jumpdest input 4831 [] (by simp) (by norm_num))

private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4832 []) =
      some (PatternedScan.stS input 4857 [111, sizeBit input]) := by
  have hpc : Artifact.submissionArtifact.instructionPC 3682 = 4832 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4857 [111, sizeBit input]) =
      some (PatternedScan.stS input 111 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3688 4857 [111, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_taken input 4857 111 111 (sizeBit input) []
...
private theorem run_mask_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4857 [111, sizeBit input]) =
      some (PatternedScan.stS input 4858 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3688 4857 [111, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_fall input 4857 111 (sizeBit input) []
...
private def gasSteps_mask_prefix (input : ByteArray) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4857 [111, sizeBit input]) :=
...
private def gasSteps_mask_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4858 []) := by
...
private def lengthPrefix : List Located :=
  [DirectGuard.pushAt 3689 2 1016 (by exact J2EntryWindow.get 8),
   DirectGuard.pushAt 3690 5 6308489473 (by exact J2EntryWindow.get 9),
   DirectGuard.opAt 3691 .CALLDATASIZE (by exact J2EntryWindow.get 10),
   DirectGuard.pushAt 3692 1 24 (by exact J2EntryWindow.get 11),
   DirectGuard.opAt 3693 .AND (by exact J2EntryWindow.get 12),
   DirectGuard.opAt 3694 .SHR (by exact J2EntryWindow.get 13),
   DirectGuard.opAt 3695 .AND (by exact J2EntryWindow.get 14),
   DirectGuard.opAt 3696 .CALLDATASIZE (by exact J2EntryWindow.get 15),
   DirectGuard.opAt 3697 .EQ (by exact J2EntryWindow.get 16),
   DirectGuard.pushAt 3698 1 111 (by exact J2EntryWindow.get 17)]

private def lengthJump : List Located :=
  [DirectGuard.opAt 3699 .JUMPI (by exact J2EntryWindow.get 18)]

private theorem run_length_prefix (input : ByteArray) :
    DirectGuard.run lengthPrefix (PatternedScan.stS input 4858 []) =
      some (PatternedScan.stS input 4877 [111, lengthCond input]) := by
...
private def gasSteps_length_match (input : ByteArray)
    ...
    GasSteps (PatternedScan.stS input 4858 []) (PatternedScan.patternedEntry input) := by
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4877 [111, lengthCond input]) =
      some (PatternedScan.stS input 111 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3699 4877 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_taken input 4877 111 111 (lengthCond input) []
...
private def gasSteps_length_fail (input : ByteArray) (hfit : CalldataFits input)
    (h256 : input.size ≠ 256) (h376 : input.size ≠ 376) (h1000 : input.size ≠ 1000) :
    GasSteps (PatternedScan.stS input 4858 []) (AbcArm.armEntry input) := by
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4877 [111, lengthCond input]) =
      some (AbcArm.armEntry input) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3699 4877 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_fall input 4877 111 (lengthCond input) []
