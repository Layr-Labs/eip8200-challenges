...
/- The failure path stops at JUMPI.  It must not include the success suffix:
   ...
   fail the PC check. -/
@[simp] private theorem entryPC61 : Artifact.submissionArtifact.instructionPC 60 = 101 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC62 : Artifact.submissionArtifact.instructionPC 61 = 102 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4142 : Artifact.submissionArtifact.instructionPC 4137 = 5128 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4143 : Artifact.submissionArtifact.instructionPC 4138 = 5129 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4144 : Artifact.submissionArtifact.instructionPC 4139 = 5132 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4145 : Artifact.submissionArtifact.instructionPC 4140 = 5133 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4146 : Artifact.submissionArtifact.instructionPC 4141 = 5134 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4147 : Artifact.submissionArtifact.instructionPC 4142 = 5135 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4148 : Artifact.submissionArtifact.instructionPC 4143 = 5136 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4149 : Artifact.submissionArtifact.instructionPC 4144 = 5137 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4150 : Artifact.submissionArtifact.instructionPC 4145 = 5138 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4151 : Artifact.submissionArtifact.instructionPC 4146 = 5140 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4152 : Artifact.submissionArtifact.instructionPC 4147 = 5141 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4153 : Artifact.submissionArtifact.instructionPC 4148 = 5142 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4154 : Artifact.submissionArtifact.instructionPC 4149 = 5143 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4155 : Artifact.submissionArtifact.instructionPC 4150 = 5146 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4156 : Artifact.submissionArtifact.instructionPC 4151 = 5147 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4157 : Artifact.submissionArtifact.instructionPC 4152 = 5148 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4158 : Artifact.submissionArtifact.instructionPC 4153 = 5150 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4166 : Artifact.submissionArtifact.instructionPC 4161 = 5178 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4167 : Artifact.submissionArtifact.instructionPC 4162 = 5179 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4168 : Artifact.submissionArtifact.instructionPC 4163 = 5180 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4169 : Artifact.submissionArtifact.instructionPC 4164 = 5182 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4170 : Artifact.submissionArtifact.instructionPC 4165 = 5183 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4171 : Artifact.submissionArtifact.instructionPC 4166 = 5184 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4172 : Artifact.submissionArtifact.instructionPC 4167 = 5186 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4173 : Artifact.submissionArtifact.instructionPC 4168 = 5187 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4174 : Artifact.submissionArtifact.instructionPC 4169 = 5188 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4175 : Artifact.submissionArtifact.instructionPC 4170 = 5189 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4176 : Artifact.submissionArtifact.instructionPC 4171 = 5191 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4177 : Artifact.submissionArtifact.instructionPC 4172 = 5192 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4178 : Artifact.submissionArtifact.instructionPC 4173 = 5193 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4179 : Artifact.submissionArtifact.instructionPC 4174 = 5194 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4180 : Artifact.submissionArtifact.instructionPC 4175 = 5197 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private def guardJumpPath : List Located :=
  [DirectGuard.opAt 4137 .JUMPDEST,
   DirectGuard.pushAt 4138 2 5178,
   DirectGuard.opAt 4139 .JUMP]

private def guardSizePath : List Located :=
  [DirectGuard.opAt 4161 .JUMPDEST,
   DirectGuard.opAt 4162 .CALLDATASIZE,
   DirectGuard.pushAt 4163 1 56,
   DirectGuard.opAt 4164 .EQ,
   DirectGuard.opAt 4165 .CALLDATASIZE,
   DirectGuard.pushAt 4166 1 120,
   DirectGuard.opAt 4167 .EQ,
   DirectGuard.opAt 4168 .OR,
   DirectGuard.opAt 4169 .CALLDATASIZE,
   DirectGuard.pushAt 4170 1 128,
   DirectGuard.opAt 4171 .EQ,
   DirectGuard.opAt 4172 .OR,
   DirectGuard.opAt 4173 .ISZERO,
   DirectGuard.pushAt 4174 2 5133,
   DirectGuard.opAt 4175 .JUMP]

private def guardBytePrefix : List Located :=
  [DirectGuard.opAt 4140 .JUMPDEST,
   DirectGuard.pushAt 4141 0 0,
   DirectGuard.opAt 4142 .CALLDATALOAD,
   DirectGuard.pushAt 4143 0 0,
   DirectGuard.opAt 4144 .BYTE,
   DirectGuard.pushAt 4145 1 7,
   DirectGuard.opAt 4146 .EQ,
   DirectGuard.opAt 4147 .ISZERO,
   DirectGuard.opAt 4148 .OR,
   DirectGuard.pushAt 4149 2 368]

private def guardBytePath : List Located := guardBytePrefix ++ [DirectGuard.opAt 4150 .JUMPI]
...
private def guardMatchSuffix : List Located :=
  [DirectGuard.pushAt 4151 0 0,
   DirectGuard.pushAt 4152 1 101,
   DirectGuard.opAt 4153 .JUMP]

private def guardMatchTail : List Located :=
  [DirectGuard.opAt 60 .JUMPDEST, DirectGuard.opAt 61 .POP]
...
private theorem guard_size_dest :
  ...
  Artifact.submissionArtifact.isValidJumpDest_index 4161 (by rfl)

private theorem guard_byte_dest :
    Decode.isValidJumpDest submissionBytecode 5133 = true :=
  Artifact.submissionArtifact.isValidJumpDest_index 4140 (by rfl)
...
private theorem run_guard_jump (input : ByteArray) :
  ...
  have h0 := PatternedScan.blockOfS (DirectGuard.opAt 4137 .JUMPDEST)
    (PatternedScan.pcFactS input 4137 5128 [] (by norm_num) entryPC4142)
    (PatternedScan.stepS_jumpdest input 5128 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4138 2 5178)
    (PatternedScan.pcFactS input 4138 5129 [] (by norm_num) entryPC4143)
    (PatternedScan.stepS_push input 5129 2 5178 [] (by simp) (by decide) (by decide) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4139 .JUMP)
    (PatternedScan.pcFactS input 4139 5132 [5178] (by norm_num) entryPC4144)
    (PatternedScan.stepS_jump input 5132 5178 5178 [] (by simp) (by norm_num)
      (by simpa using Challenge.EvmProof.Word.literal_eq_ofNat 5178) guard_size_dest)
  have h01 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4137 .JUMPDEST] [DirectGuard.pushAt 4138 2 5178] _ _ _ h0 rfl h1
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4137 .JUMPDEST, DirectGuard.pushAt 4138 2 5178]
    [DirectGuard.opAt 4139 .JUMP] _ _ _ h01 rfl h2
...
private theorem run_guard_size (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 4161 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4161 5178 [] (by norm_num) entryPC4166)
    (PatternedScan.stepS_jumpdest input 5178 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.opAt 4162 .CALLDATASIZE
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4162 5179 [] (by norm_num) entryPC4167)
    (PatternedScan.stepS_calldatasize input 5179 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 4163 1 56
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4163 5180 [(UInt256.ofNat input.size)] (by norm_num) entryPC4168)
  ...
  let l3 : Located := DirectGuard.opAt 4164 .EQ
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4164 5182 [(56 : UInt256), (UInt256.ofNat input.size)] (by norm_num) entryPC4169)
    (PatternedScan.stepS_eq input 5182 (56 : UInt256) (UInt256.ofNat input.size) [] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4165 .CALLDATASIZE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4165 5183 [v3] (by norm_num) entryPC4170)
    (PatternedScan.stepS_calldatasize input 5183 [v3] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4166 1 120
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4166 5184 [(UInt256.ofNat input.size), v3] (by norm_num) entryPC4171)
  ...
  let l6 : Located := DirectGuard.opAt 4167 .EQ
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4167 5186 [(120 : UInt256), (UInt256.ofNat input.size), v3] (by norm_num) entryPC4172)
  ...
  let l7 : Located := DirectGuard.opAt 4168 .OR
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4168 5187 [v6, v3] (by norm_num) entryPC4173)
    (PatternedScan.stepS_or input 5187 v6 v3 [] (by simp) (by norm_num))
  let l8 : Located := DirectGuard.opAt 4169 .CALLDATASIZE
  have h8 := PatternedScan.blockOfS l8
    (PatternedScan.pcFactS input 4169 5188 [v7] (by norm_num) entryPC4174)
    (PatternedScan.stepS_calldatasize input 5188 [v7] (by simp) (by norm_num))
  let l9 : Located := DirectGuard.pushAt 4170 1 128
  have h9 := PatternedScan.blockOfS l9
    (PatternedScan.pcFactS input 4170 5189 [(UInt256.ofNat input.size), v7] (by norm_num) entryPC4175)
  ...
  let l10 : Located := DirectGuard.opAt 4171 .EQ
  have h10 := PatternedScan.blockOfS l10
    (PatternedScan.pcFactS input 4171 5191 [(128 : UInt256), (UInt256.ofNat input.size), v7] (by norm_num) entryPC4176)
  ...
  let l11 : Located := DirectGuard.opAt 4172 .OR
  have h11 := PatternedScan.blockOfS l11
    (PatternedScan.pcFactS input 4172 5192 [v10, v7] (by norm_num) entryPC4177)
    (PatternedScan.stepS_or input 5192 v10 v7 [] (by simp) (by norm_num))
  let v12 : UInt256 := UInt256.isZero v11
  let l12 : Located := DirectGuard.opAt 4173 .ISZERO
  have h12 := PatternedScan.blockOfS l12
    (PatternedScan.pcFactS input 4173 5193 [v11] (by norm_num) entryPC4178)
    (PatternedScan.stepS_iszero input 5193 v11 [] (by simp) (by norm_num))
  let l13 : Located := DirectGuard.pushAt 4174 2 5133
  have h13 := PatternedScan.blockOfS l13
    (PatternedScan.pcFactS input 4174 5194 [v12] (by norm_num) entryPC4179)
    (PatternedScan.stepS_push input 5194 2 5133 [v12] (by simp) (by decide) (by decide) (by norm_num))
  let l14 : Located := DirectGuard.opAt 4175 .JUMP
  have h14 := PatternedScan.blockOfS l14
    (PatternedScan.pcFactS input 4175 5197 [(5133 : UInt256), v12] (by norm_num) entryPC4180)
...
private theorem run_guard_byte_prefix (input : ByteArray) (flag : UInt256) :
  ...
  have h0 := PatternedScan.blockOfS (DirectGuard.opAt 4140 .JUMPDEST)
    (PatternedScan.pcFactS input 4140 5133 [flag] (by norm_num) entryPC4145)
    (PatternedScan.stepS_jumpdest input 5133 [flag] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4141 0 0)
    (PatternedScan.pcFactS input 4141 5134 [flag] (by norm_num) entryPC4146)
    (PatternedScan.stepS_push0 input 5134 [flag] (by simp) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4142 .CALLDATALOAD)
    (PatternedScan.pcFactS input 4142 5135 [0, flag] (by norm_num) entryPC4147)
    (PatternedScan.stepS_calldataload input 5135 0 [flag] (by simp) (by norm_num))
  have h3 := PatternedScan.blockOfS (DirectGuard.pushAt 4143 0 0)
    (PatternedScan.pcFactS input 4143 5136 [w, flag] (by norm_num) entryPC4148)
    (PatternedScan.stepS_push0 input 5136 [w, flag] (by simp) (by norm_num))
  have h4 := PatternedScan.blockOfS (DirectGuard.opAt 4144 .BYTE)
    (PatternedScan.pcFactS input 4144 5137 [0, w, flag] (by norm_num) entryPC4149)
    (PatternedScan.stepS_byte input 5137 0 w [flag] (by simp) (by norm_num))
  have h5 := PatternedScan.blockOfS (DirectGuard.pushAt 4145 1 7)
    (PatternedScan.pcFactS input 4145 5138 [b, flag] (by norm_num) entryPC4150)
    (PatternedScan.stepS_push input 5138 1 7 [b, flag] (by simp) (by decide) (by decide) (by norm_num))
  have h6 := PatternedScan.blockOfS (DirectGuard.opAt 4146 .EQ)
    (PatternedScan.pcFactS input 4146 5140 [7, b, flag] (by norm_num) entryPC4151)
    (PatternedScan.stepS_eq input 5140 7 b [flag] (by simp) (by norm_num))
  have h7 := PatternedScan.blockOfS (DirectGuard.opAt 4147 .ISZERO)
    (PatternedScan.pcFactS input 4147 5141 [e, flag] (by norm_num) entryPC4152)
    (PatternedScan.stepS_iszero input 5141 e [flag] (by simp) (by norm_num))
  have h8 := PatternedScan.blockOfS (DirectGuard.opAt 4148 .OR)
    (PatternedScan.pcFactS input 4148 5142 [z, flag] (by norm_num) entryPC4153)
    (PatternedScan.stepS_or input 5142 z flag [] (by simp) (by norm_num))
  have h9 := PatternedScan.blockOfS (DirectGuard.pushAt 4149 2 368)
    (PatternedScan.pcFactS input 4149 5143 [f] (by norm_num) entryPC4154)
  ...
  have a1 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST] [DirectGuard.pushAt 4141 0 0] _ _ _ h0 rfl h1
  have a2 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0] [DirectGuard.opAt 4142 .CALLDATALOAD] _ _ _ a1 rfl h2
  have a3 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0, DirectGuard.opAt 4142 .CALLDATALOAD] [DirectGuard.pushAt 4143 0 0] _ _ _ a2 rfl h3
  have a4 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0, DirectGuard.opAt 4142 .CALLDATALOAD, DirectGuard.pushAt 4143 0 0] [DirectGuard.opAt 4144 .BYTE] _ _ _ a3 rfl h4
  have a5 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0, DirectGuard.opAt 4142 .CALLDATALOAD, DirectGuard.pushAt 4143 0 0, DirectGuard.opAt 4144 .BYTE] [DirectGuard.pushAt 4145 1 7] _ _ _ a4 rfl h5
  have a6 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0, DirectGuard.opAt 4142 .CALLDATALOAD, DirectGuard.pushAt 4143 0 0, DirectGuard.opAt 4144 .BYTE, DirectGuard.pushAt 4145 1 7] [DirectGuard.opAt 4146 .EQ] _ _ _ a5 rfl h6
  have a7 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0, DirectGuard.opAt 4142 .CALLDATALOAD, DirectGuard.pushAt 4143 0 0, DirectGuard.opAt 4144 .BYTE, DirectGuard.pushAt 4145 1 7, DirectGuard.opAt 4146 .EQ] [DirectGuard.opAt 4147 .ISZERO] _ _ _ a6 rfl h7
  have a8 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0, DirectGuard.opAt 4142 .CALLDATALOAD, DirectGuard.pushAt 4143 0 0, DirectGuard.opAt 4144 .BYTE, DirectGuard.pushAt 4145 1 7, DirectGuard.opAt 4146 .EQ, DirectGuard.opAt 4147 .ISZERO] [DirectGuard.opAt 4148 .OR] _ _ _ a7 rfl h8
  have a9 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4140 .JUMPDEST, DirectGuard.pushAt 4141 0 0, DirectGuard.opAt 4142 .CALLDATALOAD, DirectGuard.pushAt 4143 0 0, DirectGuard.opAt 4144 .BYTE, DirectGuard.pushAt 4145 1 7, DirectGuard.opAt 4146 .EQ, DirectGuard.opAt 4147 .ISZERO, DirectGuard.opAt 4148 .OR] [DirectGuard.pushAt 4149 2 368] _ _ _ a8 rfl h9
...
private theorem run_guard_byte_fail (input : ByteArray) (flag : UInt256)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4150 .JUMPI)
    (PatternedScan.pcFactS input 4150 5146 [368, byteFlag input flag] (by norm_num) entryPC4155)
  ...
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4150 .JUMPI] _ _ _ (run_guard_byte_prefix input flag) rfl hj
...
private theorem run_guard_byte_match (input : ByteArray)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4150 .JUMPI)
    (PatternedScan.pcFactS input 4150 5146 [368, UInt256.ofNat 0] (by norm_num) entryPC4155)
    (PatternedScan.stepS_jumpi_fall input 5146 368 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))
  have h0 := PatternedScan.blockOfS (DirectGuard.pushAt 4151 0 0)
    (PatternedScan.pcFactS input 4151 5147 [] (by norm_num) entryPC4156)
    (PatternedScan.stepS_push0 input 5147 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4152 1 101)
    (PatternedScan.pcFactS input 4152 5148 [0] (by norm_num) entryPC4157)
    (PatternedScan.stepS_push input 5148 1 101 [0] (by simp) (by decide) (by decide) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4153 .JUMP)
    (PatternedScan.pcFactS input 4153 5150 [101, 0] (by norm_num) entryPC4158)
  ...
  have hpj := Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4150 .JUMPI] _ _ _ hprefix rfl hj
  have h01 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4151 0 0] [DirectGuard.pushAt 4152 1 101] _ _ _ h0 rfl h1
  have hs := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4151 0 0, DirectGuard.pushAt 4152 1 101]
    [DirectGuard.opAt 4153 .JUMP] _ _ _ h01 rfl h2
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
