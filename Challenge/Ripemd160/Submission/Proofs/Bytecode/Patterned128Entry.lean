...
@[simp] private theorem entryPC4146 : Artifact.submissionArtifact.instructionPC 4128 = 5159 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4147 : Artifact.submissionArtifact.instructionPC 4129 = 5160 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4148 : Artifact.submissionArtifact.instructionPC 4130 = 5161 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4149 : Artifact.submissionArtifact.instructionPC 4131 = 5162 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4150 : Artifact.submissionArtifact.instructionPC 4132 = 5163 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4151 : Artifact.submissionArtifact.instructionPC 4133 = 5165 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4152 : Artifact.submissionArtifact.instructionPC 4134 = 5166 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4153 : Artifact.submissionArtifact.instructionPC 4134 = 5166 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4154 : Artifact.submissionArtifact.instructionPC 4135 = 5167 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4155 : Artifact.submissionArtifact.instructionPC 4136 = 5170 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4156 : Artifact.submissionArtifact.instructionPC 4137 = 5171 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4157 : Artifact.submissionArtifact.instructionPC 4138 = 5172 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4158 : Artifact.submissionArtifact.instructionPC 4139 = 5174 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
@[simp] private theorem entryPC4168 : Artifact.submissionArtifact.instructionPC 4122 = 5152 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4169 : Artifact.submissionArtifact.instructionPC 4124 = 5154 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4170 : Artifact.submissionArtifact.instructionPC 4125 = 5155 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4171 : Artifact.submissionArtifact.instructionPC 4126 = 5157 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4172 : Artifact.submissionArtifact.instructionPC 4127 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4173 : Artifact.submissionArtifact.instructionPC 4127 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4174 : Artifact.submissionArtifact.instructionPC 4127 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4175 : Artifact.submissionArtifact.instructionPC 4127 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4176 : Artifact.submissionArtifact.instructionPC 4127 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4177 : Artifact.submissionArtifact.instructionPC 4127 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4178 : Artifact.submissionArtifact.instructionPC 4127 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private def guardSizePath : List Located :=
  [DirectGuard.opAt 4119 .JUMPDEST,
   DirectGuard.pushAt 4120 9 18446744073709551745,
...
private def guardBytePrefix : List Located :=
  [DirectGuard.pushAt 4128 0 0,
   DirectGuard.opAt 4129 .CALLDATALOAD,
   DirectGuard.pushAt 4130 0 0,
   DirectGuard.opAt 4131 .BYTE,
   DirectGuard.pushAt 4132 1 7,
   DirectGuard.opAt 4133 .XOR,
   DirectGuard.opAt 4134 .OR,
   DirectGuard.pushAt 4135 2 360]

private def guardBytePath : List Located := guardBytePrefix ++ [DirectGuard.opAt 4136 .JUMPI]
...
private def guardMatchSuffix : List Located :=
  [DirectGuard.pushAt 4137 0 0,
   DirectGuard.pushAt 4138 1 98,
...
private def byteEntry (input : ByteArray) (flag : UInt256) : State :=
  PatternedScan.stS input 5159 [flag]
private def byteDone (input : ByteArray) : State := PatternedScan.stS input 5171 []
...
private theorem run_guard_size (input : ByteArray) :
  ...
  let m : UInt256 := 18446744073709551745
  ...
  let l1 : Located := DirectGuard.pushAt 4120 9 18446744073709551745
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4120 5140 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5140 9 18446744073709551745 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 4121 1 56
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4121 5150 [m] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5150 1 56 [m] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := DirectGuard.opAt 4122 .CALLDATASIZE
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4122 5152 [56, m] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldatasize input 5152 [56, m] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4123 .SUB
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4123 5153 [x, 56, m] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_sub input 5153 x 56 [m] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.opAt 4124 .SHR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4124 5154 [d, m] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shr input 5154 d m [] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.pushAt 4125 1 1
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4125 5155 [shifted] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5155 1 1 [shifted] (by simp) (by decide) (by decide) (by norm_num))
  let l7 : Located := DirectGuard.opAt 4126 .AND
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4126 5157 [1, shifted] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_and input 5157 1 shifted [] (by simp) (by norm_num))
  let l8 : Located := DirectGuard.opAt 4127 .ISZERO
  have h8 := PatternedScan.blockOfS l8
    (PatternedScan.pcFactS input 4127 5158 [bit] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_iszero input 5158 bit [] (by simp) (by norm_num))
...
private theorem run_guard_byte_prefix (input : ByteArray) (flag : UInt256) :
    DirectGuard.run guardBytePrefix (byteEntry input flag) =
      some (PatternedScan.stS input 5170 [360, byteFlag input flag]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let z := UInt256.xor 7 b
  let f := UInt256.lor z flag
  let l0 : Located := DirectGuard.pushAt 4128 0 0
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4128 5159 [flag] (by norm_num) entryPC4146)
    (PatternedScan.stepS_push0 input 5159 [flag] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.opAt 4129 .CALLDATALOAD
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4129 5160 [0, flag] (by norm_num) entryPC4147)
    (PatternedScan.stepS_calldataload input 5160 0 [flag] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 4130 0 0
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4130 5161 [w, flag] (by norm_num) entryPC4148)
    (PatternedScan.stepS_push0 input 5161 [w, flag] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.opAt 4131 .BYTE
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4131 5162 [0, w, flag] (by norm_num) entryPC4149)
    (PatternedScan.stepS_byte input 5162 0 w [flag] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.pushAt 4132 1 7
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4132 5163 [b, flag] (by norm_num) entryPC4150)
    (PatternedScan.stepS_push input 5163 1 7 [b, flag] (by simp) (by decide) (by decide) (by norm_num))
  let l5 : Located := DirectGuard.opAt 4133 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4133 5165 [7, b, flag] (by norm_num) entryPC4151)
    (PatternedScan.stepS_xor input 5165 7 b [flag] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4134 .OR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4134 5166 [z, flag] (by norm_num) entryPC4152)
    (PatternedScan.stepS_or input 5166 z flag [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4135 2 360
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4135 5167 [f] (by norm_num) entryPC4154)
    (PatternedScan.stepS_push input 5167 2 360 [f] (by simp) (by decide) (by decide) (by norm_num))
...
private theorem run_guard_byte_fail (input : ByteArray) (flag : UInt256)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4136 .JUMPI)
    (PatternedScan.pcFactS input 4136 5170 [360, byteFlag input flag] (by norm_num) entryPC4155)
    (PatternedScan.stepS_jumpi_taken input 5170 360 360 (byteFlag input flag) []
  ...
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4136 .JUMPI] _ _ _ (run_guard_byte_prefix input flag) rfl hj
...
private theorem run_guard_byte_match (input : ByteArray)
  ...
  have hprefix : DirectGuard.run guardBytePrefix (byteEntry input (UInt256.ofNat 0)) =
      some (PatternedScan.stS input 5170 [360, UInt256.ofNat 0]) := by
    simpa only [hf] using run_guard_byte_prefix input (UInt256.ofNat 0)
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4136 .JUMPI)
    (PatternedScan.pcFactS input 4136 5170 [360, UInt256.ofNat 0] (by norm_num) entryPC4155)
    (PatternedScan.stepS_jumpi_fall input 5170 360 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))
  have h0 := PatternedScan.blockOfS (DirectGuard.pushAt 4137 0 0)
    (PatternedScan.pcFactS input 4137 5171 [] (by norm_num) entryPC4156)
    (PatternedScan.stepS_push0 input 5171 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4138 1 98)
    (PatternedScan.pcFactS input 4138 5172 [0] (by norm_num) entryPC4157)
    (PatternedScan.stepS_push input 5172 1 98 [0] (by simp) (by decide) (by decide) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4139 .JUMP)
    (PatternedScan.pcFactS input 4139 5174 [98, 0] (by norm_num) entryPC4158)
    (PatternedScan.stepS_jump input 5174 98 98 [0] (by simp) (by norm_num)
  ...
  have hpj := Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4136 .JUMPI] _ _ _ hprefix rfl hj
  have h01 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4137 0 0] [DirectGuard.pushAt 4138 1 98] _ _ _ h0 rfl h1
  have hs := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4137 0 0, DirectGuard.pushAt 4138 1 98]
