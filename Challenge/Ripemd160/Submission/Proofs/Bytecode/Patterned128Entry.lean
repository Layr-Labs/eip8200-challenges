...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3926 .JUMPDEST,
   DirectGuard.pushAt 3927 0 0,
   DirectGuard.opAt 3928 .CALLDATALOAD,
   DirectGuard.pushAt 3929 0 0,
   DirectGuard.opAt 3930 .BYTE,
   DirectGuard.pushAt 3931 1 7,
   DirectGuard.opAt 3932 .XOR,
   DirectGuard.pushAt 3933 2 5125]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3935 0 0,
   DirectGuard.pushAt 3936 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 3937 .CALLDATASIZE,
   DirectGuard.opAt 3938 .SHR,
   DirectGuard.pushAt 3939 1 1,
   DirectGuard.opAt 3940 .AND,
   DirectGuard.pushAt 3941 1 106]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3943 .POP,
   DirectGuard.pushAt 3944 2 272,
   DirectGuard.opAt 3945 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4762 []) =
      some (PatternedScan.stS input 4773 [5125, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3926 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3926 4762 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4762 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3927 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3927 4763 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4763 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3928 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3928 4764 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4764 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3929 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3929 4765 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4765 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3930 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3930 4766 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4766 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3931 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3931 4767 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4767 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3932 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3932 4769 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4769 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3933 2 5125
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3933 4770 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4770 2 5125 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3935 = 4774 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3936 = 4775 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3937 = 4793 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3938 = 4794 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3939 = 4795 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3940 = 4797 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3941 = 4798 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3942 = 4800 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3943 = 4801 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3944 = 4802 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3945 = 4805 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4774 []) =
      some (PatternedScan.stS input 4800 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3934 .JUMPI] (PatternedScan.stS input 4773 [5125, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3934 .JUMPI)
    (PatternedScan.pcFactS input 3934 4773 [5125, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4773 5125 5125 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3934 .JUMPI] (PatternedScan.stS input 4773 [5125, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4774 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3934 .JUMPI)
    (PatternedScan.pcFactS input 3934 4773 [5125, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4773 5125 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3942 .JUMPI]
      (PatternedScan.stS input 4800 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3942 .JUMPI)
    (PatternedScan.pcFactS input 3942 4800 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4800 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3942 .JUMPI]
      (PatternedScan.stS input 4800 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4801 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3942 .JUMPI)
    (PatternedScan.pcFactS input 3942 4800 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4800 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4801 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3943 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3943 4801 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4801 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3944 2 272
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3944 4802 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4802 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3945 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3945 4805 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4805 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4774 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4774 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4774 []) (PatternedScan.patternedEntry input) := by
