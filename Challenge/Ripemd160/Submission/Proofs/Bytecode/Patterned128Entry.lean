...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3882 .JUMPDEST (by exact GuardInstructionWindow.get 103),
   DirectGuard.pushAt 3883 0 0 (by exact GuardInstructionWindow.get 104),
   DirectGuard.opAt 3884 .CALLDATALOAD (by exact GuardInstructionWindow.get 105),
   DirectGuard.pushAt 3885 0 0 (by exact GuardInstructionWindow.get 106),
   DirectGuard.opAt 3886 .BYTE (by exact GuardInstructionWindow.get 107),
   DirectGuard.pushAt 3887 1 7 (by exact GuardInstructionWindow.get 108),
   DirectGuard.opAt 3888 .XOR (by exact GuardInstructionWindow.get 109),
   DirectGuard.pushAt 3889 2 5112 (by exact GuardInstructionWindow.get 110)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3891 0 0 (by exact GuardInstructionWindow.get 112),
   DirectGuard.pushAt 3892 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 113),
   DirectGuard.opAt 3893 .CALLDATASIZE (by exact GuardInstructionWindow.get 114),
   DirectGuard.opAt 3894 .SHR (by exact GuardInstructionWindow.get 115),
   DirectGuard.pushAt 3895 1 1 (by exact GuardInstructionWindow.get 116),
   DirectGuard.opAt 3896 .AND (by exact GuardInstructionWindow.get 117),
   DirectGuard.pushAt 3897 1 106 (by exact GuardInstructionWindow.get 118)]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3899 .POP (by exact GuardInstructionWindow.get 120),
   DirectGuard.pushAt 3900 2 335 (by exact GuardInstructionWindow.get 121),
   DirectGuard.opAt 3901 .JUMP (by exact GuardInstructionWindow.get 122)]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4749 []) =
      some (PatternedScan.stS input 4760 [5112, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3882 .JUMPDEST (by exact GuardInstructionWindow.get 103)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3882 4749 [] (by norm_num) (GuardInstructionWindow.pc 103))
    (PatternedScan.stepS_jumpdest input 4749 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3883 0 0 (by exact GuardInstructionWindow.get 104)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3883 4750 [] (by norm_num) (GuardInstructionWindow.pc 104))
    (PatternedScan.stepS_push0 input 4750 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3884 .CALLDATALOAD (by exact GuardInstructionWindow.get 105)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3884 4751 [0] (by norm_num) (GuardInstructionWindow.pc 105))
    (PatternedScan.stepS_calldataload input 4751 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3885 0 0 (by exact GuardInstructionWindow.get 106)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3885 4752 [w] (by norm_num) (GuardInstructionWindow.pc 106))
    (PatternedScan.stepS_push0 input 4752 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3886 .BYTE (by exact GuardInstructionWindow.get 107)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3886 4753 [0, w] (by norm_num) (GuardInstructionWindow.pc 107))
    (PatternedScan.stepS_byte input 4753 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3887 1 7 (by exact GuardInstructionWindow.get 108)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3887 4754 [b] (by norm_num) (GuardInstructionWindow.pc 108))
    (PatternedScan.stepS_push input 4754 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3888 .XOR (by exact GuardInstructionWindow.get 109)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3888 4756 [7, b] (by norm_num) (GuardInstructionWindow.pc 109))
    (PatternedScan.stepS_xor input 4756 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3889 2 5112 (by exact GuardInstructionWindow.get 110)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3889 4757 [v] (by norm_num) (GuardInstructionWindow.pc 110))
    (PatternedScan.stepS_push input 4757 2 5112 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3891 = 4761 := by
  exact GuardInstructionWindow.pc 112

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3892 = 4762 := by
  exact GuardInstructionWindow.pc 113

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3893 = 4780 := by
  exact GuardInstructionWindow.pc 114

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3894 = 4781 := by
  exact GuardInstructionWindow.pc 115

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3895 = 4782 := by
  exact GuardInstructionWindow.pc 116

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3896 = 4784 := by
  exact GuardInstructionWindow.pc 117

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3897 = 4785 := by
  exact GuardInstructionWindow.pc 118

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3898 = 4787 := by
  exact GuardInstructionWindow.pc 119

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3899 = 4788 := by
  exact GuardInstructionWindow.pc 120

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3900 = 4789 := by
  exact GuardInstructionWindow.pc 121

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3901 = 4792 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4761 []) =
      some (PatternedScan.stS input 4787 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3890 .JUMPI (by exact GuardInstructionWindow.get 111)] (PatternedScan.stS input 4760 [5112, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3890 .JUMPI (by exact GuardInstructionWindow.get 111))
    (PatternedScan.pcFactS input 3890 4760 [5112, byteValue input] (by norm_num) (GuardInstructionWindow.pc 111))
    (PatternedScan.stepS_jumpi_taken input 4760 5112 5112 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3890 .JUMPI (by exact GuardInstructionWindow.get 111)] (PatternedScan.stS input 4760 [5112, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4761 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3890 .JUMPI (by exact GuardInstructionWindow.get 111))
    (PatternedScan.pcFactS input 3890 4760 [5112, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 111))
    (PatternedScan.stepS_jumpi_fall input 4760 5112 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3898 .JUMPI (by exact GuardInstructionWindow.get 119)]
      (PatternedScan.stS input 4787 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3898 .JUMPI (by exact GuardInstructionWindow.get 119))
    (PatternedScan.pcFactS input 3898 4787 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4787 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3898 .JUMPI (by exact GuardInstructionWindow.get 119)]
      (PatternedScan.stS input 4787 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4788 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3898 .JUMPI (by exact GuardInstructionWindow.get 119))
    (PatternedScan.pcFactS input 3898 4787 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4787 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4788 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3899 .POP (by exact GuardInstructionWindow.get 120)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3899 4788 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4788 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3900 2 335 (by exact GuardInstructionWindow.get 121)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3900 4789 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4789 2 335 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3901 .JUMP (by exact GuardInstructionWindow.get 122)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3901 4792 [335] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4792 335 335 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4761 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4761 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4761 []) (PatternedScan.patternedEntry input) := by
