...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3850 .JUMPDEST,
   ...
   DirectGuard.pushAt 3857 2 5169]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4806 []) =
      some (PatternedScan.stS input 4817 [5169, byteValue input]) := by
  ...
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3850 4806 [] (by norm_num) (by
  ...
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3851 4807 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
  ...
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3852 4808 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
  ...
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3853 4809 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
  ...
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3854 4810 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
  ...
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3855 4811 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
  ...
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3856 4813 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4813 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3857 2 5169
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3857 4814 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4814 2 5169 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3859 = 4818 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3860 = 4819 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3861 = 4837 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3862 = 4838 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3863 = 4839 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3864 = 4841 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3865 = 4842 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3866 = 4844 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3867 = 4845 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3868 = 4846 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3869 = 4849 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4818 []) =
      some (PatternedScan.stS input 4844 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3858 .JUMPI] (PatternedScan.stS input 4817 [5169, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3858 .JUMPI)
    (PatternedScan.pcFactS input 3858 4817 [5169, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4817 5169 5169 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3858 .JUMPI] (PatternedScan.stS input 4817 [5169, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4818 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3858 .JUMPI)
    (PatternedScan.pcFactS input 3858 4817 [5169, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4817 5169 (UInt256.ofNat 0) []
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3866 .JUMPI]
      (PatternedScan.stS input 4844 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3866 .JUMPI)
    (PatternedScan.pcFactS input 3866 4844 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3866 .JUMPI]
      (PatternedScan.stS input 4844 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4845 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3866 .JUMPI)
    (PatternedScan.pcFactS input 3866 4844 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
...
private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4845 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3867 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3867 4845 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4845 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3868 2 272
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3868 4846 [] (by norm_num) sizeHitPC4113)
  ...
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3869 4849 [272] (by norm_num) sizeHitPC4114)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4818 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4818 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4818 []) (PatternedScan.patternedEntry input) := by
