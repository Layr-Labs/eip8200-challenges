...
private def guardJumpPath : List Located :=
  [DirectGuard.opAt 4132 .JUMPDEST,
   DirectGuard.pushAt 4133 2 5178,
   DirectGuard.opAt 4134 .JUMP]
...
private theorem run_guard_jump (input : ByteArray) :
  ...
  have h0 := PatternedScan.blockOfS (DirectGuard.opAt 4132 .JUMPDEST)
    (PatternedScan.pcFactS input 4132 5128 [] (by norm_num) entryPC4142)
    (PatternedScan.stepS_jumpdest input 5128 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4133 2 5178)
    (PatternedScan.pcFactS input 4133 5129 [] (by norm_num) entryPC4143)
    (PatternedScan.stepS_push input 5129 2 5178 [] (by simp) (by decide) (by decide) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4134 .JUMP)
    (PatternedScan.pcFactS input 4134 5132 [5178] (by norm_num) entryPC4144)
  ...
  have h01 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4132 .JUMPDEST] [DirectGuard.pushAt 4133 2 5178] _ _ _ h0 rfl h1
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.opAt 4132 .JUMPDEST, DirectGuard.pushAt 4133 2 5178]
    [DirectGuard.opAt 4134 .JUMP] _ _ _ h01 rfl h2
