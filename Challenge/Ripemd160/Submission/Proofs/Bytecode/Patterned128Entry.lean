...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3845 .JUMPDEST (by exact GuardInstructionWindow.get 114),
   DirectGuard.pushAt 3846 0 0 (by exact GuardInstructionWindow.get 115),
   DirectGuard.opAt 3847 .CALLDATALOAD (by exact GuardInstructionWindow.get 116),
   DirectGuard.pushAt 3848 0 0 (by exact GuardInstructionWindow.get 117),
   DirectGuard.opAt 3849 .BYTE (by exact GuardInstructionWindow.get 118),
   DirectGuard.pushAt 3850 1 7 (by exact GuardInstructionWindow.get 119),
   DirectGuard.opAt 3851 .XOR (by exact GuardInstructionWindow.get 120),
   DirectGuard.pushAt 3852 2 5161 (by exact GuardInstructionWindow.get 121)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3854 0 0 (by exact GuardInstructionWindow.get 123),
   DirectGuard.pushAt 3855 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 124),
   DirectGuard.opAt 3856 .CALLDATASIZE (by exact GuardInstructionWindow.get 125),
   DirectGuard.opAt 3857 .SHR (by exact GuardInstructionWindow.get 126),
   DirectGuard.pushAt 3858 1 1 (by exact GuardInstructionWindow.get 127),
   DirectGuard.opAt 3859 .AND (by exact GuardInstructionWindow.get 128),
   DirectGuard.pushAt 3860 1 106 (by exact GuardInstructionWindow.get 129)]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3862 .POP (by exact GuardInstructionWindow.get 131),
   DirectGuard.pushAt 3863 2 272 (by exact GuardInstructionWindow.get 132),
   DirectGuard.opAt 3864 .JUMP (by exact GuardInstructionWindow.get 133)]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4798 []) =
      some (PatternedScan.stS input 4809 [5161, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3845 .JUMPDEST (by exact GuardInstructionWindow.get 114)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3845 4798 [] (by norm_num) (GuardInstructionWindow.pc 114))
    (PatternedScan.stepS_jumpdest input 4798 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3846 0 0 (by exact GuardInstructionWindow.get 115)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3846 4799 [] (by norm_num) (GuardInstructionWindow.pc 115))
    (PatternedScan.stepS_push0 input 4799 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3847 .CALLDATALOAD (by exact GuardInstructionWindow.get 116)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3847 4800 [0] (by norm_num) (GuardInstructionWindow.pc 116))
    (PatternedScan.stepS_calldataload input 4800 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3848 0 0 (by exact GuardInstructionWindow.get 117)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3848 4801 [w] (by norm_num) (GuardInstructionWindow.pc 117))
    (PatternedScan.stepS_push0 input 4801 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3849 .BYTE (by exact GuardInstructionWindow.get 118)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3849 4802 [0, w] (by norm_num) (GuardInstructionWindow.pc 118))
    (PatternedScan.stepS_byte input 4802 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3850 1 7 (by exact GuardInstructionWindow.get 119)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3850 4803 [b] (by norm_num) (GuardInstructionWindow.pc 119))
    (PatternedScan.stepS_push input 4803 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3851 .XOR (by exact GuardInstructionWindow.get 120)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3851 4805 [7, b] (by norm_num) (GuardInstructionWindow.pc 120))
    (PatternedScan.stepS_xor input 4805 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3852 2 5161 (by exact GuardInstructionWindow.get 121)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3852 4806 [v] (by norm_num) (GuardInstructionWindow.pc 121))
    (PatternedScan.stepS_push input 4806 2 5161 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3854 = 4810 := by
  exact GuardInstructionWindow.pc 123

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3855 = 4811 := by
  exact GuardInstructionWindow.pc 124

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3856 = 4829 := by
  exact GuardInstructionWindow.pc 125

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3857 = 4830 := by
  exact GuardInstructionWindow.pc 126

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3858 = 4831 := by
  exact GuardInstructionWindow.pc 127

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3859 = 4833 := by
  exact GuardInstructionWindow.pc 128

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3860 = 4834 := by
  exact GuardInstructionWindow.pc 129

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3861 = 4836 := by
  exact GuardInstructionWindow.pc 130

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3862 = 4837 := by
  exact GuardInstructionWindow.pc 131

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3863 = 4838 := by
  exact GuardInstructionWindow.pc 132

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3864 = 4841 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4810 []) =
      some (PatternedScan.stS input 4836 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4809 [5161, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3853 4809 [5161, byteValue input] (by norm_num) (GuardInstructionWindow.pc 122))
    (PatternedScan.stepS_jumpi_taken input 4809 5161 5161 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4809 [5161, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4810 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3853 4809 [5161, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 122))
    (PatternedScan.stepS_jumpi_fall input 4809 5161 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3861 .JUMPI (by exact GuardInstructionWindow.get 130)]
      (PatternedScan.stS input 4836 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3861 .JUMPI (by exact GuardInstructionWindow.get 130))
    (PatternedScan.pcFactS input 3861 4836 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4836 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3861 .JUMPI (by exact GuardInstructionWindow.get 130)]
      (PatternedScan.stS input 4836 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4837 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3861 .JUMPI (by exact GuardInstructionWindow.get 130))
    (PatternedScan.pcFactS input 3861 4836 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4836 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4837 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3862 .POP (by exact GuardInstructionWindow.get 131)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3862 4837 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4837 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3863 2 272 (by exact GuardInstructionWindow.get 132)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3863 4838 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4838 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3864 .JUMP (by exact GuardInstructionWindow.get 133)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3864 4841 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4841 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4810 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4810 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4810 []) (PatternedScan.patternedEntry input) := by
