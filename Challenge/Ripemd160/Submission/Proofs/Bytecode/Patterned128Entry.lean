...
@[simp] private theorem entryPC62 : Artifact.submissionArtifact.instructionPC 72 = 116 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private theorem guard_fallback_dest : Decode.isValidJumpDest submissionBytecode 358 = true :=
  Artifact.submissionArtifact.isValidJumpDest_index 244 (by rfl)
...
private def guardJumpState (input : ByteArray) : State :=
  { DirectGuard.guardEntry input with pc := UInt256.ofNat 115, stack := [] }

private def bytePrefix : List Located :=
  [DirectGuard.opAt 3838 .JUMPDEST (by exact GuardInstructionWindow.get 181),
   DirectGuard.pushAt 3839 1 7 (by exact GuardInstructionWindow.get 182),
   DirectGuard.pushAt 3840 0 0 (by exact GuardInstructionWindow.get 183),
   DirectGuard.opAt 3841 .CALLDATALOAD (by exact GuardInstructionWindow.get 184),
   DirectGuard.pushAt 3842 0 0 (by exact GuardInstructionWindow.get 185),
   DirectGuard.opAt 3843 .BYTE (by exact GuardInstructionWindow.get 186),
   DirectGuard.opAt 3844 .XOR (by exact GuardInstructionWindow.get 187),
   DirectGuard.pushAt 3845 2 4902 (by exact GuardInstructionWindow.get 188)]
...
private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3847 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 190),
   ...
   DirectGuard.pushAt 3852 1 115 (by exact GuardInstructionWindow.get 195)]

private def fallbackSuffix : List Located :=
  [DirectGuard.pushAt 3854 2 358 (by exact GuardInstructionWindow.get 197),
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4860 []) =
      some (PatternedScan.stS input 4871 [4902, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor b 7
  let l0 : Located := DirectGuard.opAt 3838 .JUMPDEST (by exact GuardInstructionWindow.get 181)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3838 4860 [] (by norm_num) (GuardInstructionWindow.pc 181))
    (PatternedScan.stepS_jumpdest input 4860 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3839 1 7 (by exact GuardInstructionWindow.get 182)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3839 4861 [] (by norm_num) (GuardInstructionWindow.pc 182))
    (PatternedScan.stepS_push input 4861 1 7 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 3840 0 0 (by exact GuardInstructionWindow.get 183)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3840 4863 [7] (by norm_num) (GuardInstructionWindow.pc 183))
    (PatternedScan.stepS_push0 input 4863 [7] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.opAt 3841 .CALLDATALOAD (by exact GuardInstructionWindow.get 184)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3841 4864 [0, 7] (by norm_num) (GuardInstructionWindow.pc 184))
    (PatternedScan.stepS_calldataload input 4864 0 [7] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.pushAt 3842 0 0 (by exact GuardInstructionWindow.get 185)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3842 4865 [w, 7] (by norm_num) (GuardInstructionWindow.pc 185))
    (PatternedScan.stepS_push0 input 4865 [w, 7] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.opAt 3843 .BYTE (by exact GuardInstructionWindow.get 186)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3843 4866 [0, w, 7] (by norm_num) (GuardInstructionWindow.pc 186))
    (PatternedScan.stepS_byte input 4866 0 w [7] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3844 .XOR (by exact GuardInstructionWindow.get 187)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3844 4867 [b, 7] (by norm_num) (GuardInstructionWindow.pc 187))
    (PatternedScan.stepS_xor input 4867 b 7 [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3845 2 4902 (by exact GuardInstructionWindow.get 188)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3845 4868 [v] (by norm_num) (GuardInstructionWindow.pc 188))
    (PatternedScan.stepS_push input 4868 2 4902 [v] (by simp) (by decide) (by decide) (by norm_num))
  ...
  have hv : v = byteValue input := by
    simp only [v, b, w, byteValue, Word.literal_eq_ofNat, RawExpressionAC.xor_comm]
  rw [hv] at hseq7
  exact hseq7

@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3847 = 4872 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3847 = 4872 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3848 = 4890 := by
  exact GuardInstructionWindow.pc 191

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3849 = 4891 := by
  exact GuardInstructionWindow.pc 192

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3850 = 4892 := by
  exact GuardInstructionWindow.pc 193

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3851 = 4894 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3852 = 4895 := by
  exact GuardInstructionWindow.pc 195

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3853 = 4897 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3854 = 4898 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3854 = 4898 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3855 = 4901 := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3846 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 4871 [4902, byteValue input]) =
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 3846 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3846 4871 [4902, byteValue input] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_taken input 4871 4902 4902 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3846 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 4871 [4902, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4872 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3846 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3846 4871 [4902, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_fall input 4871 4902 (UInt256.ofNat 0) []
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 196)]
      (PatternedScan.stS input 4897 [115, sizeBit input]) =
      some (PatternedScan.stS input 115 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 196))
    (PatternedScan.pcFactS input 3853 4897 [115, sizeBit input] (by norm_num) sizeHitPC4111)
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 196)]
      (PatternedScan.stS input 4897 [115, sizeBit input]) =
      some (PatternedScan.stS input 4898 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3853 .JUMPI (by exact GuardInstructionWindow.get 196))
    (PatternedScan.pcFactS input 3853 4897 [115, sizeBit input] (by norm_num) sizeHitPC4111)
...
private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4898 []) =
      some (DirectGuard.fallbackState input) := by
  let l1 : Located := DirectGuard.pushAt 3854 2 358 (by exact GuardInstructionWindow.get 197)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3854 4898 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4898 2 358 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3855 .JUMP (by exact GuardInstructionWindow.get 198)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3855 4901 [358] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4901 358 358 [] (by simp) (by norm_num) rfl guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4872 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4872 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4872 []) (PatternedScan.patternedEntry input) := by
