...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3839 .JUMPDEST (by exact GuardInstructionWindow.get 114),
   DirectGuard.pushAt 3840 0 0 (by exact GuardInstructionWindow.get 115),
   DirectGuard.opAt 3841 .CALLDATALOAD (by exact GuardInstructionWindow.get 116),
   DirectGuard.pushAt 3842 0 0 (by exact GuardInstructionWindow.get 117),
   DirectGuard.opAt 3843 .BYTE (by exact GuardInstructionWindow.get 118),
   DirectGuard.pushAt 3844 1 7 (by exact GuardInstructionWindow.get 119),
   DirectGuard.opAt 3845 .XOR (by exact GuardInstructionWindow.get 120),
   DirectGuard.pushAt 3846 2 5155 (by exact GuardInstructionWindow.get 121)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3848 0 0 (by exact GuardInstructionWindow.get 123),
   DirectGuard.pushAt 3849 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 124),
   DirectGuard.opAt 3850 .CALLDATASIZE (by exact GuardInstructionWindow.get 125),
   DirectGuard.opAt 3851 .SHR (by exact GuardInstructionWindow.get 126),
   DirectGuard.pushAt 3852 1 1 (by exact GuardInstructionWindow.get 127),
   DirectGuard.opAt 3853 .AND (by exact GuardInstructionWindow.get 128),
   DirectGuard.pushAt 3854 1 106 (by exact GuardInstructionWindow.get 129)]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3856 .POP (by exact GuardInstructionWindow.get 131),
   DirectGuard.pushAt 3857 2 272 (by exact GuardInstructionWindow.get 132),
   DirectGuard.opAt 3858 .JUMP (by exact GuardInstructionWindow.get 133)]
...
private theorem run_byte_prefix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 3839 .JUMPDEST (by exact GuardInstructionWindow.get 114)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3839 4792 [] (by norm_num) (GuardInstructionWindow.pc 114))
    (PatternedScan.stepS_jumpdest input 4792 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3840 0 0 (by exact GuardInstructionWindow.get 115)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3840 4793 [] (by norm_num) (GuardInstructionWindow.pc 115))
    (PatternedScan.stepS_push0 input 4793 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3841 .CALLDATALOAD (by exact GuardInstructionWindow.get 116)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3841 4794 [0] (by norm_num) (GuardInstructionWindow.pc 116))
    (PatternedScan.stepS_calldataload input 4794 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3842 0 0 (by exact GuardInstructionWindow.get 117)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3842 4795 [w] (by norm_num) (GuardInstructionWindow.pc 117))
    (PatternedScan.stepS_push0 input 4795 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3843 .BYTE (by exact GuardInstructionWindow.get 118)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3843 4796 [0, w] (by norm_num) (GuardInstructionWindow.pc 118))
    (PatternedScan.stepS_byte input 4796 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3844 1 7 (by exact GuardInstructionWindow.get 119)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3844 4797 [b] (by norm_num) (GuardInstructionWindow.pc 119))
    (PatternedScan.stepS_push input 4797 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3845 .XOR (by exact GuardInstructionWindow.get 120)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3845 4799 [7, b] (by norm_num) (GuardInstructionWindow.pc 120))
    (PatternedScan.stepS_xor input 4799 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3846 2 5155 (by exact GuardInstructionWindow.get 121)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3846 4800 [v] (by norm_num) (GuardInstructionWindow.pc 121))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3848 = 4804 := by
  exact GuardInstructionWindow.pc 123

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3849 = 4805 := by
  exact GuardInstructionWindow.pc 124

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3850 = 4823 := by
  exact GuardInstructionWindow.pc 125

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3851 = 4824 := by
  exact GuardInstructionWindow.pc 126

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3852 = 4825 := by
  exact GuardInstructionWindow.pc 127

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3853 = 4827 := by
  exact GuardInstructionWindow.pc 128

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3854 = 4828 := by
  exact GuardInstructionWindow.pc 129

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3855 = 4830 := by
  exact GuardInstructionWindow.pc 130

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3856 = 4831 := by
  exact GuardInstructionWindow.pc 131

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3857 = 4832 := by
  exact GuardInstructionWindow.pc 132

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3858 = 4835 := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4803 [5155, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3847 4803 [5155, byteValue input] (by norm_num) (GuardInstructionWindow.pc 122))
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4803 [5155, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4804 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3847 4803 [5155, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 122))
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3855 .JUMPI (by exact GuardInstructionWindow.get 130)]
      (PatternedScan.stS input 4830 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3855 .JUMPI (by exact GuardInstructionWindow.get 130))
    (PatternedScan.pcFactS input 3855 4830 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
...
private theorem run_fallback_suffix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 3856 .POP (by exact GuardInstructionWindow.get 131)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3856 4831 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4831 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3857 2 272 (by exact GuardInstructionWindow.get 132)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3857 4832 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4832 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3858 .JUMP (by exact GuardInstructionWindow.get 133)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3858 4835 [272] (by norm_num) sizeHitPC4114)
