...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3852 .JUMPDEST,
   DirectGuard.pushAt 3853 0 0,
   DirectGuard.opAt 3854 .CALLDATALOAD,
   DirectGuard.pushAt 3855 0 0,
   DirectGuard.opAt 3856 .BYTE,
   DirectGuard.pushAt 3857 1 7,
   DirectGuard.opAt 3858 .XOR,
   DirectGuard.pushAt 3859 2 5165]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3861 0 0,
   DirectGuard.pushAt 3862 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 3863 .CALLDATASIZE,
   DirectGuard.opAt 3864 .SHR,
   DirectGuard.pushAt 3865 1 1,
   DirectGuard.opAt 3866 .AND,
   DirectGuard.pushAt 3867 1 106]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3869 .POP,
   DirectGuard.pushAt 3870 2 272,
   DirectGuard.opAt 3871 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4802 []) =
      some (PatternedScan.stS input 4813 [5165, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3852 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3852 4802 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4802 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3853 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3853 4803 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4803 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3854 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3854 4804 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4804 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3855 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3855 4805 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4805 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3856 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3856 4806 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4806 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3857 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3857 4807 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4807 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3858 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3858 4809 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4809 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3859 2 5165
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3859 4810 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4810 2 5165 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3861 = 4814 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3862 = 4815 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3863 = 4833 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3864 = 4834 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3865 = 4835 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3866 = 4837 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3867 = 4838 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3868 = 4840 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3869 = 4841 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3870 = 4842 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3871 = 4845 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4814 []) =
      some (PatternedScan.stS input 4840 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3860 .JUMPI] (PatternedScan.stS input 4813 [5165, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3860 .JUMPI)
    (PatternedScan.pcFactS input 3860 4813 [5165, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4813 5165 5165 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3860 .JUMPI] (PatternedScan.stS input 4813 [5165, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4814 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3860 .JUMPI)
    (PatternedScan.pcFactS input 3860 4813 [5165, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4813 5165 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3868 .JUMPI]
      (PatternedScan.stS input 4840 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3868 .JUMPI)
    (PatternedScan.pcFactS input 3868 4840 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4840 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3868 .JUMPI]
      (PatternedScan.stS input 4840 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4841 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3868 .JUMPI)
    (PatternedScan.pcFactS input 3868 4840 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4840 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4841 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3869 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3869 4841 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4841 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3870 2 272
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3870 4842 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4842 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3871 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3871 4845 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4845 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4814 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4814 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4814 []) (PatternedScan.patternedEntry input) := by
