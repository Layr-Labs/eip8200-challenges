...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3831 .JUMPDEST (by exact GuardInstructionWindow.get 108),
   DirectGuard.pushAt 3832 0 0 (by exact GuardInstructionWindow.get 109),
   DirectGuard.opAt 3833 .CALLDATALOAD (by exact GuardInstructionWindow.get 110),
   DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 111),
   DirectGuard.opAt 3835 .BYTE (by exact GuardInstructionWindow.get 112),
   DirectGuard.pushAt 3836 1 7 (by exact GuardInstructionWindow.get 113),
   DirectGuard.opAt 3837 .XOR (by exact GuardInstructionWindow.get 114),
   DirectGuard.pushAt 3838 2 5211 (by exact GuardInstructionWindow.get 115)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3840 0 0 (by exact GuardInstructionWindow.get 117),
   DirectGuard.pushAt 3841 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 118),
   DirectGuard.opAt 3842 .CALLDATASIZE (by exact GuardInstructionWindow.get 119),
   DirectGuard.opAt 3843 .SHR (by exact GuardInstructionWindow.get 120),
   DirectGuard.pushAt 3844 1 1 (by exact GuardInstructionWindow.get 121),
   DirectGuard.opAt 3845 .AND (by exact GuardInstructionWindow.get 122),
   DirectGuard.pushAt 3846 1 106 (by exact GuardInstructionWindow.get 123)]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3848 .POP (by exact GuardInstructionWindow.get 125),
   DirectGuard.pushAt 3849 2 272 (by exact GuardInstructionWindow.get 126),
   DirectGuard.opAt 3850 .JUMP (by exact GuardInstructionWindow.get 127)]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4848 []) =
      some (PatternedScan.stS input 4859 [5211, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3831 .JUMPDEST (by exact GuardInstructionWindow.get 108)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3831 4848 [] (by norm_num) (GuardInstructionWindow.pc 108))
    (PatternedScan.stepS_jumpdest input 4848 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3832 0 0 (by exact GuardInstructionWindow.get 109)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3832 4849 [] (by norm_num) (GuardInstructionWindow.pc 109))
    (PatternedScan.stepS_push0 input 4849 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3833 .CALLDATALOAD (by exact GuardInstructionWindow.get 110)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3833 4850 [0] (by norm_num) (GuardInstructionWindow.pc 110))
    (PatternedScan.stepS_calldataload input 4850 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 111)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3834 4851 [w] (by norm_num) (GuardInstructionWindow.pc 111))
    (PatternedScan.stepS_push0 input 4851 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3835 .BYTE (by exact GuardInstructionWindow.get 112)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3835 4852 [0, w] (by norm_num) (GuardInstructionWindow.pc 112))
    (PatternedScan.stepS_byte input 4852 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3836 1 7 (by exact GuardInstructionWindow.get 113)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3836 4853 [b] (by norm_num) (GuardInstructionWindow.pc 113))
    (PatternedScan.stepS_push input 4853 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3837 .XOR (by exact GuardInstructionWindow.get 114)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3837 4855 [7, b] (by norm_num) (GuardInstructionWindow.pc 114))
    (PatternedScan.stepS_xor input 4855 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3838 2 5211 (by exact GuardInstructionWindow.get 115)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3838 4856 [v] (by norm_num) (GuardInstructionWindow.pc 115))
    (PatternedScan.stepS_push input 4856 2 5211 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3840 = 4860 := by
  exact GuardInstructionWindow.pc 117

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3841 = 4861 := by
  exact GuardInstructionWindow.pc 118

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3842 = 4879 := by
  exact GuardInstructionWindow.pc 119

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3843 = 4880 := by
  exact GuardInstructionWindow.pc 120

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3844 = 4881 := by
  exact GuardInstructionWindow.pc 121

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3845 = 4883 := by
  exact GuardInstructionWindow.pc 122

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3846 = 4884 := by
  exact GuardInstructionWindow.pc 123

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3847 = 4886 := by
  exact GuardInstructionWindow.pc 124

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3848 = 4887 := by
  exact GuardInstructionWindow.pc 125

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3849 = 4888 := by
  exact GuardInstructionWindow.pc 126

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3850 = 4891 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4860 []) =
      some (PatternedScan.stS input 4886 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3839 .JUMPI (by exact GuardInstructionWindow.get 116)] (PatternedScan.stS input 4859 [5211, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3839 .JUMPI (by exact GuardInstructionWindow.get 116))
    (PatternedScan.pcFactS input 3839 4859 [5211, byteValue input] (by norm_num) (GuardInstructionWindow.pc 116))
    (PatternedScan.stepS_jumpi_taken input 4859 5211 5211 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3839 .JUMPI (by exact GuardInstructionWindow.get 116)] (PatternedScan.stS input 4859 [5211, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4860 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3839 .JUMPI (by exact GuardInstructionWindow.get 116))
    (PatternedScan.pcFactS input 3839 4859 [5211, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 116))
    (PatternedScan.stepS_jumpi_fall input 4859 5211 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 124)]
      (PatternedScan.stS input 4886 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 124))
    (PatternedScan.pcFactS input 3847 4886 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4886 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 124)]
      (PatternedScan.stS input 4886 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4887 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 124))
    (PatternedScan.pcFactS input 3847 4886 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4886 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4887 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3848 .POP (by exact GuardInstructionWindow.get 125)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3848 4887 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4887 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3849 2 272 (by exact GuardInstructionWindow.get 126)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3849 4888 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4888 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3850 .JUMP (by exact GuardInstructionWindow.get 127)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3850 4891 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4891 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
and the byte-0 gate misses ('a' = 0x61 ≠ 7), so the byte-0 `JUMPI` lands on the arm (pc 5211). -/
