...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3634 = 4815 := J2EntryWindow.pc 0
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3635 = 4816 := J2EntryWindow.pc 1
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3641 = 4841 := J2EntryWindow.pc 7
private theorem packedPC3735 : Artifact.submissionArtifact.instructionPC 3642 = 4842 := J2EntryWindow.pc 8
private theorem packedPC3736 : Artifact.submissionArtifact.instructionPC 3643 = 4845 := J2EntryWindow.pc 9
private theorem packedPC3737 : Artifact.submissionArtifact.instructionPC 3644 = 4851 := J2EntryWindow.pc 10
private theorem packedPC3738 : Artifact.submissionArtifact.instructionPC 3645 = 4852 := J2EntryWindow.pc 11
private theorem packedPC3739 : Artifact.submissionArtifact.instructionPC 3646 = 4854 := J2EntryWindow.pc 12
private theorem packedPC3740 : Artifact.submissionArtifact.instructionPC 3647 = 4855 := J2EntryWindow.pc 13
private theorem packedPC3741 : Artifact.submissionArtifact.instructionPC 3648 = 4856 := J2EntryWindow.pc 14
private theorem packedPC3742 : Artifact.submissionArtifact.instructionPC 3649 = 4857 := J2EntryWindow.pc 15
private theorem packedPC3743 : Artifact.submissionArtifact.instructionPC 3650 = 4858 := J2EntryWindow.pc 16
private theorem packedPC3744 : Artifact.submissionArtifact.instructionPC 3651 = 4859 := J2EntryWindow.pc 17
private theorem packedPC3745 : Artifact.submissionArtifact.instructionPC 3652 = 4861 := J2EntryWindow.pc 18

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3636 = 4818 :=
  J2EntryWindow.pc 2
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3637 = 4836 :=
  J2EntryWindow.pc 3
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3638 = 4837 :=
  J2EntryWindow.pc 4
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3639 = 4838 :=
  J2EntryWindow.pc 5
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3640 = 4839 :=
  J2EntryWindow.pc 6

/-! ## The size mask -/

private def maskEntry : List Located :=
  [DirectGuard.opAt 3634 .JUMPDEST (by exact J2EntryWindow.get 0)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3635 1 1 (by exact J2EntryWindow.get 1),
   DirectGuard.pushAt 3636 17 342276208914615837337402008677671501826 (by exact J2EntryWindow.get 2),
   DirectGuard.opAt 3637 .CALLDATASIZE (by exact J2EntryWindow.get 3),
   DirectGuard.opAt 3638 .SHR (by exact J2EntryWindow.get 4),
   DirectGuard.opAt 3639 .AND (by exact J2EntryWindow.get 5),
   DirectGuard.pushAt 3640 1 122 (by exact J2EntryWindow.get 6)]

private def maskJump : List Located :=
  [DirectGuard.opAt 3641 .JUMPI (by exact J2EntryWindow.get 7)]
...
private theorem run_mask_entry (input : ByteArray) :
    DirectGuard.run maskEntry (PatternedScan.stS input 4815 []) =
      some (PatternedScan.stS input 4816 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3634 4815 [] (by norm_num) pc3836)
    (PatternedScan.stepS_jumpdest input 4815 [] (by simp) (by norm_num))

private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4816 []) =
      some (PatternedScan.stS input 4841 [122, sizeBit input]) := by
  have hpc : Artifact.submissionArtifact.instructionPC 3635 = 4816 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4841 [122, sizeBit input]) =
      some (PatternedScan.stS input 122 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3641 4841 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_taken input 4841 122 122 (sizeBit input) []
...
private theorem run_mask_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3641 4841 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_fall input 4841 122 (sizeBit input) []
...
private def gasSteps_mask_prefix (input : ByteArray) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4841 [122, sizeBit input]) :=
...
private def gasSteps_mask_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4842 []) := by
...
private def lengthPrefix : List Located :=
  [DirectGuard.pushAt 3642 2 1016 (by exact J2EntryWindow.get 8),
   DirectGuard.pushAt 3643 5 6308489473 (by exact J2EntryWindow.get 9),
   DirectGuard.opAt 3644 .CALLDATASIZE (by exact J2EntryWindow.get 10),
   DirectGuard.pushAt 3645 1 24 (by exact J2EntryWindow.get 11),
   DirectGuard.opAt 3646 .AND (by exact J2EntryWindow.get 12),
   DirectGuard.opAt 3647 .SHR (by exact J2EntryWindow.get 13),
   DirectGuard.opAt 3648 .AND (by exact J2EntryWindow.get 14),
   DirectGuard.opAt 3649 .CALLDATASIZE (by exact J2EntryWindow.get 15),
   DirectGuard.opAt 3650 .EQ (by exact J2EntryWindow.get 16),
   DirectGuard.pushAt 3651 1 122 (by exact J2EntryWindow.get 17)]

private def lengthJump : List Located :=
  [DirectGuard.opAt 3652 .JUMPI (by exact J2EntryWindow.get 18)]

private theorem run_length_prefix (input : ByteArray) :
    DirectGuard.run lengthPrefix (PatternedScan.stS input 4842 []) =
      some (PatternedScan.stS input 4861 [122, lengthCond input]) := by
...
private def gasSteps_length_match (input : ByteArray)
    ...
    GasSteps (PatternedScan.stS input 4842 []) (PatternedScan.patternedEntry input) := by
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4861 [122, lengthCond input]) =
      some (PatternedScan.stS input 122 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3652 4861 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_taken input 4861 122 122 (lengthCond input) []
...
private def gasSteps_length_fail (input : ByteArray) (hfit : CalldataFits input)
    (h256 : input.size ≠ 256) (h376 : input.size ≠ 376) (h1000 : input.size ≠ 1000) :
    GasSteps (PatternedScan.stS input 4842 []) (AbcArm.armEntry input) := by
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4861 [122, lengthCond input]) =
      some (AbcArm.armEntry input) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3652 4861 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_fall input 4861 122 (lengthCond input) []
