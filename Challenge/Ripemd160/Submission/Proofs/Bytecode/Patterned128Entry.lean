...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3842 .JUMPDEST (by exact GuardInstructionWindow.get 185),
   ...
   DirectGuard.pushAt 3844 0 0 (by exact GuardInstructionWindow.get 187),
   DirectGuard.opAt 3845 .CALLDATALOAD (by exact GuardInstructionWindow.get 188),
   DirectGuard.pushAt 3846 0 0 (by exact GuardInstructionWindow.get 189),
   DirectGuard.opAt 3847 .BYTE (by exact GuardInstructionWindow.get 190),
   DirectGuard.opAt 3848 .XOR (by exact GuardInstructionWindow.get 191),
   DirectGuard.pushAt 3849 2 4901 (by exact GuardInstructionWindow.get 192)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3851 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 194),
   DirectGuard.opAt 3852 .CALLDATASIZE (by exact GuardInstructionWindow.get 195),
   DirectGuard.opAt 3853 .SHR (by exact GuardInstructionWindow.get 196),
   DirectGuard.pushAt 3854 1 1 (by exact GuardInstructionWindow.get 197),
   DirectGuard.opAt 3855 .AND (by exact GuardInstructionWindow.get 198),
   DirectGuard.pushAt 3856 1 115 (by exact GuardInstructionWindow.get 199)]
...
private theorem run_byte_prefix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 3842 .JUMPDEST (by exact GuardInstructionWindow.get 185)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3842 4863 [] (by norm_num) (GuardInstructionWindow.pc 185))
    (PatternedScan.stepS_jumpdest input 4863 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3843 1 7 (by exact GuardInstructionWindow.get 186)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3843 4864 [] (by norm_num) (GuardInstructionWindow.pc 186))
    (PatternedScan.stepS_push input 4864 1 7 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 3844 0 0 (by exact GuardInstructionWindow.get 187)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3844 4866 [7] (by norm_num) (GuardInstructionWindow.pc 187))
    (PatternedScan.stepS_push0 input 4866 [7] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.opAt 3845 .CALLDATALOAD (by exact GuardInstructionWindow.get 188)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3845 4867 [0, 7] (by norm_num) (GuardInstructionWindow.pc 188))
    (PatternedScan.stepS_calldataload input 4867 0 [7] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.pushAt 3846 0 0 (by exact GuardInstructionWindow.get 189)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3846 4868 [w, 7] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_push0 input 4868 [w, 7] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.opAt 3847 .BYTE (by exact GuardInstructionWindow.get 190)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3847 4869 [0, w, 7] (by norm_num) (GuardInstructionWindow.pc 190))
    (PatternedScan.stepS_byte input 4869 0 w [7] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3848 .XOR (by exact GuardInstructionWindow.get 191)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3848 4870 [b, 7] (by norm_num) (GuardInstructionWindow.pc 191))
    (PatternedScan.stepS_xor input 4870 b 7 [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3849 2 4901 (by exact GuardInstructionWindow.get 192)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3849 4871 [v] (by norm_num) (GuardInstructionWindow.pc 192))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3851 = 4875 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3851 = 4875 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3852 = 4893 := by
  exact GuardInstructionWindow.pc 195

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3853 = 4894 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3854 = 4895 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3855 = 4897 := by
  exact GuardInstructionWindow.pc 198

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3856 = 4898 := by
  exact GuardInstructionWindow.pc 199

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3857 = 4900 := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3850 .JUMPI (by exact GuardInstructionWindow.get 193)] (PatternedScan.stS input 4874 [4901, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3850 .JUMPI (by exact GuardInstructionWindow.get 193))
    (PatternedScan.pcFactS input 3850 4874 [4901, byteValue input] (by norm_num) (GuardInstructionWindow.pc 193))
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3850 .JUMPI (by exact GuardInstructionWindow.get 193)] (PatternedScan.stS input 4874 [4901, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4875 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3850 .JUMPI (by exact GuardInstructionWindow.get 193))
    (PatternedScan.pcFactS input 3850 4874 [4901, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 193))
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3857 .JUMPI (by exact GuardInstructionWindow.get 200)]
      (PatternedScan.stS input 4900 [115, sizeBit input]) =
      some (PatternedScan.stS input 115 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3857 .JUMPI (by exact GuardInstructionWindow.get 200))
    (PatternedScan.pcFactS input 3857 4900 [115, sizeBit input] (by norm_num) sizeHitPC4111)
