...
private def guardCheckPath : List Located :=
  [DirectGuard.opAt 4112 .JUMPDEST,
   ...
   DirectGuard.pushAt 4114 2 128,
   DirectGuard.opAt 4115 .XOR,
   DirectGuard.pushAt 4116 0 0,
   DirectGuard.opAt 4117 .CALLDATALOAD,
   DirectGuard.pushAt 4118 0 0,
   DirectGuard.opAt 4119 .BYTE,
   DirectGuard.pushAt 4120 2 7,
   DirectGuard.opAt 4121 .XOR,
   DirectGuard.opAt 4122 .OR,
   DirectGuard.pushAt 4123 2 368,
   DirectGuard.opAt 4124 .JUMPI]

private def guardMatchSuffix : List Located :=
  [DirectGuard.pushAt 4125 0 0,
   DirectGuard.pushAt 4126 1 101,
   DirectGuard.opAt 4127 .JUMP]
