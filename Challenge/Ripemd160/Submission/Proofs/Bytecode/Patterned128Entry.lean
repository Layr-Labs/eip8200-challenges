...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3890 .JUMPDEST,
   ...
   DirectGuard.pushAt 3897 2 5043]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3899 0 0,
   DirectGuard.pushAt 3900 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 3901 .CALLDATASIZE,
   DirectGuard.opAt 3902 .SHR,
   DirectGuard.pushAt 3903 1 1,
   DirectGuard.opAt 3904 .AND,
   DirectGuard.pushAt 3905 1 106]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3907 .POP,
   DirectGuard.pushAt 3908 2 272,
   DirectGuard.opAt 3909 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4680 []) =
      some (PatternedScan.stS input 4691 [5043, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3890 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3890 4680 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4680 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3891 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3891 4681 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4681 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3892 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3892 4682 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4682 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3893 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3893 4683 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4683 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3894 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3894 4684 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4684 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3895 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3895 4685 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4685 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3896 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3896 4687 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4687 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3897 2 5043
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3897 4688 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4688 2 5043 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3899 = 4692 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3900 = 4693 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3901 = 4711 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3902 = 4712 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3903 = 4713 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3904 = 4715 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3905 = 4716 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3906 = 4718 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3907 = 4719 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3908 = 4720 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3909 = 4723 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4692 []) =
      some (PatternedScan.stS input 4718 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3898 .JUMPI] (PatternedScan.stS input 4691 [5043, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3898 .JUMPI)
    (PatternedScan.pcFactS input 3898 4691 [5043, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4691 5043 5043 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3898 .JUMPI] (PatternedScan.stS input 4691 [5043, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4692 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3898 .JUMPI)
    (PatternedScan.pcFactS input 3898 4691 [5043, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4691 5043 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3906 .JUMPI]
      (PatternedScan.stS input 4718 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3906 .JUMPI)
    (PatternedScan.pcFactS input 3906 4718 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4718 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3906 .JUMPI]
      (PatternedScan.stS input 4718 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4719 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3906 .JUMPI)
    (PatternedScan.pcFactS input 3906 4718 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4718 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4719 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3907 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3907 4719 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4719 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3908 2 272
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3908 4720 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4720 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3909 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3909 4723 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4723 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4692 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4692 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4692 []) (PatternedScan.patternedEntry input) := by
