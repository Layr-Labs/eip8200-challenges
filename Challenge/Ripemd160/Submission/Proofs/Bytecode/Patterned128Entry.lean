...
Entered at pc 4833 when the first calldata byte is 7, or when a short or
...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3640 = 4821 := J2EntryWindow.pc 0
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3641 = 4822 := J2EntryWindow.pc 1
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3647 = 4847 := J2EntryWindow.pc 7
private theorem packedPC3735 : Artifact.submissionArtifact.instructionPC 3648 = 4848 := J2EntryWindow.pc 8
private theorem packedPC3736 : Artifact.submissionArtifact.instructionPC 3649 = 4851 := J2EntryWindow.pc 9
private theorem packedPC3737 : Artifact.submissionArtifact.instructionPC 3650 = 4857 := J2EntryWindow.pc 10
private theorem packedPC3738 : Artifact.submissionArtifact.instructionPC 3651 = 4858 := J2EntryWindow.pc 11
private theorem packedPC3739 : Artifact.submissionArtifact.instructionPC 3652 = 4860 := J2EntryWindow.pc 12
private theorem packedPC3740 : Artifact.submissionArtifact.instructionPC 3653 = 4861 := J2EntryWindow.pc 13
private theorem packedPC3741 : Artifact.submissionArtifact.instructionPC 3654 = 4862 := J2EntryWindow.pc 14
private theorem packedPC3742 : Artifact.submissionArtifact.instructionPC 3655 = 4863 := J2EntryWindow.pc 15
private theorem packedPC3743 : Artifact.submissionArtifact.instructionPC 3656 = 4864 := J2EntryWindow.pc 16
private theorem packedPC3744 : Artifact.submissionArtifact.instructionPC 3657 = 4865 := J2EntryWindow.pc 17
private theorem packedPC3745 : Artifact.submissionArtifact.instructionPC 3658 = 4867 := J2EntryWindow.pc 18

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3642 = 4824 :=
  J2EntryWindow.pc 2
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3643 = 4842 :=
  J2EntryWindow.pc 3
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3644 = 4843 :=
  J2EntryWindow.pc 4
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3645 = 4844 :=
  J2EntryWindow.pc 5
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3646 = 4845 :=
  J2EntryWindow.pc 6

/-! ## The size mask -/

private def maskEntry : List Located :=
  [DirectGuard.opAt 3640 .JUMPDEST (by exact J2EntryWindow.get 0)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3641 1 1 (by exact J2EntryWindow.get 1),
   DirectGuard.pushAt 3642 17 342276208914615837337402008677671501826 (by exact J2EntryWindow.get 2),
   DirectGuard.opAt 3643 .CALLDATASIZE (by exact J2EntryWindow.get 3),
   DirectGuard.opAt 3644 .SHR (by exact J2EntryWindow.get 4),
   DirectGuard.opAt 3645 .AND (by exact J2EntryWindow.get 5),
   DirectGuard.pushAt 3646 1 122 (by exact J2EntryWindow.get 6)]

private def maskJump : List Located :=
  [DirectGuard.opAt 3647 .JUMPI (by exact J2EntryWindow.get 7)]
...
private theorem run_mask_entry (input : ByteArray) :
    DirectGuard.run maskEntry (PatternedScan.stS input 4821 []) =
      some (PatternedScan.stS input 4822 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3640 4821 [] (by norm_num) pc3836)
    (PatternedScan.stepS_jumpdest input 4821 [] (by simp) (by norm_num))

private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4822 []) =
      some (PatternedScan.stS input 4847 [122, sizeBit input]) := by
  have hpc : Artifact.submissionArtifact.instructionPC 3641 = 4822 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4847 [122, sizeBit input]) =
      some (PatternedScan.stS input 122 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3647 4847 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_taken input 4847 122 122 (sizeBit input) []
...
private theorem run_mask_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4847 [122, sizeBit input]) =
      some (PatternedScan.stS input 4848 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3647 4847 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_fall input 4847 122 (sizeBit input) []
...
private def gasSteps_mask_prefix (input : ByteArray) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4847 [122, sizeBit input]) :=
...
private def lengthPrefix : List Located :=
  [DirectGuard.pushAt 3648 2 1016 (by exact J2EntryWindow.get 8),
   DirectGuard.pushAt 3649 5 6308489473 (by exact J2EntryWindow.get 9),
   DirectGuard.opAt 3650 .CALLDATASIZE (by exact J2EntryWindow.get 10),
   DirectGuard.pushAt 3651 1 24 (by exact J2EntryWindow.get 11),
   DirectGuard.opAt 3652 .AND (by exact J2EntryWindow.get 12),
   DirectGuard.opAt 3653 .SHR (by exact J2EntryWindow.get 13),
   DirectGuard.opAt 3654 .AND (by exact J2EntryWindow.get 14),
   DirectGuard.opAt 3655 .CALLDATASIZE (by exact J2EntryWindow.get 15),
   DirectGuard.opAt 3656 .EQ (by exact J2EntryWindow.get 16),
   DirectGuard.pushAt 3657 1 122 (by exact J2EntryWindow.get 17)]

private def lengthJump : List Located :=
  [DirectGuard.opAt 3658 .JUMPI (by exact J2EntryWindow.get 18)]

private theorem run_length_prefix (input : ByteArray) :
    DirectGuard.run lengthPrefix (PatternedScan.stS input 4848 []) =
      some (PatternedScan.stS input 4867 [122, lengthCond input]) := by
...
private def gasSteps_length_match (input : ByteArray)
  ...
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4867 [122, lengthCond input]) =
      some (PatternedScan.stS input 122 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3658 4867 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_taken input 4867 122 122 (lengthCond input) []
...
private def gasSteps_length_fail (input : ByteArray) (hfit : CalldataFits input)
    (h256 : input.size ≠ 256) (h376 : input.size ≠ 376) (h1000 : input.size ≠ 1000) :
    GasSteps (PatternedScan.stS input 4848 []) (AbcArm.armEntry input) := by
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4867 [122, lengthCond input]) =
      some (AbcArm.armEntry input) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3658 4867 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_fall input 4867 122 (lengthCond input) []
