...
@[simp] private theorem entryPC4146 : Artifact.submissionArtifact.instructionPC 4144 = 5144 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4147 : Artifact.submissionArtifact.instructionPC 4145 = 5145 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4148 : Artifact.submissionArtifact.instructionPC 4146 = 5146 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4149 : Artifact.submissionArtifact.instructionPC 4147 = 5147 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4150 : Artifact.submissionArtifact.instructionPC 4148 = 5148 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4151 : Artifact.submissionArtifact.instructionPC 4149 = 5150 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4152 : Artifact.submissionArtifact.instructionPC 4150 = 5151 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4153 : Artifact.submissionArtifact.instructionPC 4151 = 5152 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4154 : Artifact.submissionArtifact.instructionPC 4152 = 5153 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4155 : Artifact.submissionArtifact.instructionPC 4153 = 5156 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4156 : Artifact.submissionArtifact.instructionPC 4154 = 5157 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4157 : Artifact.submissionArtifact.instructionPC 4155 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4158 : Artifact.submissionArtifact.instructionPC 4156 = 5160 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
@[simp] private theorem entryPC4169 : Artifact.submissionArtifact.instructionPC 4134 = 5132 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4170 : Artifact.submissionArtifact.instructionPC 4135 = 5133 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4171 : Artifact.submissionArtifact.instructionPC 4136 = 5134 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4172 : Artifact.submissionArtifact.instructionPC 4137 = 5136 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4173 : Artifact.submissionArtifact.instructionPC 4138 = 5137 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4174 : Artifact.submissionArtifact.instructionPC 4139 = 5138 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4175 : Artifact.submissionArtifact.instructionPC 4140 = 5139 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4176 : Artifact.submissionArtifact.instructionPC 4141 = 5141 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4177 : Artifact.submissionArtifact.instructionPC 4142 = 5142 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4178 : Artifact.submissionArtifact.instructionPC 4143 = 5143 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private def guardSizePath : List Located :=
  [DirectGuard.opAt 4131 .JUMPDEST,
   DirectGuard.opAt 4132 .CALLDATASIZE,
   DirectGuard.pushAt 4133 1 56,
   DirectGuard.opAt 4134 .EQ,
   DirectGuard.opAt 4135 .CALLDATASIZE,
   DirectGuard.pushAt 4136 1 120,
   DirectGuard.opAt 4137 .EQ,
   DirectGuard.opAt 4138 .OR,
   DirectGuard.opAt 4139 .CALLDATASIZE,
   DirectGuard.pushAt 4140 1 128,
   DirectGuard.opAt 4141 .EQ,
   DirectGuard.opAt 4142 .OR,
   DirectGuard.opAt 4143 .ISZERO]

private def guardBytePrefix : List Located :=
  [DirectGuard.pushAt 4144 0 0,
   DirectGuard.opAt 4145 .CALLDATALOAD,
   DirectGuard.pushAt 4146 0 0,
   DirectGuard.opAt 4147 .BYTE,
   DirectGuard.pushAt 4148 1 7,
   DirectGuard.opAt 4149 .EQ,
   DirectGuard.opAt 4150 .ISZERO,
   DirectGuard.opAt 4151 .OR,
   DirectGuard.pushAt 4152 2 368]

private def guardBytePath : List Located := guardBytePrefix ++ [DirectGuard.opAt 4153 .JUMPI]
...
private def guardMatchSuffix : List Located :=
  [DirectGuard.pushAt 4154 0 0,
   DirectGuard.pushAt 4155 1 101,
   DirectGuard.opAt 4156 .JUMP]
...
private theorem run_guard_size (input : ByteArray) :
  ...
  let l2 : Located := DirectGuard.pushAt 4133 1 56
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4133 5130 [(UInt256.ofNat input.size)] (by norm_num) entryPC4168)
  ...
  let l3 : Located := DirectGuard.opAt 4134 .EQ
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4134 5132 [(56 : UInt256), (UInt256.ofNat input.size)] (by norm_num) entryPC4169)
    (PatternedScan.stepS_eq input 5132 (56 : UInt256) (UInt256.ofNat input.size) [] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4135 .CALLDATASIZE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4135 5133 [v3] (by norm_num) entryPC4170)
    (PatternedScan.stepS_calldatasize input 5133 [v3] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4136 1 120
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4136 5134 [(UInt256.ofNat input.size), v3] (by norm_num) entryPC4171)
  ...
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4137 5136 [(120 : UInt256), (UInt256.ofNat input.size), v3] (by norm_num) entryPC4172)
  ...
  let l7 : Located := DirectGuard.opAt 4138 .OR
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4138 5137 [v6, v3] (by norm_num) entryPC4173)
    (PatternedScan.stepS_or input 5137 v6 v3 [] (by simp) (by norm_num))
  let l8 : Located := DirectGuard.opAt 4139 .CALLDATASIZE
  have h8 := PatternedScan.blockOfS l8
    (PatternedScan.pcFactS input 4139 5138 [v7] (by norm_num) entryPC4174)
    (PatternedScan.stepS_calldatasize input 5138 [v7] (by simp) (by norm_num))
  let l9 : Located := DirectGuard.pushAt 4140 1 128
  have h9 := PatternedScan.blockOfS l9
    (PatternedScan.pcFactS input 4140 5139 [(UInt256.ofNat input.size), v7] (by norm_num) entryPC4175)
  ...
  let l10 : Located := DirectGuard.opAt 4141 .EQ
  have h10 := PatternedScan.blockOfS l10
    (PatternedScan.pcFactS input 4141 5141 [(128 : UInt256), (UInt256.ofNat input.size), v7] (by norm_num) entryPC4176)
  ...
  let l11 : Located := DirectGuard.opAt 4142 .OR
  have h11 := PatternedScan.blockOfS l11
    (PatternedScan.pcFactS input 4142 5142 [v10, v7] (by norm_num) entryPC4177)
    (PatternedScan.stepS_or input 5142 v10 v7 [] (by simp) (by norm_num))
  let v12 : UInt256 := UInt256.isZero v11
  let l12 : Located := DirectGuard.opAt 4143 .ISZERO
  have h12 := PatternedScan.blockOfS l12
    (PatternedScan.pcFactS input 4143 5143 [v11] (by norm_num) entryPC4178)
...
private theorem run_guard_byte_prefix (input : ByteArray) (flag : UInt256) :
  ...
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4144 0 0)
    (PatternedScan.pcFactS input 4144 5144 [flag] (by norm_num) entryPC4146)
    (PatternedScan.stepS_push0 input 5144 [flag] (by simp) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4145 .CALLDATALOAD)
    (PatternedScan.pcFactS input 4145 5145 [0, flag] (by norm_num) entryPC4147)
    (PatternedScan.stepS_calldataload input 5145 0 [flag] (by simp) (by norm_num))
  have h3 := PatternedScan.blockOfS (DirectGuard.pushAt 4146 0 0)
    (PatternedScan.pcFactS input 4146 5146 [w, flag] (by norm_num) entryPC4148)
    (PatternedScan.stepS_push0 input 5146 [w, flag] (by simp) (by norm_num))
  have h4 := PatternedScan.blockOfS (DirectGuard.opAt 4147 .BYTE)
    (PatternedScan.pcFactS input 4147 5147 [0, w, flag] (by norm_num) entryPC4149)
    (PatternedScan.stepS_byte input 5147 0 w [flag] (by simp) (by norm_num))
  have h5 := PatternedScan.blockOfS (DirectGuard.pushAt 4148 1 7)
    (PatternedScan.pcFactS input 4148 5148 [b, flag] (by norm_num) entryPC4150)
    (PatternedScan.stepS_push input 5148 1 7 [b, flag] (by simp) (by decide) (by decide) (by norm_num))
  have h6 := PatternedScan.blockOfS (DirectGuard.opAt 4149 .EQ)
    (PatternedScan.pcFactS input 4149 5150 [7, b, flag] (by norm_num) entryPC4151)
    (PatternedScan.stepS_eq input 5150 7 b [flag] (by simp) (by norm_num))
  have h7 := PatternedScan.blockOfS (DirectGuard.opAt 4150 .ISZERO)
    (PatternedScan.pcFactS input 4150 5151 [e, flag] (by norm_num) entryPC4152)
    (PatternedScan.stepS_iszero input 5151 e [flag] (by simp) (by norm_num))
  have h8 := PatternedScan.blockOfS (DirectGuard.opAt 4151 .OR)
    (PatternedScan.pcFactS input 4151 5152 [z, flag] (by norm_num) entryPC4153)
    (PatternedScan.stepS_or input 5152 z flag [] (by simp) (by norm_num))
  have h9 := PatternedScan.blockOfS (DirectGuard.pushAt 4152 2 368)
    (PatternedScan.pcFactS input 4152 5153 [f] (by norm_num) entryPC4154)
  ...
  have a2 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0] [DirectGuard.opAt 4145 .CALLDATALOAD] _ _ _ h1 rfl h2
  have a3 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0, DirectGuard.opAt 4145 .CALLDATALOAD] [DirectGuard.pushAt 4146 0 0] _ _ _ a2 rfl h3
  have a4 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0, DirectGuard.opAt 4145 .CALLDATALOAD, DirectGuard.pushAt 4146 0 0] [DirectGuard.opAt 4147 .BYTE] _ _ _ a3 rfl h4
  have a5 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0, DirectGuard.opAt 4145 .CALLDATALOAD, DirectGuard.pushAt 4146 0 0, DirectGuard.opAt 4147 .BYTE] [DirectGuard.pushAt 4148 1 7] _ _ _ a4 rfl h5
  have a6 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0, DirectGuard.opAt 4145 .CALLDATALOAD, DirectGuard.pushAt 4146 0 0, DirectGuard.opAt 4147 .BYTE, DirectGuard.pushAt 4148 1 7] [DirectGuard.opAt 4149 .EQ] _ _ _ a5 rfl h6
  have a7 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0, DirectGuard.opAt 4145 .CALLDATALOAD, DirectGuard.pushAt 4146 0 0, DirectGuard.opAt 4147 .BYTE, DirectGuard.pushAt 4148 1 7, DirectGuard.opAt 4149 .EQ] [DirectGuard.opAt 4150 .ISZERO] _ _ _ a6 rfl h7
  have a8 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0, DirectGuard.opAt 4145 .CALLDATALOAD, DirectGuard.pushAt 4146 0 0, DirectGuard.opAt 4147 .BYTE, DirectGuard.pushAt 4148 1 7, DirectGuard.opAt 4149 .EQ, DirectGuard.opAt 4150 .ISZERO] [DirectGuard.opAt 4151 .OR] _ _ _ a7 rfl h8
  have a9 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4144 0 0, DirectGuard.opAt 4145 .CALLDATALOAD, DirectGuard.pushAt 4146 0 0, DirectGuard.opAt 4147 .BYTE, DirectGuard.pushAt 4148 1 7, DirectGuard.opAt 4149 .EQ, DirectGuard.opAt 4150 .ISZERO, DirectGuard.opAt 4151 .OR] [DirectGuard.pushAt 4152 2 368] _ _ _ a8 rfl h9
...
private theorem run_guard_byte_fail (input : ByteArray) (flag : UInt256)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4153 .JUMPI)
    (PatternedScan.pcFactS input 4153 5156 [368, byteFlag input flag] (by norm_num) entryPC4155)
  ...
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4153 .JUMPI] _ _ _ (run_guard_byte_prefix input flag) rfl hj
...
private theorem run_guard_byte_match (input : ByteArray)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4153 .JUMPI)
    (PatternedScan.pcFactS input 4153 5156 [368, UInt256.ofNat 0] (by norm_num) entryPC4155)
    (PatternedScan.stepS_jumpi_fall input 5156 368 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))
  have h0 := PatternedScan.blockOfS (DirectGuard.pushAt 4154 0 0)
    (PatternedScan.pcFactS input 4154 5157 [] (by norm_num) entryPC4156)
    (PatternedScan.stepS_push0 input 5157 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4155 1 101)
    (PatternedScan.pcFactS input 4155 5158 [0] (by norm_num) entryPC4157)
    (PatternedScan.stepS_push input 5158 1 101 [0] (by simp) (by decide) (by decide) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4156 .JUMP)
    (PatternedScan.pcFactS input 4156 5160 [101, 0] (by norm_num) entryPC4158)
  ...
  have hpj := Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4153 .JUMPI] _ _ _ hprefix rfl hj
  have h01 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4154 0 0] [DirectGuard.pushAt 4155 1 101] _ _ _ h0 rfl h1
  have hs := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4154 0 0, DirectGuard.pushAt 4155 1 101]
    [DirectGuard.opAt 4156 .JUMP] _ _ _ h01 rfl h2
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
