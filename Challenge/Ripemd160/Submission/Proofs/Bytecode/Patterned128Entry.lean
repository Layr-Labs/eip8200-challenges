...
@[simp] private theorem entryPC4146 : Artifact.submissionArtifact.instructionPC 4145 = 5144 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4147 : Artifact.submissionArtifact.instructionPC 4146 = 5145 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4148 : Artifact.submissionArtifact.instructionPC 4147 = 5146 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4149 : Artifact.submissionArtifact.instructionPC 4148 = 5147 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4150 : Artifact.submissionArtifact.instructionPC 4149 = 5148 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4151 : Artifact.submissionArtifact.instructionPC 4150 = 5150 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4152 : Artifact.submissionArtifact.instructionPC 4151 = 5151 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4153 : Artifact.submissionArtifact.instructionPC 4152 = 5152 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4154 : Artifact.submissionArtifact.instructionPC 4153 = 5153 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4155 : Artifact.submissionArtifact.instructionPC 4154 = 5156 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4156 : Artifact.submissionArtifact.instructionPC 4155 = 5157 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4157 : Artifact.submissionArtifact.instructionPC 4156 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4158 : Artifact.submissionArtifact.instructionPC 4157 = 5160 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4166 : Artifact.submissionArtifact.instructionPC 4132 = 5128 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4167 : Artifact.submissionArtifact.instructionPC 4133 = 5129 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4168 : Artifact.submissionArtifact.instructionPC 4134 = 5130 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4169 : Artifact.submissionArtifact.instructionPC 4135 = 5132 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4170 : Artifact.submissionArtifact.instructionPC 4136 = 5133 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4171 : Artifact.submissionArtifact.instructionPC 4137 = 5134 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4172 : Artifact.submissionArtifact.instructionPC 4138 = 5136 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4173 : Artifact.submissionArtifact.instructionPC 4139 = 5137 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4174 : Artifact.submissionArtifact.instructionPC 4140 = 5138 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4175 : Artifact.submissionArtifact.instructionPC 4141 = 5139 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4176 : Artifact.submissionArtifact.instructionPC 4142 = 5141 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4177 : Artifact.submissionArtifact.instructionPC 4143 = 5142 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4178 : Artifact.submissionArtifact.instructionPC 4144 = 5143 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private def guardSizePath : List Located :=
  [DirectGuard.opAt 4132 .JUMPDEST,
   DirectGuard.opAt 4133 .CALLDATASIZE,
   DirectGuard.pushAt 4134 1 56,
   DirectGuard.opAt 4135 .EQ,
   DirectGuard.opAt 4136 .CALLDATASIZE,
   DirectGuard.pushAt 4137 1 120,
   DirectGuard.opAt 4138 .EQ,
   DirectGuard.opAt 4139 .OR,
   DirectGuard.opAt 4140 .CALLDATASIZE,
   DirectGuard.pushAt 4141 1 128,
   DirectGuard.opAt 4142 .EQ,
...
private theorem run_guard_size (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 4132 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4132 5128 [] (by norm_num) entryPC4166)
    (PatternedScan.stepS_jumpdest input 5128 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.opAt 4133 .CALLDATASIZE
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4133 5129 [] (by norm_num) entryPC4167)
    (PatternedScan.stepS_calldatasize input 5129 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 4134 1 56
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4134 5130 [(UInt256.ofNat input.size)] (by norm_num) entryPC4168)
    (PatternedScan.stepS_push input 5130 1 56 [(UInt256.ofNat input.size)] (by simp) (by decide) (by decide) (by norm_num))
  let v3 : UInt256 := UInt256.eq (56 : UInt256) (UInt256.ofNat input.size)
  let l3 : Located := DirectGuard.opAt 4135 .EQ
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4135 5132 [(56 : UInt256), (UInt256.ofNat input.size)] (by norm_num) entryPC4169)
    (PatternedScan.stepS_eq input 5132 (56 : UInt256) (UInt256.ofNat input.size) [] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4136 .CALLDATASIZE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4136 5133 [v3] (by norm_num) entryPC4170)
    (PatternedScan.stepS_calldatasize input 5133 [v3] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4137 1 120
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4137 5134 [(UInt256.ofNat input.size), v3] (by norm_num) entryPC4171)
    (PatternedScan.stepS_push input 5134 1 120 [(UInt256.ofNat input.size), v3] (by simp) (by decide) (by decide) (by norm_num))
  let v6 : UInt256 := UInt256.eq (120 : UInt256) (UInt256.ofNat input.size)
  let l6 : Located := DirectGuard.opAt 4138 .EQ
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4138 5136 [(120 : UInt256), (UInt256.ofNat input.size), v3] (by norm_num) entryPC4172)
    (PatternedScan.stepS_eq input 5136 (120 : UInt256) (UInt256.ofNat input.size) [v3] (by simp) (by norm_num))
  let v7 : UInt256 := UInt256.lor v6 v3
  let l7 : Located := DirectGuard.opAt 4139 .OR
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4139 5137 [v6, v3] (by norm_num) entryPC4173)
    (PatternedScan.stepS_or input 5137 v6 v3 [] (by simp) (by norm_num))
  let l8 : Located := DirectGuard.opAt 4140 .CALLDATASIZE
  have h8 := PatternedScan.blockOfS l8
    (PatternedScan.pcFactS input 4140 5138 [v7] (by norm_num) entryPC4174)
    (PatternedScan.stepS_calldatasize input 5138 [v7] (by simp) (by norm_num))
  let l9 : Located := DirectGuard.pushAt 4141 1 128
  have h9 := PatternedScan.blockOfS l9
    (PatternedScan.pcFactS input 4141 5139 [(UInt256.ofNat input.size), v7] (by norm_num) entryPC4175)
    (PatternedScan.stepS_push input 5139 1 128 [(UInt256.ofNat input.size), v7] (by simp) (by decide) (by decide) (by norm_num))
  let v10 : UInt256 := UInt256.eq (128 : UInt256) (UInt256.ofNat input.size)
  let l10 : Located := DirectGuard.opAt 4142 .EQ
  have h10 := PatternedScan.blockOfS l10
    (PatternedScan.pcFactS input 4142 5141 [(128 : UInt256), (UInt256.ofNat input.size), v7] (by norm_num) entryPC4176)
    (PatternedScan.stepS_eq input 5141 (128 : UInt256) (UInt256.ofNat input.size) [v7] (by simp) (by norm_num))
  let v11 : UInt256 := UInt256.lor v10 v7
  let l11 : Located := DirectGuard.opAt 4143 .OR
  have h11 := PatternedScan.blockOfS l11
    (PatternedScan.pcFactS input 4143 5142 [v10, v7] (by norm_num) entryPC4177)
    (PatternedScan.stepS_or input 5142 v10 v7 [] (by simp) (by norm_num))
  let v12 : UInt256 := UInt256.isZero v11
  let l12 : Located := DirectGuard.opAt 4144 .ISZERO
  have h12 := PatternedScan.blockOfS l12
    (PatternedScan.pcFactS input 4144 5143 [v11] (by norm_num) entryPC4178)
    (PatternedScan.stepS_iszero input 5143 v11 [] (by simp) (by norm_num))
  ...
  have h7_13 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [l7, l8, l9, l10] [l11, l12] _ _ _ h7_11 rfl h11_13
  have h0_13 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [l0, l1, l2, l3, l4, l5, l6] [l7, l8, l9, l10, l11, l12] _ _ _ h0_7 rfl h7_13
  have hv : v12 = sizeFlag input := by
    simp only [sizeFlag, v3, v6, v7, v10, v11, v12, Challenge.EvmProof.Word.literal_eq_ofNat]
  rw [show UInt256.isZero v11 = sizeFlag input from hv] at h0_13
  exact h0_13
...
private theorem run_guard_byte_prefix (input : ByteArray) (flag : UInt256) :
  ...
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4145 0 0)
    (PatternedScan.pcFactS input 4145 5144 [flag] (by norm_num) entryPC4146)
  ...
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4146 .CALLDATALOAD)
    (PatternedScan.pcFactS input 4146 5145 [0, flag] (by norm_num) entryPC4147)
  ...
  have h3 := PatternedScan.blockOfS (DirectGuard.pushAt 4147 0 0)
    (PatternedScan.pcFactS input 4147 5146 [w, flag] (by norm_num) entryPC4148)
    (PatternedScan.stepS_push0 input 5146 [w, flag] (by simp) (by norm_num))
  have h4 := PatternedScan.blockOfS (DirectGuard.opAt 4148 .BYTE)
    (PatternedScan.pcFactS input 4148 5147 [0, w, flag] (by norm_num) entryPC4149)
  ...
  have h5 := PatternedScan.blockOfS (DirectGuard.pushAt 4149 1 7)
    (PatternedScan.pcFactS input 4149 5148 [b, flag] (by norm_num) entryPC4150)
    (PatternedScan.stepS_push input 5148 1 7 [b, flag] (by simp) (by decide) (by decide) (by norm_num))
  have h6 := PatternedScan.blockOfS (DirectGuard.opAt 4150 .EQ)
    (PatternedScan.pcFactS input 4150 5150 [7, b, flag] (by norm_num) entryPC4151)
    (PatternedScan.stepS_eq input 5150 7 b [flag] (by simp) (by norm_num))
  have h7 := PatternedScan.blockOfS (DirectGuard.opAt 4151 .ISZERO)
    (PatternedScan.pcFactS input 4151 5151 [e, flag] (by norm_num) entryPC4152)
    (PatternedScan.stepS_iszero input 5151 e [flag] (by simp) (by norm_num))
  have h8 := PatternedScan.blockOfS (DirectGuard.opAt 4152 .OR)
    (PatternedScan.pcFactS input 4152 5152 [z, flag] (by norm_num) entryPC4153)
    (PatternedScan.stepS_or input 5152 z flag [] (by simp) (by norm_num))
  have h9 := PatternedScan.blockOfS (DirectGuard.pushAt 4153 2 368)
    (PatternedScan.pcFactS input 4153 5153 [f] (by norm_num) entryPC4154)
  ...
  have a2 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0] [DirectGuard.opAt 4146 .CALLDATALOAD] _ _ _ h1 rfl h2
  have a3 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0, DirectGuard.opAt 4146 .CALLDATALOAD] [DirectGuard.pushAt 4147 0 0] _ _ _ a2 rfl h3
  have a4 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0, DirectGuard.opAt 4146 .CALLDATALOAD, DirectGuard.pushAt 4147 0 0] [DirectGuard.opAt 4148 .BYTE] _ _ _ a3 rfl h4
  have a5 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0, DirectGuard.opAt 4146 .CALLDATALOAD, DirectGuard.pushAt 4147 0 0, DirectGuard.opAt 4148 .BYTE] [DirectGuard.pushAt 4149 1 7] _ _ _ a4 rfl h5
  have a6 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0, DirectGuard.opAt 4146 .CALLDATALOAD, DirectGuard.pushAt 4147 0 0, DirectGuard.opAt 4148 .BYTE, DirectGuard.pushAt 4149 1 7] [DirectGuard.opAt 4150 .EQ] _ _ _ a5 rfl h6
  have a7 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0, DirectGuard.opAt 4146 .CALLDATALOAD, DirectGuard.pushAt 4147 0 0, DirectGuard.opAt 4148 .BYTE, DirectGuard.pushAt 4149 1 7, DirectGuard.opAt 4150 .EQ] [DirectGuard.opAt 4151 .ISZERO] _ _ _ a6 rfl h7
  have a8 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0, DirectGuard.opAt 4146 .CALLDATALOAD, DirectGuard.pushAt 4147 0 0, DirectGuard.opAt 4148 .BYTE, DirectGuard.pushAt 4149 1 7, DirectGuard.opAt 4150 .EQ, DirectGuard.opAt 4151 .ISZERO] [DirectGuard.opAt 4152 .OR] _ _ _ a7 rfl h8
  have a9 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4145 0 0, DirectGuard.opAt 4146 .CALLDATALOAD, DirectGuard.pushAt 4147 0 0, DirectGuard.opAt 4148 .BYTE, DirectGuard.pushAt 4149 1 7, DirectGuard.opAt 4150 .EQ, DirectGuard.opAt 4151 .ISZERO, DirectGuard.opAt 4152 .OR] [DirectGuard.pushAt 4153 2 368] _ _ _ a8 rfl h9
...
private theorem run_guard_byte_fail (input : ByteArray) (flag : UInt256)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4154 .JUMPI)
    (PatternedScan.pcFactS input 4154 5156 [368, byteFlag input flag] (by norm_num) entryPC4155)
...
private theorem run_guard_byte_match (input : ByteArray)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4154 .JUMPI)
    (PatternedScan.pcFactS input 4154 5156 [368, UInt256.ofNat 0] (by norm_num) entryPC4155)
  ...
  have h0 := PatternedScan.blockOfS (DirectGuard.pushAt 4155 0 0)
    (PatternedScan.pcFactS input 4155 5157 [] (by norm_num) entryPC4156)
    (PatternedScan.stepS_push0 input 5157 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4156 1 101)
    (PatternedScan.pcFactS input 4156 5158 [0] (by norm_num) entryPC4157)
  ...
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4157 .JUMP)
    (PatternedScan.pcFactS input 4157 5160 [101, 0] (by norm_num) entryPC4158)
