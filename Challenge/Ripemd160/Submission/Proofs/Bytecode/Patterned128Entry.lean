...
Entered at pc 4831 when the first calldata byte is 7, or when a short or
...
@[simp] private theorem entryPC61 : Artifact.submissionArtifact.instructionPC 73 = 122 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

private theorem guard_match_dest : Decode.isValidJumpDest submissionBytecode 122 = true :=
...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3624 = 4819 := J2EntryWindow.pc 0
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3625 = 4820 := J2EntryWindow.pc 1
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3631 = 4845 := J2EntryWindow.pc 7
private theorem packedPC3735 : Artifact.submissionArtifact.instructionPC 3632 = 4846 := J2EntryWindow.pc 8
private theorem packedPC3736 : Artifact.submissionArtifact.instructionPC 3633 = 4849 := J2EntryWindow.pc 9
private theorem packedPC3737 : Artifact.submissionArtifact.instructionPC 3634 = 4855 := J2EntryWindow.pc 10
private theorem packedPC3738 : Artifact.submissionArtifact.instructionPC 3635 = 4856 := J2EntryWindow.pc 11
private theorem packedPC3739 : Artifact.submissionArtifact.instructionPC 3636 = 4858 := J2EntryWindow.pc 12
private theorem packedPC3740 : Artifact.submissionArtifact.instructionPC 3637 = 4859 := J2EntryWindow.pc 13
private theorem packedPC3741 : Artifact.submissionArtifact.instructionPC 3638 = 4860 := J2EntryWindow.pc 14
private theorem packedPC3742 : Artifact.submissionArtifact.instructionPC 3639 = 4861 := J2EntryWindow.pc 15
private theorem packedPC3743 : Artifact.submissionArtifact.instructionPC 3640 = 4862 := J2EntryWindow.pc 16
private theorem packedPC3744 : Artifact.submissionArtifact.instructionPC 3641 = 4863 := J2EntryWindow.pc 17
private theorem packedPC3745 : Artifact.submissionArtifact.instructionPC 3642 = 4865 := J2EntryWindow.pc 18

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3626 = 4822 :=
  J2EntryWindow.pc 2
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3627 = 4840 :=
  J2EntryWindow.pc 3
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3628 = 4841 :=
  J2EntryWindow.pc 4
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3629 = 4842 :=
  J2EntryWindow.pc 5
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3630 = 4843 :=
  J2EntryWindow.pc 6

/-! ## The size mask -/

private def maskEntry : List Located :=
  [DirectGuard.opAt 3624 .JUMPDEST (by exact J2EntryWindow.get 0)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3625 1 1 (by exact J2EntryWindow.get 1),
   DirectGuard.pushAt 3626 17 342276208914615837337402008677671501826 (by exact J2EntryWindow.get 2),
   DirectGuard.opAt 3627 .CALLDATASIZE (by exact J2EntryWindow.get 3),
   DirectGuard.opAt 3628 .SHR (by exact J2EntryWindow.get 4),
   DirectGuard.opAt 3629 .AND (by exact J2EntryWindow.get 5),
   DirectGuard.pushAt 3630 1 122 (by exact J2EntryWindow.get 6)]

private def maskJump : List Located :=
  [DirectGuard.opAt 3631 .JUMPI (by exact J2EntryWindow.get 7)]

private def guardMatchTail : List Located :=
  [DirectGuard.opAt 73 .JUMPDEST]
...
private theorem run_mask_entry (input : ByteArray) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3624 4819 [] (by norm_num) pc3836)
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4820 []) =
      some (PatternedScan.stS input 4845 [122, sizeBit input]) := by
  have hpc : Artifact.submissionArtifact.instructionPC 3625 = 4820 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4845 [122, sizeBit input]) =
      some (PatternedScan.stS input 122 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3631 4845 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_taken input 4845 122 122 (sizeBit input) []
...
private theorem run_mask_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3631 4845 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_fall input 4845 122 (sizeBit input) []
      (by simp) (by norm_num) hc)

private theorem run_guard_match_tail (input : ByteArray) :
    DirectGuard.run guardMatchTail (PatternedScan.stS input 122 []) =
...
private def gasSteps_mask_prefix (input : ByteArray) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4845 [122, sizeBit input]) :=
...
private def lengthPrefix : List Located :=
  [DirectGuard.pushAt 3632 2 1016 (by exact J2EntryWindow.get 8),
   DirectGuard.pushAt 3633 5 6308489473 (by exact J2EntryWindow.get 9),
   DirectGuard.opAt 3634 .CALLDATASIZE (by exact J2EntryWindow.get 10),
   DirectGuard.pushAt 3635 1 24 (by exact J2EntryWindow.get 11),
   DirectGuard.opAt 3636 .AND (by exact J2EntryWindow.get 12),
   DirectGuard.opAt 3637 .SHR (by exact J2EntryWindow.get 13),
   DirectGuard.opAt 3638 .AND (by exact J2EntryWindow.get 14),
   DirectGuard.opAt 3639 .CALLDATASIZE (by exact J2EntryWindow.get 15),
   DirectGuard.opAt 3640 .EQ (by exact J2EntryWindow.get 16),
   DirectGuard.pushAt 3641 1 122 (by exact J2EntryWindow.get 17)]

private def lengthJump : List Located :=
  [DirectGuard.opAt 3642 .JUMPI (by exact J2EntryWindow.get 18)]

private theorem run_length_prefix (input : ByteArray) :
    DirectGuard.run lengthPrefix (PatternedScan.stS input 4846 []) =
      some (PatternedScan.stS input 4865 [122, lengthCond input]) := by
...
private def gasSteps_length_match (input : ByteArray)
  ...
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4865 [122, lengthCond input]) =
      some (PatternedScan.stS input 122 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3642 4865 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_taken input 4865 122 122 (lengthCond input) []
...
private def gasSteps_length_fail (input : ByteArray) (hfit : CalldataFits input)
  ...
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4865 [122, lengthCond input]) =
    ...
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3642 4865 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_fall input 4865 122 (lengthCond input) []
