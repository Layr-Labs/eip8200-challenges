...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3833 .JUMPDEST (by exact GuardInstructionWindow.get 114),
   DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 115),
   DirectGuard.opAt 3835 .CALLDATALOAD (by exact GuardInstructionWindow.get 116),
   DirectGuard.pushAt 3836 0 0 (by exact GuardInstructionWindow.get 117),
   DirectGuard.opAt 3837 .BYTE (by exact GuardInstructionWindow.get 118),
   DirectGuard.pushAt 3838 1 7 (by exact GuardInstructionWindow.get 119),
   DirectGuard.opAt 3839 .XOR (by exact GuardInstructionWindow.get 120),
   DirectGuard.pushAt 3840 2 5153 (by exact GuardInstructionWindow.get 121)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3842 0 0 (by exact GuardInstructionWindow.get 123),
   DirectGuard.pushAt 3843 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 124),
   DirectGuard.opAt 3844 .CALLDATASIZE (by exact GuardInstructionWindow.get 125),
   DirectGuard.opAt 3845 .SHR (by exact GuardInstructionWindow.get 126),
   DirectGuard.pushAt 3846 1 1 (by exact GuardInstructionWindow.get 127),
   DirectGuard.opAt 3847 .AND (by exact GuardInstructionWindow.get 128),
   DirectGuard.pushAt 3848 1 106 (by exact GuardInstructionWindow.get 129)]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3850 .POP (by exact GuardInstructionWindow.get 131),
   DirectGuard.pushAt 3851 2 272 (by exact GuardInstructionWindow.get 132),
   DirectGuard.opAt 3852 .JUMP (by exact GuardInstructionWindow.get 133)]
...
private theorem run_byte_prefix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 3833 .JUMPDEST (by exact GuardInstructionWindow.get 114)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3833 4790 [] (by norm_num) (GuardInstructionWindow.pc 114))
    (PatternedScan.stepS_jumpdest input 4790 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 115)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3834 4791 [] (by norm_num) (GuardInstructionWindow.pc 115))
    (PatternedScan.stepS_push0 input 4791 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3835 .CALLDATALOAD (by exact GuardInstructionWindow.get 116)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3835 4792 [0] (by norm_num) (GuardInstructionWindow.pc 116))
    (PatternedScan.stepS_calldataload input 4792 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3836 0 0 (by exact GuardInstructionWindow.get 117)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3836 4793 [w] (by norm_num) (GuardInstructionWindow.pc 117))
    (PatternedScan.stepS_push0 input 4793 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3837 .BYTE (by exact GuardInstructionWindow.get 118)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3837 4794 [0, w] (by norm_num) (GuardInstructionWindow.pc 118))
    (PatternedScan.stepS_byte input 4794 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3838 1 7 (by exact GuardInstructionWindow.get 119)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3838 4795 [b] (by norm_num) (GuardInstructionWindow.pc 119))
    (PatternedScan.stepS_push input 4795 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3839 .XOR (by exact GuardInstructionWindow.get 120)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3839 4797 [7, b] (by norm_num) (GuardInstructionWindow.pc 120))
    (PatternedScan.stepS_xor input 4797 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3840 2 5153 (by exact GuardInstructionWindow.get 121)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3840 4798 [v] (by norm_num) (GuardInstructionWindow.pc 121))
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4801 [5153, byteValue input]) =
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3841 4801 [5153, byteValue input] (by norm_num) (GuardInstructionWindow.pc 122))
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4801 [5153, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4802 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3841 4801 [5153, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 122))
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 130)]
      (PatternedScan.stS input 4828 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 130))
...
private theorem run_fallback_suffix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 3850 .POP (by exact GuardInstructionWindow.get 131)
  have h0 := PatternedScan.blockOfS l0
  ...
  let l1 : Located := DirectGuard.pushAt 3851 2 272 (by exact GuardInstructionWindow.get 132)
  have h1 := PatternedScan.blockOfS l1
  ...
  let l2 : Located := DirectGuard.opAt 3852 .JUMP (by exact GuardInstructionWindow.get 133)
  have h2 := PatternedScan.blockOfS l2
