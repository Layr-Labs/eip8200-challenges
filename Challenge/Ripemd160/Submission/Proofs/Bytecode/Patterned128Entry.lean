...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3876 .JUMPDEST,
   DirectGuard.pushAt 3877 0 0,
   DirectGuard.opAt 3878 .CALLDATALOAD,
   DirectGuard.pushAt 3879 0 0,
   DirectGuard.opAt 3880 .BYTE,
   DirectGuard.pushAt 3881 1 7,
   DirectGuard.opAt 3882 .XOR,
   DirectGuard.pushAt 3883 2 5027]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3885 0 0,
   DirectGuard.pushAt 3886 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 3887 .CALLDATASIZE,
   DirectGuard.opAt 3888 .SHR,
   DirectGuard.pushAt 3889 1 1,
   DirectGuard.opAt 3890 .AND,
   DirectGuard.pushAt 3891 1 106]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3893 .POP,
   DirectGuard.pushAt 3894 2 272,
   DirectGuard.opAt 3895 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4664 []) =
      some (PatternedScan.stS input 4675 [5027, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3876 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3876 4664 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4664 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3877 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3877 4665 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4665 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3878 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3878 4666 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4666 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3879 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3879 4667 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4667 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3880 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3880 4668 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4668 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3881 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3881 4669 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4669 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3882 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3882 4671 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4671 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3883 2 5027
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3883 4672 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4672 2 5027 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3885 = 4676 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3886 = 4677 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3887 = 4695 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3888 = 4696 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3889 = 4697 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3890 = 4699 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3891 = 4700 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3892 = 4702 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3893 = 4703 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3894 = 4704 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3895 = 4707 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4676 []) =
      some (PatternedScan.stS input 4702 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3884 .JUMPI] (PatternedScan.stS input 4675 [5027, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3884 .JUMPI)
    (PatternedScan.pcFactS input 3884 4675 [5027, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4675 5027 5027 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3884 .JUMPI] (PatternedScan.stS input 4675 [5027, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4676 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3884 .JUMPI)
    (PatternedScan.pcFactS input 3884 4675 [5027, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4675 5027 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3892 .JUMPI]
      (PatternedScan.stS input 4702 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3892 .JUMPI)
    (PatternedScan.pcFactS input 3892 4702 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4702 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3892 .JUMPI]
      (PatternedScan.stS input 4702 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4703 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3892 .JUMPI)
    (PatternedScan.pcFactS input 3892 4702 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4702 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4703 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3893 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3893 4703 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4703 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3894 2 272
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3894 4704 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4704 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3895 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3895 4707 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4707 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4676 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4676 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4676 []) (PatternedScan.patternedEntry input) := by
