...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 4054 .JUMPDEST,
   DirectGuard.pushAt 4055 0 0,
   DirectGuard.opAt 4056 .CALLDATALOAD,
   DirectGuard.pushAt 4057 0 0,
   DirectGuard.opAt 4058 .BYTE,
   DirectGuard.pushAt 4059 1 7,
   DirectGuard.opAt 4060 .XOR,
   DirectGuard.pushAt 4061 2 5158]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 4063 0 0,
   DirectGuard.pushAt 4064 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 4065 .CALLDATASIZE,
   DirectGuard.opAt 4066 .SHR,
   DirectGuard.pushAt 4067 1 1,
   DirectGuard.opAt 4068 .AND,
   DirectGuard.pushAt 4069 1 98]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 4071 .POP,
   DirectGuard.pushAt 4072 2 268,
   DirectGuard.opAt 4073 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4790 []) =
      some (PatternedScan.stS input 4801 [5158, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 4054 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4054 4790 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4790 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4055 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4055 4791 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4791 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4056 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4056 4792 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4792 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 4057 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4057 4793 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4793 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4058 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4058 4794 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4794 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4059 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4059 4795 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4795 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4060 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4060 4797 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4797 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4061 2 5158
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4061 4798 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4798 2 5158 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 4063 = 4802 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 4064 = 4803 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 4065 = 4821 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 4066 = 4822 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 4067 = 4823 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 4068 = 4825 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 4069 = 4826 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 4070 = 4828 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 4071 = 4829 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 4072 = 4830 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 4073 = 4833 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4802 []) =
      some (PatternedScan.stS input 4828 [98, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 4062 .JUMPI] (PatternedScan.stS input 4801 [5158, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4062 .JUMPI)
    (PatternedScan.pcFactS input 4062 4801 [5158, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4801 5158 5158 (byteValue input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 5158) (byteValue_true input hbyte) AbcArm.arm_dest)

private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 4062 .JUMPI] (PatternedScan.stS input 4801 [5158, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4802 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4062 .JUMPI)
    (PatternedScan.pcFactS input 4062 4801 [5158, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4801 5158 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4070 .JUMPI]
      (PatternedScan.stS input 4828 [98, sizeBit input, 0]) =
      some (PatternedScan.stS input 98 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4070 .JUMPI)
    (PatternedScan.pcFactS input 4070 4828 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4828 98 98 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 4070 .JUMPI)
    (PatternedScan.pcFactS input 4070 4828 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4828 98 (sizeBit input) [0]
...
private theorem run_fallback_suffix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 4071 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4071 4829 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4829 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4072 2 268
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4072 4830 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4830 2 268 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4073 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4073 4833 [268] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4833 268 268 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
