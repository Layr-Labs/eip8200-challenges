...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3833 .JUMPDEST (by exact GuardInstructionWindow.get 112),
   DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 113),
   DirectGuard.opAt 3835 .CALLDATALOAD (by exact GuardInstructionWindow.get 114),
   DirectGuard.pushAt 3836 0 0 (by exact GuardInstructionWindow.get 115),
   DirectGuard.opAt 3837 .BYTE (by exact GuardInstructionWindow.get 116),
   DirectGuard.pushAt 3838 1 7 (by exact GuardInstructionWindow.get 117),
   DirectGuard.opAt 3839 .XOR (by exact GuardInstructionWindow.get 118),
   DirectGuard.pushAt 3840 2 5153 (by exact GuardInstructionWindow.get 119)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3842 0 0 (by exact GuardInstructionWindow.get 121),
   DirectGuard.pushAt 3843 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 122),
   DirectGuard.opAt 3844 .CALLDATASIZE (by exact GuardInstructionWindow.get 123),
   DirectGuard.opAt 3845 .SHR (by exact GuardInstructionWindow.get 124),
   DirectGuard.pushAt 3846 1 1 (by exact GuardInstructionWindow.get 125),
   DirectGuard.opAt 3847 .AND (by exact GuardInstructionWindow.get 126),
   DirectGuard.pushAt 3848 1 106 (by exact GuardInstructionWindow.get 127)]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 3850 .POP (by exact GuardInstructionWindow.get 129),
   DirectGuard.pushAt 3851 2 272 (by exact GuardInstructionWindow.get 130),
   DirectGuard.opAt 3852 .JUMP (by exact GuardInstructionWindow.get 131)]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4790 []) =
      some (PatternedScan.stS input 4801 [5153, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3833 .JUMPDEST (by exact GuardInstructionWindow.get 112)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3833 4790 [] (by norm_num) (GuardInstructionWindow.pc 112))
    (PatternedScan.stepS_jumpdest input 4790 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3834 0 0 (by exact GuardInstructionWindow.get 113)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3834 4791 [] (by norm_num) (GuardInstructionWindow.pc 113))
    (PatternedScan.stepS_push0 input 4791 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3835 .CALLDATALOAD (by exact GuardInstructionWindow.get 114)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3835 4792 [0] (by norm_num) (GuardInstructionWindow.pc 114))
    (PatternedScan.stepS_calldataload input 4792 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3836 0 0 (by exact GuardInstructionWindow.get 115)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3836 4793 [w] (by norm_num) (GuardInstructionWindow.pc 115))
    (PatternedScan.stepS_push0 input 4793 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3837 .BYTE (by exact GuardInstructionWindow.get 116)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3837 4794 [0, w] (by norm_num) (GuardInstructionWindow.pc 116))
    (PatternedScan.stepS_byte input 4794 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3838 1 7 (by exact GuardInstructionWindow.get 117)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3838 4795 [b] (by norm_num) (GuardInstructionWindow.pc 117))
    (PatternedScan.stepS_push input 4795 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3839 .XOR (by exact GuardInstructionWindow.get 118)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3839 4797 [7, b] (by norm_num) (GuardInstructionWindow.pc 118))
    (PatternedScan.stepS_xor input 4797 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3840 2 5153 (by exact GuardInstructionWindow.get 119)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3840 4798 [v] (by norm_num) (GuardInstructionWindow.pc 119))
    (PatternedScan.stepS_push input 4798 2 5153 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3842 = 4802 := by
  exact GuardInstructionWindow.pc 121

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3843 = 4803 := by
  exact GuardInstructionWindow.pc 122

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3844 = 4821 := by
  exact GuardInstructionWindow.pc 123

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3845 = 4822 := by
  exact GuardInstructionWindow.pc 124

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3846 = 4823 := by
  exact GuardInstructionWindow.pc 125

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3847 = 4825 := by
  exact GuardInstructionWindow.pc 126

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3848 = 4826 := by
  exact GuardInstructionWindow.pc 127

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3849 = 4828 := by
  exact GuardInstructionWindow.pc 128

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3850 = 4829 := by
  exact GuardInstructionWindow.pc 129

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3851 = 4830 := by
  exact GuardInstructionWindow.pc 130

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3852 = 4833 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4802 []) =
      some (PatternedScan.stS input 4828 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 120)] (PatternedScan.stS input 4801 [5153, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 120))
    (PatternedScan.pcFactS input 3841 4801 [5153, byteValue input] (by norm_num) (GuardInstructionWindow.pc 120))
    (PatternedScan.stepS_jumpi_taken input 4801 5153 5153 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 120)] (PatternedScan.stS input 4801 [5153, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4802 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 120))
    (PatternedScan.pcFactS input 3841 4801 [5153, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 120))
    (PatternedScan.stepS_jumpi_fall input 4801 5153 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 128)]
      (PatternedScan.stS input 4828 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 128))
    (PatternedScan.pcFactS input 3849 4828 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4828 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 128)]
      (PatternedScan.stS input 4828 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4829 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 128))
    (PatternedScan.pcFactS input 3849 4828 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4828 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4829 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3850 .POP (by exact GuardInstructionWindow.get 129)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3850 4829 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4829 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3851 2 272 (by exact GuardInstructionWindow.get 130)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3851 4830 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4830 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3852 .JUMP (by exact GuardInstructionWindow.get 131)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3852 4833 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4833 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4802 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4802 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4802 []) (PatternedScan.patternedEntry input) := by
