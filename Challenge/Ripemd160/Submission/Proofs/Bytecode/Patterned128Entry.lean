...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3844 .JUMPDEST (by exact GuardInstructionWindow.get 187),
   DirectGuard.pushAt 3845 0 0 (by exact GuardInstructionWindow.get 188),
   DirectGuard.opAt 3846 .CALLDATALOAD (by exact GuardInstructionWindow.get 189),
   DirectGuard.pushAt 3847 0 0 (by exact GuardInstructionWindow.get 190),
   DirectGuard.opAt 3848 .BYTE (by exact GuardInstructionWindow.get 191),
   DirectGuard.pushAt 3849 1 7 (by exact GuardInstructionWindow.get 192),
   DirectGuard.opAt 3850 .XOR (by exact GuardInstructionWindow.get 193),
   DirectGuard.pushAt 3851 2 4904 (by exact GuardInstructionWindow.get 194)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3853 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 196),
   DirectGuard.opAt 3854 .CALLDATASIZE (by exact GuardInstructionWindow.get 197),
   DirectGuard.opAt 3855 .SHR (by exact GuardInstructionWindow.get 198),
   DirectGuard.pushAt 3856 1 1 (by exact GuardInstructionWindow.get 199),
   DirectGuard.opAt 3857 .AND (by exact GuardInstructionWindow.get 200),
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4866 []) =
      some (PatternedScan.stS input 4877 [4904, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 3844 .JUMPDEST (by exact GuardInstructionWindow.get 187)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3844 4866 [] (by norm_num) (GuardInstructionWindow.pc 187))
    (PatternedScan.stepS_jumpdest input 4866 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3845 0 0 (by exact GuardInstructionWindow.get 188)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3845 4867 [] (by norm_num) (GuardInstructionWindow.pc 188))
    (PatternedScan.stepS_push0 input 4867 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3846 .CALLDATALOAD (by exact GuardInstructionWindow.get 189)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3846 4868 [0] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_calldataload input 4868 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 3847 0 0 (by exact GuardInstructionWindow.get 190)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3847 4869 [w] (by norm_num) (GuardInstructionWindow.pc 190))
    (PatternedScan.stepS_push0 input 4869 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 3848 .BYTE (by exact GuardInstructionWindow.get 191)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3848 4870 [0, w] (by norm_num) (GuardInstructionWindow.pc 191))
    (PatternedScan.stepS_byte input 4870 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 3849 1 7 (by exact GuardInstructionWindow.get 192)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3849 4871 [b] (by norm_num) (GuardInstructionWindow.pc 192))
    (PatternedScan.stepS_push input 4871 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3850 .XOR (by exact GuardInstructionWindow.get 193)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3850 4873 [7, b] (by norm_num) (GuardInstructionWindow.pc 193))
    (PatternedScan.stepS_xor input 4873 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3851 2 4904 (by exact GuardInstructionWindow.get 194)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3851 4874 [v] (by norm_num) (GuardInstructionWindow.pc 194))
    (PatternedScan.stepS_push input 4874 2 4904 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3853 = 4878 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3853 = 4878 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3854 = 4896 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3855 = 4897 := by
  exact GuardInstructionWindow.pc 198

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3856 = 4898 := by
  exact GuardInstructionWindow.pc 199

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3857 = 4900 := by
  exact GuardInstructionWindow.pc 200

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3858 = 4901 := by
  exact GuardInstructionWindow.pc 201

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3859 = 4903 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4878 []) =
      some (PatternedScan.stS input 4903 [115, sizeBit input]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3852 .JUMPI (by exact GuardInstructionWindow.get 195)] (PatternedScan.stS input 4877 [4904, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3852 .JUMPI (by exact GuardInstructionWindow.get 195))
    (PatternedScan.pcFactS input 3852 4877 [4904, byteValue input] (by norm_num) (GuardInstructionWindow.pc 195))
    (PatternedScan.stepS_jumpi_taken input 4877 4904 4904 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3852 .JUMPI (by exact GuardInstructionWindow.get 195)] (PatternedScan.stS input 4877 [4904, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4878 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3852 .JUMPI (by exact GuardInstructionWindow.get 195))
    (PatternedScan.pcFactS input 3852 4877 [4904, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 195))
    (PatternedScan.stepS_jumpi_fall input 4877 4904 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3859 .JUMPI (by exact GuardInstructionWindow.get 202)]
      (PatternedScan.stS input 4903 [115, sizeBit input]) =
      some (PatternedScan.stS input 115 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3859 .JUMPI (by exact GuardInstructionWindow.get 202))
    (PatternedScan.pcFactS input 3859 4903 [115, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4903 115 115 (sizeBit input) []
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3859 .JUMPI (by exact GuardInstructionWindow.get 202)]
      (PatternedScan.stS input 4903 [115, sizeBit input]) =
      some (PatternedScan.stS input 4904 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3859 .JUMPI (by exact GuardInstructionWindow.get 202))
    (PatternedScan.pcFactS input 3859 4903 [115, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4903 115 (sizeBit input) []
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4878 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4878 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4878 []) (PatternedScan.patternedEntry input) := by
