...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 4046 .JUMPDEST,
   DirectGuard.pushAt 4047 0 0,
   DirectGuard.opAt 4048 .CALLDATALOAD,
   DirectGuard.pushAt 4049 0 0,
   DirectGuard.opAt 4050 .BYTE,
   DirectGuard.pushAt 4051 1 7,
   DirectGuard.opAt 4052 .XOR,
   DirectGuard.pushAt 4053 2 5154]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 4055 0 0,
   DirectGuard.pushAt 4056 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 4057 .CALLDATASIZE,
   DirectGuard.opAt 4058 .SHR,
   DirectGuard.pushAt 4059 1 1,
   DirectGuard.opAt 4060 .AND,
   DirectGuard.pushAt 4061 1 106]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 4063 .POP,
   DirectGuard.pushAt 4064 2 276,
   DirectGuard.opAt 4065 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 4046 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4046 4791 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4791 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4047 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4047 4792 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4792 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4048 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4048 4793 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4793 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 4049 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4049 4794 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4794 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4050 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4050 4795 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4795 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4051 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4051 4796 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4796 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4052 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4052 4798 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4798 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4053 2 5154
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4053 4799 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 4055 = 4803 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 4056 = 4804 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 4057 = 4822 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 4058 = 4823 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 4059 = 4824 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 4060 = 4826 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 4061 = 4827 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 4062 = 4829 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 4063 = 4830 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 4064 = 4831 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 4065 = 4834 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 4054 .JUMPI] (PatternedScan.stS input 4802 [5154, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4054 .JUMPI)
    (PatternedScan.pcFactS input 4054 4802 [5154, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 4054 .JUMPI] (PatternedScan.stS input 4802 [5154, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4803 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4054 .JUMPI)
    (PatternedScan.pcFactS input 4054 4802 [5154, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4062 .JUMPI]
      (PatternedScan.stS input 4829 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 106 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4062 .JUMPI)
    (PatternedScan.pcFactS input 4062 4829 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
...
private theorem run_fallback_suffix (input : ByteArray) :
  ...
  let l0 : Located := DirectGuard.opAt 4063 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4063 4830 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4830 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4064 2 276
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4064 4831 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4831 2 276 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4065 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4065 4834 [276] (by norm_num) sizeHitPC4114)
