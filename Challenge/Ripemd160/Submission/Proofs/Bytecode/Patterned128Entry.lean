...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3640 = 4841 := J2EntryWindow.pc 0
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3641 = 4842 := J2EntryWindow.pc 1
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3647 = 4867 := J2EntryWindow.pc 7
private theorem packedPC3735 : Artifact.submissionArtifact.instructionPC 3648 = 4868 := J2EntryWindow.pc 8
private theorem packedPC3736 : Artifact.submissionArtifact.instructionPC 3649 = 4871 := J2EntryWindow.pc 9
private theorem packedPC3737 : Artifact.submissionArtifact.instructionPC 3650 = 4877 := J2EntryWindow.pc 10
private theorem packedPC3738 : Artifact.submissionArtifact.instructionPC 3651 = 4878 := J2EntryWindow.pc 11
private theorem packedPC3739 : Artifact.submissionArtifact.instructionPC 3652 = 4880 := J2EntryWindow.pc 12
private theorem packedPC3740 : Artifact.submissionArtifact.instructionPC 3653 = 4881 := J2EntryWindow.pc 13
private theorem packedPC3741 : Artifact.submissionArtifact.instructionPC 3654 = 4882 := J2EntryWindow.pc 14
private theorem packedPC3742 : Artifact.submissionArtifact.instructionPC 3655 = 4883 := J2EntryWindow.pc 15
private theorem packedPC3743 : Artifact.submissionArtifact.instructionPC 3656 = 4884 := J2EntryWindow.pc 16
private theorem packedPC3744 : Artifact.submissionArtifact.instructionPC 3657 = 4885 := J2EntryWindow.pc 17
private theorem packedPC3745 : Artifact.submissionArtifact.instructionPC 3658 = 4887 := J2EntryWindow.pc 18

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3642 = 4844 :=
  J2EntryWindow.pc 2
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3643 = 4862 :=
  J2EntryWindow.pc 3
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3644 = 4863 :=
  J2EntryWindow.pc 4
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3645 = 4864 :=
  J2EntryWindow.pc 5
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3646 = 4865 :=
  J2EntryWindow.pc 6
...
private theorem run_mask_entry (input : ByteArray) :
    DirectGuard.run maskEntry (PatternedScan.stS input 4841 []) =
      some (PatternedScan.stS input 4842 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3644 4819 [] (by norm_num) pc3836)
    (PatternedScan.stepS_jumpdest input 4841 [] (by simp) (by norm_num))

private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4842 []) =
      some (PatternedScan.stS input 4867 [122, sizeBit input]) := by
  have hpc : Artifact.submissionArtifact.instructionPC 3641 = 4842 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4867 [122, sizeBit input]) =
      some (PatternedScan.stS input 122 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3651 4845 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_taken input 4867 122 122 (sizeBit input) []
...
private theorem run_mask_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run maskJump (PatternedScan.stS input 4867 [122, sizeBit input]) =
      some (PatternedScan.stS input 4868 []) :=
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3651 4845 [122, sizeBit input] (by norm_num) pc3843)
    (PatternedScan.stepS_jumpi_fall input 4867 122 (sizeBit input) []
...
private def gasSteps_mask_prefix (input : ByteArray) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4867 [122, sizeBit input]) :=
...
private def gasSteps_mask_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4868 []) := by
...
private theorem run_length_prefix (input : ByteArray) :
    DirectGuard.run lengthPrefix (PatternedScan.stS input 4868 []) =
      some (PatternedScan.stS input 4887 [122, lengthCond input]) := by
...
private def gasSteps_length_match (input : ByteArray)
    ...
    GasSteps (PatternedScan.stS input 4868 []) (PatternedScan.patternedEntry input) := by
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4887 [122, lengthCond input]) =
      some (PatternedScan.stS input 122 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3662 4865 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_taken input 4887 122 122 (lengthCond input) []
...
private def gasSteps_length_fail (input : ByteArray) (hfit : CalldataFits input)
    (h256 : input.size ≠ 256) (h376 : input.size ≠ 376) (h1000 : input.size ≠ 1000) :
    GasSteps (PatternedScan.stS input 4868 []) (AbcArm.armEntry input) := by
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4887 [122, lengthCond input]) =
      some (AbcArm.armEntry input) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3662 4865 _ (by norm_num) packedPC3745)
      (PatternedScan.stepS_jumpi_fall input 4887 122 (lengthCond input) []
