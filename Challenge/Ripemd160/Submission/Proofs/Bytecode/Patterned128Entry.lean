...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 4030 .JUMPDEST,
   DirectGuard.pushAt 4031 0 0,
   DirectGuard.opAt 4032 .CALLDATALOAD,
   DirectGuard.pushAt 4033 0 0,
   DirectGuard.opAt 4034 .BYTE,
   DirectGuard.pushAt 4035 1 7,
   DirectGuard.opAt 4036 .XOR,
   DirectGuard.pushAt 4037 2 5172]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 4039 0 0,
   DirectGuard.pushAt 4040 17 342276208914615837337402008677671501826,
   DirectGuard.opAt 4041 .CALLDATASIZE,
   DirectGuard.opAt 4042 .SHR,
   DirectGuard.pushAt 4043 1 1,
   DirectGuard.opAt 4044 .AND,
   DirectGuard.pushAt 4045 1 98]

private def fallbackSuffix : List Located :=
  [DirectGuard.opAt 4047 .POP,
   DirectGuard.pushAt 4048 2 268,
   DirectGuard.opAt 4049 .JUMP]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4803 []) =
      some (PatternedScan.stS input 4814 [5172, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor 7 b
  let l0 : Located := DirectGuard.opAt 4030 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4030 4803 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 4803 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4031 0 0
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4031 4804 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4804 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4032 .CALLDATALOAD
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4032 4805 [0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 4805 0 [] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.pushAt 4033 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4033 4806 [w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 4806 [w] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4034 .BYTE
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4034 4807 [0, w] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_byte input 4807 0 w [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4035 1 7
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4035 4808 [b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4808 1 7 [b] (by simp) (by decide) (by decide) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4036 .XOR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4036 4810 [7, b] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 4810 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4037 2 5172
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4037 4811 [v] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 4811 2 5172 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 4039 = 4815 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 4040 = 4816 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 4041 = 4834 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 4042 = 4835 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 4043 = 4836 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 4044 = 4838 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 4045 = 4839 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 4046 = 4841 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 4047 = 4842 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 4048 = 4843 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 4049 = 4846 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4815 []) =
      some (PatternedScan.stS input 4841 [98, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 4038 .JUMPI] (PatternedScan.stS input 4814 [5172, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4038 .JUMPI)
    (PatternedScan.pcFactS input 4038 4814 [5172, byteValue input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 4814 5172 5172 (byteValue input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 5172) (byteValue_true input hbyte) AbcArm.arm_dest)

private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 4038 .JUMPI] (PatternedScan.stS input 4814 [5172, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4815 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4038 .JUMPI)
    (PatternedScan.pcFactS input 4038 4814 [5172, UInt256.ofNat 0] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 4814 5172 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4046 .JUMPI]
      (PatternedScan.stS input 4841 [98, sizeBit input, 0]) =
      some (PatternedScan.stS input 98 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4046 .JUMPI)
    (PatternedScan.pcFactS input 4046 4841 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4841 98 98 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 4046 .JUMPI]
      (PatternedScan.stS input 4841 [98, sizeBit input, 0]) =
      some (PatternedScan.stS input 4842 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 4046 .JUMPI)
    (PatternedScan.pcFactS input 4046 4841 [98, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4841 98 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4842 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 4047 .POP
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4047 4842 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4842 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 4048 2 268
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4048 4843 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4843 2 268 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 4049 .JUMP
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4049 4846 [268] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4846 268 268 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4815 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4815 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4815 []) (PatternedScan.patternedEntry input) := by
