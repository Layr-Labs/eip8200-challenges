...
private theorem guard_fallback_dest : Decode.isValidJumpDest submissionBytecode 349 = true :=
...
private def fallbackSuffix : List Located :=
  [DirectGuard.pushAt 3852 2 349 (by exact GuardInstructionWindow.get 197),
...
private theorem run_fallback_suffix (input : ByteArray) :
  ...
  let l1 : Located := DirectGuard.pushAt 3852 2 349 (by exact GuardInstructionWindow.get 197)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3852 4892 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4892 2 349 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3853 .JUMP (by exact GuardInstructionWindow.get 198)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3853 4895 [349] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4895 349 349 [] (by simp) (by norm_num) rfl guard_fallback_dest)
