...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3841 .JUMPDEST (by exact GuardInstructionWindow.get 185),
   DirectGuard.pushAt 3842 1 7 (by exact GuardInstructionWindow.get 186),
   DirectGuard.pushAt 3843 0 0 (by exact GuardInstructionWindow.get 187),
   DirectGuard.opAt 3844 .CALLDATALOAD (by exact GuardInstructionWindow.get 188),
   DirectGuard.pushAt 3845 0 0 (by exact GuardInstructionWindow.get 189),
   DirectGuard.opAt 3846 .BYTE (by exact GuardInstructionWindow.get 190),
   DirectGuard.opAt 3847 .XOR (by exact GuardInstructionWindow.get 191),
   DirectGuard.pushAt 3848 2 4901 (by exact GuardInstructionWindow.get 192)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3850 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 194),
   DirectGuard.opAt 3851 .CALLDATASIZE (by exact GuardInstructionWindow.get 195),
   DirectGuard.opAt 3852 .SHR (by exact GuardInstructionWindow.get 196),
   DirectGuard.pushAt 3853 1 1 (by exact GuardInstructionWindow.get 197),
   DirectGuard.opAt 3854 .AND (by exact GuardInstructionWindow.get 198),
   DirectGuard.pushAt 3855 1 115 (by exact GuardInstructionWindow.get 199)]

private def guardMatchTail : List Located :=
  [DirectGuard.opAt 71 .JUMPDEST]

private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4863 []) =
      some (PatternedScan.stS input 4874 [4901, byteValue input]) := by
  let w := MachineState.readWord input 0
  let b := UInt256.byteAt 0 w
  let v := UInt256.xor b 7
  let l0 : Located := DirectGuard.opAt 3841 .JUMPDEST (by exact GuardInstructionWindow.get 185)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3841 4863 [] (by norm_num) (GuardInstructionWindow.pc 185))
    (PatternedScan.stepS_jumpdest input 4863 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3842 1 7 (by exact GuardInstructionWindow.get 186)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3842 4864 [] (by norm_num) (GuardInstructionWindow.pc 186))
    (PatternedScan.stepS_push input 4864 1 7 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 3843 0 0 (by exact GuardInstructionWindow.get 187)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3843 4866 [7] (by norm_num) (GuardInstructionWindow.pc 187))
    (PatternedScan.stepS_push0 input 4866 [7] (by simp) (by norm_num))
  let l3 : Located := DirectGuard.opAt 3844 .CALLDATALOAD (by exact GuardInstructionWindow.get 188)
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3844 4867 [0, 7] (by norm_num) (GuardInstructionWindow.pc 188))
    (PatternedScan.stepS_calldataload input 4867 0 [7] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.pushAt 3845 0 0 (by exact GuardInstructionWindow.get 189)
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3845 4868 [w, 7] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_push0 input 4868 [w, 7] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.opAt 3846 .BYTE (by exact GuardInstructionWindow.get 190)
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3846 4869 [0, w, 7] (by norm_num) (GuardInstructionWindow.pc 190))
    (PatternedScan.stepS_byte input 4869 0 w [7] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.opAt 3847 .XOR (by exact GuardInstructionWindow.get 191)
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3847 4870 [b, 7] (by norm_num) (GuardInstructionWindow.pc 191))
    (PatternedScan.stepS_xor input 4870 b 7 [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3848 2 4901 (by exact GuardInstructionWindow.get 192)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3848 4871 [v] (by norm_num) (GuardInstructionWindow.pc 192))
    (PatternedScan.stepS_push input 4871 2 4901 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3850 = 4875 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3850 = 4875 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3851 = 4893 := by
  exact GuardInstructionWindow.pc 195

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3852 = 4894 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3853 = 4895 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3854 = 4897 := by
  exact GuardInstructionWindow.pc 198

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3855 = 4898 := by
  exact GuardInstructionWindow.pc 199

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3856 = 4900 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4875 []) =
      some (PatternedScan.stS input 4900 [115, sizeBit input]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 193)] (PatternedScan.stS input 4874 [4901, byteValue input]) =
      some (AbcArm.armEntry input) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 193))
    (PatternedScan.pcFactS input 3849 4874 [4901, byteValue input] (by norm_num) (GuardInstructionWindow.pc 193))
    (PatternedScan.stepS_jumpi_taken input 4874 4901 4901 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 193)] (PatternedScan.stS input 4874 [4901, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4875 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 193))
    (PatternedScan.pcFactS input 3849 4874 [4901, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 193))
    (PatternedScan.stepS_jumpi_fall input 4874 4901 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))

private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3856 .JUMPI (by exact GuardInstructionWindow.get 200)]
      (PatternedScan.stS input 4900 [115, sizeBit input]) =
      some (PatternedScan.stS input 115 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3856 .JUMPI (by exact GuardInstructionWindow.get 200))
    (PatternedScan.pcFactS input 3856 4900 [115, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4900 115 115 (sizeBit input) []
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3856 .JUMPI (by exact GuardInstructionWindow.get 200)]
      (PatternedScan.stS input 4900 [115, sizeBit input]) =
      some (PatternedScan.stS input 4901 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3856 .JUMPI (by exact GuardInstructionWindow.get 200))
    (PatternedScan.pcFactS input 3856 4900 [115, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4900 115 (sizeBit input) []
...
private def gasSteps_byte_match (input : ByteArray)
    (hbyte : DirectGuard.firstByte input = 7) :
    GasSteps (DirectGuard.guardEntry input) (PatternedScan.stS input 4875 []) := by
...
private def gasSteps_size_fail (input : ByteArray) (hfit : CalldataFits input)
    ...
    GasSteps (PatternedScan.stS input 4875 []) (DirectGuard.fallbackState input) := by
...
private def gasSteps_size_match (input : ByteArray) (hsize : input.size = 56 ∨ input.size = 120 ∨ input.size = 63 ∨ input.size = 64 ∨ input.size = 65 ∨ input.size = 128 ∨ input.size = 119 ∨ input.size = 55 ∨ input.size = 1 ∨ input.size = 31 ∨ input.size = 32) :
    GasSteps (PatternedScan.stS input 4875 []) (PatternedScan.patternedEntry input) := by
