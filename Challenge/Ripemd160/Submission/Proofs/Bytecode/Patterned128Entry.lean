...
@[simp] private theorem entryPC4151 : Artifact.submissionArtifact.instructionPC 4149 = 5151 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4152 : Artifact.submissionArtifact.instructionPC 4150 = 5152 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4153 : Artifact.submissionArtifact.instructionPC 4150 = 5152 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4154 : Artifact.submissionArtifact.instructionPC 4151 = 5153 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4155 : Artifact.submissionArtifact.instructionPC 4152 = 5156 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4156 : Artifact.submissionArtifact.instructionPC 4153 = 5157 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4157 : Artifact.submissionArtifact.instructionPC 4154 = 5158 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4158 : Artifact.submissionArtifact.instructionPC 4155 = 5160 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
@[simp] private theorem entryPC4169 : Artifact.submissionArtifact.instructionPC 4135 = 5133 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4170 : Artifact.submissionArtifact.instructionPC 4136 = 5134 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4171 : Artifact.submissionArtifact.instructionPC 4137 = 5135 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4172 : Artifact.submissionArtifact.instructionPC 4138 = 5137 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem entryPC4173 : Artifact.submissionArtifact.instructionPC 4139 = 5138 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
private def guardSizePath : List Located :=
  [DirectGuard.opAt 4132 .JUMPDEST,
   ...
   DirectGuard.pushAt 4134 2 64,
   DirectGuard.opAt 4135 .NOT,
   DirectGuard.opAt 4136 .AND,
   DirectGuard.pushAt 4137 1 56,
...
private def guardBytePrefix : List Located :=
  [DirectGuard.pushAt 4144 0 0,
   ...
   DirectGuard.pushAt 4148 2 7,
   DirectGuard.opAt 4149 .XOR,
   DirectGuard.opAt 4150 .OR,
   DirectGuard.pushAt 4151 2 368]

private def guardBytePath : List Located := guardBytePrefix ++ [DirectGuard.opAt 4152 .JUMPI]
...
private def guardMatchSuffix : List Located :=
  [DirectGuard.pushAt 4153 0 0,
   DirectGuard.pushAt 4154 1 101,
   DirectGuard.opAt 4155 .JUMP]
...
private theorem run_guard_size (input : ByteArray) :
  ...
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4132 5128 [] (by norm_num)
      entryPC4166)
  ...
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4133 5129 [] (by norm_num)
      entryPC4167)
    (PatternedScan.stepS_calldatasize input 5129 [] (by simp) (by norm_num))
  let l2 : Located := DirectGuard.pushAt 4134 2 64
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4134 5130 [x] (by norm_num)
      entryPC4168)
    (PatternedScan.stepS_push input 5130 2 64 [x] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := DirectGuard.opAt 4135 .NOT
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4135 5133 [64, x] (by norm_num)
      entryPC4169)
    (step_size_not input 5133 64 [x] (by simp) (by norm_num))
  let l4 : Located := DirectGuard.opAt 4136 .AND
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4136 5134 [nm, x] (by norm_num)
      entryPC4170)
    (PatternedScan.stepS_and input 5134 nm x [] (by simp) (by norm_num))
  let l5 : Located := DirectGuard.pushAt 4137 1 56
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4137 5135 [masked] (by norm_num)
      entryPC4171)
  ...
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4138 5137 [56, masked] (by norm_num)
      entryPC4172)
  ...
  rw [hp] at h6
  let l7 : Located := DirectGuard.opAt 4139 .CALLDATASIZE
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4139 5138 [pair] (by norm_num)
      entryPC4174)
    (PatternedScan.stepS_calldatasize input 5138 [pair] (by simp) (by norm_num))
  let l8 : Located := DirectGuard.pushAt 4140 1 128
  have h8 := PatternedScan.blockOfS l8
    (PatternedScan.pcFactS input 4140 5139 [x, pair] (by norm_num)
      entryPC4175)
    (PatternedScan.stepS_push input 5139 1 128 [x, pair] (by simp) (by decide) (by decide) (by norm_num))
  let l9 : Located := DirectGuard.opAt 4141 .EQ
  have h9 := PatternedScan.blockOfS l9
    (PatternedScan.pcFactS input 4141 5141 [128, x, pair] (by norm_num)
      entryPC4176)
    (PatternedScan.stepS_eq input 5141 128 x [pair] (by simp) (by norm_num))
  let l10 : Located := DirectGuard.opAt 4142 .OR
  have h10 := PatternedScan.blockOfS l10
    (PatternedScan.pcFactS input 4142 5142 [v128, pair] (by norm_num)
      entryPC4177)
    (PatternedScan.stepS_or input 5142 v128 pair [] (by simp) (by norm_num))
  let l11 : Located := DirectGuard.opAt 4143 .ISZERO
  have h11 := PatternedScan.blockOfS l11
    (PatternedScan.pcFactS input 4143 5143 [both] (by norm_num)
      entryPC4178)
...
private theorem run_guard_byte_prefix (input : ByteArray) (flag : UInt256) :
  ...
  let l0 : Located := DirectGuard.pushAt 4144 0 0
  have h0 := PatternedScan.blockOfS l0
  ...
  let l1 : Located := DirectGuard.opAt 4145 .CALLDATALOAD
  have h1 := PatternedScan.blockOfS l1
  ...
  let l2 : Located := DirectGuard.pushAt 4146 0 0
  have h2 := PatternedScan.blockOfS l2
  ...
  let l3 : Located := DirectGuard.opAt 4147 .BYTE
  have h3 := PatternedScan.blockOfS l3
  ...
  let l4 : Located := DirectGuard.pushAt 4148 2 7
  have h4 := PatternedScan.blockOfS l4
  ...
  let l5 : Located := DirectGuard.opAt 4149 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4149 5151 [7, b, flag] (by norm_num) entryPC4151)
    (PatternedScan.stepS_xor input 5151 7 b [flag] (by simp) (by norm_num))
  let l6 : Located := DirectGuard.opAt 4150 .OR
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4150 5152 [z, flag] (by norm_num) entryPC4152)
    (PatternedScan.stepS_or input 5152 z flag [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 4151 2 368
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 4151 5153 [f] (by norm_num) entryPC4154)
...
private theorem run_guard_byte_fail (input : ByteArray) (flag : UInt256)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4152 .JUMPI)
    (PatternedScan.pcFactS input 4152 5156 [368, byteFlag input flag] (by norm_num) entryPC4155)
  ...
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4152 .JUMPI] _ _ _ (run_guard_byte_prefix input flag) rfl hj
...
private theorem run_guard_byte_match (input : ByteArray)
  ...
  have hj := PatternedScan.blockOfS (DirectGuard.opAt 4152 .JUMPI)
    (PatternedScan.pcFactS input 4152 5156 [368, UInt256.ofNat 0] (by norm_num) entryPC4155)
    (PatternedScan.stepS_jumpi_fall input 5156 368 (UInt256.ofNat 0) []
      (by simp) (by norm_num) (by decide))
  have h0 := PatternedScan.blockOfS (DirectGuard.pushAt 4153 0 0)
    (PatternedScan.pcFactS input 4153 5157 [] (by norm_num) entryPC4156)
    (PatternedScan.stepS_push0 input 5157 [] (by simp) (by norm_num))
  have h1 := PatternedScan.blockOfS (DirectGuard.pushAt 4154 1 101)
    (PatternedScan.pcFactS input 4154 5158 [0] (by norm_num) entryPC4157)
    (PatternedScan.stepS_push input 5158 1 101 [0] (by simp) (by decide) (by decide) (by norm_num))
  have h2 := PatternedScan.blockOfS (DirectGuard.opAt 4155 .JUMP)
    (PatternedScan.pcFactS input 4155 5160 [101, 0] (by norm_num) entryPC4158)
  ...
  have hpj := Challenge.EvmProof.Stepper.runLocatedBlock_append
    guardBytePrefix [DirectGuard.opAt 4152 .JUMPI] _ _ _ hprefix rfl hj
  have h01 := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4153 0 0] [DirectGuard.pushAt 4154 1 101] _ _ _ h0 rfl h1
  have hs := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [DirectGuard.pushAt 4153 0 0, DirectGuard.pushAt 4154 1 101]
    [DirectGuard.opAt 4155 .JUMP] _ _ _ h01 rfl h2
  exact Challenge.EvmProof.Stepper.runLocatedBlock_append
