...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3762 = 4806 := GuardInstructionWindow.pc 183
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3763 = 4807 := GuardInstructionWindow.pc 184
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3769 = 4832 := GuardInstructionWindow.pc 190
private theorem pc3844 : Artifact.submissionArtifact.instructionPC 3770 = 4833 := GuardInstructionWindow.pc 191
private theorem pc3845 : Artifact.submissionArtifact.instructionPC 3771 = 4834 := GuardInstructionWindow.pc 192
private theorem pc3846 : Artifact.submissionArtifact.instructionPC 3772 = 4837 := GuardInstructionWindow.pc 193
private theorem pc3847 : Artifact.submissionArtifact.instructionPC 3773 = 4838 := GuardInstructionWindow.pc 194
private theorem pc3848 : Artifact.submissionArtifact.instructionPC 3774 = 4841 := GuardInstructionWindow.pc 195
private theorem pc3849 : Artifact.submissionArtifact.instructionPC 3775 = 4842 := GuardInstructionWindow.pc 196
private theorem pc3850 : Artifact.submissionArtifact.instructionPC 3776 = 4843 := GuardInstructionWindow.pc 197
private theorem pc3851 : Artifact.submissionArtifact.instructionPC 3777 = 4844 := GuardInstructionWindow.pc 198
private theorem pc3852 : Artifact.submissionArtifact.instructionPC 3778 = 4845 := GuardInstructionWindow.pc 199
private theorem pc3853 : Artifact.submissionArtifact.instructionPC 3779 = 4848 := GuardInstructionWindow.pc 200
private theorem pc3854 : Artifact.submissionArtifact.instructionPC 3780 = 4849 := GuardInstructionWindow.pc 201
private theorem pc3855 : Artifact.submissionArtifact.instructionPC 3781 = 4850 := GuardInstructionWindow.pc 202
private theorem pc3856 : Artifact.submissionArtifact.instructionPC 3782 = 4852 := GuardInstructionWindow.pc 203

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3764 = 4825 :=
  GuardInstructionWindow.pc 185
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3765 = 4826 :=
  GuardInstructionWindow.pc 186
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3766 = 4827 :=
  GuardInstructionWindow.pc 187
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3767 = 4829 :=
  GuardInstructionWindow.pc 188
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3768 = 4830 :=
  GuardInstructionWindow.pc 189

/-! ## The size mask -/

private def maskEntry : List Located :=
  [DirectGuard.opAt 3762 .JUMPDEST (by exact GuardInstructionWindow.get 183)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3763 17 342276208914615837337402008677671501826 (by exact GuardInstructionWindow.get 184),
   DirectGuard.opAt 3764 .CALLDATASIZE (by exact GuardInstructionWindow.get 185),
   DirectGuard.opAt 3765 .SHR (by exact GuardInstructionWindow.get 186),
   DirectGuard.pushAt 3766 1 1 (by exact GuardInstructionWindow.get 187),
   DirectGuard.opAt 3767 .AND (by exact GuardInstructionWindow.get 188),
   DirectGuard.pushAt 3768 1 111 (by exact GuardInstructionWindow.get 189)]

private def maskJump : List Located :=
  [DirectGuard.opAt 3769 .JUMPI (by exact GuardInstructionWindow.get 190)]
...
private theorem run_mask_entry (input : ByteArray) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3762 4806 [] (by norm_num) pc3836)
...
private theorem run_size_prefix (input : ByteArray) :
  ...
  have hpc : Artifact.submissionArtifact.instructionPC 3763 = 4807 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3769 4832 [111, sizeBit input] (by norm_num) pc3843)
...
private def lengthPrefix : List Located :=
  [DirectGuard.opAt 3770 .CALLDATASIZE (by exact GuardInstructionWindow.get 191),
   DirectGuard.pushAt 3771 2 376 (by exact GuardInstructionWindow.get 192),
   DirectGuard.opAt 3772 .EQ (by exact GuardInstructionWindow.get 193),
   DirectGuard.pushAt 3773 2 1000 (by exact GuardInstructionWindow.get 194),
   DirectGuard.opAt 3774 .CALLDATASIZE (by exact GuardInstructionWindow.get 195),
   DirectGuard.opAt 3775 .EQ (by exact GuardInstructionWindow.get 196),
   DirectGuard.opAt 3776 .OR (by exact GuardInstructionWindow.get 197),
   DirectGuard.opAt 3777 .CALLDATASIZE (by exact GuardInstructionWindow.get 198),
   DirectGuard.pushAt 3778 2 256 (by exact GuardInstructionWindow.get 199),
   DirectGuard.opAt 3779 .EQ (by exact GuardInstructionWindow.get 200),
   DirectGuard.opAt 3780 .OR (by exact GuardInstructionWindow.get 201),
   DirectGuard.pushAt 3781 1 111 (by exact GuardInstructionWindow.get 202)]

private def lengthJump : List Located :=
  [DirectGuard.opAt 3782 .JUMPI (by exact GuardInstructionWindow.get 203)]
...
private theorem run_length_prefix (input : ByteArray) :
  ...
  have hpc : Artifact.submissionArtifact.instructionPC 3770 = 4833 := pc3844
...
private def gasSteps_length_match (input : ByteArray)
  ...
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4852 [111, lengthCond input]) =
      some (PatternedScan.stS input 111 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3782 4852 _ (by norm_num) pc3856)
