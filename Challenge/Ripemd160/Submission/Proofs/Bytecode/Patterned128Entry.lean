...
private theorem pc3836 : Artifact.submissionArtifact.instructionPC 3640 = 4819 := J2EntryWindow.pc 0
private theorem pc3837 : Artifact.submissionArtifact.instructionPC 3641 = 4820 := J2EntryWindow.pc 1
private theorem pc3843 : Artifact.submissionArtifact.instructionPC 3647 = 4845 := J2EntryWindow.pc 7
private theorem packedPC3735 : Artifact.submissionArtifact.instructionPC 3648 = 4846 := J2EntryWindow.pc 8
private theorem packedPC3736 : Artifact.submissionArtifact.instructionPC 3649 = 4849 := J2EntryWindow.pc 9
private theorem packedPC3737 : Artifact.submissionArtifact.instructionPC 3650 = 4855 := J2EntryWindow.pc 10
private theorem packedPC3738 : Artifact.submissionArtifact.instructionPC 3651 = 4856 := J2EntryWindow.pc 11
private theorem packedPC3739 : Artifact.submissionArtifact.instructionPC 3652 = 4858 := J2EntryWindow.pc 12
private theorem packedPC3740 : Artifact.submissionArtifact.instructionPC 3653 = 4859 := J2EntryWindow.pc 13
private theorem packedPC3741 : Artifact.submissionArtifact.instructionPC 3654 = 4860 := J2EntryWindow.pc 14
private theorem packedPC3742 : Artifact.submissionArtifact.instructionPC 3655 = 4861 := J2EntryWindow.pc 15
private theorem packedPC3743 : Artifact.submissionArtifact.instructionPC 3656 = 4862 := J2EntryWindow.pc 16
private theorem packedPC3744 : Artifact.submissionArtifact.instructionPC 3657 = 4863 := J2EntryWindow.pc 17
private theorem packedPC3745 : Artifact.submissionArtifact.instructionPC 3658 = 4865 := J2EntryWindow.pc 18

@[simp] private theorem sizeHitPC3838 : Artifact.submissionArtifact.instructionPC 3642 = 4822 :=
  J2EntryWindow.pc 2
@[simp] private theorem sizeHitPC3839 : Artifact.submissionArtifact.instructionPC 3643 = 4840 :=
  J2EntryWindow.pc 3
@[simp] private theorem sizeHitPC3840 : Artifact.submissionArtifact.instructionPC 3644 = 4841 :=
  J2EntryWindow.pc 4
@[simp] private theorem sizeHitPC3841 : Artifact.submissionArtifact.instructionPC 3645 = 4842 :=
  J2EntryWindow.pc 5
@[simp] private theorem sizeHitPC3842 : Artifact.submissionArtifact.instructionPC 3646 = 4843 :=
  J2EntryWindow.pc 6

/-! ## The size mask -/

private def maskEntry : List Located :=
  [DirectGuard.opAt 3644 .JUMPDEST (by exact J2EntryWindow.get 0)]

private def sizePrefix : List Located :=
  [DirectGuard.pushAt 3645 1 1 (by exact J2EntryWindow.get 1),
   DirectGuard.pushAt 3646 17 342276208914615837337402008677671501826 (by exact J2EntryWindow.get 2),
   DirectGuard.opAt 3647 .CALLDATASIZE (by exact J2EntryWindow.get 3),
   DirectGuard.opAt 3648 .SHR (by exact J2EntryWindow.get 4),
   DirectGuard.opAt 3649 .AND (by exact J2EntryWindow.get 5),
   DirectGuard.pushAt 3650 1 122 (by exact J2EntryWindow.get 6)]

private def maskJump : List Located :=
  [DirectGuard.opAt 3651 .JUMPI (by exact J2EntryWindow.get 7)]
...
private theorem run_mask_entry (input : ByteArray) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3644 4819 [] (by norm_num) pc3836)
...
private theorem run_size_prefix (input : ByteArray) :
  ...
  have hpc : Artifact.submissionArtifact.instructionPC 3641 = 4820 := pc3837
...
private theorem run_mask_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
  ...
  PatternedScan.blockOfS _
    (PatternedScan.pcFactS input 3651 4845 [122, sizeBit input] (by norm_num) pc3843)
...
private def lengthPrefix : List Located :=
  [DirectGuard.pushAt 3652 2 1016 (by exact J2EntryWindow.get 8),
   DirectGuard.pushAt 3653 5 6308489473 (by exact J2EntryWindow.get 9),
   DirectGuard.opAt 3654 .CALLDATASIZE (by exact J2EntryWindow.get 10),
   DirectGuard.pushAt 3655 1 24 (by exact J2EntryWindow.get 11),
   DirectGuard.opAt 3656 .AND (by exact J2EntryWindow.get 12),
   DirectGuard.opAt 3657 .SHR (by exact J2EntryWindow.get 13),
   DirectGuard.opAt 3658 .AND (by exact J2EntryWindow.get 14),
   DirectGuard.opAt 3659 .CALLDATASIZE (by exact J2EntryWindow.get 15),
   DirectGuard.opAt 3660 .EQ (by exact J2EntryWindow.get 16),
   DirectGuard.pushAt 3661 1 122 (by exact J2EntryWindow.get 17)]

private def lengthJump : List Located :=
  [DirectGuard.opAt 3662 .JUMPI (by exact J2EntryWindow.get 18)]
...
private def gasSteps_length_match (input : ByteArray)
  ...
  have hj : DirectGuard.run lengthJump (PatternedScan.stS input 4865 [122, lengthCond input]) =
      some (PatternedScan.stS input 122 []) :=
    PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3662 4865 _ (by norm_num) packedPC3745)
