...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3833 .JUMPDEST (by exact GuardInstructionWindow.get 114),
   ...
   DirectGuard.pushAt 3840 2 5205 (by exact GuardInstructionWindow.get 121)]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4842 []) =
      some (PatternedScan.stS input 4853 [5205, byteValue input]) := by
  ...
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3833 4842 [] (by norm_num) (GuardInstructionWindow.pc 114))
  ...
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3834 4843 [] (by norm_num) (GuardInstructionWindow.pc 115))
  ...
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3835 4844 [0] (by norm_num) (GuardInstructionWindow.pc 116))
  ...
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3836 4845 [w] (by norm_num) (GuardInstructionWindow.pc 117))
  ...
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3837 4846 [0, w] (by norm_num) (GuardInstructionWindow.pc 118))
  ...
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3838 4847 [b] (by norm_num) (GuardInstructionWindow.pc 119))
  ...
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3839 4849 [7, b] (by norm_num) (GuardInstructionWindow.pc 120))
    (PatternedScan.stepS_xor input 4849 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3840 2 5205 (by exact GuardInstructionWindow.get 121)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3840 4850 [v] (by norm_num) (GuardInstructionWindow.pc 121))
    (PatternedScan.stepS_push input 4850 2 5205 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3842 = 4854 := by
  exact GuardInstructionWindow.pc 123

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3843 = 4855 := by
  exact GuardInstructionWindow.pc 124

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3844 = 4873 := by
  exact GuardInstructionWindow.pc 125

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3845 = 4874 := by
  exact GuardInstructionWindow.pc 126

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3846 = 4875 := by
  exact GuardInstructionWindow.pc 127

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3847 = 4877 := by
  exact GuardInstructionWindow.pc 128

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3848 = 4878 := by
  exact GuardInstructionWindow.pc 129

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3849 = 4880 := by
  exact GuardInstructionWindow.pc 130

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3850 = 4881 := by
  exact GuardInstructionWindow.pc 131

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3851 = 4882 := by
  exact GuardInstructionWindow.pc 132

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3852 = 4885 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4854 []) =
      some (PatternedScan.stS input 4880 [106, sizeBit input, 0]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4853 [5205, byteValue input]) =
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3841 4853 [5205, byteValue input] (by norm_num) (GuardInstructionWindow.pc 122))
    (PatternedScan.stepS_jumpi_taken input 4853 5205 5205 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122)] (PatternedScan.stS input 4853 [5205, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4854 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3841 .JUMPI (by exact GuardInstructionWindow.get 122))
    (PatternedScan.pcFactS input 3841 4853 [5205, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 122))
    (PatternedScan.stepS_jumpi_fall input 4853 5205 (UInt256.ofNat 0) []
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 130)]
      (PatternedScan.stS input 4880 [106, sizeBit input, 0]) =
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 130))
    (PatternedScan.pcFactS input 3849 4880 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4880 106 106 (sizeBit input) [0]
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 130)]
      (PatternedScan.stS input 4880 [106, sizeBit input, 0]) =
      some (PatternedScan.stS input 4881 [0]) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3849 .JUMPI (by exact GuardInstructionWindow.get 130))
    (PatternedScan.pcFactS input 3849 4880 [106, sizeBit input, 0] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4880 106 (sizeBit input) [0]
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4881 [0]) =
      some (DirectGuard.fallbackState input) := by
  let l0 : Located := DirectGuard.opAt 3850 .POP (by exact GuardInstructionWindow.get 131)
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3850 4881 [0] (by norm_num) sizeHitPC4112)
    (PatternedScan.stepS_pop input 4881 0 [] (by simp) (by norm_num))
  let l1 : Located := DirectGuard.pushAt 3851 2 272 (by exact GuardInstructionWindow.get 132)
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3851 4882 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4882 2 272 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3852 .JUMP (by exact GuardInstructionWindow.get 133)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3852 4885 [272] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4885 272 272 [] (by simp) (by norm_num) (by rfl) guard_fallback_dest)
