...
private def bytePrefix : List Located :=
  [DirectGuard.opAt 3839 .JUMPDEST (by exact GuardInstructionWindow.get 181),
   ...
   DirectGuard.pushAt 3846 2 4886 (by exact GuardInstructionWindow.get 188)]
...
private theorem run_byte_prefix (input : ByteArray) :
    DirectGuard.run bytePrefix (PatternedScan.stS input 4844 []) =
      some (PatternedScan.stS input 4855 [4886, byteValue input]) := by
  ...
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 3839 4844 [] (by norm_num) (GuardInstructionWindow.pc 181))
  ...
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3840 4845 [] (by norm_num) (GuardInstructionWindow.pc 182))
  ...
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3841 4846 [0] (by norm_num) (GuardInstructionWindow.pc 183))
  ...
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 3842 4847 [w] (by norm_num) (GuardInstructionWindow.pc 184))
  ...
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 3843 4848 [0, w] (by norm_num) (GuardInstructionWindow.pc 185))
  ...
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 3844 4849 [b] (by norm_num) (GuardInstructionWindow.pc 186))
  ...
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 3845 4851 [7, b] (by norm_num) (GuardInstructionWindow.pc 187))
    (PatternedScan.stepS_xor input 4851 7 b [] (by simp) (by norm_num))
  let l7 : Located := DirectGuard.pushAt 3846 2 4886 (by exact GuardInstructionWindow.get 188)
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 3846 4852 [v] (by norm_num) (GuardInstructionWindow.pc 188))
    (PatternedScan.stepS_push input 4852 2 4886 [v] (by simp) (by decide) (by decide) (by norm_num))
...
@[simp] private theorem sizeHitPC4102 : Artifact.submissionArtifact.instructionPC 3848 = 4856 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4103 : Artifact.submissionArtifact.instructionPC 3848 = 4856 := by
  exact GuardInstructionWindow.pc 190

@[simp] private theorem sizeHitPC4106 : Artifact.submissionArtifact.instructionPC 3849 = 4874 := by
  exact GuardInstructionWindow.pc 191

@[simp] private theorem sizeHitPC4107 : Artifact.submissionArtifact.instructionPC 3850 = 4875 := by
  exact GuardInstructionWindow.pc 192

@[simp] private theorem sizeHitPC4108 : Artifact.submissionArtifact.instructionPC 3851 = 4876 := by
  exact GuardInstructionWindow.pc 193

@[simp] private theorem sizeHitPC4109 : Artifact.submissionArtifact.instructionPC 3852 = 4878 := by
  exact GuardInstructionWindow.pc 194

@[simp] private theorem sizeHitPC4110 : Artifact.submissionArtifact.instructionPC 3853 = 4879 := by
  exact GuardInstructionWindow.pc 195

@[simp] private theorem sizeHitPC4111 : Artifact.submissionArtifact.instructionPC 3854 = 4881 := by
  exact GuardInstructionWindow.pc 196

@[simp] private theorem sizeHitPC4112 : Artifact.submissionArtifact.instructionPC 3855 = 4882 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4113 : Artifact.submissionArtifact.instructionPC 3855 = 4882 := by
  exact GuardInstructionWindow.pc 197

@[simp] private theorem sizeHitPC4114 : Artifact.submissionArtifact.instructionPC 3856 = 4885 := by
...
private theorem run_size_prefix (input : ByteArray) :
    DirectGuard.run sizePrefix (PatternedScan.stS input 4856 []) =
      some (PatternedScan.stS input 4881 [107, sizeBit input]) := by
...
private theorem run_byte_fail (input : ByteArray)
    (hbyte : DirectGuard.firstByte input ≠ 7) :
    DirectGuard.run [DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 4855 [4886, byteValue input]) =
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3847 4855 [4886, byteValue input] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_taken input 4855 4886 4886 (byteValue input) []
...
private theorem run_byte_fall (input : ByteArray) :
    DirectGuard.run [DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 189)] (PatternedScan.stS input 4855 [4886, UInt256.ofNat 0]) =
      some (PatternedScan.stS input 4856 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3847 .JUMPI (by exact GuardInstructionWindow.get 189))
    (PatternedScan.pcFactS input 3847 4855 [4886, UInt256.ofNat 0] (by norm_num) (GuardInstructionWindow.pc 189))
    (PatternedScan.stepS_jumpi_fall input 4855 4886 (UInt256.ofNat 0) []
...
private theorem run_size_match (input : ByteArray) (hc : UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3854 .JUMPI (by exact GuardInstructionWindow.get 196)]
      (PatternedScan.stS input 4881 [107, sizeBit input]) =
  ...
  exact PatternedScan.blockOfS (DirectGuard.opAt 3854 .JUMPI (by exact GuardInstructionWindow.get 196))
    (PatternedScan.pcFactS input 3854 4881 [107, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_taken input 4881 107 107 (sizeBit input) []
...
private theorem run_size_fall (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeBit input)) :
    DirectGuard.run [DirectGuard.opAt 3854 .JUMPI (by exact GuardInstructionWindow.get 196)]
      (PatternedScan.stS input 4881 [107, sizeBit input]) =
      some (PatternedScan.stS input 4882 []) := by
  exact PatternedScan.blockOfS (DirectGuard.opAt 3854 .JUMPI (by exact GuardInstructionWindow.get 196))
    (PatternedScan.pcFactS input 3854 4881 [107, sizeBit input] (by norm_num) sizeHitPC4111)
    (PatternedScan.stepS_jumpi_fall input 4881 107 (sizeBit input) []
      (by simp) (by norm_num) hc)

private theorem run_fallback_suffix (input : ByteArray) :
    DirectGuard.run fallbackSuffix (PatternedScan.stS input 4882 []) =
  ...
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 3855 4882 [] (by norm_num) sizeHitPC4113)
    (PatternedScan.stepS_push input 4882 2 351 [] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := DirectGuard.opAt 3856 .JUMP (by exact GuardInstructionWindow.get 198)
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 3856 4885 [351] (by norm_num) sizeHitPC4114)
    (PatternedScan.stepS_jump input 4885 351 351 [] (by simp) (by norm_num) rfl guard_fallback_dest)
