...
def gasSteps_size_test (input : ByteArray) (sv ov : UInt256) (rest : List UInt256)
  ...
  have a := soundS (opAt 156 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 156 241 _ (by norm_num) (by rfl))
      (stepS_calldatasize input 241 (sv :: ov :: rest) (by simp; omega) (by norm_num)))
  have b := soundS (opAt 157 (.Dup ⟨2, by decide⟩))
    (blockOfS _ (pcFactS input 157 242 _ (by norm_num) (by rfl))
  ...
  have c := soundS (opAt 158 .LT)
    (blockOfS _ (pcFactS input 158 243 _ (by norm_num) (by rfl))
      (stepS_lt input 243 ov (UInt256.ofNat input.size) (sv :: ov :: rest)
        (by simp; omega) (by norm_num)))
  have d := soundS (pushAt 159 1 152)
    (blockOfS _ (pcFactS input 159 244 _ (by norm_num) (by rfl))
...
def gasSteps_size_more (input : ByteArray) (sv ov : UInt256) (rest : List UInt256)
  ...
  exact (gasSteps_size_test input sv ov rest hlen).trans
    (soundS (opAt 160 .JUMPI)
      (blockOfS _ (pcFactS input 160 246 _ (by norm_num) (by rfl))
