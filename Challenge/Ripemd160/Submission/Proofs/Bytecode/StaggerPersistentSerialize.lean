...
theorem endian8_pc : endian8Site.startPC = UInt256.ofNat 4651 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3663) = UInt256.ofNat 4651
...
theorem endian16_pc : endian16Site.startPC = UInt256.ofNat 4683 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3673) = UInt256.ofNat 4683
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem terminal_pc : terminalSite.startPC = UInt256.ofNat 4715 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3683) = UInt256.ofNat 4715
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
