...
theorem endian8_pc : endian8Site.startPC = UInt256.ofNat 4673 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3736) = UInt256.ofNat 4673
...
theorem endian16_pc : endian16Site.startPC = UInt256.ofNat 4705 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3746) = UInt256.ofNat 4705
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem terminal_pc : terminalSite.startPC = UInt256.ofNat 4737 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3756) = UInt256.ofNat 4737
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
