...
theorem entry_pc : entrySite.startPC = UInt256.ofNat 4734 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3789) = UInt256.ofNat 4734
...
theorem endian8_pc : endian8Site.startPC = UInt256.ofNat 4751 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3802) = UInt256.ofNat 4751
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem endian16_pc : endian16Site.startPC = UInt256.ofNat 4767 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3815) = UInt256.ofNat 4767
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem terminal_pc : terminalSite.startPC = UInt256.ofNat 4784 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3828) = UInt256.ofNat 4784
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
