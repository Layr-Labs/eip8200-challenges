...
theorem endian8_slice : (Artifact.submissionArtifact.instructions.drop 3572).take endian8Code.length = endian8Code := by rfl
...
theorem endian8_pc : endian8Site.startPC = UInt256.ofNat 4662 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3572) = UInt256.ofNat 4662
...
theorem endian16_slice : (Artifact.submissionArtifact.instructions.drop 3582).take endian16Code.length = endian16Code := by rfl
...
theorem endian16_pc : endian16Site.startPC = UInt256.ofNat 4675 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3582) = UInt256.ofNat 4675
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem terminal_slice : (Artifact.submissionArtifact.instructions.drop 3592).take terminalCode.length = terminalCode := by rfl
...
theorem terminal_pc : terminalSite.startPC = UInt256.ofNat 4689 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3592) = UInt256.ofNat 4689
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
