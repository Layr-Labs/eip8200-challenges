...
theorem endian8_pc : endian8Site.startPC = UInt256.ofNat 4690 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3547) = UInt256.ofNat 4690
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
theorem endian8_end : endian8Site.endPC = UInt256.ofNat 4703 := by
...
theorem endian16_pc : endian16Site.startPC = UInt256.ofNat 4703 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3557) = UInt256.ofNat 4703
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
theorem endian16_end : endian16Site.endPC = UInt256.ofNat 4717 := by
...
theorem terminal_pc : terminalSite.startPC = UInt256.ofNat 4717 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3567) = UInt256.ofNat 4717
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
