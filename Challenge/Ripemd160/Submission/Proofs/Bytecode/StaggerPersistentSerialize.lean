...
theorem endian8_pc : endian8Site.startPC = UInt256.ofNat 4767 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3825) = UInt256.ofNat 4767
...
theorem endian16_pc : endian16Site.startPC = UInt256.ofNat 4799 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3835) = UInt256.ofNat 4799
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem terminal_pc : terminalSite.startPC = UInt256.ofNat 4831 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3845) = UInt256.ofNat 4831
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
