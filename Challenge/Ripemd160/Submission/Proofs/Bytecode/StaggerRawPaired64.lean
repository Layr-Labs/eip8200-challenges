...
theorem site_pc : site.startPC = UInt256.ofNat 3943 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3213) = UInt256.ofNat 3943
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3943) template = UInt256.ofNat 3988 := by decide
  rw [hend] at hraw
