...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v7) (UInt256.ofNat 22))),
    ...
    (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.land x.v1 (UInt256.add (UInt256.ofNat 2840853838) (UInt256.add (MachineState.readWord memory 210) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v9 x.v7) x.v0) (UInt256.xor x.v9 (UInt256.xor x.v7 x.v4))) x.v6))))) (UInt256.ofNat 23)))),
    x.v8,
    x.v9,
    x.v10,
    x.v11,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3212).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3212 actual_slice
    (by change 3212 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 3940 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3212) = UInt256.ofNat 3940
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3940) template = UInt256.ofNat 3985 := by decide
  rw [hend] at hraw
