...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add (UInt256.ofNat 2840853838) (UInt256.add (MachineState.readWord memory 54) (UInt256.add (UInt256.xor x.v11 (UInt256.xor x.v9 (UInt256.xor x.v6 (UInt256.lor x.v0 (UInt256.land x.v9 x.v11))))) x.v8))))) (UInt256.ofNat 29)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3944, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3988, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3944) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3944) template = UInt256.ofNat 3988 := by decide
  rw [hend] at hraw
