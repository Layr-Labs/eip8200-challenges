...
private def upperValue (high : UInt256) : UInt256 := (UInt256.xor (UInt256.mul (UInt256.ofNat 65537) (UInt256.land (UInt256.xor (UInt256.shiftRight (UInt256.xor (UInt256.mul (UInt256.land (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high) mask8) (UInt256.ofNat 257)) high) (UInt256.ofNat 16)) (UInt256.xor (UInt256.mul (UInt256.land (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high) mask8) (UInt256.ofNat 257)) high)) mask16)) (UInt256.xor (UInt256.mul (UInt256.land (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high) mask8) (UInt256.ofNat 257)) high))
...
private def lowerValue (low : UInt256) : UInt256 := (UInt256.xor (UInt256.mul (UInt256.ofNat 65537) (UInt256.land (UInt256.xor (UInt256.xor (UInt256.mul (UInt256.ofNat 257) (UInt256.land (UInt256.xor (UInt256.shiftRight low (UInt256.ofNat 8)) low) mask8)) low) (UInt256.shiftRight (UInt256.xor (UInt256.mul (UInt256.ofNat 257) (UInt256.land (UInt256.xor (UInt256.shiftRight low (UInt256.ofNat 8)) low) mask8)) low) (UInt256.ofNat 16))) mask16)) (UInt256.xor (UInt256.mul (UInt256.ofNat 257) (UInt256.land (UInt256.xor (UInt256.shiftRight low (UInt256.ofNat 8)) low) mask8)) low))
...
private theorem run_lower (s : State) (pc low returnPC : UInt256) (rest : List UInt256)
    ...
    runInstrSeq lowerReverse {s with pc := pc, stack := low :: mask8 :: mask16 :: returnPC :: maskWord :: rest} =
      some {s with pc := pcAfter pc lowerReverse, stack := PairedScheduleData.reversedWord low :: returnPC :: maskWord :: rest} := by
...
def cleanupTemplate : List Instr :=
  [.op .JUMPDEST, .op .JUMPDEST, .op (.Dup ⟨1, by decide⟩)]
private theorem run_cleanup (s : State) (pc returnPC : UInt256)
  ...
  have hcap (n : Nat) (hn : n ≤ 27) : rest.length + n < 1024 := by omega
  simp (discharger := omega) [cleanupTemplate, runInstrSeq, DataStepper.runInstr, pcAfter,
    UInt256.succ, Instr.size, hrun, hcap, Nat.add_assoc, List.getElem?_cons_zero]
  all_goals repeat first | apply And.intro | rfl
