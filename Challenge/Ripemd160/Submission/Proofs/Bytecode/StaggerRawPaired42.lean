...
theorem site_pc : site.startPC = UInt256.ofNat 3033 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2293) = UInt256.ofNat 3033
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3033) template = UInt256.ofNat 3067 := by decide
  rw [hend] at hraw
