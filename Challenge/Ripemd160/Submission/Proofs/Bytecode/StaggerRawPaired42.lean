...
theorem site_pc : site.startPC = UInt256.ofNat 2936 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2244) = UInt256.ofNat 2936
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2936) template = UInt256.ofNat 2968 := by decide
  rw [hend] at hraw
