...
theorem site_pc : site.startPC = UInt256.ofNat 3548 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2718) = UInt256.ofNat 3548
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3548) template = UInt256.ofNat 3588 := by decide
  rw [hend] at hraw
