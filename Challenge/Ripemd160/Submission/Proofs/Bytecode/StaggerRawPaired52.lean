...
theorem site_pc : site.startPC = UInt256.ofNat 3492 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2688) = UInt256.ofNat 3492
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3492) template = UInt256.ofNat 3533 := by decide
  rw [hend] at hraw
