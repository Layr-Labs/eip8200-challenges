...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v8) (UInt256.ofNat 28))),
    ...
    x.v6,
    x.v0,
    (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.land x.v2 (UInt256.add x.v6 (UInt256.add x.v1 (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v3 x.v8) x.v5) (UInt256.xor (UInt256.land x.v3 x.v8) x.v0)) x.v8) x.v7))))) (UInt256.ofNat 24)))),
    x.v9,
    x.v10,
    x.v11,
    x.v12,
...
theorem site_pc : site.startPC = UInt256.ofNat 3496 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2693) = UInt256.ofNat 3496
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3496, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3534, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3496) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3496) template = UInt256.ofNat 3534 := by decide
  rw [hend] at hraw
