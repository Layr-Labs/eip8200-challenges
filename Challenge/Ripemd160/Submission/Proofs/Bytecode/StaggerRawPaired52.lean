...
theorem site_pc : site.startPC = UInt256.ofNat 3409 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2731) = UInt256.ofNat 3409
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3409) template = UInt256.ofNat 3447 := by decide
  rw [hend] at hraw
