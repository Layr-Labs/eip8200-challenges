import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 3636 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2976) = UInt256.ofNat 3636
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 3636) template = UInt256.ofNat 3682 := by decide
   rw [hend] at hraw
