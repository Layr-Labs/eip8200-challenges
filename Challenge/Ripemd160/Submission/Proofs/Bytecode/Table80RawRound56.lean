import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 3547 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2936) = UInt256.ofNat 3547
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 3547) template = UInt256.ofNat 3593 := by decide
   rw [hend] at hraw
