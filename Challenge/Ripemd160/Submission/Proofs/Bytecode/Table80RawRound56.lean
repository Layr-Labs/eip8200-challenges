import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 3557 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2926) = UInt256.ofNat 3557
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 3557) template = UInt256.ofNat 3603 := by decide
   rw [hend] at hraw
