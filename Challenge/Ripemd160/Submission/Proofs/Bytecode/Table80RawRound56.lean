import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 3554 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2940) = UInt256.ofNat 3554
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 3554) template = UInt256.ofNat 3600 := by decide
   rw [hend] at hraw
