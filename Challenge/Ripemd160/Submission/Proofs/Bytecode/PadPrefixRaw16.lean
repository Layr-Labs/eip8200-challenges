...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw16
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v6,
    x.v7,
    (UInt256.add (UInt256.ofNat 1518500249) x.v5),
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add (UInt256.add (UInt256.ofNat 1518500249) x.v5) (UInt256.add (MachineState.readWord memory 252) (UInt256.add (UInt256.lor (UInt256.xor x.v0 (UInt256.land (UInt256.xor x.v4 x.v6) (UInt256.lor x.v0 x.v9))) (UInt256.land x.v9 x.v6)) x.v8))))) (UInt256.ofNat 31)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v7,
    (UInt256.add (UInt256.ofNat 1518500249) x.v5),
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add (UInt256.add (UInt256.ofNat 1518500249) x.v5) (UInt256.add (MachineState.readWord memory 252) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.xor x.v6 x.v4) (UInt256.lor x.v9 x.v0)) x.v0) (UInt256.land x.v9 x.v6)) x.v8))))) (UInt256.ofNat 31)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
private theorem run_generated (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
  ...
  have hz252 : MachineState.readWord s.memory 252 = UInt256.ofNat 0 :=
    PadPrefixContract.read_zero s hz ⟨14, by decide⟩ (by decide)
  ...
  simp (discharger := omega) [template, inputStack, actualOutput, hz252,
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw16
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 4580).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 4580 actual_slice
    (by change 4580 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 5759 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 4580) = UInt256.ofNat 5759
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 5759, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 5801, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 5759) x rho hstack hrun hactive hz
  have hend : pcAfter (UInt256.ofNat 5759) template = UInt256.ofNat 5801 := by decide
  rw [hend] at hraw
