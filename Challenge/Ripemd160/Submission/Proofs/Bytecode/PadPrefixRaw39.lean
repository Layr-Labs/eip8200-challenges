...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw39
...
def template : List Instr :=
  [ .op (.Swap ⟨7, by decide⟩),
    ...
    .op .SHR,
    .op .OR,
    .push ⟨13, by decide⟩ (UInt256.ofNat 1267650599933081496321645346815),
    .op .AND,
    .op (.Dup ⟨10, by decide⟩),
    .op .MUL,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land (UInt256.ofNat 1267650599933081496321645346815) (UInt256.lor (UInt256.shiftRight (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 468) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8))) (UInt256.ofNat 76)) (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 468) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8)))))) (UInt256.ofNat 23)))),
    x.v7,
    x.v0,
    x.v9,
    x.v10,
...
private theorem run_generated (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
  ...
  have hz468 : MachineState.readWord s.memory 468 = UInt256.ofNat 0 :=
    PadPrefixContract.read_zero s hz ⟨26, by decide⟩ (by decide)
  ...
  simp (discharger := omega) [template, inputStack, actualOutput, hz468,
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw39
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 5393).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 5393 actual_slice
    (by change 5393 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 6733 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 5393) = UInt256.ofNat 6733
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 6733, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 6779, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 6733) x rho hstack hrun hactive hz
  have hend : pcAfter (UInt256.ofNat 6733) template = UInt256.ofNat 6779 := by decide
  rw [hend] at hraw
