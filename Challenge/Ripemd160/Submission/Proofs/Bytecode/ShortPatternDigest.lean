...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternDigest
...
theorem spec_pattern56 : Challenge.Ripemd160.spec ShortPatternLogic.data56 = paddedDigest56 := by
  change Challenge.Ripemd160.spec (PatternedInputData.patternedInput.extract 0 56) = paddedDigest56
  rw [← data56_pattern]
  exact spec56
#print axioms spec_pattern56
theorem spec_pattern120 : Challenge.Ripemd160.spec ShortPatternLogic.data120 = paddedDigest120 := by
  change Challenge.Ripemd160.spec (PatternedInputData.patternedInput.extract 0 120) = paddedDigest120
  rw [← data120_pattern]
  exact spec120
#print axioms spec_pattern120
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternDigest
