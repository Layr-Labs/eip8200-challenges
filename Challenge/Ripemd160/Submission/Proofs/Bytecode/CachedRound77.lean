...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3767).take actualTemplate.length = actualTemplate := by rfl
def actualSite : GenericRoundSite Artifact.submissionArtifact .Osaka actualTemplate :=
  StackSiteBuilder.ofSlice actualTemplate 3767 actual_slice
...
theorem actual_pc : actualSite.startPC = UInt256.ofNat 4471 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3767) = UInt256.ofNat 4471
