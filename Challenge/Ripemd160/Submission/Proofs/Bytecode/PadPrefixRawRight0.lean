...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRawRight0
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v6 x.v3) (UInt256.ofNat 28)),
    x.v0,
    x.v2,
    (UInt256.land x.v7 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v6 (UInt256.land x.v7 (UInt256.add x.v0 (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v4) x.v3) x.v2) x.v1))))) (UInt256.ofNat 30)))),
    x.v4,
    x.v5,
    x.v6,
    x.v7,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v6 x.v3) (UInt256.ofNat 28)),
    x.v0,
    x.v2,
    (UInt256.land x.v7 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v6 (UInt256.land x.v7 (UInt256.add x.v0 (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.xor x.v2 (UInt256.lor (UInt256.lnot x.v4) x.v3)) x.v1))))) (UInt256.ofNat 30)))),
    x.v4,
    x.v5,
    x.v6,
    x.v7,
...
private theorem run_generated (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
    (hstack : rho.length ≤ 900) (halias : rho[0]? = some x.v2) (hrun : s.halt = .Running)
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3891).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3891 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4988 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3891) = UInt256.ofNat 4988
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4988, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 5019, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4988) x rho hstack halias hrun hactive
  have hend : pcAfter (UInt256.ofNat 4988) template = UInt256.ofNat 5019 := by decide
  rw [hend] at hraw
  exact DenseScheduleLift.gasSteps_of_raw site _ _ hcode hfork hrun hnp site_pc.symm advances hraw
#print axioms gasSteps
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRawRight0
