import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawRound52
 ...
 def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
   [ (UInt256.land x.v7 (UInt256.shiftRight (UInt256.mul x.v6 x.v3) (UInt256.ofNat 22))),
    x.v0,
    x.v2,
    (UInt256.land x.v7 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v6 (UInt256.land x.v7 (UInt256.add x.v4 (UInt256.add (MachineState.readWord memory 510) (UInt256.add (UInt256.xor x.v3 (UInt256.land (UInt256.xor (UInt256.lor x.v8 x.v3) x.v2) (UInt256.xor (UInt256.land x.v8 x.v3) x.v0))) x.v1))))) (UInt256.ofNat 18)))),
    x.v4,
    x.v5,
    x.v6,
    x.v7,
 ...
 def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
   StackSiteBuilder.ofSlice template 2775 actual_slice
     ...
     (by decide)
 theorem site_pc : site.startPC = UInt256.ofNat 3393 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2775) = UInt256.ofNat 3393
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
     ...
     GasSteps {s with pc := UInt256.ofNat 3393, stack := inputStack x rho}
       {s with pc := UInt256.ofNat 3433, stack := outputStack s.memory x rho} := by
   have hraw := run_actual s (UInt256.ofNat 3393) x rho hstack hrun hactive
   have hend : pcAfter (UInt256.ofNat 3393) template = UInt256.ofNat 3433 := by decide
   rw [hend] at hraw
   exact DenseScheduleLift.gasSteps_of_raw site _ _ hcode hfork hrun hnp site_pc.symm advances hraw
 #print axioms gasSteps

end Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawRound52
