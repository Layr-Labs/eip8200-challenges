...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan32
...
def gasSteps_last (input : ByteArray) (hsize : input.size = 32) :
  ...
  gasSteps_compare_end input 0 (scalarAt 0) (scanAcc input 0)
    (by rw [hsize]; decide) (by rw [hsize])
    (by norm_num) (by decide) (by decide)
def gasSteps_scan (input : ByteArray) (hsize : input.size = 32) :
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan32
#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan32.gasSteps_scan
