...
theorem schedule_endInstructionPC :
    Artifact.submissionArtifact.instructionPC 453 = 755 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
theorem tailPrefix_instructionPC :
    Artifact.submissionArtifact.instructionPC 4019 = 4951 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

theorem tailPrefix_endInstructionPC :
    Artifact.submissionArtifact.instructionPC 4088 = 5045 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
