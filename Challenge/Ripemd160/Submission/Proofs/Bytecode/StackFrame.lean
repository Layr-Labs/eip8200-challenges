...
def prefixPath : List Located :=
  [⟨861, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨864, .push ⟨2, by decide⟩ (UInt256.ofNat 0x10c1), by rfl, by decide⟩,
...
@[simp] theorem loadSite1238_startPC :
    loadSite1238.startPC = UInt256.ofNat 0x9ee := by
...
theorem run_prefix (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest12ac : Decode.isValidJumpDest submissionBytecode 0x10c1 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2775 (by rfl)
...
theorem run_route (s : State) (left : Compression.EvmWorking)
  ...
  have hpc : Artifact.submissionArtifact.instructionPC
      QuadLayout.routeIndex = 0x9ed := QuadLayout.route_pc
