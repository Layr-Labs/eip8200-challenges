...
def exitPath : List Located :=
  [⟨325, .push ⟨4, by decide⟩ mask, by rfl, by decide⟩,
   ⟨326, .push ⟨5, by decide⟩ QuadRoundTemplate.factor, by rfl, by decide⟩]
...
@[simp] theorem loadSite987_startPC : loadSite987.startPC = UInt256.ofNat 0x267 := by
  rfl

@[simp] theorem loadSite1238_startPC :
    loadSite1238.startPC = UInt256.ofNat 0xb65 := by
...
def frameRest (input : ByteArray) (i : Nat) : List UInt256 :=
  UInt256.ofNat 0x73 :: StackBlockModel.driverRest input i
...
def frameSeam (s : State) (input : ByteArray) (i : Nat) : State :=
  { StackBlockModel.scheduledState s input i with
    pc := UInt256.ofNat 0x258, stack := frameRest input i }
...
theorem frameEntry_eq_scheduleEntry (s : State) (input : ByteArray) (i : Nat) :
    DriverTrace.compressEntry s input i =
      DenseScheduleTemplate.scheduleEntry s
        ...
        (DriverTrace.messageOffsetWord i) (UInt256.ofNat 0x73)
...
theorem denseEnd_eq_frameSeam (s : State) (input : ByteArray) (i : Nat) :
  ...
  have hpc : PackedScheduleSite.packedScheduleSite.startPC = UInt256.ofNat 471 :=
  ...
  have h := DenseScheduleState.returned_eq_schedule_with_memory_active s
    (UInt256.ofNat 471) mo (UInt256.ofNat 670) (UInt256.ofNat 0x73 :: dr)
    (DenseScheduleTemplate.denseExpectedMemory s mo) rfl
  have hu := congrArg (fun t : State =>
    { t with pc := UInt256.ofNat 600, stack := UInt256.ofNat 0x73 :: dr }) h
  rw [hpc]
  show DenseScheduleTemplate.denseExpectedState s (UInt256.ofNat 471)
      mo (UInt256.ofNat 0x73) dr = frameSeam s input i
  calc DenseScheduleTemplate.denseExpectedState s (UInt256.ofNat 471)
        mo (UInt256.ofNat 0x73) dr =
      { Schedule.scheduleReturned
          (DenseScheduleTemplate.denseExpectedState s (UInt256.ofNat 471)
            mo (UInt256.ofNat 670) (UInt256.ofNat 0x73 :: dr))
          (UInt256.ofNat 670) (UInt256.ofNat 0x73 :: dr) with
        pc := UInt256.ofNat 600, stack := UInt256.ofNat 0x73 :: dr } := by
    ...
    _ = { Schedule.scheduleReturned
            ...
            (UInt256.ofNat 670) (UInt256.ofNat 0x73 :: dr) with
          pc := UInt256.ofNat 600, stack := UInt256.ofNat 0x73 :: dr } := hu
    _ = frameSeam s input i := by
        ...
        rw [show [UInt256.ofNat 0x73] ++ dr = UInt256.ofNat 0x73 :: dr from rfl]
...
theorem run_exit (s : State) (input : ByteArray) (i : Nat)
  ...
  have hpc940 : Artifact.submissionArtifact.instructionPC 325 = 0x218 := by rfl
  have hpc941 : Artifact.submissionArtifact.instructionPC 326 = 0x219 := by rfl
...
def gasSteps_schedule (s : State) (input : ByteArray) (i : Nat)
  ...
  have hraw :
      StackRoundTrace.runInstrSeq DenseScheduleTemplate.denseBeforeJumpTemplate
        (DenseScheduleTemplate.scheduleEntry s
          PackedScheduleSite.packedScheduleSite.startPC
          (DriverTrace.messageOffsetWord i) (UInt256.ofNat 0x73) rest) =
        some (DenseScheduleTemplate.denseExpectedState s
          PackedScheduleSite.packedScheduleSite.startPC
          (DriverTrace.messageOffsetWord i) (UInt256.ofNat 0x73) rest) := by
