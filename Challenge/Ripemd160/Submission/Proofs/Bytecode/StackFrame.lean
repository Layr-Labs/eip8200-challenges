...
def prefixPath : List Located :=
  [⟨1074, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨1077, .push ⟨2, by decide⟩ (UInt256.ofNat 0x1126), by rfl, by decide⟩,
...
theorem run_prefix (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest12ac : Decode.isValidJumpDest submissionBytecode 0x1126 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2782 (by rfl)
