...
def prefixPath : List Located :=
  [⟨889, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨892, .push ⟨2, by decide⟩ (UInt256.ofNat 4711), by rfl, by decide⟩,
...
@[simp] theorem loadSite1238_startPC :
    loadSite1238.startPC = UInt256.ofNat 0xb75 := by
...
theorem run_prefix (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest12ac : Decode.isValidJumpDest submissionBytecode 0x1267 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3249 (by rfl)
...
theorem run_route (s : State) (left : Compression.EvmWorking)
  ...
  have hpc : Artifact.submissionArtifact.instructionPC
      QuadLayout.routeIndex = 0xb74 := QuadLayout.route_pc
