...
theorem site_pc : site.startPC = UInt256.ofNat 3733 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3040) = UInt256.ofNat 3733
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3733) template = UInt256.ofNat 3771 := by decide
  rw [hend] at hraw
