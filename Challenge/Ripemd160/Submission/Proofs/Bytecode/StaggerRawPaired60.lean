...
theorem site_pc : site.startPC = UInt256.ofNat 3835 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3000) = UInt256.ofNat 3835
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3835) template = UInt256.ofNat 3876 := by decide
  rw [hend] at hraw
