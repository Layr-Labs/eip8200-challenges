...
theorem site_pc : site.startPC = UInt256.ofNat 3849 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3008) = UInt256.ofNat 3849
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3849) template = UInt256.ofNat 3890 := by decide
  rw [hend] at hraw
