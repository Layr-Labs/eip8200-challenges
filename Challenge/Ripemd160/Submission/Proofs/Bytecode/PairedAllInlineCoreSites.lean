import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift0
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift1
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift8
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift9
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift10
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift11
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift12
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift13
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift14
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift15
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift18
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift19
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift20
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift22
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift24
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift25
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift26
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift29
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift30
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift31
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift33
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift34
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift36
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift37
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift38
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift39
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift42
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift44
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift45
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift47
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift48
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift49
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift50
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift51
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift52
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift53
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift54
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift56
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift59
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift60
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift65
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift67
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift69
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift71
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift72
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift73
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift75
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift76
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedShift78
...
def gasSteps_core_prefix (s : State) (f : CoreFrame) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 766, stack := coreStack [.a, .b, .c, .d, .e, .factor, .pair, .upper, .lower] f (cache s.memory ++ rho)}
      {s with pc := UInt256.ofNat 4563, stack := coreStack [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] (PairedAllInlineCoreTrace.corePrefixChain.eval s.memory f) (cache s.memory ++ rho)} := by
  ...
  have g1 := CachedShift0.gasSteps s f1 rho hstack hrun hactive hcode hfork hnp
  let f3 := PairedAllInlineCoreTrace.inline1Block.eval s.memory f2
  have g2 := CachedShift1.gasSteps s f2 rho hstack hrun hactive hcode hfork hnp
  ...
  have g9 := CachedShift8.gasSteps s f9 rho hstack hrun hactive hcode hfork hnp
  let f11 := PairedAllInlineCoreTrace.inline9Block.eval s.memory f10
  have g10 := CachedShift9.gasSteps s f10 rho hstack hrun hactive hcode hfork hnp
  let f12 := PairedAllInlineCoreTrace.inline10Block.eval s.memory f11
  have g11 := CachedShift10.gasSteps s f11 rho hstack hrun hactive hcode hfork hnp
  let f13 := PairedAllInlineCoreTrace.inline11Block.eval s.memory f12
  have g12 := CachedShift11.gasSteps s f12 rho hstack hrun hactive hcode hfork hnp
  let f14 := PairedAllInlineCoreTrace.inline12Block.eval s.memory f13
  have g13 := CachedShift12.gasSteps s f13 rho hstack hrun hactive hcode hfork hnp
  let f15 := PairedAllInlineCoreTrace.inline13Block.eval s.memory f14
  have g14 := CachedShift13.gasSteps s f14 rho hstack hrun hactive hcode hfork hnp
  let f16 := PairedAllInlineCoreTrace.inline14Block.eval s.memory f15
  have g15 := CachedShift14.gasSteps s f15 rho hstack hrun hactive hcode hfork hnp
  let f17 := PairedAllInlineCoreTrace.inline15Block.eval s.memory f16
  have g16 := CachedShift15.gasSteps s f16 rho hstack hrun hactive hcode hfork hnp
  ...
  have g20 := CachedShift18.gasSteps s f20 rho hstack hrun hactive hcode hfork hnp
  let f22 := PairedAllInlineCoreTrace.inline19Block.eval s.memory f21
  have g21 := CachedShift19.gasSteps s f21 rho hstack hrun hactive hcode hfork hnp
  let f23 := PairedAllInlineCoreTrace.inline20Block.eval s.memory f22
  have g22 := CachedShift20.gasSteps s f22 rho hstack hrun hactive hcode hfork hnp
  ...
  have g24 := CachedShift22.gasSteps s f24 rho hstack hrun hactive hcode hfork hnp
  ...
  have g26 := CachedShift24.gasSteps s f26 rho hstack hrun hactive hcode hfork hnp
  let f28 := PairedAllInlineCoreTrace.inline25Block.eval s.memory f27
  have g27 := CachedShift25.gasSteps s f27 rho hstack hrun hactive hcode hfork hnp
  let f29 := PairedAllInlineCoreTrace.inline26Block.eval s.memory f28
  have g28 := CachedShift26.gasSteps s f28 rho hstack hrun hactive hcode hfork hnp
  ...
  have g31 := CachedShift29.gasSteps s f31 rho hstack hrun hactive hcode hfork hnp
  let f33 := PairedAllInlineCoreTrace.inline30Block.eval s.memory f32
  have g32 := CachedShift30.gasSteps s f32 rho hstack hrun hactive hcode hfork hnp
  let f34 := PairedAllInlineCoreTrace.inline31Block.eval s.memory f33
  have g33 := CachedShift31.gasSteps s f33 rho hstack hrun hactive hcode hfork hnp
  ...
  have g36 := CachedShift33.gasSteps s f36 rho hstack hrun hactive hcode hfork hnp
  let f38 := PairedAllInlineCoreTrace.inline34Block.eval s.memory f37
  have g37 := CachedShift34.gasSteps s f37 rho hstack hrun hactive hcode hfork hnp
  ...
  have g39 := CachedShift36.gasSteps s f39 rho hstack hrun hactive hcode hfork hnp
  let f41 := PairedAllInlineCoreTrace.inline37Block.eval s.memory f40
  have g40 := CachedShift37.gasSteps s f40 rho hstack hrun hactive hcode hfork hnp
  let f42 := PairedAllInlineCoreTrace.inline38Block.eval s.memory f41
  have g41 := CachedShift38.gasSteps s f41 rho hstack hrun hactive hcode hfork hnp
  let f43 := PairedAllInlineCoreTrace.inline39Block.eval s.memory f42
  have g42 := CachedShift39.gasSteps s f42 rho hstack hrun hactive hcode hfork hnp
  ...
  have g45 := CachedShift42.gasSteps s f45 rho hstack hrun hactive hcode hfork hnp
  ...
  have g47 := CachedShift44.gasSteps s f47 rho hstack hrun hactive hcode hfork hnp
  let f49 := PairedAllInlineCoreTrace.inline45Block.eval s.memory f48
  have g48 := CachedShift45.gasSteps s f48 rho hstack hrun hactive hcode hfork hnp
  ...
  have g50 := CachedShift47.gasSteps s f50 rho hstack hrun hactive hcode hfork hnp
  ...
  have g52 := CachedShift48.gasSteps s f52 rho hstack hrun hactive hcode hfork hnp
  let f54 := PairedAllInlineCoreTrace.inline49Block.eval s.memory f53
  have g53 := CachedShift49.gasSteps s f53 rho hstack hrun hactive hcode hfork hnp
  let f55 := PairedAllInlineCoreTrace.inline50Block.eval s.memory f54
  have g54 := CachedShift50.gasSteps s f54 rho hstack hrun hactive hcode hfork hnp
  let f56 := PairedAllInlineCoreTrace.inline51Block.eval s.memory f55
  have g55 := CachedShift51.gasSteps s f55 rho hstack hrun hactive hcode hfork hnp
  let f57 := PairedAllInlineCoreTrace.inline52Block.eval s.memory f56
  have g56 := CachedShift52.gasSteps s f56 rho hstack hrun hactive hcode hfork hnp
  let f58 := PairedAllInlineCoreTrace.inline53Block.eval s.memory f57
  have g57 := CachedShift53.gasSteps s f57 rho hstack hrun hactive hcode hfork hnp
  let f59 := PairedAllInlineCoreTrace.inline54Block.eval s.memory f58
  have g58 := CachedShift54.gasSteps s f58 rho hstack hrun hactive hcode hfork hnp
  ...
  have g60 := CachedShift56.gasSteps s f60 rho hstack hrun hactive hcode hfork hnp
  ...
  have g63 := CachedShift59.gasSteps s f63 rho hstack hrun hactive hcode hfork hnp
  let f65 := PairedAllInlineCoreTrace.inline60Block.eval s.memory f64
  have g64 := CachedShift60.gasSteps s f64 rho hstack hrun hactive hcode hfork hnp
  ...
  have g70 := CachedShift65.gasSteps s f70 rho hstack hrun hactive hcode hfork hnp
  ...
  have g72 := CachedShift67.gasSteps s f72 rho hstack hrun hactive hcode hfork hnp
  ...
  have g74 := CachedShift69.gasSteps s f74 rho hstack hrun hactive hcode hfork hnp
  ...
  have g76 := CachedShift71.gasSteps s f76 rho hstack hrun hactive hcode hfork hnp
  let f78 := PairedAllInlineCoreTrace.inline72Block.eval s.memory f77
  have g77 := CachedShift72.gasSteps s f77 rho hstack hrun hactive hcode hfork hnp
  let f79 := PairedAllInlineCoreTrace.inline73Block.eval s.memory f78
  have g78 := CachedShift73.gasSteps s f78 rho hstack hrun hactive hcode hfork hnp
  ...
  have g80 := CachedShift75.gasSteps s f80 rho hstack hrun hactive hcode hfork hnp
  let f82 := PairedAllInlineCoreTrace.inline76Block.eval s.memory f81
  have g81 := CachedShift76.gasSteps s f81 rho hstack hrun hactive hcode hfork hnp
  ...
  have g83 := CachedShift78.gasSteps s f83 rho hstack hrun hactive hcode hfork hnp
