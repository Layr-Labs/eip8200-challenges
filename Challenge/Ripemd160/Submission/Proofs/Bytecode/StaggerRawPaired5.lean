...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.add (UInt256.land x.v11 (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 666) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v4 x.v6) x.v0) (UInt256.xor x.v4 (UInt256.xor x.v9 x.v6))) x.v5))))) (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 666) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v4 x.v6) x.v0) (UInt256.xor x.v4 (UInt256.xor x.v9 x.v6))) x.v5)))))) (UInt256.ofNat 31)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
theorem site_pc : site.startPC = UInt256.ofNat 1399 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 899) = UInt256.ofNat 1399
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1399, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1442, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1399) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1399) template = UInt256.ofNat 1442 := by decide
  rw [hend] at hraw
