...
private theorem pc_base : Artifact.submissionArtifact.instructionPC 3681 = 4827 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3681+index) = 4827+byteLength (tail.take index) := by
