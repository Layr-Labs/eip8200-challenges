...
private theorem pc_base : Artifact.submissionArtifact.instructionPC 3667 = 4817 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3667+index) = 4817+byteLength (tail.take index) := by
