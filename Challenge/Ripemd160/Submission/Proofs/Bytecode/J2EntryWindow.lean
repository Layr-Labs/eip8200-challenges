...
private theorem pc_base : Artifact.submissionArtifact.instructionPC 3640 = 4841 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3640+index) = 4841+byteLength (tail.take index) := by
