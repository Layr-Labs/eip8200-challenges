...
private theorem pc_base : Artifact.submissionArtifact.instructionPC 3644 = 4832 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3644+index) = 4832+byteLength (tail.take index) := by
