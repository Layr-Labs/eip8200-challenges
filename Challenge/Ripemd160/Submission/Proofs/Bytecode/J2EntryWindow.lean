...
private theorem pc_base : Artifact.submissionArtifact.instructionPC 3685 = 4826 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3685+index) = 4826+byteLength (tail.take index) := by
