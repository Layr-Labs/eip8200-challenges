...
private theorem pc_base : Artifact.submissionArtifact.instructionPC 3640 = 4819 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3640+index) = 4819+byteLength (tail.take index) := by
