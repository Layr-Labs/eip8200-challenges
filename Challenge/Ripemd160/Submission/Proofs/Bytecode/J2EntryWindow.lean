...
private theorem pc_base : Artifact.submissionArtifact.instructionPC 3644 = 4836 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3644+index) = 4836+byteLength (tail.take index) := by
