...
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CavityFallthroughSitesLeft
import Challenge.Ripemd160.Submission.Proofs.Bytecode.CavityFallthroughSitesRight
...
def leftNormalIndexOf (k : Fin 20) (hk : 4 ≤ k.val) (h : k.val % 4 ≠ 3) : Fin 12 :=
  ⟨k.val - k.val / 4 - 3, by omega⟩

theorem leftNormalFin_indexOf (k : Fin 20) (hk : 4 ≤ k.val)
    (h : k.val % 4 ≠ 3) :
    CavityFallthroughSitesLeft.normalFin (leftNormalIndexOf k hk h) = k := by
  apply Fin.ext
  dsimp [leftNormalIndexOf, CavityFallthroughSitesLeft.normalFin]
  omega

def leftFallthroughGroupOf (k : Fin 20) (hk : 4 ≤ k.val) : Fin 4 :=
  ⟨k.val / 4 - 1, by omega⟩

theorem leftFallthroughK_groupOf (k : Fin 20) (hk : 4 ≤ k.val)
    (h : k.val % 4 = 3) :
    CavityFallthroughSitesLeft.fallthroughK (leftFallthroughGroupOf k hk) = k := by
  apply Fin.ext
  dsimp [leftFallthroughGroupOf, CavityFallthroughSitesLeft.fallthroughK]
  omega

def rightNormalIndexOf (k : Fin 20) (hk : k.val < 16) (h : k.val % 4 ≠ 3) : Fin 12 :=
  ⟨k.val - k.val / 4, by omega⟩

theorem rightNormalFin_indexOf (k : Fin 20) (hk : k.val < 16)
    (h : k.val % 4 ≠ 3) :
    CavityFallthroughSitesRight.normalFin (rightNormalIndexOf k hk h) = k := by
  apply Fin.ext
  dsimp [rightNormalIndexOf, CavityFallthroughSitesRight.normalFin]
  omega

def rightFallthroughGroupOf (k : Fin 20) (hk : k.val < 16) : Fin 4 :=
  ⟨k.val / 4, by omega⟩

theorem rightFallthroughK_groupOf (k : Fin 20) (hk : k.val < 16)
    (h : k.val % 4 = 3) :
    CavityFallthroughSitesRight.fallthroughK (rightFallthroughGroupOf k hk) = k := by
  apply Fin.ext
  dsimp [rightFallthroughGroupOf, CavityFallthroughSitesRight.fallthroughK]
  omega
