...
@[simp] theorem rightPC_zero : rightPC 0 = UInt256.ofNat 0x811 := by rfl

@[simp] theorem rightPC_end : rightPC 40 = UInt256.ofNat 0xae0 := by rfl

@[simp] theorem rightStartPC_eq : rightStartPC = UInt256.ofNat 0x811 := by rfl

@[simp] theorem rightEndPC_eq : rightEndPC = UInt256.ofNat 0xae0 := by rfl
