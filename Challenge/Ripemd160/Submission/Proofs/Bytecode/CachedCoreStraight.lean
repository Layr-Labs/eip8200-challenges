...
def group32Template : List Instr :=
  [ .op (.Swap ⟨3, by decide⟩),
    ...
    .op .JUMPDEST,
    .op .JUMPDEST ]
theorem group32_pcAfter : pcAfter (UInt256.ofNat 2513) group32Template = UInt256.ofNat 2541 := by rfl
def group32Physical : PairedAllInlineCoreTrace.CoreBlock 2513 2541 [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] [.k, .a, .b, .c, .d, .e, .factor, .pair, .upper, .lower] where
...
theorem inline33_pcAfter : pcAfter (UInt256.ofNat 2584) PairedAllInlineCoreTrace.inline33Template = UInt256.ofNat 2630 := by rfl
def inline33Physical : PairedAllInlineCoreTrace.CoreBlock 2584 2630 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline33Template
  eval := PairedAllInlineCoreTrace.inline33Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline33Template_word s (UInt256.ofNat 2584) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline33Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline33Template :=
  StackSiteBuilder.ofSlice inline33Template 2032 inline33_slice
    ...
    (by decide)
theorem inline33_pc : inline33Site.startPC = UInt256.ofNat 2584 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2032) = UInt256.ofNat 2584
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline34_pcAfter : pcAfter (UInt256.ofNat 2630) PairedAllInlineCoreTrace.inline34Template = UInt256.ofNat 2676 := by rfl
def inline34Physical : PairedAllInlineCoreTrace.CoreBlock 2630 2676 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline34Template
  eval := PairedAllInlineCoreTrace.inline34Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline34Template_word s (UInt256.ofNat 2630) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline34Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline34Template :=
  StackSiteBuilder.ofSlice inline34Template 2071 inline34_slice
    ...
    (by decide)
theorem inline34_pc : inline34Site.startPC = UInt256.ofNat 2630 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2071) = UInt256.ofNat 2630
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline36_pcAfter : pcAfter (UInt256.ofNat 2719) PairedAllInlineCoreTrace.inline36Template = UInt256.ofNat 2765 := by rfl
def inline36Physical : PairedAllInlineCoreTrace.CoreBlock 2719 2765 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline36Template
  eval := PairedAllInlineCoreTrace.inline36Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline36Template_word s (UInt256.ofNat 2719) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline36Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline36Template :=
  StackSiteBuilder.ofSlice inline36Template 2148 inline36_slice
    ...
    (by decide)
theorem inline36_pc : inline36Site.startPC = UInt256.ofNat 2719 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2148) = UInt256.ofNat 2719
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline37_pcAfter : pcAfter (UInt256.ofNat 2765) PairedAllInlineCoreTrace.inline37Template = UInt256.ofNat 2811 := by rfl
def inline37Physical : PairedAllInlineCoreTrace.CoreBlock 2765 2811 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline37Template
  eval := PairedAllInlineCoreTrace.inline37Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline37Template_word s (UInt256.ofNat 2765) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline37Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline37Template :=
  StackSiteBuilder.ofSlice inline37Template 2187 inline37_slice
    ...
    (by decide)
theorem inline37_pc : inline37Site.startPC = UInt256.ofNat 2765 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2187) = UInt256.ofNat 2765
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline38_pcAfter : pcAfter (UInt256.ofNat 2811) PairedAllInlineCoreTrace.inline38Template = UInt256.ofNat 2857 := by rfl
def inline38Physical : PairedAllInlineCoreTrace.CoreBlock 2811 2857 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline38Template
  eval := PairedAllInlineCoreTrace.inline38Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline38Template_word s (UInt256.ofNat 2811) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline38Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline38Template :=
  StackSiteBuilder.ofSlice inline38Template 2226 inline38_slice
    ...
    (by decide)
theorem inline38_pc : inline38Site.startPC = UInt256.ofNat 2811 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2226) = UInt256.ofNat 2811
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline39_pcAfter : pcAfter (UInt256.ofNat 2857) PairedAllInlineCoreTrace.inline39Template = UInt256.ofNat 2899 := by rfl
def inline39Physical : PairedAllInlineCoreTrace.CoreBlock 2857 2899 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline39Template
  eval := PairedAllInlineCoreTrace.inline39Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline39Template_word s (UInt256.ofNat 2857) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline39Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline39Template :=
  StackSiteBuilder.ofSlice inline39Template 2265 inline39_slice
    ...
    (by decide)
theorem inline39_pc : inline39Site.startPC = UInt256.ofNat 2857 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2265) = UInt256.ofNat 2857
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline42_pcAfter : pcAfter (UInt256.ofNat 2985) PairedAllInlineCoreTrace.inline42Template = UInt256.ofNat 3030 := by rfl
def inline42Physical : PairedAllInlineCoreTrace.CoreBlock 2985 3030 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline42Template
  eval := PairedAllInlineCoreTrace.inline42Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline42Template_word s (UInt256.ofNat 2985) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline42Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline42Template :=
  StackSiteBuilder.ofSlice inline42Template 2378 inline42_slice
    ...
    (by decide)
theorem inline42_pc : inline42Site.startPC = UInt256.ofNat 2985 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2378) = UInt256.ofNat 2985
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline44_pcAfter : pcAfter (UInt256.ofNat 3073) PairedAllInlineCoreTrace.inline44Template = UInt256.ofNat 3119 := by rfl
def inline44Physical : PairedAllInlineCoreTrace.CoreBlock 3073 3119 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline44Template
  eval := PairedAllInlineCoreTrace.inline44Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline44Template_word s (UInt256.ofNat 3073) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline44Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline44Template :=
  StackSiteBuilder.ofSlice inline44Template 2455 inline44_slice
    ...
    (by decide)
theorem inline44_pc : inline44Site.startPC = UInt256.ofNat 3073 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2455) = UInt256.ofNat 3073
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline45_pcAfter : pcAfter (UInt256.ofNat 3119) PairedAllInlineCoreTrace.inline45Template = UInt256.ofNat 3161 := by rfl
def inline45Physical : PairedAllInlineCoreTrace.CoreBlock 3119 3161 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline45Template
  eval := PairedAllInlineCoreTrace.inline45Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline45Template_word s (UInt256.ofNat 3119) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline45Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline45Template :=
  StackSiteBuilder.ofSlice inline45Template 2494 inline45_slice
    ...
    (by decide)
theorem inline45_pc : inline45Site.startPC = UInt256.ofNat 3119 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2494) = UInt256.ofNat 3119
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline47_pcAfter : pcAfter (UInt256.ofNat 3197) PairedAllInlineCoreTrace.inline47Template = UInt256.ofNat 3236 := by rfl
def inline47Physical : PairedAllInlineCoreTrace.CoreBlock 3197 3236 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline47Template
  eval := PairedAllInlineCoreTrace.inline47Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline47Template_word s (UInt256.ofNat 3197) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
def inline47Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline47Template :=
  StackSiteBuilder.ofSlice inline47Template 2563 inline47_slice
    ...
    (by decide)
theorem inline47_pc : inline47Site.startPC = UInt256.ofNat 3197 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2563) = UInt256.ofNat 3197
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem group48_pcAfter : pcAfter (UInt256.ofNat 3236) group48Template = UInt256.ofNat 3259 := by rfl
def group48Physical : PairedAllInlineCoreTrace.CoreBlock 3236 3259 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.k, .d, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
...
def group48Site : GenericRoundSite Artifact.submissionArtifact .Osaka group48Template :=
  StackSiteBuilder.ofSlice group48Template 2596 group48_slice
    ...
    (by decide)
theorem group48_pc : group48Site.startPC = UInt256.ofNat 3236 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2596) = UInt256.ofNat 3236
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline48_pcAfter : pcAfter (UInt256.ofNat 3259) PairedAllInlineCoreTrace.inline48Template = UInt256.ofNat 3311 := by rfl
def inline48Physical : PairedAllInlineCoreTrace.CoreBlock 3259 3311 [.k, .d, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline48Template
  eval := PairedAllInlineCoreTrace.inline48Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline48Template_word s (UInt256.ofNat 3259) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline48_slice :
    (Artifact.submissionArtifact.instructions.drop 2599).take inline48Template.length = inline48Template := by rfl
def inline48Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline48Template :=
  StackSiteBuilder.ofSlice inline48Template 2599 inline48_slice
    (by change 2599 + inline48Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline48Template) (by decide))
    (by decide)
theorem inline48_pc : inline48Site.startPC = UInt256.ofNat 3259 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2599) = UInt256.ofNat 3259
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline49_pcAfter : pcAfter (UInt256.ofNat 3311) PairedAllInlineCoreTrace.inline49Template = UInt256.ofNat 3364 := by rfl
def inline49Physical : PairedAllInlineCoreTrace.CoreBlock 3311 3364 [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline49Template
  eval := PairedAllInlineCoreTrace.inline49Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline49Template_word s (UInt256.ofNat 3311) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline49_slice :
    (Artifact.submissionArtifact.instructions.drop 2645).take inline49Template.length = inline49Template := by rfl
def inline49Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline49Template :=
  StackSiteBuilder.ofSlice inline49Template 2645 inline49_slice
    (by change 2645 + inline49Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline49Template) (by decide))
    (by decide)
theorem inline49_pc : inline49Site.startPC = UInt256.ofNat 3311 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2645) = UInt256.ofNat 3311
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline50_pcAfter : pcAfter (UInt256.ofNat 3364) PairedAllInlineCoreTrace.inline50Template = UInt256.ofNat 3417 := by rfl
def inline50Physical : PairedAllInlineCoreTrace.CoreBlock 3364 3417 [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline50Template
  eval := PairedAllInlineCoreTrace.inline50Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline50Template_word s (UInt256.ofNat 3364) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline50_slice :
    (Artifact.submissionArtifact.instructions.drop 2691).take inline50Template.length = inline50Template := by rfl
def inline50Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline50Template :=
  StackSiteBuilder.ofSlice inline50Template 2691 inline50_slice
    (by change 2691 + inline50Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline50Template) (by decide))
    (by decide)
theorem inline50_pc : inline50Site.startPC = UInt256.ofNat 3364 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2691) = UInt256.ofNat 3364
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline51_pcAfter : pcAfter (UInt256.ofNat 3417) PairedAllInlineCoreTrace.inline51Template = UInt256.ofNat 3469 := by rfl
def inline51Physical : PairedAllInlineCoreTrace.CoreBlock 3417 3469 [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline51Template
  eval := PairedAllInlineCoreTrace.inline51Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline51Template_word s (UInt256.ofNat 3417) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline51_slice :
    (Artifact.submissionArtifact.instructions.drop 2737).take inline51Template.length = inline51Template := by rfl
def inline51Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline51Template :=
  StackSiteBuilder.ofSlice inline51Template 2737 inline51_slice
    (by change 2737 + inline51Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline51Template) (by decide))
    (by decide)
theorem inline51_pc : inline51Site.startPC = UInt256.ofNat 3417 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2737) = UInt256.ofNat 3417
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline52_pcAfter : pcAfter (UInt256.ofNat 3469) PairedAllInlineCoreTrace.inline52Template = UInt256.ofNat 3514 := by rfl
def inline52Physical : PairedAllInlineCoreTrace.CoreBlock 3469 3514 [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline52Template
  eval := PairedAllInlineCoreTrace.inline52Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline52Template_word s (UInt256.ofNat 3469) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline52_slice :
    (Artifact.submissionArtifact.instructions.drop 2783).take inline52Template.length = inline52Template := by rfl
def inline52Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline52Template :=
  StackSiteBuilder.ofSlice inline52Template 2783 inline52_slice
    (by change 2783 + inline52Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline52Template) (by decide))
    (by decide)
theorem inline52_pc : inline52Site.startPC = UInt256.ofNat 3469 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2783) = UInt256.ofNat 3469
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline53_pcAfter : pcAfter (UInt256.ofNat 3514) PairedAllInlineCoreTrace.inline53Template = UInt256.ofNat 3564 := by rfl
def inline53Physical : PairedAllInlineCoreTrace.CoreBlock 3514 3564 [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline53Template
  eval := PairedAllInlineCoreTrace.inline53Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline53Template_word s (UInt256.ofNat 3514) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline53_slice :
    (Artifact.submissionArtifact.instructions.drop 2823).take inline53Template.length = inline53Template := by rfl
def inline53Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline53Template :=
  StackSiteBuilder.ofSlice inline53Template 2823 inline53_slice
    (by change 2823 + inline53Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline53Template) (by decide))
    (by decide)
theorem inline53_pc : inline53Site.startPC = UInt256.ofNat 3514 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2823) = UInt256.ofNat 3514
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline54_pcAfter : pcAfter (UInt256.ofNat 3564) PairedAllInlineCoreTrace.inline54Template = UInt256.ofNat 3617 := by rfl
def inline54Physical : PairedAllInlineCoreTrace.CoreBlock 3564 3617 [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline54Template
  eval := PairedAllInlineCoreTrace.inline54Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline54Template_word s (UInt256.ofNat 3564) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline54_slice :
    (Artifact.submissionArtifact.instructions.drop 2867).take inline54Template.length = inline54Template := by rfl
def inline54Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline54Template :=
  StackSiteBuilder.ofSlice inline54Template 2867 inline54_slice
    (by change 2867 + inline54Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline54Template) (by decide))
    (by decide)
theorem inline54_pc : inline54Site.startPC = UInt256.ofNat 3564 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2867) = UInt256.ofNat 3564
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline56_pcAfter : pcAfter (UInt256.ofNat 3666) PairedAllInlineCoreTrace.inline56Template = UInt256.ofNat 3719 := by rfl
def inline56Physical : PairedAllInlineCoreTrace.CoreBlock 3666 3719 [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline56Template
  eval := PairedAllInlineCoreTrace.inline56Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline56Template_word s (UInt256.ofNat 3666) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline56_slice :
    (Artifact.submissionArtifact.instructions.drop 2958).take inline56Template.length = inline56Template := by rfl
def inline56Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline56Template :=
  StackSiteBuilder.ofSlice inline56Template 2958 inline56_slice
    (by change 2958 + inline56Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline56Template) (by decide))
    (by decide)
theorem inline56_pc : inline56Site.startPC = UInt256.ofNat 3666 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2958) = UInt256.ofNat 3666
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline59_pcAfter : pcAfter (UInt256.ofNat 3819) PairedAllInlineCoreTrace.inline59Template = UInt256.ofNat 3872 := by rfl
def inline59Physical : PairedAllInlineCoreTrace.CoreBlock 3819 3872 [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline59Template
  eval := PairedAllInlineCoreTrace.inline59Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline59Template_word s (UInt256.ofNat 3819) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline59_slice :
    (Artifact.submissionArtifact.instructions.drop 3094).take inline59Template.length = inline59Template := by rfl
def inline59Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline59Template :=
  StackSiteBuilder.ofSlice inline59Template 3094 inline59_slice
    (by change 3094 + inline59Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline59Template) (by decide))
    (by decide)
theorem inline59_pc : inline59Site.startPC = UInt256.ofNat 3819 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3094) = UInt256.ofNat 3819
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline60_pcAfter : pcAfter (UInt256.ofNat 3872) PairedAllInlineCoreTrace.inline60Template = UInt256.ofNat 3925 := by rfl
def inline60Physical : PairedAllInlineCoreTrace.CoreBlock 3872 3925 [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] [.d, .e, .c, .b, .k, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline60Template
  eval := PairedAllInlineCoreTrace.inline60Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline60Template_word s (UInt256.ofNat 3872) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline60_slice :
    (Artifact.submissionArtifact.instructions.drop 3140).take inline60Template.length = inline60Template := by rfl
def inline60Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline60Template :=
  StackSiteBuilder.ofSlice inline60Template 3140 inline60_slice
    (by change 3140 + inline60Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline60Template) (by decide))
    (by decide)
theorem inline60_pc : inline60Site.startPC = UInt256.ofNat 3872 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3140) = UInt256.ofNat 3872
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem group64_pcAfter : pcAfter (UInt256.ofNat 4073) PairedAllInlineCoreTrace.group64Template = UInt256.ofNat 4080 := by rfl
def group64Physical : PairedAllInlineCoreTrace.CoreBlock 4073 4080 [.d, .a, .b, .c, .k, .e, .factor, .pair, .upper, .lower] [.k, .a, .b, .c, .d, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.group64Template
  eval := PairedAllInlineCoreTrace.group64Block.eval
  run := by
    intro s f rho hstack hrun _hactive
    have h := PairedAllInlineCoreTrace.run_group64Template s (UInt256.ofNat 4073) f.frame rho hstack hrun
...
theorem group64_slice :
    (Artifact.submissionArtifact.instructions.drop 3319).take group64Template.length = group64Template := by rfl
def group64Site : GenericRoundSite Artifact.submissionArtifact .Osaka group64Template :=
  StackSiteBuilder.ofSlice group64Template 3319 group64_slice
    (by change 3319 + group64Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := group64Template) (by decide))
    (by decide)
theorem group64_pc : group64Site.startPC = UInt256.ofNat 4073 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3319) = UInt256.ofNat 4073
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline65_pcAfter : pcAfter (UInt256.ofNat 4125) PairedAllInlineCoreTrace.inline65Template = UInt256.ofNat 4176 := by rfl
def inline65Physical : PairedAllInlineCoreTrace.CoreBlock 4125 4176 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline65Template
  eval := PairedAllInlineCoreTrace.inline65Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline65Template_word s (UInt256.ofNat 4125) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline65_slice :
    (Artifact.submissionArtifact.instructions.drop 3363).take inline65Template.length = inline65Template := by rfl
def inline65Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline65Template :=
  StackSiteBuilder.ofSlice inline65Template 3363 inline65_slice
    (by change 3363 + inline65Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline65Template) (by decide))
    (by decide)
theorem inline65_pc : inline65Site.startPC = UInt256.ofNat 4125 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3363) = UInt256.ofNat 4125
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline67_pcAfter : pcAfter (UInt256.ofNat 4224) PairedAllInlineCoreTrace.inline67Template = UInt256.ofNat 4275 := by rfl
def inline67Physical : PairedAllInlineCoreTrace.CoreBlock 4224 4275 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline67Template
  eval := PairedAllInlineCoreTrace.inline67Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline67Template_word s (UInt256.ofNat 4224) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline67_slice :
    (Artifact.submissionArtifact.instructions.drop 3450).take inline67Template.length = inline67Template := by rfl
def inline67Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline67Template :=
  StackSiteBuilder.ofSlice inline67Template 3450 inline67_slice
    (by change 3450 + inline67Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline67Template) (by decide))
    (by decide)
theorem inline67_pc : inline67Site.startPC = UInt256.ofNat 4224 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3450) = UInt256.ofNat 4224
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline69_pcAfter : pcAfter (UInt256.ofNat 4322) PairedAllInlineCoreTrace.inline69Template = UInt256.ofNat 4373 := by rfl
def inline69Physical : PairedAllInlineCoreTrace.CoreBlock 4322 4373 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline69Template
  eval := PairedAllInlineCoreTrace.inline69Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline69Template_word s (UInt256.ofNat 4322) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline69_slice :
    (Artifact.submissionArtifact.instructions.drop 3537).take inline69Template.length = inline69Template := by rfl
def inline69Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline69Template :=
  StackSiteBuilder.ofSlice inline69Template 3537 inline69_slice
    (by change 3537 + inline69Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline69Template) (by decide))
    (by decide)
theorem inline69_pc : inline69Site.startPC = UInt256.ofNat 4322 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3537) = UInt256.ofNat 4322
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline71_pcAfter : pcAfter (UInt256.ofNat 4418) PairedAllInlineCoreTrace.inline71Template = UInt256.ofNat 4469 := by rfl
def inline71Physical : PairedAllInlineCoreTrace.CoreBlock 4418 4469 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline71Template
  eval := PairedAllInlineCoreTrace.inline71Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline71Template_word s (UInt256.ofNat 4418) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline71_slice :
    (Artifact.submissionArtifact.instructions.drop 3622).take inline71Template.length = inline71Template := by rfl
def inline71Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline71Template :=
  StackSiteBuilder.ofSlice inline71Template 3622 inline71_slice
    (by change 3622 + inline71Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline71Template) (by decide))
    (by decide)
theorem inline71_pc : inline71Site.startPC = UInt256.ofNat 4418 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3622) = UInt256.ofNat 4418
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline72_pcAfter : pcAfter (UInt256.ofNat 4469) PairedAllInlineCoreTrace.inline72Template = UInt256.ofNat 4520 := by rfl
def inline72Physical : PairedAllInlineCoreTrace.CoreBlock 4469 4520 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline72Template
  eval := PairedAllInlineCoreTrace.inline72Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline72Template_word s (UInt256.ofNat 4469) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline72_slice :
    (Artifact.submissionArtifact.instructions.drop 3666).take inline72Template.length = inline72Template := by rfl
def inline72Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline72Template :=
  StackSiteBuilder.ofSlice inline72Template 3666 inline72_slice
    (by change 3666 + inline72Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline72Template) (by decide))
    (by decide)
theorem inline72_pc : inline72Site.startPC = UInt256.ofNat 4469 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3666) = UInt256.ofNat 4469
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline73_pcAfter : pcAfter (UInt256.ofNat 4520) PairedAllInlineCoreTrace.inline73Template = UInt256.ofNat 4567 := by rfl
def inline73Physical : PairedAllInlineCoreTrace.CoreBlock 4520 4567 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline73Template
  eval := PairedAllInlineCoreTrace.inline73Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline73Template_word s (UInt256.ofNat 4520) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline73_slice :
    (Artifact.submissionArtifact.instructions.drop 3710).take inline73Template.length = inline73Template := by rfl
def inline73Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline73Template :=
  StackSiteBuilder.ofSlice inline73Template 3710 inline73_slice
    (by change 3710 + inline73Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline73Template) (by decide))
    (by decide)
theorem inline73_pc : inline73Site.startPC = UInt256.ofNat 4520 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3710) = UInt256.ofNat 4520
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline75_pcAfter : pcAfter (UInt256.ofNat 4615) PairedAllInlineCoreTrace.inline75Template = UInt256.ofNat 4667 := by rfl
def inline75Physical : PairedAllInlineCoreTrace.CoreBlock 4615 4667 [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline75Template
  eval := PairedAllInlineCoreTrace.inline75Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline75Template_word s (UInt256.ofNat 4615) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline75_slice :
    (Artifact.submissionArtifact.instructions.drop 3795).take inline75Template.length = inline75Template := by rfl
def inline75Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline75Template :=
  StackSiteBuilder.ofSlice inline75Template 3795 inline75_slice
    (by change 3795 + inline75Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline75Template) (by decide))
    (by decide)
theorem inline75_pc : inline75Site.startPC = UInt256.ofNat 4615 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3795) = UInt256.ofNat 4615
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline76_pcAfter : pcAfter (UInt256.ofNat 4667) PairedAllInlineCoreTrace.inline76Template = UInt256.ofNat 4717 := by rfl
def inline76Physical : PairedAllInlineCoreTrace.CoreBlock 4667 4717 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline76Template
  eval := PairedAllInlineCoreTrace.inline76Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline76Template_word s (UInt256.ofNat 4667) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline76_slice :
    (Artifact.submissionArtifact.instructions.drop 3839).take inline76Template.length = inline76Template := by rfl
def inline76Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline76Template :=
  StackSiteBuilder.ofSlice inline76Template 3839 inline76_slice
    (by change 3839 + inline76Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline76Template) (by decide))
    (by decide)
theorem inline76_pc : inline76Site.startPC = UInt256.ofNat 4667 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3839) = UInt256.ofNat 4667
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem inline78_pcAfter : pcAfter (UInt256.ofNat 4765) PairedAllInlineCoreTrace.inline78Template = UInt256.ofNat 4816 := by rfl
def inline78Physical : PairedAllInlineCoreTrace.CoreBlock 4765 4816 [.d, .k, .b, .c, .a, .e, .factor, .pair, .upper, .lower] [.d, .k, .c, .b, .e, .a, .factor, .pair, .upper, .lower] where
  code := PairedAllInlineCoreTrace.inline78Template
  eval := PairedAllInlineCoreTrace.inline78Block.eval
  run := by
    intro s f rho hstack hrun hactive
    have h := PairedAllInlineCoreTrace.run_inline78Template_word s (UInt256.ofNat 4765) f.frame rho
      hstack hrun hactive rfl rfl rfl rfl
...
theorem inline78_slice :
    (Artifact.submissionArtifact.instructions.drop 3926).take inline78Template.length = inline78Template := by rfl
def inline78Site : GenericRoundSite Artifact.submissionArtifact .Osaka inline78Template :=
  StackSiteBuilder.ofSlice inline78Template 3926 inline78_slice
    (by change 3926 + inline78Template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := inline78Template) (by decide))
    (by decide)
theorem inline78_pc : inline78Site.startPC = UInt256.ofNat 4765 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3926) = UInt256.ofNat 4765
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
