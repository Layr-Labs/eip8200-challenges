...
theorem site_pc : site.startPC = UInt256.ofNat 4228 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3471) = UInt256.ofNat 4228
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4228) template = UInt256.ofNat 4273 := by decide
  rw [hend] at hraw
