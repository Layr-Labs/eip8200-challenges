...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 270) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.xor x.v6 x.v9)) (UInt256.lor (UInt256.land x.v6 x.v11) x.v0)) x.v7))) (UInt256.ofNat 72)) (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 270) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.xor x.v6 x.v9)) (UInt256.lor (UInt256.land x.v6 x.v11) x.v0)) x.v7)))))) (UInt256.ofNat 26)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3407 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4321 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3407) = UInt256.ofNat 4321
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4321, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 4365, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4321) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4321) template = UInt256.ofNat 4365 := by decide
  rw [hend] at hraw
