...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v4,
    (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.land x.v11 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 270) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v5 x.v10) x.v0) (UInt256.xor x.v10 (UInt256.xor x.v5 x.v8))) x.v6))) (UInt256.ofNat 72)) (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 270) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v5 x.v10) x.v0) (UInt256.xor x.v10 (UInt256.xor x.v5 x.v8))) x.v6)))))) (UInt256.ofNat 26)))),
    x.v0,
    x.v7,
    x.v8,
    x.v9,
...
theorem site_pc : site.startPC = UInt256.ofNat 4315 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3423) = UInt256.ofNat 4315
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4315, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 4359, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4315) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4315) template = UInt256.ofNat 4359 := by decide
  rw [hend] at hraw
