...
theorem site_pc : site.startPC = UInt256.ofNat 1310 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 803) = UInt256.ofNat 1310
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1310) template = UInt256.ofNat 1352 := by decide
  rw [hend] at hraw
