...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.add (UInt256.land (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 774) (UInt256.add (UInt256.xor x.v6 (UInt256.xor x.v9 (UInt256.xor x.v4 (UInt256.lor x.v0 (UInt256.land x.v4 x.v6))))) x.v5)))) x.v11) (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 774) (UInt256.add (UInt256.xor x.v6 (UInt256.xor x.v9 (UInt256.xor x.v4 (UInt256.lor x.v0 (UInt256.land x.v4 x.v6))))) x.v5)))))) (UInt256.ofNat 25)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 791 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1335 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 791) = UInt256.ofNat 1335
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1335, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1377, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1335) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1335) template = UInt256.ofNat 1377 := by decide
  rw [hend] at hraw
