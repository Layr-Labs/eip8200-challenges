...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3525).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4430 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3525) = UInt256.ofNat 4430
