...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3515).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4422 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3515) = UInt256.ofNat 4422
