...
def dispatchPath : List Located :=
  [⟨785, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨786, .push ⟨1, by decide⟩ (UInt256.ofNat 5), by rfl, by decide⟩,
   ⟨787, .op .SHL, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨788, .push ⟨2, by decide⟩ (UInt256.ofNat 1681), by rfl, by decide⟩,
   ⟨789, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨790, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]

def arm0 : List Located :=
  [⟨792, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨793, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨794, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨795, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨796, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨797, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]

def arm1 : List Located :=
  [⟨824, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨825, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨826, .op (.Dup ⟨2, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨827, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨828, .op .AND, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨829, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨830, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨831, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨832, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]

def arm2 : List Located :=
  [⟨856, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨857, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨858, .op .NOT, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨859, .op .OR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨860, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨861, .push ⟨4, by decide⟩ (UInt256.ofNat 4294967295), by rfl, by decide⟩,
   ⟨862, .op .AND, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨863, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨864, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨865, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]

def arm3 : List Located :=
  [⟨884, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨885, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨886, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨887, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨888, .op (.Swap ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨889, .op .AND, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨890, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨891, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨892, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨893, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]

def arm4 : List Located :=
  [⟨916, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨917, .op (.Swap ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨918, .op .NOT, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨919, .op .OR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨920, .op .XOR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨921, .push ⟨4, by decide⟩ (UInt256.ofNat 4294967295), by rfl, by decide⟩,
   ⟨922, .op .AND, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨923, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨924, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨925, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]
...
@[simp] private theorem validCase0 :
    Decode.isValidJumpDest submissionBytecode 0x477 = true := by
  have hpc : Artifact.submissionArtifact.instructionPC 792 = 0x470 := by rfl
  rw [← hpc]
  exact Artifact.submissionArtifact.isValidJumpDest_index 798 (by rfl)

@[simp] private theorem validCase1 :
    Decode.isValidJumpDest submissionBytecode 0x497 = true := by
  have hpc : Artifact.submissionArtifact.instructionPC 824 = 0x493 := by rfl
  rw [← hpc]
  exact Artifact.submissionArtifact.isValidJumpDest_index 830 (by rfl)

@[simp] private theorem validCase2 :
    Decode.isValidJumpDest submissionBytecode 0x4b7 = true := by
  have hpc : Artifact.submissionArtifact.instructionPC 856 = 0x4b9 := by rfl
  rw [← hpc]
  exact Artifact.submissionArtifact.isValidJumpDest_index 862 (by rfl)

@[simp] private theorem validCase3 :
    Decode.isValidJumpDest submissionBytecode 0x4d7 = true := by
  have hpc : Artifact.submissionArtifact.instructionPC 884 = 0x4da := by rfl
  rw [← hpc]
  exact Artifact.submissionArtifact.isValidJumpDest_index 890 (by rfl)

@[simp] private theorem validCase4 :
    Decode.isValidJumpDest submissionBytecode 0x4f7 = true := by
  have hpc : Artifact.submissionArtifact.instructionPC 916 = 0x4fd := by rfl
  rw [← hpc]
  exact Artifact.submissionArtifact.isValidJumpDest_index 922 (by rfl)
