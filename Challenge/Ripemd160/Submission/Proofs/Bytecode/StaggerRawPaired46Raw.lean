...
def template : List Instr :=
  [ .op (.Swap ⟨0, by decide⟩),
    ...
    .op (.Dup ⟨8, by decide⟩),
    .op .ADD,
    .push ⟨13, by decide⟩ (UInt256.ofNat 475368975196266490020700880928),
    .op (.Dup ⟨14, by decide⟩),
    .op (.Swap ⟨1, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op .AND,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 23))),
    ...
    (UInt256.ofNat 23),
    x.v8,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mulMod (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 702) (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor x.v9 (UInt256.land x.v0 x.v6)) (UInt256.xor x.v6 x.v11)) (UInt256.xor x.v11 x.v0)) x.v7)))) (UInt256.ofNat 475368975196266490020700880928) x.v13) (UInt256.ofNat 27)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
