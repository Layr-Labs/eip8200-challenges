...
theorem entry_fresh (input : ByteArray) (hz : input.size%64=0)
    (address : Nat) (ha : 1120+input.size≤address) :
...
theorem states_fresh (input : ByteArray) (hz : input.size%64=0) (n address : Nat)
...
theorem lowChain_fresh (input : ByteArray) (hz : input.size%64=0) (n address : Nat)
    (ha : 1120+input.size≤address) :
