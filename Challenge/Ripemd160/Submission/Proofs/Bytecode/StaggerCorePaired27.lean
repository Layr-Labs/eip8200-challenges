...
theorem output_eq (memory : ByteArray) (h4 : UInt256) (q right : WordLane) (rho : List UInt256) :
  ...
  have hkb : StaggerAlgorithm.physicalKey 26 = UInt256.ofNat 34535016170389834383797866734609369064725061767952821 := by decide
  have hka : StaggerAlgorithm.physicalKey 27 = UInt256.ofNat 34535016170389834383797866734609369064725061767952821 := by decide
