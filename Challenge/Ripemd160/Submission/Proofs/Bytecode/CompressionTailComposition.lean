import Challenge.Ripemd160.Submission.Proofs.Bytecode.CompressionTailTrace
...
def combinationCleaned (s : State) (messageOffset returnDest : UInt256)
  ...
  { combination4 s messageOffset returnDest rest with
      pc := UInt256.ofNat 955, stack := returnDest :: rest }
...
@[simp] theorem combination4_pc (s : State)
    ...
    (combination4 s messageOffset returnDest rest).pc = UInt256.ofNat 949 := by
...
def gasSteps_combination0 (s : State) (messageOffset returnDest : UInt256)
  ...
  apply Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka combination0Located
  · simpa [combinationEntry, Artifact.submissionArtifact] using hcode
...
def gasSteps_combination1 (s : State) (messageOffset returnDest : UInt256)
  ...
  apply Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka combination1Located
  · simpa only [combination0_executionEnv, Artifact.submissionArtifact] using hcode
...
def gasSteps_combination2 (s : State) (messageOffset returnDest : UInt256)
  ...
  apply Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka combination2Located
  · simpa only [combination1_executionEnv, Artifact.submissionArtifact] using hcode
  · simpa [State.fork] using hfork
...
def gasSteps_combination3 (s : State) (messageOffset returnDest : UInt256)
  ...
  apply Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka combination3Located
  · simpa only [combination2_executionEnv, Artifact.submissionArtifact] using hcode
  · simpa [State.fork] using hfork
...
def gasSteps_combination4 (s : State) (messageOffset returnDest : UInt256)
  ...
  apply Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka combination4Located
  · simpa only [combination3_executionEnv, Artifact.submissionArtifact] using hcode
  · simpa [State.fork] using hfork
...
def gasSteps_combinationPops (s : State)
  ...
  apply Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka combinationPopsLocated
  · simpa only [combination4_executionEnv, Artifact.submissionArtifact] using hcode
  · simpa [State.fork] using hfork
...
def gasSteps_combinationJump (s : State)
  ...
  apply Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka combinationJumpLocated
  · simpa only [combinationCleaned_executionEnv, Artifact.submissionArtifact] using hcode
  · simpa [State.fork] using hfork
