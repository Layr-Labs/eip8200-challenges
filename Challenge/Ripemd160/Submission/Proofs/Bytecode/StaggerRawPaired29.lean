...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 28))),
    ...
    x.v2,
    x.v3,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v11 (UInt256.land x.v10 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.ofNat 40945789247971450477386360121479348807026276516919705) (UInt256.add (MachineState.readWord memory 162) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.land (UInt256.xor (UInt256.land x.v0 x.v7) x.v4) (UInt256.xor x.v7 x.v2)) x.v2) x.v0) x.v5))) (UInt256.ofNat 72)) (UInt256.add (UInt256.ofNat 40945789247971450477386360121479348807026276516919705) (UInt256.add (MachineState.readWord memory 162) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.land (UInt256.xor (UInt256.land x.v0 x.v7) x.v4) (UInt256.xor x.v7 x.v2)) x.v2) x.v0) x.v5)))))) (UInt256.ofNat 25)))),
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 1852).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1852 actual_slice
    (by change 1852 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 2470 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1852) = UInt256.ofNat 2470
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2470, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2540, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2470) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2470) template = UInt256.ofNat 2540 := by decide
  rw [hend] at hraw
