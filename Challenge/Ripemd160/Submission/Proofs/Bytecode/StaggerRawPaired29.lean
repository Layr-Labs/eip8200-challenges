...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v15 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.add (UInt256.ofNat 6410773077581616093588493386869979742301214748966912) x.v8) (UInt256.add (MachineState.readWord memory 162) (UInt256.add (UInt256.xor (UInt256.xor x.v0 x.v4) (UInt256.land (UInt256.xor x.v4 x.v9) (UInt256.xor (UInt256.land x.v0 x.v9) x.v6))) x.v7))) (UInt256.ofNat 72)) (UInt256.add (UInt256.add (UInt256.ofNat 6410773077581616093588493386869979742301214748966912) x.v8) (UInt256.add (MachineState.readWord memory 162) (UInt256.add (UInt256.xor (UInt256.xor x.v0 x.v4) (UInt256.land (UInt256.xor x.v4 x.v9) (UInt256.xor (UInt256.land x.v0 x.v9) x.v6))) x.v7)))))) (UInt256.ofNat 25)))),
...
theorem site_pc : site.startPC = UInt256.ofNat 2527 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1881) = UInt256.ofNat 2527
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2527, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2581, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2527) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2527) template = UInt256.ofNat 2581 := by decide
  rw [hend] at hraw
