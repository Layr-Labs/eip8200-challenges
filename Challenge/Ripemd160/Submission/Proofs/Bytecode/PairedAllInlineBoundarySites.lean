...
theorem schedule_instructionPC :
    Artifact.submissionArtifact.instructionPC 294 = 537 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

theorem schedule_endInstructionPC :
    Artifact.submissionArtifact.instructionPC 459 = 772 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
theorem scheduleSite_startPC : scheduleSite.startPC = UInt256.ofNat 537 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 294) =
    UInt256.ofNat 537
  rw [schedule_instructionPC]

theorem scheduleSite_endPC : scheduleSite.endPC = UInt256.ofNat 772 := by
...
theorem startupSite_startPC : startupSite.startPC = UInt256.ofNat 772 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 459) =
    UInt256.ofNat 772
  rw [startup_instructionPC]

theorem startupSite_endPC : startupSite.endPC = UInt256.ofNat 820 := by
...
theorem tailPrefix_instructionPC :
    Artifact.submissionArtifact.instructionPC 3969 = 4863 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

theorem tailPrefix_endInstructionPC :
    Artifact.submissionArtifact.instructionPC 4038 = 4947 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
theorem tailPrefixSite_startPC : tailPrefixSite.startPC = UInt256.ofNat 4863 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3969) =
    UInt256.ofNat 4863
  rw [tailPrefix_instructionPC]

theorem tailPrefixSite_endPC : tailPrefixSite.endPC = UInt256.ofNat 4947 := by
...
theorem tailJump_pc : tailJump.pc = UInt256.ofNat 4947 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 4038) =
    UInt256.ofNat 4947
  rw [tailPrefix_endInstructionPC]
...
def gasSteps_schedule (s : State) (returnPC : UInt256) (p : Nat)
    ...
    GasSteps (DenseScheduleTemplate.scheduleEntry s (UInt256.ofNat 537) (UInt256.ofNat p) returnPC rest)
      { s with
...
def gasSteps_startup (s : State) (rho : List UInt256) (hstack : rho.length ≤ 1002)
    ...
    (hnp : Precompile.isPrecompileWithConfig s.executionEnv.precompileConfig
      s.executionEnv.fork s.executionEnv.codeAddr = false) :
    GasSteps {s with pc := UInt256.ofNat 772, stack := rho}
      {s with pc := UInt256.ofNat 820, stack := PairedStartupTrace.resultStack s.memory rho} := by
...
def gasSteps_tail (s : State) (ret : UInt256) (q : PairedTailTrace.Frame)
    ...
    (hnp : Precompile.isPrecompileWithConfig s.executionEnv.precompileConfig
      s.executionEnv.fork s.executionEnv.codeAddr = false) :
    GasSteps {s with pc := UInt256.ofNat 4863, stack := PairedAllInlineTail.entryStack q ret rho}
