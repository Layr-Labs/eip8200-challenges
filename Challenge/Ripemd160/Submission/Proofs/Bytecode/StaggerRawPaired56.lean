...
theorem site_pc : site.startPC = UInt256.ofNat 3583 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2890) = UInt256.ofNat 3583
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3583) template = UInt256.ofNat 3621 := by decide
  rw [hend] at hraw
