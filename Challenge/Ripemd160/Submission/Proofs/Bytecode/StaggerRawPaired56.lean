...
theorem site_pc : site.startPC = UInt256.ofNat 3707 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2891) = UInt256.ofNat 3707
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3707) template = UInt256.ofNat 3746 := by decide
  rw [hend] at hraw
