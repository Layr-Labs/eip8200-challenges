...
theorem site_pc : site.startPC = UInt256.ofNat 3718 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3013) = UInt256.ofNat 3718
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3718) template = UInt256.ofNat 3767 := by decide
  rw [hend] at hraw
