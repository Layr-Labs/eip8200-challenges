...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.lor (UInt256.shiftLeft x.lower (UInt256.ofNat 144)) x.lower),
    ...
    (UInt256.lor x.h1 (UInt256.shiftLeft (UInt256.land x.lower (UInt256.add x.re (UInt256.shiftRight (UInt256.mul x.factor (UInt256.land x.lower (UInt256.add (UInt256.add (MachineState.readWord memory 378) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.rd) x.rc) x.rb) x.ra)) x.k))) (UInt256.ofNat 29)))) (UInt256.ofNat 144))),
  ...
  UInt256.land x.lower (UInt256.add x.re
    (UInt256.shiftRight (UInt256.mul x.factor
      (UInt256.land x.lower (UInt256.add x.k
        (UInt256.add (MachineState.readWord memory 378)
