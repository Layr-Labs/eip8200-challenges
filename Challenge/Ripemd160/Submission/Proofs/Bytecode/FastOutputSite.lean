...
@[simp] theorem fastOutputReturn_pc :
    fastOutputReturn.pc = UInt256.ofNat 0x13af := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 4089) =
    UInt256.ofNat 0x13af
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
theorem fastOutputReturn_site_end :
  ...
  calc
    fastOutputReturn.pc = UInt256.ofNat 0x13af := fastOutputReturn_pc
