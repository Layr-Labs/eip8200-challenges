...
theorem site_pc : site.startPC = UInt256.ofNat 4873 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3889) = UInt256.ofNat 4873
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem site_pc : site.startPC = UInt256.ofNat 4894 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3901) = UInt256.ofNat 4894
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem site_pc : site.startPC = UInt256.ofNat 4896 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3903) = UInt256.ofNat 4896
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem valid_4796 (s : State) (e : Env s) : Decode.isValidJumpDest s.executionEnv.code (UInt256.ofNat 4873).toNat = true := by
  rw [e.code]
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3889 (by rfl)
  have hp : Artifact.submissionArtifact.instructionPC 3889 = 4873 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  simpa only [hp, Word.word_toNat_ofNat, Nat.reducePow, Nat.reduceMod] using h
