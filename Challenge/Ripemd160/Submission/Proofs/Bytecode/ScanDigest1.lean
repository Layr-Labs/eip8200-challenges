...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ScanDigest1
...
theorem data_pattern : data = ShortPatternLogic.data1 := by decide
...
theorem spec_data : Challenge.Ripemd160.spec data = paddedDigest := by
  ...
  rw [hash_data]
  decide
theorem spec_pattern : Challenge.Ripemd160.spec ShortPatternLogic.data1 = paddedDigest := by
  rw [← data_pattern]
  exact spec_data
#print axioms spec_pattern
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ScanDigest1
