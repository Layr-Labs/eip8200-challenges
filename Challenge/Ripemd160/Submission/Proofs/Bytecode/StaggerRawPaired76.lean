...
theorem site_pc : site.startPC = UInt256.ofNat 4487 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3654) = UInt256.ofNat 4487
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4487) template = UInt256.ofNat 4522 := by decide
  rw [hend] at hraw
