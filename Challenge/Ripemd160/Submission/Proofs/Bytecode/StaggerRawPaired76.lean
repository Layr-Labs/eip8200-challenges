...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3627).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4544 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3627) = UInt256.ofNat 4544
