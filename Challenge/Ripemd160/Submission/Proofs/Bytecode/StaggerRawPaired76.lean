...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3593).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4524 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3593) = UInt256.ofNat 4524
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4524) template = UInt256.ofNat 4560 := by decide
  rw [hend] at hraw
