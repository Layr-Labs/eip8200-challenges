...
theorem site_pc : site.startPC = UInt256.ofNat 4403 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3646) = UInt256.ofNat 4403
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4403) template = UInt256.ofNat 4437 := by decide
  rw [hend] at hraw
