...
theorem site_pc : site.startPC = UInt256.ofNat 2744 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1939) = UInt256.ofNat 2744
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2744) template = UInt256.ofNat 2778 := by decide
  rw [hend] at hraw
