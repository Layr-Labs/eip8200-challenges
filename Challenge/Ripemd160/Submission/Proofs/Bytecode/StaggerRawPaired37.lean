...
theorem site_pc : site.startPC = UInt256.ofNat 2685 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2064) = UInt256.ofNat 2685
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2685) template = UInt256.ofNat 2720 := by decide
  rw [hend] at hraw
