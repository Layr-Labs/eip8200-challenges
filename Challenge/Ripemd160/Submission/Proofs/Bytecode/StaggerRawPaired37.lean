...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v4,
    (UInt256.land x.v2 (UInt256.add x.v6 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v11 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v4 (UInt256.add (MachineState.readWord memory 144) (UInt256.add (UInt256.xor x.v0 (UInt256.lor (UInt256.lnot x.v5) x.v8)) x.v7))) (UInt256.ofNat 72)) (UInt256.add x.v4 (UInt256.add (MachineState.readWord memory 144) (UInt256.add (UInt256.xor x.v0 (UInt256.lor (UInt256.lnot x.v5) x.v8)) x.v7)))))) (UInt256.ofNat 23)))),
    x.v6,
    x.v0,
    x.v8,
    x.v9,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 2142 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 2838 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2142) = UInt256.ofNat 2838
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2838, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2876, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2838) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2838) template = UInt256.ofNat 2876 := by decide
  rw [hend] at hraw
  exact DenseScheduleLift.gasSteps_of_raw site _ _ hcode hfork hrun hnp site_pc.symm advances hraw
#print axioms gasSteps
end Challenge.Ripemd160.Submission.Proofs.Bytecode.StaggerRawPaired37
