...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3598).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4510 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3598) = UInt256.ofNat 4510
