...
theorem site_pc : site.startPC = UInt256.ofNat 4380 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3613) = UInt256.ofNat 4380
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4380) template = UInt256.ofNat 4426 := by decide
  rw [hend] at hraw
