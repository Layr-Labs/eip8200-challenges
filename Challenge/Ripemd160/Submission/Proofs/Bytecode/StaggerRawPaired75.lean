...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3570).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4486 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3570) = UInt256.ofNat 4486
