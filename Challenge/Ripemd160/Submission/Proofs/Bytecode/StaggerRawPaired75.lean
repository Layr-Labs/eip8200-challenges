...
theorem site_pc : site.startPC = UInt256.ofNat 4325 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3438) = UInt256.ofNat 4325
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4325) template = UInt256.ofNat 4376 := by decide
  rw [hend] at hraw
