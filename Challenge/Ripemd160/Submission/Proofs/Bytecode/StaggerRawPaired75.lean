...
theorem site_pc : site.startPC = UInt256.ofNat 4474 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3561) = UInt256.ofNat 4474
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4474) template = UInt256.ofNat 4516 := by decide
  rw [hend] at hraw
