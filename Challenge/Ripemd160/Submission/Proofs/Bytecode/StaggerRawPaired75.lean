...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3621).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4391 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3621) = UInt256.ofNat 4391
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4391) template = UInt256.ofNat 4437 := by decide
  rw [hend] at hraw
