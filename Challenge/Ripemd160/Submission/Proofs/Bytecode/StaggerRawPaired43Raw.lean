...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.add (UInt256.land x.v4 (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 414) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8))))) (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 414) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8)))))) (UInt256.ofNat 27)))),
    x.v7,
    x.v0,
    x.v9,
    x.v10,
