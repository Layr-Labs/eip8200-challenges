...
theorem jumpDest_hit1 : Decode.isValidJumpDest submissionBytecode 5230 = true := by
  have hpc : Artifact.submissionArtifact.instructionPC 4140 = 5230 := PrefixStatePaths.pc4126
  have h := Artifact.submissionArtifact.isValidJumpDest_index 4140 (by rfl)
  rw [hpc] at h
  exact h
