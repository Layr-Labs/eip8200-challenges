...
theorem jump_pc : jumpSite.startPC = UInt256.ofNat 4850 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3834) = UInt256.ofNat 4850
...
def gasSteps_jump (s : State) (rho : List UInt256) (hstack : rho.length ≤ 1022)
  ...
  exact PadJump.run_template s (UInt256.ofNat 4850) rho 915 hstack hrun (valid_merge s hcode)
