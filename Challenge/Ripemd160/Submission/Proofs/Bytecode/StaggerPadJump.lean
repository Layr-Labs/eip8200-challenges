...
theorem jump_pc : jumpSite.startPC = UInt256.ofNat 4855 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3840) = UInt256.ofNat 4855
...
def gasSteps_jump (s : State) (rho : List UInt256) (hstack : rho.length ≤ 1022)
  ...
  exact PadJump.run_template s (UInt256.ofNat 4855) rho 925 hstack hrun (valid_merge s hcode)
