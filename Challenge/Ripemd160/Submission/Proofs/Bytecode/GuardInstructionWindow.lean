...
theorem tail_eq : Artifact.submissionArtifact.instructions.drop 3627 = tail := by rfl

theorem pc_base : Artifact.submissionArtifact.instructionPC 3627 = 4521 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3627 + index) =
