...
theorem tail_eq : Artifact.submissionArtifact.instructions.drop 3665 = tail := by rfl

theorem pc_base : Artifact.submissionArtifact.instructionPC 3665 = 4866 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3665 + index) =
