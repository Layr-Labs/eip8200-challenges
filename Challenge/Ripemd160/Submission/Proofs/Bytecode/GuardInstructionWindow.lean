...
[
  ...
  op 0x1c,
  op 0x18,
  .push 32 0x00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff00ff,
  op 0x16,
  op 0x02,
  op 0x18,
  .push 3 65537,
  ...
  op 0x1c,
  op 0x18,
  .push 32 0x0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff0000ffff,
  op 0x16,
  op 0x02,
  op 0x18,
  .push 0 0,
...
theorem tail_eq : Artifact.submissionArtifact.instructions.drop 3723 = tail := by rfl

theorem pc_base : Artifact.submissionArtifact.instructionPC 3723 = 4656 := by
  rw [instructionPC_eq_byteLength]
  rfl

theorem get (index : Nat) :
    Artifact.submissionArtifact.instructions[3723 + index]? = tail[index]? := by
  rw [← InstructionWindow.get_drop, tail_eq]

theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3723 + index) =
      4656 + byteLength (tail.take index) := by
