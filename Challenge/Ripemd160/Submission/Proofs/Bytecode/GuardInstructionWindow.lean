...
theorem tail_eq : Artifact.submissionArtifact.instructions.drop 3667 = tail := by rfl

theorem pc_base : Artifact.submissionArtifact.instructionPC 3667 = 4866 := by
...
theorem pc (index : Nat) :
    Artifact.submissionArtifact.instructionPC (3667 + index) =
