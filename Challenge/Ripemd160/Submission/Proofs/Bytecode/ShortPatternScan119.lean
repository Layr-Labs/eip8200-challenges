...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan119
...
def gasSteps_last (input : ByteArray) (hsize : input.size = 119) :
...
def gasSteps_scan (input : ByteArray) (hsize : input.size = 119) :
  ...
  exact (sound setupPath (run_setup input)).trans
    ((gasStep0 input hfit (by rw [hsize]; decide)).trans
      ((gasStep1 input hfit (by rw [hsize]; decide)).trans
        ((gasStep2 input hfit (by rw [hsize]; decide)).trans last)))

end Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan119

#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan119.gasSteps_last
#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan119.gasSteps_scan
