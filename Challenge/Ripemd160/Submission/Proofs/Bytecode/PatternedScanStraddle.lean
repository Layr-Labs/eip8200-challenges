...
def gasSteps_scalar_bump (input : ByteArray) (E S sv ov acc : UInt256) :
  ...
  have a := soundS (opAt 129 (.Swap ⟨1, by decide⟩))
  ...
  have b := soundS (pushAt 130 1 11)
    (blockOfS _ (pcFactS input 130 212 _ (by norm_num) (by rfl))
      (stepS_push input 212 1 11 [sv, S, E, ov, acc, P7, M, m7, P, m8]
        (by simp) (by decide) (by decide) (by norm_num)))
  have c := soundS (opAt 131 .ADD)
    (blockOfS _ (pcFactS input 131 214 _ (by norm_num) (by rfl))
      (stepS_add input 214 11 sv [S, E, ov, acc, P7, M, m7, P, m8]
        (by simp) (by norm_num)))
  have d := soundS (opAt 132 (.Swap ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 132 215 _ (by norm_num) (by rfl))
...
def gasSteps_straddle_sym (input : ByteArray) (E S sv ov acc : UInt256) :
  ...
  have step2989 := soundS (opAt 103 .JUMPDEST)
    (blockOfS _ (pcFactS input 103 180 [E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2989)
      (stepS_jumpdest input 180 [E, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2990 := soundS (opAt 104 (.Dup ⟨6, by decide⟩))
    (blockOfS _ (pcFactS input 104 181 [E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2990)
      (stepS_dup input 181 6 (by decide) [E, S, sv, ov, acc, P7, M, m7, P, m8] (M) (by rfl) (by simp) (by norm_num)))
  have step2991 := soundS (opAt 105 (.Dup ⟨4, by decide⟩))
    (blockOfS _ (pcFactS input 105 182 [M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2991)
      (stepS_dup input 182 4 (by decide) [M, E, S, sv, ov, acc, P7, M, m7, P, m8] (ov) (by rfl) (by simp) (by norm_num)))
  have step2992 := soundS (pushAt 106 1 8)
    (blockOfS _ (pcFactS input 106 183 [ov, M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2992)
      (stepS_push input 183 1 (8 : UInt256) [ov, M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have step2993 := soundS (opAt 107 .SHR)
    (blockOfS _ (pcFactS input 107 185 [(8 : UInt256), ov, M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2993)
      (stepS_shr input 185 ((8 : UInt256)) (ov) [M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2994 := soundS (pushAt 108 1 5)
    (blockOfS _ (pcFactS input 108 186 [(UInt256.shiftRight ov (8 : UInt256)), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2994)
  ...
  have step2995 := soundS (opAt 109 .MUL)
    (blockOfS _ (pcFactS input 109 188 [(5 : UInt256), (UInt256.shiftRight ov (8 : UInt256)), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2995)
      (stepS_mul input 188 ((5 : UInt256)) ((UInt256.shiftRight ov (8 : UInt256))) [M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2996 := soundS (pushAt 110 1 27)
    (blockOfS _ (pcFactS input 110 189 [((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2996)
  ...
  have step2997 := soundS (opAt 111 .SUB)
    (blockOfS _ (pcFactS input 111 191 [(27 : UInt256), ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2997)
  ...
  have step2998 := soundS (pushAt 112 1 3)
    (blockOfS _ (pcFactS input 112 192 [((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256)))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2998)
  ...
  have step2999 := soundS (opAt 113 .SHL)
    (blockOfS _ (pcFactS input 113 194 [(3 : UInt256), ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256)))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2999)
  ...
  have step3000 := soundS (opAt 114 .SHR)
    (blockOfS _ (pcFactS input 114 195 [((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3000)
  ...
  have step3001 := soundS (pushAt 115 1 11)
    (blockOfS _ (pcFactS input 115 196 [(UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256)))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3001)
  ...
  have step3002 := soundS (opAt 116 .MUL)
    (blockOfS _ (pcFactS input 116 198 [(11 : UInt256), (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256)))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3002)
  ...
  have step3003 := soundS (opAt 117 (.Dup ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 117 199 [((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3003)
  ...
  have step3004 := soundS (opAt 118 (.Dup ⟨9, by decide⟩))
    (blockOfS _ (pcFactS input 118 200 [E, ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3004)
  ...
  have step3005 := soundS (opAt 119 .AND)
    (blockOfS _ (pcFactS input 119 201 [m7, E, ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3005)
  ...
  have step3006 := soundS (opAt 120 (.Dup ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 120 202 [(UInt256.land m7 E), ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3006)
  ...
  have step3007 := soundS (opAt 121 .ADD)
    (blockOfS _ (pcFactS input 121 203 [((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), (UInt256.land m7 E), ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3007)
  ...
  have step3008 := soundS (opAt 122 (.Dup ⟨2, by decide⟩))
    (blockOfS _ (pcFactS input 122 204 [(((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))) + (UInt256.land m7 E)), ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3008)
  ...
  have step3009 := soundS (opAt 123 (.Dup ⟨12, by decide⟩))
    (blockOfS _ (pcFactS input 123 205 [E, (((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))) + (UInt256.land m7 E)), ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3009)
  ...
  have step3010 := soundS (opAt 124 .AND)
    (blockOfS _ (pcFactS input 124 206 [m8, E, (((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))) + (UInt256.land m7 E)), ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3010)
  ...
  have step3012 := soundS (opAt 126 (.Swap ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 126 208 [(UInt256.xor (UInt256.land m8 E) (((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))) + (UInt256.land m7 E))), ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3012)
  ...
  have step3013 := soundS (opAt 127 .POP)
    (blockOfS _ (pcFactS input 127 209 [E, ((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), (UInt256.xor (UInt256.land m8 E) (((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))) + (UInt256.land m7 E))), S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3013)
  ...
  have step3014 := soundS (opAt 128 .POP)
    (blockOfS _ (pcFactS input 128 210 [((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))), (UInt256.xor (UInt256.land m8 E) (((11 : UInt256) * (UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))))) + (UInt256.land m7 E))), S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3014)
