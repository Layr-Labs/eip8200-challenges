...
def gasSteps_straddle_sym (input : ByteArray) (E S sv ov acc : UInt256) :
  ...
  have step2998 := soundS (pushAt 2985 1 0x08)
  ...
  have step2999 := soundS (opAt 2986 .MUL)
    (blockOfS _ (pcFactS input 2986 5345 [(8 : UInt256), ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256)))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2999)
