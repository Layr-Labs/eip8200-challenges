...
theorem hdest5170 : Decode.isValidJumpDest submissionBytecode 215 = true :=
  Artifact.submissionArtifact.isValidJumpDest_index 129 (by rfl)
...
def gasSteps_straddle_sym (input : ByteArray) (E S sv ov acc : UInt256) :
  ...
  have step2990 := soundS (opAt 105 (.Dup ⟨6, by decide⟩))
    (blockOfS _ (pcFactS input 105 187 [E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2990)
  ...
  have step2991 := soundS (opAt 106 (.Dup ⟨4, by decide⟩))
    (blockOfS _ (pcFactS input 106 188 [M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2991)
  ...
  have step2992 := soundS (pushAt 107 1 8)
    (blockOfS _ (pcFactS input 107 189 [ov, M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2992)
  ...
  have step2993 := soundS (opAt 108 .SHR)
    (blockOfS _ (pcFactS input 108 190 [(8 : UInt256), ov, M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2993)
      (stepS_shr input 187 ((8 : UInt256)) (ov) [M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2994 := soundS (pushAt 109 1 40)
    (blockOfS _ (pcFactS input 109 191 [(UInt256.shiftRight ov (8 : UInt256)), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2994)
  ...
  have step2995 := soundS (opAt 110 .MUL)
    (blockOfS _ (pcFactS input 110 192 [(40 : UInt256), (UInt256.shiftRight ov (8 : UInt256)), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2995)
  ...
  have step2996 := soundS (pushAt 111 1 216)
    (blockOfS _ (pcFactS input 111 193 [((40 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2996)
  ...
  have step2997 := soundS (opAt 112 .SUB)
    (blockOfS _ (pcFactS input 112 195 [(216 : UInt256), ((40 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2997)
  ...
  have step3000 := soundS (opAt 113 .SHR)
    (blockOfS _ (pcFactS input 113 196 [((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256))))), M, E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3000)
  ...
  have step3001 := soundS (pushAt 114 1 11)
    (blockOfS _ (pcFactS input 114 197 [(UInt256.shiftRight M ((8 : UInt256) * ((27 : UInt256) - ((5 : UInt256) * (UInt256.shiftRight ov (8 : UInt256)))))), E, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc3001)
