...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v8) (UInt256.ofNat 28))),
    ...
    x.v6,
    x.v7,
    (UInt256.land x.v2 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.land x.v11 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 108) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.land (UInt256.xor (UInt256.land x.v0 x.v5) x.v8) (UInt256.xor x.v5 x.v3)) x.v3) x.v0) x.v4))) (UInt256.ofNat 72)) (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 108) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.land (UInt256.xor (UInt256.land x.v0 x.v5) x.v8) (UInt256.xor x.v5 x.v3)) x.v3) x.v0) x.v4)))))) (UInt256.ofNat 25)))),
    x.v9,
    x.v10,
    x.v11,
    x.v12,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1897 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 2541 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1897) = UInt256.ofNat 2541
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2541, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2586, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2541) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2541) template = UInt256.ofNat 2586 := by decide
  rw [hend] at hraw
