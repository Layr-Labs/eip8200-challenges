...
theorem site_pc : site.startPC = UInt256.ofNat 1664 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1100) = UInt256.ofNat 1664
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1664) template = UInt256.ofNat 1717 := by decide
  rw [hend] at hraw
