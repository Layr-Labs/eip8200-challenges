...
theorem site_pc : site.startPC = UInt256.ofNat 2392 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1767) = UInt256.ofNat 2392
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2392) template = UInt256.ofNat 2432 := by decide
  rw [hend] at hraw
