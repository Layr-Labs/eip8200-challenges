...
theorem run_setup (input : ByteArray) :
  ...
  have hpc3326 : Artifact.submissionArtifact.instructionPC 3472 = 5087 := by rfl
  have hpc3327 : Artifact.submissionArtifact.instructionPC 3473 = 5088 := by rfl
  have hpc3328 : Artifact.submissionArtifact.instructionPC 3474 = 5089 := by rfl
  have hpc3330 : Artifact.submissionArtifact.instructionPC 3476 = 5123 := by rfl
  have hpc3331 : Artifact.submissionArtifact.instructionPC 3477 = 5124 := by rfl
  have hpc3332 : Artifact.submissionArtifact.instructionPC 3478 = 5126 := by rfl
  have hpc3333 : Artifact.submissionArtifact.instructionPC 3479 = 5127 := by rfl
  have hpc3335 : Artifact.submissionArtifact.instructionPC 3481 = 5129 := by rfl
...
theorem run_word_straddle (input : ByteArray) (k : Nat) (a : UInt256) (hk : k < 31)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1489 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3564 (by rfl)
