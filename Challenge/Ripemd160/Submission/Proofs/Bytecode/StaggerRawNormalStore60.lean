...
theorem site_pc : site.startPC = UInt256.ofNat 726 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 461) = UInt256.ofNat 726
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 726) template = UInt256.ofNat 805 := by decide
  rw [hend] at hraw
