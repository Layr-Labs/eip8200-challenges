import Challenge.Ripemd160.Submission.Proofs.Bytecode.CachedEndianMultiply
...
def fastEndianStage8 : List Instr := CachedEndianMultiply.code 8

def fastEndianStage16 : List Instr := CachedEndianMultiply.code 16
...
theorem fastOutputTemplate_byteLength :
  ...
  simp [fastOutputBeforeReturnTemplate, fastPackTemplate, fastLoad0,
    fastPackStep, fastEndianStage8, fastEndianStage16, CachedEndianMultiply.code, CachedEndianMultiply.maskDup,
...
theorem fastOutputTemplate_staticGas : staticGas fastOutputTemplate = 141 := by
  norm_num [staticGas, fastOutputTemplate, fastOutputBeforeReturnTemplate,
    ...
    fastEndianStage16, CachedEndianMultiply.code, CachedEndianMultiply.maskDup,
    DenseScheduleTemplate.endianFactorPush, DenseScheduleTemplate.endianFactor,
