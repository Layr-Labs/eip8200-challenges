...
@[simp] private theorem submissionInstructionsChunk12_length : submissionInstructionsChunk12.length = 85 := by rfl
...
theorem referenceInstructions_count : submissionInstructions.length = 2485 := by
