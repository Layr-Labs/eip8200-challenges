...
private theorem codePrefix_size : codePrefix.size = 4630 := by
...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4944 + 20*((72808268889/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (314 + 20*((72808268889/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (314 + 20*((72808268889/n)%16)) 20 =
