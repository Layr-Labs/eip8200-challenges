...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (5214 - 20*((392382779957/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (590 - 20*((392382779957/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (590 - 20*((392382779957/n)%16)) 20 =
      MachineState.readPadded payload (280 - 20*((392382779957/n)%16)) 20 := by
  rcases hn with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
  all_goals decide

private theorem selected_nat (n : Nat) (hn : Allowed n) :
    (selected (UInt256.ofNat 5214) n).toNat = 5214 - 20*((392382779957/n)%16) := by
  rcases hn with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
  all_goals decide
