...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3574).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4457 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3574) = UInt256.ofNat 4457
