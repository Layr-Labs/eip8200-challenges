...
theorem site_pc : site.startPC = UInt256.ofNat 4435 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3526) = UInt256.ofNat 4435
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4435) template = UInt256.ofNat 4474 := by decide
  rw [hend] at hraw
