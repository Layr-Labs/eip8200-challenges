...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3556).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4465 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3556) = UInt256.ofNat 4465
