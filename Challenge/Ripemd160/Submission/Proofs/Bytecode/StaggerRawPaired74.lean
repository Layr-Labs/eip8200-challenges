...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3563).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4472 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3563) = UInt256.ofNat 4472
