...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3465).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4338 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3465) = UInt256.ofNat 4338
