...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v7) (UInt256.ofNat 28))),
    ...
    x.v5,
    x.v6,
    (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 972) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v9 x.v7) x.v0) (UInt256.xor x.v9 (UInt256.xor x.v7 x.v4))) x.v3))))) (UInt256.ofNat 25)))),
    x.v8,
    x.v9,
    x.v10,
    x.v11,
...
theorem site_pc : site.startPC = UInt256.ofNat 4447 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3535) = UInt256.ofNat 4447
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4447) template = UInt256.ofNat 4486 := by decide
  rw [hend] at hraw
