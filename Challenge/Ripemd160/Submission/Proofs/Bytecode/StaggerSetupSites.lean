...
theorem branch_pc : branchSite.startPC = UInt256.ofNat 4802 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3718) = UInt256.ofNat 4802
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem high_pc : highSite.startPC = UInt256.ofNat 4806 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3720) = UInt256.ofNat 4806
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
