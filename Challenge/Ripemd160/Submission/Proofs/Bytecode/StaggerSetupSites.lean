...
theorem normal_pc : normalSite.startPC = UInt256.ofNat 541 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 343) = UInt256.ofNat 541
...
theorem pad_pc : padSite.startPC = UInt256.ofNat 450 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 286) = UInt256.ofNat 450
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem pad_end : pcAfter (UInt256.ofNat 450) StaggerPad.padTemplate = UInt256.ofNat 524 := by decide
