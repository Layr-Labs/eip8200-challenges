...
theorem site_pc : site.startPC = UInt256.ofNat 4104 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3359) = UInt256.ofNat 4104
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4104) template = UInt256.ofNat 4140 := by decide
  rw [hend] at hraw
