...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v7,
    x.v8,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 630) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v9 x.v11) x.v0) (UInt256.xor x.v11 (UInt256.xor x.v9 x.v6))) x.v5))))) (UInt256.ofNat 32)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3304 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4203 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3304) = UInt256.ofNat 4203
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4203, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 4242, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4203) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4203) template = UInt256.ofNat 4242 := by decide
  rw [hend] at hraw
