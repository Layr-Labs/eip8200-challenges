...
theorem site_pc : site.startPC = UInt256.ofNat 4192 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3308) = UInt256.ofNat 4192
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4192) template = UInt256.ofNat 4231 := by decide
  rw [hend] at hraw
