...
def callTemplate : List Instr :=
  [.push ⟨3, by decide⟩ (UInt256.ofNat 65565), .push 0 0, .op .NOT, .op .DIV,
   .push ⟨2, by decide⟩ (UInt256.ofNat 285), .push 0 0, .op .NOT, .op .DIV,
   .push ⟨2, by decide⟩ (UInt256.ofNat 1084), .op (.Dup ⟨14, by decide⟩), .op .ADD]
def pointer (off : UInt256) : UInt256 := UInt256.add (UInt256.ofNat 1084) off
...
theorem run_call (s : State) (pc off limit : UInt256) (h : Compression.HashState)
  ...
  have hpointer : off + UInt256.ofNat 1084 = pointer off := RawExpressionAC.add_comm _ _
