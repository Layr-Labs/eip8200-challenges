...
def callTemplate : List Instr :=
  [.push ⟨3, by decide⟩ (UInt256.ofNat 65537), .push 0 0, .op .NOT, .op .DIV,
   ...
   .op (.Dup ⟨13, by decide⟩), .push ⟨2, by decide⟩ (UInt256.ofNat 1120), .op .ADD]
...
theorem run_call (s : State) (pc off limit : UInt256) (h : Compression.HashState)
  ...
  simp (discharger := omega) [callTemplate, frame, pointer, DeferredNormalInitial.mask8_div, DeferredNormalInitial.mask16_div, hzero, runInstrSeq, DataStepper.runInstr,
