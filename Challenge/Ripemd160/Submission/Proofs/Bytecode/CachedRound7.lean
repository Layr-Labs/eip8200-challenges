...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 766).take actualTemplate.length = actualTemplate := by rfl
def actualSite : GenericRoundSite Artifact.submissionArtifact .Osaka actualTemplate :=
  StackSiteBuilder.ofSlice actualTemplate 766 actual_slice
...
theorem actual_pc : actualSite.startPC = UInt256.ofNat 1049 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 766) = UInt256.ofNat 1049
