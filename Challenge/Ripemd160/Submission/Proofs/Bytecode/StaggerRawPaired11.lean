...
theorem site_pc : site.startPC = UInt256.ofNat 1644 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1121) = UInt256.ofNat 1644
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1644) template = UInt256.ofNat 1688 := by decide
  rw [hend] at hraw
