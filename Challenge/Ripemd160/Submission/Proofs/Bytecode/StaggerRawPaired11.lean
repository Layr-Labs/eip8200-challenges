...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 28))),
    ...
    x.v2,
    x.v0,
    (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v10 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 522) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v2 x.v4) x.v0) (UInt256.xor x.v2 (UInt256.xor x.v7 x.v4))) x.v3))) (UInt256.ofNat 72)) (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 522) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v2 x.v4) x.v0) (UInt256.xor x.v2 (UInt256.xor x.v7 x.v4))) x.v3)))))) (UInt256.ofNat 20)))),
    x.v5,
    x.v6,
    x.v7,
    x.v8,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1127 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1622 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1127) = UInt256.ofNat 1622
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1622, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1666, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1622) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1622) template = UInt256.ofNat 1666 := by decide
  rw [hend] at hraw
