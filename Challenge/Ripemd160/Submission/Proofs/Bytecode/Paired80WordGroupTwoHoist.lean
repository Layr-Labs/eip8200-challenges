...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.Paired80WordGroupTwoHoist

open EvmSemantics
open Paired80Core PairedLaneUInt256Bridge Paired80WordBoolean
open Paired80WordRotate Paired80WordRound Paired80GroupTwoHoist
...
theorem rawWordStep2_eq_of_supported (r s : Nat) (message k : UInt256) (q : WordLane)
  ...
  exact congrArg
    (fun x : UInt256 => PairedLaneWordRound.WordLane.mk q.e x q.b
      (UInt256.land (wordShift q.c 22) pairWord) q.d)
    (hoistedT_eq r s q.a q.b q.c q.d q.e message k hb hc hd)

#print axioms rawWordStep2_eq_of_supported

theorem packCrypto_supported (l q : Paired80CryptoBridge.CryptoLane) :
...
theorem rawWordStep2_of_crypto (r s : Nat)
    ...
    rawWordStep2 r s (word (pack wl.toBitVec wr.toBitVec))
      ...
      packCrypto (Paired80CryptoBridge.cryptoStep 2 r wl kl l)
        (Paired80CryptoBridge.cryptoStep 2 s wr kr q) := by
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.Paired80WordGroupTwoHoist
