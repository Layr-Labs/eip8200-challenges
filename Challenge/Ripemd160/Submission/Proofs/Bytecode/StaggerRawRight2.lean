...
theorem site_pc : site.startPC = UInt256.ofNat 1180 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 688) = UInt256.ofNat 1174
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1180) template = UInt256.ofNat 1184 := by decide
  rw [hend] at hraw
