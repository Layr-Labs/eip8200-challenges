...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v7 (UInt256.shiftRight (UInt256.mul x.v6 x.v3) (UInt256.ofNat 22))),
    x.v1,
    x.v2,
    (UInt256.land x.v7 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v6 (UInt256.land x.v7 (UInt256.add x.v1 (UInt256.add x.v11 (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v0) x.v3) x.v2) x.v4))))) (UInt256.ofNat 23)))),
    x.v0,
    x.v5,
    x.v6,
    x.v7,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 693 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 1062 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 693) = UInt256.ofNat 1062
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1062, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 1093, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1062) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1062) template = UInt256.ofNat 1093 := by decide
  rw [hend] at hraw
