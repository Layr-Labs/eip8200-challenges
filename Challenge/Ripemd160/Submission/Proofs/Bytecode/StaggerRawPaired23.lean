...
theorem site_pc : site.startPC = UInt256.ofNat 2222 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1604) = UInt256.ofNat 2222
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2222) template = UInt256.ofNat 2268 := by decide
  rw [hend] at hraw
