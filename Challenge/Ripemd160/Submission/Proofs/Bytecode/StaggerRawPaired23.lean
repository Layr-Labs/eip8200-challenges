...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v4,
    (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v11 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 774) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v5 x.v0) (UInt256.xor x.v8 x.v3)) x.v0) (UInt256.land x.v8 x.v5)) x.v6))) (UInt256.ofNat 72)) (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 774) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v5 x.v0) (UInt256.xor x.v8 x.v3)) x.v0) (UInt256.land x.v8 x.v5)) x.v6)))))) (UInt256.ofNat 20)))),
    x.v0,
    x.v7,
    x.v8,
    x.v9,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 1617).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1617 actual_slice
    (by change 1617 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 2209 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1617) = UInt256.ofNat 2209
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2209, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2255, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2209) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2209) template = UInt256.ofNat 2255 := by decide
  rw [hend] at hraw
