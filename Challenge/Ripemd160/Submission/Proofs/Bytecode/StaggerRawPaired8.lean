...
theorem site_pc : site.startPC = UInt256.ofNat 1389 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 978) = UInt256.ofNat 1389
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1389) template = UInt256.ofNat 1427 := by decide
  rw [hend] at hraw
