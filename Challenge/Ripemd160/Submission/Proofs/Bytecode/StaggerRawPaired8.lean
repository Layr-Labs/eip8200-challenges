...
theorem site_pc : site.startPC = UInt256.ofNat 1439 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1036) = UInt256.ofNat 1439
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1439) template = UInt256.ofNat 1478 := by decide
  rw [hend] at hraw
