...
theorem site_pc : site.startPC = UInt256.ofNat 1485 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1057) = UInt256.ofNat 1485
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1485) template = UInt256.ofNat 1524 := by decide
  rw [hend] at hraw
