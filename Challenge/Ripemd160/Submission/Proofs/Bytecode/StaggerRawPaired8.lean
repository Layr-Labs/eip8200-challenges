...
theorem site_pc : site.startPC = UInt256.ofNat 1468 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1046) = UInt256.ofNat 1468
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1468) template = UInt256.ofNat 1507 := by decide
  rw [hend] at hraw
