...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v7,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 756) (UInt256.add (UInt256.xor (UInt256.lor x.v0 (UInt256.land x.v9 x.v4)) (UInt256.xor (UInt256.xor x.v9 x.v4) x.v6)) x.v8))))) (UInt256.ofNat 27)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
theorem site_pc : site.startPC = UInt256.ofNat 1591 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1064) = UInt256.ofNat 1591
