...
@[simp] private theorem branchPC0 : Artifact.submissionArtifact.instructionPC 158 = 286 := rfl
@[simp] private theorem branchPC1 : Artifact.submissionArtifact.instructionPC 159 = 287 := rfl
@[simp] private theorem branchPC2 : Artifact.submissionArtifact.instructionPC 160 = 288 := rfl
@[simp] private theorem cleanupDupPC : Artifact.submissionArtifact.instructionPC 162 = 292 := rfl
...
@[simp] private theorem e4PC165 : Artifact.submissionArtifact.instructionPC 162 = 292 := rfl
@[simp] private theorem e4PC166 : Artifact.submissionArtifact.instructionPC 163 = 293 := rfl
@[simp] private theorem e4PC167 : Artifact.submissionArtifact.instructionPC 164 = 289 := rfl
@[simp] private theorem e4PC168 : Artifact.submissionArtifact.instructionPC 165 = 295 := rfl
@[simp] private theorem e4PC169 : Artifact.submissionArtifact.instructionPC 166 = 296 := rfl
@[simp] private theorem e4PC170 : Artifact.submissionArtifact.instructionPC 167 = 297 := rfl
@[simp] private theorem e4PC171 : Artifact.submissionArtifact.instructionPC 168 = 298 := rfl
@[simp] private theorem e4PC172 : Artifact.submissionArtifact.instructionPC 169 = 299 := rfl
@[simp] private theorem e4PC173 : Artifact.submissionArtifact.instructionPC 170 = 300 := rfl

@[simp] private theorem branchJumpPC : Artifact.submissionArtifact.instructionPC 161 = 291 := rfl
