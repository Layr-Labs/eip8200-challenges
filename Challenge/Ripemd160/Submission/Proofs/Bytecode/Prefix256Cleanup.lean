...
@[simp] private theorem branchPC0 : Artifact.submissionArtifact.instructionPC 157 = 255 := rfl
@[simp] private theorem branchPC1 : Artifact.submissionArtifact.instructionPC 158 = 256 := rfl
@[simp] private theorem branchPC2 : Artifact.submissionArtifact.instructionPC 159 = 259 := rfl
@[simp] private theorem cleanupDupPC : Artifact.submissionArtifact.instructionPC 185 = 352 := rfl
...
def branchPath : List Located :=
  [opAt 157 (.Dup ⟨2, by decide⟩), pushAt 158 2 351, opAt 159 .JUMPI]
