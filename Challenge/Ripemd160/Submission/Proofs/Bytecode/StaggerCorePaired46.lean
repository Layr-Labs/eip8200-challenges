...
def gasSteps (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3055, stack := stack s.memory h4 [ .d, .a, .cachedMessage 360, .pair, .upper, .e, .b, .literal 23, .k, .c, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] q right (StaggerModeSeven.physicalKey 45) rho}
      {s with pc := UInt256.ofNat 3110, stack := stack s.memory h4 [ .d, .e, .cachedMessage 360, .pair, .upper, .a, .c, .literal 23, .k, .b, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (eval s.memory q) right (StaggerModeSeven.physicalKey 46) rho} := by
