...
theorem output_eq (memory : ByteArray) (h4 : UInt256) (q right : WordLane) (rho : List UInt256) :
    StaggerRawPaired46.outputStack memory (input memory h4 q right (StaggerModeSeven.physicalKey 45)) rho =
      stack memory h4 [ .d, .e, .cachedMessage 360, .pair, .upper, .a, .c, .literal 23, .k, .b, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (eval memory q) right (StaggerModeSeven.physicalKey 46) rho := by
  have hkb : StaggerModeSeven.physicalKey 45 = UInt256.ofNat 45805601672572416830120737830960963807809187239029693 := by decide
  have hka : StaggerModeSeven.physicalKey 46 = UInt256.ofNat 45805601672572416830120737830960963807809187239029693 := by decide
  ...
  have hrescale (x y : UInt256) :
      UInt256.land pairWord (UInt256.add y (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 10141204804187018453417038184478) x) (UInt256.ofNat 26))) =
      UInt256.land pairWord (UInt256.add y (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 20282409608374036906834076368928) x) (UInt256.ofNat 27))) := by
...
def gasSteps (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3155, stack := stack s.memory h4 [ .d, .a, .cachedMessage 360, .pair, .upper, .e, .b, .literal 23, .k, .c, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] q right (StaggerModeSeven.physicalKey 45) rho}
      {s with pc := UInt256.ofNat 3210, stack := stack s.memory h4 [ .d, .e, .cachedMessage 360, .pair, .upper, .a, .c, .literal 23, .k, .b, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (eval s.memory q) right (StaggerModeSeven.physicalKey 46) rho} := by
