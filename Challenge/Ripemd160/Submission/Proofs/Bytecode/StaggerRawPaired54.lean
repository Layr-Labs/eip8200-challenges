...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v7) (UInt256.ofNat 22))),
    ...
    x.v5,
    x.v0,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.add x.v15 (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v2 x.v7) x.v4) (UInt256.xor (UInt256.land x.v2 x.v7) x.v0)) x.v7) x.v6))))) (UInt256.ofNat 23)))),
    x.v8,
    x.v9,
    x.v10,
    x.v11,
...
theorem site_pc : site.startPC = UInt256.ofNat 3509 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2819) = UInt256.ofNat 3509
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3509) template = UInt256.ofNat 3547 := by decide
  rw [hend] at hraw
