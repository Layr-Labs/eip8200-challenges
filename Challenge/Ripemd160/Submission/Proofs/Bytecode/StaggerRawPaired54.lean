...
theorem site_pc : site.startPC = UInt256.ofNat 3460 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2792) = UInt256.ofNat 3460
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3460) template = UInt256.ofNat 3500 := by decide
  rw [hend] at hraw
