...
theorem site_pc : site.startPC = UInt256.ofNat 3629 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2793) = UInt256.ofNat 3629
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3629) template = UInt256.ofNat 3669 := by decide
  rw [hend] at hraw
