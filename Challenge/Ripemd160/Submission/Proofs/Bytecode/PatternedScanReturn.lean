...
@[simp] private theorem selectPC265 : Artifact.submissionArtifact.instructionPC 166 = 260 := rfl
@[simp] private theorem selectPC270 : Artifact.submissionArtifact.instructionPC 171 = 287 := rfl
@[simp] private theorem selectPC271 : Artifact.submissionArtifact.instructionPC 172 = 288 := rfl
@[simp] private theorem selectPC272 : Artifact.submissionArtifact.instructionPC 173 = 291 := rfl
@[simp] private theorem selectPC273 : Artifact.submissionArtifact.instructionPC 174 = 292 := rfl
@[simp] private theorem selectPC274 : Artifact.submissionArtifact.instructionPC 175 = 313 := rfl
@[simp] private theorem selectPC275 : Artifact.submissionArtifact.instructionPC 176 = 314 := rfl
...
def storedState (input : ByteArray) : State :=
  { atPC input 339 with stack := hitRest, memory := answerMemory, activeWords := UInt256.ofNat 1 }

def sizedState (input : ByteArray) : State :=
  { storedState input with pc := UInt256.ofNat 340, stack := UInt256.ofNat 32 :: hitRest }
