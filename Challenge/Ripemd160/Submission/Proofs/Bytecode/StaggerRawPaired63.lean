...
theorem site_pc : site.startPC = UInt256.ofNat 3853 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3149) = UInt256.ofNat 3853
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3853) template = UInt256.ofNat 3893 := by decide
  rw [hend] at hraw
