...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 324) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.land (UInt256.lor (UInt256.xor x.v6 x.v9) x.v4) x.v0) (UInt256.land x.v4 x.v9)) x.v6) x.v7))))) (UInt256.ofNat 26)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
theorem site_pc : site.startPC = UInt256.ofNat 3970 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3118) = UInt256.ofNat 3970
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3970) template = UInt256.ofNat 4011 := by decide
  rw [hend] at hraw
