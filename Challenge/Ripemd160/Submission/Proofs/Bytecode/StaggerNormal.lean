...
def poolStack (words : Nat → UInt256) : List UInt256 :=
  [ words 9, words 3, words 1, words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ]
...
def NormalStore60Input (words : Nat → UInt256) : StaggerRaw.Input :=
  ⟨words 9, words 3, words 1, words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0⟩
theorem NormalStore60_output (memory : ByteArray) (words : Nat → UInt256) (rho : List UInt256) :
    StaggerRawNormalStore60.outputStack memory (NormalStore60Input words) rho = [ words 9, words 3, words 1, words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho := by rfl
...
theorem run_NormalStore60 (s : State) (pc : UInt256) (words : Nat → UInt256) (rho : List UInt256)
    (hs : rho.length ≤ 900) (hr : s.halt = .Running) (ha : 35 ≤ s.activeWords.toNat) :
    runInstrSeq StaggerRawNormalStore60.template {s with pc := pc, stack := [ words 9, words 3, words 1, words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho} =
      some {s with pc := pcAfter pc StaggerRawNormalStore60.template, stack := [ words 9, words 3, words 1, words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho, memory := storeDescending s.memory (tableWords words) 45 16} := by
...
theorem NormalStore44_output (memory : ByteArray) (words : Nat → UInt256) (rho : List UInt256) :
    StaggerRawNormalStore44.outputStack memory (NormalStore44Input words) rho = [ words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho := by rfl
...
theorem run_NormalStore44 (s : State) (pc : UInt256) (words : Nat → UInt256) (rho : List UInt256)
    (hs : rho.length ≤ 900) (hr : s.halt = .Running) (ha : 35 ≤ s.activeWords.toNat) :
    runInstrSeq StaggerRawNormalStore44.template {s with pc := pc, stack := [ words 9, words 3, words 1, words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho} =
      some {s with pc := pcAfter pc StaggerRawNormalStore44.template, stack := [ words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho, memory := storeDescending s.memory (tableWords words) 29 16} := by
...
def NormalStore28Input (words : Nat → UInt256) : StaggerRaw.Input :=
  ⟨words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0⟩
theorem NormalStore28_output (memory : ByteArray) (words : Nat → UInt256) (rho : List UInt256) :
    StaggerRawNormalStore28.outputStack memory (NormalStore28Input words) rho = [ words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho := by rfl
...
theorem run_NormalStore28 (s : State) (pc : UInt256) (words : Nat → UInt256) (rho : List UInt256)
    (hs : rho.length ≤ 900) (hr : s.halt = .Running) (ha : 35 ≤ s.activeWords.toNat) :
    runInstrSeq StaggerRawNormalStore28.template {s with pc := pc, stack := [ words 2, words 15, words 7, words 10, words 13, words 14, words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho} =
      some {s with pc := pcAfter pc StaggerRawNormalStore28.template, stack := [ words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho, memory := storeDescending s.memory (tableWords words) 13 16} := by
...
def NormalStore12Input (words : Nat → UInt256) : StaggerRaw.Input :=
  ⟨words 11, words 8, words 5, words 12, words 0, words 4, words 6, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0, UInt256.ofNat 0⟩
...
theorem run_NormalStore12 (s : State) (pc : UInt256) (words : Nat → UInt256) (rho : List UInt256)
    (hs : rho.length ≤ 900) (hr : s.halt = .Running) (ha : 35 ≤ s.activeWords.toNat) :
    runInstrSeq StaggerRawNormalStore12.template {s with pc := pc, stack := [ words 11, words 8, words 5, words 12, words 0, words 4, words 6 ] ++ rho} =
