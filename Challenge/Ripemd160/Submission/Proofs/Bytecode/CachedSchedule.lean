...
def rawMemory (memory : ByteArray) (value : UInt256) : ByteArray :=
  (writeWord (writeWord (writeWord (writeWord (writeWord (writeWord (writeWord (writeWord (writeWord memory 0 (UInt256.shiftRight value (UInt256.ofNat 252))) 32 (UInt256.shiftRight value (UInt256.ofNat 220))) 256 (UInt256.shiftRight value (UInt256.ofNat 160))) 288 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 156)))) 320 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 96)))) 352 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 64)))) 384 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 32)))) 416 (UInt256.land maskWord value)) 512 (UInt256.ofNat 0))
...
private def lowerMemory (memory : ByteArray) (value : UInt256) : ByteArray :=
  (writeWord (writeWord (writeWord (writeWord (writeWord (writeWord (writeWord (writeWord memory 0 (UInt256.shiftRight value (UInt256.ofNat 252))) 32 (UInt256.shiftRight value (UInt256.ofNat 220))) 256 (UInt256.shiftRight value (UInt256.ofNat 160))) 288 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 156)))) 320 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 96)))) 352 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 64)))) 384 (UInt256.land maskWord (UInt256.shiftRight value (UInt256.ofNat 32)))) 416 (UInt256.land maskWord value))
