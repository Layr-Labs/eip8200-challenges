...
theorem site_pc : site.startPC = UInt256.ofNat 4483 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3381) = UInt256.ofNat 4483
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4483) x rho hstack haliasA haliasE haliasD haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4483) template = UInt256.ofNat 4513 := by decide
  rw [hend] at hraw
