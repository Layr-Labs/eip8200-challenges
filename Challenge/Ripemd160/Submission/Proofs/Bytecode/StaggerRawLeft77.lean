...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v13 x.v1) (UInt256.ofNat 28)),
    (UInt256.land x.v14 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v14 (UInt256.add x.v0 (UInt256.add (MachineState.readWord memory 0) (UInt256.add (UInt256.xor (UInt256.lor x.v1 (UInt256.lnot x.v2)) x.v7) x.v6))))) (UInt256.ofNat 30)))),
    x.v2,
    x.v3,
    (UInt256.ofNat 28),
    x.v5,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3578 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4476 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3578) = UInt256.ofNat 4476
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4476, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 4505, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4476) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4476) template = UInt256.ofNat 4505 := by decide
  rw [hend] at hraw
