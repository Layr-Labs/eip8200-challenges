...
theorem site_pc : site.startPC = UInt256.ofNat 4461 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3504) = UInt256.ofNat 4461
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4461) x rho hstack haliasA haliasE haliasD haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4461) template = UInt256.ofNat 4492 := by decide
  rw [hend] at hraw
