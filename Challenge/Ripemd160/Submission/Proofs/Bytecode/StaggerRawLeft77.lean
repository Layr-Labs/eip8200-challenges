...
theorem site_pc : site.startPC = UInt256.ofNat 4463 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3510) = UInt256.ofNat 4463
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4463) template = UInt256.ofNat 4491 := by decide
  rw [hend] at hraw
