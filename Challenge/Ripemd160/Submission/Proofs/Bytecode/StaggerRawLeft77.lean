...
def template : List Instr :=
  [ .op (.Dup ⟨2, by decide⟩),
    ...
    .op (.Dup ⟨13, by decide⟩),
    .op .MUL,
    .push ⟨3, by decide⟩ (UInt256.ofNat 30),
    .op .SHR,
    .op (.Dup ⟨3, by decide⟩),
    .op .ADD,
    .op (.Dup ⟨14, by decide⟩),
...
def inputStack (x : Input) (rho : List UInt256) : List UInt256 :=
  [ x.v6, x.v1, x.v2, x.v3, (UInt256.ofNat 28), x.v5, x.v0, x.v7, x.v8, x.v9, x.v10, x.v11, x.v12, x.v13, x.v14, x.v15, x.v16, x.v17, x.v18, x.v19 ] ++ rho
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3541 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4442 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3541) = UInt256.ofNat 4442
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4442, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 4472, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4442) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4442) template = UInt256.ofNat 4472 := by decide
  rw [hend] at hraw
