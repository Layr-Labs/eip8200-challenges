...
theorem site_pc : site.startPC = UInt256.ofNat 4524 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3424) = UInt256.ofNat 4524
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4524) x rho hstack haliasA haliasE haliasD haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4524) template = UInt256.ofNat 4555 := by decide
  rw [hend] at hraw
