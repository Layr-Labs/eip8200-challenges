...
theorem site_pc : site.startPC = UInt256.ofNat 4485 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3383) = UInt256.ofNat 4485
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4485) x rho hstack haliasA haliasE haliasD haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4485) template = UInt256.ofNat 4515 := by decide
  rw [hend] at hraw
