...
theorem site_pc : site.startPC = UInt256.ofNat 4477 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3377) = UInt256.ofNat 4477
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4477) x rho hstack haliasA haliasE haliasD haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4477) template = UInt256.ofNat 4507 := by decide
  rw [hend] at hraw
