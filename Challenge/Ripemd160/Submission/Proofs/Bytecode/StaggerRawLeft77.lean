...
def inputStack (x : Input) (rho : List UInt256) : List UInt256 :=
  [ x.v14, x.v1, x.v2, x.v3, (UInt256.ofNat 28), x.v5, x.v0, x.v7, x.v8, x.v9, x.v10, x.v11, x.v12, x.v13, x.v14, x.v15, x.v16, x.v17, x.v18, x.v19 ] ++ rho
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v13 x.v1) (UInt256.ofNat 28)),
    (UInt256.land x.v14 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v14 (UInt256.add x.v0 (UInt256.add (MachineState.readWord memory 0) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v2) x.v1) x.v7) x.v6))))) (UInt256.ofNat 30)))),
    x.v2,
    x.v3,
    (UInt256.ofNat 28),
    x.v5,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v13 x.v1) (UInt256.ofNat 28)),
    (UInt256.land x.v14 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v14 (UInt256.add x.v0 (UInt256.add (MachineState.readWord memory 0) (UInt256.add (UInt256.xor x.v7 (UInt256.lor x.v1 (UInt256.lnot x.v2))) x.v6))))) (UInt256.ofNat 30)))),
    x.v2,
    x.v3,
    (UInt256.ofNat 28),
    x.v5,
...
private theorem run_generated (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
    (hstack : rho.length ≤ 900) (haliasA : x.v10 = x.v6) (haliasD : x.v11 = x.v2) (hrun : s.halt = .Running)
  ...
  simp (discharger := omega) [template, inputStack, actualOutput,
    ...
    List.exchange, List.getElem?_cons_zero, Nat.add_assoc, hrun, hbase, hzero, hcap, haliasA, haliasD,
...
theorem run_actual (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
  ...
  simpa only [actualOutput_eq] using run_generated s pc x rho hstack haliasA haliasD hrun hactive
#print axioms run_actual
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3573).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3573 actual_slice
    (by change 3573 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4506 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3573) = UInt256.ofNat 4506
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4506, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 4534, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4506) x rho hstack haliasA haliasD hrun hactive
  have hend : pcAfter (UInt256.ofNat 4506) template = UInt256.ofNat 4534 := by decide
  rw [hend] at hraw
