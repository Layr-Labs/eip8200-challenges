...
theorem site_pc : site.startPC = UInt256.ofNat 4481 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3379) = UInt256.ofNat 4481
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4481) x rho hstack haliasA haliasE haliasD haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4481) template = UInt256.ofNat 4511 := by decide
  rw [hend] at hraw
