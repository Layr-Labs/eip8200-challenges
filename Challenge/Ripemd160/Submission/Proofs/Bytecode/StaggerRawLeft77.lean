...
theorem site_pc : site.startPC = UInt256.ofNat 4495 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3441) = UInt256.ofNat 4495
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4495) x rho hstack haliasA haliasE haliasD haliasR hrun hactive
  have hend : pcAfter (UInt256.ofNat 4495) template = UInt256.ofNat 4526 := by decide
  rw [hend] at hraw
