...
theorem site_pc : site.startPC = UInt256.ofNat 4424 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3518) = UInt256.ofNat 4424
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4424) template = UInt256.ofNat 4452 := by decide
  rw [hend] at hraw
