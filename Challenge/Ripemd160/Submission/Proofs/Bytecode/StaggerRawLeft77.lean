...
theorem site_pc : site.startPC = UInt256.ofNat 4488 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3386) = UInt256.ofNat 4488
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4488) template = UInt256.ofNat 4518 := by decide
  rw [hend] at hraw
