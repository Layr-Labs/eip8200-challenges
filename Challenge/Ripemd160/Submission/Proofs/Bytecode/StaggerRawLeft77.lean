...
theorem site_pc : site.startPC = UInt256.ofNat 4510 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3388) = UInt256.ofNat 4510
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4510) template = UInt256.ofNat 4541 := by decide
  rw [hend] at hraw
