...
def gasSteps_checkEarly (input : ByteArray)
  ...
  rw [show sizeMatched input = stG input 0x1380 [] from rfl,
    show PatternedScan.patternedEntry input = stG input 0x13d6 [] from rfl]
  refine ?_
  have step0 := soundG (pushAt 3414 0 0)
    (blockOf _ (pcFactG input 3414 0x1380 [] (by norm_num) pc2819)
      (stepG_push0 input 0x1380 [] (by simp) (by norm_num)))
  have step1 := soundG (opAt 3415 .CALLDATALOAD)
    (blockOf _ (pcFactG input 3415 0x1381 [(⟨0⟩ : UInt256)] (by norm_num) pc2820)
      (stepG_calldataload input 0x1381 ⟨0⟩ [] (by simp) (by norm_num)))
  rw [refW_eq] at step1
  have step2 := soundG (opAt 3416 (.Dup ⟨0, by decide⟩))
    (blockOf _ (pcFactG input 3416 0x1382 [referenceWord input] (by norm_num) pc2821)
      (stepG_dup1 input 0x1382 (referenceWord input) [] (by simp) (by norm_num)))
  ...
  have step4 := soundG (opAt 3423 .XOR)
    (blockOf _ (pcFactG input 3423 0x138b
        [KnownInputData.fullWord, referenceWord input, referenceWord input]
        (by norm_num) pc2823)
      (stepG_xor input 0x138b KnownInputData.fullWord (referenceWord input)
        [referenceWord input] (by simp) (by norm_num)))
  have step5 := soundG (pushAt 3424 2 (UInt256.ofNat 5072))
    (blockOf _ (pcFactG input 3424 0x138c
        [UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2824)
      (stepG_push input 0x138c 2 (UInt256.ofNat 5072)
        [UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by simp) (by decide) (by decide) (by norm_num)))
  have step6 := soundG (opAt 3425 .JUMPI)
    (blockOf _ (pcFactG input 3425 0x138f
        [UInt256.ofNat 5072,
         UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2825)
      (stepG_jumpi_taken input 0x138f 5072
  ...
  have step9 := soundG (pushAt 3462 2 (UInt256.ofNat 5078))
    (blockOf _ (pcFactG input 3462 0x13d2 [] (by norm_num) pc2862)
      (stepG_push input 0x13d2 2 (UInt256.ofNat 5078) [] (by simp) (by decide)
        (by decide) (by norm_num)))
  have step10 := soundG (opAt 3463 .POP)
    (blockOf _ (pcFactG input 3463 0x13d5 [UInt256.ofNat 5078] (by norm_num) pc2863)
      (stepG_pop input 0x13d5 (UInt256.ofNat 5078) [] (by simp) (by norm_num)))
