...
def gasSteps_checkEarly (input : ByteArray)
  ...
  have hcleanup : Decode.isValidJumpDest submissionBytecode 4996 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2547 (by rfl)
  have hblock : Decode.isValidJumpDest submissionBytecode 5072 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2590 (by rfl)
  rw [show sizeMatched input = stG input 4891 [] from rfl,
    show PatternedScan.patternedEntry input = stG input 5072 [] from rfl]
  refine ?_
  have step0 := soundG (pushAt 2506 0 0)
    (blockOf _ (pcFactG input 2506 4891 [] (by norm_num) pc2819)
      (stepG_push0 input 4891 [] (by simp) (by norm_num)))
  have step1 := soundG (opAt 2507 .CALLDATALOAD)
    (blockOf _ (pcFactG input 2507 4892 [(⟨0⟩ : UInt256)] (by norm_num) pc2820)
      (stepG_calldataload input 4892 ⟨0⟩ [] (by simp) (by norm_num)))
  rw [refW_eq] at step1
  have step2 := soundG (opAt 2508 (.Dup ⟨0, by decide⟩))
    (blockOf _ (pcFactG input 2508 4893 [referenceWord input] (by norm_num) pc2821)
      (stepG_dup1 input 4893 (referenceWord input) [] (by simp) (by norm_num)))
  have step3 := soundG (pushAt 2509 32 KnownInputData.fullWord)
    (blockOf _ (pcFactG input 2509 4894 [referenceWord input, referenceWord input]
        (by norm_num) pc2822)
      (stepG_push input 4894 32 KnownInputData.fullWord
        [referenceWord input, referenceWord input] (by simp) (by decide) (by decide)
        (by norm_num)))
  have step4 := soundG (opAt 2510 .XOR)
    (blockOf _ (pcFactG input 2510 4927
  ...
  have step5 := soundG (pushAt 2511 2 (UInt256.ofNat 4996))
    (blockOf _ (pcFactG input 2511 4928
  ...
  have step6 := soundG (opAt 2512 .JUMPI)
    (blockOf _ (pcFactG input 2512 4931
        [UInt256.ofNat 4996,
         UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2825)
  ...
  have step7 := soundG (opAt 2547 .JUMPDEST)
    (blockOf _ (pcFactG input 2547 4996 [referenceWord input] (by norm_num) pc2860)
      (stepG_jumpdest input 4996 [referenceWord input] (by simp) (by norm_num)))
  have step8 := soundG (opAt 2548 .POP)
    (blockOf _ (pcFactG input 2548 4997 [referenceWord input] (by norm_num) pc2861)
      (stepG_pop input 4997 (referenceWord input) [] (by simp) (by norm_num)))
  have step9 := soundG (pushAt 2549 2 (UInt256.ofNat 5072))
    (blockOf _ (pcFactG input 2549 4998 [] (by norm_num) pc2862)
      (stepG_push input 4998 2 (UInt256.ofNat 5072) [] (by simp) (by decide)
        (by decide) (by norm_num)))
  have step10 := soundG (opAt 2550 .JUMP)
    (blockOf _ (pcFactG input 2550 5001 [UInt256.ofNat 5072] (by norm_num) pc2863)
