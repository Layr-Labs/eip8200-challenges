...
def gasSteps_checkEarly (input : ByteArray)
  ...
  have step0 := soundG (pushAt 15 0 0)
    (blockOf _ (pcFactG input 15 0x18 [] (by norm_num) pc2819)
      (stepG_push0 input 0x18 [] (by simp) (by norm_num)))
  have step1 := soundG (opAt 16 .CALLDATALOAD)
    (blockOf _ (pcFactG input 16 0x19 [(⟨0⟩ : UInt256)] (by norm_num) pc2820)
      (stepG_calldataload input 0x19 ⟨0⟩ [] (by simp) (by norm_num)))
  rw [refW_eq] at step1
  have step2 := soundG (opAt 17 (.Dup ⟨0, by decide⟩))
    (blockOf _ (pcFactG input 17 0x1a [referenceWord input] (by norm_num) pc2821)
  ...
  have step4 := soundG (opAt 24 .XOR)
    (blockOf _ (pcFactG input 24 0x23
  ...
  have step5 := soundG (pushAt 25 1 (UInt256.ofNat 101))
  ...
  have step6 := soundG (opAt 26 .JUMPI)
    (blockOf _ (pcFactG input 26 0x26
        [UInt256.ofNat 101,
         UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2825)
  ...
  have step7 := soundG (opAt 60 .JUMPDEST)
    (blockOf _ (pcFactG input 60 0x65 [referenceWord input] (by norm_num) pc2860)
      (stepG_jumpdest input 0x65 [referenceWord input] (by simp) (by norm_num)))
  have step8 := soundG (opAt 61 .POP)
    (blockOf _ (pcFactG input 61 0x66 [referenceWord input] (by norm_num) pc2861)
