...
def gasSteps_checkEarly (input : ByteArray)
  ...
  have hblock : Decode.isValidJumpDest submissionBytecode 0x1345 = true :=
  ...
  have step6 := soundG (opAt 2988 .JUMPI)
    (blockOf _ (pcFactG input 2988 0x12fe
        [UInt256.ofNat 4962,
         UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2825)
      (stepG_jumpi_taken input 0x12fe 4962
  ...
  have step9 := soundG (pushAt 3025 2 (UInt256.ofNat 4968))
    (blockOf _ (pcFactG input 3025 0x1341 [] (by norm_num) pc2862)
      (stepG_push input 0x1341 2 (UInt256.ofNat 4968) [] (by simp) (by decide)
        (by decide) (by norm_num)))
  have step10 := soundG (opAt 3026 .JUMP)
    (blockOf _ (pcFactG input 3026 0x1344 [UInt256.ofNat 4968] (by norm_num) pc2863)
      (stepG_jump input 0x1344 4968 [] (by simp) (by norm_num) hblock))
