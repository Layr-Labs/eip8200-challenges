...
def gasSteps_checkEarly (input : ByteArray)
  ...
  rw [show sizeMatched input = stG input 0x1f [] from rfl,
    show PatternedScan.patternedEntry input = stG input 0x6d [] from rfl]
  refine ?_
  have step0 := soundG (pushAt 19 0 0)
    (blockOf _ (pcFactG input 19 0x1f [] (by norm_num) pc2819)
      (stepG_push0 input 0x1f [] (by simp) (by norm_num)))
  have step1 := soundG (opAt 20 .CALLDATALOAD)
    (blockOf _ (pcFactG input 20 0x20 [(⟨0⟩ : UInt256)] (by norm_num) pc2820)
      (stepG_calldataload input 0x20 ⟨0⟩ [] (by simp) (by norm_num)))
  rw [refW_eq] at step1
  have step2 := soundG (opAt 21 (.Dup ⟨0, by decide⟩))
    (blockOf _ (pcFactG input 21 0x21 [referenceWord input] (by norm_num) pc2821)
      (stepG_dup1 input 0x21 (referenceWord input) [] (by simp) (by norm_num)))
  ...
  have step4 := soundG (opAt 28 .XOR)
    (blockOf _ (pcFactG input 28 0x2a
        [KnownInputData.fullWord, referenceWord input, referenceWord input]
        (by norm_num) pc2823)
      (stepG_xor input 0x2a KnownInputData.fullWord (referenceWord input)
        [referenceWord input] (by simp) (by norm_num)))
  have step5 := soundG (pushAt 29 1 (UInt256.ofNat 107))
    (blockOf _ (pcFactG input 29 0x2b
        [UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2824)
      (stepG_push input 0x2b 1 (UInt256.ofNat 107)
        [UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by simp) (by decide) (by decide) (by norm_num)))
  have step6 := soundG (opAt 30 .JUMPI)
    (blockOf _ (pcFactG input 30 0x2d
        [UInt256.ofNat 107,
         UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2825)
      (stepG_jumpi_taken input 0x2d 107
  ...
  have step7 := soundG (opAt 64 .JUMPDEST)
    (blockOf _ (pcFactG input 64 0x6b [referenceWord input] (by norm_num) pc2860)
      (stepG_jumpdest input 0x6b [referenceWord input] (by simp) (by norm_num)))
  have step8 := soundG (opAt 65 .POP)
    (blockOf _ (pcFactG input 65 0x6c [referenceWord input] (by norm_num) pc2861)
      (stepG_pop input 0x6c (referenceWord input) [] (by simp) (by norm_num)))
