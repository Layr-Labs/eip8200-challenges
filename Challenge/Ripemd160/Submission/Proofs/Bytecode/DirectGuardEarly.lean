...
def gasSteps_checkEarly (input : ByteArray)
    ...
    GasSteps (sizeMatched input) (stG input 4836 []) := by
  ...
  have step4 := soundG (pushAt 32 2 (UInt256.ofNat 4836))
    (blockOf _ (pcFactG input 32 49 [UInt256.xor KnownInputData.fullWord (referenceWord input)]
      (by norm_num) pc_e26)
      (stepG_push input 49 2 (UInt256.ofNat 4836)
        [UInt256.xor KnownInputData.fullWord (referenceWord input)]
        (by simp) (by decide) (by decide) (by norm_num)))
  have step5 := soundG (opAt 33 .JUMPI)
    (blockOf _ (pcFactG input 33 52 [4836, UInt256.xor KnownInputData.fullWord (referenceWord input)]
      (by norm_num) pc_e27)
      (stepG_jumpi_taken input 52 4836 (UInt256.xor KnownInputData.fullWord (referenceWord input))
