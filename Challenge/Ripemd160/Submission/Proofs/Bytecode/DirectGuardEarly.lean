...
def gasSteps_checkEarly (input : ByteArray)
  ...
  have htrue : UInt256.isTrue
    ...
    have h : UInt256.isTrue
      ...
      simpa using hnat
    simpa using h
  have hcleanup : Decode.isValidJumpDest submissionBytecode 0x13b4 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3460 (by rfl)
  rw [show sizeMatched input = stG input 0x1364 [] from rfl,
    show PatternedScan.patternedEntry input = stG input 0x13ba [] from rfl]
  refine ?_
  have step0 := soundG (pushAt 3414 0 0)
    (blockOf _ (pcFactG input 3414 0x1364 [] (by norm_num) pc2819)
      (stepG_push0 input 0x1364 [] (by simp) (by norm_num)))
  have step1 := soundG (opAt 3415 .CALLDATALOAD)
    (blockOf _ (pcFactG input 3415 0x1365 [(⟨0⟩ : UInt256)] (by norm_num) pc2820)
      (stepG_calldataload input 0x1365 ⟨0⟩ [] (by simp) (by norm_num)))
  rw [refW_eq] at step1
  have step2 := soundG (opAt 3416 (.Dup ⟨0, by decide⟩))
    (blockOf _ (pcFactG input 3416 0x1366 [referenceWord input] (by norm_num) pc2821)
      (stepG_dup1 input 0x1366 (referenceWord input) [] (by simp) (by norm_num)))
  ...
  have step4 := soundG (opAt 3423 .XOR)
    (blockOf _ (pcFactG input 3423 0x136f
        [KnownInputData.fullWord, referenceWord input, referenceWord input]
        (by norm_num) pc2823)
      (stepG_xor input 0x136f KnownInputData.fullWord (referenceWord input)
        [referenceWord input] (by simp) (by norm_num)))
  have step5 := soundG (pushAt 3424 2 (UInt256.ofNat 5044))
    (blockOf _ (pcFactG input 3424 0x1370
        [UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2824)
      (stepG_push input 0x1370 2 (UInt256.ofNat 5044)
        [UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by simp) (by decide) (by decide) (by norm_num)))
  have step6 := soundG (opAt 3425 .JUMPI)
    (blockOf _ (pcFactG input 3425 0x1373
        [UInt256.ofNat 5044,
         UInt256.xor KnownInputData.fullWord (referenceWord input), referenceWord input]
        (by norm_num) pc2825)
      (stepG_jumpi_taken input 0x1373 5044
  ...
  have step7 := soundG (opAt 3460 .JUMPDEST)
    (blockOf _ (pcFactG input 3460 0x13b4 [referenceWord input] (by norm_num) pc2860)
      (stepG_jumpdest input 0x13b4 [referenceWord input] (by simp) (by norm_num)))
  have step8 := soundG (opAt 3461 .POP)
    (blockOf _ (pcFactG input 3461 0x13b5 [referenceWord input] (by norm_num) pc2861)
      (stepG_pop input 0x13b5 (referenceWord input) [] (by simp) (by norm_num)))
  have step9 := soundG (pushAt 3462 2 (UInt256.ofNat 5050))
    (blockOf _ (pcFactG input 3462 0x13b6 [] (by norm_num) pc2862)
      (stepG_push input 0x13b6 2 (UInt256.ofNat 5050) [] (by simp) (by decide)
        (by decide) (by norm_num)))
  have step10 := soundG (opAt 3463 .POP)
    (blockOf _ (pcFactG input 3463 0x13b9 [UInt256.ofNat 5050] (by norm_num) pc2863)
      (stepG_pop input 0x13b9 (UInt256.ofNat 5050) [] (by simp) (by norm_num)))
