...
theorem site_pc : site.startPC = UInt256.ofNat 1338 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 870) = UInt256.ofNat 1338
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1338) template = UInt256.ofNat 1377 := by decide
  rw [hend] at hraw
