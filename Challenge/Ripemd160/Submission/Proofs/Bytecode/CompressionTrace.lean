...
def combinationLocated : List Located :=
  [⟨565, .push ⟨4, by decide⟩ (UInt256.ofNat 0xffffffff), by rfl, by decide⟩,
   ...
   ⟨585, .push ⟨4, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ...
   ⟨600, .push ⟨4, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ⟨601, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨602, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨615, .push ⟨4, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ⟨616, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨630, .push ⟨4, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ⟨631, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨632, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨633, .push ⟨1, by decide⟩ (UInt256.ofNat 160), by rfl, by decide⟩,
   ⟨634, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨635, .op (.Dup ⟨5, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨636, .push ⟨4, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
