...
theorem site_pc : site.startPC = UInt256.ofNat 2192 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1624) = UInt256.ofNat 2192
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2192) template = UInt256.ofNat 2246 := by decide
  rw [hend] at hraw
