...
def input (memory : ByteArray) (h q : WordLane) (off limit : UInt256) :
    StaggerPersistentPackRaw.Input :=
  ⟨q.d, UInt256.ofNat 1352829926, q.c, q.b, q.e, q.a,
    factorWord, lowerWord, MachineState.readWord memory 140,
    MachineState.readWord memory 190, MachineState.readWord memory 310,
...
theorem output_eq (memory : ByteArray) (h q : WordLane) (off limit : UInt256)
  ...
  have hm : UInt256.lor lowerWord (UInt256.shiftLeft lowerWord (UInt256.ofNat 80)) =
      Paired80WordBoolean.pairWord := by decide
  have hu : UInt256.shiftLeft lowerWord (UInt256.ofNat 80) = upperWord := by decide
