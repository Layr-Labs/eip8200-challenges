...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 562).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 938 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 562) = UInt256.ofNat 938
