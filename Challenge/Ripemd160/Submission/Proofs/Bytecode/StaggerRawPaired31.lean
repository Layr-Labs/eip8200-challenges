...
theorem site_pc : site.startPC = UInt256.ofNat 2625 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1968) = UInt256.ofNat 2625
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2625) template = UInt256.ofNat 2670 := by decide
  rw [hend] at hraw
