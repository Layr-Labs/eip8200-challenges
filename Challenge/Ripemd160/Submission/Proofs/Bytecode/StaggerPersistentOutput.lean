...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3623).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4648 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3623) = UInt256.ofNat 4648
