...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw3
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 882) (UInt256.add (UInt256.xor (UInt256.lor x.v0 (UInt256.land x.v4 x.v6)) (UInt256.xor (UInt256.xor x.v4 x.v9) x.v6)) x.v5))) (UInt256.ofNat 72)) (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 882) (UInt256.add (UInt256.xor (UInt256.lor x.v0 (UInt256.land x.v4 x.v6)) (UInt256.xor (UInt256.xor x.v4 x.v9) x.v6)) x.v5)))))) (UInt256.ofNat 20)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 882) (UInt256.add (UInt256.xor (UInt256.xor x.v4 (UInt256.xor (UInt256.lor (UInt256.land x.v6 x.v4) x.v0) x.v9)) x.v6) x.v5))) (UInt256.ofNat 72)) (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 882) (UInt256.add (UInt256.xor (UInt256.xor x.v4 (UInt256.xor (UInt256.lor (UInt256.land x.v6 x.v4) x.v0) x.v9)) x.v6) x.v5)))))) (UInt256.ofNat 20)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
private theorem run_generated (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
  ...
  have hz882 : MachineState.readWord s.memory 882 = UInt256.ofNat 0 :=
    PadPrefixContract.read_zero s hz ⟨49, by decide⟩ (by decide)
  ...
  simp (discharger := omega) [template, inputStack, actualOutput, hz882,
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw3
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 4112).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 4112 actual_slice
    (by change 4112 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 5235 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 4112) = UInt256.ofNat 5235
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 5235, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 5273, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 5235) x rho hstack hrun hactive hz
  have hend : pcAfter (UInt256.ofNat 5235) template = UInt256.ofNat 5273 := by decide
  rw [hend] at hraw
