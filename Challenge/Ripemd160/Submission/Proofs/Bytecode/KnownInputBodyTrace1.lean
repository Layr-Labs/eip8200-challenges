...
theorem run_selector_4 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3947 = true :=
...
theorem run_selector_5 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3966 = true :=
...
theorem run_selector_6 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3988 = true :=
...
theorem run_selector_7 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 4010 = true :=
