...
theorem run_selector_4 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3923 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3161 (by rfl)
...
theorem run_selector_5 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3943 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3179 (by rfl)
  simp (config := { maxSteps := 1000000 })
...
theorem run_selector_7 (s : State)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 3985 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3215 (by rfl)
  simp (config := { maxSteps := 1000000 })
