...
def decisionPath : List Located :=
  [⟨277, .op .CALLDATASIZE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨278, .push ⟨2, by decide⟩ (UInt256.ofNat 5023), by rfl, by decide⟩,
   ⟨279, .op .JUMPI, by rfl, wfOp (by decide) trivial rfl⟩]

def bodyPath : List Located :=
  [⟨280, .push ⟨4, by decide⟩ h0, by rfl, by decide⟩,
   ⟨281, .push ⟨1, by decide⟩ (UInt256.ofNat 32), by rfl, by decide⟩,
   ⟨282, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨283, .push ⟨4, by decide⟩ h1, by rfl, by decide⟩,
   ⟨284, .push ⟨1, by decide⟩ (UInt256.ofNat 64), by rfl, by decide⟩,
   ⟨285, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨286, .push ⟨4, by decide⟩ h2, by rfl, by decide⟩,
   ⟨287, .push ⟨1, by decide⟩ (UInt256.ofNat 96), by rfl, by decide⟩,
   ⟨288, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨289, .push ⟨4, by decide⟩ h3, by rfl, by decide⟩,
   ⟨290, .push ⟨1, by decide⟩ (UInt256.ofNat 128), by rfl, by decide⟩,
   ⟨291, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨292, .push ⟨4, by decide⟩ h4, by rfl, by decide⟩,
   ⟨293, .push ⟨1, by decide⟩ (UInt256.ofNat 160), by rfl, by decide⟩,
   ⟨294, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨295, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨296, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]
...
theorem run_decision_nonempty (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 5023 = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 4096 = 5023 := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 4096 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2792 : Artifact.submissionArtifact.instructionPC 277 = 0x1e9 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2793 : Artifact.submissionArtifact.instructionPC 277 = 0x1e9 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2794 : Artifact.submissionArtifact.instructionPC 278 = 0x1ea := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2795 : Artifact.submissionArtifact.instructionPC 279 = 0x1ed := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
...
theorem run_body (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1d5 = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 264 = 0x1d5 := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 264 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2796 : Artifact.submissionArtifact.instructionPC 280 = 0x1ee := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2797 : Artifact.submissionArtifact.instructionPC 281 = 0x1f3 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2798 : Artifact.submissionArtifact.instructionPC 282 = 0x1f5 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2799 : Artifact.submissionArtifact.instructionPC 283 = 0x1f6 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2800 : Artifact.submissionArtifact.instructionPC 284 = 0x1fb := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2801 : Artifact.submissionArtifact.instructionPC 285 = 0x1fd := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2802 : Artifact.submissionArtifact.instructionPC 286 = 0x1fe := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2803 : Artifact.submissionArtifact.instructionPC 287 = 0x203 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2804 : Artifact.submissionArtifact.instructionPC 288 = 0x205 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2805 : Artifact.submissionArtifact.instructionPC 289 = 0x206 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2806 : Artifact.submissionArtifact.instructionPC 290 = 0x20b := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2807 : Artifact.submissionArtifact.instructionPC 291 = 0x20d := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2808 : Artifact.submissionArtifact.instructionPC 292 = 0x20e := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2809 : Artifact.submissionArtifact.instructionPC 293 = 0x213 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2810 : Artifact.submissionArtifact.instructionPC 294 = 0x215 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2811 : Artifact.submissionArtifact.instructionPC 295 = 0x216 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2812 : Artifact.submissionArtifact.instructionPC 296 = 0x217 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
