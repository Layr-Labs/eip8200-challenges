...
def decisionPath : List Located :=
  [⟨275, .op .CALLDATASIZE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨276, .push ⟨2, by decide⟩ (UInt256.ofNat 5023), by rfl, by decide⟩,
...
theorem run_decision_nonempty (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 5023 = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 4094 = 5023 := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 4094 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2792 : Artifact.submissionArtifact.instructionPC 275 = 0x1e9 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2793 : Artifact.submissionArtifact.instructionPC 275 = 0x1e9 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2794 : Artifact.submissionArtifact.instructionPC 276 = 0x1ea := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2795 : Artifact.submissionArtifact.instructionPC 277 = 0x1ed := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
...
theorem run_body (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1d5 = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 262 = 0x1d5 := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 262 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2796 : Artifact.submissionArtifact.instructionPC 278 = 0x1ee := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2797 : Artifact.submissionArtifact.instructionPC 279 = 0x1f3 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2798 : Artifact.submissionArtifact.instructionPC 280 = 0x1f5 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2799 : Artifact.submissionArtifact.instructionPC 281 = 0x1f6 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2800 : Artifact.submissionArtifact.instructionPC 282 = 0x1fb := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2801 : Artifact.submissionArtifact.instructionPC 283 = 0x1fd := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2802 : Artifact.submissionArtifact.instructionPC 284 = 0x1fe := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2803 : Artifact.submissionArtifact.instructionPC 285 = 0x203 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2804 : Artifact.submissionArtifact.instructionPC 286 = 0x205 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2805 : Artifact.submissionArtifact.instructionPC 287 = 0x206 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2806 : Artifact.submissionArtifact.instructionPC 288 = 0x20b := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2807 : Artifact.submissionArtifact.instructionPC 289 = 0x20d := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2808 : Artifact.submissionArtifact.instructionPC 290 = 0x20e := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2809 : Artifact.submissionArtifact.instructionPC 291 = 0x213 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2810 : Artifact.submissionArtifact.instructionPC 292 = 0x215 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2811 : Artifact.submissionArtifact.instructionPC 293 = 0x216 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2812 : Artifact.submissionArtifact.instructionPC 294 = 0x217 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
