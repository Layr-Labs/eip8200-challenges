...
def decisionPath : List Located :=
  [⟨2473, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2474, .op .CALLDATASIZE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2475, .push ⟨2, by decide⟩ (UInt256.ofNat 0x726), by rfl, by decide⟩,
   ⟨2476, .op .JUMPI, by rfl, wfOp (by decide) trivial rfl⟩]

def bodyPath : List Located :=
  [⟨2477, .push ⟨4, by decide⟩ h0, by rfl, by decide⟩,
   ⟨2478, .push ⟨1, by decide⟩ (UInt256.ofNat 0x20), by rfl, by decide⟩,
   ⟨2479, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2480, .push ⟨4, by decide⟩ h1, by rfl, by decide⟩,
   ⟨2481, .push ⟨1, by decide⟩ (UInt256.ofNat 0x40), by rfl, by decide⟩,
   ⟨2482, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2483, .push ⟨4, by decide⟩ h2, by rfl, by decide⟩,
   ⟨2484, .push ⟨1, by decide⟩ (UInt256.ofNat 0x60), by rfl, by decide⟩,
   ⟨2485, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2486, .push ⟨4, by decide⟩ h3, by rfl, by decide⟩,
   ⟨2487, .push ⟨1, by decide⟩ (UInt256.ofNat 0x80), by rfl, by decide⟩,
   ⟨2488, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2489, .push ⟨4, by decide⟩ h4, by rfl, by decide⟩,
   ⟨2490, .push ⟨1, by decide⟩ (UInt256.ofNat 0xa0), by rfl, by decide⟩,
   ⟨2491, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2492, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2493, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]
...
theorem run_decision_nonempty (s : State) (input : ByteArray) (i : Nat)
  ...
  have hpc2473 : Artifact.submissionArtifact.instructionPC 2473 = 0x1374 := by rfl
  have hpc2474 : Artifact.submissionArtifact.instructionPC 2474 = 0x1375 := by rfl
  have hpc2475 : Artifact.submissionArtifact.instructionPC 2475 = 0x1376 := by rfl
  have hpc2476 : Artifact.submissionArtifact.instructionPC 2476 = 0x1379 := by rfl
  simp [decisionPath, Challenge.EvmProof.Stepper.runLocatedBlock,
    ...
    hrun, htrue, hdest, hpc2473, hpc2474, hpc2475, hpc2476, UInt256.isTrue,
...
theorem run_decision_empty (s : State) (input : ByteArray) (i : Nat)
  ...
  simp [decisionPath, Challenge.EvmProof.Stepper.runLocatedBlock,
    ...
    hpc2473, hpc2474, hpc2475, hpc2476,
...
theorem run_body (s : State) (input : ByteArray) (i : Nat)
  ...
  have hpc2477 : Artifact.submissionArtifact.instructionPC 2477 = 0x137a := by rfl
  have hpc2478 : Artifact.submissionArtifact.instructionPC 2478 = 0x137f := by rfl
  have hpc2479 : Artifact.submissionArtifact.instructionPC 2479 = 0x1381 := by rfl
  have hpc2480 : Artifact.submissionArtifact.instructionPC 2480 = 0x1382 := by rfl
  have hpc2481 : Artifact.submissionArtifact.instructionPC 2481 = 0x1387 := by rfl
  have hpc2482 : Artifact.submissionArtifact.instructionPC 2482 = 0x1389 := by rfl
  have hpc2483 : Artifact.submissionArtifact.instructionPC 2483 = 0x138a := by rfl
  have hpc2484 : Artifact.submissionArtifact.instructionPC 2484 = 0x138f := by rfl
  have hpc2485 : Artifact.submissionArtifact.instructionPC 2485 = 0x1391 := by rfl
  have hpc2486 : Artifact.submissionArtifact.instructionPC 2486 = 0x1392 := by rfl
  have hpc2487 : Artifact.submissionArtifact.instructionPC 2487 = 0x1397 := by rfl
  have hpc2488 : Artifact.submissionArtifact.instructionPC 2488 = 0x1399 := by rfl
  have hpc2489 : Artifact.submissionArtifact.instructionPC 2489 = 0x139a := by rfl
  have hpc2490 : Artifact.submissionArtifact.instructionPC 2490 = 0x139f := by rfl
  have hpc2491 : Artifact.submissionArtifact.instructionPC 2491 = 0x13a1 := by rfl
  have hpc2492 : Artifact.submissionArtifact.instructionPC 2492 = 0x13a2 := by rfl
  have hpc2493 : Artifact.submissionArtifact.instructionPC 2493 = 0x13a3 := by rfl
  simp (config := { maxSteps := 300000 })
    [bodyPath, Challenge.EvmProof.Stepper.runLocatedBlock,
      ...
      hpc2477, hpc2478, hpc2479, hpc2480, hpc2481, hpc2482, hpc2483,
      hpc2484, hpc2485, hpc2486, hpc2487, hpc2488, hpc2489, hpc2490,
      hpc2491, hpc2492, hpc2493,
