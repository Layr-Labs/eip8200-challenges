...
def decisionPath : List Located :=
  [⟨274, .op .CALLDATASIZE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨275, .push ⟨2, by decide⟩ (UInt256.ofNat 5035), by rfl, by decide⟩,
...
theorem run_decision_nonempty (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 5035 = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 4081 = 5035 := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 4081 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2792 : Artifact.submissionArtifact.instructionPC 274 = 0x1e1 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2793 : Artifact.submissionArtifact.instructionPC 274 = 0x1e1 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2794 : Artifact.submissionArtifact.instructionPC 275 = 0x1e2 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2795 : Artifact.submissionArtifact.instructionPC 276 = 0x1e5 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
...
theorem run_body (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1cd = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 261 = 0x1cd := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 261 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2796 : Artifact.submissionArtifact.instructionPC 277 = 0x1e6 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2797 : Artifact.submissionArtifact.instructionPC 278 = 0x1eb := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2798 : Artifact.submissionArtifact.instructionPC 279 = 0x1ed := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2799 : Artifact.submissionArtifact.instructionPC 280 = 0x1ee := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2800 : Artifact.submissionArtifact.instructionPC 281 = 0x1f3 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2801 : Artifact.submissionArtifact.instructionPC 282 = 0x1f5 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2802 : Artifact.submissionArtifact.instructionPC 283 = 0x1f6 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2803 : Artifact.submissionArtifact.instructionPC 284 = 0x1fb := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2804 : Artifact.submissionArtifact.instructionPC 285 = 0x1fd := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2805 : Artifact.submissionArtifact.instructionPC 286 = 0x1fe := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2806 : Artifact.submissionArtifact.instructionPC 287 = 0x203 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2807 : Artifact.submissionArtifact.instructionPC 288 = 0x205 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2808 : Artifact.submissionArtifact.instructionPC 289 = 0x206 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2809 : Artifact.submissionArtifact.instructionPC 290 = 0x20b := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2810 : Artifact.submissionArtifact.instructionPC 291 = 0x20d := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2811 : Artifact.submissionArtifact.instructionPC 292 = 0x20e := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2812 : Artifact.submissionArtifact.instructionPC 293 = 0x20f := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
