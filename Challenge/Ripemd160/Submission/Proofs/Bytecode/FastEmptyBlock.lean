...
nonempty calldata buffer therefore falls through to the existing compressor.
For the unique padded block of the empty input, it installs the five known
post-compression chaining words and returns directly to the driver.
-/
...
def decisionPath : List Located :=
  [⟨2565, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2566, .op .CALLDATASIZE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2567, .push ⟨2, by decide⟩ (UInt256.ofNat 0x726), by rfl, by decide⟩,
   ⟨2568, .op .JUMPI, by rfl, wfOp (by decide) trivial rfl⟩]

def bodyPath : List Located :=
  [⟨2569, .push ⟨4, by decide⟩ h0, by rfl, by decide⟩,
   ⟨2570, .push ⟨1, by decide⟩ (UInt256.ofNat 0x20), by rfl, by decide⟩,
   ⟨2571, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2572, .push ⟨4, by decide⟩ h1, by rfl, by decide⟩,
   ⟨2573, .push ⟨1, by decide⟩ (UInt256.ofNat 0x40), by rfl, by decide⟩,
   ⟨2574, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2575, .push ⟨4, by decide⟩ h2, by rfl, by decide⟩,
   ⟨2576, .push ⟨1, by decide⟩ (UInt256.ofNat 0x60), by rfl, by decide⟩,
   ⟨2577, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2578, .push ⟨4, by decide⟩ h3, by rfl, by decide⟩,
   ⟨2579, .push ⟨1, by decide⟩ (UInt256.ofNat 0x80), by rfl, by decide⟩,
   ⟨2580, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2581, .push ⟨4, by decide⟩ h4, by rfl, by decide⟩,
   ⟨2582, .push ⟨1, by decide⟩ (UInt256.ofNat 0xa0), by rfl, by decide⟩,
   ⟨2583, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2584, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨2585, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]

def bodyEntry (s : State) (input : ByteArray) (i : Nat) : State :=
  { s with
    pc := UInt256.ofNat 0x13e8
...
@[simp] theorem resultState_pc (s : State) (input : ByteArray) (i : Nat) :
    (resultState s input i).pc = UInt256.ofNat 0x643 := by
  rfl

@[simp] theorem resultState_stack (s : State) (input : ByteArray) (i : Nat) :
    (resultState s input i).stack =
