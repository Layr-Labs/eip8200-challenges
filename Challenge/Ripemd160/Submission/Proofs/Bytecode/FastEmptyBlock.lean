...
def decisionPath : List Located :=
  [⟨3962, .op .CALLDATASIZE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3963, .push ⟨2, by decide⟩ (UInt256.ofNat 440), by rfl, by decide⟩,
   ⟨3964, .op .JUMPI, by rfl, wfOp (by decide) trivial rfl⟩]

def bodyPath : List Located :=
  [⟨3965, .push ⟨4, by decide⟩ h0, by rfl, by decide⟩,
   ⟨3966, .push ⟨1, by decide⟩ (UInt256.ofNat 32), by rfl, by decide⟩,
   ⟨3967, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3968, .push ⟨4, by decide⟩ h1, by rfl, by decide⟩,
   ⟨3969, .push ⟨1, by decide⟩ (UInt256.ofNat 64), by rfl, by decide⟩,
   ⟨3970, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3971, .push ⟨4, by decide⟩ h2, by rfl, by decide⟩,
   ⟨3972, .push ⟨1, by decide⟩ (UInt256.ofNat 96), by rfl, by decide⟩,
   ⟨3973, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3974, .push ⟨4, by decide⟩ h3, by rfl, by decide⟩,
   ⟨3975, .push ⟨1, by decide⟩ (UInt256.ofNat 128), by rfl, by decide⟩,
   ⟨3976, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3977, .push ⟨4, by decide⟩ h4, by rfl, by decide⟩,
   ⟨3978, .push ⟨1, by decide⟩ (UInt256.ofNat 160), by rfl, by decide⟩,
   ⟨3979, .op .MSTORE, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3980, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3981, .push ⟨2, by decide⟩ (UInt256.ofNat 5123), by rfl, by decide⟩,
   ⟨3982, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]

def bodyEntry (s : State) (input : ByteArray) (i : Nat) : State :=
  { s with
    pc := UInt256.ofNat 0x1419
    stack := [DriverTrace.messageOffsetWord i, DriverTrace.blockOffsetWord i, Padding.paddedWord input] }
...
theorem run_decision_nonempty (s : State) (input : ByteArray) (i : Nat)
  ...
  have htrue : UInt256.isTrue (UInt256.ofNat input.size) := by
    exact hmod
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1b8 = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 244 = 0x1b8 := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 244 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2793 : Artifact.submissionArtifact.instructionPC 3962 = 0x1414 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2794 : Artifact.submissionArtifact.instructionPC 3963 = 0x1415 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2795 : Artifact.submissionArtifact.instructionPC 3964 = 0x1418 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
...
theorem run_body (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1403 = true := by
    have hpc : Artifact.submissionArtifact.instructionPC 3950 = 0x1403 := by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]
      decide
    have h := Artifact.submissionArtifact.isValidJumpDest_index 3950 (by rfl)
    rw [hpc] at h
    exact h
  have hpc2796 : Artifact.submissionArtifact.instructionPC 3965 = 0x1419 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2797 : Artifact.submissionArtifact.instructionPC 3966 = 0x141e := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2798 : Artifact.submissionArtifact.instructionPC 3967 = 0x1420 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2799 : Artifact.submissionArtifact.instructionPC 3968 = 0x1421 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2800 : Artifact.submissionArtifact.instructionPC 3969 = 0x1426 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2801 : Artifact.submissionArtifact.instructionPC 3970 = 0x1428 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2802 : Artifact.submissionArtifact.instructionPC 3971 = 0x1429 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2803 : Artifact.submissionArtifact.instructionPC 3972 = 0x142e := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2804 : Artifact.submissionArtifact.instructionPC 3973 = 0x1430 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2805 : Artifact.submissionArtifact.instructionPC 3974 = 0x1431 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2806 : Artifact.submissionArtifact.instructionPC 3975 = 0x1436 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2807 : Artifact.submissionArtifact.instructionPC 3976 = 0x1438 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2808 : Artifact.submissionArtifact.instructionPC 3977 = 0x1439 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2809 : Artifact.submissionArtifact.instructionPC 3978 = 0x143e := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2810 : Artifact.submissionArtifact.instructionPC 3979 = 0x1440 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2811 : Artifact.submissionArtifact.instructionPC 3980 = 0x1441 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpcIns : Artifact.submissionArtifact.instructionPC 3981 = 0x1442 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hpc2812 : Artifact.submissionArtifact.instructionPC 3982 = 0x1445 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  simp (config := { maxSteps := 300000 })
    [bodyPath, Challenge.EvmProof.Stepper.runLocatedBlock,
      ...
      hpc2810, hpc2811, hpcIns, hpc2812,
