...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 28))),
    ...
    x.v2,
    x.v0,
    (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.add (UInt256.mul (UInt256.ofNat 511) (UInt256.land (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 1008) (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v2 x.v4) x.v7) (UInt256.xor (UInt256.land x.v2 x.v4) x.v0)) x.v4) x.v3)))) x.v9)) (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 1008) (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v2 x.v4) x.v7) (UInt256.xor (UInt256.land x.v2 x.v4) x.v0)) x.v4) x.v3)))))) (UInt256.ofNat 32)))),
    x.v5,
    x.v6,
    x.v7,
    x.v8,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 2633 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 3487 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2633) = UInt256.ofNat 3487
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3487, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3536, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3487) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3487) template = UInt256.ofNat 3536 := by decide
  rw [hend] at hraw
