...
theorem site_pc : site.startPC = UInt256.ofNat 3600 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2492) = UInt256.ofNat 3600
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3600) template = UInt256.ofNat 3656 := by decide
  rw [hend] at hraw
