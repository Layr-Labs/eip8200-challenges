...
theorem site_pc : site.startPC = UInt256.ofNat 3366 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2449) = UInt256.ofNat 3366
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3366) template = UInt256.ofNat 3394 := by decide
  rw [hend] at hraw
