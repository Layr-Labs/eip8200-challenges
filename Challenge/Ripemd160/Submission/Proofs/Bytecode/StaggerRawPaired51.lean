...
theorem site_pc : site.startPC = UInt256.ofNat 3484 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2689) = UInt256.ofNat 3484
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3484) template = UInt256.ofNat 3532 := by decide
  rw [hend] at hraw
