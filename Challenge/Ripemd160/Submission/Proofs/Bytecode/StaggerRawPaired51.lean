...
theorem site_pc : site.startPC = UInt256.ofNat 3338 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2452) = UInt256.ofNat 3338
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3338) template = UInt256.ofNat 3394 := by decide
  rw [hend] at hraw
