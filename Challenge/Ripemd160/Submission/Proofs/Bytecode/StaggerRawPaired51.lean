...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v0,
    (UInt256.land x.v2 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.add (UInt256.mul (UInt256.ofNat 511) (UInt256.land (UInt256.land x.v2 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 1008) (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v3 x.v5) x.v8) (UInt256.xor (UInt256.land x.v5 x.v3) x.v0)) x.v5) x.v4)))) x.v10)) (UInt256.land x.v2 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 1008) (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v3 x.v5) x.v8) (UInt256.xor (UInt256.land x.v5 x.v3) x.v0)) x.v5) x.v4)))))) (UInt256.ofNat 32)))),
    x.v6,
    x.v7,
    x.v8,
    x.v9,
...
theorem site_pc : site.startPC = UInt256.ofNat 3447 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2650) = UInt256.ofNat 3447
