...
theorem site_pc : site.startPC = UInt256.ofNat 2322 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1697) = UInt256.ofNat 2322
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2322) template = UInt256.ofNat 2362 := by decide
  rw [hend] at hraw
