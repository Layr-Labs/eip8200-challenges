...
theorem site_pc : site.startPC = UInt256.ofNat 2254 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1655) = UInt256.ofNat 2254
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2254) template = UInt256.ofNat 2295 := by decide
  rw [hend] at hraw
