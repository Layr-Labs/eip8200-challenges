...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v7,
    x.v8,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 414) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v9 x.v0) (UInt256.xor x.v4 x.v6)) x.v0) (UInt256.land x.v9 x.v6)) x.v5))))) (UInt256.ofNat 31)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
theorem site_pc : site.startPC = UInt256.ofNat 2244 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1648) = UInt256.ofNat 2244
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2244) template = UInt256.ofNat 2285 := by decide
  rw [hend] at hraw
