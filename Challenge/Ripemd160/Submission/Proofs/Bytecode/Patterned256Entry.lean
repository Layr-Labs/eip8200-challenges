...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.Patterned256Entry
...
proved: `run_size_match_short` for the classifier, `gasSteps_checkEarly` for the
first-word test. -/
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.Patterned256Entry
