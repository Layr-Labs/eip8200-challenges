...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan120
...
def gasSteps_last (input : ByteArray) (hsize : input.size = 120) :
...
def gasSteps_scan (input : ByteArray) (hsize : input.size = 120) :
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan120

#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan120.gasSteps_last
#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan120.gasSteps_scan
