...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v15 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.ofNat 2400959708) (UInt256.add (MachineState.readWord memory 108) (UInt256.add (UInt256.xor x.v6 (UInt256.xor (UInt256.land x.v9 x.v4) (UInt256.land (UInt256.lor (UInt256.xor x.v6 x.v9) x.v4) x.v0))) x.v5))) (UInt256.ofNat 72)) (UInt256.add (UInt256.ofNat 2400959708) (UInt256.add (MachineState.readWord memory 108) (UInt256.add (UInt256.xor x.v6 (UInt256.xor (UInt256.land x.v9 x.v4) (UInt256.land (UInt256.lor (UInt256.xor x.v6 x.v9) x.v4) x.v0))) x.v5)))))) (UInt256.ofNat 26)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
theorem site_pc : site.startPC = UInt256.ofNat 3826 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2972) = UInt256.ofNat 3826
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3826) template = UInt256.ofNat 3877 := by decide
  rw [hend] at hraw
