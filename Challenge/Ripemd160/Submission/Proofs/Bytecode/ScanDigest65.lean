...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ScanDigest65
...
def digest : ByteArray := ByteArray.mk #[0x47, 0x52, 0x72, 0xba, 0x46, 0x7c, 0xa6, 0x71, 0x6d, 0xbb, 0x1c, 0x19, 0xa8, 0x4d, 0xe3, 0x55, 0xf0, 0x65, 0x82, 0x9a]
def paddedDigest : ByteArray := ByteArray.mk #[0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x47, 0x52, 0x72, 0xba, 0x46, 0x7c, 0xa6, 0x71, 0x6d, 0xbb, 0x1c, 0x19, 0xa8, 0x4d, 0xe3, 0x55, 0xf0, 0x65, 0x82, 0x9a]
def paddedDigestWord : UInt256 := 0x475272ba467ca6716dbb1c19a84de355f065829a
theorem data_pattern : data = ShortPatternLogic.data65 := by decide
def finalWords : Array UInt32 := #[0x8047, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x208, 0x0]
def finalState : Array UInt32 := #[0xba725247, 0x71a67c46, 0x191cbb6d, 0x55e34da8, 0x9a8265f0]
...
theorem spec_data : Challenge.Ripemd160.spec data = paddedDigest := by
  ...
  rw [hash_data]
  decide
theorem spec_pattern : Challenge.Ripemd160.spec ShortPatternLogic.data65 = paddedDigest := by
  rw [← data_pattern]
  exact spec_data
#print axioms spec_pattern
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ScanDigest65
