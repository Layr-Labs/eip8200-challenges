...
theorem run_size_target (s : State) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x12e8 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2823 (by rfl)
...
theorem run_size_fallback (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x12aa = true :=
...
theorem run_loop_more (s : State) (input : ByteArray) (i n : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1302 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2838 (by rfl)
