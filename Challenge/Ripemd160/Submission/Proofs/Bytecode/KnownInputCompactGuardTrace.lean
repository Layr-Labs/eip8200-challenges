...
theorem run_size_target (s : State) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0xdfe = true :=
...
theorem run_size_fallback (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0xddb = true :=
...
theorem run_loop_more (s : State) (input : ByteArray) (i n : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0xe0e = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2854 (by rfl)
