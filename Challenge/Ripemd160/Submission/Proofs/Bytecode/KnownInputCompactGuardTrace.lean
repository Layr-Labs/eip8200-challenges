...
theorem run_size_target (s : State) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0xdeb = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2835 (by rfl)
...
theorem run_size_fallback (s : State) (input : ByteArray) (i : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0xdca = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2806 (by rfl)
...
theorem run_loop_more (s : State) (input : ByteArray) (i n : Nat)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0xdfc = true :=
