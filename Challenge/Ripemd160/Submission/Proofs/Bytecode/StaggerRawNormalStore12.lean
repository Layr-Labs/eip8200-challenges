...
theorem site_pc : site.startPC = UInt256.ofNat 883 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 534) = UInt256.ofNat 883
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 883) template = UInt256.ofNat 925 := by decide
  rw [hend] at hraw
