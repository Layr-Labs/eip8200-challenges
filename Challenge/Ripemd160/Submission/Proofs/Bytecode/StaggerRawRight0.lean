...
theorem site_pc : site.startPC = UInt256.ofNat 1073 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 652) = UInt256.ofNat 1073
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1073) template = UInt256.ofNat 1103 := by decide
  rw [hend] at hraw
