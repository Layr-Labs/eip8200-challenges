...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 498).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 861 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 498) = UInt256.ofNat 861
