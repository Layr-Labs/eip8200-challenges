...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3503).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4259 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3503) = UInt256.ofNat 4259
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4259) template = UInt256.ofNat 4295 := by decide
  rw [hend] at hraw
