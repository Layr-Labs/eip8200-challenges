...
theorem site_pc : site.startPC = UInt256.ofNat 4220 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3343) = UInt256.ofNat 4220
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4220) template = UInt256.ofNat 4257 := by decide
  rw [hend] at hraw
