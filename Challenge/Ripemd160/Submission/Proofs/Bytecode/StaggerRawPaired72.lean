...
theorem site_pc : site.startPC = UInt256.ofNat 4402 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3446) = UInt256.ofNat 4402
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4402) template = UInt256.ofNat 4441 := by decide
  rw [hend] at hraw
