...
theorem site_pc : site.startPC = UInt256.ofNat 4236 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3495) = UInt256.ofNat 4236
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4236) template = UInt256.ofNat 4272 := by decide
  rw [hend] at hraw
