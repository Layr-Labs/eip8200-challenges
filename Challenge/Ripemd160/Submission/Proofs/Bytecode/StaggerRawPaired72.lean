...
theorem site_pc : site.startPC = UInt256.ofNat 4273 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3512) = UInt256.ofNat 4273
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4273) template = UInt256.ofNat 4309 := by decide
  rw [hend] at hraw
