...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3508).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4329 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3508) = UInt256.ofNat 4329
