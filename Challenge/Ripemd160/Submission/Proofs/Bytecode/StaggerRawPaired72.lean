...
theorem site_pc : site.startPC = UInt256.ofNat 4277 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3384) = UInt256.ofNat 4277
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4277) template = UInt256.ofNat 4314 := by decide
  rw [hend] at hraw
