...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3509).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4551 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3509) = UInt256.ofNat 4551
