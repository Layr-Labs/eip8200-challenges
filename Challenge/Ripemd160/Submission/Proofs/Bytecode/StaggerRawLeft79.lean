...
theorem site_pc : site.startPC = UInt256.ofNat 4542 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3436) = UInt256.ofNat 4542
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4542) template = UInt256.ofNat 4572 := by decide
  rw [hend] at hraw
