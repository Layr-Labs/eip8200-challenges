...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3634).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4527 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3634) = UInt256.ofNat 4527
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4527) template = UInt256.ofNat 4555 := by decide
  rw [hend] at hraw
