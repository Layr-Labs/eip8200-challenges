...
theorem site_pc : site.startPC = UInt256.ofNat 4551 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3486) = UInt256.ofNat 4551
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4551) template = UInt256.ofNat 4581 := by decide
  rw [hend] at hraw
