...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3538).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4551 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3538) = UInt256.ofNat 4551
