...
theorem site_pc : site.startPC = UInt256.ofNat 4553 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3633) = UInt256.ofNat 4553
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4553) template = UInt256.ofNat 4582 := by decide
  rw [hend] at hraw
