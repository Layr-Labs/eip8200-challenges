...
theorem site_pc : site.startPC = UInt256.ofNat 4569 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3443) = UInt256.ofNat 4569
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4569) template = UInt256.ofNat 4599 := by decide
  rw [hend] at hraw
