...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3505).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4555 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3505) = UInt256.ofNat 4555
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4555) template = UInt256.ofNat 4584 := by decide
  rw [hend] at hraw
