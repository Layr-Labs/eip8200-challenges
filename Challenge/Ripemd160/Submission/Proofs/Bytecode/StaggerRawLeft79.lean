...
theorem site_pc : site.startPC = UInt256.ofNat 4538 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3432) = UInt256.ofNat 4538
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4538) template = UInt256.ofNat 4568 := by decide
  rw [hend] at hraw
