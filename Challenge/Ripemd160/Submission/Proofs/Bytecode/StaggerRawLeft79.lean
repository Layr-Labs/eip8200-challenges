...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3569).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4479 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3569) = UInt256.ofNat 4479
