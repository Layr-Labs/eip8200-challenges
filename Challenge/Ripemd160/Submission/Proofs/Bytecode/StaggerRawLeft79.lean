...
theorem site_pc : site.startPC = UInt256.ofNat 4544 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3629) = UInt256.ofNat 4544
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4544) template = UInt256.ofNat 4573 := by decide
  rw [hend] at hraw
