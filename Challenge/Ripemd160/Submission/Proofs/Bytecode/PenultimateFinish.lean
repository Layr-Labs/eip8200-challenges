...
theorem resultMemory_dirty78_message (memory : ByteArray) (l r : PairedLaneCryptoBridge.CryptoLane)
    (k : UInt256) (hk : Normal k)
    (hm : Normal (PairedHelperBooleanTrace.algorithmMessage memory 79)) :
...
#print axioms resultMemory_dirty78_message
