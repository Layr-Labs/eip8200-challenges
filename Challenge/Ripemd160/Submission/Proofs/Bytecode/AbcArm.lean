...
theorem pcArm : Artifact.submissionArtifact.instructionPC 4085 = 5157 := by
...
def sizePath : List Located :=
  [opAt 4085 .JUMPDEST, opAt 4086 .CALLDATASIZE, pushAt 4087 1 3, opAt 4088 .SUB, pushAt 4089 2 272]
...
theorem run_size (input : ByteArray) :
  ...
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4085 5157 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
  ...
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4086 5158 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
  ...
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4087 5159 [sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5159 1 3 [sz] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := opAt 4088 .SUB
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4088 5161 [3, sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_sub input 5161 3 sz [] (by simp) (by norm_num))
  let l4 : Located := pushAt 4089 2 272
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4089 5162 [sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
theorem run_size_miss (input : ByteArray) (hc : UInt256.isTrue (sizeCond input)) :
    run [opAt 4090 .JUMPI] (PatternedScan.stS input 5165 [272, sizeCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4090 .JUMPI)
    (PatternedScan.pcFactS input 4090 5165 [272, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
def wordPath : List Located :=
  [pushAt 4091 3 6382179, pushAt 4092 1 232, opAt 4093 .SHL, pushAt 4094 0 0, opAt 4095 .CALLDATALOAD,
   opAt 4096 .XOR, pushAt 4097 2 272]
...
theorem run_word (input : ByteArray) :
  ...
  let l0 : Located := pushAt 4091 3 6382179
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4091 5166 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5166 3 6382179 [] (by simp) (by decide) (by decide) (by norm_num))
  let l1 : Located := pushAt 4092 1 232
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4092 5170 [6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5170 1 232 [6382179] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := opAt 4093 .SHL
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4093 5172 [232, 6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shl input 5172 232 6382179 [] (by simp) (by norm_num))
  let l3 : Located := pushAt 4094 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4094 5173 [abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 5173 [abcW] (by simp) (by norm_num))
  let l4 : Located := opAt 4095 .CALLDATALOAD
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4095 5174 [0, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 5174 0 [abcW] (by simp) (by norm_num))
  let l5 : Located := opAt 4096 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4096 5175 [w, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 5175 w abcW [] (by simp) (by norm_num))
  let l6 : Located := pushAt 4097 2 272
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4097 5176 [wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
theorem run_word_miss (input : ByteArray) (hc : UInt256.isTrue (wordCond input)) :
    run [opAt 4098 .JUMPI] (PatternedScan.stS input 5179 [272, wordCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4098 .JUMPI)
    (PatternedScan.pcFactS input 4098 5179 [272, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
def storePath : List Located :=
  [pushAt 4099 20 814647003348588794217809277549781461204094028796, pushAt 4100 0 0, opAt 4101 .MSTORE]

def finishPath : List Located :=
  [pushAt 4103 0 0, opAt 4104 .RETURN]

@[simp] theorem pcRet0 : Artifact.submissionArtifact.instructionPC 4099 = 5180 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet1 : Artifact.submissionArtifact.instructionPC 4100 = 5201 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet2 : Artifact.submissionArtifact.instructionPC 4101 = 5202 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet3 : Artifact.submissionArtifact.instructionPC 4102 = 5203 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet4 : Artifact.submissionArtifact.instructionPC 4103 = 5204 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet5 : Artifact.submissionArtifact.instructionPC 4104 = 5205 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
def gasSteps_msize (input : ByteArray) : GasSteps (storedState input) (sizedState input) := by
  ...
  have hp : (storedState input).pc.toNat = Artifact.submissionArtifact.instructionPC 4102 := by
    rw [pcRet3]; rfl
  have hop : (storedState input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (storedState input) 4102
