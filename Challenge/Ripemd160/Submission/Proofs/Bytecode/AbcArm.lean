...
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3645 = 4852 := by
  exact GuardInstructionWindow.pc 0
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3646 = 4853 := by
  exact GuardInstructionWindow.pc 1
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3647 = 4854 := by
  exact GuardInstructionWindow.pc 2
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3648 = 4856 := by
  exact GuardInstructionWindow.pc 3
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3649 = 4857 := by
  exact GuardInstructionWindow.pc 4
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3650 = 4858 := by
  exact GuardInstructionWindow.pc 5
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3651 = 4862 := by
  exact GuardInstructionWindow.pc 6
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3652 = 4863 := by
  exact GuardInstructionWindow.pc 7
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3653 = 4864 := by
  exact GuardInstructionWindow.pc 8
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3654 = 4867 := by
  exact GuardInstructionWindow.pc 9
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3655 = 4868 := by
  exact GuardInstructionWindow.pc 10
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3656 = 4889 := by
  exact GuardInstructionWindow.pc 11
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3657 = 4890 := by
  exact GuardInstructionWindow.pc 12
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3658 = 4891 := by
  exact GuardInstructionWindow.pc 13
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3659 = 4912 := by
  exact GuardInstructionWindow.pc 14
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3660 = 4913 := by
  exact GuardInstructionWindow.pc 15
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3661 = 4914 := by
  exact GuardInstructionWindow.pc 16
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3662 = 4915 := by
  exact GuardInstructionWindow.pc 17
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3663 = 4916 := by
  exact GuardInstructionWindow.pc 18
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3664 = 4917 := by
...
def wordPath : List Located :=
  [⟨3645, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 0, by decide⟩,
   ⟨3646, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 1, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3647, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 2, by decide⟩,
   ⟨3648, .op .SHR, by exact GuardInstructionWindow.get 3, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3649, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 4, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3650, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 5, by decide⟩,
   ⟨3651, .op .MUL, by exact GuardInstructionWindow.get 6, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3652, .op .XOR, by exact GuardInstructionWindow.get 7, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3653, .push ⟨2, by decide⟩ (UInt256.ofNat 339), by exact GuardInstructionWindow.get 8, by decide⟩,
   ⟨3654, .op .JUMPI, by exact GuardInstructionWindow.get 9, ⟨by decide, trivial, rfl⟩⟩]

def wordMissPath : List Located := wordPath ++ [entryDest]

def storePath : List Located :=
  [⟨3655, .push ⟨20, by decide⟩ (UInt256.ofNat 95383801997447390147238369573240532004699299169), by exact GuardInstructionWindow.get 10, by decide⟩,
   ⟨3656, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 11, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3657, .op .SHR, by exact GuardInstructionWindow.get 12, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3658, .push ⟨20, by decide⟩ (UInt256.ofNat 802931186561056611446976448233794645126013734992), by exact GuardInstructionWindow.get 13, by decide⟩,
   ⟨3659, .op .XOR, by exact GuardInstructionWindow.get 14, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3660, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 15, by decide⟩,
   ⟨3661, .op .MSTORE, by exact GuardInstructionWindow.get 16, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3663, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 18, by decide⟩,
   ⟨3664, .op .RETURN, by exact GuardInstructionWindow.get 19, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 4852
...
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 4916, stack := [UInt256.ofNat 32]}
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
  ...
  have hbranch : DataStepper.runLocatedBlock [wordBranch] (wordTested input) =
    ...
    PatternedScan.blockOfS wordBranch
      (PatternedScan.pcFactS input 3654 4867 [UInt256.ofNat 339, wordCond input] (by norm_num) pc_4104)
      (PatternedScan.stepS_jumpi_taken input 4867 339 (UInt256.ofNat 339) (wordCond input) []
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    DataStepper.runLocatedBlock wordPath (armEntry input) = some (Execution.atPC input 4868) := by
  have ht : ¬ UInt256.isTrue (wordCond input) := by rw [hm]; decide
  have hbranch : DataStepper.runLocatedBlock [wordBranch] (wordTested input) = some (Execution.atPC input 4868) :=
    PatternedScan.blockOfS wordBranch
      (PatternedScan.pcFactS input 3654 4867 [UInt256.ofNat 339, wordCond input] (by norm_num) pc_4104)
      (PatternedScan.stepS_jumpi_fall input 4867 (UInt256.ofNat 339) (wordCond input) []
...
theorem run_store (input : ByteArray) :
    DataStepper.runLocatedBlock storePath (Execution.atPC input 4868) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3662 .MSIZE
    (by exact GuardInstructionWindow.get 17) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3662 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3662 rfl hp .MSIZE none hd rfl
