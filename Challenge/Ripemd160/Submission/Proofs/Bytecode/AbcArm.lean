...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3878 = 4971 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3879 = 4972 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3880 = 4973 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3881 = 4974 := by
  exact GuardInstructionWindow.pc 225
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3882 = 4975 := by
  exact GuardInstructionWindow.pc 226
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3857 = 4901 := by
  exact GuardInstructionWindow.pc 201
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3858 = 4902 := by
  exact GuardInstructionWindow.pc 202
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3859 = 4903 := by
  exact GuardInstructionWindow.pc 203
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3860 = 4905 := by
  exact GuardInstructionWindow.pc 204
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3861 = 4906 := by
  exact GuardInstructionWindow.pc 205
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3862 = 4909 := by
  exact GuardInstructionWindow.pc 206
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3863 = 4910 := by
  exact GuardInstructionWindow.pc 207
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3864 = 4914 := by
  exact GuardInstructionWindow.pc 208
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3865 = 4915 := by
  exact GuardInstructionWindow.pc 209
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3866 = 4916 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3867 = 4917 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3868 = 4918 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3869 = 4920 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3870 = 4921 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3871 = 4922 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3872 = 4925 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3873 = 4926 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3874 = 4927 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3875 = 4948 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3876 = 4949 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3877 = 4970 := by
  exact GuardInstructionWindow.pc 221

def sizePath : List Located :=
  [⟨3857, .op .JUMPDEST, by exact GuardInstructionWindow.get 201, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3858, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 202, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3859, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 203, by decide⟩,
   ⟨3860, .op .SHR, by exact GuardInstructionWindow.get 204, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3861, .push ⟨2, by decide⟩ (UInt256.ofNat 358), by exact GuardInstructionWindow.get 205, by decide⟩,
   ⟨3862, .op .JUMPI, by exact GuardInstructionWindow.get 206, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3863, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 207, by decide⟩,
   ⟨3864, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 208, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3865, .op .MUL, by exact GuardInstructionWindow.get 209, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3866, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 210, by decide⟩,
   ⟨3867, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 211, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3868, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 212, by decide⟩,
   ⟨3869, .op .SHR, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3870, .op .XOR, by exact GuardInstructionWindow.get 214, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3871, .push ⟨2, by decide⟩ (UInt256.ofNat 358), by exact GuardInstructionWindow.get 215, by decide⟩,
   ⟨3872, .op .JUMPI, by exact GuardInstructionWindow.get 216, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3873, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 217, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3874, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 218, by decide⟩,
   ⟨3875, .op .MUL, by exact GuardInstructionWindow.get 219, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3876, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 220, by decide⟩,
   ⟨3877, .op .SUB, by exact GuardInstructionWindow.get 221, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3878, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 222, by decide⟩,
   ⟨3879, .op .MSTORE, by exact GuardInstructionWindow.get 223, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3881, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 225, by decide⟩,
   ⟨3882, .op .RETURN, by exact GuardInstructionWindow.get 226, ⟨by decide, trivial, rfl⟩⟩]
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 4901 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3857 (by exact GuardInstructionWindow.get 201)
  rw [pc_4089] at h
  exact h
