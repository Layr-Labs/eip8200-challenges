...
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 230 = 385 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3895 = 5161 := by
  exact GuardInstructionWindow.pc 164
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3896 = 5162 := by
  exact GuardInstructionWindow.pc 165
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3897 = 5163 := by
  exact GuardInstructionWindow.pc 166
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3898 = 5165 := by
  exact GuardInstructionWindow.pc 167
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3899 = 5166 := by
  exact GuardInstructionWindow.pc 168
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3900 = 5169 := by
  exact GuardInstructionWindow.pc 169
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3901 = 5170 := by
  exact GuardInstructionWindow.pc 170
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3902 = 5174 := by
  exact GuardInstructionWindow.pc 171
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3903 = 5175 := by
  exact GuardInstructionWindow.pc 172
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3904 = 5176 := by
  exact GuardInstructionWindow.pc 173
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3905 = 5177 := by
  exact GuardInstructionWindow.pc 174
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3906 = 5178 := by
  exact GuardInstructionWindow.pc 175
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3907 = 5180 := by
  exact GuardInstructionWindow.pc 176
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3908 = 5181 := by
  exact GuardInstructionWindow.pc 177
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3909 = 5182 := by
  exact GuardInstructionWindow.pc 178
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3910 = 5185 := by
  exact GuardInstructionWindow.pc 179
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3911 = 5186 := by
  exact GuardInstructionWindow.pc 180
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3912 = 5207 := by
  exact GuardInstructionWindow.pc 181
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3913 = 5208 := by
  exact GuardInstructionWindow.pc 182
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3914 = 5211 := by
  exact GuardInstructionWindow.pc 183

def sizePath : List Located :=
  [⟨3895, .op .JUMPDEST, by exact GuardInstructionWindow.get 164, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3896, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 165, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3897, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 166, by decide⟩,
   ⟨3898, .op .SHR, by exact GuardInstructionWindow.get 167, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3899, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by exact GuardInstructionWindow.get 168, by decide⟩,
   ⟨3900, .op .JUMPI, by exact GuardInstructionWindow.get 169, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3901, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 170, by decide⟩,
   ⟨3902, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 171, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3903, .op .MUL, by exact GuardInstructionWindow.get 172, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3904, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 173, by decide⟩,
   ⟨3905, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 174, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3906, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 175, by decide⟩,
   ⟨3907, .op .SHR, by exact GuardInstructionWindow.get 176, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3908, .op .XOR, by exact GuardInstructionWindow.get 177, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3909, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by exact GuardInstructionWindow.get 178, by decide⟩,
   ⟨3910, .op .JUMPI, by exact GuardInstructionWindow.get 179, ⟨by decide, trivial, rfl⟩⟩]

def storePath : List Located :=
  [⟨3911, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 180, by decide⟩,
   ⟨3912, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 181, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3913, .push ⟨2, by decide⟩ (UInt256.ofNat 354), by exact GuardInstructionWindow.get 182, by decide⟩,
   ⟨3914, .op .JUMP, by exact GuardInstructionWindow.get 183, ⟨by decide, trivial, rfl⟩⟩,
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5161
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5161 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3895 (by exact GuardInstructionWindow.get 164)
  rw [pc_4089] at h
  exact h
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5170) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5170) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5170) =
      some (Execution.atPC input 5186) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5186) = some (stored input) := by
