...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3902 = 5248 := by
  exact GuardInstructionWindow.pc 234
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3903 = 5249 := by
  exact GuardInstructionWindow.pc 235
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3904 = 5250 := by
  exact GuardInstructionWindow.pc 236
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3905 = 5251 := by
  exact GuardInstructionWindow.pc 237
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3906 = 5252 := by
  exact GuardInstructionWindow.pc 238
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3881 = 5178 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3882 = 5179 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3883 = 5180 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3884 = 5182 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3885 = 5183 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3886 = 5186 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3887 = 5187 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3888 = 5191 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3889 = 5192 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3890 = 5193 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3891 = 5194 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3892 = 5195 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3893 = 5197 := by
  exact GuardInstructionWindow.pc 225
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3894 = 5198 := by
  exact GuardInstructionWindow.pc 226
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3895 = 5199 := by
  exact GuardInstructionWindow.pc 227
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3896 = 5202 := by
  exact GuardInstructionWindow.pc 228
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3897 = 5203 := by
  exact GuardInstructionWindow.pc 229
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3898 = 5204 := by
  exact GuardInstructionWindow.pc 230
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3899 = 5225 := by
  exact GuardInstructionWindow.pc 231
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3900 = 5226 := by
  exact GuardInstructionWindow.pc 232
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3901 = 5247 := by
  exact GuardInstructionWindow.pc 233

def sizePath : List Located :=
  [⟨3881, .op .JUMPDEST, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3882, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 214, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3883, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 215, by decide⟩,
   ⟨3884, .op .SHR, by exact GuardInstructionWindow.get 216, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3885, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 217, by decide⟩,
   ⟨3886, .op .JUMPI, by exact GuardInstructionWindow.get 218, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3887, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 219, by decide⟩,
   ⟨3888, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 220, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3889, .op .MUL, by exact GuardInstructionWindow.get 221, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3890, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 222, by decide⟩,
   ⟨3891, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 223, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3892, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 224, by decide⟩,
   ⟨3893, .op .SHR, by exact GuardInstructionWindow.get 225, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3894, .op .XOR, by exact GuardInstructionWindow.get 226, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3895, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 227, by decide⟩,
   ⟨3896, .op .JUMPI, by exact GuardInstructionWindow.get 228, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3897, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 229, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3898, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 230, by decide⟩,
   ⟨3899, .op .MUL, by exact GuardInstructionWindow.get 231, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3900, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 232, by decide⟩,
   ⟨3901, .op .SUB, by exact GuardInstructionWindow.get 233, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3902, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 234, by decide⟩,
   ⟨3903, .op .MSTORE, by exact GuardInstructionWindow.get 235, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3905, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 237, by decide⟩,
   ⟨3906, .op .RETURN, by exact GuardInstructionWindow.get 238, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5178
...
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 5251, stack := [UInt256.ofNat 32]}
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5178 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3881 (by exact GuardInstructionWindow.get 213)
  rw [pc_4089] at h
  exact h
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5187) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5187) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5187) =
      some (Execution.atPC input 5203) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5203) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hs : sizeCond input = 0) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3904 .MSIZE
    (by exact GuardInstructionWindow.get 236) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3904 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3904 rfl hp .MSIZE none hd rfl
