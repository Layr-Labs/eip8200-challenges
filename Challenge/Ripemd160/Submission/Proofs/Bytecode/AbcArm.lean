...
@[simp] theorem pc_176 : Artifact.submissionArtifact.instructionPC 239 = 351 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3918 = 5245 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3919 = 5246 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3920 = 5247 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3921 = 5248 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3922 = 5249 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3897 = 5175 := by
  exact GuardInstructionWindow.pc 134
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3898 = 5176 := by
  exact GuardInstructionWindow.pc 135
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3899 = 5177 := by
  exact GuardInstructionWindow.pc 136
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3900 = 5179 := by
  exact GuardInstructionWindow.pc 137
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3901 = 5180 := by
  exact GuardInstructionWindow.pc 138
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3902 = 5183 := by
  exact GuardInstructionWindow.pc 139
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3903 = 5184 := by
  exact GuardInstructionWindow.pc 140
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3904 = 5188 := by
  exact GuardInstructionWindow.pc 141
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3905 = 5189 := by
  exact GuardInstructionWindow.pc 142
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3906 = 5190 := by
  exact GuardInstructionWindow.pc 143
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3907 = 5191 := by
  exact GuardInstructionWindow.pc 144
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3908 = 5192 := by
  exact GuardInstructionWindow.pc 145
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3909 = 5194 := by
  exact GuardInstructionWindow.pc 146
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3910 = 5195 := by
  exact GuardInstructionWindow.pc 147
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3911 = 5196 := by
  exact GuardInstructionWindow.pc 148
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3912 = 5199 := by
  exact GuardInstructionWindow.pc 149
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3913 = 5200 := by
  exact GuardInstructionWindow.pc 150
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3914 = 5201 := by
  exact GuardInstructionWindow.pc 151
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3915 = 5222 := by
  exact GuardInstructionWindow.pc 152
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3916 = 5223 := by
  exact GuardInstructionWindow.pc 153
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3917 = 5244 := by
  exact GuardInstructionWindow.pc 154

def sizePath : List Located :=
  [⟨3897, .op .JUMPDEST, by exact GuardInstructionWindow.get 134, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3898, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 135, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3899, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 136, by decide⟩,
   ⟨3900, .op .SHR, by exact GuardInstructionWindow.get 137, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3901, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 138, by decide⟩,
   ⟨3902, .op .JUMPI, by exact GuardInstructionWindow.get 139, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3903, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 140, by decide⟩,
   ⟨3904, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 141, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3905, .op .MUL, by exact GuardInstructionWindow.get 142, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3906, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 143, by decide⟩,
   ⟨3907, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 144, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3908, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 145, by decide⟩,
   ⟨3909, .op .SHR, by exact GuardInstructionWindow.get 146, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3910, .op .XOR, by exact GuardInstructionWindow.get 147, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3911, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 148, by decide⟩,
   ⟨3912, .op .JUMPI, by exact GuardInstructionWindow.get 149, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3913, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 150, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3914, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 151, by decide⟩,
   ⟨3915, .op .MUL, by exact GuardInstructionWindow.get 152, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3916, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 153, by decide⟩,
   ⟨3917, .op .SUB, by exact GuardInstructionWindow.get 154, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3918, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 155, by decide⟩,
   ⟨3919, .op .MSTORE, by exact GuardInstructionWindow.get 156, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3921, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ⟨3922, .op .RETURN, by rfl, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5175
...
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 5248, stack := [UInt256.ofNat 32]}
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5175 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3897 (by exact GuardInstructionWindow.get 134)
  rw [pc_4089] at h
  exact h
private theorem valid_generic : Decode.isValidJumpDest submissionBytecode 351 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 239 (by rfl)
  rw [pc_176] at h
  exact h
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5184) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5184) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5184) =
      some (Execution.atPC input 5200) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5200) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hs : sizeCond input = 0) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3920 .MSIZE
    (by rfl) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3920 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3920 rfl hp .MSIZE none hd rfl
