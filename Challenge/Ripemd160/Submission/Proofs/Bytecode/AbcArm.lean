...
@[simp] theorem pc_176 : Artifact.submissionArtifact.instructionPC 227 = 497 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3886 = 5450 := by
  exact GuardInstructionWindow.pc 234
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3887 = 5451 := by
  exact GuardInstructionWindow.pc 235
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3888 = 5452 := by
  exact GuardInstructionWindow.pc 236
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3889 = 5453 := by
  exact GuardInstructionWindow.pc 237
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3890 = 5454 := by
  exact GuardInstructionWindow.pc 238
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3865 = 5380 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3866 = 5381 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3867 = 5382 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3868 = 5384 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3869 = 5385 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3870 = 5388 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3871 = 5389 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3872 = 5393 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3873 = 5394 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3874 = 5395 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3875 = 5396 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3876 = 5397 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3877 = 5399 := by
  exact GuardInstructionWindow.pc 225
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3878 = 5400 := by
  exact GuardInstructionWindow.pc 226
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3879 = 5401 := by
  exact GuardInstructionWindow.pc 227
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3880 = 5404 := by
  exact GuardInstructionWindow.pc 228
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3881 = 5405 := by
  exact GuardInstructionWindow.pc 229
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3882 = 5406 := by
  exact GuardInstructionWindow.pc 230
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3883 = 5427 := by
  exact GuardInstructionWindow.pc 231
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3884 = 5428 := by
  exact GuardInstructionWindow.pc 232
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3885 = 5449 := by
  exact GuardInstructionWindow.pc 233

def sizePath : List Located :=
  [⟨3865, .op .JUMPDEST, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3866, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 214, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3867, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 215, by decide⟩,
   ⟨3868, .op .SHR, by exact GuardInstructionWindow.get 216, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3869, .push ⟨2, by decide⟩ (UInt256.ofNat 497), by exact GuardInstructionWindow.get 217, by decide⟩,
   ⟨3870, .op .JUMPI, by exact GuardInstructionWindow.get 218, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3871, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 219, by decide⟩,
   ⟨3872, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 220, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3873, .op .MUL, by exact GuardInstructionWindow.get 221, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3874, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 222, by decide⟩,
   ⟨3875, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 223, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3876, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 224, by decide⟩,
   ⟨3877, .op .SHR, by exact GuardInstructionWindow.get 225, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3878, .op .XOR, by exact GuardInstructionWindow.get 226, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3879, .push ⟨2, by decide⟩ (UInt256.ofNat 497), by exact GuardInstructionWindow.get 227, by decide⟩,
   ⟨3880, .op .JUMPI, by exact GuardInstructionWindow.get 228, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3881, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 229, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3882, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 230, by decide⟩,
   ⟨3883, .op .MUL, by exact GuardInstructionWindow.get 231, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3884, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 232, by decide⟩,
   ⟨3885, .op .SUB, by exact GuardInstructionWindow.get 233, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3886, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 234, by decide⟩,
   ⟨3887, .op .MSTORE, by exact GuardInstructionWindow.get 235, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3889, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 237, by decide⟩,
   ⟨3890, .op .RETURN, by exact GuardInstructionWindow.get 238, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5380
def fallbackState (input : ByteArray) : State := Execution.atPC input 497
...
def stored (input : ByteArray) : State :=
  {initialState submissionBytecode input 0 with
    pc := UInt256.ofNat 5452
    memory := answerMemory input
    activeWords := UInt256.ofNat 1}
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 5453, stack := [UInt256.ofNat 32]}
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5380 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3865 (by exact GuardInstructionWindow.get 213)
  rw [pc_4089] at h
  exact h
private theorem valid_generic : Decode.isValidJumpDest submissionBytecode 497 = true := by
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5389) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5389) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5389) =
      some (Execution.atPC input 5405) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5405) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hs : sizeCond input = 0) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3888 .MSIZE
    (by exact GuardInstructionWindow.get 236) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3888 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3888 rfl hp .MSIZE none hd rfl
