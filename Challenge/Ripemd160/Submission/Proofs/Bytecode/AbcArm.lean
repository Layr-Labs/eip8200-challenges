...
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 284 = 447 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3924 = 5159 := by
  exact GuardInstructionWindow.pc 153
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3925 = 5160 := by
  exact GuardInstructionWindow.pc 154
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3926 = 5161 := by
  exact GuardInstructionWindow.pc 155
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3927 = 5163 := by
  exact GuardInstructionWindow.pc 156
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3928 = 5164 := by
  exact GuardInstructionWindow.pc 157
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3929 = 5167 := by
  exact GuardInstructionWindow.pc 158
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3930 = 5168 := by
  exact GuardInstructionWindow.pc 159
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3931 = 5172 := by
  exact GuardInstructionWindow.pc 160
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3932 = 5173 := by
  exact GuardInstructionWindow.pc 161
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3933 = 5174 := by
  exact GuardInstructionWindow.pc 162
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3934 = 5175 := by
  exact GuardInstructionWindow.pc 163
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3935 = 5176 := by
  exact GuardInstructionWindow.pc 164
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3936 = 5178 := by
  exact GuardInstructionWindow.pc 165
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3937 = 5179 := by
  exact GuardInstructionWindow.pc 166
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3938 = 5180 := by
  exact GuardInstructionWindow.pc 167
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3939 = 5183 := by
  exact GuardInstructionWindow.pc 168
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3940 = 5184 := by
  exact GuardInstructionWindow.pc 169
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3941 = 5205 := by
  exact GuardInstructionWindow.pc 170
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3942 = 5206 := by
  exact GuardInstructionWindow.pc 171
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3943 = 5209 := by
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5159
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5168) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5168) =
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5184) = some (stored input) := by
