...
def sizePath : List Located :=
  [⟨3883, .op .JUMPDEST, by exact GuardInstructionWindow.get 162, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3884, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 163, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3885, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 164, by decide⟩,
   ⟨3886, .op .SHR, by exact GuardInstructionWindow.get 165, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3887, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by exact GuardInstructionWindow.get 166, by decide⟩,
   ⟨3888, .op .JUMPI, by exact GuardInstructionWindow.get 167, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3889, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 168, by decide⟩,
   ⟨3890, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 169, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3891, .op .MUL, by exact GuardInstructionWindow.get 170, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3892, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 171, by decide⟩,
   ⟨3893, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 172, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3894, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 173, by decide⟩,
   ⟨3895, .op .SHR, by exact GuardInstructionWindow.get 174, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3896, .op .XOR, by exact GuardInstructionWindow.get 175, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3897, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by exact GuardInstructionWindow.get 176, by decide⟩,
   ⟨3898, .op .JUMPI, by exact GuardInstructionWindow.get 177, ⟨by decide, trivial, rfl⟩⟩]

def storePath : List Located :=
  [⟨3899, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 178, by decide⟩,
   ⟨3900, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 179, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3901, .push ⟨2, by decide⟩ (UInt256.ofNat 354), by exact GuardInstructionWindow.get 180, by decide⟩,
   ⟨3902, .op .JUMP, by exact GuardInstructionWindow.get 181, ⟨by decide, trivial, rfl⟩⟩,
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5153 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3883 (by exact GuardInstructionWindow.get 162)
  rw [pc_4089] at h
  exact h
