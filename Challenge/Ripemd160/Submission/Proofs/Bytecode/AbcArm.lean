...
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 284 = 447 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3921 = 5173 := by
  exact GuardInstructionWindow.pc 150
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3922 = 5174 := by
  exact GuardInstructionWindow.pc 151
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3923 = 5175 := by
  exact GuardInstructionWindow.pc 152
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3924 = 5177 := by
  exact GuardInstructionWindow.pc 153
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3925 = 5178 := by
  exact GuardInstructionWindow.pc 154
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3926 = 5181 := by
  exact GuardInstructionWindow.pc 155
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3927 = 5182 := by
  exact GuardInstructionWindow.pc 156
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3928 = 5186 := by
  exact GuardInstructionWindow.pc 157
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3929 = 5187 := by
  exact GuardInstructionWindow.pc 158
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3930 = 5188 := by
  exact GuardInstructionWindow.pc 159
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3931 = 5189 := by
  exact GuardInstructionWindow.pc 160
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3932 = 5190 := by
  exact GuardInstructionWindow.pc 161
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3933 = 5192 := by
  exact GuardInstructionWindow.pc 162
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3934 = 5193 := by
  exact GuardInstructionWindow.pc 163
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3935 = 5194 := by
  exact GuardInstructionWindow.pc 164
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3936 = 5197 := by
  exact GuardInstructionWindow.pc 165
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3937 = 5198 := by
  exact GuardInstructionWindow.pc 166
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3938 = 5219 := by
  exact GuardInstructionWindow.pc 167
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3939 = 5220 := by
  exact GuardInstructionWindow.pc 168
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3940 = 5223 := by
  exact GuardInstructionWindow.pc 169

def sizePath : List Located :=
  [⟨3921, .op .JUMPDEST, by exact GuardInstructionWindow.get 150, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3922, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 151, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3923, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 152, by decide⟩,
   ⟨3924, .op .SHR, by exact GuardInstructionWindow.get 153, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3925, .push ⟨2, by decide⟩ (UInt256.ofNat 335), by exact GuardInstructionWindow.get 154, by decide⟩,
   ⟨3926, .op .JUMPI, by exact GuardInstructionWindow.get 155, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3927, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 156, by decide⟩,
   ⟨3928, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 157, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3929, .op .MUL, by exact GuardInstructionWindow.get 158, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3930, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 159, by decide⟩,
   ⟨3931, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 160, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3932, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 161, by decide⟩,
   ⟨3933, .op .SHR, by exact GuardInstructionWindow.get 162, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3934, .op .XOR, by exact GuardInstructionWindow.get 163, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3935, .push ⟨2, by decide⟩ (UInt256.ofNat 335), by exact GuardInstructionWindow.get 164, by decide⟩,
   ⟨3936, .op .JUMPI, by exact GuardInstructionWindow.get 165, ⟨by decide, trivial, rfl⟩⟩]

def storePath : List Located :=
  [⟨3937, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 166, by decide⟩,
   ⟨3938, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 167, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3939, .push ⟨2, by decide⟩ (UInt256.ofNat 417), by exact GuardInstructionWindow.get 168, by decide⟩,
   ⟨3940, .op .JUMP, by exact GuardInstructionWindow.get 169, ⟨by decide, trivial, rfl⟩⟩,
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5173
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5173 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3921 (by exact GuardInstructionWindow.get 150)
  rw [pc_4089] at h
  exact h
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5182) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5182) =
      some (Execution.atPC input 5198) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5198) = some (stored input) := by
