...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3842 = 4943 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3843 = 4944 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3844 = 4945 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3845 = 4946 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3846 = 4947 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3827 = 4882 := by
  exact GuardInstructionWindow.pc 203
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3828 = 4886 := by
  exact GuardInstructionWindow.pc 204
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3829 = 4887 := by
  exact GuardInstructionWindow.pc 205
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3830 = 4888 := by
  exact GuardInstructionWindow.pc 206
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3831 = 4889 := by
  exact GuardInstructionWindow.pc 207
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3832 = 4890 := by
  exact GuardInstructionWindow.pc 208
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3833 = 4892 := by
  exact GuardInstructionWindow.pc 209
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3834 = 4893 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3835 = 4894 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3836 = 4897 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3837 = 4898 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3838 = 4899 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3839 = 4920 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3840 = 4921 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3841 = 4942 := by
  exact GuardInstructionWindow.pc 217

def wordPath : List Located :=
  [⟨3827, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 203, by decide⟩,
   ⟨3828, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 204, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3829, .op .MUL, by exact GuardInstructionWindow.get 205, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3830, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 206, by decide⟩,
   ⟨3831, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 207, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3832, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 208, by decide⟩,
   ⟨3833, .op .SHR, by exact GuardInstructionWindow.get 209, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3834, .op .XOR, by exact GuardInstructionWindow.get 210, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3835, .push ⟨2, by decide⟩ (UInt256.ofNat 358), by exact GuardInstructionWindow.get 211, by decide⟩,
   ⟨3836, .op .JUMPI, by exact GuardInstructionWindow.get 212, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3837, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3838, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 214, by decide⟩,
   ⟨3839, .op .MUL, by exact GuardInstructionWindow.get 215, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3840, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 216, by decide⟩,
   ⟨3841, .op .SUB, by exact GuardInstructionWindow.get 217, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3842, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 218, by decide⟩,
   ⟨3843, .op .MSTORE, by exact GuardInstructionWindow.get 219, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3845, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 221, by decide⟩,
   ⟨3846, .op .RETURN, by exact GuardInstructionWindow.get 222, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 4882
...
def stored (input : ByteArray) : State :=
  {initialState submissionBytecode input 0 with
    pc := UInt256.ofNat 4945
    memory := answerMemory input
    activeWords := UInt256.ofNat 1}
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 4946, stack := [UInt256.ofNat 32]}
def returned (input : ByteArray) : State :=
  {stored input with
    pc := UInt256.ofNat 4947
    halt := .Returned
...
theorem run_store (input : ByteArray) :
    DataStepper.runLocatedBlock storePath (Execution.atPC input 4898) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3870 .MSIZE
    (by exact GuardInstructionWindow.get 220) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3844 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3870 rfl hp .MSIZE none hd rfl
