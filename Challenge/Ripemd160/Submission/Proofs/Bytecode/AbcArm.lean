...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3872 = 4967 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3873 = 4968 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3874 = 4969 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3875 = 4970 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3876 = 4971 := by
  exact GuardInstructionWindow.pc 225
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3857 = 4906 := by
  exact GuardInstructionWindow.pc 206
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3858 = 4910 := by
  exact GuardInstructionWindow.pc 207
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3859 = 4911 := by
  exact GuardInstructionWindow.pc 208
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3860 = 4912 := by
  exact GuardInstructionWindow.pc 209
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3861 = 4913 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3862 = 4914 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3863 = 4916 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3864 = 4917 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3865 = 4918 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3866 = 4921 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3867 = 4922 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3868 = 4923 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3869 = 4944 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3870 = 4945 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3871 = 4966 := by
  exact GuardInstructionWindow.pc 220

def wordPath : List Located :=
  [⟨3857, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 206, by decide⟩,
   ⟨3858, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 207, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3859, .op .MUL, by exact GuardInstructionWindow.get 208, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3860, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 209, by decide⟩,
   ⟨3861, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 210, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3862, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 211, by decide⟩,
   ⟨3863, .op .SHR, by exact GuardInstructionWindow.get 212, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3864, .op .XOR, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3865, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 214, by decide⟩,
   ⟨3866, .op .JUMPI, by exact GuardInstructionWindow.get 215, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3867, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 216, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3868, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 217, by decide⟩,
   ⟨3869, .op .MUL, by exact GuardInstructionWindow.get 218, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3870, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 219, by decide⟩,
   ⟨3871, .op .SUB, by exact GuardInstructionWindow.get 220, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3872, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 221, by decide⟩,
   ⟨3873, .op .MSTORE, by exact GuardInstructionWindow.get 222, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3875, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 224, by decide⟩,
   ⟨3876, .op .RETURN, by exact GuardInstructionWindow.get 225, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 4906
