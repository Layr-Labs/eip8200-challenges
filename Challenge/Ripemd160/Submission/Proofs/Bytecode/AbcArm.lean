...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3878 = 4954 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3879 = 4955 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3880 = 4956 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3881 = 4957 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3882 = 4958 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3857 = 4884 := by
  exact GuardInstructionWindow.pc 199
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3858 = 4885 := by
  exact GuardInstructionWindow.pc 200
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3859 = 4886 := by
  exact GuardInstructionWindow.pc 201
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3860 = 4888 := by
  exact GuardInstructionWindow.pc 202
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3861 = 4889 := by
  exact GuardInstructionWindow.pc 203
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3862 = 4892 := by
  exact GuardInstructionWindow.pc 204
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3863 = 4893 := by
  exact GuardInstructionWindow.pc 205
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3864 = 4897 := by
  exact GuardInstructionWindow.pc 206
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3865 = 4898 := by
  exact GuardInstructionWindow.pc 207
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3866 = 4899 := by
  exact GuardInstructionWindow.pc 208
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3867 = 4900 := by
  exact GuardInstructionWindow.pc 209
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3868 = 4901 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3869 = 4903 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3870 = 4904 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3871 = 4905 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3872 = 4908 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3873 = 4909 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3874 = 4910 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3875 = 4931 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3876 = 4932 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3877 = 4953 := by
  exact GuardInstructionWindow.pc 219

def sizePath : List Located :=
  [⟨3857, .op .JUMPDEST, by exact GuardInstructionWindow.get 199, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3858, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 200, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3859, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 201, by decide⟩,
   ⟨3860, .op .SHR, by exact GuardInstructionWindow.get 202, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3861, .push ⟨2, by decide⟩ (UInt256.ofNat 349), by exact GuardInstructionWindow.get 203, by decide⟩,
   ⟨3862, .op .JUMPI, by exact GuardInstructionWindow.get 204, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3863, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 205, by decide⟩,
   ⟨3864, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 206, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3865, .op .MUL, by exact GuardInstructionWindow.get 207, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3866, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 208, by decide⟩,
   ⟨3867, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 209, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3868, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 210, by decide⟩,
   ⟨3869, .op .SHR, by exact GuardInstructionWindow.get 211, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3870, .op .XOR, by exact GuardInstructionWindow.get 212, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3871, .push ⟨2, by decide⟩ (UInt256.ofNat 349), by exact GuardInstructionWindow.get 213, by decide⟩,
   ⟨3872, .op .JUMPI, by exact GuardInstructionWindow.get 214, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3873, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 215, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3874, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 216, by decide⟩,
   ⟨3875, .op .MUL, by exact GuardInstructionWindow.get 217, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3876, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 218, by decide⟩,
   ⟨3877, .op .SUB, by exact GuardInstructionWindow.get 219, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3878, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 220, by decide⟩,
   ⟨3879, .op .MSTORE, by exact GuardInstructionWindow.get 221, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3881, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 223, by decide⟩,
   ⟨3882, .op .RETURN, by exact GuardInstructionWindow.get 224, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 4884
...
def stored (input : ByteArray) : State :=
  {initialState submissionBytecode input 0 with
    pc := UInt256.ofNat 4956
    memory := answerMemory input
    activeWords := UInt256.ofNat 1}
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 4957, stack := [UInt256.ofNat 32]}
def returned (input : ByteArray) : State :=
  {stored input with
    pc := UInt256.ofNat 4958
    halt := .Returned
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 4884 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3857 (by exact GuardInstructionWindow.get 199)
  rw [pc_4089] at h
  exact h
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    DataStepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 4893) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    DataStepper.runLocatedBlock wordPath (Execution.atPC input 4893) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    DataStepper.runLocatedBlock wordPath (Execution.atPC input 4893) =
      some (Execution.atPC input 4909) := by
...
theorem run_store (input : ByteArray) :
    DataStepper.runLocatedBlock storePath (Execution.atPC input 4909) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hs : sizeCond input = 0) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3880 .MSIZE
    (by exact GuardInstructionWindow.get 222) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3880 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3880 rfl hp .MSIZE none hd rfl
