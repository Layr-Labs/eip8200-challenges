...
@[simp] theorem pc_176 : Artifact.submissionArtifact.instructionPC 240 = 351 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3788 = 4948 := by
  exact GuardInstructionWindow.pc 230
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3789 = 4949 := by
  exact GuardInstructionWindow.pc 231
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3790 = 4950 := by
  exact GuardInstructionWindow.pc 232
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3791 = 4951 := by
  exact GuardInstructionWindow.pc 233
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3792 = 4952 := by
  exact GuardInstructionWindow.pc 234
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3773 = 4887 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3774 = 4888 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3775 = 4889 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3776 = 4891 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3777 = 4892 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3778 = 4893 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3779 = 4897 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3780 = 4898 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3781 = 4899 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3782 = 4902 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3783 = 4903 := by
  exact GuardInstructionWindow.pc 225
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3784 = 4924 := by
  exact GuardInstructionWindow.pc 226
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3785 = 4925 := by
  exact GuardInstructionWindow.pc 227
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3786 = 4926 := by
  exact GuardInstructionWindow.pc 228
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3787 = 4947 := by
  exact GuardInstructionWindow.pc 229

def wordPath : List Located :=
  [⟨3773, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 215, by decide⟩,
   ⟨3774, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 216, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3775, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 217, by decide⟩,
   ⟨3776, .op .SHR, by exact GuardInstructionWindow.get 218, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3777, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 219, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3778, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 220, by decide⟩,
   ⟨3779, .op .MUL, by exact GuardInstructionWindow.get 221, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3780, .op .XOR, by exact GuardInstructionWindow.get 222, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3781, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 223, by decide⟩,
   ⟨3782, .op .JUMPI, by exact GuardInstructionWindow.get 224, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3783, .push ⟨20, by decide⟩ (UInt256.ofNat 95383801997447390147238369573240532004699299169), by exact GuardInstructionWindow.get 225, by decide⟩,
   ⟨3784, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 226, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3785, .op .SHR, by exact GuardInstructionWindow.get 227, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3786, .push ⟨20, by decide⟩ (UInt256.ofNat 802931186561056611446976448233794645126013734992), by exact GuardInstructionWindow.get 228, by decide⟩,
   ⟨3787, .op .XOR, by exact GuardInstructionWindow.get 229, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3788, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 230, by decide⟩,
   ⟨3789, .op .MSTORE, by exact GuardInstructionWindow.get 231, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3791, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 233, by decide⟩,
   ⟨3792, .op .RETURN, by exact GuardInstructionWindow.get 234, ⟨by decide, trivial, rfl⟩⟩]
...
private theorem run_word_jump_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
  ...
  · change (UInt256.ofNat 4902).toNat = Artifact.submissionArtifact.instructionPC 3782
    rw [pc_4104]; rfl
...
def gasSteps_hit (input : ByteArray) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3790 .MSIZE
    (by exact GuardInstructionWindow.get 232) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3790 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3790 rfl hp .MSIZE none hd rfl
