...
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3700 = 4874 := by
  exact GuardInstructionWindow.pc 0
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3701 = 4875 := by
  exact GuardInstructionWindow.pc 1
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3702 = 4876 := by
  exact GuardInstructionWindow.pc 2
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3703 = 4878 := by
  exact GuardInstructionWindow.pc 3
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3704 = 4879 := by
  exact GuardInstructionWindow.pc 4
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3705 = 4880 := by
  exact GuardInstructionWindow.pc 5
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3706 = 4884 := by
  exact GuardInstructionWindow.pc 6
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3707 = 4885 := by
  exact GuardInstructionWindow.pc 7
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3708 = 4886 := by
  exact GuardInstructionWindow.pc 8
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3709 = 4889 := by
  exact GuardInstructionWindow.pc 9
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3710 = 4890 := by
  exact GuardInstructionWindow.pc 10
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3711 = 4911 := by
  exact GuardInstructionWindow.pc 11
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3712 = 4912 := by
  exact GuardInstructionWindow.pc 12
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3713 = 4913 := by
  exact GuardInstructionWindow.pc 13
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3714 = 4934 := by
  exact GuardInstructionWindow.pc 14
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3715 = 4935 := by
  exact GuardInstructionWindow.pc 15
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3716 = 4936 := by
  exact GuardInstructionWindow.pc 16
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3717 = 4937 := by
  exact GuardInstructionWindow.pc 17
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3718 = 4938 := by
  exact GuardInstructionWindow.pc 18
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3719 = 4939 := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
  ...
  have hbranch : DataStepper.runLocatedBlock [wordBranch] (wordTested input) = some (fallbackState input) :=
    PatternedScan.blockOfS wordBranch
      (PatternedScan.pcFactS input 3709 4889 [UInt256.ofNat 336, wordCond input] (by norm_num) pc_4104)
