...
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 245 = 403 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3978 = 5129 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3979 = 5130 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3980 = 5131 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3981 = 5133 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3982 = 5134 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3983 = 5137 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3984 = 5138 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3985 = 5142 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3986 = 5143 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3987 = 5144 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3988 = 5145 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3989 = 5146 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3990 = 5148 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3991 = 5149 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3992 = 5150 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3993 = 5153 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3994 = 5154 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3995 = 5175 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3996 = 5176 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3997 = 5179 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl

def sizePath : List Located :=
  [⟨3978, .op .JUMPDEST, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3979, .op .CALLDATASIZE, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3980, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by rfl, by decide⟩,
   ⟨3981, .op .SHR, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3982, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by rfl, by decide⟩,
   ⟨3983, .op .JUMPI, by rfl, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3984, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by rfl, by decide⟩,
   ⟨3985, .op .CALLDATASIZE, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3986, .op .MUL, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3987, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ⟨3988, .op .CALLDATALOAD, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3989, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by rfl, by decide⟩,
   ⟨3990, .op .SHR, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3991, .op .XOR, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3992, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by rfl, by decide⟩,
   ⟨3993, .op .JUMPI, by rfl, ⟨by decide, trivial, rfl⟩⟩]

def storePath : List Located :=
  [⟨3994, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by rfl, by decide⟩,
   ⟨3995, .op .CALLDATASIZE, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3996, .push ⟨2, by decide⟩ (UInt256.ofNat 372), by rfl, by decide⟩,
   ⟨3997, .op .JUMP, by rfl, ⟨by decide, trivial, rfl⟩⟩,
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5129
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5129 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3978 (by rfl)
  rw [pc_4089] at h
  exact h
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5138) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5138) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5138) =
      some (Execution.atPC input 5154) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5154) = some (stored input) := by
