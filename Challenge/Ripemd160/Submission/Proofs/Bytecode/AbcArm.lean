...
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 230 = 385 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3885 = 5142 := by
  exact GuardInstructionWindow.pc 166
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3886 = 5143 := by
  exact GuardInstructionWindow.pc 167
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3887 = 5144 := by
  exact GuardInstructionWindow.pc 168
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3888 = 5146 := by
  exact GuardInstructionWindow.pc 169
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3889 = 5147 := by
  exact GuardInstructionWindow.pc 170
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3890 = 5150 := by
  exact GuardInstructionWindow.pc 171
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3891 = 5151 := by
  exact GuardInstructionWindow.pc 172
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3892 = 5155 := by
  exact GuardInstructionWindow.pc 173
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3893 = 5156 := by
  exact GuardInstructionWindow.pc 174
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3894 = 5157 := by
  exact GuardInstructionWindow.pc 175
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3895 = 5158 := by
  exact GuardInstructionWindow.pc 176
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3896 = 5159 := by
  exact GuardInstructionWindow.pc 177
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3897 = 5161 := by
  exact GuardInstructionWindow.pc 178
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3898 = 5162 := by
  exact GuardInstructionWindow.pc 179
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3899 = 5163 := by
  exact GuardInstructionWindow.pc 180
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3900 = 5166 := by
  exact GuardInstructionWindow.pc 181
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3901 = 5167 := by
  exact GuardInstructionWindow.pc 182
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3902 = 5188 := by
  exact GuardInstructionWindow.pc 183
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3903 = 5189 := by
  exact GuardInstructionWindow.pc 184
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3904 = 5192 := by
  exact GuardInstructionWindow.pc 185

def sizePath : List Located :=
  [⟨3885, .op .JUMPDEST, by exact GuardInstructionWindow.get 166, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3886, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 167, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3887, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 168, by decide⟩,
   ⟨3888, .op .SHR, by exact GuardInstructionWindow.get 169, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3889, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by exact GuardInstructionWindow.get 170, by decide⟩,
   ⟨3890, .op .JUMPI, by exact GuardInstructionWindow.get 171, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3891, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 172, by decide⟩,
   ⟨3892, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 173, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3893, .op .MUL, by exact GuardInstructionWindow.get 174, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3894, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 175, by decide⟩,
   ⟨3895, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 176, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3896, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 177, by decide⟩,
   ⟨3897, .op .SHR, by exact GuardInstructionWindow.get 178, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3898, .op .XOR, by exact GuardInstructionWindow.get 179, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3899, .push ⟨2, by decide⟩ (UInt256.ofNat 272), by exact GuardInstructionWindow.get 180, by decide⟩,
   ⟨3900, .op .JUMPI, by exact GuardInstructionWindow.get 181, ⟨by decide, trivial, rfl⟩⟩]

def storePath : List Located :=
  [⟨3901, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 182, by decide⟩,
   ⟨3902, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 183, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3903, .push ⟨2, by decide⟩ (UInt256.ofNat 354), by exact GuardInstructionWindow.get 184, by decide⟩,
   ⟨3904, .op .JUMP, by exact GuardInstructionWindow.get 185, ⟨by decide, trivial, rfl⟩⟩,
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5142
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5142 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3885 (by exact GuardInstructionWindow.get 166)
  rw [pc_4089] at h
  exact h
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5151) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5151) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5151) =
      some (Execution.atPC input 5167) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5167) = some (stored input) := by
