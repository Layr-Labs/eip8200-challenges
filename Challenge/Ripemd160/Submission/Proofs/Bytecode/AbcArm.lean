...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3803 = 4948 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3804 = 4949 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3805 = 4950 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3806 = 4951 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3807 = 4952 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3788 = 4887 := by
  exact GuardInstructionWindow.pc 204
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3789 = 4888 := by
  exact GuardInstructionWindow.pc 205
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3790 = 4889 := by
  exact GuardInstructionWindow.pc 206
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3791 = 4891 := by
  exact GuardInstructionWindow.pc 207
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3792 = 4892 := by
  exact GuardInstructionWindow.pc 208
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3793 = 4893 := by
  exact GuardInstructionWindow.pc 209
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3794 = 4897 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3795 = 4898 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3796 = 4899 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3797 = 4902 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3798 = 4903 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3799 = 4904 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3800 = 4925 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3801 = 4926 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3802 = 4947 := by
...
def wordPath : List Located :=
  [⟨3788, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 204, by decide⟩,
   ...
   ⟨3792, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 208, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3793, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 209, by decide⟩,
   ⟨3794, .op .MUL, by exact GuardInstructionWindow.get 210, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3795, .op .XOR, by exact GuardInstructionWindow.get 211, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3796, .push ⟨2, by decide⟩ (UInt256.ofNat 354), by exact GuardInstructionWindow.get 212, by decide⟩,
   ⟨3797, .op .JUMPI, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3798, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 214, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3799, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 215, by decide⟩,
   ⟨3800, .op .MUL, by exact GuardInstructionWindow.get 216, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3801, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 217, by decide⟩,
   ⟨3802, .op .SUB, by exact GuardInstructionWindow.get 218, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3803, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 219, by decide⟩,
   ⟨3804, .op .MSTORE, by exact GuardInstructionWindow.get 220, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3806, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 222, by decide⟩,
   ⟨3807, .op .RETURN, by exact GuardInstructionWindow.get 223, ⟨by decide, trivial, rfl⟩⟩]
...
def gasSteps_hit (input : ByteArray) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3805 .MSIZE
    (by exact GuardInstructionWindow.get 221) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3805 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3805 rfl hp .MSIZE none hd rfl
