...
@[simp] theorem pc_176 : Artifact.submissionArtifact.instructionPC 242 = 353 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3811 = 4914 := by
  exact GuardInstructionWindow.pc 225
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3812 = 4915 := by
  exact GuardInstructionWindow.pc 226
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3813 = 4916 := by
  exact GuardInstructionWindow.pc 227
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3814 = 4917 := by
  exact GuardInstructionWindow.pc 228
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3815 = 4918 := by
  exact GuardInstructionWindow.pc 229
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3796 = 4853 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3797 = 4854 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3798 = 4855 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3799 = 4857 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3800 = 4858 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3801 = 4859 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3802 = 4863 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3803 = 4864 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3804 = 4865 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3805 = 4868 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3806 = 4869 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3807 = 4870 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3808 = 4891 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3809 = 4892 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3810 = 4913 := by
  exact GuardInstructionWindow.pc 224

def wordPath : List Located :=
  [⟨3796, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 210, by decide⟩,
   ⟨3797, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 211, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3798, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 212, by decide⟩,
   ⟨3799, .op .SHR, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3800, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 214, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3801, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 215, by decide⟩,
   ⟨3802, .op .MUL, by exact GuardInstructionWindow.get 216, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3803, .op .XOR, by exact GuardInstructionWindow.get 217, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3804, .push ⟨2, by decide⟩ (UInt256.ofNat 353), by exact GuardInstructionWindow.get 218, by decide⟩,
   ⟨3805, .op .JUMPI, by exact GuardInstructionWindow.get 219, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3806, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 220, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3807, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 221, by decide⟩,
   ⟨3808, .op .MUL, by exact GuardInstructionWindow.get 222, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3809, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 223, by decide⟩,
   ⟨3810, .op .SUB, by exact GuardInstructionWindow.get 224, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3811, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 225, by decide⟩,
   ⟨3812, .op .MSTORE, by exact GuardInstructionWindow.get 226, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3814, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 228, by decide⟩,
   ⟨3815, .op .RETURN, by exact GuardInstructionWindow.get 229, ⟨by decide, trivial, rfl⟩⟩]
...
def fallbackState (input : ByteArray) : State := Execution.atPC input 353
...
private theorem valid_generic : Decode.isValidJumpDest submissionBytecode 353 = true := by
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    DataStepper.runLocatedBlock wordPath (armEntry input) =
      some (Execution.atPC input 4869) := by
...
def gasSteps_hit (input : ByteArray) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3813 .MSIZE
    (by exact GuardInstructionWindow.get 227) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3813 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3813 rfl hp .MSIZE none hd rfl
