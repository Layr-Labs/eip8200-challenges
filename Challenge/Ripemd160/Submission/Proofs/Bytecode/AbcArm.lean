...
@[simp] theorem pc_176 : Artifact.submissionArtifact.instructionPC 243 = 355 := by
...
def wordPath : List Located :=
  [⟨3764, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 201, by decide⟩,
   ...
   ⟨3772, .push ⟨2, by decide⟩ (UInt256.ofNat 355), by exact GuardInstructionWindow.get 209, by decide⟩,
...
def fallbackState (input : ByteArray) : State := Execution.atPC input 355
...
private theorem valid_generic : Decode.isValidJumpDest submissionBytecode 355 = true := by
