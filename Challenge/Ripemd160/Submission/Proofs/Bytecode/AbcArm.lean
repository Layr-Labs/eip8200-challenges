...
@[simp] theorem pc_176 : Artifact.submissionArtifact.instructionPC 226 = 329 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_236 : Artifact.submissionArtifact.instructionPC 269 = 411 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_237 : Artifact.submissionArtifact.instructionPC 270 = 412 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_238 : Artifact.submissionArtifact.instructionPC 271 = 433 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_239 : Artifact.submissionArtifact.instructionPC 272 = 434 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_240 : Artifact.submissionArtifact.instructionPC 273 = 435 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 274 = 436 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 275 = 437 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 276 = 438 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 277 = 439 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 278 = 440 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3900 = 5197 := by
  exact GuardInstructionWindow.pc 147
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3901 = 5198 := by
  exact GuardInstructionWindow.pc 148
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3902 = 5199 := by
  exact GuardInstructionWindow.pc 149
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3903 = 5201 := by
  exact GuardInstructionWindow.pc 150
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3904 = 5202 := by
  exact GuardInstructionWindow.pc 151
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3905 = 5205 := by
  exact GuardInstructionWindow.pc 152
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3906 = 5206 := by
  exact GuardInstructionWindow.pc 153
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3907 = 5210 := by
  exact GuardInstructionWindow.pc 154
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3908 = 5211 := by
  exact GuardInstructionWindow.pc 155
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3909 = 5212 := by
  exact GuardInstructionWindow.pc 156
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3910 = 5213 := by
  exact GuardInstructionWindow.pc 157
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3911 = 5214 := by
  exact GuardInstructionWindow.pc 158
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3912 = 5216 := by
  exact GuardInstructionWindow.pc 159
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3913 = 5217 := by
  exact GuardInstructionWindow.pc 160
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3914 = 5218 := by
  exact GuardInstructionWindow.pc 161
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3915 = 5221 := by
  exact GuardInstructionWindow.pc 162
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3916 = 5222 := by
  exact GuardInstructionWindow.pc 163
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3917 = 5243 := by
  exact GuardInstructionWindow.pc 164
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3918 = 5244 := by
  exact GuardInstructionWindow.pc 165
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3919 = 5247 := by
  exact GuardInstructionWindow.pc 166

def sizePath : List Located :=
  [⟨3900, .op .JUMPDEST, by exact GuardInstructionWindow.get 147, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3901, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 148, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3902, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 149, by decide⟩,
   ⟨3903, .op .SHR, by exact GuardInstructionWindow.get 150, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3904, .push ⟨2, by decide⟩ (UInt256.ofNat 329), by exact GuardInstructionWindow.get 151, by decide⟩,
   ⟨3905, .op .JUMPI, by exact GuardInstructionWindow.get 152, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3906, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 153, by decide⟩,
   ⟨3907, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 154, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3908, .op .MUL, by exact GuardInstructionWindow.get 155, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3909, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 156, by decide⟩,
   ⟨3910, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 157, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3911, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 158, by decide⟩,
   ⟨3912, .op .SHR, by exact GuardInstructionWindow.get 159, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3913, .op .XOR, by exact GuardInstructionWindow.get 160, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3914, .push ⟨2, by decide⟩ (UInt256.ofNat 329), by exact GuardInstructionWindow.get 161, by decide⟩,
   ⟨3915, .op .JUMPI, by exact GuardInstructionWindow.get 162, ⟨by decide, trivial, rfl⟩⟩]

def storePath : List Located :=
  [⟨3916, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 163, by decide⟩,
   ⟨3917, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 164, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3918, .push ⟨2, by decide⟩ (UInt256.ofNat 411), by exact GuardInstructionWindow.get 165, by decide⟩,
   ⟨3919, .op .JUMP, by exact GuardInstructionWindow.get 166, ⟨by decide, trivial, rfl⟩⟩,
   ⟨269, .op .JUMPDEST, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ...
   ⟨272, .op (.Swap ⟨0, by decide⟩), by rfl, ⟨by decide, trivial, rfl⟩⟩,
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5197
...
def stored (input : ByteArray) : State :=
  {initialState submissionBytecode input 0 with
    pc := UInt256.ofNat 438
    memory := answerMemory input
    activeWords := UInt256.ofNat 1}
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 439, stack := [UInt256.ofNat 32]}
def returned (input : ByteArray) : State :=
  {stored input with
    pc := UInt256.ofNat 440
    halt := .Returned
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5197 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3900 (by exact GuardInstructionWindow.get 147)
  rw [pc_4089] at h
  exact h
private theorem valid_generic : Decode.isValidJumpDest submissionBytecode 329 = true := by
  ...
  rw [pc_176] at h
  exact h
private theorem valid_return : Decode.isValidJumpDest submissionBytecode 411 = true := by
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5206) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5206) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5206) =
      some (Execution.atPC input 5222) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5222) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hs : sizeCond input = 0) (hw : wordCond input = 0) :
  ...
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 276 rfl hp .MSIZE none hd rfl
