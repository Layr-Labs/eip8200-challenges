...
@[simp] theorem pc_176 : Artifact.submissionArtifact.instructionPC 228 = 331 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_236 : Artifact.submissionArtifact.instructionPC 273 = 413 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_237 : Artifact.submissionArtifact.instructionPC 274 = 414 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_238 : Artifact.submissionArtifact.instructionPC 275 = 436 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_239 : Artifact.submissionArtifact.instructionPC 276 = 437 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_240 : Artifact.submissionArtifact.instructionPC 277 = 438 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 278 = 439 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 279 = 440 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 280 = 441 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 281 = 442 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 282 = 443 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3933 = 5108 := by
  exact GuardInstructionWindow.pc 156
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3934 = 5109 := by
  exact GuardInstructionWindow.pc 157
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3935 = 5110 := by
  exact GuardInstructionWindow.pc 158
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3936 = 5112 := by
  exact GuardInstructionWindow.pc 159
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3937 = 5113 := by
  exact GuardInstructionWindow.pc 160
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3938 = 5116 := by
  exact GuardInstructionWindow.pc 161
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3939 = 5117 := by
  exact GuardInstructionWindow.pc 162
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3940 = 5121 := by
  exact GuardInstructionWindow.pc 163
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3941 = 5122 := by
  exact GuardInstructionWindow.pc 164
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3942 = 5123 := by
  exact GuardInstructionWindow.pc 165
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3943 = 5124 := by
  exact GuardInstructionWindow.pc 166
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3944 = 5125 := by
  exact GuardInstructionWindow.pc 167
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3945 = 5127 := by
  exact GuardInstructionWindow.pc 168
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3946 = 5128 := by
  exact GuardInstructionWindow.pc 169
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3947 = 5129 := by
  exact GuardInstructionWindow.pc 170
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3948 = 5132 := by
  exact GuardInstructionWindow.pc 171
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3949 = 5133 := by
  exact GuardInstructionWindow.pc 172
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3950 = 5154 := by
  exact GuardInstructionWindow.pc 173
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3951 = 5155 := by
  exact GuardInstructionWindow.pc 174
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3952 = 5158 := by
  exact GuardInstructionWindow.pc 175

def sizePath : List Located :=
  [⟨3933, .op .JUMPDEST, by exact GuardInstructionWindow.get 156, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3934, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 157, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3935, .push ⟨1, by decide⟩ (UInt256.ofNat 2), by exact GuardInstructionWindow.get 158, by decide⟩,
   ⟨3936, .op .SHR, by exact GuardInstructionWindow.get 159, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3937, .push ⟨2, by decide⟩ (UInt256.ofNat 331), by exact GuardInstructionWindow.get 160, by decide⟩,
   ⟨3938, .op .JUMPI, by exact GuardInstructionWindow.get 161, ⟨by decide, trivial, rfl⟩⟩]

def wordPath : List Located :=
  [⟨3939, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 162, by decide⟩,
   ⟨3940, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 163, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3941, .op .MUL, by exact GuardInstructionWindow.get 164, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3942, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 165, by decide⟩,
   ⟨3943, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 166, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3944, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 167, by decide⟩,
   ⟨3945, .op .SHR, by exact GuardInstructionWindow.get 168, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3946, .op .XOR, by exact GuardInstructionWindow.get 169, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3947, .push ⟨2, by decide⟩ (UInt256.ofNat 331), by exact GuardInstructionWindow.get 170, by decide⟩,
   ⟨3948, .op .JUMPI, by exact GuardInstructionWindow.get 171, ⟨by decide, trivial, rfl⟩⟩]

def storePath : List Located :=
  [⟨3949, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 172, by decide⟩,
   ⟨3950, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 173, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3951, .push ⟨2, by decide⟩ (UInt256.ofNat 413), by exact GuardInstructionWindow.get 174, by decide⟩,
   ⟨3952, .op .JUMP, by exact GuardInstructionWindow.get 175, ⟨by decide, trivial, rfl⟩⟩,
   ⟨273, .op .JUMPDEST, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨274, .push ⟨21, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by rfl, by decide⟩,
   ⟨275, .op .MUL, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨276, .op (.Swap ⟨0, by decide⟩), by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨277, .op .SUB, by rfl, ⟨by decide, trivial, rfl⟩⟩,
   ⟨278, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ⟨279, .op .MSTORE, by rfl, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨281, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by rfl, by decide⟩,
   ⟨282, .op .RETURN, by rfl, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 5112
...
def stored (input : ByteArray) : State :=
  {initialState submissionBytecode input 0 with
    pc := UInt256.ofNat 441
    memory := answerMemory input
    activeWords := UInt256.ofNat 1}
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 442, stack := [UInt256.ofNat 32]}
def returned (input : ByteArray) : State :=
  {stored input with
    pc := UInt256.ofNat 443
    halt := .Returned
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5112 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 3933 (by exact GuardInstructionWindow.get 156)
  rw [pc_4089] at h
  exact h
private theorem valid_generic : Decode.isValidJumpDest submissionBytecode 335 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 228 (by rfl)
  rw [pc_176] at h
  exact h
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    Stepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 5121) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5121) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    Stepper.runLocatedBlock wordPath (Execution.atPC input 5121) =
      some (Execution.atPC input 5137) := by
...
theorem run_store (input : ByteArray) :
    Stepper.runLocatedBlock storePath (Execution.atPC input 5137) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hs : sizeCond input = 0) (hw : wordCond input = 0) :
  ...
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 280 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 280 rfl hp .MSIZE none hd rfl
