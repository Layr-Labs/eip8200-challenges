...
theorem pcArm : Artifact.submissionArtifact.instructionPC 4078 = 5163 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5163 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 4078 (by rfl)
  rw [pcArm] at h
  exact h
...
def armEntry (input : ByteArray) : State := PatternedScan.stS input 5163 []

def sizePath : List Located :=
  [opAt 4078 .JUMPDEST, opAt 4079 .CALLDATASIZE, pushAt 4080 1 3, opAt 4081 .SUB, pushAt 4082 2 268]

theorem run_size (input : ByteArray) :
    run sizePath (armEntry input) =
      some (PatternedScan.stS input 5171 [268, sizeCond input]) := by
  let sz := UInt256.ofNat input.size
  let l0 : Located := opAt 4078 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4078 5163 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 5163 [] (by simp) (by norm_num))
  let l1 : Located := opAt 4079 .CALLDATASIZE
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4079 5164 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldatasize input 5164 [] (by simp) (by norm_num))
  let l2 : Located := pushAt 4080 1 3
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4080 5165 [sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5165 1 3 [sz] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := opAt 4081 .SUB
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4081 5167 [3, sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_sub input 5167 3 sz [] (by simp) (by norm_num))
  let l4 : Located := pushAt 4082 2 268
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4082 5168 [sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5168 2 268 [sizeCond input] (by simp) (by decide) (by decide) (by norm_num))
...
theorem run_size_miss (input : ByteArray) (hc : UInt256.isTrue (sizeCond input)) :
    run [opAt 4083 .JUMPI] (PatternedScan.stS input 5171 [268, sizeCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4083 .JUMPI)
    (PatternedScan.pcFactS input 4083 5171 [268, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5171 268 268 (sizeCond input) []
...
theorem run_size_pass (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeCond input)) :
    run [opAt 4083 .JUMPI] (PatternedScan.stS input 5171 [268, sizeCond input]) =
      some (PatternedScan.stS input 5172 []) :=
  PatternedScan.blockOfS (opAt 4083 .JUMPI)
    (PatternedScan.pcFactS input 4083 5171 [268, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5171 268 (sizeCond input) []
...
def wordPath : List Located :=
  [pushAt 4084 3 6382179, pushAt 4085 1 232, opAt 4086 .SHL, pushAt 4087 0 0, opAt 4088 .CALLDATALOAD,
   opAt 4089 .XOR, pushAt 4090 2 268]

theorem run_word (input : ByteArray) :
    run wordPath (PatternedScan.stS input 5172 []) =
      some (PatternedScan.stS input 5185 [268, wordCond input]) := by
  let w := MachineState.readWord input 0
  let abcW := UInt256.shiftLeft 6382179 232
  let l0 : Located := pushAt 4084 3 6382179
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4084 5172 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5172 3 6382179 [] (by simp) (by decide) (by decide) (by norm_num))
  let l1 : Located := pushAt 4085 1 232
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4085 5176 [6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5176 1 232 [6382179] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := opAt 4086 .SHL
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4086 5178 [232, 6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shl input 5178 232 6382179 [] (by simp) (by norm_num))
  let l3 : Located := pushAt 4087 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4087 5179 [abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 5179 [abcW] (by simp) (by norm_num))
  let l4 : Located := opAt 4088 .CALLDATALOAD
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4088 5180 [0, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 5180 0 [abcW] (by simp) (by norm_num))
  let l5 : Located := opAt 4089 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4089 5181 [w, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 5181 w abcW [] (by simp) (by norm_num))
  let l6 : Located := pushAt 4090 2 268
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4090 5182 [wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5182 2 268 [wordCond input] (by simp) (by decide) (by decide) (by norm_num))
  have s1 := Stepper.runLocatedBlock_append [l0] [l1] _ _ _ h0 rfl h1
  have s2 := Stepper.runLocatedBlock_append [l0, l1] [l2] _ _ _ s1 rfl h2
  have s3 := Stepper.runLocatedBlock_append [l0, l1, l2] [l3] _ _ _ s2 rfl h3
  have s4 := Stepper.runLocatedBlock_append [l0, l1, l2, l3] [l4] _ _ _ s3 rfl h4
...
theorem run_word_miss (input : ByteArray) (hc : UInt256.isTrue (wordCond input)) :
    run [opAt 4091 .JUMPI] (PatternedScan.stS input 5185 [268, wordCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4091 .JUMPI)
    (PatternedScan.pcFactS input 4091 5185 [268, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5185 268 268 (wordCond input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 268) hc generic_dest)

theorem run_word_hit (input : ByteArray) (hc : ¬ UInt256.isTrue (wordCond input)) :
    run [opAt 4091 .JUMPI] (PatternedScan.stS input 5185 [268, wordCond input]) =
      some (PatternedScan.stS input 5186 []) :=
  PatternedScan.blockOfS (opAt 4091 .JUMPI)
    (PatternedScan.pcFactS input 4091 5185 [268, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5185 268 (wordCond input) []
      (by simp) (by norm_num) hc)
...
def storedState (input : ByteArray) : State :=
  { initialState submissionBytecode input 0 with
    pc := UInt256.ofNat 5209
    memory := answerMemory
    activeWords := UInt256.ofNat 1 }

def sizedState (input : ByteArray) : State :=
  { storedState input with pc := UInt256.ofNat 5210, stack := [UInt256.ofNat 32] }
...
def storePath : List Located :=
  [pushAt 4092 20 814647003348588794217809277549781461204094028796, pushAt 4093 0 0, opAt 4094 .MSTORE]

def finishPath : List Located :=
  [pushAt 4096 0 0, opAt 4097 .RETURN]

@[simp] theorem pcRet0 : Artifact.submissionArtifact.instructionPC 4092 = 5186 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet1 : Artifact.submissionArtifact.instructionPC 4093 = 5207 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet2 : Artifact.submissionArtifact.instructionPC 4094 = 5208 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet3 : Artifact.submissionArtifact.instructionPC 4095 = 5209 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet4 : Artifact.submissionArtifact.instructionPC 4096 = 5210 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet5 : Artifact.submissionArtifact.instructionPC 4097 = 5211 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem run_store (input : ByteArray) :
    run storePath (PatternedScan.stS input 5186 []) = some (storedState input) := by
...
def gasSteps_msize (input : ByteArray) : GasSteps (storedState input) (sizedState input) := by
  have hd := Artifact.submissionArtifact.decodeAt_op_index 4095 .MSIZE
    (by rfl) (by decide) trivial
  have hp : (storedState input).pc.toNat = Artifact.submissionArtifact.instructionPC 4095 := by
    rw [pcRet3]; rfl
  have hop : (storedState input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (storedState input) 4095
