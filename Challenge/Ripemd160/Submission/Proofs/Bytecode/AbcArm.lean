...
def wordPath : List Located :=
  [pushAt 4097 3 6382179, pushAt 4098 1 232, opAt 4099 .SHL, pushAt 4100 0 0, opAt 4101 .CALLDATALOAD,
   opAt 4102 .XOR, pushAt 4103 2 272]
...
theorem run_word (input : ByteArray) :
  ...
  let l0 : Located := pushAt 4097 3 6382179
  have h0 := PatternedScan.blockOfS l0
  ...
  let l1 : Located := pushAt 4098 1 232
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4098 5170 [6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5170 1 232 [6382179] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := opAt 4099 .SHL
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4099 5172 [232, 6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shl input 5172 232 6382179 [] (by simp) (by norm_num))
  let l3 : Located := pushAt 4100 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4100 5173 [abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 5173 [abcW] (by simp) (by norm_num))
  let l4 : Located := opAt 4101 .CALLDATALOAD
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4101 5174 [0, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 5174 0 [abcW] (by simp) (by norm_num))
  let l5 : Located := opAt 4102 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4102 5175 [w, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 5175 w abcW [] (by simp) (by norm_num))
  let l6 : Located := pushAt 4103 2 272
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4103 5176 [wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
theorem run_word_miss (input : ByteArray) (hc : UInt256.isTrue (wordCond input)) :
    run [opAt 4104 .JUMPI] (PatternedScan.stS input 5179 [272, wordCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4104 .JUMPI)
    (PatternedScan.pcFactS input 4104 5179 [272, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
...
def storePath : List Located :=
  [pushAt 4105 20 814647003348588794217809277549781461204094028796, pushAt 4106 0 0, opAt 4107 .MSTORE]

def finishPath : List Located :=
  [pushAt 4109 0 0, opAt 4110 .RETURN]

@[simp] theorem pcRet0 : Artifact.submissionArtifact.instructionPC 4105 = 5180 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet1 : Artifact.submissionArtifact.instructionPC 4106 = 5201 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet2 : Artifact.submissionArtifact.instructionPC 4107 = 5202 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet3 : Artifact.submissionArtifact.instructionPC 4108 = 5203 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet4 : Artifact.submissionArtifact.instructionPC 4109 = 5204 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet5 : Artifact.submissionArtifact.instructionPC 4110 = 5205 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
def gasSteps_msize (input : ByteArray) : GasSteps (storedState input) (sizedState input) := by
  have hd := Artifact.submissionArtifact.decodeAt_op_index 4108 .MSIZE
    (by rfl) (by decide) trivial
  have hp : (storedState input).pc.toNat = Artifact.submissionArtifact.instructionPC 4108 := by
    rw [pcRet3]; rfl
  have hop : (storedState input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (storedState input) 4108
