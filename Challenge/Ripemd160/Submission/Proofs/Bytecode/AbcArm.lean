...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3877 = 4959 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3878 = 4960 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3879 = 4961 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3880 = 4962 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3881 = 4963 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_4089 : Artifact.submissionArtifact.instructionPC 3856 = 4889 := by
  exact GuardInstructionWindow.pc 199
@[simp] theorem pc_4090 : Artifact.submissionArtifact.instructionPC 3857 = 4890 := by
  exact GuardInstructionWindow.pc 200
@[simp] theorem pc_4091 : Artifact.submissionArtifact.instructionPC 3858 = 4891 := by
  exact GuardInstructionWindow.pc 201
@[simp] theorem pc_4092 : Artifact.submissionArtifact.instructionPC 3859 = 4893 := by
  exact GuardInstructionWindow.pc 202
@[simp] theorem pc_4093 : Artifact.submissionArtifact.instructionPC 3860 = 4894 := by
  exact GuardInstructionWindow.pc 203
@[simp] theorem pc_4094 : Artifact.submissionArtifact.instructionPC 3861 = 4897 := by
  exact GuardInstructionWindow.pc 204
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3862 = 4898 := by
  exact GuardInstructionWindow.pc 205
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3863 = 4902 := by
  exact GuardInstructionWindow.pc 206
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3864 = 4903 := by
  exact GuardInstructionWindow.pc 207
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3865 = 4904 := by
  exact GuardInstructionWindow.pc 208
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3866 = 4905 := by
  exact GuardInstructionWindow.pc 209
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3867 = 4906 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3868 = 4908 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3869 = 4909 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3870 = 4910 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3871 = 4913 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3872 = 4914 := by
  exact GuardInstructionWindow.pc 215
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3873 = 4915 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3874 = 4936 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3875 = 4937 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3876 = 4958 := by
...
def sizePath : List Located :=
  [⟨3856, .op .JUMPDEST, by exact GuardInstructionWindow.get 199, ⟨by decide, trivial, rfl⟩⟩,
   ...
   ⟨3860, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 203, by decide⟩,
...
def wordPath : List Located :=
  [⟨3862, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 205, by decide⟩,
   ...
   ⟨3870, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 213, by decide⟩,
...
def armEntry (input : ByteArray) : State := Execution.atPC input 4889
...
def stored (input : ByteArray) : State :=
  {initialState submissionBytecode input 0 with
    pc := UInt256.ofNat 4961
    memory := answerMemory input
    activeWords := UInt256.ofNat 1}
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 4962, stack := [UInt256.ofNat 32]}
def returned (input : ByteArray) : State :=
  {stored input with
    pc := UInt256.ofNat 4963
    halt := .Returned
...
theorem arm_dest : Decode.isValidJumpDest submissionBytecode 4889 = true := by
...
theorem run_small (input : ByteArray) (hm : sizeCond input = 0) :
    DataStepper.runLocatedBlock sizePath (armEntry input) =
      some (Execution.atPC input 4898) := by
...
theorem run_word_miss (input : ByteArray) (hm : wordCond input ≠ 0) :
    DataStepper.runLocatedBlock wordPath (Execution.atPC input 4898) =
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    DataStepper.runLocatedBlock wordPath (Execution.atPC input 4898) =
      some (Execution.atPC input 4914) := by
...
theorem run_store (input : ByteArray) :
    DataStepper.runLocatedBlock storePath (Execution.atPC input 4914) = some (stored input) := by
