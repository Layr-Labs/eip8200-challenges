...
theorem pcArm : Artifact.submissionArtifact.instructionPC 4080 = 5180 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5180 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 4080 (by rfl)
  rw [pcArm] at h
  exact h
...
def armEntry (input : ByteArray) : State := PatternedScan.stS input 5180 []

def sizePath : List Located :=
  [opAt 4080 .JUMPDEST, opAt 4081 .CALLDATASIZE, pushAt 4082 1 3, opAt 4083 .SUB, pushAt 4084 2 268]

theorem run_size (input : ByteArray) :
    run sizePath (armEntry input) =
      some (PatternedScan.stS input 5188 [268, sizeCond input]) := by
  let sz := UInt256.ofNat input.size
  let l0 : Located := opAt 4080 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4080 5180 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 5180 [] (by simp) (by norm_num))
  let l1 : Located := opAt 4081 .CALLDATASIZE
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4081 5181 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldatasize input 5181 [] (by simp) (by norm_num))
  let l2 : Located := pushAt 4082 1 3
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4082 5182 [sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5182 1 3 [sz] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := opAt 4083 .SUB
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4083 5184 [3, sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_sub input 5184 3 sz [] (by simp) (by norm_num))
  let l4 : Located := pushAt 4084 2 268
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4084 5185 [sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5185 2 268 [sizeCond input] (by simp) (by decide) (by decide) (by norm_num))
...
theorem run_size_miss (input : ByteArray) (hc : UInt256.isTrue (sizeCond input)) :
    run [opAt 4085 .JUMPI] (PatternedScan.stS input 5188 [268, sizeCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4085 .JUMPI)
    (PatternedScan.pcFactS input 4085 5188 [268, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5188 268 268 (sizeCond input) []
...
theorem run_size_pass (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeCond input)) :
    run [opAt 4085 .JUMPI] (PatternedScan.stS input 5188 [268, sizeCond input]) =
      some (PatternedScan.stS input 5189 []) :=
  PatternedScan.blockOfS (opAt 4085 .JUMPI)
    (PatternedScan.pcFactS input 4085 5188 [268, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5188 268 (sizeCond input) []
...
def wordPath : List Located :=
  [pushAt 4086 3 6382179, pushAt 4087 1 232, opAt 4088 .SHL, pushAt 4089 0 0, opAt 4090 .CALLDATALOAD,
   opAt 4091 .XOR, pushAt 4092 2 268]

theorem run_word (input : ByteArray) :
    run wordPath (PatternedScan.stS input 5189 []) =
      some (PatternedScan.stS input 5202 [268, wordCond input]) := by
  let w := MachineState.readWord input 0
  let abcW := UInt256.shiftLeft 6382179 232
  let l0 : Located := pushAt 4086 3 6382179
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4086 5189 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5189 3 6382179 [] (by simp) (by decide) (by decide) (by norm_num))
  let l1 : Located := pushAt 4087 1 232
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4087 5193 [6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5193 1 232 [6382179] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := opAt 4088 .SHL
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4088 5195 [232, 6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shl input 5195 232 6382179 [] (by simp) (by norm_num))
  let l3 : Located := pushAt 4089 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4089 5196 [abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 5196 [abcW] (by simp) (by norm_num))
  let l4 : Located := opAt 4090 .CALLDATALOAD
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4090 5197 [0, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 5197 0 [abcW] (by simp) (by norm_num))
  let l5 : Located := opAt 4091 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4091 5198 [w, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 5198 w abcW [] (by simp) (by norm_num))
  let l6 : Located := pushAt 4092 2 268
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4092 5199 [wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5199 2 268 [wordCond input] (by simp) (by decide) (by decide) (by norm_num))
  have s1 := Stepper.runLocatedBlock_append [l0] [l1] _ _ _ h0 rfl h1
  have s2 := Stepper.runLocatedBlock_append [l0, l1] [l2] _ _ _ s1 rfl h2
  have s3 := Stepper.runLocatedBlock_append [l0, l1, l2] [l3] _ _ _ s2 rfl h3
  have s4 := Stepper.runLocatedBlock_append [l0, l1, l2, l3] [l4] _ _ _ s3 rfl h4
...
theorem run_word_miss (input : ByteArray) (hc : UInt256.isTrue (wordCond input)) :
    run [opAt 4093 .JUMPI] (PatternedScan.stS input 5202 [268, wordCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4093 .JUMPI)
    (PatternedScan.pcFactS input 4093 5202 [268, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5202 268 268 (wordCond input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 268) hc generic_dest)
...
theorem run_word_hit (input : ByteArray) (hc : ¬ UInt256.isTrue (wordCond input)) :
  ...
  PatternedScan.blockOfS (opAt 4093 .JUMPI)
    (PatternedScan.pcFactS input 4093 5202 [268, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5202 268 (wordCond input) []
      (by simp) (by norm_num) hc)
...
def sizedState (input : ByteArray) : State :=
  { storedState input with pc := UInt256.ofNat 5227, stack := [UInt256.ofNat 32] }

def returnedState (input : ByteArray) : State :=
  { storedState input with
    pc := UInt256.ofNat 5228
    halt := .Returned
    hReturn := MachineState.readPadded answerMemory 0 32 }

def storePath : List Located :=
  [pushAt 4094 20 814647003348588794217809277549781461204094028796, pushAt 4095 0 0, opAt 4096 .MSTORE]

def finishPath : List Located :=
  [pushAt 4098 0 0, opAt 4099 .RETURN]

@[simp] theorem pcRet0 : Artifact.submissionArtifact.instructionPC 4094 = 5203 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet1 : Artifact.submissionArtifact.instructionPC 4095 = 5224 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet2 : Artifact.submissionArtifact.instructionPC 4096 = 5225 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet3 : Artifact.submissionArtifact.instructionPC 4097 = 5226 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet4 : Artifact.submissionArtifact.instructionPC 4098 = 5227 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet5 : Artifact.submissionArtifact.instructionPC 4099 = 5228 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem run_store (input : ByteArray) :
    run storePath (PatternedScan.stS input 5203 []) = some (storedState input) := by
...
def gasSteps_msize (input : ByteArray) : GasSteps (storedState input) (sizedState input) := by
  have hd := Artifact.submissionArtifact.decodeAt_op_index 4097 .MSIZE
    (by rfl) (by decide) trivial
  have hp : (storedState input).pc.toNat = Artifact.submissionArtifact.instructionPC 4097 := by
    rw [pcRet3]; rfl
  have hop : (storedState input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (storedState input) 4097
