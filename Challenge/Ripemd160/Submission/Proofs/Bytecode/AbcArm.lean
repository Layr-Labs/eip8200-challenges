...
theorem pcArm : Artifact.submissionArtifact.instructionPC 4067 = 5123 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5123 = true := by
...
def armEntry (input : ByteArray) : State := PatternedScan.stS input 5123 []

def sizePath : List Located :=
  [opAt 4067 .JUMPDEST, opAt 4068 .CALLDATASIZE, pushAt 4069 1 3, opAt 4070 .SUB, pushAt 4071 2 276]

theorem run_size (input : ByteArray) :
    run sizePath (armEntry input) =
      some (PatternedScan.stS input 5131 [276, sizeCond input]) := by
  let sz := UInt256.ofNat input.size
  let l0 : Located := opAt 4067 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4067 5123 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 5123 [] (by simp) (by norm_num))
  let l1 : Located := opAt 4068 .CALLDATASIZE
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4068 5124 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldatasize input 5124 [] (by simp) (by norm_num))
  let l2 : Located := pushAt 4069 1 3
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4069 5125 [sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5125 1 3 [sz] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := opAt 4070 .SUB
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4070 5127 [3, sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_sub input 5127 3 sz [] (by simp) (by norm_num))
  let l4 : Located := pushAt 4071 2 276
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4071 5128 [sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5128 2 276 [sizeCond input] (by simp) (by decide) (by decide) (by norm_num))
...
theorem run_size_miss (input : ByteArray) (hc : UInt256.isTrue (sizeCond input)) :
    run [opAt 4072 .JUMPI] (PatternedScan.stS input 5131 [276, sizeCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4072 .JUMPI)
    (PatternedScan.pcFactS input 4072 5131 [276, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5131 276 276 (sizeCond input) []
...
theorem run_size_pass (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeCond input)) :
  ...
  PatternedScan.blockOfS (opAt 4072 .JUMPI)
    (PatternedScan.pcFactS input 4072 5131 [276, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5131 276 (sizeCond input) []
...
def wordPath : List Located :=
  [pushAt 4073 3 6382179, pushAt 4074 1 232, opAt 4075 .SHL, pushAt 4076 0 0, opAt 4077 .CALLDATALOAD,
   opAt 4078 .XOR, pushAt 4079 2 276]

theorem run_word (input : ByteArray) :
    run wordPath (PatternedScan.stS input 5132 []) =
      some (PatternedScan.stS input 5145 [276, wordCond input]) := by
  let w := MachineState.readWord input 0
  let abcW := UInt256.shiftLeft 6382179 232
  let l0 : Located := pushAt 4073 3 6382179
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4073 5132 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5132 3 6382179 [] (by simp) (by decide) (by decide) (by norm_num))
  let l1 : Located := pushAt 4074 1 232
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4074 5136 [6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5136 1 232 [6382179] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := opAt 4075 .SHL
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4075 5138 [232, 6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shl input 5138 232 6382179 [] (by simp) (by norm_num))
  let l3 : Located := pushAt 4076 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4076 5139 [abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 5139 [abcW] (by simp) (by norm_num))
  let l4 : Located := opAt 4077 .CALLDATALOAD
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4077 5140 [0, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 5140 0 [abcW] (by simp) (by norm_num))
  let l5 : Located := opAt 4078 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4078 5141 [w, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 5141 w abcW [] (by simp) (by norm_num))
  let l6 : Located := pushAt 4079 2 276
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4079 5142 [wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5142 2 276 [wordCond input] (by simp) (by decide) (by decide) (by norm_num))
  have s1 := Stepper.runLocatedBlock_append [l0] [l1] _ _ _ h0 rfl h1
  have s2 := Stepper.runLocatedBlock_append [l0, l1] [l2] _ _ _ s1 rfl h2
  have s3 := Stepper.runLocatedBlock_append [l0, l1, l2] [l3] _ _ _ s2 rfl h3
  have s4 := Stepper.runLocatedBlock_append [l0, l1, l2, l3] [l4] _ _ _ s3 rfl h4
...
theorem run_word_miss (input : ByteArray) (hc : UInt256.isTrue (wordCond input)) :
    run [opAt 4080 .JUMPI] (PatternedScan.stS input 5145 [276, wordCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4080 .JUMPI)
    (PatternedScan.pcFactS input 4080 5145 [276, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5145 276 276 (wordCond input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 276) hc generic_dest)

theorem run_word_hit (input : ByteArray) (hc : ¬ UInt256.isTrue (wordCond input)) :
    run [opAt 4080 .JUMPI] (PatternedScan.stS input 5145 [276, wordCond input]) =
      some (PatternedScan.stS input 5146 []) :=
  PatternedScan.blockOfS (opAt 4080 .JUMPI)
    (PatternedScan.pcFactS input 4080 5145 [276, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5145 276 (wordCond input) []
      (by simp) (by norm_num) hc)
...
def sizedState (input : ByteArray) : State :=
  { storedState input with pc := UInt256.ofNat 5170, stack := [UInt256.ofNat 32] }

def returnedState (input : ByteArray) : State :=
  { storedState input with
    pc := UInt256.ofNat 5171
    halt := .Returned
    hReturn := MachineState.readPadded answerMemory 0 32 }

def storePath : List Located :=
  [pushAt 4081 20 814647003348588794217809277549781461204094028796, pushAt 4082 0 0, opAt 4083 .MSTORE]

def finishPath : List Located :=
  [pushAt 4085 0 0, opAt 4086 .RETURN]

@[simp] theorem pcRet0 : Artifact.submissionArtifact.instructionPC 4081 = 5146 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet1 : Artifact.submissionArtifact.instructionPC 4082 = 5167 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet2 : Artifact.submissionArtifact.instructionPC 4083 = 5168 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet3 : Artifact.submissionArtifact.instructionPC 4084 = 5169 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet4 : Artifact.submissionArtifact.instructionPC 4085 = 5170 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet5 : Artifact.submissionArtifact.instructionPC 4086 = 5171 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem run_store (input : ByteArray) :
    run storePath (PatternedScan.stS input 5146 []) = some (storedState input) := by
...
def gasSteps_msize (input : ByteArray) : GasSteps (storedState input) (sizedState input) := by
  have hd := Artifact.submissionArtifact.decodeAt_op_index 4084 .MSIZE
    (by rfl) (by decide) trivial
  have hp : (storedState input).pc.toNat = Artifact.submissionArtifact.instructionPC 4084 := by
    rw [pcRet3]; rfl
  have hop : (storedState input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (storedState input) 4084
