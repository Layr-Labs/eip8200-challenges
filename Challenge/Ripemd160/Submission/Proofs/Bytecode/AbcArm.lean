...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3789 = 4948 := by
  exact GuardInstructionWindow.pc 231
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3790 = 4949 := by
  exact GuardInstructionWindow.pc 232
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3791 = 4950 := by
  exact GuardInstructionWindow.pc 233
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3792 = 4951 := by
  exact GuardInstructionWindow.pc 234
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3793 = 4952 := by
  exact GuardInstructionWindow.pc 235
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3774 = 4887 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3775 = 4888 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3776 = 4889 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3777 = 4891 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3778 = 4892 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3779 = 4893 := by
  exact GuardInstructionWindow.pc 221
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3780 = 4897 := by
  exact GuardInstructionWindow.pc 222
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3781 = 4898 := by
  exact GuardInstructionWindow.pc 223
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3782 = 4899 := by
  exact GuardInstructionWindow.pc 224
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3783 = 4902 := by
...
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3787 = 4926 := by
  exact GuardInstructionWindow.pc 229
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3788 = 4947 := by
  exact GuardInstructionWindow.pc 230

def wordPath : List Located :=
  [⟨3774, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 216, by decide⟩,
   ⟨3775, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 217, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3776, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 218, by decide⟩,
   ⟨3777, .op .SHR, by exact GuardInstructionWindow.get 219, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3778, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 220, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3779, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 221, by decide⟩,
   ⟨3780, .op .MUL, by exact GuardInstructionWindow.get 222, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3781, .op .XOR, by exact GuardInstructionWindow.get 223, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3782, .push ⟨2, by decide⟩ (UInt256.ofNat 351), by exact GuardInstructionWindow.get 224, by decide⟩,
   ⟨3783, .op .JUMPI, by exact GuardInstructionWindow.get 225, ⟨by decide, trivial, rfl⟩⟩]
...
def finishPath : List Located :=
  [⟨3792, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 234, by decide⟩,
   ⟨3793, .op .RETURN, by exact GuardInstructionWindow.get 235, ⟨by decide, trivial, rfl⟩⟩]
...
def gasSteps_hit (input : ByteArray) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3791 .MSIZE
    (by exact GuardInstructionWindow.get 233) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3791 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3791 rfl hp .MSIZE none hd rfl
