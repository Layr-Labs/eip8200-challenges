...
theorem pcArm : Artifact.submissionArtifact.instructionPC 4118 = 5156 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem arm_dest : Decode.isValidJumpDest submissionBytecode 5156 = true := by
  have h := Artifact.submissionArtifact.isValidJumpDest_index 4118 (by rfl)
  rw [pcArm] at h
  exact h
...
def armEntry (input : ByteArray) : State := PatternedScan.stS input 5156 []

def sizePath : List Located :=
  [opAt 4118 .JUMPDEST, opAt 4119 .CALLDATASIZE, pushAt 4120 1 3, opAt 4121 .SUB, pushAt 4122 2 268]

theorem run_size (input : ByteArray) :
    run sizePath (armEntry input) =
      some (PatternedScan.stS input 5164 [268, sizeCond input]) := by
  let sz := UInt256.ofNat input.size
  let l0 : Located := opAt 4118 .JUMPDEST
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4118 5156 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpdest input 5156 [] (by simp) (by norm_num))
  let l1 : Located := opAt 4119 .CALLDATASIZE
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4119 5157 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldatasize input 5157 [] (by simp) (by norm_num))
  let l2 : Located := pushAt 4120 1 3
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4120 5158 [sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5158 1 3 [sz] (by simp) (by decide) (by decide) (by norm_num))
  let l3 : Located := opAt 4121 .SUB
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4121 5160 [3, sz] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_sub input 5160 3 sz [] (by simp) (by norm_num))
  let l4 : Located := pushAt 4122 2 268
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4122 5161 [sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5161 2 268 [sizeCond input] (by simp) (by decide) (by decide) (by norm_num))
...
theorem run_size_miss (input : ByteArray) (hc : UInt256.isTrue (sizeCond input)) :
    run [opAt 4123 .JUMPI] (PatternedScan.stS input 5164 [268, sizeCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4123 .JUMPI)
    (PatternedScan.pcFactS input 4123 5164 [268, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5164 268 268 (sizeCond input) []
...
theorem run_size_pass (input : ByteArray) (hc : ¬ UInt256.isTrue (sizeCond input)) :
    run [opAt 4123 .JUMPI] (PatternedScan.stS input 5164 [268, sizeCond input]) =
      some (PatternedScan.stS input 5165 []) :=
  PatternedScan.blockOfS (opAt 4123 .JUMPI)
    (PatternedScan.pcFactS input 4123 5164 [268, sizeCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5164 268 (sizeCond input) []
...
def wordPath : List Located :=
  [pushAt 4124 3 6382179, pushAt 4125 1 232, opAt 4126 .SHL, pushAt 4127 0 0, opAt 4128 .CALLDATALOAD,
   opAt 4129 .XOR, pushAt 4130 2 268]

theorem run_word (input : ByteArray) :
    run wordPath (PatternedScan.stS input 5165 []) =
      some (PatternedScan.stS input 5178 [268, wordCond input]) := by
  let w := MachineState.readWord input 0
  let abcW := UInt256.shiftLeft 6382179 232
  let l0 : Located := pushAt 4124 3 6382179
  have h0 := PatternedScan.blockOfS l0
    (PatternedScan.pcFactS input 4124 5165 [] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5165 3 6382179 [] (by simp) (by decide) (by decide) (by norm_num))
  let l1 : Located := pushAt 4125 1 232
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 4125 5169 [6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5169 1 232 [6382179] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := opAt 4126 .SHL
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 4126 5171 [232, 6382179] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_shl input 5171 232 6382179 [] (by simp) (by norm_num))
  let l3 : Located := pushAt 4127 0 0
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 4127 5172 [abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push0 input 5172 [abcW] (by simp) (by norm_num))
  let l4 : Located := opAt 4128 .CALLDATALOAD
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 4128 5173 [0, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_calldataload input 5173 0 [abcW] (by simp) (by norm_num))
  let l5 : Located := opAt 4129 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 4129 5174 [w, abcW] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_xor input 5174 w abcW [] (by simp) (by norm_num))
  let l6 : Located := pushAt 4130 2 268
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 4130 5175 [wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_push input 5175 2 268 [wordCond input] (by simp) (by decide) (by decide) (by norm_num))
  have s1 := Stepper.runLocatedBlock_append [l0] [l1] _ _ _ h0 rfl h1
  have s2 := Stepper.runLocatedBlock_append [l0, l1] [l2] _ _ _ s1 rfl h2
  have s3 := Stepper.runLocatedBlock_append [l0, l1, l2] [l3] _ _ _ s2 rfl h3
  have s4 := Stepper.runLocatedBlock_append [l0, l1, l2, l3] [l4] _ _ _ s3 rfl h4
...
theorem run_word_miss (input : ByteArray) (hc : UInt256.isTrue (wordCond input)) :
    run [opAt 4131 .JUMPI] (PatternedScan.stS input 5178 [268, wordCond input]) =
      some (fallbackState input) :=
  PatternedScan.blockOfS (opAt 4131 .JUMPI)
    (PatternedScan.pcFactS input 4131 5178 [268, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_taken input 5178 268 268 (wordCond input) []
      (by simp) (by norm_num) (by simpa using Word.literal_eq_ofNat 268) hc generic_dest)
...
theorem run_word_hit (input : ByteArray) (hc : ¬ UInt256.isTrue (wordCond input)) :
  ...
  PatternedScan.blockOfS (opAt 4131 .JUMPI)
    (PatternedScan.pcFactS input 4131 5178 [268, wordCond input] (by norm_num) (by
      rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide))
    (PatternedScan.stepS_jumpi_fall input 5178 268 (wordCond input) []
      (by simp) (by norm_num) hc)
...
def sizedState (input : ByteArray) : State :=
  { storedState input with pc := UInt256.ofNat 5203, stack := [UInt256.ofNat 32] }
...
def storePath : List Located :=
  [pushAt 4132 20 814647003348588794217809277549781461204094028796, pushAt 4133 0 0, opAt 4134 .MSTORE]

def finishPath : List Located :=
  [pushAt 4136 0 0, opAt 4137 .RETURN]

@[simp] theorem pcRet0 : Artifact.submissionArtifact.instructionPC 4132 = 5179 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet1 : Artifact.submissionArtifact.instructionPC 4133 = 5200 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet2 : Artifact.submissionArtifact.instructionPC 4134 = 5201 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet3 : Artifact.submissionArtifact.instructionPC 4135 = 5202 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet4 : Artifact.submissionArtifact.instructionPC 4136 = 5203 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pcRet5 : Artifact.submissionArtifact.instructionPC 4137 = 5204 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide

theorem run_store (input : ByteArray) :
    run storePath (PatternedScan.stS input 5179 []) = some (storedState input) := by
...
def gasSteps_msize (input : ByteArray) : GasSteps (storedState input) (sizedState input) := by
  have hd := Artifact.submissionArtifact.decodeAt_op_index 4135 .MSIZE
    (by rfl) (by decide) trivial
  have hp : (storedState input).pc.toNat = Artifact.submissionArtifact.instructionPC 4135 := by
    rw [pcRet3]; rfl
  have hop : (storedState input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (storedState input) 4135
