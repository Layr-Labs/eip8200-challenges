...
@[simp] theorem pc_241 : Artifact.submissionArtifact.instructionPC 3793 = 4941 := by
  exact GuardInstructionWindow.pc 216
@[simp] theorem pc_242 : Artifact.submissionArtifact.instructionPC 3794 = 4942 := by
  exact GuardInstructionWindow.pc 217
@[simp] theorem pc_243 : Artifact.submissionArtifact.instructionPC 3795 = 4943 := by
  exact GuardInstructionWindow.pc 218
@[simp] theorem pc_244 : Artifact.submissionArtifact.instructionPC 3796 = 4944 := by
  exact GuardInstructionWindow.pc 219
@[simp] theorem pc_245 : Artifact.submissionArtifact.instructionPC 3797 = 4945 := by
  exact GuardInstructionWindow.pc 220
@[simp] theorem pc_4095 : Artifact.submissionArtifact.instructionPC 3778 = 4880 := by
  exact GuardInstructionWindow.pc 201
@[simp] theorem pc_4096 : Artifact.submissionArtifact.instructionPC 3779 = 4881 := by
  exact GuardInstructionWindow.pc 202
@[simp] theorem pc_4097 : Artifact.submissionArtifact.instructionPC 3780 = 4882 := by
  exact GuardInstructionWindow.pc 203
@[simp] theorem pc_4098 : Artifact.submissionArtifact.instructionPC 3781 = 4884 := by
  exact GuardInstructionWindow.pc 204
@[simp] theorem pc_4099 : Artifact.submissionArtifact.instructionPC 3782 = 4885 := by
  exact GuardInstructionWindow.pc 205
@[simp] theorem pc_4100 : Artifact.submissionArtifact.instructionPC 3783 = 4886 := by
  exact GuardInstructionWindow.pc 206
@[simp] theorem pc_4101 : Artifact.submissionArtifact.instructionPC 3784 = 4890 := by
  exact GuardInstructionWindow.pc 207
@[simp] theorem pc_4102 : Artifact.submissionArtifact.instructionPC 3785 = 4891 := by
  exact GuardInstructionWindow.pc 208
@[simp] theorem pc_4103 : Artifact.submissionArtifact.instructionPC 3786 = 4892 := by
  exact GuardInstructionWindow.pc 209
@[simp] theorem pc_4104 : Artifact.submissionArtifact.instructionPC 3787 = 4895 := by
  exact GuardInstructionWindow.pc 210
@[simp] theorem pc_4105 : Artifact.submissionArtifact.instructionPC 3788 = 4896 := by
  exact GuardInstructionWindow.pc 211
@[simp] theorem pc_4106 : Artifact.submissionArtifact.instructionPC 3789 = 4897 := by
  exact GuardInstructionWindow.pc 212
@[simp] theorem pc_4107 : Artifact.submissionArtifact.instructionPC 3790 = 4918 := by
  exact GuardInstructionWindow.pc 213
@[simp] theorem pc_4108 : Artifact.submissionArtifact.instructionPC 3791 = 4919 := by
  exact GuardInstructionWindow.pc 214
@[simp] theorem pc_4109 : Artifact.submissionArtifact.instructionPC 3792 = 4940 := by
  exact GuardInstructionWindow.pc 215

def wordPath : List Located :=
  [⟨3778, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 201, by decide⟩,
   ⟨3779, .op .CALLDATALOAD, by exact GuardInstructionWindow.get 202, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3780, .push ⟨1, by decide⟩ (UInt256.ofNat 232), by exact GuardInstructionWindow.get 203, by decide⟩,
   ⟨3781, .op .SHR, by exact GuardInstructionWindow.get 204, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3782, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 205, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3783, .push ⟨3, by decide⟩ (UInt256.ofNat 2127393), by exact GuardInstructionWindow.get 206, by decide⟩,
   ⟨3784, .op .MUL, by exact GuardInstructionWindow.get 207, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3785, .op .XOR, by exact GuardInstructionWindow.get 208, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3786, .push ⟨2, by decide⟩ (UInt256.ofNat 354), by exact GuardInstructionWindow.get 209, by decide⟩,
   ⟨3787, .op .JUMPI, by exact GuardInstructionWindow.get 210, ⟨by decide, trivial, rfl⟩⟩]

/-- The small-input answer block sits at the end of the code and is entered by fall-through
from the word test. -/
def storePath : List Located :=
  [⟨3788, .op .CALLDATASIZE, by exact GuardInstructionWindow.get 211, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3789, .push ⟨20, by decide⟩ (UInt256.ofNat 25448770637332498804579667936807160623886401639), by exact GuardInstructionWindow.get 212, by decide⟩,
   ⟨3790, .op .MUL, by exact GuardInstructionWindow.get 213, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3791, .push ⟨20, by decide⟩ (UInt256.ofNat 890993315260586290631548281360202943075753233713), by exact GuardInstructionWindow.get 214, by decide⟩,
   ⟨3792, .op .SUB, by exact GuardInstructionWindow.get 215, ⟨by decide, trivial, rfl⟩⟩,
   ⟨3793, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 216, by decide⟩,
   ⟨3794, .op .MSTORE, by exact GuardInstructionWindow.get 217, ⟨by decide, trivial, rfl⟩⟩]

def finishPath : List Located :=
  [⟨3796, .push ⟨0, by decide⟩ (UInt256.ofNat 0), by exact GuardInstructionWindow.get 219, by decide⟩,
   ⟨3797, .op .RETURN, by exact GuardInstructionWindow.get 220, ⟨by decide, trivial, rfl⟩⟩]
...
def armEntry (input : ByteArray) : State := Execution.atPC input 4880
...
def sized (input : ByteArray) : State :=
  {stored input with pc := UInt256.ofNat 4944, stack := [UInt256.ofNat 32]}
...
theorem run_word_hit (input : ByteArray) (hm : wordCond input = 0) :
    DataStepper.runLocatedBlock wordPath (armEntry input) =
      some (Execution.atPC input 4896) := by
...
theorem run_store (input : ByteArray) :
    DataStepper.runLocatedBlock storePath (Execution.atPC input 4896) = some (stored input) := by
...
def gasSteps_hit (input : ByteArray) (hw : wordCond input = 0) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 3795 .MSIZE
    (by exact GuardInstructionWindow.get 218) (by decide) trivial
  have hp : (stored input).pc.toNat = Artifact.submissionArtifact.instructionPC 3795 := by
    rw [pc_243]; rfl
  have hop : (stored input).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (stored input) 3795 rfl hp .MSIZE none hd rfl
