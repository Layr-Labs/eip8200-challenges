...
def template : List Instr :=
  [ .op (.Swap ⟨0, by decide⟩),
    ...
    .op (.Dup ⟨8, by decide⟩),
    .op .ADD,
    .push ⟨13, by decide⟩ (UInt256.ofNat 2376844875981332450086324535340),
    .op (.Dup ⟨14, by decide⟩),
    .op (.Swap ⟨1, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op .AND,
