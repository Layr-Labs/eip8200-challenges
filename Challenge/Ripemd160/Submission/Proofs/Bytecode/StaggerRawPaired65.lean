...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 28))),
    ...
    x.v2,
    x.v3,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v10 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 846) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v9 x.v4) x.v0) (UInt256.xor x.v9 (UInt256.xor x.v7 x.v4))) x.v5))) (UInt256.ofNat 72)) (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 846) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v9 x.v4) x.v0) (UInt256.xor x.v9 (UInt256.xor x.v7 x.v4))) x.v5)))))) (UInt256.ofNat 20)))),
    x.v0,
    x.v6,
    x.v7,
    x.v8,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3189).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3189 actual_slice
    (by change 3189 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4115 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3189) = UInt256.ofNat 4115
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4115) template = UInt256.ofNat 4159 := by decide
  rw [hend] at hraw
