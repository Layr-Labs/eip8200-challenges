...
theorem site_pc : site.startPC = UInt256.ofNat 3184 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2430) = UInt256.ofNat 3184
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3184) template = UInt256.ofNat 3228 := by decide
  rw [hend] at hraw
