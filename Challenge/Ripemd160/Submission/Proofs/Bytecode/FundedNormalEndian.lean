...
private def upperValue (high : UInt256) : UInt256 := (UInt256.xor (UInt256.mul (UInt256.ofNat 65537) (UInt256.land (UInt256.xor (UInt256.xor (UInt256.mul (UInt256.land mask8 (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high)) (UInt256.ofNat 285)) high) (UInt256.shiftRight (UInt256.xor (UInt256.mul (UInt256.land mask8 (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high)) (UInt256.ofNat 285)) high) (UInt256.ofNat 16))) mask16)) (UInt256.xor (UInt256.mul (UInt256.land mask8 (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high)) (UInt256.ofNat 285)) high))
...
private def lowerValue (low : UInt256) : UInt256 := (UInt256.xor (UInt256.mul (UInt256.ofNat 65537) (UInt256.land mask16 (UInt256.xor (UInt256.xor (UInt256.mul (UInt256.ofNat 285) (UInt256.land (UInt256.xor low (UInt256.shiftRight low (UInt256.ofNat 8))) mask8)) low) (UInt256.shiftRight (UInt256.xor (UInt256.mul (UInt256.ofNat 285) (UInt256.land (UInt256.xor low (UInt256.shiftRight low (UInt256.ofNat 8))) mask8)) low) (UInt256.ofNat 16))))) (UInt256.xor (UInt256.mul (UInt256.ofNat 285) (UInt256.land (UInt256.xor low (UInt256.shiftRight low (UInt256.ofNat 8))) mask8)) low))
