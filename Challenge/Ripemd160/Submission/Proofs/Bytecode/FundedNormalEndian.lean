...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.FundedNormalEndian
...
def upperReverse : List Instr := [ .push ⟨2, by decide⟩ (UInt256.ofNat 285),
  .op (.Dup ⟨1, by decide⟩),
  .op (.Dup ⟨2, by decide⟩),
  ...
  .op .MUL,
  .op .XOR ]
def lowerReverse : List Instr := [ .op (.Dup ⟨1, by decide⟩),
  .op (.Dup ⟨1, by decide⟩),
  .push ⟨1, by decide⟩ (UInt256.ofNat 8),
  .op .SHR,
  .op (.Dup ⟨2, by decide⟩),
  ...
  .op .MUL,
  .op .XOR ]
def template : List Instr := [ .push ⟨2, by decide⟩ (UInt256.ofNat 285),
  .op (.Dup ⟨1, by decide⟩),
  .op (.Dup ⟨2, by decide⟩),
  .push ⟨1, by decide⟩ (UInt256.ofNat 8),
  .op .SHR,
...
private def upperValue (high : UInt256) : UInt256 := (UInt256.xor (UInt256.mul (UInt256.ofNat 65565) (UInt256.land (UInt256.xor (UInt256.xor (UInt256.mul (UInt256.land mask8 (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high)) (UInt256.ofNat 285)) high) (UInt256.shiftRight (UInt256.xor (UInt256.mul (UInt256.land mask8 (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high)) (UInt256.ofNat 285)) high) (UInt256.ofNat 16))) mask16)) (UInt256.xor (UInt256.mul (UInt256.land mask8 (UInt256.xor (UInt256.shiftRight high (UInt256.ofNat 8)) high)) (UInt256.ofNat 285)) high))
...
private theorem run_upper (s : State) (pc high low returnPC : UInt256) (rest : List UInt256)
    ...
    runInstrSeq upperReverse {s with pc := pc, stack := high :: low :: mask8 :: maskWord :: mask16 :: returnPC :: rest} =
      some {s with pc := pcAfter pc upperReverse, stack := PairedScheduleData.reversedWord high :: low :: mask8 :: maskWord :: mask16 :: returnPC :: rest} := by
...
private def lowerValue (low : UInt256) : UInt256 := (UInt256.xor (UInt256.mul (UInt256.ofNat 65565) (UInt256.land mask16 (UInt256.xor (UInt256.xor (UInt256.mul (UInt256.ofNat 285) (UInt256.land (UInt256.xor low (UInt256.shiftRight low (UInt256.ofNat 8))) mask8)) low) (UInt256.shiftRight (UInt256.xor (UInt256.mul (UInt256.ofNat 285) (UInt256.land (UInt256.xor low (UInt256.shiftRight low (UInt256.ofNat 8))) mask8)) low) (UInt256.ofNat 16))))) (UInt256.xor (UInt256.mul (UInt256.ofNat 285) (UInt256.land (UInt256.xor low (UInt256.shiftRight low (UInt256.ofNat 8))) mask8)) low))
...
private theorem run_lower (s : State) (pc low returnPC : UInt256) (rest : List UInt256)
    (hstack : rest.length ≤ 996) (hrun : s.halt = .Running) :
    runInstrSeq lowerReverse {s with pc := pc, stack := low :: mask8 :: maskWord :: mask16 :: returnPC :: rest} =
      some {s with pc := pcAfter pc lowerReverse, stack := PairedScheduleData.reversedWord low :: mask8 :: maskWord :: mask16 :: returnPC :: rest} := by
...
theorem run_endian (s : State) (pc low high returnPC : UInt256) (rest : List UInt256)
    ...
    runInstrSeq template {s with pc := pc, stack := high :: low :: mask8 :: maskWord :: mask16 :: returnPC :: rest} =
      some {s with pc := pcAfter pc template, stack := maskWord :: returnPC :: rest, memory := Table80ScratchZero.scratchMemory s.memory (PairedScheduleData.reversedWord low) (PairedScheduleData.reversedWord high)} := by
  ...
  have h4 := PairedSchedulePrimitives.run_storeTemplate
    ...
    (PairedScheduleData.reversedWord low) 28 (mask8 :: maskWord :: mask16 :: returnPC :: rest)
    (by simp; omega) (by decide) hrun
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.FundedNormalEndian
