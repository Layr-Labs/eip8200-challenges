...
def copied (s : State) : State :=
  { s with
    memory := MachineState.writeBytes s.memory
      (MachineState.readPadded submissionBytecode 261 32) 0
...
theorem literal_bytes : MachineState.readPadded submissionBytecode 261 32 =
    Data.Bytes.natToBytesPadded (PatternedWordData.expectedWordAt 0).toNat 32 := by
  have hprefix : MachineState.readPadded submissionBytecode 261 32 =
      MachineState.readPadded submissionByteChunk0 261 32 := by
