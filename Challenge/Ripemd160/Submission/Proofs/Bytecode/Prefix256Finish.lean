...
def gasSteps_miss (input : ByteArray) (sv ov acc : UInt256) (hne : acc ≠ 0) :
    GasSteps (stS input 254 [sv, ov, acc, P7, M, m7, P, m8]) (fallbackState input) :=
...
def gasSteps_finish_hit (input : ByteArray) (sv ov acc : UInt256)
    ...
    GasSteps (stS input 254 [sv, ov, acc, P7, M, m7, P, m8]) (DigestReturn.returnedState input paddedDigestWord [sv, ov, 0, P7, M, m7, P, m8]) := by
  subst acc
