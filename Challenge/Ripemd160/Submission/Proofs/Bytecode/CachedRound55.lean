...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 2798).take actualTemplate.length = actualTemplate := by rfl
def actualSite : GenericRoundSite Artifact.submissionArtifact .Osaka actualTemplate :=
  StackSiteBuilder.ofSlice actualTemplate 2798 actual_slice
...
theorem actual_pc : actualSite.startPC = UInt256.ofNat 3386 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2798) = UInt256.ofNat 3386
