import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem actual_slice :
     (Artifact.submissionArtifact.instructions.drop 3883).take template.length = template := by rfl
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 4588 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3883) = UInt256.ofNat 4588
