import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 def template : List Instr :=
   [ .op (.Swap ⟨4, by decide⟩),
    ...
    .op (.Dup ⟨5, by decide⟩),
    .op .MUL,
    .push ⟨1, by decide⟩ (UInt256.ofNat 101),
    .op .SHR,
    .op (.Swap ⟨0, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op .MUL,
 ...
 def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
   [ (UInt256.shiftRight (UInt256.mul x.v6 x.v2) (UInt256.ofNat 22)),
    (UInt256.shiftRight (UInt256.mul x.v6 (UInt256.land x.v7 (UInt256.add (UInt256.add (MachineState.readWord memory 100) (UInt256.add (UInt256.xor x.v3 (UInt256.xor x.v2 (UInt256.xor x.v9 (UInt256.lor x.v0 (UInt256.land x.v9 x.v2))))) x.v5)) x.v1))) (UInt256.ofNat 101)),
    x.v3,
    x.v4,
    x.v0,
    x.v6,
 ...
 theorem actual_slice :
     (Artifact.submissionArtifact.instructions.drop 3885).take template.length = template := by rfl
 def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
   StackSiteBuilder.ofSlice template 3885 actual_slice
     ...
     (by decide)
 theorem site_pc : site.startPC = UInt256.ofNat 4588 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3885) = UInt256.ofNat 4588
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
     ...
     GasSteps {s with pc := UInt256.ofNat 4588, stack := inputStack x rho}
       {s with pc := UInt256.ofNat 4618, stack := outputStack s.memory x rho} := by
   have hraw := run_actual s (UInt256.ofNat 4588) x rho hstack hrun hactive
   have hend : pcAfter (UInt256.ofNat 4588) template = UInt256.ofNat 4618 := by decide
   rw [hend] at hraw
