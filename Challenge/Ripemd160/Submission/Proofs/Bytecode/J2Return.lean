...
theorem output_spec (s : State) (e : Env s) (rho : List UInt256)
  ...
  have hsz : Artifact.submissionArtifact.code.size = 5234 := by
    change submissionBytecode.size = 5234
    rw [referenceBytecode_size]
  have hsrc : source s = selected (UInt256.ofNat 5234) s.executionEnv.calldata.size := by
