...
theorem output_spec (s : State) (e : Env s) (rho : List UInt256)
  ...
  have hsz : Artifact.submissionArtifact.code.size = 5207 := by
    change submissionBytecode.size = 5207
    rw [referenceBytecode_size]
  have hsrc : source s = selected (UInt256.ofNat 5207) s.executionEnv.calldata.size := by
