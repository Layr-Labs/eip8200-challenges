...
private theorem copy_decoded (s : State) (e : Env s) (rho : List UInt256) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 213 .CODECOPY
...
private theorem size_decoded (s : State) (e : Env s) (rho : List UInt256) :
  ...
  have hd := Artifact.submissionArtifact.decodeAt_op_index 214 .MSIZE
    (by rfl) (by decide) trivial
  ...
  change (UInt256.ofNat 321).toNat = Artifact.submissionArtifact.instructionPC 214
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
