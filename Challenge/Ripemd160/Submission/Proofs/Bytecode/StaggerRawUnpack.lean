...
theorem site_pc : site.startPC = UInt256.ofNat 4422 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3518) = UInt256.ofNat 4422
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4422) template = UInt256.ofNat 4432 := by decide
  rw [hend] at hraw
