...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3625).take template.length = template := by rfl
...
theorem site_pc : site.startPC = UInt256.ofNat 4565 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3625) = UInt256.ofNat 4565
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4565) template = UInt256.ofNat 4581 := by decide
  rw [hend] at hraw
