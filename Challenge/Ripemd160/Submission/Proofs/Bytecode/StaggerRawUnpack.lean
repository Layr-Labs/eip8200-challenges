...
theorem site_pc : site.startPC = UInt256.ofNat 4554 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3633) = UInt256.ofNat 4554
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4554) template = UInt256.ofNat 4570 := by decide
  rw [hend] at hraw
