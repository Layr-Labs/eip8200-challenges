...
theorem site_pc : site.startPC = UInt256.ofNat 4563 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3645) = UInt256.ofNat 4563
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4563) template = UInt256.ofNat 4579 := by decide
  rw [hend] at hraw
