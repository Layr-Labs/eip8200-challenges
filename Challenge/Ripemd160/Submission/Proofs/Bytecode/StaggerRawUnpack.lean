...
theorem site_pc : site.startPC = UInt256.ofNat 4479 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3377) = UInt256.ofNat 4479
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4479) template = UInt256.ofNat 4484 := by decide
  rw [hend] at hraw
