...
theorem site_pc : site.startPC = UInt256.ofNat 4467 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3566) = UInt256.ofNat 4467
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4467) template = UInt256.ofNat 4483 := by decide
  rw [hend] at hraw
