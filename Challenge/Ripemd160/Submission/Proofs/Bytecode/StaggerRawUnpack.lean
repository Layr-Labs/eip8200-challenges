...
theorem site_pc : site.startPC = UInt256.ofNat 4477 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3566) = UInt256.ofNat 4477
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4477) template = UInt256.ofNat 4487 := by decide
  rw [hend] at hraw
