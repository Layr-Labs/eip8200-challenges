...
theorem site_pc : site.startPC = UInt256.ofNat 4485 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3425) = UInt256.ofNat 4485
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4485) template = UInt256.ofNat 4491 := by decide
  rw [hend] at hraw
