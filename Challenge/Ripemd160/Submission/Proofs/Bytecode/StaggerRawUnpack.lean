...
theorem site_pc : site.startPC = UInt256.ofNat 4566 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3644) = UInt256.ofNat 4566
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4566) template = UInt256.ofNat 4582 := by decide
  rw [hend] at hraw
