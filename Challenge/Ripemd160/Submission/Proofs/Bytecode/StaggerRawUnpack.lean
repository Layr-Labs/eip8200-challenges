...
theorem site_pc : site.startPC = UInt256.ofNat 4463 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3566) = UInt256.ofNat 4463
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4463) template = UInt256.ofNat 4479 := by decide
  rw [hend] at hraw
