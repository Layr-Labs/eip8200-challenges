...
theorem site_pc : site.startPC = UInt256.ofNat 4437 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3677) = UInt256.ofNat 4437
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4437) template = UInt256.ofNat 4457 := by decide
  rw [hend] at hraw
