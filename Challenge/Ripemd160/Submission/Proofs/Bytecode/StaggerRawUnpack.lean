...
theorem site_pc : site.startPC = UInt256.ofNat 4478 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3569) = UInt256.ofNat 4478
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4478) template = UInt256.ofNat 4494 := by decide
  rw [hend] at hraw
