...
theorem site_pc : site.startPC = UInt256.ofNat 4484 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3570) = UInt256.ofNat 4484
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4484) template = UInt256.ofNat 4494 := by decide
  rw [hend] at hraw
