...
theorem site_pc : site.startPC = UInt256.ofNat 4571 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3680) = UInt256.ofNat 4571
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4571) template = UInt256.ofNat 4587 := by decide
  rw [hend] at hraw
