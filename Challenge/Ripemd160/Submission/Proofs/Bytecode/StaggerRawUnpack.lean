...
theorem site_pc : site.startPC = UInt256.ofNat 4473 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3563) = UInt256.ofNat 4473
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4473) template = UInt256.ofNat 4489 := by decide
  rw [hend] at hraw
