...
theorem site_pc : site.startPC = UInt256.ofNat 4466 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3565) = UInt256.ofNat 4466
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4466) template = UInt256.ofNat 4482 := by decide
  rw [hend] at hraw
