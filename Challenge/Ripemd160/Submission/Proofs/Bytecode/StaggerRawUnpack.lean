...
theorem site_pc : site.startPC = UInt256.ofNat 4504 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3382) = UInt256.ofNat 4504
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4504) template = UInt256.ofNat 4510 := by decide
  rw [hend] at hraw
