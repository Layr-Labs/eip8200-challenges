...
theorem site_pc : site.startPC = UInt256.ofNat 4430 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3522) = UInt256.ofNat 4430
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4430) template = UInt256.ofNat 4440 := by decide
  rw [hend] at hraw
