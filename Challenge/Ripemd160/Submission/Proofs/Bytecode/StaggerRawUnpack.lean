...
theorem site_pc : site.startPC = UInt256.ofNat 4522 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3687) = UInt256.ofNat 4522
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4522) template = UInt256.ofNat 4538 := by decide
  rw [hend] at hraw
