...
theorem site_pc : site.startPC = UInt256.ofNat 4476 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3407) = UInt256.ofNat 4476
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4476) template = UInt256.ofNat 4482 := by decide
  rw [hend] at hraw
