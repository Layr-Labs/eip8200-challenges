...
theorem site_pc : site.startPC = UInt256.ofNat 4489 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3435) = UInt256.ofNat 4489
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4489) template = UInt256.ofNat 4495 := by decide
  rw [hend] at hraw
