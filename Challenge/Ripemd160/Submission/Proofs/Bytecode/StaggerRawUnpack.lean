...
theorem site_pc : site.startPC = UInt256.ofNat 4501 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3467) = UInt256.ofNat 4501
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4501) template = UInt256.ofNat 4507 := by decide
  rw [hend] at hraw
