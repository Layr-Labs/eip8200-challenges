...
theorem site_pc : site.startPC = UInt256.ofNat 4496 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3563) = UInt256.ofNat 4496
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 4496) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4496) template = UInt256.ofNat 4506 := by decide
  rw [hend] at hraw
