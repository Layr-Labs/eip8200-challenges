...
theorem site_pc : site.startPC = UInt256.ofNat 4472 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3372) = UInt256.ofNat 4472
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4472) template = UInt256.ofNat 4477 := by decide
  rw [hend] at hraw
