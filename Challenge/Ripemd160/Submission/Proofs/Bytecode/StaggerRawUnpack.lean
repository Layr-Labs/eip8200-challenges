...
theorem site_pc : site.startPC = UInt256.ofNat 4469 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3493) = UInt256.ofNat 4469
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4469) template = UInt256.ofNat 4475 := by decide
  rw [hend] at hraw
