...
theorem site_pc : site.startPC = UInt256.ofNat 4607 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3394) = UInt256.ofNat 4607
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4607) template = UInt256.ofNat 4612 := by decide
  rw [hend] at hraw
