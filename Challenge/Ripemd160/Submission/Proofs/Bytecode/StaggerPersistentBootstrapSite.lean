...
theorem site_pc : site.startPC = UInt256.ofNat 904 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 572) = UInt256.ofNat 904
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 904) x rho hs hr ha
  have hend : pcAfter (UInt256.ofNat 904) template = UInt256.ofNat 915 := by decide
  rw [hend] at hraw
