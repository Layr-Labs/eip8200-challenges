...
theorem site_pc : site.startPC = UInt256.ofNat 999 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 628) = UInt256.ofNat 999
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 999) x rho hs hr ha
  have hend : pcAfter (UInt256.ofNat 999) template = UInt256.ofNat 1090 := by decide
  rw [hend] at hraw
