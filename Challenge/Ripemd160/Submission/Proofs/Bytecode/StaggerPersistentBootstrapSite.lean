...
theorem site_pc : site.startPC = UInt256.ofNat 1177 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 544) = UInt256.ofNat 1177
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 1177) x rho hs hr ha
  have hend : pcAfter (UInt256.ofNat 1177) template = UInt256.ofNat 1188 := by decide
  rw [hend] at hraw
