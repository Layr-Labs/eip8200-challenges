...
theorem site_pc : site.startPC = UInt256.ofNat 917 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 560) = UInt256.ofNat 917
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 917) x rho hs hr ha
  have hend : pcAfter (UInt256.ofNat 917) template = UInt256.ofNat 928 := by decide
  rw [hend] at hraw
