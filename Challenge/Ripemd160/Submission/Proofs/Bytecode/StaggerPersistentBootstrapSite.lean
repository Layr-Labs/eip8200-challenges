...
theorem site_pc : site.startPC = UInt256.ofNat 1095 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 639) = UInt256.ofNat 1095
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 1095) x rho hs hr ha
  have hend : pcAfter (UInt256.ofNat 1095) template = UInt256.ofNat 1106 := by decide
  rw [hend] at hraw
