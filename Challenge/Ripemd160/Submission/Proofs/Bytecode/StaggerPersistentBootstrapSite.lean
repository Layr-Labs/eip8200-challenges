...
theorem site_pc : site.startPC = UInt256.ofNat 882 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 475) = UInt256.ofNat 882
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 882) template = UInt256.ofNat 883 := by decide
  rw [hend] at hraw
