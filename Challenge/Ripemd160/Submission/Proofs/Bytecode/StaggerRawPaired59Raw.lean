...
def template : List Instr :=
  [ .op (.Swap ⟨4, by decide⟩),
    ...
    .op (.Dup ⟨1, by decide⟩),
    .op .ADD,
    .push ⟨14, by decide⟩ (UInt256.ofNat 80971182108430725463937373962269),
    .op (.Dup ⟨13, by decide⟩),
    .op (.Swap ⟨1, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op .AND,
