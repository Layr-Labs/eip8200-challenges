...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 595).take actualTemplate.length = actualTemplate := by rfl
def actualSite : GenericRoundSite Artifact.submissionArtifact .Osaka actualTemplate :=
  StackSiteBuilder.ofSlice actualTemplate 595 actual_slice
...
theorem actual_pc : actualSite.startPC = UInt256.ofNat 863 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 595) = UInt256.ofNat 863
