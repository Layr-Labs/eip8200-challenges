...
def template : List Instr :=
  [ .op (.Swap ⟨7, by decide⟩),
    .op .POP,
    .push ⟨22, by decide⟩ (UInt256.ofNat 40945789247971450477386360121479348807026276516919733),
    .op (.Swap ⟨0, by decide⟩),
    .op (.Dup ⟨8, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op (.Dup ⟨8, by decide⟩),
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23))),
    (UInt256.ofNat 40945789247971450477386360121479348807026276516919733),
    x.v2,
    x.v3,
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mulMod (UInt256.land x.v3 (UInt256.add (UInt256.ofNat 40945789247971450477386360121479348807026276516919733) (UInt256.add (MachineState.readWord memory 666) (UInt256.add (UInt256.xor (UInt256.xor (UInt256.land (UInt256.xor x.v4 x.v9) (UInt256.xor (UInt256.land x.v0 x.v9) x.v6)) x.v4) x.v0) x.v7)))) x.v15 x.v12) (UInt256.ofNat 25)))),
    (UInt256.ofNat 23),
    x.v0,
    x.v9,
    x.v10,
