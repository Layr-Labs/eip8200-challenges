...
theorem site_pc : site.startPC = UInt256.ofNat 3633 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2951) = UInt256.ofNat 3633
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3633) template = UInt256.ofNat 3671 := by decide
  rw [hend] at hraw
