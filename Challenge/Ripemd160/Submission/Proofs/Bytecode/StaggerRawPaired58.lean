...
theorem site_pc : site.startPC = UInt256.ofNat 3669 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2969) = UInt256.ofNat 3669
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3669) template = UInt256.ofNat 3707 := by decide
  rw [hend] at hraw
