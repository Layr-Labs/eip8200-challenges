...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan56
...
def gasSteps_last (input : ByteArray) (hsize : input.size = 56) :
...
def gasSteps_scan (input : ByteArray) (hsize : input.size = 56) :
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan56

#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan56.gasSteps_last
#print axioms Challenge.Ripemd160.Submission.Proofs.Bytecode.ShortPatternScan56.gasSteps_scan
