...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw19
...
def template : List Instr :=
  [ .op (.Swap ⟨6, by decide⟩),
    ...
    .op (.Dup ⟨12, by decide⟩),
    .op .AND,
    .push ⟨13, by decide⟩ (UInt256.ofNat 10141204804187018453442807988232),
    .op .MUL,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 10141204804187018453442807988232) (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 504) (UInt256.add (UInt256.lor (UInt256.land x.v9 x.v6) (UInt256.xor x.v0 (UInt256.land (UInt256.xor x.v9 x.v4) (UInt256.lor x.v6 x.v0)))) x.v7))) (UInt256.ofNat 72)) (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 504) (UInt256.add (UInt256.lor (UInt256.land x.v9 x.v6) (UInt256.xor x.v0 (UInt256.land (UInt256.xor x.v9 x.v4) (UInt256.lor x.v6 x.v0)))) x.v7)))))) (UInt256.ofNat 22)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 10141204804187018453442807988232) (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 504) (UInt256.add (UInt256.lor (UInt256.land x.v6 x.v9) (UInt256.xor (UInt256.land (UInt256.lor x.v0 x.v6) (UInt256.xor x.v4 x.v9)) x.v0)) x.v7))) (UInt256.ofNat 72)) (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 504) (UInt256.add (UInt256.lor (UInt256.land x.v6 x.v9) (UInt256.xor (UInt256.land (UInt256.lor x.v0 x.v6) (UInt256.xor x.v4 x.v9)) x.v0)) x.v7)))))) (UInt256.ofNat 22)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
private theorem run_generated (s : State) (pc : UInt256) (x : Input) (rho : List UInt256)
  ...
  have hz504 : MachineState.readWord s.memory 504 = UInt256.ofNat 0 :=
    PadPrefixContract.read_zero s hz ⟨28, by decide⟩ (by decide)
  ...
  simp (discharger := omega) [template, inputStack, actualOutput, hz504,
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixRaw19
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 4692).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 4692 actual_slice
    (by change 4692 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 5894 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 4692) = UInt256.ofNat 5894
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 5894, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 5947, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 5894) x rho hstack hrun hactive hz
  have hend : pcAfter (UInt256.ofNat 5894) template = UInt256.ofNat 5947 := by decide
  rw [hend] at hraw
