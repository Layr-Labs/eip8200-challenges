import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawRound24
 ...
 def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
   [ (UInt256.land x.v7 (UInt256.shiftRight (UInt256.mul x.v6 x.v3) (UInt256.ofNat 22))),
    x.v0,
    x.v2,
    (UInt256.land x.v7 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v6 (UInt256.land x.v7 (UInt256.add x.v4 (UInt256.add (MachineState.readWord memory 260) (UInt256.add (UInt256.lor (UInt256.land x.v3 x.v2) (UInt256.xor x.v0 (UInt256.land (UInt256.lor x.v0 x.v3) (UInt256.xor x.v8 x.v2)))) x.v1))))) (UInt256.ofNat 25)))),
    x.v4,
    x.v5,
    x.v6,
    x.v7,
 ...
 def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
   StackSiteBuilder.ofSlice template 1711 actual_slice
     ...
     (by decide)
 theorem site_pc : site.startPC = UInt256.ofNat 2224 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1711) = UInt256.ofNat 2224
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
     ...
     GasSteps {s with pc := UInt256.ofNat 2224, stack := inputStack x rho}
       {s with pc := UInt256.ofNat 2263, stack := outputStack s.memory x rho} := by
   have hraw := run_actual s (UInt256.ofNat 2224) x rho hstack hrun hactive
   have hend : pcAfter (UInt256.ofNat 2224) template = UInt256.ofNat 2263 := by decide
   rw [hend] at hraw
   exact DenseScheduleLift.gasSteps_of_raw site _ _ hcode hfork hrun hnp site_pc.symm advances hraw
 #print axioms gasSteps

end Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawRound24
