import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 2210 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1697) = UInt256.ofNat 2210
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 2210) template = UInt256.ofNat 2249 := by decide
   rw [hend] at hraw
