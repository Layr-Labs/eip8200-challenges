import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixJoin
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired0
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired1
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired2
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired3
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired4
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired5
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired6
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired7
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired8
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired9
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired10
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired11
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired12
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired13
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired14
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired15
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired16
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired17
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired18
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired19
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired20
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired21
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired22
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired23
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired24
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired25
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired26
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired27
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired28
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired29
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired30
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired31
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired32
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired33
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired34
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired35
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired36
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired37
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired38
import Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixPaired39
...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixCore
...
def pcs : Array Nat := #[5115, 5163, 5200, 5235, 5273, 5306, 5343, 5376, 5418, 5451, 5488, 5521, 5559, 5592, 5642, 5700, 5759, 5801, 5859, 5894, 5947, 5982, 6040, 6080, 6120, 6155, 6199, 6234, 6288, 6325, 6395, 6435, 6475, 6529, 6575, 6607, 6639, 6667, 6705, 6733, 2862, 2892, 2943, 2975, 3012, 3044, 3114, 3172, 3216, 3263, 3308, 3348, 3406, 3445, 3503, 3543, 3602, 3641, 3699, 3738, 3798, 3837, 3888, 3928, 3968, 4013, 4056, 4094, 4137, 4174, 4212, 4247, 4289, 4326, 4369, 4407, 4448, 4484]
...
private def gasSteps_at0 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
    (hs : rho.length ≤ 900) (hr : s.halt = .Running) (ha : 35 ≤ s.activeWords.toNat) (hz : PadPrefixContract.ZeroLoads s)
  ...
  exact PadPrefixPaired0.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at1 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired1.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at2 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired2.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at3 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired3.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at4 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired4.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at5 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired5.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at6 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired6.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at7 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired7.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at8 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired8.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at9 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired9.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at10 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired10.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at11 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired11.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at12 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired12.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at13 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired13.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at14 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired14.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at15 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired15.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at16 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired16.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at17 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired17.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at18 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired18.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at19 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired19.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at20 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired20.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at21 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired21.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at22 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired22.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at23 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired23.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at24 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired24.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at25 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired25.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at26 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired26.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at27 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired27.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at28 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired28.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at29 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired29.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at30 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired30.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at31 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired31.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at32 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired32.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at33 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired33.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at34 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired34.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at35 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired35.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at36 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired36.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at37 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired37.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at38 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  exact PadPrefixPaired38.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
...
private def gasSteps_at39 (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  have g := PadPrefixPaired39.gasSteps s h4 q right rho hs hr ha hz hcode hfork hnp
  apply g.trans
  apply PadPrefixJoin.gasSteps s _ _ hr hcode hfork hnp
  simp only [StaggerCoreCommon.stack, List.length_append, List.length_map,
...
def gasSteps_step (s : State) (h4 : UInt256) (i : Fin 77) (q right : WordLane) (rho : List UInt256)
  ...
  match i with
  | ⟨0, _⟩ => exact gasSteps_at0 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨1, _⟩ => exact gasSteps_at1 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨2, _⟩ => exact gasSteps_at2 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨3, _⟩ => exact gasSteps_at3 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨4, _⟩ => exact gasSteps_at4 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨5, _⟩ => exact gasSteps_at5 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨6, _⟩ => exact gasSteps_at6 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨7, _⟩ => exact gasSteps_at7 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨8, _⟩ => exact gasSteps_at8 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨9, _⟩ => exact gasSteps_at9 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨10, _⟩ => exact gasSteps_at10 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨11, _⟩ => exact gasSteps_at11 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨12, _⟩ => exact gasSteps_at12 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨13, _⟩ => exact gasSteps_at13 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨14, _⟩ => exact gasSteps_at14 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨15, _⟩ => exact gasSteps_at15 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨16, _⟩ => exact gasSteps_at16 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨17, _⟩ => exact gasSteps_at17 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨18, _⟩ => exact gasSteps_at18 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨19, _⟩ => exact gasSteps_at19 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨20, _⟩ => exact gasSteps_at20 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨21, _⟩ => exact gasSteps_at21 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨22, _⟩ => exact gasSteps_at22 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨23, _⟩ => exact gasSteps_at23 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨24, _⟩ => exact gasSteps_at24 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨25, _⟩ => exact gasSteps_at25 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨26, _⟩ => exact gasSteps_at26 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨27, _⟩ => exact gasSteps_at27 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨28, _⟩ => exact gasSteps_at28 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨29, _⟩ => exact gasSteps_at29 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨30, _⟩ => exact gasSteps_at30 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨31, _⟩ => exact gasSteps_at31 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨32, _⟩ => exact gasSteps_at32 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨33, _⟩ => exact gasSteps_at33 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨34, _⟩ => exact gasSteps_at34 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨35, _⟩ => exact gasSteps_at35 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨36, _⟩ => exact gasSteps_at36 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨37, _⟩ => exact gasSteps_at37 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨38, _⟩ => exact gasSteps_at38 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨39, _⟩ => exact gasSteps_at39 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨40, _⟩ => exact gasSteps_at40 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨41, _⟩ => exact gasSteps_at41 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨42, _⟩ => exact gasSteps_at42 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨43, _⟩ => exact gasSteps_at43 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨44, _⟩ => exact gasSteps_at44 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨45, _⟩ => exact gasSteps_at45 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨46, _⟩ => exact gasSteps_at46 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨47, _⟩ => exact gasSteps_at47 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨48, _⟩ => exact gasSteps_at48 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨49, _⟩ => exact gasSteps_at49 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨50, _⟩ => exact gasSteps_at50 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨51, _⟩ => exact gasSteps_at51 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨52, _⟩ => exact gasSteps_at52 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨53, _⟩ => exact gasSteps_at53 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨54, _⟩ => exact gasSteps_at54 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨55, _⟩ => exact gasSteps_at55 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨56, _⟩ => exact gasSteps_at56 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨57, _⟩ => exact gasSteps_at57 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨58, _⟩ => exact gasSteps_at58 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨59, _⟩ => exact gasSteps_at59 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨60, _⟩ => exact gasSteps_at60 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨61, _⟩ => exact gasSteps_at61 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨62, _⟩ => exact gasSteps_at62 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨63, _⟩ => exact gasSteps_at63 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨64, _⟩ => exact gasSteps_at64 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨65, _⟩ => exact gasSteps_at65 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨66, _⟩ => exact gasSteps_at66 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨67, _⟩ => exact gasSteps_at67 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨68, _⟩ => exact gasSteps_at68 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨69, _⟩ => exact gasSteps_at69 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨70, _⟩ => exact gasSteps_at70 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨71, _⟩ => exact gasSteps_at71 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨72, _⟩ => exact gasSteps_at72 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨73, _⟩ => exact gasSteps_at73 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨74, _⟩ => exact gasSteps_at74 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨75, _⟩ => exact gasSteps_at75 s h4 q right rho hs hr ha hz hcode hfork hnp
  | ⟨76, _⟩ => exact gasSteps_at76 s h4 q right rho hs hr ha hz hcode hfork hnp
...
def gasSteps_prefix (s : State) (h4 : UInt256) (n : Nat) (hn : n ≤ 77) (q right : WordLane) (rho : List UInt256)
  ...
  | succ n ih =>
    exact (ih (by omega)).trans
      (gasSteps_step s h4 ⟨n, by omega⟩ (fold (message s.memory) n q) right rho hs hr ha hz hcode hfork hnp)


def suffixState (s : State) (h4 : UInt256) (q : WordLane) (rho : List UInt256) : State :=
  {s with pc := UInt256.ofNat 4582, stack := stack s.memory h4 [ .b, .e, .a, .d, .cachedMessage 360, .k, .c, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 350, .cache 310, .cache 190, .cache 500 ] (epilogue s.memory q) q (UInt256.ofNat 2840853838) rho}
...
def gasSteps_pairedSuffix (s : State) (h4 : UInt256) (q right : WordLane) (rho : List UInt256)
  ...
  (gasSteps_prefix s h4 77 (by decide) q right rho hs hr ha hz hcode hfork hnp).trans
    (gasSteps_suffix s h4 (fold (message s.memory) 77 q) right rho hs hr ha hz hcode hfork hnp)

#print axioms gasSteps_step
#print axioms gasSteps_prefix
#print axioms gasSteps_suffix
#print axioms gasSteps_pairedSuffix
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PadPrefixCore
