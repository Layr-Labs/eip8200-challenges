...
def template : List Instr :=
  [ .op (.Swap ⟨0, by decide⟩),
    ...
    .op .XOR,
    .op .ADD,
    .push ⟨2, by decide⟩ (UInt256.ofNat 946),
    .op .MLOAD,
    .op .ADD,
    .op (.Dup ⟨8, by decide⟩),
    .op .ADD,
    .push ⟨13, by decide⟩ (UInt256.ofNat 1109194275457955143375908765732),
    .op (.Dup ⟨14, by decide⟩),
    .op (.Swap ⟨1, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op .AND,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23)),
    x.v0,
    x.v2,
    x.v3,
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mulMod (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 918) (UInt256.add (UInt256.xor (UInt256.xor x.v11 x.v9) (UInt256.xor x.v6 (UInt256.lor (UInt256.land x.v11 x.v6) x.v0))) x.v7)))) (UInt256.ofNat 1109194275457955143375908765732) x.v13) (UInt256.ofNat 21)))),
    (UInt256.ofNat 23),
    x.v8,
    x.v9,
    x.v10,
