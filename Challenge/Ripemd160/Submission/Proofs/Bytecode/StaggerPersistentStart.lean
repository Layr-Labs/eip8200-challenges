...
theorem initial_pc : initialSite.startPC = UInt256.ofNat 358 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 234) = UInt256.ofNat 358
...
theorem jump_pc : jumpSite.startPC = UInt256.ofNat 4763 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3647) = UInt256.ofNat 4763
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem round_pc : roundSite.startPC = UInt256.ofNat 4718 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3614) = UInt256.ofNat 4718
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
def gasSteps_entry (s : State) (stack : List UInt256) (hstack : stack.length ≤ 1000)
  ...
  · apply PadLift.advancesAll_sound; decide
  · simpa only [entryTemplate, show UInt256.ofNat 4737 + UInt256.ofNat 1 = UInt256.ofNat 4710 by decide] using
