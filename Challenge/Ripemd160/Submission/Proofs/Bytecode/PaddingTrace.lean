...
def lengthIterationPath : List
    (Challenge.EvmProof.DataStepper.Located Artifact.submissionArtifact .Osaka) :=
  [⟨3771, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3772, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3773, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3774, .op .MSTORE8, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3775, .push ⟨1, by decide⟩ (UInt256.ofNat 1), by rfl, by decide⟩,
   ⟨3776, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3777, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨3778, .push ⟨1, by decide⟩ (UInt256.ofNat 8), by rfl, by decide⟩,
