...
def lengthIterationPath : List
  ...
  [⟨378, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨384, .push ⟨1, by decide⟩ (UInt256.ofNat 255), by rfl, by decide⟩,
   ⟨385, .op (.Dup ⟨3, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨386, .op (.Dup ⟨2, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨387, .push ⟨1, by decide⟩ (UInt256.ofNat 3), by rfl, by decide⟩,
   ⟨388, .op .SHL, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨389, .op .SHR, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨390, .op .AND, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨391, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨392, .op (.Dup ⟨3, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨393, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨394, .op .MSTORE8, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨395, .push ⟨1, by decide⟩ (UInt256.ofNat 1), by rfl, by decide⟩,
   ⟨396, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨397, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨398, .op (.Swap ⟨0, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨399, .op .POP, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨400, .push ⟨2, by decide⟩ (UInt256.ofNat 0x209), by rfl, by decide⟩,
   ⟨401, .op .JUMP, by rfl, wfOp (by decide) trivial rfl⟩]
...
def lengthBytePath := (lengthIterationPath.drop 6).take 7
def lengthStorePath := (lengthIterationPath.drop 13).take 4
def lengthIncrementPath := (lengthIterationPath.drop 17).take 5
def lengthBackPath := lengthIterationPath.drop 22
...
def lengthByteState (input : ByteArray) (i : Nat) : State :=
  { lengthBodyState input i with
    pc := UInt256.ofNat (Artifact.instructionPC 391)
...
@[simp] private theorem lengthByteState_pc (input : ByteArray) (i : Nat) :
    (lengthByteState input i).pc = UInt256.ofNat 0x21b := by rfl
...
@[simp] private theorem lengthStoredState_pc (input : ByteArray) (i : Nat) :
    (lengthStoredState input i).pc = UInt256.ofNat 0x21f := by rfl
...
@[simp] private theorem lengthIncrementedState_pc (input : ByteArray) (i : Nat) :
    (lengthIncrementedState input i).pc = UInt256.ofNat 0x225 := by rfl
...
@[simp] private theorem lengthBackReady_pc (input : ByteArray) (i : Nat) :
    (lengthBackReady input i).pc = UInt256.ofNat 0x228 := by rfl
