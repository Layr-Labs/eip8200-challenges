...
theorem site_pc : site.startPC = UInt256.ofNat 788 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 496) = UInt256.ofNat 788
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 788) template = UInt256.ofNat 862 := by decide
  rw [hend] at hraw
