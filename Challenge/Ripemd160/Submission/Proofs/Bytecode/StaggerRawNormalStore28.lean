...
theorem site_pc : site.startPC = UInt256.ofNat 822 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 526) = UInt256.ofNat 822
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 822) template = UInt256.ofNat 883 := by decide
  rw [hend] at hraw
