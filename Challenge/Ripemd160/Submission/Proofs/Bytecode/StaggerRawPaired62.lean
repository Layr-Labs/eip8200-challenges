...
theorem site_pc : site.startPC = UInt256.ofNat 3825 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3122) = UInt256.ofNat 3825
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3825) template = UInt256.ofNat 3866 := by decide
  rw [hend] at hraw
