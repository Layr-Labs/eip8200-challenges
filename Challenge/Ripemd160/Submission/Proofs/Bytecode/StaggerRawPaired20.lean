...
theorem site_pc : site.startPC = UInt256.ofNat 2069 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1490) = UInt256.ofNat 2069
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2069) template = UInt256.ofNat 2110 := by decide
  rw [hend] at hraw
