...
theorem site_pc : site.startPC = UInt256.ofNat 1589 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1097) = UInt256.ofNat 1589
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1589) template = UInt256.ofNat 1628 := by decide
  rw [hend] at hraw
