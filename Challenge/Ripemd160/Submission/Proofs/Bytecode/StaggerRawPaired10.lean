...
theorem site_pc : site.startPC = UInt256.ofNat 1564 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1129) = UInt256.ofNat 1564
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1564) template = UInt256.ofNat 1603 := by decide
  rw [hend] at hraw
