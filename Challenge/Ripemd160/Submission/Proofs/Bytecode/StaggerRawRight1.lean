...
theorem site_pc : site.startPC = UInt256.ofNat 1168 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 605) = UInt256.ofNat 1168
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 1168) x rho hstack halias hkey hcache hrun hactive
  have hend : pcAfter (UInt256.ofNat 1168) template = UInt256.ofNat 1208 := by decide
  rw [hend] at hraw
