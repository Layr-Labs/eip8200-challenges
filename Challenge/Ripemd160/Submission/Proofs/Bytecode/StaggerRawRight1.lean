...
theorem site_pc : site.startPC = UInt256.ofNat 1036 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 530) = UInt256.ofNat 1036
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hraw := run_actual s (UInt256.ofNat 1036) x rho hstack halias hkey hcache hrun hactive
  have hend : pcAfter (UInt256.ofNat 1036) template = UInt256.ofNat 1076 := by decide
  rw [hend] at hraw
