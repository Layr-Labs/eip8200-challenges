...
theorem site_pc : site.startPC = UInt256.ofNat 896 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 503) = UInt256.ofNat 896
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 896) template = UInt256.ofNat 936 := by decide
  rw [hend] at hraw
