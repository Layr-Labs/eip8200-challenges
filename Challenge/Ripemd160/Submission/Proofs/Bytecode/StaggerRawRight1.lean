...
theorem site_pc : site.startPC = UInt256.ofNat 951 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 605) = UInt256.ofNat 951
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 951) template = UInt256.ofNat 981 := by decide
  rw [hend] at hraw
