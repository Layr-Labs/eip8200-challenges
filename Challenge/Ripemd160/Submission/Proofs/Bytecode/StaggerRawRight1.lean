...
theorem site_pc : site.startPC = UInt256.ofNat 1041 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 626) = UInt256.ofNat 1041
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1041) template = UInt256.ofNat 1073 := by decide
  rw [hend] at hraw
