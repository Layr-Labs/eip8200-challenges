...
theorem site_pc : site.startPC = UInt256.ofNat 3165 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2398) = UInt256.ofNat 3165
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3165) template = UInt256.ofNat 3197 := by decide
  rw [hend] at hraw
