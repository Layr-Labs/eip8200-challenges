...
theorem site_pc : site.startPC = UInt256.ofNat 2978 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2313) = UInt256.ofNat 2978
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2978) template = UInt256.ofNat 3010 := by decide
  rw [hend] at hraw
