...
theorem site_pc : site.startPC = UInt256.ofNat 2992 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2310) = UInt256.ofNat 2992
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2992) template = UInt256.ofNat 3024 := by decide
  rw [hend] at hraw
