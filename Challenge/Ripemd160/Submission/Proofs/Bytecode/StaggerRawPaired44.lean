...
theorem site_pc : site.startPC = UInt256.ofNat 3096 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2369) = UInt256.ofNat 3096
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3096) template = UInt256.ofNat 3129 := by decide
  rw [hend] at hraw
