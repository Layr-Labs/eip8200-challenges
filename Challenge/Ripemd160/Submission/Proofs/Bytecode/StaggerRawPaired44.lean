...
theorem site_pc : site.startPC = UInt256.ofNat 3093 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2414) = UInt256.ofNat 3097
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3093) template = UInt256.ofNat 3125 := by decide
  rw [hend] at hraw
