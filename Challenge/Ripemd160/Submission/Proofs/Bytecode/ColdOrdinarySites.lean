...
theorem normal_pc : normalSite.startPC = UInt256.ofNat 487 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 257) = UInt256.ofNat 487
...
theorem normal_end : pcAfter (UInt256.ofNat 487) actualNormalTemplate = UInt256.ofNat 860 := by decide
...
def gasSteps_normal (s : State) (ret a2 a3 a4 a5 a6 a7 a8 a9 a10 off lim : UInt256)
  ...
  have h := PersistentMaskEndian.run_normal s (UInt256.ofNat 487) ret a2 a3 a4 a5 a6 a7 a8 a9 a10 off lim rho p hstack hrun hp hbound hq1 hq0
  have hend : pcAfter (UInt256.ofNat 487) PersistentMaskEndian.normalTemplate = UInt256.ofNat 860 := by decide
  rw [hend] at h
  exact h
