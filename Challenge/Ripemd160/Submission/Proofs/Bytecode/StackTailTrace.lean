...
/-!
# Located H18 final-combination trace

The raw tail theorem is lifted through the exact H18 artifact.  The path starts
at instruction 1966 and ends at instruction 2026.  The 448 helper instructions
...
private theorem tailAfter_length : tailAfter.length = 448 := by
  simp [tailAfter]
