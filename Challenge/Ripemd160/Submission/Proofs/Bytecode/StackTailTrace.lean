...
at instruction 1966 and ends at instruction 2026.  The 559 instructions after
the tail remain in the artifact suffix.
-/
...
private theorem tailAfter_length : tailAfter.length = 559 := by
  simp [tailAfter]
