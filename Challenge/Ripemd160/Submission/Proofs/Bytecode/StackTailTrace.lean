...
/-!
# Located H14 final-combination trace

The raw tail theorem is lifted through the exact H14 artifact.  The path starts
at instruction 1966 and ends at instruction 2026.  The 486 helper instructions
...
private theorem tailAfter_length : tailAfter.length = 486 := by
  simp [tailAfter]
