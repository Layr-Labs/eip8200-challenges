...
/-!
# Located H12 final-combination trace

The raw tail theorem is lifted through the exact H12 artifact.  The path starts
at instruction 1966 and ends at instruction 2026.  The 556 helper instructions
...
private theorem tailAfter_length : tailAfter.length = 556 := by
  simp [tailAfter]
