...
theorem post_pc : postSite.startPC = UInt256.ofNat 4648 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3515) = UInt256.ofNat 4648
...
def gasSteps_bound (s : State) (h : Compression.HashState) (off limit : UInt256)
  ...
  · have hr := run_exit s (UInt256.ofNat 4626) h off limit rho 508 (by omega) hrun hhit
    have he : pcAfter (UInt256.ofNat 4648) (StaggerPersistentLoopRaw.template 508) = UInt256.ofNat 4660 := by decide
    rw [he] at hr
    exact hr
