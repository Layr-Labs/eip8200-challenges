import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 2434 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1906) = UInt256.ofNat 2434
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 2434) template = UInt256.ofNat 2479 := by decide
   rw [hend] at hraw
