import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 2428 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1916) = UInt256.ofNat 2428
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 2428) template = UInt256.ofNat 2473 := by decide
   rw [hend] at hraw
