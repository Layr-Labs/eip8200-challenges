...
theorem output_eq (memory : ByteArray) (q right : WordLane) (rho : List UInt256) :
    StaggerRawUnpack.outputStack memory (input memory q right (StaggerAlgorithm.physicalKey 76)) rho =
      stack memory [ .k, .c, .d, .e, .a, .b, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 190, .cache 310, .cache 350, .cache 500, .cache 230 ] (StaggerCoreModel.left q) (q) (UInt256.ofNat 2840853838) rho := by
...
def gasSteps (s : State) (q right : WordLane) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4471, stack := stack s.memory [ .d, .pair, .upper, .e, .c, .a, .k, .b, .factor, .lower, .cache 140, .cache 190, .cache 310, .cache 350, .cache 500, .cache 230 ] q right (StaggerAlgorithm.physicalKey 76) rho}
      {s with pc := UInt256.ofNat 4491, stack := stack s.memory [ .k, .c, .d, .e, .a, .b, .er, .cr, .ar, .dr, .br, .factor, .lower, .cache 140, .cache 190, .cache 310, .cache 350, .cache 500, .cache 230 ] (StaggerCoreModel.left q) (q) (UInt256.ofNat 2840853838) rho} := by
