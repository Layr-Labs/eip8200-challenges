...
def callPath : List Located :=
  [⟨882, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨887, .push ⟨2, by decide⟩ (UInt256.ofNat 4899), by rfl, by decide⟩,
...
def postCheckPath : List Located :=
  [⟨874, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨880, .push ⟨2, by decide⟩ (UInt256.ofNat 4773), by rfl, by decide⟩,
...
theorem run_call (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1323 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3382 (by rfl)
...
theorem run_postCheck_exit (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x12a5 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3334 (by rfl)
  simp [postCheckPath, Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
