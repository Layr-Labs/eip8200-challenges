...
def callPath : List Located :=
  [⟨239, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨240, .push ⟨2, by decide⟩ (UInt256.ofNat 421), by rfl, by decide⟩,
   ⟨241, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨242, .push ⟨2, by decide⟩ (UInt256.ofNat Padding.messageOffset),
      by rfl, by decide⟩,
...
def postCheckPath : List Located :=
  [⟨231, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨232, .push ⟨1, by decide⟩ (UInt256.ofNat 64), by rfl, by decide⟩,
   ...
   ⟨236, .op .EQ, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨237, .push ⟨2, by decide⟩ (UInt256.ofNat 5174), by rfl, by decide⟩,
   ⟨238, .op .JUMPI, by rfl, wfOp (by decide) trivial rfl⟩]

@[simp] private theorem pc785 : Artifact.submissionArtifact.instructionPC 231 = 0x1a5 := by decide
@[simp] private theorem pc786 : Artifact.submissionArtifact.instructionPC 232 = 0x1a6 := by decide
@[simp] private theorem pc787 : Artifact.submissionArtifact.instructionPC 233 = 0x1a8 := by decide
@[simp] private theorem pc788 : Artifact.submissionArtifact.instructionPC 234 = 0x1a9 := by decide
@[simp] private theorem pc789 : Artifact.submissionArtifact.instructionPC 235 = 0x1aa := by decide
@[simp] private theorem pc790 : Artifact.submissionArtifact.instructionPC 236 = 0x1ab := by decide
@[simp] private theorem pc791 : Artifact.submissionArtifact.instructionPC 237 = 0x1ac := by decide
@[simp] private theorem pc792 : Artifact.submissionArtifact.instructionPC 238 = 0x1af := by decide
@[simp] private theorem pc793 : Artifact.submissionArtifact.instructionPC 239 = 0x1b0 := by decide
@[simp] private theorem pc794 : Artifact.submissionArtifact.instructionPC 240 = 0x1b1 := by decide
@[simp] private theorem pc795 : Artifact.submissionArtifact.instructionPC 241 = 0x1b4 := by decide
@[simp] private theorem pc796 : Artifact.submissionArtifact.instructionPC 242 = 0x1b5 := by decide
@[simp] private theorem pc797 : Artifact.submissionArtifact.instructionPC 243 = 0x1b8 := by decide
...
def dispatchEntry (s : State) (input : ByteArray) (i : Nat) : State :=
  { s with
    ...
    stack := [messageOffsetWord i, UInt256.ofNat 0x1a5,
...
theorem run_postCheck_exit (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1436 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 3581 (by rfl)
  simp [postCheckPath, Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
