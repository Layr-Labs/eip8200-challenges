...
def callPath : List Located :=
  [⟨271, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨272, .push ⟨2, by decide⟩ (UInt256.ofNat 466), by rfl, by decide⟩,
...
def postCheckPath : List Located :=
  [⟨263, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨269, .push ⟨2, by decide⟩ (UInt256.ofNat 5170), by rfl, by decide⟩,
   ⟨270, .op .JUMPI, by rfl, wfOp (by decide) trivial rfl⟩]

@[simp] private theorem pc785 : Artifact.submissionArtifact.instructionPC 263 = 0x1d2 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc786 : Artifact.submissionArtifact.instructionPC 264 = 0x1d3 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc787 : Artifact.submissionArtifact.instructionPC 265 = 0x1d5 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc788 : Artifact.submissionArtifact.instructionPC 266 = 0x1d6 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc789 : Artifact.submissionArtifact.instructionPC 267 = 0x1d7 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc790 : Artifact.submissionArtifact.instructionPC 268 = 0x1d8 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc791 : Artifact.submissionArtifact.instructionPC 269 = 0x1d9 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc792 : Artifact.submissionArtifact.instructionPC 270 = 0x1dc := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc793 : Artifact.submissionArtifact.instructionPC 271 = 0x1dd := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc794 : Artifact.submissionArtifact.instructionPC 272 = 0x1de := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc795 : Artifact.submissionArtifact.instructionPC 273 = 0x1e1 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc796 : Artifact.submissionArtifact.instructionPC 274 = 0x1e2 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc797 : Artifact.submissionArtifact.instructionPC 275 = 0x1e5 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
...
def dispatchEntry (s : State) (input : ByteArray) (i : Nat) : State :=
  { s with
    pc := UInt256.ofNat 0x1e6
    stack := [messageOffsetWord i, UInt256.ofNat 0x1d2,
...
theorem padReturned_blockSeparated (input : ByteArray)
    ...
    (hi : i < blockCount input) :
    ∀ k, k < 16 →
      0x200 ≤ (Schedule.loadOffsetWord (messageOffsetWord i) k).toNat := by
  simpa [messageOffsetWord, blockOffset, blockCount] using
...
theorem run_postCheck_exit (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1432 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 4480 (by rfl)
  simp [postCheckPath, Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
