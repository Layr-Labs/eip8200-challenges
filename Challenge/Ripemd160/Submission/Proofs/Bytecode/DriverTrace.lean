...
def callPath : List Located :=
  [⟨888, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨893, .push ⟨2, by decide⟩ (UInt256.ofNat 0x12a7), by rfl, by decide⟩,
...
def postCheckPath : List Located :=
  [⟨880, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨886, .push ⟨2, by decide⟩ (UInt256.ofNat 0x11ed), by rfl, by decide⟩,
...
theorem run_call (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x12a7 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2884 (by rfl)
...
theorem run_postCheck_exit (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x11ed = true :=
