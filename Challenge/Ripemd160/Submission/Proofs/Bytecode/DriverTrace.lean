...
def conditionPath : List Located :=
  [⟨704, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ...
   ⟨708, .push ⟨2, by decide⟩ (UInt256.ofNat 0x139f), by rfl, by decide⟩,
...
def callPath : List Located :=
  [⟨710, .push ⟨2, by decide⟩ (UInt256.ofNat 0x436), by rfl, by decide⟩,
   ...
   ⟨714, .push ⟨2, by decide⟩ (UInt256.ofNat 0x1459), by rfl, by decide⟩,
...
theorem run_condition_exit (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x139f = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2709 (by rfl)
  simp [conditionPath, Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
...
theorem run_call (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1459 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 2759 (by rfl)
