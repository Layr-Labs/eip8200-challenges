...
def callPath : List Located :=
  [⟨270, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨271, .push ⟨2, by decide⟩ (UInt256.ofNat 461), by rfl, by decide⟩,
   ⟨272, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨273, .push ⟨2, by decide⟩ (UInt256.ofNat Padding.messageOffset),
      by rfl, by decide⟩,
   ⟨274, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩]

def postCheckPath : List Located :=
  [⟨262, .op .JUMPDEST, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨263, .push ⟨1, by decide⟩ (UInt256.ofNat 64), by rfl, by decide⟩,
   ⟨264, .op .ADD, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨265, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨266, .op (.Dup ⟨1, by decide⟩), by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨267, .op .EQ, by rfl, wfOp (by decide) trivial rfl⟩,
   ⟨268, .push ⟨2, by decide⟩ (UInt256.ofNat 4963), by rfl, by decide⟩,
   ⟨269, .op .JUMPI, by rfl, wfOp (by decide) trivial rfl⟩]

@[simp] private theorem pc785 : Artifact.submissionArtifact.instructionPC 262 = 0x1cd := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc786 : Artifact.submissionArtifact.instructionPC 263 = 0x1ce := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc787 : Artifact.submissionArtifact.instructionPC 264 = 0x1d0 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc788 : Artifact.submissionArtifact.instructionPC 265 = 0x1d1 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc789 : Artifact.submissionArtifact.instructionPC 266 = 0x1d2 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc790 : Artifact.submissionArtifact.instructionPC 267 = 0x1d3 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc791 : Artifact.submissionArtifact.instructionPC 268 = 0x1d4 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc792 : Artifact.submissionArtifact.instructionPC 269 = 0x1d7 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc793 : Artifact.submissionArtifact.instructionPC 270 = 0x1d8 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc794 : Artifact.submissionArtifact.instructionPC 271 = 0x1d9 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc795 : Artifact.submissionArtifact.instructionPC 272 = 0x1dc := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc796 : Artifact.submissionArtifact.instructionPC 273 = 0x1dd := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc797 : Artifact.submissionArtifact.instructionPC 274 = 0x1e0 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc798 : Artifact.submissionArtifact.instructionPC 275 = 0x1e1 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
@[simp] private theorem pc799 : Artifact.submissionArtifact.instructionPC 275 = 0x1e1 := by rw [Challenge.Ripemd160.Submission.Proofs.Bytecode.ArtifactByteLength.instructionPC_eq_byteLength]; rfl
...
def dispatchEntry (s : State) (input : ByteArray) (i : Nat) : State :=
  { s with
    ...
    stack := [messageOffsetWord i, UInt256.ofNat 0x1cd,
...
theorem run_postCheck_exit (s : State) (input : ByteArray)
  ...
  have hdest : Decode.isValidJumpDest submissionBytecode 0x1363 = true :=
    Artifact.submissionArtifact.isValidJumpDest_index 4032 (by rfl)
  simp [postCheckPath, Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
