...
theorem wordSet_cost_potential (s : State)
    ...
    (TableTrace.gasSteps_wordSet s base i value returnDest rest hstack hcode
      hfork hrun hnp hvalid hvalue).cost + MachineState.memCost s.activeWords.toNat =
  ...
  have hraw := blockCost_potential TableTrace.hSetPath
    ...
    (TableTrace.run_wordSet s base i value returnDest rest hstack hcode hrun hvalid hvalue)
