...
theorem site_pc : site.startPC = UInt256.ofNat 2881 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2276) = UInt256.ofNat 2881
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2881) template = UInt256.ofNat 2912 := by decide
  rw [hend] at hraw
