...
theorem site_pc : site.startPC = UInt256.ofNat 2944 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2236) = UInt256.ofNat 2944
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2944) template = UInt256.ofNat 2978 := by decide
  rw [hend] at hraw
