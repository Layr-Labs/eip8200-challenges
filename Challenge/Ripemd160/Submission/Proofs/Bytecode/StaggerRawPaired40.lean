...
theorem site_pc : site.startPC = UInt256.ofNat 2839 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2184) = UInt256.ofNat 2839
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2839) template = UInt256.ofNat 2869 := by decide
  rw [hend] at hraw
