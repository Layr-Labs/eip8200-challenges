...
theorem site_pc : site.startPC = UInt256.ofNat 2976 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2272) = UInt256.ofNat 2976
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2976) template = UInt256.ofNat 3006 := by decide
  rw [hend] at hraw
