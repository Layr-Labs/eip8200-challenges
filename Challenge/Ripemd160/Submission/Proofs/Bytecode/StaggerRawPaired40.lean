...
theorem site_pc : site.startPC = UInt256.ofNat 2988 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2224) = UInt256.ofNat 2988
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2988) template = UInt256.ofNat 3022 := by decide
  rw [hend] at hraw
