...
theorem site_pc : site.startPC = UInt256.ofNat 2842 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2183) = UInt256.ofNat 2842
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2842) template = UInt256.ofNat 2872 := by decide
  rw [hend] at hraw
