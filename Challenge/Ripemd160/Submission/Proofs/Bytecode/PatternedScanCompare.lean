...
def gasSteps_compare_more_sym (input : ByteArray) (W S sv ov acc : UInt256) (hc : UInt256.isTrue (UInt256.gt (992 : UInt256) ((32 : UInt256) + ov))) :
  ...
  have step2945 := soundS (opAt 2945 (.Dup ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 2945 5179 [sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2945)
      (stepS_dup input 5179 0 (by decide) [sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (sv) (by rfl) (by simp) (by norm_num)))
  have step2946 := soundS (pushAt 2946 1 0xa0)
    (blockOfS _ (pcFactS input 2946 5180 [sv, sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2946)
      (stepS_push input 5180 1 (160 : UInt256) [sv, sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have step2947 := soundS (opAt 2947 .ADD)
    (blockOfS _ (pcFactS input 2947 5182 [(160 : UInt256), sv, sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2947)
      (stepS_add input 5182 ((160 : UInt256)) (sv) [sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2948 := soundS (pushAt 2948 1 0xff)
    (blockOfS _ (pcFactS input 2948 5183 [((160 : UInt256) + sv), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2948)
      (stepS_push input 5183 1 (255 : UInt256) [((160 : UInt256) + sv), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have step2949 := soundS (opAt 2949 .AND)
    (blockOfS _ (pcFactS input 2949 5185 [(255 : UInt256), ((160 : UInt256) + sv), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2949)
      (stepS_and input 5185 ((255 : UInt256)) (((160 : UInt256) + sv)) [sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2950 := soundS (opAt 2950 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 2950 5186 [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2950)
      (stepS_swap input 5186 0 (by decide) [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] [sv, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by rfl) (by simp) (by norm_num)))
  have step2951 := soundS (opAt 2951 .POP)
    (blockOfS _ (pcFactS input 2951 5187 [sv, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2951)
      (stepS_pop input 5187 (sv) [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2952 := soundS (opAt 2952 (.Dup ⟨1, by decide⟩))
  ...
  have step2953 := soundS (pushAt 2953 1 0x20)
    (blockOfS _ (pcFactS input 2953 5189 [ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2953)
  ...
  have step2954 := soundS (opAt 2954 .ADD)
    (blockOfS _ (pcFactS input 2954 5191 [(32 : UInt256), ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2954)
  ...
  have step2955 := soundS (opAt 2955 (.Swap ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 2955 5192 [((32 : UInt256) + ov), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2955)
  ...
  have step2956 := soundS (opAt 2956 .POP)
    (blockOfS _ (pcFactS input 2956 5193 [ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2956)
