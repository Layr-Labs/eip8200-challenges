...
theorem hdest5144 : Decode.isValidJumpDest submissionBytecode 0x13d0 = true :=
  Artifact.submissionArtifact.isValidJumpDest_index 3385 (by rfl)
...
def gasSteps_compare_more_sym (input : ByteArray) (W S sv ov acc : UInt256) (hc : UInt256.isTrue (UInt256.gt (992 : UInt256) ((32 : UInt256) + ov))) :
  ...
  have step2936 := soundS (opAt 3407 .JUMPDEST)
    (blockOfS _ (pcFactS input 3407 0x13ea [W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2936)
      (stepS_jumpdest input 0x13ea [W, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2937 := soundS (opAt 3408 (.Dup ⟨3, by decide⟩))
    (blockOfS _ (pcFactS input 3408 0x13eb [W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2937)
      (stepS_dup input 0x13eb 3 (by decide) [W, S, sv, ov, acc, P7, M, m7, P, m8] (ov) (by rfl) (by simp) (by norm_num)))
  have step2938 := soundS (opAt 3409 .CALLDATALOAD)
    (blockOfS _ (pcFactS input 3409 0x13ec [ov, W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2938)
      (stepS_calldataload input 0x13ec (ov) [W, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2939 := soundS (opAt 3410 .XOR)
    (blockOfS _ (pcFactS input 3410 0x13ed [(MachineState.readWord input (ov).toNat), W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2939)
      (stepS_xor input 0x13ed ((MachineState.readWord input (ov).toNat)) (W) [S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2940 := soundS (opAt 3411 (.Dup ⟨4, by decide⟩))
    (blockOfS _ (pcFactS input 3411 0x13ee [(UInt256.xor (MachineState.readWord input (ov).toNat) W), S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2940)
  ...
  have step2941 := soundS (opAt 3412 .OR)
    (blockOfS _ (pcFactS input 3412 0x13ef [acc, (UInt256.xor (MachineState.readWord input (ov).toNat) W), S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2941)
  ...
  have step2942 := soundS (opAt 3413 (.Swap ⟨3, by decide⟩))
    (blockOfS _ (pcFactS input 3413 0x13f0 [(UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2942)
  ...
  have step2943 := soundS (opAt 3414 .POP)
    (blockOfS _ (pcFactS input 3414 0x13f1 [acc, S, sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2943)
  ...
  have step2944 := soundS (opAt 3415 .POP)
    (blockOfS _ (pcFactS input 3415 0x13f2 [S, sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2944)
  ...
  have step2945 := soundS (opAt 3416 .JUMPDEST)
    (blockOfS _ (pcFactS input 3416 0x13f3 [sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2945)
  ...
  have step2946 := soundS (pushAt 3417 1 160)
    (blockOfS _ (pcFactS input 3417 0x13f4 [sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2946)
  ...
  have step2947 := soundS (opAt 3418 .ADD)
    (blockOfS _ (pcFactS input 3418 0x13f6 [(160 : UInt256), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2947)
  ...
  have step2948 := soundS (pushAt 3419 1 255)
    (blockOfS _ (pcFactS input 3419 0x13f7 [((160 : UInt256) + sv), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2948)
  ...
  have step2949 := soundS (opAt 3420 .AND)
    (blockOfS _ (pcFactS input 3420 0x13f9 [(255 : UInt256), ((160 : UInt256) + sv), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2949)
  ...
  have step2950 := soundS (opAt 3421 .JUMPDEST)
    (blockOfS _ (pcFactS input 3421 0x13fa [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2950)
  ...
  have step2951 := soundS (opAt 3422 .JUMPDEST)
    (blockOfS _ (pcFactS input 3422 0x13fb [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2951)
  ...
  have step2952 := soundS (opAt 3423 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 3423 0x13fc [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2952)
  ...
  have step2953 := soundS (pushAt 3424 1 32)
    (blockOfS _ (pcFactS input 3424 0x13fd [ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2953)
  ...
  have step2954 := soundS (opAt 3425 .ADD)
    (blockOfS _ (pcFactS input 3425 0x13ff [(32 : UInt256), ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2954)
  ...
  have step2955 := soundS (opAt 3426 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 3426 0x1400 [((32 : UInt256) + ov), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2955)
  ...
  have step2956 := soundS (opAt 3427 .JUMPDEST)
    (blockOfS _ (pcFactS input 3427 0x1401 [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2956)
  ...
  have step2957 := soundS (opAt 3428 (.Dup ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 3428 0x1402 [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2957)
  ...
  have step2958 := soundS (pushAt 3429 2 992)
    (blockOfS _ (pcFactS input 3429 0x1403 [((32 : UInt256) + ov), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2958)
  ...
  have step2959 := soundS (opAt 3430 .GT)
    (blockOfS _ (pcFactS input 3430 0x1406 [(992 : UInt256), ((32 : UInt256) + ov), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2959)
  ...
  have step2960 := soundS (pushAt 3431 2 5072)
    (blockOfS _ (pcFactS input 3431 0x1407 [(UInt256.gt (992 : UInt256) ((32 : UInt256) + ov)), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2960)
  ...
  have step2961 := soundS (opAt 3432 .JUMPI)
    (blockOfS _ (pcFactS input 3432 0x140a [(5072 : UInt256), (UInt256.gt (992 : UInt256) ((32 : UInt256) + ov)), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2961)
