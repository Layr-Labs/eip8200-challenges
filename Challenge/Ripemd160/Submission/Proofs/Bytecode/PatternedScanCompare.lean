...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
  ...
  have pos200 : Artifact.submissionArtifact.instructionPC 126 = 243 := by
  ...
  have pos201 : Artifact.submissionArtifact.instructionPC 127 = 244 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos202 : Artifact.submissionArtifact.instructionPC 128 = 245 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos203 : Artifact.submissionArtifact.instructionPC 129 = 246 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos204 : Artifact.submissionArtifact.instructionPC 130 = 247 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step204 := soundS (pushAt 136 5 4446160832)
    (blockOfS _ (pcFactS input 136 221 [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos204)
      (stepS_push input 219 5 (4446160832 : UInt256) [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos205 : Artifact.submissionArtifact.instructionPC 131 = 253 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step205 := soundS (opAt 137 (.Dup ⟨4, by decide⟩))
    (blockOfS _ (pcFactS input 137 222 [(4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos205)
      (stepS_dup input 225 4 (by decide) [(4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] ov (by rfl) (by simp) (by norm_num)))
  have pos206 : Artifact.submissionArtifact.instructionPC 132 = 254 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step206 := soundS (opAt 138 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 138 225 [ov, (4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos206)
      (stepS_calldatasize input 226 [ov, (4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos207 : Artifact.submissionArtifact.instructionPC 133 = 255 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step207 := soundS (opAt 139 .SUB)
    (blockOfS _ (pcFactS input 139 226 [v2, ov, (4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos207)
      (stepS_sub input 227 v2 ov [(4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have posX0 : Artifact.submissionArtifact.instructionPC 134 = 256 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have stepX0 := soundS (pushAt 140 1 2)
    (blockOfS _ (pcFactS input 140 227 [v3, (4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) posX0)
      (stepS_push input 228 1 2 [v3, (4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have posX1 : Artifact.submissionArtifact.instructionPC 135 = 258 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have stepX1 := soundS (opAt 141 .XOR)
    (blockOfS _ (pcFactS input 141 228 [2, v3, (4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) posX1)
      (stepS_xor input 230 2 v3 [(4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos208 : Artifact.submissionArtifact.instructionPC 136 = 259 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step208 := soundS (opAt 142 .SHR)
    (blockOfS _ (pcFactS input 142 229 [vx, (4446160832 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos208)
      (stepS_shr input 231 vx (4446160832 : UInt256) [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos209 : Artifact.submissionArtifact.instructionPC 137 = 260 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step209 := soundS (pushAt 143 1 248)
    (blockOfS _ (pcFactS input 143 230 [v4, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos209)
      (stepS_push input 232 1 (248 : UInt256) [v4, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos210 : Artifact.submissionArtifact.instructionPC 138 = 262 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step210 := soundS (opAt 144 .AND)
    (blockOfS _ (pcFactS input 144 231 [(248 : UInt256), v4, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos210)
      (stepS_and input 234 (248 : UInt256) v4 [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos211 : Artifact.submissionArtifact.instructionPC 139 = 263 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step211 := soundS (opAt 145 .SHR)
    (blockOfS _ (pcFactS input 145 232 [v5, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos211)
      (stepS_shr input 235 v5 v1 [S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos212 : Artifact.submissionArtifact.instructionPC 140 = 264 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step212 := soundS (opAt 146 (.Dup ⟨4, by decide⟩))
    (blockOfS _ (pcFactS input 146 233 [v6, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos212)
      (stepS_dup input 236 4 (by decide) [v6, S, sv, ov, acc, P7, M, m7, P, m8] acc (by rfl) (by simp) (by norm_num)))
  have pos213 : Artifact.submissionArtifact.instructionPC 141 = 265 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step213 := soundS (opAt 147 .OR)
    (blockOfS _ (pcFactS input 147 234 [acc, v6, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos213)
      (stepS_or input 237 acc v6 [S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos214 : Artifact.submissionArtifact.instructionPC 142 = 266 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step214 := soundS (opAt 148 (.Swap ⟨3, by decide⟩))
    (blockOfS _ (pcFactS input 148 235 [v7, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos214)
      (stepS_swap input 238 3 (by decide) [v7, S, sv, ov, acc, P7, M, m7, P, m8] [acc, S, sv, ov, v7, P7, M, m7, P, m8] (by rfl) (by simp) (by norm_num)))
  have pos215 : Artifact.submissionArtifact.instructionPC 143 = 267 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step215 := soundS (opAt 149 .POP)
    (blockOfS _ (pcFactS input 149 236 [acc, S, sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos215)
      (stepS_pop input 239 acc [S, sv, ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos216 : Artifact.submissionArtifact.instructionPC 144 = 268 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step216 := soundS (opAt 150 .POP)
    (blockOfS _ (pcFactS input 150 239 [S, sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos216)
      (stepS_pop input 240 S [sv, ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos217 : Artifact.submissionArtifact.instructionPC 145 = 269 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step217 := soundS (pushAt 151 1 160)
    (blockOfS _ (pcFactS input 151 240 [sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos217)
      (stepS_push input 241 1 (160 : UInt256) [sv, ov, v7, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos218 : Artifact.submissionArtifact.instructionPC 146 = 271 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step218 := soundS (opAt 152 .ADD)
    (blockOfS _ (pcFactS input 152 241 [(160 : UInt256), sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos218)
      (stepS_add input 243 (160 : UInt256) sv [ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos219 : Artifact.submissionArtifact.instructionPC 147 = 272 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step219 := soundS (pushAt 153 1 255)
    (blockOfS _ (pcFactS input 153 242 [v8, ov, v7, P7, M, m7, P, m8] (by norm_num) pos219)
      (stepS_push input 244 1 (255 : UInt256) [v8, ov, v7, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos220 : Artifact.submissionArtifact.instructionPC 148 = 274 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step220 := soundS (opAt 154 .AND)
    (blockOfS _ (pcFactS input 154 243 [(255 : UInt256), v8, ov, v7, P7, M, m7, P, m8] (by norm_num) pos220)
      (stepS_and input 246 (255 : UInt256) v8 [ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos221 : Artifact.submissionArtifact.instructionPC 149 = 275 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step221 := soundS (opAt 155 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 155 244 [v9, ov, v7, P7, M, m7, P, m8] (by norm_num) pos221)
      (stepS_swap input 247 0 (by decide) [v9, ov, v7, P7, M, m7, P, m8] [ov, v9, v7, P7, M, m7, P, m8] (by rfl) (by simp) (by norm_num)))
  have pos222 : Artifact.submissionArtifact.instructionPC 150 = 276 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step222 := soundS (pushAt 156 1 32)
    (blockOfS _ (pcFactS input 156 245 [ov, v9, v7, P7, M, m7, P, m8] (by norm_num) pos222)
      (stepS_push input 248 1 (32 : UInt256) [ov, v9, v7, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos223 : Artifact.submissionArtifact.instructionPC 151 = 278 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step223 := soundS (opAt 157 .ADD)
    (blockOfS _ (pcFactS input 157 246 [(32 : UInt256), ov, v9, v7, P7, M, m7, P, m8] (by norm_num) pos223)
      (stepS_add input 250 (32 : UInt256) ov [v9, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos224 : Artifact.submissionArtifact.instructionPC 152 = 279 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step224 := soundS (opAt 158 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 158 247 [v10, v9, v7, P7, M, m7, P, m8] (by norm_num) pos224)
...
theorem scalar_step (s k : Nat) (hs : s < 256)
  ...
  have h255 : (255 : UInt256) = UInt256.ofNat 283 := rfl
  have h160 : (160 : UInt256) = UInt256.ofNat 188 := rfl
  rw [h255, h160,
