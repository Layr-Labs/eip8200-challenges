...
def gasSteps_compare_more_sym (input : ByteArray) (W S sv ov acc : UInt256) (hc : UInt256.isTrue (UInt256.gt (992 : UInt256) ((32 : UInt256) + ov))) :
  ...
  have step2945 := soundS (opAt 2932 (.Dup ⟨0, by decide⟩))
  ...
  have step2946 := soundS (pushAt 2933 1 0xa0)
    (blockOfS _ (pcFactS input 2933 5247 [sv, sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2946)
  ...
  have step2947 := soundS (opAt 2934 .ADD)
    (blockOfS _ (pcFactS input 2934 5249 [(160 : UInt256), sv, sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2947)
  ...
  have step2948 := soundS (pushAt 2935 1 0xff)
    (blockOfS _ (pcFactS input 2935 5250 [((160 : UInt256) + sv), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2948)
  ...
  have step2949 := soundS (opAt 2936 .AND)
    (blockOfS _ (pcFactS input 2936 5252 [(255 : UInt256), ((160 : UInt256) + sv), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2949)
  ...
  have step2950 := soundS (opAt 2937 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 2937 5253 [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), sv, ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2950)
  ...
  have step2951 := soundS (opAt 2938 .POP)
    (blockOfS _ (pcFactS input 2938 5254 [sv, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2951)
  ...
  have step2952 := soundS (opAt 2939 (.Dup ⟨1, by decide⟩))
  ...
  have step2953 := soundS (pushAt 2940 1 0x20)
    (blockOfS _ (pcFactS input 2940 5256 [ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2953)
  ...
  have step2954 := soundS (opAt 2941 .ADD)
    (blockOfS _ (pcFactS input 2941 5258 [(32 : UInt256), ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2954)
  ...
  have step2955 := soundS (opAt 2942 (.Swap ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 2942 5259 [((32 : UInt256) + ov), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ov, (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2955)
  ...
  have step2956 := soundS (opAt 2943 .POP)
    (blockOfS _ (pcFactS input 2943 5260 [ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2956)
