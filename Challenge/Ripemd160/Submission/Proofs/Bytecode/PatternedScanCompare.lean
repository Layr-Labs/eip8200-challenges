...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
  ...
  have pos200 : Artifact.submissionArtifact.instructionPC 129 = 246 := by
  ...
  have pos201 : Artifact.submissionArtifact.instructionPC 130 = 247 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos202 : Artifact.submissionArtifact.instructionPC 131 = 248 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos203 : Artifact.submissionArtifact.instructionPC 132 = 249 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos204 : Artifact.submissionArtifact.instructionPC 133 = 251 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos205 : Artifact.submissionArtifact.instructionPC 134 = 252 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos206 : Artifact.submissionArtifact.instructionPC 135 = 255 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos207 : Artifact.submissionArtifact.instructionPC 136 = 256 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have posX0 : Artifact.submissionArtifact.instructionPC 137 = 257 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have posX1 : Artifact.submissionArtifact.instructionPC 138 = 258 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos208 : Artifact.submissionArtifact.instructionPC 139 = 259 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos209 : Artifact.submissionArtifact.instructionPC 140 = 260 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos210 : Artifact.submissionArtifact.instructionPC 141 = 261 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos211 : Artifact.submissionArtifact.instructionPC 142 = 262 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos212 : Artifact.submissionArtifact.instructionPC 143 = 263 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos213 : Artifact.submissionArtifact.instructionPC 144 = 264 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos214 : Artifact.submissionArtifact.instructionPC 145 = 265 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos215 : Artifact.submissionArtifact.instructionPC 146 = 266 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos216 : Artifact.submissionArtifact.instructionPC 147 = 269 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos217 : Artifact.submissionArtifact.instructionPC 148 = 270 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos218 : Artifact.submissionArtifact.instructionPC 149 = 271 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos219 : Artifact.submissionArtifact.instructionPC 150 = 272 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos220 : Artifact.submissionArtifact.instructionPC 151 = 273 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos221 : Artifact.submissionArtifact.instructionPC 152 = 274 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos222 : Artifact.submissionArtifact.instructionPC 153 = 275 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos223 : Artifact.submissionArtifact.instructionPC 154 = 276 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos224 : Artifact.submissionArtifact.instructionPC 155 = 277 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
