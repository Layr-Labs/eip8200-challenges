...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
    GasSteps (stS input 210 [W, S, sv, ov, acc, P7, M, m7, P, m8])
  ...
  have pos200 : Artifact.submissionArtifact.instructionPC 127 = 210 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step200 := soundS (opAt 127 .JUMPDEST)
    (blockOfS _ (pcFactS input 127 210 [W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos200)
      (stepS_jumpdest input 210 [W, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos201 : Artifact.submissionArtifact.instructionPC 128 = 211 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step201 := soundS (opAt 128 (.Dup ⟨3, by decide⟩))
    (blockOfS _ (pcFactS input 128 211 [W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos201)
      (stepS_dup input 211 3 (by decide) [W, S, sv, ov, acc, P7, M, m7, P, m8] ov (by rfl) (by simp) (by norm_num)))
  have pos202 : Artifact.submissionArtifact.instructionPC 129 = 212 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step202 := soundS (opAt 129 .CALLDATALOAD)
    (blockOfS _ (pcFactS input 129 212 [ov, W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos202)
      (stepS_calldataload input 212 ov [W, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos203 : Artifact.submissionArtifact.instructionPC 130 = 213 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step203 := soundS (opAt 130 .XOR)
    (blockOfS _ (pcFactS input 130 213 [v0, W, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos203)
      (stepS_xor input 213 v0 W [S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos204 : Artifact.submissionArtifact.instructionPC 131 = 214 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step204 := soundS (pushAt 131 5 18253660160)
    (blockOfS _ (pcFactS input 131 214 [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos204)
      (stepS_push input 214 5 (18253660160 : UInt256) [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos205 : Artifact.submissionArtifact.instructionPC 132 = 220 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step205 := soundS (opAt 132 (.Dup ⟨4, by decide⟩))
    (blockOfS _ (pcFactS input 132 220 [(18253660160 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos205)
      (stepS_dup input 220 4 (by decide) [(18253660160 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] ov (by rfl) (by simp) (by norm_num)))
  have pos206 : Artifact.submissionArtifact.instructionPC 133 = 221 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step206 := soundS (opAt 133 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 133 221 [ov, (18253660160 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos206)
      (stepS_calldatasize input 221 [ov, (18253660160 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos207 : Artifact.submissionArtifact.instructionPC 134 = 222 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step207 := soundS (opAt 134 .SUB)
    (blockOfS _ (pcFactS input 134 222 [v2, ov, (18253660160 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos207)
      (stepS_sub input 222 v2 ov [(18253660160 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos208 : Artifact.submissionArtifact.instructionPC 135 = 223 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step208 := soundS (opAt 135 .SHR)
    (blockOfS _ (pcFactS input 135 223 [v3, (18253660160 : UInt256), v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos208)
      (stepS_shr input 223 v3 (18253660160 : UInt256) [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos209 : Artifact.submissionArtifact.instructionPC 136 = 224 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step209 := soundS (pushAt 136 1 251)
    (blockOfS _ (pcFactS input 136 224 [v4, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos209)
      (stepS_push input 224 1 (251 : UInt256) [v4, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos210 : Artifact.submissionArtifact.instructionPC 137 = 226 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step210 := soundS (opAt 137 .AND)
    (blockOfS _ (pcFactS input 137 226 [(251 : UInt256), v4, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos210)
      (stepS_and input 226 (251 : UInt256) v4 [v1, S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos211 : Artifact.submissionArtifact.instructionPC 138 = 227 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step211 := soundS (opAt 138 .SHR)
    (blockOfS _ (pcFactS input 138 227 [v5, v1, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos211)
      (stepS_shr input 227 v5 v1 [S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos212 : Artifact.submissionArtifact.instructionPC 139 = 228 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step212 := soundS (opAt 139 (.Dup ⟨4, by decide⟩))
    (blockOfS _ (pcFactS input 139 228 [v6, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos212)
      (stepS_dup input 228 4 (by decide) [v6, S, sv, ov, acc, P7, M, m7, P, m8] acc (by rfl) (by simp) (by norm_num)))
  have pos213 : Artifact.submissionArtifact.instructionPC 140 = 229 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step213 := soundS (opAt 140 .OR)
    (blockOfS _ (pcFactS input 140 229 [acc, v6, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos213)
      (stepS_or input 229 acc v6 [S, sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos214 : Artifact.submissionArtifact.instructionPC 141 = 230 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step214 := soundS (opAt 141 (.Swap ⟨3, by decide⟩))
    (blockOfS _ (pcFactS input 141 230 [v7, S, sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pos214)
      (stepS_swap input 230 3 (by decide) [v7, S, sv, ov, acc, P7, M, m7, P, m8] [acc, S, sv, ov, v7, P7, M, m7, P, m8] (by rfl) (by simp) (by norm_num)))
  have pos215 : Artifact.submissionArtifact.instructionPC 142 = 231 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step215 := soundS (opAt 142 .POP)
    (blockOfS _ (pcFactS input 142 231 [acc, S, sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos215)
      (stepS_pop input 231 acc [S, sv, ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos216 : Artifact.submissionArtifact.instructionPC 143 = 232 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step216 := soundS (opAt 143 .POP)
    (blockOfS _ (pcFactS input 143 232 [S, sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos216)
      (stepS_pop input 232 S [sv, ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos217 : Artifact.submissionArtifact.instructionPC 144 = 233 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step217 := soundS (pushAt 144 1 160)
    (blockOfS _ (pcFactS input 144 233 [sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos217)
      (stepS_push input 233 1 (160 : UInt256) [sv, ov, v7, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos218 : Artifact.submissionArtifact.instructionPC 145 = 235 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step218 := soundS (opAt 145 .ADD)
    (blockOfS _ (pcFactS input 145 235 [(160 : UInt256), sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos218)
      (stepS_add input 235 (160 : UInt256) sv [ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos219 : Artifact.submissionArtifact.instructionPC 146 = 236 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step219 := soundS (pushAt 146 1 255)
    (blockOfS _ (pcFactS input 146 236 [v8, ov, v7, P7, M, m7, P, m8] (by norm_num) pos219)
      (stepS_push input 236 1 (255 : UInt256) [v8, ov, v7, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos220 : Artifact.submissionArtifact.instructionPC 147 = 238 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step220 := soundS (opAt 147 .AND)
    (blockOfS _ (pcFactS input 147 238 [(255 : UInt256), v8, ov, v7, P7, M, m7, P, m8] (by norm_num) pos220)
      (stepS_and input 238 (255 : UInt256) v8 [ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos221 : Artifact.submissionArtifact.instructionPC 148 = 239 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step221 := soundS (opAt 148 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 148 239 [v9, ov, v7, P7, M, m7, P, m8] (by norm_num) pos221)
      (stepS_swap input 239 0 (by decide) [v9, ov, v7, P7, M, m7, P, m8] [ov, v9, v7, P7, M, m7, P, m8] (by rfl) (by simp) (by norm_num)))
  have pos222 : Artifact.submissionArtifact.instructionPC 149 = 240 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step222 := soundS (pushAt 149 1 32)
    (blockOfS _ (pcFactS input 149 240 [ov, v9, v7, P7, M, m7, P, m8] (by norm_num) pos222)
      (stepS_push input 240 1 (32 : UInt256) [ov, v9, v7, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos223 : Artifact.submissionArtifact.instructionPC 150 = 242 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step223 := soundS (opAt 150 .ADD)
    (blockOfS _ (pcFactS input 150 242 [(32 : UInt256), ov, v9, v7, P7, M, m7, P, m8] (by norm_num) pos223)
      (stepS_add input 242 (32 : UInt256) ov [v9, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos224 : Artifact.submissionArtifact.instructionPC 151 = 243 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step224 := soundS (opAt 151 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 151 243 [v10, v9, v7, P7, M, m7, P, m8] (by norm_num) pos224)
