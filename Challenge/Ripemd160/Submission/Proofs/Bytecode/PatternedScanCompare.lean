...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
  ...
  have pos206 : Artifact.submissionArtifact.instructionPC 137 = 225 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos207 : Artifact.submissionArtifact.instructionPC 138 = 226 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have posX0 : Artifact.submissionArtifact.instructionPC 139 = 227 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have stepX0 := soundS (pushAt 139 1 2)
  ...
  have posX1 : Artifact.submissionArtifact.instructionPC 140 = 229 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have stepX1 := soundS (opAt 140 .XOR)
  ...
  have pos208 : Artifact.submissionArtifact.instructionPC 141 = 230 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos209 : Artifact.submissionArtifact.instructionPC 142 = 231 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step209 := soundS (pushAt 142 1 248)
  ...
  have pos210 : Artifact.submissionArtifact.instructionPC 143 = 233 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos211 : Artifact.submissionArtifact.instructionPC 144 = 234 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos212 : Artifact.submissionArtifact.instructionPC 145 = 235 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos213 : Artifact.submissionArtifact.instructionPC 146 = 236 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos214 : Artifact.submissionArtifact.instructionPC 147 = 237 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos215 : Artifact.submissionArtifact.instructionPC 148 = 238 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos216 : Artifact.submissionArtifact.instructionPC 149 = 239 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step216 := soundS (opAt 149 .POP)
    (blockOfS _ (pcFactS input 149 239 [S, sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos216)
      (stepS_pop input 240 S [sv, ov, v7, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have pos217 : Artifact.submissionArtifact.instructionPC 150 = 240 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  have step217 := soundS (pushAt 150 1 160)
    (blockOfS _ (pcFactS input 150 240 [sv, ov, v7, P7, M, m7, P, m8] (by norm_num) pos217)
      (stepS_push input 241 1 (160 : UInt256) [sv, ov, v7, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have pos218 : Artifact.submissionArtifact.instructionPC 151 = 242 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos219 : Artifact.submissionArtifact.instructionPC 152 = 243 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos220 : Artifact.submissionArtifact.instructionPC 153 = 245 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos221 : Artifact.submissionArtifact.instructionPC 154 = 246 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos222 : Artifact.submissionArtifact.instructionPC 155 = 247 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos223 : Artifact.submissionArtifact.instructionPC 156 = 249 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos224 : Artifact.submissionArtifact.instructionPC 157 = 250 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
