...
def gasSteps_compare_more_sym (input : ByteArray) (W S sv ov acc : UInt256) (hc : UInt256.isTrue (UInt256.gt (992 : UInt256) ((32 : UInt256) + ov))) :
  ...
  have step2952 := soundS (opAt 3164 (.Swap ⟨0, by decide⟩))
  ...
  have step2953 := soundS (pushAt 3165 1 0x20)
    (blockOfS _ (pcFactS input 3165 5189 [ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2953)
  ...
  have step2954 := soundS (opAt 3166 .ADD)
    (blockOfS _ (pcFactS input 3166 5191 [(32 : UInt256), ov, (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2954)
  ...
  have step2955 := soundS (opAt 3167 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 3167 5192 [((32 : UInt256) + ov), (UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2955)
  ...
  have step2956 := soundS (opAt 3168 .JUMPDEST)
    (blockOfS _ (pcFactS input 3168 5193 [(UInt256.land (255 : UInt256) ((160 : UInt256) + sv)), ((32 : UInt256) + ov), (UInt256.lor acc (UInt256.xor (MachineState.readWord input (ov).toNat) W)), P7, M, m7, P, m8] (by norm_num) pc2956)
