...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
  ...
  have pos200 : Artifact.submissionArtifact.instructionPC 126 = 215 := by
  ...
  have pos205 : Artifact.submissionArtifact.instructionPC 131 = 225 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos206 : Artifact.submissionArtifact.instructionPC 132 = 226 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos215 : Artifact.submissionArtifact.instructionPC 143 = 239 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos216 : Artifact.submissionArtifact.instructionPC 144 = 240 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
