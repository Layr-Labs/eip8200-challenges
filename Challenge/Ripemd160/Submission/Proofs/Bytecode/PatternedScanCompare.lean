...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
  ...
  have pos201 : Artifact.submissionArtifact.instructionPC 127 = 216 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos203 : Artifact.submissionArtifact.instructionPC 129 = 218 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos204 : Artifact.submissionArtifact.instructionPC 130 = 219 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos207 : Artifact.submissionArtifact.instructionPC 133 = 227 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have posX0 : Artifact.submissionArtifact.instructionPC 134 = 228 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos210 : Artifact.submissionArtifact.instructionPC 138 = 234 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos211 : Artifact.submissionArtifact.instructionPC 139 = 235 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos212 : Artifact.submissionArtifact.instructionPC 140 = 236 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos213 : Artifact.submissionArtifact.instructionPC 141 = 237 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos214 : Artifact.submissionArtifact.instructionPC 142 = 238 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos217 : Artifact.submissionArtifact.instructionPC 145 = 241 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos220 : Artifact.submissionArtifact.instructionPC 148 = 246 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos221 : Artifact.submissionArtifact.instructionPC 149 = 247 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos222 : Artifact.submissionArtifact.instructionPC 150 = 248 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos223 : Artifact.submissionArtifact.instructionPC 151 = 250 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos224 : Artifact.submissionArtifact.instructionPC 152 = 251 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
