...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
  ...
  have pos200 : Artifact.submissionArtifact.instructionPC 126 = 246 := by
  ...
  have pos205 : Artifact.submissionArtifact.instructionPC 131 = 252 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos206 : Artifact.submissionArtifact.instructionPC 132 = 255 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos215 : Artifact.submissionArtifact.instructionPC 143 = 266 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos216 : Artifact.submissionArtifact.instructionPC 144 = 269 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
