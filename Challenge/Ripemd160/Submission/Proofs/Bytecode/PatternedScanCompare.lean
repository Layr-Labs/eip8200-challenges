...
def gasSteps_compare_fold (input : ByteArray) (W S sv ov acc : UInt256) :
  ...
  have pos200 : Artifact.submissionArtifact.instructionPC 132 = 214 := by
  ...
  have pos201 : Artifact.submissionArtifact.instructionPC 133 = 215 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos202 : Artifact.submissionArtifact.instructionPC 134 = 216 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos203 : Artifact.submissionArtifact.instructionPC 135 = 217 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos204 : Artifact.submissionArtifact.instructionPC 136 = 218 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have posX0 : Artifact.submissionArtifact.instructionPC 140 = 227 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have posX1 : Artifact.submissionArtifact.instructionPC 141 = 229 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos208 : Artifact.submissionArtifact.instructionPC 142 = 230 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos209 : Artifact.submissionArtifact.instructionPC 143 = 231 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos210 : Artifact.submissionArtifact.instructionPC 144 = 233 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos211 : Artifact.submissionArtifact.instructionPC 145 = 234 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos212 : Artifact.submissionArtifact.instructionPC 146 = 235 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos213 : Artifact.submissionArtifact.instructionPC 147 = 236 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos214 : Artifact.submissionArtifact.instructionPC 148 = 237 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos215 : Artifact.submissionArtifact.instructionPC 149 = 238 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos216 : Artifact.submissionArtifact.instructionPC 150 = 239 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos217 : Artifact.submissionArtifact.instructionPC 151 = 240 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos218 : Artifact.submissionArtifact.instructionPC 152 = 242 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos219 : Artifact.submissionArtifact.instructionPC 153 = 243 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos220 : Artifact.submissionArtifact.instructionPC 154 = 245 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos221 : Artifact.submissionArtifact.instructionPC 155 = 246 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos222 : Artifact.submissionArtifact.instructionPC 156 = 247 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos223 : Artifact.submissionArtifact.instructionPC 157 = 249 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
  ...
  have pos224 : Artifact.submissionArtifact.instructionPC 158 = 250 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
