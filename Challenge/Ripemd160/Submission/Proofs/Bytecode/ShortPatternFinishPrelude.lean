...
def paddedDigestWord (n : Nat) : UInt256 :=
  ...
  if n = 32 then 0x1acf41b09f87acc983c2a043f5044c8f71c52dbd else
...
def storedState (n : Nat) (input : ByteArray) (sv ov : UInt256) : State :=
  { stS input 5266 (returnRest sv ov) with
...
def digestStorePath : List Located :=
  [opAt 4109 .JUMPDEST,
   ...
   opAt 4138 .MUL,
   opAt 4139 .XOR,
   pushAt 4140 20 1108562550528238721714208539311585353493002664126,
...
@[simp] private theorem shortPC4195 : Artifact.submissionArtifact.instructionPC 4141 = 5258 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4196 : Artifact.submissionArtifact.instructionPC 4142 = 5259 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4197 : Artifact.submissionArtifact.instructionPC 4143 = 5261 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4198 : Artifact.submissionArtifact.instructionPC 4144 = 5262 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4199 : Artifact.submissionArtifact.instructionPC 4145 = 5263 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4200 : Artifact.submissionArtifact.instructionPC 4146 = 5264 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4201 : Artifact.submissionArtifact.instructionPC 4147 = 5265 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4202 : Artifact.submissionArtifact.instructionPC 4148 = 5266 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4203 : Artifact.submissionArtifact.instructionPC 4149 = 5267 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortPC4204 : Artifact.submissionArtifact.instructionPC 4150 = 5268 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
theorem run_selector (n : Nat) (input : ByteArray) (sv ov : UInt256)
    (hn : n = 56 ∨ n = 120 ∨ n = 64 ∨ n = 65 ∨ n = 128 ∨ n = 32) (hsize : input.size = n) :
