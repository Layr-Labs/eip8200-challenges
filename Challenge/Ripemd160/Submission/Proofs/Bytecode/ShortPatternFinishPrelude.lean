...
@[simp] theorem pc4843 : Artifact.submissionArtifact.instructionPC 3863 = 4837 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4844 : Artifact.submissionArtifact.instructionPC 3865 = 4840 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4846 : Artifact.submissionArtifact.instructionPC 3866 = 4842 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
@[simp] theorem pc4857 : Artifact.submissionArtifact.instructionPC 3869 = 4848 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4858 : Artifact.submissionArtifact.instructionPC 3870 = 4849 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4860 : Artifact.submissionArtifact.instructionPC 3871 = 4848 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4861 : Artifact.submissionArtifact.instructionPC 3865 = 4842 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4864 : Artifact.submissionArtifact.instructionPC 3866 = 4845 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
@[simp] theorem pc4868 : Artifact.submissionArtifact.instructionPC 3874 = 4853 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4870 : Artifact.submissionArtifact.instructionPC 3875 = 4855 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
@[simp] theorem pc4871 : Artifact.submissionArtifact.instructionPC 3865 = 4856 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
