...
def tableOffset (n : Nat) : Nat := 4864 + 21 * (((259820 * n + 5281) / 65536) % 14)
...
def codeSizedState (n : Nat) (input : ByteArray) (sv ov : UInt256) : State :=
  stS input 274 ([UInt256.ofNat 5281, UInt256.ofNat 259820 * UInt256.ofNat n, 14, 20] ++ returnRest sv ov)
...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (tableOffset n) 20 =
      MachineState.readPadded submissionByteChunk20 (148 + 21 * (((259820 * n + 5281) / 65536) % 14)) 20 := by
...
private theorem tablePayload (n : Nat)
    ...
    MachineState.readPadded submissionByteChunk20 (148 + 21 * (((259820 * n + 5281) / 65536) % 14)) 20 =
