...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.PersistentPadding

open EvmSemantics

def messageOffset : Nat := 1632
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.PersistentPadding
