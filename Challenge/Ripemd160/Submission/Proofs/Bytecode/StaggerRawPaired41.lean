...
theorem site_pc : site.startPC = UInt256.ofNat 2893 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2212) = UInt256.ofNat 2893
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2893) template = UInt256.ofNat 2944 := by decide
  rw [hend] at hraw
