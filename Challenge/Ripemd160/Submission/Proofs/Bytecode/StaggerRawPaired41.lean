...
theorem site_pc : site.startPC = UInt256.ofNat 2915 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2067) = UInt256.ofNat 2915
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2915) template = UInt256.ofNat 2962 := by decide
  rw [hend] at hraw
