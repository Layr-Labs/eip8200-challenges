...
theorem site_pc : site.startPC = UInt256.ofNat 2876 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2174) = UInt256.ofNat 2876
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2876) template = UInt256.ofNat 2923 := by decide
  rw [hend] at hraw
