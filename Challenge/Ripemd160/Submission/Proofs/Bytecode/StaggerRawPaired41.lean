...
def template : List Instr :=
  [ .op (.Swap ⟨7, by decide⟩),
    ...
    .op (.Dup ⟨12, by decide⟩),
    .op .AND,
    .push ⟨14, by decide⟩ (UInt256.ofNat 649037107467969181018144982958081),
    .op .MUL,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 649037107467969181018144982958081) (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 234) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8))) (UInt256.ofNat 72)) (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 234) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8)))))) (UInt256.ofNat 24)))),
    x.v7,
    x.v0,
    x.v9,
    x.v10,
...
theorem site_pc : site.startPC = UInt256.ofNat 2880 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2210) = UInt256.ofNat 2880
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2880, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2931, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2880) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2880) template = UInt256.ofNat 2931 := by decide
  rw [hend] at hraw
