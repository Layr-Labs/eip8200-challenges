...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.FinalCorrectness
...
theorem correct (facts : RemainingFacts) : Correct submissionBytecode :=
  GasCost.correct_of_schedule (correctWithSchedule facts)

end Challenge.Ripemd160.Submission.Proofs.Bytecode.FinalCorrectness
