...
theorem run_checkEntry (input : ByteArray)
  ...
  have hpc3278 : Artifact.submissionArtifact.instructionPC 3320 = 4938 := by rfl
  have hpc3279 : Artifact.submissionArtifact.instructionPC 3321 = 4939 := by rfl
  have hpc3280 : Artifact.submissionArtifact.instructionPC 3322 = 4940 := by rfl
  have hpc3281 : Artifact.submissionArtifact.instructionPC 3323 = 4941 := by rfl
  have hpc3282 : Artifact.submissionArtifact.instructionPC 3324 = 4943 := by rfl
