...
theorem run_checkEntry (input : ByteArray)
  ...
  have hpc3278 : Artifact.submissionArtifact.instructionPC 3611 = 5058 := by rfl
  have hpc3279 : Artifact.submissionArtifact.instructionPC 3612 = 5059 := by rfl
  have hpc3280 : Artifact.submissionArtifact.instructionPC 3613 = 5060 := by rfl
  have hpc3281 : Artifact.submissionArtifact.instructionPC 3614 = 5061 := by rfl
  have hpc3282 : Artifact.submissionArtifact.instructionPC 3615 = 5063 := by rfl
