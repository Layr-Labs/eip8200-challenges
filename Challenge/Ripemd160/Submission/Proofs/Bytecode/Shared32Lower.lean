...
theorem run_lower (s : State) (pc ret mw a2 a3 a4 a5 a6 a7 a8 a9 a10 lim : UInt256)
    ...
    runInstrSeq lowerTemplate
      ...
      some {s with
        ...
        memory := writeWord (writeWord s.memory 46
            (PairedScheduleData.reversedWord (MachineState.readWord s.memory 1120))) 28
  ...
  have h3 := run_lowStore s pc2 low F hF hrun ha
...
theorem lower_bytes : assembleBytes lowerTemplate =
    [97,4,96,140,1,81,128,96,8,28,129,24,143,22,97,1,1,2,24,143,129,128,96,16,28,24,22,98,1,0,1,2,24,128,96,46,82,96,28,82] := by decide
