...
private theorem left2Second_slice :
    (A.instructions.drop 1447).take (((CachedMaskParams.leftCode 2).drop 178).take 210).length =
...
def left2Second : GenericRoundSite A .Osaka (((CachedMaskParams.leftCode 2).drop 178).take 210) :=
  StackSiteBuilder.ofSlice _ 1447 left2Second_slice (by
    change 1447 + (((CachedMaskParams.leftCode 2).drop 178).take 210).length ≤ Artifact.submissionInstructions.length
    rw [Artifact.referenceInstructions_count]
    decide) code_bound wellFormed_left2Second (by decide)

private theorem left2Third_slice :
    (A.instructions.drop 2665).take ((CachedMaskParams.leftCode 2).drop 388).length =
...
def left2Third : GenericRoundSite A .Osaka ((CachedMaskParams.leftCode 2).drop 388) :=
  StackSiteBuilder.ofSlice _ 2665 left2Third_slice (by
    change 2665 + ((CachedMaskParams.leftCode 2).drop 388).length ≤ Artifact.submissionInstructions.length
    rw [Artifact.referenceInstructions_count]
...
private theorem rightSecond_slice :
    (A.instructions.drop 2634).take (CachedMaskParams.rightCode.drop 373).length =
...
def rightSecond : GenericRoundSite A .Osaka (CachedMaskParams.rightCode.drop 373) :=
  StackSiteBuilder.ofSlice _ 2634 rightSecond_slice (by
    change 2634 + (CachedMaskParams.rightCode.drop 373).length ≤ Artifact.submissionInstructions.length
    rw [Artifact.referenceInstructions_count]
...
def left2Entry : Bridge A .Osaka where
  push := exactSite 1444 (.push 2 (UInt256.ofNat 1352)) (by rfl) (by decide)
...
def left2Bridge1 : Bridge A .Osaka where
  push := exactSite 1278 (.push 2 (UInt256.ofNat 1917)) (by rfl) (by decide)
...
def left2Bridge2 : Bridge A .Osaka where
  push := exactSite 1657 (.push 2 (UInt256.ofNat 4243)) (by rfl) (by decide)
  jump := exactSite 1658 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
  destination := exactSite 2664 (.op .JUMPDEST) (by rfl)
    (wfOp (by decide) trivial rfl)
  push_instr := by
    simp only [exactSite]
    apply congrArg (Instr.push ⟨2, by decide⟩)
...
def left2Return : Bridge A .Osaka where
  push := exactSite 2725 (.push 2 (UInt256.ofNat 2193)) (by rfl) (by decide)
  jump := exactSite 2726 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
  destination := exactSite 1659 (.op .JUMPDEST) (by rfl)
    (wfOp (by decide) trivial rfl)
  push_instr := by
    simp only [exactSite]
    apply congrArg (Instr.push ⟨2, by decide⟩)
...
def rightEntry : Bridge A .Osaka where
  push := exactSite 2631 (.push 2 (UInt256.ofNat 561)) (by rfl) (by decide)
  jump := exactSite 2632 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
...
def rightBridge1 : Bridge A .Osaka where
  push := exactSite 840 (.push 2 (UInt256.ofNat 4206)) (by rfl) (by decide)
  jump := exactSite 841 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
  destination := exactSite 2633 (.op .JUMPDEST) (by rfl)
    (wfOp (by decide) trivial rfl)
  push_instr := by
    simp only [exactSite]
    apply congrArg (Instr.push ⟨2, by decide⟩)
...
def rightReturn : Bridge A .Osaka where
  push := exactSite 2661 (.push 2 (UInt256.ofNat 4325)) (by rfl) (by decide)
  jump := exactSite 2662 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
