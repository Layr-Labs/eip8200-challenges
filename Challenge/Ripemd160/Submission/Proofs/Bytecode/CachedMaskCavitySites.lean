...
private theorem left2Second_slice :
    (A.instructions.drop 1456).take (((CachedMaskParams.leftCode 2).drop 178).take 210).length =
...
def left2Second : GenericRoundSite A .Osaka (((CachedMaskParams.leftCode 2).drop 178).take 210) :=
  StackSiteBuilder.ofSlice _ 1456 left2Second_slice (by
    change 1456 + (((CachedMaskParams.leftCode 2).drop 178).take 210).length ≤ Artifact.submissionInstructions.length
    rw [Artifact.referenceInstructions_count]
    decide) code_bound wellFormed_left2Second (by decide)

private theorem left2Third_slice :
    (A.instructions.drop 2728).take ((CachedMaskParams.leftCode 2).drop 388).length =
...
def left2Third : GenericRoundSite A .Osaka ((CachedMaskParams.leftCode 2).drop 388) :=
  StackSiteBuilder.ofSlice _ 2728 left2Third_slice (by
    change 2728 + ((CachedMaskParams.leftCode 2).drop 388).length ≤ Artifact.submissionInstructions.length
    rw [Artifact.referenceInstructions_count]
...
private theorem rightSecond_slice :
    (A.instructions.drop 2697).take (CachedMaskParams.rightCode.drop 373).length =
...
def rightSecond : GenericRoundSite A .Osaka (CachedMaskParams.rightCode.drop 373) :=
  StackSiteBuilder.ofSlice _ 2697 rightSecond_slice (by
    change 2697 + (CachedMaskParams.rightCode.drop 373).length ≤ Artifact.submissionInstructions.length
    rw [Artifact.referenceInstructions_count]
...
def left2Entry : Bridge A .Osaka where
  push := exactSite 1453 (.push 2 (UInt256.ofNat 1352)) (by rfl) (by decide)
  jump := exactSite 1454 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
...
def left2Bridge1 : Bridge A .Osaka where
  push := exactSite 1278 (.push 2 (UInt256.ofNat 1879)) (by rfl) (by decide)
  jump := exactSite 1279 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
  destination := exactSite 1455 (.op .JUMPDEST) (by rfl)
    (wfOp (by decide) trivial rfl)
  push_instr := by
    simp only [exactSite]
    apply congrArg (Instr.push ⟨2, by decide⟩)
...
def left2Bridge2 : Bridge A .Osaka where
  push := exactSite 1666 (.push 2 (UInt256.ofNat 3911)) (by rfl) (by decide)
  jump := exactSite 1667 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
  destination := exactSite 2727 (.op .JUMPDEST) (by rfl)
    (wfOp (by decide) trivial rfl)
  push_instr := by
    simp only [exactSite]
    apply congrArg (Instr.push ⟨2, by decide⟩)
...
def left2Return : Bridge A .Osaka where
  push := exactSite 2788 (.push 2 (UInt256.ofNat 2155)) (by rfl) (by decide)
  jump := exactSite 2789 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
  destination := exactSite 1668 (.op .JUMPDEST) (by rfl)
    (wfOp (by decide) trivial rfl)
  push_instr := by
    simp only [exactSite]
    apply congrArg (Instr.push ⟨2, by decide⟩)
...
def rightEntry : Bridge A .Osaka where
  push := exactSite 2694 (.push 2 (UInt256.ofNat 561)) (by rfl) (by decide)
  jump := exactSite 2695 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
...
def rightBridge1 : Bridge A .Osaka where
  push := exactSite 840 (.push 2 (UInt256.ofNat 3874)) (by rfl) (by decide)
  jump := exactSite 841 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
  destination := exactSite 2696 (.op .JUMPDEST) (by rfl)
    (wfOp (by decide) trivial rfl)
  push_instr := by
    simp only [exactSite]
    apply congrArg (Instr.push ⟨2, by decide⟩)
...
def rightReturn : Bridge A .Osaka where
  push := exactSite 2724 (.push 2 (UInt256.ofNat 4122)) (by rfl) (by decide)
  jump := exactSite 2725 (.op .JUMP) (by rfl) (wfOp (by decide) trivial rfl)
