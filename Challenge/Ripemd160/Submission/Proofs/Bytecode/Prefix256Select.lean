...
def gasSteps_select (input : ByteArray) (rest : List UInt256) (hlen : rest.length < 1020) :
  ...
  have t1 := soundS (opAt 166 (.Dup ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 166 270 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
      (stepS_dup input 270 0 (by decide) (UInt256.ofNat input.size :: rest) (UInt256.ofNat input.size) (by rfl) (by simp only [List.length_cons]; omega) (by norm_num)))
...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have t3 := soundS (pushAt 163 2 5189)
    (blockOfS _ (pcFactS input 163 265 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_push input 265 2 5189 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest)
        (by simp only [List.length_cons]; omega) (by decide) (by decide) (by norm_num)))
  have t4 := soundS (opAt 164 .JUMPI)
    (blockOfS _ (pcFactS input 164 268 (5189 :: UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_jumpi_fall input 268 5189 (UInt256.gt 129 (UInt256.ofNat input.size)) rest
