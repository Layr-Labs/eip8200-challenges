...
def gasSteps_select (input : ByteArray) (rest : List UInt256) (hlen : rest.length < 1020) :
  ...
  have t0 := soundS (opAt 165 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 165 268 rest (by norm_num) (by rfl))
      (stepS_calldatasize input 268 rest (by omega) (by norm_num)))
  have t1 := soundS (opAt 166 (.Dup ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 166 269 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t2 := soundS (pushAt 167 2 376)
    (blockOfS _ (pcFactS input 167 270 (UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t3 := soundS (opAt 168 .EQ)
    (blockOfS _ (pcFactS input 168 273 (376 :: UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t4 := soundS (pushAt 169 20 digestDifference)
    (blockOfS _ (pcFactS input 169 274 (UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t5 := soundS (opAt 170 .MUL)
    (blockOfS _ (pcFactS input 170 295 (digestDifference :: UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t6 := soundS (opAt 171 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 171 296 (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t7 := soundS (pushAt 172 2 256)
    (blockOfS _ (pcFactS input 172 297 (UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t8 := soundS (opAt 173 .EQ)
    (blockOfS _ (pcFactS input 173 300 (256 :: UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t9 := soundS (pushAt 174 20 digestDifference256)
    (blockOfS _ (pcFactS input 174 301 (UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t10 := soundS (opAt 175 .MUL)
    (blockOfS _ (pcFactS input 175 322 (digestDifference256 :: UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t11 := soundS (opAt 176 .XOR)
    (blockOfS _ (pcFactS input 176 323 (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size)) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t12 := soundS (pushAt 177 20 digest1000)
    (blockOfS _ (pcFactS input 177 324 (UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
  ...
  have t13 := soundS (opAt 178 .XOR)
    (blockOfS _ (pcFactS input 178 345 (digest1000 :: UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have t0 := soundS (opAt 160 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 160 260 rest (by norm_num) (by rfl))
      (stepS_calldatasize input 260 rest (by omega) (by norm_num)))
  have t1 := soundS (pushAt 161 1 129)
    (blockOfS _ (pcFactS input 161 261 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t2 := soundS (opAt 162 .GT)
    (blockOfS _ (pcFactS input 162 263 (129 :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
      (stepS_gt input 263 129 (UInt256.ofNat input.size) rest
        (by omega) (by norm_num)))
  have t3 := soundS (pushAt 163 2 5198)
    (blockOfS _ (pcFactS input 163 264 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_push input 264 2 5198 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest)
        (by simp only [List.length_cons]; omega) (by decide) (by decide) (by norm_num)))
  have t4 := soundS (opAt 164 .JUMPI)
    (blockOfS _ (pcFactS input 164 267 (5198 :: UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
