...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have t3 := soundS (pushAt 163 2 5284)
    (blockOfS _ (pcFactS input 163 259 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_push input 259 2 5284 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest)
        (by simp only [List.length_cons]; omega) (by decide) (by decide) (by norm_num)))
  have t4 := soundS (opAt 164 .JUMPI)
    (blockOfS _ (pcFactS input 164 262 (5284 :: UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_jumpi_fall input 262 5284 (UInt256.gt 129 (UInt256.ofNat input.size)) rest
