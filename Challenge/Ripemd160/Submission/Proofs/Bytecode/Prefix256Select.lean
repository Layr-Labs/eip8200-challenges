...
def gasSteps_select (input : ByteArray) (rest : List UInt256) (hlen : rest.length < 1020) :
  ...
  have t1 := soundS (opAt 172 (.Dup ⟨0, by decide⟩))
...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have t1 := soundS (pushAt 167 1 129)
  ...
  have t2 := soundS (opAt 168 .GT)
    (blockOfS _ (pcFactS input 168 263 (129 :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
      (stepS_gt input 263 129 (UInt256.ofNat input.size) rest
        (by omega) (by norm_num)))
  have t3 := soundS (pushAt 169 2 5202)
    (blockOfS _ (pcFactS input 169 264 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_push input 264 2 5202 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest)
        (by simp only [List.length_cons]; omega) (by decide) (by decide) (by norm_num)))
  have t4 := soundS (opAt 170 .JUMPI)
    (blockOfS _ (pcFactS input 170 267 (5202 :: UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_jumpi_fall input 267 5202 (UInt256.gt 129 (UInt256.ofNat input.size)) rest
