...
def gasSteps_select (input : ByteArray) (rest : List UInt256) (hlen : rest.length < 1020) :
  ...
  have t1 := soundS (opAt 168 (.Dup ⟨0, by decide⟩))
  ...
  have t2 := soundS (pushAt 169 2 376)
    (blockOfS _ (pcFactS input 169 265 (UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t3 := soundS (opAt 170 .EQ)
    (blockOfS _ (pcFactS input 170 268 (376 :: UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t4 := soundS (pushAt 171 20 digestDifference)
    (blockOfS _ (pcFactS input 171 269 (UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t5 := soundS (opAt 172 .MUL)
    (blockOfS _ (pcFactS input 172 290 (digestDifference :: UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t6 := soundS (opAt 173 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 173 291 (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t7 := soundS (pushAt 174 2 256)
    (blockOfS _ (pcFactS input 174 292 (UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t8 := soundS (opAt 175 .EQ)
    (blockOfS _ (pcFactS input 175 295 (256 :: UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t9 := soundS (pushAt 176 20 digestDifference256)
    (blockOfS _ (pcFactS input 176 296 (UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t10 := soundS (opAt 177 .MUL)
    (blockOfS _ (pcFactS input 177 317 (digestDifference256 :: UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t11 := soundS (opAt 178 .XOR)
    (blockOfS _ (pcFactS input 178 318 (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size)) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t12 := soundS (pushAt 179 20 digest1000)
    (blockOfS _ (pcFactS input 179 319 (UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
  ...
  have t13 := soundS (opAt 180 .XOR)
    (blockOfS _ (pcFactS input 180 340 (digest1000 :: UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have hfalse : ¬ UInt256.isTrue
    ...
    rw [heq]
    decide
  have t0 := soundS (opAt 162 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 162 255 rest (by norm_num) (by rfl))
      (stepS_calldatasize input 255 rest (by omega) (by norm_num)))
  have t1 := soundS (pushAt 163 1 129)
    (blockOfS _ (pcFactS input 163 256 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t2 := soundS (opAt 164 .GT)
    (blockOfS _ (pcFactS input 164 258 (129 :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
      (stepS_gt input 258 129 (UInt256.ofNat input.size) rest
        (by omega) (by norm_num)))
  have t3 := soundS (pushAt 165 2 5078)
    (blockOfS _ (pcFactS input 165 259 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_push input 259 2 5078 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest)
        (by simp only [List.length_cons]; omega) (by decide) (by decide) (by norm_num)))
  have t4 := soundS (opAt 166 .JUMPI)
    (blockOfS _ (pcFactS input 166 262 (5078 :: UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_jumpi_fall input 262 5072 (UInt256.gt 129 (UInt256.ofNat input.size)) rest
