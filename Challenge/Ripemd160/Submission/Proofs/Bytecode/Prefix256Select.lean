...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have t2 := soundS (opAt 166 .GT)
    (blockOfS _ (pcFactS input 166 263 (129 :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
      (stepS_gt input 263 129 (UInt256.ofNat input.size) rest
        (by omega) (by norm_num)))
  have t3 := soundS (pushAt 167 2 5198)
    (blockOfS _ (pcFactS input 167 264 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_push input 264 2 5198 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest)
        (by simp only [List.length_cons]; omega) (by decide) (by decide) (by norm_num)))
  have t4 := soundS (opAt 168 .JUMPI)
    (blockOfS _ (pcFactS input 168 267 (5198 :: UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
