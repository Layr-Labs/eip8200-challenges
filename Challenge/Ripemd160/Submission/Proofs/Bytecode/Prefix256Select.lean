...
def gasSteps_select (input : ByteArray) (rest : List UInt256) (hlen : rest.length < 1020) :
  ...
  have t0 := soundS (opAt 168 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 168 268 rest (by norm_num) (by rfl))
      (stepS_calldatasize input 268 rest (by omega) (by norm_num)))
  have t1 := soundS (opAt 169 (.Dup ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 169 269 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t2 := soundS (pushAt 170 2 376)
    (blockOfS _ (pcFactS input 170 270 (UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t3 := soundS (opAt 171 .EQ)
    (blockOfS _ (pcFactS input 171 273 (376 :: UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t4 := soundS (pushAt 172 20 digestDifference)
    (blockOfS _ (pcFactS input 172 274 (UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t5 := soundS (opAt 173 .MUL)
    (blockOfS _ (pcFactS input 173 295 (digestDifference :: UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t6 := soundS (opAt 174 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 174 296 (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t7 := soundS (pushAt 175 2 256)
    (blockOfS _ (pcFactS input 175 297 (UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t8 := soundS (opAt 176 .EQ)
    (blockOfS _ (pcFactS input 176 300 (256 :: UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t9 := soundS (pushAt 177 20 digestDifference256)
    (blockOfS _ (pcFactS input 177 301 (UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t10 := soundS (opAt 178 .MUL)
    (blockOfS _ (pcFactS input 178 322 (digestDifference256 :: UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t11 := soundS (opAt 179 .XOR)
    (blockOfS _ (pcFactS input 179 323 (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size)) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t12 := soundS (pushAt 180 20 digest1000)
    (blockOfS _ (pcFactS input 180 324 (UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
  ...
  have t13 := soundS (opAt 181 .XOR)
    (blockOfS _ (pcFactS input 181 345 (digest1000 :: UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have hfalse : ¬ UInt256.isTrue
    ...
    rw [heq]
    decide
  have t0 := soundS (opAt 163 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 163 260 rest (by norm_num) (by rfl))
      (stepS_calldatasize input 260 rest (by omega) (by norm_num)))
  have t1 := soundS (pushAt 164 1 129)
    (blockOfS _ (pcFactS input 164 261 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t2 := soundS (opAt 165 .GT)
    (blockOfS _ (pcFactS input 165 263 (129 :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
      (stepS_gt input 263 129 (UInt256.ofNat input.size) rest
        (by omega) (by norm_num)))
  have t3 := soundS (pushAt 166 2 5198)
    (blockOfS _ (pcFactS input 166 264 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
      (stepS_push input 264 2 5198 (UInt256.gt 129 (UInt256.ofNat input.size) :: rest)
        (by simp only [List.length_cons]; omega) (by decide) (by decide) (by norm_num)))
  have t4 := soundS (opAt 167 .JUMPI)
    (blockOfS _ (pcFactS input 167 267 (5198 :: UInt256.gt 129 (UInt256.ofNat input.size) :: rest) (by norm_num) (by rfl))
