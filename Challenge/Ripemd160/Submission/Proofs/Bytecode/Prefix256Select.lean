...
def gasSteps_select (input : ByteArray) (rest : List UInt256) (hlen : rest.length < 1020) :
  ...
  have t0 := soundS (opAt 169 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 169 260 rest (by norm_num) (by rfl))
      (stepS_calldatasize input 260 rest (by omega) (by norm_num)))
  have t1 := soundS (opAt 170 (.Dup ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 170 261 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t2 := soundS (pushAt 171 2 376)
    (blockOfS _ (pcFactS input 171 262 (UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t3 := soundS (opAt 172 .EQ)
    (blockOfS _ (pcFactS input 172 265 (376 :: UInt256.ofNat input.size :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t4 := soundS (pushAt 173 20 digestDifference)
    (blockOfS _ (pcFactS input 173 266 (UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t5 := soundS (opAt 174 .MUL)
    (blockOfS _ (pcFactS input 174 287 (digestDifference :: UInt256.eq (376) (UInt256.ofNat input.size) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t6 := soundS (opAt 175 (.Swap ⟨0, by decide⟩))
    (blockOfS _ (pcFactS input 175 288 (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
  ...
  have t7 := soundS (pushAt 176 2 256)
    (blockOfS _ (pcFactS input 176 289 (UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t8 := soundS (opAt 177 .EQ)
    (blockOfS _ (pcFactS input 177 292 (256 :: UInt256.ofNat input.size :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t9 := soundS (pushAt 178 20 digestDifference256)
    (blockOfS _ (pcFactS input 178 293 (UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t10 := soundS (opAt 179 .MUL)
    (blockOfS _ (pcFactS input 179 314 (digestDifference256 :: UInt256.eq (256) (UInt256.ofNat input.size) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t11 := soundS (opAt 180 .XOR)
    (blockOfS _ (pcFactS input 180 315 (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size)) :: UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size)) :: rest) (by norm_num) (by rfl))
  ...
  have t12 := soundS (pushAt 181 20 digest1000)
    (blockOfS _ (pcFactS input 181 316 (UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
  ...
  have t13 := soundS (opAt 182 .XOR)
    (blockOfS _ (pcFactS input 182 337 (digest1000 :: UInt256.xor (UInt256.mul (digestDifference256) (UInt256.eq (256) (UInt256.ofNat input.size))) (UInt256.mul (digestDifference) (UInt256.eq (376) (UInt256.ofNat input.size))) :: rest) (by norm_num) (by rfl))
...
def gasSteps_skip128 (input : ByteArray) (rest : List UInt256)
  ...
  have t0 := soundS (opAt 164 .CALLDATASIZE)
    (blockOfS _ (pcFactS input 164 252 rest (by norm_num) (by rfl))
      (stepS_calldatasize input 252 rest (by omega) (by norm_num)))
  have t1 := soundS (pushAt 165 1 129)
    (blockOfS _ (pcFactS input 165 253 (UInt256.ofNat input.size :: rest) (by norm_num) (by rfl))
