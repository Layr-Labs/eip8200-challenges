...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.StaggerRawPaired69
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v4,
    (UInt256.land x.v2 (UInt256.add x.v4 (UInt256.shiftRight (UInt256.mul x.v9 (UInt256.land x.v2 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 36) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v10 x.v5) x.v0) (UInt256.xor x.v10 (UInt256.xor x.v8 x.v5))) x.v6))))) (UInt256.ofNat 30)))),
    x.v0,
    x.v7,
    x.v8,
    x.v9,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 3353).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3353 actual_slice
    (by change 3353 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4238 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3353) = UInt256.ofNat 4238
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.StaggerRawPaired69
