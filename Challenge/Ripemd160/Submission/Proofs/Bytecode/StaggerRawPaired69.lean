...
theorem site_pc : site.startPC = UInt256.ofNat 4269 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3374) = UInt256.ofNat 4269
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4269) template = UInt256.ofNat 4306 := by decide
  rw [hend] at hraw
