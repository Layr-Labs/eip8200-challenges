...
theorem site_pc : site.startPC = UInt256.ofNat 4353 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3273) = UInt256.ofNat 4353
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4353) template = UInt256.ofNat 4391 := by decide
  rw [hend] at hraw
