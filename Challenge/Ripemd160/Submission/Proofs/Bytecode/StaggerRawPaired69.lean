...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 22))),
    ...
    x.v2,
    x.v3,
    (UInt256.land x.v1 (UInt256.add x.v3 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.land x.v1 (UInt256.add x.v6 (UInt256.add (MachineState.readWord memory 20) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.land x.v9 x.v4) x.v0) (UInt256.xor x.v9 (UInt256.xor x.v4 x.v7))) x.v5))))) (UInt256.ofNat 24)))),
    x.v0,
    x.v6,
    x.v7,
    x.v8,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 3401 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 4151 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3401) = UInt256.ofNat 4151
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 4151, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 4189, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 4151) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 4151) template = UInt256.ofNat 4189 := by decide
  rw [hend] at hraw
