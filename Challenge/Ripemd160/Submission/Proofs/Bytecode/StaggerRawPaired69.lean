...
theorem site_pc : site.startPC = UInt256.ofNat 4154 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3402) = UInt256.ofNat 4154
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 4154) template = UInt256.ofNat 4192 := by decide
  rw [hend] at hraw
