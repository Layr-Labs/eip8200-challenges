...
def stack1 (q : Input) (rho : List UInt256) : List UInt256 := [ q.cache140, q.late252, q.late342, (UInt256.add (UInt256.shiftRight q.rc (UInt256.ofNat 144)) q.lb), q.lc, q.re, q.ld, q.ra, q.rd, q.le, q.factor, q.lower, (UInt256.add (UInt256.shiftRight q.rb (UInt256.ofNat 144)) q.la), q.cache190, q.cache310, q.cache350, q.h4, q.h1, q.h2, q.h3, q.h0, q.off, q.limit ] ++ rho
...
def stack2 (q : Input) (rho : List UInt256) : List UInt256 := [ (UInt256.shiftRight q.re (UInt256.ofNat 144)), q.ld, q.ra, (UInt256.add (UInt256.shiftRight q.rc (UInt256.ofNat 144)) q.lb), q.le, q.factor, q.lower, (UInt256.add (UInt256.shiftRight q.rb (UInt256.ofNat 144)) q.la), q.cache190, q.cache310, (UInt256.add (UInt256.shiftRight q.rd (UInt256.ofNat 144)) q.lc), q.h4, q.h1, q.h2, q.h3, q.h0, q.off, q.limit ] ++ rho
...
def stack3 (q : Input) (rho : List UInt256) : List UInt256 := [ (UInt256.shiftRight q.ra (UInt256.ofNat 144)), q.le, q.factor, q.lower, (UInt256.add (UInt256.shiftRight q.rb (UInt256.ofNat 144)) q.la), q.cache190, (UInt256.add (UInt256.shiftRight q.re (UInt256.ofNat 144)) q.ld), (UInt256.add (UInt256.shiftRight q.rd (UInt256.ofNat 144)) q.lc), q.h4, q.h1, q.h2, q.h3, (UInt256.land q.lower (UInt256.add q.h0 (UInt256.add (UInt256.shiftRight q.rc (UInt256.ofNat 144)) q.lb))), q.off, q.limit ] ++ rho
...
def stack4 (q : Input) (rho : List UInt256) : List UInt256 := [ (UInt256.add q.h3 (UInt256.add (UInt256.shiftRight q.ra (UInt256.ofNat 144)) q.le)), (UInt256.add (UInt256.shiftRight q.re (UInt256.ofNat 144)) q.ld), (UInt256.add (UInt256.shiftRight q.rd (UInt256.ofNat 144)) q.lc), q.lower, q.h1, q.h2, (UInt256.land q.lower (UInt256.add q.h4 (UInt256.add (UInt256.shiftRight q.rb (UInt256.ofNat 144)) q.la))), (UInt256.land q.lower (UInt256.add q.h0 (UInt256.add (UInt256.shiftRight q.rc (UInt256.ofNat 144)) q.lb))), q.off, q.limit ] ++ rho
...
def chunk4 : List Instr := [ .op (.Dup ⟨3, by decide⟩),
    .op .AND,
    .op (.Swap ⟨4, by decide⟩),
    .op .ADD,
    .op (.Dup ⟨2, by decide⟩),
