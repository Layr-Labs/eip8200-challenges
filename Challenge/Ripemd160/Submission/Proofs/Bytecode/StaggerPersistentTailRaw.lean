...
def stack1 (q : Input) (rho : List UInt256) : List UInt256 := [ (UInt256.ofNat 172), q.re, q.rc, q.ra, q.rd, q.rb, q.lb, q.lower, q.lc, q.ld, q.la, q.le, q.h4, q.h1, q.h2, q.h3, q.h0, q.off, q.limit ] ++ rho
...
def stack2 (q : Input) (rho : List UInt256) : List UInt256 := [ (UInt256.shiftRight q.rd (UInt256.ofNat 172)), (UInt256.add q.h2 (UInt256.shiftRight q.re (UInt256.ofNat 172))), (UInt256.shiftRight q.ra (UInt256.ofNat 172)), q.rb, q.lb, q.lower, q.lc, q.ld, q.la, q.le, q.h4, q.h1, (UInt256.shiftRight q.rc (UInt256.ofNat 172)), q.h3, q.h0, q.off, q.limit ] ++ rho
...
def stack3 (q : Input) (rho : List UInt256) : List UInt256 := [ q.lower, (UInt256.add q.le (UInt256.add q.h3 (UInt256.shiftRight q.ra (UInt256.ofNat 172)))), q.lb, q.lower, q.lc, (UInt256.shiftRight q.rd (UInt256.ofNat 172)), q.la, (UInt256.shiftRight q.rb (UInt256.ofNat 172)), q.h4, q.h1, (UInt256.shiftRight q.rc (UInt256.ofNat 172)), (UInt256.land q.lower (UInt256.add q.ld (UInt256.add q.h2 (UInt256.shiftRight q.re (UInt256.ofNat 172))))), q.h0, q.off, q.limit ] ++ rho
...
def stack4 (q : Input) (rho : List UInt256) : List UInt256 := [ q.lower, (UInt256.add (UInt256.add q.h1 q.lc) (UInt256.shiftRight q.rd (UInt256.ofNat 172))), q.la, (UInt256.shiftRight q.rb (UInt256.ofNat 172)), q.h4, (UInt256.land q.lower (UInt256.add q.h0 (UInt256.add (UInt256.shiftRight q.rc (UInt256.ofNat 172)) q.lb))), (UInt256.land q.lower (UInt256.add q.le (UInt256.add q.h3 (UInt256.shiftRight q.ra (UInt256.ofNat 172))))), (UInt256.land q.lower (UInt256.add q.ld (UInt256.add q.h2 (UInt256.shiftRight q.re (UInt256.ofNat 172))))), q.lower, q.off, q.limit ] ++ rho
...
def stack5 (q : Input) (rho : List UInt256) : List UInt256 := [ (UInt256.land q.lower (UInt256.add (UInt256.add q.h1 q.lc) (UInt256.shiftRight q.rd (UInt256.ofNat 172)))), (UInt256.land q.lower (UInt256.add q.ld (UInt256.add q.h2 (UInt256.shiftRight q.re (UInt256.ofNat 172))))), (UInt256.land q.lower (UInt256.add q.le (UInt256.add q.h3 (UInt256.shiftRight q.ra (UInt256.ofNat 172))))), (UInt256.land q.lower (UInt256.add (UInt256.add q.h4 q.la) (UInt256.shiftRight q.rb (UInt256.ofNat 172)))), (UInt256.land q.lower (UInt256.add q.h0 (UInt256.add (UInt256.shiftRight q.rc (UInt256.ofNat 172)) q.lb))), q.off, q.limit ] ++ rho
...
def entryStack (q : Input) (rho : List UInt256) : List UInt256 := [ q.lb,
    q.le,
    q.la,
    q.ld,
    q.literal72,
