...
theorem site_pc : site.startPC = UInt256.ofNat 2585 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2021) = UInt256.ofNat 2585
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2585) template = UInt256.ofNat 2637 := by decide
  rw [hend] at hraw
