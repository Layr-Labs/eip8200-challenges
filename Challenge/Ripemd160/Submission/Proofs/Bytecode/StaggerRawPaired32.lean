...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    x.v0,
    x.v8,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add (UInt256.ofNat 136726760529788758926252426176837954510549114783656865) (UInt256.add (MachineState.readWord memory 972) (UInt256.add (UInt256.xor x.v0 (UInt256.lor (UInt256.lnot x.v9) x.v6)) x.v5))))) (UInt256.ofNat 27)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 1965 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 2642 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1965) = UInt256.ofNat 2642
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2642, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2702, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2642) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2642) template = UInt256.ofNat 2702 := by decide
  rw [hend] at hraw
