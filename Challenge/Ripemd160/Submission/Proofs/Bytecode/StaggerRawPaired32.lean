...
theorem site_pc : site.startPC = UInt256.ofNat 2522 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1910) = UInt256.ofNat 2522
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2522) template = UInt256.ofNat 2580 := by decide
  rw [hend] at hraw
