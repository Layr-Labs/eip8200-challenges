...
theorem site_pc : site.startPC = UInt256.ofNat 2705 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2007) = UInt256.ofNat 2705
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2705) template = UInt256.ofNat 2764 := by decide
  rw [hend] at hraw
