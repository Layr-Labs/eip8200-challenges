...
theorem site_pc : site.startPC = UInt256.ofNat 2669 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1961) = UInt256.ofNat 2669
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2669) template = UInt256.ofNat 2729 := by decide
  rw [hend] at hraw
