...
theorem site_pc : site.startPC = UInt256.ofNat 2689 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2017) = UInt256.ofNat 2689
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2689) template = UInt256.ofNat 2748 := by decide
  rw [hend] at hraw
