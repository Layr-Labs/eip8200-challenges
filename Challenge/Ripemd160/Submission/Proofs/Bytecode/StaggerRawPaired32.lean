...
theorem site_pc : site.startPC = UInt256.ofNat 2619 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1967) = UInt256.ofNat 2619
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2619) template = UInt256.ofNat 2679 := by decide
  rw [hend] at hraw
