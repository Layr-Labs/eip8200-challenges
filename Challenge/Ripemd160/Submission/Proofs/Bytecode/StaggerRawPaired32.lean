...
theorem site_pc : site.startPC = UInt256.ofNat 2700 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2001) = UInt256.ofNat 2700
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2700) template = UInt256.ofNat 2759 := by decide
  rw [hend] at hraw
