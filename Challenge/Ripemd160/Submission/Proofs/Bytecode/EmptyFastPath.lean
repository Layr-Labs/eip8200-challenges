...
def gasSteps_dispatch_empty :
    Challenge.EvmProof.GasSteps (Execution.atPC emptyInput 0x14b4)
      (Execution.atPC emptyInput 0x14b9) := by
  ...
  have hrun : Challenge.EvmProof.Stepper.runLocatedBlock Execution.path_dispatch
      ...
      some (Execution.atPC emptyInput 0x14b9) := by
...
def gasSteps_2922 :
    Challenge.EvmProof.GasSteps (Execution.atPC emptyInput 0x14b9) s1_push20 := by
  have hrun : Challenge.EvmProof.Stepper.runLocatedBlock path_2922
      (Execution.atPC emptyInput 0x14b9) = some s1_push20 := by
...
def gasSteps_empty_tail :
    Challenge.EvmProof.GasSteps (Execution.atPC emptyInput 0x14b9) emptyFinal :=
