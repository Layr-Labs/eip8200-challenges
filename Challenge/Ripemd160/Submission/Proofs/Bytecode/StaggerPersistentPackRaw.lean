...
def outputStack (x : Input) (rho : List UInt256) : List UInt256 := [(UInt256.lor x.lower (UInt256.shiftLeft x.lower (UInt256.ofNat 80))), (UInt256.shiftLeft x.lower (UInt256.ofNat 80)), (UInt256.lor x.h4 (UInt256.shiftLeft x.re (UInt256.ofNat 80))), (UInt256.lor x.h1 (UInt256.shiftLeft x.rb (UInt256.ofNat 80))), (UInt256.lor x.h0 (UInt256.shiftLeft x.ra (UInt256.ofNat 80))), (UInt256.lor x.h3 (UInt256.shiftLeft x.rd (UInt256.ofNat 80))), (UInt256.lor x.h2 (UInt256.shiftLeft x.rc (UInt256.ofNat 80))), x.factor, x.lower, x.cache140, x.cache190, x.cache310, x.cache350, x.h4, x.h1, x.h2, x.h3, x.h0, x.off, x.limit] ++ rho
