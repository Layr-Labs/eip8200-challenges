...
def template : List Instr :=
  [ .push ⟨23, by decide⟩ (UInt256.ofNat 136726760529788758926252426176837954510549114783656893),
    .op (.Swap ⟨4, by decide⟩),
    .op (.Dup ⟨1, by decide⟩),
    .op (.Dup ⟨10, by decide⟩),
    .op .NOT,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 23))),
    ...
    x.v3,
    x.v4,
    (UInt256.ofNat 136726760529788758926252426176837954510549114783656893),
    x.v6,
    (UInt256.ofNat 23),
    x.v8,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add (UInt256.ofNat 136726760529788758926252426176837954510549114783656893) (UInt256.add (MachineState.readWord memory 972) (UInt256.add (UInt256.xor (UInt256.lor x.v6 (UInt256.lnot x.v9)) x.v0) x.v5))))) (UInt256.ofNat 22)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
