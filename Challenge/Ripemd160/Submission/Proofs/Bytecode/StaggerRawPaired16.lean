...
theorem site_pc : site.startPC = UInt256.ofNat 1888 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1326) = UInt256.ofNat 1888
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1888) template = UInt256.ofNat 1954 := by decide
  rw [hend] at hraw
