...
theorem site_pc : site.startPC = UInt256.ofNat 2017 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1274) = UInt256.ofNat 2017
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2017) template = UInt256.ofNat 2063 := by decide
  rw [hend] at hraw
