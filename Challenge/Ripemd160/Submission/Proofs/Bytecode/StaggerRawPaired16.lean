...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v9) (UInt256.ofNat 28))),
    ...
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land x.v3 (UInt256.add (UInt256.ofNat 34535016170389834383797866734609369064725061767952793) (UInt256.add (MachineState.readWord memory 630) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.xor x.v4 x.v6) (UInt256.lor x.v0 x.v9)) x.v0) (UInt256.land x.v9 x.v6)) x.v8))))) (UInt256.ofNat 31)))),
    x.v10,
    x.v11,
    x.v12,
    x.v13,
...
theorem site_pc : site.startPC = UInt256.ofNat 1951 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1377) = UInt256.ofNat 1951
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 1951, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2016, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 1951) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 1951) template = UInt256.ofNat 2016 := by decide
  rw [hend] at hraw
