...
theorem site_pc : site.startPC = UInt256.ofNat 1761 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1292) = UInt256.ofNat 1761
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1761) template = UInt256.ofNat 1807 := by decide
  rw [hend] at hraw
