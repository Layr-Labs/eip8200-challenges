...
def template : List Instr :=
  [ .op (.Swap ⟨0, by decide⟩),
    ...
    .op (.Dup ⟨5, by decide⟩),
    .op .ADD,
    .push ⟨13, by decide⟩ (UInt256.ofNat 20123953283308614743486684463133),
    .op (.Dup ⟨13, by decide⟩),
    .op (.Swap ⟨1, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op .AND,
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 23))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mulMod (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 990) (UInt256.add (UInt256.xor x.v9 (UInt256.xor (UInt256.lor (UInt256.land x.v0 x.v4) (UInt256.xor (UInt256.land x.v9 x.v4) x.v6)) x.v0)) x.v7)))) (UInt256.ofNat 20123953283308614743486684463133) x.v12) (UInt256.ofNat 24)))),
    (UInt256.ofNat 23),
    x.v8,
    x.v9,
    x.v10,
