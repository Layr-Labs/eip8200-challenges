...
def guardEntry (input : ByteArray) : State := atPC input 4861
...
private theorem pc_g9 : Artifact.submissionArtifact.instructionPC 9 = 12 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
private theorem pc_g10 : Artifact.submissionArtifact.instructionPC 10 = 14 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
private theorem pc_g11 : Artifact.submissionArtifact.instructionPC 11 = 15 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
private theorem pc_g12 : Artifact.submissionArtifact.instructionPC 12 = 16 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
...
theorem generic_dest : Decode.isValidJumpDest submissionBytecode 353 = true := by
  have hpc : Artifact.submissionArtifact.instructionPC 242 = 353 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; rfl
...
theorem run_gate_prefix (input : ByteArray) :
    run gatePrefix (PatternedScan.stS input 11 []) =
      some (PatternedScan.stS input 24 [353, EntryGateLogic.gateWord input.size]) := by
  ...
  let l1 : Located := pushAt 9 1 2
  have h1 := PatternedScan.blockOfS l1
    (PatternedScan.pcFactS input 9 12 [n] (by norm_num) pc_g9)
    (PatternedScan.stepS_push input 12 1 2 [n] (by simp) (by decide) (by decide) (by norm_num))
  let l2 : Located := opAt 10 .SHR
  have h2 := PatternedScan.blockOfS l2
    (PatternedScan.pcFactS input 10 14 [2, n] (by norm_num) pc_g10)
    (PatternedScan.stepS_shr input 14 2 n [] (by simp) (by norm_num))
  let l3 : Located := opAt 11 .CALLDATASIZE
  have h3 := PatternedScan.blockOfS l3
    (PatternedScan.pcFactS input 11 15 [s] (by norm_num) pc_g11)
    (stepS_calldatasize input 15 [s] (by simp) (by norm_num))
  let l4 : Located := pushAt 12 2 1000
  have h4 := PatternedScan.blockOfS l4
    (PatternedScan.pcFactS input 12 16 [n, s] (by norm_num) pc_g12)
    (PatternedScan.stepS_push input 16 2 1000 [n, s] (by simp) (by decide) (by decide) (by norm_num))
  let l5 : Located := opAt 13 .XOR
  have h5 := PatternedScan.blockOfS l5
    (PatternedScan.pcFactS input 13 19 [1000, n, s] (by norm_num) pc_g13)
    (PatternedScan.stepS_xor input 19 1000 n [s] (by simp) (by norm_num))
  let l6 : Located := opAt 14 .MUL
  have h6 := PatternedScan.blockOfS l6
    (PatternedScan.pcFactS input 14 20 [x, s] (by norm_num) pc_g14)
    (PatternedScan.stepS_mul input 20 x s [] (by simp) (by norm_num))
  let l7 : Located := pushAt 15 2 353
  have h7 := PatternedScan.blockOfS l7
    (PatternedScan.pcFactS input 15 21 [x * s] (by norm_num) pc_g15)
    (PatternedScan.stepS_push input 21 2 353 [x * s] (by simp) (by decide) (by decide) (by norm_num))
...
theorem run_gate_taken (input : ByteArray) (hfit : CalldataFits input)
    ...
    run gatePath (PatternedScan.stS input 11 []) = some (PatternedScan.stS input 353 []) := by
  have hj : run [opAt 16 .JUMPI]
      (PatternedScan.stS input 24 [353, EntryGateLogic.gateWord input.size]) =
      some (PatternedScan.stS input 353 []) := by
    exact PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 16 24 _ (by norm_num) pc_g16)
      (PatternedScan.stepS_jumpi_taken input 24 353 353 _ []
...
theorem run_gate_fall (input : ByteArray) (hfit : CalldataFits input)
  ...
  have hj : run [opAt 16 .JUMPI]
    ...
    exact PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 16 24 _ (by norm_num) pc_g16)
      (PatternedScan.stepS_jumpi_fall input 24 353 _ []
