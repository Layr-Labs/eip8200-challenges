...
def guardEntry (input : ByteArray) : State := atPC input 4959
...
theorem run_size_fail_large (input : ByteArray) (hfit : CalldataFits input)
  ...
  change run largeSizePath (PatternedScan.stS input 8 []) =
    some (PatternedScan.stS input 4959 [])
  -- rw idiom rather than term mode: the term form forces instructionPC 4066 and
  ...
  have hpc4131 : Artifact.submissionArtifact.instructionPC 4066 = 4959 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]
    decide
  have hdest : Decode.isValidJumpDest submissionBytecode 4959 = true := by
    have h := Artifact.submissionArtifact.isValidJumpDest_index 4066 (by rfl)
    rw [hpc4131] at h
    exact h
  have hprefix :
      run
    ...
    simp (config := { decide := true })
      [opAt, pushAt, wfOp, PatternedScan.stS,
       ...
       Challenge.EvmProof.Word.word_toNat_ofNat]
  have hpush :
      run [pushAt 17 2 4959] (PatternedScan.stS input 26 [UInt256.ofNat 1]) =
        some (PatternedScan.stS input 29 [UInt256.ofNat 4959, UInt256.ofNat 1]) := by
    exact PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 17 26 _ (by norm_num) pc_classifier_112)
      (PatternedScan.stepS_push input 26 2 4959 [UInt256.ofNat 1]
        (by norm_num) (by decide) (by decide) (by norm_num))
  have htrue : UInt256.isTrue (UInt256.ofNat 1) := by decide
  have hjump :
      run [opAt 18 .JUMPI]
          (PatternedScan.stS input 29 [UInt256.ofNat 4959, UInt256.ofNat 1]) =
        some (PatternedScan.stS input 4959 []) := by
    exact PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 18 29 _ (by norm_num) pc_classifier_113)
      (PatternedScan.stepS_jumpi_taken input 29 4959 4959 (UInt256.ofNat 1) []
  ...
  have hprefix_push :
    ...
    exact Challenge.EvmProof.Stepper.runLocatedBlock_append
      [opAt 5 .CALLDATASIZE, pushAt 6 2 256, opAt 7 .EQ,
       ...
       opAt 11 .CALLDATASIZE, pushAt 12 2 1000,
       opAt 13 .EQ, opAt 14 .OR, opAt 15 .OR, opAt 16 .ISZERO]
      [pushAt 17 2 4959] _ _ _ hprefix rfl hpush
  have hfull :
      run
          [opAt 5 .CALLDATASIZE, pushAt 6 2 256, opAt 7 .EQ,
           opAt 8 .CALLDATASIZE, pushAt 9 2 376, opAt 10 .EQ,
           opAt 11 .CALLDATASIZE, pushAt 12 2 1000,
           opAt 13 .EQ, opAt 14 .OR, opAt 15 .OR, opAt 16 .ISZERO,
           pushAt 17 2 4959, opAt 18 .JUMPI]
        (PatternedScan.stS input 8 []) =
      some (PatternedScan.stS input 4959 []) := by
    exact Challenge.EvmProof.Stepper.runLocatedBlock_append
      [opAt 5 .CALLDATASIZE, pushAt 6 2 256, opAt 7 .EQ,
...
private theorem run_sizePrelude (input : ByteArray) (hfit : CalldataFits input) :
  ...
  have hp4 : Artifact.submissionArtifact.instructionPC 4 = 7 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
  have hdpc : Artifact.submissionArtifact.instructionPC 4066 = 4959 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
  have hdest : Decode.isValidJumpDest submissionBytecode 4959 = true := by
    have h := Artifact.submissionArtifact.isValidJumpDest_index 4066 (by rfl)
    rw [hdpc] at h
  ...
  change run sizePrelude (PatternedScan.stS input 0 []) =
    some (if input.size < 129 then PatternedScan.stS input 4959 [] else PatternedScan.stS input 8 [])
  ...
  have cc : run [opAt 2 .GT] (PatternedScan.stS input 3 [UInt256.ofNat 129, UInt256.ofNat input.size]) =
    ...
    exact PatternedScan.blockOfS _
      ...
      (PatternedScan.stepS_gt input 3 (UInt256.ofNat 129) (UInt256.ofNat input.size) []
        (by simp) (by norm_num))
  have d : run [pushAt 3 2 4959] (PatternedScan.stS input 4 [c]) =
      some (PatternedScan.stS input 7 [UInt256.ofNat 4959, c]) := by
    exact PatternedScan.blockOfS _
      (PatternedScan.pcFactS input 3 4 _ (by norm_num) hp3)
      (PatternedScan.stepS_push input 4 2 4959 [c]
        (by simp) (by decide) (by decide) (by norm_num))
  have e : run [opAt 4 .JUMPI] (PatternedScan.stS input 7 [UInt256.ofNat 4959, c]) =
      some (if input.size < 129 then PatternedScan.stS input 4959 [] else PatternedScan.stS input 8 []) := by
    ...
    · rw [if_pos hs]
      ...
      exact PatternedScan.blockOfS _
        ...
        (PatternedScan.stepS_jumpi_taken input 7 4959 4959 c []
          (by simp) (by norm_num) rfl hc hdest)
    · rw [if_neg hs]
      have hc : ¬ UInt256.isTrue c := by rw [hgt, if_neg hs]; decide
      exact PatternedScan.blockOfS _
        (PatternedScan.pcFactS input 4 7 _ (by norm_num) hp4)
        (PatternedScan.stepS_jumpi_fall input 7 4959 c []
  ...
  have abcd := Stepper.runLocatedBlock_append (([opAt 0 .CALLDATASIZE] ++ [pushAt 1 1 129]) ++ [opAt 2 .GT]) [pushAt 3 2 4959] _ _ _ abc rfl d
  have abcde := Stepper.runLocatedBlock_append ((([opAt 0 .CALLDATASIZE] ++ [pushAt 1 1 129]) ++ [opAt 2 .GT]) ++ [pushAt 3 2 4959]) [opAt 4 .JUMPI] _ _ _ abcd rfl e
