...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 680).take actualTemplate.length = actualTemplate := by rfl
def actualSite : GenericRoundSite Artifact.submissionArtifact .Osaka actualTemplate :=
  StackSiteBuilder.ofSlice actualTemplate 680 actual_slice
...
theorem actual_pc : actualSite.startPC = UInt256.ofNat 954 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 680) = UInt256.ofNat 954
