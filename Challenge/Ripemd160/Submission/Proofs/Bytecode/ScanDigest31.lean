...
namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.ScanDigest31
open EvmSemantics EvmSemantics.Crypto
open Challenge.Ripemd160.Submission.Proofs.Bytecode
def data : ByteArray := ByteArray.mk #[0x7, 0x2c, 0x51, 0x76, 0x9b, 0xc0, 0xe5, 0xa, 0x2f, 0x54, 0x79, 0x9e, 0xc3, 0xe8, 0xd, 0x32, 0x57, 0x7c, 0xa1, 0xc6, 0xeb, 0x10, 0x35, 0x5a, 0x7f, 0xa4, 0xc9, 0xee, 0x13, 0x38, 0x5d]
def digest : ByteArray := ByteArray.mk #[0xdb, 0x4d, 0x90, 0xb3, 0xbe, 0x82, 0x8e, 0xa7, 0xce, 0xd8, 0xd8, 0x79, 0xdb, 0xce, 0xa2, 0xc1, 0xd5, 0xfe, 0x20, 0x7f]
def paddedDigest : ByteArray := ByteArray.mk #[0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xdb, 0x4d, 0x90, 0xb3, 0xbe, 0x82, 0x8e, 0xa7, 0xce, 0xd8, 0xd8, 0x79, 0xdb, 0xce, 0xa2, 0xc1, 0xd5, 0xfe, 0x20, 0x7f]
def paddedDigestWord : UInt256 := 0xdb4d90b3be828ea7ced8d879dbcea2c1d5fe207f
theorem data_pattern : data = ShortPatternLogic.data31 := by decide
def finalWords : Array UInt32 := #[0x76512c07, 0xae5c09b, 0x9e79542f, 0x320de8c3, 0xc6a17c57, 0x5a3510eb, 0xeec9a47f, 0x805d3813, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xf8, 0x0]
def finalState : Array UInt32 := #[0xb3904ddb, 0xa78e82be, 0x79d8d8ce, 0xc1a2cedb, 0x7f20fed5]
...
theorem spec_data : Challenge.Ripemd160.spec data = paddedDigest := by
  ...
  rw [hash_data]
  decide
theorem spec_pattern : Challenge.Ripemd160.spec ShortPatternLogic.data31 = paddedDigest := by
  rw [← data_pattern]
  exact spec_data
#print axioms spec_pattern
end Challenge.Ripemd160.Submission.Proofs.Bytecode.ScanDigest31
