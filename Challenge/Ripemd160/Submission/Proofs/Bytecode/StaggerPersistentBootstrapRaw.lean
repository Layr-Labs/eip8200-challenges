...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 := [(UInt256.ofNat 1352829926), x.h0, x.h1, x.h2, x.h3, x.h4, (UInt256.ofNat 4294967297), (UInt256.ofNat 4294967295), (MachineState.readWord memory 140), (MachineState.readWord memory 190), (MachineState.readWord memory 310), (MachineState.readWord memory 350), x.h4, x.h1, x.h2, x.h3, x.h0, x.off, x.limit] ++ rho
