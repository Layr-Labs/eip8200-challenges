import Challenge.Ripemd160.Submission.Proofs.Bytecode.Paired80SumsNormalize
...
theorem normalize_four_adds (a0 a1 a2 a3 b0 b1 b2 b3 : BitVec 32) :
  ...
  have hsplit :
      (((a0.toNat + b0.toNat * 2 ^ 80) +
        (a1.toNat + b1.toNat * 2 ^ 80)) +
        (a2.toNat + b2.toNat * 2 ^ 80)) +
        (a3.toNat + b3.toNat * 2 ^ 80) =
      (a0.toNat + a1.toNat + a2.toNat + a3.toNat) +
        (b0.toNat + b1.toNat + b2.toNat + b3.toNat) * 2 ^ 80 := by
