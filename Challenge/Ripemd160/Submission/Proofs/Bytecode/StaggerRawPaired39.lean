...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.land (UInt256.ofNat 1267650599933081496321645346815) (UInt256.lor (UInt256.shiftRight (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 522) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8))) (UInt256.ofNat 76)) (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 522) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8)))))) (UInt256.ofNat 23)))),
    x.v7,
    x.v0,
    x.v9,
    x.v10,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 2150 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 2788 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2150) = UInt256.ofNat 2788
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 2788, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 2839, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 2788) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 2788) template = UInt256.ofNat 2839 := by decide
  rw [hend] at hraw
