...
theorem site_pc : site.startPC = UInt256.ofNat 2751 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2124) = UInt256.ofNat 2751
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2751) template = UInt256.ofNat 2800 := by decide
  rw [hend] at hraw
