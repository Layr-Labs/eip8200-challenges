...
def right0 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step true false 4 8 (MachineState.readWord memory 540) (UInt256.ofNat 1352829926) q
...
def right2 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step true false 4 9 (MachineState.readWord memory 378) (UInt256.ofNat 1352829926) q
...
def left78 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step false false 4 5 (MachineState.readWord memory 1008) (UInt256.ofNat 2840853838) q
def left79 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step false false 4 6 (MachineState.readWord memory 288) (UInt256.ofNat 2840853838) q
