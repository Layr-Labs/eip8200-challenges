...
def pairWord (l r : UInt256) : UInt256 := UInt256.lor (UInt256.shiftLeft r (UInt256.ofNat 172)) l
...
def right0 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step true false 4 8 (MachineState.readWord memory 486) (UInt256.ofNat 1352829954) q
def right1 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step true false 4 9 (MachineState.readWord memory 162) (UInt256.ofNat 1352829954) q
def right2 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step true false 4 9 (MachineState.readWord memory 252) (UInt256.ofNat 1352829954) q
def left77 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step true false 4 8 (MachineState.readWord memory 0) (UInt256.ofNat 2840853866) q
def left78 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step false false 4 5 (MachineState.readWord memory 612) (UInt256.ofNat 2840853866) q
def left79 (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerScalarWord.step false false 4 6 (MachineState.readWord memory 198) (UInt256.ofNat 2840853866) q
...
def paired (memory : ByteArray) (q : WordLane) : WordLane :=
  StaggerModeSeven.fold (message memory) 77 (pair q (prologue memory q))
...
def addResult (memory : ByteArray) (l r : UInt256) (haddr : Nat) : UInt256 :=
  StaggerScalarWord.mask (UInt256.add (UInt256.add l
    (UInt256.shiftRight r (UInt256.ofNat 172))) (MachineState.readWord memory haddr))
