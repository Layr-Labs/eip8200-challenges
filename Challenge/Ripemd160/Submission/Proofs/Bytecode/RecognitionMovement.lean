...
def gasSteps_finish_yes (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    ...
    GasSteps (atState s 313 (frame f rho)) (atState s 4888 (frame f rho)) := by
  apply finish.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_finish s (UInt256.ofNat 313) f rho 4888 hs e.run (valid_4796 s e)
