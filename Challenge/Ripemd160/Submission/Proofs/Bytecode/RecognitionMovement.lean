...
def gasSteps_normal (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 334 (frame f rho)) (atState s 357 (frame (RecognitionBodyRaw.normalResult s f) rho)) := by
  apply normal.lift s _ e (frame f rho)
  have h := RecognitionFundedBodyRaw.run_normal s (UInt256.ofNat 334) f rho hs e.run
...
def gasSteps_boundary (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 373 (frame f rho)) (atState s 426 (frame (RecognitionBodyRaw.boundaryResult s f) rho)) := by
  apply boundary.lift s _ e (frame f rho)
  have h := RecognitionFundedBodyRaw.run_boundary s (UInt256.ofNat 373) f rho hs e.run
...
def gasSteps_partial (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 448 (frame f rho)) (atState s 464 (frame (RecognitionControlRaw.partialResult s f) rho)) := by
  apply partialWord.lift s _ e (frame f rho)
  have h := RecognitionControlRaw.run_partial s (UInt256.ofNat 448) f rho hs e.run
...
def gasSteps_reset0 (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 319 (frame f rho)) (atState s 322 (frame ({f with stop := f.full}) rho)) := by
  apply reset0.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_reset s (UInt256.ofNat 319) f rho hs e.run
...
def gasSteps_reset (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 433 (frame f rho)) (atState s 436 (frame ({f with stop := f.full}) rho)) := by
  apply reset.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_reset s (UInt256.ofNat 433) f rho hs e.run
...
def gasSteps_init (s : State) (e : Env s) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 108 rho)
      (atState s 312 (frame (RecognitionControlRaw.initResult s.executionEnv.calldata.size) rho)) := by
...
def gasSteps_test0_continue (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    ...
    GasSteps (atState s 323 (frame f rho)) (atState s 334 (frame f rho)) := by
  apply test0.lift s _ e (frame f rho)
  have h := RecognitionControlRaw.run_test_continue s (UInt256.ofNat 323) f rho 334 hs e.run hc (valid_185 s e)
...
def gasSteps_test0_exit (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    ...
    GasSteps (atState s 323 (frame f rho)) (atState s 330 (frame f rho)) := by
  apply test0.lift s _ e (frame f rho)
  have h := RecognitionControlRaw.run_test_exit s (UInt256.ofNat 323) f rho 334 hs e.run hc
  simpa only [atState, test0.end_pc] using h

def gasSteps_test_continue (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    (hs : rho.length ≤ 990) (hc : f.off.toNat < f.stop.toNat) :
    GasSteps (atState s 357 (frame f rho)) (atState s 334 (frame f rho)) := by
  apply test.lift s _ e (frame f rho)
  have h := RecognitionControlRaw.run_test_continue s (UInt256.ofNat 357) f rho 334 hs e.run hc (valid_185 s e)
  simpa only [atState, test.end_pc] using h

def gasSteps_test_exit (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    (hs : rho.length ≤ 990) (hc : f.stop.toNat ≤ f.off.toNat) :
    GasSteps (atState s 357 (frame f rho)) (atState s 364 (frame f rho)) := by
  apply test.lift s _ e (frame f rho)
  have h := RecognitionControlRaw.run_test_exit s (UInt256.ofNat 357) f rho 334 hs e.run hc
  simpa only [atState, test.end_pc] using h
...
def gasSteps_segment_yes (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    ...
    GasSteps (atState s 364 (frame f rho)) (atState s 440 (frame f rho)) := by
  apply segment.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_segment s (UInt256.ofNat 364) f rho 440 hs e.run (valid_291 s e)
...
def gasSteps_segment_no (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    (hs : rho.length ≤ 990) (hc : ¬ (¬ f.off.toNat < f.full.toNat)) :
    GasSteps (atState s 364 (frame f rho)) (atState s 373 (frame f rho)) := by
  apply segment.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_segment s (UInt256.ofNat 364) f rho 440 hs e.run (valid_291 s e)
...
def gasSteps_partialBranch_yes (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    ...
    GasSteps (atState s 440 (frame f rho)) (atState s 464 (frame f rho)) := by
  apply partialBranch.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_partial s (UInt256.ofNat 440) f rho 464 hs e.run (valid_315 s e)
...
def gasSteps_partialBranch_no (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    (hs : rho.length ≤ 990) (hc : ¬ (f.off.toNat = s.executionEnv.calldata.size % 2^256)) :
    GasSteps (atState s 440 (frame f rho)) (atState s 448 (frame f rho)) := by
  apply partialBranch.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_partial s (UInt256.ofNat 440) f rho 464 hs e.run (valid_315 s e)
...
def gasSteps_finish_yes (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    ...
    GasSteps (atState s 464 (frame f rho)) (atState s 469 (RecognitionBranchRaw.finishRest f rho)) := by
  apply finish.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_finish s (UInt256.ofNat 464) f rho 488 hs e.run (valid_342 s e)
...
def gasSteps_finish_no (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256)
    (hs : rho.length ≤ 990) (hc : ¬ (f.acc.toNat = 0)) :
    GasSteps (atState s 464 (frame f rho)) (atState s 488 (RecognitionBranchRaw.finishRest f rho)) := by
  apply finish.lift s _ e (frame f rho)
  have h := RecognitionBranchRaw.run_finish s (UInt256.ofNat 464) f rho 488 hs e.run (valid_342 s e)
...
def gasSteps_cleanup (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 488 (RecognitionBranchRaw.finishRest f rho)) (atState s 497 rho) := by
  apply cleanup.lift s _ e (RecognitionBranchRaw.finishRest f rho)
  have h := RecognitionControlSimplify.run_cleanup s (UInt256.ofNat 488) f rho hs e.run
...
def gasSteps_clamp0 (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 312 (frame f rho)) (atState s 322 (frame (RecognitionFrame.clamp f) rho)) := by
  have h := RecognitionBranchRaw.run_clamp s (UInt256.ofNat 312) f rho 322 hs e.run (valid_174 s e)
  ...
  · have g : GasSteps (atState s 312 (frame f rho))
        (atState s 319 (frame f rho)) := by
      apply clamp0.lift s _ e (frame f rho)
...
def gasSteps_back (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 436 (frame f rho)) (atState s 322 (frame f rho)) := by
  apply back.lift s _ e (frame f rho)
  have hv : Decode.isValidJumpDest s.executionEnv.code 322 = true := by
...
def gasSteps_clamp (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 426 (frame f rho)) (atState s 322 (frame (RecognitionFrame.clamp f) rho)) := by
  have h := RecognitionBranchRaw.run_clamp_width 2 (by decide) s (UInt256.ofNat 426) f rho 322 hs e.run (valid_175 s e)
  by_cases hc : f.stop.toNat < f.full.toNat
  · apply clamp.lift s _ e (frame f rho)
    simpa only [atState, RecognitionFrame.clamp, if_pos hc] using h
  · have g : GasSteps (atState s 426 (frame f rho))
        (atState s 433 (frame f rho)) := by
      apply clamp.lift s _ e (frame f rho)
...
def gasSteps_pass0 (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 322 (frame f rho)) (atState s 323 (frame f rho)) := by
  apply pass0.lift s _ e (frame f rho)
  have h := RecognitionControlSimplify.run_pass s (UInt256.ofNat 322) (frame f rho)
...
def gasSteps_skip (s : State) (e : Env s) (f : RecognitionBodyRaw.Frame) (rho : List UInt256) (hs : rho.length ≤ 990) :
    GasSteps (atState s 330 (frame f rho)) (atState s 364 (frame f rho)) := by
  apply skip.lift s _ e (frame f rho)
  have hv : Decode.isValidJumpDest s.executionEnv.code 364 = true := by
