import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 3289 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2690) = UInt256.ofNat 3289
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 3289) template = UInt256.ofNat 3334 := by decide
   rw [hend] at hraw
