...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.add (UInt256.mul (UInt256.ofNat 63) (UInt256.land (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 864) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v6 x.v0) (UInt256.xor x.v4 x.v9)) x.v0) (UInt256.land x.v9 x.v6)) x.v7)))) x.v4)) (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.add (MachineState.readWord memory 864) (UInt256.add (UInt256.lor (UInt256.xor (UInt256.land (UInt256.lor x.v6 x.v0) (UInt256.xor x.v4 x.v9)) x.v0) (UInt256.land x.v9 x.v6)) x.v7)))))) (UInt256.ofNat 32)))),
    x.v0,
    x.v8,
    x.v9,
    x.v10,
...
theorem site_pc : site.startPC = UInt256.ofNat 1954 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1366) = UInt256.ofNat 1954
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 1954) template = UInt256.ofNat 2002 := by decide
  rw [hend] at hraw
