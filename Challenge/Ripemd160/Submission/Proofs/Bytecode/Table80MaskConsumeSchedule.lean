...
import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80MaskConsumePool
...
def normalTemplate : List Instr := ((Table80Setup.initialTemplate ++ endianTemplate) ++ poolTemplate) ++ storesTemplate
