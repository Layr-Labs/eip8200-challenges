...
def gasSteps_tail_hit_sym (input : ByteArray) (sv ov acc : UInt256) (hc : ¬ UInt256.isTrue (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (0x88add2f71c41668b : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))) :
    GasSteps (stS input 5131 [sv, ov, acc, P7, M, m7, P, m8])
      (stS input 5165 []) := by
  have step2962 := soundS (pushAt 3433 2 992)
    (blockOfS _ (pcFactS input 3433 0x140b [sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2962)
      (stepS_push input 0x140b 2 (992 : UInt256) [sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have step2963 := soundS (opAt 3434 .CALLDATALOAD)
    (blockOfS _ (pcFactS input 3434 0x140e [(992 : UInt256), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2963)
      (stepS_calldataload input 0x140e ((992 : UInt256)) [sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2964 := soundS (pushAt 3435 8 9848759918901945995)
    (blockOfS _ (pcFactS input 3435 0x140f [(MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2964)
  ...
  have step2965 := soundS (pushAt 3436 1 192)
    (blockOfS _ (pcFactS input 3436 0x1418 [(9848759918901945995 : UInt256), (MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2965)
  ...
  have step2966 := soundS (opAt 3437 .SHL)
    (blockOfS _ (pcFactS input 3437 0x141a [(192 : UInt256), (9848759918901945995 : UInt256), (MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2966)
  ...
  have step2967 := soundS (opAt 3438 .XOR)
    (blockOfS _ (pcFactS input 3438 0x141b [(UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)), (MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2967)
  ...
  have step2968 := soundS (opAt 3439 (.Dup ⟨3, by decide⟩))
    (blockOfS _ (pcFactS input 3439 0x141c [(UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2968)
  ...
  have step2969 := soundS (opAt 3440 .OR)
    (blockOfS _ (pcFactS input 3440 0x141d [acc, (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2969)
  ...
  have step2970 := soundS (opAt 3441 (.Swap ⟨2, by decide⟩))
    (blockOfS _ (pcFactS input 3441 0x141e [(UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2970)
  ...
  have step2971 := soundS (opAt 3442 .POP)
    (blockOfS _ (pcFactS input 3442 0x141f [acc, sv, ov, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), P7, M, m7, P, m8] (by norm_num) pc2971)
  ...
  have step2972 := soundS (opAt 3443 (.Swap ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 3443 0x1420 [sv, ov, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), P7, M, m7, P, m8] (by norm_num) pc2972)
  ...
  have step2973 := soundS (opAt 3444 (.Swap ⟨6, by decide⟩))
    (blockOfS _ (pcFactS input 3444 0x1421 [(UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), ov, sv, P7, M, m7, P, m8] (by norm_num) pc2973)
  ...
  have step2974 := soundS (opAt 3445 .POP)
    (blockOfS _ (pcFactS input 3445 0x1422 [m8, ov, sv, P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2974)
  ...
  have step2975 := soundS (opAt 3446 .POP)
    (blockOfS _ (pcFactS input 3446 0x1423 [ov, sv, P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2975)
  ...
  have step2976 := soundS (opAt 3447 .POP)
    (blockOfS _ (pcFactS input 3447 0x1424 [sv, P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2976)
  ...
  have step2977 := soundS (opAt 3448 .POP)
    (blockOfS _ (pcFactS input 3448 0x1425 [P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2977)
  ...
  have step2978 := soundS (opAt 3449 .POP)
    (blockOfS _ (pcFactS input 3449 0x1426 [M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2978)
  ...
  have step2979 := soundS (opAt 3450 .POP)
    (blockOfS _ (pcFactS input 3450 0x1427 [m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2979)
  ...
  have step2980 := soundS (opAt 3451 .POP)
    (blockOfS _ (pcFactS input 3451 0x1428 [P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2980)
  ...
  have step2981 := soundS (pushAt 3452 2 972)
    (blockOfS _ (pcFactS input 3452 0x1429 [(UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2981)
      (stepS_push input 0x1429 2 (972 : UInt256) [(UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by simp) (by decide) (by decide) (by norm_num)))
  have step2982 := soundS (opAt 3453 .JUMPI)
    (blockOfS _ (pcFactS input 3453 0x142c [(972 : UInt256), (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2982)
      (stepS_jumpi_fall input 0x142c ((972 : UInt256)) ((UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))) [] (by simp) (by norm_num) hc))
...
def gasSteps_tail_miss_sym (input : ByteArray) (sv ov acc : UInt256) (hc : UInt256.isTrue (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (0x88add2f71c41668b : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))) :
  ...
  have step2982 := soundS (opAt 3453 .JUMPI)
    (blockOfS _ (pcFactS input 3453 0x142c [(972 : UInt256), (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2982)
      (stepS_jumpi_taken input 0x142c 972 ((972 : UInt256)) ((UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))) [] (by simp) (by norm_num) rfl hc hdest1006))
  exact step2962.trans (step2963.trans (step2964.trans (step2965.trans (step2966.trans (step2967.trans (step2968.trans (step2969.trans (step2970.trans (step2971.trans (step2972.trans (step2973.trans (step2974.trans (step2975.trans (step2976.trans (step2977.trans (step2978.trans (step2979.trans (step2980.trans (step2981.trans (step2982))))))))))))))))))))
...
private theorem tail_state_eq (input : ByteArray) :
    tailState input (scanAcc input 31) =
      stS input 5131 [UInt256.ofNat (scalarAt 31), UInt256.ofNat 992,
...
def gasSteps_tail_hit (input : ByteArray) (hz : scanAccFinal input = 0) :
  ...
  have hc : ¬ UInt256.isTrue (UInt256.lor (scanAcc input 31)
    ...
    exact fun h => h hz
  rw [tail_state_eq, show hitState input = stS input 5165 [] from rfl]
