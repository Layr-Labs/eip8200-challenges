...
def gasSteps_tail_hit_sym (input : ByteArray) (sv ov acc : UInt256) (hc : ¬ UInt256.isTrue (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (0x88add2f71c41668b : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))) :
    GasSteps (stS input 5203 [sv, ov, acc, P7, M, m7, P, m8])
      (stS input 5237 []) := by
  have step2962 := soundS (pushAt 3174 2 0x03e0)
    (blockOfS _ (pcFactS input 3174 5203 [sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2962)
      (stepS_push input 5203 2 (992 : UInt256) [sv, ov, acc, P7, M, m7, P, m8] (by simp) (by decide) (by decide) (by norm_num)))
  have step2963 := soundS (opAt 3175 .CALLDATALOAD)
    (blockOfS _ (pcFactS input 3175 5206 [(992 : UInt256), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2963)
      (stepS_calldataload input 5206 ((992 : UInt256)) [sv, ov, acc, P7, M, m7, P, m8] (by simp) (by norm_num)))
  have step2964 := soundS (pushAt 3176 8 0x88add2f71c41668b)
    (blockOfS _ (pcFactS input 3176 5207 [(MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2964)
  ...
  have step2965 := soundS (pushAt 3177 1 0xc0)
    (blockOfS _ (pcFactS input 3177 5216 [(9848759918901945995 : UInt256), (MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2965)
  ...
  have step2966 := soundS (opAt 3178 .SHL)
    (blockOfS _ (pcFactS input 3178 5218 [(192 : UInt256), (9848759918901945995 : UInt256), (MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2966)
  ...
  have step2967 := soundS (opAt 3179 .XOR)
    (blockOfS _ (pcFactS input 3179 5219 [(UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)), (MachineState.readWord input ((992 : UInt256)).toNat), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2967)
  ...
  have step2968 := soundS (opAt 3180 (.Dup ⟨3, by decide⟩))
    (blockOfS _ (pcFactS input 3180 5220 [(UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2968)
  ...
  have step2969 := soundS (opAt 3181 .OR)
    (blockOfS _ (pcFactS input 3181 5221 [acc, (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2969)
  ...
  have step2970 := soundS (opAt 3182 (.Swap ⟨2, by decide⟩))
    (blockOfS _ (pcFactS input 3182 5222 [(UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), sv, ov, acc, P7, M, m7, P, m8] (by norm_num) pc2970)
  ...
  have step2971 := soundS (opAt 3183 .POP)
    (blockOfS _ (pcFactS input 3183 5223 [acc, sv, ov, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), P7, M, m7, P, m8] (by norm_num) pc2971)
  ...
  have step2972 := soundS (opAt 3184 (.Swap ⟨1, by decide⟩))
    (blockOfS _ (pcFactS input 3184 5224 [sv, ov, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), P7, M, m7, P, m8] (by norm_num) pc2972)
  ...
  have step2973 := soundS (opAt 3185 (.Swap ⟨6, by decide⟩))
    (blockOfS _ (pcFactS input 3185 5225 [(UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat))), ov, sv, P7, M, m7, P, m8] (by norm_num) pc2973)
  ...
  have step2974 := soundS (opAt 3186 .POP)
    (blockOfS _ (pcFactS input 3186 5226 [m8, ov, sv, P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2974)
  ...
  have step2975 := soundS (opAt 3187 .POP)
    (blockOfS _ (pcFactS input 3187 5227 [ov, sv, P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2975)
  ...
  have step2976 := soundS (opAt 3188 .POP)
    (blockOfS _ (pcFactS input 3188 5228 [sv, P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2976)
  ...
  have step2977 := soundS (opAt 3189 .POP)
    (blockOfS _ (pcFactS input 3189 5229 [P7, M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2977)
  ...
  have step2978 := soundS (opAt 3190 .POP)
    (blockOfS _ (pcFactS input 3190 5230 [M, m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2978)
  ...
  have step2979 := soundS (opAt 3191 .POP)
    (blockOfS _ (pcFactS input 3191 5231 [m7, P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2979)
  ...
  have step2980 := soundS (opAt 3192 .POP)
    (blockOfS _ (pcFactS input 3192 5232 [P, (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2980)
  ...
  have step2981 := soundS (pushAt 3193 2 0x03ee)
    (blockOfS _ (pcFactS input 3193 5233 [(UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2981)
  ...
  have step2982 := soundS (opAt 3194 .JUMPI)
    (blockOfS _ (pcFactS input 3194 5236 [(1006 : UInt256), (UInt256.lor acc (UInt256.xor (UInt256.shiftLeft (9848759918901945995 : UInt256) (192 : UInt256)) (MachineState.readWord input ((992 : UInt256)).toNat)))] (by norm_num) pc2982)
