...
def cache (memory : ByteArray) : List UInt256 :=
  [MachineState.readWord memory 288, MachineState.readWord memory 256, MachineState.readWord memory 384, MachineState.readWord memory 416, MachineState.readWord memory 320, MachineState.readWord memory 352]
