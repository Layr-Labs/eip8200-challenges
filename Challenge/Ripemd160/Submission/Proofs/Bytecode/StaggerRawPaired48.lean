...
theorem site_pc : site.startPC = UInt256.ofNat 3228 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2471) = UInt256.ofNat 3228
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3228) template = UInt256.ofNat 3275 := by decide
  rw [hend] at hraw
