...
It proves the primary 48-operation helper: 47 operations before `RETURN` and
...
theorem runInstrSeq_fastEndianStage16
  ...
  simpa [DenseScheduleTrace.stageState, FastOutputTemplate.fastEndianStage16,
    DenseScheduleTemplate.endianStage16] using
