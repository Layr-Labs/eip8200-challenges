...
theorem site_pc : site.startPC = UInt256.ofNat 3294 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2642) = UInt256.ofNat 3294
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3294) template = UInt256.ofNat 3334 := by decide
  rw [hend] at hraw
