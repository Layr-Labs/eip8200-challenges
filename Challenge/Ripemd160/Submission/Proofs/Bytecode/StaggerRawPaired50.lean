...
theorem site_pc : site.startPC = UInt256.ofNat 3296 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2545) = UInt256.ofNat 3296
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3296) template = UInt256.ofNat 3336 := by decide
  rw [hend] at hraw
