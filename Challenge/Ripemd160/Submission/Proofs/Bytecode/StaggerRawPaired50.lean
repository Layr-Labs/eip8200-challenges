...
theorem site_pc : site.startPC = UInt256.ofNat 3447 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2596) = UInt256.ofNat 3447
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3447) template = UInt256.ofNat 3487 := by decide
  rw [hend] at hraw
