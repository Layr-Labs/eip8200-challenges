...
theorem site_pc : site.startPC = UInt256.ofNat 2346 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1834) = UInt256.ofNat 2346
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2346) template = UInt256.ofNat 2384 := by decide
  rw [hend] at hraw
