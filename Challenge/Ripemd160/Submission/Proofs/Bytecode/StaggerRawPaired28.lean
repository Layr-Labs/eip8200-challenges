...
theorem site_pc : site.startPC = UInt256.ofNat 2490 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1845) = UInt256.ofNat 2490
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2490) template = UInt256.ofNat 2527 := by decide
  rw [hend] at hraw
