...
theorem site_pc : site.startPC = UInt256.ofNat 2493 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1855) = UInt256.ofNat 2493
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2493) template = UInt256.ofNat 2530 := by decide
  rw [hend] at hraw
