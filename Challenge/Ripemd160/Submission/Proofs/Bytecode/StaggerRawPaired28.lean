...
theorem site_pc : site.startPC = UInt256.ofNat 2438 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1804) = UInt256.ofNat 2438
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2438) template = UInt256.ofNat 2476 := by decide
  rw [hend] at hraw
