...
def digestStorePath : List Located :=
  [opAt 4149 .JUMPDEST,
   pushAt 4150 20 paddedDigestWord,
   pushAt 4151 0 0,
   opAt 4152 .MSTORE]

def digestFinishPath : List Located :=
  [pushAt 4154 0 0, opAt 4155 .RETURN]
...
@[simp] private theorem digestStorePC4160 :
    Artifact.submissionArtifact.instructionPC 4149 = 5151 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestStorePC4161 :
    Artifact.submissionArtifact.instructionPC 4150 = 5152 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestStorePC4162 :
    Artifact.submissionArtifact.instructionPC 4151 = 5173 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestStorePC4163 :
    Artifact.submissionArtifact.instructionPC 4152 = 5174 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestFinishPC4165 :
    Artifact.submissionArtifact.instructionPC 4154 = 5176 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestFinishPC4166 :
    Artifact.submissionArtifact.instructionPC 4155 = 5177 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide
...
theorem run_selector (input : ByteArray) (sv ov : UInt256)
  ...
  have hc : run [opAt 4172 .CALLDATASIZE, pushAt 4173 1 128, opAt 4174 .EQ, pushAt 4175 2 5151, opAt 4176 .JUMPI] (stS input 5199 (returnRest sv ov)) = some (stS input 5151 (returnRest sv ov)) := by
    have hdest : Decode.isValidJumpDest submissionBytecode 5151 = true :=
      Artifact.submissionArtifact.isValidJumpDest_index 4149 (by rfl)
    ...
    have h0123 :
      ...
      exact Challenge.EvmProof.Stepper.runLocatedBlock_append
        [opAt 4172 .CALLDATASIZE, pushAt 4173 1 128, opAt 4174 .EQ]
        [pushAt 4175 2 5151] _ _ _ h012 (by rfl) h3
    have h01234 :
        Challenge.EvmProof.Stepper.runLocatedBlock
            [opAt 4172 .CALLDATASIZE, pushAt 4173 1 128, opAt 4174 .EQ,
              pushAt 4175 2 5151, opAt 4176 .JUMPI]
            (stS input 5199 (returnRest sv ov)) =
          some (stS input 5151 (returnRest sv ov)) := by
      exact Challenge.EvmProof.Stepper.runLocatedBlock_append
        [opAt 4172 .CALLDATASIZE, pushAt 4173 1 128, opAt 4174 .EQ,
          pushAt 4175 2 5151] [opAt 4176 .JUMPI] _ _ _ h0123 (by rfl) h4
    exact h01234
  have hbc := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [opAt 4171 .JUMPDEST] [opAt 4172 .CALLDATASIZE, pushAt 4173 1 128, opAt 4174 .EQ, pushAt 4175 2 5151, opAt 4176 .JUMPI] _ _ _ hb (by rfl) hc
  have habc := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [opAt 161 .CALLDATASIZE, pushAt 162 1 129, opAt 163 .GT, pushAt 164 2 5198, opAt 165 .JUMPI] ([opAt 4171 .JUMPDEST] ++ [opAt 4172 .CALLDATASIZE, pushAt 4173 1 128, opAt 4174 .EQ, pushAt 4175 2 5151, opAt 4176 .JUMPI]) _ _ _ ha (by rfl) hbc
  exact habc
...
def gasSteps_return (input : ByteArray) (sv ov : UInt256)
  ...
  have hop : (storedState input sv ov).decodedOp = some .MSIZE :=
    Artifact.submissionArtifact.state_decodedOp_of (storedState input sv ov) 4153
