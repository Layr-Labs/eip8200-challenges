...
@[simp] private theorem digestStorePC4160 :
    Artifact.submissionArtifact.instructionPC 4143 = 5175 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestStorePC4161 :
    Artifact.submissionArtifact.instructionPC 4144 = 5176 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestStorePC4162 :
    Artifact.submissionArtifact.instructionPC 4145 = 5197 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestStorePC4163 :
    Artifact.submissionArtifact.instructionPC 4146 = 5198 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestFinishPC4165 :
    Artifact.submissionArtifact.instructionPC 4148 = 5200 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem digestFinishPC4166 :
    Artifact.submissionArtifact.instructionPC 4149 = 5201 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  decide

@[simp] private theorem shortHelperPC4181 :
    Artifact.submissionArtifact.instructionPC 4150 = 5202 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  rfl

@[simp] private theorem shortHelperPC4182 :
    Artifact.submissionArtifact.instructionPC 4151 = 5203 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  rfl

@[simp] private theorem shortHelperPC4183 :
    Artifact.submissionArtifact.instructionPC 4152 = 5204 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  rfl

@[simp] private theorem shortHelperPC4184 :
    Artifact.submissionArtifact.instructionPC 4153 = 5206 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  rfl

@[simp] private theorem shortHelperPC4185 :
    Artifact.submissionArtifact.instructionPC 4154 = 5207 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  rfl

@[simp] private theorem shortHelperPC4186 :
    Artifact.submissionArtifact.instructionPC 4155 = 5210 := by
  rw [ArtifactByteLength.instructionPC_eq_byteLength]
  rfl
...
theorem run_selector (input : ByteArray) (sv ov : UInt256)
  ...
  have ha : run [opAt 160 .CALLDATASIZE, pushAt 161 1 129, opAt 162 .GT, pushAt 163 2 5202, opAt 164 .JUMPI] (stS input 255 (returnRest sv ov)) = some (stS input 5202 (returnRest sv ov)) := by
    ...
    exact h01234
  have hb : run [opAt 4150 .JUMPDEST] (stS input 5202 (returnRest sv ov)) = some (stS input 5203 (returnRest sv ov)) := by
    exact blockOfS _ (pcFactS input 4150 5202 _ (by norm_num) shortHelperPC4181)
      (stepS_jumpdest input 5202 (returnRest sv ov) (by simp [returnRest]) (by norm_num))
  have hc : run [opAt 4151 .CALLDATASIZE, pushAt 4152 1 63, opAt 4153 .EQ, pushAt 4154 2 5175, opAt 4155 .JUMPI] (stS input 5203 (returnRest sv ov)) = some (stS input 5175 (returnRest sv ov)) := by
    ...
    have h0 :
      ...
      exact blockOfS _
        (pcFactS input 4151 5203 _ (by norm_num) shortHelperPC4182)
    ...
    have h1 :
      ...
      exact blockOfS _
        (pcFactS input 4152 5204 _ (by norm_num) shortHelperPC4183)
    ...
    have h2 :
      ...
      exact blockOfS _
        (pcFactS input 4153 5206 _ (by norm_num) shortHelperPC4184)
    ...
    have h3 :
      ...
      exact blockOfS _
        (pcFactS input 4154 5207 _ (by norm_num) shortHelperPC4185)
    ...
    have h4 :
      ...
      exact blockOfS _
        (pcFactS input 4155 5210 _ (by norm_num) shortHelperPC4186)
    ...
    have h0123 :
      ...
      exact Challenge.EvmProof.Stepper.runLocatedBlock_append
        [opAt 4151 .CALLDATASIZE, pushAt 4152 1 63, opAt 4153 .EQ]
        [pushAt 4154 2 5175] _ _ _ h012 (by rfl) h3
    have h01234 :
        Challenge.EvmProof.Stepper.runLocatedBlock
            [opAt 4151 .CALLDATASIZE, pushAt 4152 1 63, opAt 4153 .EQ,
              pushAt 4154 2 5175, opAt 4155 .JUMPI]
            (stS input 5203 (returnRest sv ov)) =
          some (stS input 5175 (returnRest sv ov)) := by
      exact Challenge.EvmProof.Stepper.runLocatedBlock_append
        [opAt 4151 .CALLDATASIZE, pushAt 4152 1 63, opAt 4153 .EQ,
          pushAt 4154 2 5175] [opAt 4155 .JUMPI] _ _ _ h0123 (by rfl) h4
    exact h01234
  have hbc := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [opAt 4150 .JUMPDEST] [opAt 4151 .CALLDATASIZE, pushAt 4152 1 63, opAt 4153 .EQ, pushAt 4154 2 5175, opAt 4155 .JUMPI] _ _ _ hb (by rfl) hc
  have habc := Challenge.EvmProof.Stepper.runLocatedBlock_append
    [opAt 160 .CALLDATASIZE, pushAt 161 1 129, opAt 162 .GT, pushAt 163 2 5202, opAt 164 .JUMPI] ([opAt 4150 .JUMPDEST] ++ [opAt 4151 .CALLDATASIZE, pushAt 4152 1 63, opAt 4153 .EQ, pushAt 4154 2 5175, opAt 4155 .JUMPI]) _ _ _ ha (by rfl) hbc
  exact habc
