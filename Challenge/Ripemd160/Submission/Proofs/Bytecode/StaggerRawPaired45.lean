...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.ofNat 45805601672572416830120737830960963807809187239029665) (UInt256.add (MachineState.readWord memory 576) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.land (UInt256.xor x.v9 x.v11) (UInt256.xor (UInt256.land x.v9 x.v0) x.v6))) x.v0) x.v8))) (UInt256.ofNat 72)) (UInt256.add (UInt256.ofNat 45805601672572416830120737830960963807809187239029665) (UInt256.add (MachineState.readWord memory 576) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.land (UInt256.xor x.v9 x.v11) (UInt256.xor (UInt256.land x.v9 x.v0) x.v6))) x.v0) x.v8)))))) (UInt256.ofNat 20)))),
    x.v7,
...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.ofNat 45805601672572416830120737830960963807809187239029665) (UInt256.add (MachineState.readWord memory 576) (UInt256.add (UInt256.xor (UInt256.xor x.v0 x.v11) (UInt256.land (UInt256.xor (UInt256.land x.v0 x.v9) x.v6) (UInt256.xor x.v9 x.v11))) x.v8))) (UInt256.ofNat 72)) (UInt256.add (UInt256.ofNat 45805601672572416830120737830960963807809187239029665) (UInt256.add (MachineState.readWord memory 576) (UInt256.add (UInt256.xor (UInt256.xor x.v0 x.v11) (UInt256.land (UInt256.xor (UInt256.land x.v0 x.v9) x.v6) (UInt256.xor x.v9 x.v11))) x.v8)))))) (UInt256.ofNat 20)))),
    x.v7,
    (UInt256.ofNat 45805601672572416830120737830960963807809187239029665),
    x.v9,
    x.v10,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 2338).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 2338 actual_slice
    (by change 2338 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 3032 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2338) = UInt256.ofNat 3032
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3032, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3102, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3032) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3032) template = UInt256.ofNat 3102 := by decide
  rw [hend] at hraw
