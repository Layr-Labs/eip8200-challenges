...
theorem site_pc : site.startPC = UInt256.ofNat 3088 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2227) = UInt256.ofNat 3088
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3088) template = UInt256.ofNat 3155 := by decide
  rw [hend] at hraw
