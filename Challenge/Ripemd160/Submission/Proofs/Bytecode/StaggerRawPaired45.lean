...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.add (UInt256.ofNat 4859812446901711551265000851017333273431271886815232) (UInt256.land x.v3 x.v5)) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.land (UInt256.xor x.v9 x.v11) (UInt256.xor (UInt256.land x.v9 x.v0) x.v6))) x.v0) x.v8))) (UInt256.ofNat 72)) (UInt256.add (UInt256.add (UInt256.ofNat 4859812446901711551265000851017333273431271886815232) (UInt256.land x.v3 x.v5)) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.land (UInt256.xor x.v9 x.v11) (UInt256.xor (UInt256.land x.v9 x.v0) x.v6))) x.v0) x.v8)))))) (UInt256.ofNat 20)))),
    x.v7,
...
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 2429 actual_slice
    ...
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 3159 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2429) = UInt256.ofNat 3159
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3159, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3216, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3159) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3159) template = UInt256.ofNat 3216 := by decide
  rw [hend] at hraw
