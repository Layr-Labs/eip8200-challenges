...
theorem site_pc : site.startPC = UInt256.ofNat 3117 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2390) = UInt256.ofNat 3117
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3117) template = UInt256.ofNat 3190 := by decide
  rw [hend] at hraw
