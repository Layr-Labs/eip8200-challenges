...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v2 (UInt256.shiftRight (UInt256.mul x.v9 x.v5) (UInt256.ofNat 28))),
    ...
    x.v3,
    x.v0,
    (UInt256.land x.v2 (UInt256.add x.v6 (UInt256.shiftRight (UInt256.mul x.v13 (UInt256.land x.v11 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.ofNat 141586572954389725278986803886319569511332025164491681) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor (UInt256.land x.v0 x.v8) x.v5) (UInt256.xor x.v8 x.v3)) x.v0) x.v8)) x.v7))) (UInt256.ofNat 72)) (UInt256.add (UInt256.ofNat 141586572954389725278986803886319569511332025164491681) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor (UInt256.land x.v0 x.v8) x.v5) (UInt256.xor x.v8 x.v3)) x.v0) x.v8)) x.v7)))))) (UInt256.ofNat 20)))),
    x.v6,
...
theorem site_pc : site.startPC = UInt256.ofNat 3127 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2401) = UInt256.ofNat 3127
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3127) template = UInt256.ofNat 3200 := by decide
  rw [hend] at hraw
