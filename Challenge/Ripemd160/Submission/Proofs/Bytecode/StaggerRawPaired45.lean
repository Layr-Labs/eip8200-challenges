...
theorem site_pc : site.startPC = UInt256.ofNat 3123 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2396) = UInt256.ofNat 3123
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3123) template = UInt256.ofNat 3196 := by decide
  rw [hend] at hraw
