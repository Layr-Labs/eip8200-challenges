...
theorem site_pc : site.startPC = UInt256.ofNat 3167 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2384) = UInt256.ofNat 3167
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3167) template = UInt256.ofNat 3240 := by decide
  rw [hend] at hraw
