...
def template : List Instr :=
  [ .op (.Swap ⟨4, by decide⟩),
    .op .POP,
    .push ⟨25, by decide⟩ (UInt256.ofNat 45805601672572416830120737830960963807809187239029665),
    .op (.Swap ⟨7, by decide⟩),
    .op (.Dup ⟨5, by decide⟩),
    .op (.Dup ⟨7, by decide⟩),
    .op (.Dup ⟨7, by decide⟩),
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.ofNat 45805601672572416830120737830960963807809187239029665) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.land (UInt256.xor x.v9 x.v11) (UInt256.xor (UInt256.land x.v9 x.v0) x.v6))) x.v0) x.v8))) (UInt256.ofNat 72)) (UInt256.add (UInt256.ofNat 45805601672572416830120737830960963807809187239029665) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.xor (UInt256.xor x.v11 (UInt256.land (UInt256.xor x.v9 x.v11) (UInt256.xor (UInt256.land x.v9 x.v0) x.v6))) x.v0) x.v8)))))) (UInt256.ofNat 20)))),
    x.v7,
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3187, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3260, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3187) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3187) template = UInt256.ofNat 3260 := by decide
  rw [hend] at hraw
