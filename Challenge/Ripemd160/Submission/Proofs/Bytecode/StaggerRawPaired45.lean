...
def template : List Instr :=
  [ .op (.Swap ⟨2, by decide⟩),
    .op .POP,
    .push ⟨15, by decide⟩ (UInt256.ofNat 7675423499596335302361841487440801),
    .op (.Swap ⟨5, by decide⟩),
    .op (.Dup ⟨7, by decide⟩),
    .op (.Dup ⟨4, by decide⟩),
    .op (.Dup ⟨1, by decide⟩),
...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v1 (UInt256.shiftRight (UInt256.mul x.v8 x.v4) (UInt256.ofNat 22))),
    ...
    x.v2,
    x.v0,
    (UInt256.land x.v1 (UInt256.add x.v5 (UInt256.shiftRight (UInt256.mul x.v8 (UInt256.add (UInt256.mul (UInt256.ofNat 7) (UInt256.land x.v2 (UInt256.land x.v1 (UInt256.add (UInt256.ofNat 7675423499596335302361841487440801) (UInt256.add (MachineState.readWord memory 270) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor (UInt256.land x.v0 x.v7) x.v4) (UInt256.xor x.v2 x.v7)) x.v0) x.v7)) x.v6)))))) (UInt256.land x.v1 (UInt256.add (UInt256.ofNat 7675423499596335302361841487440801) (UInt256.add (MachineState.readWord memory 270) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor (UInt256.lor (UInt256.xor (UInt256.land x.v0 x.v7) x.v4) (UInt256.xor x.v2 x.v7)) x.v0) x.v7)) x.v6)))))) (UInt256.ofNat 20)))),
    x.v5,
    (UInt256.ofNat 7675423499596335302361841487440801),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
theorem site_pc : site.startPC = UInt256.ofNat 3025 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2424) = UInt256.ofNat 3025
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3025, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3092, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3025) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3025) template = UInt256.ofNat 3092 := by decide
  rw [hend] at hraw
