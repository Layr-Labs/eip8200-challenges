...
def actualOutput (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul x.v14 (UInt256.land x.v12 (UInt256.lor (UInt256.shiftRight (UInt256.add (UInt256.ofNat 141586572954389725278986803886319569511332025164491681) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor x.v0 x.v9) (UInt256.lor (UInt256.xor x.v6 (UInt256.land x.v0 x.v9)) (UInt256.xor x.v9 x.v4)))) x.v8))) (UInt256.ofNat 72)) (UInt256.add (UInt256.ofNat 141586572954389725278986803886319569511332025164491681) (UInt256.add (MachineState.readWord memory 486) (UInt256.add (UInt256.lnot (UInt256.xor (UInt256.xor x.v0 x.v9) (UInt256.lor (UInt256.xor x.v6 (UInt256.land x.v0 x.v9)) (UInt256.xor x.v9 x.v4)))) x.v8)))))) (UInt256.ofNat 20)))),
    x.v7,
    (UInt256.ofNat 141586572954389725278986803886319569511332025164491681),
    x.v9,
    x.v10,
...
theorem actual_slice :
    (Artifact.submissionArtifact.instructions.drop 2431).take template.length = template := by rfl
def site : StackRoundTemplate.GenericRoundSite Artifact.submissionArtifact .Osaka template :=
  StackSiteBuilder.ofSlice template 2431 actual_slice
    (by change 2431 + template.length ≤ Artifact.submissionInstructions.length
        rw [Artifact.referenceInstructions_count]; decide)
    StackRoundData.artifact_code_bound
    (StackRoundData.templateWellFormed_mem (instructions := template) (by decide))
    (by decide)
theorem site_pc : site.startPC = UInt256.ofNat 3187 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2431) = UInt256.ofNat 3187
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
    ...
    GasSteps {s with pc := UInt256.ofNat 3187, stack := inputStack x rho}
      {s with pc := UInt256.ofNat 3259, stack := outputStack s.memory x rho} := by
  have hraw := run_actual s (UInt256.ofNat 3187) x rho hstack hrun hactive
  have hend : pcAfter (UInt256.ofNat 3187) template = UInt256.ofNat 3259 := by decide
  rw [hend] at hraw
