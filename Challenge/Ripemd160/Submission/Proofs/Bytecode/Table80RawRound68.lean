import Challenge.Ripemd160.Submission.Proofs.Bytecode.Table80RawCommon
 ...
 theorem site_pc : site.startPC = UInt256.ofNat 4114 := by
   change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 3442) = UInt256.ofNat 4114
 ...
 def gasSteps (s : State) (x : Input) (rho : List UInt256)
   ...
   have hend : pcAfter (UInt256.ofNat 4114) template = UInt256.ofNat 4158 := by decide
   rw [hend] at hraw
