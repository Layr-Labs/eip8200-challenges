...
private theorem scanBefore_pc :
    (YulEvmCompiler.assembleBytes scanBefore).length = 253 := by rfl
...
private theorem scan_instruction_pc (index : Nat)
    ...
    Artifact.submissionArtifact.instructionPC index =
      253 + (YulEvmCompiler.assembleBytes (scanSuffix.take (index - 150))).length := by
  have hi : index - 150 ≤ scanSuffix.length := by
    rw [scanSuffix_length]
    omega
  have h := ArtifactSegment.instructionPC_segment_of_bounds Artifact.submissionArtifact
    scanBefore scanSuffix [] 150 253 artifact_scan_split scanBefore_length
...
def wordPath : List Located :=
  [opAt 168 .JUMPDEST, opAt 169 (.Dup ⟨0, by decide⟩),
   ...
   opAt 185 .AND, pushAt 186 1 224, opAt 187 .EQ, pushAt 188 2 407,
   opAt 189 .JUMPI]
...
def comparePath : List Located :=
  [opAt 190 .JUMPDEST, opAt 191 (.Dup ⟨3, by decide⟩),
   ...
   pushAt 210 2 305, opAt 211 .JUMPI]

/-- Fold the padded tail word and branch misses to the deferred cleanup. -/
def tailPath : List Located :=
  [opAt 212 (.Dup ⟨1, by decide⟩), opAt 213 .CALLDATALOAD,
   pushAt 214 8 9848759918901945995, pushAt 215 1 192, opAt 216 .SHL,
   opAt 217 .XOR, opAt 218 (.Dup ⟨3, by decide⟩), opAt 219 .OR,
   pushAt 220 2 5310, opAt 221 .JUMPI]

/-- Store and return the stored digest. -/
def returnPath : List Located :=
  [pushAt 222 20 766350606435067737561421097975693824639675460820,
   pushAt 223 0 0, opAt 224 .MSTORE, opAt 225 .MSIZE, pushAt 226 0 0,
   opAt 227 .RETURN]

/-- On a miss, discard the eight scan temporaries and rejoin the generic path. -/
def cleanupPath : List Located :=
  [opAt 4282 .JUMPDEST,
   opAt 4283 .POP, opAt 4284 .POP, opAt 4285 .POP, opAt 4286 .POP,
   opAt 4287 .POP, opAt 4288 .POP, opAt 4289 .POP, opAt 4290 .POP,
   pushAt 4291 1 3, opAt 4292 .JUMP]

/-- Shift the correction constant out of `M`. -/
def straddleCorrPath : List Located :=
  [opAt 228 .JUMPDEST, opAt 229 (.Dup ⟨6, by decide⟩),
   opAt 230 (.Dup ⟨4, by decide⟩), pushAt 231 1 8, opAt 232 .SHR,
   pushAt 233 1 5, opAt 234 .MUL, pushAt 235 1 27, opAt 236 .SUB,
   pushAt 237 1 3, opAt 238 .SHL, opAt 239 .SHR, pushAt 240 1 11,
   opAt 241 .MUL]

/-- Apply the correction to the expected word. -/
def straddleAddPath : List Located :=
  [opAt 242 (.Dup ⟨1, by decide⟩), opAt 243 (.Dup ⟨9, by decide⟩),
   opAt 244 .AND, opAt 245 (.Dup ⟨1, by decide⟩), opAt 246 .ADD,
   opAt 247 (.Dup ⟨2, by decide⟩), opAt 248 (.Dup ⟨12, by decide⟩),
   opAt 249 .AND, opAt 250 .XOR, opAt 251 (.Swap ⟨1, by decide⟩),
   opAt 252 .POP, opAt 253 .POP]

/-- Bump the scalar and rejoin the scan. -/
def straddleBackPath : List Located :=
  [opAt 254 (.Swap ⟨1, by decide⟩), pushAt 255 1 11, opAt 256 .ADD,
   opAt 257 (.Swap ⟨1, by decide⟩), pushAt 258 3 331,
   opAt 259 .JUMP]


@[simp] theorem pc2903 : Artifact.submissionArtifact.instructionPC 150 = 0xfd :=
  by rw [scan_instruction_pc 150 (by decide) (by decide)]; rfl
@[simp] theorem pc2904 : Artifact.submissionArtifact.instructionPC 150 = 0xfd :=
  by rw [scan_instruction_pc 150 (by decide) (by decide)]; rfl
@[simp] theorem pc2905 : Artifact.submissionArtifact.instructionPC 154 = 0x102 :=
  by rw [scan_instruction_pc 154 (by decide) (by decide)]; rfl
@[simp] theorem pc2906 : Artifact.submissionArtifact.instructionPC 159 = 0x128 :=
  by rw [scan_instruction_pc 159 (by decide) (by decide)]; rfl
@[simp] theorem pc2907 : Artifact.submissionArtifact.instructionPC 161 = 0x12a :=
  by rw [scan_instruction_pc 161 (by decide) (by decide)]; rfl
@[simp] theorem pc2908 : Artifact.submissionArtifact.instructionPC 162 = 0x12b :=
  by rw [scan_instruction_pc 162 (by decide) (by decide)]; rfl
@[simp] theorem pc2909 : Artifact.submissionArtifact.instructionPC 163 = 0x12c :=
  by rw [scan_instruction_pc 163 (by decide) (by decide)]; rfl
@[simp] theorem pc2910 : Artifact.submissionArtifact.instructionPC 164 = 0x12d :=
  by rw [scan_instruction_pc 164 (by decide) (by decide)]; rfl
@[simp] theorem pc2911 : Artifact.submissionArtifact.instructionPC 165 = 0x12e :=
  by rw [scan_instruction_pc 165 (by decide) (by decide)]; rfl
@[simp] theorem pc2912 : Artifact.submissionArtifact.instructionPC 166 = 0x12f :=
  by rw [scan_instruction_pc 166 (by decide) (by decide)]; rfl
@[simp] theorem pc2913 : Artifact.submissionArtifact.instructionPC 167 = 0x130 :=
  by rw [scan_instruction_pc 167 (by decide) (by decide)]; rfl
@[simp] theorem pc2914 : Artifact.submissionArtifact.instructionPC 168 = 0x131 :=
  by rw [scan_instruction_pc 168 (by decide) (by decide)]; rfl
@[simp] theorem pc2915 : Artifact.submissionArtifact.instructionPC 169 = 0x132 :=
  by rw [scan_instruction_pc 169 (by decide) (by decide)]; rfl
@[simp] theorem pc2916 : Artifact.submissionArtifact.instructionPC 170 = 0x133 :=
  by rw [scan_instruction_pc 170 (by decide) (by decide)]; rfl
@[simp] theorem pc2917 : Artifact.submissionArtifact.instructionPC 171 = 0x134 :=
  by rw [scan_instruction_pc 171 (by decide) (by decide)]; rfl
@[simp] theorem pc2918 : Artifact.submissionArtifact.instructionPC 172 = 0x135 :=
  by rw [scan_instruction_pc 172 (by decide) (by decide)]; rfl
@[simp] theorem pc2919 : Artifact.submissionArtifact.instructionPC 173 = 0x136 :=
  by rw [scan_instruction_pc 173 (by decide) (by decide)]; rfl
@[simp] theorem pc2920 : Artifact.submissionArtifact.instructionPC 174 = 0x137 :=
  by rw [scan_instruction_pc 174 (by decide) (by decide)]; rfl
@[simp] theorem pc2921 : Artifact.submissionArtifact.instructionPC 175 = 0x138 :=
  by rw [scan_instruction_pc 175 (by decide) (by decide)]; rfl
@[simp] theorem pc2922 : Artifact.submissionArtifact.instructionPC 176 = 0x139 :=
  by rw [scan_instruction_pc 176 (by decide) (by decide)]; rfl
@[simp] theorem pc2923 : Artifact.submissionArtifact.instructionPC 177 = 0x13a :=
  by rw [scan_instruction_pc 177 (by decide) (by decide)]; rfl
@[simp] theorem pc2924 : Artifact.submissionArtifact.instructionPC 178 = 0x13b :=
  by rw [scan_instruction_pc 178 (by decide) (by decide)]; rfl
@[simp] theorem pc2925 : Artifact.submissionArtifact.instructionPC 179 = 0x13c :=
  by rw [scan_instruction_pc 179 (by decide) (by decide)]; rfl
@[simp] theorem pc2926 : Artifact.submissionArtifact.instructionPC 180 = 0x13d :=
  by rw [scan_instruction_pc 180 (by decide) (by decide)]; rfl
@[simp] theorem pc2927 : Artifact.submissionArtifact.instructionPC 181 = 0x13e :=
  by rw [scan_instruction_pc 181 (by decide) (by decide)]; rfl
@[simp] theorem pc2928 : Artifact.submissionArtifact.instructionPC 182 = 0x13f :=
  by rw [scan_instruction_pc 182 (by decide) (by decide)]; rfl
@[simp] theorem pc2929 : Artifact.submissionArtifact.instructionPC 183 = 0x140 :=
  by rw [scan_instruction_pc 183 (by decide) (by decide)]; rfl
@[simp] theorem pc2930 : Artifact.submissionArtifact.instructionPC 184 = 0x141 :=
  by rw [scan_instruction_pc 184 (by decide) (by decide)]; rfl
@[simp] theorem pc2931 : Artifact.submissionArtifact.instructionPC 185 = 0x143 :=
  by rw [scan_instruction_pc 185 (by decide) (by decide)]; rfl
@[simp] theorem pc2932 : Artifact.submissionArtifact.instructionPC 186 = 0x144 :=
  by rw [scan_instruction_pc 186 (by decide) (by decide)]; rfl
@[simp] theorem pc2933 : Artifact.submissionArtifact.instructionPC 187 = 0x146 :=
  by rw [scan_instruction_pc 187 (by decide) (by decide)]; rfl
@[simp] theorem pc2934 : Artifact.submissionArtifact.instructionPC 188 = 0x147 :=
  by rw [scan_instruction_pc 188 (by decide) (by decide)]; rfl
@[simp] theorem pc2935 : Artifact.submissionArtifact.instructionPC 189 = 0x14a :=
  by rw [scan_instruction_pc 189 (by decide) (by decide)]; rfl
@[simp] theorem pc2936 : Artifact.submissionArtifact.instructionPC 190 = 0x14b :=
  by rw [scan_instruction_pc 190 (by decide) (by decide)]; rfl
@[simp] theorem pc2937 : Artifact.submissionArtifact.instructionPC 191 = 0x14c :=
  by rw [scan_instruction_pc 191 (by decide) (by decide)]; rfl
@[simp] theorem pc2938 : Artifact.submissionArtifact.instructionPC 192 = 0x14d :=
  by rw [scan_instruction_pc 192 (by decide) (by decide)]; rfl
@[simp] theorem pc2939 : Artifact.submissionArtifact.instructionPC 193 = 0x14e :=
  by rw [scan_instruction_pc 193 (by decide) (by decide)]; rfl
@[simp] theorem pc2940 : Artifact.submissionArtifact.instructionPC 194 = 0x14f :=
  by rw [scan_instruction_pc 194 (by decide) (by decide)]; rfl
@[simp] theorem pc2941 : Artifact.submissionArtifact.instructionPC 195 = 0x150 :=
  by rw [scan_instruction_pc 195 (by decide) (by decide)]; rfl
@[simp] theorem pc2942 : Artifact.submissionArtifact.instructionPC 196 = 0x151 :=
  by rw [scan_instruction_pc 196 (by decide) (by decide)]; rfl
@[simp] theorem pc2943 : Artifact.submissionArtifact.instructionPC 197 = 0x152 :=
  by rw [scan_instruction_pc 197 (by decide) (by decide)]; rfl
@[simp] theorem pc2944 : Artifact.submissionArtifact.instructionPC 198 = 0x153 :=
  by rw [scan_instruction_pc 198 (by decide) (by decide)]; rfl
@[simp] theorem pc2945 : Artifact.submissionArtifact.instructionPC 199 = 0x154 :=
  by rw [scan_instruction_pc 199 (by decide) (by decide)]; rfl
@[simp] theorem pc2946 : Artifact.submissionArtifact.instructionPC 199 = 0x154 :=
  by rw [scan_instruction_pc 199 (by decide) (by decide)]; rfl
@[simp] theorem pc2947 : Artifact.submissionArtifact.instructionPC 200 = 0x156 :=
  by rw [scan_instruction_pc 200 (by decide) (by decide)]; rfl
@[simp] theorem pc2948 : Artifact.submissionArtifact.instructionPC 201 = 0x157 :=
  by rw [scan_instruction_pc 201 (by decide) (by decide)]; rfl
@[simp] theorem pc2949 : Artifact.submissionArtifact.instructionPC 202 = 0x159 :=
  by rw [scan_instruction_pc 202 (by decide) (by decide)]; rfl
@[simp] theorem pc2950 : Artifact.submissionArtifact.instructionPC 203 = 0x15a :=
  by rw [scan_instruction_pc 203 (by decide) (by decide)]; rfl
@[simp] theorem pc2951 : Artifact.submissionArtifact.instructionPC 203 = 0x15a :=
  by rw [scan_instruction_pc 203 (by decide) (by decide)]; rfl
@[simp] theorem pc2952 : Artifact.submissionArtifact.instructionPC 203 = 0x15a :=
  by rw [scan_instruction_pc 203 (by decide) (by decide)]; rfl
@[simp] theorem pc2953 : Artifact.submissionArtifact.instructionPC 204 = 0x15b :=
  by rw [scan_instruction_pc 204 (by decide) (by decide)]; rfl
@[simp] theorem pc2954 : Artifact.submissionArtifact.instructionPC 205 = 0x15d :=
  by rw [scan_instruction_pc 205 (by decide) (by decide)]; rfl
@[simp] theorem pc2955 : Artifact.submissionArtifact.instructionPC 206 = 0x15e :=
  by rw [scan_instruction_pc 206 (by decide) (by decide)]; rfl
@[simp] theorem pc2956 : Artifact.submissionArtifact.instructionPC 207 = 0x15f :=
  by rw [scan_instruction_pc 207 (by decide) (by decide)]; rfl
@[simp] theorem pc2957 : Artifact.submissionArtifact.instructionPC 207 = 0x15f :=
  by rw [scan_instruction_pc 207 (by decide) (by decide)]; rfl
@[simp] theorem pc2958 : Artifact.submissionArtifact.instructionPC 208 = 0x160 :=
  by rw [scan_instruction_pc 208 (by decide) (by decide)]; rfl
@[simp] theorem pc2959 : Artifact.submissionArtifact.instructionPC 209 = 0x163 :=
  by rw [scan_instruction_pc 209 (by decide) (by decide)]; rfl
@[simp] theorem pc2960 : Artifact.submissionArtifact.instructionPC 210 = 0x164 :=
  by rw [scan_instruction_pc 210 (by decide) (by decide)]; rfl
@[simp] theorem pc2961 : Artifact.submissionArtifact.instructionPC 211 = 0x167 :=
  by rw [scan_instruction_pc 211 (by decide) (by decide)]; rfl
@[simp] theorem pc2962 : Artifact.submissionArtifact.instructionPC 212 = 0x168 :=
  by rw [scan_instruction_pc 212 (by decide) (by decide)]; rfl
@[simp] theorem pc2963 : Artifact.submissionArtifact.instructionPC 213 = 0x169 :=
  by rw [scan_instruction_pc 213 (by decide) (by decide)]; rfl
@[simp] theorem pc2964 : Artifact.submissionArtifact.instructionPC 214 = 0x16a :=
  by rw [scan_instruction_pc 214 (by decide) (by decide)]; rfl
@[simp] theorem pc2965 : Artifact.submissionArtifact.instructionPC 215 = 0x173 :=
  by rw [scan_instruction_pc 215 (by decide) (by decide)]; rfl
@[simp] theorem pc2966 : Artifact.submissionArtifact.instructionPC 216 = 0x175 :=
  by rw [scan_instruction_pc 216 (by decide) (by decide)]; rfl
@[simp] theorem pc2967 : Artifact.submissionArtifact.instructionPC 217 = 0x176 :=
  by rw [scan_instruction_pc 217 (by decide) (by decide)]; rfl
@[simp] theorem pc2968 : Artifact.submissionArtifact.instructionPC 218 = 0x177 :=
  by rw [scan_instruction_pc 218 (by decide) (by decide)]; rfl
@[simp] theorem pc2969 : Artifact.submissionArtifact.instructionPC 219 = 0x178 :=
  by rw [scan_instruction_pc 219 (by decide) (by decide)]; rfl
@[simp] theorem pc2970 : Artifact.submissionArtifact.instructionPC 220 = 0x179 :=
  by rw [scan_instruction_pc 220 (by decide) (by decide)]; rfl
@[simp] theorem pc2971 : Artifact.submissionArtifact.instructionPC 221 = 0x17c :=
  by rw [scan_instruction_pc 221 (by decide) (by decide)]; rfl
@[simp] theorem pcReturn0 : Artifact.submissionArtifact.instructionPC 222 = 0x17d :=
  by rw [scan_instruction_pc 222 (by decide) (by decide)]; rfl
@[simp] theorem pcReturn1 : Artifact.submissionArtifact.instructionPC 223 = 0x192 :=
  by rw [scan_instruction_pc 223 (by decide) (by decide)]; rfl
@[simp] theorem pcReturn2 : Artifact.submissionArtifact.instructionPC 224 = 0x193 :=
  by rw [scan_instruction_pc 224 (by decide) (by decide)]; rfl
@[simp] theorem pcReturn3 : Artifact.submissionArtifact.instructionPC 225 = 0x194 :=
  by rw [scan_instruction_pc 225 (by decide) (by decide)]; rfl
@[simp] theorem pcReturn4 : Artifact.submissionArtifact.instructionPC 226 = 0x195 :=
  by rw [scan_instruction_pc 226 (by decide) (by decide)]; rfl
@[simp] theorem pcReturn5 : Artifact.submissionArtifact.instructionPC 227 = 0x196 :=
  by rw [scan_instruction_pc 227 (by decide) (by decide)]; rfl
@[simp] theorem pc2989 : Artifact.submissionArtifact.instructionPC 228 = 0x197 :=
  by rw [scan_instruction_pc 228 (by decide) (by decide)]; rfl
@[simp] theorem pc2990 : Artifact.submissionArtifact.instructionPC 229 = 0x198 :=
  by rw [scan_instruction_pc 229 (by decide) (by decide)]; rfl
@[simp] theorem pc2991 : Artifact.submissionArtifact.instructionPC 230 = 0x199 :=
  by rw [scan_instruction_pc 230 (by decide) (by decide)]; rfl
@[simp] theorem pc2992 : Artifact.submissionArtifact.instructionPC 231 = 0x19a :=
  by rw [scan_instruction_pc 231 (by decide) (by decide)]; rfl
@[simp] theorem pc2993 : Artifact.submissionArtifact.instructionPC 232 = 0x19c :=
  by rw [scan_instruction_pc 232 (by decide) (by decide)]; rfl
@[simp] theorem pc2994 : Artifact.submissionArtifact.instructionPC 233 = 0x19d :=
  by rw [scan_instruction_pc 233 (by decide) (by decide)]; rfl
@[simp] theorem pc2995 : Artifact.submissionArtifact.instructionPC 234 = 0x19f :=
  by rw [scan_instruction_pc 234 (by decide) (by decide)]; rfl
@[simp] theorem pc2996 : Artifact.submissionArtifact.instructionPC 235 = 0x1a0 :=
  by rw [scan_instruction_pc 235 (by decide) (by decide)]; rfl
@[simp] theorem pc2997 : Artifact.submissionArtifact.instructionPC 236 = 0x1a2 :=
  by rw [scan_instruction_pc 236 (by decide) (by decide)]; rfl
@[simp] theorem pc2998 : Artifact.submissionArtifact.instructionPC 237 = 0x1a3 :=
  by rw [scan_instruction_pc 237 (by decide) (by decide)]; rfl
@[simp] theorem pc2999 : Artifact.submissionArtifact.instructionPC 238 = 0x1a5 :=
  by rw [scan_instruction_pc 238 (by decide) (by decide)]; rfl
@[simp] theorem pc3000 : Artifact.submissionArtifact.instructionPC 239 = 0x1a6 :=
  by rw [scan_instruction_pc 239 (by decide) (by decide)]; rfl
@[simp] theorem pc3001 : Artifact.submissionArtifact.instructionPC 240 = 0x1a7 :=
  by rw [scan_instruction_pc 240 (by decide) (by decide)]; rfl
@[simp] theorem pc3002 : Artifact.submissionArtifact.instructionPC 241 = 0x1a9 :=
  by rw [scan_instruction_pc 241 (by decide) (by decide)]; rfl
@[simp] theorem pc3003 : Artifact.submissionArtifact.instructionPC 242 = 0x1aa :=
  by rw [scan_instruction_pc 242 (by decide) (by decide)]; rfl
@[simp] theorem pc3004 : Artifact.submissionArtifact.instructionPC 243 = 0x1ab :=
  by rw [scan_instruction_pc 243 (by decide) (by decide)]; rfl
@[simp] theorem pc3005 : Artifact.submissionArtifact.instructionPC 244 = 0x1ac :=
  by rw [scan_instruction_pc 244 (by decide) (by decide)]; rfl
@[simp] theorem pc3006 : Artifact.submissionArtifact.instructionPC 245 = 0x1ad :=
  by rw [scan_instruction_pc 245 (by decide) (by decide)]; rfl
@[simp] theorem pc3007 : Artifact.submissionArtifact.instructionPC 246 = 0x1ae :=
  by rw [scan_instruction_pc 246 (by decide) (by decide)]; rfl
@[simp] theorem pc3008 : Artifact.submissionArtifact.instructionPC 247 = 0x1af :=
  by rw [scan_instruction_pc 247 (by decide) (by decide)]; rfl
@[simp] theorem pc3009 : Artifact.submissionArtifact.instructionPC 248 = 0x1b0 :=
  by rw [scan_instruction_pc 248 (by decide) (by decide)]; rfl
@[simp] theorem pc3010 : Artifact.submissionArtifact.instructionPC 249 = 0x1b1 :=
  by rw [scan_instruction_pc 249 (by decide) (by decide)]; rfl
@[simp] theorem pc3011 : Artifact.submissionArtifact.instructionPC 250 = 0x1b2 :=
  by rw [scan_instruction_pc 250 (by decide) (by decide)]; rfl
@[simp] theorem pc3012 : Artifact.submissionArtifact.instructionPC 251 = 0x1b3 :=
  by rw [scan_instruction_pc 251 (by decide) (by decide)]; rfl
@[simp] theorem pc3013 : Artifact.submissionArtifact.instructionPC 252 = 0x1b4 :=
  by rw [scan_instruction_pc 252 (by decide) (by decide)]; rfl
@[simp] theorem pc3014 : Artifact.submissionArtifact.instructionPC 253 = 0x1b5 :=
  by rw [scan_instruction_pc 253 (by decide) (by decide)]; rfl
@[simp] theorem pc3015 : Artifact.submissionArtifact.instructionPC 254 = 0x1b6 :=
  by rw [scan_instruction_pc 254 (by decide) (by decide)]; rfl
@[simp] theorem pc3016 : Artifact.submissionArtifact.instructionPC 255 = 0x1b7 :=
  by rw [scan_instruction_pc 255 (by decide) (by decide)]; rfl
@[simp] theorem pc3017 : Artifact.submissionArtifact.instructionPC 256 = 0x1b9 :=
  by rw [scan_instruction_pc 256 (by decide) (by decide)]; rfl
@[simp] theorem pc3018 : Artifact.submissionArtifact.instructionPC 257 = 0x1ba :=
  by rw [scan_instruction_pc 257 (by decide) (by decide)]; rfl
@[simp] theorem pc3019 : Artifact.submissionArtifact.instructionPC 258 = 0x1bb :=
  by rw [scan_instruction_pc 258 (by decide) (by decide)]; rfl
@[simp] theorem pc3020 : Artifact.submissionArtifact.instructionPC 258 = 0x1bb :=
  by rw [scan_instruction_pc 258 (by decide) (by decide)]; rfl
@[simp] theorem pc3021 : Artifact.submissionArtifact.instructionPC 259 = 0x1bf :=
  by rw [scan_instruction_pc 259 (by decide) (by decide)]; rfl

@[simp] theorem pcCleanup0 : Artifact.submissionArtifact.instructionPC 4282 = 0x14be := by
  rw [scan_instruction_pc 4282 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup1 : Artifact.submissionArtifact.instructionPC 4283 = 0x14bf := by
  rw [scan_instruction_pc 4283 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup2 : Artifact.submissionArtifact.instructionPC 4284 = 0x14c0 := by
  rw [scan_instruction_pc 4284 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup3 : Artifact.submissionArtifact.instructionPC 4285 = 0x14c1 := by
  rw [scan_instruction_pc 4285 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup4 : Artifact.submissionArtifact.instructionPC 4286 = 0x14c2 := by
  rw [scan_instruction_pc 4286 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup5 : Artifact.submissionArtifact.instructionPC 4287 = 0x14c3 := by
  rw [scan_instruction_pc 4287 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup6 : Artifact.submissionArtifact.instructionPC 4288 = 0x14c4 := by
  rw [scan_instruction_pc 4288 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup7 : Artifact.submissionArtifact.instructionPC 4289 = 0x14c5 := by
  rw [scan_instruction_pc 4289 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup8 : Artifact.submissionArtifact.instructionPC 4290 = 0x14c6 := by
  rw [scan_instruction_pc 4290 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup9 : Artifact.submissionArtifact.instructionPC 4291 = 0x14c7 := by
  rw [scan_instruction_pc 4291 (by decide) (by decide)]
  rfl
@[simp] theorem pcCleanup10 : Artifact.submissionArtifact.instructionPC 4292 = 0x14c9 := by
  rw [scan_instruction_pc 4292 (by decide) (by decide)]
  rfl
