import Challenge.Ripemd160.Submission.Proofs.Bytecode.GuardArtifactFacts
...
private theorem scanSuffix_length : scanSuffix.length = 4031 := by
  simp [scanSuffix]
