...
private theorem scanSuffix_length : scanSuffix.length = 4062 := by
  simp [scanSuffix]
...
def tailPath : List Located :=
  [opAt 169 .JUMPDEST, opAt 171 (.Swap ⟨2, by decide⟩), opAt 172 .POP,
   opAt 173 (.Swap ⟨1, by decide⟩), opAt 174 (.Swap ⟨6, by decide⟩), opAt 175 .POP,
   opAt 176 .POP, opAt 177 .POP, opAt 178 .POP, opAt 179 .POP, opAt 180 .POP, opAt 181 .POP,
...
@[simp] theorem pc2974 : Artifact.submissionArtifact.instructionPC 175 = 273 :=
  by rw [scan_instruction_pc 175 (by decide) (by decide)]; rfl
@[simp] theorem pc2975 : Artifact.submissionArtifact.instructionPC 176 = 274 :=
  by rw [scan_instruction_pc 176 (by decide) (by decide)]; rfl
@[simp] theorem pc2976 : Artifact.submissionArtifact.instructionPC 177 = 275 :=
  by rw [scan_instruction_pc 177 (by decide) (by decide)]; rfl
@[simp] theorem pc2977 : Artifact.submissionArtifact.instructionPC 178 = 276 :=
  by rw [scan_instruction_pc 178 (by decide) (by decide)]; rfl
@[simp] theorem pc2978 : Artifact.submissionArtifact.instructionPC 179 = 277 :=
  by rw [scan_instruction_pc 179 (by decide) (by decide)]; rfl
@[simp] theorem pc2979 : Artifact.submissionArtifact.instructionPC 180 = 278 :=
  by rw [scan_instruction_pc 180 (by decide) (by decide)]; rfl
@[simp] theorem pc2980 : Artifact.submissionArtifact.instructionPC 181 = 279 :=
  by rw [scan_instruction_pc 181 (by decide) (by decide)]; rfl
@[simp] theorem pc2981 : Artifact.submissionArtifact.instructionPC 182 = 280 :=
  by rw [scan_instruction_pc 182 (by decide) (by decide)]; rfl
@[simp] theorem pc2982 : Artifact.submissionArtifact.instructionPC 183 = 283 :=
