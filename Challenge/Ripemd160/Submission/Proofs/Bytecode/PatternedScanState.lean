...
private theorem scanSuffix_length : scanSuffix.length = 4051 := by
  simp [scanSuffix]
...
@[simp] theorem pc2969a : Artifact.submissionArtifact.instructionPC 164 = 258 :=
