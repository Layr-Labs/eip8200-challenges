...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v0,
    (UInt256.land x.v3 (UInt256.add x.v8 (UInt256.shiftRight (UInt256.mul x.v10 (UInt256.add (UInt256.mul (UInt256.ofNat 15) (UInt256.land (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 360) (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v4 x.v6) x.v9) (UInt256.xor (UInt256.land x.v6 x.v4) x.v0)) x.v6) x.v5)))) x.v4)) (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.add (MachineState.readWord memory 360) (UInt256.add (UInt256.xor (UInt256.land (UInt256.xor (UInt256.lor x.v4 x.v6) x.v9) (UInt256.xor (UInt256.land x.v6 x.v4) x.v0)) x.v6) x.v5)))))) (UInt256.ofNat 30)))),
    x.v7,
    x.v8,
    x.v9,
    x.v10,
...
theorem site_pc : site.startPC = UInt256.ofNat 3630 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 2796) = UInt256.ofNat 3630
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 3630) template = UInt256.ofNat 3678 := by decide
  rw [hend] at hraw
