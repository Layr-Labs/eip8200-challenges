...
theorem site_pc : site.startPC = UInt256.ofNat 2110 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1604) = UInt256.ofNat 2110
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2110) template = UInt256.ofNat 2151 := by decide
  rw [hend] at hraw
