...
theorem site_pc : site.startPC = UInt256.ofNat 2124 := by
  change UInt256.ofNat (Artifact.submissionArtifact.instructionPC 1613) = UInt256.ofNat 2124
...
def gasSteps (s : State) (x : Input) (rho : List UInt256)
  ...
  have hend : pcAfter (UInt256.ofNat 2124) template = UInt256.ofNat 2165 := by decide
  rw [hend] at hraw
