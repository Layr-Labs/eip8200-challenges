...
def outputStack (memory : ByteArray) (x : Input) (rho : List UInt256) : List UInt256 :=
  [ (UInt256.land x.v3 (UInt256.shiftRight (UInt256.mul x.v10 x.v6) (UInt256.ofNat 28))),
    ...
    x.v4,
    x.v5,
    (UInt256.land x.v3 (UInt256.add x.v7 (UInt256.shiftRight (UInt256.mul (UInt256.ofNat 10141204804187018453477167726608) (UInt256.mod (UInt256.land x.v3 (UInt256.add x.v5 (UInt256.add (MachineState.readWord memory 306) (UInt256.add (UInt256.xor (UInt256.lor (UInt256.lnot x.v6) x.v9) x.v0) x.v8)))) x.v12)) (UInt256.ofNat 23)))),
    x.v7,
    x.v0,
    x.v9,
    x.v10,
