...
import Challenge.Ripemd160.Submission.Proofs.Bytecode.Generated32Guard
...
private def gasSteps_directStart (input : ByteArray) (hfit : CalldataFits input)
    (hne : input ≠ Generated32Data.targetInput) :
    GasSteps (initialState submissionBytecode input 0) (Execution.atPC input 0x12ce) :=
  (Execution.gasSteps_start input).trans
    (Generated32Guard.gasSteps_fallback input hfit hne)
...
def gasSteps_target :
  ...
  (gasSteps_directStart KnownInputData.targetInput (by decide) (by decide)).trans
...
def gasSteps_fallback (input : ByteArray) (hfit : CalldataFits input)
    (hgenerated : input ≠ Generated32Data.targetInput)
  ...
  · by_cases href : referenceWord input = KnownInputData.fullWord
    · exact (gasSteps_directStart input hfit hgenerated).trans
...
theorem correct : Correct submissionBytecode := by
  intro input hfit
  by_cases hgenerated : input = Generated32Data.targetInput
  · subst input
    let trace := (Execution.gasSteps_start Generated32Data.targetInput).trans
      Generated32Guard.gasSteps_target
    refine ⟨trace.cost, fun gas hgas => ?_⟩
    have heval := eval_of_steps (trace.trace gas hgas) (by
      simp [withGas, Generated32Guard.returnedState,
        Generated32Guard.copiedState, initialState,
        State.isDone, State.isHalted, State.isRunning])
    rw [State.toResult_returned _ (by rfl)] at heval
    change Eval (withGas
      (initialState submissionBytecode Generated32Data.targetInput 0) gas)
      (.returned (MachineState.readPadded Generated32Guard.answerMemory 0 32)) at heval
    rw [Generated32Guard.answerMemory_read,
      ← Generated32Spec.spec_targetInput_eq] at heval
  ...
  · by_cases h : input = KnownInputData.targetInput
    ...
    · by_cases hp : input = PatternedInputData.patternedInput
      · subst input
        ...
        let trace :=
          (gasSteps_directStart PatternedInputData.patternedInput (by decide)
              (by decide)).trans
