...
theorem correct : Correct submissionBytecode := by
  ...
  by_cases hgen : input = Gen27InputData.gen27Input
  · exact Gen27Arm.correct_gen27 input hfit hgen
      (Patterned128Entry.gasSteps_gen27_entry input hfit hgen)
  ...
  · by_cases hp : input = PatternedInputData.patternedInput
    ...
    · by_cases hsize56 : input.size = 56
      · by_cases hbyte : firstByte input = 7
        ...
        · exact StackCorrect.correct input hfit
            (gasSteps_fallback input hfit h hp habc hgen (Or.inr hbyte) h256 hshort)
      ...
      · by_cases hbyte : firstByte input = 7
        ...
        · exact StackCorrect.correct input hfit
            (gasSteps_fallback input hfit h hp habc hgen (Or.inr hbyte) h256 hshort)
      exact StackCorrect.correct input hfit
        (gasSteps_fallback input hfit h hp habc hgen
