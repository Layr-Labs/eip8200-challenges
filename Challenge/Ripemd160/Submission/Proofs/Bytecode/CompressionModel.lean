...
/-!
# Pure outer model for the compiled RIPEMD-160 compressor

This layer names the state recurrence used by the outer driver.  It keeps the
functional state model and its context-preservation facts, but leaves the
machine `GasSteps` proof to the immediate-run integration layer.
-/

namespace Challenge.Ripemd160.Submission.Proofs.Bytecode.CompressionModel
...
end Challenge.Ripemd160.Submission.Proofs.Bytecode.CompressionModel
