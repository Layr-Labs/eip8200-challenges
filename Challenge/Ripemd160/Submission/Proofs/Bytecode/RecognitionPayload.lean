...
private theorem codePrefix_size : codePrefix.size = 4671 := by
...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4866 + 21*((203142/n)%14)) 20 =
...
theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4866) n).toNat 20 =
      MachineState.readPadded payload (21*((203142/n)%14)) 20 := by
