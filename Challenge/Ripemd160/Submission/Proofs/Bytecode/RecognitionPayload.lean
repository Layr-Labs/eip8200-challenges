...
private theorem codePrefix_size : codePrefix.size = 4601 := by
...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4953 + 20*((4043689217/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (352 + 20*((4043689217/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (352 + 20*((4043689217/n)%16)) 20 =
