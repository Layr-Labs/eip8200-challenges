...
private theorem codePrefix_size : codePrefix.size = 4604 := by
...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4919 + 20*((4043689217/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (315 + 20*((4043689217/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (315 + 20*((4043689217/n)%16)) 20 =
      MachineState.readPadded payload (20*((4043689217/n)%16)) 20 := by
  rcases hn with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
  all_goals decide

theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4919) n).toNat 20 =
      MachineState.readPadded payload (20*((4043689217/n)%16)) 20 := by
