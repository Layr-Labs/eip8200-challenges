...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4905 + 20*((4022793/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (354 + 20*((4022793/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (354 + 20*((4022793/n)%16)) 20 =
...
theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4905) n).toNat 20 =
      MachineState.readPadded payload (20*((4022793/n)%16)) 20 := by
