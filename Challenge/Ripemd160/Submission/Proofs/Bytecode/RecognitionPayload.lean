...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4946 + 20*((2020082812/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (330 + 20*((2020082812/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (330 + 20*((2020082812/n)%16)) 20 =
      MachineState.readPadded payload (20*((2020082812/n)%16)) 20 := by
  rcases hn with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
  all_goals decide

theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4946) n).toNat 20 =
      MachineState.readPadded payload (20*((2020082812/n)%16)) 20 := by
