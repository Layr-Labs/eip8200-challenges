...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4953 + 20*((217301197/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (336 + 20*((217301197/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (336 + 20*((217301197/n)%16)) 20 =
      MachineState.readPadded payload (20*((217301197/n)%16)) 20 := by
