...
private theorem codePrefix_size : codePrefix.size = 4575 := by
...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4964 + 20*((16714936/n)%16)) 20 =
...
theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4964) n).toNat 20 =
      MachineState.readPadded payload (20*((16714936/n)%16)) 20 := by
