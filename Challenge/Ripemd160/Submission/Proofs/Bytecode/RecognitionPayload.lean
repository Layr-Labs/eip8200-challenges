...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4904 + 21*((2377101/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (224 + 21*((2377101/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (224 + 21*((2377101/n)%16)) 20 =
      MachineState.readPadded payload (21*((2377101/n)%16)) 20 := by
  rcases hn with rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl | rfl
  all_goals decide

theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4904) n).toNat 20 =
      MachineState.readPadded payload (21*((2377101/n)%16)) 20 := by
