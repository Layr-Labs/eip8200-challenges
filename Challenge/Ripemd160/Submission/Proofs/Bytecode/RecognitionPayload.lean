...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4880 + 21*((203142/n)%14)) 20 =
      MachineState.readPadded submissionByteChunk20 (209 + 21*((203142/n)%14)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (209 + 21*((203142/n)%14)) 20 =
...
theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4880) n).toNat 20 =
      MachineState.readPadded payload (21*((203142/n)%14)) 20 := by
