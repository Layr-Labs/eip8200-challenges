...
private theorem tableRead (n : Nat) :
    MachineState.readPadded submissionBytecode (4881 + 21*((16714936/n)%16)) 20 =
      MachineState.readPadded submissionByteChunk20 (201 + 21*((16714936/n)%16)) 20 := by
...
private theorem tablePayload (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionByteChunk20 (201 + 21*((16714936/n)%16)) 20 =
...
theorem read_selected (n : Nat) (hn : Allowed n) :
    MachineState.readPadded submissionBytecode (selected (UInt256.ofNat 4881) n).toNat 20 =
      MachineState.readPadded payload (21*((16714936/n)%16)) 20 := by
