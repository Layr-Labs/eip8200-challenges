...
theorem end_pc : pcAfter (UInt256.ofNat 112) template = UInt256.ofNat 211 := by decide
...
theorem site_pc : site.startPC = UInt256.ofNat 216 := by
  ...
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
theorem end_pc : pcAfter (UInt256.ofNat 216) template = UInt256.ofNat 239 := by decide
theorem form : ∀ instruction ∈ template.dropLast, RecognitionLift.Advances instruction :=
  RecognitionLift.advancesAll_sound _ (by decide)
def lift (s t : State) (e : Env s) (stack : List UInt256)
...
theorem site_pc : site.startPC = UInt256.ofNat 245 := by
  ...
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
theorem end_pc : pcAfter (UInt256.ofNat 245) template = UInt256.ofNat 263 := by decide
theorem form : ∀ instruction ∈ template.dropLast, RecognitionLift.Advances instruction :=
  RecognitionLift.advancesAll_sound _ (by decide)
def lift (s t : State) (e : Env s) (stack : List UInt256)
...
theorem site_pc : site.startPC = UInt256.ofNat 263 := by
  ...
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
theorem end_pc : pcAfter (UInt256.ofNat 263) template = UInt256.ofNat 270 := by decide
theorem form : ∀ instruction ∈ template.dropLast, RecognitionLift.Advances instruction :=
  RecognitionLift.advancesAll_sound _ (by decide)
def lift (s t : State) (e : Env s) (stack : List UInt256)
...
theorem site_pc : site.startPC = UInt256.ofNat 270 := by
  ...
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
theorem end_pc : pcAfter (UInt256.ofNat 270) template = UInt256.ofNat 311 := by decide
theorem form : ∀ instruction ∈ template.dropLast, RecognitionLift.Advances instruction :=
  RecognitionLift.advancesAll_sound _ (by decide)
def lift (s t : State) (e : Env s) (stack : List UInt256)
...
theorem site_pc : site.startPC = UInt256.ofNat 311 := by
  ...
  rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
theorem end_pc : pcAfter (UInt256.ofNat 311) template = UInt256.ofNat 317 := by decide
theorem form : ∀ instruction ∈ template.dropLast, RecognitionLift.Advances instruction :=
  RecognitionLift.advancesAll_sound _ (by decide)
def lift (s t : State) (e : Env s) (stack : List UInt256)
...
theorem valid_190 (s : State) (e : Env s) : Decode.isValidJumpDest s.executionEnv.code 188 = true := by
  ...
  have hp : Artifact.submissionArtifact.instructionPC 101 = 188 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
...
theorem valid_219 (s : State) (e : Env s) : Decode.isValidJumpDest s.executionEnv.code 217 = true := by
  ...
  have hp : Artifact.submissionArtifact.instructionPC 128 = 217 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
  simpa only [hp] using h
...
theorem valid_298 (s : State) (e : Env s) : Decode.isValidJumpDest s.executionEnv.code 292 = true := by
  ...
  have hp : Artifact.submissionArtifact.instructionPC 193 = 292 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
  simpa only [hp] using h
...
theorem valid_341 (s : State) (e : Env s) : Decode.isValidJumpDest s.executionEnv.code 336 = true := by
  ...
  have hp : Artifact.submissionArtifact.instructionPC 220 = 336 := by
    rw [ArtifactByteLength.instructionPC_eq_byteLength]; decide
  simpa only [hp] using h
...
def moves (s : State) (e : Env s) (rho : List UInt256) (hs : rho.length≤990) : Moves s rho where
  ...
  transition f hlen := by
    ...
    simpa only [atState, transitionSite.end_pc] using run_transition s (UInt256.ofNat 270) f rho hs e.run hlen
  first f := by
    apply firstSite.lift s _ e (frame f rho)
    have h := run_first s (UInt256.ofNat 211) f rho hs e.run (valid_219 s e)
  ...
  normalGuard f := by
    ...
    have h := run_normalGuard s (UInt256.ofNat 239) f rho hs e.run (valid_190 s e)
  ...
  finish f hlen := by
    ...
    have h := run_finish s (UInt256.ofNat 263) f rho hs e.run hlen (valid_298 s e)
  ...
  transitionGuard f := by
    ...
    have h := run_transitionGuard s (UInt256.ofNat 311) f rho hs e.run (valid_190 s e)
    by_cases hc : f.off.toNat<f.full.toNat
  ...
  toTail f := by
    ...
    simpa only [atState] using run_toTail s (UInt256.ofNat 317) (frame f rho) hc e.run (valid_219 s e)
