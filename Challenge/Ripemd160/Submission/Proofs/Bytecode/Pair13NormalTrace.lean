...
theorem run_normal (s : State) (pc ret a2 a3 a4 a5 a6 a7 a8 a9 a10 off lim : UInt256)
  ...
  let F := stk ret (UInt256.ofNat 4294967323) a2 a3 a4 a5 a6 a7 a8 a9 a10 off lim rho
  ...
  have h1 := run_template s pc ret (UInt256.ofNat 4294967323) a2 a3 a4 a5 a6 a7 a8 a9 a10 off lim rho p
...
theorem end_pc : pcAfter (UInt256.ofNat 494) normalTemplate = UInt256.ofNat 896 := by decide
