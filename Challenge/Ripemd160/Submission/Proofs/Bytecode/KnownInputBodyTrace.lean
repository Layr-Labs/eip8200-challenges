...
private theorem bodyValid (i : Nat) (hi : i < 16) :
  ...
  interval_cases i <;>
    first
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3063 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3081 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3099 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3117 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3135 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3153 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3171 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3189 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3207 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3225 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3243 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3261 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3279 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3297 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3315 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3333 (by rfl)
