...
private theorem bodyValid (i : Nat) (hi : i < 16) :
  ...
  interval_cases i <;>
    first
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3080 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3098 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3116 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3134 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3152 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3170 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3188 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3206 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3224 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3242 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3260 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3278 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3296 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3314 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3332 (by rfl)
    | exact Artifact.submissionArtifact.isValidJumpDest_index 3350 (by rfl)
