...
theorem scheduleP120_0 :
    CompressionCorrect.schedule (Padding.paddedMessage inputP120) 0 = B10 := by
...
theorem scheduleP120_1 :
    CompressionCorrect.schedule (Padding.paddedMessage inputP120) 64 = B14 := by
  simp only [Padding.paddedMessage, lengthBytes_expand,
    CompressionCorrect.schedule, EvmSemantics.Crypto.Ripemd160.readLE32,
    Std.Legacy.Range.forIn_eq_forIn_range', Std.Legacy.Range.size,
    Nat.sub_zero, Nat.add_sub_cancel, Nat.div_one, pure_bind,
...
theorem scheduleP120_2 :
    CompressionCorrect.schedule (Padding.paddedMessage inputP120) 128 = B15 := by
  simp only [Padding.paddedMessage, lengthBytes_expand,
    CompressionCorrect.schedule, EvmSemantics.Crypto.Ripemd160.readLE32,
    Std.Legacy.Range.forIn_eq_forIn_range', Std.Legacy.Range.size,
    Nat.sub_zero, Nat.add_sub_cancel, Nat.div_one, pure_bind,
