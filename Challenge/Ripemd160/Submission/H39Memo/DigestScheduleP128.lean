...
theorem scheduleP128_0 :
    CompressionCorrect.schedule (Padding.paddedMessage inputP128) 0 = B10 := by
...
theorem scheduleP128_1 :
    CompressionCorrect.schedule (Padding.paddedMessage inputP128) 64 = B16 := by
  simp only [Padding.paddedMessage, lengthBytes_expand,
    CompressionCorrect.schedule, EvmSemantics.Crypto.Ripemd160.readLE32,
    Std.Legacy.Range.forIn_eq_forIn_range', Std.Legacy.Range.size,
    Nat.sub_zero, Nat.add_sub_cancel, Nat.div_one, pure_bind,
...
theorem scheduleP128_2 :
    CompressionCorrect.schedule (Padding.paddedMessage inputP128) 128 = B17 := by
  simp only [Padding.paddedMessage, lengthBytes_expand,
    CompressionCorrect.schedule, EvmSemantics.Crypto.Ripemd160.readLE32,
    Std.Legacy.Range.forIn_eq_forIn_range', Std.Legacy.Range.size,
    Nat.sub_zero, Nat.add_sub_cancel, Nat.div_one, pure_bind,
