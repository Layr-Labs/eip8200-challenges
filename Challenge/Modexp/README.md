...
zero-modulus cases, missing trailing bytes, a 257-bit modulus, BN254 inversion,
a fixed 256-bit tuple, and RSA-1024/RSA-2048 public-exponent operations. Tests
are evidence, not the correctness proof.
...
The total covers all 13 public vectors, all of which are checked.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Reference](Reference/) | 1284 | 183 | 2403 | 1193 | 950 | 183 | 39913 | 18958693 | 44253 | 44253 | 70590487 | 770374226 | 860100123 | 16207.51× | 1.00× |
