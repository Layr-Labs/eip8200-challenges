...
The executable suite includes 10 focused cases and 48 generated public cases.
...
The total covers all 58 public vectors, all of which are checked.
...
| implementation | bytes | empty | small | zero exp | zero mod | zero M | EIP-198 #1 | BN254 inv | random 256 | all vectors | vs precompile | vs reference |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Reference](Reference/) | 1284 | 183 | 2403 | 1193 | 950 | 183 | 39913 | 44253 | 44253 | 3464424201 | 13763.88× | 1.00× |
