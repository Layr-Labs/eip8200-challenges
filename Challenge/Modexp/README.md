...
The executable suite includes 9 focused cases and 48 generated public cases.
The generated corpus contains 32 256-bit cases, 10 RSA-1024 cases, and 6
...
The public corpus uses `corpusSeed := 0` in `Scorer.lean`. A private evaluator
can replace that one value before building to derive different generic and
BN254 bases and moduli while keeping the fixed exponent schedule.
...
The total covers all 57 public vectors, all of which are checked.
...
| implementation | bytes | empty | small | zero exp | zero mod | zero M | EIP-198 #1 | BN254 inv | all vectors | vs precompile | vs reference |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Reference](Reference/) | 1284 | 183 | 2403 | 1193 | 950 | 183 | 39913 | 44253 | 3464379948 | 13990.49× | 1.00× |
