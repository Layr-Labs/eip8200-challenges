...
The executable suite includes 8 focused cases and 36 generated public cases.
The generated corpus contains 32 256-bit cases, 2 RSA-1024 cases, and 2
...
The total covers all 44 public vectors, all of which are checked.
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Reference](Reference/) | 1284 | 183 | 1193 | 950 | 183 | 39913 | 44253 | 1313215999 | 6957.21× | 1.00× |
