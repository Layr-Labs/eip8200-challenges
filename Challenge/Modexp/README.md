...
The executable suite includes 8 focused cases and 48 generated public cases.
...
The total covers all 56 public vectors, all of which are checked.
...
| implementation | bytes | empty | zero exp | zero mod | zero M | EIP-198 #1 | BN254 inv | all vectors | vs precompile | vs reference |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| [Reference](Reference/) | 1284 | 183 | 1193 | 950 | 183 | 39913 | 44253 | 3464377545 | 14018.78× | 1.00× |
