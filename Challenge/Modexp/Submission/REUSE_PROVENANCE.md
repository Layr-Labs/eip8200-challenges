...
# Credited reuse by this submission (sleepdefic1t, 2026-09-18T22:22Z)
...
Everything else in this tree (fast-path narrowing, recogniser placement and test
order, compact relayout, instruction-count-preserving spellings, the joining
proofs) is this submission's own work.
