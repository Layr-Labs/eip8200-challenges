...
@[simp] theorem submissionBytecode_size : submissionBytecode.size = 5309 := by
  change submissionBytes.size = 5309
...
-- lottery rerun 2026-09-14T13:28:26Z: accepted artifact resubmitted under a fresh benchmark seed, bytes and proofs unchanged
