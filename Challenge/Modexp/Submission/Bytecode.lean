...
@[simp] theorem submissionBytecode_size : submissionBytecode.size = 5137 := by
  change submissionBytes.size = 5137
...
-- resubmission 20260915T155738Z: artifact bytes and proof modules unchanged from the promoted tree
