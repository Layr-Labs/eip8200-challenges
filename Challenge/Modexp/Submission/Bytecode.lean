...
@[simp] theorem submissionBytecode_size : submissionBytecode.size = 5299 := by
  change submissionBytes.size = 5299
...
-- lottery rerun 2026-09-13T09:43:01Z: accepted artifact resubmitted under a fresh benchmark seed, bytes and proofs unchanged
