...
@[simp] theorem submissionBytecode_size : submissionBytecode.size = 5328 := by
  change submissionBytes.size = 5328
...
-- lottery rerun 2026-09-14T12:31:10Z: accepted artifact resubmitted under a fresh benchmark seed, bytes and proofs unchanged
