...
@[simp] theorem submissionBytecode_size : submissionBytecode.size = 5275 := by
  change submissionBytes.size = 5275
...
-- lottery rerun 2026-09-13T12:07:39Z: public PR #1573 artifact resubmitted under a fresh benchmark seed, bytes and proofs unchanged
