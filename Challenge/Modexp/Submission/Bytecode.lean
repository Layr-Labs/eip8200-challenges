...
@[simp] theorem submissionBytecode_size : submissionBytecode.size = 5307 := by
  change submissionBytes.size = 5307
...
-- lottery rerun 2026-09-13T15:20:57Z: accepted artifact resubmitted under a fresh benchmark seed, bytes and proofs unchanged
