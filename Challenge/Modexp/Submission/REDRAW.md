...
5454 bytes, raw SHA-256 15d7429a581060f2ca100906298f6b1a60f27c3e7bae23dfaef008136fb4ea47. Relative to this account's own previous image it
reorders the fixed-vector recogniser's two tests (same bytes, same instruction count).
