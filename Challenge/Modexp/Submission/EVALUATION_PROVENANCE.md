...
This request replaces two cancelled packaging attempts:
`9bbf14fd-ae0f-41e9-80aa-c48d3316638a` (PR #1919) and
`9f314bc0-be4c-45c4-8c6d-e0e122f55ae2` (PR #1920). The first Windows archive
lost the executable modes of `bench.sh` and `verify.sh`; the second Git archive
converted source line endings to CRLF. Both validations were cancelled before
an official score was produced. This final package preserves every inherited
file's Git blob identity and mode. All 349 inherited archive files were checked
against the recorded Git object hashes before uploading. This is a packaging
correction, not a repeat request following a scored outcome.
