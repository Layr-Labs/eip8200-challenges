...
def gasSteps_reduce (s : State) (mem : ByteArray) (f pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret : UInt256)
  ...
  have hr : MachineState.readWord (l2Step mem mu c0 4 3).memory 2720 = UInt256.ofNat 5191 :=
    (SquareFourReduce.read_l2_outside mem mu c0 2720 (Or.inr (by decide)) 3 (by decide)).trans hroute
