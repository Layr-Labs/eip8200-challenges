import Challenge.Modexp.Submission.Proofs.Fast.TnCandidateSquareBlocks
import Challenge.Modexp.Submission.Proofs.Fast.TnCandidateSgtStep
...
namespace Challenge.Modexp.Submission.Proofs.Fast.TnCandidateSquareSteps
...
open TnCacheSquareTrace TnCandidateSquareBlocks

def outState (tn : UInt256) (s : State) (mem : ByteArray) (pb n i : Nat)
  ...
  framed {s with memory := mem} hd
    (TnCacheFrameOps.frame (UInt256.ofNat (ptrAt (pb+32*n-32) i)) hd
      (UInt256.ofNat (pb-32)) ent tn (UInt256.ofNat (TnCandidateReductionSteps.l2PC n)) inv
      (m0 :: rest))

def l1Q (tn : UInt256) (pc : Nat) (s : State) (q : MacState) (bi : UInt256) (pb n i : Nat)
    (hd ent inv m0 : UInt256) (rest : List UInt256) : State :=
  TnCacheL1Trace.qState s (UInt256.ofNat pc) q bi
    (UInt256.ofNat (ptrAt (pb+32*n-32) i)) hd (UInt256.ofNat (pb-32)) ent tn
    (UInt256.ofNat (TnCandidateReductionSteps.l2PC n)) inv (m0 :: rest)

def environment (s : State) (hcode : s.executionEnv.code = TnCandidate.bytecode)
    (hfork : s.fork = .Osaka) (hrun : s.halt = .Running)
    (hnp : Precompile.isPrecompileWithConfig s.executionEnv.precompileConfig
      s.executionEnv.fork s.executionEnv.codeAddr = false) :
    Environment TnCandidateArtifact.submissionArtifact .Osaka s :=
  ⟨by change TnCandidate.bytecode.size < 2^256; rw [TnCandidate.bytecode_size]; decide,
    hcode, hfork, hrun, hnp⟩

def stepsOf {pc : Nat} {instructions : List Instr}
    (block : Block TnCandidateArtifact.submissionArtifact .Osaka pc instructions) {s t : State}
...
noncomputable def prologue_steps (s : State) (mem : ByteArray) (tn : UInt256) (n i e : Nat)
    ...
    (hjump : Decode.isValidJumpDest TnCandidate.bytecode e = true)
    (he : e + 37 < 2 ^ 256) :
    Challenge.EvmProof.GasSteps
      (outState tn s mem 2368 n i (UInt256.ofNat 4471) (UInt256.ofNat e) pdst ret
        (w10 :: w11 :: w12 :: w13 :: aprev :: rest))
      (l1Q tn e s (sqPro mem n i (UInt256.sgt (UInt256.ofNat 0) aprev))
        (sqB2 (sqX mem n i) (UInt256.sgt (UInt256.ofNat 0) aprev)) 2368 n i
        (UInt256.ofNat 4471) (UInt256.ofNat (e + 37)) pdst ret
  ...
  -- block A
  have hA := run_A s' P (UInt256.ofNat 4471) (UInt256.ofNat (2368 - 32)) (UInt256.ofNat e)
    tn allOnes (UInt256.ofNat (TnCandidateReductionSteps.l2PC n)) pdst ret w10 w11 w12 w13 aprev rest (by omega) hactP
  rw [push0_eq] at hA
  have gA := stepsOf blockA hA rfl hcode hfork hrun hnp
  -- the SGT
  have gS := TnCandidateSgtStep.gasSteps_sqRowSgt
    { s' with pc := UInt256.ofNat 4477,
              stack := UInt256.ofNat 0 :: aprev :: MachineState.readWord s'.memory P.toNat :: P ::
                UInt256.ofNat 4471 :: UInt256.ofNat (2368 - 32) :: UInt256.ofNat e :: tn ::
                allOnes :: UInt256.ofNat (TnCandidateReductionSteps.l2PC n) :: pdst :: ret :: w10 :: w11 :: w12 :: w13 ::
  ...
  have hB := run_B s' (UInt256.sgt (UInt256.ofNat 0) aprev) (MachineState.readWord s'.memory P.toNat) P
    (UInt256.ofNat 4471) (UInt256.ofNat (2368 - 32)) (UInt256.ofNat e) tn allOnes
    (UInt256.ofNat (TnCandidateReductionSteps.l2PC n) :: pdst :: ret :: w10 :: w11 :: w12 :: w13 ::
      MachineState.readWord s'.memory P.toNat :: rest)
...
end Challenge.Modexp.Submission.Proofs.Fast.TnCandidateSquareSteps
