...
opaque gasSteps_entry (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      {outState s (mpZeroed s (StagedOperand.stage mem pa n) n) pa pb n 0
        ...
        (MachineState.readWord mem 9440 :: MachineState.readWord mem 96 :: MachineState.readWord mem 64 :: MachineState.readWord mem 32 :: UInt256.ofNat (pa+32*n-32) :: pdst :: ret :: rest) with pc := UInt256.ofNat 4168} :=
...
opaque gasSteps_l1Last (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  have h := gasSteps_l1Mac 4432 0 8256 l1Mac7 s mem bi pa pb n i (n-1) pdst ret rest
