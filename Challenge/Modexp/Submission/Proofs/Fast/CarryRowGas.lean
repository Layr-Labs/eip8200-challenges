...
opaque gasSteps_entry (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      {outState s (mpZeroed s (StagedOperand.stage mem pa n) n) pa pb n 0
        ...
        (MachineState.readWord mem 9440 :: MachineState.readWord mem 96 :: MachineState.readWord mem 64 :: MachineState.readWord mem 32 :: UInt256.ofNat (pa+32*n-32) :: pdst :: ret :: rest) with pc := UInt256.ofNat 4164} :=
...
opaque gasSteps_tailNext (s : State) (mem : ByteArray) (c mu bi : UInt256)
    ...
    (hpb : 32 ≤ pb) (hpbFit : pb + 32 * n ≤ 9472)
    (hroute : MachineState.readWord mem 9280 = UInt256.ofNat 4169) :
    Challenge.EvmProof.GasSteps
...
opaque gasSteps_l1Last (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  have h := gasSteps_l1Mac 4428 0 8256 l1Mac7 s mem bi pa pb n i (n-1) pdst ret rest
...
opaque gasSteps_l2Final (s : State) (mem : ByteArray) (bi mu c0 : UInt256)
  ...
  have h := gasSteps_l2Mac 4726 0 0 8256 8288 l2Mac6 s mem bi mu c0 pa pb n i (n-2) pdst ret rest
    hcap hrun hcode hfork hnp hact hn32 (by omega)
