...
def dispatchBlock : Block Artifact.submissionArtifact .Osaka 4853 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3687 5 4853 dispatchProgram
...
def nxJd : Block Artifact.submissionArtifact .Osaka 4862 [.op .JUMPDEST] :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3692 1 4862 [.op .JUMPDEST]
    (by decide) (by rfl) (by rfl) (by decide)
