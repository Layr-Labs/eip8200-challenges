...
namespace Challenge.Modexp.Submission.Proofs.Fast.FixedExponentFallbackCore
...
theorem run_fallbackProgram (s : State) (memory : ByteArray)
    ...
    (hjump : Decode.isValidJumpDest s.executionEnv.code 1760 = true)
    (hrun : s.halt = .Running) :
...
end Challenge.Modexp.Submission.Proofs.Fast.FixedExponentFallbackCore
