...
def sqExitBlock : Block Artifact.submissionArtifact .Osaka 4005 sqExitProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3019 12 4005 sqExitProgram
    (by decide) (by rfl) (by rfl) (by decide)

def lastBlock : Block Artifact.submissionArtifact .Osaka 4027 lastProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3031 6 4027 lastProgram
    (by decide) (by rfl) (by rfl) (by decide)

def againBlock : Block Artifact.submissionArtifact .Osaka 4049 againProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3043 10 4049 againProgram
    (by decide) (by rfl) (by rfl) (by decide)
