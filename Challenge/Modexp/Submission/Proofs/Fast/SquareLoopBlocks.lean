...
def sqExitBlock : Block Artifact.submissionArtifact .Osaka 4174 sqExitProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3162 12 4174 sqExitProgram
    (by decide) (by rfl) (by rfl) (by decide)

def lastBlock : Block Artifact.submissionArtifact .Osaka 4196 lastProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3174 6 4196 lastProgram
    (by decide) (by rfl) (by rfl) (by decide)

def againBlock : Block Artifact.submissionArtifact .Osaka 4218 againProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3186 10 4218 againProgram
    (by decide) (by rfl) (by rfl) (by decide)
