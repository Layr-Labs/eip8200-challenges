...
def l2Eight : Block submissionArtifact .Osaka 3851 (TnMod128Chain.fullProgram 8) :=
  WindowTwentyOneSlice.block allWellFormed 3081 206 3851 (TnMod128Chain.fullProgram 8)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Four : Block submissionArtifact .Osaka 3987 (TnMod128Chain.fullProgram 4) :=
  WindowTwentyOneSlice.block allWellFormed 3199 88 3987 (TnMod128Chain.fullProgram 4)
    (by decide) (by rfl) (by rfl) (by decide)

def cachedCell : Block submissionArtifact .Osaka 3922 (TnMod128Trace.program) :=
  WindowTwentyOneSlice.block allWellFormed 3142 29 3922 (TnMod128Trace.program)
    (by decide) (by rfl) (by rfl) (by decide)

def middle : Block submissionArtifact .Osaka 3832 (TnCacheRowTrace.middle) :=
  WindowTwentyOneSlice.block allWellFormed 3062 19 3832 (TnCacheRowTrace.middle)
    (by decide) (by rfl) (by rfl) (by decide)

def middleCopy : Block submissionArtifact .Osaka 5431 (TnCacheRowTrace.middle ++ [.push 2 3987, .op .JUMP]) :=
  WindowTwentyOneSlice.block allWellFormed 4365 21 5431 (TnCacheRowTrace.middle ++ [.push 2 3987, .op .JUMP])
    (by decide) (by rfl) (by rfl) (by decide)

def tail : Block submissionArtifact .Osaka 4087 (TnCacheRowTrace.tail) :=
  WindowTwentyOneSlice.block allWellFormed 3287 17 4087 (TnCacheRowTrace.tail)
    (by decide) (by rfl) (by rfl) (by decide)

def flush : Block submissionArtifact .Osaka 4138 (TnCacheFrameOps.flush) :=
  WindowTwentyOneSlice.block allWellFormed 3304 3 4138 (TnCacheFrameOps.flush)
    (by decide) (by rfl) (by rfl) (by decide)

def afterSquareReset : Block submissionArtifact .Osaka 3482 (TnCacheFrameOps.reset) :=
  WindowTwentyOneSlice.block allWellFormed 2774 3 3482 (TnCacheFrameOps.reset)
    (by decide) (by rfl) (by rfl) (by decide)

def againReset : Block submissionArtifact .Osaka 4252 (TnCacheFrameOps.reset) :=
  WindowTwentyOneSlice.block allWellFormed 3377 3 4252 (TnCacheFrameOps.reset)
    (by decide) (by rfl) (by rfl) (by decide)
