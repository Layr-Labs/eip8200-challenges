...
def l2Eight : Block submissionArtifact .Osaka 3666 (TnMod128Chain.fullProgram 8) :=
  WindowTwentyOneSlice.block allWellFormed 2747 206 3666 (TnMod128Chain.fullProgram 8)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Four : Block submissionArtifact .Osaka 3812 (TnMod128Chain.fullProgram 4) :=
  WindowTwentyOneSlice.block allWellFormed 2865 88 3812 (TnMod128Chain.fullProgram 4)
    (by decide) (by rfl) (by rfl) (by decide)

def cachedCell : Block submissionArtifact .Osaka 3746 (TnMod128Trace.program) :=
  WindowTwentyOneSlice.block allWellFormed 2808 29 3746 (TnMod128Trace.program)
    (by decide) (by rfl) (by rfl) (by decide)

def middle : Block submissionArtifact .Osaka 3647 (TnCacheRowTrace.middle) :=
  WindowTwentyOneSlice.block allWellFormed 2728 19 3647 (TnCacheRowTrace.middle)
    (by decide) (by rfl) (by rfl) (by decide)

def middleCopy : Block submissionArtifact .Osaka 5291 (TnCacheRowTrace.middle ++ [.push 2 3812, .op .JUMP]) :=
  WindowTwentyOneSlice.block allWellFormed 4047 21 5291 (TnCacheRowTrace.middle ++ [.push 2 3812, .op .JUMP])
    (by decide) (by rfl) (by rfl) (by decide)

def tail : Block submissionArtifact .Osaka 3912 (TnCacheRowTrace.tail) :=
  WindowTwentyOneSlice.block allWellFormed 2953 17 3912 (TnCacheRowTrace.tail)
    (by decide) (by rfl) (by rfl) (by decide)

def flush : Block submissionArtifact .Osaka 3963 (TnCacheFrameOps.flush) :=
  WindowTwentyOneSlice.block allWellFormed 2970 3 3963 (TnCacheFrameOps.flush)
    (by decide) (by rfl) (by rfl) (by decide)

def afterSquareReset : Block submissionArtifact .Osaka 3299 (TnCacheFrameOps.reset) :=
  WindowTwentyOneSlice.block allWellFormed 2442 3 3299 (TnCacheFrameOps.reset)
    (by decide) (by rfl) (by rfl) (by decide)

def againReset : Block submissionArtifact .Osaka 4077 (TnCacheFrameOps.reset) :=
  WindowTwentyOneSlice.block allWellFormed 3043 3 4077 (TnCacheFrameOps.reset)
    (by decide) (by rfl) (by rfl) (by decide)
