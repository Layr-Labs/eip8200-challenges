...
def middleCopy : Block submissionArtifact .Osaka 5431 (TnCacheRowTrace.middle ++ [.push 2 3987, .op .JUMP]) :=
  WindowTwentyOneSlice.block allWellFormed 4361 21 5431 (TnCacheRowTrace.middle ++ [.push 2 3987, .op .JUMP])
    (by decide) (by rfl) (by rfl) (by decide)
...
def againReset : Block submissionArtifact .Osaka 4252 (TnCacheFrameOps.reset) :=
  WindowTwentyOneSlice.block allWellFormed 3373 3 4252 (TnCacheFrameOps.reset)
    (by decide) (by rfl) (by rfl) (by decide)
