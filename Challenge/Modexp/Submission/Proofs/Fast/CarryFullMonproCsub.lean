...
opaque gasSteps_monproCsub (E : EntryLemmas) (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (Csub.csReturnedState s (selectedRows (mpZeroed s (inputMemory mem pa n) n) pa pb n n) n n pdst ret
        rest) :=
  (gasSteps_toCsub E s mem pa pb n pdst ret rest (by omega) hrun hcode hfork hnp hact hn
