...
theorem run_guard (s : State) (pc : Nat)
    ...
    runInstructions normalGuard
      (framed s (UInt256.ofNat pc)
        (TnCacheFrameOps.frame pbi (UInt256.ofNat 3711) pb ent tn target inv rest)) =
    some (framed s (UInt256.ofNat (pc+9))
      (TnCacheFrameOps.frame pbi (UInt256.ofNat 3711) pb ent tn target inv rest)) := by
  have h8 : rest.length+8 < 1024 := by omega
  have h9 : rest.length+9 < 1024 := by omega
  have h10 : rest.length+10 < 1024 := by omega
  have h4471 : (4471 : UInt256).toNat = 4471 := by decide
...
theorem run_square_guard (s : State) (pc : Nat)
    (pbi pb ent tn target inv : UInt256) (rest : List UInt256) (hcap : rest.length ≤ 1006)
    (hj : Decode.isValidJumpDest s.executionEnv.code 4362 = true) :
    runInstructions normalGuard
      (framed s (UInt256.ofNat pc)
        (TnCacheFrameOps.frame pbi (UInt256.ofNat 4471) pb ent tn target inv rest)) =
    some (framed s (UInt256.ofNat 4362)
      (TnCacheFrameOps.frame pbi (UInt256.ofNat 4471) pb ent tn target inv rest)) := by
  have h8 : rest.length+8 < 1024 := by omega
  have h9 : rest.length+9 < 1024 := by omega
  have h10 : rest.length+10 < 1024 := by omega
  have h4471 : (4471 : UInt256).toNat = 4471 := by decide
  have h4362 : (4362 : UInt256).toNat = 4362 := by decide
  have ht : (4362 : UInt256) = UInt256.ofNat 4362 := by decide
  simp [normalGuard, TnCacheFrameOps.frame, framed, runInstructions,
    Challenge.EvmProof.Stepper.runInstr, h8, h9, h10,
