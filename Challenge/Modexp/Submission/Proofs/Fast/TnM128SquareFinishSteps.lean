...
def exitState (s : State) (mem : ByteArray) (tn : UInt256) (_n : Nat)
  ...
  framed {s with memory := mem} (UInt256.ofNat 4033)
...
noncomputable def finish_steps (s : State)
  ...
  let stack := TnCacheFrameOps.frame (pointer 2368 n n) (UInt256.ofNat 4093) (UInt256.ofNat 2336)
  ...
  have hj : Decode.isValidJumpDest aft.executionEnv.code 4033 = true := by
    rw [show aft.executionEnv.code = TnM128CandidateArtifact.submissionArtifact.code from env.code]
    exact TnM128CandidateArtifact.isValidJumpDest_index 3025 (by rfl)
  have hf := TnCacheFrameOps.run_flush 3963 st (pointer 2368 n n) (UInt256.ofNat 4093)
  ...
  have hg := TnCacheExitTrace.run_square_guard aft 3968 (pointer 2368 n n)
    (UInt256.ofNat 2336) (UInt256.ofNat (sqEnt n n)) z.tn (MachineState.readWord z.memory 128) inv
    tail htail hj
  ...
  have he : sqEnt n n = 3683 := by unfold sqEnt; omega
