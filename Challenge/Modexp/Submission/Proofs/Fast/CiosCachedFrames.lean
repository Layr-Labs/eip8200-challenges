...
def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4494 + UInt256.ofNat 152 * isFour n
...
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 4646 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4494 := by decide
