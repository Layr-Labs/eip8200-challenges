...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4285 + UInt256.ofNat 153 * isFour n

def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4584 + UInt256.ofNat 153 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 4438 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 4285 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 4737 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4584 := by decide
