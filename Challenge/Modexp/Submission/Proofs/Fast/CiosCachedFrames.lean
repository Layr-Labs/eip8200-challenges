...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4549 + UInt256.ofNat 150 * isFour n

def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4891 + UInt256.ofNat 150 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 4699 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 4549 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 5041 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4891 := by decide
...
def l1At (pc : Nat) (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  { s with pc := UInt256.ofNat pc
           stack := [(l1Step mem bi pa n j).carry, bi,
                     ...
                     UInt256.ofNat pa, UInt256.ofNat (pb - 32), l1Target n, negative32, allOnes, l2Target n, modulusAddress n, pdst, ret] ++ rest
