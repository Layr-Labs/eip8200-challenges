...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4543 + UInt256.ofNat 150 * isFour n

def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4888 + UInt256.ofNat 150 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 4693 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 4543 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 5038 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4888 := by decide
