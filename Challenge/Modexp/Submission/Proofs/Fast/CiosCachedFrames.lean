...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 3754 + UInt256.ofNat 148 * isFour n

/-- Second-loop entry (`ent + 0x12b`), fixed for the whole kernel call. -/
def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4043 + UInt256.ofNat 148 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 3902 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 3754 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 4191 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4043 := by decide
...
`hd` is the row head the tail returns to (`JUMPI` via `DUP3`; 4266 for the multiply,
