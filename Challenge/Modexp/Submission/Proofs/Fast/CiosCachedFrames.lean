...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4546 + UInt256.ofNat 150 * isFour n

def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4891 + UInt256.ofNat 145 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 4696 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 4546 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 5036 := by decide
