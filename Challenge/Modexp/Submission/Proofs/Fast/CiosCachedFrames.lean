...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4008 + UInt256.ofNat 152 * isFour n

/-- Second-loop entry (`ent + 0x12b`), fixed for the whole kernel call. -/
def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4307 + UInt256.ofNat 152 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 4160 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 4008 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 4459 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4307 := by decide
...
the `sq_row` pc 4664 for the square) and `ent` is the first-loop entry
