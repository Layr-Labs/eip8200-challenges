...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4201 + UInt256.ofNat 148 * isFour n

/-- Second-loop entry (`ent + 0x12b`), fixed for the whole kernel call. -/
def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4493 + UInt256.ofNat 148 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 4349 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 4201 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 4641 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4493 := by decide
...
`hd` is the row head the tail returns to (`JUMPI` via `DUP3`; 4178 for the multiply,
the `sq_row` pc 4878 for the square) and `ent` is the first-loop entry
