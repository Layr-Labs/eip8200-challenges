...
def l1Target (n : Nat) : UInt256 :=
  UInt256.ofNat 3927 + UInt256.ofNat 152 * isFour n

/-- Second-loop entry (`ent + 0x12b`), fixed for the whole kernel call. -/
def l2Target (n : Nat) : UInt256 :=
  UInt256.ofNat 4226 + UInt256.ofNat 152 * isFour n

@[simp] theorem l1Target_four : l1Target 4 = UInt256.ofNat 4079 := by decide
@[simp] theorem l1Target_eight : l1Target 8 = UInt256.ofNat 3927 := by decide
@[simp] theorem l2Target_four : l2Target 4 = UInt256.ofNat 4378 := by decide
@[simp] theorem l2Target_eight : l2Target 8 = UInt256.ofNat 4226 := by decide
