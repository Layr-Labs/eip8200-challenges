...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (1266 : UInt256) = UInt256.ofNat 1266 := by decide
  have h1939 : (3209 : UInt256) = UInt256.ofNat 3209 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (1255 : UInt256) = UInt256.ofNat 1255 := by decide
  have h2877Nat : (UInt256.ofNat 1255).toNat = 1255 := by decide
