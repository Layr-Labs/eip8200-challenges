...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (2069 : UInt256) = UInt256.ofNat 2065 := by decide
  have h1939 : (3912 : UInt256) = UInt256.ofNat 3900 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (2058 : UInt256) = UInt256.ofNat 2054 := by decide
  have h2877Nat : (UInt256.ofNat 2054).toNat = 2058 := by decide
