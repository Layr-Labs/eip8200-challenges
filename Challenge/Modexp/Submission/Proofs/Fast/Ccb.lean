...
* `blk1751` (idx 1751..1757, pc 2515..2525) — the loop head `CCL`, which
  pushes the call frame `[px, px, px, 2526]` and jumps to `MONPRO` (pc 4453);
...
def amCallState (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 2203
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 2517] ++ ([UInt256.ofNat px, ret] ++ rest)
           memory := mem }
...
/-- The `MONPRO` call, pc 4453, with the frame `[px, px, px, 2526]` pushed. -/
def mpCallState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
    (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 4453
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 2531] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_entry (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  have h2874 : (2517 : UInt256) = UInt256.ofNat 2517 := by decide
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (2531 : UInt256) = UInt256.ofNat 2531 := by decide
  have h1939 : (4453 : UInt256) = UInt256.ofNat 4453 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (2520 : UInt256) = UInt256.ofNat 2520 := by decide
