...
def mpCallState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 3353
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 1527] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (1527 : UInt256) = UInt256.ofNat 1527 := by decide
  have h1939 : (3353 : UInt256) = UInt256.ofNat 3353 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (1516 : UInt256) = UInt256.ofNat 1516 := by decide
  have h2877Nat : (UInt256.ofNat 1516).toNat = 1516 := by decide
