...
/-- The multiply entry `JUMPDEST` at pc 3881 (0x0f50, instruction 2957), the target of every `MONPRO` call. -/
...
def loopState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 2058
           stack := loopStack px k ret rest
           memory := mem }

/-- The `MONPRO` call, pc 4096, with the frame `[px, px, px, 2310]` pushed. -/
...
/-- `blk1751` (pc 2299..2309): push the `MONPRO` frame and jump to pc 4096. -/
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (2069 : UInt256) = UInt256.ofNat 2069 := by decide
  have h1939 : (3873 : UInt256) = UInt256.ofNat 3873 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (2058 : UInt256) = UInt256.ofNat 2058 := by decide
  have h2877Nat : (UInt256.ofNat 2058).toNat = 2058 := by decide
