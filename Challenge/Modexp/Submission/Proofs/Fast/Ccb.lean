...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h1939 : (3862 : UInt256) = UInt256.ofNat 3862 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (2070 : UInt256) = UInt256.ofNat 2070 := by decide
  have h2877Nat : (UInt256.ofNat 2070).toNat = 2070 := by decide
