...
def amCallState (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 2463
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 2870] ++ ([UInt256.ofNat px, ret] ++ rest)
           memory := mem }
...
def mpCallState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 1939
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 2884] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_entry (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  have h2874 : (2870 : UInt256) = UInt256.ofNat 2870 := by decide
  have h2467 : (2463 : UInt256) = UInt256.ofNat 2463 := by decide
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (2884 : UInt256) = UInt256.ofNat 2884 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (2873 : UInt256) = UInt256.ofNat 2873 := by decide
  have h2877Nat : (UInt256.ofNat 2873).toNat = 2873 := by decide
