...
def mpCallState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 3552
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 1662] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (1662 : UInt256) = UInt256.ofNat 1662 := by decide
  have h1939 : (3552 : UInt256) = UInt256.ofNat 3552 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (1651 : UInt256) = UInt256.ofNat 1651 := by decide
  have h2877Nat : (UInt256.ofNat 1651).toNat = 1651 := by decide
