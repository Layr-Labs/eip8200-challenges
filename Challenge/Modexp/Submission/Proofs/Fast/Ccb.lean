...
def mpCallState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 3349
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 1528] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (1528 : UInt256) = UInt256.ofNat 1528 := by decide
  have h1939 : (3349 : UInt256) = UInt256.ofNat 3349 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (1517 : UInt256) = UInt256.ofNat 1517 := by decide
  have h2877Nat : (UInt256.ofNat 1517).toNat = 1517 := by decide
