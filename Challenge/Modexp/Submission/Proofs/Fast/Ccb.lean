...
def amCallState (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 2199
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 2478] ++ ([UInt256.ofNat px, ret] ++ rest)
           memory := mem }
...
theorem run_entry (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  have h2874 : (2478 : UInt256) = UInt256.ofNat 2478 := by decide
  have h2467 : (2199 : UInt256) = UInt256.ofNat 2199 := by decide
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (2492 : UInt256) = UInt256.ofNat 2492 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (2481 : UInt256) = UInt256.ofNat 2481 := by decide
  have h2877Nat : (UInt256.ofNat 2481).toNat = 2481 := by decide
