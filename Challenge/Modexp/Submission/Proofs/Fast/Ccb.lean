...
def mpCallState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 3536
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 1658] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (1658 : UInt256) = UInt256.ofNat 1658 := by decide
  have h1939 : (3536 : UInt256) = UInt256.ofNat 3536 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (1647 : UInt256) = UInt256.ofNat 1647 := by decide
  have h2877Nat : (UInt256.ofNat 1647).toNat = 1647 := by decide
