...
def amCallState (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 2432
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 2659] ++ ([UInt256.ofNat px, ret] ++ rest)
           memory := mem }
...
def mpCallState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 1939
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 2673] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_entry (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  have h2874 : (2659 : UInt256) = UInt256.ofNat 2659 := by decide
  have h2467 : (2432 : UInt256) = UInt256.ofNat 2432 := by decide
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h2888 : (2673 : UInt256) = UInt256.ofNat 2673 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h2877 : (2662 : UInt256) = UInt256.ofNat 2662 := by decide
  have h2877Nat : (UInt256.ofNat 2662).toNat = 2662 := by decide
