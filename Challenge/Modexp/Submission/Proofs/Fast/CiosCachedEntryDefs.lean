...
def zeroProgram : List Instr := (entryProgram.drop 32).take 8
def pointersProgram : List Instr := entryProgram.drop 40
...
def clearedState (s : State) (mem : ByteArray) (pa pb n : Nat)
  ...
  { s with pc := UInt256.ofNat 4226
           stack := [UInt256.ofNat (32*n), UInt256.ofNat pa, UInt256.ofNat pb,
             l1Target n, negative32, allOnes, l2Target n, modulusValue mem n, inverseValue mem, tailPointerValue mem, low64Value mem, low32Value mem, dst, ret] ++ rest
