...
def input (s : State) (mem : ByteArray) (aprev tl inv m0 m96 m64 m32 dst ret : UInt256)
  ...
  {TnM128SquareSteps.outState (UInt256.ofNat 0) (MachineState.readWord mem 128) s mem 2368 8 0
      (UInt256.ofNat 4093) (UInt256.ofNat 3387) inv m0
      (tl :: m96 :: m64 :: m32 :: aprev :: dst :: ret :: rest) with pc := UInt256.ofNat 4917}
...
noncomputable def steps (s : State)
  ...
  have hp := TnM128R8FirstRow.run_program st (UInt256.ofNat 4917) (UInt256.ofNat 4093)
    (UInt256.ofNat 3387) (UInt256.ofNat 3424) (UInt256.ofNat 0) (MachineState.readWord mem 128)
    (UInt256.ofNat 3666) inv m0 m96 m64 m32 aprev (dst :: ret :: rest)
    (by simp only [List.length_cons]; omega) hact hL2
  have g0 := TnM128R8FirstRow.block.steps
    (s := initial st (UInt256.ofNat 4917) (UInt256.ofNat 4093) (UInt256.ofNat 3387)
  ...
  have g1 := TnM128R8SuffixSteps.suffix_steps s env q (UInt256.ofNat 0)
    (UInt256.ofNat 2592) (UInt256.ofNat 4093) (UInt256.ofNat 2336) (UInt256.ofNat 3424)
  ...
  rw [hz, hf] at g1
  have hjoin : TnM128R8FirstRow.result st (UInt256.ofNat 4093) (UInt256.ofNat 3424)
      (MachineState.readWord mem 128) (UInt256.ofNat 3666) inv m0 m96 m64 m32 (dst :: ret :: rest) =
      TnCacheL2Trace.state {s with memory := q.memory} (UInt256.ofNat 3666)
  ...
  have hstart : initial st (UInt256.ofNat 4917) (UInt256.ofNat 4093) (UInt256.ofNat 3387)
      (UInt256.ofNat 0) (MachineState.readWord mem 128) inv m0 m96 m64 m32 aprev (dst :: ret :: rest) =
