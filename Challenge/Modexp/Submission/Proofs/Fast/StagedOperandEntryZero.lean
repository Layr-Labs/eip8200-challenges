...
from the end of calldata), keeping `hd` on top: pc 3953 → 3973. -/
...
/-- Operand pointers and the jump to the row head (pc 3973 → `hd`):
...
(the row head: 3983 for the multiply, 4665 for the square). -/
