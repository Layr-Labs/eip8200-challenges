...
from the end of calldata), keeping `hd` on top: pc 3955 → 3975. -/
...
/-- Operand pointers and the jump to the row head (pc 3975 → `hd`):
...
(the row head: 3985 for the multiply, 4663 for the square). -/
