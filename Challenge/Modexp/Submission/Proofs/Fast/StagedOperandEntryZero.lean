...
from the end of calldata), keeping `hd` on top: pc 4223 → 4243. -/
...
/-- Operand pointers and the jump to the row head (pc 4243 → `hd`):
...
(the row head: 4253 for the multiply, 4914 for the square). -/
