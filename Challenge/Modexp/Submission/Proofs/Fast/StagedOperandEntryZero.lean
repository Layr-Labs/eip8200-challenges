...
from the end of calldata), keeping `hd` on top: pc 4233 → 4253. -/
...
/-- Operand pointers and the jump to the row head (pc 4253 → `hd`):
...
(the row head: 4263 for the multiply, 4924 for the square). -/
