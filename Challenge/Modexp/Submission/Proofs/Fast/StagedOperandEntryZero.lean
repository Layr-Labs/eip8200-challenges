...
from the end of calldata), keeping `hd` on top: pc 4137 → 4157. -/
...
/-- Operand pointers and the jump to the row head (pc 4157 → `hd`):
...
(the row head: 4167 for the multiply, 4831 for the square). -/
