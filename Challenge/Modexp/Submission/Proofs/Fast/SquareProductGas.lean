...
def gasSteps_product (s : State) (mem : ByteArray) (ai : UInt256) (i : Nat)
  ...
  · have hin : i < 7 := by omega
    have hj : Decode.isValidJumpDest s.executionEnv.code (SquareControls.target (delta i)).toNat = true := by
      ...
      interval_cases i
      · exact Artifact.isValidJumpDest_index 3212 (by rfl)
      · exact Artifact.isValidJumpDest_index 3244 (by rfl)
      · exact Artifact.isValidJumpDest_index 3276 (by rfl)
      · exact Artifact.isValidJumpDest_index 3308 (by rfl)
      · exact Artifact.isValidJumpDest_index 3340 (by rfl)
      · exact Artifact.isValidJumpDest_index 3372 (by rfl)
      · exact Artifact.isValidJumpDest_index 3404 (by rfl)
