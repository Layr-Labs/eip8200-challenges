...
def gasSteps_product (s : State) (mem : ByteArray) (ai : UInt256) (i : Nat)
  ...
  · have hin : i < 7 := by omega
    have hj : Decode.isValidJumpDest s.executionEnv.code (SquareControls.target (delta i)).toNat = true := by
      ...
      interval_cases i
      · exact Artifact.isValidJumpDest_index 3206 (by rfl)
      · exact Artifact.isValidJumpDest_index 3238 (by rfl)
      · exact Artifact.isValidJumpDest_index 3270 (by rfl)
      · exact Artifact.isValidJumpDest_index 3302 (by rfl)
      · exact Artifact.isValidJumpDest_index 3334 (by rfl)
      · exact Artifact.isValidJumpDest_index 3366 (by rfl)
      · exact Artifact.isValidJumpDest_index 3398 (by rfl)
