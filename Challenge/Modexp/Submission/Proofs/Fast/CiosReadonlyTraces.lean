...
theorem run_entry (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    some (outState s (mpZeroed s mem n) pa pb n 0
      ...
      (MachineState.readWord mem 128 :: MachineState.readWord mem 96 :: MachineState.readWord mem 64 :: MachineState.readWord mem 32 :: MachineState.readWord mem 9440 :: dst :: ret :: rest)) := by
  let tl := MachineState.readWord mem 9440
  let inv := MachineState.readWord mem 9376
  let m0 := MachineState.readWord mem (32*n-32)
  let m128 := MachineState.readWord mem 128
  let m96 := MachineState.readWord mem 96
  let m64 := MachineState.readWord mem 64
  let m32 := MachineState.readWord mem 32
  have hcap' : (m128 :: m96 :: m64 :: m32 :: tl :: dst :: ret :: rest).length ≤ 1005 := by simp only [List.length_cons]; omega
  have hc4 : rest.length+4 < 1024 := by omega
  have hc11 : rest.length+11 < 1024 := by omega
  have hlegacy := CiosCached.run_cache s mem pa pb n inv m0
    (m128 :: m96 :: m64 :: m32 :: tl :: dst :: ret :: rest) hcap' hact hs32
  have hskip : runInstructions [.op .JUMPDEST]
      (maskEntryState s mem pa pb inv m0 (m128 :: m96 :: m64 :: m32 :: tl :: dst :: ret :: rest)) =
    some (framed { s with memory := mem } (UInt256.ofNat 4189)
      ([UInt256.ofNat pa,UInt256.ofNat pb,inv,m0,m128,m96,m64,m32,tl,dst,ret] ++ rest)) := by
  ...
  have hbody := CiosCached.run_entryBody s mem pa pb n inv m0
    (m128 :: m96 :: m64 :: m32 :: tl :: dst :: ret :: rest) hcap' hrun hact hn hn32 hpa hpaFit hpb hpbFit hcds hs32
...
theorem run_middle (s : State) (mem : ByteArray) (c bi : UInt256)
    (pa pb n i : Nat) (tl inv m0 m128 m96 m64 m32 dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions fullMidProgram
      (CiosCached.midState s mem c bi pa pb n i inv m0 (m128 :: m96 :: m64 :: m32 :: tl :: dst :: ret :: rest)) =
    some (CiosCached.l2At 4583 s (midMem mem c) bi (rowMu mem n) (rowC0 mem n)
      pa pb n i 0 inv m0 (m128 :: m96 :: m64 :: m32 :: tl :: dst :: ret :: rest)) := by
  ...
  have trace := runInstructions_append_some _ _ _ _ _
    (CiosCachedMidStore.run_store { s with memory := mem } c bi
      ...
      (l1Target n) (l2Target n) inv (m0 :: m128 :: m96 :: m64 :: m32 :: tl :: dst :: ret :: rest)
    ...
    (run_cachedProduct_model { s with memory := midMem mem c }
      ...
      (UInt256.ofNat (pb-32)) (l1Target n) (l2Target n) tl inv m0 m128 m96 m64 m32 dst ret n rest hcap hn32 hact
...
theorem run_exit (s : State) (pbi paEnd pbEnd flag target2 tl inv m0 m128 m96 m64 m32 dst ret : UInt256)
    (rest : List UInt256) (hcap : rest.length ≤ 998)
    (htarget : Decode.isValidJumpDest s.executionEnv.code 2220 = true) :
    runInstructions fullExitProgram
      (framed s (UInt256.ofNat 4872)
        ([pbi,paEnd,pbEnd,flag,negative32,allOnes,target2,inv,m0,m128,m96,m64,m32,tl,dst,ret] ++ rest)) =
