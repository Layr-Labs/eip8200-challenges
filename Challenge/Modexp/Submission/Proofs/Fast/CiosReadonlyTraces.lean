...
theorem run_exit_pop (s : State) (pbi paEnd pbEnd flag target2 tl inv m0 aEnd m96 m64 m32 dst ret : UInt256)
    (rest : List UInt256) (hcap : rest.length ≤ 998)
    (_htarget : Decode.isValidJumpDest s.executionEnv.code 4671 = true) :
  ...
  have hc15 : rest.length+15 < 1024 := by omega
  have hc16 : rest.length+16 < 1024 := by omega
  have hpc14 : (UInt256.ofNat 4653).succ.succ.succ.succ.succ.succ.succ.succ.succ.succ.succ.succ.succ.succ = UInt256.ofNat 4667 := by decide
  have hpcEnd : (UInt256.ofNat 4667 + UInt256.ofNat 3).succ = UInt256.ofNat 4671 := by decide
