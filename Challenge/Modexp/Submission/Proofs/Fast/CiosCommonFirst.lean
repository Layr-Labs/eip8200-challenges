...
theorem run_commonFirst (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    runInstructions commonFirstProgram
      (firstAt 4255 s mem bi pb n i hd ent inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: dst :: ret :: rest)) =
    some (l1At 4281 s mem bi pa pb n i 1 hd ent inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: dst :: ret :: rest)) := by
  ...
  have hl := run_load st (UInt256.ofNat 4255) bi pbi hd (UInt256.ofNat (pb-32))
    ent (l2Target n) tl inv m0 aEnd m96 m64 m32 dst ret rest hcap hA
  have hp := CiosNoDummyCarry.run_product st (advancePC 3 (UInt256.ofNat 4255))
  ...
  have hf := run_finish st (advancePC 13 (advancePC 3 (UInt256.ofNat 4255)))
  ...
  have hpc : advancePC 13 (advancePC 3 (UInt256.ofNat 4255))+UInt256.ofNat 10 = UInt256.ofNat 4281 := by decide
