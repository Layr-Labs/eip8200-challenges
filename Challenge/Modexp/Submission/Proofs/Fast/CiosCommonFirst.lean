...
theorem run_commonFirst (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    some (l1At 4279 s mem bi pa pb n i 1 hd ent inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: dst :: ret :: rest)) := by
  ...
  have hm := CiosNoDummyCarry.run_multiply st (advancePC 3 (UInt256.ofNat 4255))
  ...
  have hf := run_fused st (advancePC 6 (advancePC 3 (UInt256.ofNat 4255)))
  ...
  have hpc : advancePC 6 (advancePC 3 (UInt256.ofNat 4255))+UInt256.ofNat 15 = UInt256.ofNat 4279 := by decide
