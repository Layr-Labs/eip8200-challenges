...
theorem run_commonFirst (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    runInstructions commonFirstProgram
      (firstAt 4253 s mem bi pa pb n i inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: dst :: ret :: rest)) =
    some (l1At 4279 s mem bi pa pb n i 1 inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: dst :: ret :: rest)) := by
  ...
  have hl := run_load st (UInt256.ofNat 4253) bi pbi (UInt256.ofNat pa) (UInt256.ofNat (pb-32))
    (l1Target n) (l2Target n) tl inv m0 aEnd m96 m64 m32 dst ret rest hcap hA
  have hp := CiosNoDummyCarry.run_product st (advancePC 3 (UInt256.ofNat 4253))
  ...
  have hf := run_finish st (advancePC 13 (advancePC 3 (UInt256.ofNat 4253)))
  ...
  have hpc : advancePC 13 (advancePC 3 (UInt256.ofNat 4253))+UInt256.ofNat 10 = UInt256.ofNat 4279 := by decide
