...
theorem guard_iff (mem : ByteArray) (pa pb n : Nat) (hn : n ≤ 8)
...
def args (mem : ByteArray) (pa n : Nat) (dst ret : UInt256) (rest : List UInt256) : List UInt256 :=
  MachineState.readWord mem 2880 :: MachineState.readWord mem 96 :: MachineState.readWord mem 64 ::
...
def out (s : State) (mem : ByteArray) (pa pb n : Nat) (dst ret : UInt256) (rest : List UInt256) : State :=
  outState s (mpZeroed s (before mem pa pb n) n) pa pb n 0
    (MachineState.readWord mem 2816) (MachineState.readWord mem (32*n-32)) (args mem pa n dst ret rest)
...
def gasSteps_header (s : State) (mem : ByteArray) (pa pb n : Nat) (dst ret : UInt256) (rest : List UInt256)
    ...
    (hn : n=4 ∨ n=8) (hpa : 32 ≤ pa) (hpafit : pa+32*n ≤ 2048)
    ...
    Challenge.EvmProof.GasSteps (Cios2Dispatch.dispatchState s mem pa pb dst ret rest)
      {out s mem pa pb n dst ret rest with pc := UInt256.ofNat 4164} := by
  ...
  have hread (a : Nat) (hd : a+32 ≤ 2368 ∨ 2752 ≤ a) := read_select_outside mem (UInt256.ofNat pa) (UInt256.ofNat pb) a hd
  have he := CarryRowGas.gasSteps_entry s (SquareSelect.selectedMemory mem (UInt256.ofNat pa) (UInt256.ofNat pb)) pa pb n
    ...
    ((hread 2784 (Or.inr (by decide))).trans hs32) ((hread 2848 (Or.inr (by decide))).trans hml)
  simpa only [out, args, before, inputMemory, selected, if_pos hn, CiosCached.entryState, stateAt,
    hread 2816 (Or.inr (by decide)), hread (32*n-32) (Or.inl (by omega)),
    hread 2880 (Or.inr (by decide)), hread 96 (Or.inl (by decide)),
    hread 64 (Or.inl (by decide)), hread 32 (Or.inl (by decide))] using he

def routerBlock : Block Artifact.submissionArtifact .Osaka 4164 SquareRoute.headerProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3145 3 4164 SquareRoute.headerProgram
...
def gasSteps_route (s : State) (mem : ByteArray) (route : UInt256) (rest : List UInt256)
    ...
    (env : Environment Artifact.submissionArtifact .Osaka s) :
    Challenge.EvmProof.GasSteps (stateAt s mem 4164 rest) (framed {s with memory := mem} route rest) :=
