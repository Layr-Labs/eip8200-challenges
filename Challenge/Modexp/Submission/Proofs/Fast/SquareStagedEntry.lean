...
def block : Block Artifact.submissionArtifact .Osaka 4759 program :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3570 9 4759 program
...
def gasSteps_entry (s : State) (mem : ByteArray) (n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s mem 512 n 0 (UInt256.ofNat 4759) ent inv m0 rest)
      { outState s mem 2368 n 0 (UInt256.ofNat 4448) ent inv m0 rest with
