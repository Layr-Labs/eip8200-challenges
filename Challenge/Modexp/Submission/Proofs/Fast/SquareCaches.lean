...
theorem readonlyCache_sqRowsCarry {mem : ByteArray} {n : Nat} {tl inv m0 : UInt256}
  ...
  hc.of_preserved
    (readWord_sqRowsCarry mem n 5280 hn (Or.inr (by decide)) i hi)
...
theorem extraCache_sqRowsCarry {mem : ByteArray} {m96 m64 m32 : UInt256}
    (hc : CiosReadonlyExtra.ExtraCache mem m96 m64 m32) (n : Nat) (hn : n ≤ 32) (i : Nat)
    (hi : i ≤ n) :
...
theorem inverse_sqRowsCarry (mem : ByteArray) (n : Nat) (hn : n ≤ 32)
...
theorem inverse_sqPro (mem : ByteArray) (n i : Nat) (tb : UInt256) (hn : n ≤ 32) (hi : i < n)
