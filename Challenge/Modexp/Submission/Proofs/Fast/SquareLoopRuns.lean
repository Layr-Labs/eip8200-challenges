...
private theorem activeWords9280 (s : State) (hact : 93 ≤ s.activeWords.toNat) :
    UInt256.ofNat (MachineState.activeWordsAfter s.activeWords.toNat 2720 32) =
      s.activeWords := by
  have hnat : MachineState.activeWordsAfter s.activeWords.toNat 2720 32 =
...
theorem run_sqExit_more (s : State) (mem : ByteArray) (n c : Nat)
    ...
    (hact : 93 ≤ s.activeWords.toNat) (hcpos : 0 < c) (hc16 : c + 1 ≤ 16)
    (hcount : MachineState.readWord mem 2720 = UInt256.ofNat (c + 1)) :
  ...
  have h9280 : (2720 : UInt256).toNat = 2720 := by decide
...
theorem run_sqExit_last (s : State) (mem : ByteArray) (n : Nat)
    ...
    (hcount : MachineState.readWord mem 2720 = UInt256.ofNat 1) :
    runInstructions sqExitProgram
      (frameAt pcSqExit s mem n pbi ent tl inv m0 m96 m64 m32 aprev pdst ret rest) =
...
def gasSteps_csubAt (s : State) (X : ByteArray) (n : Nat) (ret : UInt256)
    ...
    (hml : MachineState.readWord X 2848 = UInt256.ofNat (32 * n - 32))
    (htl : MachineState.readWord X 2880 = UInt256.ofNat (2080 + 32 * n))
    (hs32 : MachineState.readWord (Csub.csStep X n n).memory 2784 = UInt256.ofNat (32 * n))
