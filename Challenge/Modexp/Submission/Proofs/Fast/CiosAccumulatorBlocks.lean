import Challenge.Modexp.Submission.Proofs.Fast.CiosAccumulatorModel
...
namespace Challenge.Modexp.Submission.Proofs.Fast.CiosAccumulatorBlocks
...
def mid : Block Artifact.submissionArtifact .Osaka 4537 CiosAccumulatorModel.middleProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3391 26 4537 CiosAccumulatorModel.middleProgram
    (by decide) (by rfl) (by rfl) (by decide)

def l2Dispatch : Block Artifact.submissionArtifact .Osaka 4565 l2DispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3417 2 4565 l2DispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac0 : Block Artifact.submissionArtifact .Osaka 4568 (l2Program 9 192 8448 8480) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3420 31 4568 (l2Program 9 192 8448 8480)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac1 : Block Artifact.submissionArtifact .Osaka 4612 (l2Program 1 160 8416 8448) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3451 31 4612 (l2Program 1 160 8416 8448)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac2 : Block Artifact.submissionArtifact .Osaka 4648 (l2Program 1 128 8384 8416) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3482 31 4648 (l2Program 1 128 8384 8416)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac3 : Block Artifact.submissionArtifact .Osaka 4684 (l2Program 1 96 8352 8384) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3513 31 4684 (l2Program 1 96 8352 8384)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Join : Block Artifact.submissionArtifact .Osaka 4720 joinProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3544 1 4720 joinProgram
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac4 : Block Artifact.submissionArtifact .Osaka 4721 (l2Program 1 64 8320 8352) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3545 31 4721 (l2Program 1 64 8320 8352)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac5 : Block Artifact.submissionArtifact .Osaka 4757 (l2Program 1 32 8288 8320) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3576 31 4757 (l2Program 1 32 8288 8320)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac6 : Block Artifact.submissionArtifact .Osaka 4793 (l2Program 0 0 8256 8288) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3607 31 4793 (l2Program 0 0 8256 8288)
    (by decide) (by rfl) (by rfl) (by decide)

def tailLoop : Block Artifact.submissionArtifact .Osaka 4828 CiosAccumulatorTrace.tailLoopProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3638 19 4828 CiosAccumulatorTrace.tailLoopProgram
    (by decide) (by rfl) (by rfl) (by decide)

def exitBlock : Block Artifact.submissionArtifact .Osaka 4885 CiosReadonly.fullExitProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3657 16 4885 CiosReadonly.fullExitProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
def l2Join8 : Block Artifact.submissionArtifact .Osaka 4567 joinProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3419 1 4567 joinProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
end Challenge.Modexp.Submission.Proofs.Fast.CiosAccumulatorBlocks
