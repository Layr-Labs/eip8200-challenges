...
def gasSteps_rowArithmetic (s : State) (mem : ByteArray) (pa pb i : Nat)
  ...
  have hL1_0 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 0).memory 4664 ([(l1Step mem bi pa 8 0).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_0 hcode hfork
  ...
  have hL1_1 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 1).memory 4705 ([(l1Step mem bi pa 8 1).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_1 hcode hfork
  ...
  have hL1_2 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 2).memory 4745 ([(l1Step mem bi pa 8 2).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_2 hcode hfork
  ...
  have hL1_3 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 3).memory 4785 ([(l1Step mem bi pa 8 3).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_3 hcode hfork
  ...
  have hL1_4 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 4).memory 4825 ([(l1Step mem bi pa 8 4).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_4 hcode hfork
  ...
  have hL1_5 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 5).memory 4865 ([(l1Step mem bi pa 8 5).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_5 hcode hfork
  ...
  have hL1_6 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 6).memory 4905 ([(l1Step mem bi pa 8 6).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_6 hcode hfork
  ...
  have hL1_7 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l1Step mem bi pa 8 7).memory 4945 ([(l1Step mem bi pa 8 7).carry, bi, UInt256.ofNat (pa - 32), maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l1_7 hcode hfork
  ...
  have hL2_0 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l2Step middle mu c0 8 0).memory 5037 ([(l2Step middle mu c0 8 0).carry, mu, maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l2_0 hcode hfork
  ...
  have hL2_1 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l2Step middle mu c0 8 1).memory 5075 ([(l2Step middle mu c0 8 1).carry, mu, maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l2_1 hcode hfork
  ...
  have hL2_2 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l2Step middle mu c0 8 2).memory 5113 ([(l2Step middle mu c0 8 2).carry, mu, maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l2_2 hcode hfork
  ...
  have hL2_3 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l2Step middle mu c0 8 3).memory 5151 ([(l2Step middle mu c0 8 3).carry, mu, maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l2_3 hcode hfork
  ...
  have hL2_4 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l2Step middle mu c0 8 4).memory 5189 ([(l2Step middle mu c0 8 4).carry, mu, maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l2_4 hcode hfork
  ...
  have hL2_5 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l2Step middle mu c0 8 5).memory 5227 ([(l2Step middle mu c0 8 5).carry, mu, maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l2_5 hcode hfork
  ...
  have hL2_6 := Challenge.EvmProof.Stepper.runLocatedBlock_sound
    (s := atState s (l2Step middle mu c0 8 6).memory 5265 ([(l2Step middle mu c0 8 6).carry, mu, maxWord] ++ suffix)) Artifact.submissionArtifact .Osaka block_l2_6 hcode hfork
