...
theorem run_cache (s : State) (mem : ByteArray) (pa pb n : Nat)
  ...
  have hK : UInt256.lnot (31 : UInt256) = negative32 := by decide
  have hN : UInt256.lnot (0 : UInt256) = allOnes := by decide
  ...
  simp [cacheProgram, entryProgram, runInstructions, Challenge.EvmProof.Stepper.runInstr,
    ...
    hK, hN, h128, h9344, hs32, hactS, State.activeWordsAfterUInt256,
