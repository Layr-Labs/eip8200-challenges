import Challenge.Modexp.Submission.Proofs.Fast.FixedExponentRouteCorrect
...
namespace Challenge.Modexp.Submission.Proofs.Fast.FixedExponentCorrect
...
def handled_of_bDoneConcrete (input : ByteArray) (s : State) (mem : ByteArray)
  ...
  handled_of_bDoneWithGeneric
    (FixedExponentRouteCorrect.route input s mem n bsize esize msize mm minv bM
      sub spec hcode hfork hrun hnp hdata hstack hact hn hn32 hb he hmz hm32
      hbsize hesize hmsz hmm hodd hradix hbMlt hbMform hframe hmod hbase hone)
...
end Challenge.Modexp.Submission.Proofs.Fast.FixedExponentCorrect
