...
def l2Eight : Block submissionArtifact .Osaka 4023 (TnCacheL2Chain.fullProgram 8) :=
  WindowTwentyOneSlice.block allWellFormed 3039 207 4023 (TnCacheL2Chain.fullProgram 8)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Four : Block submissionArtifact .Osaka 4171 (TnCacheL2Chain.fullProgram 4) :=
  WindowTwentyOneSlice.block allWellFormed 3158 88 4171 (TnCacheL2Chain.fullProgram 4)
    (by decide) (by rfl) (by rfl) (by decide)

def middle : Block submissionArtifact .Osaka 4000 (TnCacheRowTrace.middle ++ TnCacheReductionTrace.dispatch) :=
  WindowTwentyOneSlice.block allWellFormed 3016 23 4000 (TnCacheRowTrace.middle ++ TnCacheReductionTrace.dispatch)
    (by decide) (by rfl) (by rfl) (by decide)

def tailShort : Block submissionArtifact .Osaka 4271 (TnCacheRowTrace.tailShort) :=
  WindowTwentyOneSlice.block allWellFormed 3246 18 4271 (TnCacheRowTrace.tailShort)
    (by decide) (by rfl) (by rfl) (by decide)

def flush : Block submissionArtifact .Osaka 4292 (TnCacheFrameOps.flush) :=
  WindowTwentyOneSlice.block allWellFormed 3264 3 4292 (TnCacheFrameOps.flush)
    (by decide) (by rfl) (by rfl) (by decide)

def afterSquareReset : Block submissionArtifact .Osaka 3658 (TnCacheFrameOps.reset) :=
  WindowTwentyOneSlice.block allWellFormed 2733 3 3658 (TnCacheFrameOps.reset)
    (by decide) (by rfl) (by rfl) (by decide)

def againReset : Block submissionArtifact .Osaka 4419 (TnCacheFrameOps.reset) :=
  WindowTwentyOneSlice.block allWellFormed 3346 3 4419 (TnCacheFrameOps.reset)
    (by decide) (by rfl) (by rfl) (by decide)
