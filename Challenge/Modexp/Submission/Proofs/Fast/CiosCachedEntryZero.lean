...
theorem run_zero (s : State) (mem : ByteArray) (pa pb n : Nat)
    (dst ret : UInt256) (rest : List UInt256) (hcap : rest.length ≤ 1002)
  ...
  simp [hExtra9, hExtra10, hExtra11, hExtra12, hExtra13, hExtra14, hExtra15, zeroProgram, entryProgram, runInstructions, Challenge.EvmProof.Stepper.runInstr,
