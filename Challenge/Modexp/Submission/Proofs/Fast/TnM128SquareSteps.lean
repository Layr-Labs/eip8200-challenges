...
noncomputable def prologue_steps (s : State) (mem : ByteArray) (tn m128 : UInt256) (n i e : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState tn m128 s mem 2368 n i (UInt256.ofNat 4093) (UInt256.ofNat e) pdst ret
      ...
      (l1Q tn m128 e s (sqPro mem n i (UInt256.sgt (UInt256.ofNat 0) aprev))
        ...
        (UInt256.ofNat 4093) (UInt256.ofNat (e + 37)) pdst ret
  ...
  -- block A
  have hA := run_A s' P (UInt256.ofNat 4093) (UInt256.ofNat (2368 - 32)) (UInt256.ofNat e)
  ...
  have gS := TnM128SgtStep.gasSteps_sqRowSgt
    { s' with pc := UInt256.ofNat 4099,
              stack := UInt256.ofNat 0 :: aprev :: MachineState.readWord s'.memory P.toNat :: P ::
                UInt256.ofNat 4093 :: UInt256.ofNat (2368 - 32) :: UInt256.ofNat e :: tn ::
  ...
  have hB := run_B s' (UInt256.sgt (UInt256.ofNat 0) aprev) (MachineState.readWord s'.memory P.toNat) P
    (UInt256.ofNat 4093) (UInt256.ofNat (2368 - 32)) (UInt256.ofNat e) tn allOnes
