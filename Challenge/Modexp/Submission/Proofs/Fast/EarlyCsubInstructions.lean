...
def jumpProgram : List Instr := [.push 2 5032, .op .JUMP]
def copyProgram : List Instr :=
  [.op .JUMPDEST, .push 2 2112, .push 2 2688, .op .MLOAD,
   .op (.Swap ⟨1, by decide⟩), .op .MCOPY, .op .JUMP]

def checkBlock : Block Artifact.submissionArtifact .Osaka 4877 checkProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3726 11 4877 checkProgram
    (by decide) (by rfl) (by rfl) (by decide)
def jumpBlock : Block Artifact.submissionArtifact .Osaka 4894 jumpProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3737 2 4894 jumpProgram
    (by decide) (by rfl) (by rfl) (by decide)
def copyBlock : Block Artifact.submissionArtifact .Osaka 5268 copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4010 7 5268 copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
theorem run_check (s : State) (mem : ByteArray) (dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions checkProgram (atState s mem 4877 dst ret rest) =
      some (atState s mem (if Skip mem then 5268 else 4894) dst ret rest) := by
  ...
  have heq5165 : (5268 : UInt256) = UInt256.ofNat 5268 := by decide
  have h5165 : (5268 : UInt256).toNat = 5268 := by decide
...
theorem run_jump (s : State) (mem : ByteArray) (dst ret : UInt256) (rest : List UInt256)
    ...
    (hcode : s.executionEnv.code = Challenge.Modexp.submissionBytecode) :
    runInstructions jumpProgram (atState s mem 4894 dst ret rest) =
      some (atState s mem 5032 dst ret rest) := by
  have hc1 : rest.length+1 < 1024 := by omega
  have hc2 : rest.length+2 < 1024 := by omega
  have hc3 : rest.length+3 < 1024 := by omega
  have heq4925 : (5032 : UInt256) = UInt256.ofNat 5032 := by decide
  have h4925 : (5032 : UInt256).toNat = 5032 := by decide
...
theorem run_copy (s : State) (mem : ByteArray) (n : Nat) (dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions copyProgram (atState s mem 5268 dst ret rest) =
