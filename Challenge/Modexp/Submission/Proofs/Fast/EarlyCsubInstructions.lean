...
def checkBlock : Block Artifact.submissionArtifact .Osaka 4330 checkProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3277 11 4330 checkProgram
    (by decide) (by rfl) (by rfl) (by decide)
def jumpBlock : Block Artifact.submissionArtifact .Osaka 4347 jumpProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3288 2 4347 jumpProgram
    (by decide) (by rfl) (by rfl) (by decide)
def copyBlock : Block Artifact.submissionArtifact .Osaka 4736 copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3568 7 4736 copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
