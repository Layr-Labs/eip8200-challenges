...
def checkBlock : Block Artifact.submissionArtifact .Osaka 4667 checkProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3576 12 4667 checkProgram
    (by decide) (by rfl) (by rfl) (by decide)
def jumpBlock : Block Artifact.submissionArtifact .Osaka 4685 jumpProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3588 2 4685 jumpProgram
    (by decide) (by rfl) (by rfl) (by decide)
def copyBlock : Block Artifact.submissionArtifact .Osaka 5087 copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3867 7 5087 copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
