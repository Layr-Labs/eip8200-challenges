...
def checkBlock : Block Artifact.submissionArtifact .Osaka 4086 checkProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3278 11 4086 checkProgram
    (by decide) (by rfl) (by rfl) (by decide)
def jumpBlock : Block Artifact.submissionArtifact .Osaka 4103 jumpProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3289 2 4103 jumpProgram
    (by decide) (by rfl) (by rfl) (by decide)
def copyBlock : Block Artifact.submissionArtifact .Osaka 4464 copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3544 7 4464 copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
