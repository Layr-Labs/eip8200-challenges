...
def checkProgram : List Instr :=
  [.op .JUMPDEST, .push 0 0, .op .MLOAD, .push 2 8256, .op .MLOAD,
   ...
   .push 2 5037, .op .JUMPI]
def jumpProgram : List Instr := [.push 2 4836, .op .JUMP]
def copyProgram : List Instr :=
  [.op .JUMPDEST, .push 2 8256, .push 2 9344, .op .MLOAD,
   .op (.Swap ⟨1, by decide⟩), .op .MCOPY, .op .JUMP]

def checkBlock : Block Artifact.submissionArtifact .Osaka 4536 checkProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3456 12 4536 checkProgram
    (by decide) (by rfl) (by rfl) (by decide)
def copyBlock : Block Artifact.submissionArtifact .Osaka 5037 copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3802 7 5037 copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
theorem run_check (s : State) (mem : ByteArray) (dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions checkProgram (atState s mem 4536 dst ret rest) =
  ...
  have heq5165 : (5037 : UInt256) = UInt256.ofNat 5037 := by decide
  have h5165 : (5037 : UInt256).toNat = 5037 := by decide
...
theorem run_copy (s : State) (mem : ByteArray) (n : Nat) (dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions copyProgram (atState s mem 5037 dst ret rest) =
