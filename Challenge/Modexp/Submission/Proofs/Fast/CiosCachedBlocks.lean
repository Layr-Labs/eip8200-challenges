...
def tailLoop : Block Artifact.submissionArtifact .Osaka 4828 CarryRowPrograms.tail :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3638 19 4828 CarryRowPrograms.tail
    (by decide) (by rfl) (by rfl) (by decide)
