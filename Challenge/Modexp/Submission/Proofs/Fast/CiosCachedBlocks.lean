...
def mid : Block Artifact.submissionArtifact .Osaka 4546 CiosReadonly.fullMidProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3395 26 4546 CiosReadonly.fullMidProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
def tailLoop : Block Artifact.submissionArtifact .Osaka 4837 (CiosCached.tailProgram.take 23) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3639 23 4837 (CiosCached.tailProgram.take 23)
    (by decide) (by rfl) (by rfl) (by decide)

def exitBlock : Block Artifact.submissionArtifact .Osaka 4870 CiosReadonly.fullExitProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3662 16 4870 CiosReadonly.fullExitProgram
    (by decide) (by rfl) (by rfl) (by decide)
