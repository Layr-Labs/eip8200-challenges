...
def tailLoop : Block Artifact.submissionArtifact .Osaka 5006 (CiosCached.tailProgram.take 26) :=
  WindowNineSlice.block Artifact.allWellFormed 3620 26 5006 (CiosCached.tailProgram.take 26)
    (by decide) (by rfl) (by rfl) (by decide)
...
def l2Mac6 : Block Artifact.submissionArtifact .Osaka 4966 l2LastProgram :=
  WindowNineSlice.block Artifact.allWellFormed 3586 34 4966 l2LastProgram
    (by decide) (by rfl) (by rfl) (by decide)

def exitBlock : Block Artifact.submissionArtifact .Osaka 5042 (CiosCached.tailProgram.drop 26) :=
  WindowNineSlice.block Artifact.allWellFormed 3646 8 5042 (CiosCached.tailProgram.drop 26)
    (by decide) (by rfl) (by rfl) (by decide)
