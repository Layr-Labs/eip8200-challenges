...
opaque gasSteps_square_four (s : State) (mem : ByteArray) (pa : Nat) (dst ret : UInt256) (rest : List UInt256)
    ...
    (hpa : 32 ≤ pa) (hpafit : pa+128 ≤ 8192)
    (hcds : s.executionEnv.calldata.size < 2^256)
    (hs32 : MachineState.readWord mem 9344 = UInt256.ofNat 128)
    (htl : MachineState.readWord mem 9440 = UInt256.ofNat 8352)
    (hml : MachineState.readWord mem 9408 = UInt256.ofNat 96)
  ...
  have hr : MachineState.readWord initial 9280 = UInt256.ofNat 5040 := by
    rw [mpZeroed_readWord_outside s _ 4 9280 (Or.inr (by decide))]
  ...
  have hentry : Challenge.EvmProof.GasSteps (Cios2Dispatch.dispatchState s mem pa pa dst ret rest)
      (SquareFourRowsGas.state s (prepared s mem pa pa 4) pa 0
        (MachineState.readWord mem 9440) (MachineState.readWord mem 9376) (MachineState.readWord mem 96)
  ...
  have hread (addr : Nat) (hd : addr+32 ≤ 8192 ∨ 9312 ≤ addr) := read_prepared_outside s mem pa pa 4 addr (by decide) hd
  refine hentry.trans <| SquareFourRowsGas.gasSteps_rows s (prepared s mem pa pa 4) pa
    ...
    ⟨htl, (hread 9376 (Or.inr (by decide))).symm, (hread 96 (Or.inl (by decide))).symm⟩
    ⟨(hread 96 (Or.inl (by decide))).symm, (hread 64 (Or.inl (by decide))).symm,
      (hread 32 (Or.inl (by decide))).symm⟩
    (by simpa only [inverseInvariant, hread 96 (Or.inl (by decide)), hread 9376 (Or.inr (by decide))] using hinv)
    ?_ ?_ env
