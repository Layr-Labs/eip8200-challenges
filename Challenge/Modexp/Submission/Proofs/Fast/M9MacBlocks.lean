...
/-- Block 0: instructions 1977..2005, pc 2682..2718,
`-N` limb at 1504 (0x5e0), `t` limb at 2336 (0x920).

Block 0 carries the zero-carry `PUSH4` schedule (`headZeroProgram`, instruction 1992 / pc 2699), not the
...
def block1 : Block Artifact.submissionArtifact .Osaka 2719 (blockProgram 1472 2304) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2006 30 2719 (blockProgram 1472 2304)
    (by decide) (by rfl) (by rfl) (by decide)
...
def block2 : Block Artifact.submissionArtifact .Osaka 2755 (blockProgram 1440 2272) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2036 30 2755 (blockProgram 1440 2272)
    (by decide) (by rfl) (by rfl) (by decide)
...
def block3 : Block Artifact.submissionArtifact .Osaka 2791 (blockProgram 1408 2240) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2066 30 2791 (blockProgram 1408 2240)
    (by decide) (by rfl) (by rfl) (by decide)
...
def block4 : Block Artifact.submissionArtifact .Osaka 2827 (headProgram 1376 2208) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2096 31 2827 (headProgram 1376 2208)
    (by decide) (by rfl) (by rfl) (by decide)
...
def block5 : Block Artifact.submissionArtifact .Osaka 2864 (blockProgram 1344 2176) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2127 30 2864 (blockProgram 1344 2176)
    (by decide) (by rfl) (by rfl) (by decide)
...
def block6 : Block Artifact.submissionArtifact .Osaka 2900 (blockProgram 1312 2144) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2157 30 2900 (blockProgram 1312 2144)
    (by decide) (by rfl) (by rfl) (by decide)
...
def block7 : Block Artifact.submissionArtifact .Osaka 2936 (blockProgram 1280 2112) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2187 30 2936 (blockProgram 1280 2112)
    (by decide) (by rfl) (by rfl) (by decide)
...
def exitBlock : Block Artifact.submissionArtifact .Osaka 2972 exitProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2217 3 2972 exitProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
theorem jumpDest2827 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 2827 = true :=
  Artifact.isValidJumpDest_index 2096 (by rfl)
