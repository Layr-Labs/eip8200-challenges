...
def block0 : Block Artifact.submissionArtifact .Osaka 2869 (headZeroProgram 1504 2336) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2307 31 2869 (headZeroProgram 1504 2336)
    (by decide) (by rfl) (by rfl) (by decide)

/-- Block 1: instructions 2008..2037, pc 2719..2754,
`-N` limb at 1472 (0x5c0), `t` limb at 2304 (0x900). -/
def block1 : Block Artifact.submissionArtifact .Osaka 2906 (blockProgram 1472 2304) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2338 30 2906 (blockProgram 1472 2304)
    (by decide) (by rfl) (by rfl) (by decide)

/-- Block 2: instructions 2038..2067, pc 2755..2790,
`-N` limb at 1440 (0x5a0), `t` limb at 2272 (0x8e0). -/
def block2 : Block Artifact.submissionArtifact .Osaka 2942 (blockProgram 1440 2272) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2368 30 2942 (blockProgram 1440 2272)
    (by decide) (by rfl) (by rfl) (by decide)

/-- Block 3: instructions 2068..2097, pc 2791..2826,
`-N` limb at 1408 (0x580), `t` limb at 2240 (0x8c0). -/
def block3 : Block Artifact.submissionArtifact .Osaka 2978 (blockProgram 1408 2240) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2398 30 2978 (blockProgram 1408 2240)
    (by decide) (by rfl) (by rfl) (by decide)

/-- Block 4: instructions 2098..2128, pc 2827..2863,
`-N` limb at 1376 (0x560), `t` limb at 2208 (0x8a0). -/
def block4 : Block Artifact.submissionArtifact .Osaka 3014 (headProgram 1376 2208) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2428 31 3014 (headProgram 1376 2208)
    (by decide) (by rfl) (by rfl) (by decide)

/-- Block 5: instructions 2129..2158, pc 2864..2899,
`-N` limb at 1344 (0x540), `t` limb at 2176 (0x880). -/
def block5 : Block Artifact.submissionArtifact .Osaka 3051 (blockProgram 1344 2176) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2459 30 3051 (blockProgram 1344 2176)
    (by decide) (by rfl) (by rfl) (by decide)

/-- Block 6: instructions 2159..2188, pc 2900..2935,
`-N` limb at 1312 (0x520), `t` limb at 2144 (0x860). -/
def block6 : Block Artifact.submissionArtifact .Osaka 3087 (blockProgram 1312 2144) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2489 30 3087 (blockProgram 1312 2144)
    (by decide) (by rfl) (by rfl) (by decide)

/-- Block 7: instructions 2189..2218, pc 2936..2971,
`-N` limb at 1280 (0x500), `t` limb at 2112 (0x840). -/
def block7 : Block Artifact.submissionArtifact .Osaka 3123 (blockProgram 1280 2112) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2519 30 3123 (blockProgram 1280 2112)
    (by decide) (by rfl) (by rfl) (by decide)

/-- The exit `SWAP1 SWAP2 POP`: instructions 2219..2221, pc 2972..2974; falls into pc 2975. -/
def exitBlock : Block Artifact.submissionArtifact .Osaka 3159 exitProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2549 3 3159 exitProgram
    (by decide) (by rfl) (by rfl) (by decide)

/-- E6, the section entry: instructions 1970..1976, pc 2673..2681 (old pc 2936..2950). -/
def entryBlock : Block Artifact.submissionArtifact .Osaka 2860 entryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2300 7 2860 entryProgram
    (by decide) (by rfl) (by rfl) (by decide)

/-- The eight-limb entry (block 0's `JUMPDEST`, instruction 1977). -/
theorem jumpDest2682 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 2869 = true :=
  Artifact.isValidJumpDest_index 2307 (by rfl)

/-- The four-limb entry (block 4's `JUMPDEST`, instruction 2098, = 2682 + 0x91). -/
theorem jumpDest2827 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3014 = true :=
