...
import Challenge.Modexp.Submission.Proofs.Fast.GuardEip2Trace1
...
def gasSteps_match (input : ByteArray) (h : guardDiff input = 0) :
  ...
  (((sound preludePath rfl (GuardEip2Trace0.run_prelude input) rfl rfl deployAddress_not_precompile).trans
    ...
    (sound check1Path rfl (GuardEip2Trace1.run_check1 input) rfl rfl deployAddress_not_precompile)).trans
