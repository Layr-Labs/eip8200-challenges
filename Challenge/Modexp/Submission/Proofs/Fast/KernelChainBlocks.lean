...
def l1Block1 : Block Artifact.submissionArtifact .Osaka 3380 (stepProgram 192 2304) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2506 31 3380 (stepProgram 192 2304)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block2 : Block Artifact.submissionArtifact .Osaka 3417 (stepProgram 160 2272) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2537 31 3417 (stepProgram 160 2272)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block3 : Block Artifact.submissionArtifact .Osaka 3454 (stepProgram 128 2240) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2568 31 3454 (stepProgram 128 2240)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block4 : Block Artifact.submissionArtifact .Osaka 3491 (stepProgram 96 2208) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2599 31 3491 (stepProgram 96 2208)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block5 : Block Artifact.submissionArtifact .Osaka 3528 (stepProgram 64 2176) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2630 31 3528 (stepProgram 64 2176)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block6 : Block Artifact.submissionArtifact .Osaka 3565 (stepProgram 32 2144) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2661 31 3565 (stepProgram 32 2144)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block7 : Block Artifact.submissionArtifact .Osaka 3602 (stepProgram 0 2112) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2692 31 3602 (stepProgram 0 2112)
    (by decide) (by rfl) (by rfl) (by decide)
