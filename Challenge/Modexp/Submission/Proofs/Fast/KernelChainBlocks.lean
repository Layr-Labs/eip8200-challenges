...
def l1Block1 : Block Artifact.submissionArtifact .Osaka 4068 (stepProgram 192 8448) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3071 32 4068 (stepProgram 192 8448)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block2 : Block Artifact.submissionArtifact .Osaka 4106 (stepProgram 160 8416) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3103 32 4106 (stepProgram 160 8416)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block3 : Block Artifact.submissionArtifact .Osaka 4144 (stepProgram 128 8384) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3135 32 4144 (stepProgram 128 8384)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block4 : Block Artifact.submissionArtifact .Osaka 4182 (stepProgram 96 8352) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3167 32 4182 (stepProgram 96 8352)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block5 : Block Artifact.submissionArtifact .Osaka 4220 (stepProgram 64 8320) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3199 32 4220 (stepProgram 64 8320)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block6 : Block Artifact.submissionArtifact .Osaka 4258 (stepProgram 32 8288) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3231 32 4258 (stepProgram 32 8288)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block7 : Block Artifact.submissionArtifact .Osaka 4296 (stepProgram 0 8256) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3263 32 4296 (stepProgram 0 8256)
    (by decide) (by rfl) (by rfl) (by decide)
