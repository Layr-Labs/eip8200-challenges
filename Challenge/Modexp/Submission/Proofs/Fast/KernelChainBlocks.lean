...
def l1Block1 : Block Artifact.submissionArtifact .Osaka 4060 (stepProgram 192 4352) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3063 31 4060 (stepProgram 192 4352)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block2 : Block Artifact.submissionArtifact .Osaka 4098 (stepProgram 160 4320) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3094 31 4098 (stepProgram 160 4320)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block3 : Block Artifact.submissionArtifact .Osaka 4136 (stepProgram 128 4288) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3125 31 4136 (stepProgram 128 4288)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block4 : Block Artifact.submissionArtifact .Osaka 4174 (stepProgram 96 4256) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3156 31 4174 (stepProgram 96 4256)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block5 : Block Artifact.submissionArtifact .Osaka 4212 (stepProgram 64 4224) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3187 31 4212 (stepProgram 64 4224)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block6 : Block Artifact.submissionArtifact .Osaka 4250 (stepProgram 32 4192) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3218 31 4250 (stepProgram 32 4192)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Block7 : Block Artifact.submissionArtifact .Osaka 4288 (stepProgram 0 4160) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3249 31 4288 (stepProgram 0 4160)
    (by decide) (by rfl) (by rfl) (by decide)
