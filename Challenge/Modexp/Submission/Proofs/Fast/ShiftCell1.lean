...
@[simp] private theorem compactLoopPC2758 : Artifact.submissionArtifact.instructionPC 2807 = 3761 := by rfl
@[simp] private theorem compactLoopPC2759 : Artifact.submissionArtifact.instructionPC 2808 = 3764 := by rfl
@[simp] private theorem compactLoopPC2760 : Artifact.submissionArtifact.instructionPC 2808 = 3764 := by rfl
@[simp] private theorem compactLoopPC2761 : Artifact.submissionArtifact.instructionPC 2808 = 3764 := by rfl
@[simp] private theorem compactLoopPC2762 : Artifact.submissionArtifact.instructionPC 2809 = 3765 := by rfl
@[simp] private theorem compactLoopPC2763 : Artifact.submissionArtifact.instructionPC 2810 = 3766 := by rfl
@[simp] private theorem compactLoopPC2764 : Artifact.submissionArtifact.instructionPC 2811 = 3767 := by rfl
@[simp] private theorem compactLoopPC2765 : Artifact.submissionArtifact.instructionPC 2812 = 3768 := by rfl
@[simp] private theorem compactLoopPC2766 : Artifact.submissionArtifact.instructionPC 2813 = 3769 := by rfl
@[simp] private theorem compactLoopPC2767 : Artifact.submissionArtifact.instructionPC 2814 = 3770 := by rfl
@[simp] private theorem compactLoopPC2768 : Artifact.submissionArtifact.instructionPC 2815 = 3771 := by rfl
@[simp] private theorem compactLoopPC2769 : Artifact.submissionArtifact.instructionPC 2816 = 3772 := by rfl
@[simp] private theorem compactLoopPC2770 : Artifact.submissionArtifact.instructionPC 2817 = 3773 := by rfl
@[simp] private theorem compactLoopPC2771 : Artifact.submissionArtifact.instructionPC 2818 = 3774 := by rfl
@[simp] private theorem compactLoopPC2772 : Artifact.submissionArtifact.instructionPC 2819 = 3775 := by rfl
@[simp] private theorem compactLoopPC2773 : Artifact.submissionArtifact.instructionPC 2820 = 3776 := by rfl
@[simp] private theorem compactLoopPC2774 : Artifact.submissionArtifact.instructionPC 2821 = 3777 := by rfl
@[simp] private theorem compactLoopPC2775 : Artifact.submissionArtifact.instructionPC 2822 = 3778 := by rfl
@[simp] private theorem compactLoopPC2776 : Artifact.submissionArtifact.instructionPC 2823 = 3779 := by rfl
@[simp] private theorem compactLoopPC2777 : Artifact.submissionArtifact.instructionPC 2824 = 3780 := by rfl
@[simp] private theorem compactLoopPC2778 : Artifact.submissionArtifact.instructionPC 2825 = 3781 := by rfl
@[simp] private theorem compactLoopPC2779 : Artifact.submissionArtifact.instructionPC 2826 = 3782 := by rfl
@[simp] private theorem compactLoopPC2780 : Artifact.submissionArtifact.instructionPC 2827 = 3783 := by rfl
@[simp] private theorem compactLoopPC2781 : Artifact.submissionArtifact.instructionPC 2828 = 3784 := by rfl
@[simp] private theorem compactLoopPC2782 : Artifact.submissionArtifact.instructionPC 2829 = 3785 := by rfl
@[simp] private theorem compactLoopPC2783 : Artifact.submissionArtifact.instructionPC 2830 = 3786 := by rfl
@[simp] private theorem compactLoopPC2784 : Artifact.submissionArtifact.instructionPC 2831 = 3787 := by rfl
@[simp] private theorem compactLoopPC2785 : Artifact.submissionArtifact.instructionPC 2832 = 3788 := by rfl
@[simp] private theorem compactLoopPC2786 : Artifact.submissionArtifact.instructionPC 2833 = 3789 := by rfl
@[simp] private theorem compactLoopPC2787 : Artifact.submissionArtifact.instructionPC 2834 = 3790 := by rfl
@[simp] private theorem compactLoopPC2788 : Artifact.submissionArtifact.instructionPC 2835 = 3791 := by rfl
@[simp] private theorem compactLoopPC2789 : Artifact.submissionArtifact.instructionPC 2836 = 3792 := by rfl
@[simp] private theorem compactLoopPC2790 : Artifact.submissionArtifact.instructionPC 2837 = 3793 := by rfl
@[simp] private theorem compactLoopPC2791 : Artifact.submissionArtifact.instructionPC 2838 = 3794 := by rfl
@[simp] private theorem compactLoopPC2792 : Artifact.submissionArtifact.instructionPC 2839 = 3795 := by rfl
@[simp] private theorem compactLoopPC2793 : Artifact.submissionArtifact.instructionPC 2840 = 3796 := by rfl
@[simp] private theorem compactLoopPC2794 : Artifact.submissionArtifact.instructionPC 2841 = 3797 := by rfl
@[simp] private theorem compactLoopPC2795 : Artifact.submissionArtifact.instructionPC 2842 = 3798 := by rfl
...
def cellPath :
  ...
  [opAt 2806 .JUMPDEST,
   ...
   opAt 2812 (.Dup ⟨6, by decide⟩),
   opAt 2813 (.Dup ⟨2, by decide⟩),
   opAt 2814 .MUL,
   opAt 2815 (.Swap ⟨1, by decide⟩),
   opAt 2816 (.Dup ⟨7, by decide⟩),
   opAt 2817 .MULMOD,
   opAt 2818 (.Dup ⟨1, by decide⟩),
   opAt 2819 (.Dup ⟨1, by decide⟩),
   opAt 2820 .LT,
   opAt 2821 .SUB,
   opAt 2822 (.Dup ⟨5, by decide⟩),
   opAt 2823 (.Dup ⟨2, by decide⟩),
   opAt 2824 .ADD,
   opAt 2825 (.Dup ⟨0, by decide⟩),
   opAt 2826 (.Swap ⟨6, by decide⟩),
   opAt 2827 .GT,
   opAt 2828 .SUB,
   opAt 2829 .SUB,
   opAt 2830 (.Dup ⟨4, by decide⟩),
   opAt 2831 (.Dup ⟨2, by decide⟩),
   opAt 2832 .MLOAD,
   opAt 2833 .ADD,
   opAt 2834 (.Dup ⟨0, by decide⟩),
   opAt 2835 (.Swap ⟨5, by decide⟩),
   opAt 2836 .GT,
   opAt 2837 .ADD,
   opAt 2838 (.Swap ⟨3, by decide⟩),
   opAt 2839 (.Dup ⟨1, by decide⟩),
   opAt 2840 .MSTORE,
   opAt 2841 (.Dup ⟨2, by decide⟩),
   opAt 2842 .ADD]

@[simp] private theorem cellStartPC : Artifact.submissionArtifact.instructionPC 2806 = 3760 := by rfl
