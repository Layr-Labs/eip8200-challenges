...
/-- Loading the established limb-size word at 2784 does not expand memory
...
theorem copiedActiveWords_eq (template : State) (n : Nat)
    (hn32 : n ≤ 8) (hactive : 93 ≤ template.activeWords.toNat) :
...
theorem copiedMemory_esizeWord (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readWord (copiedMemory mem n) 2848 =
      MachineState.readWord mem 2848 :=
  copiedMemory_readWord_above mem n 2848 hn32 (by omega)

theorem copiedMemory_msizeWord (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readWord (copiedMemory mem n) 2880 =
      MachineState.readWord mem 2880 :=
  copiedMemory_readWord_above mem n 2880 hn32 (by omega)

theorem copiedMemory_exponentPtrWord (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readWord (copiedMemory mem n) 2912 =
      MachineState.readWord mem 2912 :=
  copiedMemory_readWord_above mem n 2912 hn32 (by omega)

theorem copiedMemory_exponentSizeWord (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readWord (copiedMemory mem n) 2944 =
      MachineState.readWord mem 2944 :=
  copiedMemory_readWord_above mem n 2944 hn32 (by omega)
...
theorem copiedMemory_modulusBlock (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
...
theorem copiedMemory_accumulatorBlock (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readPadded (copiedMemory mem n) 256 (32 * n) =
      MachineState.readPadded mem 256 (32 * n) :=
  copiedMemory_readPadded_before mem n 256 (32 * n) (by omega)

theorem copiedMemory_baseBlock (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readPadded (copiedMemory mem n) 512 (32 * n) =
      MachineState.readPadded mem 512 (32 * n) :=
  copiedMemory_readPadded_before mem n 512 (32 * n) (by omega)

theorem copiedMemory_oneBlock (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readPadded (copiedMemory mem n) 768 (32 * n) =
      MachineState.readPadded mem 768 (32 * n) :=
  copiedMemory_readPadded_before mem n 768 (32 * n) (by omega)

theorem copiedMemory_r1Block (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
...
theorem copiedMemory_ccBlock (mem : ByteArray) (n : Nat) (hn32 : n ≤ 8) :
    MachineState.readPadded (copiedMemory mem n) 1280 (32 * n) =
      MachineState.readPadded mem 1280 (32 * n) :=
  copiedMemory_readPadded_before mem n 1280 (32 * n) (by omega)
...
theorem fastRepresents_copied_before (mem : ByteArray)
    (n ptr count value : Nat) (hbefore : ptr + 32 * count ≤ 1536)
...
theorem fastRepresents_rr_of_cc (mem : ByteArray) (n value : Nat)
    (hn2 : 2 ≤ n) (hcc : Model.FastRepresents mem 1280 n value) :
    Model.FastRepresents (copiedMemory mem n) 1536 n value := by
  unfold copiedMemory
  exact Csub.fastRepresents_mcopy mem 1280 1536 n value (by omega) hcc

theorem fastRepresents_modulus_preserved (mem : ByteArray) (n value : Nat)
    (hn32 : n ≤ 8) (hrep : Model.FastRepresents mem 0 n value) :
...
theorem fastRepresents_accumulator_preserved (mem : ByteArray) (n value : Nat)
    (hn32 : n ≤ 8) (hrep : Model.FastRepresents mem 256 n value) :
    Model.FastRepresents (copiedMemory mem n) 256 n value :=
  fastRepresents_copied_before mem n 256 n value (by omega) hrep

theorem fastRepresents_base_preserved (mem : ByteArray) (n value : Nat)
    (hn32 : n ≤ 8) (hrep : Model.FastRepresents mem 512 n value) :
    Model.FastRepresents (copiedMemory mem n) 512 n value :=
  fastRepresents_copied_before mem n 512 n value (by omega) hrep

theorem fastRepresents_one_preserved (mem : ByteArray) (n value : Nat)
    (hn32 : n ≤ 8) (hrep : Model.FastRepresents mem 768 n value) :
    Model.FastRepresents (copiedMemory mem n) 768 n value :=
  fastRepresents_copied_before mem n 768 n value (by omega) hrep

theorem fastRepresents_r1_preserved (mem : ByteArray) (n value : Nat)
    (hn32 : n ≤ 8) (hrep : Model.FastRepresents mem 1024 n value) :
...
theorem fastRepresents_cc_preserved (mem : ByteArray) (n value : Nat)
    (hn32 : n ≤ 8) (hrep : Model.FastRepresents mem 1280 n value) :
    Model.FastRepresents (copiedMemory mem n) 1280 n value :=
  fastRepresents_copied_before mem n 1280 n value (by omega) hrep
...
structure RrCopyInv (mem : ByteArray) (n mm R : Nat) : Prop where
  ...
  rr : Model.FastRepresents mem 1536 n (Limbs.radix * R % mm)
