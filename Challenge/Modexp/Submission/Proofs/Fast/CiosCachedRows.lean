...
opaque gasSteps_l1Four (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  (gasSteps_l1Mac 4444 64 2176 l1Mac5 s mem bi pa pb 4 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4482 32 2144 l1Mac6 s mem bi pa pb 4 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
...
opaque gasSteps_l1Eight (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  (gasSteps_l1Mac 4291 192 2304 l1Mac1 s mem bi pa pb 8 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4329 160 2272 l1Mac2 s mem bi pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4367 128 2240 l1Mac3 s mem bi pa pb 8 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4405 96 2208 l1Mac4 s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Join s mem bi pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp).trans <|
  (gasSteps_l1Mac 4444 64 2176 l1Mac5 s mem bi pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4482 32 2144 l1Mac6 s mem bi pa pb 8 i 6 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
...
opaque gasSteps_l2Eight (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
  ...
  (gasSteps_l2Mac 4519 11 192 2304 2336 l2Mac0 s mid bi mu c0 pa pb 8 i 0 inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: pdst :: ret :: rest) hcap' hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
