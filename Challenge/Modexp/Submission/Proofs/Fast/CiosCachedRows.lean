...
opaque gasSteps_l1Four (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 4578 s mem bi pa pb 4 i 0 pdst ret rest)
  ...
  (gasSteps_l1Mac 4732 l1Mac4 s mem bi pa pb 4 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4769 l1Mac5 s mem bi pa pb 4 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4806 l1Mac6 s mem bi pa pb 4 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  gasSteps_l1Mac 4843 l1Mac7 s mem bi pa pb 4 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit
...
opaque gasSteps_l1Eight (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 4578 s mem bi pa pb 8 i 0 pdst ret rest)
  ...
  (gasSteps_l1Mac 4583 l1Mac0 s mem bi pa pb 8 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4620 l1Mac1 s mem bi pa pb 8 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4657 l1Mac2 s mem bi pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4694 l1Mac3 s mem bi pa pb 8 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Join s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp).trans <|
  (gasSteps_l1Mac 4732 l1Mac4 s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4769 l1Mac5 s mem bi pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4806 l1Mac6 s mem bi pa pb 8 i 6 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  gasSteps_l1Mac 4843 l1Mac7 s mem bi pa pb 8 i 7 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) hpa hpaFit
...
opaque gasSteps_l2Four (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4948 s mid bi mu c0 pa pb 4 i 0 pdst ret rest)
  ...
  (gasSteps_l2Mac 5114 l2Mac4 s mid bi mu c0 pa pb 4 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5154 l2Mac5 s mid bi mu c0 pa pb 4 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  gasSteps_l2Mac 5194 l2Mac6 s mid bi mu c0 pa pb 4 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)
...
opaque gasSteps_l2Eight (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4948 s mid bi mu c0 pa pb 8 i 0 pdst ret rest)
  ...
  (gasSteps_l2Mac 4953 l2Mac0 s mid bi mu c0 pa pb 8 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 4993 l2Mac1 s mid bi mu c0 pa pb 8 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5033 l2Mac2 s mid bi mu c0 pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5073 l2Mac3 s mid bi mu c0 pa pb 8 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  (gasSteps_l2Join s mid bi mu c0 pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp).trans <|
  (gasSteps_l2Mac 5114 l2Mac4 s mid bi mu c0 pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5154 l2Mac5 s mid bi mu c0 pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)).trans <|
  gasSteps_l2Mac 5194 l2Mac6 s mid bi mu c0 pa pb 8 i 6 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide)
