...
opaque gasSteps_l1Four (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 4547 s mem bi pa pb 4 i 0 pdst ret rest)
  ...
  (gasSteps_l1Mac 4700 96 8352 l1Mac4 s mem bi pa pb 4 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4738 64 8320 l1Mac5 s mem bi pa pb 4 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4776 32 8288 l1Mac6 s mem bi pa pb 4 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
...
opaque gasSteps_l1Eight (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 4547 s mem bi pa pb 8 i 0 pdst ret rest)
  ...
  (gasSteps_l1First 4550 224 8480 l1Mac0 s mem bi pa pb 8 i pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4585 192 8448 l1Mac1 s mem bi pa pb 8 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4623 160 8416 l1Mac2 s mem bi pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4661 128 8384 l1Mac3 s mem bi pa pb 8 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Join s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp).trans <|
  (gasSteps_l1Mac 4700 96 8352 l1Mac4 s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4738 64 8320 l1Mac5 s mem bi pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4776 32 8288 l1Mac6 s mem bi pa pb 8 i 6 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) hpa hpaFit).trans <|
...
opaque gasSteps_l2Four (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4889 s mid bi mu c0 pa pb 4 i 0 pdst ret rest)
  ...
  (gasSteps_l2Mac 5042 1 64 8320 8352 l2Mac4 s mid bi mu c0 pa pb 4 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5078 1 32 8288 8320 l2Mac5 s mid bi mu c0 pa pb 4 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
...
opaque gasSteps_l2Eight (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4889 s mid bi mu c0 pa pb 8 i 0 pdst ret rest)
  ...
  (gasSteps_l2Mac 4892 6 192 8448 8480 l2Mac0 s mid bi mu c0 pa pb 8 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 4933 1 160 8416 8448 l2Mac1 s mid bi mu c0 pa pb 8 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 4969 1 128 8384 8416 l2Mac2 s mid bi mu c0 pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5005 1 96 8352 8384 l2Mac3 s mid bi mu c0 pa pb 8 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Join s mid bi mu c0 pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp).trans <|
  (gasSteps_l2Mac 5042 1 64 8320 8352 l2Mac4 s mid bi mu c0 pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5078 1 32 8288 8320 l2Mac5 s mid bi mu c0 pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
...
opaque gasSteps_rowFourToTail (s : State) (mem : ByteArray) (pa pb i : Nat)
  ...
  refine (gasSteps_mid s (l1Step mem (rowBi mem pb 4 i) pa 4 4).memory
    ...
    (by decide) hml4 htl4 hminv4).trans ?_
...
opaque gasSteps_rowEightToTail (s : State) (mem : ByteArray) (pa pb i : Nat)
  ...
  refine (gasSteps_mid s (l1Step mem (rowBi mem pb 8 i) pa 8 8).memory
    ...
    (by decide) hml8 htl8 hminv8).trans ?_
  simpa only [rowL1, rowMid, rowL2] using
    gasSteps_l2Eight s
...
opaque gasSteps_rowFourNext (s : State) (mem : ByteArray) (pa pb i : Nat)
  ...
  (gasSteps_rowFourToTail s mem pa pb i pdst ret rest hcap hrun hcode hfork hnp
      hact (by omega) hpa hpaFit hpb hpbFit htl hml hminv).trans <|
