...
opaque gasSteps_l1Four (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 4600 s mem bi pa pb 4 i 0 pdst ret rest)
  ...
  (gasSteps_l1Mac 4758 8352 l1Mac4 s mem bi pa pb 4 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4796 8320 l1Mac5 s mem bi pa pb 4 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4834 8288 l1Mac6 s mem bi pa pb 4 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
...
opaque gasSteps_l1Eight (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 4600 s mem bi pa pb 8 i 0 pdst ret rest)
  ...
  (gasSteps_l1Mac 4605 8480 l1Mac0 s mem bi pa pb 8 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4643 8448 l1Mac1 s mem bi pa pb 8 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4681 8416 l1Mac2 s mem bi pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4719 8384 l1Mac3 s mem bi pa pb 8 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Join s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp).trans <|
  (gasSteps_l1Mac 4758 8352 l1Mac4 s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4796 8320 l1Mac5 s mem bi pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Mac 4834 8288 l1Mac6 s mem bi pa pb 8 i 6 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) hpa hpaFit).trans <|
...
opaque gasSteps_l2Four (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4955 s mid bi mu c0 pa pb 4 i 0 pdst ret rest)
  ...
  (gasSteps_l2Mac 5113 64 8320 8352 l2Mac4 s mid bi mu c0 pa pb 4 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5151 32 8288 8320 l2Mac5 s mid bi mu c0 pa pb 4 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
...
opaque gasSteps_l2Eight (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4955 s mid bi mu c0 pa pb 8 i 0 pdst ret rest)
  ...
  (gasSteps_l2Mac 4960 192 8448 8480 l2Mac0 s mid bi mu c0 pa pb 8 i 0 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 4998 160 8416 8448 l2Mac1 s mid bi mu c0 pa pb 8 i 1 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5036 128 8384 8416 l2Mac2 s mid bi mu c0 pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5074 96 8352 8384 l2Mac3 s mid bi mu c0 pa pb 8 i 3 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Join s mid bi mu c0 pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp).trans <|
  (gasSteps_l2Mac 5113 64 8320 8352 l2Mac4 s mid bi mu c0 pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
  (gasSteps_l2Mac 5151 32 8288 8320 l2Mac5 s mid bi mu c0 pa pb 8 i 5 pdst ret rest hcap hrun hcode hfork hnp hact (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
...
opaque gasSteps_rowFourNext (s : State) (mem : ByteArray) (pa pb i : Nat)
  ...
  (gasSteps_rowFourToTail s mem pa pb i pdst ret rest hcap hrun hcode hfork hnp
      hact (by omega) hpa hpaFit hpb hpbFit htl hml).trans <|
