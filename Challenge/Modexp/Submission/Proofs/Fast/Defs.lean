...
@[simp] theorem fastPC24 (i : Nat) (hi : 1831 ≤ i) (hii : i ≤ 1845) :
    Artifact.submissionArtifact.instructionPC i =
      [3000,3001,3002,3003,3006,3007,3010,3011,3014,3017,3018,3021,3022,3023,3026][i - 1831]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC25 (i : Nat) (hi : 2081 ≤ i) (hii : i ≤ 2115) :
    Artifact.submissionArtifact.instructionPC i =
      [3288,3289,3290,3292,3293,3295,3296,3297,3298,3299,3300,3302,3303,3304,3307,3308,3311,3312,3313,3316,3319,3322,3325,3328,3329,3330,3333,3336,3339,3342,3345,3346,3347,3348,3351][i - 2081]! := by
  interval_cases i <;> decide
