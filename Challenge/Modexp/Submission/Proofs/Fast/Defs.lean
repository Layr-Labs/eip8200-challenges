...
private theorem fastPCAnchor18 :
    Artifact.submissionArtifact.instructionPC 1690 = 2406 := by
  calc
...
@[simp] theorem fastPC17 (i : Nat) (hi : 1650 ≤ i) (hii : i ≤ 1689) :
    Artifact.submissionArtifact.instructionPC i =
      [2288,2291,2292,2293,2296,2297,2298,2299,2300,2303,2304,2305,2314,2315,2316,2317,2318,2319,2320,2353,2354,2355,2356,2357,2358,2359,2360,2361,2362,2363,2364,2365,2366,2367,2368,2369,2370,2371,2372,2405][i - 1650]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC18 (i : Nat) (hi : 1690 ≤ i) (hii : i ≤ 1730) :
    Artifact.submissionArtifact.instructionPC i =
      [2406,2407,2408,2441,2442,2445,2446,2447,2450,2451,2452,2453,2456,2457,2458,2461,2462,2463,2466,2467,2470,2471,2472,2473,2474,2475,2476,2477,2478,2479,2480,2481,2482,2483,2484,2485,2486,2487,2488,2489,2490][i - 1690]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
theorem jumpDest2666 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 2317 = true :=
