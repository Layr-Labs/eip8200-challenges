...
@[simp] theorem fusedCsubPC0 (i : Nat) (hi : 3084 ≤ i) (hii : i ≤ 3096) :
    Artifact.submissionArtifact.instructionPC i =
      [5267,5268,5271,5272,5273,5274,5277,5278,5279,5280,5281,5282,5285][i - 3084]! := by
  interval_cases i <;> decide

/-- PC table for the fused limb loop. -/
@[simp] theorem fusedCsubPC1 (i : Nat) (hi : 3097 ≤ i) (hii : i ≤ 3151) :
    Artifact.submissionArtifact.instructionPC i =
      [5286,5287,5288,5289,5290,5291,5292,5293,5294,5295,5296,5297,5298,5299,5300,5301,5302,5303,5304,5305,5306,5307,5308,5309,5312,5313,5314,5315,5316,5317,5318,5319,5320,5321,5322,5323,5324,5325,5326,5327,5328,5329,5332,5333,5334,5335,5336,5337,5339,5340,5341,5344,5345,5346,5349][i - 3097]! := by
  interval_cases i <;> decide

/-- PC table for the fused selection/return tail. -/
@[simp] theorem fusedCsubPC2 (i : Nat) (hi : 3152 ≤ i) (hii : i ≤ 3174) :
    Artifact.submissionArtifact.instructionPC i =
      [5350,5351,5354,5355,5356,5357,5358,5359,5362,5363,5366,5367,5370,5371,5372,5373,5374,5375,5376,5377,5378,5379,5380][i - 3152]! := by
  interval_cases i <;> decide
...
theorem jumpDest5267 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5267 = true :=
  Artifact.isValidJumpDest_index 3084 (by rfl)

theorem jumpDest5286 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5286 = true :=
