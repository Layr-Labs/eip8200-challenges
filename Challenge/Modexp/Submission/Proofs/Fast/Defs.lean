...
@[simp] theorem fullBasePC (i : Nat)
    (hi : 2447 ≤ i) (hii : i ≤ 2498) :
    Artifact.submissionArtifact.instructionPC i =
      [3345,3346,3347,3348,3349,3350,3351,3353,3354,3355,3356,3359,3360,3361,3363,3366,3367,3370,3373,3376,3379,3382,3383,3386,3389,3392,3395,3398,3399,3400,3401,3403,3404,3406,3407,3408,3409,3411,3412,3413,3415,3416,3418,3419,3420,3421,3422,3425,3426,3427,3429,3432][i - 2447]! := by
...
theorem jumpDest3571 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3310 = true :=
...
theorem jumpDest3661 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3399 = true :=
