...
@[simp] theorem fastPC10 (i : Nat) (hi : 1377 ≤ i) (hii : i ≤ 1416) :
    Artifact.submissionArtifact.instructionPC i =
      [1937,1938,1939,1940,1943,1944,1945,1947,1948,1949,1952,1953,1954,1955,1956,1958,1959,1960,1962,1963,1964,1965,1966,1967,1968,1970,1971,1972,1973,1974,1975,1980,1981,1982,1983,1984,1985,1986,1989,1990][i - 1377]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC12 (i : Nat) (hi : 1457 ≤ i) (hii : i ≤ 1496) :
    Artifact.submissionArtifact.instructionPC i =
      [2128,2130,2131,2132,2133,2134,2135,2136,2137,2138,2139,2140,2141,2142,2143,2144,2147,2148,2149,2150,2153,2154,2155,2158,2159,2160,2161,2162,2167,2168,2169,2170,2173,2174,2175,2176,2177,2178,2179,2212][i - 1457]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC13 (i : Nat) (hi : 1497 ≤ i) (hii : i ≤ 1536) :
    Artifact.submissionArtifact.instructionPC i =
      [2213,2214,2215,2216,2217,2218,2219,2220,2221,2222,2223,2224,2225,2226,2227,2231,2232,2233,2236,2237,2239,2240,2241,2242,2243,2244,2245,2246,2247,2248,2249,2282,2283,2284,2285,2286,2287,2288,2289,2290][i - 1497]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
their proof modules. -/
@[simp] theorem fullBasePC (i : Nat) (hi : 2361 ≤ i) (hii : i ≤ 2413) :
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fusedCsubPC0 (i : Nat) (hi : 2862 ≤ i) (hii : i ≤ 2877) :
    Artifact.submissionArtifact.instructionPC i =
      [4643,4644,4647,4648,4649,4652,4653,4654,4655,4656,4657,4658,4659,
       4660,4661,4664][i - 2862]! := by
  interval_cases i <;> decide

/-- PC table for the fused limb loop. -/
@[simp] theorem fusedCsubPC1 (i : Nat) (hi : 2878 ≤ i) (hii : i ≤ 2932) :
    Artifact.submissionArtifact.instructionPC i =
      [4665,4666,4667,4668,4669,4670,4671,4672,4673,4674,4675,4676,4677,
       4678,4679,4680,4681,4682,4683,4684,4685,4686,4687,4688,4691,4692,
       4693,4694,4695,4696,4697,4698,4699,4700,4701,4702,4703,4704,4705,
       4706,4707,4708,4711,4712,4713,4714,4715,4716,4718,4719,4720,4723,
       4724,4725,4728][i - 2878]! := by
  interval_cases i <;> decide

/-- PC table for the fused selection/return tail. -/
@[simp] theorem fusedCsubPC2 (i : Nat) (hi : 2933 ≤ i) (hii : i ≤ 2955) :
    Artifact.submissionArtifact.instructionPC i =
      [4729,4730,4733,4734,4735,4736,4737,4738,4741,4742,4745,4746,4749,
       4750,4751,4752,4753,4754,4755,4756,4757,4758,4759][i - 2933]! := by
  interval_cases i <;> decide
