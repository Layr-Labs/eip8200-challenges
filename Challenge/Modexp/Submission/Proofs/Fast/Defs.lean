...
@[simp] theorem fastPC2 (i : Nat) (hi : 1057 ≤ i) (hii : i ≤ 1092) :
    Artifact.submissionArtifact.instructionPC i =
      [1428,1429,1432,1433,1436,1437,1438,1439,1440,1441,1442,1443,1444,
       1445,1446,1447,1448,1449,1450,1451,1452,1454,1455,1456,
       1457,1458,1460,1461,1462,1463,1464,1465,1467,1468,1469,1470][i - 1057]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC3 (i : Nat) (hi : 1093 ≤ i) (hii : i ≤ 1132) :
    Artifact.submissionArtifact.instructionPC i =
      [1471,1472,1474,1475,1476,1477,1478,1479,1481,1482,1483,1484,1485,
       1486,1488,1489,1490,1491,1492,1493,1495,1496,1497,1498,
       1499,1500,1502,1503,1504,1505,1506,1509,1510,1511,1512,
       1514,1517,1518,1521,1524][i - 1093]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC4 (i : Nat) (hi : 1133 ≤ i) (hii : i ≤ 1172) :
    Artifact.submissionArtifact.instructionPC i =
      [1527,1528,1529,1532,1533,1536,1539,1540,1543,1546,1549,1550,1551,
       1554,1555,1558,1561,1562,1564,1565,1568,1571,1574,1577,
       1580,1581,1582,1583,1584,1585,1587,1588,1591,1592,1595,
       1596,1599,1600,1601,1603][i - 1133]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC5 (i : Nat) (hi : 1173 ≤ i) (hii : i ≤ 1212) :
    Artifact.submissionArtifact.instructionPC i =
      [1605,1607,1608,1609,1610,1611,1614,1615,1616,1617,1618,1621,1622,
       1623,1624,1625,1626,1629,1630,1633,1634,1636,1638,1640,
       1642,1644,1646,1647,1648,1649,1650,1651,1652,1653,1654,
       1655,1656,1657,1658,1659][i - 1173]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC6 (i : Nat) (hi : 1213 ≤ i) (hii : i ≤ 1252) :
    Artifact.submissionArtifact.instructionPC i =
      [1660,1661,1662,1663,1664,1667,1668,1671,1674,1677,1680,1683,1684,
       1685,1686,1687,1688,1690,1691,1692,1693,1695,1696,1697,
       1698,1701,1702,1703,1706,1709,1712,1715,1718,1719,1720,
       1722,1723,1726,1727,1728][i - 1213]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC7 (i : Nat) (hi : 1253 ≤ i) (hii : i ≤ 1292) :
    Artifact.submissionArtifact.instructionPC i =
      [1729,1730,1733,1736,1739,1742,1745,1746,1747,1748,1751,1752,1754,
       1756,1758,1760,1761,1762,1763,1764,1765,1768,1769,1772,
       1773,1774,1775,1776,1777,1778,1780,1781,1784,1787,1790,
       1793,1796,1797,1798,1799][i - 1253]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC8 (i : Nat) (hi : 1293 ≤ i) (hii : i ≤ 1332) :
    Artifact.submissionArtifact.instructionPC i =
      [1800,1801,1802,1805,1806,1809,1812,1815,1818,1821,1822,1823,1824,
       1826,1827,1828,1831,1832,1833,1834,1836,1837,1840,1841,
       1842,1843,1845,1846,1849,1850,1851,1854,1857,1860,1863,
       1866,1867,1868,1869,1870][i - 1293]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC9 (i : Nat) (hi : 1333 ≤ i) (hii : i ≤ 1372) :
    Artifact.submissionArtifact.instructionPC i =
      [1871,1874,1875,1876,1877,1878,1879,1882,1883,1884,1885,1886,1887,
       1890,1891,1892,1893,1894,1895,1896,1897,1898,1901,1902,
       1903,1906,1907,1910,1911,1912,1913,1916,1917,1918,1920,
       1921,1922,1923,1926,1927][i - 1333]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC10 (i : Nat) (hi : 1373 ≤ i) (hii : i ≤ 1411) :
    Artifact.submissionArtifact.instructionPC i =
      [1928,1929,1930,1931,1934,1935,1936,1938,1939,1940,1943,1944,1945,
       1946,1947,1949,1950,1951,1953,1954,1955,1956,1957,1958,
       1959,1961,1962,1963,1964,1965,1966,1967,1968,1969,1972,
       1973,1974,1977,1978][i - 1373]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC12 (i : Nat) (hi : 1449 ≤ i) (hii : i ≤ 1491) :
    Artifact.submissionArtifact.instructionPC i =
      [2016,2017,2019,2020,2021,2022,2024,2025,2026,2027,2028,2029,2030,
       2033,2034,2035,2036,2037,2040,2041,2042,2043,2046,2047,
       2048,2051,2052,2055,2056,2057,2060,2061,2062,2063,2066,
       2067,2068,2069,2070,2071,2072,2073,2074][i - 1449]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC13 (i : Nat) (hi : 1492 ≤ i) (hii : i ≤ 1532) :
    Artifact.submissionArtifact.instructionPC i =
      [2075,2076,2077,2078,2079,2080,2081,2082,2083,2084,2085,2086,2087,
       2090,2091,2093,2094,2095,2098,2099,2101,2102,2103,2104,
       2105,2106,2107,2108,2109,2110,2111,2112,2113,2114,2115,
       2116,2117,2118,2119,2120,2121][i - 1492]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC14 (i : Nat) (hi : 1533 ≤ i) (hii : i ≤ 1569) :
    Artifact.submissionArtifact.instructionPC i =
      [2122,2123,2124,2125,2126,2127,2128,2129,2130,2131,2132,2133,2134,
       2135,2137,2138,2140,2141,2142,2143,2144,2145,2147,2148,
       2149,2152,2153,2154,2157,2158,2159,2160,2161,2162,2163,
       2164,2165][i - 1533]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC15 (i : Nat) (hi : 1570 ≤ i) (hii : i ≤ 1610) :
    Artifact.submissionArtifact.instructionPC i =
      [2168,2169,2170,2171,2174,2175,2176,2179,2180,2181,2184,2185,2187,
       2188,2189,2190,2191,2192,2195,2196,2197,2198,2199,2202,
       2203,2204,2207,2208,2209,2210,2211,2213,2214,2215,2216,
       2217,2218,2220,2221,2222,2223][i - 1570]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC16 (i : Nat) (hi : 1611 ≤ i) (hii : i ≤ 1653) :
    Artifact.submissionArtifact.instructionPC i =
      [2224,2225,2226,2227,2230,2231,2232,2233,2234,2235,2236,2237,2238,
       2239,2240,2241,2242,2243,2244,2245,2246,2247,2248,2249,
       2250,2251,2252,2253,2254,2255,2256,2258,2259,2260,2261,
       2263,2264,2265,2266,2267,2269,2270,2271][i - 1611]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC17 (i : Nat) (hi : 1654 ≤ i) (hii : i ≤ 1691) :
    Artifact.submissionArtifact.instructionPC i =
      [2272,2275,2276,2277,2280,2281,2282,2283,2284,2287,2288,2289,2292,
       2293,2296,2297,2298,2301,2302,2305,2306,2307,2308,2309,
       2310,2311,2312,2313,2314,2315,2316,2317,2318,2319,2320,
       2321,2322,2323][i - 1654]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC18 (i : Nat) (hi : 1692 ≤ i) (hii : i ≤ 1731) :
    Artifact.submissionArtifact.instructionPC i =
      [2324,2325,2326,2327,2328,2329,2330,2331,2332,2333,2334,2335,2368,
       2369,2370,2403,2404,2405,2406,2439,2440,2441,2444,2445,
       2446,2449,2450,2451,2452,2453,2454,2457,2458,2459,2462,
       2463,2464,2467,2468,2471][i - 1692]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC20 (i : Nat) (hi : 1737 ≤ i) (hii : i ≤ 1762) :
    Artifact.submissionArtifact.instructionPC i =
      [2477,2478,2481,2482,2483,2484,2487,2488,2489,2491,2492,2495,2496,
       2497,2498,2501,2502,2503,2504,2505,2506,2507,2510,2511,
       2512,2513][i - 1737]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC22 (i : Nat) (hi : 1776 ≤ i) (hii : i ≤ 1810) :
    Artifact.submissionArtifact.instructionPC i =
      [2535,2536,2537,2540,2541,2542,2543,2544,2545,2546,2547,2550,2551,
       2553,2556,2557,2558,2559,2560,2562,2563,2564,2565,2567,
       2568,2569,2570,2572,2573,2574,2576,2577,2579,2580,2583][i - 1776]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC23 (i : Nat) (hi : 1811 ≤ i) (hii : i ≤ 1825) :
    Artifact.submissionArtifact.instructionPC i =
      [2584,2585,2586,2589,2590,2593,2594,2597,2600,2601,2604,2607,2608,
       2609,2612][i - 1811]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fullBasePC (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      ([3329,3330,3331,3332,3333,3334,3335,3337,3338,3339,3340,3343,3344,
       3345,3347,3350,3351,3354,3357,3360,3363,3366,3367,3368,
       3371,3374,3377,3380,3383,3384,3385,3386,3388,3389,3391,
       3392,3393,3394,3396,3397,3398,3400,3401,3403,3404,3405,
       3406,3407,3410,3411,3412,3414,3417] : List Nat)[i - 2458]! := by
