...
The appended Montgomery path and certified suffix occupy instruction indices
977..1882 (pc 1314..3085).  This module fixes the `Located` constructors, the
...
@[simp] theorem fastPC9 (i : Nat) (hi : 1337 ≤ i) (hii : i ≤ 1376) :
    Artifact.submissionArtifact.instructionPC i =
      [1880,1883,1884,1885,1886,1887,1888,1891,1892,1893,1894,1895,1896,1899,1900,1901,1902,1903,1904,1905,1906,1907,1910,1911,1912,1915,1916,1919,1920,1921,1922,1925,1926,1927,1928,1929,1930,1931,1934,1935][i - 1337]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC10 (i : Nat) (hi : 1377 ≤ i) (hii : i ≤ 1416) :
    Artifact.submissionArtifact.instructionPC i =
      [1936,1937,1938,1939,1940,1943,1944,1945,1947,1948,1949,1952,1953,1954,1955,1956,1958,1959,1960,1962,1963,1964,1965,1966,1967,1968,1970,1971,1972,1973,1974,1975,1976,1977,1978,1981,1982,1983,1985,1986][i - 1377]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC11 (i : Nat) (hi : 1417 ≤ i) (hii : i ≤ 1456) :
    Artifact.submissionArtifact.instructionPC i =
      [1989,1990,1991,1993,1994,1995,1996,1997,1998,1999,2000,2001,2002,2003,2036,2037,2038,2039,2040,2041,2042,2043,2044,2045,2046,2047,2048,2049,2050,2051,2052,2053,2054,2055,2056,2057,2058,2059,2060,2061][i - 1417]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC12 (i : Nat) (hi : 1457 ≤ i) (hii : i ≤ 1496) :
    Artifact.submissionArtifact.instructionPC i =
      [2062,2063,2064,2097,2098,2099,2132,2133,2134,2135,2136,2137,2140,2141,2142,2143,2144,2147,2148,2149,2150,2153,2154,2155,2158,2159,2162,2163,2164,2167,2168,2169,2170,2173,2174,2175,2176,2177,2178,2179][i - 1457]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC13 (i : Nat) (hi : 1497 ≤ i) (hii : i ≤ 1536) :
    Artifact.submissionArtifact.instructionPC i =
      [2212,2213,2214,2215,2216,2217,2218,2219,2220,2221,2222,2223,2224,2225,2228,2229,2231,2232,2233,2236,2237,2239,2240,2241,2242,2243,2244,2245,2246,2247,2248,2249,2282,2283,2284,2285,2286,2287,2288,2289][i - 1497]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC14 (i : Nat) (hi : 1537 ≤ i) (hii : i ≤ 1576) :
    Artifact.submissionArtifact.instructionPC i =
      [2290,2291,2292,2293,2294,2295,2296,2297,2298,2299,2300,2301,2302,2303,2304,2305,2306,2307,2308,2309,2311,2312,2313,2346,2347,2348,2381,2382,2383,2386,2387,2388,2391,2392,2393,2394,2395,2396,2397,2398][i - 1537]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC15 (i : Nat) (hi : 1577 ≤ i) (hii : i ≤ 1616) :
    Artifact.submissionArtifact.instructionPC i =
      [2399,2402,2403,2404,2405,2408,2409,2410,2413,2414,2415,2418,2419,2452,2453,2454,2455,2456,2459,2460,2461,2462,2463,2466,2467,2468,2471,2472,2473,2474,2475,2477,2478,2479,2480,2481,2482,2484,2485,2486][i - 1577]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC16 (i : Nat) (hi : 1617 ≤ i) (hii : i ≤ 1656) :
    Artifact.submissionArtifact.instructionPC i =
      [2487,2488,2489,2490,2491,2494,2495,2496,2497,2498,2499,2500,2501,2502,2503,2504,2505,2506,2507,2508,2509,2510,2511,2512,2513,2514,2515,2516,2517,2518,2519,2520,2553,2554,2555,2588,2589,2590,2591,2624][i - 1617]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC17 (i : Nat) (hi : 1657 ≤ i) (hii : i ≤ 1696) :
    Artifact.submissionArtifact.instructionPC i =
      [2625,2626,2629,2630,2631,2634,2635,2636,2637,2638,2641,2642,2643,2646,2647,2650,2651,2652,2655,2656,2659,2660,2661,2662,2663,2664,2665,2666,2667,2668,2669,2670,2671,2672,2673,2674,2675,2676,2677,2678][i - 1657]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC18 (i : Nat) (hi : 1697 ≤ i) (hii : i ≤ 1736) :
    Artifact.submissionArtifact.instructionPC i =
      [2679,2680,2681,2682,2683,2684,2685,2686,2687,2688,2689,2690,2691,2692,2725,2726,2727,2760,2761,2762,2763,2796,2797,2798,2801,2802,2803,2806,2807,2808,2809,2810,2811,2814,2815,2816,2849,2850,2853,2854][i - 1697]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC19 (i : Nat) (hi : 1737 ≤ i) (hii : i ≤ 1742) :
    Artifact.submissionArtifact.instructionPC i =
      [2857,2858,2859,2860,2861,2862][i - 1737]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC20 (i : Nat) (hi : 1743 ≤ i) (hii : i ≤ 1768) :
    Artifact.submissionArtifact.instructionPC i =
      [2863,2864,2867,2868,2869,2870,2873,2874,2875,2877,2878,2881,2882,2883,2884,2887,2888,2889,2891,2892,2893,2894,2897,2898,2899,2900][i - 1743]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC21 (i : Nat) (hi : 1769 ≤ i) (hii : i ≤ 1781) :
    Artifact.submissionArtifact.instructionPC i =
      [2901,2902,2903,2904,2906,2907,2908,2911,2912,2914,2917,2918,2921][i - 1769]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC22 (i : Nat) (hi : 1782 ≤ i) (hii : i ≤ 1823) :
    Artifact.submissionArtifact.instructionPC i =
      [2922,2923,2924,2925,2928,2929,2932,2933,2934,2935,2936,2937,2939,
       2940,2943,2944,2946,2947,2950,2951,2954,2955,2956,2957,2960,2961,
       2964,2967,2968,2970,2973,2974,2975,2978,2979,2982,2985,2986,2987,
       2989,2991,2994][i - 1782]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC23 (i : Nat) (hi : 1824 ≤ i) (hii : i ≤ 1882) :
    Artifact.submissionArtifact.instructionPC i =
      [2995,2996,2999,3000,3001,3002,3005,3006,3007,3010,3011,3012,3013,
       3016,3017,3018,3021,3022,3023,3024,3027,3028,3029,3032,3033,3034,
       3035,3038,3039,3040,3043,3044,3045,3046,3049,3050,3051,3054,3055,
       3056,3057,3060,3061,3062,3065,3066,3067,3068,3071,3072,3073,3076,
       3077,3078,3079,3082,3083,3084,3085][i - 1824]! := by
  interval_cases i <;> decide

@[simp] theorem fastPC24 (i : Nat) (hi : 1883 ≤ i) (hii : i ≤ 1912) :
    Artifact.submissionArtifact.instructionPC i =
      [3086,3087,3090,3091,3093,3094,3095,3098,3099,3100,3101,3103,3104,3105,
       3108,3109,3111,3112,3114,3115,3116,3119,3120,3121,3124,3125,3127,3130,
       3131,3132][i - 1883]! := by
  interval_cases i <;> decide
...
theorem jumpDest2955 :
  ...
  Artifact.isValidJumpDest_index 1803 (by rfl)
...
theorem jumpDest3006 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3006 = true :=
  Artifact.isValidJumpDest_index 1831 (by rfl)

theorem jumpDest3017 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3017 = true :=
  Artifact.isValidJumpDest_index 1838 (by rfl)

theorem jumpDest3028 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3028 = true :=
  Artifact.isValidJumpDest_index 1845 (by rfl)

theorem jumpDest3039 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3039 = true :=
  Artifact.isValidJumpDest_index 1852 (by rfl)

theorem jumpDest3050 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3050 = true :=
  Artifact.isValidJumpDest_index 1859 (by rfl)

theorem jumpDest3061 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3061 = true :=
  Artifact.isValidJumpDest_index 1866 (by rfl)

theorem jumpDest3072 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3072 = true :=
  Artifact.isValidJumpDest_index 1873 (by rfl)

theorem jumpDest3083 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3083 = true :=
  Artifact.isValidJumpDest_index 1880 (by rfl)

theorem jumpDest3086 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3086 = true :=
  Artifact.isValidJumpDest_index 1883 (by rfl)
