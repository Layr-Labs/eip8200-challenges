...
private theorem fastPCAnchor24 :
    Artifact.submissionArtifact.instructionPC 2233 = 2884 := by
  calc
    Artifact.submissionArtifact.instructionPC 2233 =
        Artifact.submissionArtifact.instructionPC 1605 +
          (assembleBytes ((Artifact.submissionArtifact.instructions.drop 1605).take 628)).length :=
      instructionPC_add Artifact.submissionArtifact 1605 628
    _ = 2884 := by
      rw [fastPCAnchor23]
      rfl
...
@[simp] theorem fullBasePC (i : Nat) (hi : 2233 ≤ i) (hii : i ≤ 2278) :
    Artifact.submissionArtifact.instructionPC i =
      [2884, 2885, 2886, 2887, 2888, 2889, 2890, 2892, 2893, 2894, 2895, 2898, 2899, 2900, 2902, 2905, 2906, 2909, 2912, 2915, 2918, 2921, 2922, 2923, 2924, 2926, 2927, 2929, 2930, 2931, 2932, 2934, 2935, 2936, 2938, 2939, 2941, 2942, 2943, 2944, 2945, 2948, 2949, 2950, 2952, 2955][i - 2233]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
        Artifact.submissionArtifact.instructionPC (2233 + (i - 2233)) := by
      rw [Nat.add_sub_of_le hi]
    _ = Artifact.submissionArtifact.instructionPC 2233 +
          (assembleBytes ((Artifact.submissionArtifact.instructions.drop 2233).take (i - 2233))).length :=
      instructionPC_add Artifact.submissionArtifact 2233 (i - 2233)
    _ = _ := by
      rw [fastPCAnchor24]
      interval_cases i <;> rfl
...
theorem jumpDest3111 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 2849 = true :=
...
theorem jumpDest4976 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4642 = true :=
  Artifact.isValidJumpDest_index 3545 (by rfl)

theorem jumpDestSub : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4822 = true :=
  Artifact.isValidJumpDest_index 3662 (by rfl)

theorem jumpDestCopyResume : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5073 = true :=
  Artifact.isValidJumpDest_index 3843 (by rfl)

theorem jumpDestEarlyCopy : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5062 = true :=
