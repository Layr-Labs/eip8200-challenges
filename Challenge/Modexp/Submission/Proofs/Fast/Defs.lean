...
private theorem fastPCAnchor18 :
    Artifact.submissionArtifact.instructionPC 1690 = 2342 := by
  calc
...
@[simp] theorem fastPC17 (i : Nat) (hi : 1650 ≤ i) (hii : i ≤ 1689) :
    Artifact.submissionArtifact.instructionPC i =
      [2288,2291,2292,2293,2296,2297,2298,2299,2300,2303,2304,2305,2308,2309,2312,2313,2314,2317,2318,2321,2322,2323,2324,2325,2326,2327,2328,2329,2330,2331,2332,2333,2334,2335,2336,2337,2338,2339,2340,2341][i - 1650]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
@[simp] theorem fastPC18 (i : Nat) (hi : 1690 ≤ i) (hii : i ≤ 1730) :
    Artifact.submissionArtifact.instructionPC i =
      [2342,2343,2344,2345,2346,2347,2348,2349,2350,2351,2352,2353,2354,2387,2388,2389,2422,2423,2424,2425,2458,2459,2460,2463,2464,2465,2468,2469,2470,2471,2472,2473,2476,2477,2478,2481,2482,2483,2486,2487,2490][i - 1690]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
