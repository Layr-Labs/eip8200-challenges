...
@[simp] theorem fastPC21 (i : Nat) (hi : 1768 ≤ i) (hii : i ≤ 1809) :
    Artifact.submissionArtifact.instructionPC i =
      [2901,2902,2903,2904,2907,2908,2911,2912,2913,2914,2915,2916,2918,
       2919,2922,2923,2925,2926,2929,2930,2933,2934,2935,2936,2939,2940,
       2943,2946,2947,2949,2952,2953,2954,2957,2958,2961,2964,2965,2966,
       2968,2970,2973][i - 1768]! := by
  interval_cases i <;> decide
...
theorem jumpDest2934 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 2934 = true :=
  Artifact.isValidJumpDest_index 1789 (by rfl)

theorem jumpDest2953 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 2953 = true :=
