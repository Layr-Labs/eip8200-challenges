...
def entry : Block Artifact.submissionArtifact .Osaka 4481 (CiosStackCachePrograms.entry) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3200 64 4481 (CiosStackCachePrograms.entry)
    (by decide) (by rfl) (by rfl) (by decide)

def out : Block Artifact.submissionArtifact .Osaka 4595 (CiosStackCachePrograms.out) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3264 5 4595 (CiosStackCachePrograms.out)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Dispatch : Block Artifact.submissionArtifact .Osaka 4600 (dispatchFor 4757) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3269 3 4600 (dispatchFor 4757)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac0 : Block Artifact.submissionArtifact .Osaka 4605 (l1StepFor 7) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3272 34 4605 (l1StepFor 7)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac1 : Block Artifact.submissionArtifact .Osaka 4643 (l1StepFor 6) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3306 34 4643 (l1StepFor 6)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac2 : Block Artifact.submissionArtifact .Osaka 4681 (l1StepFor 5) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3340 34 4681 (l1StepFor 5)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac3 : Block Artifact.submissionArtifact .Osaka 4719 (l1StepFor 4) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3374 34 4719 (l1StepFor 4)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Join : Block Artifact.submissionArtifact .Osaka 4757 ([.op .JUMPDEST]) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3408 1 4757 ([.op .JUMPDEST])
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac4 : Block Artifact.submissionArtifact .Osaka 4758 (l1StepFor 3) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3409 34 4758 (l1StepFor 3)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac5 : Block Artifact.submissionArtifact .Osaka 4796 (l1StepFor 2) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3443 33 4796 (l1StepFor 2)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac6 : Block Artifact.submissionArtifact .Osaka 4829 (l1StepFor 1) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3476 33 4829 (l1StepFor 1)
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac7 : Block Artifact.submissionArtifact .Osaka 4862 (l1Last) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3509 32 4862 (l1Last)
    (by decide) (by rfl) (by rfl) (by decide)

def mid : Block Artifact.submissionArtifact .Osaka 4894 (midProgram) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3541 28 4894 (midProgram)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Dispatch : Block Artifact.submissionArtifact .Osaka 4928 (dispatchFor 5085) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3569 3 4928 (dispatchFor 5085)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac0 : Block Artifact.submissionArtifact .Osaka 4933 (l2BodyFor 6) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3572 32 4933 (l2BodyFor 6)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac1 : Block Artifact.submissionArtifact .Osaka 4971 (l2BodyFor 5) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3604 32 4971 (l2BodyFor 5)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac2 : Block Artifact.submissionArtifact .Osaka 5009 (l2BodyFor 4) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3636 32 5009 (l2BodyFor 4)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac3 : Block Artifact.submissionArtifact .Osaka 5047 (l2BodyFor 3) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3668 32 5047 (l2BodyFor 3)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Join : Block Artifact.submissionArtifact .Osaka 5085 ([.op .JUMPDEST]) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3700 1 5085 ([.op .JUMPDEST])
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac4 : Block Artifact.submissionArtifact .Osaka 5086 (l2BodyFor 2) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3701 31 5086 (l2BodyFor 2)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac5 : Block Artifact.submissionArtifact .Osaka 5121 (l2BodyFor 1) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3732 30 5121 (l2BodyFor 1)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac6 : Block Artifact.submissionArtifact .Osaka 5151 (l2BodyFor 0) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3762 30 5151 (l2BodyFor 0)
    (by decide) (by rfl) (by rfl) (by decide)

def tail : Block Artifact.submissionArtifact .Osaka 5181 (tailProgram) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3792 23 5181 (tailProgram)
    (by decide) (by rfl) (by rfl) (by decide)

def exit : Block Artifact.submissionArtifact .Osaka 5212 (CiosStackCachePrograms.exit) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3815 19 5212 (CiosStackCachePrograms.exit)
    (by decide) (by rfl) (by rfl) (by decide)
...
def kernelBlocks : KernelBlocks Artifact.submissionArtifact where
  ...
  tail := tail
  exit := exit
  jumpOut := by exact Artifact.isValidJumpDest_index 3264 (by rfl)
  jumpL1 := by exact Artifact.isValidJumpDest_index 3408 (by rfl)
  jumpL2 := by exact Artifact.isValidJumpDest_index 3700 (by rfl)
