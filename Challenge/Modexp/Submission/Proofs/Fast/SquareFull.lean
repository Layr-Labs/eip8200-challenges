...
head `hd = sq_row = 4664` on top of the call frame `[2048, 2048, 2048, ret]`
(`Cios2Dispatch.commonState s mem 4664 2048 2048 (ofNat 2048) ret rest`, definitionally
WP-C's `Exp.sqCall`).
...
def gasSteps_squareFull (s : State) (mem : ByteArray) (p a mm : Nat)
  ...
  have g1 := Cios2Dispatch.gasSteps_commonFallbackOfWidth s mem 4724 2048 2048 (p + 2)
