...
def gasSteps_squareFull (s : State) (mem : ByteArray) (p a mm : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (Cios2Dispatch.commonState s mem 4685 2048 2048 (UInt256.ofNat 2048) ret rest)
  ...
  · -- the square kernel
    ...
    have g1 := Cios2Dispatch.gasSteps_commonSetupInput s mem (UInt256.ofNat 4685) 2048 2048 (p + 2)
  ...
  · -- the generic MONPRO fallback
    have g1 := Cios2Dispatch.gasSteps_commonFallbackOfWidth s mem 4685 2048 2048 (p + 2)
