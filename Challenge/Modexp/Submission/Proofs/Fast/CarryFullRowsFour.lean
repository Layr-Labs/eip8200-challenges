...
opaque gasSteps_rowsFour (s : State) (mem : ByteArray) (pa pb : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s (mpZeroed s mem 4) pb 4 0 (UInt256.ofNat 3543) (l1Target 4) inv m0
        (tl :: m96 :: m64 :: m32 :: aEnd :: pdst :: ret :: rest))
      (mpCsubState s (rowsCarry (mpZeroed s mem 4) pa pb 4 4) pdst ret
        (TnM128InitialMultiply.retainedFrame s mem pa pb 4 tl inv m0 aEnd m96 m64 m32 pdst ret rest)) := by
  ...
  have g := TnM128InitialMultiply.rows_steps s env mem pa pb 4
