...
theorem jumpDestSetup :
  ...
  exact Artifact.isValidJumpDest_index 2675 (by rfl)
...
theorem jumpDestRowHead :
  ...
  exact Artifact.isValidJumpDest_index 2768 (by rfl)
...
theorem jumpDestSqRow :
  ...
  exact Artifact.isValidJumpDest_index 3350 (by rfl)
...
def setup : Block Artifact.submissionArtifact .Osaka 3576 StagedOperand.fullEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2675 59 3576 StagedOperand.fullEntryProgram
