...
theorem jumpDest4057 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4440 = true := by
  exact Artifact.isValidJumpDest_index 3185 (by rfl)

theorem jumpDest4080 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4463 = true := by
...
theorem run_dispatch4 (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  have h4080 : (4463 : UInt256).toNat = 4463 := by decide
  have h4080' : (4463 : UInt256) = UInt256.ofNat 4463 := by decide
  have hcond128 :
...
theorem run_dispatchFallback (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  have hc6 : rest.length + 6 < 1024 := by omega
  have hc7 : rest.length + 7 < 1024 := by omega
  have h1939 : (1916 : UInt256).toNat = 1916 := by decide
  have h1939' : (1916 : UInt256) = UInt256.ofNat 1916 := by decide
