...
theorem jumpDestCommon :
  ...
  exact Artifact.isValidJumpDest_index 3074 (by rfl)
...
theorem jumpDestSetup :
  ...
  exact Artifact.isValidJumpDest_index 3089 (by rfl)
...
theorem jumpDestSqRow :
  ...
  exact Artifact.isValidJumpDest_index 3770 (by rfl)
...
def setup : Block Artifact.submissionArtifact .Osaka 4120 StagedOperand.fullEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3089 60 4120 StagedOperand.fullEntryProgram
