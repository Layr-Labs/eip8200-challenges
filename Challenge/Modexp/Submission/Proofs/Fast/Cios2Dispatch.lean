...
theorem jumpDest4057 :
  ...
  exact Artifact.isValidJumpDest_index 3160 (by rfl)

theorem jumpDest4080 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4455 = true := by
...
theorem run_dispatch4 (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  have h4080 : (4455 : UInt256).toNat = 4455 := by decide
  have h4080' : (4455 : UInt256) = UInt256.ofNat 4455 := by decide
  have hcond128 :
