...
theorem jumpDestRowHead :
  ...
  exact Artifact.isValidJumpDest_index 2487 (by rfl)
...
theorem jumpDestSqRow :
  ...
  exact Artifact.isValidJumpDest_index 3059 (by rfl)
...
def setup : Block Artifact.submissionArtifact .Osaka 3214 TnM128Setup.fullEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2389 58 3214 TnM128Setup.fullEntryProgram
