...
theorem jumpDest4057 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4493 = true := by
  exact Artifact.isValidJumpDest_index 3167 (by rfl)

theorem jumpDest4080 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4516 = true := by
  exact Artifact.isValidJumpDest_index 3181 (by rfl)
...
theorem run_dispatch4 (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  have h4080 : (4516 : UInt256).toNat = 4516 := by decide
  have h4080' : (4516 : UInt256) = UInt256.ofNat 4516 := by decide
  have hcond128 :
...
theorem run_dispatchFallback (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  have hc6 : rest.length + 6 < 1024 := by omega
  have hc7 : rest.length + 7 < 1024 := by omega
  have h1939 : (1870 : UInt256).toNat = 1870 := by decide
  have h1939' : (1870 : UInt256) = UInt256.ofNat 1870 := by decide
