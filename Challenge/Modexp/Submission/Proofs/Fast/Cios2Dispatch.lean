...
theorem jumpDestCommon :
  ...
  exact Artifact.isValidJumpDest_index 3030 (by rfl)
...
theorem jumpDestRowHead :
  ...
  exact Artifact.isValidJumpDest_index 3107 (by rfl)
...
theorem jumpDestSqRow :
  ...
  exact Artifact.isValidJumpDest_index 3713 (by rfl)
...
example (s : State) (mem : ByteArray) (ret : UInt256) (tail : List UInt256) :
    ({ s with pc := UInt256.ofNat 4051
              ...
              memory := mem } : State) =
      commonState s mem 4923 2048 2048 (UInt256.ofNat 2048) ret tail := rfl
...
def setup : Block Artifact.submissionArtifact .Osaka 4075 StagedOperand.fullEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3045 62 4075 StagedOperand.fullEntryProgram
