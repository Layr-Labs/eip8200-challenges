...
theorem jumpDest4012 :
  ...
  exact Artifact.isValidJumpDest_index 2651 (by rfl)
...
theorem jumpDestRowHead :
  ...
  exact Artifact.isValidJumpDest_index 2762 (by rfl)
...
theorem jumpDestSqRow :
  ...
  exact Artifact.isValidJumpDest_index 3354 (by rfl)
...
def setup : Block Artifact.submissionArtifact .Osaka 3580 StagedOperand.fullEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2668 60 3580 StagedOperand.fullEntryProgram
