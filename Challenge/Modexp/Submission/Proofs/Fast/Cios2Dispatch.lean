...
theorem jumpDest4012 :
  ...
  exact Artifact.isValidJumpDest_index 2512 (by rfl)
...
theorem jumpDestCommon :
  ...
  exact Artifact.isValidJumpDest_index 2514 (by rfl)
...
theorem jumpDestSetup :
  ...
  exact Artifact.isValidJumpDest_index 2530 (by rfl)
...
theorem jumpDestRowHead :
  ...
  exact Artifact.isValidJumpDest_index 2623 (by rfl)
...
def setup : Block Artifact.submissionArtifact .Osaka 3383 StagedOperand.fullEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2530 59 3383 StagedOperand.fullEntryProgram
