...
theorem jumpDest4012 :
  ...
  exact Artifact.isValidJumpDest_index 2710 (by rfl)
...
theorem jumpDestSqRow :
  ...
  exact Artifact.isValidJumpDest_index 3383 (by rfl)
...
opaque gasSteps_mulEntry (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (commonState s (mpZeroed s mem n) (UInt256.ofNat 3543) pa pb pdst
  ...
  have htail : (ret :: rest).length ≤ 1008 := by simp; omega
  exact mulEntry.steps
    (environment (legacyState s (mpZeroed s mem n) pa pb pdst
      (UInt256.ofNat GenericReturnAdapter.genericShimPC) (ret :: rest))
      hcode hfork hrun hnp)
    rfl (run_mulEntry s (mpZeroed s mem n) pa pb pdst
      (UInt256.ofNat GenericReturnAdapter.genericShimPC) (ret :: rest) htail)
...
opaque gasSteps_dispatch4 (s : State) (mem : ByteArray) (pa pb : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (CiosCached.setupState s (mpZeroed s mem 4) (UInt256.ofNat 3543)
        pa pb pdst (UInt256.ofNat GenericReturnAdapter.genericShimPC) (ret :: rest)) := by
  ...
  have htail : (ret :: rest).length ≤ 1008 := by simp; omega
  exact gasSteps_common s (mpZeroed s mem 4) (UInt256.ofNat 3543) pa pb pdst
    (UInt256.ofNat GenericReturnAdapter.genericShimPC) (ret :: rest)
    htail hrun hcode hfork hnp hact (Or.inl hs32') hguard' hzero'
...
opaque gasSteps_dispatch8 (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  refine (gasSteps_mulEntry s mem pa pb 8 pdst ret rest hcap hrun hcode hfork hnp
    hact (by decide) hcds hs32).trans ?_
  have htail : (ret :: rest).length ≤ 1008 := by simp; omega
  exact gasSteps_common s (mpZeroed s mem 8) (UInt256.ofNat 3543) pa pb pdst
    (UInt256.ofNat GenericReturnAdapter.genericShimPC) (ret :: rest)
    htail hrun hcode hfork hnp hact (Or.inr hs32') hguard' hzero'
...
opaque gasSteps_mulSetup (s : State) (mem : ByteArray) (pa pb n : Nat)
  ...
  exact gasSteps_commonSetup s mem (UInt256.ofNat 3543) pa pb n pdst
