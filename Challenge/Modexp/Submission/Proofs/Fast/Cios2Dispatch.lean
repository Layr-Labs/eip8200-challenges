...
theorem jumpDestSetup :
  ...
  exact Artifact.isValidJumpDest_index 2674 (by rfl)
...
theorem jumpDestSqRow :
  ...
  exact Artifact.isValidJumpDest_index 3352 (by rfl)
...
def setup : Block Artifact.submissionArtifact .Osaka 3328 StagedOperand.fullEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2674 59 3328 StagedOperand.fullEntryProgram
