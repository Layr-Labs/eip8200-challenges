...
theorem jumpDest4057 :
  ...
  exact Artifact.isValidJumpDest_index 3135 (by rfl)
...
theorem run_dispatch4 (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  have h4080 : (4451 : UInt256).toNat = 4451 := by decide
  have h4080' : (4451 : UInt256) = UInt256.ofNat 4451 := by decide
  have hcond128 :
...
theorem run_dispatchFallback (s : State) (mem : ByteArray) (pa pb : Nat)
  ...
  have hc6 : rest.length + 6 < 1024 := by omega
  have hc7 : rest.length + 7 < 1024 := by omega
  have h1939 : (1920 : UInt256).toNat = 1920 := by decide
  have h1939' : (1920 : UInt256) = UInt256.ofNat 1920 := by decide
