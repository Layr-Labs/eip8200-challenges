...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h1926 : (1654 : UInt256) = UInt256.ofNat 1654 := by decide
  have h2467 : (1939 : UInt256) = UInt256.ofNat 1939 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h1915 : (1643 : UInt256) = UInt256.ofNat 1643 := by decide
  have h1915Nat : (UInt256.ofNat 1643).toNat = 1643 := by decide
...
theorem jump1926 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 1654).toNat = true := by
  rw [show (UInt256.ofNat 1654).toNat = 1654 by decide]
  exact jumpDest1852
...
def gasSteps_double256_addmod (s : State) (mem : ByteArray) (px n : Nat)
  ...
  gasSteps_double256 s px ret rest (iterMem (dblStep px n) mem)
    (fun i _ => Challenge.EvmProof.GasSteps.cast
      (gasSteps_addmodStep s (iterMem (dblStep px n) mem i) px n (UInt256.ofNat 1654)
