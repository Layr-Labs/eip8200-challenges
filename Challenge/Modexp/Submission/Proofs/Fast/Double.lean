...
def callState (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  { s with pc := UInt256.ofNat 1487
           stack := [UInt256.ofNat px, UInt256.ofNat px, UInt256.ofNat px,
                     UInt256.ofNat 1202] ++ loopStack px k ret rest
           memory := mem }
...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h1926 : (1202 : UInt256) = UInt256.ofNat 1202 := by decide
  have h2467 : (1487 : UInt256) = UInt256.ofNat 1487 := by decide
...
/-- Decrementing by adding `NOT 0`: `x + (2 ^ 256 - 1) = x - 1` for `1 ≤ x`.
The loop tail of `blk1369` uses this instead of a literal `1` and a `SUB`. -/
theorem lnotZero_add_ofNat (i : Nat) (hi : 1 ≤ i) (hi' : i < 2 ^ 256) :
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h1915 : (1191 : UInt256) = UInt256.ofNat 1191 := by decide
  have h1915Nat : (UInt256.ofNat 1191).toNat = 1191 := by decide
  have hdec : UInt256.lnot (UInt256.ofNat 0) + UInt256.ofNat (k' + 1) =
      UInt256.ofNat k' := by
    have h := lnotZero_add_ofNat (k' + 1) (by omega) (by omega)
  ...
  simp (config := { maxSteps := 400000 }) [blk1369, opAt, pushAt, wfOp,
    ...
    hzero, hzero', h1915, h1915Nat, hdec, htrue, jumpDest1841, List.exchange,
    Challenge.EvmProof.Word.literal_eq_ofNat,
    Challenge.EvmProof.Word.succ_ofNat_mod,
    Challenge.EvmProof.Word.ofNat_add_mod,
    Challenge.EvmProof.Word.word_toNat_ofNat]
...
theorem run_retLast (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  have hzero' : ({ val := 0 } : UInt256) = UInt256.ofNat 0 := by decide
  have h1915 : (1191 : UInt256) = UInt256.ofNat 1191 := by decide
  have hdec : UInt256.lnot (UInt256.ofNat 0) + UInt256.ofNat 1 =
      UInt256.ofNat 0 := by
    have h := lnotZero_add_ofNat 1 (by omega) (by norm_num)
    simpa using h
  ...
  simp (config := { maxSteps := 400000 }) [blk1369, opAt, pushAt, wfOp,
    ...
    hzero, hzero', h1915, hdec, hfalse, List.exchange,
    Challenge.EvmProof.Word.literal_eq_ofNat,
    Challenge.EvmProof.Word.succ_ofNat_mod,
    Challenge.EvmProof.Word.ofNat_add_mod,
    Challenge.EvmProof.Word.word_toNat_ofNat]
...
theorem jump1926 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 1202).toNat = true := by
  rw [show (UInt256.ofNat 1202).toNat = 1202 by decide]
  exact jumpDest1852
...
def gasSteps_double256_addmod (s : State) (mem : ByteArray) (px n : Nat)
  ...
  gasSteps_double256 s px ret rest (iterMem (dblStep px n) mem)
    (fun i _ => Challenge.EvmProof.GasSteps.cast
      (gasSteps_addmodStep s (iterMem (dblStep px n) mem i) px n (UInt256.ofNat 1202)
