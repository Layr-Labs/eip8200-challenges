...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h1926 : (1206 : UInt256) = UInt256.ofNat 1206 := by decide
  have h2467 : (1491 : UInt256) = UInt256.ofNat 1491 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have hc4 : rest.length + 4 < 1024 := by omega
  have hc5 : rest.length + 5 < 1024 := by omega
  have h1915 : (1195 : UInt256) = UInt256.ofNat 1195 := by decide
  have h1915Nat : (UInt256.ofNat 1195).toNat = 1195 := by decide
  have hdec : UInt256.lnot (UInt256.ofNat 0) + UInt256.ofNat (k' + 1) = UInt256.ofNat k' := by
    have h := BigC.dec_ofNat (k' + 1) (by omega) (by omega)
  ...
  simp (config := { maxSteps := 400000 }) [blk1369, opAt, pushAt, wfOp,
    ...
    h1915, h1915Nat, hdec, htrue, jumpDest1841, List.exchange, BigC.zero_lit,
    Challenge.EvmProof.Word.literal_eq_ofNat,
    Challenge.EvmProof.Word.succ_ofNat_mod,
    Challenge.EvmProof.Word.ofNat_add_mod,
    Challenge.EvmProof.Word.word_toNat_ofNat]
...
theorem run_retLast (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
  ...
  have hc5 : rest.length + 5 < 1024 := by omega
  have h1915 : (1195 : UInt256) = UInt256.ofNat 1195 := by decide
  have hdec : UInt256.lnot (UInt256.ofNat 0) + UInt256.ofNat 1 = UInt256.ofNat 0 := by decide
  have hfalse : ¬ UInt256.isTrue (UInt256.ofNat 0) := by decide
  simp (config := { maxSteps := 400000 }) [blk1369, opAt, pushAt, wfOp,
    Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
    retState, exitState, loopStack, fastPC9, hc3, hc4, hc5, hrun,
    h1915, hdec, hfalse, List.exchange, BigC.zero_lit,
    Challenge.EvmProof.Word.literal_eq_ofNat,
    Challenge.EvmProof.Word.succ_ofNat_mod,
    Challenge.EvmProof.Word.ofNat_add_mod,
    Challenge.EvmProof.Word.word_toNat_ofNat]
...
theorem jump1926 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 1206).toNat = true := by
  rw [show (UInt256.ofNat 1206).toNat = 1206 by decide]
  exact jumpDest1852
...
def gasSteps_double256_addmod (s : State) (mem : ByteArray) (px n : Nat)
  ...
  gasSteps_double256 s px ret rest (iterMem (dblStep px n) mem)
    (fun i _ => Challenge.EvmProof.GasSteps.cast
      (gasSteps_addmodStep s (iterMem (dblStep px n) mem i) px n (UInt256.ofNat 1206)
