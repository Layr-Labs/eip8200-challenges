...
theorem run_call (s : State) (mem : ByteArray) (px k : Nat) (ret : UInt256)
  ...
  have h1926 : (1194 : UInt256) = UInt256.ofNat 1194 := by decide
  have h2467 : (1479 : UInt256) = UInt256.ofNat 1479 := by decide
...
theorem run_ret (s : State) (mem : ByteArray) (px k k' : Nat) (ret : UInt256)
  ...
  have h1915 : (1183 : UInt256) = UInt256.ofNat 1183 := by decide
  have h1915Nat : (UInt256.ofNat 1183).toNat = 1183 := by decide
...
theorem jump1926 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 1194).toNat = true := by
  rw [show (UInt256.ofNat 1194).toNat = 1194 by decide]
  exact jumpDest1852
...
def gasSteps_double256_addmod (s : State) (mem : ByteArray) (px n : Nat)
  ...
  gasSteps_double256 s px ret rest (iterMem (dblStep px n) mem)
    (fun i _ => Challenge.EvmProof.GasSteps.cast
      (gasSteps_addmodStep s (iterMem (dblStep px n) mem i) px n (UInt256.ofNat 1194)
