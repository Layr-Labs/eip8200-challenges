...
def gasSteps_loops (s : State) (mem : ByteArray) (f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret : UInt256)
  ...
  have fixed (pc k : Nat) (w : Fin 33) (x loadAddr storeAddr : UInt256)
      ...
      (hx : x.toNat = 32*(4-2-k))
      (hl : loadAddr.toNat = 2112+32*(4-2-k))
      (hs : storeAddr.toNat = 2112+32*(4-1-k))
  ...
  have extra (pc k : Nat) (slot : Fin 3) (x loadAddr storeAddr : UInt256)
      ...
      (hl : loadAddr.toNat = 2112+32*(4-2-k))
      (hs : storeAddr.toNat = 2112+32*(4-1-k)) (hk : k+1 < 4) :
  ...
  exact hd.trans <| hj.trans <|
    (extra 4662 0 1 64 2176 2208 CarryRowBlocks.l2Mac4 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    (extra 4696 1 2 32 2144 2176 CarryRowBlocks.l2Mac5 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    fixed 4730 2 0 0 2112 2144 CarryRowBlocks.l2Mac6 (by decide) (by decide) (by decide) (by decide) (by decide)
