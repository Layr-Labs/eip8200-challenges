...
/-- Entry retained by setup: 3387 for eight limbs, 5179 for four limbs.
...
def sqEnt (n i : Nat) : Nat := 3387 + 448 * (8 - n) + 37 * i
...
def rowState (s : State) (a0 : UInt256) (M0 : ByteArray) (n : Nat)
  ...
  outState s (sqRowsCarry M0 n i) 2368 n i (UInt256.ofNat 4093) (UInt256.ofNat (sqEnt n i)) inv m0
