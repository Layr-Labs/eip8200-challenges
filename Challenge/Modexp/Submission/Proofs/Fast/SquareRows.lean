...
4864) is
    ...
    row head `hd = 4960` ─ prologue (`SquareRow.gasSteps_prologue`) ─▶ first-loop entry
    `4294 + 37(8 - n + i)` ─ chain (limb steps `i+1 .. n-1`) ─▶ middle `JUMPDEST` 4553
...
(limb step `i + 1`); for the last row the middle `JUMPDEST` 4553. -/
def sqEnt (n i : Nat) : Nat := 4286 + 37 * (8 - n + i)
...
theorem sgt_zero_setup (n : Nat) (hn : n ≤ 32) :
...
theorem jumpDest4710' :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode (UInt256.ofNat 4979).toNat = true :=
  jumpDest4710
...
def gasSteps_rowToTail (s : State) (mem : ByteArray) (n i : Nat)
    ...
    (hsnap : StagedOperand.Snapshot mem 4864 n) :
    Challenge.EvmProof.GasSteps
      (outState s mem 4864 n i (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i)) inv m0
      ...
      (tailState s
        ...
        4864 n i (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i + 37)) inv m0
  ...
  have gC := KernelChain.gasSteps_l1Suffix (9 - n + i) (by omega) (by omega) s
    ...
    (sqB2 (sqX mem n i) (UInt256.sgt (UInt256.ofNat 0) aprev)) 4864 4864 n i (i + 1)
    (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i + 37)) inv m0
  ...
  have hQ : l1Run (sqPro mem n i (UInt256.sgt (UInt256.ofNat 0) aprev))
      (sqB2 (sqX mem n i) (UInt256.sgt (UInt256.ofNat 0) aprev)) 4864 n (i + 1) (n - 1 - i) =
  ...
  have hcQ : CiosReadonly.ReadonlyCache (sqL1 mem n i (UInt256.sgt (UInt256.ofNat 0) aprev)).memory
      n tl inv m0 :=
    SquareCaches.readonlyCache_l1Run (SquareCaches.readonlyCache_sqPro hc hn32 i hi _) hn32 _ 4864
      (i + 1) (n - 1 - i) hstep
  have heQ : CiosReadonlyExtra.ExtraCache
      (sqL1 mem n i (UInt256.sgt (UInt256.ofNat 0) aprev)).memory m96 m64 m32 :=
    SquareCaches.extraCache_l1Run (SquareCaches.extraCache_sqPro he n i hi _) _ 4864 n
      (i + 1) (n - 1 - i) hstep
  have hminvQ : inverseInvariant (sqL1 mem n i (UInt256.sgt (UInt256.ofNat 0) aprev)).memory n :=
    SquareCaches.inverse_l1Run _ _ 4864 n (i + 1) (n - 1 - i) hn32 hstep
  ...
  have gM := CarryRowGas.gasSteps_mid s (sqL1 mem n i (UInt256.sgt (UInt256.ofNat 0) aprev)).memory
    ...
    (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i + 37)) tl inv m0 (sqX mem n i) m96 m64 m32
    pdst ret rest hcap hrun hcode hfork hnp hact hn2 hn32 hminvQ hcQ
  refine (gP.trans gC).trans (gM.trans ?_)
  -- the second loop
  by_cases h4 : n = 4
  · subst h4
    exact CarryRowGas.gasSteps_l2Four s _ _ _ _ 4864 i (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt 4 i + 37))
  ...
  · obtain rfl : n = 8 := by omega
    exact CarryRowGas.gasSteps_l2Eight s _ _ _ _ 4864 i (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt 8 i + 37))
...
def gasSteps_rowNext (s : State) (mem : ByteArray) (n i : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s mem 4864 n i (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i)) inv m0
        (tl :: m96 :: m64 :: m32 :: aprev :: pdst :: ret :: rest))
      (outState s (sqRowCarry mem n i (UInt256.sgt (UInt256.ofNat 0) aprev)) 4864 n (i + 1)
        (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i + 37)) inv m0
        (tl :: m96 :: m64 :: m32 :: sqX mem n i :: pdst :: ret :: rest)) :=
  ...
  (CarryRowGas.gasSteps_tailNext s _ _ _ _ 4864 n i (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i + 37))
...
retained (the R0 kernel-exit dispatch sends `hd = sq_row` there). -/
def gasSteps_rowLastToExit (s : State) (mem : ByteArray) (n i : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (CiosCachedTailDefs.sqExitState s
        ...
        (UInt256.ofNat (ptrAt (4864 + 32 * n - 32) (i + 1))) 4864 n (UInt256.ofNat 4979)
        (UInt256.ofNat (sqEnt n i + 37)) inv m0
        (tl :: m96 :: m64 :: m32 :: sqX mem n i :: pdst :: ret :: rest)) :=
  (gasSteps_rowToTail s mem n i tl inv m0 m96 m64 m32 aprev pdst ret rest hcap hrun hcode hfork
    hnp hact hn (by omega) hminv hc he hsnap).trans
  (CarryRowGas.gasSteps_tailLastSq s _ _ _ _ 4864 n i (UInt256.ofNat (sqEnt n i + 37))
...
def rowState (s : State) (a0 : UInt256) (M0 : ByteArray) (n : Nat)
  ...
  outState s (sqRowsCarry M0 n i) 4864 n i (UInt256.ofNat 4979) (UInt256.ofNat (sqEnt n i)) inv m0
...
machine-carry square rows `sqRowsCarry M0 n n` in memory and the frame retained. -/
def gasSteps_rowsToExit (s : State) (a0 : UInt256) (M0 : ByteArray) (n : Nat)
    ...
    (hsnap : StagedOperand.Snapshot M0 4864 n) :
    Challenge.EvmProof.GasSteps
      (rowState s a0 M0 n tl inv m0 m96 m64 m32 pdst ret rest 0)
      (CiosCachedTailDefs.sqExitState s (sqRowsCarry M0 n n)
        (UInt256.ofNat (ptrAt (4864 + 32 * n - 32) n)) 4864 n (UInt256.ofNat 4979)
        (UInt256.ofNat (sqEnt n n)) inv m0
        (tl :: m96 :: m64 :: m32 :: sqLast M0 n :: pdst :: ret :: rest)) := by
  have hn8 : n ≤ 8 := by omega
  have hn32 : n ≤ 32 := by omega
  have next : ∀ i, i < n - 1 →
      Challenge.EvmProof.GasSteps (rowState s a0 M0 n tl inv m0 m96 m64 m32 pdst ret rest i)
        (rowState s a0 M0 n tl inv m0 m96 m64 m32 pdst ret rest (i + 1)) := by
    intro i hi
    have g := gasSteps_rowNext s (sqRowsCarry M0 n i) n i tl inv m0 m96 m64 m32
      (sqPrev a0 M0 n i) pdst ret rest hcap hrun hcode hfork hnp hact hn (by omega)
    ...
    rw [sqTb_eq_prev a0 M0 n i (by omega) hn8 ha0, ← sqRowsCarry_succ, sqEnt_succ n i] at g
    exact g
  have last := gasSteps_rowLastToExit s (sqRowsCarry M0 n (n - 1)) n (n - 1) tl inv m0 m96 m64 m32
  ...
  rw [sqTb_eq_prev a0 M0 n (n - 1) (by omega) hn8 ha0, ← sqRowsCarry_succ,
    show n - 1 + 1 = n by omega, sqEnt_succ n (n - 1), show n - 1 + 1 = n by omega] at last
  exact (Challenge.EvmProof.GasSteps.iterateBounded
    (I := rowState s a0 M0 n tl inv m0 m96 m64 m32 pdst ret rest) (n - 1) next).trans last
