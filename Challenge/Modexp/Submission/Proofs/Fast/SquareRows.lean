...
def sqEnt (n i : Nat) : Nat := 4060 + 38 * (8 - n + i)
...
theorem jumpDest4710' :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode (UInt256.ofNat 4772).toNat = true :=
  jumpDest4710
...
def gasSteps_rowToTail (s : State) (mem : ByteArray) (n i : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s mem 2048 n i (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt n i)) inv m0
      ...
      (tailState s
        ...
        2048 n i (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt n i + 38)) inv m0
  ...
  have gC := KernelChain.gasSteps_l1Suffix (9 - n + i) (by omega) (by omega) s
    ...
    (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt n i + 38)) inv m0
  ...
  have gM := CarryRowGas.gasSteps_mid s (sqL1 mem n i (UInt256.sgt (UInt256.ofNat 0) aprev)).memory
    ...
    (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt n i + 38)) tl inv m0 (sqX mem n i) m96 m64 m32
    pdst ret rest hcap hrun hcode hfork hnp hact hn2 hn32 hminvQ hcQ
  refine (gP.trans gC).trans (gM.trans ?_)
  -- the second loop
  by_cases h4 : n = 4
  · subst h4
    exact CarryRowGas.gasSteps_l2Four s _ _ _ _ 2048 i (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt 4 i + 38))
  ...
  · obtain rfl : n = 8 := by omega
    exact CarryRowGas.gasSteps_l2Eight s _ _ _ _ 2048 i (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt 8 i + 38))
...
def gasSteps_rowNext (s : State) (mem : ByteArray) (n i : Nat)
  ...
  (CarryRowGas.gasSteps_tailNext s _ _ _ _ 2048 n i (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt n i + 38))
...
def gasSteps_rowLastToExit (s : State) (mem : ByteArray) (n i : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (CiosCachedTailDefs.sqExitState s
        ...
        (UInt256.ofNat (ptrAt (2048 + 32 * n - 32) (i + 1))) 2048 n (UInt256.ofNat 4772)
...
def rowState (s : State) (a0 : UInt256) (M0 : ByteArray) (n : Nat)
  ...
  outState s (sqRowsCarry M0 n i) 2048 n i (UInt256.ofNat 4772) (UInt256.ofNat (sqEnt n i)) inv m0
...
def gasSteps_rowsToExit (s : State) (a0 : UInt256) (M0 : ByteArray) (n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (CiosCachedTailDefs.sqExitState s (sqRowsCarry M0 n n)
        (UInt256.ofNat (ptrAt (2048 + 32 * n - 32) n)) 2048 n (UInt256.ofNat 4772)
