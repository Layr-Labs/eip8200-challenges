...
theorem run_exit (s : State) (pbi paEnd pbEnd flag target2 dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions exitProgram
      (framed s (UInt256.ofNat 4813) ([pbi, paEnd, pbEnd, flag, negative32, allOnes, target2, dst, ret] ++ rest)) =
  ...
  -- settled directly.
  have hstep : (UInt256.ofNat 4820 + UInt256.ofNat 3).succ = UInt256.ofNat 4824 := by decide
