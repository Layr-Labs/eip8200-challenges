...
theorem run_exit (s : State) (pbi paEnd pbEnd flag target2 dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions exitProgram
      (framed s (UInt256.ofNat 4646) ([pbi, paEnd, pbEnd, flag, negative32, allOnes, target2, dst, ret] ++ rest)) =
    some (framed s (UInt256.ofNat 4653) ([dst, ret] ++ rest)) := by
  ...
  -- settled directly.
  have hstep : (UInt256.ofNat 4665 + UInt256.ofNat 3).succ = UInt256.ofNat 4653 := by decide
