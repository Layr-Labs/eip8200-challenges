...
theorem run_exit (s : State) (pbi paEnd pbEnd flag target2 cachedAddress cachedInverse cachedTailPointer cachedLow96 cachedLow64 cachedLow32 dst ret : UInt256) (rest : List UInt256)
    (hcap : rest.length ≤ 1006)
    (htarget : Decode.isValidJumpDest s.executionEnv.code 2220 = true) :
    runInstructions exitProgram
      (framed s (UInt256.ofNat 4868) ([pbi, paEnd, pbEnd, flag, negative32, allOnes, target2, cachedAddress, cachedInverse, cachedTailPointer, cachedLow96, cachedLow64, cachedLow32, dst, ret] ++ rest)) =
  ...
  simp [hExtra9, hExtra10, hExtra11, hExtra12, hExtra13, hExtra14, hExtra15, exitProgram, CiosCached.tailProgram, framed, runInstructions, Challenge.EvmProof.Stepper.runInstr,
