import Challenge.Modexp.Submission.Proofs.Fast.CiosStackCacheInitBodyPointerWords
...
theorem run_pointers (s : State) (mem : ByteArray) (pa pb n : Nat)
  ...
  have h := PointerWords.run_words { s with memory := mpZeroed s mem n } (UInt256.ofNat (32*n))
