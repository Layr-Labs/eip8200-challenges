...
def blk2896a :
  ...
  [opAt 1766 .JUMPDEST,
   opAt 1767 (.Dup ⟨0, by decide⟩),
   opAt 1768 .MLOAD,
   opAt 1769 .NOT,
   opAt 1770 (.Dup ⟨2, by decide⟩),
   opAt 1771 .ADD,
   opAt 1772 (.Dup ⟨0, by decide⟩),
   opAt 1773 (.Swap ⟨2, by decide⟩),
   opAt 1774 .GT,
   opAt 1775 (.Swap ⟨1, by decide⟩),
   opAt 1776 (.Dup ⟨1, by decide⟩),
   pushAt 1777 2 1280,
   opAt 1778 .ADD,
   opAt 1779 .MSTORE]
