...
opaque gasSteps_entry (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (outState s (mpZeroed s mem n) pa pb n 0
        ...
        (MachineState.readWord mem 2880 :: MachineState.readWord mem 96 :: MachineState.readWord mem 64 :: MachineState.readWord mem 32 :: UInt256.ofNat (pa+32*n-32) :: pdst :: ret :: rest)) :=
...
opaque gasSteps_mid (s : State) (mem : ByteArray) (c bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (l2At 4516 s (midMem mem c) bi (rowMu mem n)
...
opaque gasSteps_l1Last (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  l1Mac7.steps (environment (l1At 4511 s mem bi pa pb n i (n-1) pdst ret rest) hcode hfork hrun hnp) rfl
    (run_l1Last 2112 s mem bi pa pb n i pdst ret rest hcap hact hn32 hpos (by decide) hpa hpaFit)
...
opaque gasSteps_l1Dispatch8 (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (l1At 4291 s mem bi pa pb 8 i j pdst ret rest) :=
  ...
  (l1Join8.steps (environment (l1At 4204 s mem bi pa pb 8 i j pdst ret rest) hcode hfork hrun hnp) rfl
...
opaque gasSteps_l1Join (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    (hnp : Precompile.isPrecompileWithConfig s.executionEnv.precompileConfig
      s.executionEnv.fork s.executionEnv.codeAddr = false) :
    Challenge.EvmProof.GasSteps
      (l1At 4356 s mem bi pa pb n i j pdst ret rest)
      (l1At 4444 s mem bi pa pb n i j pdst ret rest) :=
  l1Join.steps (environment (l1At 4356 s mem bi pa pb n i j pdst ret rest) hcode hfork hrun hnp) rfl
