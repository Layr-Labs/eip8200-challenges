...
opaque gasSteps_l2Last (s : State) (mem : ByteArray) (bi mu c0 : UInt256)
    ...
    (hn32 : n ≤ 32) (hk : k+1 < n) :
    Challenge.EvmProof.GasSteps
      (l2At 4966 s mem bi mu c0 pa pb n i k pdst ret rest)
  ...
  l2Mac6.steps (environment (l2At 4966 s mem bi mu c0 pa pb n i k pdst ret rest)
    hcode hfork hrun hnp) rfl (by
      have h := CiosCachedL2LastRun.run_step s (UInt256.ofNat 4966) mem bi mu c0 n k
