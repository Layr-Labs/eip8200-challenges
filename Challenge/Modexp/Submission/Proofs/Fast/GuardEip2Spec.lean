...
/-- EIP-198 example 2 exponent (`2^256 - 0x1000003d2`), as the calldata word. -/
def exponent : Nat :=
  115792089237316195423570985008687907853269984665640564039457584007908834671662
/-- EIP-198 example 2 modulus (`2^256 - 0x1000003d1`), as the calldata word. -/
def modulus : Nat :=
...
/-- Empty base and positive exponent: `0^e mod m = 0`. -/
