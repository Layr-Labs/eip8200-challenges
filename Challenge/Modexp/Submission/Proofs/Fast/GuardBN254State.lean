...
namespace Challenge.Modexp.Submission.Proofs.Fast.GuardBN254State

open EvmSemantics
open EvmSemantics.EVM
open Challenge.Modexp.Submission.Proofs.Bytecode
open GuardBN254Logic
...
def jumpStackState (input : ByteArray) (condition : UInt256) : State :=
  { initialState submissionBytecode input 0 with
      pc := UInt256.ofNat 5178
      stack := [UInt256.ofNat 5183, condition] }
...
def chunk0 := GuardBN254Data.checks.take 3
def chunk1 := GuardBN254Data.checks.drop 3
...
end Challenge.Modexp.Submission.Proofs.Fast.GuardBN254State
