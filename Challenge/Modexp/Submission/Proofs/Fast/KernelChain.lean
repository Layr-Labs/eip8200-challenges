...
def gasSteps_l1Step (k : Nat) (hk1 : 1 ≤ k) (hk7 : k ≤ 7)
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (3742 + 37 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q (3742 + 37 * k) s (SquareModel.l1StepOn q bi pa n j) bi pb n i hd ent pdst ret rest) := by
  ...
  interval_cases k
  · exact l1Block1.steps (environment (l1Q 3742 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3742 192 2304 (by decide) (by decide))
  · exact l1Block2.steps (environment (l1Q 3779 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3779 160 2272 (by decide) (by decide))
  · exact l1Block3.steps (environment (l1Q 3816 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3816 128 2240 (by decide) (by decide))
  · exact l1Block4.steps (environment (l1Q 3853 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3853 96 2208 (by decide) (by decide))
  · exact l1Block5.steps (environment (l1Q 3890 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3890 64 2176 (by decide) (by decide))
  · exact l1Block6.steps (environment (l1Q 3927 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3927 32 2144 (by decide) (by decide))
  · exact l1Block7.steps (environment (l1Q 3964 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3964 0 2112 (by decide) (by decide))
...
def gasSteps_l1Run : (m k : Nat) → 1 ≤ k → k + m = 8 →
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (3742 + 37 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q 4001 s (SquareModel.l1Run q bi pa n j m) bi pb n i hd ent pdst ret rest)
...
def gasSteps_l1SuffixMul (k : Nat) (hk1 : 1 ≤ k) (hk8 : k ≤ 8)
    ...
    Challenge.EvmProof.GasSteps
      (l1At (3742 + 37 * (k - 1)) s mem bi pa pb n i j hd ent pdst ret rest)
