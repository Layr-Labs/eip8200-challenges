...
def gasSteps_l1Step (k : Nat) (hk1 : 1 ≤ k) (hk7 : k ≤ 7)
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (4072 + 38 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q (4072 + 38 * k) s (SquareModel.l1StepOn q bi pa n j) bi pb n i hd ent pdst ret rest) := by
  ...
  interval_cases k
  · exact l1Block1.steps (environment (l1Q 4072 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4072 192 8448 (by decide) (by decide))
  · exact l1Block2.steps (environment (l1Q 4110 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4110 160 8416 (by decide) (by decide))
  · exact l1Block3.steps (environment (l1Q 4148 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4148 128 8384 (by decide) (by decide))
  · exact l1Block4.steps (environment (l1Q 4186 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4186 96 8352 (by decide) (by decide))
  · exact l1Block5.steps (environment (l1Q 4224 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4224 64 8320 (by decide) (by decide))
  · exact l1Block6.steps (environment (l1Q 4262 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4262 32 8288 (by decide) (by decide))
  · exact l1Block7.steps (environment (l1Q 4300 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4300 0 8256 (by decide) (by decide))
...
def gasSteps_l1Run : (m k : Nat) → 1 ≤ k → k + m = 8 →
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (4072 + 38 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q 4338 s (SquareModel.l1Run q bi pa n j m) bi pb n i hd ent pdst ret rest)
...
def gasSteps_l1SuffixMul (k : Nat) (hk1 : 1 ≤ k) (hk8 : k ≤ 8)
    ...
    Challenge.EvmProof.GasSteps
      (l1At (4072 + 38 * (k - 1)) s mem bi pa pb n i j hd ent pdst ret rest)
