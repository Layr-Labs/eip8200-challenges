...
def gasSteps_l1Step (k : Nat) (hk1 : 1 ≤ k) (hk7 : k ≤ 7)
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (3752 + 37 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q (3752 + 37 * k) s (SquareModel.l1StepOn q bi pa n j) bi pb n i hd ent pdst ret rest) := by
  ...
  interval_cases k
  · exact l1Block1.steps (environment (l1Q 3752 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3752 192 2304 (by decide) (by decide))
  · exact l1Block2.steps (environment (l1Q 3789 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3789 160 2272 (by decide) (by decide))
  · exact l1Block3.steps (environment (l1Q 3826 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3826 128 2240 (by decide) (by decide))
  · exact l1Block4.steps (environment (l1Q 3863 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3863 96 2208 (by decide) (by decide))
  · exact l1Block5.steps (environment (l1Q 3900 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3900 64 2176 (by decide) (by decide))
  · exact l1Block6.steps (environment (l1Q 3937 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3937 32 2144 (by decide) (by decide))
  · exact l1Block7.steps (environment (l1Q 3974 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 3974 0 2112 (by decide) (by decide))
...
def gasSteps_l1Run : (m k : Nat) → 1 ≤ k → k + m = 8 →
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (3752 + 37 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q 4011 s (SquareModel.l1Run q bi pa n j m) bi pb n i hd ent pdst ret rest)
...
def gasSteps_l1SuffixMul (k : Nat) (hk1 : 1 ≤ k) (hk8 : k ≤ 8)
    ...
    Challenge.EvmProof.GasSteps
      (l1At (3752 + 37 * (k - 1)) s mem bi pa pb n i j hd ent pdst ret rest)
