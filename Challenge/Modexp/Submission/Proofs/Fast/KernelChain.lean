...
def gasSteps_l1Step (k : Nat) (hk1 : 1 ≤ k) (hk7 : k ≤ 7)
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (4049 + 38 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q (4049 + 38 * k) s (SquareModel.l1StepOn q bi pa n j) bi pb n i hd ent pdst ret rest) := by
  ...
  interval_cases k
  · exact l1Block1.steps (environment (l1Q 4049 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4049 192 8448 (by decide) (by decide))
  · exact l1Block2.steps (environment (l1Q 4087 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4087 160 8416 (by decide) (by decide))
  · exact l1Block3.steps (environment (l1Q 4125 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4125 128 8384 (by decide) (by decide))
  · exact l1Block4.steps (environment (l1Q 4163 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4163 96 8352 (by decide) (by decide))
  · exact l1Block5.steps (environment (l1Q 4201 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4201 64 8320 (by decide) (by decide))
  · exact l1Block6.steps (environment (l1Q 4239 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4239 32 8288 (by decide) (by decide))
  · exact l1Block7.steps (environment (l1Q 4277 s q bi pb n i hd ent pdst ret rest)
      hcode hfork hrun hnp) rfl (hrunQ 4277 0 8256 (by decide) (by decide))
...
def gasSteps_l1Run : (m k : Nat) → 1 ≤ k → k + m = 8 →
    ...
    Challenge.EvmProof.GasSteps
      (l1Q (4049 + 38 * (k - 1)) s q bi pb n i hd ent pdst ret rest)
      (l1Q 4315 s (SquareModel.l1Run q bi pa n j m) bi pb n i hd ent pdst ret rest)
...
def gasSteps_l1SuffixMul (k : Nat) (hk1 : 1 ≤ k) (hk8 : k ≤ 8)
    ...
    Challenge.EvmProof.GasSteps
      (l1At (4049 + 38 * (k - 1)) s mem bi pa pb n i j hd ent pdst ret rest)
