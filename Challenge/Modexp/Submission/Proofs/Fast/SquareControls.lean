...
def target (delta : UInt256) : UInt256 :=
  UInt256.ofNat 4504 - UInt256.ofNat 38 * UInt256.shiftRight delta (UInt256.ofNat 5)
...
theorem run_guard (s : State) (c ai pbi pa pb delta : UInt256) (rest : List UInt256)
    ...
    (hjump : Decode.isValidJumpDest s.executionEnv.code 5290 = true) :
    runInstructions guardProgram
      (framed s (UInt256.ofNat 5225) ([c,ai,pbi,pa,pb,delta] ++ rest)) =
    some (framed s (if UInt256.isTrue (UInt256.isZero delta) then UInt256.ofNat 5290 else UInt256.ofNat 5231)
...
theorem run_dispatch (s : State) (c ai pbi pa pb delta : UInt256) (rest : List UInt256)
    ...
    runInstructions dispatchProgram
      (framed s (UInt256.ofNat 5278) ([c,ai,pbi,pa,pb,delta] ++ rest)) =
  ...
  have h4499 : (4504 : UInt256) = UInt256.ofNat 4504 := by decide
...
theorem run_last (s : State) (mem : ByteArray) (c ai : UInt256) (rest : List UInt256)
    ...
    (hjump : Decode.isValidJumpDest s.executionEnv.code 4493 = true) :
    runInstructions lastProgram (stateAt s mem 5290 (c :: ai :: rest)) =
      some (stateAt s (storeWord mem 8224 (MachineState.readWord mem 8224+c)) 4493
...
theorem run_mu (s : State) (mem : ByteArray) (f ai : UInt256) (rest : List UInt256)
    ...
    runInstructions muProgram (stateAt s mem 4493 (f :: ai :: rest)) =
      some (stateAt s mem 4496 (f :: rest)) := by
  have hc2 : rest.length+2 < 1024 := by omega
...
def guardBlock : Block Artifact.submissionArtifact .Osaka 5225 guardProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3953 4 5225 guardProgram
    (by decide) (by rfl) (by rfl) (by decide)
def dispatchBlock : Block Artifact.submissionArtifact .Osaka 5278 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3997 8 5278 dispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
def lastBlock : Block Artifact.submissionArtifact .Osaka 5290 lastProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4005 11 5290 lastProgram
    (by decide) (by rfl) (by rfl) (by decide)
def muBlock : Block Artifact.submissionArtifact .Osaka 4493 muProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3417 3 4493 muProgram
    (by decide) (by rfl) (by rfl) (by decide)

theorem target_index (i : Nat) (hi : i < 7) :
    target (UInt256.ofNat (32*(7-i))) = UInt256.ofNat (4162+38*(i+2)) := by
