...
def guardBlock : Block Artifact.submissionArtifact .Osaka 5229 guardProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3968 4 5229 guardProgram
    (by decide) (by rfl) (by rfl) (by decide)
def dispatchBlock : Block Artifact.submissionArtifact .Osaka 5282 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4012 8 5282 dispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
def lastBlock : Block Artifact.submissionArtifact .Osaka 5294 lastProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4020 11 5294 lastProgram
    (by decide) (by rfl) (by rfl) (by decide)
def muBlock : Block Artifact.submissionArtifact .Osaka 4497 muProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3425 3 4497 muProgram
    (by decide) (by rfl) (by rfl) (by decide)
