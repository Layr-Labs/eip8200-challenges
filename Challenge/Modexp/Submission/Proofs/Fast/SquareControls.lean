...
def guardBlock : Block Artifact.submissionArtifact .Osaka 5229 guardProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3969 4 5229 guardProgram
    (by decide) (by rfl) (by rfl) (by decide)
def dispatchBlock : Block Artifact.submissionArtifact .Osaka 5282 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4013 8 5282 dispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
def lastBlock : Block Artifact.submissionArtifact .Osaka 5294 lastProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4021 11 5294 lastProgram
    (by decide) (by rfl) (by rfl) (by decide)
