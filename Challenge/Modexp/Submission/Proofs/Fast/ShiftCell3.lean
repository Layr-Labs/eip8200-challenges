...
@[simp] private theorem compactLoopPC2758 : Artifact.submissionArtifact.instructionPC 2457 = 3274 := by rfl
@[simp] private theorem compactLoopPC2759 : Artifact.submissionArtifact.instructionPC 2458 = 3277 := by rfl
@[simp] private theorem compactLoopPC2760 : Artifact.submissionArtifact.instructionPC 2458 = 3277 := by rfl
@[simp] private theorem compactLoopPC2761 : Artifact.submissionArtifact.instructionPC 2458 = 3277 := by rfl
@[simp] private theorem compactLoopPC2762 : Artifact.submissionArtifact.instructionPC 2459 = 3278 := by rfl
@[simp] private theorem compactLoopPC2763 : Artifact.submissionArtifact.instructionPC 2460 = 3279 := by rfl
@[simp] private theorem compactLoopPC2764 : Artifact.submissionArtifact.instructionPC 2461 = 3280 := by rfl
@[simp] private theorem compactLoopPC2765 : Artifact.submissionArtifact.instructionPC 2462 = 3281 := by rfl
@[simp] private theorem compactLoopPC2766 : Artifact.submissionArtifact.instructionPC 2463 = 3282 := by rfl
@[simp] private theorem compactLoopPC2767 : Artifact.submissionArtifact.instructionPC 2464 = 3283 := by rfl
@[simp] private theorem compactLoopPC2768 : Artifact.submissionArtifact.instructionPC 2465 = 3284 := by rfl
@[simp] private theorem compactLoopPC2769 : Artifact.submissionArtifact.instructionPC 2466 = 3285 := by rfl
@[simp] private theorem compactLoopPC2770 : Artifact.submissionArtifact.instructionPC 2467 = 3286 := by rfl
@[simp] private theorem compactLoopPC2771 : Artifact.submissionArtifact.instructionPC 2468 = 3287 := by rfl
@[simp] private theorem compactLoopPC2772 : Artifact.submissionArtifact.instructionPC 2469 = 3288 := by rfl
@[simp] private theorem compactLoopPC2773 : Artifact.submissionArtifact.instructionPC 2470 = 3289 := by rfl
@[simp] private theorem compactLoopPC2774 : Artifact.submissionArtifact.instructionPC 2471 = 3290 := by rfl
@[simp] private theorem compactLoopPC2775 : Artifact.submissionArtifact.instructionPC 2472 = 3291 := by rfl
@[simp] private theorem compactLoopPC2776 : Artifact.submissionArtifact.instructionPC 2473 = 3292 := by rfl
@[simp] private theorem compactLoopPC2777 : Artifact.submissionArtifact.instructionPC 2474 = 3293 := by rfl
@[simp] private theorem compactLoopPC2778 : Artifact.submissionArtifact.instructionPC 2475 = 3294 := by rfl
@[simp] private theorem compactLoopPC2779 : Artifact.submissionArtifact.instructionPC 2476 = 3295 := by rfl
@[simp] private theorem compactLoopPC2780 : Artifact.submissionArtifact.instructionPC 2477 = 3296 := by rfl
@[simp] private theorem compactLoopPC2781 : Artifact.submissionArtifact.instructionPC 2478 = 3297 := by rfl
@[simp] private theorem compactLoopPC2782 : Artifact.submissionArtifact.instructionPC 2479 = 3298 := by rfl
@[simp] private theorem compactLoopPC2783 : Artifact.submissionArtifact.instructionPC 2480 = 3299 := by rfl
@[simp] private theorem compactLoopPC2784 : Artifact.submissionArtifact.instructionPC 2481 = 3300 := by rfl
@[simp] private theorem compactLoopPC2785 : Artifact.submissionArtifact.instructionPC 2482 = 3301 := by rfl
@[simp] private theorem compactLoopPC2786 : Artifact.submissionArtifact.instructionPC 2483 = 3302 := by rfl
@[simp] private theorem compactLoopPC2787 : Artifact.submissionArtifact.instructionPC 2484 = 3303 := by rfl
@[simp] private theorem compactLoopPC2788 : Artifact.submissionArtifact.instructionPC 2485 = 3304 := by rfl
@[simp] private theorem compactLoopPC2789 : Artifact.submissionArtifact.instructionPC 2486 = 3305 := by rfl
@[simp] private theorem compactLoopPC2790 : Artifact.submissionArtifact.instructionPC 2487 = 3306 := by rfl
@[simp] private theorem compactLoopPC2791 : Artifact.submissionArtifact.instructionPC 2488 = 3307 := by rfl
@[simp] private theorem compactLoopPC2792 : Artifact.submissionArtifact.instructionPC 2489 = 3308 := by rfl
@[simp] private theorem compactLoopPC2793 : Artifact.submissionArtifact.instructionPC 2490 = 3309 := by rfl
@[simp] private theorem compactLoopPC2794 : Artifact.submissionArtifact.instructionPC 2491 = 3310 := by rfl
@[simp] private theorem compactLoopPC2795 : Artifact.submissionArtifact.instructionPC 2492 = 3311 := by rfl
...
def cellPath :
  ...
  [opAt 2456 .JUMPDEST,
   ...
   opAt 2462 (.Dup ⟨6, by decide⟩),
   opAt 2463 (.Dup ⟨2, by decide⟩),
   opAt 2464 .MUL,
   opAt 2465 (.Swap ⟨1, by decide⟩),
   opAt 2466 (.Dup ⟨7, by decide⟩),
   opAt 2467 .MULMOD,
   opAt 2468 (.Dup ⟨1, by decide⟩),
   opAt 2469 (.Dup ⟨1, by decide⟩),
   opAt 2470 .LT,
   opAt 2471 .SUB,
   opAt 2472 (.Dup ⟨5, by decide⟩),
   opAt 2473 (.Dup ⟨2, by decide⟩),
   opAt 2474 .ADD,
   opAt 2475 (.Dup ⟨0, by decide⟩),
   opAt 2476 (.Swap ⟨6, by decide⟩),
   opAt 2477 .GT,
   opAt 2478 .SUB,
   opAt 2479 .SUB,
   opAt 2480 (.Dup ⟨4, by decide⟩),
   opAt 2481 (.Dup ⟨2, by decide⟩),
   opAt 2482 .MLOAD,
   opAt 2483 .ADD,
   opAt 2484 (.Dup ⟨0, by decide⟩),
   opAt 2485 (.Swap ⟨5, by decide⟩),
   opAt 2486 .GT,
   opAt 2487 .ADD,
   opAt 2488 (.Swap ⟨3, by decide⟩),
   opAt 2489 (.Dup ⟨1, by decide⟩),
   opAt 2490 .MSTORE,
   opAt 2491 (.Dup ⟨2, by decide⟩),
   opAt 2492 .ADD]

@[simp] private theorem cellStartPC : Artifact.submissionArtifact.instructionPC 2456 = 3273 := by rfl
...
theorem run_cell3 (s : State) (um : ByteArray) (q pa pt pa' pt' : UInt256)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock cellPath
      ...
      some { s with pc := UInt256.ofNat 3312
