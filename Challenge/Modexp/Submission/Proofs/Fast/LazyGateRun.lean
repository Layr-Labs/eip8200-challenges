...
def program : List Instr :=
  [.op .JUMPDEST, .push 2 2080, .op .MLOAD, .push 2 4240, .op .JUMPI]
...
theorem run_gate (s : State) (mem : ByteArray) (dst ret : UInt256) (rest : List UInt256)
    ...
    runInstructions program (atState s mem 4443 dst ret rest) =
      some (atState s mem
  ...
  have h4491 : (4240 : UInt256).toNat = 4244 := by decide
  have heq4491 : (4240 : UInt256) = UInt256.ofNat 4240 := by decide
