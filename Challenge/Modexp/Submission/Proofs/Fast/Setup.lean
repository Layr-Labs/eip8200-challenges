...
def setupPathD :
  ...
  [pushAt 1125 0 0, opAt 1126 .SUB, pushAt 1127 2 9376, opAt 1128 .MSTORE,
   ...
   opAt 1133 .MSTORE, pushAt 1134 2 4537, pushAt 1135 2 4096,
   pushAt 1136 2 2897, opAt 1137 .JUMP]
...
def setupExitState (s : State) (input : ByteArray) (m0 : Nat) : State :=
  { s with pc := UInt256.ofNat 2897
           stack := UInt256.ofNat 4096 :: UInt256.ofNat 4537 :: outerStack input
...
theorem fastSetupState_pc (input : ByteArray) :
    (fastSetupState input).pc = UInt256.ofNat 2897 := rfl

theorem fastSetupState_stack (input : ByteArray) :
    (fastSetupState input).stack =
      UInt256.ofNat 4096 :: UInt256.ofNat 4537 :: outerStack input := rfl
