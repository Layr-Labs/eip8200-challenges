...
def dispatchBlock : Block Artifact.submissionArtifact .Osaka 4512 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3436 2 4512 dispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
theorem jump_entry : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4514 = true :=
...
def state (s : State) (mem : ByteArray) (f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret : UInt256)
  ...
  CiosCachedL2.state s (UInt256.ofNat pc) mem f mu c0 8 k pbi pa pb tag (UInt256.ofNat 4514) inv
...
theorem run_dispatch (s : State) (mem : ByteArray) (f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret : UInt256)
    ...
    (hjump : Decode.isValidJumpDest s.executionEnv.code 4514 = true) :
    runInstructions dispatchProgram (state s mem f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret rest 4512 0) =
      some (state s mem f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret rest 4514 0) := by
...
def gasSteps_loops (s : State) (mem : ByteArray) (f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (state s mem f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret rest 4512 0)
      (state s mem f mu c0 pbi pa pb tag tl inv m0 aEnd m96 m64 m32 dst ret rest 4761 7) := by
  ...
  have fixed (pc k : Nat) (w : Fin 33) (x loadAddr storeAddr : UInt256)
    ...
    have h := CiosCachedL2.run_step w s (UInt256.ofNat pc) mem f mu c0 8 k x loadAddr storeAddr
      hx hl hs pbi pa pb tag (UInt256.ofNat 4514) inv
  ...
  have extra (pc k : Nat) (slot : Fin 3) (x loadAddr storeAddr : UInt256)
    ...
    have h := CiosReadonlyExtra.run_extraStep slot s (UInt256.ofNat pc) mem f mu c0 8 k x loadAddr storeAddr
      hx hx' hl hs pbi pa pb tag (UInt256.ofNat 4514) tl inv m0 aEnd m96 m64 m32 dst ret rest hcap hact
      (by decide) hk hc
    simpa only [S, state, Challenge.EvmProof.Word.ofNat_add_mod] using h
  have hd : Challenge.EvmProof.GasSteps (S 4512 0) (S 4514 0) :=
  ...
  have hdj : Challenge.EvmProof.GasSteps (S 4514 0) (S 4515 0) := by
    let block : Block Artifact.submissionArtifact .Osaka 4514 joinProgram :=
      WindowTwentyOneSlice.block Artifact.allWellFormed 3438 1 4514 joinProgram
        (by decide) (by rfl) (by rfl) (by decide)
    apply block.steps (s := S 4514 0) (env.transfer rfl rfl) rfl
  ...
  have hj : Challenge.EvmProof.GasSteps (S 4657 4) (S 4658 4) := by
    apply CarryRowBlocks.l2Join.steps (s := S 4657 4) (env.transfer rfl rfl) rfl
...
(fixed 4515 0 1 192 2304 2336 CarryRowBlocks.l2Mac0 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    (fixed 4551 1 1 160 2272 2304 CarryRowBlocks.l2Mac1 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    (fixed 4587 2 1 128 2240 2272 CarryRowBlocks.l2Mac2 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    (extra 4623 3 0 96 2208 2240 CarryRowBlocks.l2Mac3 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    hj.trans <|
    (extra 4658 4 1 64 2176 2208 CarryRowBlocks.l2Mac4 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    (extra 4692 5 2 32 2144 2176 CarryRowBlocks.l2Mac5 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
    fixed 4726 6 0 0 2112 2144 CarryRowBlocks.l2Mac6 (by decide) (by decide) (by decide) (by decide) (by decide)
