...
def dispatchBlock : Block Artifact.submissionArtifact .Osaka 4516 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3444 2 4516 dispatchProgram
...
(fixed 4519 0 1 192 8448 8480 CarryRowBlocks.l2Mac0 (by decide) (by decide) (by decide) (by decide) (by decide)).trans <|
