...
theorem run_cleanup (s : State) (c : CachedMemory) (r : ReadOnlyCache)
    ...
    runInstructions CiosStackCachePrograms.tailCleanup
      (framed s (UInt256.ofNat 5206) ([carry, mu, bi] ++ rowFrame c r pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 5209) ([carry] ++ rowFrame c r pbi paEnd pbEnd flag dst ret rest)) := by
...
theorem run_loadHead (s : State) (c : CachedMemory) (r : ReadOnlyCache)
    ...
    runInstructions loadHead
      (framed s (UInt256.ofNat 5209) ([carry] ++ rowFrame c r pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 5215) ([MachineState.readWord s.memory 8224 + carry, carry] ++ rowFrame c r pbi paEnd pbEnd flag dst ret rest)) := by
  have h16 : rest.length+16 < 1024 := by omega
  have h17 : rest.length+17 < 1024 := by omega
  have h18 : rest.length+18 < 1024 := by omega
  have h19 : rest.length+19 < 1024 := by omega
...
theorem run_storeCached (s : State) (c : CachedMemory) (r : ReadOnlyCache)
    ...
    runInstructions storeCached
      (framed s (UInt256.ofNat 5215) ([sum, carry] ++ rowFrame c r pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 5218) ([sum, carry] ++ rowFrame (c.write 8256 sum) r pbi paEnd pbEnd flag dst ret rest)) := by
  have h16 : rest.length+16 < 1024 := by omega
  have h17 : rest.length+17 < 1024 := by omega
  have h18 : rest.length+18 < 1024 := by omega
  have h19 : rest.length+19 < 1024 := by omega
...
theorem run_storeHigh (s : State) (c : CachedMemory) (r : ReadOnlyCache)
    ...
    runInstructions storeHigh
      (framed s (UInt256.ofNat 5218) ([sum, carry] ++ rowFrame c r pbi paEnd pbEnd flag dst ret rest)) =
    some (framed { s with memory := storeWord s.memory 8224 (MachineState.readWord s.memory 8192 + UInt256.lt sum carry) } (UInt256.ofNat 5228) (rowFrame c r pbi paEnd pbEnd flag dst ret rest)) := by
  have h16 : rest.length+16 < 1024 := by omega
  have h17 : rest.length+17 < 1024 := by omega
  have h18 : rest.length+18 < 1024 := by omega
  have h19 : rest.length+19 < 1024 := by omega
...
theorem run_test (s : State) (c : CachedMemory) (r : ReadOnlyCache)
    ...
    (rest : List UInt256) (hcap : rest.length ≤ 998) (htarget : Decode.isValidJumpDest s.executionEnv.code 4620 = true) :
    runInstructions CiosStackCachePrograms.tailTest
      (framed s (UInt256.ofNat 5228) (rowFrame c r pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (if UInt256.isTrue (UInt256.gt (negative32+pbi) pbEnd) then UInt256.ofNat 4620 else UInt256.ofNat 5237) (rowFrame c r (negative32+pbi) paEnd pbEnd flag dst ret rest)) := by
  have h16 : rest.length+16 < 1024 := by omega
  have h17 : rest.length+17 < 1024 := by omega
  have h18 : rest.length+18 < 1024 := by omega
  have h19 : rest.length+19 < 1024 := by omega
...
theorem run_store (s : State) (c : CachedMemory) (r : ReadOnlyCache)
    ...
    runInstructions CiosStackCachePrograms.tailStore
      (framed { s with memory := c.memory } (UInt256.ofNat 5209)
