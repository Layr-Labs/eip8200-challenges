...
theorem read_product_outside (mem : ByteArray) (ai : UInt256) (i addr : Nat)
    (hi : i ≤ 4) (hd : addr+32 ≤ 8256 ∨ 8384 ≤ addr) :
...
theorem read_mid_outside (mem : ByteArray) (ai : UInt256) (i addr : Nat)
    (hi : i ≤ 4) (hd : addr+32 ≤ 8224 ∨ 8384 ≤ addr) :
...
theorem represents_mid (mem : ByteArray) (ai : UInt256) (i ptr count v : Nat)
    (hi : i ≤ 4) (hd : ptr+32*count ≤ 8224 ∨ 8384 ≤ ptr)
...
theorem low_mid (mem : ByteArray) (ai : UInt256) (i : Nat) :
    Csub.lowValue (mid mem ai i) 8256 4 4 = low (product mem ai i).memory := by
...
theorem extra_toNat (mem : ByteArray) (a : Nat) (ai : UInt256) (i : Nat)
    (hd : Model.FastRepresents mem 8928 5 (2*a)) (ha : a < Limbs.radix^4)
    (hi : i < 4) :
...
theorem row_equation (mem : ByteArray) (a m : Nat) (ai : UInt256) (i : Nat)
  ...
  rw [top] at red
  have hlow : low mem = Csub.lowValue mem 8256 4 4 := limbSum_eq_lowValue mem 8256 4 4
  have heq : low (product mem ai i).memory +
    ...
    calc
      ...
      _ = _ := by rw [coeff]
  calc
    _ = (MachineState.readWord mem 8224).toNat*Limbs.radix^4 +
