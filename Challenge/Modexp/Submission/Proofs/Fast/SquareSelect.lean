...
def normalProgram : List Instr :=
  [.push 0 0, .push 2 8928, .op .MSTORE, .push 2 4173, .push 2 5031, .op .JUMP]
...
def checkBlock : Block Artifact.submissionArtifact .Osaka 5007 checkProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3815 6 5007 checkProgram
    (by decide) (by rfl) (by rfl) (by decide)
def normalBlock : Block Artifact.submissionArtifact .Osaka 5015 normalProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3821 6 5015 normalProgram
    (by decide) (by rfl) (by rfl) (by decide)
def squareBlock : Block Artifact.submissionArtifact .Osaka 5027 squareProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3827 2 5027 squareProgram
    (by decide) (by rfl) (by rfl) (by decide)
def storeBlock : Block Artifact.submissionArtifact .Osaka 5031 storeProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3829 5 5031 storeProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
theorem run_normal (s : State) (mem : ByteArray) (rest : List UInt256)
    ...
    runInstructions normalProgram (stateAt s mem 5015 rest) =
      some (stateAt s (storeWord mem 8928 (UInt256.ofNat 0)) 5031
...
def selectedMemory (mem : ByteArray) (pa pb : UInt256) : ByteArray :=
  if UInt256.isTrue (guard mem pa pb) then storeWord mem 9280 (UInt256.ofNat 5040)
...
def gasSteps_select (s : State) (mem : ByteArray) (pa pb dst ret : UInt256)
  ...
  · rw [if_neg hs] at check
    ...
    have put := storeBlock.steps (EarlyCsub.environment (stateAt s (storeWord mem 8928 (UInt256.ofNat 0)) 5031 (UInt256.ofNat 4173 :: args)) hcode hfork hrun hnp) rfl
