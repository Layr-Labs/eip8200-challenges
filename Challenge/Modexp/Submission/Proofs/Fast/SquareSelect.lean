...
def normalProgram : List Instr :=
  [.push 0 0, .push 2 2368, .op .MSTORE, .push 2 4173, .push 2 5040, .op .JUMP]
...
def checkBlock : Block Artifact.submissionArtifact .Osaka 5007 checkProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3817 11 5007 checkProgram
    (by decide) (by rfl) (by rfl) (by decide)
def normalBlock : Block Artifact.submissionArtifact .Osaka 5024 normalProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3828 6 5024 normalProgram
    (by decide) (by rfl) (by rfl) (by decide)
def squareBlock : Block Artifact.submissionArtifact .Osaka 5036 squareProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3834 2 5036 squareProgram
    (by decide) (by rfl) (by rfl) (by decide)
def storeBlock : Block Artifact.submissionArtifact .Osaka 5040 storeProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3836 5 5040 storeProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
theorem run_normal (s : State) (mem : ByteArray) (rest : List UInt256)
    ...
    runInstructions normalProgram (stateAt s mem 5024 rest) =
      some (stateAt s (storeWord mem 2368 (UInt256.ofNat 0)) 5040
...
def selectedMemory (mem : ByteArray) (pa pb : UInt256) : ByteArray :=
  if UInt256.isTrue (guard mem pa pb) then storeWord mem 2720 (UInt256.ofNat 5049)
...
def gasSteps_select (s : State) (mem : ByteArray) (pa pb dst ret : UInt256)
  ...
  · rw [if_neg hs] at check
    ...
    have put := storeBlock.steps (EarlyCsub.environment (stateAt s (storeWord mem 2368 (UInt256.ofNat 0)) 5040 (UInt256.ofNat 4173 :: args)) hcode hfork hrun hnp) rfl
