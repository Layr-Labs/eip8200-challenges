...
def normalProgram : List Instr :=
  [.push 0 0, .push 2 8928, .op .MSTORE, .push 2 4169, .push 2 5036, .op .JUMP]
...
theorem run_normal (s : State) (mem : ByteArray) (rest : List UInt256)
    ...
    runInstructions normalProgram (stateAt s mem 5020 rest) =
      some (stateAt s (storeWord mem 8928 (UInt256.ofNat 0)) 5036
...
def selectedMemory (mem : ByteArray) (pa pb : UInt256) : ByteArray :=
  if UInt256.isTrue (guard mem pa pb) then storeWord mem 9280 (UInt256.ofNat 5045)
  else storeWord (storeWord mem 8928 (UInt256.ofNat 0)) 9280 (UInt256.ofNat 4169)
...
def gasSteps_select (s : State) (mem : ByteArray) (pa pb dst ret : UInt256)
  ...
  · rw [if_neg hs] at check
    ...
    have put := storeBlock.steps (EarlyCsub.environment (stateAt s (storeWord mem 8928 (UInt256.ofNat 0)) 5036 (UInt256.ofNat 4169 :: args)) hcode hfork hrun hnp) rfl
      (run_store s (storeWord mem 8928 (UInt256.ofNat 0)) (UInt256.ofNat 4169)
