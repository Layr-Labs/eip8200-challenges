...
structure RowLemmas : Type where
  ...
  gasSteps_out : ∀ (s : State) (mem : ByteArray) (pb n i : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s mem pb n i (UInt256.ofNat 3358) ent pdst ret rest)
      (firstAt 3361 s mem (rowBi mem pb n i) pb n i (UInt256.ofNat 3358) ent pdst ret rest)
  ...
  gasSteps_commonFirst : ∀ (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (firstAt 3361 s mem bi pb n i hd ent inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: pdst :: ret :: rest))
      (l1At 3385 s mem bi pa pb n i 1 hd ent inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: pdst :: ret :: rest))
  ...
  gasSteps_l1MulFour : ∀ (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 3385 s mem bi pa pb 4 i 1 hd (l1Target 4) pdst ret rest)
      (midStateAt 5290 s (l1Step mem bi pa 4 4).memory (l1Step mem bi pa 4 4).carry bi
  ...
  gasSteps_l1MulEight : ∀ (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 3385 s mem bi pa pb 8 i 1 hd (l1Target 8) pdst ret rest)
  ...
  the private ladder copy, 5290 -> 5310. -/
  gasSteps_midCopy : ∀ (s : State) (mem : ByteArray) (c bi : UInt256)
    ...
    (hc : CiosReadonly.ReadonlyCache mem n tl inv m0),
    Challenge.EvmProof.GasSteps
      (midStateAt 5290 s mem c bi pb n i hd ent inv m0 (tl :: m96 :: m64 :: m32 :: aEnd :: pdst :: ret :: rest))
...
structure EntryLemmas : Type where
  ...
  gasSteps_mulEntry : ∀ (s : State) (mem : ByteArray) (pa pb : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (Cios2Dispatch.commonState s mem (UInt256.ofNat 3358) pa pb pdst ret rest)
...
theorem jumpDest_rowHead :
  ...
  rw [show (UInt256.ofNat 3358).toNat = 3358 from by decide]
