...
structure EntryLemmas : Type where
  ...
  gasSteps_mulEntry : ∀ (s : State) (mem : ByteArray) (pa pb : Nat)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (Cios2Dispatch.commonState s mem (UInt256.ofNat 4258) pa pb pdst ret rest)
...
theorem jumpDest_rowHead :
  ...
  rw [show (UInt256.ofNat 4258).toNat = 4258 from by decide]
  exact Artifact.isValidJumpDest_index 3184 (by rfl)
