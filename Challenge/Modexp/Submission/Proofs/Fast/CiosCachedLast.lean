...
theorem run_l2Last (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
  ...
  have h := run_stepLast 0 s (UInt256.ofNat 3993) mid bi mu c0 n (n-2) 0 2112 2144
  ...
  have hpc : UInt256.ofNat 3993 + UInt256.ofNat ((0 : Fin 33).val + 33) = UInt256.ofNat 4026 := by
    decide
  rw [hnn, hpc] at h
