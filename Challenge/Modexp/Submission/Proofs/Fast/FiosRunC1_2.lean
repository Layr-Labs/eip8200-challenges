...
theorem run_BodyE_exit (s : State) (mem : ByteArray) (n pa pb : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkFiosBodyE
      ...
      = some (fiosTail s mem n pa pb pdst ret rest i) := by
  ...
  have hix2 : n - 1 = n - 2 + 1 := by omega
  have hfallNat := tFallAddr_mod n hn2 hn32
  have hsNat := storeAddr_mod n (n - 2) hn32 (by omega)
  have hptNat := tAddr_mod n (n - 2) hn32 (by omega)
  have hstepNat := tStepAddr_mod n (n - 2) hn32 (by omega)
  have hix0 : n - (n - 2) - 2 = 0 := by omega
  have hix1 : n - (n - 2) - 1 = 1 := by omega
  have hmod_8288 : (8288) %
      115792089237316195423570985008687907853269984665640564039457584007913129639936
      = 8288 := Nat.mod_eq_of_lt (by omega)
  have hact_8288 : UInt256.ofNat (MachineState.activeWordsAfter
      s.activeWords.toNat (8288) 32) = s.activeWords :=
    Csub.activeWords_fix s _ 32 (by decide) (by omega) hact
  simp (config := { maxSteps := 400000 }) [blkFiosBodyE, opAt, pushAt, wfOp,
    Challenge.EvmProof.Stepper.runLocatedBlock, Challenge.EvmProof.Stepper.runLocated,
    Challenge.EvmProof.Stepper.runInstr, fiosBodyD, fiosTail, fiosBody, bodyFrame,
    rowFrame, bodyW_succ, memAt, c1At, c2At, mAt, aiAt, uAt, nAt, bAt, tAt,
    Monpro.macSum, Monpro.macCarry, Challenge.EvmProof.Word.word_toNat_add, Csub.ptrAt,
    Csub.ptrAt_succ, ofNat_K_step, hfallNat, fastPCFios4, hc1, hc2, hc3, hc4, hc5, hc6, hc7, hc8, hc9, hc10,
    hc11, hc12, hc13, hc14, hc15, hc16, hc17, hc18, hcode, hrun, h32', h5653', h8224',
    h115792089237316195423570985008687907853269984665640564039457584007913129639904',
    h32, h5653, h8224, hjump, jumpDest5653, hix2, hsNat, hptNat, hstepNat, hix0, hix1,
    hmod_8288, hact_8288, UInt256.gt, UInt256.isTrue, State.activeWordsAfterUInt256,
