...
def mid : Block Artifact.submissionArtifact .Osaka 4008 CarryRowPrograms.middleBlock :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3018 24 4008 CarryRowPrograms.middleBlock
    (by decide) (by rfl) (by rfl) (by decide)

def l2Dispatch : Block Artifact.submissionArtifact .Osaka 4036 l2DispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3042 2 4036 l2DispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
