...
def out : Block Artifact.submissionArtifact .Osaka 3520 outProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2619 3 3520 outProgram
    (by decide) (by rfl) (by rfl) (by decide)

def l1Dispatch : Block Artifact.submissionArtifact .Osaka 3547 l1DispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2646 2 3547 l1DispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)

def l1Mac0 : Block Artifact.submissionArtifact .Osaka 3523 CiosReadonly.commonFirstProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2622 24 3523 CiosReadonly.commonFirstProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
def mid : Block Artifact.submissionArtifact .Osaka 3808 CarryRowPrograms.middleBlock :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2865 23 3808 CarryRowPrograms.middleBlock
    (by decide) (by rfl) (by rfl) (by decide)

def l2Dispatch : Block Artifact.submissionArtifact .Osaka 3835 l2DispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2888 2 3835 l2DispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
def l2Mac0 : Block Artifact.submissionArtifact .Osaka 3838 (l2Program 10 192 2304 2336) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2891 30 3838 (l2Program 10 192 2304 2336)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac1 : Block Artifact.submissionArtifact .Osaka 3882 (l2Program 1 160 2272 2304) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2921 30 3882 (l2Program 1 160 2272 2304)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac2 : Block Artifact.submissionArtifact .Osaka 3917 (l2Program 1 128 2240 2272) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2951 30 3917 (l2Program 1 128 2240 2272)
    (by decide) (by rfl) (by rfl) (by decide)

def l2Mac3 : Block Artifact.submissionArtifact .Osaka 3952 (CiosReadonlyExtra.extraProgram 0 2208 2240) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2981 28 3952 (CiosReadonlyExtra.extraProgram 0 2208 2240)
    (by decide) (by rfl) (by rfl) (by decide)
...
def l2Join8 : Block Artifact.submissionArtifact .Osaka 3837 joinProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2890 1 3837 joinProgram
    (by decide) (by rfl) (by rfl) (by decide)
