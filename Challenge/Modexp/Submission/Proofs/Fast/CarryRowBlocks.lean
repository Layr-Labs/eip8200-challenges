...
def l2Mac6 : Block Artifact.submissionArtifact .Osaka 4715 (l2Program 0 0 8256 8288) :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3563 30 4715 (l2Program 0 0 8256 8288)
    (by decide) (by rfl) (by rfl) (by decide)

def tailLoop : Block Artifact.submissionArtifact .Osaka 4750 CarryRowPrograms.tail :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3593 20 4750 CarryRowPrograms.tail
    (by decide) (by rfl) (by rfl) (by decide)

def exitBlock : Block Artifact.submissionArtifact .Osaka 4786 CiosReadonly.fullExitProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3619 16 4786 CiosReadonly.fullExitProgram
    (by decide) (by rfl) (by rfl) (by decide)
