...
theorem run_fallback (input : ByteArray) :
    Challenge.EvmProof.Stepper.runLocatedBlock fallbackPath (branchState input 5139) =
  ...
  simp [fallbackPath, Main.opAt, Main.pushAt, Main.wfOp,
    ...
    fallbackState, Main.trampolineState, branchState, initialState, hjump, guardEip2PC0, guardEip2PC1, guardEip2PC2,
