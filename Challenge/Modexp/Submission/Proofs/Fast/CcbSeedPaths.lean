...
private theorem seedPCAnchor :
    Artifact.submissionArtifact.instructionPC 2484 = 4011 := by rfl

@[simp] theorem seedPC (i : Nat)
    (hi : 2484 ≤ i) (hii : i ≤ 2511) :
    Artifact.submissionArtifact.instructionPC i =
      ([4011,4012,4015,4016,4018,4019,4020,4022,4023,4024,4025,4028,4029,4030,4031,4034,4035,4036,4037,4038,4039,4040,4043,4044,4045,4047,4048,4051] : List Nat)[i - 2484]! := by
