...
private theorem seedPCAnchor :
    Artifact.submissionArtifact.instructionPC 2552 = 3396 := by rfl

@[simp] theorem seedPC (i : Nat)
    (hi : 2552 ≤ i) (hii : i ≤ 2579) :
    Artifact.submissionArtifact.instructionPC i =
      ([3396,3397,3400,3401,3403,3404,3405,3407,3408,3409,3410,3413,3414,3415,3416,3419,3420,3421,3422,3423,3424,3425,3428,3429,3430,3432,3433,3436] : List Nat)[i - 2552]! := by
