...
private theorem seedPCAnchor :
    Artifact.submissionArtifact.instructionPC 2056 = 2754 := by
...
@[simp] theorem seedPC (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      ([2754,2755,2758,2759,2761,2762,2763,2765,2766,2767,2768,2771,2772,2773,2774,2777,2778,2779,2780,2781,2782,2783,2786,2787,2788,2790,2791,2794] : List Nat)[i - 2056]! := by
  rw [Challenge.Modexp.Submission.Proofs.Bytecode.PCFast.instructionPC_eq_byteLength]
