...
theorem jumpDest4115 :
  ...
  exact Artifact.isValidJumpDest_index 2957 (by rfl)
...
theorem run_tailNext (s : State) (mem : ByteArray) (pmj ptj c mu bi : UInt256)
  ...
  have h4115 : (4234 : UInt256).toNat = 4234 := by decide
  have h4115' : (4234 : UInt256) = UInt256.ofNat 4234 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (4234 : UInt256).toNat = true := by
    rw [h4115]
    exact jumpDest4115
