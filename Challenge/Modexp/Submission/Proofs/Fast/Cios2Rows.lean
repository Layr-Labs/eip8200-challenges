...
/-- Four-limb L1: pair 0/1, then MAC 2 and the exiting MAC 3. -/
def gasSteps_l1Four (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  (gasSteps_l1Pair s mem bi pa pb 4 i 0 pdst ret rest hcap hrun hcode hfork
      hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1FirstMac s mem bi pa pb 4 i 2 pdst ret rest hcap hrun hcode hfork
      hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  gasSteps_l1SecondMacExit s mem bi pa pb 4 i 3 pdst ret rest hcap hrun hcode
    hfork hnp hact (by decide) (by decide) hpa hpaFit

/-- Eight-limb L1: pairs 0/1, 2/3, 4/5, then MAC 6 and exiting MAC 7. -/
def gasSteps_l1Eight (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  (gasSteps_l1Pair s mem bi pa pb 8 i 0 pdst ret rest hcap hrun hcode hfork
      hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Pair s mem bi pa pb 8 i 2 pdst ret rest hcap hrun hcode hfork
      hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1Pair s mem bi pa pb 8 i 4 pdst ret rest hcap hrun hcode hfork
      hnp hact (by decide) (by decide) hpa hpaFit).trans <|
  (gasSteps_l1FirstMac s mem bi pa pb 8 i 6 pdst ret rest hcap hrun hcode hfork
      hnp hact (by decide) (by decide) hpa hpaFit).trans <|
...
def gasSteps_l2Four (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4520 s mid bi mu c0 pa pb 4 i 0 pdst ret rest)
...
def gasSteps_l2Eight (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
    ...
    (hact : 296 ≤ s.activeWords.toNat) :
    Challenge.EvmProof.GasSteps
      (l2At 4520 s mid bi mu c0 pa pb 8 i 0 pdst ret rest)
