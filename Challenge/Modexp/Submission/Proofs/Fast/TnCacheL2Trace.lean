...
namespace Challenge.Modexp.Submission.Proofs.Fast.TnCacheL2Trace
...
theorem run_step (w : Fin 33) (template : State) (pc : UInt256) (mem : ByteArray)
    ...
    runInstructions (l2Program w x tl ts)
      (state template pc mem bi mu c0 n k pbi paEnd pbEnd flag tn destination returnPC rest) =
...
end Challenge.Modexp.Submission.Proofs.Fast.TnCacheL2Trace
