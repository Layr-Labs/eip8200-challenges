...
theorem run_l1FourthMacBody (s : State) (mem : ByteArray) (bi : UInt256)
...
def gasSteps_l1FourthMacBody (s : State) (mem : ByteArray) (bi : UInt256)
    (pa pb n i k : Nat) (pdst ret : UInt256) (rest : List UInt256)
    (hcap : rest.length ≤ 1008) (hrun : s.halt = .Running)
    (hcode : s.executionEnv.code = Challenge.Modexp.submissionBytecode)
    (hfork : s.fork = .Osaka)
  ...
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
    ...
    (run_l1FourthMacBody s mem bi pa pb n i k pdst ret rest hcap hrun hcode hact
