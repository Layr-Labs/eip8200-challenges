...
def blkUL1_0 :
  ...
  [opAt 2551 .JUMPDEST,
   ...
   opAt 2553 .MLOAD,
   pushAt 2554 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2555 (.Dup ⟨5, by decide⟩),
   opAt 2556 (.Dup ⟨2, by decide⟩),
   opAt 2557 .MUL,
   opAt 2558 (.Swap ⟨1, by decide⟩),
   opAt 2559 (.Dup ⟨6, by decide⟩),
   opAt 2560 .MULMOD,
   opAt 2561 (.Dup ⟨1, by decide⟩),
   opAt 2562 (.Dup ⟨1, by decide⟩),
   opAt 2563 .LT,
   opAt 2564 .SUB,
   opAt 2565 (.Dup ⟨4, by decide⟩),
   opAt 2566 (.Dup ⟨2, by decide⟩),
   opAt 2567 .ADD,
   opAt 2568 (.Dup ⟨0, by decide⟩),
   opAt 2569 (.Swap ⟨5, by decide⟩),
   opAt 2570 .GT,
   opAt 2571 .SUB,
   opAt 2572 .SUB,
   opAt 2573 (.Dup ⟨3, by decide⟩),
   opAt 2574 (.Dup ⟨3, by decide⟩),
   opAt 2575 .MLOAD,
   opAt 2576 .ADD,
   opAt 2577 (.Dup ⟨0, by decide⟩),
   opAt 2578 (.Swap ⟨4, by decide⟩),
   opAt 2579 .GT,
   opAt 2580 .ADD,
   opAt 2581 (.Swap ⟨2, by decide⟩),
   opAt 2582 (.Dup ⟨2, by decide⟩),
   pushAt 2583 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2584 .ADD,
...
def blkUL1_1 :
  ...
  [opAt 2589 .JUMPDEST,
   ...
   opAt 2591 .MLOAD,
   pushAt 2592 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2593 (.Dup ⟨5, by decide⟩),
   opAt 2594 (.Dup ⟨2, by decide⟩),
   opAt 2595 .MUL,
   opAt 2596 (.Swap ⟨1, by decide⟩),
   opAt 2597 (.Dup ⟨6, by decide⟩),
   opAt 2598 .MULMOD,
   ...
   opAt 2616 (.Swap ⟨4, by decide⟩),
   opAt 2617 .GT,
   opAt 2618 .ADD,
   opAt 2619 (.Swap ⟨2, by decide⟩),
   opAt 2620 (.Dup ⟨2, by decide⟩),
   pushAt 2621 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2622 .ADD,
...
def blkUL1_2 :
  ...
  [opAt 2627 .JUMPDEST,
   ...
   opAt 2629 .MLOAD,
   pushAt 2630 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2631 (.Dup ⟨5, by decide⟩),
   opAt 2632 (.Dup ⟨2, by decide⟩),
   opAt 2633 .MUL,
   opAt 2634 (.Swap ⟨1, by decide⟩),
   opAt 2635 (.Dup ⟨6, by decide⟩),
   opAt 2636 .MULMOD,
   opAt 2637 (.Dup ⟨1, by decide⟩),
   opAt 2638 (.Dup ⟨1, by decide⟩),
   opAt 2639 .LT,
   opAt 2640 .SUB,
   opAt 2641 (.Dup ⟨4, by decide⟩),
   opAt 2642 (.Dup ⟨2, by decide⟩),
   opAt 2643 .ADD,
   opAt 2644 (.Dup ⟨0, by decide⟩),
   opAt 2645 (.Swap ⟨5, by decide⟩),
   opAt 2646 .GT,
   opAt 2647 .SUB,
   opAt 2648 .SUB,
   opAt 2649 (.Dup ⟨3, by decide⟩),
   opAt 2650 (.Dup ⟨3, by decide⟩),
   opAt 2651 .MLOAD,
   opAt 2652 .ADD,
   opAt 2653 (.Dup ⟨0, by decide⟩),
   opAt 2654 (.Swap ⟨4, by decide⟩),
   opAt 2655 .GT,
   opAt 2656 .ADD,
   opAt 2657 (.Swap ⟨2, by decide⟩),
   opAt 2658 (.Dup ⟨2, by decide⟩),
   pushAt 2659 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2660 .ADD,
...
def blkUL1_3 :
  ...
  [opAt 2665 .JUMPDEST,
   ...
   opAt 2667 .MLOAD,
   pushAt 2668 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2669 (.Dup ⟨5, by decide⟩),
   opAt 2670 (.Dup ⟨2, by decide⟩),
   opAt 2671 .MUL,
   opAt 2672 (.Swap ⟨1, by decide⟩),
   opAt 2673 (.Dup ⟨6, by decide⟩),
   opAt 2674 .MULMOD,
   opAt 2675 (.Dup ⟨1, by decide⟩),
   opAt 2676 (.Dup ⟨1, by decide⟩),
   opAt 2677 .LT,
   opAt 2678 .SUB,
   opAt 2679 (.Dup ⟨4, by decide⟩),
   opAt 2680 (.Dup ⟨2, by decide⟩),
   opAt 2681 .ADD,
   opAt 2682 (.Dup ⟨0, by decide⟩),
   opAt 2683 (.Swap ⟨5, by decide⟩),
   opAt 2684 .GT,
   opAt 2685 .SUB,
   opAt 2686 .SUB,
   ...
   opAt 2692 (.Swap ⟨4, by decide⟩),
   opAt 2693 .GT,
   opAt 2694 .ADD,
   opAt 2695 (.Swap ⟨2, by decide⟩),
   opAt 2696 (.Dup ⟨2, by decide⟩),
   pushAt 2697 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2698 .ADD,
   opAt 2699 (.Swap ⟨2, by decide⟩),
   opAt 2700 .MSTORE,
   pushAt 2701 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2702 .ADD]
