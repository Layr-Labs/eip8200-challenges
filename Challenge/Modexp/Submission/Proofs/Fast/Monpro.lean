...
import Challenge.Modexp.Submission.Proofs.Fast.MonproN8Rows
...
def mpDispatchPath : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3084 .JUMPDEST,
   opAt 3085 .JUMPDEST,
   pushAt 3086 2 9344,
   opAt 3087 .MLOAD,
   ...
   pushAt 3117 2 5405,
   opAt 3118 .JUMPI]
def mpSelect8Path : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3122 .JUMPDEST,
   opAt 3123 .POP]
def mpFallbackPath : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3119 .POP,
   pushAt 3120 2 1974,
   opAt 3121 .JUMP]
def mpEntryPath (n : Nat) :=
  blk1379 ++ mpDispatchPath ++ (if n = 8 then mpSelect8Path else mpFallbackPath)

def mpSelectedState (s : State) (mem : ByteArray) (pa pb n : Nat)
    (pdst ret : UInt256) (rest : List UInt256) : State :=
  if n = 8 then MonproN8.rowState s mem pa pb 0 pdst ret rest
  else mpOutState s mem pa pb n 0 pdst ret rest
...
theorem run_mpEntry (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock (mpEntryPath n)
      (mpEntryState s mem pa pb pdst ret rest) =
      some (mpSelectedState s (mpZeroed s mem n) pa pb n pdst ret rest) := by
  ...
  have hs32z : MachineState.readWord (mpZeroed s mem n) 9344 = UInt256.ofNat (32 * n) := by
    unfold mpZeroed
    rw [Challenge.EvmProof.Memory.readWord_writeBytes_disjoint]
    · exact hs32
    · rw [Challenge.EvmProof.Memory.readPadded_size]
      omega
  have heq : (UInt256.ofNat (32 * n)).toNat = 256 ↔ n = 8 := by
    rw [Challenge.EvmProof.Word.word_toNat_ofNat, Nat.mod_eq_of_lt (by omega)]
    omega
  have heq256 : 256 = (UInt256.ofNat (32 * n)).toNat ↔ n = 8 := by
    rw [eq_comm]
    exact heq
  by_cases hn8 : n = 8
  all_goals simp (config := { maxSteps := 800000 })
    [mpEntryPath, mpDispatchPath, mpSelect8Path, mpFallbackPath,
      mpSelectedState, MonproN8.rowState, MonproN8.atState,
      hn8, heq, heq256, hs32z, UInt256.eq, UInt256.isTrue,
      MonproN8.jump_dispatch, MonproN8.jump_entry8, jumpDest1974,
      blk1379, opAt, pushAt, wfOp,
      Challenge.EvmProof.Stepper.runLocatedBlock,
      Challenge.EvmProof.Stepper.runLocated,
      Challenge.EvmProof.Stepper.runInstr,
      mpEntryState, mpOutState, mpZeroed, fastPC10,
      hc4, hc5, hc6, hc7, hc8, hrun, hcode, h32, h64, h8192, h9344, hs32,
...
def blkUL1_0 :
  ...
  [opAt 2517 .JUMPDEST,
   ...
   opAt 2519 .MLOAD,
   pushAt 2520 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2521 (.Dup ⟨5, by decide⟩),
   opAt 2522 (.Dup ⟨2, by decide⟩),
   opAt 2523 .MUL,
   opAt 2524 (.Swap ⟨1, by decide⟩),
   opAt 2525 (.Dup ⟨6, by decide⟩),
   opAt 2526 .MULMOD,
   opAt 2527 (.Dup ⟨1, by decide⟩),
   opAt 2528 (.Dup ⟨1, by decide⟩),
   opAt 2529 .LT,
   opAt 2530 .SUB,
   opAt 2531 (.Dup ⟨4, by decide⟩),
   opAt 2532 (.Dup ⟨2, by decide⟩),
   opAt 2533 .ADD,
   opAt 2534 (.Dup ⟨0, by decide⟩),
   opAt 2535 (.Swap ⟨5, by decide⟩),
   opAt 2536 .GT,
   opAt 2537 .SUB,
   opAt 2538 .SUB,
   ...
   opAt 2544 (.Swap ⟨4, by decide⟩),
   opAt 2545 .GT,
   opAt 2546 .ADD,
   opAt 2547 (.Swap ⟨2, by decide⟩),
   opAt 2548 (.Dup ⟨2, by decide⟩),
   pushAt 2549 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2550 .ADD,
   opAt 2551 (.Swap ⟨2, by decide⟩),
   opAt 2552 .MSTORE,
   pushAt 2553 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2554 .ADD]
...
theorem run_mpL1Copy0 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkUL1_0
      (mpL1At 4071 s mem bi pa pb n i j pdst ret rest) =
      some (mpL1At 4205 s mem bi pa pb n i (j + 1) pdst ret rest) := by
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
...
def blkUL1_1 :
  ...
  [opAt 2555 .JUMPDEST,
   ...
   opAt 2557 .MLOAD,
   pushAt 2558 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2559 (.Dup ⟨5, by decide⟩),
   opAt 2560 (.Dup ⟨2, by decide⟩),
   opAt 2561 .MUL,
   opAt 2562 (.Swap ⟨1, by decide⟩),
   opAt 2563 (.Dup ⟨6, by decide⟩),
   opAt 2564 .MULMOD,
   opAt 2565 (.Dup ⟨1, by decide⟩),
   opAt 2566 (.Dup ⟨1, by decide⟩),
   opAt 2567 .LT,
   opAt 2568 .SUB,
   opAt 2569 (.Dup ⟨4, by decide⟩),
   opAt 2570 (.Dup ⟨2, by decide⟩),
   opAt 2571 .ADD,
   opAt 2572 (.Dup ⟨0, by decide⟩),
   opAt 2573 (.Swap ⟨5, by decide⟩),
   opAt 2574 .GT,
   opAt 2575 .SUB,
   opAt 2576 .SUB,
   opAt 2577 (.Dup ⟨3, by decide⟩),
   opAt 2578 (.Dup ⟨3, by decide⟩),
   opAt 2579 .MLOAD,
   opAt 2580 .ADD,
   opAt 2581 (.Dup ⟨0, by decide⟩),
   opAt 2582 (.Swap ⟨4, by decide⟩),
   opAt 2583 .GT,
   opAt 2584 .ADD,
   opAt 2585 (.Swap ⟨2, by decide⟩),
   opAt 2586 (.Dup ⟨2, by decide⟩),
   pushAt 2587 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2588 .ADD,
   opAt 2589 (.Swap ⟨2, by decide⟩),
   opAt 2590 .MSTORE,
   pushAt 2591 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2592 .ADD]
...
theorem run_mpL1Copy1 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkUL1_1
      (mpL1At 4205 s mem bi pa pb n i j pdst ret rest) =
      some (mpL1At 4339 s mem bi pa pb n i (j + 1) pdst ret rest) := by
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
...
def blkUL1_2 :
  ...
  [opAt 2593 .JUMPDEST,
   ...
   opAt 2595 .MLOAD,
   pushAt 2596 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2597 (.Dup ⟨5, by decide⟩),
   opAt 2598 (.Dup ⟨2, by decide⟩),
   opAt 2599 .MUL,
   opAt 2600 (.Swap ⟨1, by decide⟩),
   opAt 2601 (.Dup ⟨6, by decide⟩),
   opAt 2602 .MULMOD,
   ...
   opAt 2620 (.Swap ⟨4, by decide⟩),
   opAt 2621 .GT,
   opAt 2622 .ADD,
   opAt 2623 (.Swap ⟨2, by decide⟩),
   opAt 2624 (.Dup ⟨2, by decide⟩),
   pushAt 2625 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2626 .ADD,
   opAt 2627 (.Swap ⟨2, by decide⟩),
   opAt 2628 .MSTORE,
   pushAt 2629 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2630 .ADD]
...
theorem run_mpL1Copy2 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkUL1_2
      (mpL1At 4339 s mem bi pa pb n i j pdst ret rest) =
      some (mpL1At 4473 s mem bi pa pb n i (j + 1) pdst ret rest) := by
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
...
def blkUL1_3 :
  ...
  [opAt 2631 .JUMPDEST,
   ...
   opAt 2633 .MLOAD,
   pushAt 2634 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2635 (.Dup ⟨5, by decide⟩),
   opAt 2636 (.Dup ⟨2, by decide⟩),
   opAt 2637 .MUL,
   opAt 2638 (.Swap ⟨1, by decide⟩),
   opAt 2639 (.Dup ⟨6, by decide⟩),
   opAt 2640 .MULMOD,
   opAt 2641 (.Dup ⟨1, by decide⟩),
   opAt 2642 (.Dup ⟨1, by decide⟩),
   opAt 2643 .LT,
   opAt 2644 .SUB,
   opAt 2645 (.Dup ⟨4, by decide⟩),
   opAt 2646 (.Dup ⟨2, by decide⟩),
   opAt 2647 .ADD,
   opAt 2648 (.Dup ⟨0, by decide⟩),
   opAt 2649 (.Swap ⟨5, by decide⟩),
   opAt 2650 .GT,
   opAt 2651 .SUB,
   opAt 2652 .SUB,
   opAt 2653 (.Dup ⟨3, by decide⟩),
   opAt 2654 (.Dup ⟨3, by decide⟩),
   opAt 2655 .MLOAD,
   opAt 2656 .ADD,
   opAt 2657 (.Dup ⟨0, by decide⟩),
   opAt 2658 (.Swap ⟨4, by decide⟩),
   opAt 2659 .GT,
   opAt 2660 .ADD,
   opAt 2661 (.Swap ⟨2, by decide⟩),
   opAt 2662 (.Dup ⟨2, by decide⟩),
   pushAt 2663 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2664 .ADD,
   opAt 2665 (.Swap ⟨2, by decide⟩),
   opAt 2666 .MSTORE,
   pushAt 2667 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2668 .ADD]
...
theorem run_mpL1Copy3 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkUL1_3
      (mpL1At 4473 s mem bi pa pb n i j pdst ret rest) =
      some (mpL1At 4607 s mem bi pa pb n i (j + 1) pdst ret rest) := by
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
...
def blkTestL1 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2669 (.Dup ⟨5, by decide⟩),
   opAt 2670 (.Dup ⟨1, by decide⟩),
   opAt 2671 .GT,
   pushAt 2672 2 4071,
   opAt 2673 .JUMPI]
...
theorem jumpDest2140 :
  ...
  Artifact.isValidJumpDest_index 1463 (by rfl)
...
theorem run_stubL1 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkStubL1
      ...
      some (mpL1At 4052 s mem bi pa pb n i j pdst ret rest) := by
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
  have h3924 : (4052 : UInt256).toNat = 4052 := by decide
  have h3924' : (4052 : UInt256) = UInt256.ofNat 4052 := by decide
...
theorem run_mpL1Copy3T (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkUL1_3T
      (mpL1At 4473 s mem bi pa pb n i j pdst ret rest) =
      some (mpL1At 4071 s mem bi pa pb n i (j + 1) pdst ret rest) := by
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
  ...
  have hK : (115792089237316195423570985008687907853269984665640564039457584007913129639904 :
      UInt256) = UInt256.ofNat
        115792089237316195423570985008687907853269984665640564039457584007913129639904 := by
    decide
  have h1995 : (4071 : UInt256).toNat = 4071 := by decide
  have h1995' : (4071 : UInt256) = UInt256.ofNat 4071 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (4071 : UInt256).toNat = true := by
...
theorem jumpDest4082 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4205 = true :=
  Artifact.isValidJumpDest_index 2555 (by rfl)

theorem jumpDest4221 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4339 = true :=
  Artifact.isValidJumpDest_index 2593 (by rfl)

theorem jumpDest4360 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4473 = true :=
...
theorem run_dispatchL1 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j t : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blkDispL1
      (mpL1At 4052 s mem bi pa pb n i j pdst ret rest) =
      some (mpL1At (4071 + 134 * t) s mem bi pa pb n i j pdst ret rest) := by
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
  have p0 : (4071 : UInt256) + (134 : UInt256) * UInt256.ofNat 0 = UInt256.ofNat 4071 := by decide
  have p1 : (4071 : UInt256) + (134 : UInt256) * UInt256.ofNat 1 = UInt256.ofNat 4205 := by decide
  have p2 : (4071 : UInt256) + (134 : UInt256) * UInt256.ofNat 2 = UInt256.ofNat 4339 := by decide
  have p3 : (4071 : UInt256) + (134 : UInt256) * UInt256.ofNat 3 = UInt256.ofNat 4473 := by decide
  have q0 : (UInt256.ofNat 4071).toNat = 4071 := by decide
  have q1 : (UInt256.ofNat 4205).toNat = 4205 := by decide
  have q2 : (UInt256.ofNat 4339).toNat = 4339 := by decide
  have q3 : (UInt256.ofNat 4473).toNat = 4473 := by decide
  interval_cases t <;>
    simp (config := { maxSteps := 400000 })
...
def gasSteps_dispL1 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j t : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpL1At 4052 s mem bi pa pb n i j pdst ret rest)
      (mpL1At (4071 + 134 * t) s mem bi pa pb n i j pdst ret rest) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
...
def gasSteps_L1c0 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpL1At 4071 s mem bi pa pb n i j pdst ret rest)
      (mpL1At 4205 s mem bi pa pb n i (j + 1) pdst ret rest) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
...
def gasSteps_L1c1 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpL1At 4205 s mem bi pa pb n i j pdst ret rest)
      (mpL1At 4339 s mem bi pa pb n i (j + 1) pdst ret rest) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
...
def gasSteps_L1c2 (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpL1At 4339 s mem bi pa pb n i j pdst ret rest)
      (mpL1At 4473 s mem bi pa pb n i (j + 1) pdst ret rest) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
...
def gasSteps_L1c3T (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpL1At 4473 s mem bi pa pb n i j pdst ret rest)
      (mpL1At 4071 s mem bi pa pb n i (j + 1) pdst ret rest) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
...
def gasSteps_L1pass (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpL1At 4071 s mem bi pa pb n i j pdst ret rest)
      (mpL1At 4071 s mem bi pa pb n i (j + 4) pdst ret rest) :=
...
def gasSteps_L1run (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpL1At (4071 + 134 * t) s mem bi pa pb n i 0 pdst ret rest)
      (mpMidOf s mem bi pa pb n i pdst ret rest) := by
  interval_cases t
  · by_cases hEq : 4 = n
...
def gasSteps_mpEntry (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpEntryState s mem pa pb pdst ret rest)
      (mpSelectedState s (mpZeroed s mem n) pa pb n pdst ret rest) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka (mpEntryPath n) hcode hfork
    (run_mpEntry s mem pa pb n pdst ret rest hcap hrun hcode hact hn hn32 hpa hpaFit
...
def gasSteps_monproToCsub (s : State) (mem : ByteArray) (pa pb m : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (mpEntryState s mem pa pb pdst ret rest)
      (mpCsubState s
        (rowsMem (mpZeroed s mem (m + 2)) pa pb (m + 2) (m + 2)) pdst ret rest) := by
  have he := gasSteps_mpEntry s mem pa pb (m + 2) pdst ret rest hcap hrun hcode hfork hnp
    hact (by omega) hn32 hpa hpaFit hpb hpbFit hcds hs32
  by_cases hn8 : m + 2 = 8
  · have hm6 : m = 6 := by omega
    subst m
    simp only [mpSelectedState, if_pos (show 6 + 2 = 8 from rfl)] at he
    exact he.trans (MonproN8.gasSteps_rowsToCsub s (mpZeroed s mem 8) pa pb pdst ret rest
      hcap hrun hcode hfork hnp hact hpa hpaFit hpb hpbFit)
  · simp only [mpSelectedState, if_neg hn8] at he
    exact he.trans <|
