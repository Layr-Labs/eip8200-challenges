...
`MONPRO` occupies instruction indices 1427..1647 (pc 1987..2268).  It is
...
scratch area, and tail-calls `CSUB` at pc 2354 with stack `[pc, ret]`.
...
/-- Subroutine entry, pc 1987, stack `[pa, pb, pd, ret]`. -/
...
/-- The row middle, pc 2098.  The two spent loop pointers are popped at once,
so they stay opaque. -/
...
/-- The subroutine exit, pc 2501, after all `n` rows. -/
...
/-- `CSUB` entry, pc 2354, with stack `[pd, ret]`. -/
...
theorem run_mpL1Body (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
  ...
  have hK : (115792089237316195423570985008687907853269984665640564039457584007913129639904 :
    ...
    decide
  have h1995 : (1723 : UInt256).toNat = 1723 := by decide
  have h1995' : (1723 : UInt256) = UInt256.ofNat 1723 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (1723 : UInt256).toNat = true := by
...
theorem run_mpL2Body (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
  ...
  have h32 : (32 : UInt256) = UInt256.ofNat 32 := by decide
  have h8224 : (8224 : UInt256).toNat = 8224 := by decide
  have h2241 : (1847 : UInt256).toNat = 1847 := by decide
  have h2241' : (1847 : UInt256) = UInt256.ofNat 1847 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (1847 : UInt256).toNat = true := by
...
theorem run_mpTailNext (s : State) (mem : ByteArray) (pmj ptj c mu bi : UInt256)
  ...
  have h1974 : (1709 : UInt256).toNat = 1709 := by decide
  have h1974' : (1709 : UInt256) = UInt256.ofNat 1709 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (1709 : UInt256).toNat = true := by
...
theorem run_mpExit (s : State) (mem : ByteArray) (pbi : UInt256) (pa pb : Nat)
  ...
  have hc4 : rest.length + 4 < 1024 := by omega
  have hc5 : rest.length + 5 < 1024 := by omega
  have h2642 : (4792 : UInt256).toNat = 4792 := by decide
  have h2642' : (4792 : UInt256) = UInt256.ofNat 4792 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (4792 : UInt256).toNat = true := by
...
`MONPRO` is entered at pc 1987 with stack `[pa, pb, pd, ret]` and tail-calls
`CSUB` at pc 2354 with stack `[pd, ret]`; `CSUB` (proved in `Fast.Csub`) copies
...
`MONPRO` enters `CSUB` at pc 2354 with stack `[pd, ret]`, `t[n]` at
...
/-- The whole `MONPRO` call: from the subroutine entry at pc 1987 with stack
