...
/-- The outer loop head, pc 1900, at the start of row `i`. -/
...
/-- The first limb loop head, pc 1914, after `j` steps of row `i`. -/
...
theorem run_mpL1Body (s : State) (mem : ByteArray) (bi : UInt256) (pa pb n i j : Nat)
  ...
  have hK : (115792089237316195423570985008687907853269984665640564039457584007913129639904 :
    ...
    decide
  have h1995 : (1675 : UInt256).toNat = 1675 := by decide
  have h1995' : (1675 : UInt256) = UInt256.ofNat 1675 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (1675 : UInt256).toNat = true := by
...
theorem run_mpL2Body (s : State) (mid : ByteArray) (bi mu c0 : UInt256)
  ...
  have h32 : (32 : UInt256) = UInt256.ofNat 32 := by decide
  have h8224 : (4128 : UInt256).toNat = 4128 := by decide
  have h2241 : (1799 : UInt256).toNat = 1799 := by decide
  have h2241' : (1799 : UInt256) = UInt256.ofNat 1799 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (1799 : UInt256).toNat = true := by
  ...
  have hnextT : ptrAt (4096 + 32 * n) (k + 1) %
      ...
      8160 + 32 * n - 32 * k := by
    rw [ptrAt_mod _ _ (by omega) (by omega)]; omega
  have hgt : 4128 < 8160 + 32 * n - 32 * k := by omega
...
theorem run_mpTailNext (s : State) (mem : ByteArray) (pmj ptj c mu bi : UInt256)
  ...
  have h1974 : (1661 : UInt256).toNat = 1661 := by decide
  have h1974' : (1661 : UInt256) = UInt256.ofNat 1661 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (1661 : UInt256).toNat = true := by
...
theorem run_mpExit (s : State) (mem : ByteArray) (pbi : UInt256) (pa pb : Nat)
  ...
  have hc4 : rest.length + 4 < 1024 := by omega
  have hc5 : rest.length + 5 < 1024 := by omega
  have h2642 : (4669 : UInt256).toNat = 4669 := by decide
  have h2642' : (4669 : UInt256) = UInt256.ofNat 4669 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (4669 : UInt256).toNat = true := by
...
`32 * 32 = 256` bytes.  `MONPRO` leaves all of them, and every scratch word at
...
/-- `CSUB` writes only inside `SUBB = [3072, 3072 + 32 * n)` and the
destination block. -/
