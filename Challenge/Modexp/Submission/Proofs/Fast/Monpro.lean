...
/-- `CSUB` entry, pc 4978, with stack `[pd, ret]`. -/
...
theorem run_mpExit (s : State) (mem : ByteArray) (pbi : UInt256) (pa pb : Nat)
  ...
  have hc4 : rest.length + 4 < 1024 := by omega
  have hc5 : rest.length + 5 < 1024 := by omega
  have h2642 : (4978 : UInt256).toNat = 4978 := by decide
  have h2642' : (4978 : UInt256) = UInt256.ofNat 4978 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (4978 : UInt256).toNat = true := by
    rw [h2642]; exact jumpDest4978
  simp (config := { maxSteps := 400000 })
    [blk1595, opAt, pushAt, wfOp,
      ...
      hc2, hc3, hc4, hc5, hrun, hcode, h2642, h2642', hjump, jumpDest4978,
      Challenge.EvmProof.Word.succ_ofNat_mod,
      Challenge.EvmProof.Word.ofNat_add_mod,
      Challenge.EvmProof.Word.word_toNat_ofNat, Nat.mod_eq_of_lt,
      List.exchange]
