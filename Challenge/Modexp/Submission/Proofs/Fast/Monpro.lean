...
def blkUL1_0 :
  ...
  [opAt 2559 .JUMPDEST,
   ...
   opAt 2561 .MLOAD,
   pushAt 2562 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2563 (.Dup ⟨5, by decide⟩),
   opAt 2564 (.Dup ⟨2, by decide⟩),
   opAt 2565 .MUL,
   opAt 2566 (.Swap ⟨1, by decide⟩),
   opAt 2567 (.Dup ⟨6, by decide⟩),
   opAt 2568 .MULMOD,
   opAt 2569 (.Dup ⟨1, by decide⟩),
   opAt 2570 (.Dup ⟨1, by decide⟩),
   opAt 2571 .LT,
   opAt 2572 .SUB,
   opAt 2573 (.Dup ⟨4, by decide⟩),
   opAt 2574 (.Dup ⟨2, by decide⟩),
   opAt 2575 .ADD,
   opAt 2576 (.Dup ⟨0, by decide⟩),
   opAt 2577 (.Swap ⟨5, by decide⟩),
   opAt 2578 .GT,
   opAt 2579 .SUB,
   opAt 2580 .SUB,
   ...
   opAt 2592 .ADD,
   opAt 2593 (.Swap ⟨2, by decide⟩),
   opAt 2594 .MSTORE,
   pushAt 2595 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2596 .ADD]
...
def blkUL1_1 :
  ...
  [opAt 2597 .JUMPDEST,
   ...
   opAt 2599 .MLOAD,
   pushAt 2600 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2601 (.Dup ⟨5, by decide⟩),
   opAt 2602 (.Dup ⟨2, by decide⟩),
   opAt 2603 .MUL,
   opAt 2604 (.Swap ⟨1, by decide⟩),
   opAt 2605 (.Dup ⟨6, by decide⟩),
   opAt 2606 .MULMOD,
   ...
   opAt 2615 (.Swap ⟨5, by decide⟩),
   opAt 2616 .GT,
   opAt 2617 .SUB,
   opAt 2618 .SUB,
   opAt 2619 (.Dup ⟨3, by decide⟩),
   opAt 2620 (.Dup ⟨3, by decide⟩),
   opAt 2621 .MLOAD,
   opAt 2622 .ADD,
   opAt 2623 (.Dup ⟨0, by decide⟩),
   opAt 2624 (.Swap ⟨4, by decide⟩),
   opAt 2625 .GT,
   opAt 2626 .ADD,
   ...
   opAt 2632 .MSTORE,
   pushAt 2633 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2634 .ADD]
...
def blkUL1_2 :
  ...
  [opAt 2635 .JUMPDEST,
   ...
   opAt 2639 (.Dup ⟨5, by decide⟩),
   opAt 2640 (.Dup ⟨2, by decide⟩),
   opAt 2641 .MUL,
   opAt 2642 (.Swap ⟨1, by decide⟩),
   opAt 2643 (.Dup ⟨6, by decide⟩),
   opAt 2644 .MULMOD,
   opAt 2645 (.Dup ⟨1, by decide⟩),
   opAt 2646 (.Dup ⟨1, by decide⟩),
   opAt 2647 .LT,
   opAt 2648 .SUB,
   opAt 2649 (.Dup ⟨4, by decide⟩),
   opAt 2650 (.Dup ⟨2, by decide⟩),
   opAt 2651 .ADD,
   opAt 2652 (.Dup ⟨0, by decide⟩),
   opAt 2653 (.Swap ⟨5, by decide⟩),
   opAt 2654 .GT,
   opAt 2655 .SUB,
   opAt 2656 .SUB,
   opAt 2657 (.Dup ⟨3, by decide⟩),
   opAt 2658 (.Dup ⟨3, by decide⟩),
   opAt 2659 .MLOAD,
   opAt 2660 .ADD,
   opAt 2661 (.Dup ⟨0, by decide⟩),
   opAt 2662 (.Swap ⟨4, by decide⟩),
   opAt 2663 .GT,
   opAt 2664 .ADD,
   ...
   opAt 2668 .ADD,
   opAt 2669 (.Swap ⟨2, by decide⟩),
   opAt 2670 .MSTORE,
   pushAt 2671 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2672 .ADD]
...
def blkUL1_3 :
  ...
  [opAt 2673 .JUMPDEST,
   ...
   opAt 2675 .MLOAD,
   pushAt 2676 32 115792089237316195423570985008687907853269984665640564039457584007913129639935,
   opAt 2677 (.Dup ⟨5, by decide⟩),
   opAt 2678 (.Dup ⟨2, by decide⟩),
   opAt 2679 .MUL,
   opAt 2680 (.Swap ⟨1, by decide⟩),
   opAt 2681 (.Dup ⟨6, by decide⟩),
   opAt 2682 .MULMOD,
   opAt 2683 (.Dup ⟨1, by decide⟩),
   opAt 2684 (.Dup ⟨1, by decide⟩),
   opAt 2685 .LT,
   opAt 2686 .SUB,
   opAt 2687 (.Dup ⟨4, by decide⟩),
   opAt 2688 (.Dup ⟨2, by decide⟩),
   opAt 2689 .ADD,
   opAt 2690 (.Dup ⟨0, by decide⟩),
   opAt 2691 (.Swap ⟨5, by decide⟩),
   opAt 2692 .GT,
   opAt 2693 .SUB,
   opAt 2694 .SUB,
   opAt 2695 (.Dup ⟨3, by decide⟩),
   opAt 2696 (.Dup ⟨3, by decide⟩),
   opAt 2697 .MLOAD,
   opAt 2698 .ADD,
   opAt 2699 (.Dup ⟨0, by decide⟩),
   opAt 2700 (.Swap ⟨4, by decide⟩),
   opAt 2701 .GT,
   opAt 2702 .ADD,
   opAt 2703 (.Swap ⟨2, by decide⟩),
   opAt 2704 (.Dup ⟨2, by decide⟩),
   pushAt 2705 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2706 .ADD,
   opAt 2707 (.Swap ⟨2, by decide⟩),
   opAt 2708 .MSTORE,
   pushAt 2709 32 115792089237316195423570985008687907853269984665640564039457584007913129639904,
   opAt 2710 .ADD]
