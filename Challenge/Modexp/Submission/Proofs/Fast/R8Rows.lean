...
def gasSteps_rowZeroToTail (s : State) (mem : ByteArray)
    ...
    Challenge.EvmProof.GasSteps
      ...
      (tailState s
        ...
        2368 8 0 (UInt256.ofNat 4427) (UInt256.ofNat (sqEnt 8 0 + 37)) inv m0
  ...
  have gM := CarryRowGas.gasSteps_mid s (sqL1 mem 8 0 (UInt256.ofNat 0)).memory
    ...
    (UInt256.ofNat 4427) (UInt256.ofNat (sqEnt 8 0 + 37)) tl inv m0 (sqX mem 8 0) m96 m64 m32
    pdst ret rest hcap hrun hcode hfork hnp hact hn2 hn32 hminvQ hcQ
  refine (gP.trans gC).trans (gM.trans ?_)
  -- the second loop
  exact CarryRowGas.gasSteps_l2Eight s _ _ _ _ 2368 0 (UInt256.ofNat 4427) (UInt256.ofNat (sqEnt 8 0 + 37))
...
def gasSteps_rowZeroNext (s : State) (mem : ByteArray)
  ...
  (CarryRowGas.gasSteps_tailNext s _ _ _ _ 2368 8 0 (UInt256.ofNat 4427) (UInt256.ofNat (sqEnt 8 0 + 37))
