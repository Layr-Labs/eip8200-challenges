...
def gasSteps_rowZeroToTail (s : State) (mem : ByteArray)
    ...
    Challenge.EvmProof.GasSteps
      { outState s mem 2368 8 0 (UInt256.ofNat 4444) (UInt256.ofNat (sqEnt 8 0)) inv m0
      ...
      (tailState s
        ...
        2368 8 0 (UInt256.ofNat 4444) (UInt256.ofNat (sqEnt 8 0 + 37)) inv m0
  ...
  have gC := KernelChain.gasSteps_l1Suffix (9 - 8 + 0) (by omega) (by omega) s
    ...
    (UInt256.ofNat 4444) (UInt256.ofNat (sqEnt 8 0 + 37)) inv m0
  ...
  have gM := CarryRowGas.gasSteps_mid s (sqL1 mem 8 0 (UInt256.ofNat 0)).memory
    ...
    (UInt256.ofNat 4444) (UInt256.ofNat (sqEnt 8 0 + 37)) tl inv m0 (sqX mem 8 0) m96 m64 m32
    pdst ret rest hcap hrun hcode hfork hnp hact hn2 hn32 hminvQ hcQ
  refine (gP.trans gC).trans (gM.trans ?_)
  -- the second loop
  exact CarryRowGas.gasSteps_l2Eight s _ _ _ _ 2368 0 (UInt256.ofNat 4444) (UInt256.ofNat (sqEnt 8 0 + 37))
...
def gasSteps_rowZeroNext (s : State) (mem : ByteArray)
  ...
  (CarryRowGas.gasSteps_tailNext s _ _ _ _ 2368 8 0 (UInt256.ofNat 4444) (UInt256.ofNat (sqEnt 8 0 + 37))
...
def gasSteps_rowsToExit (s : State) (a0 : UInt256) (M0 : ByteArray)
    ...
    Challenge.EvmProof.GasSteps
      { rowState s a0 M0 8 tl inv m0 m96 m64 m32 pdst ret rest 0 with pc := UInt256.ofNat 5280 }
      (CiosCachedTailDefs.sqExitState s (sqRowsCarry M0 8 8)
        (UInt256.ofNat (ptrAt (2368 + 32 * 8 - 32) 8)) 2368 8 (UInt256.ofNat 4444)
