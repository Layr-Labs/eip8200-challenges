...
def blockA : Block Artifact.submissionArtifact .Osaka 4710 programA :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3604 6 4710 programA
    (by decide) (by rfl) (by rfl) (by decide)

def blockB : Block Artifact.submissionArtifact .Osaka 4717 programB :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3611 43 4717 programB
    (by decide) (by rfl) (by rfl) (by decide)
...
def gasSteps_prologue (s : State) (mem : ByteArray) (n i e : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s mem 2048 n i (UInt256.ofNat 4710) (UInt256.ofNat e) pdst ret
  ...
  -- block A
  have hA := run_A s' P (UInt256.ofNat 4710) (UInt256.ofNat (2048 - 32)) (UInt256.ofNat e)
  ...
  have gS := SgtStep.gasSteps_sqRowSgt
    { s' with pc := UInt256.ofNat 4716,
              stack := UInt256.ofNat 0 :: aprev :: MachineState.readWord s'.memory P.toNat :: P ::
                UInt256.ofNat 4710 :: UInt256.ofNat (2048 - 32) :: UInt256.ofNat e :: negative32 ::
  ...
  have hB := run_B s' (UInt256.sgt (UInt256.ofNat 0) aprev) (MachineState.readWord s'.memory P.toNat) P
    (UInt256.ofNat 4710) (UInt256.ofNat (2048 - 32)) (UInt256.ofNat e) negative32 allOnes
