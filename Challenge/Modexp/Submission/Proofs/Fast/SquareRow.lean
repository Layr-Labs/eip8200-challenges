...
`sq_row` is the row head `hd = 4797` of a square call.  On the kernel row frame
...
(idx 3559..3698, pc 4797, 6 instructions), `SgtStep.gasSteps_sqRowSgt_framed`
(idx 3744, pc 4803), block B (idx 3700..3840, pc 4923, 43 instructions; its
...
/-- `DUP2 ADD DUP2 DUP2 ADD SWAP2 DUP9 DUP3 DUP3 MULMOD` (idx 3700..3721). -/
...
`JUMP` (pc 5032..5032), so every pc and instruction index from 43 (idx 3725) on is unchanged. -/
...
def blockA : Block Artifact.submissionArtifact .Osaka 4448 programA :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3354 6 4448 programA
    (by decide) (by rfl) (by rfl) (by decide)

def blockB : Block Artifact.submissionArtifact .Osaka 4455 programB :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3361 41 4455 programB
    (by decide) (by rfl) (by rfl) (by decide)

/-- `sq_row` itself is a jump destination (the frame's row head for square calls). -/
theorem jumpDest4710 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4448 = true :=
  Artifact.isValidJumpDest_index 3354 (by rfl)
...
theorem run_A (s : State) (P hd w3 ent w5 M w7 w8 w9 w10 w11 w12 w13 aprev : UInt256)
    ...
    runInstructions programA
      { s with pc := UInt256.ofNat 4448,
               stack := P :: hd :: w3 :: ent :: w5 :: M :: w7 :: w8 :: w9 :: w10 :: w11 :: w12 ::
                 w13 :: aprev :: rest } =
    some { s with pc := UInt256.ofNat 4454,
...
theorem run_B1 (s : State) (tb x P hd w3 ent w5 M : UInt256)
    ...
    runInstructions programB1
      { s with pc := UInt256.ofNat 4455,
               stack := tb :: x :: P :: hd :: w3 :: ent :: w5 :: M :: rest } =
    some { s with pc := UInt256.ofNat 4465,
...
theorem run_B2 (s : State) (mmr x f b2 : UInt256)
    ...
    runInstructions programB2
      { s with pc := UInt256.ofNat 4465, stack := mmr :: x :: f :: b2 :: rest } =
    some { s with pc := UInt256.ofNat 4480,
...
theorem run_B3a (s : State) (hi lo b2 P : UInt256)
    ...
    runInstructions programB3a
      { s with pc := UInt256.ofNat 4480, stack := hi :: lo :: b2 :: P :: rest } =
    some { s with pc := UInt256.ofNat 4486,
...
theorem run_B3b (s : State) (tA lo hi b2 P : UInt256)
    ...
    runInstructions programB3b
      { s with pc := UInt256.ofNat 4486, stack := tA :: lo :: hi :: b2 :: P :: rest } =
    some { s with pc := UInt256.ofNat 4495,
...
theorem run_B4 (s : State) (C b2 P hd w3 ent : UInt256)
    ...
    runInstructions programB4
      { s with pc := UInt256.ofNat 4493, stack := C :: b2 :: P :: hd :: w3 :: ent :: rest } =
    some { s with pc := ent,
...
theorem run_B23a (s : State) (mmr x f b2 P : UInt256)
    ...
    runInstructions programB23a
      { s with pc := UInt256.ofNat 4465, stack := mmr :: x :: f :: b2 :: P :: rest } =
    some { s with pc := UInt256.ofNat 4482,
                  stack := (P - (256 : UInt256)) ::
...
theorem run_B23b (s : State) (tA d lo b2 P : UInt256)
    ...
    runInstructions programB23b
      { s with pc := UInt256.ofNat 4482, stack := tA :: d :: lo :: b2 :: P :: rest } =
    some { s with pc := UInt256.ofNat 4493,
...
row head (`hd = 4797`, frame slot `ent = e`, slot 14 = `aprev`) to the first-loop entry
...
def gasSteps_prologue (s : State) (mem : ByteArray) (n i e : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s mem 2368 n i (UInt256.ofNat 4448) (UInt256.ofNat e) pdst ret
      ...
      (l1Q e s (sqPro mem n i (UInt256.sgt (UInt256.ofNat 0) aprev))
        ...
        (UInt256.ofNat 4448) (UInt256.ofNat (e + 37)) pdst ret
  ...
  -- block A
  have hA := run_A s' P (UInt256.ofNat 4448) (UInt256.ofNat (2368 - 32)) (UInt256.ofNat e)
  ...
  have gS := SgtStep.gasSteps_sqRowSgt
    { s' with pc := UInt256.ofNat 4454,
              stack := UInt256.ofNat 0 :: aprev :: MachineState.readWord s'.memory P.toNat :: P ::
                UInt256.ofNat 4448 :: UInt256.ofNat (2368 - 32) :: UInt256.ofNat e :: negative32 ::
  ...
  have hB := run_B s' (UInt256.sgt (UInt256.ofNat 0) aprev) (MachineState.readWord s'.memory P.toNat) P
    (UInt256.ofNat 4448) (UInt256.ofNat (2368 - 32)) (UInt256.ofNat e) negative32 allOnes
