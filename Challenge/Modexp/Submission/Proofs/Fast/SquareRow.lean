...
/-!
# The `sq_row` prologue of the square rows (sqCP1m, new idx 3604..3644, pc 0x1266)

`sq_row` is the row head `hd = 4664` of a square call.  On the kernel row frame
...
(idx 3604..3600, pc 4664, 6 instructions), `SgtStep.gasSteps_sqRowSgt_framed`
(idx 3601, pc 4716), block B (idx 3602..3644, pc 4703, 43 instructions; its
...
/-- `JUMPDEST DUP1 MLOAD DUP1 SWAP15 PUSH0` (idx 3604..3600). -/
def programA : List Instr :=
  [.op .JUMPDEST, .op (.Dup ⟨0, by decide⟩), .op .MLOAD, .op (.Dup ⟨0, by decide⟩),
   .op (.Swap ⟨14, by decide⟩), .push 0 0]

/-- `DUP2 ADD DUP2 DUP2 ADD SWAP2 DUP9 DUP3 DUP3 MULMOD` (idx 3602..3614). -/
...
/-- `SWAP2 DUP2 DUP2 LT SWAP2 MUL SWAP2 SUB DUP2 DUP2 LT DUP3 SWAP2 SUB SUB` (idx 3621..3629). -/
...
/-- `SWAP1 DUP4 PUSH2 0x1840 ADD` (idx 3630..3641). -/
def programB3a : List Instr :=
  [.op (.Swap ⟨0, by decide⟩), .op (.Dup ⟨3, by decide⟩), .push 2 6208, .op .ADD]

/-- `DUP1 MLOAD DUP3 ADD DUP1 SWAP2 MSTORE LT ADD` (idx 3631..3639). -/
...
/-- `PUSH1 0x26 DUP7 ADD SWAP6 JUMP` (idx 3640..3644). -/
def programB4 : List Instr :=
  [.push 1 38, .op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op .JUMP]

/-- Everything after the `SGT` (idx 3602..3644). -/
def programB : List Instr :=
  (((programB1 ++ programB2) ++ programB3a) ++ programB3b) ++ programB4

/-! ## Location certificates -/

def blockA : Block Artifact.submissionArtifact .Osaka 4724 programA :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3620 6 4724 programA
    (by decide) (by rfl) (by rfl) (by decide)

def blockB : Block Artifact.submissionArtifact .Osaka 4731 programB :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3627 43 4731 programB
    (by decide) (by rfl) (by rfl) (by decide)

/-- `sq_row` itself is a jump destination (the frame's row head for square calls). -/
theorem jumpDest4710 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4724 = true :=
  Artifact.isValidJumpDest_index 3620 (by rfl)
...
theorem run_A (s : State) (P hd w3 ent w5 M w7 w8 w9 w10 w11 w12 w13 aprev : UInt256)
    ...
    runInstructions programA
      { s with pc := UInt256.ofNat 4724,
               stack := P :: hd :: w3 :: ent :: w5 :: M :: w7 :: w8 :: w9 :: w10 :: w11 :: w12 ::
                 w13 :: aprev :: rest } =
    some { s with pc := UInt256.ofNat 4730,
...
theorem run_B2 (s : State) (mmr x f b2 : UInt256)
    ...
    runInstructions programB2
      { s with pc := UInt256.ofNat 4741, stack := mmr :: x :: f :: b2 :: rest } =
...
theorem run_B3a (s : State) (hi lo b2 P : UInt256)
    ...
    runInstructions programB3a
      { s with pc := UInt256.ofNat 4756, stack := hi :: lo :: b2 :: P :: rest } =
...
theorem run_B3b (s : State) (tA lo hi b2 P : UInt256)
    ...
    runInstructions programB3b
      { s with pc := UInt256.ofNat 4762, stack := tA :: lo :: hi :: b2 :: P :: rest } =
    some { s with pc := UInt256.ofNat 4771,
...
theorem run_B4 (s : State) (C b2 P hd w3 ent : UInt256)
    ...
    runInstructions programB4
      { s with pc := UInt256.ofNat 4771, stack := C :: b2 :: P :: hd :: w3 :: ent :: rest } =
    some { s with pc := ent,
...
row head (`hd = 4664`, frame slot `ent = e`, slot 14 = `aprev`) to the first-loop entry
...
def gasSteps_prologue (s : State) (mem : ByteArray) (n i e : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s mem 2048 n i (UInt256.ofNat 4724) (UInt256.ofNat e) pdst ret
      ...
      (l1Q e s (sqPro mem n i (UInt256.sgt (UInt256.ofNat 0) aprev))
        ...
        (UInt256.ofNat 4724) (UInt256.ofNat (e + 38)) pdst ret
  ...
  -- block A
  have hA := run_A s' P (UInt256.ofNat 4724) (UInt256.ofNat (2048 - 32)) (UInt256.ofNat e)
  ...
  have gS := SgtStep.gasSteps_sqRowSgt
    { s' with pc := UInt256.ofNat 4730,
              stack := UInt256.ofNat 0 :: aprev :: MachineState.readWord s'.memory P.toNat :: P ::
                UInt256.ofNat 4724 :: UInt256.ofNat (2048 - 32) :: UInt256.ofNat e :: negative32 ::
  ...
  have hB := run_B s' (UInt256.sgt (UInt256.ofNat 0) aprev) (MachineState.readWord s'.memory P.toNat) P
    (UInt256.ofNat 4724) (UInt256.ofNat (2048 - 32)) (UInt256.ofNat e) negative32 allOnes
