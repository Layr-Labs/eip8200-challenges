...
def gateBlock : Block Artifact.submissionArtifact .Osaka 4528 LazyGate.program :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3589 5 4528 LazyGate.program
    (by decide) (by rfl) (by rfl) (by decide)

def copyBlock : Block Artifact.submissionArtifact .Osaka 4537 LazyGate.copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3594 7 4537 LazyGate.copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
