...
def gateBlock : Block Artifact.submissionArtifact .Osaka 4443 LazyGate.program :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3556 5 4443 LazyGate.program
    (by decide) (by rfl) (by rfl) (by decide)

def copyBlock : Block Artifact.submissionArtifact .Osaka 4452 LazyGate.copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3561 7 4452 LazyGate.copyProgram
    (by decide) (by rfl) (by rfl) (by decide)

theorem jumpDestGate : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4443 = true :=
  Artifact.isValidJumpDest_index 3556 (by rfl)

theorem jumpDestCopy : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4452 = true :=
...
def gasSteps_csub_lazy (s : State) (memory : ByteArray) (n : Nat)
    ...
    (hfast : n = 4 ∨ n = 8) :
    Challenge.EvmProof.GasSteps (LazyGate.atState s memory 4443 pdst ret rest)
