...
def gateBlock : Block Artifact.submissionArtifact .Osaka 4333 LazyGate.program :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3243 5 4333 LazyGate.program
    (by decide) (by rfl) (by rfl) (by decide)

def copyBlock : Block Artifact.submissionArtifact .Osaka 4342 LazyGate.copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3248 7 4342 LazyGate.copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
