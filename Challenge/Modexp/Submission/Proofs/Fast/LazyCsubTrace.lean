...
def gateBlock : Block Artifact.submissionArtifact .Osaka 4458 LazyGate.program :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3532 4 4458 LazyGate.program
    (by decide) (by rfl) (by rfl) (by decide)

def copyBlock : Block Artifact.submissionArtifact .Osaka 4464 LazyGate.copyProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3536 7 4464 LazyGate.copyProgram
    (by decide) (by rfl) (by rfl) (by decide)
