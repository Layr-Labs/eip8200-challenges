...
theorem run_out (s : State) (mem : ByteArray) (pa pb n i : Nat)
    ...
    runInstructions outProgram
      ...
      some (l1At 4244 s mem (rowBi mem pb n i) pa pb n i 0 pdst ret rest) := by
  ...
  simp (config := { maxSteps := 800000 })
    [hExtra9, hExtra10, hExtra11, hExtra12, hExtra13, hExtra14, hExtra15, hExtra16, outProgram, runInstructions,
