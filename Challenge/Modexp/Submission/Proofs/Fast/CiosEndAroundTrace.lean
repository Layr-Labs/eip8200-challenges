...
theorem run_loadLow (s : State) (bi pbi paEnd pbEnd flag dst ret : UInt256) (n : Nat)
    ...
    runInstructions loadLow
      (framed s (UInt256.ofNat 4928) (baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4934) ([MachineState.readWord s.memory (8224+32*n)] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) := by
...
theorem run_makeMu (s : State) (bi pbi paEnd pbEnd flag dst ret : UInt256) (t0 : UInt256)
    ...
    runInstructions makeMu
      (framed s (UInt256.ofNat 4934) ([t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4935) ([MachineState.readWord s.memory 9376 * t0, t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) := by
  have hp9408 : (9408 : UInt256).toNat = 9408 := by decide
  have hp9440 : (9440 : UInt256).toNat = 9440 := by decide
  have hp9376 : (9376 : UInt256).toNat = 9376 := by decide
  have h0 : rest.length < 1024 := by omega
...
theorem run_loadMod (s : State) (bi pbi paEnd pbEnd flag dst ret : UInt256) (n : Nat) (mu t0 : UInt256)
    ...
    runInstructions loadMod
      (framed s (UInt256.ofNat 4935) ([mu, t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4941) ([MachineState.readWord s.memory (32*n-32), mu, mu, t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) := by
  have hp9408 : (9408 : UInt256).toNat = 9408 := by decide
  have hp9440 : (9440 : UInt256).toNat = 9440 := by decide
  have hp9376 : (9376 : UInt256).toNat = 9376 := by decide
  have h0 : rest.length < 1024 := by omega
...
theorem run_makeModProduct (s : State) (bi pbi paEnd pbEnd flag dst ret : UInt256) (m0 mu t0 : UInt256)
    ...
    runInstructions makeModProduct
      (framed s (UInt256.ofNat 4941) ([m0, mu, mu, t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4944) ([UInt256.mulMod mu m0 maxWord, mu, t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) := by
  have hp9408 : (9408 : UInt256).toNat = 9408 := by decide
  have hp9440 : (9440 : UInt256).toNat = 9440 := by decide
  have hp9376 : (9376 : UInt256).toNat = 9376 := by decide
  have h0 : rest.length < 1024 := by omega
...
theorem run_finishCarry (s : State) (bi pbi paEnd pbEnd flag dst ret : UInt256) (mm mu t0 : UInt256)
    ...
    runInstructions finishCarry
      (framed s (UInt256.ofNat 4944) ([mm, mu, t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4954) ([endCarry mm t0, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) := by
  have hp9408 : (9408 : UInt256).toNat = 9408 := by decide
  have hp9440 : (9440 : UInt256).toNat = 9440 := by decide
  have hp9376 : (9376 : UInt256).toNat = 9376 := by decide
  have h0 : rest.length < 1024 := by omega
