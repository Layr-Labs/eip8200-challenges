...
opaque gasSteps_rowsEight (L : RowLemmas) (s : State) (mem : ByteArray) (pa pb : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s (mpZeroed s mem 8) pb 8 0 (UInt256.ofNat 3520) (l1Target 8) m64 m32 (m0 :: tl :: m96 :: negative32 :: inv :: aEnd :: pdst :: ret :: rest))
  ...
  refine (Challenge.EvmProof.GasSteps.iterateBounded
    (I := fun i => outState s (rowsCarry (mpZeroed s mem 8) pa pb 8 i)
      pb 8 i (UInt256.ofNat 3520) (l1Target 8) m64 m32 (m0 :: tl :: m96 :: negative32 :: inv :: aEnd :: pdst :: ret :: rest)) 7 ?_).trans ?_
  · intro i hi
    exact gasSteps_rowEightNext L s (rowsCarry (mpZeroed s mem 8) pa pb 8 i) pa pb i
      ...
      (extraCache_rowsCarry hez pa pb 8 i (by decide)) hAend (hsz.rows_stage pb i (by decide) hpaFit)
  · exact
      gasSteps_rowEightLast L s (rowsCarry (mpZeroed s mem 8) pa pb 8 7) pa pb 7
        ...
        (extraCache_rowsCarry hez pa pb 8 7 (by decide)) hAend (hsz.rows_stage pb 7 (by decide) hpaFit)
