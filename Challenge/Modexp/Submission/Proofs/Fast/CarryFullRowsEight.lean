...
/-- The eight rows of an eight-limb multiply, from the row-0 head (`hd = 3996`) to the final
subtraction. -/
opaque gasSteps_rowsEight (L : RowLemmas) (s : State) (mem : ByteArray) (pa pb : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (outState s (mpZeroed s mem 8) pb 8 0 (UInt256.ofNat 3988) (l1Target 8) inv m0
