...
def private0 : Block submissionArtifact .Osaka 5430 (TnCacheL1Suffix.program 0) :=
  WindowTwentyOneSlice.block allWellFormed 4360 1 5430 (TnCacheL1Suffix.program 0)
    (by decide) (by rfl) (by rfl) (by decide)

def private1 : Block submissionArtifact .Osaka 5393 (TnCacheL1Suffix.program 1) :=
  WindowTwentyOneSlice.block allWellFormed 4329 32 5393 (TnCacheL1Suffix.program 1)
    (by decide) (by rfl) (by rfl) (by decide)

def private2 : Block submissionArtifact .Osaka 5356 (TnCacheL1Suffix.program 2) :=
  WindowTwentyOneSlice.block allWellFormed 4298 63 5356 (TnCacheL1Suffix.program 2)
    (by decide) (by rfl) (by rfl) (by decide)

def private3 : Block submissionArtifact .Osaka 5319 (TnCacheL1Suffix.program 3) :=
  WindowTwentyOneSlice.block allWellFormed 4267 94 5319 (TnCacheL1Suffix.program 3)
    (by decide) (by rfl) (by rfl) (by decide)
...
def drop : Block submissionArtifact .Osaka 4152 (TnCacheExitTrace.drop) :=
  WindowTwentyOneSlice.block allWellFormed 3311 4 4152 (TnCacheExitTrace.drop)
    (by decide) (by rfl) (by rfl) (by decide)
