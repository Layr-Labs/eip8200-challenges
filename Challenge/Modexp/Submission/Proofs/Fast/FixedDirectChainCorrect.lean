...
theorem jumpD3996 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
    (UInt256.ofNat 3996).toNat = true :=
  Exp.jumpD 3996 (by decide) FixedDirectPaths.jumpDest3996
