...
@[simp] private theorem compactLoopPC2758 : Artifact.submissionArtifact.instructionPC 2845 = 3800 := by rfl
@[simp] private theorem compactLoopPC2759 : Artifact.submissionArtifact.instructionPC 2846 = 3803 := by rfl
@[simp] private theorem compactLoopPC2760 : Artifact.submissionArtifact.instructionPC 2846 = 3803 := by rfl
@[simp] private theorem compactLoopPC2761 : Artifact.submissionArtifact.instructionPC 2846 = 3803 := by rfl
@[simp] private theorem compactLoopPC2762 : Artifact.submissionArtifact.instructionPC 2847 = 3804 := by rfl
@[simp] private theorem compactLoopPC2763 : Artifact.submissionArtifact.instructionPC 2848 = 3805 := by rfl
@[simp] private theorem compactLoopPC2764 : Artifact.submissionArtifact.instructionPC 2849 = 3806 := by rfl
@[simp] private theorem compactLoopPC2765 : Artifact.submissionArtifact.instructionPC 2850 = 3807 := by rfl
@[simp] private theorem compactLoopPC2766 : Artifact.submissionArtifact.instructionPC 2851 = 3808 := by rfl
@[simp] private theorem compactLoopPC2767 : Artifact.submissionArtifact.instructionPC 2852 = 3809 := by rfl
@[simp] private theorem compactLoopPC2768 : Artifact.submissionArtifact.instructionPC 2853 = 3810 := by rfl
@[simp] private theorem compactLoopPC2769 : Artifact.submissionArtifact.instructionPC 2854 = 3811 := by rfl
@[simp] private theorem compactLoopPC2770 : Artifact.submissionArtifact.instructionPC 2855 = 3812 := by rfl
@[simp] private theorem compactLoopPC2771 : Artifact.submissionArtifact.instructionPC 2856 = 3813 := by rfl
@[simp] private theorem compactLoopPC2772 : Artifact.submissionArtifact.instructionPC 2857 = 3814 := by rfl
@[simp] private theorem compactLoopPC2773 : Artifact.submissionArtifact.instructionPC 2858 = 3815 := by rfl
@[simp] private theorem compactLoopPC2774 : Artifact.submissionArtifact.instructionPC 2859 = 3816 := by rfl
@[simp] private theorem compactLoopPC2775 : Artifact.submissionArtifact.instructionPC 2860 = 3817 := by rfl
@[simp] private theorem compactLoopPC2776 : Artifact.submissionArtifact.instructionPC 2861 = 3818 := by rfl
@[simp] private theorem compactLoopPC2777 : Artifact.submissionArtifact.instructionPC 2862 = 3819 := by rfl
@[simp] private theorem compactLoopPC2778 : Artifact.submissionArtifact.instructionPC 2863 = 3820 := by rfl
@[simp] private theorem compactLoopPC2779 : Artifact.submissionArtifact.instructionPC 2864 = 3821 := by rfl
@[simp] private theorem compactLoopPC2780 : Artifact.submissionArtifact.instructionPC 2865 = 3822 := by rfl
@[simp] private theorem compactLoopPC2781 : Artifact.submissionArtifact.instructionPC 2866 = 3823 := by rfl
@[simp] private theorem compactLoopPC2782 : Artifact.submissionArtifact.instructionPC 2867 = 3824 := by rfl
@[simp] private theorem compactLoopPC2783 : Artifact.submissionArtifact.instructionPC 2868 = 3825 := by rfl
@[simp] private theorem compactLoopPC2784 : Artifact.submissionArtifact.instructionPC 2869 = 3826 := by rfl
@[simp] private theorem compactLoopPC2785 : Artifact.submissionArtifact.instructionPC 2870 = 3827 := by rfl
@[simp] private theorem compactLoopPC2786 : Artifact.submissionArtifact.instructionPC 2871 = 3828 := by rfl
@[simp] private theorem compactLoopPC2787 : Artifact.submissionArtifact.instructionPC 2872 = 3829 := by rfl
@[simp] private theorem compactLoopPC2788 : Artifact.submissionArtifact.instructionPC 2873 = 3830 := by rfl
@[simp] private theorem compactLoopPC2789 : Artifact.submissionArtifact.instructionPC 2874 = 3831 := by rfl
@[simp] private theorem compactLoopPC2790 : Artifact.submissionArtifact.instructionPC 2875 = 3832 := by rfl
@[simp] private theorem compactLoopPC2791 : Artifact.submissionArtifact.instructionPC 2876 = 3833 := by rfl
@[simp] private theorem compactLoopPC2792 : Artifact.submissionArtifact.instructionPC 2877 = 3834 := by rfl
@[simp] private theorem compactLoopPC2793 : Artifact.submissionArtifact.instructionPC 2878 = 3835 := by rfl
@[simp] private theorem compactLoopPC2794 : Artifact.submissionArtifact.instructionPC 2879 = 3836 := by rfl
@[simp] private theorem compactLoopPC2795 : Artifact.submissionArtifact.instructionPC 2880 = 3837 := by rfl
...
def cellPath :
  ...
  [opAt 2844 .JUMPDEST,
   ...
   opAt 2850 (.Dup ⟨6, by decide⟩),
   opAt 2851 (.Dup ⟨2, by decide⟩),
   opAt 2852 .MUL,
   opAt 2853 (.Swap ⟨1, by decide⟩),
   opAt 2854 (.Dup ⟨7, by decide⟩),
   opAt 2855 .MULMOD,
   opAt 2856 (.Dup ⟨1, by decide⟩),
   opAt 2857 (.Dup ⟨1, by decide⟩),
   opAt 2858 .LT,
   opAt 2859 .SUB,
   opAt 2860 (.Dup ⟨5, by decide⟩),
   opAt 2861 (.Dup ⟨2, by decide⟩),
   opAt 2862 .ADD,
   opAt 2863 (.Dup ⟨0, by decide⟩),
   opAt 2864 (.Swap ⟨6, by decide⟩),
   opAt 2865 .GT,
   opAt 2866 .SUB,
   opAt 2867 .SUB,
   opAt 2868 (.Dup ⟨4, by decide⟩),
   opAt 2869 (.Dup ⟨2, by decide⟩),
   opAt 2870 .MLOAD,
   opAt 2871 .ADD,
   opAt 2872 (.Dup ⟨0, by decide⟩),
   opAt 2873 (.Swap ⟨5, by decide⟩),
   opAt 2874 .GT,
   opAt 2875 .ADD,
   opAt 2876 (.Swap ⟨3, by decide⟩),
   opAt 2877 (.Dup ⟨1, by decide⟩),
   opAt 2878 .MSTORE,
   opAt 2879 (.Dup ⟨2, by decide⟩),
   opAt 2880 .ADD]

@[simp] private theorem cellStartPC : Artifact.submissionArtifact.instructionPC 2844 = 3799 := by rfl
