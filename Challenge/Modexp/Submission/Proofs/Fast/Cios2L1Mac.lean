...
theorem jumpDest4695 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4695 = true := by
  exact Artifact.isValidJumpDest_index 2897 (by rfl)
...
theorem run_l1FirstMac (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock firstMac
      ...
      some (l1At 4270 s mem bi pa pb n i (j + 1) pdst ret rest) := by
...
theorem run_l1SecondMacExit (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  have hK :
      (115792089237316195423570985008687907853269984665640564039457584007913129639904 :
        UInt256) = UInt256.ofNat
          115792089237316195423570985008687907853269984665640564039457584007913129639904 := by
    decide
  have h4695 : (4695 : UInt256).toNat = 4695 := by decide
  have h4695' : (4695 : UInt256) = UInt256.ofNat 4695 := by decide
  have hjump : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (4695 : UInt256).toNat = true := by
    rw [h4695]
    exact jumpDest4695
  have hpaj : ptrAt (pa + 32 * n - 32) k %
      115792089237316195423570985008687907853269984665640564039457584007913129639936 =
  ...
  simp (config := { maxSteps := 800000 })
    [secondMacExit, secondMac, Cios2Paths.L1.secondPC, Cios2Paths.L1.secondStartIndex,
      ...
      hc9, hc10, hc11, hc12, hc13, hrun, hK, h4695, h4695', hjump,
      jumpDest4695,
...
def gasSteps_l1FirstMac (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    Challenge.EvmProof.GasSteps
      (l1At 4136 s mem bi pa pb n i j pdst ret rest)
      (l1At 4270 s mem bi pa pb n i (j + 1) pdst ret rest) :=
