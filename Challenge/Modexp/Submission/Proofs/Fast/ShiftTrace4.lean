...
def gasSteps_macCell (s : State) (um : ByteArray) (q : UInt256)
    (n bsize esize msize k j : Nat) (hn32 : n ≤ 32) (hj : j < n) (e : Env s) :
...
structure StepInv (mem : ByteArray) (n bsize mm minv : Nat) : Prop where
  ...
  cache : MachineState.readWord mem 6304 = ShiftCacheModel.entryWord n
    ...
    (    (((soundEnv blk3013 e
      ...
      (soundEnv blk3069 e
        (run_macSetup s mem n bsize esize msize k (by omega) hn32 e.act296
          ...
          (by rw [hhighU 9408 (by omega)]; exact hml0) e.code e.run))).trans
