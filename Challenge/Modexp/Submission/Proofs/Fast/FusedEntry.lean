...
def prefixBlock : Block Artifact.submissionArtifact .Osaka 3414 prefixProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2712 34 3414 prefixProgram
    (by decide) (by rfl) (by rfl) (by decide)
def clearBlock : Block Artifact.submissionArtifact .Osaka 3465 clearProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2746 6 3465 clearProgram
    (by decide) (by rfl) (by rfl) (by decide)
def reloadBlock : Block Artifact.submissionArtifact .Osaka 3475 reloadProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2752 4 3475 reloadProgram
    (by decide) (by rfl) (by rfl) (by decide)
