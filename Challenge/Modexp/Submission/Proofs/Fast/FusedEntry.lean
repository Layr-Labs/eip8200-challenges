...
def prefixBlock : Block Artifact.submissionArtifact .Osaka 3666 prefixProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2727 28 3666 prefixProgram
    (by decide) (by rfl) (by rfl) (by decide)
def clearBlock : Block Artifact.submissionArtifact .Osaka 3707 clearProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2755 6 3707 clearProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
def prefixState (s : State) (mem : ByteArray) (n : Nat)
    (tl inv m0 m96 m64 m32 : UInt256) (rest : List UInt256) : State :=
  { rowReady s mem n tl inv m0 m96 m64 m32 rest with pc := UInt256.ofNat 3707 }
...
theorem run_prefix (s : State) (mem : ByteArray) (n : Nat)
    ...
    runInstructions prefixProgram
      (frameAt 3666 s mem n pbi ent tl inv m0 m96 m64 m32 aprev pdst ret rest) =
...
def gasSteps_entry (s : State) (mem : ByteArray) (n : Nat)
  ...
  (prefixBlock.steps (CarryRowBlocks.environment
    (frameAt 3666 s mem n pbi ent tl inv m0 m96 m64 m32 aprev pdst ret rest) hcode hfork hrun hnp) rfl
