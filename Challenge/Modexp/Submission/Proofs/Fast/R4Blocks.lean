...
def block_pro : Block Artifact.submissionArtifact .Osaka 4795 prog_pro :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3619 8 4795 prog_pro
...
def block_r0d : Block Artifact.submissionArtifact .Osaka 4803 prog_r0d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3627 20 4803 prog_r0d
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4825 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3647 21 4825 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4848 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3668 21 4848 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4871 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3689 21 4871 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4904, .push 2 5147,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4894 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3710 6 4894 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 5147 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3931 12 5147 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5159 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3943 27 5159 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5186 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3970 27 5186 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5213 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3997 27 5213 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5240 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4024 14 5240 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4904 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3716 6 4904 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4915 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3723 30 4915 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4945 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3753 27 4945 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4974 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3780 27 4974 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5017, .push 2 5147, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 5003 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3807 10 5003 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 5017 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3817 6 5017 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 5028 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3824 30 5028 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 5058 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3854 27 5058 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5101, .push 2 5147, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 5087 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3881 10 5087 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 5101 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3891 6 5101 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 5112 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3898 27 5112 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 5139 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3925 6 5139 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5257 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4041 29 5257 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
