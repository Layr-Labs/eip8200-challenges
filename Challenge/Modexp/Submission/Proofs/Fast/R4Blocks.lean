...
def block_prodiag : Block Artifact.submissionArtifact .Osaka 4504 prog_prodiag :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3593 27 4504 prog_prodiag
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4533 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3620 21 4533 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4556 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3641 21 4556 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4579 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3662 21 4579 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4612, .push 2 4852,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4602 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3683 6 4602 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 4852 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3901 11 4852 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 4863 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3912 27 4863 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 4890 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3939 27 4890 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 4917 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3966 27 4917 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 4944 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3993 12 4944 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4612 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3689 6 4612 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4623 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3696 29 4623 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4652 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3725 27 4652 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4681 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3752 27 4681 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4724, .push 2 4852, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4710 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3779 10 4710 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 4724 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3789 6 4724 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 4735 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3796 29 4735 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 4764 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3825 27 4764 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4807, .push 2 4852, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 4793 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3852 10 4793 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 4807 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3862 6 4807 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 4818 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3869 26 4818 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 4844 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3895 6 4844 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 4958 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4007 19 4958 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
