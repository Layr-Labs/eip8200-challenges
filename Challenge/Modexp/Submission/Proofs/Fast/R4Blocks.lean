...
def prog_prodiag : List Instr :=
  [.op .JUMPDEST, .op (.Dup ⟨7, by decide⟩), .push 0 0, .op .MLOAD, .op (.Dup ⟨14, by decide⟩),
   .op (.Dup ⟨14, by decide⟩), .op (.Dup ⟨12, by decide⟩), .push 2 2464, .op .MLOAD,
   .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨0, by decide⟩), .op .ADD, .op (.Dup ⟨1, by decide⟩),
   .op (.Dup ⟨0, by decide⟩), .op .MUL, .op (.Dup ⟨13, by decide⟩), .op (.Dup ⟨0, by decide⟩),
   .op (.Swap ⟨3, by decide⟩), .op (.Dup ⟨0, by decide⟩), .op .MULMOD,
   .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op .GT, .op (.Dup ⟨2, by decide⟩),
   .op (.Swap ⟨1, by decide⟩), .op .SUB, .op .SUB]

def block_prodiag : Block Artifact.submissionArtifact .Osaka 4508 prog_prodiag :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3563 27 4508 prog_prodiag
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4537 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3590 21 4537 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4560 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3611 21 4560 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4583 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3632 21 4583 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0e : Block Artifact.submissionArtifact .Osaka 4606 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3653 6 4606 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 4856 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3871 11 4856 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5174..5201（idx 3951..3978）。 -/
def prog_reds1 : List Instr :=
  [.op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨12, by decide⟩), .op .MUL, .op (.Dup ⟨10, by decide⟩),
   .op (.Dup ⟨13, by decide⟩), .op (.Dup ⟨4, by decide⟩), .op .MULMOD,
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 4867 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3882 27 4867 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5202..5229（idx 3979..4006）。 -/
def prog_reds2 : List Instr :=
  [.op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨13, by decide⟩), .op .MUL, .op (.Dup ⟨10, by decide⟩),
   .op (.Dup ⟨14, by decide⟩), .op (.Dup ⟨4, by decide⟩), .op .MULMOD,
   .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op .GT, .op .SUB,
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 4894 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3909 27 4894 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5230..5257（idx 4007..4034）。 -/
def prog_reds3 : List Instr :=
  [.op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨14, by decide⟩), .op .MUL, .op (.Dup ⟨10, by decide⟩),
   .op (.Dup ⟨15, by decide⟩), .op (.Dup ⟨4, by decide⟩), .op .MULMOD,
   .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op .GT, .op .SUB,
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 4921 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3936 27 4921 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5258..5273（idx 4035..4050）。 -/
def prog_redt : List Instr :=
  [.op (.Dup ⟨8, by decide⟩), .op .ADD, .op (.Swap ⟨3, by decide⟩), .op .POP, .op .POP,
   .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op .LT, .op .ADD,
   .op (.Swap ⟨4, by decide⟩), .op .JUMP]

def block_redt : Block Artifact.submissionArtifact .Osaka 4948 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3963 11 4948 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4616 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3659 6 4616 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4914..4947（idx 3715..3748）。 -/
def prog_r1d : List Instr :=
  [.op (.Dup ⟨1, by decide⟩), .op .ADD, .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨1, by decide⟩),
   .op .ADD, .op (.Swap ⟨1, by decide⟩), .op (.Dup ⟨8, by decide⟩), .op (.Dup ⟨2, by decide⟩),
   .op (.Dup ⟨2, by decide⟩), .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨5, by decide⟩), .op .MUL,
   .op (.Swap ⟨4, by decide⟩), .op .LT, .op (.Swap ⟨2, by decide⟩), .op .MULMOD, .op .SUB,
   .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨1, by decide⟩), .op .LT, .op .SUB,
   .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩),
   .op (.Dup ⟨6, by decide⟩), .op .LT, .op .SUB, .op .SUB]

def block_r1d : Block Artifact.submissionArtifact .Osaka 4627 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3666 29 4627 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4656 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3695 27 4656 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4685 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3722 27 4685 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩),
   .op .LT, .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4728, .push 2 4856, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4714 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3749 10 4714 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 4728 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3759 6 4728 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def prog_r2d : List Instr :=
  [.op (.Dup ⟨1, by decide⟩), .op .ADD, .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨1, by decide⟩),
   ...
   .op (.Swap ⟨4, by decide⟩), .op .LT, .op (.Swap ⟨2, by decide⟩), .op .MULMOD, .op .SUB,
   .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨1, by decide⟩), .op .LT, .op .SUB,
   .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨5, by decide⟩), .op .ADD, .op (.Swap ⟨4, by decide⟩),
   .op (.Dup ⟨5, by decide⟩), .op .LT, .op .SUB, .op .SUB]

def block_r2d : Block Artifact.submissionArtifact .Osaka 4739 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3766 29 4739 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 4768 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3795 27 4768 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩),
   .op .LT, .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4811, .push 2 4856, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 4797 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3822 10 4797 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 4811 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3832 6 4811 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5119..5149（idx 3898..3928）。 -/
def prog_r3d : List Instr :=
  [.op (.Dup ⟨1, by decide⟩), .op .ADD, .op (.Swap ⟨0, by decide⟩), .op (.Dup ⟨7, by decide⟩),
   .op (.Dup ⟨2, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op (.Dup ⟨0, by decide⟩),
   .op (.Dup ⟨5, by decide⟩), .op .MUL, .op (.Swap ⟨4, by decide⟩), .op .LT,
   .op (.Swap ⟨2, by decide⟩), .op .MULMOD, .op .SUB, .op (.Dup ⟨1, by decide⟩),
   .op (.Dup ⟨1, by decide⟩), .op .LT, .op .SUB, .op (.Dup ⟨1, by decide⟩),
   .op (.Dup ⟨3, by decide⟩), .op .ADD, .op (.Swap ⟨2, by decide⟩), .op (.Dup ⟨3, by decide⟩),
   .op .LT, .op .SUB, .op .SUB]

def block_r3d : Block Artifact.submissionArtifact .Osaka 4822 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3839 26 4822 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 4848 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3865 6 4848 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def prog_exit : List Instr :=
  [.op .JUMPDEST, .push 3 2112, .op .MSTORE, .push 3 2144, .op .MSTORE, .push 3 2176,
   .op .MSTORE, .push 3 2208, .op .MSTORE, .push 3 2080, .op .MSTORE, .op .POP, .op .POP,
   .op .POP, .op .POP, .op .POP, .op .POP, .push 7 4119, .op .JUMP]

def block_exit : Block Artifact.submissionArtifact .Osaka 4962 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3977 19 4962 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
