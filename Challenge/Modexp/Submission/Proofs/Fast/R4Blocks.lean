...
def block_prodiag : Block Artifact.submissionArtifact .Osaka 4782 prog_prodiag :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3606 27 4782 prog_prodiag
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4811 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3633 21 4811 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4834 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3654 21 4834 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4857 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3675 21 4857 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4890, .push 2 5133,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4880 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3696 6 4880 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 5133 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3917 11 5133 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5144 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3928 27 5144 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5171 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3955 27 5171 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5198 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3982 27 5198 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5225 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4009 14 5225 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4890 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3702 6 4890 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4901 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3709 30 4901 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4931 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3739 27 4931 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4960 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3766 27 4960 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5003, .push 2 5133, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4989 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3793 10 4989 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 5003 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3803 6 5003 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 5014 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3810 30 5014 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 5044 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3840 27 5044 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5087, .push 2 5133, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 5073 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3867 10 5073 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 5087 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3877 6 5087 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 5098 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3884 27 5098 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 5125 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3911 6 5125 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5239 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4023 29 5239 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
