...
def block_prodiag : Block Artifact.submissionArtifact .Osaka 4788 prog_prodiag :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3611 27 4788 prog_prodiag
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4817 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3638 21 4817 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4840 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3659 21 4840 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4863 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3680 21 4863 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4896, .push 2 5136,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4886 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3701 6 4886 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5155..5170（idx 3935..3950）。 -/
...
def block_redm : Block Artifact.submissionArtifact .Osaka 5136 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3919 11 5136 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5171..5198（idx 3951..3978）。 -/
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5147 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3930 27 5147 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5199..5226（idx 3979..4006）。 -/
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5174 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3957 27 5174 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5227..5254（idx 4007..4034）。 -/
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5201 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3984 27 5201 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5255..5270（idx 4035..4050）。 -/
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5228 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4011 14 5228 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4896 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3707 6 4896 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4914..4946（idx 3715..3748）。 -/
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4907 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3714 29 4907 prog_r1d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)

/-- pc 4947..4975（idx 3749..3775）。 -/
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4936 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3743 27 4936 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4976..5004（idx 3776..3802）。 -/
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4965 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3770 27 4965 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5005..5018（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5008, .push 2 5136, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4994 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3797 10 4994 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5019..5028（idx 3813..3818）。 -/
def prog_r2h : List Instr :=
  [.op .JUMPDEST, .push 2 2400, .op .MLOAD, .push 2 2432, .op .MLOAD, .push 0 0]

def block_r2h : Block Artifact.submissionArtifact .Osaka 5008 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3807 6 5008 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5030..5062（idx 3820..3853）。 -/
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 5019 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3814 29 5019 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)

/-- pc 5063..5091（idx 3854..3880）。 -/
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 5048 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3843 27 5048 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5092..5105（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5091, .push 2 5136, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 5077 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3870 10 5077 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5106..5115（idx 3891..3896）。 -/
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 5091 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3880 6 5091 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5116..5146（idx 3898..3928）。 -/
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 5102 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3887 26 5102 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)

/-- pc 5147..5152（idx 3929..3934）。 -/
def prog_r3e : List Instr :=
  [.op (.Dup ⟨5, by decide⟩), .op .ADD, .op (.Swap ⟨4, by decide⟩), .op (.Dup ⟨5, by decide⟩), .op .LT,
   .push 2 5242]

def block_r3e : Block Artifact.submissionArtifact .Osaka 5128 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3913 6 5128 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5271..5311（idx 4051..4079）。 -/
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5242 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4025 29 5242 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
