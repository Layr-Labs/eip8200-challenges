...
def block_pro : Block Artifact.submissionArtifact .Osaka 4785 prog_pro :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3609 8 4785 prog_pro
...
def block_r0d : Block Artifact.submissionArtifact .Osaka 4793 prog_r0d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3617 20 4793 prog_r0d
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4815 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3637 21 4815 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4838 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3658 21 4838 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4861 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3679 21 4861 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4894, .push 2 5137,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4884 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3700 6 4884 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 5137 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3921 12 5137 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5149 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3933 27 5149 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5176 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3960 27 5176 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5203 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3987 27 5203 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5230 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4014 14 5230 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4894 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3706 6 4894 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4905 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3713 30 4905 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4935 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3743 27 4935 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4964 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3770 27 4964 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5007, .push 2 5137, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4993 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3797 10 4993 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 5007 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3807 6 5007 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 5018 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3814 30 5018 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 5048 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3844 27 5048 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5091, .push 2 5137, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 5077 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3871 10 5077 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 5091 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3881 6 5091 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 5102 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3888 27 5102 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 5129 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3915 6 5129 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5244 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4028 29 5244 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
