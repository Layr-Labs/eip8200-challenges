...
def block_prodiag : Block Artifact.submissionArtifact .Osaka 4592 prog_prodiag :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3461 27 4592 prog_prodiag
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4621 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3488 21 4621 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4644 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3509 21 4644 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4667 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3530 21 4667 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4700, .push 2 4943,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4690 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3551 6 4690 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 4943 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3772 11 4943 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 4954 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3783 27 4954 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 4981 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3810 27 4981 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5008 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3837 27 5008 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5035 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3864 14 5035 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4700 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3557 6 4700 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4711 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3564 30 4711 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4741 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3594 27 4741 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4770 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3621 27 4770 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4813, .push 2 4943, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4799 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3648 10 4799 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 4813 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3658 6 4813 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 4824 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3665 30 4824 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 4854 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3695 27 4854 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4897, .push 2 4943, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 4883 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3722 10 4883 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 4897 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3732 6 4897 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 4908 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3739 27 4908 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 4935 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3766 6 4935 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5049 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3878 29 5049 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
