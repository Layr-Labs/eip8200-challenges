...
def prog_redm : List Instr :=
  [.op .JUMPDEST, .op (.Dup ⟨5, by decide⟩), .op (.Dup ⟨13, by decide⟩), .op .MUL, .op (.Dup ⟨6, by decide⟩),
   .op (.Dup ⟨9, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op (.Dup ⟨12, by decide⟩), .op .MULMOD,
   .op (.Dup ⟨10, by decide⟩), .op (.Swap ⟨1, by decide⟩), .op .ADDMOD]

def block_redm : Block Artifact.submissionArtifact .Osaka 5133 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3902 12 5133 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5145 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3914 27 5145 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5172 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3941 27 5172 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5199 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3968 27 5199 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5226 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3995 14 5226 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
