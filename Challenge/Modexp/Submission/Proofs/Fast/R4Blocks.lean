...
def block_prodiag : Block Artifact.submissionArtifact .Osaka 4810 prog_prodiag :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3630 27 4810 prog_prodiag
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4839 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3657 21 4839 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4862 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3678 21 4862 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4885 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3699 21 4885 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4918, .push 2 5161,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4908 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3720 6 4908 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 5161 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3941 11 5161 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5172 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3952 27 5172 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5199 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3979 27 5199 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5226 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4006 27 5226 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5253 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4033 14 5253 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4918 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3726 6 4918 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4929 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3733 30 4929 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4959 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3763 27 4959 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4988 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3790 27 4988 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5031, .push 2 5161, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 5017 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3817 10 5017 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 5031 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3827 6 5031 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 5042 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3834 30 5042 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 5072 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3864 27 5072 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5115, .push 2 5161, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 5101 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3891 10 5101 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 5115 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3901 6 5115 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 5126 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3908 27 5126 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 5153 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3935 6 5153 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5267 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4047 29 5267 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
