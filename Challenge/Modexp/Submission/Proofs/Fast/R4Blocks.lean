...
def block_pro : Block Artifact.submissionArtifact .Osaka 4797 prog_pro :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3621 8 4797 prog_pro
...
def block_r0d : Block Artifact.submissionArtifact .Osaka 4805 prog_r0d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3629 20 4805 prog_r0d
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4827 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3649 21 4827 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4850 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3670 21 4850 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4873 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3691 21 4873 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4906, .push 2 5149,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4896 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3712 6 4896 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 5149 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3933 12 5149 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5161 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3945 27 5161 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5188 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3972 27 5188 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5215 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3999 27 5215 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5242 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4026 14 5242 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4906 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3718 6 4906 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4917 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3725 30 4917 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4947 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3755 27 4947 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4976 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3782 27 4976 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5019, .push 2 5149, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 5005 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3809 10 5005 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 5019 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3819 6 5019 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 5030 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3826 30 5030 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 5060 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3856 27 5060 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5103, .push 2 5149, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 5089 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3883 10 5089 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 5103 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3893 6 5103 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 5114 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3900 27 5114 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 5141 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3927 6 5141 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5259 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4043 29 5259 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
