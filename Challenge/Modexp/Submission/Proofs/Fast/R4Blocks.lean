...
def block_pro : Block Artifact.submissionArtifact .Osaka 4772 prog_pro :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3581 8 4772 prog_pro
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4800..4823（idx 3617..3638）。 -/
def prog_r0d : List Instr :=
  [.push 2 2464, .op .MLOAD, .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨1, by decide⟩), .op .ADD,
   .op (.Swap ⟨0, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨0, by decide⟩), .op .MUL,
   .op (.Swap ⟨1, by decide⟩), .op (.Dup ⟨0, by decide⟩), .op .MULMOD, .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨2, by decide⟩),
   .op .GT, .op (.Dup ⟨2, by decide⟩), .op (.Swap ⟨1, by decide⟩), .op .SUB, .op .SUB]

def block_r0d : Block Artifact.submissionArtifact .Osaka 4780 prog_r0d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3589 20 4780 prog_r0d
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4802 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3609 21 4802 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4825 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3630 21 4825 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4848 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3651 21 4848 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4881, .push 2 5133,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4871 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3672 6 4871 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def prog_redm : List Instr :=
  [.op .JUMPDEST, .op (.Dup ⟨5, by decide⟩), .op (.Dup ⟨13, by decide⟩), .op .MUL, .op (.Dup ⟨6, by decide⟩),
   .op (.Dup ⟨9, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op (.Dup ⟨12, by decide⟩), .op .MULMOD, .op (.Dup ⟨1, by decide⟩),
   .op .ADD, .op (.Dup ⟨0, by decide⟩), .op (.Swap ⟨1, by decide⟩), .op .GT, .op .ADD]

def block_redm : Block Artifact.submissionArtifact .Osaka 5133 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3902 15 5133 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 5148 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3917 27 5148 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 5175 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3944 27 5175 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5202 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3971 27 5202 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5229 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3998 14 5229 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4881 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3678 6 4881 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4892 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3685 34 4892 prog_r1d
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4926 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3719 27 4926 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4955 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3746 27 4955 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4998, .push 2 5133, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4984 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3773 10 4984 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 4998 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3783 6 4998 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 5009 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3790 34 5009 prog_r2d
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 5043 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3824 27 5043 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 5086, .push 2 5133, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 5072 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3851 10 5072 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 5086 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3861 6 5086 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5119..5149（idx 3898..3928）。 -/
def prog_r3d : List Instr :=
  [.op (.Dup ⟨1, by decide⟩), .op .MUL, .op (.Swap ⟨0, by decide⟩), .op (.Dup ⟨7, by decide⟩), .op (.Dup ⟨1, by decide⟩),
   .op (.Dup ⟨2, by decide⟩), .op .MUL, .op (.Swap ⟨1, by decide⟩), .op (.Dup ⟨0, by decide⟩), .op .MULMOD,
   .op (.Dup ⟨0, by decide⟩), .op (.Dup ⟨2, by decide⟩), .op .GT, .op .SUB, .op (.Dup ⟨1, by decide⟩),
   .op (.Dup ⟨3, by decide⟩), .op .ADD, .op (.Dup ⟨4, by decide⟩), .op (.Dup ⟨1, by decide⟩), .op .ADD,
   .op (.Swap ⟨4, by decide⟩), .op (.Dup ⟨5, by decide⟩), .op .LT, .op (.Swap ⟨3, by decide⟩), .op .GT,
   .op .SUB, .op .SUB, .op .ADD]

def block_r3d : Block Artifact.submissionArtifact .Osaka 5097 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3868 28 5097 prog_r3d
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 5125 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3896 6 5125 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5243 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4012 29 5243 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
