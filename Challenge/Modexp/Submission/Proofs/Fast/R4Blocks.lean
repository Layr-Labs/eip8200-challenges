...
def prog_prodiag : List Instr :=
  [.op .JUMPDEST, .op (.Dup ⟨12, by decide⟩), .push 0 0, .op .MLOAD,
   .op (.Dup ⟨9, by decide⟩), .op (.Dup ⟨7, by decide⟩), .op (.Dup ⟨12, by decide⟩),
...
def block_prodiag : Block Artifact.submissionArtifact .Osaka 4596 prog_prodiag :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3450 27 4596 prog_prodiag
...
def block_r0z1 : Block Artifact.submissionArtifact .Osaka 4625 prog_r0z1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3477 21 4625 prog_r0z1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z2 : Block Artifact.submissionArtifact .Osaka 4648 prog_r0z2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3498 21 4648 prog_r0z2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r0z3 : Block Artifact.submissionArtifact .Osaka 4671 prog_r0z3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3519 21 4671 prog_r0z3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 4893..4902（idx 3702..3707）。 -/
def prog_r0e : List Instr :=
  [.op (.Swap ⟨4, by decide⟩), .op .POP, .push 0 0, .push 2 4704, .push 2 4944,
   .op .JUMP]

def block_r0e : Block Artifact.submissionArtifact .Osaka 4694 prog_r0e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3540 6 4694 prog_r0e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redm : Block Artifact.submissionArtifact .Osaka 4944 prog_redm :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3758 11 4944 prog_redm
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds1 : Block Artifact.submissionArtifact .Osaka 4955 prog_reds1 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3769 27 4955 prog_reds1
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds2 : Block Artifact.submissionArtifact .Osaka 4982 prog_reds2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3796 27 4982 prog_reds2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_reds3 : Block Artifact.submissionArtifact .Osaka 5009 prog_reds3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3823 27 5009 prog_reds3
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_redt : Block Artifact.submissionArtifact .Osaka 5036 prog_redt :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3850 12 5036 prog_redt
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1h : Block Artifact.submissionArtifact .Osaka 4704 prog_r1h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3546 6 4704 prog_r1h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1d : Block Artifact.submissionArtifact .Osaka 4715 prog_r1d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3553 29 4715 prog_r1d
...
def block_r1c2 : Block Artifact.submissionArtifact .Osaka 4744 prog_r1c2 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3582 27 4744 prog_r1c2
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r1c3 : Block Artifact.submissionArtifact .Osaka 4773 prog_r1c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3609 27 4773 prog_r1c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5006..5019（idx 3803..3812）。 -/
def prog_r1e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4816, .push 2 4944, .op .JUMP]

def block_r1e : Block Artifact.submissionArtifact .Osaka 4802 prog_r1e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3636 10 4802 prog_r1e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2h : Block Artifact.submissionArtifact .Osaka 4816 prog_r2h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3646 6 4816 prog_r2h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r2d : Block Artifact.submissionArtifact .Osaka 4827 prog_r2d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3653 29 4827 prog_r2d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r2c3 : Block Artifact.submissionArtifact .Osaka 4856 prog_r2c3 :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3682 27 4856 prog_r2c3
    (by decide) (by rfl) (by rfl) (by decide)

/-- pc 5094..5107（idx 3881..3890）。 -/
def prog_r2e : List Instr :=
  [.op (.Dup ⟨6, by decide⟩), .op .ADD, .op (.Swap ⟨5, by decide⟩), .op (.Dup ⟨6, by decide⟩), .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP, .push 2 4899, .push 2 4944, .op .JUMP]

def block_r2e : Block Artifact.submissionArtifact .Osaka 4885 prog_r2e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3709 10 4885 prog_r2e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3h : Block Artifact.submissionArtifact .Osaka 4899 prog_r3h :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3719 6 4899 prog_r3h
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_r3d : Block Artifact.submissionArtifact .Osaka 4910 prog_r3d :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3726 26 4910 prog_r3d
    (by decide) (by rw [PCFast.instructionPC_eq_byteLength]; rfl) (by rfl) (by decide)
...
def block_r3e : Block Artifact.submissionArtifact .Osaka 4936 prog_r3e :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3752 6 4936 prog_r3e
    (by decide) (by rfl) (by rfl) (by decide)
...
def block_exit : Block Artifact.submissionArtifact .Osaka 5050 prog_exit :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3864 29 5050 prog_exit
    (by decide) (by rfl) (by rfl) (by decide)
