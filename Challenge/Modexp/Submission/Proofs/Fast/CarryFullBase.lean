...
theorem readonlyCache_rowsCarry {mem : ByteArray} {n pa pb i : Nat}
    {tl inv m0 : EvmSemantics.UInt256} (hc : CiosReadonly.ReadonlyCache mem n tl inv m0)
    (hn : n ≤ 32) :
...
theorem extraCache_rowsCarry {mem : ByteArray} {n pa pb i : Nat}
    {m96 m64 m32 : EvmSemantics.UInt256} (hc : CiosReadonlyExtra.ExtraCache mem m96 m64 m32)
    (hn : n ≤ 32) :
