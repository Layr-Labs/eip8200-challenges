...
namespace Challenge.Modexp.Submission.Proofs.Fast.CiosCachedLow32
...
theorem run_cached_step (template : State) (pc : UInt256) (mem : ByteArray)
    ...
    (hx : x.toNat = 32 * (n - 2 - k)) (hselect : x.toNat = 32) (htl : tl.toNat = 8256 + 32 * (n - 2 - k))
    ...
    (hcache : rest[2]? = some (MachineState.readWord mem 32)) :
  ...
  have hpres : MachineState.readWord st.memory 32 = MachineState.readWord mem 32 :=
...
end Challenge.Modexp.Submission.Proofs.Fast.CiosCachedLow32
