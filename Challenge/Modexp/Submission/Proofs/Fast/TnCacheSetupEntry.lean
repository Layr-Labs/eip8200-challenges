import Challenge.Modexp.Submission.Proofs.Fast.TnCacheSetupPrefix
import Challenge.Modexp.Submission.Proofs.Fast.TnCacheSetupZero
...
namespace Challenge.Modexp.Submission.Proofs.Fast.TnCacheSetup
...
theorem run_entry (s : State) (mem : ByteArray) (hd : UInt256) (pa pb n : Nat)
  ...
  have hlow := EntryPrefix.run_low { s with memory := mem } hd
    ...
    (UInt256.ofNat 3740 + EntryPrefix.displacement mem)
    (UInt256.ofNat 4023 + EntryPrefix.displacement mem)
...
end Challenge.Modexp.Submission.Proofs.Fast.TnCacheSetup
