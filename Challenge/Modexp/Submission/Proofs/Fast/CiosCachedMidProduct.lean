...
theorem run_loadMu (s : State) (n : Nat) (bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions loadMuProgram
      (framed s (UInt256.ofNat 4894) (baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4904)
...
theorem run_loadM0 (s : State) (n : Nat) (mu bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions loadM0Program
      (framed s (UInt256.ofNat 4904) ([mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4910)
