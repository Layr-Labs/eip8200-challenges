...
def loadMod : List Instr := (productProgram.drop 8).take 2
def makeModProduct : List Instr := (productProgram.drop 10).take 4
def finishCarry : List Instr := productProgram.drop 14
...
theorem run_loadLow (s : State) (bi pbi paEnd pbEnd flag dst ret : UInt256) (n : Nat)
    ...
    runInstructions loadLow
      (framed s (UInt256.ofNat 4865) (baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4870)
...
theorem run_makeMu (s : State) (bi pbi paEnd pbEnd flag dst ret t0 : UInt256)
    ...
    runInstructions makeMu
      (framed s (UInt256.ofNat 4870) ([t0] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4877)
...
theorem run_loadMod (s : State) (bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    (hret : ret = modulusAddress n) :
    runInstructions loadMod
      (framed s (UInt256.ofNat 4877) ([t0, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4879)
  ...
  simp [loadMod, productProgram, midProgram, runInstructions, Challenge.EvmProof.Stepper.runInstr,
    framed, baseStack, hc11, hc12, hret, modulusAddress, State.activeWordsAfterUInt256,
...
theorem run_makeModProduct (s : State) (bi pbi paEnd pbEnd flag dst ret m0 mu t0 : UInt256)
    ...
    runInstructions makeModProduct
      (framed s (UInt256.ofNat 4879) ([m0, t0, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
...
theorem run_finishCarry (s : State) (bi pbi paEnd pbEnd flag dst ret mm mu t0 : UInt256)
    ...
    runInstructions finishCarry
      (framed s (UInt256.ofNat 4883) ([mm, t0, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4889)
...
theorem run_product (s : State) (n : Nat) (bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    (hminv : inverseInvariant s.memory n) (hret : ret = modulusAddress n) :
