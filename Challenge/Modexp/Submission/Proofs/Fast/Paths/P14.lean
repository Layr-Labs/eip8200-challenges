...
`CCB` (pc 2497) replaces the second `DOUBLE256` call: it doubles `CC` once
...
/-- Instructions 1742..1748, pc 2497..2507: `CCB` entry, `ADDMOD(px, px) → px`. -/
def blk1742 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  []

/-- Instructions 1751..1757, pc 2511..2521: `MONPRO(px, px) → px`. -/
def blk1751 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1540 .JUMPDEST,
   pushAt 1541 2 2081,
...
/-- Instructions 1758..1764, pc 2522..2531: decrement and loop back. -/
def blk1758 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1547 .JUMPDEST,
   pushAt 1548 0 0,
...
/-- Instructions 1765..1767, pc 2532..2896: drop the counter and return. -/
def blk1765 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1554 .POP,
   opAt 1555 .POP,
