...
/-! Basic-block instruction paths, group 11 (instructions 1568..1753). -/
...
/-- Instructions 1568..1721, pc 2304..2592. -/
def blk1569 :
...
/-- Instructions 1672..1727, pc 2594..2345. -/
def blk1595 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1031 .POP,
   opAt 1032 .POP,
...
/-- Instructions 1600..1753, pc 2346..2379. -/
def blk1600 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1036 .JUMPDEST,
   pushAt 1037 2 2688,
