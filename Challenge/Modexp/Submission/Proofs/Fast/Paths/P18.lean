...
@[simp] theorem leadingBitPC (i : Nat)
    (hi : 2642 ≤ i) (hii : i ≤ 2656) :
    Artifact.submissionArtifact.instructionPC i =
      [3603,3604,3605,3606,3609,3610,3613,3614,3617,3620,3621,3624,3625,3626,3629][i - 2642]! := by
  interval_cases i <;> decide

theorem jumpDest3865 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3603 = true :=
  Artifact.isValidJumpDest_index 2642 (by rfl)

theorem jumpDest3887 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3625 = true :=
