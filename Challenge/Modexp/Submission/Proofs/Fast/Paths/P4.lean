...
dispatcher. The remaining decoded instructions through index 1216 are
unreachable padding, preserving the old loop head at index 1216 / pc 1803. -/
def blk1195 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 673 2 2429,
   opAt 674 .JUMP]

/-- Instructions 1216..1352, pc 1803..1811. -/
def blk1216 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 675 .JUMPDEST,
...
/-- Instructions 1353..1358, pc 1812..1833. -/
def blk1223 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 681 2 987,
   pushAt 682 2 256,
...
/-- Instructions 1359..1379, pc 1834..1820. -/
def blk1229 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 687 .JUMPDEST,
...
/-- Instructions 1333..1384, pc 1728..1828. -/
def blk1250 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 708 .JUMPDEST,
   pushAt 709 1 1,
