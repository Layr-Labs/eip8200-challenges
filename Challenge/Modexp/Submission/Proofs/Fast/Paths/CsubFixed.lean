...
@[simp] theorem fixedPC1619 : Artifact.submissionArtifact.instructionPC 1619 = 2224 := by
  calc
    Artifact.submissionArtifact.instructionPC 1619 =
        Artifact.submissionArtifact.instructionPC 1618 + (YulEvmCompiler.Instr.push 2 4975).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 1618 _ (by rfl)
    _ = 2224 := by rw [fixedPC1618]; rfl

@[simp] theorem fixedPC3775 : Artifact.submissionArtifact.instructionPC 3775 = 4975 := by rfl

@[simp] theorem fixedJump4971 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4975 = true := by
  simpa only [Artifact.instructionPC, fixedPC3775] using Artifact.isValidJumpDest_index 3775 (by rfl)

@[simp] theorem fixedPC3776 : Artifact.submissionArtifact.instructionPC 3776 = 4976 := by
  calc
    ...
    _ = 4976 := by rw [fixedPC3775]; rfl

@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3777 = 4979 := by
  calc
    ...
    _ = 4979 := by rw [fixedPC3776]; rfl

@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3778 = 4980 := by
  calc
    ...
    _ = 4980 := by rw [fixedPC3777]; rfl

@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3779 = 4983 := by
  calc
    ...
    _ = 4983 := by rw [fixedPC3778]; rfl

@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3780 = 4984 := by
  calc
    ...
    _ = 4984 := by rw [fixedPC3779]; rfl

@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3781 = 4987 := by
  calc
    Artifact.submissionArtifact.instructionPC 3781 =
        Artifact.submissionArtifact.instructionPC 3780 + (YulEvmCompiler.Instr.push 2 5023).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3780 _ (by rfl)
    _ = 4987 := by rw [fixedPC3780]; rfl

@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3782 = 4988 := by
  calc
    ...
    _ = 4988 := by rw [fixedPC3781]; rfl

@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3783 = 4991 := by
  calc
    ...
    _ = 4991 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3784 = 4992 := by
  calc
    ...
    _ = 4992 := by rw [fixedPC3783]; rfl

@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3785 = 4994 := by
  calc
...
@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3786 = 4995 := by
  calc
...
@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3787 = 4998 := by
  calc
    Artifact.submissionArtifact.instructionPC 3787 =
        Artifact.submissionArtifact.instructionPC 3786 + (YulEvmCompiler.Instr.push 2 5280).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3786 _ (by rfl)
    _ = 4998 := by rw [fixedPC3786]; rfl

@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3788 = 4999 := by
  calc
    ...
    _ = 4999 := by rw [fixedPC3787]; rfl

@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3789 = 5002 := by
  calc
    ...
    _ = 5002 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3790 = 5003 := by
  calc
    ...
    _ = 5003 := by rw [fixedPC3789]; rfl

@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3791 = 5006 := by
  calc
    ...
    _ = 5006 := by rw [fixedPC3790]; rfl

@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3792 = 5007 := by
  calc
    ...
    _ = 5007 := by rw [fixedPC3791]; rfl

@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3793 = 5008 := by
  calc
    ...
    _ = 5008 := by rw [fixedPC3792]; rfl

@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3794 = 5011 := by
  calc
    ...
    _ = 5011 := by rw [fixedPC3793]; rfl

@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3795 = 5012 := by
  calc
    ...
    _ = 5012 := by rw [fixedPC3794]; rfl

@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3796 = 5015 := by
  calc
    ...
    _ = 5015 := by rw [fixedPC3795]; rfl

@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3797 = 5016 := by
  calc
    ...
    _ = 5016 := by rw [fixedPC3796]; rfl

@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3798 = 5017 := by
  calc
    ...
    _ = 5017 := by rw [fixedPC3797]; rfl

@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3799 = 5018 := by
  calc
    ...
    _ = 5018 := by rw [fixedPC3798]; rfl

@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3800 = 5019 := by
  calc
    ...
    _ = 5019 := by rw [fixedPC3799]; rfl

@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3801 = 5022 := by
  calc
    ...
    _ = 5022 := by rw [fixedPC3800]; rfl

@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3802 = 5023 := by
  calc
    ...
    _ = 5023 := by rw [fixedPC3801]; rfl

@[simp] theorem fixedJump5019 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5023 = true := by
  simpa only [Artifact.instructionPC, fixedPC3802] using Artifact.isValidJumpDest_index 3802 (by rfl)

@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3803 = 5024 := by
  calc
    ...
    _ = 5024 := by rw [fixedPC3802]; rfl

@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3804 = 5027 := by
  calc
    ...
    _ = 5027 := by rw [fixedPC3803]; rfl

@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3805 = 5028 := by
  calc
    ...
    _ = 5028 := by rw [fixedPC3804]; rfl

@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3806 = 5030 := by
  calc
...
@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3807 = 5031 := by
  calc
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3808 = 5032 := by
  calc
    ...
    _ = 5032 := by rw [fixedPC3807]; rfl

@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3809 = 5033 := by
  calc
    ...
    _ = 5033 := by rw [fixedPC3808]; rfl

@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3810 = 5034 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3813 = 5039 := by
  calc
    ...
    _ = 5039 := by rw [fixedPC3812]; rfl

@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3814 = 5040 := by
  calc
    ...
    _ = 5040 := by rw [fixedPC3813]; rfl

@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3815 = 5043 := by
  calc
    ...
    _ = 5043 := by rw [fixedPC3814]; rfl

@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3816 = 5044 := by
  calc
    ...
    _ = 5044 := by rw [fixedPC3815]; rfl

@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3817 = 5046 := by
  calc
...
@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3818 = 5047 := by
  calc
...
@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3819 = 5048 := by
  calc
    ...
    _ = 5048 := by rw [fixedPC3818]; rfl

@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3820 = 5049 := by
  calc
...
@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3831 = 5062 := by
  calc
    ...
    _ = 5062 := by rw [fixedPC3830]; rfl

@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3832 = 5063 := by
  calc
    ...
    _ = 5063 := by rw [fixedPC3831]; rfl

@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3833 = 5066 := by
  calc
    ...
    _ = 5066 := by rw [fixedPC3832]; rfl

@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3834 = 5067 := by
  calc
    ...
    _ = 5067 := by rw [fixedPC3833]; rfl

@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3835 = 5069 := by
  calc
...
@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3836 = 5070 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3837 = 5071 := by
  calc
    ...
    _ = 5071 := by rw [fixedPC3836]; rfl

@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3838 = 5072 := by
  calc
...
@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3849 = 5085 := by
  calc
    ...
    _ = 5085 := by rw [fixedPC3848]; rfl

@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3850 = 5086 := by
  calc
    ...
    _ = 5086 := by rw [fixedPC3849]; rfl

@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3851 = 5089 := by
  calc
    ...
    _ = 5089 := by rw [fixedPC3850]; rfl

@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3852 = 5090 := by
  calc
    ...
    _ = 5090 := by rw [fixedPC3851]; rfl

@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3853 = 5092 := by
  calc
...
@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3854 = 5093 := by
  calc
...
@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3855 = 5094 := by
  calc
    ...
    _ = 5094 := by rw [fixedPC3854]; rfl

@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3856 = 5095 := by
  calc
    ...
    _ = 5095 := by rw [fixedPC3855]; rfl

@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3857 = 5096 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3867 = 5108 := by
  calc
    ...
    _ = 5108 := by rw [fixedPC3866]; rfl

@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3868 = 5109 := by
  calc
    ...
    _ = 5109 := by rw [fixedPC3867]; rfl

@[simp] theorem fixedJump5105 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5109 = true := by
  simpa only [Artifact.instructionPC, fixedPC3868] using Artifact.isValidJumpDest_index 3868 (by rfl)

@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3869 = 5110 := by
  calc
    ...
    _ = 5110 := by rw [fixedPC3868]; rfl

@[simp] theorem fixedPC3870 : Artifact.submissionArtifact.instructionPC 3870 = 5113 := by
  calc
    ...
    _ = 5113 := by rw [fixedPC3869]; rfl

@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3871 = 5114 := by
  calc
    ...
    _ = 5114 := by rw [fixedPC3870]; rfl

@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3872 = 5116 := by
  calc
...
@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3873 = 5117 := by
  calc
...
@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3874 = 5118 := by
  calc
    ...
    _ = 5118 := by rw [fixedPC3873]; rfl

@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3875 = 5119 := by
  calc
    ...
    _ = 5119 := by rw [fixedPC3874]; rfl

@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3876 = 5120 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3886 = 5132 := by
  calc
    ...
    _ = 5132 := by rw [fixedPC3885]; rfl

@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3887 = 5133 := by
  calc
    ...
    _ = 5133 := by rw [fixedPC3886]; rfl

@[simp] theorem fixedJump5129 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5133 = true := by
  simpa only [Artifact.instructionPC, fixedPC3887] using Artifact.isValidJumpDest_index 3887 (by rfl)

@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3888 = 5134 := by
  calc
    ...
    _ = 5134 := by rw [fixedPC3887]; rfl

@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3889 = 5137 := by
  calc
    ...
    _ = 5137 := by rw [fixedPC3888]; rfl

@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3890 = 5138 := by
  calc
    ...
    _ = 5138 := by rw [fixedPC3889]; rfl

@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3891 = 5140 := by
  calc
...
@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3892 = 5141 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3893 = 5142 := by
  calc
    ...
    _ = 5142 := by rw [fixedPC3892]; rfl

@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3894 = 5143 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3905 = 5156 := by
  calc
    ...
    _ = 5156 := by rw [fixedPC3904]; rfl

@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3906 = 5157 := by
  calc
    ...
    _ = 5157 := by rw [fixedPC3905]; rfl

@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3907 = 5160 := by
  calc
    ...
    _ = 5160 := by rw [fixedPC3906]; rfl

@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3908 = 5161 := by
  calc
    ...
    _ = 5161 := by rw [fixedPC3907]; rfl

@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3909 = 5163 := by
  calc
...
@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3910 = 5164 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3911 = 5165 := by
  calc
    ...
    _ = 5165 := by rw [fixedPC3910]; rfl

@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3912 = 5166 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3923 = 5179 := by
  calc
    ...
    _ = 5179 := by rw [fixedPC3922]; rfl

@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3924 = 5180 := by
  calc
    ...
    _ = 5180 := by rw [fixedPC3923]; rfl

@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3925 = 5183 := by
  calc
    ...
    _ = 5183 := by rw [fixedPC3924]; rfl

@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3926 = 5184 := by
  calc
    ...
    _ = 5184 := by rw [fixedPC3925]; rfl

@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3927 = 5185 := by
  calc
    ...
    _ = 5185 := by rw [fixedPC3926]; rfl

@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3928 = 5186 := by
  calc
    ...
    _ = 5186 := by rw [fixedPC3927]; rfl

@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3929 = 5187 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3941 = 5201 := by
  calc
    ...
    _ = 5201 := by rw [fixedPC3940]; rfl

@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3942 = 5202 := by
  calc
    ...
    _ = 5202 := by rw [fixedPC3941]; rfl

@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3943 = 5203 := by
  calc
    ...
    _ = 5203 := by rw [fixedPC3942]; rfl

@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3944 = 5206 := by
  calc
    ...
    _ = 5206 := by rw [fixedPC3943]; rfl

@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3945 = 5207 := by
  calc
    ...
    _ = 5207 := by rw [fixedPC3944]; rfl

@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3946 = 5208 := by
  calc
    ...
    _ = 5208 := by rw [fixedPC3945]; rfl

@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3947 = 5211 := by
  calc
    ...
    _ = 5211 := by rw [fixedPC3946]; rfl

@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3948 = 5212 := by
  calc
    ...
    _ = 5212 := by rw [fixedPC3947]; rfl

@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3949 = 5213 := by
  calc
    ...
    _ = 5213 := by rw [fixedPC3948]; rfl

@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3950 = 5216 := by
  calc
    ...
    _ = 5216 := by rw [fixedPC3949]; rfl

@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3951 = 5217 := by
  calc
    ...
    _ = 5217 := by rw [fixedPC3950]; rfl

@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3952 = 5220 := by
  calc
    ...
    _ = 5220 := by rw [fixedPC3951]; rfl

@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3953 = 5221 := by
  calc
    ...
    _ = 5221 := by rw [fixedPC3952]; rfl

@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3954 = 5222 := by
  calc
    ...
    _ = 5222 := by rw [fixedPC3953]; rfl

@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3955 = 5223 := by
  calc
    ...
    _ = 5223 := by rw [fixedPC3954]; rfl

@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3956 = 5224 := by
  calc
    ...
    _ = 5224 := by rw [fixedPC3955]; rfl

@[simp] theorem fixedJump5220 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5224 = true := by
  simpa only [Artifact.instructionPC, fixedPC3956] using Artifact.isValidJumpDest_index 3956 (by rfl)
...
@[simp] theorem fixedPC3960 : Artifact.submissionArtifact.instructionPC 3960 = 5229 := by
  calc
    ...
    _ = 5229 := by rw [fixedPC3959]; rfl

@[simp] theorem fixedPC3961 : Artifact.submissionArtifact.instructionPC 3961 = 5230 := by
  calc
    ...
    _ = 5230 := by rw [fixedPC3960]; rfl

@[simp] theorem fixedPC3962 : Artifact.submissionArtifact.instructionPC 3962 = 5232 := by
  calc
    ...
    _ = 5232 := by rw [fixedPC3961]; rfl

@[simp] theorem fixedPC3963 : Artifact.submissionArtifact.instructionPC 3963 = 5233 := by
  calc
    ...
    _ = 5233 := by rw [fixedPC3962]; rfl

@[simp] theorem fixedPC3964 : Artifact.submissionArtifact.instructionPC 3964 = 5235 := by
  calc
    ...
    _ = 5235 := by rw [fixedPC3963]; rfl

@[simp] theorem fixedPC3965 : Artifact.submissionArtifact.instructionPC 3965 = 5236 := by
  calc
    ...
    _ = 5236 := by rw [fixedPC3964]; rfl

@[simp] theorem fixedPC3966 : Artifact.submissionArtifact.instructionPC 3966 = 5237 := by
  calc
    ...
    _ = 5237 := by rw [fixedPC3965]; rfl

@[simp] theorem fixedPC3967 : Artifact.submissionArtifact.instructionPC 3967 = 5238 := by
  calc
    ...
    _ = 5238 := by rw [fixedPC3966]; rfl

@[simp] theorem fixedPC3968 : Artifact.submissionArtifact.instructionPC 3968 = 5240 := by
  calc
    ...
    _ = 5240 := by rw [fixedPC3967]; rfl

@[simp] theorem fixedPC3969 : Artifact.submissionArtifact.instructionPC 3969 = 5241 := by
  calc
    ...
    _ = 5241 := by rw [fixedPC3968]; rfl

@[simp] theorem fixedPC3970 : Artifact.submissionArtifact.instructionPC 3970 = 5242 := by
  calc
    ...
    _ = 5242 := by rw [fixedPC3969]; rfl

@[simp] theorem fixedPC3971 : Artifact.submissionArtifact.instructionPC 3971 = 5243 := by
  calc
    ...
    _ = 5243 := by rw [fixedPC3970]; rfl

@[simp] theorem fixedPC3972 : Artifact.submissionArtifact.instructionPC 3972 = 5245 := by
  calc
    ...
    _ = 5245 := by rw [fixedPC3971]; rfl

@[simp] theorem fixedPC3973 : Artifact.submissionArtifact.instructionPC 3973 = 5246 := by
  calc
    ...
    _ = 5246 := by rw [fixedPC3972]; rfl

@[simp] theorem fixedPC3974 : Artifact.submissionArtifact.instructionPC 3974 = 5247 := by
  calc
    ...
    _ = 5247 := by rw [fixedPC3973]; rfl

@[simp] theorem fixedPC3975 : Artifact.submissionArtifact.instructionPC 3975 = 5250 := by
  calc
    Artifact.submissionArtifact.instructionPC 3975 =
        Artifact.submissionArtifact.instructionPC 3974 + (YulEvmCompiler.Instr.push 2 5272).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3974 _ (by rfl)
    _ = 5250 := by rw [fixedPC3974]; rfl

@[simp] theorem fixedPC3976 : Artifact.submissionArtifact.instructionPC 3976 = 5251 := by
  calc
    ...
    _ = 5251 := by rw [fixedPC3975]; rfl

@[simp] theorem fixedPC3977 : Artifact.submissionArtifact.instructionPC 3977 = 5252 := by
  calc
    ...
    _ = 5252 := by rw [fixedPC3976]; rfl

@[simp] theorem fixedPC3978 : Artifact.submissionArtifact.instructionPC 3978 = 5254 := by
  calc
    ...
    _ = 5254 := by rw [fixedPC3977]; rfl

@[simp] theorem fixedPC3979 : Artifact.submissionArtifact.instructionPC 3979 = 5255 := by
  calc
    ...
    _ = 5255 := by rw [fixedPC3978]; rfl

@[simp] theorem fixedPC3980 : Artifact.submissionArtifact.instructionPC 3980 = 5256 := by
  calc
    ...
    _ = 5256 := by rw [fixedPC3979]; rfl

@[simp] theorem fixedPC3981 : Artifact.submissionArtifact.instructionPC 3981 = 5257 := by
  calc
    ...
    _ = 5257 := by rw [fixedPC3980]; rfl

@[simp] theorem fixedPC3982 : Artifact.submissionArtifact.instructionPC 3982 = 5258 := by
  calc
    ...
    _ = 5258 := by rw [fixedPC3981]; rfl

@[simp] theorem fixedPC3983 : Artifact.submissionArtifact.instructionPC 3983 = 5261 := by
  calc
    ...
    _ = 5261 := by rw [fixedPC3982]; rfl

@[simp] theorem fixedPC3984 : Artifact.submissionArtifact.instructionPC 3984 = 5262 := by
  calc
    ...
    _ = 5262 := by rw [fixedPC3983]; rfl

@[simp] theorem fixedPC3985 : Artifact.submissionArtifact.instructionPC 3985 = 5263 := by
  calc
    ...
    _ = 5263 := by rw [fixedPC3984]; rfl

@[simp] theorem fixedPC3986 : Artifact.submissionArtifact.instructionPC 3986 = 5265 := by
  calc
    ...
    _ = 5265 := by rw [fixedPC3985]; rfl

@[simp] theorem fixedPC3987 : Artifact.submissionArtifact.instructionPC 3987 = 5266 := by
  calc
    ...
    _ = 5266 := by rw [fixedPC3986]; rfl

@[simp] theorem fixedPC3988 : Artifact.submissionArtifact.instructionPC 3988 = 5267 := by
  calc
    ...
    _ = 5267 := by rw [fixedPC3987]; rfl

@[simp] theorem fixedPC3989 : Artifact.submissionArtifact.instructionPC 3989 = 5268 := by
  calc
    ...
    _ = 5268 := by rw [fixedPC3988]; rfl

@[simp] theorem fixedPC3990 : Artifact.submissionArtifact.instructionPC 3990 = 5271 := by
  calc
    Artifact.submissionArtifact.instructionPC 3990 =
        Artifact.submissionArtifact.instructionPC 3989 + (YulEvmCompiler.Instr.push 2 4885).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3989 _ (by rfl)
    _ = 5271 := by rw [fixedPC3989]; rfl

@[simp] theorem fixedPC3991 : Artifact.submissionArtifact.instructionPC 3991 = 5272 := by
  calc
    ...
    _ = 5272 := by rw [fixedPC3990]; rfl

@[simp] theorem fixedJump5268 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5272 = true := by
  simpa only [Artifact.instructionPC, fixedPC3991] using Artifact.isValidJumpDest_index 3991 (by rfl)

@[simp] theorem fixedPC3992 : Artifact.submissionArtifact.instructionPC 3992 = 5273 := by
  calc
    ...
    _ = 5273 := by rw [fixedPC3991]; rfl

@[simp] theorem fixedPC3993 : Artifact.submissionArtifact.instructionPC 3993 = 5274 := by
  calc
    ...
    _ = 5274 := by rw [fixedPC3992]; rfl

@[simp] theorem fixedPC3994 : Artifact.submissionArtifact.instructionPC 3994 = 5275 := by
  calc
...
@[simp] theorem fixedPC3996 : Artifact.submissionArtifact.instructionPC 3996 = 5279 := by
  calc
    ...
    _ = 5279 := by rw [fixedPC3995]; rfl

@[simp] theorem fixedPC3997 : Artifact.submissionArtifact.instructionPC 3997 = 5280 := by
  calc
    ...
    _ = 5280 := by rw [fixedPC3996]; rfl

@[simp] theorem fixedJump5276 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5280 = true := by
  simpa only [Artifact.instructionPC, fixedPC3997] using Artifact.isValidJumpDest_index 3997 (by rfl)

@[simp] theorem fixedPC3998 : Artifact.submissionArtifact.instructionPC 3998 = 5281 := by
  calc
    ...
    _ = 5281 := by rw [fixedPC3997]; rfl

@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3999 = 5284 := by
  calc
    ...
    _ = 5284 := by rw [fixedPC3998]; rfl

@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 4000 = 5285 := by
  calc
    ...
    _ = 5285 := by rw [fixedPC3999]; rfl

@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 4001 = 5287 := by
  calc
    ...
    _ = 5287 := by rw [fixedPC4000]; rfl

@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 4002 = 5288 := by
  calc
    ...
    _ = 5288 := by rw [fixedPC4001]; rfl

@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 4003 = 5289 := by
  calc
    ...
    _ = 5289 := by rw [fixedPC4002]; rfl

@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 4004 = 5290 := by
  calc
    ...
    _ = 5290 := by rw [fixedPC4003]; rfl

@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 4005 = 5291 := by
  calc
...
@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 4008 = 5296 := by
  calc
    ...
    _ = 5296 := by rw [fixedPC4007]; rfl

@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 4009 = 5297 := by
  calc
    ...
    _ = 5297 := by rw [fixedPC4008]; rfl

@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 4010 = 5300 := by
  calc
    Artifact.submissionArtifact.instructionPC 4010 =
        Artifact.submissionArtifact.instructionPC 4009 + (YulEvmCompiler.Instr.push 2 5133).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4009 _ (by rfl)
    _ = 5300 := by rw [fixedPC4009]; rfl
