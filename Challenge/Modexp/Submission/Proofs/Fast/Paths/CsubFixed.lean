...
def csGenericPath : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1575 .JUMPDEST,
   ...
   pushAt 3736 2 9408,
   opAt 3737 .MLOAD,
   opAt 3738 (.Dup ⟨0, by decide⟩),
   pushAt 3739 2 7168,
   opAt 3740 .ADD,
   pushAt 3741 2 8256,
   opAt 3742 .POP,
   opAt 3743 (.Swap ⟨0, by decide⟩),
   pushAt 3744 0 0,
...
def csFixedStep8_1 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3760 2 8448,
   ...
   pushAt 3762 1 192,
   opAt 3763 .MLOAD,
   opAt 3764 (.Dup ⟨1, by decide⟩),
   opAt 3765 (.Dup ⟨1, by decide⟩),
   opAt 3766 .GT,
   opAt 3767 (.Swap ⟨1, by decide⟩),
   opAt 3768 .SUB,
   opAt 3769 (.Dup ⟨2, by decide⟩),
   opAt 3770 (.Dup ⟨1, by decide⟩),
   opAt 3771 .SUB,
   opAt 3772 (.Swap ⟨2, by decide⟩),
   opAt 3773 .GT,
   opAt 3774 .OR,
   opAt 3775 (.Swap ⟨0, by decide⟩),
   pushAt 3776 2 7360,
   opAt 3777 .MSTORE]
...
def csFixedStep8_2 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3778 2 8416,
   ...
   pushAt 3780 1 160,
   opAt 3781 .MLOAD,
   opAt 3782 (.Dup ⟨1, by decide⟩),
   opAt 3783 (.Dup ⟨1, by decide⟩),
   opAt 3784 .GT,
   opAt 3785 (.Swap ⟨1, by decide⟩),
   opAt 3786 .SUB,
   opAt 3787 (.Dup ⟨2, by decide⟩),
   opAt 3788 (.Dup ⟨1, by decide⟩),
   opAt 3789 .SUB,
   opAt 3790 (.Swap ⟨2, by decide⟩),
   opAt 3791 .GT,
   opAt 3792 .OR,
...
def csFixedStep8_3 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3796 2 8384,
   ...
   pushAt 3798 1 128,
   opAt 3799 .MLOAD,
   opAt 3800 (.Dup ⟨1, by decide⟩),
   opAt 3801 (.Dup ⟨1, by decide⟩),
   opAt 3802 .GT,
   opAt 3803 (.Swap ⟨1, by decide⟩),
   opAt 3804 .SUB,
   opAt 3805 (.Dup ⟨2, by decide⟩),
   opAt 3806 (.Dup ⟨1, by decide⟩),
   opAt 3807 .SUB,
   opAt 3808 (.Swap ⟨2, by decide⟩),
   opAt 3809 .GT,
   opAt 3810 .OR,
   opAt 3811 (.Swap ⟨0, by decide⟩),
   pushAt 3812 2 7296,
   opAt 3813 .MSTORE]
...
def csFixedTail8 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3888 .ISZERO,
   ...
   opAt 3890 .MLOAD,
   opAt 3891 .OR,
   pushAt 3892 32 115792089237316195423570985008687907853269984665640564039457584007913129638848,
   opAt 3893 .MUL,
   pushAt 3894 2 8256,
   opAt 3895 .ADD,
   pushAt 3896 2 9344,
...
@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3721 = 4978 := by rfl

@[simp] theorem fixedJump4975 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4978 = true := by
  simpa only [Artifact.instructionPC, fixedPC3777] using Artifact.isValidJumpDest_index 3721 (by rfl)

@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3722 = 4979 := by
  calc
    Artifact.submissionArtifact.instructionPC 3722 =
        Artifact.submissionArtifact.instructionPC 3721 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3721 _ (by rfl)
    _ = 4979 := by rw [fixedPC3777]; rfl

@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3723 = 4982 := by
  calc
    Artifact.submissionArtifact.instructionPC 3723 =
        Artifact.submissionArtifact.instructionPC 3722 + (YulEvmCompiler.Instr.push 2 9344).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3722 _ (by rfl)
    _ = 4982 := by rw [fixedPC3778]; rfl

@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3724 = 4983 := by
  calc
...
@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3725 = 4986 := by
  calc
    Artifact.submissionArtifact.instructionPC 3725 =
        Artifact.submissionArtifact.instructionPC 3724 + (YulEvmCompiler.Instr.push 2 256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3724 _ (by rfl)
    _ = 4986 := by rw [fixedPC3780]; rfl

@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3726 = 4987 := by
  calc
    Artifact.submissionArtifact.instructionPC 3726 =
        Artifact.submissionArtifact.instructionPC 3725 + (YulEvmCompiler.Instr.op .EQ).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3725 _ (by rfl)
    _ = 4987 := by rw [fixedPC3781]; rfl

@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3727 = 4990 := by
  calc
    Artifact.submissionArtifact.instructionPC 3727 =
        Artifact.submissionArtifact.instructionPC 3726 + (YulEvmCompiler.Instr.push 2 5026).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3726 _ (by rfl)
    _ = 4990 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3728 = 4991 := by
  calc
    Artifact.submissionArtifact.instructionPC 3728 =
        Artifact.submissionArtifact.instructionPC 3727 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3727 _ (by rfl)
    _ = 4991 := by rw [fixedPC3783]; rfl

@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3729 = 4994 := by
  calc
...
@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3730 = 4995 := by
  calc
...
@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3731 = 4997 := by
  calc
    Artifact.submissionArtifact.instructionPC 3731 =
        Artifact.submissionArtifact.instructionPC 3730 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3730 _ (by rfl)
    _ = 4997 := by rw [fixedPC3786]; rfl

@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3732 = 4998 := by
  calc
...
@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3733 = 5001 := by
  calc
    Artifact.submissionArtifact.instructionPC 3733 =
        Artifact.submissionArtifact.instructionPC 3732 + (YulEvmCompiler.Instr.push 2 5312).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3732 _ (by rfl)
    _ = 5001 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3734 = 5002 := by
  calc
...
@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3735 = 5005 := by
  calc
    Artifact.submissionArtifact.instructionPC 3735 =
        Artifact.submissionArtifact.instructionPC 3734 + (YulEvmCompiler.Instr.push 2 9440).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3734 _ (by rfl)
    _ = 5005 := by rw [fixedPC3790]; rfl

@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3736 = 5006 := by
  calc
...
@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3737 = 5009 := by
  calc
    Artifact.submissionArtifact.instructionPC 3737 =
        Artifact.submissionArtifact.instructionPC 3736 + (YulEvmCompiler.Instr.push 2 9408).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3736 _ (by rfl)
    _ = 5009 := by rw [fixedPC3792]; rfl

@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3738 = 5010 := by
  calc
...
@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3739 = 5011 := by
  calc
    Artifact.submissionArtifact.instructionPC 3739 =
        Artifact.submissionArtifact.instructionPC 3738 + (YulEvmCompiler.Instr.op (.Dup ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3738 _ (by rfl)
    _ = 5011 := by rw [fixedPC3794]; rfl

@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3740 = 5014 := by
  calc
    Artifact.submissionArtifact.instructionPC 3740 =
        Artifact.submissionArtifact.instructionPC 3739 + (YulEvmCompiler.Instr.push 2 7168).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3739 _ (by rfl)
    _ = 5014 := by rw [fixedPC3795]; rfl

@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3741 = 5015 := by
  calc
    Artifact.submissionArtifact.instructionPC 3741 =
        Artifact.submissionArtifact.instructionPC 3740 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3740 _ (by rfl)
    _ = 5015 := by rw [fixedPC3796]; rfl

@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3742 = 5018 := by
  calc
    Artifact.submissionArtifact.instructionPC 3742 =
        Artifact.submissionArtifact.instructionPC 3741 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3741 _ (by rfl)
    _ = 5018 := by rw [fixedPC3797]; rfl

@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3743 = 5019 := by
  calc
    Artifact.submissionArtifact.instructionPC 3743 =
        Artifact.submissionArtifact.instructionPC 3742 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3742 _ (by rfl)
    _ = 5019 := by rw [fixedPC3798]; rfl

@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3744 = 5020 := by
  calc
    Artifact.submissionArtifact.instructionPC 3744 =
        Artifact.submissionArtifact.instructionPC 3743 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3743 _ (by rfl)
    _ = 5020 := by rw [fixedPC3799]; rfl

@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3745 = 5021 := by
  calc
    Artifact.submissionArtifact.instructionPC 3745 =
        Artifact.submissionArtifact.instructionPC 3744 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3744 _ (by rfl)
    _ = 5021 := by rw [fixedPC3800]; rfl

@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3746 = 5022 := by
  calc
...
@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3747 = 5025 := by
  calc
    Artifact.submissionArtifact.instructionPC 3747 =
        Artifact.submissionArtifact.instructionPC 3746 + (YulEvmCompiler.Instr.push 2 2144).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3746 _ (by rfl)
    _ = 5025 := by rw [fixedPC3802]; rfl

@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3748 = 5026 := by
  calc
    Artifact.submissionArtifact.instructionPC 3748 =
        Artifact.submissionArtifact.instructionPC 3747 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5023 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5026 = true := by
  simpa only [Artifact.instructionPC, fixedPC3804] using Artifact.isValidJumpDest_index 3748 (by rfl)

@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3749 = 5027 := by
  calc
...
@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3750 = 5030 := by
  calc
    Artifact.submissionArtifact.instructionPC 3750 =
        Artifact.submissionArtifact.instructionPC 3749 + (YulEvmCompiler.Instr.push 2 8480).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3749 _ (by rfl)
    _ = 5030 := by rw [fixedPC3805]; rfl

@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3751 = 5031 := by
  calc
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3752 = 5033 := by
  calc
    Artifact.submissionArtifact.instructionPC 3752 =
        Artifact.submissionArtifact.instructionPC 3751 + (YulEvmCompiler.Instr.push 1 224).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3751 _ (by rfl)
    _ = 5033 := by rw [fixedPC3807]; rfl

@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3753 = 5034 := by
  calc
...
@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3754 = 5035 := by
  calc
...
@[simp] theorem fixedPC3811 : Artifact.submissionArtifact.instructionPC 3755 = 5036 := by
  calc
...
@[simp] theorem fixedPC3812 : Artifact.submissionArtifact.instructionPC 3756 = 5037 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3757 = 5038 := by
  calc
...
@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3758 = 5039 := by
  calc
...
@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3759 = 5042 := by
  calc
    Artifact.submissionArtifact.instructionPC 3759 =
        Artifact.submissionArtifact.instructionPC 3758 + (YulEvmCompiler.Instr.push 2 7392).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3758 _ (by rfl)
    _ = 5042 := by rw [fixedPC3814]; rfl

@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3760 = 5043 := by
  calc
...
@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3761 = 5046 := by
  calc
    Artifact.submissionArtifact.instructionPC 3761 =
        Artifact.submissionArtifact.instructionPC 3760 + (YulEvmCompiler.Instr.push 2 8448).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3760 _ (by rfl)
    _ = 5046 := by rw [fixedPC3816]; rfl

@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3762 = 5047 := by
  calc
    Artifact.submissionArtifact.instructionPC 3762 =
        Artifact.submissionArtifact.instructionPC 3761 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3761 _ (by rfl)
    _ = 5047 := by rw [fixedPC3817]; rfl

@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3763 = 5049 := by
  calc
    Artifact.submissionArtifact.instructionPC 3763 =
        Artifact.submissionArtifact.instructionPC 3762 + (YulEvmCompiler.Instr.push 1 192).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3762 _ (by rfl)
    _ = 5049 := by rw [fixedPC3818]; rfl

@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3764 = 5050 := by
  calc
    Artifact.submissionArtifact.instructionPC 3764 =
        Artifact.submissionArtifact.instructionPC 3763 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3763 _ (by rfl)
    _ = 5050 := by rw [fixedPC3819]; rfl

@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3765 = 5051 := by
  calc
    Artifact.submissionArtifact.instructionPC 3765 =
        Artifact.submissionArtifact.instructionPC 3764 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3764 _ (by rfl)
    _ = 5051 := by rw [fixedPC3820]; rfl

@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3766 = 5052 := by
  calc
...
@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3767 = 5053 := by
  calc
    Artifact.submissionArtifact.instructionPC 3767 =
        Artifact.submissionArtifact.instructionPC 3766 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3766 _ (by rfl)
    _ = 5053 := by rw [fixedPC3822]; rfl

@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3768 = 5054 := by
  calc
    Artifact.submissionArtifact.instructionPC 3768 =
        Artifact.submissionArtifact.instructionPC 3767 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3767 _ (by rfl)
    _ = 5054 := by rw [fixedPC3823]; rfl

@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3769 = 5055 := by
  calc
...
@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3770 = 5056 := by
  calc
    Artifact.submissionArtifact.instructionPC 3770 =
        Artifact.submissionArtifact.instructionPC 3769 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3769 _ (by rfl)
    _ = 5056 := by rw [fixedPC3825]; rfl

@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3771 = 5057 := by
  calc
...
@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3772 = 5058 := by
  calc
    Artifact.submissionArtifact.instructionPC 3772 =
        Artifact.submissionArtifact.instructionPC 3771 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3771 _ (by rfl)
    _ = 5058 := by rw [fixedPC3827]; rfl

@[simp] theorem fixedPC3829 : Artifact.submissionArtifact.instructionPC 3773 = 5059 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3774 = 5060 := by
  calc
...
@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3775 = 5061 := by
  calc
    Artifact.submissionArtifact.instructionPC 3775 =
        Artifact.submissionArtifact.instructionPC 3774 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3774 _ (by rfl)
    _ = 5061 := by rw [fixedPC3830]; rfl

@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3776 = 5062 := by
  calc
    Artifact.submissionArtifact.instructionPC 3776 =
        Artifact.submissionArtifact.instructionPC 3775 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3775 _ (by rfl)
    _ = 5062 := by rw [fixedPC3831]; rfl

@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3777 = 5065 := by
  calc
    Artifact.submissionArtifact.instructionPC 3777 =
        Artifact.submissionArtifact.instructionPC 3776 + (YulEvmCompiler.Instr.push 2 7360).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3776 _ (by rfl)
    _ = 5065 := by rw [fixedPC3832]; rfl

@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3778 = 5066 := by
  calc
...
@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3779 = 5069 := by
  calc
    Artifact.submissionArtifact.instructionPC 3779 =
        Artifact.submissionArtifact.instructionPC 3778 + (YulEvmCompiler.Instr.push 2 8416).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3778 _ (by rfl)
    _ = 5069 := by rw [fixedPC3834]; rfl

@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3780 = 5070 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3781 = 5072 := by
  calc
    Artifact.submissionArtifact.instructionPC 3781 =
        Artifact.submissionArtifact.instructionPC 3780 + (YulEvmCompiler.Instr.push 1 160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3780 _ (by rfl)
    _ = 5072 := by rw [fixedPC3836]; rfl

@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3782 = 5073 := by
  calc
...
@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3783 = 5074 := by
  calc
    Artifact.submissionArtifact.instructionPC 3783 =
        Artifact.submissionArtifact.instructionPC 3782 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3782 _ (by rfl)
    _ = 5074 := by rw [fixedPC3838]; rfl

@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3784 = 5075 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3785 = 5076 := by
  calc
    Artifact.submissionArtifact.instructionPC 3785 =
        Artifact.submissionArtifact.instructionPC 3784 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3784 _ (by rfl)
    _ = 5076 := by rw [fixedPC3840]; rfl

@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3786 = 5077 := by
  calc
    Artifact.submissionArtifact.instructionPC 3786 =
        Artifact.submissionArtifact.instructionPC 3785 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3785 _ (by rfl)
    _ = 5077 := by rw [fixedPC3841]; rfl

@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3787 = 5078 := by
  calc
...
@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3788 = 5079 := by
  calc
    Artifact.submissionArtifact.instructionPC 3788 =
        Artifact.submissionArtifact.instructionPC 3787 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3787 _ (by rfl)
    _ = 5079 := by rw [fixedPC3843]; rfl

@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3789 = 5080 := by
  calc
...
@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3790 = 5081 := by
  calc
    Artifact.submissionArtifact.instructionPC 3790 =
        Artifact.submissionArtifact.instructionPC 3789 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3789 _ (by rfl)
    _ = 5081 := by rw [fixedPC3845]; rfl

@[simp] theorem fixedPC3847 : Artifact.submissionArtifact.instructionPC 3791 = 5082 := by
  calc
    Artifact.submissionArtifact.instructionPC 3791 =
        Artifact.submissionArtifact.instructionPC 3790 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3790 _ (by rfl)
    _ = 5082 := by rw [fixedPC3846]; rfl

@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3792 = 5083 := by
  calc
...
@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3793 = 5084 := by
  calc
    Artifact.submissionArtifact.instructionPC 3793 =
        Artifact.submissionArtifact.instructionPC 3792 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3792 _ (by rfl)
    _ = 5084 := by rw [fixedPC3848]; rfl

@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3794 = 5085 := by
  calc
    Artifact.submissionArtifact.instructionPC 3794 =
        Artifact.submissionArtifact.instructionPC 3793 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3793 _ (by rfl)
    _ = 5085 := by rw [fixedPC3849]; rfl

@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3795 = 5088 := by
  calc
    Artifact.submissionArtifact.instructionPC 3795 =
        Artifact.submissionArtifact.instructionPC 3794 + (YulEvmCompiler.Instr.push 2 7328).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3794 _ (by rfl)
    _ = 5088 := by rw [fixedPC3850]; rfl

@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3796 = 5089 := by
  calc
    Artifact.submissionArtifact.instructionPC 3796 =
        Artifact.submissionArtifact.instructionPC 3795 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3795 _ (by rfl)
    _ = 5089 := by rw [fixedPC3851]; rfl

@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3797 = 5092 := by
  calc
    Artifact.submissionArtifact.instructionPC 3797 =
        Artifact.submissionArtifact.instructionPC 3796 + (YulEvmCompiler.Instr.push 2 8384).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3796 _ (by rfl)
    _ = 5092 := by rw [fixedPC3852]; rfl

@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3798 = 5093 := by
  calc
    Artifact.submissionArtifact.instructionPC 3798 =
        Artifact.submissionArtifact.instructionPC 3797 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3797 _ (by rfl)
    _ = 5093 := by rw [fixedPC3853]; rfl

@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3799 = 5095 := by
  calc
    Artifact.submissionArtifact.instructionPC 3799 =
        Artifact.submissionArtifact.instructionPC 3798 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3798 _ (by rfl)
    _ = 5095 := by rw [fixedPC3854]; rfl

@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3800 = 5096 := by
  calc
...
@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3801 = 5097 := by
  calc
    Artifact.submissionArtifact.instructionPC 3801 =
        Artifact.submissionArtifact.instructionPC 3800 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3800 _ (by rfl)
    _ = 5097 := by rw [fixedPC3856]; rfl

@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3802 = 5098 := by
  calc
...
@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3803 = 5099 := by
  calc
...
@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3804 = 5100 := by
  calc
    Artifact.submissionArtifact.instructionPC 3804 =
        Artifact.submissionArtifact.instructionPC 3803 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3803 _ (by rfl)
    _ = 5100 := by rw [fixedPC3859]; rfl

@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3805 = 5101 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3806 = 5102 := by
  calc
    Artifact.submissionArtifact.instructionPC 3806 =
        Artifact.submissionArtifact.instructionPC 3805 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3805 _ (by rfl)
    _ = 5102 := by rw [fixedPC3861]; rfl

@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3807 = 5103 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3808 = 5104 := by
  calc
    Artifact.submissionArtifact.instructionPC 3808 =
        Artifact.submissionArtifact.instructionPC 3807 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3807 _ (by rfl)
    _ = 5104 := by rw [fixedPC3863]; rfl

@[simp] theorem fixedPC3865 : Artifact.submissionArtifact.instructionPC 3809 = 5105 := by
  calc
    Artifact.submissionArtifact.instructionPC 3809 =
        Artifact.submissionArtifact.instructionPC 3808 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3808 _ (by rfl)
    _ = 5105 := by rw [fixedPC3864]; rfl

@[simp] theorem fixedPC3866 : Artifact.submissionArtifact.instructionPC 3810 = 5106 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3811 = 5107 := by
  calc
    Artifact.submissionArtifact.instructionPC 3811 =
        Artifact.submissionArtifact.instructionPC 3810 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3810 _ (by rfl)
    _ = 5107 := by rw [fixedPC3866]; rfl

@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3812 = 5108 := by
  calc
    Artifact.submissionArtifact.instructionPC 3812 =
        Artifact.submissionArtifact.instructionPC 3811 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3811 _ (by rfl)
    _ = 5108 := by rw [fixedPC3867]; rfl

@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3813 = 5111 := by
  calc
    Artifact.submissionArtifact.instructionPC 3813 =
        Artifact.submissionArtifact.instructionPC 3812 + (YulEvmCompiler.Instr.push 2 7296).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3812 _ (by rfl)
    _ = 5111 := by rw [fixedPC3868]; rfl

@[simp] theorem fixedPC3870 : Artifact.submissionArtifact.instructionPC 3814 = 5112 := by
  calc
...
@[simp] theorem fixedJump5109 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5112 = true := by
  simpa only [Artifact.instructionPC, fixedPC3870] using Artifact.isValidJumpDest_index 3814 (by rfl)

@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3815 = 5113 := by
  calc
    Artifact.submissionArtifact.instructionPC 3815 =
        Artifact.submissionArtifact.instructionPC 3814 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3814 _ (by rfl)
    _ = 5113 := by rw [fixedPC3870]; rfl

@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3816 = 5116 := by
  calc
...
@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3817 = 5117 := by
  calc
...
@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3818 = 5119 := by
  calc
...
@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3819 = 5120 := by
  calc
...
@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3820 = 5121 := by
  calc
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3821 = 5122 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3822 = 5123 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3823 = 5124 := by
  calc
...
@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3824 = 5125 := by
  calc
...
@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3825 = 5126 := by
  calc
...
@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3826 = 5127 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3827 = 5128 := by
  calc
...
@[simp] theorem fixedPC3884 : Artifact.submissionArtifact.instructionPC 3828 = 5129 := by
  calc
...
@[simp] theorem fixedPC3885 : Artifact.submissionArtifact.instructionPC 3829 = 5130 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3830 = 5131 := by
  calc
...
@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3831 = 5132 := by
  calc
...
@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3832 = 5135 := by
  calc
...
@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3833 = 5136 := by
  calc
...
@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3834 = 5137 := by
  calc
...
@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3835 = 5140 := by
  calc
...
@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3836 = 5141 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3837 = 5143 := by
  calc
...
@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3838 = 5144 := by
  calc
...
@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3839 = 5145 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3840 = 5146 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3841 = 5147 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3842 = 5148 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3843 = 5149 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3844 = 5150 := by
  calc
...
@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3845 = 5151 := by
  calc
...
@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3846 = 5152 := by
  calc
...
@[simp] theorem fixedPC3903 : Artifact.submissionArtifact.instructionPC 3847 = 5153 := by
  calc
...
@[simp] theorem fixedPC3904 : Artifact.submissionArtifact.instructionPC 3848 = 5154 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3849 = 5155 := by
  calc
...
@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3850 = 5156 := by
  calc
...
@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3851 = 5159 := by
  calc
...
@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3852 = 5160 := by
  calc
...
@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3853 = 5163 := by
  calc
...
@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3854 = 5164 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3855 = 5166 := by
  calc
...
@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3856 = 5167 := by
  calc
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3857 = 5168 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3858 = 5169 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3859 = 5170 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3860 = 5171 := by
  calc
...
@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3861 = 5172 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3862 = 5173 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3863 = 5174 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3864 = 5175 := by
  calc
...
@[simp] theorem fixedPC3921 : Artifact.submissionArtifact.instructionPC 3865 = 5176 := by
  calc
...
@[simp] theorem fixedPC3922 : Artifact.submissionArtifact.instructionPC 3866 = 5177 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3867 = 5178 := by
  calc
...
@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3868 = 5179 := by
  calc
...
@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3869 = 5182 := by
  calc
...
@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3870 = 5183 := by
  calc
...
@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3871 = 5186 := by
  calc
...
@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3872 = 5187 := by
  calc
...
@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3873 = 5188 := by
  calc
...
@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3874 = 5189 := by
  calc
...
@[simp] theorem fixedPC3931 : Artifact.submissionArtifact.instructionPC 3875 = 5190 := by
  calc
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3876 = 5191 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3877 = 5192 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3878 = 5193 := by
  calc
...
@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3879 = 5194 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3880 = 5195 := by
  calc
...
@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3881 = 5196 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3882 = 5197 := by
  calc
...
@[simp] theorem fixedPC3939 : Artifact.submissionArtifact.instructionPC 3883 = 5198 := by
  calc
...
@[simp] theorem fixedPC3940 : Artifact.submissionArtifact.instructionPC 3884 = 5199 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3885 = 5200 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3886 = 5201 := by
  calc
...
@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3887 = 5204 := by
  calc
...
@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3888 = 5205 := by
  calc
...
@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3889 = 5206 := by
  calc
...
@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3890 = 5209 := by
  calc
...
@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3891 = 5210 := by
  calc
...
@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3892 = 5211 := by
  calc
...
@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3893 = 5244 := by
  calc
    Artifact.submissionArtifact.instructionPC 3893 =
        Artifact.submissionArtifact.instructionPC 3892 + (YulEvmCompiler.Instr.push 32 115792089237316195423570985008687907853269984665640564039457584007913129638848).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3892 _ (by rfl)
    _ = 5244 := by rw [fixedPC3948]; rfl

@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3893 = 5244 :=
  fixedPC3949

@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3894 = 5245 := by
  calc
    Artifact.submissionArtifact.instructionPC 3894 =
        Artifact.submissionArtifact.instructionPC 3893 + (YulEvmCompiler.Instr.op .MUL).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3893 _ (by rfl)
    _ = 5245 := by rw [fixedPC3950]; rfl

@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3895 = 5248 := by
  calc
    Artifact.submissionArtifact.instructionPC 3895 =
        Artifact.submissionArtifact.instructionPC 3894 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3894 _ (by rfl)
    _ = 5248 := by rw [fixedPC3951]; rfl

@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3896 = 5249 := by
  calc
    Artifact.submissionArtifact.instructionPC 3896 =
        Artifact.submissionArtifact.instructionPC 3895 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3895 _ (by rfl)
    _ = 5249 := by rw [fixedPC3952]; rfl

@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3897 = 5252 := by
  calc
    Artifact.submissionArtifact.instructionPC 3897 =
        Artifact.submissionArtifact.instructionPC 3896 + (YulEvmCompiler.Instr.push 2 9344).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3896 _ (by rfl)
    _ = 5252 := by rw [fixedPC3953]; rfl

@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3898 = 5253 := by
  calc
    Artifact.submissionArtifact.instructionPC 3898 =
        Artifact.submissionArtifact.instructionPC 3897 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3897 _ (by rfl)
    _ = 5253 := by rw [fixedPC3954]; rfl

@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3899 = 5254 := by
  calc
...
@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 3900 = 5255 := by
  calc
    Artifact.submissionArtifact.instructionPC 3900 =
        Artifact.submissionArtifact.instructionPC 3899 + (YulEvmCompiler.Instr.op .MCOPY).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3899 _ (by rfl)
    _ = 5255 := by rw [fixedPC3956]; rfl

@[simp] theorem fixedPC3958 : Artifact.submissionArtifact.instructionPC 3901 = 5256 := by
  calc
    Artifact.submissionArtifact.instructionPC 3901 =
        Artifact.submissionArtifact.instructionPC 3900 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5224 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5256 = true := by
  simpa only [Artifact.instructionPC, fixedPC3958] using Artifact.isValidJumpDest_index 3901 (by rfl)

@[simp] theorem fixedPC3959 : Artifact.submissionArtifact.instructionPC 3902 = 5257 := by
  calc
...
@[simp] theorem fixedPC3960 : Artifact.submissionArtifact.instructionPC 3903 = 5258 := by
  calc
    Artifact.submissionArtifact.instructionPC 3903 =
        Artifact.submissionArtifact.instructionPC 3902 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3902 _ (by rfl)
    _ = 5258 := by rw [fixedPC3959]; rfl

@[simp] theorem fixedPC3961 : Artifact.submissionArtifact.instructionPC 3904 = 5259 := by
  calc
...
@[simp] theorem fixedPC3962 : Artifact.submissionArtifact.instructionPC 3905 = 5261 := by
  calc
...
@[simp] theorem fixedPC3963 : Artifact.submissionArtifact.instructionPC 3906 = 5262 := by
  calc
...
@[simp] theorem fixedPC3964 : Artifact.submissionArtifact.instructionPC 3907 = 5264 := by
  calc
    Artifact.submissionArtifact.instructionPC 3907 =
        Artifact.submissionArtifact.instructionPC 3906 + (YulEvmCompiler.Instr.push 1 64).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3906 _ (by rfl)
    _ = 5264 := by rw [fixedPC3963]; rfl

@[simp] theorem fixedPC3965 : Artifact.submissionArtifact.instructionPC 3908 = 5265 := by
  calc
...
@[simp] theorem fixedPC3966 : Artifact.submissionArtifact.instructionPC 3909 = 5267 := by
  calc
...
@[simp] theorem fixedPC3967 : Artifact.submissionArtifact.instructionPC 3910 = 5268 := by
  calc
    Artifact.submissionArtifact.instructionPC 3910 =
        Artifact.submissionArtifact.instructionPC 3909 + (YulEvmCompiler.Instr.op (.Dup ⟨3, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3909 _ (by rfl)
    _ = 5268 := by rw [fixedPC3966]; rfl

@[simp] theorem fixedPC3968 : Artifact.submissionArtifact.instructionPC 3911 = 5269 := by
  calc
...
@[simp] theorem fixedPC3969 : Artifact.submissionArtifact.instructionPC 3912 = 5270 := by
  calc
...
@[simp] theorem fixedPC3970 : Artifact.submissionArtifact.instructionPC 3913 = 5272 := by
  calc
...
@[simp] theorem fixedPC3971 : Artifact.submissionArtifact.instructionPC 3914 = 5273 := by
  calc
...
@[simp] theorem fixedPC3972 : Artifact.submissionArtifact.instructionPC 3915 = 5274 := by
  calc
...
@[simp] theorem fixedPC3973 : Artifact.submissionArtifact.instructionPC 3916 = 5275 := by
  calc
...
@[simp] theorem fixedPC3974 : Artifact.submissionArtifact.instructionPC 3917 = 5277 := by
  calc
...
@[simp] theorem fixedPC3975 : Artifact.submissionArtifact.instructionPC 3918 = 5278 := by
  calc
...
@[simp] theorem fixedPC3976 : Artifact.submissionArtifact.instructionPC 3919 = 5279 := by
  calc
...
@[simp] theorem fixedPC3977 : Artifact.submissionArtifact.instructionPC 3920 = 5282 := by
  calc
    Artifact.submissionArtifact.instructionPC 3920 =
        Artifact.submissionArtifact.instructionPC 3919 + (YulEvmCompiler.Instr.push 2 5304).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3919 _ (by rfl)
    _ = 5282 := by rw [fixedPC3976]; rfl

@[simp] theorem fixedPC3978 : Artifact.submissionArtifact.instructionPC 3921 = 5283 := by
  calc
    Artifact.submissionArtifact.instructionPC 3921 =
        Artifact.submissionArtifact.instructionPC 3920 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3920 _ (by rfl)
    _ = 5283 := by rw [fixedPC3977]; rfl

@[simp] theorem fixedPC3979 : Artifact.submissionArtifact.instructionPC 3922 = 5284 := by
  calc
...
@[simp] theorem fixedPC3980 : Artifact.submissionArtifact.instructionPC 3923 = 5286 := by
  calc
    Artifact.submissionArtifact.instructionPC 3923 =
        Artifact.submissionArtifact.instructionPC 3922 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3922 _ (by rfl)
    _ = 5286 := by rw [fixedPC3979]; rfl

@[simp] theorem fixedPC3981 : Artifact.submissionArtifact.instructionPC 3924 = 5287 := by
  calc
...
@[simp] theorem fixedPC3982 : Artifact.submissionArtifact.instructionPC 3925 = 5288 := by
  calc
    Artifact.submissionArtifact.instructionPC 3925 =
        Artifact.submissionArtifact.instructionPC 3924 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3924 _ (by rfl)
    _ = 5288 := by rw [fixedPC3981]; rfl

@[simp] theorem fixedPC3983 : Artifact.submissionArtifact.instructionPC 3926 = 5289 := by
  calc
...
@[simp] theorem fixedPC3984 : Artifact.submissionArtifact.instructionPC 3927 = 5290 := by
  calc
    Artifact.submissionArtifact.instructionPC 3927 =
        Artifact.submissionArtifact.instructionPC 3926 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3926 _ (by rfl)
    _ = 5290 := by rw [fixedPC3983]; rfl

@[simp] theorem fixedPC3985 : Artifact.submissionArtifact.instructionPC 3928 = 5293 := by
  calc
    Artifact.submissionArtifact.instructionPC 3928 =
        Artifact.submissionArtifact.instructionPC 3927 + (YulEvmCompiler.Instr.push 2 1186).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3927 _ (by rfl)
    _ = 5293 := by rw [fixedPC3984]; rfl

@[simp] theorem fixedPC3986 : Artifact.submissionArtifact.instructionPC 3929 = 5294 := by
  calc
...
@[simp] theorem fixedPC3987 : Artifact.submissionArtifact.instructionPC 3930 = 5295 := by
  calc
    Artifact.submissionArtifact.instructionPC 3930 =
        Artifact.submissionArtifact.instructionPC 3929 + (YulEvmCompiler.Instr.op (.Dup ⟨3, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3929 _ (by rfl)
    _ = 5295 := by rw [fixedPC3986]; rfl

@[simp] theorem fixedPC3988 : Artifact.submissionArtifact.instructionPC 3931 = 5297 := by
  calc
    Artifact.submissionArtifact.instructionPC 3931 =
        Artifact.submissionArtifact.instructionPC 3930 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3930 _ (by rfl)
    _ = 5297 := by rw [fixedPC3987]; rfl

@[simp] theorem fixedPC3989 : Artifact.submissionArtifact.instructionPC 3932 = 5298 := by
  calc
    Artifact.submissionArtifact.instructionPC 3932 =
        Artifact.submissionArtifact.instructionPC 3931 + (YulEvmCompiler.Instr.op (.Dup ⟨6, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3931 _ (by rfl)
    _ = 5298 := by rw [fixedPC3988]; rfl

@[simp] theorem fixedPC3990 : Artifact.submissionArtifact.instructionPC 3933 = 5299 := by
  calc
    Artifact.submissionArtifact.instructionPC 3933 =
        Artifact.submissionArtifact.instructionPC 3932 + (YulEvmCompiler.Instr.op (.Dup ⟨8, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3932 _ (by rfl)
    _ = 5299 := by rw [fixedPC3989]; rfl

@[simp] theorem fixedPC3991 : Artifact.submissionArtifact.instructionPC 3934 = 5300 := by
  calc
    Artifact.submissionArtifact.instructionPC 3934 =
        Artifact.submissionArtifact.instructionPC 3933 + (YulEvmCompiler.Instr.op (.Dup ⟨10, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3933 _ (by rfl)
    _ = 5300 := by rw [fixedPC3990]; rfl

@[simp] theorem fixedPC3992 : Artifact.submissionArtifact.instructionPC 3935 = 5303 := by
  calc
    Artifact.submissionArtifact.instructionPC 3935 =
        Artifact.submissionArtifact.instructionPC 3934 + (YulEvmCompiler.Instr.push 2 4888).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3934 _ (by rfl)
    _ = 5303 := by rw [fixedPC3991]; rfl

@[simp] theorem fixedPC3993 : Artifact.submissionArtifact.instructionPC 3936 = 5304 := by
  calc
    Artifact.submissionArtifact.instructionPC 3936 =
        Artifact.submissionArtifact.instructionPC 3935 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5272 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5304 = true := by
  simpa only [Artifact.instructionPC, fixedPC3993] using Artifact.isValidJumpDest_index 3936 (by rfl)

@[simp] theorem fixedPC3994 : Artifact.submissionArtifact.instructionPC 3937 = 5305 := by
  calc
    Artifact.submissionArtifact.instructionPC 3937 =
        Artifact.submissionArtifact.instructionPC 3936 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3936 _ (by rfl)
    _ = 5305 := by rw [fixedPC3993]; rfl

@[simp] theorem fixedPC3995 : Artifact.submissionArtifact.instructionPC 3938 = 5306 := by
  calc
...
@[simp] theorem fixedPC3996 : Artifact.submissionArtifact.instructionPC 3939 = 5307 := by
  calc
    Artifact.submissionArtifact.instructionPC 3939 =
        Artifact.submissionArtifact.instructionPC 3938 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3938 _ (by rfl)
    _ = 5307 := by rw [fixedPC3995]; rfl

@[simp] theorem fixedPC3997 : Artifact.submissionArtifact.instructionPC 3940 = 5308 := by
  calc
...
@[simp] theorem fixedPC3998 : Artifact.submissionArtifact.instructionPC 3941 = 5311 := by
  calc
    Artifact.submissionArtifact.instructionPC 3941 =
        Artifact.submissionArtifact.instructionPC 3940 + (YulEvmCompiler.Instr.push 2 1233).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3940 _ (by rfl)
    _ = 5311 := by rw [fixedPC3997]; rfl

@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3942 = 5312 := by
  calc
    Artifact.submissionArtifact.instructionPC 3942 =
        Artifact.submissionArtifact.instructionPC 3941 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5280 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5312 = true := by
  simpa only [Artifact.instructionPC, fixedPC3999] using Artifact.isValidJumpDest_index 3942 (by rfl)

@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 3943 = 5313 := by
  calc
...
@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 3944 = 5316 := by
  calc
    Artifact.submissionArtifact.instructionPC 3944 =
        Artifact.submissionArtifact.instructionPC 3943 + (YulEvmCompiler.Instr.push 2 8352).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3943 _ (by rfl)
    _ = 5316 := by rw [fixedPC4000]; rfl

@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 3945 = 5317 := by
  calc
...
@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 3946 = 5319 := by
  calc
    Artifact.submissionArtifact.instructionPC 3946 =
        Artifact.submissionArtifact.instructionPC 3945 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3945 _ (by rfl)
    _ = 5319 := by rw [fixedPC4002]; rfl

@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 3947 = 5320 := by
  calc
...
@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 3948 = 5321 := by
  calc
...
@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 3949 = 5322 := by
  calc
...
@[simp] theorem fixedPC4007 : Artifact.submissionArtifact.instructionPC 3950 = 5323 := by
  calc
...
@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 3951 = 5324 := by
  calc
...
@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 3952 = 5325 := by
  calc
...
@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 3953 = 5328 := by
  calc
    Artifact.submissionArtifact.instructionPC 3953 =
        Artifact.submissionArtifact.instructionPC 3952 + (YulEvmCompiler.Instr.push 2 7264).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3952 _ (by rfl)
    _ = 5328 := by rw [fixedPC4009]; rfl

@[simp] theorem fixedPC4011 : Artifact.submissionArtifact.instructionPC 3954 = 5329 := by
  calc
    Artifact.submissionArtifact.instructionPC 3954 =
        Artifact.submissionArtifact.instructionPC 3953 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3953 _ (by rfl)
    _ = 5329 := by rw [fixedPC4010]; rfl

@[simp] theorem fixedPC4012 : Artifact.submissionArtifact.instructionPC 3955 = 5332 := by
  calc
    Artifact.submissionArtifact.instructionPC 3955 =
        Artifact.submissionArtifact.instructionPC 3954 + (YulEvmCompiler.Instr.push 2 5136).bytes.length :=
