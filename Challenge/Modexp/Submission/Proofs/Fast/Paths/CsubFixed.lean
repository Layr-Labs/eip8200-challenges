...
@[simp] theorem fixedPC1619 : Artifact.submissionArtifact.instructionPC 1577 = 2143 := by
  calc
    Artifact.submissionArtifact.instructionPC 1577 =
        Artifact.submissionArtifact.instructionPC 1576 + (YulEvmCompiler.Instr.push 2 3847).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 1576 _ (by rfl)
    _ = 2143 := by rw [fixedPC1618]; rfl

@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3748 = 4978 := by rfl
...
@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3749 = 4979 := by
  calc
...
@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3750 = 4982 := by
  calc
...
@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3751 = 4983 := by
  calc
...
@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3752 = 4986 := by
  calc
...
@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3753 = 4987 := by
  calc
...
@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3754 = 4990 := by
  calc
    Artifact.submissionArtifact.instructionPC 3754 =
        Artifact.submissionArtifact.instructionPC 3753 + (YulEvmCompiler.Instr.push 2 5026).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3753 _ (by rfl)
    _ = 4990 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3755 = 4991 := by
  calc
...
@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3756 = 4994 := by
  calc
...
@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3757 = 4995 := by
  calc
...
@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3758 = 4997 := by
  calc
...
@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3759 = 4998 := by
  calc
...
@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3760 = 5001 := by
  calc
    Artifact.submissionArtifact.instructionPC 3760 =
        Artifact.submissionArtifact.instructionPC 3759 + (YulEvmCompiler.Instr.push 2 3873).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3759 _ (by rfl)
    _ = 5001 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3761 = 5002 := by
  calc
...
@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3762 = 5005 := by
  calc
...
@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3763 = 5006 := by
  calc
...
@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3764 = 5009 := by
  calc
...
@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3765 = 5010 := by
  calc
...
@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3766 = 5011 := by
  calc
...
@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3767 = 5014 := by
  calc
...
@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3768 = 5015 := by
  calc
...
@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3769 = 5018 := by
  calc
...
@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3770 = 5019 := by
  calc
...
@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3771 = 5020 := by
  calc
...
@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3772 = 5021 := by
  calc
...
@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3773 = 5022 := by
  calc
...
@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3774 = 5025 := by
  calc
...
@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3775 = 5026 := by
  calc
...
@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3776 = 5027 := by
  calc
...
@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3777 = 5030 := by
  calc
...
@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3778 = 5031 := by
  calc
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3779 = 5033 := by
  calc
...
@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3780 = 5034 := by
  calc
...
@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3781 = 5035 := by
  calc
...
@[simp] theorem fixedPC3811 : Artifact.submissionArtifact.instructionPC 3782 = 5036 := by
  calc
...
@[simp] theorem fixedPC3812 : Artifact.submissionArtifact.instructionPC 3783 = 5037 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3784 = 5038 := by
  calc
...
@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3785 = 5039 := by
  calc
...
@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3786 = 5042 := by
  calc
...
@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3787 = 5043 := by
  calc
...
@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3788 = 5046 := by
  calc
...
@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3789 = 5047 := by
  calc
...
@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3790 = 5049 := by
  calc
...
@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3791 = 5050 := by
  calc
...
@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3792 = 5051 := by
  calc
...
@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3793 = 5052 := by
  calc
...
@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3794 = 5053 := by
  calc
...
@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3795 = 5054 := by
  calc
...
@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3796 = 5055 := by
  calc
...
@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3797 = 5056 := by
  calc
...
@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3798 = 5057 := by
  calc
...
@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3799 = 5058 := by
  calc
...
@[simp] theorem fixedPC3829 : Artifact.submissionArtifact.instructionPC 3800 = 5059 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3801 = 5060 := by
  calc
...
@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3802 = 5061 := by
  calc
...
@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3803 = 5062 := by
  calc
...
@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3804 = 5065 := by
  calc
...
@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3805 = 5066 := by
  calc
...
@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3806 = 5069 := by
  calc
...
@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3807 = 5070 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3808 = 5072 := by
  calc
...
@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3809 = 5073 := by
  calc
...
@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3810 = 5074 := by
  calc
...
@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3811 = 5075 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3812 = 5076 := by
  calc
...
@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3813 = 5077 := by
  calc
...
@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3814 = 5078 := by
  calc
...
@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3815 = 5079 := by
  calc
...
@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3816 = 5080 := by
  calc
...
@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3817 = 5081 := by
  calc
...
@[simp] theorem fixedPC3847 : Artifact.submissionArtifact.instructionPC 3818 = 5082 := by
  calc
...
@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3819 = 5083 := by
  calc
...
@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3820 = 5084 := by
  calc
...
@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3821 = 5085 := by
  calc
...
@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3822 = 5088 := by
  calc
...
@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3823 = 5089 := by
  calc
...
@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3824 = 5092 := by
  calc
...
@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3825 = 5093 := by
  calc
...
@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3826 = 5095 := by
  calc
...
@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3827 = 5096 := by
  calc
...
@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3828 = 5097 := by
  calc
...
@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3829 = 5098 := by
  calc
...
@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3830 = 5099 := by
  calc
...
@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3831 = 5100 := by
  calc
...
@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3832 = 5101 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3833 = 5102 := by
  calc
...
@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3834 = 5103 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3835 = 5104 := by
  calc
...
@[simp] theorem fixedPC3865 : Artifact.submissionArtifact.instructionPC 3836 = 5105 := by
  calc
...
@[simp] theorem fixedPC3866 : Artifact.submissionArtifact.instructionPC 3837 = 5106 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3838 = 5107 := by
  calc
...
@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3839 = 5108 := by
  calc
...
@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3840 = 5111 := by
  calc
...
@[simp] theorem fixedPC3870 : Artifact.submissionArtifact.instructionPC 3841 = 5112 := by
  calc
...
@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3842 = 5113 := by
  calc
...
@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3843 = 5116 := by
  calc
...
@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3844 = 5117 := by
  calc
...
@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3845 = 5119 := by
  calc
...
@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3846 = 5120 := by
  calc
...
@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3847 = 5121 := by
  calc
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3848 = 5122 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3849 = 5123 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3850 = 5124 := by
  calc
...
@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3851 = 5125 := by
  calc
...
@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3852 = 5126 := by
  calc
...
@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3853 = 5127 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3854 = 5128 := by
  calc
...
@[simp] theorem fixedPC3884 : Artifact.submissionArtifact.instructionPC 3855 = 5129 := by
  calc
...
@[simp] theorem fixedPC3885 : Artifact.submissionArtifact.instructionPC 3856 = 5130 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3857 = 5131 := by
  calc
...
@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3858 = 5132 := by
  calc
...
@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3859 = 5135 := by
  calc
...
@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3860 = 5136 := by
  calc
...
@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3861 = 5137 := by
  calc
...
@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3862 = 5140 := by
  calc
...
@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3863 = 5141 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3864 = 5143 := by
  calc
...
@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3865 = 5144 := by
  calc
...
@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3866 = 5145 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3867 = 5146 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3868 = 5147 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3869 = 5148 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3870 = 5149 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3871 = 5150 := by
  calc
...
@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3872 = 5151 := by
  calc
...
@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3873 = 5152 := by
  calc
...
@[simp] theorem fixedPC3903 : Artifact.submissionArtifact.instructionPC 3874 = 5153 := by
  calc
...
@[simp] theorem fixedPC3904 : Artifact.submissionArtifact.instructionPC 3875 = 5154 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3876 = 5155 := by
  calc
...
@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3877 = 5156 := by
  calc
...
@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3878 = 5159 := by
  calc
...
@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3879 = 5160 := by
  calc
...
@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3880 = 5163 := by
  calc
...
@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3881 = 5164 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3882 = 5166 := by
  calc
...
@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3883 = 5167 := by
  calc
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3884 = 5168 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3885 = 5169 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3886 = 5170 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3887 = 5171 := by
  calc
...
@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3888 = 5172 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3889 = 5173 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3890 = 5174 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3891 = 5175 := by
  calc
...
@[simp] theorem fixedPC3921 : Artifact.submissionArtifact.instructionPC 3892 = 5176 := by
  calc
...
@[simp] theorem fixedPC3922 : Artifact.submissionArtifact.instructionPC 3893 = 5177 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3894 = 5178 := by
  calc
...
@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3895 = 5179 := by
  calc
...
@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3896 = 5182 := by
  calc
...
@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3897 = 5183 := by
  calc
...
@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3898 = 5186 := by
  calc
...
@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3899 = 5187 := by
  calc
...
@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3900 = 5188 := by
  calc
...
@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3901 = 5189 := by
  calc
...
@[simp] theorem fixedPC3931 : Artifact.submissionArtifact.instructionPC 3902 = 5190 := by
  calc
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3903 = 5191 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3904 = 5192 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3905 = 5193 := by
  calc
...
@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3906 = 5194 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3907 = 5195 := by
  calc
...
@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3908 = 5196 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3909 = 5197 := by
  calc
...
@[simp] theorem fixedPC3939 : Artifact.submissionArtifact.instructionPC 3910 = 5198 := by
  calc
...
@[simp] theorem fixedPC3940 : Artifact.submissionArtifact.instructionPC 3911 = 5199 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3912 = 5200 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3913 = 5201 := by
  calc
...
@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3914 = 5204 := by
  calc
...
@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3915 = 5205 := by
  calc
...
@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3916 = 5206 := by
  calc
...
@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3917 = 5209 := by
  calc
...
@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3918 = 5210 := by
  calc
...
@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3919 = 5211 := by
  calc
...
@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3931 = 5244 := by
  decide

@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3931 = 5244 :=
  fixedPC3949

@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3932 = 5245 := by
  calc
...
@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3933 = 5248 := by
  calc
...
@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3934 = 5249 := by
  calc
...
@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3935 = 5252 := by
  calc
...
@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3936 = 5253 := by
  calc
...
@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3937 = 5254 := by
  calc
...
@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 3938 = 5255 := by
  calc
...
@[simp] theorem fixedPC3958 : Artifact.submissionArtifact.instructionPC 3939 = 5256 := by
  calc
...
@[simp] theorem fixedPC3959 : Artifact.submissionArtifact.instructionPC 3940 = 5257 := by
  calc
...
@[simp] theorem fixedPC3960 : Artifact.submissionArtifact.instructionPC 3941 = 5258 := by
  calc
...
@[simp] theorem fixedPC3961 : Artifact.submissionArtifact.instructionPC 3942 = 5259 := by
  calc
...
@[simp] theorem fixedPC3962 : Artifact.submissionArtifact.instructionPC 3943 = 5261 := by
  calc
...
@[simp] theorem fixedPC3963 : Artifact.submissionArtifact.instructionPC 3944 = 5262 := by
  calc
...
@[simp] theorem fixedPC3964 : Artifact.submissionArtifact.instructionPC 3945 = 5264 := by
  calc
...
@[simp] theorem fixedPC3965 : Artifact.submissionArtifact.instructionPC 3946 = 5265 := by
  calc
...
@[simp] theorem fixedPC3966 : Artifact.submissionArtifact.instructionPC 3947 = 5267 := by
  calc
...
@[simp] theorem fixedPC3967 : Artifact.submissionArtifact.instructionPC 3948 = 5268 := by
  calc
...
@[simp] theorem fixedPC3968 : Artifact.submissionArtifact.instructionPC 3949 = 5269 := by
  calc
...
@[simp] theorem fixedPC3969 : Artifact.submissionArtifact.instructionPC 3950 = 5270 := by
  calc
...
@[simp] theorem fixedPC3970 : Artifact.submissionArtifact.instructionPC 3951 = 5272 := by
  calc
...
@[simp] theorem fixedPC3971 : Artifact.submissionArtifact.instructionPC 3952 = 5273 := by
  calc
...
@[simp] theorem fixedPC3972 : Artifact.submissionArtifact.instructionPC 3953 = 5274 := by
  calc
...
@[simp] theorem fixedPC3973 : Artifact.submissionArtifact.instructionPC 3954 = 5275 := by
  calc
...
@[simp] theorem fixedPC3974 : Artifact.submissionArtifact.instructionPC 3955 = 5277 := by
  calc
...
@[simp] theorem fixedPC3975 : Artifact.submissionArtifact.instructionPC 3956 = 5278 := by
  calc
...
@[simp] theorem fixedPC3976 : Artifact.submissionArtifact.instructionPC 3957 = 5279 := by
  calc
...
@[simp] theorem fixedPC3977 : Artifact.submissionArtifact.instructionPC 3958 = 5282 := by
  calc
    Artifact.submissionArtifact.instructionPC 3958 =
        Artifact.submissionArtifact.instructionPC 3957 + (YulEvmCompiler.Instr.push 2 5304).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3957 _ (by rfl)
    _ = 5282 := by rw [fixedPC3976]; rfl

@[simp] theorem fixedPC3978 : Artifact.submissionArtifact.instructionPC 3959 = 5283 := by
  calc
...
@[simp] theorem fixedPC3979 : Artifact.submissionArtifact.instructionPC 3960 = 5284 := by
  calc
...
@[simp] theorem fixedPC3980 : Artifact.submissionArtifact.instructionPC 3961 = 5286 := by
  calc
...
@[simp] theorem fixedPC3981 : Artifact.submissionArtifact.instructionPC 3962 = 5287 := by
  calc
...
@[simp] theorem fixedPC3982 : Artifact.submissionArtifact.instructionPC 3963 = 5288 := by
  calc
...
@[simp] theorem fixedPC3983 : Artifact.submissionArtifact.instructionPC 3964 = 5289 := by
  calc
...
@[simp] theorem fixedPC3984 : Artifact.submissionArtifact.instructionPC 3965 = 5290 := by
  calc
...
@[simp] theorem fixedPC3985 : Artifact.submissionArtifact.instructionPC 3966 = 5293 := by
  calc
...
@[simp] theorem fixedPC3986 : Artifact.submissionArtifact.instructionPC 3967 = 5294 := by
  calc
...
@[simp] theorem fixedPC3987 : Artifact.submissionArtifact.instructionPC 3968 = 5295 := by
  calc
...
@[simp] theorem fixedPC3988 : Artifact.submissionArtifact.instructionPC 3969 = 5297 := by
  calc
...
@[simp] theorem fixedPC3989 : Artifact.submissionArtifact.instructionPC 3970 = 5298 := by
  calc
...
@[simp] theorem fixedPC3990 : Artifact.submissionArtifact.instructionPC 3971 = 5299 := by
  calc
...
@[simp] theorem fixedPC3991 : Artifact.submissionArtifact.instructionPC 3972 = 5300 := by
  calc
...
@[simp] theorem fixedPC3992 : Artifact.submissionArtifact.instructionPC 3973 = 5303 := by
  calc
    Artifact.submissionArtifact.instructionPC 3973 =
        Artifact.submissionArtifact.instructionPC 3972 + (YulEvmCompiler.Instr.push 2 4888).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3972 _ (by rfl)
    _ = 5303 := by rw [fixedPC3991]; rfl

@[simp] theorem fixedPC3993 : Artifact.submissionArtifact.instructionPC 3974 = 5304 := by
  calc
...
@[simp] theorem fixedPC3994 : Artifact.submissionArtifact.instructionPC 3975 = 5305 := by
  calc
...
@[simp] theorem fixedPC3995 : Artifact.submissionArtifact.instructionPC 3976 = 5306 := by
  calc
...
@[simp] theorem fixedPC3996 : Artifact.submissionArtifact.instructionPC 3977 = 5307 := by
  calc
...
@[simp] theorem fixedPC3997 : Artifact.submissionArtifact.instructionPC 3978 = 5308 := by
  calc
...
@[simp] theorem fixedPC3998 : Artifact.submissionArtifact.instructionPC 3979 = 5311 := by
  calc
...
@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 2928 = 3873 := by
  decide

@[simp] theorem fixedJump5280 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 3873 = true := by
  simpa only [Artifact.instructionPC, fixedPC3999] using Artifact.isValidJumpDest_index 2928 (by rfl)

@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 2929 = 3874 := by
  calc
    Artifact.submissionArtifact.instructionPC 2929 =
        Artifact.submissionArtifact.instructionPC 2928 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2928 _ (by rfl)
    _ = 3874 := by rw [fixedPC3999]; rfl

@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 2930 = 3877 := by
  calc
    Artifact.submissionArtifact.instructionPC 2930 =
        Artifact.submissionArtifact.instructionPC 2929 + (YulEvmCompiler.Instr.push 2 8352).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2929 _ (by rfl)
    _ = 3877 := by rw [fixedPC4000]; rfl

@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 2931 = 3878 := by
  calc
    Artifact.submissionArtifact.instructionPC 2931 =
        Artifact.submissionArtifact.instructionPC 2930 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2930 _ (by rfl)
    _ = 3878 := by rw [fixedPC4001]; rfl

@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 2932 = 3880 := by
  calc
    Artifact.submissionArtifact.instructionPC 2932 =
        Artifact.submissionArtifact.instructionPC 2931 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2931 _ (by rfl)
    _ = 3880 := by rw [fixedPC4002]; rfl

@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 2933 = 3881 := by
  calc
    ...
    _ = 3881 := by rw [fixedPC4003]; rfl

@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 2934 = 3882 := by
  calc
    Artifact.submissionArtifact.instructionPC 2934 =
        Artifact.submissionArtifact.instructionPC 2933 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2933 _ (by rfl)
    _ = 3882 := by rw [fixedPC4004]; rfl

@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 2935 = 3883 := by
  calc
    Artifact.submissionArtifact.instructionPC 2935 =
        Artifact.submissionArtifact.instructionPC 2934 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2934 _ (by rfl)
    _ = 3883 := by rw [fixedPC4005]; rfl

@[simp] theorem fixedPC4007 : Artifact.submissionArtifact.instructionPC 2936 = 3884 := by
  calc
    Artifact.submissionArtifact.instructionPC 2936 =
        Artifact.submissionArtifact.instructionPC 2935 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2935 _ (by rfl)
    _ = 3884 := by rw [fixedPC4006]; rfl

@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 2937 = 3885 := by
  calc
    Artifact.submissionArtifact.instructionPC 2937 =
        Artifact.submissionArtifact.instructionPC 2936 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2936 _ (by rfl)
    _ = 3885 := by rw [fixedPC4007]; rfl

@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 2938 = 3886 := by
  calc
    Artifact.submissionArtifact.instructionPC 2938 =
        Artifact.submissionArtifact.instructionPC 2937 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2937 _ (by rfl)
    _ = 3886 := by rw [fixedPC4008]; rfl

@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 2939 = 3889 := by
  calc
    Artifact.submissionArtifact.instructionPC 2939 =
        Artifact.submissionArtifact.instructionPC 2938 + (YulEvmCompiler.Instr.push 2 7264).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2938 _ (by rfl)
    _ = 3889 := by rw [fixedPC4009]; rfl

@[simp] theorem fixedPC4011 : Artifact.submissionArtifact.instructionPC 2940 = 3890 := by
  calc
    Artifact.submissionArtifact.instructionPC 2940 =
        Artifact.submissionArtifact.instructionPC 2939 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2939 _ (by rfl)
    _ = 3890 := by rw [fixedPC4010]; rfl

@[simp] theorem fixedPC4012 : Artifact.submissionArtifact.instructionPC 2941 = 3893 := by
  calc
    Artifact.submissionArtifact.instructionPC 2941 =
        Artifact.submissionArtifact.instructionPC 2940 + (YulEvmCompiler.Instr.push 2 5136).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2940 _ (by rfl)
    _ = 3893 := by rw [fixedPC4011]; rfl
...
@[simp] theorem earlyExtraPC3918 : Artifact.submissionArtifact.instructionPC 3920 = 5214 := by rfl
@[simp] theorem earlyExtraPC3919 : Artifact.submissionArtifact.instructionPC 3921 = 5215 := by rfl
@[simp] theorem earlyExtraPC3920 : Artifact.submissionArtifact.instructionPC 3922 = 5218 := by rfl
@[simp] theorem earlyExtraPC3921 : Artifact.submissionArtifact.instructionPC 3923 = 5219 := by rfl
@[simp] theorem earlyExtraPC3922 : Artifact.submissionArtifact.instructionPC 3924 = 5220 := by rfl
@[simp] theorem earlyExtraPC3923 : Artifact.submissionArtifact.instructionPC 3925 = 5236 := by rfl
@[simp] theorem earlyExtraPC3924 : Artifact.submissionArtifact.instructionPC 3926 = 5239 := by rfl
@[simp] theorem earlyExtraPC3925 : Artifact.submissionArtifact.instructionPC 3927 = 5240 := by rfl
@[simp] theorem earlyExtraPC3926 : Artifact.submissionArtifact.instructionPC 3928 = 5241 := by rfl
@[simp] theorem earlyExtraPC3927 : Artifact.submissionArtifact.instructionPC 3929 = 5242 := by rfl
@[simp] theorem earlyExtraPC3928 : Artifact.submissionArtifact.instructionPC 3930 = 5243 := by rfl
