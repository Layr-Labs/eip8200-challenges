...
def csGenericPath : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3819 .JUMPDEST,
   ...
   pushAt 3834 2 2752,
   opAt 3835 .MLOAD,
   opAt 3836 (.Dup ⟨0, by decide⟩),
   pushAt 3837 2 1792,
   opAt 3838 .ADD,
   opAt 3839 (.Swap ⟨0, by decide⟩),
   pushAt 3840 0 0,
...
def csFixedStep8_4 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [
   ...
   opAt 3916 .GT,
   opAt 3917 (.Swap ⟨1, by decide⟩),
   opAt 3918 .SUB,
   opAt 3919 (.Dup ⟨2, by decide⟩),
   opAt 3920 (.Dup ⟨1, by decide⟩),
   opAt 3921 .SUB,
   opAt 3922 (.Swap ⟨2, by decide⟩),
   opAt 3923 .GT,
   opAt 3924 .OR,
   opAt 3925 (.Swap ⟨0, by decide⟩),
   pushAt 3926 2 1888,
   opAt 3927 .MSTORE]
...
@[simp] theorem fixedPC1618 : Artifact.submissionArtifact.instructionPC 1543 = 2108 := by rfl

@[simp] theorem fixedPC1619 : Artifact.submissionArtifact.instructionPC 1544 = 2111 := by
  calc
    Artifact.submissionArtifact.instructionPC 1544 =
        Artifact.submissionArtifact.instructionPC 1543 + (YulEvmCompiler.Instr.push 2 4877).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 1543 _ (by rfl)
    _ = 2111 := by rw [fixedPC1618]; rfl

@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3819 = 5032 := by rfl

@[simp] theorem fixedJump4975 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5032 = true := by
  simpa only [Artifact.instructionPC, fixedPC3777] using Artifact.isValidJumpDest_index 3819 (by rfl)

@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3820 = 5033 := by
  calc
    Artifact.submissionArtifact.instructionPC 3820 =
        Artifact.submissionArtifact.instructionPC 3819 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3819 _ (by rfl)
    _ = 5033 := by rw [fixedPC3777]; rfl

@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3821 = 5036 := by
  calc
    Artifact.submissionArtifact.instructionPC 3821 =
        Artifact.submissionArtifact.instructionPC 3820 + (YulEvmCompiler.Instr.push 2 2688).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3820 _ (by rfl)
    _ = 5036 := by rw [fixedPC3778]; rfl

@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3822 = 5037 := by
  calc
...
@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3823 = 5040 := by
  calc
    Artifact.submissionArtifact.instructionPC 3823 =
        Artifact.submissionArtifact.instructionPC 3822 + (YulEvmCompiler.Instr.push 2 256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3822 _ (by rfl)
    _ = 5040 := by rw [fixedPC3780]; rfl

@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3824 = 5041 := by
  calc
    Artifact.submissionArtifact.instructionPC 3824 =
        Artifact.submissionArtifact.instructionPC 3823 + (YulEvmCompiler.Instr.op .EQ).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3823 _ (by rfl)
    _ = 5041 := by rw [fixedPC3781]; rfl

@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3825 = 5044 := by
  calc
    Artifact.submissionArtifact.instructionPC 3825 =
        Artifact.submissionArtifact.instructionPC 3824 + (YulEvmCompiler.Instr.push 2 5076).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3824 _ (by rfl)
    _ = 5044 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3826 = 5045 := by
  calc
    Artifact.submissionArtifact.instructionPC 3826 =
        Artifact.submissionArtifact.instructionPC 3825 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3825 _ (by rfl)
    _ = 5045 := by rw [fixedPC3783]; rfl

@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3827 = 5048 := by
  calc
    Artifact.submissionArtifact.instructionPC 3827 =
        Artifact.submissionArtifact.instructionPC 3826 + (YulEvmCompiler.Instr.push 2 2688).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3826 _ (by rfl)
    _ = 5048 := by rw [fixedPC3784]; rfl

@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3828 = 5049 := by
  calc
    Artifact.submissionArtifact.instructionPC 3828 =
        Artifact.submissionArtifact.instructionPC 3827 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3827 _ (by rfl)
    _ = 5049 := by rw [fixedPC3785]; rfl

@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3829 = 5051 := by
  calc
    Artifact.submissionArtifact.instructionPC 3829 =
        Artifact.submissionArtifact.instructionPC 3828 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3828 _ (by rfl)
    _ = 5051 := by rw [fixedPC3786]; rfl

@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3830 = 5052 := by
  calc
    Artifact.submissionArtifact.instructionPC 3830 =
        Artifact.submissionArtifact.instructionPC 3829 + (YulEvmCompiler.Instr.op .EQ).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3829 _ (by rfl)
    _ = 5052 := by rw [fixedPC3787]; rfl

@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3831 = 5055 := by
  calc
    Artifact.submissionArtifact.instructionPC 3831 =
        Artifact.submissionArtifact.instructionPC 3830 + (YulEvmCompiler.Instr.push 2 4898).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3830 _ (by rfl)
    _ = 5055 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3832 = 5056 := by
  calc
    Artifact.submissionArtifact.instructionPC 3832 =
        Artifact.submissionArtifact.instructionPC 3831 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3831 _ (by rfl)
    _ = 5056 := by rw [fixedPC3789]; rfl

@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3833 = 5059 := by
  calc
    Artifact.submissionArtifact.instructionPC 3833 =
        Artifact.submissionArtifact.instructionPC 3832 + (YulEvmCompiler.Instr.push 2 2784).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3832 _ (by rfl)
    _ = 5059 := by rw [fixedPC3790]; rfl

@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3834 = 5060 := by
  calc
...
@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3835 = 5063 := by
  calc
    Artifact.submissionArtifact.instructionPC 3835 =
        Artifact.submissionArtifact.instructionPC 3834 + (YulEvmCompiler.Instr.push 2 2752).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3834 _ (by rfl)
    _ = 5063 := by rw [fixedPC3792]; rfl

@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3836 = 5064 := by
  calc
...
@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3837 = 5065 := by
  calc
    Artifact.submissionArtifact.instructionPC 3837 =
        Artifact.submissionArtifact.instructionPC 3836 + (YulEvmCompiler.Instr.op (.Dup ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3836 _ (by rfl)
    _ = 5065 := by rw [fixedPC3794]; rfl

@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3838 = 5068 := by
  calc
    Artifact.submissionArtifact.instructionPC 3838 =
        Artifact.submissionArtifact.instructionPC 3837 + (YulEvmCompiler.Instr.push 2 1792).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3837 _ (by rfl)
    _ = 5068 := by rw [fixedPC3795]; rfl

@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3839 = 5069 := by
  calc
    Artifact.submissionArtifact.instructionPC 3839 =
        Artifact.submissionArtifact.instructionPC 3838 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3838 _ (by rfl)
    _ = 5069 := by rw [fixedPC3796]; rfl

@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3839 = 5069 := fixedPC3797

@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3839 = 5069 := fixedPC3797

@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3840 = 5070 := by
  calc
    Artifact.submissionArtifact.instructionPC 3840 =
        Artifact.submissionArtifact.instructionPC 3839 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3839 _ (by rfl)
    _ = 5070 := by rw [fixedPC3799]; rfl

@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3841 = 5071 := by
  calc
    Artifact.submissionArtifact.instructionPC 3841 =
        Artifact.submissionArtifact.instructionPC 3840 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3840 _ (by rfl)
    _ = 5071 := by rw [fixedPC3800]; rfl

@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3842 = 5072 := by
  calc
...
@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3843 = 5075 := by
  calc
    Artifact.submissionArtifact.instructionPC 3843 =
        Artifact.submissionArtifact.instructionPC 3842 + (YulEvmCompiler.Instr.push 2 2112).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3842 _ (by rfl)
    _ = 5075 := by rw [fixedPC3802]; rfl

@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3844 = 5076 := by
  calc
    Artifact.submissionArtifact.instructionPC 3844 =
        Artifact.submissionArtifact.instructionPC 3843 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5023 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5076 = true := by
  simpa only [Artifact.instructionPC, fixedPC3804] using Artifact.isValidJumpDest_index 3844 (by rfl)

@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3845 = 5077 := by
  calc
    Artifact.submissionArtifact.instructionPC 3845 =
        Artifact.submissionArtifact.instructionPC 3844 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3844 _ (by rfl)
    _ = 5077 := by rw [fixedPC3804]; rfl

@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3846 = 5080 := by
  calc
    Artifact.submissionArtifact.instructionPC 3846 =
        Artifact.submissionArtifact.instructionPC 3845 + (YulEvmCompiler.Instr.push 2 2336).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3845 _ (by rfl)
    _ = 5080 := by rw [fixedPC3805]; rfl

@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3847 = 5081 := by
  calc
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3848 = 5083 := by
  calc
    Artifact.submissionArtifact.instructionPC 3848 =
        Artifact.submissionArtifact.instructionPC 3847 + (YulEvmCompiler.Instr.push 1 224).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3847 _ (by rfl)
    _ = 5083 := by rw [fixedPC3807]; rfl

@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3849 = 5084 := by
  calc
...
@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3850 = 5085 := by
  calc
...
@[simp] theorem fixedPC3811 : Artifact.submissionArtifact.instructionPC 3851 = 5086 := by
  calc
...
@[simp] theorem fixedPC3812 : Artifact.submissionArtifact.instructionPC 3852 = 5087 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3853 = 5088 := by
  calc
    Artifact.submissionArtifact.instructionPC 3853 =
        Artifact.submissionArtifact.instructionPC 3852 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3852 _ (by rfl)
    _ = 5088 := by rw [fixedPC3812]; rfl

@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3854 = 5089 := by
  calc
...
@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3855 = 5092 := by
  calc
    Artifact.submissionArtifact.instructionPC 3855 =
        Artifact.submissionArtifact.instructionPC 3854 + (YulEvmCompiler.Instr.push 2 2016).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3854 _ (by rfl)
    _ = 5092 := by rw [fixedPC3814]; rfl

@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3856 = 5093 := by
  calc
...
@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3857 = 5096 := by
  calc
    Artifact.submissionArtifact.instructionPC 3857 =
        Artifact.submissionArtifact.instructionPC 3856 + (YulEvmCompiler.Instr.push 2 2304).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3856 _ (by rfl)
    _ = 5096 := by rw [fixedPC3816]; rfl

@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3858 = 5097 := by
  calc
...
@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3859 = 5099 := by
  calc
    Artifact.submissionArtifact.instructionPC 3859 =
        Artifact.submissionArtifact.instructionPC 3858 + (YulEvmCompiler.Instr.push 1 192).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3858 _ (by rfl)
    _ = 5099 := by rw [fixedPC3818]; rfl

@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3860 = 5100 := by
  calc
...
@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3861 = 5101 := by
  calc
...
@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3862 = 5102 := by
  calc
...
@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3863 = 5103 := by
  calc
...
@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3864 = 5104 := by
  calc
...
@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3865 = 5105 := by
  calc
...
@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3866 = 5106 := by
  calc
...
@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3867 = 5107 := by
  calc
...
@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3868 = 5108 := by
  calc
...
@[simp] theorem fixedPC3829 : Artifact.submissionArtifact.instructionPC 3869 = 5109 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3870 = 5110 := by
  calc
...
@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3871 = 5111 := by
  calc
...
@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3872 = 5112 := by
  calc
...
@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3873 = 5115 := by
  calc
    Artifact.submissionArtifact.instructionPC 3873 =
        Artifact.submissionArtifact.instructionPC 3872 + (YulEvmCompiler.Instr.push 2 1984).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3872 _ (by rfl)
    _ = 5115 := by rw [fixedPC3832]; rfl

@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3874 = 5116 := by
  calc
...
@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3875 = 5119 := by
  calc
    Artifact.submissionArtifact.instructionPC 3875 =
        Artifact.submissionArtifact.instructionPC 3874 + (YulEvmCompiler.Instr.push 2 2272).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3874 _ (by rfl)
    _ = 5119 := by rw [fixedPC3834]; rfl

@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3876 = 5120 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3877 = 5122 := by
  calc
    Artifact.submissionArtifact.instructionPC 3877 =
        Artifact.submissionArtifact.instructionPC 3876 + (YulEvmCompiler.Instr.push 1 160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3876 _ (by rfl)
    _ = 5122 := by rw [fixedPC3836]; rfl

@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3878 = 5123 := by
  calc
...
@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3879 = 5124 := by
  calc
...
@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3880 = 5125 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3881 = 5126 := by
  calc
...
@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3882 = 5127 := by
  calc
...
@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3883 = 5128 := by
  calc
...
@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3884 = 5129 := by
  calc
...
@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3885 = 5130 := by
  calc
...
@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3886 = 5131 := by
  calc
...
@[simp] theorem fixedPC3847 : Artifact.submissionArtifact.instructionPC 3887 = 5132 := by
  calc
...
@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3888 = 5133 := by
  calc
...
@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3889 = 5134 := by
  calc
...
@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3890 = 5135 := by
  calc
...
@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3891 = 5138 := by
  calc
    Artifact.submissionArtifact.instructionPC 3891 =
        Artifact.submissionArtifact.instructionPC 3890 + (YulEvmCompiler.Instr.push 2 1952).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3890 _ (by rfl)
    _ = 5138 := by rw [fixedPC3850]; rfl

@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3892 = 5139 := by
  calc
...
@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3893 = 5142 := by
  calc
    Artifact.submissionArtifact.instructionPC 3893 =
        Artifact.submissionArtifact.instructionPC 3892 + (YulEvmCompiler.Instr.push 2 2240).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3892 _ (by rfl)
    _ = 5142 := by rw [fixedPC3852]; rfl

@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3894 = 5143 := by
  calc
...
@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3895 = 5145 := by
  calc
    Artifact.submissionArtifact.instructionPC 3895 =
        Artifact.submissionArtifact.instructionPC 3894 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3894 _ (by rfl)
    _ = 5145 := by rw [fixedPC3854]; rfl

@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3896 = 5146 := by
  calc
...
@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3897 = 5147 := by
  calc
...
@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3898 = 5148 := by
  calc
...
@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3899 = 5149 := by
  calc
    Artifact.submissionArtifact.instructionPC 3899 =
        Artifact.submissionArtifact.instructionPC 3898 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3898 _ (by rfl)
    _ = 5149 := by rw [fixedPC3858]; rfl

@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3900 = 5150 := by
  calc
    Artifact.submissionArtifact.instructionPC 3900 =
        Artifact.submissionArtifact.instructionPC 3899 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3899 _ (by rfl)
    _ = 5150 := by rw [fixedPC3859]; rfl

@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3901 = 5151 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3902 = 5152 := by
  calc
    Artifact.submissionArtifact.instructionPC 3902 =
        Artifact.submissionArtifact.instructionPC 3901 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3901 _ (by rfl)
    _ = 5152 := by rw [fixedPC3861]; rfl

@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3903 = 5153 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3904 = 5154 := by
  calc
...
@[simp] theorem fixedPC3865 : Artifact.submissionArtifact.instructionPC 3905 = 5155 := by
  calc
    Artifact.submissionArtifact.instructionPC 3905 =
        Artifact.submissionArtifact.instructionPC 3904 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3904 _ (by rfl)
    _ = 5155 := by rw [fixedPC3864]; rfl

@[simp] theorem fixedPC3866 : Artifact.submissionArtifact.instructionPC 3906 = 5156 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3907 = 5157 := by
  calc
    Artifact.submissionArtifact.instructionPC 3907 =
        Artifact.submissionArtifact.instructionPC 3906 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3906 _ (by rfl)
    _ = 5157 := by rw [fixedPC3866]; rfl

@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3908 = 5158 := by
  calc
    Artifact.submissionArtifact.instructionPC 3908 =
        Artifact.submissionArtifact.instructionPC 3907 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3907 _ (by rfl)
    _ = 5158 := by rw [fixedPC3867]; rfl

@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3909 = 5161 := by
  calc
    Artifact.submissionArtifact.instructionPC 3909 =
        Artifact.submissionArtifact.instructionPC 3908 + (YulEvmCompiler.Instr.push 2 1920).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3908 _ (by rfl)
    _ = 5161 := by rw [fixedPC3868]; rfl

@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3910 = 5162 := by
  calc
    Artifact.submissionArtifact.instructionPC 3910 =
        Artifact.submissionArtifact.instructionPC 3909 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3909 _ (by rfl)
    _ = 5162 := by rw [fixedPC3869]; rfl

@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3911 = 5165 := by
  calc
    Artifact.submissionArtifact.instructionPC 3911 =
        Artifact.submissionArtifact.instructionPC 3910 + (YulEvmCompiler.Instr.push 2 2208).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3910 _ (by rfl)
    _ = 5165 := by rw [fixedPC3871]; rfl

@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3912 = 5166 := by
  calc
    Artifact.submissionArtifact.instructionPC 3912 =
        Artifact.submissionArtifact.instructionPC 3911 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3911 _ (by rfl)
    _ = 5166 := by rw [fixedPC3872]; rfl

@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3913 = 5168 := by
  calc
...
@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3914 = 5169 := by
  calc
...
@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3915 = 5170 := by
  calc
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3916 = 5171 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3917 = 5172 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3918 = 5173 := by
  calc
    Artifact.submissionArtifact.instructionPC 3918 =
        Artifact.submissionArtifact.instructionPC 3917 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3917 _ (by rfl)
    _ = 5173 := by rw [fixedPC3878]; rfl

@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3919 = 5174 := by
  calc
    Artifact.submissionArtifact.instructionPC 3919 =
        Artifact.submissionArtifact.instructionPC 3918 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3918 _ (by rfl)
    _ = 5174 := by rw [fixedPC3879]; rfl

@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3920 = 5175 := by
  calc
...
@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3921 = 5176 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3922 = 5177 := by
  calc
    Artifact.submissionArtifact.instructionPC 3922 =
        Artifact.submissionArtifact.instructionPC 3921 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3921 _ (by rfl)
    _ = 5177 := by rw [fixedPC3882]; rfl

@[simp] theorem fixedPC3884 : Artifact.submissionArtifact.instructionPC 3923 = 5178 := by
  calc
    Artifact.submissionArtifact.instructionPC 3923 =
        Artifact.submissionArtifact.instructionPC 3922 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3922 _ (by rfl)
    _ = 5178 := by rw [fixedPC3883]; rfl

@[simp] theorem fixedPC3885 : Artifact.submissionArtifact.instructionPC 3924 = 5179 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3925 = 5180 := by
  calc
...
@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3926 = 5181 := by
  calc
    Artifact.submissionArtifact.instructionPC 3926 =
        Artifact.submissionArtifact.instructionPC 3925 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3925 _ (by rfl)
    _ = 5181 := by rw [fixedPC3886]; rfl

@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3927 = 5184 := by
  calc
    Artifact.submissionArtifact.instructionPC 3927 =
        Artifact.submissionArtifact.instructionPC 3926 + (YulEvmCompiler.Instr.push 2 1888).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3926 _ (by rfl)
    _ = 5184 := by rw [fixedPC3887]; rfl

@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3928 = 5185 := by
  calc
    Artifact.submissionArtifact.instructionPC 3928 =
        Artifact.submissionArtifact.instructionPC 3927 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
...
@[simp] theorem fixedJump5133 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5185 = true := by
  simpa only [Artifact.instructionPC, fixedPC3889] using Artifact.isValidJumpDest_index 3928 (by rfl)

@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3929 = 5186 := by
  calc
    Artifact.submissionArtifact.instructionPC 3929 =
        Artifact.submissionArtifact.instructionPC 3928 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3928 _ (by rfl)
    _ = 5186 := by rw [fixedPC3889]; rfl

@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3930 = 5189 := by
  calc
    Artifact.submissionArtifact.instructionPC 3930 =
        Artifact.submissionArtifact.instructionPC 3929 + (YulEvmCompiler.Instr.push 2 2176).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3929 _ (by rfl)
    _ = 5189 := by rw [fixedPC3890]; rfl

@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3931 = 5190 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3932 = 5192 := by
  calc
    Artifact.submissionArtifact.instructionPC 3932 =
        Artifact.submissionArtifact.instructionPC 3931 + (YulEvmCompiler.Instr.push 1 64).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3931 _ (by rfl)
    _ = 5192 := by rw [fixedPC3892]; rfl

@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3933 = 5193 := by
  calc
...
@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3934 = 5194 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3935 = 5195 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3936 = 5196 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3937 = 5197 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3938 = 5198 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3939 = 5199 := by
  calc
...
@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3940 = 5200 := by
  calc
...
@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3941 = 5201 := by
  calc
...
@[simp] theorem fixedPC3903 : Artifact.submissionArtifact.instructionPC 3942 = 5202 := by
  calc
...
@[simp] theorem fixedPC3904 : Artifact.submissionArtifact.instructionPC 3943 = 5203 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3944 = 5204 := by
  calc
...
@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3945 = 5205 := by
  calc
...
@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3946 = 5208 := by
  calc
    Artifact.submissionArtifact.instructionPC 3946 =
        Artifact.submissionArtifact.instructionPC 3945 + (YulEvmCompiler.Instr.push 2 1856).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3945 _ (by rfl)
    _ = 5208 := by rw [fixedPC3906]; rfl

@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3947 = 5209 := by
  calc
...
@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3948 = 5212 := by
  calc
    Artifact.submissionArtifact.instructionPC 3948 =
        Artifact.submissionArtifact.instructionPC 3947 + (YulEvmCompiler.Instr.push 2 2144).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3947 _ (by rfl)
    _ = 5212 := by rw [fixedPC3908]; rfl

@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3949 = 5213 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3950 = 5215 := by
  calc
    Artifact.submissionArtifact.instructionPC 3950 =
        Artifact.submissionArtifact.instructionPC 3949 + (YulEvmCompiler.Instr.push 1 32).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3949 _ (by rfl)
    _ = 5215 := by rw [fixedPC3910]; rfl

@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3951 = 5216 := by
  calc
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3952 = 5217 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3953 = 5218 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3954 = 5219 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3955 = 5220 := by
  calc
...
@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3956 = 5221 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3957 = 5222 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3958 = 5223 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3959 = 5224 := by
  calc
...
@[simp] theorem fixedPC3921 : Artifact.submissionArtifact.instructionPC 3960 = 5225 := by
  calc
...
@[simp] theorem fixedPC3922 : Artifact.submissionArtifact.instructionPC 3961 = 5226 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3962 = 5227 := by
  calc
...
@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3963 = 5228 := by
  calc
...
@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3964 = 5231 := by
  calc
    Artifact.submissionArtifact.instructionPC 3964 =
        Artifact.submissionArtifact.instructionPC 3963 + (YulEvmCompiler.Instr.push 2 1824).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3963 _ (by rfl)
    _ = 5231 := by rw [fixedPC3924]; rfl

@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3965 = 5232 := by
  calc
...
@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3966 = 5235 := by
  calc
    Artifact.submissionArtifact.instructionPC 3966 =
        Artifact.submissionArtifact.instructionPC 3965 + (YulEvmCompiler.Instr.push 2 2112).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3965 _ (by rfl)
    _ = 5235 := by rw [fixedPC3926]; rfl

@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3967 = 5236 := by
  calc
...
@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3968 = 5237 := by
  calc
    Artifact.submissionArtifact.instructionPC 3968 =
        Artifact.submissionArtifact.instructionPC 3967 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3967 _ (by rfl)
    _ = 5237 := by rw [fixedPC3928]; rfl

@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3969 = 5238 := by
  calc
...
@[simp] theorem fixedPC3931 : Artifact.submissionArtifact.instructionPC 3970 = 5239 := by
  calc
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3971 = 5240 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3972 = 5241 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3973 = 5242 := by
  calc
...
@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3974 = 5243 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3975 = 5244 := by
  calc
...
@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3976 = 5245 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3977 = 5246 := by
  calc
...
@[simp] theorem fixedPC3939 : Artifact.submissionArtifact.instructionPC 3978 = 5247 := by
  calc
...
@[simp] theorem fixedPC3940 : Artifact.submissionArtifact.instructionPC 3979 = 5248 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3980 = 5249 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3981 = 5250 := by
  calc
...
@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3982 = 5253 := by
  calc
    Artifact.submissionArtifact.instructionPC 3982 =
        Artifact.submissionArtifact.instructionPC 3981 + (YulEvmCompiler.Instr.push 2 1792).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3981 _ (by rfl)
    _ = 5253 := by rw [fixedPC3942]; rfl

@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3983 = 5254 := by
  calc
...
@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3984 = 5255 := by
  calc
    Artifact.submissionArtifact.instructionPC 3984 =
        Artifact.submissionArtifact.instructionPC 3983 + (YulEvmCompiler.Instr.op .ISZERO).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3983 _ (by rfl)
    _ = 5255 := by rw [fixedPC3944]; rfl

@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3985 = 5258 := by
  calc
    Artifact.submissionArtifact.instructionPC 3985 =
        Artifact.submissionArtifact.instructionPC 3984 + (YulEvmCompiler.Instr.push 2 2080).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3984 _ (by rfl)
    _ = 5258 := by rw [fixedPC3945]; rfl

@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3986 = 5259 := by
  calc
...
@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3987 = 5260 := by
  calc
...
@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3999 = 5280 := by
  decide

@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3999 = 5280 :=
  fixedPC3949

@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 4000 = 5281 := by
  calc
    Artifact.submissionArtifact.instructionPC 4000 =
        Artifact.submissionArtifact.instructionPC 3999 + (YulEvmCompiler.Instr.op .MUL).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3999 _ (by rfl)
    _ = 5281 := by rw [fixedPC3950]; rfl

@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 4001 = 5284 := by
  calc
    Artifact.submissionArtifact.instructionPC 4001 =
        Artifact.submissionArtifact.instructionPC 4000 + (YulEvmCompiler.Instr.push 2 2112).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4000 _ (by rfl)
    _ = 5284 := by rw [fixedPC3951]; rfl

@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 4002 = 5285 := by
  calc
    Artifact.submissionArtifact.instructionPC 4002 =
        Artifact.submissionArtifact.instructionPC 4001 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4001 _ (by rfl)
    _ = 5285 := by rw [fixedPC3952]; rfl

@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 4003 = 5288 := by
  calc
    Artifact.submissionArtifact.instructionPC 4003 =
        Artifact.submissionArtifact.instructionPC 4002 + (YulEvmCompiler.Instr.push 2 2688).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4002 _ (by rfl)
    _ = 5288 := by rw [fixedPC3953]; rfl

@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 4004 = 5289 := by
  calc
...
@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 4005 = 5290 := by
  calc
    Artifact.submissionArtifact.instructionPC 4005 =
        Artifact.submissionArtifact.instructionPC 4004 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4004 _ (by rfl)
    _ = 5290 := by rw [fixedPC3955]; rfl

@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 4006 = 5291 := by
  calc
    Artifact.submissionArtifact.instructionPC 4006 =
        Artifact.submissionArtifact.instructionPC 4005 + (YulEvmCompiler.Instr.op .MCOPY).bytes.length :=
...
@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3720 = 4898 := by
  decide

@[simp] theorem fixedJump5280 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4898 = true := by
  simpa only [Artifact.instructionPC, fixedPC3999] using Artifact.isValidJumpDest_index 3720 (by rfl)

@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 3721 = 4899 := by
  calc
...
@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 3722 = 4902 := by
  calc
    Artifact.submissionArtifact.instructionPC 3722 =
        Artifact.submissionArtifact.instructionPC 3721 + (YulEvmCompiler.Instr.push 2 2208).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3721 _ (by rfl)
    _ = 4902 := by rw [fixedPC4000]; rfl

@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 3723 = 4903 := by
  calc
...
@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 3724 = 4905 := by
  calc
    Artifact.submissionArtifact.instructionPC 3724 =
        Artifact.submissionArtifact.instructionPC 3723 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3723 _ (by rfl)
    _ = 4905 := by rw [fixedPC4002]; rfl

@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 3725 = 4906 := by
  calc
...
@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 3726 = 4907 := by
  calc
...
@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 3727 = 4908 := by
  calc
...
@[simp] theorem fixedPC4007 : Artifact.submissionArtifact.instructionPC 3728 = 4909 := by
  calc
...
@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 3729 = 4910 := by
  calc
...
@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 3730 = 4911 := by
  calc
...
@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 3731 = 4914 := by
  calc
    Artifact.submissionArtifact.instructionPC 3731 =
        Artifact.submissionArtifact.instructionPC 3730 + (YulEvmCompiler.Instr.push 2 1888).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3730 _ (by rfl)
    _ = 4914 := by rw [fixedPC4009]; rfl

@[simp] theorem fixedPC4011 : Artifact.submissionArtifact.instructionPC 3732 = 4915 := by
  calc
...
@[simp] theorem fixedPC4012 : Artifact.submissionArtifact.instructionPC 3733 = 4918 := by
  calc
    Artifact.submissionArtifact.instructionPC 3733 =
        Artifact.submissionArtifact.instructionPC 3732 + (YulEvmCompiler.Instr.push 2 5185).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3732 _ (by rfl)
    _ = 4918 := by rw [fixedPC4011]; rfl


@[simp] theorem earlyExtraPC2880 : Artifact.submissionArtifact.instructionPC 2918 = 3877 := by rfl
@[simp] theorem earlyExtraPC2883 : Artifact.submissionArtifact.instructionPC 3707 = 4877 := by rfl
@[simp] theorem earlyExtraPC2884 : Artifact.submissionArtifact.instructionPC 3708 = 4878 := by rfl
@[simp] theorem earlyExtraPC2885 : Artifact.submissionArtifact.instructionPC 3709 = 4879 := by rfl
@[simp] theorem earlyExtraPC2886 : Artifact.submissionArtifact.instructionPC 3710 = 4880 := by rfl
@[simp] theorem earlyExtraPC2887 : Artifact.submissionArtifact.instructionPC 3711 = 4883 := by rfl
@[simp] theorem earlyExtraPC2888 : Artifact.submissionArtifact.instructionPC 3712 = 4884 := by rfl
@[simp] theorem earlyExtraPC2889 : Artifact.submissionArtifact.instructionPC 3713 = 4885 := by rfl
@[simp] theorem earlyExtraPC2890 : Artifact.submissionArtifact.instructionPC 3714 = 4888 := by rfl
@[simp] theorem earlyExtraPC2891 : Artifact.submissionArtifact.instructionPC 3715 = 4889 := by rfl
@[simp] theorem earlyExtraPC2892 : Artifact.submissionArtifact.instructionPC 3716 = 4890 := by rfl
@[simp] theorem earlyExtraPC2893 : Artifact.submissionArtifact.instructionPC 3716 = 4890 := by rfl
@[simp] theorem earlyExtraPC2894 : Artifact.submissionArtifact.instructionPC 3717 = 4893 := by rfl
@[simp] theorem earlyExtraPC2895 : Artifact.submissionArtifact.instructionPC 3718 = 4894 := by rfl
@[simp] theorem earlyExtraPC2896 : Artifact.submissionArtifact.instructionPC 3719 = 4897 := by rfl
@[simp] theorem earlyExtraPC2927 : Artifact.submissionArtifact.instructionPC 2918 = 3877 := by rfl
@[simp] theorem earlyExtraPC2930 : Artifact.submissionArtifact.instructionPC 3720 = 4898 := by rfl
@[simp] theorem earlyExtraPC2931 : Artifact.submissionArtifact.instructionPC 3721 = 4899 := by rfl
@[simp] theorem earlyExtraPC2932 : Artifact.submissionArtifact.instructionPC 3722 = 4902 := by rfl
@[simp] theorem earlyExtraPC2933 : Artifact.submissionArtifact.instructionPC 3723 = 4903 := by rfl
@[simp] theorem earlyExtraPC2934 : Artifact.submissionArtifact.instructionPC 3724 = 4905 := by rfl
@[simp] theorem earlyExtraPC2935 : Artifact.submissionArtifact.instructionPC 3725 = 4906 := by rfl
@[simp] theorem earlyExtraPC2936 : Artifact.submissionArtifact.instructionPC 3726 = 4907 := by rfl
@[simp] theorem earlyExtraPC2937 : Artifact.submissionArtifact.instructionPC 3727 = 4908 := by rfl
@[simp] theorem earlyExtraPC2938 : Artifact.submissionArtifact.instructionPC 3728 = 4909 := by rfl
@[simp] theorem earlyExtraPC2939 : Artifact.submissionArtifact.instructionPC 3729 = 4910 := by rfl
@[simp] theorem earlyExtraPC2940 : Artifact.submissionArtifact.instructionPC 3730 = 4911 := by rfl
@[simp] theorem earlyExtraPC2941 : Artifact.submissionArtifact.instructionPC 3731 = 4914 := by rfl
@[simp] theorem earlyExtraPC2942 : Artifact.submissionArtifact.instructionPC 3732 = 4915 := by rfl
@[simp] theorem earlyExtraPC2943 : Artifact.submissionArtifact.instructionPC 3733 = 4918 := by rfl
@[simp] theorem earlyExtraPC3918 : Artifact.submissionArtifact.instructionPC 3988 = 5263 := by rfl
@[simp] theorem earlyExtraPC3919 : Artifact.submissionArtifact.instructionPC 3989 = 5264 := by rfl
@[simp] theorem earlyExtraPC3920 : Artifact.submissionArtifact.instructionPC 3990 = 5267 := by rfl
@[simp] theorem earlyExtraPC3921 : Artifact.submissionArtifact.instructionPC 3991 = 5268 := by rfl
@[simp] theorem earlyExtraPC3922 : Artifact.submissionArtifact.instructionPC 3992 = 5269 := by rfl
@[simp] theorem earlyExtraPC3923 : Artifact.submissionArtifact.instructionPC 3993 = 5272 := by rfl
@[simp] theorem earlyExtraPC3924 : Artifact.submissionArtifact.instructionPC 3994 = 5275 := by rfl
@[simp] theorem earlyExtraPC3925 : Artifact.submissionArtifact.instructionPC 3995 = 5276 := by rfl
@[simp] theorem earlyExtraPC3926 : Artifact.submissionArtifact.instructionPC 3996 = 5277 := by rfl
@[simp] theorem earlyExtraPC3927 : Artifact.submissionArtifact.instructionPC 3997 = 5278 := by rfl
@[simp] theorem earlyExtraPC3928 : Artifact.submissionArtifact.instructionPC 3998 = 5279 := by rfl
