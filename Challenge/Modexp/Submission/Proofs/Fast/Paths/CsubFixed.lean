...
def csGenericPath : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3764 .JUMPDEST,
   ...
   pushAt 3779 2 5312,
   opAt 3780 .MLOAD,
   opAt 3781 (.Dup ⟨0, by decide⟩),
   pushAt 3782 2 3072,
   opAt 3783 .ADD,
   pushAt 3784 2 4160,
   opAt 3785 .POP,
   opAt 3786 (.Swap ⟨0, by decide⟩),
   pushAt 3787 0 0,
...
def csFixedStep8_5 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3875 .JUMPDEST,
   ...
   opAt 3884 .SUB,
   opAt 3885 (.Dup ⟨2, by decide⟩),
   opAt 3886 (.Dup ⟨1, by decide⟩),
   opAt 3887 .SUB,
   opAt 3888 (.Swap ⟨2, by decide⟩),
   opAt 3889 .GT,
   opAt 3890 .OR,
   opAt 3891 (.Swap ⟨0, by decide⟩),
   pushAt 3892 2 3136,
   opAt 3893 .MSTORE]
...
def csFixedStep8_6 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3894 2 4192,
   ...
   opAt 3900 .GT,
   opAt 3901 (.Swap ⟨1, by decide⟩),
   opAt 3902 .SUB,
   opAt 3903 (.Dup ⟨2, by decide⟩),
   opAt 3904 (.Dup ⟨1, by decide⟩),
   opAt 3905 .SUB,
   opAt 3906 (.Swap ⟨2, by decide⟩),
   opAt 3907 .GT,
   opAt 3908 .OR,
   opAt 3909 (.Swap ⟨0, by decide⟩),
   pushAt 3910 2 3104,
   opAt 3911 .MSTORE]
...
@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3764 = 4976 := by rfl

@[simp] theorem fixedJump4975 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4976 = true := by
  simpa only [Artifact.instructionPC, fixedPC3777] using Artifact.isValidJumpDest_index 3764 (by rfl)

@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3765 = 4977 := by
  calc
    Artifact.submissionArtifact.instructionPC 3765 =
        Artifact.submissionArtifact.instructionPC 3764 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3764 _ (by rfl)
    _ = 4977 := by rw [fixedPC3777]; rfl

@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3766 = 4980 := by
  calc
    Artifact.submissionArtifact.instructionPC 3766 =
        Artifact.submissionArtifact.instructionPC 3765 + (YulEvmCompiler.Instr.push 2 5248).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3765 _ (by rfl)
    _ = 4980 := by rw [fixedPC3778]; rfl

@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3767 = 4981 := by
  calc
    Artifact.submissionArtifact.instructionPC 3767 =
        Artifact.submissionArtifact.instructionPC 3766 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3766 _ (by rfl)
    _ = 4981 := by rw [fixedPC3779]; rfl

@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3768 = 4984 := by
  calc
    Artifact.submissionArtifact.instructionPC 3768 =
        Artifact.submissionArtifact.instructionPC 3767 + (YulEvmCompiler.Instr.push 2 256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3767 _ (by rfl)
    _ = 4984 := by rw [fixedPC3780]; rfl

@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3769 = 4985 := by
  calc
    Artifact.submissionArtifact.instructionPC 3769 =
        Artifact.submissionArtifact.instructionPC 3768 + (YulEvmCompiler.Instr.op .EQ).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3768 _ (by rfl)
    _ = 4985 := by rw [fixedPC3781]; rfl

@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3770 = 4988 := by
  calc
    Artifact.submissionArtifact.instructionPC 3770 =
        Artifact.submissionArtifact.instructionPC 3769 + (YulEvmCompiler.Instr.push 2 5024).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3769 _ (by rfl)
    _ = 4988 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3771 = 4989 := by
  calc
    Artifact.submissionArtifact.instructionPC 3771 =
        Artifact.submissionArtifact.instructionPC 3770 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3770 _ (by rfl)
    _ = 4989 := by rw [fixedPC3783]; rfl

@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3772 = 4992 := by
  calc
    Artifact.submissionArtifact.instructionPC 3772 =
        Artifact.submissionArtifact.instructionPC 3771 + (YulEvmCompiler.Instr.push 2 5248).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3771 _ (by rfl)
    _ = 4992 := by rw [fixedPC3784]; rfl

@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3773 = 4993 := by
  calc
...
@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3774 = 4995 := by
  calc
    Artifact.submissionArtifact.instructionPC 3774 =
        Artifact.submissionArtifact.instructionPC 3773 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3773 _ (by rfl)
    _ = 4995 := by rw [fixedPC3786]; rfl

@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3775 = 4996 := by
  calc
    Artifact.submissionArtifact.instructionPC 3775 =
        Artifact.submissionArtifact.instructionPC 3774 + (YulEvmCompiler.Instr.op .EQ).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3774 _ (by rfl)
    _ = 4996 := by rw [fixedPC3787]; rfl

@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3776 = 4999 := by
  calc
    Artifact.submissionArtifact.instructionPC 3776 =
        Artifact.submissionArtifact.instructionPC 3775 + (YulEvmCompiler.Instr.push 2 4826).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3775 _ (by rfl)
    _ = 4999 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3777 = 5000 := by
  calc
    Artifact.submissionArtifact.instructionPC 3777 =
        Artifact.submissionArtifact.instructionPC 3776 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3776 _ (by rfl)
    _ = 5000 := by rw [fixedPC3789]; rfl

@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3778 = 5003 := by
  calc
    Artifact.submissionArtifact.instructionPC 3778 =
        Artifact.submissionArtifact.instructionPC 3777 + (YulEvmCompiler.Instr.push 2 5344).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3777 _ (by rfl)
    _ = 5003 := by rw [fixedPC3790]; rfl

@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3779 = 5004 := by
  calc
...
@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3780 = 5007 := by
  calc
    Artifact.submissionArtifact.instructionPC 3780 =
        Artifact.submissionArtifact.instructionPC 3779 + (YulEvmCompiler.Instr.push 2 5312).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3779 _ (by rfl)
    _ = 5007 := by rw [fixedPC3792]; rfl

@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3781 = 5008 := by
  calc
...
@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3782 = 5009 := by
  calc
    Artifact.submissionArtifact.instructionPC 3782 =
        Artifact.submissionArtifact.instructionPC 3781 + (YulEvmCompiler.Instr.op (.Dup ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3781 _ (by rfl)
    _ = 5009 := by rw [fixedPC3794]; rfl

@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3783 = 5012 := by
  calc
    Artifact.submissionArtifact.instructionPC 3783 =
        Artifact.submissionArtifact.instructionPC 3782 + (YulEvmCompiler.Instr.push 2 3072).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3782 _ (by rfl)
    _ = 5012 := by rw [fixedPC3795]; rfl

@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3784 = 5013 := by
  calc
    Artifact.submissionArtifact.instructionPC 3784 =
        Artifact.submissionArtifact.instructionPC 3783 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3783 _ (by rfl)
    _ = 5013 := by rw [fixedPC3796]; rfl

@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3785 = 5016 := by
  calc
    Artifact.submissionArtifact.instructionPC 3785 =
        Artifact.submissionArtifact.instructionPC 3784 + (YulEvmCompiler.Instr.push 2 4160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3784 _ (by rfl)
    _ = 5016 := by rw [fixedPC3797]; rfl

@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3786 = 5017 := by
  calc
    Artifact.submissionArtifact.instructionPC 3786 =
        Artifact.submissionArtifact.instructionPC 3785 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3785 _ (by rfl)
    _ = 5017 := by rw [fixedPC3798]; rfl

@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3787 = 5018 := by
  calc
    Artifact.submissionArtifact.instructionPC 3787 =
        Artifact.submissionArtifact.instructionPC 3786 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3786 _ (by rfl)
    _ = 5018 := by rw [fixedPC3799]; rfl

@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3788 = 5019 := by
  calc
    Artifact.submissionArtifact.instructionPC 3788 =
        Artifact.submissionArtifact.instructionPC 3787 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3787 _ (by rfl)
    _ = 5019 := by rw [fixedPC3800]; rfl

@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3789 = 5020 := by
  calc
...
@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3790 = 5023 := by
  calc
    Artifact.submissionArtifact.instructionPC 3790 =
        Artifact.submissionArtifact.instructionPC 3789 + (YulEvmCompiler.Instr.push 2 2120).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3789 _ (by rfl)
    _ = 5023 := by rw [fixedPC3802]; rfl

@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3791 = 5024 := by
  calc
    Artifact.submissionArtifact.instructionPC 3791 =
        Artifact.submissionArtifact.instructionPC 3790 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5023 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5024 = true := by
  simpa only [Artifact.instructionPC, fixedPC3804] using Artifact.isValidJumpDest_index 3791 (by rfl)

@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3792 = 5025 := by
  calc
    Artifact.submissionArtifact.instructionPC 3792 =
        Artifact.submissionArtifact.instructionPC 3791 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3791 _ (by rfl)
    _ = 5025 := by rw [fixedPC3804]; rfl

@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3793 = 5028 := by
  calc
    Artifact.submissionArtifact.instructionPC 3793 =
        Artifact.submissionArtifact.instructionPC 3792 + (YulEvmCompiler.Instr.push 2 4384).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3792 _ (by rfl)
    _ = 5028 := by rw [fixedPC3805]; rfl

@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3794 = 5029 := by
  calc
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3795 = 5031 := by
  calc
    Artifact.submissionArtifact.instructionPC 3795 =
        Artifact.submissionArtifact.instructionPC 3794 + (YulEvmCompiler.Instr.push 1 224).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3794 _ (by rfl)
    _ = 5031 := by rw [fixedPC3807]; rfl

@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3796 = 5032 := by
  calc
...
@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3797 = 5033 := by
  calc
...
@[simp] theorem fixedPC3811 : Artifact.submissionArtifact.instructionPC 3798 = 5034 := by
  calc
...
@[simp] theorem fixedPC3812 : Artifact.submissionArtifact.instructionPC 3799 = 5035 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3800 = 5036 := by
  calc
...
@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3801 = 5037 := by
  calc
...
@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3802 = 5040 := by
  calc
    Artifact.submissionArtifact.instructionPC 3802 =
        Artifact.submissionArtifact.instructionPC 3801 + (YulEvmCompiler.Instr.push 2 3296).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3801 _ (by rfl)
    _ = 5040 := by rw [fixedPC3814]; rfl

@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3803 = 5041 := by
  calc
...
@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3804 = 5044 := by
  calc
    Artifact.submissionArtifact.instructionPC 3804 =
        Artifact.submissionArtifact.instructionPC 3803 + (YulEvmCompiler.Instr.push 2 4352).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3803 _ (by rfl)
    _ = 5044 := by rw [fixedPC3816]; rfl

@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3805 = 5045 := by
  calc
...
@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3806 = 5047 := by
  calc
    Artifact.submissionArtifact.instructionPC 3806 =
        Artifact.submissionArtifact.instructionPC 3805 + (YulEvmCompiler.Instr.push 1 192).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3805 _ (by rfl)
    _ = 5047 := by rw [fixedPC3818]; rfl

@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3807 = 5048 := by
  calc
...
@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3808 = 5049 := by
  calc
...
@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3809 = 5050 := by
  calc
...
@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3810 = 5051 := by
  calc
...
@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3811 = 5052 := by
  calc
...
@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3812 = 5053 := by
  calc
...
@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3813 = 5054 := by
  calc
...
@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3814 = 5055 := by
  calc
...
@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3815 = 5056 := by
  calc
...
@[simp] theorem fixedPC3829 : Artifact.submissionArtifact.instructionPC 3816 = 5057 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3817 = 5058 := by
  calc
...
@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3818 = 5059 := by
  calc
...
@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3819 = 5060 := by
  calc
...
@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3820 = 5063 := by
  calc
    Artifact.submissionArtifact.instructionPC 3820 =
        Artifact.submissionArtifact.instructionPC 3819 + (YulEvmCompiler.Instr.push 2 3264).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3819 _ (by rfl)
    _ = 5063 := by rw [fixedPC3832]; rfl

@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3821 = 5064 := by
  calc
...
@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3822 = 5067 := by
  calc
    Artifact.submissionArtifact.instructionPC 3822 =
        Artifact.submissionArtifact.instructionPC 3821 + (YulEvmCompiler.Instr.push 2 4320).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3821 _ (by rfl)
    _ = 5067 := by rw [fixedPC3834]; rfl

@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3823 = 5068 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3824 = 5070 := by
  calc
    Artifact.submissionArtifact.instructionPC 3824 =
        Artifact.submissionArtifact.instructionPC 3823 + (YulEvmCompiler.Instr.push 1 160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3823 _ (by rfl)
    _ = 5070 := by rw [fixedPC3836]; rfl

@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3825 = 5071 := by
  calc
...
@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3826 = 5072 := by
  calc
...
@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3827 = 5073 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3828 = 5074 := by
  calc
...
@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3829 = 5075 := by
  calc
...
@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3830 = 5076 := by
  calc
...
@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3831 = 5077 := by
  calc
...
@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3832 = 5078 := by
  calc
...
@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3833 = 5079 := by
  calc
...
@[simp] theorem fixedPC3847 : Artifact.submissionArtifact.instructionPC 3834 = 5080 := by
  calc
...
@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3835 = 5081 := by
  calc
...
@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3836 = 5082 := by
  calc
...
@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3837 = 5083 := by
  calc
...
@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3838 = 5086 := by
  calc
    Artifact.submissionArtifact.instructionPC 3838 =
        Artifact.submissionArtifact.instructionPC 3837 + (YulEvmCompiler.Instr.push 2 3232).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3837 _ (by rfl)
    _ = 5086 := by rw [fixedPC3850]; rfl

@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3839 = 5087 := by
  calc
...
@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3840 = 5090 := by
  calc
    Artifact.submissionArtifact.instructionPC 3840 =
        Artifact.submissionArtifact.instructionPC 3839 + (YulEvmCompiler.Instr.push 2 4288).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3839 _ (by rfl)
    _ = 5090 := by rw [fixedPC3852]; rfl

@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3841 = 5091 := by
  calc
...
@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3842 = 5093 := by
  calc
    Artifact.submissionArtifact.instructionPC 3842 =
        Artifact.submissionArtifact.instructionPC 3841 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3841 _ (by rfl)
    _ = 5093 := by rw [fixedPC3854]; rfl

@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3843 = 5094 := by
  calc
...
@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3844 = 5095 := by
  calc
...
@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3845 = 5096 := by
  calc
...
@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3846 = 5097 := by
  calc
...
@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3847 = 5098 := by
  calc
...
@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3848 = 5099 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3849 = 5100 := by
  calc
...
@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3850 = 5101 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3851 = 5102 := by
  calc
...
@[simp] theorem fixedPC3865 : Artifact.submissionArtifact.instructionPC 3852 = 5103 := by
  calc
...
@[simp] theorem fixedPC3866 : Artifact.submissionArtifact.instructionPC 3853 = 5104 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3854 = 5105 := by
  calc
...
@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3855 = 5106 := by
  calc
...
@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3856 = 5109 := by
  calc
    Artifact.submissionArtifact.instructionPC 3856 =
        Artifact.submissionArtifact.instructionPC 3855 + (YulEvmCompiler.Instr.push 2 3200).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3855 _ (by rfl)
    _ = 5109 := by rw [fixedPC3868]; rfl

@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3857 = 5110 := by
  calc
...
@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3858 = 5113 := by
  calc
    Artifact.submissionArtifact.instructionPC 3858 =
        Artifact.submissionArtifact.instructionPC 3857 + (YulEvmCompiler.Instr.push 2 4256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3857 _ (by rfl)
    _ = 5113 := by rw [fixedPC3871]; rfl

@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3859 = 5114 := by
  calc
...
@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3860 = 5116 := by
  calc
    Artifact.submissionArtifact.instructionPC 3860 =
        Artifact.submissionArtifact.instructionPC 3859 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3859 _ (by rfl)
    _ = 5116 := by rw [fixedPC3873]; rfl

@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3861 = 5117 := by
  calc
...
@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3862 = 5118 := by
  calc
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3863 = 5119 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3864 = 5120 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3865 = 5121 := by
  calc
...
@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3866 = 5122 := by
  calc
...
@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3867 = 5123 := by
  calc
...
@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3868 = 5124 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3869 = 5125 := by
  calc
...
@[simp] theorem fixedPC3884 : Artifact.submissionArtifact.instructionPC 3870 = 5126 := by
  calc
...
@[simp] theorem fixedPC3885 : Artifact.submissionArtifact.instructionPC 3871 = 5127 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3872 = 5128 := by
  calc
...
@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3873 = 5129 := by
  calc
...
@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3874 = 5132 := by
  calc
    Artifact.submissionArtifact.instructionPC 3874 =
        Artifact.submissionArtifact.instructionPC 3873 + (YulEvmCompiler.Instr.push 2 3168).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3873 _ (by rfl)
    _ = 5132 := by rw [fixedPC3887]; rfl

@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3875 = 5133 := by
  calc
...
@[simp] theorem fixedJump5133 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5133 = true := by
  simpa only [Artifact.instructionPC, fixedPC3889] using Artifact.isValidJumpDest_index 3875 (by rfl)

@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3876 = 5134 := by
  calc
...
@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3877 = 5137 := by
  calc
    Artifact.submissionArtifact.instructionPC 3877 =
        Artifact.submissionArtifact.instructionPC 3876 + (YulEvmCompiler.Instr.push 2 4224).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3876 _ (by rfl)
    _ = 5137 := by rw [fixedPC3890]; rfl

@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3878 = 5138 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3879 = 5140 := by
  calc
    Artifact.submissionArtifact.instructionPC 3879 =
        Artifact.submissionArtifact.instructionPC 3878 + (YulEvmCompiler.Instr.push 1 64).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3878 _ (by rfl)
    _ = 5140 := by rw [fixedPC3892]; rfl

@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3880 = 5141 := by
  calc
...
@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3881 = 5142 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3882 = 5143 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3883 = 5144 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3884 = 5145 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3885 = 5146 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3886 = 5147 := by
  calc
    Artifact.submissionArtifact.instructionPC 3886 =
        Artifact.submissionArtifact.instructionPC 3885 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3885 _ (by rfl)
    _ = 5147 := by rw [fixedPC3899]; rfl

@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3887 = 5148 := by
  calc
    Artifact.submissionArtifact.instructionPC 3887 =
        Artifact.submissionArtifact.instructionPC 3886 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3886 _ (by rfl)
    _ = 5148 := by rw [fixedPC3900]; rfl

@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3888 = 5149 := by
  calc
...
@[simp] theorem fixedPC3903 : Artifact.submissionArtifact.instructionPC 3889 = 5150 := by
  calc
    Artifact.submissionArtifact.instructionPC 3889 =
        Artifact.submissionArtifact.instructionPC 3888 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3888 _ (by rfl)
    _ = 5150 := by rw [fixedPC3902]; rfl

@[simp] theorem fixedPC3904 : Artifact.submissionArtifact.instructionPC 3890 = 5151 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3891 = 5152 := by
  calc
    Artifact.submissionArtifact.instructionPC 3891 =
        Artifact.submissionArtifact.instructionPC 3890 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3890 _ (by rfl)
    _ = 5152 := by rw [fixedPC3904]; rfl

@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3892 = 5153 := by
  calc
    Artifact.submissionArtifact.instructionPC 3892 =
        Artifact.submissionArtifact.instructionPC 3891 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3891 _ (by rfl)
    _ = 5153 := by rw [fixedPC3905]; rfl

@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3893 = 5156 := by
  calc
    Artifact.submissionArtifact.instructionPC 3893 =
        Artifact.submissionArtifact.instructionPC 3892 + (YulEvmCompiler.Instr.push 2 3136).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3892 _ (by rfl)
    _ = 5156 := by rw [fixedPC3906]; rfl

@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3894 = 5157 := by
  calc
    Artifact.submissionArtifact.instructionPC 3894 =
        Artifact.submissionArtifact.instructionPC 3893 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3893 _ (by rfl)
    _ = 5157 := by rw [fixedPC3907]; rfl

@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3895 = 5160 := by
  calc
    Artifact.submissionArtifact.instructionPC 3895 =
        Artifact.submissionArtifact.instructionPC 3894 + (YulEvmCompiler.Instr.push 2 4192).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3894 _ (by rfl)
    _ = 5160 := by rw [fixedPC3908]; rfl

@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3896 = 5161 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3897 = 5163 := by
  calc
...
@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3898 = 5164 := by
  calc
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3899 = 5165 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3900 = 5166 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3901 = 5167 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3902 = 5168 := by
  calc
    Artifact.submissionArtifact.instructionPC 3902 =
        Artifact.submissionArtifact.instructionPC 3901 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3901 _ (by rfl)
    _ = 5168 := by rw [fixedPC3915]; rfl

@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3903 = 5169 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3904 = 5170 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3905 = 5171 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3906 = 5172 := by
  calc
...
@[simp] theorem fixedPC3921 : Artifact.submissionArtifact.instructionPC 3907 = 5173 := by
  calc
    Artifact.submissionArtifact.instructionPC 3907 =
        Artifact.submissionArtifact.instructionPC 3906 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3906 _ (by rfl)
    _ = 5173 := by rw [fixedPC3920]; rfl

@[simp] theorem fixedPC3922 : Artifact.submissionArtifact.instructionPC 3908 = 5174 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3909 = 5175 := by
  calc
    Artifact.submissionArtifact.instructionPC 3909 =
        Artifact.submissionArtifact.instructionPC 3908 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3908 _ (by rfl)
    _ = 5175 := by rw [fixedPC3922]; rfl

@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3910 = 5176 := by
  calc
    Artifact.submissionArtifact.instructionPC 3910 =
        Artifact.submissionArtifact.instructionPC 3909 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3909 _ (by rfl)
    _ = 5176 := by rw [fixedPC3923]; rfl

@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3911 = 5179 := by
  calc
    Artifact.submissionArtifact.instructionPC 3911 =
        Artifact.submissionArtifact.instructionPC 3910 + (YulEvmCompiler.Instr.push 2 3104).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3910 _ (by rfl)
    _ = 5179 := by rw [fixedPC3924]; rfl

@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3912 = 5180 := by
  calc
...
@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3913 = 5183 := by
  calc
    Artifact.submissionArtifact.instructionPC 3913 =
        Artifact.submissionArtifact.instructionPC 3912 + (YulEvmCompiler.Instr.push 2 4160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3912 _ (by rfl)
    _ = 5183 := by rw [fixedPC3926]; rfl

@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3914 = 5184 := by
  calc
...
@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3915 = 5185 := by
  calc
    Artifact.submissionArtifact.instructionPC 3915 =
        Artifact.submissionArtifact.instructionPC 3914 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3914 _ (by rfl)
    _ = 5185 := by rw [fixedPC3928]; rfl

@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3916 = 5186 := by
  calc
...
@[simp] theorem fixedPC3931 : Artifact.submissionArtifact.instructionPC 3917 = 5187 := by
  calc
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3918 = 5188 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3919 = 5189 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3920 = 5190 := by
  calc
...
@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3921 = 5191 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3922 = 5192 := by
  calc
...
@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3923 = 5193 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3924 = 5194 := by
  calc
...
@[simp] theorem fixedPC3939 : Artifact.submissionArtifact.instructionPC 3925 = 5195 := by
  calc
...
@[simp] theorem fixedPC3940 : Artifact.submissionArtifact.instructionPC 3926 = 5196 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3927 = 5197 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3928 = 5198 := by
  calc
...
@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3929 = 5201 := by
  calc
    Artifact.submissionArtifact.instructionPC 3929 =
        Artifact.submissionArtifact.instructionPC 3928 + (YulEvmCompiler.Instr.push 2 3072).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3928 _ (by rfl)
    _ = 5201 := by rw [fixedPC3942]; rfl

@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3930 = 5202 := by
  calc
...
@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3931 = 5203 := by
  calc
    Artifact.submissionArtifact.instructionPC 3931 =
        Artifact.submissionArtifact.instructionPC 3930 + (YulEvmCompiler.Instr.op .ISZERO).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3930 _ (by rfl)
    _ = 5203 := by rw [fixedPC3944]; rfl

@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3932 = 5206 := by
  calc
    Artifact.submissionArtifact.instructionPC 3932 =
        Artifact.submissionArtifact.instructionPC 3931 + (YulEvmCompiler.Instr.push 2 4128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3931 _ (by rfl)
    _ = 5206 := by rw [fixedPC3945]; rfl

@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3933 = 5207 := by
  calc
...
@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3934 = 5208 := by
  calc
    Artifact.submissionArtifact.instructionPC 3934 =
        Artifact.submissionArtifact.instructionPC 3933 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3933 _ (by rfl)
    _ = 5208 := by rw [fixedPC3947]; rfl

@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3946 = 5228 := by
  decide

@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3946 = 5228 :=
  fixedPC3949

@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3947 = 5229 := by
  calc
...
@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3948 = 5232 := by
  calc
    Artifact.submissionArtifact.instructionPC 3948 =
        Artifact.submissionArtifact.instructionPC 3947 + (YulEvmCompiler.Instr.push 2 4160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3947 _ (by rfl)
    _ = 5232 := by rw [fixedPC3951]; rfl

@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3949 = 5233 := by
  calc
...
@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3950 = 5236 := by
  calc
    Artifact.submissionArtifact.instructionPC 3950 =
        Artifact.submissionArtifact.instructionPC 3949 + (YulEvmCompiler.Instr.push 2 5248).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3949 _ (by rfl)
    _ = 5236 := by rw [fixedPC3953]; rfl

@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3951 = 5237 := by
  calc
...
@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3952 = 5238 := by
  calc
...
@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 3953 = 5239 := by
  calc
...
@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3650 = 4826 := by
  decide

@[simp] theorem fixedJump5280 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4826 = true := by
  simpa only [Artifact.instructionPC, fixedPC3999] using Artifact.isValidJumpDest_index 3650 (by rfl)

@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 3651 = 4827 := by
  calc
    Artifact.submissionArtifact.instructionPC 3651 =
        Artifact.submissionArtifact.instructionPC 3650 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3650 _ (by rfl)
    _ = 4827 := by rw [fixedPC3999]; rfl

@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 3652 = 4830 := by
  calc
    Artifact.submissionArtifact.instructionPC 3652 =
        Artifact.submissionArtifact.instructionPC 3651 + (YulEvmCompiler.Instr.push 2 4256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3651 _ (by rfl)
    _ = 4830 := by rw [fixedPC4000]; rfl

@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 3653 = 4831 := by
  calc
...
@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 3654 = 4833 := by
  calc
    Artifact.submissionArtifact.instructionPC 3654 =
        Artifact.submissionArtifact.instructionPC 3653 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3653 _ (by rfl)
    _ = 4833 := by rw [fixedPC4002]; rfl

@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 3655 = 4834 := by
  calc
    Artifact.submissionArtifact.instructionPC 3655 =
        Artifact.submissionArtifact.instructionPC 3654 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3654 _ (by rfl)
    _ = 4834 := by rw [fixedPC4003]; rfl

@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 3656 = 4835 := by
  calc
...
@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 3657 = 4836 := by
  calc
    Artifact.submissionArtifact.instructionPC 3657 =
        Artifact.submissionArtifact.instructionPC 3656 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3656 _ (by rfl)
    _ = 4836 := by rw [fixedPC4005]; rfl

@[simp] theorem fixedPC4007 : Artifact.submissionArtifact.instructionPC 3658 = 4837 := by
  calc
    Artifact.submissionArtifact.instructionPC 3658 =
        Artifact.submissionArtifact.instructionPC 3657 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3657 _ (by rfl)
    _ = 4837 := by rw [fixedPC4006]; rfl

@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 3659 = 4838 := by
  calc
    Artifact.submissionArtifact.instructionPC 3659 =
        Artifact.submissionArtifact.instructionPC 3658 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3658 _ (by rfl)
    _ = 4838 := by rw [fixedPC4007]; rfl

@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 3660 = 4839 := by
  calc
    Artifact.submissionArtifact.instructionPC 3660 =
        Artifact.submissionArtifact.instructionPC 3659 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3659 _ (by rfl)
    _ = 4839 := by rw [fixedPC4008]; rfl

@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 3661 = 4842 := by
  calc
    Artifact.submissionArtifact.instructionPC 3661 =
        Artifact.submissionArtifact.instructionPC 3660 + (YulEvmCompiler.Instr.push 2 3168).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3660 _ (by rfl)
    _ = 4842 := by rw [fixedPC4009]; rfl

@[simp] theorem fixedPC4011 : Artifact.submissionArtifact.instructionPC 3662 = 4843 := by
  calc
    Artifact.submissionArtifact.instructionPC 3662 =
        Artifact.submissionArtifact.instructionPC 3661 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3661 _ (by rfl)
    _ = 4843 := by rw [fixedPC4010]; rfl

@[simp] theorem fixedPC4012 : Artifact.submissionArtifact.instructionPC 3663 = 4846 := by
  calc
    Artifact.submissionArtifact.instructionPC 3663 =
        Artifact.submissionArtifact.instructionPC 3662 + (YulEvmCompiler.Instr.push 2 5133).bytes.length :=
...
@[simp] theorem earlyExtraPC3918 : Artifact.submissionArtifact.instructionPC 3935 = 5211 := by rfl
@[simp] theorem earlyExtraPC3919 : Artifact.submissionArtifact.instructionPC 3936 = 5212 := by rfl
@[simp] theorem earlyExtraPC3920 : Artifact.submissionArtifact.instructionPC 3937 = 5215 := by rfl
@[simp] theorem earlyExtraPC3921 : Artifact.submissionArtifact.instructionPC 3938 = 5216 := by rfl
@[simp] theorem earlyExtraPC3922 : Artifact.submissionArtifact.instructionPC 3939 = 5217 := by rfl
@[simp] theorem earlyExtraPC3923 : Artifact.submissionArtifact.instructionPC 3940 = 5220 := by rfl
@[simp] theorem earlyExtraPC3924 : Artifact.submissionArtifact.instructionPC 3941 = 5223 := by rfl
@[simp] theorem earlyExtraPC3925 : Artifact.submissionArtifact.instructionPC 3942 = 5224 := by rfl
@[simp] theorem earlyExtraPC3926 : Artifact.submissionArtifact.instructionPC 3943 = 5225 := by rfl
@[simp] theorem earlyExtraPC3927 : Artifact.submissionArtifact.instructionPC 3944 = 5226 := by rfl
@[simp] theorem earlyExtraPC3928 : Artifact.submissionArtifact.instructionPC 3945 = 5227 := by rfl
