...
@[simp] theorem fixedPC1618 : Artifact.submissionArtifact.instructionPC 1473 = 1977 := by rfl

@[simp] theorem fixedPC1619 : Artifact.submissionArtifact.instructionPC 1474 = 1980 := by
  calc
    Artifact.submissionArtifact.instructionPC 1474 =
        Artifact.submissionArtifact.instructionPC 1473 + (YulEvmCompiler.Instr.push 2 4669).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 1475 _ (by rfl)
    _ = 1984 := by rw [fixedPC1618]; rfl

@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3719 = 4909 := by rfl

@[simp] theorem fixedJump4975 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4909 = true := by
  simpa only [Artifact.instructionPC, fixedPC3777] using Artifact.isValidJumpDest_index 3719 (by rfl)

@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3720 = 4910 := by
  calc
...
@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3721 = 4913 := by
  calc
...
@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3722 = 4914 := by
  calc
...
@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3723 = 4917 := by
  calc
    Artifact.submissionArtifact.instructionPC 3723 =
        Artifact.submissionArtifact.instructionPC 3722 + (YulEvmCompiler.Instr.push 2 256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3730 _ (by rfl)
    _ = 4933 := by rw [fixedPC3780]; rfl

@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3724 = 4918 := by
  calc
...
@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3725 = 4921 := by
  calc
    Artifact.submissionArtifact.instructionPC 3725 =
        Artifact.submissionArtifact.instructionPC 3724 + (YulEvmCompiler.Instr.push 2 4973).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3732 _ (by rfl)
    _ = 4937 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3726 = 4922 := by
  calc
...
@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3727 = 4925 := by
  calc
...
@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3728 = 4926 := by
  calc
...
@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3729 = 4928 := by
  calc
    Artifact.submissionArtifact.instructionPC 3729 =
        Artifact.submissionArtifact.instructionPC 3728 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3736 _ (by rfl)
    _ = 4944 := by rw [fixedPC3786]; rfl

@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3730 = 4929 := by
  calc
...
@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3731 = 4932 := by
  calc
    Artifact.submissionArtifact.instructionPC 3731 =
        Artifact.submissionArtifact.instructionPC 3730 + (YulEvmCompiler.Instr.push 2 4691).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3738 _ (by rfl)
    _ = 4948 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3732 = 4933 := by
  calc
...
@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3733 = 4936 := by
  calc
    Artifact.submissionArtifact.instructionPC 3733 =
        Artifact.submissionArtifact.instructionPC 3732 + (YulEvmCompiler.Instr.push 2 9440).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3740 _ (by rfl)
    _ = 4952 := by rw [fixedPC3790]; rfl

@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3734 = 4937 := by
  calc
...
@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3735 = 4940 := by
  calc
    Artifact.submissionArtifact.instructionPC 3735 =
        Artifact.submissionArtifact.instructionPC 3734 + (YulEvmCompiler.Instr.push 2 9408).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3742 _ (by rfl)
    _ = 4956 := by rw [fixedPC3792]; rfl

@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3736 = 4941 := by
  calc
...
@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3737 = 4942 := by
  calc
    Artifact.submissionArtifact.instructionPC 3737 =
        Artifact.submissionArtifact.instructionPC 3736 + (YulEvmCompiler.Instr.op (.Dup ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3744 _ (by rfl)
    _ = 4958 := by rw [fixedPC3794]; rfl

@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3738 = 4945 := by
  calc
    Artifact.submissionArtifact.instructionPC 3738 =
        Artifact.submissionArtifact.instructionPC 3737 + (YulEvmCompiler.Instr.push 2 7168).bytes.length :=
...
@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3747 = 4962 := by
  calc
    Artifact.submissionArtifact.instructionPC 3747 =
        Artifact.submissionArtifact.instructionPC 3738 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
...
@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3739 = 4946 := by
  calc
...
@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3740 = 4947 := by
  calc
...
@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3741 = 4948 := by
  calc
...
@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3742 = 4949 := by
  calc
...
@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3743 = 4952 := by
  calc
    Artifact.submissionArtifact.instructionPC 3743 =
        Artifact.submissionArtifact.instructionPC 3742 + (YulEvmCompiler.Instr.push 2 1985).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3752 _ (by rfl)
    _ = 4972 := by rw [fixedPC3802]; rfl

@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3744 = 4953 := by
  calc
...
@[simp] theorem fixedJump5023 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4953 = true := by
  simpa only [Artifact.instructionPC, fixedPC3804] using Artifact.isValidJumpDest_index 3744 (by rfl)

@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3745 = 4954 := by
  calc
...
@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3746 = 4957 := by
  calc
...
@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3747 = 4958 := by
  calc
    Artifact.submissionArtifact.instructionPC 3747 =
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3748 = 4960 := by
  calc
    Artifact.submissionArtifact.instructionPC 3748 =
...
@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3749 = 4961 := by
  calc
...
@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3750 = 4962 := by
  calc
...
@[simp] theorem fixedPC3811 : Artifact.submissionArtifact.instructionPC 3751 = 4963 := by
  calc
...
@[simp] theorem fixedPC3812 : Artifact.submissionArtifact.instructionPC 3752 = 4964 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3753 = 4965 := by
  calc
...
@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3754 = 4966 := by
  calc
...
@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3755 = 4969 := by
  calc
...
@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3756 = 4970 := by
  calc
...
@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3757 = 4973 := by
  calc
...
@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3758 = 4974 := by
  calc
...
@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3759 = 4976 := by
  calc
...
@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3760 = 4977 := by
  calc
...
@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3761 = 4978 := by
  calc
...
@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3762 = 4979 := by
  calc
...
@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3763 = 4980 := by
  calc
...
@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3764 = 4981 := by
  calc
...
@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3765 = 4982 := by
  calc
...
@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3766 = 4983 := by
  calc
...
@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3767 = 4984 := by
  calc
...
@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3768 = 4985 := by
  calc
...
@[simp] theorem fixedPC3829 : Artifact.submissionArtifact.instructionPC 3769 = 4986 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3770 = 4987 := by
  calc
...
@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3771 = 4988 := by
  calc
...
@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3772 = 4989 := by
  calc
...
@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3773 = 4992 := by
  calc
...
@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3774 = 4993 := by
  calc
...
@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3775 = 4996 := by
  calc
...
@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3776 = 4997 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3777 = 4999 := by
  calc
...
@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3778 = 5000 := by
  calc
...
@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3779 = 5001 := by
  calc
...
@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3780 = 5002 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3781 = 5003 := by
  calc
...
@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3782 = 5004 := by
  calc
...
@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3783 = 5005 := by
  calc
...
@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3784 = 5006 := by
  calc
...
@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3785 = 5007 := by
  calc
...
@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3786 = 5008 := by
  calc
...
@[simp] theorem fixedPC3847 : Artifact.submissionArtifact.instructionPC 3787 = 5009 := by
  calc
...
@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3788 = 5010 := by
  calc
...
@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3789 = 5011 := by
  calc
...
@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3790 = 5012 := by
  calc
...
@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3791 = 5015 := by
  calc
...
@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3792 = 5016 := by
  calc
...
@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3793 = 5019 := by
  calc
...
@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3794 = 5020 := by
  calc
...
@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3795 = 5022 := by
  calc
...
@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3796 = 5023 := by
  calc
...
@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3797 = 5024 := by
  calc
...
@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3798 = 5025 := by
  calc
...
@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3799 = 5026 := by
  calc
...
@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3800 = 5027 := by
  calc
...
@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3801 = 5028 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3802 = 5029 := by
  calc
...
@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3803 = 5030 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3804 = 5031 := by
  calc
...
@[simp] theorem fixedPC3865 : Artifact.submissionArtifact.instructionPC 3805 = 5032 := by
  calc
...
@[simp] theorem fixedPC3866 : Artifact.submissionArtifact.instructionPC 3806 = 5033 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3807 = 5034 := by
  calc
...
@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3808 = 5035 := by
  calc
...
@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3809 = 5038 := by
  calc
...
@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3810 = 5039 := by
  calc
...
@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3811 = 5042 := by
  calc
...
@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3812 = 5043 := by
  calc
...
@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3813 = 5045 := by
  calc
...
@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3814 = 5046 := by
  calc
...
@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3815 = 5047 := by
  calc
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3816 = 5048 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3817 = 5049 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3818 = 5050 := by
  calc
...
@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3819 = 5051 := by
  calc
...
@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3820 = 5052 := by
  calc
...
@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3821 = 5053 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3822 = 5054 := by
  calc
...
@[simp] theorem fixedPC3884 : Artifact.submissionArtifact.instructionPC 3823 = 5055 := by
  calc
...
@[simp] theorem fixedPC3885 : Artifact.submissionArtifact.instructionPC 3824 = 5056 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3825 = 5057 := by
  calc
...
@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3826 = 5058 := by
  calc
...
@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3827 = 5061 := by
  calc
...
@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3828 = 5062 := by
  calc
...
@[simp] theorem fixedJump5133 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5062 = true := by
  simpa only [Artifact.instructionPC, fixedPC3889] using Artifact.isValidJumpDest_index 3828 (by rfl)

@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3829 = 5063 := by
  calc
...
@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3830 = 5066 := by
  calc
...
@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3831 = 5067 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3832 = 5069 := by
  calc
...
@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3833 = 5070 := by
  calc
...
@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3834 = 5071 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3835 = 5072 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3836 = 5073 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3837 = 5074 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3838 = 5075 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3839 = 5076 := by
  calc
...
@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3840 = 5077 := by
  calc
...
@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3841 = 5078 := by
  calc
...
@[simp] theorem fixedPC3903 : Artifact.submissionArtifact.instructionPC 3842 = 5079 := by
  calc
...
@[simp] theorem fixedPC3904 : Artifact.submissionArtifact.instructionPC 3843 = 5080 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3844 = 5081 := by
  calc
...
@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3845 = 5082 := by
  calc
...
@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3846 = 5085 := by
  calc
...
@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3847 = 5086 := by
  calc
...
@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3848 = 5089 := by
  calc
...
@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3849 = 5090 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3850 = 5092 := by
  calc
...
@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3851 = 5093 := by
  calc
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3852 = 5094 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3853 = 5095 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3854 = 5096 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3855 = 5097 := by
  calc
...
@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3856 = 5098 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3857 = 5099 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3858 = 5100 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3859 = 5101 := by
  calc
...
@[simp] theorem fixedPC3921 : Artifact.submissionArtifact.instructionPC 3860 = 5102 := by
  calc
...
@[simp] theorem fixedPC3922 : Artifact.submissionArtifact.instructionPC 3861 = 5103 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3862 = 5104 := by
  calc
...
@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3863 = 5105 := by
  calc
...
@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3864 = 5108 := by
  calc
...
@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3865 = 5109 := by
  calc
...
@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3866 = 5112 := by
  calc
...
@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3867 = 5113 := by
  calc
...
@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3868 = 5114 := by
  calc
...
@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3869 = 5115 := by
  calc
...
@[simp] theorem fixedPC3931 : Artifact.submissionArtifact.instructionPC 3870 = 5116 := by
  calc
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3871 = 5117 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3872 = 5118 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3873 = 5119 := by
  calc
...
@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3874 = 5120 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3875 = 5121 := by
  calc
...
@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3876 = 5122 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3877 = 5123 := by
  calc
...
@[simp] theorem fixedPC3939 : Artifact.submissionArtifact.instructionPC 3878 = 5124 := by
  calc
...
@[simp] theorem fixedPC3940 : Artifact.submissionArtifact.instructionPC 3879 = 5125 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3880 = 5126 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3881 = 5127 := by
  calc
...
@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3882 = 5130 := by
  calc
...
@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3883 = 5131 := by
  calc
...
@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3884 = 5132 := by
  calc
...
@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3885 = 5135 := by
  calc
...
@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3886 = 5136 := by
  calc
...
@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3887 = 5137 := by
  calc
...
@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3899 = 5157 := by
  decide

@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3899 = 5157 :=
  fixedPC3949

@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3900 = 5158 := by
  calc
    Artifact.submissionArtifact.instructionPC 3900 =
        Artifact.submissionArtifact.instructionPC 3899 + (YulEvmCompiler.Instr.op .MUL).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3909 _ (by rfl)
    _ = 5178 := by rw [fixedPC3950]; rfl

@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3901 = 5161 := by
  calc
    Artifact.submissionArtifact.instructionPC 3901 =
        Artifact.submissionArtifact.instructionPC 3900 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3910 _ (by rfl)
    _ = 5181 := by rw [fixedPC3951]; rfl

@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3902 = 5162 := by
  calc
    Artifact.submissionArtifact.instructionPC 3902 =
        Artifact.submissionArtifact.instructionPC 3901 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3911 _ (by rfl)
    _ = 5182 := by rw [fixedPC3952]; rfl

@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3903 = 5165 := by
  calc
    Artifact.submissionArtifact.instructionPC 3903 =
        Artifact.submissionArtifact.instructionPC 3902 + (YulEvmCompiler.Instr.push 2 9344).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3912 _ (by rfl)
    _ = 5185 := by rw [fixedPC3953]; rfl

@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3904 = 5166 := by
  calc
...
@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3905 = 5167 := by
  calc
...
@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 3906 = 5168 := by
  calc
    Artifact.submissionArtifact.instructionPC 3906 =
        Artifact.submissionArtifact.instructionPC 3905 + (YulEvmCompiler.Instr.op .MCOPY).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3915 _ (by rfl)
    _ = 5188 := by rw [fixedPC3956]; rfl

@[simp] theorem fixedPC3958 : Artifact.submissionArtifact.instructionPC 3907 = 5169 := by
  calc
    Artifact.submissionArtifact.instructionPC 3907 =
        Artifact.submissionArtifact.instructionPC 3906 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3916 _ (by rfl)
    _ = 5189 := by rw [fixedPC3957]; rfl

@[simp] theorem fixedJump5224 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5169 = true := by
  simpa only [Artifact.instructionPC, fixedPC3958] using Artifact.isValidJumpDest_index 3907 (by rfl)

@[simp] theorem fixedPC3959 : Artifact.submissionArtifact.instructionPC 3908 = 5170 := by
  calc
    Artifact.submissionArtifact.instructionPC 3908 =
        Artifact.submissionArtifact.instructionPC 3907 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3917 _ (by rfl)
    _ = 5190 := by rw [fixedPC3958]; rfl

@[simp] theorem fixedPC3960 : Artifact.submissionArtifact.instructionPC 3909 = 5171 := by
  calc
    Artifact.submissionArtifact.instructionPC 3909 =
        Artifact.submissionArtifact.instructionPC 3908 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3918 _ (by rfl)
    _ = 5191 := by rw [fixedPC3959]; rfl

@[simp] theorem fixedPC3961 : Artifact.submissionArtifact.instructionPC 3910 = 5172 := by
  calc
...
@[simp] theorem fixedPC3962 : Artifact.submissionArtifact.instructionPC 3911 = 5174 := by
  calc
...
@[simp] theorem fixedPC3963 : Artifact.submissionArtifact.instructionPC 3912 = 5175 := by
  calc
...
@[simp] theorem fixedPC3964 : Artifact.submissionArtifact.instructionPC 3913 = 5177 := by
  calc
    Artifact.submissionArtifact.instructionPC 3913 =
        Artifact.submissionArtifact.instructionPC 3912 + (YulEvmCompiler.Instr.push 1 64).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3922 _ (by rfl)
    _ = 5197 := by rw [fixedPC3963]; rfl

@[simp] theorem fixedPC3965 : Artifact.submissionArtifact.instructionPC 3914 = 5178 := by
  calc
    Artifact.submissionArtifact.instructionPC 3914 =
        Artifact.submissionArtifact.instructionPC 3913 + (YulEvmCompiler.Instr.op .CALLDATALOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3923 _ (by rfl)
    _ = 5198 := by rw [fixedPC3964]; rfl

@[simp] theorem fixedPC3966 : Artifact.submissionArtifact.instructionPC 3915 = 5180 := by
  calc
...
@[simp] theorem fixedPC3967 : Artifact.submissionArtifact.instructionPC 3916 = 5181 := by
  calc
    Artifact.submissionArtifact.instructionPC 3916 =
        Artifact.submissionArtifact.instructionPC 3915 + (YulEvmCompiler.Instr.op (.Dup ⟨3, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3925 _ (by rfl)
    _ = 5201 := by rw [fixedPC3966]; rfl

@[simp] theorem fixedPC3968 : Artifact.submissionArtifact.instructionPC 3917 = 5182 := by
  calc
    Artifact.submissionArtifact.instructionPC 3917 =
        Artifact.submissionArtifact.instructionPC 3916 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3926 _ (by rfl)
    _ = 5202 := by rw [fixedPC3967]; rfl

@[simp] theorem fixedPC3969 : Artifact.submissionArtifact.instructionPC 3918 = 5183 := by
  calc
...
@[simp] theorem fixedPC3970 : Artifact.submissionArtifact.instructionPC 3919 = 5185 := by
  calc
...
@[simp] theorem fixedPC3971 : Artifact.submissionArtifact.instructionPC 3920 = 5186 := by
  calc
...
@[simp] theorem fixedPC3972 : Artifact.submissionArtifact.instructionPC 3921 = 5187 := by
  calc
...
@[simp] theorem fixedPC3973 : Artifact.submissionArtifact.instructionPC 3922 = 5188 := by
  calc
...
@[simp] theorem fixedPC3974 : Artifact.submissionArtifact.instructionPC 3923 = 5190 := by
  calc
...
@[simp] theorem fixedPC3975 : Artifact.submissionArtifact.instructionPC 3924 = 5191 := by
  calc
    Artifact.submissionArtifact.instructionPC 3924 =
        Artifact.submissionArtifact.instructionPC 3923 + (YulEvmCompiler.Instr.op .XOR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3933 _ (by rfl)
    _ = 5211 := by rw [fixedPC3974]; rfl

@[simp] theorem fixedPC3976 : Artifact.submissionArtifact.instructionPC 3925 = 5192 := by
  calc
    Artifact.submissionArtifact.instructionPC 3925 =
        Artifact.submissionArtifact.instructionPC 3924 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3934 _ (by rfl)
    _ = 5212 := by rw [fixedPC3975]; rfl

@[simp] theorem fixedPC3977 : Artifact.submissionArtifact.instructionPC 3926 = 5195 := by
  calc
    Artifact.submissionArtifact.instructionPC 3926 =
        Artifact.submissionArtifact.instructionPC 3925 + (YulEvmCompiler.Instr.push 2 5237).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3935 _ (by rfl)
    _ = 5215 := by rw [fixedPC3976]; rfl

@[simp] theorem fixedPC3978 : Artifact.submissionArtifact.instructionPC 3927 = 5196 := by
  calc
    Artifact.submissionArtifact.instructionPC 3927 =
        Artifact.submissionArtifact.instructionPC 3926 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3936 _ (by rfl)
    _ = 5216 := by rw [fixedPC3977]; rfl

@[simp] theorem fixedPC3979 : Artifact.submissionArtifact.instructionPC 3928 = 5197 := by
  calc
...
@[simp] theorem fixedPC3980 : Artifact.submissionArtifact.instructionPC 3929 = 5199 := by
  calc
...
@[simp] theorem fixedPC3981 : Artifact.submissionArtifact.instructionPC 3930 = 5200 := by
  calc
    Artifact.submissionArtifact.instructionPC 3930 =
        Artifact.submissionArtifact.instructionPC 3929 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3939 _ (by rfl)
    _ = 5220 := by rw [fixedPC3980]; rfl

@[simp] theorem fixedPC3982 : Artifact.submissionArtifact.instructionPC 3931 = 5201 := by
  calc
    Artifact.submissionArtifact.instructionPC 3931 =
        Artifact.submissionArtifact.instructionPC 3930 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3940 _ (by rfl)
    _ = 5221 := by rw [fixedPC3981]; rfl

@[simp] theorem fixedPC3983 : Artifact.submissionArtifact.instructionPC 3932 = 5202 := by
  calc
...
@[simp] theorem fixedPC3984 : Artifact.submissionArtifact.instructionPC 3933 = 5203 := by
  calc
    Artifact.submissionArtifact.instructionPC 3933 =
        Artifact.submissionArtifact.instructionPC 3932 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3942 _ (by rfl)
    _ = 5223 := by rw [fixedPC3983]; rfl

@[simp] theorem fixedPC3985 : Artifact.submissionArtifact.instructionPC 3934 = 5206 := by
  calc
    Artifact.submissionArtifact.instructionPC 3934 =
        Artifact.submissionArtifact.instructionPC 3933 + (YulEvmCompiler.Instr.push 2 1186).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3943 _ (by rfl)
    _ = 5226 := by rw [fixedPC3984]; rfl

@[simp] theorem fixedPC3986 : Artifact.submissionArtifact.instructionPC 3935 = 5207 := by
  calc
...
@[simp] theorem fixedPC3987 : Artifact.submissionArtifact.instructionPC 3936 = 5208 := by
  calc
    Artifact.submissionArtifact.instructionPC 3936 =
        Artifact.submissionArtifact.instructionPC 3935 + (YulEvmCompiler.Instr.op (.Dup ⟨3, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3945 _ (by rfl)
    _ = 5228 := by rw [fixedPC3986]; rfl

@[simp] theorem fixedPC3988 : Artifact.submissionArtifact.instructionPC 3937 = 5210 := by
  calc
    Artifact.submissionArtifact.instructionPC 3937 =
        Artifact.submissionArtifact.instructionPC 3936 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3946 _ (by rfl)
    _ = 5230 := by rw [fixedPC3987]; rfl

@[simp] theorem fixedPC3989 : Artifact.submissionArtifact.instructionPC 3938 = 5211 := by
  calc
    Artifact.submissionArtifact.instructionPC 3938 =
        Artifact.submissionArtifact.instructionPC 3937 + (YulEvmCompiler.Instr.op (.Dup ⟨6, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3947 _ (by rfl)
    _ = 5231 := by rw [fixedPC3988]; rfl

@[simp] theorem fixedPC3990 : Artifact.submissionArtifact.instructionPC 3939 = 5212 := by
  calc
    Artifact.submissionArtifact.instructionPC 3939 =
        Artifact.submissionArtifact.instructionPC 3938 + (YulEvmCompiler.Instr.op (.Dup ⟨8, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3948 _ (by rfl)
    _ = 5232 := by rw [fixedPC3989]; rfl

@[simp] theorem fixedPC3991 : Artifact.submissionArtifact.instructionPC 3940 = 5213 := by
  calc
    Artifact.submissionArtifact.instructionPC 3940 =
        Artifact.submissionArtifact.instructionPC 3939 + (YulEvmCompiler.Instr.op (.Dup ⟨10, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3949 _ (by rfl)
    _ = 5233 := by rw [fixedPC3990]; rfl

@[simp] theorem fixedPC3992 : Artifact.submissionArtifact.instructionPC 3941 = 5216 := by
  calc
    Artifact.submissionArtifact.instructionPC 3941 =
        Artifact.submissionArtifact.instructionPC 3940 + (YulEvmCompiler.Instr.push 2 4841).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3950 _ (by rfl)
    _ = 5236 := by rw [fixedPC3991]; rfl

@[simp] theorem fixedPC3993 : Artifact.submissionArtifact.instructionPC 3942 = 5217 := by
  calc
...
@[simp] theorem fixedJump5272 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5217 = true := by
  simpa only [Artifact.instructionPC, fixedPC3993] using Artifact.isValidJumpDest_index 3942 (by rfl)

@[simp] theorem fixedPC3994 : Artifact.submissionArtifact.instructionPC 3943 = 5218 := by
  calc
...
@[simp] theorem fixedPC3995 : Artifact.submissionArtifact.instructionPC 3944 = 5219 := by
  calc
...
@[simp] theorem fixedPC3996 : Artifact.submissionArtifact.instructionPC 3945 = 5220 := by
  calc
    Artifact.submissionArtifact.instructionPC 3945 =
        Artifact.submissionArtifact.instructionPC 3944 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3954 _ (by rfl)
    _ = 5240 := by rw [fixedPC3995]; rfl

@[simp] theorem fixedPC3997 : Artifact.submissionArtifact.instructionPC 3946 = 5221 := by
  calc
    Artifact.submissionArtifact.instructionPC 3946 =
        Artifact.submissionArtifact.instructionPC 3945 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3955 _ (by rfl)
    _ = 5241 := by rw [fixedPC3996]; rfl

@[simp] theorem fixedPC3998 : Artifact.submissionArtifact.instructionPC 3947 = 5224 := by
  calc
    Artifact.submissionArtifact.instructionPC 3947 =
        Artifact.submissionArtifact.instructionPC 3946 + (YulEvmCompiler.Instr.push 2 1121).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3956 _ (by rfl)
    _ = 5244 := by rw [fixedPC3997]; rfl

@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3566 = 4675 := by
  decide

@[simp] theorem fixedJump5280 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4675 = true := by
  simpa only [Artifact.instructionPC, fixedPC3999] using Artifact.isValidJumpDest_index 3566 (by rfl)

@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 3567 = 4676 := by
  calc
    Artifact.submissionArtifact.instructionPC 3567 =
        Artifact.submissionArtifact.instructionPC 3566 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3574 _ (by rfl)
    _ = 4692 := by rw [fixedPC3999]; rfl

@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 3568 = 4679 := by
  calc
    Artifact.submissionArtifact.instructionPC 3568 =
        Artifact.submissionArtifact.instructionPC 3567 + (YulEvmCompiler.Instr.push 2 8352).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3575 _ (by rfl)
    _ = 4695 := by rw [fixedPC4000]; rfl

@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 3569 = 4680 := by
  calc
...
@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 3570 = 4682 := by
  calc
    Artifact.submissionArtifact.instructionPC 3570 =
        Artifact.submissionArtifact.instructionPC 3569 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3577 _ (by rfl)
    _ = 4698 := by rw [fixedPC4002]; rfl

@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 3571 = 4683 := by
  calc
...
@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 3572 = 4684 := by
  calc
...
@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 3573 = 4685 := by
  calc
    Artifact.submissionArtifact.instructionPC 3573 =
        Artifact.submissionArtifact.instructionPC 3572 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3580 _ (by rfl)
    _ = 4701 := by rw [fixedPC4005]; rfl

@[simp] theorem fixedPC4007 : Artifact.submissionArtifact.instructionPC 3574 = 4686 := by
  calc
    Artifact.submissionArtifact.instructionPC 3574 =
        Artifact.submissionArtifact.instructionPC 3573 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3581 _ (by rfl)
    _ = 4702 := by rw [fixedPC4006]; rfl

@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 3575 = 4687 := by
  calc
    Artifact.submissionArtifact.instructionPC 3575 =
        Artifact.submissionArtifact.instructionPC 3574 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3582 _ (by rfl)
    _ = 4703 := by rw [fixedPC4007]; rfl

@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 3576 = 4688 := by
  calc
    Artifact.submissionArtifact.instructionPC 3576 =
        Artifact.submissionArtifact.instructionPC 3575 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3583 _ (by rfl)
    _ = 4704 := by rw [fixedPC4008]; rfl

@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 3577 = 4691 := by
  calc
    Artifact.submissionArtifact.instructionPC 3577 =
        Artifact.submissionArtifact.instructionPC 3576 + (YulEvmCompiler.Instr.push 2 7264).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3584 _ (by rfl)
    _ = 4707 := by rw [fixedPC4009]; rfl

@[simp] theorem fixedPC4011 : Artifact.submissionArtifact.instructionPC 3578 = 4692 := by
  calc
    Artifact.submissionArtifact.instructionPC 3578 =
        Artifact.submissionArtifact.instructionPC 3577 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3585 _ (by rfl)
    _ = 4708 := by rw [fixedPC4010]; rfl

@[simp] theorem fixedPC4012 : Artifact.submissionArtifact.instructionPC 3579 = 4695 := by
  calc
    Artifact.submissionArtifact.instructionPC 3579 =
        Artifact.submissionArtifact.instructionPC 3578 + (YulEvmCompiler.Instr.push 2 5082).bytes.length :=
...
@[simp] theorem earlyExtraPC3918 : Artifact.submissionArtifact.instructionPC 3888 = 5140 := by rfl
@[simp] theorem earlyExtraPC3919 : Artifact.submissionArtifact.instructionPC 3889 = 5141 := by rfl
@[simp] theorem earlyExtraPC3920 : Artifact.submissionArtifact.instructionPC 3890 = 5144 := by rfl
@[simp] theorem earlyExtraPC3921 : Artifact.submissionArtifact.instructionPC 3891 = 5145 := by rfl
@[simp] theorem earlyExtraPC3922 : Artifact.submissionArtifact.instructionPC 3892 = 5146 := by rfl
@[simp] theorem earlyExtraPC3923 : Artifact.submissionArtifact.instructionPC 3893 = 5149 := by rfl
@[simp] theorem earlyExtraPC3924 : Artifact.submissionArtifact.instructionPC 3894 = 5152 := by rfl
@[simp] theorem earlyExtraPC3925 : Artifact.submissionArtifact.instructionPC 3895 = 5153 := by rfl
@[simp] theorem earlyExtraPC3926 : Artifact.submissionArtifact.instructionPC 3896 = 5154 := by rfl
@[simp] theorem earlyExtraPC3927 : Artifact.submissionArtifact.instructionPC 3897 = 5155 := by rfl
@[simp] theorem earlyExtraPC3928 : Artifact.submissionArtifact.instructionPC 3898 = 5156 := by rfl
