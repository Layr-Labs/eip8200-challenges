...
def csFixedStep8_1 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3817 2 8448,
   ...
   opAt 3823 .GT,
   opAt 3824 (.Swap ⟨1, by decide⟩),
   opAt 3825 .SUB,
   opAt 3826 (.Dup ⟨2, by decide⟩),
   opAt 3827 (.Dup ⟨1, by decide⟩),
   opAt 3828 .SUB,
   opAt 3829 (.Swap ⟨2, by decide⟩),
   opAt 3830 .GT,
   opAt 3831 .OR,
...
def csFixedStep8_2 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3835 2 8416,
   ...
   opAt 3841 .GT,
   opAt 3842 (.Swap ⟨1, by decide⟩),
   opAt 3843 .SUB,
   opAt 3844 (.Dup ⟨2, by decide⟩),
   opAt 3845 (.Dup ⟨1, by decide⟩),
   opAt 3846 .SUB,
   opAt 3847 (.Swap ⟨2, by decide⟩),
   opAt 3848 .GT,
   opAt 3849 .OR,
   opAt 3850 (.Swap ⟨0, by decide⟩),
   pushAt 3851 2 7328,
   opAt 3852 .MSTORE]
...
def csFixedStep8_4 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3871 .JUMPDEST,
   ...
   opAt 3880 .SUB,
   opAt 3881 (.Dup ⟨2, by decide⟩),
   opAt 3882 (.Dup ⟨1, by decide⟩),
   opAt 3883 .SUB,
   opAt 3884 (.Swap ⟨2, by decide⟩),
   opAt 3885 .GT,
   opAt 3886 .OR,
   opAt 3887 (.Swap ⟨0, by decide⟩),
   pushAt 3888 2 7264,
   opAt 3889 .MSTORE]
...
def csFixedStep4_0 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 4001 2 8352,
   ...
   pushAt 4003 1 96,
   opAt 4004 .MLOAD,
   opAt 4005 (.Dup ⟨1, by decide⟩),
   opAt 4006 (.Dup ⟨1, by decide⟩),
   opAt 4007 .GT,
   opAt 4008 (.Swap ⟨1, by decide⟩),
   opAt 4009 .SUB,
   pushAt 4010 2 7264,
   opAt 4011 .MSTORE,
   pushAt 4012 2 5134,
...
@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3778 = 4976 := by rfl

@[simp] theorem fixedJump4976 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4976 = true := by
  simpa only [Artifact.instructionPC, fixedPC3778] using Artifact.isValidJumpDest_index 3778 (by rfl)

@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3779 = 4977 := by
  calc
    Artifact.submissionArtifact.instructionPC 3779 =
        Artifact.submissionArtifact.instructionPC 3778 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3778 _ (by rfl)
    _ = 4977 := by rw [fixedPC3778]; rfl

@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3780 = 4980 := by
  calc
    Artifact.submissionArtifact.instructionPC 3780 =
        Artifact.submissionArtifact.instructionPC 3779 + (YulEvmCompiler.Instr.push 2 9344).bytes.length :=
...
@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3782 = 4984 := by
  calc
    Artifact.submissionArtifact.instructionPC 3782 =
        Artifact.submissionArtifact.instructionPC 3781 + (YulEvmCompiler.Instr.push 2 256).bytes.length :=
...
@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3783 = 4985 := by
  calc
    Artifact.submissionArtifact.instructionPC 3783 =
        Artifact.submissionArtifact.instructionPC 3782 + (YulEvmCompiler.Instr.op .EQ).bytes.length :=
...
@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3784 = 4988 := by
  calc
    Artifact.submissionArtifact.instructionPC 3784 =
        Artifact.submissionArtifact.instructionPC 3783 + (YulEvmCompiler.Instr.push 2 5024).bytes.length :=
...
@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3785 = 4989 := by
  calc
    Artifact.submissionArtifact.instructionPC 3785 =
        Artifact.submissionArtifact.instructionPC 3784 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
...
@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3786 = 4992 := by
  calc
    Artifact.submissionArtifact.instructionPC 3786 =
        Artifact.submissionArtifact.instructionPC 3785 + (YulEvmCompiler.Instr.push 2 9344).bytes.length :=
...
@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3788 = 4995 := by
  calc
...
@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3789 = 4996 := by
  calc
    Artifact.submissionArtifact.instructionPC 3789 =
        Artifact.submissionArtifact.instructionPC 3788 + (YulEvmCompiler.Instr.op .EQ).bytes.length :=
...
@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3790 = 4999 := by
  calc
    Artifact.submissionArtifact.instructionPC 3790 =
        Artifact.submissionArtifact.instructionPC 3789 + (YulEvmCompiler.Instr.push 2 5281).bytes.length :=
...
@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3791 = 5000 := by
  calc
    Artifact.submissionArtifact.instructionPC 3791 =
        Artifact.submissionArtifact.instructionPC 3790 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
...
@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3792 = 5003 := by
  calc
    Artifact.submissionArtifact.instructionPC 3792 =
        Artifact.submissionArtifact.instructionPC 3791 + (YulEvmCompiler.Instr.push 2 9440).bytes.length :=
...
@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3794 = 5007 := by
  calc
    Artifact.submissionArtifact.instructionPC 3794 =
        Artifact.submissionArtifact.instructionPC 3793 + (YulEvmCompiler.Instr.push 2 9408).bytes.length :=
...
@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3796 = 5009 := by
  calc
    Artifact.submissionArtifact.instructionPC 3796 =
        Artifact.submissionArtifact.instructionPC 3795 + (YulEvmCompiler.Instr.op (.Dup ⟨0, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3797 = 5012 := by
  calc
    Artifact.submissionArtifact.instructionPC 3797 =
        Artifact.submissionArtifact.instructionPC 3796 + (YulEvmCompiler.Instr.push 2 7168).bytes.length :=
...
@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3798 = 5013 := by
  calc
    Artifact.submissionArtifact.instructionPC 3798 =
        Artifact.submissionArtifact.instructionPC 3797 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
...
@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3799 = 5016 := by
  calc
    Artifact.submissionArtifact.instructionPC 3799 =
        Artifact.submissionArtifact.instructionPC 3798 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
...
@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3800 = 5017 := by
  calc
    Artifact.submissionArtifact.instructionPC 3800 =
        Artifact.submissionArtifact.instructionPC 3799 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
...
@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3802 = 5019 := by
  calc
    Artifact.submissionArtifact.instructionPC 3802 =
        Artifact.submissionArtifact.instructionPC 3801 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3801 _ (by rfl)
    _ = 5019 := by rw [fixedPC3801]; rfl

@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3803 = 5020 := by
  calc
    Artifact.submissionArtifact.instructionPC 3803 =
        Artifact.submissionArtifact.instructionPC 3802 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3804 = 5023 := by
  calc
    Artifact.submissionArtifact.instructionPC 3804 =
        Artifact.submissionArtifact.instructionPC 3803 + (YulEvmCompiler.Instr.push 2 2225).bytes.length :=
...
@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3805 = 5024 := by
  calc
    Artifact.submissionArtifact.instructionPC 3805 =
        Artifact.submissionArtifact.instructionPC 3804 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5024 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5024 = true := by
  simpa only [Artifact.instructionPC, fixedPC3805] using Artifact.isValidJumpDest_index 3805 (by rfl)

@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3806 = 5025 := by
  calc
    Artifact.submissionArtifact.instructionPC 3806 =
        Artifact.submissionArtifact.instructionPC 3805 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
...
@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3807 = 5028 := by
  calc
    Artifact.submissionArtifact.instructionPC 3807 =
        Artifact.submissionArtifact.instructionPC 3806 + (YulEvmCompiler.Instr.push 2 8480).bytes.length :=
...
@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3809 = 5031 := by
  calc
    Artifact.submissionArtifact.instructionPC 3809 =
        Artifact.submissionArtifact.instructionPC 3808 + (YulEvmCompiler.Instr.push 1 224).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3808 _ (by rfl)
    _ = 5031 := by rw [fixedPC3808]; rfl

@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3810 = 5032 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3813 = 5035 := by
  calc
...
@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3814 = 5036 := by
  calc
...
@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3815 = 5037 := by
  calc
...
@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3816 = 5040 := by
  calc
    Artifact.submissionArtifact.instructionPC 3816 =
        Artifact.submissionArtifact.instructionPC 3815 + (YulEvmCompiler.Instr.push 2 7392).bytes.length :=
...
@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3817 = 5041 := by
  calc
    Artifact.submissionArtifact.instructionPC 3817 =
        Artifact.submissionArtifact.instructionPC 3816 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
...
@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3818 = 5044 := by
  calc
    Artifact.submissionArtifact.instructionPC 3818 =
        Artifact.submissionArtifact.instructionPC 3817 + (YulEvmCompiler.Instr.push 2 8448).bytes.length :=
...
@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3820 = 5047 := by
  calc
    Artifact.submissionArtifact.instructionPC 3820 =
        Artifact.submissionArtifact.instructionPC 3819 + (YulEvmCompiler.Instr.push 1 192).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3819 _ (by rfl)
    _ = 5047 := by rw [fixedPC3819]; rfl

@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3821 = 5048 := by
  calc
...
@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3822 = 5049 := by
  calc
...
@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3823 = 5050 := by
  calc
...
@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3824 = 5051 := by
  calc
...
@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3825 = 5052 := by
  calc
    Artifact.submissionArtifact.instructionPC 3825 =
        Artifact.submissionArtifact.instructionPC 3824 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3824 _ (by rfl)
    _ = 5052 := by rw [fixedPC3824]; rfl

@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3826 = 5053 := by
  calc
...
@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3827 = 5054 := by
  calc
    Artifact.submissionArtifact.instructionPC 3827 =
        Artifact.submissionArtifact.instructionPC 3826 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3826 _ (by rfl)
    _ = 5054 := by rw [fixedPC3826]; rfl

@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3828 = 5055 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3830 = 5057 := by
  calc
    Artifact.submissionArtifact.instructionPC 3830 =
        Artifact.submissionArtifact.instructionPC 3829 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3829 _ (by rfl)
    _ = 5057 := by rw [fixedPC3829]; rfl

@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3831 = 5058 := by
  calc
    Artifact.submissionArtifact.instructionPC 3831 =
        Artifact.submissionArtifact.instructionPC 3830 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3830 _ (by rfl)
    _ = 5058 := by rw [fixedPC3830]; rfl

@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3832 = 5059 := by
  calc
...
@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3833 = 5060 := by
  calc
    Artifact.submissionArtifact.instructionPC 3833 =
        Artifact.submissionArtifact.instructionPC 3832 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3834 = 5063 := by
  calc
    Artifact.submissionArtifact.instructionPC 3834 =
        Artifact.submissionArtifact.instructionPC 3833 + (YulEvmCompiler.Instr.push 2 7360).bytes.length :=
...
@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3835 = 5064 := by
  calc
    Artifact.submissionArtifact.instructionPC 3835 =
        Artifact.submissionArtifact.instructionPC 3834 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
...
@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3836 = 5067 := by
  calc
    Artifact.submissionArtifact.instructionPC 3836 =
        Artifact.submissionArtifact.instructionPC 3835 + (YulEvmCompiler.Instr.push 2 8416).bytes.length :=
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3837 = 5068 := by
  calc
    Artifact.submissionArtifact.instructionPC 3837 =
        Artifact.submissionArtifact.instructionPC 3836 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
...
@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3838 = 5070 := by
  calc
    Artifact.submissionArtifact.instructionPC 3838 =
        Artifact.submissionArtifact.instructionPC 3837 + (YulEvmCompiler.Instr.push 1 160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3837 _ (by rfl)
    _ = 5070 := by rw [fixedPC3837]; rfl

@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3839 = 5071 := by
  calc
...
@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3840 = 5072 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3841 = 5073 := by
  calc
...
@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3842 = 5074 := by
  calc
    Artifact.submissionArtifact.instructionPC 3842 =
        Artifact.submissionArtifact.instructionPC 3841 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3841 _ (by rfl)
    _ = 5074 := by rw [fixedPC3841]; rfl

@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3843 = 5075 := by
  calc
    Artifact.submissionArtifact.instructionPC 3843 =
        Artifact.submissionArtifact.instructionPC 3842 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3842 _ (by rfl)
    _ = 5075 := by rw [fixedPC3842]; rfl

@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3844 = 5076 := by
  calc
...
@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3845 = 5077 := by
  calc
    Artifact.submissionArtifact.instructionPC 3845 =
        Artifact.submissionArtifact.instructionPC 3844 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3844 _ (by rfl)
    _ = 5077 := by rw [fixedPC3844]; rfl

@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3846 = 5078 := by
  calc
...
@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3848 = 5080 := by
  calc
    Artifact.submissionArtifact.instructionPC 3848 =
        Artifact.submissionArtifact.instructionPC 3847 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3847 _ (by rfl)
    _ = 5080 := by rw [fixedPC3847]; rfl

@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3849 = 5081 := by
  calc
...
@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3850 = 5082 := by
  calc
    Artifact.submissionArtifact.instructionPC 3850 =
        Artifact.submissionArtifact.instructionPC 3849 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3849 _ (by rfl)
    _ = 5082 := by rw [fixedPC3849]; rfl

@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3851 = 5083 := by
  calc
    Artifact.submissionArtifact.instructionPC 3851 =
        Artifact.submissionArtifact.instructionPC 3850 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3852 = 5086 := by
  calc
    Artifact.submissionArtifact.instructionPC 3852 =
        Artifact.submissionArtifact.instructionPC 3851 + (YulEvmCompiler.Instr.push 2 7328).bytes.length :=
...
@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3853 = 5087 := by
  calc
    Artifact.submissionArtifact.instructionPC 3853 =
        Artifact.submissionArtifact.instructionPC 3852 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
...
@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3854 = 5090 := by
  calc
    Artifact.submissionArtifact.instructionPC 3854 =
        Artifact.submissionArtifact.instructionPC 3853 + (YulEvmCompiler.Instr.push 2 8384).bytes.length :=
...
@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3856 = 5093 := by
  calc
    Artifact.submissionArtifact.instructionPC 3856 =
        Artifact.submissionArtifact.instructionPC 3855 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
...
@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3858 = 5095 := by
  calc
...
@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3859 = 5096 := by
  calc
...
@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3860 = 5097 := by
  calc
...
@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3861 = 5098 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3862 = 5099 := by
  calc
...
@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3863 = 5100 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3864 = 5101 := by
  calc
...
@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3868 = 5105 := by
  calc
...
@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3869 = 5106 := by
  calc
...
@[simp] theorem fixedPC3870 : Artifact.submissionArtifact.instructionPC 3870 = 5109 := by
  calc
    Artifact.submissionArtifact.instructionPC 3870 =
        Artifact.submissionArtifact.instructionPC 3869 + (YulEvmCompiler.Instr.push 2 7296).bytes.length :=
...
@[simp] theorem fixedJump5110 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5110 = true := by
  simpa only [Artifact.instructionPC, fixedPC3871] using Artifact.isValidJumpDest_index 3871 (by rfl)

@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3872 = 5111 := by
  calc
...
@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3873 = 5114 := by
  calc
    Artifact.submissionArtifact.instructionPC 3873 =
        Artifact.submissionArtifact.instructionPC 3872 + (YulEvmCompiler.Instr.push 2 8352).bytes.length :=
...
@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3875 = 5117 := by
  calc
    Artifact.submissionArtifact.instructionPC 3875 =
        Artifact.submissionArtifact.instructionPC 3874 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3877 = 5119 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3878 = 5120 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3879 = 5121 := by
  calc
...
@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3880 = 5122 := by
  calc
    Artifact.submissionArtifact.instructionPC 3880 =
        Artifact.submissionArtifact.instructionPC 3879 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3879 _ (by rfl)
    _ = 5122 := by rw [fixedPC3879]; rfl

@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3881 = 5123 := by
  calc
...
@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3882 = 5124 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3883 = 5125 := by
  calc
...
@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3887 = 5129 := by
  calc
...
@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3888 = 5130 := by
  calc
    Artifact.submissionArtifact.instructionPC 3888 =
        Artifact.submissionArtifact.instructionPC 3887 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3889 = 5133 := by
  calc
    Artifact.submissionArtifact.instructionPC 3889 =
        Artifact.submissionArtifact.instructionPC 3888 + (YulEvmCompiler.Instr.push 2 7264).bytes.length :=
...
@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3890 = 5134 := by
  calc
    Artifact.submissionArtifact.instructionPC 3890 =
        Artifact.submissionArtifact.instructionPC 3889 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
...
@[simp] theorem fixedJump5134 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5134 = true := by
  simpa only [Artifact.instructionPC, fixedPC3890] using Artifact.isValidJumpDest_index 3890 (by rfl)

@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3891 = 5135 := by
  calc
...
@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3892 = 5138 := by
  calc
    Artifact.submissionArtifact.instructionPC 3892 =
        Artifact.submissionArtifact.instructionPC 3891 + (YulEvmCompiler.Instr.push 2 8320).bytes.length :=
...
@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3894 = 5141 := by
  calc
    Artifact.submissionArtifact.instructionPC 3894 =
        Artifact.submissionArtifact.instructionPC 3893 + (YulEvmCompiler.Instr.push 1 64).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3893 _ (by rfl)
    _ = 5141 := by rw [fixedPC3893]; rfl

@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3895 = 5142 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3896 = 5143 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3897 = 5144 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3898 = 5145 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3899 = 5146 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3900 = 5147 := by
  calc
...
@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3901 = 5148 := by
  calc
...
@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3902 = 5149 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3905 = 5152 := by
  calc
...
@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3906 = 5153 := by
  calc
...
@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3907 = 5154 := by
  calc
...
@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3908 = 5157 := by
  calc
    Artifact.submissionArtifact.instructionPC 3908 =
        Artifact.submissionArtifact.instructionPC 3907 + (YulEvmCompiler.Instr.push 2 7232).bytes.length :=
...
@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3910 = 5161 := by
  calc
    Artifact.submissionArtifact.instructionPC 3910 =
        Artifact.submissionArtifact.instructionPC 3909 + (YulEvmCompiler.Instr.push 2 8288).bytes.length :=
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3913 = 5165 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3914 = 5166 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3915 = 5167 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3916 = 5168 := by
  calc
...
@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3917 = 5169 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3918 = 5170 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3919 = 5171 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3920 = 5172 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3923 = 5175 := by
  calc
...
@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3924 = 5176 := by
  calc
...
@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3925 = 5177 := by
  calc
...
@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3926 = 5180 := by
  calc
    Artifact.submissionArtifact.instructionPC 3926 =
        Artifact.submissionArtifact.instructionPC 3925 + (YulEvmCompiler.Instr.push 2 7200).bytes.length :=
...
@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3928 = 5184 := by
  calc
    Artifact.submissionArtifact.instructionPC 3928 =
        Artifact.submissionArtifact.instructionPC 3927 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
...
@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3930 = 5186 := by
  calc
    Artifact.submissionArtifact.instructionPC 3930 =
        Artifact.submissionArtifact.instructionPC 3929 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3932 = 5188 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3933 = 5189 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3934 = 5190 := by
  calc
...
@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3935 = 5191 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3936 = 5192 := by
  calc
...
@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3937 = 5193 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3938 = 5194 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3942 = 5198 := by
  calc
...
@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3943 = 5199 := by
  calc
...
@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3944 = 5202 := by
  calc
    Artifact.submissionArtifact.instructionPC 3944 =
        Artifact.submissionArtifact.instructionPC 3943 + (YulEvmCompiler.Instr.push 2 7168).bytes.length :=
...
@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3946 = 5204 := by
  calc
    Artifact.submissionArtifact.instructionPC 3946 =
        Artifact.submissionArtifact.instructionPC 3945 + (YulEvmCompiler.Instr.op .ISZERO).bytes.length :=
...
@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3947 = 5207 := by
  calc
    Artifact.submissionArtifact.instructionPC 3947 =
        Artifact.submissionArtifact.instructionPC 3946 + (YulEvmCompiler.Instr.push 2 8224).bytes.length :=
...
@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3949 = 5209 := by
  calc
    Artifact.submissionArtifact.instructionPC 3949 =
        Artifact.submissionArtifact.instructionPC 3948 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
...
@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3950 = 5212 := by
  calc
    Artifact.submissionArtifact.instructionPC 3950 =
        Artifact.submissionArtifact.instructionPC 3949 + (YulEvmCompiler.Instr.push 2 1087).bytes.length :=
...
@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3951 = 5213 := by
  calc
    Artifact.submissionArtifact.instructionPC 3951 =
        Artifact.submissionArtifact.instructionPC 3950 + (YulEvmCompiler.Instr.op .NOT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3950 _ (by rfl)
    _ = 5213 := by rw [fixedPC3950]; rfl

@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3952 = 5214 := by
  calc
    Artifact.submissionArtifact.instructionPC 3952 =
        Artifact.submissionArtifact.instructionPC 3951 + (YulEvmCompiler.Instr.op .MUL).bytes.length :=
...
@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3953 = 5217 := by
  calc
    Artifact.submissionArtifact.instructionPC 3953 =
        Artifact.submissionArtifact.instructionPC 3952 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
...
@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3954 = 5218 := by
  calc
    Artifact.submissionArtifact.instructionPC 3954 =
        Artifact.submissionArtifact.instructionPC 3953 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
...
@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3955 = 5221 := by
  calc
    Artifact.submissionArtifact.instructionPC 3955 =
        Artifact.submissionArtifact.instructionPC 3954 + (YulEvmCompiler.Instr.push 2 9344).bytes.length :=
...
@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3956 = 5222 := by
  calc
    Artifact.submissionArtifact.instructionPC 3956 =
        Artifact.submissionArtifact.instructionPC 3955 + (YulEvmCompiler.Instr.op .MLOAD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3955 _ (by rfl)
    _ = 5222 := by rw [fixedPC3955]; rfl

@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 3957 = 5223 := by
  calc
    Artifact.submissionArtifact.instructionPC 3957 =
        Artifact.submissionArtifact.instructionPC 3956 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3956 _ (by rfl)
    _ = 5223 := by rw [fixedPC3956]; rfl

@[simp] theorem fixedPC3958 : Artifact.submissionArtifact.instructionPC 3958 = 5224 := by
  calc
    Artifact.submissionArtifact.instructionPC 3958 =
        Artifact.submissionArtifact.instructionPC 3957 + (YulEvmCompiler.Instr.op .MCOPY).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3957 _ (by rfl)
    _ = 5224 := by rw [fixedPC3957]; rfl

@[simp] theorem fixedPC3959 : Artifact.submissionArtifact.instructionPC 3959 = 5225 := by
  calc
    Artifact.submissionArtifact.instructionPC 3959 =
        Artifact.submissionArtifact.instructionPC 3958 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5225 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5225 = true := by
  simpa only [Artifact.instructionPC, fixedPC3959] using Artifact.isValidJumpDest_index 3959 (by rfl)
...
@[simp] theorem fixedPC3961 : Artifact.submissionArtifact.instructionPC 3961 = 5227 := by
  calc
    Artifact.submissionArtifact.instructionPC 3961 =
        Artifact.submissionArtifact.instructionPC 3960 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3960 _ (by rfl)
    _ = 5227 := by rw [fixedPC3960]; rfl

@[simp] theorem fixedPC3962 : Artifact.submissionArtifact.instructionPC 3962 = 5228 := by
  calc
    Artifact.submissionArtifact.instructionPC 3962 =
        Artifact.submissionArtifact.instructionPC 3961 + (YulEvmCompiler.Instr.op .CALLDATALOAD).bytes.length :=
...
@[simp] theorem fixedPC3963 : Artifact.submissionArtifact.instructionPC 3963 = 5230 := by
  calc
    Artifact.submissionArtifact.instructionPC 3963 =
        Artifact.submissionArtifact.instructionPC 3962 + (YulEvmCompiler.Instr.push 1 32).bytes.length :=
...
@[simp] theorem fixedPC3965 : Artifact.submissionArtifact.instructionPC 3965 = 5233 := by
  calc
    Artifact.submissionArtifact.instructionPC 3965 =
        Artifact.submissionArtifact.instructionPC 3964 + (YulEvmCompiler.Instr.push 1 64).bytes.length :=
...
@[simp] theorem fixedPC3967 : Artifact.submissionArtifact.instructionPC 3967 = 5236 := by
  calc
...
@[simp] theorem fixedPC3968 : Artifact.submissionArtifact.instructionPC 3968 = 5237 := by
  calc
...
@[simp] theorem fixedPC3969 : Artifact.submissionArtifact.instructionPC 3969 = 5238 := by
  calc
    Artifact.submissionArtifact.instructionPC 3969 =
        Artifact.submissionArtifact.instructionPC 3968 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
...
@[simp] theorem fixedPC3971 : Artifact.submissionArtifact.instructionPC 3971 = 5241 := by
  calc
    Artifact.submissionArtifact.instructionPC 3971 =
        Artifact.submissionArtifact.instructionPC 3970 + (YulEvmCompiler.Instr.push 1 32).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3970 _ (by rfl)
    _ = 5241 := by rw [fixedPC3970]; rfl

@[simp] theorem fixedPC3972 : Artifact.submissionArtifact.instructionPC 3972 = 5242 := by
  calc
    Artifact.submissionArtifact.instructionPC 3972 =
        Artifact.submissionArtifact.instructionPC 3971 + (YulEvmCompiler.Instr.op .XOR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3971 _ (by rfl)
    _ = 5242 := by rw [fixedPC3971]; rfl

@[simp] theorem fixedPC3973 : Artifact.submissionArtifact.instructionPC 3973 = 5243 := by
  calc
    Artifact.submissionArtifact.instructionPC 3973 =
        Artifact.submissionArtifact.instructionPC 3972 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3972 _ (by rfl)
    _ = 5243 := by rw [fixedPC3972]; rfl

@[simp] theorem fixedPC3974 : Artifact.submissionArtifact.instructionPC 3974 = 5244 := by
  calc
    Artifact.submissionArtifact.instructionPC 3974 =
        Artifact.submissionArtifact.instructionPC 3973 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3975 : Artifact.submissionArtifact.instructionPC 3975 = 5246 := by
  calc
    Artifact.submissionArtifact.instructionPC 3975 =
        Artifact.submissionArtifact.instructionPC 3974 + (YulEvmCompiler.Instr.push 1 32).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3974 _ (by rfl)
    _ = 5246 := by rw [fixedPC3974]; rfl

@[simp] theorem fixedPC3976 : Artifact.submissionArtifact.instructionPC 3976 = 5247 := by
  calc
    Artifact.submissionArtifact.instructionPC 3976 =
        Artifact.submissionArtifact.instructionPC 3975 + (YulEvmCompiler.Instr.op .XOR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3975 _ (by rfl)
    _ = 5247 := by rw [fixedPC3975]; rfl

@[simp] theorem fixedPC3977 : Artifact.submissionArtifact.instructionPC 3977 = 5248 := by
  calc
    Artifact.submissionArtifact.instructionPC 3977 =
        Artifact.submissionArtifact.instructionPC 3976 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
...
@[simp] theorem fixedPC3978 : Artifact.submissionArtifact.instructionPC 3978 = 5251 := by
  calc
    Artifact.submissionArtifact.instructionPC 3978 =
        Artifact.submissionArtifact.instructionPC 3977 + (YulEvmCompiler.Instr.push 2 5273).bytes.length :=
...
@[simp] theorem fixedPC3979 : Artifact.submissionArtifact.instructionPC 3979 = 5252 := by
  calc
    Artifact.submissionArtifact.instructionPC 3979 =
        Artifact.submissionArtifact.instructionPC 3978 + (YulEvmCompiler.Instr.op .JUMPI).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3978 _ (by rfl)
    _ = 5252 := by rw [fixedPC3978]; rfl

@[simp] theorem fixedPC3980 : Artifact.submissionArtifact.instructionPC 3980 = 5253 := by
  calc
...
@[simp] theorem fixedPC3981 : Artifact.submissionArtifact.instructionPC 3981 = 5255 := by
  calc
    Artifact.submissionArtifact.instructionPC 3981 =
        Artifact.submissionArtifact.instructionPC 3980 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
...
@[simp] theorem fixedPC3983 : Artifact.submissionArtifact.instructionPC 3983 = 5257 := by
  calc
    Artifact.submissionArtifact.instructionPC 3983 =
        Artifact.submissionArtifact.instructionPC 3982 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3982 _ (by rfl)
    _ = 5257 := by rw [fixedPC3982]; rfl

@[simp] theorem fixedPC3984 : Artifact.submissionArtifact.instructionPC 3984 = 5258 := by
  calc
...
@[simp] theorem fixedPC3985 : Artifact.submissionArtifact.instructionPC 3985 = 5259 := by
  calc
    Artifact.submissionArtifact.instructionPC 3985 =
        Artifact.submissionArtifact.instructionPC 3984 + (YulEvmCompiler.Instr.op .ADD).bytes.length :=
...
@[simp] theorem fixedPC3986 : Artifact.submissionArtifact.instructionPC 3986 = 5262 := by
  calc
    Artifact.submissionArtifact.instructionPC 3986 =
        Artifact.submissionArtifact.instructionPC 3985 + (YulEvmCompiler.Instr.push 2 1267).bytes.length :=
...
@[simp] theorem fixedPC3988 : Artifact.submissionArtifact.instructionPC 3988 = 5264 := by
  calc
    Artifact.submissionArtifact.instructionPC 3988 =
        Artifact.submissionArtifact.instructionPC 3987 + (YulEvmCompiler.Instr.op (.Dup ⟨3, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3989 : Artifact.submissionArtifact.instructionPC 3989 = 5266 := by
  calc
    Artifact.submissionArtifact.instructionPC 3989 =
        Artifact.submissionArtifact.instructionPC 3988 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
...
@[simp] theorem fixedPC3990 : Artifact.submissionArtifact.instructionPC 3990 = 5267 := by
  calc
    Artifact.submissionArtifact.instructionPC 3990 =
        Artifact.submissionArtifact.instructionPC 3989 + (YulEvmCompiler.Instr.op (.Dup ⟨6, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3991 : Artifact.submissionArtifact.instructionPC 3991 = 5268 := by
  calc
    Artifact.submissionArtifact.instructionPC 3991 =
        Artifact.submissionArtifact.instructionPC 3990 + (YulEvmCompiler.Instr.op (.Dup ⟨8, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3992 : Artifact.submissionArtifact.instructionPC 3992 = 5269 := by
  calc
    Artifact.submissionArtifact.instructionPC 3992 =
        Artifact.submissionArtifact.instructionPC 3991 + (YulEvmCompiler.Instr.op (.Dup ⟨10, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC3993 : Artifact.submissionArtifact.instructionPC 3993 = 5272 := by
  calc
    Artifact.submissionArtifact.instructionPC 3993 =
        Artifact.submissionArtifact.instructionPC 3992 + (YulEvmCompiler.Instr.push 2 4886).bytes.length :=
...
@[simp] theorem fixedPC3994 : Artifact.submissionArtifact.instructionPC 3994 = 5273 := by
  calc
    Artifact.submissionArtifact.instructionPC 3994 =
        Artifact.submissionArtifact.instructionPC 3993 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5273 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5273 = true := by
  simpa only [Artifact.instructionPC, fixedPC3994] using Artifact.isValidJumpDest_index 3994 (by rfl)
...
@[simp] theorem fixedPC3995 : Artifact.submissionArtifact.instructionPC 3995 = 5274 := by
  calc
    Artifact.submissionArtifact.instructionPC 3995 =
        Artifact.submissionArtifact.instructionPC 3994 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
...
@[simp] theorem fixedPC3996 : Artifact.submissionArtifact.instructionPC 3996 = 5275 := by
  calc
    Artifact.submissionArtifact.instructionPC 3996 =
        Artifact.submissionArtifact.instructionPC 3995 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3995 _ (by rfl)
    _ = 5275 := by rw [fixedPC3995]; rfl

@[simp] theorem fixedPC3997 : Artifact.submissionArtifact.instructionPC 3997 = 5276 := by
  calc
    Artifact.submissionArtifact.instructionPC 3997 =
        Artifact.submissionArtifact.instructionPC 3996 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3996 _ (by rfl)
    _ = 5276 := by rw [fixedPC3996]; rfl

@[simp] theorem fixedPC3998 : Artifact.submissionArtifact.instructionPC 3998 = 5277 := by
  calc
...
@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3999 = 5280 := by
  calc
    Artifact.submissionArtifact.instructionPC 3999 =
        Artifact.submissionArtifact.instructionPC 3998 + (YulEvmCompiler.Instr.push 2 1314).bytes.length :=
...
@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 4000 = 5281 := by
  calc
    Artifact.submissionArtifact.instructionPC 4000 =
        Artifact.submissionArtifact.instructionPC 3999 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5281 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5281 = true := by
  simpa only [Artifact.instructionPC, fixedPC4000] using Artifact.isValidJumpDest_index 4000 (by rfl)

@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 4001 = 5282 := by
  calc
    Artifact.submissionArtifact.instructionPC 4001 =
        Artifact.submissionArtifact.instructionPC 4000 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
...
@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 4002 = 5285 := by
  calc
    Artifact.submissionArtifact.instructionPC 4002 =
        Artifact.submissionArtifact.instructionPC 4001 + (YulEvmCompiler.Instr.push 2 8352).bytes.length :=
...
@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 4004 = 5288 := by
  calc
    Artifact.submissionArtifact.instructionPC 4004 =
        Artifact.submissionArtifact.instructionPC 4003 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4003 _ (by rfl)
    _ = 5288 := by rw [fixedPC4003]; rfl

@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 4005 = 5289 := by
  calc
...
@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 4006 = 5290 := by
  calc
    Artifact.submissionArtifact.instructionPC 4006 =
        Artifact.submissionArtifact.instructionPC 4005 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
...
@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 4008 = 5292 := by
  calc
    Artifact.submissionArtifact.instructionPC 4008 =
        Artifact.submissionArtifact.instructionPC 4007 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4007 _ (by rfl)
    _ = 5292 := by rw [fixedPC4007]; rfl

@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 4009 = 5293 := by
  calc
    Artifact.submissionArtifact.instructionPC 4009 =
        Artifact.submissionArtifact.instructionPC 4008 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 4008 _ (by rfl)
    _ = 5293 := by rw [fixedPC4008]; rfl

@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 4010 = 5294 := by
  calc
    Artifact.submissionArtifact.instructionPC 4010 =
        Artifact.submissionArtifact.instructionPC 4009 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
...
@[simp] theorem fixedPC4011 : Artifact.submissionArtifact.instructionPC 4011 = 5297 := by
  calc
    Artifact.submissionArtifact.instructionPC 4011 =
        Artifact.submissionArtifact.instructionPC 4010 + (YulEvmCompiler.Instr.push 2 7264).bytes.length :=
...
@[simp] theorem fixedPC4012 : Artifact.submissionArtifact.instructionPC 4012 = 5298 := by
  calc
    Artifact.submissionArtifact.instructionPC 4012 =
        Artifact.submissionArtifact.instructionPC 4011 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
...
@[simp] theorem fixedPC4013 : Artifact.submissionArtifact.instructionPC 4013 = 5301 := by
  calc
    Artifact.submissionArtifact.instructionPC 4013 =
        Artifact.submissionArtifact.instructionPC 4012 + (YulEvmCompiler.Instr.push 2 5134).bytes.length :=
