...
@[simp] theorem fixedPC1619 : Artifact.submissionArtifact.instructionPC 1619 = 2224 := by
  calc
    Artifact.submissionArtifact.instructionPC 1619 =
        Artifact.submissionArtifact.instructionPC 1618 + (YulEvmCompiler.Instr.push 2 4971).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 1618 _ (by rfl)
    _ = 2224 := by rw [fixedPC1618]; rfl

@[simp] theorem fixedPC3775 : Artifact.submissionArtifact.instructionPC 3773 = 4971 := by rfl

@[simp] theorem fixedJump4971 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4971 = true := by
  simpa only [Artifact.instructionPC, fixedPC3775] using Artifact.isValidJumpDest_index 3773 (by rfl)

@[simp] theorem fixedPC3776 : Artifact.submissionArtifact.instructionPC 3774 = 4972 := by
  calc
    ...
    _ = 4972 := by rw [fixedPC3775]; rfl

@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3775 = 4975 := by
  calc
    ...
    _ = 4975 := by rw [fixedPC3776]; rfl

@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3776 = 4976 := by
  calc
    ...
    _ = 4976 := by rw [fixedPC3777]; rfl

@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3777 = 4979 := by
  calc
    ...
    _ = 4979 := by rw [fixedPC3778]; rfl

@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3778 = 4980 := by
  calc
...
@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3779 = 4983 := by
  calc
    Artifact.submissionArtifact.instructionPC 3779 =
        Artifact.submissionArtifact.instructionPC 3778 + (YulEvmCompiler.Instr.push 2 5019).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3778 _ (by rfl)
    _ = 4983 := by rw [fixedPC3780]; rfl

@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3780 = 4984 := by
  calc
...
@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3781 = 4987 := by
  calc
    ...
    _ = 4987 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3782 = 4988 := by
  calc
...
@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3783 = 4990 := by
  calc
    ...
    _ = 4990 := by rw [fixedPC3784]; rfl

@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3784 = 4991 := by
  calc
    ...
    _ = 4991 := by rw [fixedPC3785]; rfl

@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3785 = 4994 := by
  calc
    Artifact.submissionArtifact.instructionPC 3785 =
        Artifact.submissionArtifact.instructionPC 3784 + (YulEvmCompiler.Instr.push 2 5276).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3784 _ (by rfl)
    _ = 4994 := by rw [fixedPC3786]; rfl

@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3786 = 4995 := by
  calc
...
@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3787 = 4998 := by
  calc
    ...
    _ = 4998 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3788 = 4999 := by
  calc
...
@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3789 = 5002 := by
  calc
...
@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3790 = 5003 := by
  calc
...
@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3791 = 5004 := by
  calc
...
@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3792 = 5007 := by
  calc
...
@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3793 = 5008 := by
  calc
...
@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3794 = 5011 := by
  calc
...
@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3795 = 5012 := by
  calc
...
@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3796 = 5013 := by
  calc
...
@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3797 = 5014 := by
  calc
...
@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3798 = 5015 := by
  calc
...
@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3799 = 5018 := by
  calc
...
@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3800 = 5019 := by
  calc
...
@[simp] theorem fixedJump5019 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5019 = true := by
  simpa only [Artifact.instructionPC, fixedPC3802] using Artifact.isValidJumpDest_index 3800 (by rfl)

@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3801 = 5020 := by
  calc
...
@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3802 = 5023 := by
  calc
...
@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3803 = 5024 := by
  calc
...
@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3804 = 5026 := by
  calc
...
@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3805 = 5027 := by
  calc
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3806 = 5028 := by
  calc
...
@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3807 = 5029 := by
  calc
...
@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3808 = 5030 := by
  calc
...
@[simp] theorem fixedPC3811 : Artifact.submissionArtifact.instructionPC 3809 = 5031 := by
  calc
...
@[simp] theorem fixedPC3812 : Artifact.submissionArtifact.instructionPC 3810 = 5032 := by
  calc
...
@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3811 = 5035 := by
  calc
...
@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3812 = 5036 := by
  calc
...
@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3813 = 5039 := by
  calc
...
@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3814 = 5040 := by
  calc
...
@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3815 = 5042 := by
  calc
...
@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3816 = 5043 := by
  calc
...
@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3817 = 5044 := by
  calc
...
@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3818 = 5045 := by
  calc
...
@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3819 = 5046 := by
  calc
...
@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3820 = 5047 := by
  calc
...
@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3821 = 5048 := by
  calc
...
@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3822 = 5049 := by
  calc
...
@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3823 = 5050 := by
  calc
...
@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3824 = 5051 := by
  calc
...
@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3825 = 5052 := by
  calc
...
@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3826 = 5053 := by
  calc
...
@[simp] theorem fixedPC3829 : Artifact.submissionArtifact.instructionPC 3827 = 5054 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3828 = 5055 := by
  calc
...
@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3829 = 5058 := by
  calc
...
@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3830 = 5059 := by
  calc
...
@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3831 = 5062 := by
  calc
...
@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3832 = 5063 := by
  calc
...
@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3833 = 5065 := by
  calc
...
@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3834 = 5066 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3835 = 5067 := by
  calc
...
@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3836 = 5068 := by
  calc
...
@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3837 = 5069 := by
  calc
...
@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3838 = 5070 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3839 = 5071 := by
  calc
...
@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3840 = 5072 := by
  calc
...
@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3841 = 5073 := by
  calc
...
@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3842 = 5074 := by
  calc
...
@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3843 = 5075 := by
  calc
...
@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3844 = 5076 := by
  calc
...
@[simp] theorem fixedPC3847 : Artifact.submissionArtifact.instructionPC 3845 = 5077 := by
  calc
...
@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3846 = 5078 := by
  calc
...
@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3847 = 5081 := by
  calc
...
@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3848 = 5082 := by
  calc
...
@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3849 = 5085 := by
  calc
...
@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3850 = 5086 := by
  calc
...
@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3851 = 5088 := by
  calc
...
@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3852 = 5089 := by
  calc
...
@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3853 = 5090 := by
  calc
...
@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3854 = 5091 := by
  calc
...
@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3855 = 5092 := by
  calc
...
@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3856 = 5093 := by
  calc
...
@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3857 = 5094 := by
  calc
...
@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3858 = 5095 := by
  calc
...
@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3859 = 5096 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3860 = 5097 := by
  calc
...
@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3861 = 5098 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3862 = 5099 := by
  calc
...
@[simp] theorem fixedPC3865 : Artifact.submissionArtifact.instructionPC 3863 = 5100 := by
  calc
...
@[simp] theorem fixedPC3866 : Artifact.submissionArtifact.instructionPC 3864 = 5101 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3865 = 5104 := by
  calc
...
@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3866 = 5105 := by
  calc
...
@[simp] theorem fixedJump5105 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5105 = true := by
  simpa only [Artifact.instructionPC, fixedPC3868] using Artifact.isValidJumpDest_index 3866 (by rfl)

@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3867 = 5106 := by
  calc
...
@[simp] theorem fixedPC3870 : Artifact.submissionArtifact.instructionPC 3868 = 5109 := by
  calc
...
@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3869 = 5110 := by
  calc
...
@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3870 = 5112 := by
  calc
...
@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3871 = 5113 := by
  calc
...
@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3872 = 5114 := by
  calc
...
@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3873 = 5115 := by
  calc
...
@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3874 = 5116 := by
  calc
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3875 = 5117 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3876 = 5118 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3877 = 5119 := by
  calc
...
@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3878 = 5120 := by
  calc
...
@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3879 = 5121 := by
  calc
...
@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3880 = 5122 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3881 = 5123 := by
  calc
...
@[simp] theorem fixedPC3884 : Artifact.submissionArtifact.instructionPC 3882 = 5124 := by
  calc
...
@[simp] theorem fixedPC3885 : Artifact.submissionArtifact.instructionPC 3883 = 5125 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3884 = 5128 := by
  calc
...
@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3885 = 5129 := by
  calc
...
@[simp] theorem fixedJump5129 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5129 = true := by
  simpa only [Artifact.instructionPC, fixedPC3887] using Artifact.isValidJumpDest_index 3885 (by rfl)

@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3886 = 5130 := by
  calc
...
@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3887 = 5133 := by
  calc
...
@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3888 = 5134 := by
  calc
...
@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3889 = 5136 := by
  calc
...
@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3890 = 5137 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3891 = 5138 := by
  calc
...
@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3892 = 5139 := by
  calc
...
@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3893 = 5140 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3894 = 5141 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3895 = 5142 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3896 = 5143 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3897 = 5144 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3898 = 5145 := by
  calc
...
@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3899 = 5146 := by
  calc
...
@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3900 = 5147 := by
  calc
...
@[simp] theorem fixedPC3903 : Artifact.submissionArtifact.instructionPC 3901 = 5148 := by
  calc
...
@[simp] theorem fixedPC3904 : Artifact.submissionArtifact.instructionPC 3902 = 5149 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3903 = 5152 := by
  calc
...
@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3904 = 5153 := by
  calc
...
@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3905 = 5156 := by
  calc
...
@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3906 = 5157 := by
  calc
...
@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3907 = 5159 := by
  calc
...
@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3908 = 5160 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3909 = 5161 := by
  calc
...
@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3910 = 5162 := by
  calc
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3911 = 5163 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3912 = 5164 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3913 = 5165 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3914 = 5166 := by
  calc
...
@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3915 = 5167 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3916 = 5168 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3917 = 5169 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3918 = 5170 := by
  calc
...
@[simp] theorem fixedPC3921 : Artifact.submissionArtifact.instructionPC 3919 = 5171 := by
  calc
...
@[simp] theorem fixedPC3922 : Artifact.submissionArtifact.instructionPC 3920 = 5172 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3921 = 5175 := by
  calc
...
@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3922 = 5176 := by
  calc
...
@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3923 = 5179 := by
  calc
...
@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3924 = 5180 := by
  calc
...
@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3925 = 5181 := by
  calc
...
@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3926 = 5182 := by
  calc
...
@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3927 = 5183 := by
  calc
...
@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3928 = 5184 := by
  calc
...
@[simp] theorem fixedPC3931 : Artifact.submissionArtifact.instructionPC 3929 = 5185 := by
  calc
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3930 = 5186 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3931 = 5187 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3932 = 5188 := by
  calc
...
@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3933 = 5189 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3934 = 5190 := by
  calc
...
@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3935 = 5191 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3936 = 5192 := by
  calc
...
@[simp] theorem fixedPC3939 : Artifact.submissionArtifact.instructionPC 3937 = 5193 := by
  calc
...
@[simp] theorem fixedPC3940 : Artifact.submissionArtifact.instructionPC 3938 = 5194 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3939 = 5197 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3940 = 5198 := by
  calc
...
@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3941 = 5199 := by
  calc
...
@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3942 = 5202 := by
  calc
...
@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3943 = 5203 := by
  calc
...
@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3944 = 5204 := by
  calc
...
@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3945 = 5207 := by
  calc
...
@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3946 = 5208 := by
  calc
...
@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3947 = 5209 := by
  calc
...
@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3948 = 5212 := by
  calc
...
@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3949 = 5213 := by
  calc
...
@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3950 = 5216 := by
  calc
...
@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3951 = 5217 := by
  calc
...
@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3952 = 5218 := by
  calc
...
@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3953 = 5219 := by
  calc
...
@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3954 = 5220 := by
  calc
...
@[simp] theorem fixedJump5220 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5220 = true := by
  simpa only [Artifact.instructionPC, fixedPC3956] using Artifact.isValidJumpDest_index 3954 (by rfl)

@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 3955 = 5221 := by
  calc
...
@[simp] theorem fixedPC3958 : Artifact.submissionArtifact.instructionPC 3956 = 5222 := by
  calc
    ...
    _ = 5222 := by rw [fixedPC3957]; rfl

@[simp] theorem fixedPC3959 : Artifact.submissionArtifact.instructionPC 3957 = 5223 := by
  calc
    ...
    _ = 5223 := by rw [fixedPC3958]; rfl

@[simp] theorem fixedPC3960 : Artifact.submissionArtifact.instructionPC 3958 = 5225 := by
  calc
    ...
    _ = 5225 := by rw [fixedPC3959]; rfl

@[simp] theorem fixedPC3961 : Artifact.submissionArtifact.instructionPC 3959 = 5226 := by
  calc
    ...
    _ = 5226 := by rw [fixedPC3960]; rfl

@[simp] theorem fixedPC3962 : Artifact.submissionArtifact.instructionPC 3960 = 5228 := by
  calc
...
@[simp] theorem fixedPC3963 : Artifact.submissionArtifact.instructionPC 3961 = 5229 := by
  calc
    ...
    _ = 5229 := by rw [fixedPC3962]; rfl

@[simp] theorem fixedPC3964 : Artifact.submissionArtifact.instructionPC 3962 = 5231 := by
  calc
...
@[simp] theorem fixedPC3965 : Artifact.submissionArtifact.instructionPC 3963 = 5232 := by
  calc
...
@[simp] theorem fixedPC3966 : Artifact.submissionArtifact.instructionPC 3964 = 5233 := by
  calc
    ...
    _ = 5233 := by rw [fixedPC3965]; rfl

@[simp] theorem fixedPC3967 : Artifact.submissionArtifact.instructionPC 3965 = 5234 := by
  calc
    ...
    _ = 5234 := by rw [fixedPC3966]; rfl

@[simp] theorem fixedPC3968 : Artifact.submissionArtifact.instructionPC 3966 = 5236 := by
  calc
...
@[simp] theorem fixedPC3969 : Artifact.submissionArtifact.instructionPC 3967 = 5237 := by
  calc
...
@[simp] theorem fixedPC3970 : Artifact.submissionArtifact.instructionPC 3968 = 5238 := by
  calc
    ...
    _ = 5238 := by rw [fixedPC3969]; rfl

@[simp] theorem fixedPC3971 : Artifact.submissionArtifact.instructionPC 3969 = 5239 := by
  calc
    ...
    _ = 5239 := by rw [fixedPC3970]; rfl

@[simp] theorem fixedPC3972 : Artifact.submissionArtifact.instructionPC 3970 = 5241 := by
  calc
...
@[simp] theorem fixedPC3973 : Artifact.submissionArtifact.instructionPC 3971 = 5242 := by
  calc
    ...
    _ = 5242 := by rw [fixedPC3972]; rfl

@[simp] theorem fixedPC3974 : Artifact.submissionArtifact.instructionPC 3972 = 5243 := by
  calc
    ...
    _ = 5243 := by rw [fixedPC3973]; rfl

@[simp] theorem fixedPC3975 : Artifact.submissionArtifact.instructionPC 3973 = 5246 := by
  calc
    Artifact.submissionArtifact.instructionPC 3973 =
        Artifact.submissionArtifact.instructionPC 3972 + (YulEvmCompiler.Instr.push 2 5268).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3972 _ (by rfl)
    _ = 5246 := by rw [fixedPC3974]; rfl

@[simp] theorem fixedPC3976 : Artifact.submissionArtifact.instructionPC 3974 = 5247 := by
  calc
...
@[simp] theorem fixedPC3977 : Artifact.submissionArtifact.instructionPC 3975 = 5248 := by
  calc
...
@[simp] theorem fixedPC3978 : Artifact.submissionArtifact.instructionPC 3976 = 5250 := by
  calc
...
@[simp] theorem fixedPC3979 : Artifact.submissionArtifact.instructionPC 3977 = 5251 := by
  calc
...
@[simp] theorem fixedPC3980 : Artifact.submissionArtifact.instructionPC 3978 = 5252 := by
  calc
...
@[simp] theorem fixedPC3981 : Artifact.submissionArtifact.instructionPC 3979 = 5253 := by
  calc
    ...
    _ = 5253 := by rw [fixedPC3980]; rfl

@[simp] theorem fixedPC3982 : Artifact.submissionArtifact.instructionPC 3980 = 5254 := by
  calc
    ...
    _ = 5254 := by rw [fixedPC3981]; rfl

@[simp] theorem fixedPC3983 : Artifact.submissionArtifact.instructionPC 3981 = 5257 := by
  calc
...
@[simp] theorem fixedPC3984 : Artifact.submissionArtifact.instructionPC 3982 = 5258 := by
  calc
...
@[simp] theorem fixedPC3985 : Artifact.submissionArtifact.instructionPC 3983 = 5259 := by
  calc
...
@[simp] theorem fixedPC3986 : Artifact.submissionArtifact.instructionPC 3984 = 5261 := by
  calc
...
@[simp] theorem fixedPC3987 : Artifact.submissionArtifact.instructionPC 3985 = 5262 := by
  calc
...
@[simp] theorem fixedPC3988 : Artifact.submissionArtifact.instructionPC 3986 = 5263 := by
  calc
    ...
    _ = 5263 := by rw [fixedPC3987]; rfl

@[simp] theorem fixedPC3989 : Artifact.submissionArtifact.instructionPC 3987 = 5264 := by
  calc
    ...
    _ = 5264 := by rw [fixedPC3988]; rfl

@[simp] theorem fixedPC3990 : Artifact.submissionArtifact.instructionPC 3988 = 5267 := by
  calc
    Artifact.submissionArtifact.instructionPC 3988 =
        Artifact.submissionArtifact.instructionPC 3987 + (YulEvmCompiler.Instr.push 2 4881).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3987 _ (by rfl)
    _ = 5267 := by rw [fixedPC3989]; rfl

@[simp] theorem fixedPC3991 : Artifact.submissionArtifact.instructionPC 3989 = 5268 := by
  calc
...
@[simp] theorem fixedJump5268 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5268 = true := by
  simpa only [Artifact.instructionPC, fixedPC3991] using Artifact.isValidJumpDest_index 3989 (by rfl)

@[simp] theorem fixedPC3992 : Artifact.submissionArtifact.instructionPC 3990 = 5269 := by
  calc
...
@[simp] theorem fixedPC3993 : Artifact.submissionArtifact.instructionPC 3991 = 5270 := by
  calc
...
@[simp] theorem fixedPC3994 : Artifact.submissionArtifact.instructionPC 3992 = 5271 := by
  calc
    ...
    _ = 5271 := by rw [fixedPC3993]; rfl

@[simp] theorem fixedPC3995 : Artifact.submissionArtifact.instructionPC 3993 = 5272 := by
  calc
    ...
    _ = 5272 := by rw [fixedPC3994]; rfl

@[simp] theorem fixedPC3996 : Artifact.submissionArtifact.instructionPC 3994 = 5275 := by
  calc
...
@[simp] theorem fixedPC3997 : Artifact.submissionArtifact.instructionPC 3995 = 5276 := by
  calc
...
@[simp] theorem fixedJump5276 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5276 = true := by
  simpa only [Artifact.instructionPC, fixedPC3997] using Artifact.isValidJumpDest_index 3995 (by rfl)

@[simp] theorem fixedPC3998 : Artifact.submissionArtifact.instructionPC 3996 = 5277 := by
  calc
...
@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3997 = 5280 := by
  calc
...
@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 3998 = 5281 := by
  calc
...
@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 3999 = 5283 := by
  calc
...
@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 4000 = 5284 := by
  calc
...
@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 4001 = 5285 := by
  calc
...
@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 4002 = 5286 := by
  calc
...
@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 4003 = 5287 := by
  calc
...
@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 4004 = 5288 := by
  calc
    ...
    _ = 5288 := by rw [fixedPC4005]; rfl

@[simp] theorem fixedPC4007 : Artifact.submissionArtifact.instructionPC 4005 = 5289 := by
  calc
    ...
    _ = 5289 := by rw [fixedPC4006]; rfl

@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 4006 = 5292 := by
  calc
...
@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 4007 = 5293 := by
  calc
...
@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 4008 = 5296 := by
  calc
    Artifact.submissionArtifact.instructionPC 4008 =
        Artifact.submissionArtifact.instructionPC 4007 + (YulEvmCompiler.Instr.push 2 5129).bytes.length :=
