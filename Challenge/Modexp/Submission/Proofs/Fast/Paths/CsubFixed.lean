...
def csFixedStep8_1 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3758 2 8448,
   ...
   opAt 3764 .GT,
   opAt 3765 (.Swap ⟨1, by decide⟩),
   opAt 3766 .SUB,
   opAt 3767 (.Dup ⟨2, by decide⟩),
   opAt 3768 (.Dup ⟨1, by decide⟩),
   opAt 3769 .SUB,
   opAt 3770 (.Swap ⟨2, by decide⟩),
   opAt 3771 .GT,
   opAt 3772 .OR,
   opAt 3773 (.Swap ⟨0, by decide⟩),
   pushAt 3774 2 7360,
   opAt 3775 .MSTORE]
...
def csFixedStep8_2 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3776 2 8416,
   ...
   opAt 3784 .SUB,
   opAt 3785 (.Dup ⟨2, by decide⟩),
   opAt 3786 (.Dup ⟨1, by decide⟩),
   opAt 3787 .SUB,
   opAt 3788 (.Swap ⟨2, by decide⟩),
   opAt 3789 .GT,
   opAt 3790 .OR,
...
def csFixedStep8_3 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3794 2 8384,
   ...
   opAt 3800 .GT,
   opAt 3801 (.Swap ⟨1, by decide⟩),
   opAt 3802 .SUB,
   opAt 3803 (.Dup ⟨2, by decide⟩),
   opAt 3804 (.Dup ⟨1, by decide⟩),
   opAt 3805 .SUB,
   opAt 3806 (.Swap ⟨2, by decide⟩),
   opAt 3807 .GT,
   opAt 3808 .OR,
...
def csFixedStep8_4 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3812 .JUMPDEST,
   ...
   opAt 3819 .GT,
   opAt 3820 (.Swap ⟨1, by decide⟩),
   opAt 3821 .SUB,
   opAt 3822 (.Dup ⟨2, by decide⟩),
   opAt 3823 (.Dup ⟨1, by decide⟩),
   opAt 3824 .SUB,
   opAt 3825 (.Swap ⟨2, by decide⟩),
   opAt 3826 .GT,
   opAt 3827 .OR,
   opAt 3828 (.Swap ⟨0, by decide⟩),
   pushAt 3829 2 7264,
   opAt 3830 .MSTORE]
...
def csFixedStep8_7 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 3868 2 8256,
   ...
   opAt 3874 .GT,
   opAt 3875 (.Swap ⟨1, by decide⟩),
   opAt 3876 .SUB,
   opAt 3877 (.Dup ⟨2, by decide⟩),
   opAt 3878 (.Dup ⟨1, by decide⟩),
   opAt 3879 .SUB,
   opAt 3880 (.Swap ⟨2, by decide⟩),
   opAt 3881 .GT,
   opAt 3882 .OR,
   opAt 3883 (.Swap ⟨0, by decide⟩),
   pushAt 3884 2 7168,
   opAt 3885 .MSTORE]
...
def csFixedTail8 : List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 3886 .ISZERO,
   ...
   opAt 3888 .MLOAD,
   opAt 3889 .OR,
   pushAt 3890 32 115792089237316195423570985008687907853269984665640564039457584007913129638848,
   opAt 3891 .MUL,
   pushAt 3892 2 8256,
   opAt 3893 .ADD,
   pushAt 3894 2 9344,
...
@[simp] theorem fixedPC3777 : Artifact.submissionArtifact.instructionPC 3719 = 4978 := by rfl
...
@[simp] theorem fixedPC3778 : Artifact.submissionArtifact.instructionPC 3720 = 4979 := by
  calc
...
@[simp] theorem fixedPC3779 : Artifact.submissionArtifact.instructionPC 3721 = 4982 := by
  calc
...
@[simp] theorem fixedPC3780 : Artifact.submissionArtifact.instructionPC 3722 = 4983 := by
  calc
...
@[simp] theorem fixedPC3781 : Artifact.submissionArtifact.instructionPC 3723 = 4986 := by
  calc
...
@[simp] theorem fixedPC3782 : Artifact.submissionArtifact.instructionPC 3724 = 4987 := by
  calc
...
@[simp] theorem fixedPC3783 : Artifact.submissionArtifact.instructionPC 3725 = 4990 := by
  calc
    Artifact.submissionArtifact.instructionPC 3725 =
        Artifact.submissionArtifact.instructionPC 3724 + (YulEvmCompiler.Instr.push 2 5026).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3724 _ (by rfl)
    _ = 4990 := by rw [fixedPC3782]; rfl

@[simp] theorem fixedPC3784 : Artifact.submissionArtifact.instructionPC 3726 = 4991 := by
  calc
...
@[simp] theorem fixedPC3785 : Artifact.submissionArtifact.instructionPC 3727 = 4994 := by
  calc
...
@[simp] theorem fixedPC3786 : Artifact.submissionArtifact.instructionPC 3728 = 4995 := by
  calc
...
@[simp] theorem fixedPC3787 : Artifact.submissionArtifact.instructionPC 3729 = 4997 := by
  calc
...
@[simp] theorem fixedPC3788 : Artifact.submissionArtifact.instructionPC 3730 = 4998 := by
  calc
...
@[simp] theorem fixedPC3789 : Artifact.submissionArtifact.instructionPC 3731 = 5001 := by
  calc
    Artifact.submissionArtifact.instructionPC 3731 =
        Artifact.submissionArtifact.instructionPC 3730 + (YulEvmCompiler.Instr.push 2 5312).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3730 _ (by rfl)
    _ = 5001 := by rw [fixedPC3788]; rfl

@[simp] theorem fixedPC3790 : Artifact.submissionArtifact.instructionPC 3732 = 5002 := by
  calc
...
@[simp] theorem fixedPC3791 : Artifact.submissionArtifact.instructionPC 3733 = 5005 := by
  calc
...
@[simp] theorem fixedPC3792 : Artifact.submissionArtifact.instructionPC 3734 = 5006 := by
  calc
...
@[simp] theorem fixedPC3793 : Artifact.submissionArtifact.instructionPC 3735 = 5009 := by
  calc
...
@[simp] theorem fixedPC3794 : Artifact.submissionArtifact.instructionPC 3736 = 5010 := by
  calc
...
@[simp] theorem fixedPC3795 : Artifact.submissionArtifact.instructionPC 3737 = 5011 := by
  calc
...
@[simp] theorem fixedPC3796 : Artifact.submissionArtifact.instructionPC 3738 = 5014 := by
  calc
...
@[simp] theorem fixedPC3797 : Artifact.submissionArtifact.instructionPC 3739 = 5015 := by
  calc
...
@[simp] theorem fixedPC3798 : Artifact.submissionArtifact.instructionPC 3740 = 5018 := by
  calc
    Artifact.submissionArtifact.instructionPC 3740 =
        Artifact.submissionArtifact.instructionPC 3739 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3739 _ (by rfl)
    _ = 5018 := by rw [fixedPC3797]; rfl

@[simp] theorem fixedPC3799 : Artifact.submissionArtifact.instructionPC 3741 = 5019 := by
  calc
    Artifact.submissionArtifact.instructionPC 3741 =
        Artifact.submissionArtifact.instructionPC 3740 + (YulEvmCompiler.Instr.op .POP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3740 _ (by rfl)
    _ = 5019 := by rw [fixedPC3798]; rfl

@[simp] theorem fixedPC3800 : Artifact.submissionArtifact.instructionPC 3742 = 5020 := by
  calc
    Artifact.submissionArtifact.instructionPC 3742 =
        Artifact.submissionArtifact.instructionPC 3741 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3741 _ (by rfl)
    _ = 5020 := by rw [fixedPC3799]; rfl

@[simp] theorem fixedPC3801 : Artifact.submissionArtifact.instructionPC 3743 = 5021 := by
  calc
    Artifact.submissionArtifact.instructionPC 3743 =
        Artifact.submissionArtifact.instructionPC 3742 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3742 _ (by rfl)
    _ = 5021 := by rw [fixedPC3800]; rfl

@[simp] theorem fixedPC3802 : Artifact.submissionArtifact.instructionPC 3744 = 5022 := by
  calc
    Artifact.submissionArtifact.instructionPC 3744 =
        Artifact.submissionArtifact.instructionPC 3743 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3743 _ (by rfl)
    _ = 5022 := by rw [fixedPC3801]; rfl

@[simp] theorem fixedPC3803 : Artifact.submissionArtifact.instructionPC 3745 = 5025 := by
  calc
    Artifact.submissionArtifact.instructionPC 3745 =
        Artifact.submissionArtifact.instructionPC 3744 + (YulEvmCompiler.Instr.push 2 2144).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3744 _ (by rfl)
    _ = 5025 := by rw [fixedPC3802]; rfl

@[simp] theorem fixedPC3804 : Artifact.submissionArtifact.instructionPC 3746 = 5026 := by
  calc
    Artifact.submissionArtifact.instructionPC 3746 =
        Artifact.submissionArtifact.instructionPC 3745 + (YulEvmCompiler.Instr.op .JUMP).bytes.length :=
...
@[simp] theorem fixedJump5023 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5026 = true := by
  simpa only [Artifact.instructionPC, fixedPC3804] using Artifact.isValidJumpDest_index 3746 (by rfl)

@[simp] theorem fixedPC3805 : Artifact.submissionArtifact.instructionPC 3747 = 5027 := by
  calc
...
@[simp] theorem fixedPC3806 : Artifact.submissionArtifact.instructionPC 3748 = 5030 := by
  calc
    Artifact.submissionArtifact.instructionPC 3748 =
        Artifact.submissionArtifact.instructionPC 3747 + (YulEvmCompiler.Instr.push 2 8480).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3747 _ (by rfl)
    _ = 5030 := by rw [fixedPC3805]; rfl

@[simp] theorem fixedPC3807 : Artifact.submissionArtifact.instructionPC 3749 = 5031 := by
  calc
...
@[simp] theorem fixedPC3808 : Artifact.submissionArtifact.instructionPC 3750 = 5033 := by
  calc
    Artifact.submissionArtifact.instructionPC 3750 =
        Artifact.submissionArtifact.instructionPC 3749 + (YulEvmCompiler.Instr.push 1 224).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3749 _ (by rfl)
    _ = 5033 := by rw [fixedPC3807]; rfl

@[simp] theorem fixedPC3809 : Artifact.submissionArtifact.instructionPC 3751 = 5034 := by
  calc
...
@[simp] theorem fixedPC3810 : Artifact.submissionArtifact.instructionPC 3752 = 5035 := by
  calc
...
@[simp] theorem fixedPC3811 : Artifact.submissionArtifact.instructionPC 3753 = 5036 := by
  calc
...
@[simp] theorem fixedPC3812 : Artifact.submissionArtifact.instructionPC 3754 = 5037 := by
  calc
    Artifact.submissionArtifact.instructionPC 3754 =
        Artifact.submissionArtifact.instructionPC 3753 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3753 _ (by rfl)
    _ = 5037 := by rw [fixedPC3811]; rfl

@[simp] theorem fixedPC3813 : Artifact.submissionArtifact.instructionPC 3755 = 5038 := by
  calc
    Artifact.submissionArtifact.instructionPC 3755 =
        Artifact.submissionArtifact.instructionPC 3754 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3754 _ (by rfl)
    _ = 5038 := by rw [fixedPC3812]; rfl

@[simp] theorem fixedPC3814 : Artifact.submissionArtifact.instructionPC 3756 = 5039 := by
  calc
    Artifact.submissionArtifact.instructionPC 3756 =
        Artifact.submissionArtifact.instructionPC 3755 + (YulEvmCompiler.Instr.op .SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3755 _ (by rfl)
    _ = 5039 := by rw [fixedPC3813]; rfl

@[simp] theorem fixedPC3815 : Artifact.submissionArtifact.instructionPC 3757 = 5042 := by
  calc
    Artifact.submissionArtifact.instructionPC 3757 =
        Artifact.submissionArtifact.instructionPC 3756 + (YulEvmCompiler.Instr.push 2 7392).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3756 _ (by rfl)
    _ = 5042 := by rw [fixedPC3814]; rfl

@[simp] theorem fixedPC3816 : Artifact.submissionArtifact.instructionPC 3758 = 5043 := by
  calc
    Artifact.submissionArtifact.instructionPC 3758 =
        Artifact.submissionArtifact.instructionPC 3757 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3757 _ (by rfl)
    _ = 5043 := by rw [fixedPC3815]; rfl

@[simp] theorem fixedPC3817 : Artifact.submissionArtifact.instructionPC 3759 = 5046 := by
  calc
    Artifact.submissionArtifact.instructionPC 3759 =
        Artifact.submissionArtifact.instructionPC 3758 + (YulEvmCompiler.Instr.push 2 8448).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3758 _ (by rfl)
    _ = 5046 := by rw [fixedPC3816]; rfl

@[simp] theorem fixedPC3818 : Artifact.submissionArtifact.instructionPC 3760 = 5047 := by
  calc
...
@[simp] theorem fixedPC3819 : Artifact.submissionArtifact.instructionPC 3761 = 5049 := by
  calc
    Artifact.submissionArtifact.instructionPC 3761 =
        Artifact.submissionArtifact.instructionPC 3760 + (YulEvmCompiler.Instr.push 1 192).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3760 _ (by rfl)
    _ = 5049 := by rw [fixedPC3818]; rfl

@[simp] theorem fixedPC3820 : Artifact.submissionArtifact.instructionPC 3762 = 5050 := by
  calc
...
@[simp] theorem fixedPC3821 : Artifact.submissionArtifact.instructionPC 3763 = 5051 := by
  calc
...
@[simp] theorem fixedPC3822 : Artifact.submissionArtifact.instructionPC 3764 = 5052 := by
  calc
    Artifact.submissionArtifact.instructionPC 3764 =
        Artifact.submissionArtifact.instructionPC 3763 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3763 _ (by rfl)
    _ = 5052 := by rw [fixedPC3821]; rfl

@[simp] theorem fixedPC3823 : Artifact.submissionArtifact.instructionPC 3765 = 5053 := by
  calc
...
@[simp] theorem fixedPC3824 : Artifact.submissionArtifact.instructionPC 3766 = 5054 := by
  calc
    Artifact.submissionArtifact.instructionPC 3766 =
        Artifact.submissionArtifact.instructionPC 3765 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3765 _ (by rfl)
    _ = 5054 := by rw [fixedPC3823]; rfl

@[simp] theorem fixedPC3825 : Artifact.submissionArtifact.instructionPC 3767 = 5055 := by
  calc
...
@[simp] theorem fixedPC3826 : Artifact.submissionArtifact.instructionPC 3768 = 5056 := by
  calc
    Artifact.submissionArtifact.instructionPC 3768 =
        Artifact.submissionArtifact.instructionPC 3767 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3767 _ (by rfl)
    _ = 5056 := by rw [fixedPC3825]; rfl

@[simp] theorem fixedPC3827 : Artifact.submissionArtifact.instructionPC 3769 = 5057 := by
  calc
...
@[simp] theorem fixedPC3828 : Artifact.submissionArtifact.instructionPC 3770 = 5058 := by
  calc
...
@[simp] theorem fixedPC3829 : Artifact.submissionArtifact.instructionPC 3771 = 5059 := by
  calc
...
@[simp] theorem fixedPC3830 : Artifact.submissionArtifact.instructionPC 3772 = 5060 := by
  calc
    Artifact.submissionArtifact.instructionPC 3772 =
        Artifact.submissionArtifact.instructionPC 3771 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3771 _ (by rfl)
    _ = 5060 := by rw [fixedPC3829]; rfl

@[simp] theorem fixedPC3831 : Artifact.submissionArtifact.instructionPC 3773 = 5061 := by
  calc
    Artifact.submissionArtifact.instructionPC 3773 =
        Artifact.submissionArtifact.instructionPC 3772 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3772 _ (by rfl)
    _ = 5061 := by rw [fixedPC3830]; rfl

@[simp] theorem fixedPC3832 : Artifact.submissionArtifact.instructionPC 3774 = 5062 := by
  calc
    Artifact.submissionArtifact.instructionPC 3774 =
        Artifact.submissionArtifact.instructionPC 3773 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3773 _ (by rfl)
    _ = 5062 := by rw [fixedPC3831]; rfl

@[simp] theorem fixedPC3833 : Artifact.submissionArtifact.instructionPC 3775 = 5065 := by
  calc
    Artifact.submissionArtifact.instructionPC 3775 =
        Artifact.submissionArtifact.instructionPC 3774 + (YulEvmCompiler.Instr.push 2 7360).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3774 _ (by rfl)
    _ = 5065 := by rw [fixedPC3832]; rfl

@[simp] theorem fixedPC3834 : Artifact.submissionArtifact.instructionPC 3776 = 5066 := by
  calc
    Artifact.submissionArtifact.instructionPC 3776 =
        Artifact.submissionArtifact.instructionPC 3775 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3775 _ (by rfl)
    _ = 5066 := by rw [fixedPC3833]; rfl

@[simp] theorem fixedPC3835 : Artifact.submissionArtifact.instructionPC 3777 = 5069 := by
  calc
    Artifact.submissionArtifact.instructionPC 3777 =
        Artifact.submissionArtifact.instructionPC 3776 + (YulEvmCompiler.Instr.push 2 8416).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3776 _ (by rfl)
    _ = 5069 := by rw [fixedPC3834]; rfl

@[simp] theorem fixedPC3836 : Artifact.submissionArtifact.instructionPC 3778 = 5070 := by
  calc
...
@[simp] theorem fixedPC3837 : Artifact.submissionArtifact.instructionPC 3779 = 5072 := by
  calc
    Artifact.submissionArtifact.instructionPC 3779 =
        Artifact.submissionArtifact.instructionPC 3778 + (YulEvmCompiler.Instr.push 1 160).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3778 _ (by rfl)
    _ = 5072 := by rw [fixedPC3836]; rfl

@[simp] theorem fixedPC3838 : Artifact.submissionArtifact.instructionPC 3780 = 5073 := by
  calc
...
@[simp] theorem fixedPC3839 : Artifact.submissionArtifact.instructionPC 3781 = 5074 := by
  calc
...
@[simp] theorem fixedPC3840 : Artifact.submissionArtifact.instructionPC 3782 = 5075 := by
  calc
...
@[simp] theorem fixedPC3841 : Artifact.submissionArtifact.instructionPC 3783 = 5076 := by
  calc
...
@[simp] theorem fixedPC3842 : Artifact.submissionArtifact.instructionPC 3784 = 5077 := by
  calc
...
@[simp] theorem fixedPC3843 : Artifact.submissionArtifact.instructionPC 3785 = 5078 := by
  calc
...
@[simp] theorem fixedPC3844 : Artifact.submissionArtifact.instructionPC 3786 = 5079 := by
  calc
    Artifact.submissionArtifact.instructionPC 3786 =
        Artifact.submissionArtifact.instructionPC 3785 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3785 _ (by rfl)
    _ = 5079 := by rw [fixedPC3843]; rfl

@[simp] theorem fixedPC3845 : Artifact.submissionArtifact.instructionPC 3787 = 5080 := by
  calc
...
@[simp] theorem fixedPC3846 : Artifact.submissionArtifact.instructionPC 3788 = 5081 := by
  calc
...
@[simp] theorem fixedPC3847 : Artifact.submissionArtifact.instructionPC 3789 = 5082 := by
  calc
    Artifact.submissionArtifact.instructionPC 3789 =
        Artifact.submissionArtifact.instructionPC 3788 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3788 _ (by rfl)
    _ = 5082 := by rw [fixedPC3846]; rfl

@[simp] theorem fixedPC3848 : Artifact.submissionArtifact.instructionPC 3790 = 5083 := by
  calc
    Artifact.submissionArtifact.instructionPC 3790 =
        Artifact.submissionArtifact.instructionPC 3789 + (YulEvmCompiler.Instr.op .GT).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3789 _ (by rfl)
    _ = 5083 := by rw [fixedPC3847]; rfl

@[simp] theorem fixedPC3849 : Artifact.submissionArtifact.instructionPC 3791 = 5084 := by
  calc
...
@[simp] theorem fixedPC3850 : Artifact.submissionArtifact.instructionPC 3792 = 5085 := by
  calc
    Artifact.submissionArtifact.instructionPC 3792 =
        Artifact.submissionArtifact.instructionPC 3791 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3791 _ (by rfl)
    _ = 5085 := by rw [fixedPC3849]; rfl

@[simp] theorem fixedPC3851 : Artifact.submissionArtifact.instructionPC 3793 = 5088 := by
  calc
    Artifact.submissionArtifact.instructionPC 3793 =
        Artifact.submissionArtifact.instructionPC 3792 + (YulEvmCompiler.Instr.push 2 7328).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3792 _ (by rfl)
    _ = 5088 := by rw [fixedPC3850]; rfl

@[simp] theorem fixedPC3852 : Artifact.submissionArtifact.instructionPC 3794 = 5089 := by
  calc
    Artifact.submissionArtifact.instructionPC 3794 =
        Artifact.submissionArtifact.instructionPC 3793 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3793 _ (by rfl)
    _ = 5089 := by rw [fixedPC3851]; rfl

@[simp] theorem fixedPC3853 : Artifact.submissionArtifact.instructionPC 3795 = 5092 := by
  calc
    Artifact.submissionArtifact.instructionPC 3795 =
        Artifact.submissionArtifact.instructionPC 3794 + (YulEvmCompiler.Instr.push 2 8384).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3794 _ (by rfl)
    _ = 5092 := by rw [fixedPC3852]; rfl

@[simp] theorem fixedPC3854 : Artifact.submissionArtifact.instructionPC 3796 = 5093 := by
  calc
...
@[simp] theorem fixedPC3855 : Artifact.submissionArtifact.instructionPC 3797 = 5095 := by
  calc
    Artifact.submissionArtifact.instructionPC 3797 =
        Artifact.submissionArtifact.instructionPC 3796 + (YulEvmCompiler.Instr.push 1 128).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3796 _ (by rfl)
    _ = 5095 := by rw [fixedPC3854]; rfl

@[simp] theorem fixedPC3856 : Artifact.submissionArtifact.instructionPC 3798 = 5096 := by
  calc
...
@[simp] theorem fixedPC3857 : Artifact.submissionArtifact.instructionPC 3799 = 5097 := by
  calc
...
@[simp] theorem fixedPC3858 : Artifact.submissionArtifact.instructionPC 3800 = 5098 := by
  calc
    Artifact.submissionArtifact.instructionPC 3800 =
        Artifact.submissionArtifact.instructionPC 3799 + (YulEvmCompiler.Instr.op (.Dup ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3799 _ (by rfl)
    _ = 5098 := by rw [fixedPC3857]; rfl

@[simp] theorem fixedPC3859 : Artifact.submissionArtifact.instructionPC 3801 = 5099 := by
  calc
...
@[simp] theorem fixedPC3860 : Artifact.submissionArtifact.instructionPC 3802 = 5100 := by
  calc
    Artifact.submissionArtifact.instructionPC 3802 =
        Artifact.submissionArtifact.instructionPC 3801 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3801 _ (by rfl)
    _ = 5100 := by rw [fixedPC3859]; rfl

@[simp] theorem fixedPC3861 : Artifact.submissionArtifact.instructionPC 3803 = 5101 := by
  calc
...
@[simp] theorem fixedPC3862 : Artifact.submissionArtifact.instructionPC 3804 = 5102 := by
  calc
    Artifact.submissionArtifact.instructionPC 3804 =
        Artifact.submissionArtifact.instructionPC 3803 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3803 _ (by rfl)
    _ = 5102 := by rw [fixedPC3861]; rfl

@[simp] theorem fixedPC3863 : Artifact.submissionArtifact.instructionPC 3805 = 5103 := by
  calc
...
@[simp] theorem fixedPC3864 : Artifact.submissionArtifact.instructionPC 3806 = 5104 := by
  calc
...
@[simp] theorem fixedPC3865 : Artifact.submissionArtifact.instructionPC 3807 = 5105 := by
  calc
    Artifact.submissionArtifact.instructionPC 3807 =
        Artifact.submissionArtifact.instructionPC 3806 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3806 _ (by rfl)
    _ = 5105 := by rw [fixedPC3864]; rfl

@[simp] theorem fixedPC3866 : Artifact.submissionArtifact.instructionPC 3808 = 5106 := by
  calc
...
@[simp] theorem fixedPC3867 : Artifact.submissionArtifact.instructionPC 3809 = 5107 := by
  calc
    Artifact.submissionArtifact.instructionPC 3809 =
        Artifact.submissionArtifact.instructionPC 3808 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3808 _ (by rfl)
    _ = 5107 := by rw [fixedPC3866]; rfl

@[simp] theorem fixedPC3868 : Artifact.submissionArtifact.instructionPC 3810 = 5108 := by
  calc
    Artifact.submissionArtifact.instructionPC 3810 =
        Artifact.submissionArtifact.instructionPC 3809 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3809 _ (by rfl)
    _ = 5108 := by rw [fixedPC3867]; rfl

@[simp] theorem fixedPC3869 : Artifact.submissionArtifact.instructionPC 3811 = 5111 := by
  calc
    Artifact.submissionArtifact.instructionPC 3811 =
        Artifact.submissionArtifact.instructionPC 3810 + (YulEvmCompiler.Instr.push 2 7296).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3810 _ (by rfl)
    _ = 5111 := by rw [fixedPC3868]; rfl

@[simp] theorem fixedPC3870 : Artifact.submissionArtifact.instructionPC 3812 = 5112 := by
  calc
...
@[simp] theorem fixedJump5109 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5112 = true := by
  simpa only [Artifact.instructionPC, fixedPC3870] using Artifact.isValidJumpDest_index 3812 (by rfl)

@[simp] theorem fixedPC3871 : Artifact.submissionArtifact.instructionPC 3813 = 5113 := by
  calc
    Artifact.submissionArtifact.instructionPC 3813 =
        Artifact.submissionArtifact.instructionPC 3812 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3812 _ (by rfl)
    _ = 5113 := by rw [fixedPC3870]; rfl

@[simp] theorem fixedPC3872 : Artifact.submissionArtifact.instructionPC 3814 = 5116 := by
  calc
    Artifact.submissionArtifact.instructionPC 3814 =
        Artifact.submissionArtifact.instructionPC 3813 + (YulEvmCompiler.Instr.push 2 8352).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3813 _ (by rfl)
    _ = 5116 := by rw [fixedPC3871]; rfl

@[simp] theorem fixedPC3873 : Artifact.submissionArtifact.instructionPC 3815 = 5117 := by
  calc
...
@[simp] theorem fixedPC3874 : Artifact.submissionArtifact.instructionPC 3816 = 5119 := by
  calc
    Artifact.submissionArtifact.instructionPC 3816 =
        Artifact.submissionArtifact.instructionPC 3815 + (YulEvmCompiler.Instr.push 1 96).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3815 _ (by rfl)
    _ = 5119 := by rw [fixedPC3873]; rfl

@[simp] theorem fixedPC3875 : Artifact.submissionArtifact.instructionPC 3817 = 5120 := by
  calc
...
@[simp] theorem fixedPC3876 : Artifact.submissionArtifact.instructionPC 3818 = 5121 := by
  calc
...
@[simp] theorem fixedPC3877 : Artifact.submissionArtifact.instructionPC 3819 = 5122 := by
  calc
...
@[simp] theorem fixedPC3878 : Artifact.submissionArtifact.instructionPC 3820 = 5123 := by
  calc
...
@[simp] theorem fixedPC3879 : Artifact.submissionArtifact.instructionPC 3821 = 5124 := by
  calc
    Artifact.submissionArtifact.instructionPC 3821 =
        Artifact.submissionArtifact.instructionPC 3820 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3820 _ (by rfl)
    _ = 5124 := by rw [fixedPC3878]; rfl

@[simp] theorem fixedPC3880 : Artifact.submissionArtifact.instructionPC 3822 = 5125 := by
  calc
...
@[simp] theorem fixedPC3881 : Artifact.submissionArtifact.instructionPC 3823 = 5126 := by
  calc
    Artifact.submissionArtifact.instructionPC 3823 =
        Artifact.submissionArtifact.instructionPC 3822 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3822 _ (by rfl)
    _ = 5126 := by rw [fixedPC3880]; rfl

@[simp] theorem fixedPC3882 : Artifact.submissionArtifact.instructionPC 3824 = 5127 := by
  calc
...
@[simp] theorem fixedPC3883 : Artifact.submissionArtifact.instructionPC 3825 = 5128 := by
  calc
...
@[simp] theorem fixedPC3884 : Artifact.submissionArtifact.instructionPC 3826 = 5129 := by
  calc
    Artifact.submissionArtifact.instructionPC 3826 =
        Artifact.submissionArtifact.instructionPC 3825 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3825 _ (by rfl)
    _ = 5129 := by rw [fixedPC3883]; rfl

@[simp] theorem fixedPC3885 : Artifact.submissionArtifact.instructionPC 3827 = 5130 := by
  calc
...
@[simp] theorem fixedPC3886 : Artifact.submissionArtifact.instructionPC 3828 = 5131 := by
  calc
    Artifact.submissionArtifact.instructionPC 3828 =
        Artifact.submissionArtifact.instructionPC 3827 + (YulEvmCompiler.Instr.op .OR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3827 _ (by rfl)
    _ = 5131 := by rw [fixedPC3885]; rfl

@[simp] theorem fixedPC3887 : Artifact.submissionArtifact.instructionPC 3829 = 5132 := by
  calc
    Artifact.submissionArtifact.instructionPC 3829 =
        Artifact.submissionArtifact.instructionPC 3828 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3828 _ (by rfl)
    _ = 5132 := by rw [fixedPC3886]; rfl

@[simp] theorem fixedPC3888 : Artifact.submissionArtifact.instructionPC 3830 = 5135 := by
  calc
    Artifact.submissionArtifact.instructionPC 3830 =
        Artifact.submissionArtifact.instructionPC 3829 + (YulEvmCompiler.Instr.push 2 7264).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3829 _ (by rfl)
    _ = 5135 := by rw [fixedPC3887]; rfl

@[simp] theorem fixedPC3889 : Artifact.submissionArtifact.instructionPC 3831 = 5136 := by
  calc
    Artifact.submissionArtifact.instructionPC 3831 =
        Artifact.submissionArtifact.instructionPC 3830 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
...
@[simp] theorem fixedJump5133 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5136 = true := by
  simpa only [Artifact.instructionPC, fixedPC3889] using Artifact.isValidJumpDest_index 3831 (by rfl)

@[simp] theorem fixedPC3890 : Artifact.submissionArtifact.instructionPC 3832 = 5137 := by
  calc
    Artifact.submissionArtifact.instructionPC 3832 =
        Artifact.submissionArtifact.instructionPC 3831 + (YulEvmCompiler.Instr.op .JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3831 _ (by rfl)
    _ = 5137 := by rw [fixedPC3889]; rfl

@[simp] theorem fixedPC3891 : Artifact.submissionArtifact.instructionPC 3833 = 5140 := by
  calc
    Artifact.submissionArtifact.instructionPC 3833 =
        Artifact.submissionArtifact.instructionPC 3832 + (YulEvmCompiler.Instr.push 2 8320).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3832 _ (by rfl)
    _ = 5140 := by rw [fixedPC3890]; rfl

@[simp] theorem fixedPC3892 : Artifact.submissionArtifact.instructionPC 3834 = 5141 := by
  calc
...
@[simp] theorem fixedPC3893 : Artifact.submissionArtifact.instructionPC 3835 = 5143 := by
  calc
    Artifact.submissionArtifact.instructionPC 3835 =
        Artifact.submissionArtifact.instructionPC 3834 + (YulEvmCompiler.Instr.push 1 64).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3834 _ (by rfl)
    _ = 5143 := by rw [fixedPC3892]; rfl

@[simp] theorem fixedPC3894 : Artifact.submissionArtifact.instructionPC 3836 = 5144 := by
  calc
...
@[simp] theorem fixedPC3895 : Artifact.submissionArtifact.instructionPC 3837 = 5145 := by
  calc
...
@[simp] theorem fixedPC3896 : Artifact.submissionArtifact.instructionPC 3838 = 5146 := by
  calc
...
@[simp] theorem fixedPC3897 : Artifact.submissionArtifact.instructionPC 3839 = 5147 := by
  calc
...
@[simp] theorem fixedPC3898 : Artifact.submissionArtifact.instructionPC 3840 = 5148 := by
  calc
...
@[simp] theorem fixedPC3899 : Artifact.submissionArtifact.instructionPC 3841 = 5149 := by
  calc
...
@[simp] theorem fixedPC3900 : Artifact.submissionArtifact.instructionPC 3842 = 5150 := by
  calc
...
@[simp] theorem fixedPC3901 : Artifact.submissionArtifact.instructionPC 3843 = 5151 := by
  calc
...
@[simp] theorem fixedPC3902 : Artifact.submissionArtifact.instructionPC 3844 = 5152 := by
  calc
...
@[simp] theorem fixedPC3903 : Artifact.submissionArtifact.instructionPC 3845 = 5153 := by
  calc
...
@[simp] theorem fixedPC3904 : Artifact.submissionArtifact.instructionPC 3846 = 5154 := by
  calc
...
@[simp] theorem fixedPC3905 : Artifact.submissionArtifact.instructionPC 3847 = 5155 := by
  calc
...
@[simp] theorem fixedPC3906 : Artifact.submissionArtifact.instructionPC 3848 = 5156 := by
  calc
...
@[simp] theorem fixedPC3907 : Artifact.submissionArtifact.instructionPC 3849 = 5159 := by
  calc
    Artifact.submissionArtifact.instructionPC 3849 =
        Artifact.submissionArtifact.instructionPC 3848 + (YulEvmCompiler.Instr.push 2 7232).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3848 _ (by rfl)
    _ = 5159 := by rw [fixedPC3906]; rfl

@[simp] theorem fixedPC3908 : Artifact.submissionArtifact.instructionPC 3850 = 5160 := by
  calc
...
@[simp] theorem fixedPC3909 : Artifact.submissionArtifact.instructionPC 3851 = 5163 := by
  calc
    Artifact.submissionArtifact.instructionPC 3851 =
        Artifact.submissionArtifact.instructionPC 3850 + (YulEvmCompiler.Instr.push 2 8288).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3850 _ (by rfl)
    _ = 5163 := by rw [fixedPC3908]; rfl

@[simp] theorem fixedPC3910 : Artifact.submissionArtifact.instructionPC 3852 = 5164 := by
  calc
...
@[simp] theorem fixedPC3911 : Artifact.submissionArtifact.instructionPC 3853 = 5166 := by
  calc
    Artifact.submissionArtifact.instructionPC 3853 =
        Artifact.submissionArtifact.instructionPC 3852 + (YulEvmCompiler.Instr.push 1 32).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3852 _ (by rfl)
    _ = 5166 := by rw [fixedPC3910]; rfl

@[simp] theorem fixedPC3912 : Artifact.submissionArtifact.instructionPC 3854 = 5167 := by
  calc
...
@[simp] theorem fixedPC3913 : Artifact.submissionArtifact.instructionPC 3855 = 5168 := by
  calc
...
@[simp] theorem fixedPC3914 : Artifact.submissionArtifact.instructionPC 3856 = 5169 := by
  calc
...
@[simp] theorem fixedPC3915 : Artifact.submissionArtifact.instructionPC 3857 = 5170 := by
  calc
...
@[simp] theorem fixedPC3916 : Artifact.submissionArtifact.instructionPC 3858 = 5171 := by
  calc
...
@[simp] theorem fixedPC3917 : Artifact.submissionArtifact.instructionPC 3859 = 5172 := by
  calc
...
@[simp] theorem fixedPC3918 : Artifact.submissionArtifact.instructionPC 3860 = 5173 := by
  calc
...
@[simp] theorem fixedPC3919 : Artifact.submissionArtifact.instructionPC 3861 = 5174 := by
  calc
...
@[simp] theorem fixedPC3920 : Artifact.submissionArtifact.instructionPC 3862 = 5175 := by
  calc
...
@[simp] theorem fixedPC3921 : Artifact.submissionArtifact.instructionPC 3863 = 5176 := by
  calc
...
@[simp] theorem fixedPC3922 : Artifact.submissionArtifact.instructionPC 3864 = 5177 := by
  calc
...
@[simp] theorem fixedPC3923 : Artifact.submissionArtifact.instructionPC 3865 = 5178 := by
  calc
...
@[simp] theorem fixedPC3924 : Artifact.submissionArtifact.instructionPC 3866 = 5179 := by
  calc
...
@[simp] theorem fixedPC3925 : Artifact.submissionArtifact.instructionPC 3867 = 5182 := by
  calc
    Artifact.submissionArtifact.instructionPC 3867 =
        Artifact.submissionArtifact.instructionPC 3866 + (YulEvmCompiler.Instr.push 2 7200).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3866 _ (by rfl)
    _ = 5182 := by rw [fixedPC3924]; rfl

@[simp] theorem fixedPC3926 : Artifact.submissionArtifact.instructionPC 3868 = 5183 := by
  calc
...
@[simp] theorem fixedPC3927 : Artifact.submissionArtifact.instructionPC 3869 = 5186 := by
  calc
    Artifact.submissionArtifact.instructionPC 3869 =
        Artifact.submissionArtifact.instructionPC 3868 + (YulEvmCompiler.Instr.push 2 8256).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3868 _ (by rfl)
    _ = 5186 := by rw [fixedPC3926]; rfl

@[simp] theorem fixedPC3928 : Artifact.submissionArtifact.instructionPC 3870 = 5187 := by
  calc
...
@[simp] theorem fixedPC3929 : Artifact.submissionArtifact.instructionPC 3871 = 5188 := by
  calc
    Artifact.submissionArtifact.instructionPC 3871 =
        Artifact.submissionArtifact.instructionPC 3870 + (YulEvmCompiler.Instr.push 0 0).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3870 _ (by rfl)
    _ = 5188 := by rw [fixedPC3928]; rfl

@[simp] theorem fixedPC3930 : Artifact.submissionArtifact.instructionPC 3872 = 5189 := by
  calc
...
@[simp] theorem fixedPC3931 : Artifact.submissionArtifact.instructionPC 3873 = 5190 := by
  calc
...
@[simp] theorem fixedPC3932 : Artifact.submissionArtifact.instructionPC 3874 = 5191 := by
  calc
...
@[simp] theorem fixedPC3933 : Artifact.submissionArtifact.instructionPC 3875 = 5192 := by
  calc
...
@[simp] theorem fixedPC3934 : Artifact.submissionArtifact.instructionPC 3876 = 5193 := by
  calc
    Artifact.submissionArtifact.instructionPC 3876 =
        Artifact.submissionArtifact.instructionPC 3875 + (YulEvmCompiler.Instr.op (.Swap ⟨1, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3875 _ (by rfl)
    _ = 5193 := by rw [fixedPC3933]; rfl

@[simp] theorem fixedPC3935 : Artifact.submissionArtifact.instructionPC 3877 = 5194 := by
  calc
...
@[simp] theorem fixedPC3936 : Artifact.submissionArtifact.instructionPC 3878 = 5195 := by
  calc
    Artifact.submissionArtifact.instructionPC 3878 =
        Artifact.submissionArtifact.instructionPC 3877 + (YulEvmCompiler.Instr.op (.Dup ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3877 _ (by rfl)
    _ = 5195 := by rw [fixedPC3935]; rfl

@[simp] theorem fixedPC3937 : Artifact.submissionArtifact.instructionPC 3879 = 5196 := by
  calc
...
@[simp] theorem fixedPC3938 : Artifact.submissionArtifact.instructionPC 3880 = 5197 := by
  calc
...
@[simp] theorem fixedPC3939 : Artifact.submissionArtifact.instructionPC 3881 = 5198 := by
  calc
    Artifact.submissionArtifact.instructionPC 3881 =
        Artifact.submissionArtifact.instructionPC 3880 + (YulEvmCompiler.Instr.op (.Swap ⟨2, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3880 _ (by rfl)
    _ = 5198 := by rw [fixedPC3938]; rfl

@[simp] theorem fixedPC3940 : Artifact.submissionArtifact.instructionPC 3882 = 5199 := by
  calc
...
@[simp] theorem fixedPC3941 : Artifact.submissionArtifact.instructionPC 3883 = 5200 := by
  calc
...
@[simp] theorem fixedPC3942 : Artifact.submissionArtifact.instructionPC 3884 = 5201 := by
  calc
    Artifact.submissionArtifact.instructionPC 3884 =
        Artifact.submissionArtifact.instructionPC 3883 + (YulEvmCompiler.Instr.op (.Swap ⟨0, by decide⟩)).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3883 _ (by rfl)
    _ = 5201 := by rw [fixedPC3941]; rfl

@[simp] theorem fixedPC3943 : Artifact.submissionArtifact.instructionPC 3885 = 5204 := by
  calc
    Artifact.submissionArtifact.instructionPC 3885 =
        Artifact.submissionArtifact.instructionPC 3884 + (YulEvmCompiler.Instr.push 2 7168).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3884 _ (by rfl)
    _ = 5204 := by rw [fixedPC3942]; rfl

@[simp] theorem fixedPC3944 : Artifact.submissionArtifact.instructionPC 3886 = 5205 := by
  calc
    Artifact.submissionArtifact.instructionPC 3886 =
        Artifact.submissionArtifact.instructionPC 3885 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3885 _ (by rfl)
    _ = 5205 := by rw [fixedPC3943]; rfl

@[simp] theorem fixedPC3945 : Artifact.submissionArtifact.instructionPC 3887 = 5206 := by
  calc
    Artifact.submissionArtifact.instructionPC 3887 =
        Artifact.submissionArtifact.instructionPC 3886 + (YulEvmCompiler.Instr.op .ISZERO).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3886 _ (by rfl)
    _ = 5206 := by rw [fixedPC3944]; rfl

@[simp] theorem fixedPC3946 : Artifact.submissionArtifact.instructionPC 3888 = 5209 := by
  calc
    Artifact.submissionArtifact.instructionPC 3888 =
        Artifact.submissionArtifact.instructionPC 3887 + (YulEvmCompiler.Instr.push 2 8224).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3887 _ (by rfl)
    _ = 5209 := by rw [fixedPC3945]; rfl

@[simp] theorem fixedPC3947 : Artifact.submissionArtifact.instructionPC 3889 = 5210 := by
  calc
...
@[simp] theorem fixedPC3948 : Artifact.submissionArtifact.instructionPC 3890 = 5211 := by
  calc
...
@[simp] theorem fixedPC3949 : Artifact.submissionArtifact.instructionPC 3891 = 5244 := by
  calc
    Artifact.submissionArtifact.instructionPC 3891 =
        Artifact.submissionArtifact.instructionPC 3890 + (YulEvmCompiler.Instr.push 32 115792089237316195423570985008687907853269984665640564039457584007913129638848).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3890 _ (by rfl)
    _ = 5244 := by rw [fixedPC3948]; rfl

@[simp] theorem fixedPC3950 : Artifact.submissionArtifact.instructionPC 3891 = 5244 :=
  fixedPC3949

@[simp] theorem fixedPC3951 : Artifact.submissionArtifact.instructionPC 3892 = 5245 := by
  calc
...
@[simp] theorem fixedPC3952 : Artifact.submissionArtifact.instructionPC 3893 = 5248 := by
  calc
...
@[simp] theorem fixedPC3953 : Artifact.submissionArtifact.instructionPC 3894 = 5249 := by
  calc
...
@[simp] theorem fixedPC3954 : Artifact.submissionArtifact.instructionPC 3895 = 5252 := by
  calc
...
@[simp] theorem fixedPC3955 : Artifact.submissionArtifact.instructionPC 3896 = 5253 := by
  calc
...
@[simp] theorem fixedPC3956 : Artifact.submissionArtifact.instructionPC 3897 = 5254 := by
  calc
...
@[simp] theorem fixedPC3957 : Artifact.submissionArtifact.instructionPC 3898 = 5255 := by
  calc
...
@[simp] theorem fixedPC3958 : Artifact.submissionArtifact.instructionPC 3899 = 5256 := by
  calc
...
@[simp] theorem fixedPC3959 : Artifact.submissionArtifact.instructionPC 3900 = 5257 := by
  calc
...
@[simp] theorem fixedPC3960 : Artifact.submissionArtifact.instructionPC 3901 = 5258 := by
  calc
...
@[simp] theorem fixedPC3961 : Artifact.submissionArtifact.instructionPC 3902 = 5259 := by
  calc
...
@[simp] theorem fixedPC3962 : Artifact.submissionArtifact.instructionPC 3903 = 5261 := by
  calc
...
@[simp] theorem fixedPC3963 : Artifact.submissionArtifact.instructionPC 3904 = 5262 := by
  calc
...
@[simp] theorem fixedPC3964 : Artifact.submissionArtifact.instructionPC 3905 = 5264 := by
  calc
...
@[simp] theorem fixedPC3965 : Artifact.submissionArtifact.instructionPC 3906 = 5265 := by
  calc
...
@[simp] theorem fixedPC3966 : Artifact.submissionArtifact.instructionPC 3907 = 5267 := by
  calc
...
@[simp] theorem fixedPC3967 : Artifact.submissionArtifact.instructionPC 3908 = 5268 := by
  calc
...
@[simp] theorem fixedPC3968 : Artifact.submissionArtifact.instructionPC 3909 = 5269 := by
  calc
...
@[simp] theorem fixedPC3969 : Artifact.submissionArtifact.instructionPC 3910 = 5270 := by
  calc
...
@[simp] theorem fixedPC3970 : Artifact.submissionArtifact.instructionPC 3911 = 5272 := by
  calc
...
@[simp] theorem fixedPC3971 : Artifact.submissionArtifact.instructionPC 3912 = 5273 := by
  calc
...
@[simp] theorem fixedPC3972 : Artifact.submissionArtifact.instructionPC 3913 = 5274 := by
  calc
...
@[simp] theorem fixedPC3973 : Artifact.submissionArtifact.instructionPC 3914 = 5275 := by
  calc
...
@[simp] theorem fixedPC3974 : Artifact.submissionArtifact.instructionPC 3915 = 5277 := by
  calc
...
@[simp] theorem fixedPC3975 : Artifact.submissionArtifact.instructionPC 3916 = 5278 := by
  calc
...
@[simp] theorem fixedPC3976 : Artifact.submissionArtifact.instructionPC 3917 = 5279 := by
  calc
...
@[simp] theorem fixedPC3977 : Artifact.submissionArtifact.instructionPC 3918 = 5282 := by
  calc
    Artifact.submissionArtifact.instructionPC 3918 =
        Artifact.submissionArtifact.instructionPC 3917 + (YulEvmCompiler.Instr.push 2 5304).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3917 _ (by rfl)
    _ = 5282 := by rw [fixedPC3976]; rfl

@[simp] theorem fixedPC3978 : Artifact.submissionArtifact.instructionPC 3919 = 5283 := by
  calc
...
@[simp] theorem fixedPC3979 : Artifact.submissionArtifact.instructionPC 3920 = 5284 := by
  calc
...
@[simp] theorem fixedPC3980 : Artifact.submissionArtifact.instructionPC 3921 = 5286 := by
  calc
...
@[simp] theorem fixedPC3981 : Artifact.submissionArtifact.instructionPC 3922 = 5287 := by
  calc
...
@[simp] theorem fixedPC3982 : Artifact.submissionArtifact.instructionPC 3923 = 5288 := by
  calc
...
@[simp] theorem fixedPC3983 : Artifact.submissionArtifact.instructionPC 3924 = 5289 := by
  calc
...
@[simp] theorem fixedPC3984 : Artifact.submissionArtifact.instructionPC 3925 = 5290 := by
  calc
...
@[simp] theorem fixedPC3985 : Artifact.submissionArtifact.instructionPC 3926 = 5293 := by
  calc
...
@[simp] theorem fixedPC3986 : Artifact.submissionArtifact.instructionPC 3927 = 5294 := by
  calc
...
@[simp] theorem fixedPC3987 : Artifact.submissionArtifact.instructionPC 3928 = 5295 := by
  calc
...
@[simp] theorem fixedPC3988 : Artifact.submissionArtifact.instructionPC 3929 = 5297 := by
  calc
...
@[simp] theorem fixedPC3989 : Artifact.submissionArtifact.instructionPC 3930 = 5298 := by
  calc
...
@[simp] theorem fixedPC3990 : Artifact.submissionArtifact.instructionPC 3931 = 5299 := by
  calc
...
@[simp] theorem fixedPC3991 : Artifact.submissionArtifact.instructionPC 3932 = 5300 := by
  calc
...
@[simp] theorem fixedPC3992 : Artifact.submissionArtifact.instructionPC 3933 = 5303 := by
  calc
    Artifact.submissionArtifact.instructionPC 3933 =
        Artifact.submissionArtifact.instructionPC 3932 + (YulEvmCompiler.Instr.push 2 4888).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3932 _ (by rfl)
    _ = 5303 := by rw [fixedPC3991]; rfl

@[simp] theorem fixedPC3993 : Artifact.submissionArtifact.instructionPC 3934 = 5304 := by
  calc
...
@[simp] theorem fixedPC3994 : Artifact.submissionArtifact.instructionPC 3935 = 5305 := by
  calc
...
@[simp] theorem fixedPC3995 : Artifact.submissionArtifact.instructionPC 3936 = 5306 := by
  calc
...
@[simp] theorem fixedPC3996 : Artifact.submissionArtifact.instructionPC 3937 = 5307 := by
  calc
...
@[simp] theorem fixedPC3997 : Artifact.submissionArtifact.instructionPC 3938 = 5308 := by
  calc
...
@[simp] theorem fixedPC3998 : Artifact.submissionArtifact.instructionPC 3939 = 5311 := by
  calc
    Artifact.submissionArtifact.instructionPC 3939 =
        Artifact.submissionArtifact.instructionPC 3938 + (YulEvmCompiler.Instr.push 2 1233).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3938 _ (by rfl)
    _ = 5311 := by rw [fixedPC3997]; rfl

@[simp] theorem fixedPC3999 : Artifact.submissionArtifact.instructionPC 3940 = 5312 := by
  calc
...
@[simp] theorem fixedJump5280 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5312 = true := by
  simpa only [Artifact.instructionPC, fixedPC3999] using Artifact.isValidJumpDest_index 3940 (by rfl)

@[simp] theorem fixedPC4000 : Artifact.submissionArtifact.instructionPC 3941 = 5313 := by
  calc
...
@[simp] theorem fixedPC4001 : Artifact.submissionArtifact.instructionPC 3942 = 5316 := by
  calc
    Artifact.submissionArtifact.instructionPC 3942 =
        Artifact.submissionArtifact.instructionPC 3941 + (YulEvmCompiler.Instr.push 2 8352).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3941 _ (by rfl)
    _ = 5316 := by rw [fixedPC4000]; rfl

@[simp] theorem fixedPC4002 : Artifact.submissionArtifact.instructionPC 3943 = 5317 := by
  calc
...
@[simp] theorem fixedPC4003 : Artifact.submissionArtifact.instructionPC 3944 = 5319 := by
  calc
...
@[simp] theorem fixedPC4004 : Artifact.submissionArtifact.instructionPC 3945 = 5320 := by
  calc
...
@[simp] theorem fixedPC4005 : Artifact.submissionArtifact.instructionPC 3946 = 5321 := by
  calc
...
@[simp] theorem fixedPC4006 : Artifact.submissionArtifact.instructionPC 3947 = 5322 := by
  calc
...
@[simp] theorem fixedPC4007 : Artifact.submissionArtifact.instructionPC 3948 = 5323 := by
  calc
...
@[simp] theorem fixedPC4008 : Artifact.submissionArtifact.instructionPC 3949 = 5324 := by
  calc
...
@[simp] theorem fixedPC4009 : Artifact.submissionArtifact.instructionPC 3950 = 5325 := by
  calc
...
@[simp] theorem fixedPC4010 : Artifact.submissionArtifact.instructionPC 3951 = 5328 := by
  calc
    Artifact.submissionArtifact.instructionPC 3951 =
        Artifact.submissionArtifact.instructionPC 3950 + (YulEvmCompiler.Instr.push 2 7264).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3950 _ (by rfl)
    _ = 5328 := by rw [fixedPC4009]; rfl

@[simp] theorem fixedPC4011 : Artifact.submissionArtifact.instructionPC 3952 = 5329 := by
  calc
    Artifact.submissionArtifact.instructionPC 3952 =
        Artifact.submissionArtifact.instructionPC 3951 + (YulEvmCompiler.Instr.op .MSTORE).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 3951 _ (by rfl)
    _ = 5329 := by rw [fixedPC4010]; rfl

@[simp] theorem fixedPC4012 : Artifact.submissionArtifact.instructionPC 3953 = 5332 := by
  calc
    Artifact.submissionArtifact.instructionPC 3953 =
        Artifact.submissionArtifact.instructionPC 3952 + (YulEvmCompiler.Instr.push 2 5136).bytes.length :=
