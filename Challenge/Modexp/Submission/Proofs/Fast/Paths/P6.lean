...
/-! Basic-block instruction paths, group 6 (instructions 1395..1367). -/
...
/-- Instructions 1395..1323, pc 1967..1976. -/
def blk1314 :
...
/-- Instructions 1401..1413, pc 1977..2001. -/
def blk1320 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 761 .JUMPDEST,
   opAt 762 .POP,
...
/-- Instructions 1462..1469, pc 2002..2011. -/
def blk1333 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 776 .JUMPDEST,
...
/-- Instructions 1470..1344, pc 2016..2016. -/
def blk1341 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 784 .JUMPDEST,
   opAt 785 .POP,
...
/- `blk1345` (the oversize bail target `BAIL3`, pristine instructions 1344..1349) is
...
/-- Instructions 1480..1488, pc 1897..2036. -/
def blk1351 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 788 .JUMPDEST,
   opAt 789 .POP,
...
/-- Instructions 1408..1361, pc 2037..2038. -/
def blk1360 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 797 .JUMPDEST,
   pushAt 798 2 256]

/-- Instructions 1362..1367, pc 2041..2051. -/
def blk1362 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 799 .JUMPDEST,
   pushAt 800 2 1189,
