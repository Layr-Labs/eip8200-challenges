...
/-- Instructions 1396..1324, pc 1967..1976. -/
def blk1314 :
...
/-- Instructions 1402..1414, pc 1977..2001. -/
def blk1320 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 763 .JUMPDEST,
   opAt 764 .POP,
...
/-- Instructions 1463..1470, pc 2002..2011. -/
def blk1333 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 778 .JUMPDEST,
...
/- `blk1345` (the oversize bail target `BAIL3`, pristine instructions 1344..1350) is
...
/-- Instructions 1481..1489, pc 1899..2036. -/
def blk1351 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 790 .JUMPDEST,
   opAt 791 .POP,
...
/-- Instructions 1363..1368, pc 2041..2051. -/
def blk1362 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 801 .JUMPDEST,
   pushAt 802 2 1190,
