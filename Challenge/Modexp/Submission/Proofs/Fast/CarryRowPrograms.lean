...
def middleStore : List Instr :=
  [.op (.Dup ⟨0, by decide⟩), .push 2 4128, .op .MLOAD, .op .ADD,
   .op (.Dup ⟨0, by decide⟩), .push 2 4128, .op .MSTORE, .op .LT,
   .op (.Swap ⟨0, by decide⟩), .op .POP]

def middle : List Instr := middleStore ++ CiosReadonly.cachedProduct

/-- The middle block with its leading `JUMPDEST` (pc 4334, the empty-chain entry). -/
