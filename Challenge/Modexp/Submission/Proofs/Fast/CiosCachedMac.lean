...
theorem run_l1Mac (pc : Nat) (off t : UInt256) (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    (hcap : rest.length ≤ 1002) (hact : 296 ≤ s.activeWords.toNat)
  ...
  have h := CiosCachedL1.run_step s (UInt256.ofNat pc) mem bi pa n j off t hoff ht
    ...
    (UInt256.ofNat (pb-32)) (l1Target n) (l2Target n) (modulusValue mem n) (inverseValue mem :: tailPointerValue mem :: pdst :: ret :: rest) (by simp only [List.length_cons]; omega) hact hn32 hj hpa hpaFit
...
theorem run_l1First (pc : Nat) (off t : UInt256) (s : State) (mem : ByteArray) (bi : UInt256)
  ...
  have h := CiosCachedL1.run_first s (UInt256.ofNat pc) mem bi pa n off t hoff ht
    (UInt256.ofNat (ptrAt (pb+32*n-32) i))
    (UInt256.ofNat (pb-32)) (l1Target n) (l2Target n) (modulusValue mem n) (inverseValue mem :: tailPointerValue mem :: pdst :: ret :: rest) (by simp only [List.length_cons]; omega) hact hn32 hpos hpa hpaFit
  simpa only [List.cons_append, List.nil_append, CiosCachedL1.state, l1At,
    Challenge.EvmProof.Word.ofNat_add_mod] using h
...
theorem run_l1Last (t : UInt256) (s : State) (mem : ByteArray) (bi : UInt256)
    ...
    (hpa : 32 ≤ pa) (hpaFit : pa + 32*n ≤ 9472) :
    runInstructions (l1LastProgram t) (l1At 4504 s mem bi pa pb n i (n-1) pdst ret rest) =
      some (midState s (l1Step mem bi pa n n).memory (l1Step mem bi pa n n).carry bi
        pa pb n i pdst ret rest) := by
  have h := CiosCachedL1.run_last s (UInt256.ofNat 4504) mem bi pa n t ht
    (UInt256.ofNat (ptrAt (pb+32*n-32) i))
    (UInt256.ofNat (pb-32)) (l1Target n) (l2Target n) (modulusValue mem n) (inverseValue mem :: tailPointerValue mem :: pdst :: ret :: rest) (by simp only [List.length_cons]; omega) hact hn32 hpos hpa hpaFit
  have hpc : UInt256.ofNat 4504 + UInt256.ofNat 35 = UInt256.ofNat 4539 := by decide
  simpa only [List.cons_append, List.nil_append, CiosCachedL1.state, CiosCachedL1.doneState, l1At, midState, hpc, modulusValue_l1 mem bi pa n n hn32, inverseValue_l1 mem bi pa n n hn32, tailPointerValue_l1 mem bi pa n n hn32] using h
...
theorem run_l2Mac (pc : Nat) (w : Fin 33) (x tl ts : UInt256)
  ...
  have h := CiosCachedL2.run_step w s (UInt256.ofNat pc) mid bi mu c0 n k x tl ts hx htl hts
    ...
    (UInt256.ofNat (pb-32)) (l1Target n) (l2Target n) (modulusValue mid n) (inverseValue mid :: tailPointerValue mid :: pdst :: ret :: rest) (by simp only [List.length_cons]; omega) hact hn32 hk hpush
