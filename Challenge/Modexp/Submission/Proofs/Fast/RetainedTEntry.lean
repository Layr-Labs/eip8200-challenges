...
def entryBlock : Block Artifact.submissionArtifact .Osaka 4115 entryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3094 8 4115 entryProgram
    (by decide) (by rfl) (by rfl) (by decide)
def pushBlock : Block Artifact.submissionArtifact .Osaka 4127 pushProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3102 1 4127 pushProgram
    (by decide) (by rfl) (by rfl) (by decide)
def tailBlock : Block Artifact.submissionArtifact .Osaka 5135 tailProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3931 2 5135 tailProgram
    (by decide) (by rfl) (by rfl) (by decide)
