...
def entryBlock : Block Artifact.submissionArtifact .Osaka 4240 entryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3386 8 4240 entryProgram
    (by decide) (by rfl) (by rfl) (by decide)
def pushBlock : Block Artifact.submissionArtifact .Osaka 4252 pushProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3394 1 4252 pushProgram
    (by decide) (by rfl) (by rfl) (by decide)
def tailBlock : Block Artifact.submissionArtifact .Osaka 5259 tailProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4225 2 5259 tailProgram
    (by decide) (by rfl) (by rfl) (by decide)

theorem jumpDest4486 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4240 = true :=
  Artifact.isValidJumpDest_index 3386 (by rfl)
theorem jumpDest5326 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5259 = true :=
  Artifact.isValidJumpDest_index 4225 (by rfl)
...
def entryState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 4240, stack := ret :: rest, memory := mem }
def tailState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 5259, stack := ret :: rest, memory := mem }
def pushState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 4252, stack := ret :: rest, memory := mem }
...
theorem run_entry (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256)
  ...
  have heq5326 : (5259 : UInt256) = UInt256.ofNat 5259 := by decide
  have h5326 : (5259 : UInt256).toNat = 5259 := by decide
