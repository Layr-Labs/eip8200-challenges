...
def entryBlock : Block Artifact.submissionArtifact .Osaka 4486 entryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3388 8 4486 entryProgram
    (by decide) (by rfl) (by rfl) (by decide)
def pushBlock : Block Artifact.submissionArtifact .Osaka 4498 pushProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3396 1 4498 pushProgram
    (by decide) (by rfl) (by rfl) (by decide)
def tailBlock : Block Artifact.submissionArtifact .Osaka 5326 tailProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4080 2 5326 tailProgram
    (by decide) (by rfl) (by rfl) (by decide)

theorem jumpDest4486 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4486 = true :=
  Artifact.isValidJumpDest_index 3388 (by rfl)
theorem jumpDest5326 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5326 = true :=
  Artifact.isValidJumpDest_index 4080 (by rfl)
...
def entryState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 4486, stack := ret :: rest, memory := mem }
def tailState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 5326, stack := ret :: rest, memory := mem }
def pushState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 4498, stack := ret :: rest, memory := mem }
...
theorem run_entry (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256)
  ...
  have heq5326 : (5326 : UInt256) = UInt256.ofNat 5326 := by decide
  have h5326 : (5326 : UInt256).toNat = 5326 := by decide
