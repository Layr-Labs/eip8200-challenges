...
def entryBlock : Block Artifact.submissionArtifact .Osaka 4225 entryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3402 8 4225 entryProgram
    (by decide) (by rfl) (by rfl) (by decide)
def pushBlock : Block Artifact.submissionArtifact .Osaka 4237 pushProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3410 1 4237 pushProgram
    (by decide) (by rfl) (by rfl) (by decide)
def tailBlock : Block Artifact.submissionArtifact .Osaka 5245 tailProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 4239 2 5245 tailProgram
    (by decide) (by rfl) (by rfl) (by decide)

theorem jumpDest4486 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 4225 = true :=
  Artifact.isValidJumpDest_index 3402 (by rfl)
theorem jumpDest5326 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 5245 = true :=
  Artifact.isValidJumpDest_index 4239 (by rfl)
...
def entryState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 4225, stack := ret :: rest, memory := mem }
def tailState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 5245, stack := ret :: rest, memory := mem }
def pushState (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 4237, stack := ret :: rest, memory := mem }
...
theorem run_entry (s : State) (mem : ByteArray) (ret : UInt256) (rest : List UInt256)
  ...
  have heq5326 : (5245 : UInt256) = UInt256.ofNat 5245 := by decide
  have h5326 : (5245 : UInt256).toNat = 5249 := by decide
