...
@[simp] private theorem newEstimatePC2960 : Artifact.submissionArtifact.instructionPC 2623 = 3446 := by rfl
@[simp] private theorem newEstimatePC2961 : Artifact.submissionArtifact.instructionPC 2624 = 3447 := by rfl
@[simp] private theorem newEstimatePC2962 : Artifact.submissionArtifact.instructionPC 2625 = 3448 := by rfl
@[simp] private theorem newEstimatePC2963 : Artifact.submissionArtifact.instructionPC 2626 = 3449 := by rfl
@[simp] private theorem newEstimatePC2964 : Artifact.submissionArtifact.instructionPC 2627 = 3452 := by rfl
@[simp] private theorem newEstimatePC2965 : Artifact.submissionArtifact.instructionPC 2628 = 3453 := by rfl
@[simp] private theorem newEstimatePC2966 : Artifact.submissionArtifact.instructionPC 2629 = 3454 := by rfl
@[simp] private theorem newEstimatePC2967 : Artifact.submissionArtifact.instructionPC 2630 = 3456 := by rfl
@[simp] private theorem newEstimatePCk2750 : Artifact.submissionArtifact.instructionPC 2631 = 3457 := by rfl
@[simp] private theorem newEstimatePCk2751 : Artifact.submissionArtifact.instructionPC 2632 = 3459 := by rfl
@[simp] private theorem newEstimatePCk2752 : Artifact.submissionArtifact.instructionPC 2633 = 3460 := by rfl
@[simp] private theorem newEstimatePCk2753 : Artifact.submissionArtifact.instructionPC 2634 = 3461 := by rfl
@[simp] private theorem newEstimatePCk2754 : Artifact.submissionArtifact.instructionPC 2635 = 3463 := by rfl
@[simp] private theorem newEstimatePCk2755 : Artifact.submissionArtifact.instructionPC 2636 = 3464 := by rfl
@[simp] private theorem newEstimatePCk2756 : Artifact.submissionArtifact.instructionPC 2637 = 3465 := by rfl
@[simp] private theorem newEstimatePCk2757 : Artifact.submissionArtifact.instructionPC 2638 = 3466 := by rfl
@[simp] private theorem newEstimatePCk2758 : Artifact.submissionArtifact.instructionPC 2639 = 3467 := by rfl
