...
@[simp] private theorem newEstimatePC2960 : Artifact.submissionArtifact.instructionPC 2958 = 4045 := by rfl
@[simp] private theorem newEstimatePC2961 : Artifact.submissionArtifact.instructionPC 2959 = 4046 := by rfl
@[simp] private theorem newEstimatePC2962 : Artifact.submissionArtifact.instructionPC 2960 = 4047 := by rfl
@[simp] private theorem newEstimatePC2963 : Artifact.submissionArtifact.instructionPC 2961 = 4048 := by rfl
@[simp] private theorem newEstimatePC2964 : Artifact.submissionArtifact.instructionPC 2962 = 4051 := by rfl
@[simp] private theorem newEstimatePC2965 : Artifact.submissionArtifact.instructionPC 2963 = 4052 := by rfl
@[simp] private theorem newEstimatePC2966 : Artifact.submissionArtifact.instructionPC 2964 = 4053 := by rfl
@[simp] private theorem newEstimatePC2967 : Artifact.submissionArtifact.instructionPC 2965 = 4055 := by rfl
@[simp] private theorem newEstimatePC2968 : Artifact.submissionArtifact.instructionPC 2966 = 4056 := by rfl
@[simp] private theorem newEstimatePC2969 : Artifact.submissionArtifact.instructionPC 2967 = 4058 := by rfl
@[simp] private theorem newEstimatePC2970 : Artifact.submissionArtifact.instructionPC 2968 = 4059 := by rfl
@[simp] private theorem newEstimatePC2971 : Artifact.submissionArtifact.instructionPC 2969 = 4060 := by rfl
@[simp] private theorem newEstimatePC2972 : Artifact.submissionArtifact.instructionPC 2970 = 4062 := by rfl
@[simp] private theorem newEstimatePC2973 : Artifact.submissionArtifact.instructionPC 2973 = 4065 := by rfl
@[simp] private theorem newEstimatePC2974 : Artifact.submissionArtifact.instructionPC 2974 = 4066 := by rfl

/-- `blk3026`: quotient estimate with a branchless saturation mask. -/
@[simp] private theorem productEstimatePC2973 :
    Artifact.submissionArtifact.instructionPC 2971 = 4063 := by decide

@[simp] private theorem productEstimatePC2974 :
    Artifact.submissionArtifact.instructionPC 2972 = 4064 := by decide
...
theorem run_macTail_go (s : State) (mm : ByteArray) (pa pt c q : UInt256)
  ...
  simp (config := { maxSteps := 200000 })
    [blk3077b, opAt, pushAt, wfOp,
      ...
      Challenge.EvmProof.Stepper.runLocated,
      Challenge.EvmProof.Stepper.runInstr,
      pcMacTail, pcMacLoop, outer, Exp.outer, hcode, hrun, hgt, jumpDest4937,
      UInt256.gt, UInt256.isTrue,
      Challenge.EvmProof.Word.literal_eq_ofNat,
      Challenge.EvmProof.Word.word_toNat_ofNat,
      Challenge.EvmProof.Word.succ_ofNat_mod,
...
theorem run_macTail_exit (s : State) (mm : ByteArray) (pa pt c q : UInt256)
  ...
  simp (config := { maxSteps := 200000 })
    [blk3077b, opAt, pushAt, wfOp,
      ...
      Challenge.EvmProof.Stepper.runLocated,
      Challenge.EvmProof.Stepper.runInstr,
      pcMacTail, pcMid, outer, Exp.outer, hcode, hrun, hpt, jumpDest4937,
      UInt256.gt, UInt256.isTrue,
      Challenge.EvmProof.Word.literal_eq_ofNat,
      Challenge.EvmProof.Word.word_toNat_ofNat,
      Challenge.EvmProof.Word.succ_ofNat_mod,
