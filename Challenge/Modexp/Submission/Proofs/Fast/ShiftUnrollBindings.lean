...
def cell0 : Block Artifact.submissionArtifact .Osaka 2951 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2190 37 2951 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell1 : Block Artifact.submissionArtifact .Osaka 2990 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2227 37 2990 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell2 : Block Artifact.submissionArtifact .Osaka 3029 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2264 37 3029 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell3 : Block Artifact.submissionArtifact .Osaka 3068 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2301 37 3068 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cache : Block Artifact.submissionArtifact .Osaka 2792 cacheProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2080 11 2792 cacheProgram
    (by decide) (by rfl) (by rfl) (by decide)

def dispatch : Block Artifact.submissionArtifact .Osaka 2946 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2187 3 2946 dispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
...
theorem jump3723 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 2990 = true :=
  Artifact.isValidJumpDest_index 2227 (by rfl)
