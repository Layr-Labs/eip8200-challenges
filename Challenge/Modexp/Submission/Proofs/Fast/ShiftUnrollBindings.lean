...
def cell0 : Block Artifact.submissionArtifact .Osaka 3144 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2336 37 3144 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell1 : Block Artifact.submissionArtifact .Osaka 3183 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2373 37 3183 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell2 : Block Artifact.submissionArtifact .Osaka 3222 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2410 37 3222 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell3 : Block Artifact.submissionArtifact .Osaka 3261 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2447 37 3261 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cache : Block Artifact.submissionArtifact .Osaka 2985 cacheProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2226 11 2985 cacheProgram
    (by decide) (by rfl) (by rfl) (by decide)

def dispatch : Block Artifact.submissionArtifact .Osaka 3139 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2333 3 3139 dispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
