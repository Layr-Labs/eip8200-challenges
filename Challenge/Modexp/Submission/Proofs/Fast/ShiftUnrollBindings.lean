...
def cell0 : Block Artifact.submissionArtifact .Osaka 3721 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2769 37 3721 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell1 : Block Artifact.submissionArtifact .Osaka 3760 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2806 37 3760 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell2 : Block Artifact.submissionArtifact .Osaka 3799 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2843 37 3799 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cell3 : Block Artifact.submissionArtifact .Osaka 3838 cellProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2880 37 3838 cellProgram
    (by decide) (by rfl) (by rfl) (by decide)

def cache : Block Artifact.submissionArtifact .Osaka 3580 cacheProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2675 11 3580 cacheProgram
    (by decide) (by rfl) (by rfl) (by decide)

def dispatch : Block Artifact.submissionArtifact .Osaka 3716 dispatchProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2766 3 3716 dispatchProgram
    (by decide) (by rfl) (by rfl) (by decide)
