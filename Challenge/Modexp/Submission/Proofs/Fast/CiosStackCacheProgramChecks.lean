...
theorem l2Mac0_eq : l2Mac0 = compactMemoryL2Body 192 8448 8480 := rfl
theorem l2Mac1_eq : l2Mac1 = compactMemoryL2Body 160 8416 8448 := rfl
theorem l2Mac2_eq : l2Mac2 = compactMemoryL2Body 128 8384 8416 := rfl
theorem l2Mac3_eq : l2Mac3 = compactMemoryL2Body 96 8352 8384 := rfl
theorem l2Mac4_eq : l2Mac4 = compactPartialL2Body 64 8352 := rfl
