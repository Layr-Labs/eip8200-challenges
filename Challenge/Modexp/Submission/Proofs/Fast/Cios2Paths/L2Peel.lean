...
private theorem startPC :
    Artifact.submissionArtifact.instructionPC startIndex = 4832 := by rfl

@[simp] theorem peelPC (i : Nat) (hi : startIndex ≤ i) (hii : i ≤ 3121) :
    Artifact.submissionArtifact.instructionPC i =
      [4832, 4833, 4834, 4835, 4868, 4869, 4870, 4871, 4872, 4873, 4874, 4875, 4876, 4877, 4878, 4879, 4880, 4881, 4882, 4883, 4884, 4885, 4886, 4887, 4888, 4889, 4890, 4891, 4892, 4893, 4894, 4895, 4897, 4898, 4899, 4900, 4901, 4902, 4903, 4904][i - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
/-- Exact live instruction slice 3082..3121, PCs 4832..4904. -/
def cios2L2Peel :
  ...
  [opAt 0 .JUMPDEST,
   ...
   opAt 33 (.Dup ⟨11, by decide⟩),
   opAt 34 .ADD,
   opAt 35 (.Swap ⟨3, by decide⟩),
   opAt 36 .ADD,
   opAt 37 .MSTORE,
   opAt 38 (.Dup ⟨8, by decide⟩),
   opAt 39 .ADD]
