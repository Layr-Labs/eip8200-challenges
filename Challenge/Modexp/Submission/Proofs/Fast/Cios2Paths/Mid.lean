...
private theorem startPC :
    Artifact.submissionArtifact.instructionPC startIndex = 4790 := by
  rfl

@[simp] theorem midPC (index : Nat) (hlo : startIndex ≤ index)
    (hhi : index ≤ 3170) :
    Artifact.submissionArtifact.instructionPC index =
      [4790,4791,4792,4793,4796,4797,4798,4799,4802,4803,4804,4807,4808,4811,4812,4813,4816,4817,4818,4819,4822,4823,4824,4825,4826,4827,4828,4861,4862,4863,4864,4865,4866,4867,4868,4869,4870,4871,4872,4873,4874,4877,4878,4880,4881,4882,4885,4886,4888,4889][index - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC index =
