...
private theorem startPC :
    Artifact.submissionArtifact.instructionPC startIndex = 4225 := by
  rfl

@[simp] theorem entryPC (index : Nat) (hlo : startIndex ≤ index)
    (hhi : index ≤ 2982) :
    Artifact.submissionArtifact.instructionPC index =
      [4225,4226,4229,4230,4231,4233,4234,4235,4238,4239,4240,4241,4242,4244,4245,4246,4248,4249,4250,4251,4252,4253,4254,4256,4257,4258,4259][index - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC index =
