...
private theorem startPC :
    Artifact.submissionArtifact.instructionPC startIndex = 4524 := by
  rfl

@[simp] theorem tailPC (index : Nat) (hlo : startIndex ≤ index)
    (hhi : index ≤ 3002) :
    Artifact.submissionArtifact.instructionPC index =
      [4524,4525,4526,4527,4528,4529,4530,4531,4534,4535,4536,4537,4540,4541,4542,4545,4546,4547,4550,4551,4553,4554,4555,4556,4557,4558,4561,4562,4563,4564,4565,4568][index - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC index =
...
/-- Instructions 3053..3083, pc 4524..4568. -/
def cios2Tail :
