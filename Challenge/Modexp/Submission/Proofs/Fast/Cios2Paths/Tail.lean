...
private theorem startPC :
    Artifact.submissionArtifact.instructionPC startIndex = 5305 := by
  rfl

@[simp] theorem tailPC (index : Nat) (hlo : startIndex ≤ index)
    (hhi : index ≤ 3322) :
    Artifact.submissionArtifact.instructionPC index =
      [5305,5306,5307,5308,5309,5310,5311,5314,5315,5316,5317,5320,5321,5322,5325,5326,5327,5330,5331,5364,5365,5366,5367,5368,5371,5372,5373,5374,5375,5378][index - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC index =
