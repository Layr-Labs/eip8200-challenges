...
private theorem startPC : Artifact.submissionArtifact.instructionPC startIndex = 4465 := by
  rfl
...
@[simp] theorem dispatchPC (i : Nat) (hi : startIndex ≤ i)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [4465,4466,4469,4470,4471,4473,4474,4475,4478,4479,4480,4483,4484,4487][i - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
