...
def mulEntry : Block Artifact.submissionArtifact .Osaka 3353 mulEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2510 2 3353 mulEntryProgram
    (by decide) (by rfl) (by rfl) (by decide)

def commonGuard : Block Artifact.submissionArtifact .Osaka 3357 commonGuardProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2512 13 3357 commonGuardProgram
    (by decide) (by rfl) (by rfl) (by decide)

def commonFallback : Block Artifact.submissionArtifact .Osaka 3378 commonFallbackProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2525 3 3378 commonFallbackProgram
    (by decide) (by rfl) (by rfl) (by decide)
