...
private def template : List Instr :=
 ...
 YulEvmCompiler.Instr.push 2 4080,
...
private theorem startPC : Artifact.submissionArtifact.instructionPC startIndex = 4057 := by
  rfl
...
@[simp] theorem dispatchPC (i : Nat) (hi : startIndex ≤ i)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [4057,4058,4061,4062,4063,4065,4066,4067,4070,4071,4072,4075,4076,4079][i - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
/-- Full fallback path (indices 2670..2683, pc 4057..4079). -/
def cios2Dispatch :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  cios2DispatchGuard ++
  [
