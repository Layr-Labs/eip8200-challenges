...
private theorem startPC : Artifact.submissionArtifact.instructionPC startIndex = 4440 := by
  rfl
...
@[simp] theorem dispatchPC (i : Nat) (hi : startIndex ≤ i)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [4440,4441,4444,4445,4446,4448,4449,4450,4453,4454,4455,4458,4459,4462][i - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
