...
def mulEntry : Block Artifact.submissionArtifact .Osaka 4092 mulEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3073 2 4092 mulEntryProgram
    (by decide) (by rfl) (by rfl) (by decide)

def commonGuard : Block Artifact.submissionArtifact .Osaka 4096 commonGuardProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3075 12 4096 commonGuardProgram
    (by decide) (by rfl) (by rfl) (by decide)

def commonFallback : Block Artifact.submissionArtifact .Osaka 4115 commonFallbackProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 3087 3 4115 commonFallbackProgram
    (by decide) (by rfl) (by rfl) (by decide)
