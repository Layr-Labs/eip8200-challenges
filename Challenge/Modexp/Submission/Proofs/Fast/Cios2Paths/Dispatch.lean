...
def mulEntry : Block Artifact.submissionArtifact .Osaka 3209 mulEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2380 2 3209 mulEntryProgram
    (by decide) (by rfl) (by rfl) (by decide)

def commonGuard : Block Artifact.submissionArtifact .Osaka 3213 commonGuardProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2382 1 3213 commonGuardProgram
    (by decide) (by rfl) (by rfl) (by decide)
