...
private theorem startPC : Artifact.submissionArtifact.instructionPC startIndex = 4453 := by
  rfl
...
@[simp] theorem dispatchPC (i : Nat) (hi : startIndex ≤ i)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [4453,4454,4457,4458,4459,4461,4462,4463,4466,4467,4468,4471,4472,4475][i - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
