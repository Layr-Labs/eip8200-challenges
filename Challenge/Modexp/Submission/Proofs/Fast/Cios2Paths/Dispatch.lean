...
private theorem startPC : Artifact.submissionArtifact.instructionPC startIndex = 4493 := by
  rfl
...
@[simp] theorem dispatchPC (i : Nat) (hi : startIndex ≤ i)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [4493,4494,4497,4498,4499,4501,4502,4503,4506,4507,4508,4511,4512,4515][i - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
