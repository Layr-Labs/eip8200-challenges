...
def mulEntryProgram : List Instr :=
  [.op .JUMPDEST, .push 2 3516]

def commonGuardProgram : List Instr := CiosInverseGuard.guardProgram

def commonFallbackProgram : List Instr :=
  [.op .POP, .push 2 1085, .op .JUMP]

def mulEntry : Block Artifact.submissionArtifact .Osaka 3349 mulEntryProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2509 2 3349 mulEntryProgram
    (by decide) (by rfl) (by rfl) (by decide)

def commonGuard : Block Artifact.submissionArtifact .Osaka 3353 commonGuardProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2511 13 3353 commonGuardProgram
    (by decide) (by rfl) (by rfl) (by decide)

def commonFallback : Block Artifact.submissionArtifact .Osaka 3374 commonFallbackProgram :=
  WindowTwentyOneSlice.block Artifact.allWellFormed 2524 3 3374 commonFallbackProgram
    (by decide) (by rfl) (by rfl) (by decide)
