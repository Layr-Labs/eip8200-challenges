...
private theorem startPC : Artifact.submissionArtifact.instructionPC startIndex = 4432 := by
  rfl
...
@[simp] theorem dispatchPC (i : Nat) (hi : startIndex ≤ i)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [4432,4433,4436,4437,4438,4440,4441,4442,4445,4446,4447,4450,4451,4454][i - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
