...
private theorem startPC :
    Artifact.submissionArtifact.instructionPC startIndex = 4234 := by
  rfl

@[simp] theorem outPC (index : Nat) (hlo : startIndex ≤ index)
    (hhi : index ≤ 2967) :
    Artifact.submissionArtifact.instructionPC index =
      [4234,4235,4236,4237,4238,4243,4244,4245,4248,4249,4250][index - startIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC index =
