...
private theorem startPC :
    Artifact.submissionArtifact.instructionPC joinStartIndex = 4731 := by rfl

@[simp] theorem joinPC (i : Nat) (hi : joinStartIndex ≤ i) (hii : i ≤ 3031) :
    Artifact.submissionArtifact.instructionPC i =
      [4731][i - joinStartIndex]! := by
  calc
    Artifact.submissionArtifact.instructionPC i =
...
/-- Exact live instruction slice 3031..3031, PCs 4731..4731. -/
def joinBlock :
