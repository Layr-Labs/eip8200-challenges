...
theorem run_first (s : State) (x mu bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions firstProgram
      (framed s (UInt256.ofNat 4950) ([x, mu, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4957)
...
theorem run_high (s : State) (mm lo mu bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions highProgram
      (framed s (UInt256.ofNat 4957) ([mm, lo, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4964)
...
theorem run_low (s : State) (hi lo mu bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions lowProgram
      (framed s (UInt256.ofNat 4964) ([hi, lo, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4968)
