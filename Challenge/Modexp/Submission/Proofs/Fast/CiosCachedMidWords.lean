...
theorem run_first (s : State) (x mu bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions firstProgram
      (framed s (UInt256.ofNat 4603) ([x, mu, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4610)
...
theorem run_high (s : State) (mm lo mu bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions highProgram
      (framed s (UInt256.ofNat 4610) ([mm, lo, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4617)
...
theorem run_low (s : State) (hi lo mu bi pbi paEnd pbEnd flag dst ret : UInt256)
    ...
    runInstructions lowProgram
      (framed s (UInt256.ofNat 4617) ([hi, lo, mu] ++ baseStack bi pbi paEnd pbEnd flag dst ret rest)) =
    some (framed s (UInt256.ofNat 4621)
...
theorem run_words (s : State) (x mu bi pbi paEnd pbEnd flag dst ret : UInt256)
  ...
  exact runInstructions_append_some _ _ _ _ _
    (runInstructions_append_some _ _ _ _ _
      (run_first s x mu bi pbi paEnd pbEnd flag dst ret rest hcap)
      (run_high s (UInt256.mulMod x mu maxWord) (x*mu) mu
        bi pbi paEnd pbEnd flag dst ret rest hcap))
    (run_low s (mulHi x mu) (x*mu) mu bi pbi paEnd pbEnd flag dst ret rest hcap)
