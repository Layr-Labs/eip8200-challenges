...
theorem run_first (s : State) (width pa pb flag dst ret : UInt256)
    ...
    runInstructions firstProgram
      (framed s (UInt256.ofNat 4243) ([width, pa, pb, flag, negative32, allOnes, dst, ret] ++ rest)) =
...
theorem run_middle (s : State) (pbi width pa pb flag dst ret : UInt256)
    ...
    runInstructions middleProgram
      (framed s (UInt256.ofNat 4248) ([pbi, width, pa, pb, flag, negative32, allOnes, dst, ret] ++ rest)) =
    some (framed s (UInt256.ofNat 4252)
...
theorem run_last (s : State) (pbi width pa pbEnd flag dst ret : UInt256)
    ...
    runInstructions lastProgram
      (framed s (UInt256.ofNat 4252) ([pbi, width, pa, pbEnd, flag, negative32, allOnes, dst, ret] ++ rest)) =
    some (framed s (UInt256.ofNat 4254)
