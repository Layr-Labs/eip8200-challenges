...
theorem run_first (s : State) (width pa pb flag dst ret : UInt256)
    ...
    runInstructions firstProgram
      (framed s (UInt256.ofNat 4256) ([width, pa, pb, flag, negative32, allOnes, dst, ret] ++ rest)) =
    some (framed s (UInt256.ofNat 4263)
...
theorem run_middle (s : State) (pbi width pa pb flag dst ret : UInt256)
    ...
    runInstructions middleProgram
      (framed s (UInt256.ofNat 4263) ([pbi, width, pa, pb, flag, negative32, allOnes, dst, ret] ++ rest)) =
    some (framed s (UInt256.ofNat 4271)
      ([pbi, pa, pb-UInt256.ofNat 32, flag, negative32, allOnes, dst, ret] ++ rest)) := by
  have hc7 : rest.length+8 < 1024 := by omega
  have hc8 : rest.length+9 < 1024 := by omega
  have hc9 : rest.length+10 < 1024 := by omega
...
theorem run_last (s : State) (pbi pa pbEnd flag dst ret : UInt256)
    ...
    runInstructions lastProgram
      (framed s (UInt256.ofNat 4271) ([pbi, pa, pbEnd, flag, negative32, allOnes, dst, ret] ++ rest)) =
    some (framed s (UInt256.ofNat 4277)
...
theorem run_words (s : State) (width pa pb flag dst ret : UInt256)
  ...
  exact runInstructions_append_some _ _ _ _ _
    ...
    (run_last s (pb+width-UInt256.ofNat 32) pa (pb-UInt256.ofNat 32) flag dst ret rest hcap)
