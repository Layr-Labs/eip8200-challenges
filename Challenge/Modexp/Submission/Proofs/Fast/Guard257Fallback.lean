...
theorem run_fallback (input : ByteArray) :
    Challenge.EvmProof.Stepper.runLocatedBlock fallbackPath (branchState input 4982) =
  ...
  simp [fallbackPath, Main.opAt, Main.pushAt, Main.wfOp,
    ...
    fallbackState, Main.trampolineState, branchState, initialState, hjump, guardPC1,
