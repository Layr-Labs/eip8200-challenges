...
theorem run_blAdd (s : State) (mem input : ByteArray)
  ...
  have h2467Nat : (UInt256.ofNat 2463).toNat = 2463 := by decide
...
def r1Call (s : State) (mem : ByteArray) (px : Nat) (ret : UInt256)
    (n bsize esize msize : Nat) : State :=
  { s with pc := UInt256.ofNat 2897
           stack := UInt256.ofNat px :: ret :: outer n bsize esize msize
           memory := mem }

/-- The width-dependent `CCB` entry, pc 3934, stack `[px, ret] ++ OUTER`.
...
theorem run_r0 (s : State) (mem : ByteArray) (n bsize esize msize : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blk1138
      ...
      some (ccCall s (mcopyMem mem 5120 4096 (32 * n)) 5120 (UInt256.ofNat 3485)
  ...
  have hfix2 : UInt256.ofNat (MachineState.activeWordsAfter
    ...
    activeWords_fix2 s 5120 (32 * n) 4096 (32 * n) (by omega) (by omega) (by omega)
      (by omega) hact
  have h4016 : (3930 : UInt256) = UInt256.ofNat 3930 := by decide
  have h4016Nat : (UInt256.ofNat 3930).toNat = 3930 := by decide
...
def gasSteps_r0 (s : State) (mem : ByteArray) (n bsize esize msize : Nat)
    ...
    Challenge.EvmProof.GasSteps (r0State s mem n bsize esize msize)
      (ccCall s (mcopyMem mem 5120 4096 (32 * n)) 5120 (UInt256.ofNat 3485)
        n bsize esize msize) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
...
theorem jumpD3571 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
    (UInt256.ofNat 3485).toNat = true := jumpD 3485 (by decide) jumpDest3571
...
theorem jump2874 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 2870).toNat = true := by
  rw [show (UInt256.ofNat 2870).toNat = 2870 by decide]
  exact jumpDest2874

theorem jump2888 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 2884).toNat = true := by
  rw [show (UInt256.ofNat 2884).toNat = 2884 by decide]
  exact jumpDest2888

theorem jump4040 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 3954).toNat = true := by
  rw [show (UInt256.ofNat 3954).toNat = 3954 by decide]
  exact CcbSeed.jumpDest4040

/-- **`CCB` against the real `ADDMOD` and `MONPRO`.**  Entering pc 3934 with
...
def gasSteps_ccbFull (s : State) {n bsize mm minv R : Nat}
  ...
  · intro i _hi
    exact sub.addmod px px px (UInt256.ofNat 3954)
  ...
  · intro i _hi
    ...
    exact sub.monpro px px px (UInt256.ofNat 2884)
...
theorem fastSetup_entry_eq (input : ByteArray) :
    Setup.fastSetupState input =
      r1Call (Setup.fastSetupState input) (Setup.fastSetupMemory input) 4096
        (UInt256.ofNat 4537) (Setup.limbs input) (Challenge.Modexp.baseSize input)
