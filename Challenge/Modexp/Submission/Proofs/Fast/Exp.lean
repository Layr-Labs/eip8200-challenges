...
def sqCall (s : State) (mem : ByteArray) (ret : UInt256)
    (tail : List UInt256) : State :=
  { s with pc := UInt256.ofNat 3899
           stack := UInt256.ofNat 4685 :: UInt256.ofNat 2048 :: UInt256.ofNat 2048 ::
...
theorem run_rrHead (s : State) (mem : ByteArray) (n bsize esize msize k : Nat)
  ...
  have h1939Nat : (UInt256.ofNat 3895).toNat = 3895 := by decide
...
theorem run_r0 (s : State) (mem : ByteArray) (n bsize esize msize : Nat)
  ...
  have hfix2 : UInt256.ofNat (MachineState.activeWordsAfter
    ...
    activeWords_fix2 s 5120 (32 * n) 4096 (32 * n) (by omega) (by omega) (by omega)
      (by omega) hact
  have h4016 : (3267 : UInt256) = UInt256.ofNat 3267 := by decide
  have h4016Nat : (UInt256.ofNat 3267).toNat = 3267 := by decide
...
theorem jump4040 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 3291).toNat = true := by
  rw [show (UInt256.ofNat 3291).toNat = 3291 by decide]
...
def gasSteps_ccbFull (s : State) {n bsize mm minv R : Nat}
  ...
  · intro i _hi
    exact sub.addmod px px px (UInt256.ofNat 3291)
...
theorem fastSetup_entry_eq (input : ByteArray) :
    Setup.fastSetupState input =
      r1Call (Setup.fastSetupState input) (Setup.fastSetupMemory input) 4096
        (UInt256.ofNat 3308) (Setup.limbs input) (Challenge.Modexp.baseSize input)
