...
/-- The `CCB` entry, pc 2936, stack `[px, ret] ++ OUTER`.  `CCB` has the same
...
theorem run_r0 (s : State) (mem : ByteArray) (n bsize esize msize : Nat)
  ...
  have hfix2 : UInt256.ofNat (MachineState.activeWordsAfter
    ...
    activeWords_fix2 s 5120 (32 * n) 4096 (32 * n) (by omega) (by omega) (by omega)
      (by omega) hact
  have h2936 : (2936 : UInt256) = UInt256.ofNat 2936 := by decide
  have h2936Nat : (UInt256.ofNat 2936).toNat = 2936 := by decide
  simp (config := { maxSteps := 600000 }) [blk1138, opAt, pushAt, wfOp,
    Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
    r0State, ccCall, mcopyMem, outer, fastPC4, hcode, hrun, hs32, hmod, hfix1,
    hfix2, h2936, h2936Nat, jumpDest2936, State.activeWordsAfterUInt256,
    State.activeWordsAfterUInt256_2,
    Challenge.EvmProof.Word.literal_eq_ofNat,
    Challenge.EvmProof.Word.succ_ofNat_mod,
    Challenge.EvmProof.Word.ofNat_add_mod,
...
`CCB` (pc 2936) replaces the second `DOUBLE256`.  It doubles the block at
...
theorem jump2947 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 2947).toNat = true := by
  rw [show (UInt256.ofNat 2947).toNat = 2947 by decide]
  exact jumpDest2947

theorem jump2961 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 2961).toNat = true := by
  rw [show (UInt256.ofNat 2961).toNat = 2961 by decide]
  exact jumpDest2961

/-- **`CCB` against the real `ADDMOD` and `MONPRO`.**  Entering pc 2936 with
...
def gasSteps_ccbFull (s : State) {n bsize mm minv R : Nat}
  ...
  Ccb.gasSteps_ccb s px ret (outer n bsize esize msize) mem
    ...
    (sub.addmod px px px (UInt256.ofNat 2947)
      ...
      (by omega) (by omega) (by omega) (by omega) (by omega) jump2947 hf)
    (fun i hi =>
      sub.monpro px px px (UInt256.ofNat 2961)
        ...
        (by simp only [Ccb.loopStack, outer, List.length_cons, List.length_nil,
          List.length_append]; omega)
        (by omega) (by omega) (by omega) (by omega) (by omega) jump2961
