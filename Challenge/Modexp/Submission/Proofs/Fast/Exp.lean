...
/-- The `R1B` entry, pc 2894, stack `[px, ret] ++ OUTER`.  Same calling
...
/-- The `CCB` entry, pc 2856, stack `[px, ret] ++ OUTER`.  `CCB` has the same
...
theorem run_r0 (s : State) (mem : ByteArray) (n bsize esize msize : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock blk1138
      ...
      some (ccCall s (mcopyMem mem 5120 4096 (32 * n)) 5120 (UInt256.ofNat 3564)
  ...
  have hfix2 : UInt256.ofNat (MachineState.activeWordsAfter
    ...
    activeWords_fix2 s 5120 (32 * n) 4096 (32 * n) (by omega) (by omega) (by omega)
      (by omega) hact
  have h2856 : (2856 : UInt256) = UInt256.ofNat 2856 := by decide
  have h2856Nat : (UInt256.ofNat 2856).toNat = 2856 := by decide
  simp (config := { maxSteps := 600000 }) [blk1138, opAt, pushAt, wfOp,
    Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
    r0State, ccCall, mcopyMem, outer, fastPC4, hcode, hrun, hs32, hmod, hfix1,
    hfix2, h2856, h2856Nat, jumpDest2863, State.activeWordsAfterUInt256,
    State.activeWordsAfterUInt256_2,
    Challenge.EvmProof.Word.literal_eq_ofNat,
    Challenge.EvmProof.Word.succ_ofNat_mod,
    Challenge.EvmProof.Word.ofNat_add_mod,
...
def gasSteps_r0 (s : State) (mem : ByteArray) (n bsize esize msize : Nat)
    ...
    Challenge.EvmProof.GasSteps (r0State s mem n bsize esize msize)
      (ccCall s (mcopyMem mem 5120 4096 (32 * n)) 5120 (UInt256.ofNat 3564)
        n bsize esize msize) :=
  Challenge.EvmProof.Stepper.runLocatedBlock_sound
...
theorem jumpD3571 : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
    (UInt256.ofNat 3564).toNat = true := jumpD 3564 (by decide) jumpDest3571
...
`R1B` (pc 2894) stands in front of the first `DOUBLE256` call.  When the
...
/-- **The guarded `R1` block against the real `CSUB`.**  Entering pc 2894 with
...
`CCB` (pc 2856) replaces the second `DOUBLE256`.  It doubles the block at
...
theorem jump2874 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 2867).toNat = true := by
  rw [show (UInt256.ofNat 2867).toNat = 2867 by decide]
  exact jumpDest2874

theorem jump2888 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (UInt256.ofNat 2881).toNat = true := by
  rw [show (UInt256.ofNat 2881).toNat = 2881 by decide]
  exact jumpDest2888

/-- **`CCB` against the real `ADDMOD` and `MONPRO`.**  Entering pc 2856 with
...
def gasSteps_ccbFull (s : State) {n bsize mm minv R : Nat}
  ...
  Ccb.gasSteps_ccb s px ret (outer n bsize esize msize) mem
    ...
    (sub.addmod px px px (UInt256.ofNat 2867)
    ...
    (fun i hi =>
      sub.monpro px px px (UInt256.ofNat 2881)
