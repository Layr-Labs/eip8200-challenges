...
Entry schedule `[2304, 2317)`: `JUMPDEST; PUSH8 9440; MLOAD; PUSH0; SWAP1`
turns `[pdst, ret]` into `[pt, 0, dst, ret]` with `pt = 8224 + 32*n`,
falling through into the loop head at 2317.  Both arrivals at 2317
...
followed by the unchanged common return tail at `[2452, 2474)`.
-/
