...
def gasSteps_bitCopy2_sym (s : State) (rest : List UInt256)
  ...
  have step2399 := soundW hs (opAt 2314 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2314 3243 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2452)
      (stepW_dup s 3243 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2400 := soundW hs (pushAt 2315 1 1)
    (blockOfW _ (pcFactW s 2315 3244 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2453)
  ...
  have step2401 := soundW hs (opAt 2316 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2316 3246 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2454)
  ...
  have step2402 := soundW hs (pushAt 2317 1 5)
    (blockOfW _ (pcFactW s 2317 3247 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2455)
  ...
  have step2403 := soundW hs (opAt 2318 .SHR)
    (blockOfW _ (pcFactW s 2318 3249 ([(5 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2456)
      (stepW_shr s 3249 ((5 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2404 := soundW hs (opAt 2319 .AND)
    (blockOfW _ (pcFactW s 2319 3250 ([(UInt256.shiftRight byte (5 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2457)
  ...
  have step2405 := soundW hs (opAt 2320 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2320 3251 ([(UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2458)
  ...
  have step2406 := soundW hs (opAt 2321 .MUL)
    (blockOfW _ (pcFactW s 2321 3252 ([Bm1, (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2459)
  ...
  have step2407 := soundW hs (pushAt 2322 1 1)
    (blockOfW _ (pcFactW s 2322 3253 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2460)
  ...
  have step2408 := soundW hs (opAt 2323 .ADD)
    (blockOfW _ (pcFactW s 2323 3255 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2461)
  ...
  have step2409 := soundW hs (opAt 2324 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2324 3256 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2462)
  ...
  have step2410 := soundW hs (opAt 2325 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2325 3257 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2463)
  ...
  have step2411 := soundW hs (opAt 2326 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2326 3258 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2464)
  ...
  have step2412 := soundW hs (opAt 2327 .MULMOD)
    (blockOfW _ (pcFactW s 2327 3259 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2465)
  ...
  have step2413 := soundW hs (opAt 2328 .MULMOD)
    (blockOfW _ (pcFactW s 2328 3260 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2466)
  ...
  have step2414 := soundW hs (opAt 2329 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2329 3261 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2467)
  ...
  have step2415 := soundW hs (opAt 2330 .POP)
    (blockOfW _ (pcFactW s 2330 3262 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2468)
...
theorem gasSteps_bitCopy2_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2399 := blockCostW [opAt 2314 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2314 3243 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2452)
  ...
  have c2400 := blockCostW [pushAt 2315 1 1] 3
    (blockOfW _ (pcFactW s 2315 3244 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2453)
  ...
  have c2401 := blockCostW [opAt 2316 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2316 3246 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2454)
  ...
  have c2402 := blockCostW [pushAt 2317 1 5] 3
    (blockOfW _ (pcFactW s 2317 3247 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2455)
  ...
  have c2403 := blockCostW [opAt 2318 .SHR] 3
    (blockOfW _ (pcFactW s 2318 3249 ([(5 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2456)
  ...
  have c2404 := blockCostW [opAt 2319 .AND] 3
    (blockOfW _ (pcFactW s 2319 3250 ([(UInt256.shiftRight byte (5 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2457)
  ...
  have c2405 := blockCostW [opAt 2320 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2320 3251 ([(UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2458)
  ...
  have c2406 := blockCostW [opAt 2321 .MUL] 5
    (blockOfW _ (pcFactW s 2321 3252 ([Bm1, (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2459)
  ...
  have c2407 := blockCostW [pushAt 2322 1 1] 3
    (blockOfW _ (pcFactW s 2322 3253 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2460)
  ...
  have c2408 := blockCostW [opAt 2323 .ADD] 3
    (blockOfW _ (pcFactW s 2323 3255 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2461)
  ...
  have c2409 := blockCostW [opAt 2324 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2324 3256 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2462)
  ...
  have c2410 := blockCostW [opAt 2325 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2325 3257 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2463)
  ...
  have c2411 := blockCostW [opAt 2326 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2326 3258 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2464)
  ...
  have c2412 := blockCostW [opAt 2327 .MULMOD] 8
    (blockOfW _ (pcFactW s 2327 3259 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2465)
  ...
  have c2413 := blockCostW [opAt 2328 .MULMOD] 8
    (blockOfW _ (pcFactW s 2328 3260 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2466)
  ...
  have c2414 := blockCostW [opAt 2329 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2329 3261 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2467)
      (stepW_swap s 3261 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2415 := blockCostW [opAt 2330 .POP] 2
    (blockOfW _ (pcFactW s 2330 3262 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2468)
