...
def gasSteps_bitCopy2_sym (s : State) (rest : List UInt256)
  ...
  have step2399 := soundW hs (opAt 2380 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2380 3740 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2452)
  ...
  have step2400 := soundW hs (pushAt 2381 1 1)
    (blockOfW _ (pcFactW s 2381 3741 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2453)
  ...
  have step2401 := soundW hs (opAt 2382 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2382 3743 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2454)
  ...
  have step2402 := soundW hs (pushAt 2383 1 5)
    (blockOfW _ (pcFactW s 2383 3744 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2455)
  ...
  have step2403 := soundW hs (opAt 2384 .SHR)
    (blockOfW _ (pcFactW s 2384 3746 ([(5 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2456)
  ...
  have step2404 := soundW hs (opAt 2385 .AND)
    (blockOfW _ (pcFactW s 2385 3747 ([(UInt256.shiftRight byte (5 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2457)
  ...
  have step2405 := soundW hs (opAt 2386 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2386 3748 ([(UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2458)
  ...
  have step2406 := soundW hs (opAt 2387 .MUL)
    (blockOfW _ (pcFactW s 2387 3749 ([Bm1, (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2459)
  ...
  have step2407 := soundW hs (pushAt 2388 1 1)
    (blockOfW _ (pcFactW s 2388 3750 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2460)
  ...
  have step2408 := soundW hs (opAt 2389 .ADD)
    (blockOfW _ (pcFactW s 2389 3752 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2461)
  ...
  have step2409 := soundW hs (opAt 2390 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2390 3753 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2462)
  ...
  have step2410 := soundW hs (opAt 2391 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2391 3754 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2463)
  ...
  have step2411 := soundW hs (opAt 2392 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2392 3755 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2464)
  ...
  have step2412 := soundW hs (opAt 2393 .MULMOD)
    (blockOfW _ (pcFactW s 2393 3756 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2465)
  ...
  have step2413 := soundW hs (opAt 2394 .MULMOD)
    (blockOfW _ (pcFactW s 2394 3757 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2466)
  ...
  have step2414 := soundW hs (opAt 2395 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2395 3758 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2467)
  ...
  have step2415 := soundW hs (opAt 2396 .POP)
    (blockOfW _ (pcFactW s 2396 3759 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (5 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2468)
