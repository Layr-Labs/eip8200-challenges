...
instructions as every other copy, at instruction indices 1897 .. 1921 and bytes
3082 .. 3108.
-/
...
def bitDecodePath2 :
  ...
  [pushAt 1897 1 1, opAt 1898 (.Dup ⟨2, by decide⟩), pushAt 1899 1 5,
   opAt 1900 .SHR, opAt 1901 .AND]

def bitSquarePath2 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1902 (.Dup ⟨7, by decide⟩), opAt 1903 (.Dup ⟨6, by decide⟩),
   opAt 1904 (.Dup ⟨7, by decide⟩), opAt 1905 .MULMOD]

def bitMaskPath2 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1906 (.Dup ⟨1, by decide⟩), pushAt 1907 0 0, opAt 1908 .SUB]

def bitProductPath2 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1909 (.Dup ⟨9, by decide⟩), opAt 1910 (.Dup ⟨9, by decide⟩),
   opAt 1911 (.Dup ⟨3, by decide⟩), opAt 1912 .MULMOD]

def bitChoosePath2 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1913 (.Dup ⟨2, by decide⟩), opAt 1914 .XOR, opAt 1915 .AND,
   opAt 1916 (.Dup ⟨1, by decide⟩), opAt 1917 .XOR]

def bitAdvancePath2 :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1918 (.Swap ⟨6, by decide⟩), opAt 1919 .POP, opAt 1920 .POP,
   opAt 1921 .POP]
...
theorem run_bitDecode (input : ByteArray) (outer : Nat)
  ...
  have hshiftWord : (5 : UInt256) = UInt256.ofNat 5 := by decide
