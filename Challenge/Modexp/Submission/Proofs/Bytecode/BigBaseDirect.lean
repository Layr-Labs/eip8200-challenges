...
def initializePath :
  ...
  [opAt 1126 .JUMPDEST, pushAt 1127 1 1, pushAt 1128 2 3072,
   opAt 1129 .MSTORE]

def sizeGuardPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1130 (.Dup ⟨2, by decide⟩), opAt 1131 (.Dup ⟨5, by decide⟩),
   opAt 1132 .EQ, opAt 1133 .ISZERO, pushAt 1134 2 1561,
   opAt 1135 .JUMPI]

def headGuardPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1136 (.Dup ⟨7, by decide⟩), opAt 1137 .CALLDATALOAD,
   opAt 1138 (.Dup ⟨6, by decide⟩), opAt 1139 .CALLDATALOAD,
   opAt 1140 .LT, opAt 1141 .ISZERO, pushAt 1142 2 1561,
   opAt 1143 .JUMPI]

def directLoadPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 1144 2 1555, pushAt 1145 2 1024,
   opAt 1146 (.Dup ⟨4, by decide⟩), opAt 1147 (.Dup ⟨8, by decide⟩),
   pushAt 1148 2 439, opAt 1149 .JUMP]

def fastReturnPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1150 .JUMPDEST, pushAt 1151 0 0, pushAt 1152 2 925,
   opAt 1153 .JUMP]

def fallbackPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1154 .JUMPDEST, pushAt 1155 0 0, pushAt 1156 2 831,
   opAt 1157 .JUMP]
...
@[simp] private theorem directPCs (i : Nat) (hi : 1126 ≤ i)
    (hii : i ≤ 1157) :
    Artifact.submissionArtifact.instructionPC i =
      [1518, 1519, 1521, 1524, 1525, 1526, 1527, 1528,
       ...
       1555, 1556, 1557, 1560, 1561, 1562, 1563, 1566][i - 1126]! := by
