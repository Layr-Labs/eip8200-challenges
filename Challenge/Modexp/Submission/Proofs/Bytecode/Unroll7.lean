...
def gasSteps_bitCopy7_sym (s : State) (rest : List UInt256)
  ...
  have step2484 := soundW hs (opAt 2433 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2433 3840 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2537)
      (stepW_dup s 3840 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2485 := soundW hs (pushAt 2434 1 1)
    (blockOfW _ (pcFactW s 2434 3841 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2538)
  ...
  have step2486 := soundW hs (opAt 2435 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2435 3843 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2539)
  ...
  have step2487 := soundW hs (pushAt 2436 1 0)
    (blockOfW _ (pcFactW s 2436 3844 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2540)
  ...
  have step2488 := soundW hs (opAt 2437 .SHR)
    (blockOfW _ (pcFactW s 2437 3846 ([(0 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2541)
      (stepW_shr s 3846 ((0 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2489 := soundW hs (opAt 2438 .AND)
    (blockOfW _ (pcFactW s 2438 3847 ([(UInt256.shiftRight byte (0 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2542)
  ...
  have step2490 := soundW hs (opAt 2439 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2439 3848 ([(UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2543)
  ...
  have step2491 := soundW hs (opAt 2440 .MUL)
    (blockOfW _ (pcFactW s 2440 3849 ([Bm1, (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2544)
  ...
  have step2492 := soundW hs (pushAt 2441 1 1)
    (blockOfW _ (pcFactW s 2441 3850 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2545)
  ...
  have step2493 := soundW hs (opAt 2442 .ADD)
    (blockOfW _ (pcFactW s 2442 3852 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2546)
  ...
  have step2494 := soundW hs (opAt 2443 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2443 3853 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2547)
  ...
  have step2495 := soundW hs (opAt 2444 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2444 3854 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2548)
  ...
  have step2496 := soundW hs (opAt 2445 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2445 3855 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2549)
  ...
  have step2497 := soundW hs (opAt 2446 .MULMOD)
    (blockOfW _ (pcFactW s 2446 3856 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2550)
  ...
  have step2498 := soundW hs (opAt 2447 .MULMOD)
    (blockOfW _ (pcFactW s 2447 3857 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2551)
  ...
  have step2499 := soundW hs (opAt 2448 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2448 3858 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2552)
  ...
  have step2500 := soundW hs (opAt 2449 .POP)
    (blockOfW _ (pcFactW s 2449 3859 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2553)
...
theorem gasSteps_bitCopy7_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2484 := blockCostW [opAt 2433 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2433 3840 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2537)
  ...
  have c2485 := blockCostW [pushAt 2434 1 1] 3
    (blockOfW _ (pcFactW s 2434 3841 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2538)
  ...
  have c2486 := blockCostW [opAt 2435 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2435 3843 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2539)
  ...
  have c2487 := blockCostW [pushAt 2436 1 0] 3
    (blockOfW _ (pcFactW s 2436 3844 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2540)
  ...
  have c2488 := blockCostW [opAt 2437 .SHR] 3
    (blockOfW _ (pcFactW s 2437 3846 ([(0 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2541)
  ...
  have c2489 := blockCostW [opAt 2438 .AND] 3
    (blockOfW _ (pcFactW s 2438 3847 ([(UInt256.shiftRight byte (0 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2542)
  ...
  have c2490 := blockCostW [opAt 2439 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2439 3848 ([(UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2543)
  ...
  have c2491 := blockCostW [opAt 2440 .MUL] 5
    (blockOfW _ (pcFactW s 2440 3849 ([Bm1, (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2544)
  ...
  have c2492 := blockCostW [pushAt 2441 1 1] 3
    (blockOfW _ (pcFactW s 2441 3850 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2545)
  ...
  have c2493 := blockCostW [opAt 2442 .ADD] 3
    (blockOfW _ (pcFactW s 2442 3852 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2546)
  ...
  have c2494 := blockCostW [opAt 2443 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2443 3853 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2547)
  ...
  have c2495 := blockCostW [opAt 2444 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2444 3854 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2548)
  ...
  have c2496 := blockCostW [opAt 2445 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2445 3855 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2549)
  ...
  have c2497 := blockCostW [opAt 2446 .MULMOD] 8
    (blockOfW _ (pcFactW s 2446 3856 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2550)
  ...
  have c2498 := blockCostW [opAt 2447 .MULMOD] 8
    (blockOfW _ (pcFactW s 2447 3857 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2551)
  ...
  have c2499 := blockCostW [opAt 2448 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2448 3858 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2552)
      (stepW_swap s 3858 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2500 := blockCostW [opAt 2449 .POP] 2
    (blockOfW _ (pcFactW s 2449 3859 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2553)
