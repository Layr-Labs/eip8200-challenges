...
def gasSteps_bitCopy7_sym (s : State) (rest : List UInt256)
  ...
  have step2484 := soundW hs (opAt 2455 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2455 3840 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2537)
      (stepW_dup s 3840 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2485 := soundW hs (pushAt 2456 1 1)
    (blockOfW _ (pcFactW s 2456 3841 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2538)
  ...
  have step2486 := soundW hs (opAt 2457 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2457 3843 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2539)
  ...
  have step2487 := soundW hs (pushAt 2458 1 0)
    (blockOfW _ (pcFactW s 2458 3844 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2540)
  ...
  have step2488 := (soundW hs (opAt 2459 .POP)
    (blockOfW _ (pcFactW s 2459 3846 ([(0 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2541)
      (stepW_pop s 3846 (0 : UInt256) ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))).cast rfl
        (show stW s 3847 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) =
          stW s 3847 ([UInt256.shiftRight byte (0 : UInt256), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) by
            rw [shiftRight_zero])
  have step2489 := soundW hs (opAt 2460 .AND)
    (blockOfW _ (pcFactW s 2460 3847 ([(UInt256.shiftRight byte (0 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2542)
  ...
  have step2490 := soundW hs (opAt 2461 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2461 3848 ([(UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2543)
  ...
  have step2491 := soundW hs (opAt 2462 .MUL)
    (blockOfW _ (pcFactW s 2462 3849 ([Bm1, (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2544)
  ...
  have step2492 := soundW hs (pushAt 2463 1 1)
    (blockOfW _ (pcFactW s 2463 3850 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2545)
  ...
  have step2493 := soundW hs (opAt 2464 .ADD)
    (blockOfW _ (pcFactW s 2464 3852 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2546)
  ...
  have step2494 := soundW hs (opAt 2465 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2465 3853 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2547)
  ...
  have step2495 := soundW hs (opAt 2466 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2466 3854 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2548)
  ...
  have step2496 := soundW hs (opAt 2467 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2467 3855 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2549)
  ...
  have step2497 := soundW hs (opAt 2468 .MULMOD)
    (blockOfW _ (pcFactW s 2468 3856 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2550)
  ...
  have step2498 := soundW hs (opAt 2469 .MULMOD)
    (blockOfW _ (pcFactW s 2469 3857 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2551)
  ...
  have step2499 := soundW hs (opAt 2470 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2470 3858 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2552)
  ...
  have step2500 := soundW hs (opAt 2471 .POP)
    (blockOfW _ (pcFactW s 2471 3859 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2553)
...
theorem gasSteps_bitCopy7_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2484 := blockCostW [opAt 2455 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2455 3840 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2537)
  ...
  have c2485 := blockCostW [pushAt 2456 1 1] 3
    (blockOfW _ (pcFactW s 2456 3841 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2538)
  ...
  have c2486 := blockCostW [opAt 2457 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2457 3843 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2539)
  ...
  have c2487 := blockCostW [pushAt 2458 1 0] 3
    (blockOfW _ (pcFactW s 2458 3844 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2540)
  ...
  have c2488 := blockCostW [opAt 2459 .POP] 2
    (blockOfW _ (pcFactW s 2459 3846 ([(0 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2541)
  ...
  have c2489 := blockCostW [opAt 2460 .AND] 3
    (blockOfW _ (pcFactW s 2460 3847 ([(UInt256.shiftRight byte (0 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2542)
  ...
  have c2490 := blockCostW [opAt 2461 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2461 3848 ([(UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2543)
  ...
  have c2491 := blockCostW [opAt 2462 .MUL] 5
    (blockOfW _ (pcFactW s 2462 3849 ([Bm1, (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2544)
  ...
  have c2492 := blockCostW [pushAt 2463 1 1] 3
    (blockOfW _ (pcFactW s 2463 3850 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2545)
  ...
  have c2493 := blockCostW [opAt 2464 .ADD] 3
    (blockOfW _ (pcFactW s 2464 3852 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2546)
  ...
  have c2494 := blockCostW [opAt 2465 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2465 3853 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2547)
  ...
  have c2495 := blockCostW [opAt 2466 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2466 3854 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2548)
  ...
  have c2496 := blockCostW [opAt 2467 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2467 3855 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2549)
  ...
  have c2497 := blockCostW [opAt 2468 .MULMOD] 8
    (blockOfW _ (pcFactW s 2468 3856 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2550)
  ...
  have c2498 := blockCostW [opAt 2469 .MULMOD] 8
    (blockOfW _ (pcFactW s 2469 3857 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2551)
  ...
  have c2499 := blockCostW [opAt 2470 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2470 3858 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2552)
      (stepW_swap s 3858 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2500 := blockCostW [opAt 2471 .POP] 2
    (blockOfW _ (pcFactW s 2471 3859 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2553)
