...
def gasSteps_bitCopy7_sym (s : State) (rest : List UInt256)
  ...
  have step2484 := soundW hs (opAt 2473 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2473 3224 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2537)
      (stepW_dup s 3224 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2485 := soundW hs (pushAt 2474 1 1)
    (blockOfW _ (pcFactW s 2474 3225 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2538)
  ...
  have step2486 := (soundW hs (opAt 2475 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2475 3227 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2539)
    ...
    (show stW s 3228 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) =
      stW s 3228 ([UInt256.shiftRight byte (0 : UInt256), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) by
        rw [shiftRight_zero])
  have step2489 := soundW hs (opAt 2476 .AND)
    (blockOfW _ (pcFactW s 2476 3228 ([(UInt256.shiftRight byte (0 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2542)
  ...
  have step2490 := soundW hs (opAt 2477 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2477 3229 ([(UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2543)
  ...
  have step2491 := soundW hs (opAt 2478 .MUL)
    (blockOfW _ (pcFactW s 2478 3230 ([Bm1, (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2544)
  ...
  have step2492 := soundW hs (pushAt 2479 1 1)
    (blockOfW _ (pcFactW s 2479 3231 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2545)
  ...
  have step2493 := soundW hs (opAt 2480 .ADD)
    (blockOfW _ (pcFactW s 2480 3233 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2546)
  ...
  have step2494 := soundW hs (opAt 2481 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2481 3234 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2547)
  ...
  have step2495 := soundW hs (opAt 2482 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2482 3235 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2548)
  ...
  have step2496 := soundW hs (opAt 2483 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2483 3236 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2549)
  ...
  have step2497 := soundW hs (opAt 2484 .MULMOD)
    (blockOfW _ (pcFactW s 2484 3237 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2550)
  ...
  have step2498 := soundW hs (opAt 2485 .MULMOD)
    (blockOfW _ (pcFactW s 2485 3238 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2551)
  ...
  have step2499 := soundW hs (opAt 2486 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2486 3239 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2552)
  ...
  have step2500 := soundW hs (opAt 2487 .POP)
    (blockOfW _ (pcFactW s 2487 3240 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2553)
...
theorem gasSteps_bitCopy7_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2484 := blockCostW [opAt 2473 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2473 3224 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2537)
  ...
  have c2485 := blockCostW [pushAt 2474 1 1] 3
    (blockOfW _ (pcFactW s 2474 3225 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2538)
  ...
  have c2486 := blockCostW [opAt 2475 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2475 3227 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2539)
  ...
  have c2489 := blockCostW [opAt 2476 .AND] 3
    (blockOfW _ (pcFactW s 2476 3228 ([(UInt256.shiftRight byte (0 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2542)
  ...
  have c2490 := blockCostW [opAt 2477 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2477 3229 ([(UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2543)
  ...
  have c2491 := blockCostW [opAt 2478 .MUL] 5
    (blockOfW _ (pcFactW s 2478 3230 ([Bm1, (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2544)
  ...
  have c2492 := blockCostW [pushAt 2479 1 1] 3
    (blockOfW _ (pcFactW s 2479 3231 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2545)
  ...
  have c2493 := blockCostW [opAt 2480 .ADD] 3
    (blockOfW _ (pcFactW s 2480 3233 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2546)
  ...
  have c2494 := blockCostW [opAt 2481 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2481 3234 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2547)
  ...
  have c2495 := blockCostW [opAt 2482 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2482 3235 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2548)
  ...
  have c2496 := blockCostW [opAt 2483 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2483 3236 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2549)
  ...
  have c2497 := blockCostW [opAt 2484 .MULMOD] 8
    (blockOfW _ (pcFactW s 2484 3237 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2550)
  ...
  have c2498 := blockCostW [opAt 2485 .MULMOD] 8
    (blockOfW _ (pcFactW s 2485 3238 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2551)
  ...
  have c2499 := blockCostW [opAt 2486 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2486 3239 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2552)
      (stepW_swap s 3239 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2500 := blockCostW [opAt 2487 .POP] 2
    (blockOfW _ (pcFactW s 2487 3240 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (0 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2553)
