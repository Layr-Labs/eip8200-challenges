...
def iterationProgram : List Instr :=
  [.op .JUMPDEST] ++ WindowTwentyOneBody.program ++ WindowTwentyOneTail.program (UInt256.ofNat 2820)
...
def loopState (template : State) (base modulus exponent : UInt256)
  ...
  WindowTwentyOneGroup.state template (UInt256.ofNat 2820) base modulus
...
def finishState (template : State) (base modulus exponent : UInt256)
  ...
  WindowTwentyOneGroup.state template (UInt256.ofNat 3283) base modulus
...
theorem run_continue (template : State) (base modulus exponent : UInt256)
  ...
  have hshift : UInt256.shiftLeft e (UInt256.ofNat 84) =
    ...
    congr 2
  have hh := WindowTwentyOneTail.run_head template (UInt256.ofNat 2820)
    base modulus a e c rest hrest
  have hb := WindowTwentyOneBody.run_twentyOne template (UInt256.ofNat 2821)
    base modulus a exponent c (1 + 21 * count) (by omega) rest hrest
  have ht := WindowTwentyOneTail.run_tail template (UInt256.ofNat 3269) (UInt256.ofNat 2820)
