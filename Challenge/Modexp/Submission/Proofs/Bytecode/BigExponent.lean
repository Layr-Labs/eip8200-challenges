...
theorem run_squareToCopy (s : State) (accumulatorWord : UInt256)
  ...
  have h1000 : (993 : UInt256).toNat = 993 := by decide
  have h1000Word : (993 : UInt256) = UInt256.ofNat 993 := by decide
...
theorem run_copyToProduct (s : State) (accumulatorWord : UInt256)
  ...
  have h310 : (310 : UInt256).toNat = 310 := by decide
  have h310Word : (310 : UInt256) = UInt256.ofNat 310 := by decide
  have h1015 : (1008 : UInt256).toNat = 1008 := by decide
  have h1015Word : (1008 : UInt256) = UInt256.ofNat 1008 := by decide
  have hzero : ({ val := 0 } : UInt256) = 0 := by decide
...
theorem run_productToSelect (s : State) (accumulatorWord : UInt256)
  ...
  have hframe : (bitFrame accumulatorWord count b e m baseOff expOff i j
    ...
    simp [bitFrame]
    omega
  have h1034 : (1027 : UInt256).toNat = 1027 := by decide
  have h1034Word : (1027 : UInt256) = UInt256.ofNat 1027 := by decide
  have hzero : ({ val := 0 } : UInt256) = UInt256.ofNat 0 := by decide
  have h0Word : (0 : UInt256) = UInt256.ofNat 0 := by decide
...
theorem run_selectBody (s : State) (accumulatorWord : UInt256)
  ...
  have hinc := Challenge.EvmProof.Word.ofNat_add_ofNat
    (a := k) (b := 1) hk
  have h1039 : (1032 : UInt256).toNat = 1032 := by decide
  have h1039Word : (1032 : UInt256) = UInt256.ofNat 1032 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
...
theorem run_selectFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have h1090 : (1083 : UInt256).toNat = 1083 := by decide
  have h1090Word : (1083 : UInt256) = UInt256.ofNat 1083 := by decide
...
theorem run_selectFinish (s : State) (accumulatorWord : UInt256)
  ...
  have hc14 : rest.length + 14 < 1024 := by omega
  have hc15 : rest.length + 15 < 1024 := by omega
  have h963 : (956 : UInt256).toNat = 956 := by decide
  have h963Word : (956 : UInt256) = UInt256.ofNat 956 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
...
theorem run_innerFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have h1104 : (1097 : UInt256).toNat = 1097 := by decide
  have h1104Word : (1097 : UInt256) = UInt256.ofNat 1097 := by decide
...
theorem run_innerFinish (s : State) (accumulatorWord : UInt256)
  ...
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
  have h946 : (939 : UInt256).toNat = 939 := by decide
  have h946Word : (939 : UInt256) = UInt256.ofNat 939 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
