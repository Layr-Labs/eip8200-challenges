...
theorem run_innerToSquare (s : State) (accumulatorWord : UInt256)
  ...
  have h310 : (298 : UInt256).toNat = 298 := by decide
  have h310Word : (298 : UInt256) = UInt256.ofNat 298 := by decide
...
theorem run_squareToCopy (s : State) (accumulatorWord : UInt256)
  ...
  have hframe : (bitFrame accumulatorWord count b e m baseOff expOff i j
    ...
    simp [bitFrame]
    omega
  have h58 : (53 : UInt256).toNat = 53 := by decide
  have h58Word : (53 : UInt256) = UInt256.ofNat 53 := by decide
  have h1000 : (963 : UInt256).toNat = 963 := by decide
  have h1000Word : (963 : UInt256) = UInt256.ofNat 963 := by decide
...
theorem run_copyToProduct (s : State) (accumulatorWord : UInt256)
  ...
  have h310 : (298 : UInt256).toNat = 298 := by decide
  have h310Word : (298 : UInt256) = UInt256.ofNat 298 := by decide
  have h1015 : (977 : UInt256).toNat = 977 := by decide
  have h1015Word : (977 : UInt256) = UInt256.ofNat 977 := by decide
  have hzero : ({ val := 0 } : UInt256) = 0 := by decide
...
theorem run_productToSelect (s : State) (accumulatorWord : UInt256)
  ...
  have hframe : (bitFrame accumulatorWord count b e m baseOff expOff i j
    ...
    simp [bitFrame]
    omega
  have h1034 : (996 : UInt256).toNat = 996 := by decide
  have h1034Word : (996 : UInt256) = UInt256.ofNat 996 := by decide
  have hzero : ({ val := 0 } : UInt256) = UInt256.ofNat 0 := by decide
  have h0Word : (0 : UInt256) = UInt256.ofNat 0 := by decide
...
theorem run_selectBody (s : State) (accumulatorWord : UInt256)
  ...
  have hinc := Challenge.EvmProof.Word.ofNat_add_ofNat
    (a := k) (b := 1) hk
  have h1039 : (1001 : UInt256).toNat = 1001 := by decide
  have h1039Word : (1001 : UInt256) = UInt256.ofNat 1001 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
...
theorem run_selectFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have h1090 : (1052 : UInt256).toNat = 1052 := by decide
  have h1090Word : (1052 : UInt256) = UInt256.ofNat 1052 := by decide
...
theorem run_selectFinish (s : State) (accumulatorWord : UInt256)
  ...
  have hc14 : rest.length + 14 < 1024 := by omega
  have hc15 : rest.length + 15 < 1024 := by omega
  have h963 : (926 : UInt256).toNat = 926 := by decide
  have h963Word : (926 : UInt256) = UInt256.ofNat 926 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
...
theorem run_innerFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have h1104 : (1066 : UInt256).toNat = 1066 := by decide
  have h1104Word : (1066 : UInt256) = UInt256.ofNat 1066 := by decide
...
theorem run_innerFinish (s : State) (accumulatorWord : UInt256)
  ...
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
  have h946 : (909 : UInt256).toNat = 909 := by decide
  have h946Word : (909 : UInt256) = UInt256.ofNat 909 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
