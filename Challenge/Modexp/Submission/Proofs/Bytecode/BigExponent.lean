...
theorem run_innerToSquare (s : State) (accumulatorWord : UInt256)
  ...
  have h310 : (327 : UInt256).toNat = 327 := by decide
  have h310Word : (327 : UInt256) = UInt256.ofNat 327 := by decide
...
theorem run_squareToCopy (s : State) (accumulatorWord : UInt256)
  ...
  have hframe : (bitFrame accumulatorWord count b e m baseOff expOff i j
    ...
    simp [bitFrame]
    omega
  have h58 : (46 : UInt256).toNat = 46 := by decide
  have h58Word : (46 : UInt256) = UInt256.ofNat 46 := by decide
  have h1000 : (914 : UInt256).toNat = 914 := by decide
  have h1000Word : (914 : UInt256) = UInt256.ofNat 914 := by decide
...
theorem run_copyToProduct (s : State) (accumulatorWord : UInt256)
  ...
  have h310 : (327 : UInt256).toNat = 327 := by decide
  have h310Word : (327 : UInt256) = UInt256.ofNat 327 := by decide
  have h1015 : (928 : UInt256).toNat = 928 := by decide
  have h1015Word : (928 : UInt256) = UInt256.ofNat 928 := by decide
  have hzero : ({ val := 0 } : UInt256) = 0 := by decide
...
theorem run_productToSelect (s : State) (accumulatorWord : UInt256)
  ...
  have hframe : (bitFrame accumulatorWord count b e m baseOff expOff i j
    ...
    simp [bitFrame]
    omega
  have h1034 : (947 : UInt256).toNat = 947 := by decide
  have h1034Word : (947 : UInt256) = UInt256.ofNat 947 := by decide
  have hzero : ({ val := 0 } : UInt256) = UInt256.ofNat 0 := by decide
  have h0Word : (0 : UInt256) = UInt256.ofNat 0 := by decide
...
theorem run_selectBody (s : State) (accumulatorWord : UInt256)
  ...
  have hinc := Challenge.EvmProof.Word.ofNat_add_ofNat
    (a := k) (b := 1) hk
  have h1039 : (952 : UInt256).toNat = 952 := by decide
  have h1039Word : (952 : UInt256) = UInt256.ofNat 952 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
...
theorem run_selectFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have h1090 : (1003 : UInt256).toNat = 1003 := by decide
  have h1090Word : (1003 : UInt256) = UInt256.ofNat 1003 := by decide
...
theorem run_selectFinish (s : State) (accumulatorWord : UInt256)
  ...
  have hc14 : rest.length + 14 < 1024 := by omega
  have hc15 : rest.length + 15 < 1024 := by omega
  have h963 : (879 : UInt256).toNat = 879 := by decide
  have h963Word : (879 : UInt256) = UInt256.ofNat 879 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
...
theorem run_innerFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have h1104 : (1017 : UInt256).toNat = 1017 := by decide
  have h1104Word : (1017 : UInt256) = UInt256.ofNat 1017 := by decide
...
theorem run_innerFinish (s : State) (accumulatorWord : UInt256)
  ...
  have hc11 : rest.length + 11 < 1024 := by omega
  have hc12 : rest.length + 12 < 1024 := by omega
  have h946 : (862 : UInt256).toNat = 862 := by decide
  have h946Word : (862 : UInt256) = UInt256.ofNat 862 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
