...
def outerFinishGuardPath :
  ...
  [opAt 719 .JUMPDEST, opAt 720 (.Dup ⟨4, by decide⟩),
   ...
   pushAt 724 2 1111, opAt 725 .JUMPI]
...
def serializerGuardPath :
  ...
  [opAt 841 .JUMPDEST, opAt 842 (.Dup ⟨5, by decide⟩),
   ...
   pushAt 846 2 1173, opAt 847 .JUMPI]
...
def serializerBodyPath :
  ...
  [opAt 848 (.Dup ⟨0, by decide⟩), pushAt 849 1 1,
   ...
   pushAt 883 2 1114, opAt 884 .JUMP]
...
@[simp] private theorem outerFinishPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      ([939,940,941,942,943,944,947] : List Nat)[i - 719]! := by
  interval_cases i <;> decide

@[simp] private theorem serializerPCs (i : Nat)
    (hi : 838 ≤ i) (hii : i ≤ 889) :
    Artifact.submissionArtifact.instructionPC i =
      ([1111,1112,1113,1114,1115,1116,1117,1118,1119,1122,1123,1124,1126,1127,1128,1129,1130,1132,1133,1135,1136,1137,1139,1140,1142,1143,1145,1146,1149,1150,1151,1152,1153,1154,1155,1158,1159,1160,1161,1162,1163,1165,1166,1167,1168,1169,1172,1173,1174,1175,1176,1179] : List Nat)[i - 838]! := by
  interval_cases i <;> decide

private theorem jump1118 :
    Decode.isValidJumpDest submissionBytecode 1111 = true :=
...
private theorem jump1180 :
    Decode.isValidJumpDest submissionBytecode 1173 = true :=
...
theorem run_outerFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have h1118 : (1111 : UInt256).toNat = 1111 := by decide
  have h1118Word : (1111 : UInt256) = UInt256.ofNat 1111 := by decide
...
theorem run_serializerBody (s : State) (accumulatorWord : UInt256)
  ...
  have h1121 : (1114 : UInt256).toNat = 1114 := by decide
  have h1121Word : (1114 : UInt256) = UInt256.ofNat 1114 := by decide
...
theorem run_serializerFinishGuard (s : State) (accumulatorWord : UInt256)
  ...
  have hc10 : rest.length + 10 < 1024 := by omega
  have hzeroFalse : ¬(UInt256.ofNat 0).isZero.toNat = 0 := by decide
  have h1180 : (1173 : UInt256).toNat = 1173 := by decide
  have h1180Word : (1173 : UInt256) = UInt256.ofNat 1173 := by decide
  simp [serializerGuardPath, opAt, pushAt, wfOp, serializerLoop,
