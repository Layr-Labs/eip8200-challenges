...
def gasSteps_bitCopy5_sym (s : State) (rest : List UInt256)
  ...
  have step2450 := soundW hs (opAt 2371 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2371 3795 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2503)
      (stepW_dup s 3795 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2451 := soundW hs (pushAt 2372 1 1)
    (blockOfW _ (pcFactW s 2372 3796 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2504)
  ...
  have step2452 := soundW hs (opAt 2373 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2373 3798 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2505)
  ...
  have step2453 := soundW hs (pushAt 2374 1 2)
    (blockOfW _ (pcFactW s 2374 3799 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2506)
  ...
  have step2454 := soundW hs (opAt 2375 .SHR)
    (blockOfW _ (pcFactW s 2375 3801 ([(2 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2507)
      (stepW_shr s 3801 ((2 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2455 := soundW hs (opAt 2376 .AND)
    (blockOfW _ (pcFactW s 2376 3802 ([(UInt256.shiftRight byte (2 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2508)
  ...
  have step2456 := soundW hs (opAt 2377 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2377 3803 ([(UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2509)
  ...
  have step2457 := soundW hs (opAt 2378 .MUL)
    (blockOfW _ (pcFactW s 2378 3804 ([Bm1, (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2510)
  ...
  have step2458 := soundW hs (pushAt 2379 1 1)
    (blockOfW _ (pcFactW s 2379 3805 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2511)
  ...
  have step2459 := soundW hs (opAt 2380 .ADD)
    (blockOfW _ (pcFactW s 2380 3807 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2512)
  ...
  have step2460 := soundW hs (opAt 2381 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2381 3808 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2513)
  ...
  have step2461 := soundW hs (opAt 2382 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2382 3809 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2514)
  ...
  have step2462 := soundW hs (opAt 2383 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2383 3810 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2515)
  ...
  have step2463 := soundW hs (opAt 2384 .MULMOD)
    (blockOfW _ (pcFactW s 2384 3811 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2516)
  ...
  have step2464 := soundW hs (opAt 2385 .MULMOD)
    (blockOfW _ (pcFactW s 2385 3812 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2517)
  ...
  have step2465 := soundW hs (opAt 2386 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2386 3813 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2518)
  ...
  have step2466 := soundW hs (opAt 2387 .POP)
    (blockOfW _ (pcFactW s 2387 3814 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2519)
...
theorem gasSteps_bitCopy5_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2450 := blockCostW [opAt 2371 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2371 3795 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2503)
  ...
  have c2451 := blockCostW [pushAt 2372 1 1] 3
    (blockOfW _ (pcFactW s 2372 3796 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2504)
  ...
  have c2452 := blockCostW [opAt 2373 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2373 3798 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2505)
  ...
  have c2453 := blockCostW [pushAt 2374 1 2] 3
    (blockOfW _ (pcFactW s 2374 3799 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2506)
  ...
  have c2454 := blockCostW [opAt 2375 .SHR] 3
    (blockOfW _ (pcFactW s 2375 3801 ([(2 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2507)
  ...
  have c2455 := blockCostW [opAt 2376 .AND] 3
    (blockOfW _ (pcFactW s 2376 3802 ([(UInt256.shiftRight byte (2 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2508)
  ...
  have c2456 := blockCostW [opAt 2377 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2377 3803 ([(UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2509)
  ...
  have c2457 := blockCostW [opAt 2378 .MUL] 5
    (blockOfW _ (pcFactW s 2378 3804 ([Bm1, (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2510)
  ...
  have c2458 := blockCostW [pushAt 2379 1 1] 3
    (blockOfW _ (pcFactW s 2379 3805 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2511)
  ...
  have c2459 := blockCostW [opAt 2380 .ADD] 3
    (blockOfW _ (pcFactW s 2380 3807 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2512)
  ...
  have c2460 := blockCostW [opAt 2381 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2381 3808 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2513)
  ...
  have c2461 := blockCostW [opAt 2382 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2382 3809 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2514)
  ...
  have c2462 := blockCostW [opAt 2383 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2383 3810 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2515)
  ...
  have c2463 := blockCostW [opAt 2384 .MULMOD] 8
    (blockOfW _ (pcFactW s 2384 3811 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2516)
  ...
  have c2464 := blockCostW [opAt 2385 .MULMOD] 8
    (blockOfW _ (pcFactW s 2385 3812 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2517)
  ...
  have c2465 := blockCostW [opAt 2386 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2386 3813 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2518)
      (stepW_swap s 3813 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2466 := blockCostW [opAt 2387 .POP] 2
    (blockOfW _ (pcFactW s 2387 3814 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2519)
