...
def gasSteps_bitCopy5_sym (s : State) (rest : List UInt256)
  ...
  have step2450 := soundW hs (opAt 2438 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2438 3184 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2503)
      (stepW_dup s 3184 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2451 := soundW hs (pushAt 2439 1 1)
    (blockOfW _ (pcFactW s 2439 3185 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2504)
  ...
  have step2452 := soundW hs (opAt 2440 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2440 3187 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2505)
  ...
  have step2453 := soundW hs (pushAt 2441 1 2)
    (blockOfW _ (pcFactW s 2441 3188 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2506)
  ...
  have step2454 := soundW hs (opAt 2442 .SHR)
    (blockOfW _ (pcFactW s 2442 3190 ([(2 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2507)
      (stepW_shr s 3190 ((2 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2455 := soundW hs (opAt 2443 .AND)
    (blockOfW _ (pcFactW s 2443 3191 ([(UInt256.shiftRight byte (2 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2508)
  ...
  have step2456 := soundW hs (opAt 2444 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2444 3192 ([(UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2509)
  ...
  have step2457 := soundW hs (opAt 2445 .MUL)
    (blockOfW _ (pcFactW s 2445 3193 ([Bm1, (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2510)
  ...
  have step2458 := soundW hs (pushAt 2446 1 1)
    (blockOfW _ (pcFactW s 2446 3194 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2511)
  ...
  have step2459 := soundW hs (opAt 2447 .ADD)
    (blockOfW _ (pcFactW s 2447 3196 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2512)
  ...
  have step2460 := soundW hs (opAt 2448 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2448 3197 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2513)
  ...
  have step2461 := soundW hs (opAt 2449 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2449 3198 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2514)
  ...
  have step2462 := soundW hs (opAt 2450 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2450 3199 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2515)
  ...
  have step2463 := soundW hs (opAt 2451 .MULMOD)
    (blockOfW _ (pcFactW s 2451 3200 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2516)
  ...
  have step2464 := soundW hs (opAt 2452 .MULMOD)
    (blockOfW _ (pcFactW s 2452 3201 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2517)
  ...
  have step2465 := soundW hs (opAt 2453 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2453 3202 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2518)
  ...
  have step2466 := soundW hs (opAt 2454 .POP)
    (blockOfW _ (pcFactW s 2454 3203 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2519)
...
theorem gasSteps_bitCopy5_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2450 := blockCostW [opAt 2438 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2438 3184 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2503)
  ...
  have c2451 := blockCostW [pushAt 2439 1 1] 3
    (blockOfW _ (pcFactW s 2439 3185 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2504)
  ...
  have c2452 := blockCostW [opAt 2440 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2440 3187 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2505)
  ...
  have c2453 := blockCostW [pushAt 2441 1 2] 3
    (blockOfW _ (pcFactW s 2441 3188 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2506)
  ...
  have c2454 := blockCostW [opAt 2442 .SHR] 3
    (blockOfW _ (pcFactW s 2442 3190 ([(2 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2507)
  ...
  have c2455 := blockCostW [opAt 2443 .AND] 3
    (blockOfW _ (pcFactW s 2443 3191 ([(UInt256.shiftRight byte (2 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2508)
  ...
  have c2456 := blockCostW [opAt 2444 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2444 3192 ([(UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2509)
  ...
  have c2457 := blockCostW [opAt 2445 .MUL] 5
    (blockOfW _ (pcFactW s 2445 3193 ([Bm1, (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2510)
  ...
  have c2458 := blockCostW [pushAt 2446 1 1] 3
    (blockOfW _ (pcFactW s 2446 3194 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2511)
  ...
  have c2459 := blockCostW [opAt 2447 .ADD] 3
    (blockOfW _ (pcFactW s 2447 3196 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2512)
  ...
  have c2460 := blockCostW [opAt 2448 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2448 3197 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2513)
  ...
  have c2461 := blockCostW [opAt 2449 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2449 3198 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2514)
  ...
  have c2462 := blockCostW [opAt 2450 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2450 3199 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2515)
  ...
  have c2463 := blockCostW [opAt 2451 .MULMOD] 8
    (blockOfW _ (pcFactW s 2451 3200 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2516)
  ...
  have c2464 := blockCostW [opAt 2452 .MULMOD] 8
    (blockOfW _ (pcFactW s 2452 3201 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2517)
  ...
  have c2465 := blockCostW [opAt 2453 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2453 3202 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2518)
      (stepW_swap s 3202 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2466 := blockCostW [opAt 2454 .POP] 2
    (blockOfW _ (pcFactW s 2454 3203 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (2 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2519)
