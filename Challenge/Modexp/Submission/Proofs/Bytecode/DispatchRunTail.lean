...
private theorem run_wordTail_generic (template : State)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock wordTailPath
      (framed template 1246 [modOff, expOff, m, e, b]) =
    some (framed template 2632
      [b, e, m, UInt256.ofNat 96, expOff, modOff, UInt256.ofNat 1260,
        modOff, expOff, m, e, b]) := by
  have h3000 : (2632 : UInt256).toNat = 2632 := by decide
  have h3000Word : (2632 : UInt256) = UInt256.ofNat 2632 := by decide
  have h96Word : (96 : UInt256) = UInt256.ofNat 96 := by decide
  have h1267Word : (1260 : UInt256) = UInt256.ofNat 1260 := by decide
