...
private theorem run_wordTail_generic (template : State)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock wordTailPath
      (framed template 1215 [modOff, expOff, m, e, b]) =
    some (framed template 2686
      [b, e, m, UInt256.ofNat 96, expOff, modOff, UInt256.ofNat 1229,
        modOff, expOff, m, e, b]) := by
  have h3000 : (2686 : UInt256).toNat = 2686 := by decide
  have h3000Word : (2686 : UInt256) = UInt256.ofNat 2686 := by decide
  have h96Word : (96 : UInt256) = UInt256.ofNat 96 := by decide
  have h1267Word : (1229 : UInt256) = UInt256.ofNat 1229 := by decide
