...
@[simp] theorem directPC1 (i : Nat) (hi : 2045 ≤ i) (hii : i ≤ 2069) :
    Artifact.submissionArtifact.instructionPC i =
      ([2498,2499,2500,2503,2504,2507,2510,2511,2512,2515,2518,2519,2520,2521,2522,2523,2524,2527,2528,2529,2532,2535,2536,2539,2542] : List Nat)[i - 2045]! := by
  rw [Challenge.Modexp.Submission.Proofs.Bytecode.PCFast.instructionPC_eq_byteLength]
  interval_cases i <;> rfl
