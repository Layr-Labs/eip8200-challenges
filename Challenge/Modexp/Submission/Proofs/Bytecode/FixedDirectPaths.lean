...
@[simp] theorem directPC0 (i : Nat) (hi : 1846 ≤ i) (hii : i ≤ 1879) :
    Artifact.submissionArtifact.instructionPC i =
      ([2443,2444,2445,2447,2448,2451,2452,2453,2455,2456,2459,2460,2463,2464,2465,2466,2467,2469,2470,2473,2474,2476,2479,2480,2481,2484,2485,2486,2488,2489,2493,2494,2497,2498] : List Nat)[i - 1846]! := by
  rw [Challenge.Modexp.Submission.Proofs.Bytecode.PCFast.instructionPC_eq_byteLength]
  interval_cases i <;> rfl

@[simp] theorem directPC1 (i : Nat) (hi : 1880 ≤ i) (hii : i ≤ 1912) :
    Artifact.submissionArtifact.instructionPC i =
      ([2500,2501,2502,2505,2506,2509,2512,2513,2514,2517,2520,2521,2522,2523,2524,2525,2526,2529,2530,2531,2534,2537,2538,2541,2544,2545,2546,2547,2550,2553,2554,2555,2558] : List Nat)[i - 1880]! := by
  rw [Challenge.Modexp.Submission.Proofs.Bytecode.PCFast.instructionPC_eq_byteLength]
  interval_cases i <;> rfl
