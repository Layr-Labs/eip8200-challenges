...
namespace Challenge.Modexp.Submission.Proofs.Bytecode.FixedExponentEntryTrace
...
def entryPath : List (Challenge.EvmProof.Stepper.Located
  ...
  [opAt 1265 .JUMPDEST, pushAt 1266 2 3695, opAt 1267 .JUMP]
...
theorem run_entry (s : State) (memory : ByteArray)
  ...
  simp (config := { maxSteps := 300000 })
    [entryPath, opAt, pushAt, wfOp,
      ...
      FixedExponentPaths.jumpDest3680,
...
end Challenge.Modexp.Submission.Proofs.Bytecode.FixedExponentEntryTrace
