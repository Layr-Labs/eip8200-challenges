...
def branchPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [Main.pushAt 1839 2 3020, Main.opAt 1840 .JUMPI]
...
@[simp] theorem routePCs (i : Nat) (hlo : 1826 ≤ i) (hhi : i ≤ 1843) :
    Artifact.submissionArtifact.instructionPC i =
      [2996, 2997, 2998, 3000, 3001, 3002, 3004, 3005, 3006,
       3007, 3009, 3010, 3011, 3012, 3015, 3016, 3019, 3020][i - 1826]! := by
  interval_cases i <;> decide

@[simp] theorem jump3024 :
    Decode.isValidJumpDest submissionBytecode 3020 = true :=
...
def missState (input : ByteArray) : State :=
  { Dispatch.wordEntryState input with pc := UInt256.ofNat 3016 }
