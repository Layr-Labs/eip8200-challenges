...
theorem gasSteps_baseIteration_cost (input : ByteArray) (i : Nat)
    ...
    (gasSteps_baseIteration input i base hvalid hi).cost = 91 := by
  have hguard := blockCost_of_static baseGuardPath 24
    (run_baseGuard input i base hvalid hi) (by rfl)
    (by decide) (by rfl) (by rfl)
  have hcall := blockCost_of_static baseCallPath 20
    (run_baseCall input i base hvalid hi) (by rfl)
    (by decide) (by rfl) (by rfl)
  have htail := blockCost_of_static baseTailPath 47
...
theorem gasSteps_baseLoop_cost (input : ByteArray) (hvalid : ValidInput input) :
    (gasSteps_baseLoop input hvalid).cost = 91 * baseSize input := by
  unfold gasSteps_baseLoop
  have h := Challenge.EvmProof.GasSteps.iterateBounded_cost_of_const
    (count := baseSize input) (cost := 91) (body := fun i hi =>
...
theorem gasSteps_baseFinish_cost (input : ByteArray) (base : UInt256)
    ...
    (gasSteps_baseFinish input base hvalid hword).cost = 38 := by
  have hguard := blockCost_of_static baseGuardPath 24
...
theorem gasSteps_expEnter_cost (input : ByteArray) (i : Nat)
    ...
    (gasSteps_expEnter input i acc base hvalid hi).cost = 45 := by
  have hguard := blockCost_of_static expGuardPath 23
...
theorem gasSteps_bitEntry_cost (input : ByteArray) (outer : Nat)
    ...
    (gasSteps_bitEntry input outer byte offset acc base).cost = 11 :=
...
theorem gasSteps_bitCopy0_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy0 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy0_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
...
theorem gasSteps_bitCopy1_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy1 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy1_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
    (base - UInt256.ofNat 1) byte offset (UInt256.ofNat outer)
    acc base (UInt256.ofNat (modulusValue input))
    (bitFrame input outer byte offset acc base) (by simp [bitTail, callerRest])
...
theorem gasSteps_bitCopy2_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy2 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy2_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
    (base - UInt256.ofNat 1) byte offset (UInt256.ofNat outer)
    acc base (UInt256.ofNat (modulusValue input))
    (bitFrame input outer byte offset acc base) (by simp [bitTail, callerRest])
...
theorem gasSteps_bitCopy3_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy3 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy3_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
    (base - UInt256.ofNat 1) byte offset (UInt256.ofNat outer)
    acc base (UInt256.ofNat (modulusValue input))
    (bitFrame input outer byte offset acc base) (by simp [bitTail, callerRest])
...
theorem gasSteps_bitCopy4_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy4 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy4_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
    (base - UInt256.ofNat 1) byte offset (UInt256.ofNat outer)
    acc base (UInt256.ofNat (modulusValue input))
    (bitFrame input outer byte offset acc base) (by simp [bitTail, callerRest])
...
theorem gasSteps_bitCopy5_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy5 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy5_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
    (base - UInt256.ofNat 1) byte offset (UInt256.ofNat outer)
    acc base (UInt256.ofNat (modulusValue input))
    (bitFrame input outer byte offset acc base) (by simp [bitTail, callerRest])
...
theorem gasSteps_bitCopy6_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy6 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy6_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
    (base - UInt256.ofNat 1) byte offset (UInt256.ofNat outer)
    acc base (UInt256.ofNat (modulusValue input))
    (bitFrame input outer byte offset acc base) (by simp [bitTail, callerRest])
...
theorem gasSteps_bitCopy7_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitCopy7 input outer byte offset acc base).cost = 100 :=
  WordBitsFourCopies.gasSteps_copy7_cost (bitLoopState input outer 0 byte offset acc base) (bitTail input)
    (base - UInt256.ofNat 1) byte offset (UInt256.ofNat outer)
    acc base (UInt256.ofNat (modulusValue input))
    (bitFrame input outer byte offset acc base) (by simp [bitTail, callerRest])
...
theorem gasSteps_bitLoop_cost (input : ByteArray) (outer : Nat)
    (byte offset acc base : UInt256) :
    (gasSteps_bitLoop input outer byte offset acc base).cost = 821 := by
...
theorem gasSteps_expIteration_cost (input : ByteArray) (i : Nat)
    (acc base : UInt256) (hvalid : ValidInput input)
    (hi : i < exponentSize input) :
    (gasSteps_expIteration input i acc base hvalid hi).cost = 903 := by
...
theorem gasSteps_expLoop_cost (input : ByteArray) (acc base : UInt256)
    ...
    (gasSteps_expLoop input acc base hvalid).cost = 903 * exponentSize input := by
  unfold gasSteps_expLoop
  have h := Challenge.EvmProof.GasSteps.iterateBounded_cost_of_const
    (count := exponentSize input) (cost := 903) (body := fun i hi =>
...
theorem gasSteps_expFinish_cost (input : ByteArray) (acc base : UInt256)
    (hvalid : ValidInput input) (hword : modulusSize input ≤ 32) :
    (gasSteps_expFinish input acc base hvalid hword).cost = 46 := by
  have hguard := blockCost_of_static expGuardPath 23
  ...
  have hfinal : (wordFinalState input acc base).activeWords.toNat = 1 := by
    change (UInt256.ofNat (MachineState.activeWordsAfter
      (MachineState.activeWordsAfter 0 0 32) (outputOffset input)
...
def wordGas (input : ByteArray) : Nat :=
  966 + 91 * baseSize input + 761 * exponentSize input
