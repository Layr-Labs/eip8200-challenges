...
def setupPath :
  ...
  [opAt 1088 .JUMPDEST, opAt 1089 (.Dup ⟨2, by decide⟩), pushAt 1090 0 0,
   opAt 1091 .SUB, pushAt 1092 0 0, pushAt 1093 0 0]

def guardPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1094 .JUMPDEST, opAt 1095 (.Dup ⟨7, by decide⟩),
   opAt 1096 (.Dup ⟨1, by decide⟩), opAt 1097 .EQ,
   pushAt 1098 2 170, opAt 1099 .JUMPI]

def bodyPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1100 (.Dup ⟨0, by decide⟩), pushAt 1101 1 5, opAt 1102 .SHL,
   opAt 1103 (.Dup ⟨0, by decide⟩), opAt 1104 (.Dup ⟨5, by decide⟩),
   opAt 1105 .ADD, opAt 1106 .MLOAD,
   opAt 1107 (.Dup ⟨0, by decide⟩), pushAt 1108 1 255, opAt 1109 .SHR,
   opAt 1110 (.Swap ⟨0, by decide⟩), opAt 1111 (.Dup ⟨0, by decide⟩),
   opAt 1112 .ADD, opAt 1113 (.Dup ⟨4, by decide⟩), opAt 1114 .ADD,
   opAt 1115 (.Dup ⟨2, by decide⟩), opAt 1116 (.Dup ⟨7, by decide⟩),
   opAt 1117 .ADD, opAt 1118 .MSTORE,
   opAt 1119 (.Swap ⟨2, by decide⟩), opAt 1120 .POP, opAt 1121 .POP,
   pushAt 1122 1 1, opAt 1123 .ADD, pushAt 1124 2 1479, opAt 1125 .JUMP]
...
@[simp] private theorem doublePCs (i : Nat) (hi : 1088 ≤ i) (hii : i ≤ 1125) :
