...
def bitFinishTailHeadPath :
  ...
  [Word.opAt 521 .JUMPDEST, Word.opAt 522 .POP,
   Word.opAt 523 .POP, Word.opAt 524 .POP]

def bitFinishTailFinishPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [Word.pushAt 525 1 1, Word.opAt 526 .ADD,
   Word.pushAt 527 2 589, Word.opAt 528 .JUMP]

def bitFinishTailMidState (input : ByteArray) (outer : Nat)
    (acc base : UInt256) : State :=
  { bitLoopState input outer 8 0 0 acc base with
    pc := UInt256.ofNat 655
...
@[simp] private theorem exitPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [651,652,653,654,655,657,658,661,662,663,664,665,666,667,668,669,671,672,674,675,676,677,678,679,684][i - 521]! := by
...
theorem run_bitFinishTailHead (input : ByteArray) (outer : Nat)
  ...
  have h656 : (UInt256.ofNat 651).succ = UInt256.ofNat 652 := by decide
  have h657 : (UInt256.ofNat 652).succ = UInt256.ofNat 653 := by decide
  have h658 : (UInt256.ofNat 653).succ = UInt256.ofNat 654 := by decide
  have h659 : (UInt256.ofNat 654).succ = UInt256.ofNat 655 := by decide
