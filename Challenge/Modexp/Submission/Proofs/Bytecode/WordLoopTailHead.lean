...
def bitFinishTailHeadPath :
  ...
  [Word.opAt 522 .JUMPDEST, Word.opAt 523 .POP,
   Word.opAt 524 .POP, Word.opAt 525 .POP]

def bitFinishTailFinishPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [Word.pushAt 526 1 1, Word.opAt 527 .ADD,
   Word.pushAt 528 2 589, Word.opAt 529 .JUMP]
