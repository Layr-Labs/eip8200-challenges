...
def bitFinishTailFinishPath :
  ...
  [Word.pushAt 529 1 1, Word.opAt 530 .ADD,
   Word.pushAt 531 2 587, Word.opAt 532 .JUMP]
...
theorem run_bitFinishTailHead (input : ByteArray) (outer : Nat)
  ...
  have h656 : (UInt256.ofNat 652).succ = UInt256.ofNat 653 := by decide
  have h657 : (UInt256.ofNat 653).succ = UInt256.ofNat 654 := by decide
  have h658 : (UInt256.ofNat 654).succ = UInt256.ofNat 655 := by decide
  have h659 : (UInt256.ofNat 655).succ = UInt256.ofNat 656 := by decide
