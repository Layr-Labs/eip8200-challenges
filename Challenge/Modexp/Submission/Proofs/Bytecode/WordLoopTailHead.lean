...
theorem run_bitFinishTailHead (input : ByteArray) (outer : Nat)
  ...
  have h656 : (UInt256.ofNat 212).succ = UInt256.ofNat 213 := by decide
  have h657 : (UInt256.ofNat 213).succ = UInt256.ofNat 214 := by decide
  have h658 : (UInt256.ofNat 214).succ = UInt256.ofNat 215 := by decide
  have h659 : (UInt256.ofNat 215).succ = UInt256.ofNat 216 := by decide
