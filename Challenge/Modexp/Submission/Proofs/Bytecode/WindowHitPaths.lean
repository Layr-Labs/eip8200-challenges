...
def table4Path := updateAt 1874 128
def table5Path := updateAt 1883 160
def table6Path := updateAt 1892 192
def table7Path := updateAt 1901 224
def table8Path := updateAt 1910 256
def table9Path := updateAt 1919 288
def table10Path := updateAt 1928 320
def table11Path := updateAt 1937 352
def table12Path := updateAt 1946 384
def table13Path := updateAt 1955 416
def table14Path := updateAt 1964 448
def table15Path := updateAt 1973 480
...
@[simp] theorem jump3556 :
    Decode.isValidJumpDest submissionBytecode 3556 = true :=
  Artifact.isValidJumpDest_index 2326 (by rfl)

@[simp] theorem jump3548 :
    Decode.isValidJumpDest submissionBytecode 3548 = true :=
  Artifact.isValidJumpDest_index 2319 (by rfl)

@[simp] theorem jump3190 :
    Decode.isValidJumpDest submissionBytecode 3190 = true :=
