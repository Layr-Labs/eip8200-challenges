...
def gasSteps_bitCopy1_sym (s : State) (rest : List UInt256)
  ...
  have step2382 := soundW hs (opAt 2311 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2311 3715 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2435)
      (stepW_dup s 3715 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2383 := soundW hs (pushAt 2312 1 1)
    (blockOfW _ (pcFactW s 2312 3716 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2436)
  ...
  have step2384 := soundW hs (opAt 2313 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2313 3718 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2437)
  ...
  have step2385 := soundW hs (pushAt 2314 1 6)
    (blockOfW _ (pcFactW s 2314 3719 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2438)
  ...
  have step2386 := soundW hs (opAt 2315 .SHR)
    (blockOfW _ (pcFactW s 2315 3721 ([(6 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2439)
      (stepW_shr s 3721 ((6 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2387 := soundW hs (opAt 2316 .AND)
    (blockOfW _ (pcFactW s 2316 3722 ([(UInt256.shiftRight byte (6 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2440)
  ...
  have step2388 := soundW hs (opAt 2317 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2317 3723 ([(UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2441)
  ...
  have step2389 := soundW hs (opAt 2318 .MUL)
    (blockOfW _ (pcFactW s 2318 3724 ([Bm1, (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2442)
  ...
  have step2390 := soundW hs (pushAt 2319 1 1)
    (blockOfW _ (pcFactW s 2319 3725 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2443)
  ...
  have step2391 := soundW hs (opAt 2320 .ADD)
    (blockOfW _ (pcFactW s 2320 3727 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2444)
  ...
  have step2392 := soundW hs (opAt 2321 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2321 3728 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2445)
  ...
  have step2393 := soundW hs (opAt 2322 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2322 3729 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2446)
  ...
  have step2394 := soundW hs (opAt 2323 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2323 3730 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2447)
  ...
  have step2395 := soundW hs (opAt 2324 .MULMOD)
    (blockOfW _ (pcFactW s 2324 3731 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2448)
  ...
  have step2396 := soundW hs (opAt 2325 .MULMOD)
    (blockOfW _ (pcFactW s 2325 3732 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2449)
  ...
  have step2397 := soundW hs (opAt 2326 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2326 3733 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2450)
  ...
  have step2398 := soundW hs (opAt 2327 .POP)
    (blockOfW _ (pcFactW s 2327 3734 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2451)
...
theorem gasSteps_bitCopy1_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2382 := blockCostW [opAt 2311 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2311 3715 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2435)
  ...
  have c2383 := blockCostW [pushAt 2312 1 1] 3
    (blockOfW _ (pcFactW s 2312 3716 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2436)
  ...
  have c2384 := blockCostW [opAt 2313 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2313 3718 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2437)
  ...
  have c2385 := blockCostW [pushAt 2314 1 6] 3
    (blockOfW _ (pcFactW s 2314 3719 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2438)
  ...
  have c2386 := blockCostW [opAt 2315 .SHR] 3
    (blockOfW _ (pcFactW s 2315 3721 ([(6 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2439)
  ...
  have c2387 := blockCostW [opAt 2316 .AND] 3
    (blockOfW _ (pcFactW s 2316 3722 ([(UInt256.shiftRight byte (6 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2440)
  ...
  have c2388 := blockCostW [opAt 2317 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2317 3723 ([(UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2441)
  ...
  have c2389 := blockCostW [opAt 2318 .MUL] 5
    (blockOfW _ (pcFactW s 2318 3724 ([Bm1, (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2442)
  ...
  have c2390 := blockCostW [pushAt 2319 1 1] 3
    (blockOfW _ (pcFactW s 2319 3725 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2443)
  ...
  have c2391 := blockCostW [opAt 2320 .ADD] 3
    (blockOfW _ (pcFactW s 2320 3727 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2444)
  ...
  have c2392 := blockCostW [opAt 2321 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2321 3728 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2445)
  ...
  have c2393 := blockCostW [opAt 2322 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2322 3729 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2446)
  ...
  have c2394 := blockCostW [opAt 2323 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2323 3730 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2447)
  ...
  have c2395 := blockCostW [opAt 2324 .MULMOD] 8
    (blockOfW _ (pcFactW s 2324 3731 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2448)
  ...
  have c2396 := blockCostW [opAt 2325 .MULMOD] 8
    (blockOfW _ (pcFactW s 2325 3732 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2449)
  ...
  have c2397 := blockCostW [opAt 2326 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2326 3733 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2450)
      (stepW_swap s 3733 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2398 := blockCostW [opAt 2327 .POP] 2
    (blockOfW _ (pcFactW s 2327 3734 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2451)
