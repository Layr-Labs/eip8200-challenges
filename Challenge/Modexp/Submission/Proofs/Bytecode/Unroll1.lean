...
def gasSteps_bitCopy1_sym (s : State) (rest : List UInt256)
  ...
  have step2382 := soundW hs (opAt 2353 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2353 3720 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2435)
      (stepW_dup s 3720 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2383 := soundW hs (pushAt 2354 1 1)
    (blockOfW _ (pcFactW s 2354 3721 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2436)
  ...
  have step2384 := soundW hs (opAt 2355 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2355 3723 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2437)
  ...
  have step2385 := soundW hs (pushAt 2356 1 6)
    (blockOfW _ (pcFactW s 2356 3724 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2438)
  ...
  have step2386 := soundW hs (opAt 2357 .SHR)
    (blockOfW _ (pcFactW s 2357 3726 ([(6 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2439)
      (stepW_shr s 3726 ((6 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2387 := soundW hs (opAt 2358 .AND)
    (blockOfW _ (pcFactW s 2358 3727 ([(UInt256.shiftRight byte (6 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2440)
  ...
  have step2388 := soundW hs (opAt 2359 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2359 3728 ([(UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2441)
  ...
  have step2389 := soundW hs (opAt 2360 .MUL)
    (blockOfW _ (pcFactW s 2360 3729 ([Bm1, (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2442)
  ...
  have step2390 := soundW hs (pushAt 2361 1 1)
    (blockOfW _ (pcFactW s 2361 3730 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2443)
  ...
  have step2391 := soundW hs (opAt 2362 .ADD)
    (blockOfW _ (pcFactW s 2362 3732 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2444)
  ...
  have step2392 := soundW hs (opAt 2363 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2363 3733 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2445)
  ...
  have step2393 := soundW hs (opAt 2364 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2364 3734 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2446)
  ...
  have step2394 := soundW hs (opAt 2365 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2365 3735 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2447)
  ...
  have step2395 := soundW hs (opAt 2366 .MULMOD)
    (blockOfW _ (pcFactW s 2366 3736 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2448)
  ...
  have step2396 := soundW hs (opAt 2367 .MULMOD)
    (blockOfW _ (pcFactW s 2367 3737 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2449)
  ...
  have step2397 := soundW hs (opAt 2368 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2368 3738 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2450)
  ...
  have step2398 := soundW hs (opAt 2369 .POP)
    (blockOfW _ (pcFactW s 2369 3739 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2451)
...
theorem gasSteps_bitCopy1_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2382 := blockCostW [opAt 2353 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2353 3720 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2435)
  ...
  have c2383 := blockCostW [pushAt 2354 1 1] 3
    (blockOfW _ (pcFactW s 2354 3721 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2436)
  ...
  have c2384 := blockCostW [opAt 2355 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2355 3723 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2437)
  ...
  have c2385 := blockCostW [pushAt 2356 1 6] 3
    (blockOfW _ (pcFactW s 2356 3724 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2438)
  ...
  have c2386 := blockCostW [opAt 2357 .SHR] 3
    (blockOfW _ (pcFactW s 2357 3726 ([(6 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2439)
  ...
  have c2387 := blockCostW [opAt 2358 .AND] 3
    (blockOfW _ (pcFactW s 2358 3727 ([(UInt256.shiftRight byte (6 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2440)
  ...
  have c2388 := blockCostW [opAt 2359 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2359 3728 ([(UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2441)
  ...
  have c2389 := blockCostW [opAt 2360 .MUL] 5
    (blockOfW _ (pcFactW s 2360 3729 ([Bm1, (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2442)
  ...
  have c2390 := blockCostW [pushAt 2361 1 1] 3
    (blockOfW _ (pcFactW s 2361 3730 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2443)
  ...
  have c2391 := blockCostW [opAt 2362 .ADD] 3
    (blockOfW _ (pcFactW s 2362 3732 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2444)
  ...
  have c2392 := blockCostW [opAt 2363 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2363 3733 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2445)
  ...
  have c2393 := blockCostW [opAt 2364 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2364 3734 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2446)
  ...
  have c2394 := blockCostW [opAt 2365 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2365 3735 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2447)
  ...
  have c2395 := blockCostW [opAt 2366 .MULMOD] 8
    (blockOfW _ (pcFactW s 2366 3736 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2448)
  ...
  have c2396 := blockCostW [opAt 2367 .MULMOD] 8
    (blockOfW _ (pcFactW s 2367 3737 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2449)
  ...
  have c2397 := blockCostW [opAt 2368 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2368 3738 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2450)
      (stepW_swap s 3738 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2398 := blockCostW [opAt 2369 .POP] 2
    (blockOfW _ (pcFactW s 2369 3739 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (6 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2451)
