...
def framePrepProgram : List Instr :=
  [.push 1 2, .push 2 480, .op (.Dup ⟨6, by decide⟩), .op .CALLDATALOAD,
   .push 1 1, .op .SHL]
...
private theorem run_framePrep (template : State) (base modulus exponentOffset : UInt256)
    ...
    some (WindowTwentyOneTable.framed template (UInt256.ofNat 1766) base modulus 16
      ([UInt256.shiftLeft
...
private theorem run_modulusLoad (template : State)
    ...
    runInstructions modulusLoadProgram
      (WindowTwentyOneTable.framed template (UInt256.ofNat 1766) base modulus 16
        ([exponentShifted, UInt256.ofNat 480, UInt256.ofNat 2] ++ rest)) =
    some (WindowTwentyOneTable.framed template (UInt256.ofNat 1768) base modulus 16
...
private theorem run_address (template : State)
    ...
    runInstructions addressProgram
      (WindowTwentyOneTable.framed template (UInt256.ofNat 1768) base modulus 16
        ([modulus, exponentShifted, UInt256.ofNat 480, UInt256.ofNat 2] ++ rest)) =
    some (WindowTwentyOneTable.framed template (UInt256.ofNat 1775) base modulus 16
...
private theorem run_mload (template : State)
    ...
    runInstructions [.op .MLOAD]
      (WindowTwentyOneTable.framed template (UInt256.ofNat 1775) base modulus 16
        ([address exponent, modulus, exponentShifted, UInt256.ofNat 480, UInt256.ofNat 2] ++ rest)) =
    some (WindowTwentyOneGroup.state template (UInt256.ofNat 1776)
