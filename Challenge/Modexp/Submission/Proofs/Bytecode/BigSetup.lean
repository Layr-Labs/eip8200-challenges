...
def setupToClear0Path :
  ...
  [opAt 563 .JUMPDEST, pushAt 564 1 31, opAt 565 (.Dup ⟨3, by decide⟩),
   opAt 566 .ADD, pushAt 567 1 5, opAt 568 .SHR, pushAt 569 2 721,
   opAt 570 (.Dup ⟨1, by decide⟩), pushAt 571 0 0, pushAt 572 2 19,
   opAt 573 .JUMP]

def toClear1024Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 574 .JUMPDEST, pushAt 575 2 733, opAt 576 (.Dup ⟨1, by decide⟩),
   pushAt 577 2 1024, pushAt 578 2 19, opAt 579 .JUMP]

def toClear2048Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 580 .JUMPDEST, pushAt 581 2 745, opAt 582 (.Dup ⟨1, by decide⟩),
   pushAt 583 2 2048, pushAt 584 2 19, opAt 585 .JUMP]

def toClear6144Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 586 .JUMPDEST, pushAt 587 2 757, opAt 588 (.Dup ⟨1, by decide⟩),
   pushAt 589 2 6144, pushAt 590 2 19, opAt 591 .JUMP]
