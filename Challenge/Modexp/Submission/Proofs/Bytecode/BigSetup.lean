...
def setupToClear0Path :
  ...
  [opAt 524 .JUMPDEST, pushAt 525 1 31,
   opAt 526 (.Dup ⟨3, by decide⟩), opAt 527 .ADD,
   pushAt 528 1 5, opAt 529 .SHR, pushAt 530 2 653,
   opAt 531 (.Dup ⟨1, by decide⟩), pushAt 532 0 0,
   pushAt 533 1 65, opAt 534 .JUMP]

def toClear1024Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 535 .JUMPDEST, pushAt 536 2 664,
   opAt 537 (.Dup ⟨1, by decide⟩), pushAt 538 2 1024,
   pushAt 539 1 65, opAt 540 .JUMP]

def toClear2048Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 541 .JUMPDEST, pushAt 542 2 675,
   opAt 543 (.Dup ⟨1, by decide⟩), pushAt 544 2 2048,
   pushAt 545 1 65, opAt 546 .JUMP]

def toClear6144Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 547 .JUMPDEST, pushAt 548 2 686,
   opAt 549 (.Dup ⟨1, by decide⟩), pushAt 550 2 6144,
   pushAt 551 1 65, opAt 552 .JUMP]

def toLoadModulusPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 553 .JUMPDEST, pushAt 554 2 697, pushAt 555 0 0,
   opAt 556 (.Dup ⟨5, by decide⟩), opAt 557 (.Dup ⟨9, by decide⟩),
   pushAt 558 2 452, opAt 559 .JUMP]
...
def afterClear0 (s : State) (b e m baseOff expOff modOff : Nat)
    (returnDest : UInt256) (rest : List UInt256) : State :=
  BigHelpers.clearReturned s 0 (Limbs.limbCount m) 653
...
def setupReturned (s : State) (b e m baseOff expOff modOff : Nat)
  ...
  BigLoad.loadReturned
    ...
    (UInt256.ofNat modOff) (UInt256.ofNat m) 0 697
    (saved b e m baseOff expOff modOff returnDest rest)

@[simp] private theorem setupPCs (i : Nat)
    (hi : 524 ≤ i) (hii : i ≤ 559) :
    Artifact.submissionArtifact.instructionPC i =
      ([637,638,640,641,642,644,645,648,649,650,652,653,654,657,658,661,663,664,665,668,669,672,674,675,676,679,680,683,685,686,687,690,691,692,693,696] : List Nat)[i - 524]! := by
...
private theorem jump439 :
    Decode.isValidJumpDest submissionBytecode 452 = true :=
  Artifact.isValidJumpDest_index 376 (by rfl)

private theorem jump721 :
    Decode.isValidJumpDest submissionBytecode 653 = true :=
  Artifact.isValidJumpDest_index 535 (by rfl)

private theorem jump733 :
    Decode.isValidJumpDest submissionBytecode 664 = true :=
  Artifact.isValidJumpDest_index 541 (by rfl)

private theorem jump745 :
    Decode.isValidJumpDest submissionBytecode 675 = true :=
  Artifact.isValidJumpDest_index 547 (by rfl)

private theorem jump757 :
    Decode.isValidJumpDest submissionBytecode 686 = true :=
  Artifact.isValidJumpDest_index 553 (by rfl)

private theorem jump768 :
    Decode.isValidJumpDest submissionBytecode 697 = true :=
...
theorem run_setupToClear0 (s : State) (b e m baseOff expOff modOff : Nat)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock setupToClear0Path
      (setupEntry s b e m baseOff expOff modOff returnDest rest) =
        some (BigHelpers.clearEntry s 0 (Limbs.limbCount m) 653
  ...
  have h721Word : (653 : UInt256) = UInt256.ofNat 653 := by decide
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock toClear1024Path
      (afterClear0 s b e m baseOff expOff modOff returnDest rest) =
        some (BigHelpers.clearEntry
          ...
          1024 (Limbs.limbCount m) 664
          (saved b e m baseOff expOff modOff returnDest rest)) := by
  have h721 : (653 : UInt256).toNat = 653 := by decide
  have h721Word : (653 : UInt256) = UInt256.ofNat 653 := by decide
  have h19 : (65 : UInt256).toNat = 65 := by decide
  have h19Word : (65 : UInt256) = UInt256.ofNat 65 := by decide
  have hc8 : rest.length + 8 < 1024 := by omega
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock toClear2048Path
      (afterClear1024 s b e m baseOff expOff modOff returnDest rest) =
        some (BigHelpers.clearEntry
          ...
          2048 (Limbs.limbCount m) 675
          (saved b e m baseOff expOff modOff returnDest rest)) := by
  have h733 : (664 : UInt256).toNat = 664 := by decide
  have h733Word : (664 : UInt256) = UInt256.ofNat 664 := by decide
  have h19 : (65 : UInt256).toNat = 65 := by decide
  have h19Word : (65 : UInt256) = UInt256.ofNat 65 := by decide
  have hc8 : rest.length + 8 < 1024 := by omega
  have hc9 : rest.length + 9 < 1024 := by omega
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock toClear6144Path
      (afterClear2048 s b e m baseOff expOff modOff returnDest rest) =
        some (BigHelpers.clearEntry
          ...
          6144 (Limbs.limbCount m) 686
          (saved b e m baseOff expOff modOff returnDest rest)) := by
  have h745 : (675 : UInt256).toNat = 675 := by decide
  have h745Word : (675 : UInt256) = UInt256.ofNat 675 := by decide
  have h19 : (65 : UInt256).toNat = 65 := by decide
  have h19Word : (65 : UInt256) = UInt256.ofNat 65 := by decide
  have hc8 : rest.length + 8 < 1024 := by omega
  have hc9 : rest.length + 9 < 1024 := by omega
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock toLoadModulusPath
      (afterClear6144 s b e m baseOff expOff modOff returnDest rest) =
        some (BigLoad.loadEntry
          ...
          (UInt256.ofNat modOff) (UInt256.ofNat m) 0 697
          (saved b e m baseOff expOff modOff returnDest rest)) := by
  have h757 : (686 : UInt256).toNat = 686 := by decide
  have h757Word : (686 : UInt256) = UInt256.ofNat 686 := by decide
  have hzero : ({ val := 0 } : UInt256) = UInt256.ofNat 0 := by decide
  have h0Word : (0 : UInt256) = UInt256.ofNat 0 := by decide
  have h439 : (452 : UInt256).toNat = 452 := by decide
  have h439Word : (452 : UInt256) = UInt256.ofNat 452 := by decide
  have hc8 : rest.length + 8 < 1024 := by omega
  have hc9 : rest.length + 9 < 1024 := by omega
  have hc10 : rest.length + 10 < 1024 := by omega
  have hc11 : rest.length + 11 < 1024 := by omega
...
def gasSteps_setupToClear0 (s : State) (b e m baseOff expOff modOff : Nat)
    ...
    Challenge.EvmProof.GasSteps
      (setupEntry s b e m baseOff expOff modOff returnDest rest)
      (BigHelpers.clearEntry s 0 (Limbs.limbCount m) 653
        (saved b e m baseOff expOff modOff returnDest rest)) :=
...
def gasSteps_setup (s : State) (b e m baseOff expOff modOff : Nat)
  ...
  exact
    ...
    (BigHelpers.gasSteps_clear s 0 (Limbs.limbCount m) 653 frame
      hframeClear hn hcode hfork hrun hnp jump721).trans <|
    (gasSteps_toClear1024 s b e m baseOff expOff modOff returnDest rest
      hcapSetup hcode hfork hrun hnp).trans <|
    (BigHelpers.gasSteps_clear s0 1024 (Limbs.limbCount m) 664 frame
      hframeClear hn hcode0 hfork0 hrun0 hnp0 jump733).trans <|
    (gasSteps_toClear2048 s b e m baseOff expOff modOff returnDest rest
      hcapSetup hcode hfork hrun hnp).trans <|
    (BigHelpers.gasSteps_clear s1 2048 (Limbs.limbCount m) 675 frame
      hframeClear hn hcode1 hfork1 hrun1 hnp1 jump745).trans <|
    (gasSteps_toClear6144 s b e m baseOff expOff modOff returnDest rest
      hcapSetup hcode hfork hrun hnp).trans <|
    (BigHelpers.gasSteps_clear s2 6144 (Limbs.limbCount m) 686 frame
      hframeClear hn hcode2 hfork2 hrun2 hnp2 jump757).trans <|
    (gasSteps_toLoadModulus s b e m baseOff expOff modOff returnDest rest
      hm hmodOff hcap hcode hfork hrun hnp).trans <|
    BigLoad.gasSteps_loadBigEndian s3 modOff m 0 697 frame hframeLoad
...
theorem gasSteps_setup_cost_potential (s : State)
  ...
  have hc0 := BigHelpers.gasSteps_clear_cost_potential s 0 n 653 frame
    hframeClear hn hcode hfork hrun hnp jump721
  have hc1 := BigHelpers.gasSteps_clear_cost_potential s0 1024 n 664 frame
    hframeClear hn hcode0 hfork0 hrun0 hnp0 jump733
  have hc2 := BigHelpers.gasSteps_clear_cost_potential s1 2048 n 675 frame
    hframeClear hn hcode1 hfork1 hrun1 hnp1 jump745
  have hc3 := BigHelpers.gasSteps_clear_cost_potential s2 6144 n 686 frame
    hframeClear hn hcode2 hfork2 hrun2 hnp2 jump757
  have hl := BigLoad.gasSteps_loadBigEndian_cost_potential s3 modOff m 0 697
...
theorem setupReturned_modulus_represents (s : State)
  ...
  have hm : m < 2 ^ 256 := by omega
  have hloaded := BigLoadCorrect.loadReturned_represents s3 modOff 0 m 697
