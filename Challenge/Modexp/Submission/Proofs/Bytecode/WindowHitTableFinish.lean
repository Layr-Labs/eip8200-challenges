...
private theorem run_tableFinish_generic (template : State)
  ...
  have hpc3236 : (UInt256.ofNat 3236).toNat = 3236 := by decide
  have hpc3237 : (UInt256.ofNat 3237).toNat = 3237 := by decide
  have hpc3239 : (UInt256.ofNat 3239).toNat = 3239 := by decide
  have hsucc3236 : (UInt256.ofNat 3236).succ = UInt256.ofNat 3237 := by decide
  have hadd3237 : UInt256.ofNat 3237 + UInt256.ofNat 2 = UInt256.ofNat 3239 := by decide
  have hadd3239 : UInt256.ofNat 3239 + UInt256.ofNat 2 = UInt256.ofNat 3241 := by decide
  simp (disch := omega) [tableFinishPath, Main.opAt, Main.pushAt, Main.wfOp,
    ...
    hpc3236, hpc3237, hpc3239, hsucc3236, hadd3237, hadd3239,
...
def gasSteps_tableFinish (input : ByteArray) :
    Challenge.EvmProof.GasSteps (tableState input 15 3235)
