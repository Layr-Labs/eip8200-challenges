...
private theorem run_tableFinish_generic (template : State)
  ...
  have hpc3221 : (UInt256.ofNat 3221).toNat = 3221 := by decide
  have hpc3222 : (UInt256.ofNat 3222).toNat = 3222 := by decide
  have hpc3224 : (UInt256.ofNat 3224).toNat = 3224 := by decide
  have hsucc3221 : (UInt256.ofNat 3221).succ = UInt256.ofNat 3222 := by decide
  have hadd3222 : UInt256.ofNat 3222 + UInt256.ofNat 2 = UInt256.ofNat 3224 := by decide
  have hadd3224 : UInt256.ofNat 3224 + UInt256.ofNat 2 = UInt256.ofNat 3226 := by decide
  simp (disch := omega) [tableFinishPath, Main.opAt, Main.pushAt, Main.wfOp,
    ...
    hpc3221, hpc3222, hpc3224, hsucc3221, hadd3222, hadd3224,
...
def gasSteps_tableFinish (input : ByteArray) :
    Challenge.EvmProof.GasSteps (tableState input 15 3220)
