...
@[simp] private theorem finishPCs (index : Nat)
    ...
    Artifact.submissionArtifact.instructionPC index =
      [3161, 3162, 3163, 3165][index - 1956]! := by
...
private theorem run_tableFinish_generic (template : State)
  ...
  have hpc3192 : (UInt256.ofNat 3162).toNat = 3162 := by decide
  have hpc3193 : (UInt256.ofNat 3163).toNat = 3163 := by decide
  have hpc3195 : (UInt256.ofNat 3165).toNat = 3165 := by decide
  have hsucc3192 : (UInt256.ofNat 3162).succ = UInt256.ofNat 3163 := by decide
  have hadd3193 : UInt256.ofNat 3163 + UInt256.ofNat 2 = UInt256.ofNat 3165 := by decide
  have hadd3195 : UInt256.ofNat 3165 + UInt256.ofNat 2 = UInt256.ofNat 3167 := by decide
...
def gasSteps_tableFinish (input : ByteArray) :
    Challenge.EvmProof.GasSteps (tableState input 15 3161)
