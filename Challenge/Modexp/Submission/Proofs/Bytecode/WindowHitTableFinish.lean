...
private theorem run_tableFinish_generic (template : State)
  ...
  have hpc3192 : (UInt256.ofNat 2977).toNat = 2977 := by decide
  have hpc3193 : (UInt256.ofNat 2978).toNat = 2978 := by decide
  have hpc3195 : (UInt256.ofNat 2980).toNat = 2980 := by decide
  have hsucc3192 : (UInt256.ofNat 2977).succ = UInt256.ofNat 2978 := by decide
  have hadd3193 : UInt256.ofNat 2978 + UInt256.ofNat 2 = UInt256.ofNat 2980 := by decide
  have hadd3195 : UInt256.ofNat 2980 + UInt256.ofNat 2 = UInt256.ofNat 2982 := by decide
...
def gasSteps_tableFinish (input : ByteArray) :
    Challenge.EvmProof.GasSteps (tableState input 15 2976)
