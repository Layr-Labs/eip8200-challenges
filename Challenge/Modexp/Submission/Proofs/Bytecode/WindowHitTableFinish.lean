...
@[simp] private theorem finishPCs (index : Nat)
    (hlo : 1935 ≤ index) (hhi : index ≤ 1938) :
    Artifact.submissionArtifact.instructionPC index =
      [3153,3154,3155,3157][index - 1935]! := by
...
private theorem run_tableFinish_generic (template : State)
  ...
  have hpc3192 : (UInt256.ofNat 3154).toNat = 3154 := by decide
  have hpc3193 : (UInt256.ofNat 3155).toNat = 3155 := by decide
  have hpc3195 : (UInt256.ofNat 3157).toNat = 3157 := by decide
  have hsucc3192 : (UInt256.ofNat 3154).succ = UInt256.ofNat 3155 := by decide
  have hadd3193 : UInt256.ofNat 3155 + UInt256.ofNat 2 = UInt256.ofNat 3157 := by decide
  have hadd3195 : UInt256.ofNat 3157 + UInt256.ofNat 2 = UInt256.ofNat 3159 := by decide
...
def gasSteps_tableFinish (input : ByteArray) :
    Challenge.EvmProof.GasSteps (tableState input 15 3153)
