...
def gasSteps_bitCopy0_sym (s : State) (rest : List UInt256)
  ...
  have step2365 := soundW hs (opAt 2336 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2336 3700 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2418)
      (stepW_dup s 3700 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2366 := soundW hs (pushAt 2337 1 1)
    (blockOfW _ (pcFactW s 2337 3701 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2419)
  ...
  have step2367 := soundW hs (opAt 2338 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2338 3703 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2420)
  ...
  have step2368 := soundW hs (pushAt 2339 1 7)
    (blockOfW _ (pcFactW s 2339 3704 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2421)
  ...
  have step2369 := soundW hs (opAt 2340 .SHR)
    (blockOfW _ (pcFactW s 2340 3706 ([(7 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2422)
      (stepW_shr s 3706 ((7 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2370 := soundW hs (opAt 2341 .AND)
    (blockOfW _ (pcFactW s 2341 3707 ([(UInt256.shiftRight byte (7 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2423)
  ...
  have step2371 := soundW hs (opAt 2342 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2342 3708 ([(UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2424)
  ...
  have step2372 := soundW hs (opAt 2343 .MUL)
    (blockOfW _ (pcFactW s 2343 3709 ([Bm1, (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2425)
  ...
  have step2373 := soundW hs (pushAt 2344 1 1)
    (blockOfW _ (pcFactW s 2344 3710 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2426)
  ...
  have step2374 := soundW hs (opAt 2345 .ADD)
    (blockOfW _ (pcFactW s 2345 3712 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2427)
  ...
  have step2375 := soundW hs (opAt 2346 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2346 3713 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2428)
  ...
  have step2376 := soundW hs (opAt 2347 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2347 3714 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2429)
  ...
  have step2377 := soundW hs (opAt 2348 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2348 3715 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2430)
  ...
  have step2378 := soundW hs (opAt 2349 .MULMOD)
    (blockOfW _ (pcFactW s 2349 3716 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2431)
  ...
  have step2379 := soundW hs (opAt 2350 .MULMOD)
    (blockOfW _ (pcFactW s 2350 3717 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2432)
  ...
  have step2380 := soundW hs (opAt 2351 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2351 3718 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2433)
  ...
  have step2381 := soundW hs (opAt 2352 .POP)
    (blockOfW _ (pcFactW s 2352 3719 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2434)
...
theorem gasSteps_bitCopy0_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2365 := blockCostW [opAt 2336 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2336 3700 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2418)
  ...
  have c2366 := blockCostW [pushAt 2337 1 1] 3
    (blockOfW _ (pcFactW s 2337 3701 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2419)
  ...
  have c2367 := blockCostW [opAt 2338 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2338 3703 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2420)
  ...
  have c2368 := blockCostW [pushAt 2339 1 7] 3
    (blockOfW _ (pcFactW s 2339 3704 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2421)
  ...
  have c2369 := blockCostW [opAt 2340 .SHR] 3
    (blockOfW _ (pcFactW s 2340 3706 ([(7 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2422)
  ...
  have c2370 := blockCostW [opAt 2341 .AND] 3
    (blockOfW _ (pcFactW s 2341 3707 ([(UInt256.shiftRight byte (7 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2423)
  ...
  have c2371 := blockCostW [opAt 2342 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2342 3708 ([(UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2424)
  ...
  have c2372 := blockCostW [opAt 2343 .MUL] 5
    (blockOfW _ (pcFactW s 2343 3709 ([Bm1, (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2425)
  ...
  have c2373 := blockCostW [pushAt 2344 1 1] 3
    (blockOfW _ (pcFactW s 2344 3710 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2426)
  ...
  have c2374 := blockCostW [opAt 2345 .ADD] 3
    (blockOfW _ (pcFactW s 2345 3712 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2427)
  ...
  have c2375 := blockCostW [opAt 2346 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2346 3713 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2428)
  ...
  have c2376 := blockCostW [opAt 2347 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2347 3714 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2429)
  ...
  have c2377 := blockCostW [opAt 2348 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2348 3715 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2430)
  ...
  have c2378 := blockCostW [opAt 2349 .MULMOD] 8
    (blockOfW _ (pcFactW s 2349 3716 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2431)
  ...
  have c2379 := blockCostW [opAt 2350 .MULMOD] 8
    (blockOfW _ (pcFactW s 2350 3717 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2432)
  ...
  have c2380 := blockCostW [opAt 2351 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2351 3718 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2433)
      (stepW_swap s 3718 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2381 := blockCostW [opAt 2352 .POP] 2
    (blockOfW _ (pcFactW s 2352 3719 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (7 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2434)
