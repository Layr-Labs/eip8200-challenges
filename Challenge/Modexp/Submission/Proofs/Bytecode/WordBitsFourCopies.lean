...
def gasSteps_copy0 :
    GasSteps (stW s 2356 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2356 ([Bm1,1,byte,offset,outerW,(value 0 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy0_cost :
    (gasSteps_copy0 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 100 := by
  unfold gasSteps_copy0
  simp

/-- Exponent bit `1`: one pass of head, body and control with the counter at `1`. -/
def gasSteps_copy1 :
    GasSteps (stW s 2356 ([Bm1,1,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2356 ([Bm1,2,byte,offset,outerW,(value 1 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy1_cost :
    (gasSteps_copy1 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 100 := by
  unfold gasSteps_copy1
  simp

/-- Exponent bit `2`: one pass of head, body and control with the counter at `2`. -/
def gasSteps_copy2 :
    GasSteps (stW s 2356 ([Bm1,2,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2356 ([Bm1,3,byte,offset,outerW,(value 2 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy2_cost :
    (gasSteps_copy2 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 100 := by
  unfold gasSteps_copy2
  simp

/-- Exponent bit `3`: one pass of head, body and control with the counter at `3`. -/
def gasSteps_copy3 :
    GasSteps (stW s 2356 ([Bm1,3,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2356 ([Bm1,4,byte,offset,outerW,(value 3 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy3_cost :
    (gasSteps_copy3 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 100 := by
  unfold gasSteps_copy3
  simp

/-- Exponent bit `4`: one pass of head, body and control with the counter at `4`. -/
def gasSteps_copy4 :
    GasSteps (stW s 2356 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2356 ([Bm1,5,byte,offset,outerW,(value 4 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy4_cost :
    (gasSteps_copy4 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 100 := by
  unfold gasSteps_copy4
  simp

/-- Exponent bit `5`: one pass of head, body and control with the counter at `5`. -/
def gasSteps_copy5 :
    GasSteps (stW s 2356 ([Bm1,5,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2356 ([Bm1,6,byte,offset,outerW,(value 5 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy5_cost :
    (gasSteps_copy5 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 100 := by
  unfold gasSteps_copy5
  simp

/-- Exponent bit `6`: one pass of head, body and control with the counter at `6`. -/
def gasSteps_copy6 :
    GasSteps (stW s 2356 ([Bm1,6,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2356 ([Bm1,7,byte,offset,outerW,(value 6 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy6_cost :
    (gasSteps_copy6 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 100 := by
  unfold gasSteps_copy6
  simp

/-- Exponent bit `7`: one pass of head, body and control with the counter at `7`. -/
def gasSteps_copy7 :
    GasSteps (stW s 2356 ([Bm1,7,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2392 ([Bm1,8,byte,offset,outerW,(value 7 Bm1 byte acc m),base,m] ++ rest)) := by
