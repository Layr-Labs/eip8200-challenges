...
def gasSteps_copy0 :
    GasSteps (stW s 2506 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2529 ([Bm1,0,byte,offset,outerW,(value 0 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy1 :
    GasSteps (stW s 2529 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2551 ([Bm1,0,byte,offset,outerW,(value 1 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy2 :
    GasSteps (stW s 2551 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2573 ([Bm1,0,byte,offset,outerW,(value 2 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy3 :
    GasSteps (stW s 2573 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2506 ([Bm1,4,byte,offset,outerW,(value 3 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy3_cost :
    (gasSteps_copy3 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 99 := by
  unfold gasSteps_copy3
  simp

def gasSteps_copy4 :
    GasSteps (stW s 2506 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2529 ([Bm1,4,byte,offset,outerW,(value 4 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy5 :
    GasSteps (stW s 2529 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2551 ([Bm1,4,byte,offset,outerW,(value 5 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy6 :
    GasSteps (stW s 2551 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2573 ([Bm1,4,byte,offset,outerW,(value 6 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy7 :
    GasSteps (stW s 2573 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 2610 ([Bm1,0,byte,offset,outerW,(value 7 Bm1 byte acc m),base,m] ++ rest)) := by
...
@[simp] theorem gasSteps_copy7_cost :
    (gasSteps_copy7 s rest Bm1 byte offset outerW acc base m hs hrest).cost = 107 := by
