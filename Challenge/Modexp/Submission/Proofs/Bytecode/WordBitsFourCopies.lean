...
def gasSteps_copy0 :
    GasSteps (stW s 3083 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3106 ([Bm1,0,byte,offset,outerW,(value 0 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy1 :
    GasSteps (stW s 3106 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3128 ([Bm1,0,byte,offset,outerW,(value 1 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy2 :
    GasSteps (stW s 3128 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3150 ([Bm1,0,byte,offset,outerW,(value 2 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy3 :
    GasSteps (stW s 3150 ([Bm1,0,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3083 ([Bm1,4,byte,offset,outerW,(value 3 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy4 :
    GasSteps (stW s 3083 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3106 ([Bm1,4,byte,offset,outerW,(value 4 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy5 :
    GasSteps (stW s 3106 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3128 ([Bm1,4,byte,offset,outerW,(value 5 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy6 :
    GasSteps (stW s 3128 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3150 ([Bm1,4,byte,offset,outerW,(value 6 Bm1 byte acc m),base,m] ++ rest)) := by
...
def gasSteps_copy7 :
    GasSteps (stW s 3150 ([Bm1,4,byte,offset,outerW,acc,base,m] ++ rest))
      (stW s 3189 ([Bm1,0,byte,offset,outerW,(value 7 Bm1 byte acc m),base,m] ++ rest)) := by
