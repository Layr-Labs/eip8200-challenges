...
theorem run_byte0 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 2892)
  ...
  have h1 : runLocatedBlock (highSquareLookupPath 0)
      ...
      some (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2867)
  ...
  have h2 : runLocatedBlock (lowPrepPath 0)
      (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2867)
  ...
  have h3 : runLocatedBlock (lowSquareLookupPath 0)
      ...
      some (lowResultState { template with halt := .Running } (UInt256.ofNat 2892)
  ...
  have h4 : runLocatedBlock (finishPath 0)
      (lowResultState { template with halt := .Running } (UInt256.ofNat 2892)
...
theorem run_byte1 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 1)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2892)
        base modulus word pointer accumulator rest) =
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 2945)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h0 : runLocatedBlock (highPrepPath 1)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2892)
        base modulus word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 2900)
  ...
  have h1 : runLocatedBlock (highSquareLookupPath 1)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 2900)
        base modulus high (byteValue 1 word) word pointer accumulator rest) =
      some (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2920)
  ...
  have h2 : runLocatedBlock (lowPrepPath 1)
      (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2920)
  ...
  have h3 : runLocatedBlock (lowSquareLookupPath 1)
      ...
      some (lowResultState { template with halt := .Running } (UInt256.ofNat 2945)
  ...
  have h4 : runLocatedBlock (finishPath 1)
      (lowResultState { template with halt := .Running } (UInt256.ofNat 2945)
...
theorem run_byte2 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 2)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2945)
        base modulus word pointer accumulator rest) =
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 2998)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h0 : runLocatedBlock (highPrepPath 2)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2945)
        base modulus word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 2953)
  ...
  have h1 : runLocatedBlock (highSquareLookupPath 2)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 2953)
        base modulus high (byteValue 2 word) word pointer accumulator rest) =
      some (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2973)
  ...
  have h2 : runLocatedBlock (lowPrepPath 2)
      (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2973)
  ...
  have h3 : runLocatedBlock (lowSquareLookupPath 2)
      ...
      some (lowResultState { template with halt := .Running } (UInt256.ofNat 2998)
  ...
  have h4 : runLocatedBlock (finishPath 2)
      (lowResultState { template with halt := .Running } (UInt256.ofNat 2998)
...
theorem run_byte3 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 3)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2998)
        base modulus word pointer accumulator rest) =
    some (finalWordKernelState { template with halt := .Running } (UInt256.ofNat 3050)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h0 : runLocatedBlock (highPrepPath 3)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2998)
        base modulus word pointer accumulator rest) =
      some (finalHighNibbleState { template with halt := .Running } (UInt256.ofNat 3005)
  ...
  have h1 : runLocatedBlock (highSquareLookupPath 3)
      (finalHighNibbleState { template with halt := .Running } (UInt256.ofNat 3005)
        base modulus high (byteValue 3 word) word pointer accumulator rest) =
      some (finalForwardedNibbleState { template with halt := .Running } (UInt256.ofNat 3025)
  ...
  have h2 : runLocatedBlock (lowPrepPath 3)
      (finalForwardedNibbleState { template with halt := .Running } (UInt256.ofNat 3025)
  ...
  have h3 : runLocatedBlock (lowSquareLookupPath 3)
      ...
      some (finalLowResultState { template with halt := .Running } (UInt256.ofNat 3050)
  ...
  have h4 : runLocatedBlock (finishPath 3)
      (finalLowResultState { template with halt := .Running } (UInt256.ofNat 3050)
