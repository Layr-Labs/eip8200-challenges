...
theorem run_byte1 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 1)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2864)
        base modulus word pointer accumulator rest) =
  ...
  have h0 : runLocatedBlock (highPrepPath 1)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2864)
        base modulus word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 2872)
  ...
  have h1 : runLocatedBlock (highSquareLookupPath 1)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 2872)
...
theorem run_byte2 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 2)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2946)
        base modulus word pointer accumulator rest) =
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 2970)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h1 : runLocatedBlock (highSquareLookupPath 2)
      ...
      some (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2945)
  ...
  have h2 : runLocatedBlock (lowPrepPath 2)
      (forwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2945)
  ...
  have h3 : runLocatedBlock (lowSquareLookupPath 2)
      ...
      some (lowResultState { template with halt := .Running } (UInt256.ofNat 2970)
  ...
  have h4 : runLocatedBlock (finishPath 2)
      (lowResultState { template with halt := .Running } (UInt256.ofNat 2970)
...
theorem run_byte3 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 3)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2970)
        base modulus word pointer accumulator rest) =
    some (finalWordKernelState { template with halt := .Running } (UInt256.ofNat 3022)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h0 : runLocatedBlock (highPrepPath 3)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 2970)
        base modulus word pointer accumulator rest) =
      some (finalHighNibbleState { template with halt := .Running } (UInt256.ofNat 2977)
  ...
  have h1 : runLocatedBlock (highSquareLookupPath 3)
      (finalHighNibbleState { template with halt := .Running } (UInt256.ofNat 2977)
        base modulus high (byteValue 3 word) word pointer accumulator rest) =
      some (finalForwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2997)
  ...
  have h2 : runLocatedBlock (lowPrepPath 3)
      (finalForwardedNibbleState { template with halt := .Running } (UInt256.ofNat 2997)
  ...
  have h3 : runLocatedBlock (lowSquareLookupPath 3)
      ...
      some (finalLowResultState { template with halt := .Running } (UInt256.ofNat 3022)
  ...
  have h4 : runLocatedBlock (finishPath 3)
      (finalLowResultState { template with halt := .Running } (UInt256.ofNat 3022)
