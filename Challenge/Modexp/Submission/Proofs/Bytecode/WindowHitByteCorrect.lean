...
theorem run_byte0 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 0)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 3201)
        base modulus word pointer accumulator rest) =
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 3285)
  ...
  have h56 := runLocatedBlock_append (lowLookupPath 0) (finishPath 0)
    (nibbleState { template with halt := .Running } (UInt256.ofNat 3272)
    ...
    (wordKernelState { template with halt := .Running } (UInt256.ofNat 3285)
  ...
  have h456 := runLocatedBlock_append (lowSquarePath 0)
    ...
    (nibbleState { template with halt := .Running } (UInt256.ofNat 3248)
  ...
  have h3456 := runLocatedBlock_append (lowPrepPath 0)
    ...
    (nibbleState { template with halt := .Running } (UInt256.ofNat 3243)
  ...
  have h23456 := runLocatedBlock_append (highLookupPath 0)
    ...
    (nibbleState { template with halt := .Running } (UInt256.ofNat 3232)
  ...
  have h123456 := runLocatedBlock_append (highSquarePath 0)
    (highLookupPath 0 ++ lowPrepPath 0 ++ lowSquarePath 0 ++
      lowLookupPath 0 ++ finishPath 0)
    (nibbleState { template with halt := .Running } (UInt256.ofNat 3208)
...
theorem run_byte1 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 1)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 3285)
        base modulus word pointer accumulator rest) =
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 3370)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h0 : runLocatedBlock (highPrepPath 1)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 3285)
        base modulus word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3293)
  ...
  have h1 : runLocatedBlock (highSquarePath 1)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3293)
        base modulus high (byteValue 1 word) word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3317)
  ...
  have h2 : runLocatedBlock (highLookupPath 1)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3317)
        base modulus high (byteValue 1 word) word pointer highSquared rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3328)
  ...
  have h3 : runLocatedBlock (lowPrepPath 1)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3328)
        base modulus high (byteValue 1 word) word pointer highAcc rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3333)
  ...
  have h4 : runLocatedBlock (lowSquarePath 1)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3333)
        base modulus low (byteValue 1 word) word pointer highAcc rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3357)
  ...
  have h5 : runLocatedBlock (lowLookupPath 1)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3357)
...
theorem run_byte2 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 2)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 3370)
        base modulus word pointer accumulator rest) =
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 3455)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h0 : runLocatedBlock (highPrepPath 2)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 3370)
        base modulus word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3378)
  ...
  have h1 : runLocatedBlock (highSquarePath 2)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3378)
        base modulus high (byteValue 2 word) word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3402)
  ...
  have h2 : runLocatedBlock (highLookupPath 2)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3402)
        base modulus high (byteValue 2 word) word pointer highSquared rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3413)
  ...
  have h3 : runLocatedBlock (lowPrepPath 2)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3413)
        base modulus high (byteValue 2 word) word pointer highAcc rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3418)
  ...
  have h4 : runLocatedBlock (lowSquarePath 2)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3418)
        base modulus low (byteValue 2 word) word pointer highAcc rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3442)
  ...
  have h5 : runLocatedBlock (lowLookupPath 2)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3442)
...
theorem run_byte3 (template : State) (base modulus word pointer accumulator : UInt256)
    ...
    runLocatedBlock (segmentedBytePath 3)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 3455)
        base modulus word pointer accumulator rest) =
    some (wordKernelState { template with halt := .Running } (UInt256.ofNat 3540)
      base modulus word pointer
      (WindowMath.byteWordStep modulus base accumulator
  ...
  have h0 : runLocatedBlock (highPrepPath 3)
      (wordKernelState { template with halt := .Running } (UInt256.ofNat 3455)
        base modulus word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3463)
  ...
  have h1 : runLocatedBlock (highSquarePath 3)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3463)
        base modulus high (byteValue 3 word) word pointer accumulator rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3487)
  ...
  have h2 : runLocatedBlock (highLookupPath 3)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3487)
        base modulus high (byteValue 3 word) word pointer highSquared rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3498)
  ...
  have h3 : runLocatedBlock (lowPrepPath 3)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3498)
        base modulus high (byteValue 3 word) word pointer highAcc rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3503)
  ...
  have h4 : runLocatedBlock (lowSquarePath 3)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3503)
        base modulus low (byteValue 3 word) word pointer highAcc rest) =
      some (nibbleState { template with halt := .Running } (UInt256.ofNat 3527)
  ...
  have h5 : runLocatedBlock (lowLookupPath 3)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3527)
