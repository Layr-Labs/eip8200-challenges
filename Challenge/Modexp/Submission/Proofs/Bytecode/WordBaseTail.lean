...
theorem run_baseTail_head (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  have h562 : (543 : UInt256).toNat = 543 := by decide
  have h562Word : (543 : UInt256) = UInt256.ofNat 543 := by decide
...
theorem run_baseTail_finish (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  rcases hvalid with ⟨_, hb, he, hm⟩
  have hi256 : i < 2 ^ 256 := by omega
  have h541 : (523 : UInt256).toNat = 523 := by decide
  have h541Word : (523 : UInt256) = UInt256.ofNat 523 := by decide
