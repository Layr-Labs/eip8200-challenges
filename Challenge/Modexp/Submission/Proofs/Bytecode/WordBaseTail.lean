...
theorem run_baseTail_head (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  have h562 : (187 : UInt256).toNat = 187 := by decide
  have h562Word : (187 : UInt256) = UInt256.ofNat 187 := by decide
...
theorem run_baseTail_finish (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  rcases hvalid with ⟨_, hb, he, hm⟩
  have hi256 : i < 2 ^ 256 := by omega
  have h541 : (167 : UInt256).toNat = 167 := by decide
  have h541Word : (167 : UInt256) = UInt256.ofNat 167 := by decide
