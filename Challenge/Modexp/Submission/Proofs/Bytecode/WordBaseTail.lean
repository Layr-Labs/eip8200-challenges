...
theorem run_baseTail_head (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  have h562 : (542 : UInt256).toNat = 542 := by decide
  have h562Word : (542 : UInt256) = UInt256.ofNat 542 := by decide
...
theorem run_baseTail_finish (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  rcases hvalid with ⟨_, hb, he, hm⟩
  have hi256 : i < 2 ^ 256 := by omega
  have h541 : (522 : UInt256).toNat = 522 := by decide
  have h541Word : (522 : UInt256) = UInt256.ofNat 522 := by decide
