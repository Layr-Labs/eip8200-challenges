...
theorem run_baseTail_head (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  have h562 : (182 : UInt256).toNat = 182 := by decide
  have h562Word : (182 : UInt256) = UInt256.ofNat 182 := by decide
...
theorem run_baseTail_finish (input : ByteArray) (i : Nat) (base : UInt256)
  ...
  rcases hvalid with ⟨_, hb, he, hm⟩
  have hi256 : i < 2 ^ 256 := by omega
  have h541 : (164 : UInt256).toNat = 164 := by decide
  have h541Word : (164 : UInt256) = UInt256.ofNat 164 := by decide
