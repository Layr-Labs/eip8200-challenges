...
theorem run_all (template : State) (base modulus exponentOffset : UInt256)
    ...
    runInstructionsX program
      (WindowTwentyOneTablePrelude.initial template (UInt256.ofNat 1791) base modulus rest) =
  ...
  have hp := WindowTwentyOneTablePrelude.run_prelude template (UInt256.ofNat 1791)
    base modulus exponentOffset rest hrest hoffset
  have hpc : WindowTwentyOneTablePrelude.endPC (UInt256.ofNat 1791) = UInt256.ofNat 1820 := by decide
  rw [hpc] at hp
