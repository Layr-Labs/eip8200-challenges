...
structure Paths (artifact : ProgramArtifact) (fork : Fork) extends WindowTwentyOneGasCore.Paths artifact fork where
  ...
  emptyReturn : Block artifact fork 2998 WindowTwentyOneReturn.emptyProgram
  ...
  emptyJump : Decode.isValidJumpDest artifact.code 2998 = true
...
def empty_handled {artifact : ProgramArtifact} {fork : Fork}
  ...
  let final := WindowTwentyOneReturn.returned ctx (UInt256.ofNat 3013)
