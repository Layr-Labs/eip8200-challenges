...
def baseT2Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1078 .JUMPDEST, opAt 1079 (.Dup ⟨2, by decide⟩),
   pushAt 1080 2 104, opAt 1081 .JUMPI]

/-- `T2`'s zero-bit tail: drop the five arguments and return. -/
def baseT2SkipPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1082 .POP, opAt 1083 .POP, opAt 1084 .POP, opAt 1085 .POP,
   opAt 1086 .POP, opAt 1087 .JUMP]
...
@[simp] private theorem baseT2PCs (i : Nat) (hi : 1078 ≤ i) (hii : i ≤ 1087) :
    Artifact.submissionArtifact.instructionPC i =
      [1461,1462,1463,1466,1467,1468,1469,1470,1471,1472][i - 1078]! := by
  interval_cases i <;> decide
