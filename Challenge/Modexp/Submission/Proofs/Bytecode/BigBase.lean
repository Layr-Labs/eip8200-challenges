...
def innerToDoublePath :
  ...
  [pushAt 665 2 875, opAt 666 (.Dup ⟨6, by decide⟩),
   ...
   pushAt 670 2 1024, pushAt 671 2 1448, opAt 672 .JUMP]
...
def innerToAddBitPath :
  ...
  [opAt 673 .JUMPDEST, pushAt 674 2 900,
   ...
   pushAt 686 2 1448, opAt 687 .JUMP]
...
def outerFinishToAccumulatorPath :
  ...
  [opAt 707 .JUMPDEST, opAt 708 .POP, pushAt 709 2 1335,
   ...
   pushAt 715 2 1448, opAt 716 .JUMP]
...
private theorem jump1448 :
    Decode.isValidJumpDest submissionBytecode 1448 = true :=
...
theorem run_innerToDouble (s : State) (accumulator : UInt256)
  ...
  have h1448 : (1448 : UInt256).toNat = 1448 := by decide
  have h1448Word : (1448 : UInt256) = UInt256.ofNat 1448 := by decide
  have hzero : ({ val := 0 } : UInt256) = 0 := by decide
  simp [innerToDoublePath, opAt, pushAt, wfOp, innerBody, innerLoop,
    BigHelpers.addEntry, innerFrame, baseLoopPCs, hcode, hrun, jump1448,
    h1448, h1448Word, hzero, hc7, hc8, hc9, hc10, hc11, hc12, hc13, hc14,
    Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
    Challenge.EvmProof.Word.word_toNat_ofNat,
    Challenge.EvmProof.Word.ofNat_add_mod,
...
theorem run_innerToAddBit (s : State) (accumulator : UInt256)
  ...
  simp [innerToAddBitPath, opAt, pushAt, wfOp, doubledReturned,
    ...
    innerFrame, baseBit, baseLoopPCs, hcode, hrun, jump1448, hsub,
    h1448, h1448Word, h875, h875Word, hzero, hone, hseven,
...
theorem run_outerFinishToAccumulator (s : State) (accumulator : UInt256)
  ...
  simp [outerFinishToAccumulatorPath, opAt, pushAt, wfOp, outerExit,
    outerLoop, BigHelpers.addEntry, baseLoopPCs, hcode, hrun, jump1448,
    h1448, h1448Word, h925, h925Word, h1335Word, hzero,
