...
theorem run_innerGuard (s : State) (accumulator : UInt256)
  ...
  have heq : UInt256.eq (UInt256.ofNat j) (8 : UInt256) =
      UInt256.ofNat 0 := by
  ...
  simp [innerGuardPath, opAt, pushAt, wfOp, innerLoop, innerBody,
    baseLoopPCs, hrun, hj, hj256, hjmod, h8, hne, heq, hzeroNat,
...
theorem run_innerFinishGuard (s : State) (accumulator : UInt256)
  ...
  have hc8 : rest.length + 8 < 1024 := by omega
  have hc9 : rest.length + 9 < 1024 := by omega
  have heq : UInt256.eq (UInt256.ofNat 8) (8 : UInt256) =
      UInt256.ofNat 1 := by
    simp [UInt256.eq]
  ...
  simp [innerGuardPath, opAt, pushAt, wfOp, innerLoop, innerExit,
    baseLoopPCs, hcode, hrun, jump911, heq, h911, h911Word,
