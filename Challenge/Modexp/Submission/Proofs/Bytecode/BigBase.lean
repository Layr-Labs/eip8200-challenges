...
def toClearDoublePath :
  ...
  [opAt 628 .JUMPDEST, pushAt 629 2 819,
...
def outerGuardPath :
  ...
  [opAt 639 .JUMPDEST, opAt 640 (.Dup ⟨3, by decide⟩),
   ...
   pushAt 644 2 921, opAt 645 .JUMPI]
...
def innerAfterBitPath :
  ...
  [opAt 684 .JUMPDEST, pushAt 685 1 1,
   ...
   pushAt 690 2 844, opAt 691 .JUMP]
...
def innerFinishPath :
  ...
  [opAt 692 .JUMPDEST, opAt 693 .POP, opAt 694 .POP, opAt 695 .POP,
   ...
   pushAt 701 2 827, opAt 702 .JUMP]

def outerFinishToAccumulatorPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 703 .JUMPDEST, opAt 704 .POP, pushAt 705 2 940,
...
@[simp] private theorem baseSetupPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [807,808,811,812,815,818,819,820,822,825,826][i - 628]! := by
  interval_cases i <;> decide

@[simp] private theorem baseLoopPCs (i : Nat)
    (hi : 639 ≤ i) (hii : i ≤ 712) :
    Artifact.submissionArtifact.instructionPC i =
      [827,828,829,830,831,832,835,836,837,838,839,840,841,842,843,844,845,847,848,849,850,853,854,857,858,859,861,864,867,870,871,872,875,876,877,879,880,881,883,884,885,886,889,892,895,896,897,899,900,901,902,903,906,907,908,909,910,911,913,914,915,916,917,920,921,922,923,926,927,928,930,933,936,939][i - 639]! := by
  interval_cases i <;> decide
