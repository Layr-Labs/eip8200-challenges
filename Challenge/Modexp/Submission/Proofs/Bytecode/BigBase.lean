...
def outerToInnerPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 645 (.Dup ⟨0, by decide⟩),
   opAt 646 (.Dup ⟨7, by decide⟩),
   opAt 647 .ADD,
   opAt 648 (.Dup ⟨0, by decide⟩),
   opAt 649 .CALLDATALOAD,
   pushAt 650 0 0,
   opAt 651 .BYTE,
   pushAt 652 0 0]
...
def innerToAddBitPath :
  ...
  [opAt 668 .JUMPDEST,
   ...
   pushAt 671 0 0,
   pushAt 672 1 1,
   opAt 673 (.Dup ⟨5, by decide⟩),
   opAt 674 (.Dup ⟨5, by decide⟩),
   pushAt 675 1 7,
   opAt 676 .SUB,
   opAt 677 .SHR,
   opAt 678 .AND,
