...
def innerToDoublePath :
  ...
  [pushAt 665 2 875, opAt 666 (.Dup ⟨6, by decide⟩),
   ...
   pushAt 670 2 1024, pushAt 671 2 2187, opAt 672 .JUMP]
...
def innerToAddBitPath :
  ...
  [opAt 673 .JUMPDEST, pushAt 674 2 900,
   ...
   pushAt 686 2 2175, opAt 687 .JUMP]

/-- Appended trampoline `T2` at pc 2175: it
...
def baseT2Path :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1577 .JUMPDEST, opAt 1578 (.Dup ⟨2, by decide⟩),
   pushAt 1579 2 104, opAt 1580 .JUMPI]

/-- `T2`'s zero-bit tail: drop the five arguments and return. -/
def baseT2SkipPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 1581 .POP, opAt 1582 .POP, opAt 1583 .POP, opAt 1584 .POP,
   opAt 1585 .POP, opAt 1586 .JUMP]
...
at `JUMPDEST` 2175 instead of at 104. -/
...
@[simp] private theorem baseT2PCs (i : Nat) (hi : 1577 ≤ i) (hii : i ≤ 1586) :
    Artifact.submissionArtifact.instructionPC i =
      [2175,2176,2177,2180,2181,2182,2183,2184,2185,2186][i - 1577]! := by
  interval_cases i <;> decide
...
private theorem jump2175 :
    Decode.isValidJumpDest submissionBytecode 2175 = true :=
  Artifact.isValidJumpDest_index 1577 (by rfl)

private theorem jump2187 :
    Decode.isValidJumpDest submissionBytecode 2187 = true :=
...
theorem run_innerToDouble (s : State) (accumulator : UInt256)
  ...
  have h2187 : (2187 : UInt256).toNat = 2187 := by decide
  have h2187Word : (2187 : UInt256) = UInt256.ofNat 2187 := by decide
  have hzero : ({ val := 0 } : UInt256) = 0 := by decide
  simp [innerToDoublePath, opAt, pushAt, wfOp, innerBody, innerLoop,
    BigDouble.entry, innerFrame, baseLoopPCs, hcode, hrun, jump2187,
    h2187, h2187Word, hzero, hc7, hc8, hc9, hc10, hc11, hc12, hc13, hc14,
    Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
    Challenge.EvmProof.Word.word_toNat_ofNat,
    Challenge.EvmProof.Word.ofNat_add_mod,
...
theorem run_innerToAddBit (s : State) (accumulator : UInt256)
  ...
  have hc13 : rest.length + 13 < 1024 := by omega
  have hc14 : rest.length + 14 < 1024 := by omega
  have h104 : (2175 : UInt256).toNat = 2175 := by decide
  have h104Word : (2175 : UInt256) = UInt256.ofNat 2175 := by decide
  ...
  simp [innerToAddBitPath, opAt, pushAt, wfOp, doubledReturned, bitT2Entry,
    ...
    innerFrame, baseBit, baseLoopPCs, hcode, hrun, jump2175, hsub,
...
set_option linter.unusedSimpArgs false in
/-- `T2` with the base bit clear: `JUMPI` falls through to pc 2181. -/
