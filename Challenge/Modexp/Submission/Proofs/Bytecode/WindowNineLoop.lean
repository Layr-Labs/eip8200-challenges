...
def iterationProgram : List Instr :=
  [.op .JUMPDEST] ++ WindowNineBody.program ++ WindowNineTail.program (UInt256.ofNat 2801)
...
def loopState (template : State) (base modulus exponent : UInt256)
  ...
  WindowNineGroup.state template (UInt256.ofNat 2801) base modulus
...
def finishState (template : State) (base modulus exponent : UInt256)
  ...
  WindowNineGroup.state template (UInt256.ofNat 3008) base modulus
...
theorem run_continue (template : State) (base modulus exponent : UInt256)
  ...
  have hshift : UInt256.shiftLeft e (UInt256.ofNat 36) =
    ...
    congr 2
  have hh := WindowNineTail.run_head template (UInt256.ofNat 2801)
    base modulus a e c rest hrest
  have hb := WindowNineBody.run_nine template (UInt256.ofNat 2802)
    base modulus a exponent c (1 + 9 * count) (by omega) rest hrest
  have ht := WindowNineTail.run_tail template (UInt256.ofNat 2994) (UInt256.ofNat 2801)
