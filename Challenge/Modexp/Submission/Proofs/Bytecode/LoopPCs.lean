...
@[simp] theorem pc2671 : Artifact.submissionArtifact.instructionPC 2430 = 3171 := by
  calc
    ...
    _ = 3171 := by rw [pc2670]; rfl
@[simp] theorem pc2672 : Artifact.submissionArtifact.instructionPC 2431 = 3172 := by
  calc
    ...
    _ = 3172 := by rw [pc2671]; rfl
@[simp] theorem pc2673 : Artifact.submissionArtifact.instructionPC 2432 = 3173 := by
  calc
    ...
    _ = 3173 := by rw [pc2672]; rfl
@[simp] theorem pc2674 : Artifact.submissionArtifact.instructionPC 2433 = 3174 := by
  calc
    ...
    _ = 3174 := by rw [pc2673]; rfl
@[simp] theorem pc2675 : Artifact.submissionArtifact.instructionPC 2434 = 3175 := by
  calc
    Artifact.submissionArtifact.instructionPC 2434 =
        Artifact.submissionArtifact.instructionPC 2433 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.SHL).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2433 _ (by rfl)
    _ = 3175 := by rw [pc2674]; rfl
@[simp] theorem pc2676 : Artifact.submissionArtifact.instructionPC 2435 = 3176 := by
  calc
    ...
    _ = 3176 := by rw [pc2675]; rfl
@[simp] theorem pc2677 : Artifact.submissionArtifact.instructionPC 2436 = 3178 := by
  calc
    ...
    _ = 3178 := by rw [pc2676]; rfl
@[simp] theorem pc2678 : Artifact.submissionArtifact.instructionPC 2437 = 3179 := by
  calc
    ...
    _ = 3179 := by rw [pc2677]; rfl
@[simp] theorem pc2679 : Artifact.submissionArtifact.instructionPC 2438 = 3181 := by
  calc
    ...
    _ = 3181 := by rw [pc2678]; rfl
@[simp] theorem pc2680 : Artifact.submissionArtifact.instructionPC 2439 = 3182 := by
  calc
    ...
    _ = 3182 := by rw [pc2679]; rfl
@[simp] theorem pc2681 : Artifact.submissionArtifact.instructionPC 2440 = 3183 := by
  calc
    ...
    _ = 3183 := by rw [pc2680]; rfl
@[simp] theorem pc2682 : Artifact.submissionArtifact.instructionPC 2441 = 3184 := by
  calc
    ...
    _ = 3184 := by rw [pc2681]; rfl
@[simp] theorem pc2683 : Artifact.submissionArtifact.instructionPC 2442 = 3185 := by
  calc
    ...
    _ = 3185 := by rw [pc2682]; rfl
@[simp] theorem pc2684 : Artifact.submissionArtifact.instructionPC 2443 = 3187 := by
  calc
    ...
    _ = 3187 := by rw [pc2683]; rfl
@[simp] theorem pc2685 : Artifact.submissionArtifact.instructionPC 2444 = 3188 := by
  calc
    ...
    _ = 3188 := by rw [pc2684]; rfl
@[simp] theorem pc2686 : Artifact.submissionArtifact.instructionPC 2445 = 3189 := by
  calc
    ...
    _ = 3189 := by rw [pc2685]; rfl
@[simp] theorem pc2687 : Artifact.submissionArtifact.instructionPC 2446 = 3190 := by
  calc
    ...
    _ = 3190 := by rw [pc2686]; rfl
@[simp] theorem pc2688 : Artifact.submissionArtifact.instructionPC 2447 = 3191 := by
  calc
    Artifact.submissionArtifact.instructionPC 2447 =
        Artifact.submissionArtifact.instructionPC 2446 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2446 _ (by rfl)
    _ = 3191 := by rw [pc2687]; rfl
@[simp] theorem pc2689 : Artifact.submissionArtifact.instructionPC 2448 = 3192 := by
  calc
    ...
    _ = 3192 := by rw [pc2688]; rfl
@[simp] theorem pc2690 : Artifact.submissionArtifact.instructionPC 2449 = 3193 := by
  calc
    Artifact.submissionArtifact.instructionPC 2449 =
        Artifact.submissionArtifact.instructionPC 2448 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2448 _ (by rfl)
    _ = 3193 := by rw [pc2689]; rfl
@[simp] theorem pc2691 : Artifact.submissionArtifact.instructionPC 2450 = 3194 := by
  calc
    ...
    _ = 3194 := by rw [pc2690]; rfl
@[simp] theorem pc2692 : Artifact.submissionArtifact.instructionPC 2451 = 3195 := by
  calc
    Artifact.submissionArtifact.instructionPC 2451 =
        Artifact.submissionArtifact.instructionPC 2450 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2450 _ (by rfl)
    _ = 3195 := by rw [pc2691]; rfl
@[simp] theorem pc2693 : Artifact.submissionArtifact.instructionPC 2452 = 3196 := by
  calc
    ...
    _ = 3196 := by rw [pc2692]; rfl
@[simp] theorem pc2694 : Artifact.submissionArtifact.instructionPC 2453 = 3198 := by
  calc
    Artifact.submissionArtifact.instructionPC 2453 =
        Artifact.submissionArtifact.instructionPC 2452 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2452 _ (by rfl)
    _ = 3198 := by rw [pc2693]; rfl
@[simp] theorem pc2695 : Artifact.submissionArtifact.instructionPC 2454 = 3199 := by
  calc
    Artifact.submissionArtifact.instructionPC 2454 =
        Artifact.submissionArtifact.instructionPC 2453 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.SHR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2453 _ (by rfl)
    _ = 3199 := by rw [pc2694]; rfl
@[simp] theorem pc2696 : Artifact.submissionArtifact.instructionPC 2455 = 3201 := by
  calc
    ...
    _ = 3201 := by rw [pc2695]; rfl
@[simp] theorem pc2697 : Artifact.submissionArtifact.instructionPC 2456 = 3202 := by
  calc
    Artifact.submissionArtifact.instructionPC 2456 =
        Artifact.submissionArtifact.instructionPC 2455 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 2 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2455 _ (by rfl)
    _ = 3202 := by rw [pc2696]; rfl
@[simp] theorem pc2698 : Artifact.submissionArtifact.instructionPC 2457 = 3203 := by
  calc
    ...
    _ = 3203 := by rw [pc2697]; rfl
@[simp] theorem pc2699 : Artifact.submissionArtifact.instructionPC 2458 = 3204 := by
  calc
    Artifact.submissionArtifact.instructionPC 2458 =
        Artifact.submissionArtifact.instructionPC 2457 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2457 _ (by rfl)
    _ = 3204 := by rw [pc2698]; rfl
@[simp] theorem pc2700 : Artifact.submissionArtifact.instructionPC 2459 = 3205 := by
  calc
    Artifact.submissionArtifact.instructionPC 2459 =
        Artifact.submissionArtifact.instructionPC 2458 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2458 _ (by rfl)
    _ = 3205 := by rw [pc2699]; rfl
@[simp] theorem pc2701 : Artifact.submissionArtifact.instructionPC 2460 = 3207 := by
  calc
    ...
    _ = 3207 := by rw [pc2700]; rfl
@[simp] theorem pc2702 : Artifact.submissionArtifact.instructionPC 2461 = 3208 := by
  calc
    ...
    _ = 3208 := by rw [pc2701]; rfl
@[simp] theorem pc2703 : Artifact.submissionArtifact.instructionPC 2462 = 3209 := by
  calc
    ...
    _ = 3209 := by rw [pc2702]; rfl
@[simp] theorem pc2704 : Artifact.submissionArtifact.instructionPC 2463 = 3210 := by
  calc
    ...
    _ = 3210 := by rw [pc2703]; rfl
@[simp] theorem pc2705 : Artifact.submissionArtifact.instructionPC 2464 = 3211 := by
  calc
    Artifact.submissionArtifact.instructionPC 2464 =
        Artifact.submissionArtifact.instructionPC 2463 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MULMOD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2463 _ (by rfl)
    _ = 3211 := by rw [pc2704]; rfl
@[simp] theorem pc2706 : Artifact.submissionArtifact.instructionPC 2465 = 3212 := by
  calc
    ...
    _ = 3212 := by rw [pc2705]; rfl
@[simp] theorem pc2707 : Artifact.submissionArtifact.instructionPC 2466 = 3213 := by
  calc
...
@[simp] theorem pc2787 : Artifact.submissionArtifact.instructionPC 2536 = 3296 := by
  calc
    ...
    _ = 3296 := by rw [pc2786]; rfl
@[simp] theorem pc2788 : Artifact.submissionArtifact.instructionPC 2537 = 3297 := by
  calc
    Artifact.submissionArtifact.instructionPC 2537 =
        Artifact.submissionArtifact.instructionPC 2536 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 4 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2536 _ (by rfl)
    _ = 3297 := by rw [pc2787]; rfl
@[simp] theorem pc2789 : Artifact.submissionArtifact.instructionPC 2538 = 3298 := by
  calc
    ...
    _ = 3298 := by rw [pc2788]; rfl
@[simp] theorem pc2790 : Artifact.submissionArtifact.instructionPC 2539 = 3299 := by
  calc
    Artifact.submissionArtifact.instructionPC 2539 =
        Artifact.submissionArtifact.instructionPC 2538 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.SHR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2538 _ (by rfl)
    _ = 3299 := by rw [pc2789]; rfl
@[simp] theorem pc2791 : Artifact.submissionArtifact.instructionPC 2540 = 3300 := by
  calc
    Artifact.submissionArtifact.instructionPC 2540 =
        Artifact.submissionArtifact.instructionPC 2539 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.AND).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2539 _ (by rfl)
    _ = 3300 := by rw [pc2790]; rfl
@[simp] theorem pc2792 : Artifact.submissionArtifact.instructionPC 2541 = 3303 := by
  calc
    Artifact.submissionArtifact.instructionPC 2541 =
        Artifact.submissionArtifact.instructionPC 2540 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 2 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2540 _ (by rfl)
    _ = 3303 := by rw [pc2791]; rfl
@[simp] theorem pc2793 : Artifact.submissionArtifact.instructionPC 2542 = 3304 := by
  calc
    Artifact.submissionArtifact.instructionPC 2542 =
        Artifact.submissionArtifact.instructionPC 2541 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MUL).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2541 _ (by rfl)
    _ = 3304 := by rw [pc2792]; rfl
@[simp] theorem pc2794 : Artifact.submissionArtifact.instructionPC 2543 = 3307 := by
  calc
...
@[simp] theorem pc2843 : Artifact.submissionArtifact.instructionPC 2585 = 3377 := by
  calc
    ...
    _ = 3377 := by rw [pc2842]; rfl
@[simp] theorem pc2844 : Artifact.submissionArtifact.instructionPC 2586 = 3379 := by
  calc
    Artifact.submissionArtifact.instructionPC 2586 =
        Artifact.submissionArtifact.instructionPC 2585 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.JUMP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2585 _ (by rfl)
    _ = 3379 := by rw [pc2843]; rfl
@[simp] theorem pc2845 : Artifact.submissionArtifact.instructionPC 2587 = 3380 := by
  calc
    Artifact.submissionArtifact.instructionPC 2587 =
        Artifact.submissionArtifact.instructionPC 2586 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2586 _ (by rfl)
    _ = 3380 := by rw [pc2844]; rfl
@[simp] theorem pc2846 : Artifact.submissionArtifact.instructionPC 2588 = 3384 := by
  calc
    Artifact.submissionArtifact.instructionPC 2588 =
        Artifact.submissionArtifact.instructionPC 2587 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 1 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2587 _ (by rfl)
    _ = 3384 := by rw [pc2845]; rfl
@[simp] theorem pc2847 : Artifact.submissionArtifact.instructionPC 2589 = 3385 := by
  calc
    ...
    _ = 3385 := by rw [pc2846]; rfl
@[simp] theorem pc2848 : Artifact.submissionArtifact.instructionPC 2590 = 3388 := by
  calc
    Artifact.submissionArtifact.instructionPC 2590 =
        Artifact.submissionArtifact.instructionPC 2589 +
          (YulEvmCompiler.Instr.push 2 3441).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2589 _ (by rfl)
    _ = 3388 := by rw [pc2847]; rfl
@[simp] theorem pc2849 : Artifact.submissionArtifact.instructionPC 2591 = 3389 := by
  calc
    ...
    _ = 3389 := by rw [pc2848]; rfl
@[simp] theorem pc2855 : Artifact.submissionArtifact.instructionPC 2592 = 3391 := by
  calc
    Artifact.submissionArtifact.instructionPC 2592 =
        Artifact.submissionArtifact.instructionPC 2591 +
          (YulEvmCompiler.Instr.push 1 16).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2591 _ (by rfl)
    _ = 3391 := by rw [pc2849]; rfl
@[simp] theorem pc2856 : Artifact.submissionArtifact.instructionPC 2593 = 3392 := by
  calc
    ...
    _ = 3392 := by rw [pc2855]; rfl
@[simp] theorem pc2857 : Artifact.submissionArtifact.instructionPC 2594 = 3393 := by
  calc
    ...
    _ = 3393 := by rw [pc2856]; rfl
@[simp] theorem pc2858 : Artifact.submissionArtifact.instructionPC 2595 = 3396 := by
  calc
    Artifact.submissionArtifact.instructionPC 2595 =
        Artifact.submissionArtifact.instructionPC 2594 +
          (YulEvmCompiler.Instr.push 2 3409).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2594 _ (by rfl)
    _ = 3396 := by rw [pc2857]; rfl
@[simp] theorem pc2859 : Artifact.submissionArtifact.instructionPC 2596 = 3399 := by
  calc
    ...
    _ = 3399 := by rw [pc2858]; rfl
@[simp] theorem pc2860 : Artifact.submissionArtifact.instructionPC 2597 = 3402 := by
  calc
    Artifact.submissionArtifact.instructionPC 2597 =
        Artifact.submissionArtifact.instructionPC 2596 +
          (YulEvmCompiler.Instr.push 2 2048).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2596 _ (by rfl)
    _ = 3402 := by rw [pc2859]; rfl
@[simp] theorem pc2861 : Artifact.submissionArtifact.instructionPC 2598 = 3405 := by
  calc
    Artifact.submissionArtifact.instructionPC 2598 =
        Artifact.submissionArtifact.instructionPC 2597 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.JUMP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2597 _ (by rfl)
    _ = 3405 := by rw [pc2860]; rfl
