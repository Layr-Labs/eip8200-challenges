...
@[simp] theorem pc2670 : Artifact.submissionArtifact.instructionPC 2431 = 3170 := by rfl
@[simp] theorem pc2671 : Artifact.submissionArtifact.instructionPC 2432 = 3203 := by
  calc
    ...
    _ = 3203 := by rw [pc2670]; rfl
@[simp] theorem pc2672 : Artifact.submissionArtifact.instructionPC 2433 = 3204 := by
  calc
    ...
    _ = 3204 := by rw [pc2671]; rfl
@[simp] theorem pc2673 : Artifact.submissionArtifact.instructionPC 2434 = 3205 := by
  calc
    ...
    _ = 3205 := by rw [pc2672]; rfl
@[simp] theorem pc2674 : Artifact.submissionArtifact.instructionPC 2435 = 3206 := by
  calc
    ...
    _ = 3206 := by rw [pc2673]; rfl
@[simp] theorem pc2675 : Artifact.submissionArtifact.instructionPC 2436 = 3207 := by
  calc
    Artifact.submissionArtifact.instructionPC 2436 =
        Artifact.submissionArtifact.instructionPC 2435 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.SHL).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2435 _ (by rfl)
    _ = 3207 := by rw [pc2674]; rfl
@[simp] theorem pc2676 : Artifact.submissionArtifact.instructionPC 2437 = 3208 := by
  calc
    ...
    _ = 3208 := by rw [pc2675]; rfl
@[simp] theorem pc2677 : Artifact.submissionArtifact.instructionPC 2438 = 3210 := by
  calc
    ...
    _ = 3210 := by rw [pc2676]; rfl
@[simp] theorem pc2678 : Artifact.submissionArtifact.instructionPC 2439 = 3211 := by
  calc
    ...
    _ = 3211 := by rw [pc2677]; rfl
@[simp] theorem pc2679 : Artifact.submissionArtifact.instructionPC 2440 = 3213 := by
  calc
    ...
    _ = 3213 := by rw [pc2678]; rfl
@[simp] theorem pc2680 : Artifact.submissionArtifact.instructionPC 2441 = 3214 := by
  calc
    ...
    _ = 3214 := by rw [pc2679]; rfl
@[simp] theorem pc2681 : Artifact.submissionArtifact.instructionPC 2442 = 3215 := by
  calc
    ...
    _ = 3215 := by rw [pc2680]; rfl
@[simp] theorem pc2682 : Artifact.submissionArtifact.instructionPC 2443 = 3216 := by
  calc
    ...
    _ = 3216 := by rw [pc2681]; rfl
@[simp] theorem pc2683 : Artifact.submissionArtifact.instructionPC 2444 = 3217 := by
  calc
    ...
    _ = 3217 := by rw [pc2682]; rfl
@[simp] theorem pc2684 : Artifact.submissionArtifact.instructionPC 2445 = 3219 := by
  calc
    ...
    _ = 3219 := by rw [pc2683]; rfl
@[simp] theorem pc2685 : Artifact.submissionArtifact.instructionPC 2446 = 3220 := by
  calc
    ...
    _ = 3220 := by rw [pc2684]; rfl
@[simp] theorem pc2686 : Artifact.submissionArtifact.instructionPC 2447 = 3221 := by
  calc
    ...
    _ = 3221 := by rw [pc2685]; rfl
@[simp] theorem pc2687 : Artifact.submissionArtifact.instructionPC 2448 = 3222 := by
  calc
    ...
    _ = 3222 := by rw [pc2686]; rfl
@[simp] theorem pc2688 : Artifact.submissionArtifact.instructionPC 2449 = 3223 := by
  calc
    Artifact.submissionArtifact.instructionPC 2449 =
        Artifact.submissionArtifact.instructionPC 2448 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2448 _ (by rfl)
    _ = 3223 := by rw [pc2687]; rfl
@[simp] theorem pc2689 : Artifact.submissionArtifact.instructionPC 2450 = 3224 := by
  calc
    ...
    _ = 3224 := by rw [pc2688]; rfl
@[simp] theorem pc2690 : Artifact.submissionArtifact.instructionPC 2451 = 3225 := by
  calc
    Artifact.submissionArtifact.instructionPC 2451 =
        Artifact.submissionArtifact.instructionPC 2450 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.SUB).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2450 _ (by rfl)
    _ = 3225 := by rw [pc2689]; rfl
@[simp] theorem pc2691 : Artifact.submissionArtifact.instructionPC 2452 = 3226 := by
  calc
    ...
    _ = 3226 := by rw [pc2690]; rfl
@[simp] theorem pc2692 : Artifact.submissionArtifact.instructionPC 2453 = 3227 := by
  calc
    Artifact.submissionArtifact.instructionPC 2453 =
        Artifact.submissionArtifact.instructionPC 2452 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2452 _ (by rfl)
    _ = 3227 := by rw [pc2691]; rfl
@[simp] theorem pc2693 : Artifact.submissionArtifact.instructionPC 2454 = 3228 := by
  calc
    ...
    _ = 3228 := by rw [pc2692]; rfl
@[simp] theorem pc2694 : Artifact.submissionArtifact.instructionPC 2455 = 3230 := by
  calc
    ...
    _ = 3230 := by rw [pc2693]; rfl
@[simp] theorem pc2695 : Artifact.submissionArtifact.instructionPC 2456 = 3231 := by
  calc
    Artifact.submissionArtifact.instructionPC 2456 =
        Artifact.submissionArtifact.instructionPC 2455 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.SHR).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2455 _ (by rfl)
    _ = 3231 := by rw [pc2694]; rfl
@[simp] theorem pc2696 : Artifact.submissionArtifact.instructionPC 2457 = 3233 := by
  calc
    ...
    _ = 3233 := by rw [pc2695]; rfl
@[simp] theorem pc2697 : Artifact.submissionArtifact.instructionPC 2458 = 3234 := by
  calc
    Artifact.submissionArtifact.instructionPC 2458 =
        Artifact.submissionArtifact.instructionPC 2457 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 2 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2457 _ (by rfl)
    _ = 3234 := by rw [pc2696]; rfl
@[simp] theorem pc2698 : Artifact.submissionArtifact.instructionPC 2459 = 3235 := by
  calc
    ...
    _ = 3235 := by rw [pc2697]; rfl
@[simp] theorem pc2699 : Artifact.submissionArtifact.instructionPC 2460 = 3236 := by
  calc
    Artifact.submissionArtifact.instructionPC 2460 =
        Artifact.submissionArtifact.instructionPC 2459 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2459 _ (by rfl)
    _ = 3236 := by rw [pc2698]; rfl
@[simp] theorem pc2700 : Artifact.submissionArtifact.instructionPC 2461 = 3237 := by
  calc
    Artifact.submissionArtifact.instructionPC 2461 =
        Artifact.submissionArtifact.instructionPC 2460 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.ADD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2460 _ (by rfl)
    _ = 3237 := by rw [pc2699]; rfl
@[simp] theorem pc2701 : Artifact.submissionArtifact.instructionPC 2462 = 3239 := by
  calc
    ...
    _ = 3239 := by rw [pc2700]; rfl
@[simp] theorem pc2702 : Artifact.submissionArtifact.instructionPC 2463 = 3240 := by
  calc
    ...
    _ = 3240 := by rw [pc2701]; rfl
@[simp] theorem pc2703 : Artifact.submissionArtifact.instructionPC 2464 = 3241 := by
  calc
    ...
    _ = 3241 := by rw [pc2702]; rfl
@[simp] theorem pc2704 : Artifact.submissionArtifact.instructionPC 2465 = 3242 := by
  calc
    ...
    _ = 3242 := by rw [pc2703]; rfl
@[simp] theorem pc2705 : Artifact.submissionArtifact.instructionPC 2466 = 3243 := by
  calc
    Artifact.submissionArtifact.instructionPC 2466 =
        Artifact.submissionArtifact.instructionPC 2465 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MULMOD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2465 _ (by rfl)
    _ = 3243 := by rw [pc2704]; rfl
@[simp] theorem pc2706 : Artifact.submissionArtifact.instructionPC 2467 = 3244 := by
  calc
    ...
    _ = 3244 := by rw [pc2705]; rfl
@[simp] theorem pc2707 : Artifact.submissionArtifact.instructionPC 2468 = 3245 := by
  calc
    ...
    _ = 3245 := by rw [pc2706]; rfl
@[simp] theorem pc2708 : Artifact.submissionArtifact.instructionPC 2469 = 3246 := by
  calc
    Artifact.submissionArtifact.instructionPC 2469 =
        Artifact.submissionArtifact.instructionPC 2468 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 7 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2468 _ (by rfl)
    _ = 3246 := by rw [pc2707]; rfl
@[simp] theorem pc2709 : Artifact.submissionArtifact.instructionPC 2470 = 3247 := by
  calc
    Artifact.submissionArtifact.instructionPC 2470 =
        Artifact.submissionArtifact.instructionPC 2469 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2469 _ (by rfl)
    _ = 3247 := by rw [pc2708]; rfl
@[simp] theorem pc2710 : Artifact.submissionArtifact.instructionPC 2471 = 3248 := by
  calc
    Artifact.submissionArtifact.instructionPC 2471 =
        Artifact.submissionArtifact.instructionPC 2470 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 4 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2470 _ (by rfl)
    _ = 3248 := by rw [pc2709]; rfl
@[simp] theorem pc2711 : Artifact.submissionArtifact.instructionPC 2472 = 3250 := by
  calc
...
@[simp] theorem pc2843 : Artifact.submissionArtifact.instructionPC 2587 = 3409 := by
  calc
    ...
    _ = 3409 := by rw [pc2842]; rfl
@[simp] theorem pc2844 : Artifact.submissionArtifact.instructionPC 2588 = 3411 := by
  calc
    Artifact.submissionArtifact.instructionPC 2588 =
        Artifact.submissionArtifact.instructionPC 2587 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.JUMP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2587 _ (by rfl)
    _ = 3411 := by rw [pc2843]; rfl
@[simp] theorem pc2845 : Artifact.submissionArtifact.instructionPC 2589 = 3412 := by
  calc
    Artifact.submissionArtifact.instructionPC 2589 =
        Artifact.submissionArtifact.instructionPC 2588 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.JUMPDEST).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2588 _ (by rfl)
    _ = 3412 := by rw [pc2844]; rfl
@[simp] theorem pc2846 : Artifact.submissionArtifact.instructionPC 2590 = 3416 := by
  calc
    Artifact.submissionArtifact.instructionPC 2590 =
        Artifact.submissionArtifact.instructionPC 2589 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 1 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2589 _ (by rfl)
    _ = 3416 := by rw [pc2845]; rfl
@[simp] theorem pc2847 : Artifact.submissionArtifact.instructionPC 2591 = 3417 := by
  calc
    ...
    _ = 3417 := by rw [pc2846]; rfl
@[simp] theorem pc2848 : Artifact.submissionArtifact.instructionPC 2592 = 3420 := by
  calc
    ...
    _ = 3420 := by rw [pc2847]; rfl
@[simp] theorem pc2849 : Artifact.submissionArtifact.instructionPC 2593 = 3421 := by
  calc
    ...
    _ = 3421 := by rw [pc2848]; rfl
@[simp] theorem pc2855 : Artifact.submissionArtifact.instructionPC 2594 = 3423 := by
  calc
    ...
    _ = 3423 := by rw [pc2849]; rfl
@[simp] theorem pc2856 : Artifact.submissionArtifact.instructionPC 2595 = 3424 := by
  calc
    ...
    _ = 3424 := by rw [pc2855]; rfl
@[simp] theorem pc2857 : Artifact.submissionArtifact.instructionPC 2596 = 3425 := by
  calc
    ...
    _ = 3425 := by rw [pc2856]; rfl
@[simp] theorem pc2858 : Artifact.submissionArtifact.instructionPC 2597 = 3428 := by
  calc
    ...
    _ = 3428 := by rw [pc2857]; rfl
@[simp] theorem pc2859 : Artifact.submissionArtifact.instructionPC 2598 = 3431 := by
  calc
    ...
    _ = 3431 := by rw [pc2858]; rfl
@[simp] theorem pc2860 : Artifact.submissionArtifact.instructionPC 2599 = 3434 := by
  calc
    Artifact.submissionArtifact.instructionPC 2599 =
        Artifact.submissionArtifact.instructionPC 2598 +
          (YulEvmCompiler.Instr.push 2 1758).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2598 _ (by rfl)
    _ = 3434 := by rw [pc2859]; rfl
@[simp] theorem pc2861 : Artifact.submissionArtifact.instructionPC 2600 = 3437 := by
  calc
    Artifact.submissionArtifact.instructionPC 2600 =
        Artifact.submissionArtifact.instructionPC 2599 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.JUMP).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2599 _ (by rfl)
    _ = 3437 := by rw [pc2860]; rfl
