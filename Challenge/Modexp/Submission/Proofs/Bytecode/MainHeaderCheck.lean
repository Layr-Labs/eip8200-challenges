...
theorem run_headerCheck (input : ByteArray) :
  ...
  -- the block now falls through from the POP at 1146 instead of jumping,
  -- so the successor step at 1146 has to be discharged explicitly
  have hsucc : (UInt256.ofNat 1146).succ = UInt256.ofNat 1147 := by decide
