...
theorem run_byte0_model (input : ByteArray) (pointer : Nat)
    ...
    runInstructions (byteProgram 0)
      (wordState input pointer 0 3201 accumulator) =
    some (wordState input pointer 1 3285 accumulator) :=
  run_wordByte_model input pointer 0 3201 3285 accumulator (by decide) (by decide)

theorem run_byte1_model (input : ByteArray) (pointer : Nat)
    (accumulator : UInt256) :
    runInstructions (byteProgram 1)
      (wordState input pointer 1 3285 accumulator) =
    some (wordState input pointer 2 3370 accumulator) :=
  run_wordByte_model input pointer 1 3285 3370 accumulator (by decide) (by decide)

theorem run_byte2_model (input : ByteArray) (pointer : Nat)
    (accumulator : UInt256) :
    runInstructions (byteProgram 2)
      (wordState input pointer 2 3370 accumulator) =
    some (wordState input pointer 3 3455 accumulator) :=
  run_wordByte_model input pointer 2 3370 3455 accumulator (by decide) (by decide)

theorem run_byte3_model (input : ByteArray) (pointer : Nat)
    (accumulator : UInt256) :
    runInstructions (byteProgram 3)
      (wordState input pointer 3 3455 accumulator) =
    some (wordState input pointer 4 3540 accumulator) :=
  run_wordByte_model input pointer 3 3455 3540 accumulator (by decide) (by decide)
