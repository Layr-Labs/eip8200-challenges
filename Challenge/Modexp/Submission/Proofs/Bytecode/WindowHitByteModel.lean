...
theorem run_byte0_model (input : ByteArray) (pointer : Nat)
    ...
    runInstructions (byteProgram 0)
      (wordState input pointer 0 3182 accumulator) =
    some (wordState input pointer 1 3252 accumulator) :=
  run_wordByte_model input pointer 0 3182 3252 accumulator (by decide) (by decide)

theorem run_byte1_model (input : ByteArray) (pointer : Nat)
    (accumulator : UInt256) :
    runInstructions (byteProgram 1)
      (wordState input pointer 1 3252 accumulator) =
    some (wordState input pointer 2 3323 accumulator) :=
  run_wordByte_model input pointer 1 3252 3323 accumulator (by decide) (by decide)

theorem run_byte2_model (input : ByteArray) (pointer : Nat)
    (accumulator : UInt256) :
    runInstructions (byteProgram 2)
      (wordState input pointer 2 3323 accumulator) =
    some (wordState input pointer 3 3394 accumulator) :=
  run_wordByte_model input pointer 2 3323 3394 accumulator (by decide) (by decide)

theorem run_byte3_model (input : ByteArray) (pointer : Nat)
    (accumulator : UInt256) :
    runInstructions (byteProgram 3)
      (wordState input pointer 3 3394 accumulator) =
    some (wordState input pointer 4 3465 accumulator) :=
  run_wordByte_model input pointer 3 3394 3465 accumulator (by decide) (by decide)
