...
def gasSteps_bitEntry_sym (s : State) (rest : List UInt256)
  ...
  have step485 := soundW hs (pushAt 482 2 3130)
    (blockOfW _ (pcFactW s 482 585 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc485)
      (stepW_push s 585 2 (3130 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step486 := soundW hs (opAt 483 .JUMP)
    (blockOfW _ (pcFactW s 483 588 ([(3130 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc486)
      (stepW_jump s 588 3130 ((3130 : UInt256)) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num) rfl hdest))
...
theorem gasSteps_bitEntry_sym_cost (s : State) (rest : List UInt256)
  ...
  have c485 := blockCostW [pushAt 482 2 3130] 3
    (blockOfW _ (pcFactW s 482 585 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc485)
      (stepW_push s 585 2 (3130 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c486 := blockCostW [opAt 483 .JUMP] 8
    (blockOfW _ (pcFactW s 483 588 ([(3130 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc486)
      (stepW_jump s 588 3130 ((3130 : UInt256)) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num) rfl hdest)) hs.fork (by decide) (by rfl) (by rfl)
...
def gasSteps_bitBridge_sym (s : State) (rest : List UInt256)
    ...
    GasSteps (stW s 3330 ([zero, byte, offset, outerW, acc, base, m] ++ rest))
      (stW s 3130 ([zero, byte, offset, outerW, acc, base, m] ++ rest)) := by
  have step484 := soundW hs (opAt 2558 .JUMPDEST)
    (blockOfW _ (pcFactW s 2558 3330 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) wordBridgePC3418)
      (stepW_jumpdest s 3330 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step485 := soundW hs (pushAt 2559 2 3130)
    (blockOfW _ (pcFactW s 2559 3331 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) wordBridgePC3419)
      (stepW_push s 3331 2 (3130 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step486 := soundW hs (opAt 2560 .JUMP)
    (blockOfW _ (pcFactW s 2560 3334 ([(3130 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) wordBridgePC3422)
...
theorem gasSteps_bitBridge_sym_cost (s : State) (rest : List UInt256)
  ...
  have c486 := blockCostW [opAt 2560 .JUMP] 8
    (blockOfW _ (pcFactW s 2560 3334 ([(3130 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) wordBridgePC3422)
...
def gasSteps_bitBodyHead_sym (s : State) (rest : List UInt256)
  ...
  have step2361 := soundW hs (opAt 2398 .JUMPDEST)
    (blockOfW _ (pcFactW s 2398 3130 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2414)
      (stepW_jumpdest s 3130 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2362 := soundW hs (pushAt 2399 1 1)
    (blockOfW _ (pcFactW s 2399 3131 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2415)
      (stepW_push s 3131 1 (1 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2363 := soundW hs (opAt 2400 (.Dup ⟨6, by decide⟩))
    (blockOfW _ (pcFactW s 2400 3133 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
      (stepW_dup s 3133 6 (by decide) ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (base) (by rfl) (by simp; omega) (by norm_num)))
  have step2364 := soundW hs (opAt 2401 .SUB)
    (blockOfW _ (pcFactW s 2401 3134 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
theorem gasSteps_bitBodyHead_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2363 := blockCostW [opAt 2400 (.Dup ⟨6, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2400 3133 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
  ...
  have c2364 := blockCostW [opAt 2401 .SUB] 3
    (blockOfW _ (pcFactW s 2401 3134 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
def gasSteps_bitHead_sym (s : State) (rest : List UInt256)
    ...
    (hs : Frame s) (hrest : rest.length < 1000) :
    GasSteps (stW s 3130 ([zero, byte, offset, outerW, acc, base, m] ++ rest))
      (stW s 3135 ([(base - (1 : UInt256)), zero, byte, offset, outerW, acc, base, m] ++ rest)) :=
...
def gasSteps_bitExit_sym (s : State) (rest : List UInt256)
  ...
  have step2501 := soundW hs (opAt 2536 .POP)
    (blockOfW _ (pcFactW s 2536 3292 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2554)
      (stepW_pop s 3292 (Bm1) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2502 := soundW hs (pushAt 2537 2 628)
    (blockOfW _ (pcFactW s 2537 3293 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2555)
      (stepW_push s 3293 2 (628 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2503 := soundW hs (opAt 2538 .JUMP)
    (blockOfW _ (pcFactW s 2538 3296 ([(628 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
...
theorem gasSteps_bitExit_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2503 := blockCostW [opAt 2538 .JUMP] 8
    (blockOfW _ (pcFactW s 2538 3296 ([(628 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
