...
def gasSteps_bitEntry_sym (s : State) (rest : List UInt256)
    ...
    (hs : Frame s) (hrest : rest.length < 1000) (hdest : Decode.isValidJumpDest s.executionEnv.code 2811 = true) :
    GasSteps (stW s 553 ([zero, byte, offset, outerW, acc, base, m] ++ rest))
      (stW s 2944 ([zero, byte, offset, outerW, acc, base, m] ++ rest)) := by
  have step485 := soundW hs (pushAt 495 2 2811)
    (blockOfW _ (pcFactW s 462 553 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc485)
      (stepW_push s 553 2 (2811 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step486 := soundW hs (opAt 496 .JUMP)
    (blockOfW _ (pcFactW s 463 556 ([(2811 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc486)
      (stepW_jump s 556 2944 ((2811 : UInt256)) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num) rfl hdest))
...
theorem gasSteps_bitEntry_sym_cost (s : State) (rest : List UInt256)
  ...
  have c485 := blockCostW [pushAt 495 2 2811] 3
    (blockOfW _ (pcFactW s 462 553 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc485)
      (stepW_push s 553 2 (2811 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c486 := blockCostW [opAt 496 .JUMP] 8
    (blockOfW _ (pcFactW s 463 556 ([(2811 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc486)
      (stepW_jump s 556 2944 ((2811 : UInt256)) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num) rfl hdest)) hs.fork (by decide) (by rfl) (by rfl)
...
def gasSteps_bitBodyHead_sym (s : State) (rest : List UInt256)
  ...
  have step2361 := soundW hs (opAt 2170 .JUMPDEST)
  ...
  have step2362 := soundW hs (pushAt 2171 1 1)
  ...
  have step2363 := soundW hs (opAt 2172 (.Dup ⟨6, by decide⟩))
  ...
  have step2364 := soundW hs (opAt 2173 .SUB)
...
theorem gasSteps_bitBodyHead_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2363 := blockCostW [opAt 2172 (.Dup ⟨6, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2276 2947 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
  ...
  have c2364 := blockCostW [opAt 2173 .SUB] 3
    (blockOfW _ (pcFactW s 2277 2948 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
def gasSteps_bitExit_sym (s : State) (rest : List UInt256)
    ...
    (hs : Frame s) (hrest : rest.length < 1000) (hdest : Decode.isValidJumpDest s.executionEnv.code 603 = true) :
    GasSteps (stW s 3106 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest))
      (stW s 557 ([zero, byte, offset, outerW, acc, base, m] ++ rest)) := by
  have step2501 := soundW hs (opAt 2308 .POP)
  ...
  have step2502 := soundW hs (pushAt 2309 2 603)
    (blockOfW _ (pcFactW s 2413 3107 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2555)
      (stepW_push s 3107 2 (603 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2503 := soundW hs (opAt 2310 .JUMP)
    (blockOfW _ (pcFactW s 2414 3110 ([(603 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
      (stepW_jump s 3110 557 ((603 : UInt256)) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num) rfl hdest))
...
theorem gasSteps_bitExit_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2501 := blockCostW [opAt 2308 .POP] 2
    (blockOfW _ (pcFactW s 2412 3106 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2554)
      (stepW_pop s 3106 (Bm1) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2502 := blockCostW [pushAt 2309 2 603] 3
    (blockOfW _ (pcFactW s 2413 3107 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2555)
      (stepW_push s 3107 2 (603 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2503 := blockCostW [opAt 2310 .JUMP] 8
    (blockOfW _ (pcFactW s 2414 3110 ([(603 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
      (stepW_jump s 3110 557 ((603 : UInt256)) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num) rfl hdest)) hs.fork (by decide) (by rfl) (by rfl)
  simp only [soundW, Challenge.EvmProof.GasSteps.trans_cost,
    Challenge.EvmProof.Stepper.runLocatedBlock_sound_cost, Nat.reduceAdd]
  omega
