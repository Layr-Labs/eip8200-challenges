...
def gasSteps_bitBodyHead_sym (s : State) (rest : List UInt256)
  ...
  have step2361 := soundW hs (opAt 1976 .JUMPDEST)
    (blockOfW _ (pcFactW s 1976 2397 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2414)
      (stepW_jumpdest s 2397 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2362 := soundW hs (pushAt 1977 1 1)
    (blockOfW _ (pcFactW s 1977 2398 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2415)
      (stepW_push s 2398 1 (1 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2363 := soundW hs (opAt 1978 (.Dup ⟨6, by decide⟩))
    (blockOfW _ (pcFactW s 1978 2400 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
      (stepW_dup s 2400 6 (by decide) ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (base) (by rfl) (by simp; omega) (by norm_num)))
  have step2364 := soundW hs (opAt 1979 .SUB)
    (blockOfW _ (pcFactW s 1979 2401 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
theorem gasSteps_bitBodyHead_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2363 := blockCostW [opAt 1978 (.Dup ⟨6, by decide⟩)] 3
    (blockOfW _ (pcFactW s 1978 2400 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
  ...
  have c2364 := blockCostW [opAt 1979 .SUB] 3
    (blockOfW _ (pcFactW s 1979 2401 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
def gasSteps_bitExit_sym (s : State) (rest : List UInt256)
  ...
  have step2501 := soundW hs (opAt 2008 .POP)
    (blockOfW _ (pcFactW s 2008 2437 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2554)
      (stepW_pop s 2437 (Bm1) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2502 := soundW hs (pushAt 2009 1 212)
    (blockOfW _ (pcFactW s 2009 2438 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2555)
      (stepW_push s 2438 1 (212 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2503 := soundW hs (opAt 2010 .JUMP)
    (blockOfW _ (pcFactW s 2010 2440 ([(212 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
...
theorem gasSteps_bitExit_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2503 := blockCostW [opAt 2010 .JUMP] 8
    (blockOfW _ (pcFactW s 2010 2440 ([(212 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
