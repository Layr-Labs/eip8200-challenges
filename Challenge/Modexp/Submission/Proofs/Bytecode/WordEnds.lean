...
def gasSteps_bitBodyHead_sym (s : State) (rest : List UInt256)
  ...
  have step2361 := soundW hs (opAt 2327 .JUMPDEST)
    (blockOfW _ (pcFactW s 2327 3079 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2414)
  ...
  have step2362 := soundW hs (pushAt 2328 1 1)
    (blockOfW _ (pcFactW s 2328 3080 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2415)
  ...
  have step2363 := soundW hs (opAt 2329 (.Dup ⟨6, by decide⟩))
    (blockOfW _ (pcFactW s 2329 3082 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
  ...
  have step2364 := soundW hs (opAt 2330 .SUB)
    (blockOfW _ (pcFactW s 2330 3083 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
def gasSteps_bitExit_sym (s : State) (rest : List UInt256)
  ...
  have step2501 := soundW hs (opAt 2465 .POP)
    (blockOfW _ (pcFactW s 2465 3241 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2554)
      (stepW_pop s 3241 (Bm1) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2502 := soundW hs (pushAt 2466 2 692)
    (blockOfW _ (pcFactW s 2466 3242 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2555)
      (stepW_push s 3242 2 (692 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2503 := soundW hs (opAt 2467 .JUMP)
    (blockOfW _ (pcFactW s 2467 3245 ([(692 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
...
theorem gasSteps_bitExit_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2503 := blockCostW [opAt 2467 .JUMP] 8
    (blockOfW _ (pcFactW s 2467 3245 ([(692 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
