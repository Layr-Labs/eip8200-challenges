...
def gasSteps_bitBodyHead_sym (s : State) (rest : List UInt256)
  ...
  have step2361 := soundW hs (opAt 2350 .JUMPDEST)
    (blockOfW _ (pcFactW s 2350 3079 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2414)
      (stepW_jumpdest s 3079 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2362 := soundW hs (pushAt 2351 1 1)
    (blockOfW _ (pcFactW s 2351 3080 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2415)
      (stepW_push s 3080 1 (1 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2363 := soundW hs (opAt 2352 (.Dup ⟨6, by decide⟩))
    (blockOfW _ (pcFactW s 2352 3082 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
      (stepW_dup s 3082 6 (by decide) ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (base) (by rfl) (by simp; omega) (by norm_num)))
  have step2364 := soundW hs (opAt 2353 .SUB)
    (blockOfW _ (pcFactW s 2353 3083 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
theorem gasSteps_bitBodyHead_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2363 := blockCostW [opAt 2352 (.Dup ⟨6, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2352 3082 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
  ...
  have c2364 := blockCostW [opAt 2353 .SUB] 3
    (blockOfW _ (pcFactW s 2353 3083 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
def gasSteps_bitExit_sym (s : State) (rest : List UInt256)
  ...
  have step2501 := soundW hs (opAt 2488 .POP)
    (blockOfW _ (pcFactW s 2488 3241 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2554)
      (stepW_pop s 3241 (Bm1) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2502 := soundW hs (pushAt 2489 2 692)
    (blockOfW _ (pcFactW s 2489 3242 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2555)
      (stepW_push s 3242 2 (692 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2503 := soundW hs (opAt 2490 .JUMP)
    (blockOfW _ (pcFactW s 2490 3245 ([(692 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
...
theorem gasSteps_bitExit_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2503 := blockCostW [opAt 2490 .JUMP] 8
    (blockOfW _ (pcFactW s 2490 3245 ([(692 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
