...
def gasSteps_bitEntry_sym (s : State) (rest : List UInt256)
  ...
  have step485 := soundW hs (pushAt 484 2 3418)
  ...
  have step486 := soundW hs (opAt 485 .JUMP)
    (blockOfW _ (pcFactW s 485 610 ([(3418 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc486)
...
theorem gasSteps_bitEntry_sym_cost (s : State) (rest : List UInt256)
  ...
  have c485 := blockCostW [pushAt 484 2 3418] 3
    (blockOfW _ (pcFactW s 484 607 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc485)
...
def gasSteps_bitHead_sym (s : State) (rest : List UInt256)
  ...
  have step2361 := soundW hs (opAt 2509 .JUMPDEST)
    (blockOfW _ (pcFactW s 2509 3418 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2414)
      (stepW_jumpdest s 3418 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2362 := soundW hs (pushAt 2510 1 1)
    (blockOfW _ (pcFactW s 2510 3419 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2415)
      (stepW_push s 3419 1 (1 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2363 := soundW hs (opAt 2511 (.Dup ⟨6, by decide⟩))
    (blockOfW _ (pcFactW s 2511 3421 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
      (stepW_dup s 3421 6 (by decide) ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (base) (by rfl) (by simp; omega) (by norm_num)))
  have step2364 := soundW hs (opAt 2512 .SUB)
    (blockOfW _ (pcFactW s 2512 3422 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
theorem gasSteps_bitHead_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2363 := blockCostW [opAt 2511 (.Dup ⟨6, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2511 3421 ([(1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2416)
  ...
  have c2364 := blockCostW [opAt 2512 .SUB] 3
    (blockOfW _ (pcFactW s 2512 3422 ([base, (1 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2417)
...
def gasSteps_bitExit_sym (s : State) (rest : List UInt256)
  ...
  have step2501 := soundW hs (opAt 2649 .POP)
    (blockOfW _ (pcFactW s 2649 3583 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2554)
      (stepW_pop s 3583 (Bm1) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2502 := soundW hs (pushAt 2650 2 655)
    (blockOfW _ (pcFactW s 2650 3584 ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2555)
      (stepW_push s 3584 2 (655 : UInt256) ([zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by decide) (by decide) (by norm_num)))
  have step2503 := soundW hs (opAt 2651 .JUMP)
    (blockOfW _ (pcFactW s 2651 3587 ([(655 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
...
theorem gasSteps_bitExit_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2503 := blockCostW [opAt 2651 .JUMP] 8
    (blockOfW _ (pcFactW s 2651 3587 ([(655 : UInt256), zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2556)
