...
def scanGuardPath :
  ...
  [opAt 599 .JUMPDEST, opAt 600 (.Dup ⟨2, by decide⟩),
   ...
   pushAt 604 2 795, opAt 605 .JUMPI]
...
def scanBodyPath :
  ...
  [opAt 606 (.Dup ⟨0, by decide⟩), pushAt 607 1 5,
   ...
   pushAt 619 2 767, opAt 620 .JUMP]

def scanNonzeroPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 621 .JUMPDEST, opAt 622 .POP, opAt 623 (.Dup ⟨0, by decide⟩),
   pushAt 624 2 807, opAt 625 .JUMPI]
...
@[simp] private theorem scanPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [764,765,766,767,768,769,770,771,772,775,776,777,779,780,781,782,783,784,785,787,788,789,790,791,794,795,796,797,798,801,802,803,806][i - 596]! := by
