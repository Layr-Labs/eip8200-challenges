...
def entryPrefix : List Located :=
  [opAt 2405 .JUMPDEST, opAt 2406 (.Dup ⟨3, by decide⟩),
   pushAt 2407 1 1, opAt 2408 .EQ, pushAt 2409 2 3734,
   opAt 2410 .JUMPI]
...
def checkThree : List Located :=
  [pushAt 2417 1 32, opAt 2418 .MLOAD, opAt 2419 .CALLDATALOAD,
   pushAt 2420 0 0, opAt 2421 .BYTE, pushAt 2422 1 1,
...
def start : List Located :=
  [opAt 2442 .JUMPDEST, opAt 2443 (.Dup ⟨1, by decide⟩),
   pushAt 2444 2 2784, pushAt 2445 1 7, opAt 2446 .MCOPY]

def squareCall : List Located :=
  [opAt 2447 .JUMPDEST, pushAt 2448 1 15, pushAt 2449 2 1560,
   pushAt 2450 2 256, pushAt 2451 1 31, pushAt 2452 2 1519,
   opAt 2453 .JUMP]
...
def product : List Located :=
  [opAt 2461 .POP, pushAt 2462 0 0, pushAt 2463 2 256,
   pushAt 2464 1 1, pushAt 2465 2 256, pushAt 2466 2 3282,
   opAt 2467 .JUMP]
...
def decode : List Located :=
  [opAt 2468 .JUMPDEST, pushAt 2469 1 1,
   ...
   pushAt 2475 2 3282, pushAt 2476 2 256, pushAt 2477 2 1536,
   pushAt 2478 2 3241, opAt 2479 .JUMP]

def finish : List Located :=
  [opAt 2480 .JUMPDEST, pushAt 2481 2 2912, opAt 2482 .JUMP]
