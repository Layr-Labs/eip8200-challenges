...
private def fermat_load : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5194 FermatProgram.loadProgram :=
  WindowTwentyOneSlice.block allWellFormed 3771 3 5194 FermatProgram.loadProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_exponent : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5197 FermatProgram.exponentXorProgram :=
  WindowTwentyOneSlice.block allWellFormed 3774 8 5197 FermatProgram.exponentXorProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_prime : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5208 FermatProgram.primeFilterProgram :=
  WindowTwentyOneSlice.block allWellFormed 3782 11 5208 FermatProgram.primeFilterProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_result : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5258 FermatProgram.returnProgram :=
  WindowTwentyOneSlice.block allWellFormed 3793 16 5258 FermatProgram.returnProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_miss : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5277 FermatProgram.missProgram :=
  WindowTwentyOneSlice.block allWellFormed 3809 4 5277 FermatProgram.missProgram (by decide) (by rfl) (by rfl) (by decide)
...
private def earlyWord_guard : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5283 EarlyWordProgram.guardProgram :=
  WindowTwentyOneSlice.block allWellFormed 3813 20 5283 EarlyWordProgram.guardProgram (by decide) (by rfl) (by rfl) (by decide)
private def earlyWord_hit : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5310 EarlyWordProgram.hitProgram :=
  WindowTwentyOneSlice.block allWellFormed 3833 15 5310 EarlyWordProgram.hitProgram (by decide) (by rfl) (by rfl) (by decide)
private def earlyWord_miss : WindowTwentyOneBinding.Block submissionArtifact .Osaka 5331 EarlyWordProgram.missProgram :=
  WindowTwentyOneSlice.block allWellFormed 3848 6 5331 EarlyWordProgram.missProgram (by decide) (by rfl) (by rfl) (by decide)
def earlyWordPaths : EarlyWordProgram.Paths submissionArtifact .Osaka where
  guard := earlyWord_guard
  hit := earlyWord_hit
  miss := earlyWord_miss
  helperJump := by exact isValidJumpDest_index 3813 (by rfl)
  missJump := by exact isValidJumpDest_index 3848 (by rfl)
  hitJump := by exact isValidJumpDest_index 3771 (by rfl)
...
def twentyOnePaths : WindowTwentyOneGasRoute.Paths submissionArtifact .Osaka where
  ...
  hitJump := by
    have h := isValidJumpDest_index 3771 (by rfl)
    exact h
  emptyJump := by
