...
private theorem helperPCAnchor :
    Artifact.submissionArtifact.instructionPC 2171 = 3566 := by
  rfl

@[simp] theorem helperPC (i : Nat)
    (hlo : 2171 ≤ i) (hhi : i ≤ 2193) :
    Artifact.submissionArtifact.instructionPC i =
      ([3566,3567,3570,3571,3574,3577,3578,3579,3581,3582,3583,3585,3586,3587,3589,3590,3591,3593,3594,3595,3596,3597,3600] : List Nat)[i - 2171]! := by
...
def helperPath :
  ...
  [opAt 2171 .JUMPDEST,
   ...
   pushAt 2175 2 6144,
   opAt 2176 .MCOPY,
   opAt 2177 (.Dup ⟨1, by decide⟩),
   pushAt 2178 1 3,
   opAt 2179 .LT,
   opAt 2180 (.Dup ⟨2, by decide⟩),
   pushAt 2181 1 7,
   opAt 2182 .LT,
   opAt 2183 (.Dup ⟨3, by decide⟩),
   pushAt 2184 1 15,
   opAt 2185 .LT,
   opAt 2186 (.Dup ⟨4, by decide⟩),
   pushAt 2187 1 31,
   opAt 2188 .LT,
   opAt 2189 .ADD,
   opAt 2190 .ADD,
