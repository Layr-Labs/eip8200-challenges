...
def gasSteps_bitCopy3_sym (s : State) (rest : List UInt256)
  ...
  have step2416 := soundW hs (opAt 2382 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2382 3760 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2469)
      (stepW_dup s 3760 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2417 := soundW hs (pushAt 2383 1 1)
    (blockOfW _ (pcFactW s 2383 3761 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2470)
  ...
  have step2418 := soundW hs (opAt 2384 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2384 3763 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2471)
  ...
  have step2419 := soundW hs (pushAt 2385 1 4)
    (blockOfW _ (pcFactW s 2385 3764 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2472)
  ...
  have step2420 := soundW hs (opAt 2386 .SHR)
    (blockOfW _ (pcFactW s 2386 3766 ([(4 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2473)
      (stepW_shr s 3766 ((4 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2421 := soundW hs (opAt 2387 .AND)
    (blockOfW _ (pcFactW s 2387 3767 ([(UInt256.shiftRight byte (4 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2474)
  ...
  have step2422 := soundW hs (opAt 2388 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2388 3768 ([(UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2475)
  ...
  have step2423 := soundW hs (opAt 2389 .MUL)
    (blockOfW _ (pcFactW s 2389 3769 ([Bm1, (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2476)
  ...
  have step2424 := soundW hs (pushAt 2390 1 1)
    (blockOfW _ (pcFactW s 2390 3770 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2477)
  ...
  have step2425 := soundW hs (opAt 2391 .ADD)
    (blockOfW _ (pcFactW s 2391 3772 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2478)
  ...
  have step2426 := soundW hs (opAt 2392 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2392 3773 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2479)
  ...
  have step2427 := soundW hs (opAt 2393 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2393 3774 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2480)
  ...
  have step2428 := soundW hs (opAt 2394 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2394 3775 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2481)
  ...
  have step2429 := soundW hs (opAt 2395 .MULMOD)
    (blockOfW _ (pcFactW s 2395 3776 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2482)
  ...
  have step2430 := soundW hs (opAt 2396 .MULMOD)
    (blockOfW _ (pcFactW s 2396 3777 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2483)
  ...
  have step2431 := soundW hs (opAt 2397 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2397 3778 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2484)
  ...
  have step2432 := soundW hs (opAt 2398 .POP)
    (blockOfW _ (pcFactW s 2398 3779 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2485)
...
theorem gasSteps_bitCopy3_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2416 := blockCostW [opAt 2382 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2382 3760 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2469)
  ...
  have c2417 := blockCostW [pushAt 2383 1 1] 3
    (blockOfW _ (pcFactW s 2383 3761 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2470)
  ...
  have c2418 := blockCostW [opAt 2384 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2384 3763 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2471)
  ...
  have c2419 := blockCostW [pushAt 2385 1 4] 3
    (blockOfW _ (pcFactW s 2385 3764 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2472)
  ...
  have c2420 := blockCostW [opAt 2386 .SHR] 3
    (blockOfW _ (pcFactW s 2386 3766 ([(4 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2473)
  ...
  have c2421 := blockCostW [opAt 2387 .AND] 3
    (blockOfW _ (pcFactW s 2387 3767 ([(UInt256.shiftRight byte (4 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2474)
  ...
  have c2422 := blockCostW [opAt 2388 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2388 3768 ([(UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2475)
  ...
  have c2423 := blockCostW [opAt 2389 .MUL] 5
    (blockOfW _ (pcFactW s 2389 3769 ([Bm1, (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2476)
  ...
  have c2424 := blockCostW [pushAt 2390 1 1] 3
    (blockOfW _ (pcFactW s 2390 3770 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2477)
  ...
  have c2425 := blockCostW [opAt 2391 .ADD] 3
    (blockOfW _ (pcFactW s 2391 3772 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2478)
  ...
  have c2426 := blockCostW [opAt 2392 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2392 3773 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2479)
  ...
  have c2427 := blockCostW [opAt 2393 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2393 3774 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2480)
  ...
  have c2428 := blockCostW [opAt 2394 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2394 3775 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2481)
  ...
  have c2429 := blockCostW [opAt 2395 .MULMOD] 8
    (blockOfW _ (pcFactW s 2395 3776 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2482)
  ...
  have c2430 := blockCostW [opAt 2396 .MULMOD] 8
    (blockOfW _ (pcFactW s 2396 3777 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2483)
  ...
  have c2431 := blockCostW [opAt 2397 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2397 3778 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2484)
      (stepW_swap s 3778 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2432 := blockCostW [opAt 2398 .POP] 2
    (blockOfW _ (pcFactW s 2398 3779 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2485)
