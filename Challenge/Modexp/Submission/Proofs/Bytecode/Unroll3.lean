...
def gasSteps_bitCopy3_sym (s : State) (rest : List UInt256)
  ...
  have step2416 := soundW hs (opAt 2405 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2405 3144 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2469)
      (stepW_dup s 3144 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2417 := soundW hs (pushAt 2406 1 1)
    (blockOfW _ (pcFactW s 2406 3145 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2470)
  ...
  have step2418 := soundW hs (opAt 2407 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2407 3147 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2471)
  ...
  have step2419 := soundW hs (pushAt 2408 1 4)
    (blockOfW _ (pcFactW s 2408 3148 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2472)
  ...
  have step2420 := soundW hs (opAt 2409 .SHR)
    (blockOfW _ (pcFactW s 2409 3150 ([(4 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2473)
      (stepW_shr s 3150 ((4 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2421 := soundW hs (opAt 2410 .AND)
    (blockOfW _ (pcFactW s 2410 3151 ([(UInt256.shiftRight byte (4 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2474)
  ...
  have step2422 := soundW hs (opAt 2411 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2411 3152 ([(UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2475)
  ...
  have step2423 := soundW hs (opAt 2412 .MUL)
    (blockOfW _ (pcFactW s 2412 3153 ([Bm1, (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2476)
  ...
  have step2424 := soundW hs (pushAt 2413 1 1)
    (blockOfW _ (pcFactW s 2413 3154 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2477)
  ...
  have step2425 := soundW hs (opAt 2414 .ADD)
    (blockOfW _ (pcFactW s 2414 3156 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2478)
  ...
  have step2426 := soundW hs (opAt 2415 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2415 3157 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2479)
  ...
  have step2427 := soundW hs (opAt 2416 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2416 3158 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2480)
  ...
  have step2428 := soundW hs (opAt 2417 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2417 3159 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2481)
  ...
  have step2429 := soundW hs (opAt 2418 .MULMOD)
    (blockOfW _ (pcFactW s 2418 3160 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2482)
  ...
  have step2430 := soundW hs (opAt 2419 .MULMOD)
    (blockOfW _ (pcFactW s 2419 3161 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2483)
  ...
  have step2431 := soundW hs (opAt 2420 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2420 3162 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2484)
  ...
  have step2432 := soundW hs (opAt 2421 .POP)
    (blockOfW _ (pcFactW s 2421 3163 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2485)
...
theorem gasSteps_bitCopy3_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2416 := blockCostW [opAt 2405 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2405 3144 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2469)
  ...
  have c2417 := blockCostW [pushAt 2406 1 1] 3
    (blockOfW _ (pcFactW s 2406 3145 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2470)
  ...
  have c2418 := blockCostW [opAt 2407 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2407 3147 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2471)
  ...
  have c2419 := blockCostW [pushAt 2408 1 4] 3
    (blockOfW _ (pcFactW s 2408 3148 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2472)
  ...
  have c2420 := blockCostW [opAt 2409 .SHR] 3
    (blockOfW _ (pcFactW s 2409 3150 ([(4 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2473)
  ...
  have c2421 := blockCostW [opAt 2410 .AND] 3
    (blockOfW _ (pcFactW s 2410 3151 ([(UInt256.shiftRight byte (4 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2474)
  ...
  have c2422 := blockCostW [opAt 2411 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2411 3152 ([(UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2475)
  ...
  have c2423 := blockCostW [opAt 2412 .MUL] 5
    (blockOfW _ (pcFactW s 2412 3153 ([Bm1, (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2476)
  ...
  have c2424 := blockCostW [pushAt 2413 1 1] 3
    (blockOfW _ (pcFactW s 2413 3154 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2477)
  ...
  have c2425 := blockCostW [opAt 2414 .ADD] 3
    (blockOfW _ (pcFactW s 2414 3156 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2478)
  ...
  have c2426 := blockCostW [opAt 2415 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2415 3157 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2479)
  ...
  have c2427 := blockCostW [opAt 2416 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2416 3158 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2480)
  ...
  have c2428 := blockCostW [opAt 2417 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2417 3159 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2481)
  ...
  have c2429 := blockCostW [opAt 2418 .MULMOD] 8
    (blockOfW _ (pcFactW s 2418 3160 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2482)
  ...
  have c2430 := blockCostW [opAt 2419 .MULMOD] 8
    (blockOfW _ (pcFactW s 2419 3161 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2483)
  ...
  have c2431 := blockCostW [opAt 2420 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2420 3162 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2484)
      (stepW_swap s 3162 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2432 := blockCostW [opAt 2421 .POP] 2
    (blockOfW _ (pcFactW s 2421 3163 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (4 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2485)
