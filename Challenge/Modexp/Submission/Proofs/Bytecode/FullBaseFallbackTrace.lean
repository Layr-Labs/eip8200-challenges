...
private def fallbackCountPath :
  ...
  [opAt 2208 .JUMPDEST, opAt 2209 (.Dup ⟨2, by decide⟩),
   pushAt 2210 1 31, opAt 2211 .ADD, pushAt 2212 1 5, opAt 2213 .SHR]
private def fallbackWordPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2214 (.Dup ⟨3, by decide⟩), opAt 2215 (.Dup ⟨1, by decide⟩),
   pushAt 2216 1 5, opAt 2217 .SHL, opAt 2218 .SUB, pushAt 2219 1 3,
   opAt 2220 .SHL, pushAt 2221 1 96, opAt 2222 .CALLDATALOAD,
   opAt 2223 (.Swap ⟨0, by decide⟩), opAt 2224 .SHR]
private def fallbackStorePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2225 (.Dup ⟨2, by decide⟩), pushAt 2226 2 992, opAt 2227 .ADD,
   opAt 2228 .MSTORE, pushAt 2229 1 1, pushAt 2230 2 1650, opAt 2231 .JUMP]
...
theorem run_fallback (s : State) (mem input : ByteArray)
  ...
  have hjump : Decode.isValidJumpDest s.executionEnv.code 1650 = true := by
