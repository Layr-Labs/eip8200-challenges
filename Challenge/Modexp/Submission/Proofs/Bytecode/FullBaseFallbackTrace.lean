...
private def fallbackCountPath :
  ...
  [opAt 2468 .JUMPDEST, opAt 2469 (.Dup ⟨2, by decide⟩),
   pushAt 2470 1 31, opAt 2471 .ADD, pushAt 2472 1 5, opAt 2473 .SHR]
private def fallbackWordPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2474 (.Dup ⟨3, by decide⟩), opAt 2475 (.Dup ⟨1, by decide⟩),
   pushAt 2476 1 5, opAt 2477 .SHL, opAt 2478 .SUB, pushAt 2479 1 3,
   opAt 2480 .SHL, pushAt 2481 1 96, opAt 2482 .CALLDATALOAD,
   opAt 2483 (.Swap ⟨0, by decide⟩), opAt 2484 .SHR]
private def fallbackStorePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2485 (.Dup ⟨2, by decide⟩), pushAt 2486 2 992, opAt 2487 .ADD,
   opAt 2488 .MSTORE, pushAt 2489 1 1, pushAt 2490 2 1668, opAt 2491 .JUMP]
