...
private def fallbackCountPath :
  ...
  [opAt 2374 .JUMPDEST, opAt 2375 (.Dup ⟨2, by decide⟩),
   pushAt 2376 1 31, opAt 2377 .ADD, pushAt 2378 1 5, opAt 2379 .SHR]
private def fallbackWordPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2380 (.Dup ⟨3, by decide⟩), opAt 2381 (.Dup ⟨1, by decide⟩),
   pushAt 2382 1 5, opAt 2383 .SHL, opAt 2384 .SUB, pushAt 2385 1 3,
   opAt 2386 .SHL, pushAt 2387 1 96, opAt 2388 .CALLDATALOAD,
   opAt 2389 (.Swap ⟨0, by decide⟩), opAt 2390 .SHR]
private def fallbackStorePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2391 (.Dup ⟨2, by decide⟩), pushAt 2392 2 224, opAt 2393 .ADD,
   opAt 2394 .MSTORE, pushAt 2395 1 1, pushAt 2396 2 1530, opAt 2397 .JUMP]
...
private theorem activeWords_fix (s : State) (offset size : Nat) (hsz : size ≠ 0)
    (hend : offset + size ≤ 2976) (hactive : 93 ≤ s.activeWords.toNat) :
...
theorem run_fallback (s : State) (mem input : ByteArray)
    ...
    (hn32 : n ≤ 8) (hb : bsize ≤ 256) (hb0 : 1 ≤ bsize)
  ...
  have hjump : Decode.isValidJumpDest s.executionEnv.code 1530 = true := by
  ...
  have hcount : Challenge.EvmProof.Stepper.runLocatedBlock fallbackCountPath
    ...
    simp [fallbackCountPath, Challenge.EvmProof.Stepper.runLocatedBlock,
      ...
      hcode, hrun, fullBasePC, jumpDest1611,
