...
private def fallbackCountPath :
  ...
  [opAt 2280 .JUMPDEST, opAt 2281 (.Dup ⟨2, by decide⟩),
   pushAt 2282 1 31, opAt 2283 .ADD, pushAt 2284 1 5, opAt 2285 .SHR]
private def fallbackWordPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2286 (.Dup ⟨3, by decide⟩), opAt 2287 (.Dup ⟨1, by decide⟩),
   pushAt 2288 1 5, opAt 2289 .SHL, opAt 2290 .SUB, pushAt 2291 1 3,
   opAt 2292 .SHL, pushAt 2293 1 96, opAt 2294 .CALLDATALOAD,
   opAt 2295 (.Swap ⟨0, by decide⟩), opAt 2296 .SHR]
private def fallbackStorePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 2297 (.Dup ⟨2, by decide⟩), pushAt 2298 2 992, opAt 2299 .ADD,
   opAt 2300 .MSTORE, pushAt 2301 1 1, pushAt 2302 2 1431, opAt 2303 .JUMP]
...
theorem run_fallback (s : State) (mem input : ByteArray)
  ...
  have hjump : Decode.isValidJumpDest s.executionEnv.code 1431 = true := by
