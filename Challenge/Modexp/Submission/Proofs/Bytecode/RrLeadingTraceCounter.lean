...
theorem run_counter (template : State) (mem : ByteArray)
  ...
  have hpc :
      (((((UInt256.ofNat 3322).succ + UInt256.ofNat 2).succ.succ + UInt256.ofNat 2).succ.succ + UInt256.ofNat 2).succ.succ + UInt256.ofNat 2).succ.succ.succ.succ = UInt256.ofNat 3341 := by
    decide
