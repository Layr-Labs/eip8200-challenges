...
def branchProgram : List Instr := [.push 2 5366, .op .JUMPI]
...
def frameProgram : List Instr :=
  [.push 2 1229, .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨3, by decide⟩),
   .push 1 96, .op (.Dup ⟨6, by decide⟩), .op (.Dup ⟨8, by decide⟩),
   .op (.Dup ⟨10, by decide⟩), .push 2 5229, .op .JUMP]
...
def missProgram : List Instr :=
  [.op .JUMPDEST, .op .POP, .op .POP, .op .POP, .push 2 1275, .op .JUMP]
...
structure Paths (artifact : ProgramArtifact) (fork : Fork) where
  guard : WindowTwentyOneBinding.Block artifact fork 5318 guardProgram
  hit : WindowTwentyOneBinding.Block artifact fork 5345 hitProgram
  miss : WindowTwentyOneBinding.Block artifact fork 5366 missProgram
  helperJump : Decode.isValidJumpDest artifact.code 5318 = true
  missJump : Decode.isValidJumpDest artifact.code 5366 = true
  hitJump : Decode.isValidJumpDest artifact.code 5229 = true
  legacyJump : Decode.isValidJumpDest artifact.code 1275 = true
...
theorem run_header (template : State) (input : ByteArray)
    (hdata : template.executionEnv.calldata = input) :
    runInstructions headerProgram (framed template (UInt256.ofNat 5318) []) =
      some (framed template (UInt256.ofNat 5327) (headerStack input)) := by
...
theorem run_guard_value (template : State) (b e m : UInt256) :
    runInstructions guardValueProgram (framed template (UInt256.ofNat 5327) [m, e, b]) =
      some (framed template (UInt256.ofNat 5341) (widthDiff b e m :: [m, e, b])) := by
...
theorem run_branch (template : State) (value b e m : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5366 = true) :
    runInstructions branchProgram
      (framed template (UInt256.ofNat 5341) (value :: [m, e, b])) =
      some (framed template
        (if value.toNat = 0 then UInt256.ofNat 5345 else UInt256.ofNat 5366) [m, e, b]) := by
...
theorem run_guard (template : State) (input : ByteArray)
    (hdata : template.executionEnv.calldata = input)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5366 = true) :
    runInstructions guardProgram (framed template (UInt256.ofNat 5318) []) =
      some (framed template
        (if (WindowTwentyOneInput.guardDiff input).toNat = 0
          then UInt256.ofNat 5345 else UInt256.ofNat 5366) (headerStack input)) := by
...
theorem run_offsets (template : State) (b e m : UInt256) :
    runInstructions offsetsProgram (framed template (UInt256.ofNat 5345) [m, e, b]) =
      some (framed template (UInt256.ofNat 5352)
...
theorem run_frame (template : State) (b e m x y : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5229 = true) :
    runInstructions frameProgram (framed template (UInt256.ofNat 5352) [y, x, m, e, b]) =
      some (framed template (UInt256.ofNat 5229)
        [b, e, m, UInt256.ofNat 96, x, y, UInt256.ofNat 1229, y, x, m, e, b]) := by
...
theorem run_hit (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5229 = true) :
    runInstructions hitProgram (framed template (UInt256.ofNat 5345) (headerStack input)) =
      some (framed template (UInt256.ofNat 5229) (WindowTwentyOnePositive.routeStack input)) := by
...
theorem run_miss (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 1275 = true) :
    runInstructions missProgram (framed template (UInt256.ofNat 5366) (headerStack input)) =
      some (framed template (UInt256.ofNat 1275) []) := by
