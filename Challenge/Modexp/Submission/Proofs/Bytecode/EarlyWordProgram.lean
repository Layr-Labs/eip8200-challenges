...
def branchProgram : List Instr := [.push 2 5048, .op .JUMPI]
...
def frameProgram : List Instr :=
  [.push 2 1186, .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨3, by decide⟩),
   ...
   .op (.Dup ⟨10, by decide⟩), .push 2 4752, .op .JUMP]
...
def missProgram : List Instr :=
  [.op .JUMPDEST, .op .POP, .op .POP, .op .POP, .push 2 5052, .op .JUMP]
...
structure Paths (artifact : ProgramArtifact) (fork : Fork) where
  ...
  hit : WindowTwentyOneBinding.Block artifact fork 27 hitProgram
  miss : WindowTwentyOneBinding.Block artifact fork 5048 missProgram
  helperJump : Decode.isValidJumpDest artifact.code 0 = true
  missJump : Decode.isValidJumpDest artifact.code 5048 = true
  hitJump : Decode.isValidJumpDest artifact.code 4752 = true
  legacyJump : Decode.isValidJumpDest artifact.code 5052 = true
...
theorem run_header (template : State) (input : ByteArray)
    ...
    runInstructions headerProgram (framed template (UInt256.ofNat 0) []) =
      some (framed template (UInt256.ofNat 9) (headerStack input)) := by
...
theorem run_guard_value (template : State) (b e m : UInt256) :
    runInstructions guardValueProgram (framed template (UInt256.ofNat 9) [m, e, b]) =
      some (framed template (UInt256.ofNat 23) (widthDiff b e m :: [m, e, b])) := by
...
theorem run_branch (template : State) (value b e m : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5048 = true) :
    runInstructions branchProgram
      (framed template (UInt256.ofNat 23) (value :: [m, e, b])) =
      some (framed template
        (if value.toNat = 0 then UInt256.ofNat 27 else UInt256.ofNat 5048) [m, e, b]) := by
    ...
    runInstructions guardProgram (framed template (UInt256.ofNat 0) []) =
      some (framed template
        (if (WindowTwentyOneInput.guardDiff input).toNat = 0
          then UInt256.ofNat 27 else UInt256.ofNat 5048) (headerStack input)) := by
...
theorem run_offsets (template : State) (b e m : UInt256) :
    runInstructions offsetsProgram (framed template (UInt256.ofNat 27) [m, e, b]) =
      some (framed template (UInt256.ofNat 34)
...
theorem run_frame (template : State) (b e m x y : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 4752 = true) :
    runInstructions frameProgram (framed template (UInt256.ofNat 34) [y, x, m, e, b]) =
      some (framed template (UInt256.ofNat 4752)
...
theorem run_hit (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 4752 = true) :
    runInstructions hitProgram (framed template (UInt256.ofNat 27) (headerStack input)) =
      some (framed template (UInt256.ofNat 4752) (WindowTwentyOnePositive.routeStack input)) := by
...
theorem run_miss (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5052 = true) :
    runInstructions missProgram (framed template (UInt256.ofNat 5048) (headerStack input)) =
      some (framed template (UInt256.ofNat 5052) []) := by
