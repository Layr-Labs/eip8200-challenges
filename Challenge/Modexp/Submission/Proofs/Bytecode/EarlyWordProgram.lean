...
def branchProgram : List Instr := [.push 2 5159, .op .JUMPI]
...
def frameProgram : List Instr :=
  [.push 2 1186, .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨3, by decide⟩),
   ...
   .op (.Dup ⟨10, by decide⟩), .push 2 4763, .op .JUMP]
...
structure Paths (artifact : ProgramArtifact) (fork : Fork) where
  guard : WindowTwentyOneBinding.Block artifact fork 5111 guardProgram
  hit : WindowTwentyOneBinding.Block artifact fork 5138 hitProgram
  miss : WindowTwentyOneBinding.Block artifact fork 5159 missProgram
  helperJump : Decode.isValidJumpDest artifact.code 5111 = true
  missJump : Decode.isValidJumpDest artifact.code 5159 = true
  hitJump : Decode.isValidJumpDest artifact.code 4763 = true
  legacyJump : Decode.isValidJumpDest artifact.code 1121 = true
...
theorem run_header (template : State) (input : ByteArray)
    (hdata : template.executionEnv.calldata = input) :
    runInstructions headerProgram (framed template (UInt256.ofNat 5111) []) =
      some (framed template (UInt256.ofNat 5120) (headerStack input)) := by
...
theorem run_guard_value (template : State) (b e m : UInt256) :
    runInstructions guardValueProgram (framed template (UInt256.ofNat 5120) [m, e, b]) =
      some (framed template (UInt256.ofNat 5134) (widthDiff b e m :: [m, e, b])) := by
...
theorem run_branch (template : State) (value b e m : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5159 = true) :
    runInstructions branchProgram
      (framed template (UInt256.ofNat 5134) (value :: [m, e, b])) =
      some (framed template
        (if value.toNat = 0 then UInt256.ofNat 5138 else UInt256.ofNat 5159) [m, e, b]) := by
...
theorem run_guard (template : State) (input : ByteArray)
    (hdata : template.executionEnv.calldata = input)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5159 = true) :
    runInstructions guardProgram (framed template (UInt256.ofNat 5111) []) =
      some (framed template
        (if (WindowTwentyOneInput.guardDiff input).toNat = 0
          then UInt256.ofNat 5138 else UInt256.ofNat 5159) (headerStack input)) := by
...
theorem run_offsets (template : State) (b e m : UInt256) :
    runInstructions offsetsProgram (framed template (UInt256.ofNat 5138) [m, e, b]) =
      some (framed template (UInt256.ofNat 5145)
...
theorem run_frame (template : State) (b e m x y : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 4763 = true) :
    runInstructions frameProgram (framed template (UInt256.ofNat 5145) [y, x, m, e, b]) =
      some (framed template (UInt256.ofNat 4763)
...
theorem run_hit (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 4763 = true) :
    runInstructions hitProgram (framed template (UInt256.ofNat 5138) (headerStack input)) =
      some (framed template (UInt256.ofNat 4763) (WindowTwentyOnePositive.routeStack input)) := by
...
theorem run_miss (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 1121 = true) :
    runInstructions missProgram (framed template (UInt256.ofNat 5159) (headerStack input)) =
      some (framed template (UInt256.ofNat 1121) []) := by
