...
def branchProgram : List Instr := [.push 2 5237, .op .JUMPI]
...
def frameProgram : List Instr :=
  [.push 2 1186, .op (.Dup ⟨1, by decide⟩), .op (.Dup ⟨3, by decide⟩),
   ...
   .op (.Dup ⟨10, by decide⟩), .push 2 4841, .op .JUMP]
...
def missProgram : List Instr :=
  [.op .JUMPDEST, .op .POP, .op .POP, .op .POP, .push 2 1121, .op .JUMP]
...
structure Paths (artifact : ProgramArtifact) (fork : Fork) where
  guard : WindowTwentyOneBinding.Block artifact fork 5169 guardProgram
  hit : WindowTwentyOneBinding.Block artifact fork 5196 hitProgram
  miss : WindowTwentyOneBinding.Block artifact fork 5217 missProgram
  helperJump : Decode.isValidJumpDest artifact.code 5169 = true
  missJump : Decode.isValidJumpDest artifact.code 5217 = true
  hitJump : Decode.isValidJumpDest artifact.code 4825 = true
  legacyJump : Decode.isValidJumpDest artifact.code 1117 = true
...
theorem run_header (template : State) (input : ByteArray)
    (hdata : template.executionEnv.calldata = input) :
    runInstructions headerProgram (framed template (UInt256.ofNat 5169) []) =
      some (framed template (UInt256.ofNat 5178) (headerStack input)) := by
...
theorem run_guard_value (template : State) (b e m : UInt256) :
    runInstructions guardValueProgram (framed template (UInt256.ofNat 5178) [m, e, b]) =
      some (framed template (UInt256.ofNat 5192) (widthDiff b e m :: [m, e, b])) := by
...
theorem run_branch (template : State) (value b e m : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5217 = true) :
    runInstructions branchProgram
      (framed template (UInt256.ofNat 5192) (value :: [m, e, b])) =
      some (framed template
        (if value.toNat = 0 then UInt256.ofNat 5196 else UInt256.ofNat 5217) [m, e, b]) := by
...
theorem run_guard (template : State) (input : ByteArray)
    (hdata : template.executionEnv.calldata = input)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 5217 = true) :
    runInstructions guardProgram (framed template (UInt256.ofNat 5169) []) =
      some (framed template
        (if (WindowTwentyOneInput.guardDiff input).toNat = 0
          then UInt256.ofNat 5196 else UInt256.ofNat 5217) (headerStack input)) := by
...
theorem run_offsets (template : State) (b e m : UInt256) :
    runInstructions offsetsProgram (framed template (UInt256.ofNat 5196) [m, e, b]) =
      some (framed template (UInt256.ofNat 5203)
...
theorem run_frame (template : State) (b e m x y : UInt256)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 4825 = true) :
    runInstructions frameProgram (framed template (UInt256.ofNat 5203) [y, x, m, e, b]) =
      some (framed template (UInt256.ofNat 4825)
        [b, e, m, UInt256.ofNat 96, x, y, UInt256.ofNat 1182, y, x, m, e, b]) := by
...
theorem run_hit (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 4825 = true) :
    runInstructions hitProgram (framed template (UInt256.ofNat 5196) (headerStack input)) =
      some (framed template (UInt256.ofNat 4825) (WindowTwentyOnePositive.routeStack input)) := by
...
theorem run_miss (template : State) (input : ByteArray)
    (hjump : Decode.isValidJumpDest template.executionEnv.code 1117 = true) :
    runInstructions missProgram (framed template (UInt256.ofNat 5217) (headerStack input)) =
      some (framed template (UInt256.ofNat 1117) []) := by
