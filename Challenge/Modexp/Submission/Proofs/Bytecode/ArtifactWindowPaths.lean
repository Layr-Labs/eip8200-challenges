...
private def nine_width :
  ...
  WindowTwentyOneSlice.block allWellFormed 569 14 804 WindowTwentyOneEntry.widthProgram
    (by decide) (by rfl)
...
private def nine_hitTail :
  ...
  WindowTwentyOneSlice.block allWellFormed 583 4 822 WindowTwentyOneEntry.hitTailProgram
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)
...
private def nine_base :
  ...
  WindowTwentyOneSlice.block allWellFormed 587 1 827 WindowTwentyOneEntry.baseProgram
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)

private def nine_modulus :
  WindowTwentyOneBinding.Block submissionArtifact .Osaka 828 WindowTwentyOneEntry.modulusProgram :=
  WindowTwentyOneSlice.block allWellFormed 588 2 828 WindowTwentyOneEntry.modulusProgram
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)
...
private def nine_normalize :
  ...
  WindowTwentyOneSlice.block allWellFormed 590 7 831 WindowTwentyOneEntry.normalizeProgram
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)

private def nine_table :
  WindowTwentyOneBinding.Block submissionArtifact .Osaka 840 WindowTwentyOneTableBuild.program :=
  WindowTwentyOneSlice.block allWellFormed 597 91 840 WindowTwentyOneTableBuild.program
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)

private def nine_init :
  WindowTwentyOneBinding.Block submissionArtifact .Osaka 932 WindowTwentyOneInit.program :=
  WindowTwentyOneSlice.block allWellFormed 688 13 932 WindowTwentyOneInit.program
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)

private def nine_entry :
    WindowTwentyOneBinding.Block submissionArtifact .Osaka 952 WindowTwentyOneLoop.entryProgram :=
  WindowTwentyOneSlice.block allWellFormed 701 0 952 WindowTwentyOneLoop.entryProgram
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)

private def nine_trampoline :
    WindowTwentyOneBinding.Block submissionArtifact .Osaka 952 WindowTwentyOneLoop.trampolineProgram :=
  WindowTwentyOneSlice.block allWellFormed 701 13 952 WindowTwentyOneLoop.trampolineProgram
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)
...
def fermatPaths : FermatNext.Paths submissionArtifact .Osaka where
  ...
  legacyJump := by exact isValidJumpDest_index 587 (by rfl)
