...
private def fermat_prime : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4890 FermatProgram.primeProgram :=
  WindowTwentyOneSlice.block allWellFormed 3737 14 4890 FermatProgram.primeProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_exponent : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4943 FermatProgram.exponentProgram :=
  WindowTwentyOneSlice.block allWellFormed 3751 9 4943 FermatProgram.exponentProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_result : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4955 FermatProgram.returnProgram :=
  WindowTwentyOneSlice.block allWellFormed 3760 16 4955 FermatProgram.returnProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_miss : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4974 FermatProgram.missProgram :=
  WindowTwentyOneSlice.block allWellFormed 3776 4 4974 FermatProgram.missProgram (by decide) (by rfl) (by rfl) (by decide)
def fermatPaths : FermatProgram.Paths submissionArtifact .Osaka where
  prime := fermat_prime
  exponent := fermat_exponent
  result := fermat_result
  miss := fermat_miss
  missJump := by exact isValidJumpDest_index 3776 (by rfl)
...
def twentyOnePaths : WindowTwentyOneGasRoute.Paths submissionArtifact .Osaka where
  ...
  hitJump := by
    have h := isValidJumpDest_index 3737 (by rfl)
    exact h
  emptyJump := by
