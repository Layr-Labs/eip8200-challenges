...
private def fermat_prime : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4883 FermatProgram.primeProgram :=
  WindowTwentyOneSlice.block allWellFormed 3674 14 4883 FermatProgram.primeProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_exponent : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4936 FermatProgram.exponentProgram :=
  WindowTwentyOneSlice.block allWellFormed 3688 9 4936 FermatProgram.exponentProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_result : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4948 FermatProgram.returnProgram :=
  WindowTwentyOneSlice.block allWellFormed 3697 16 4948 FermatProgram.returnProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_miss : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4967 FermatProgram.missProgram :=
  WindowTwentyOneSlice.block allWellFormed 3713 4 4967 FermatProgram.missProgram (by decide) (by rfl) (by rfl) (by decide)
def fermatPaths : FermatProgram.Paths submissionArtifact .Osaka where
  prime := fermat_prime
  exponent := fermat_exponent
  result := fermat_result
  miss := fermat_miss
  missJump := by exact isValidJumpDest_index 3713 (by rfl)
