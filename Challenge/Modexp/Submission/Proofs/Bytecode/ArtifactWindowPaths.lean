...
private def nine_init :
  ...
  WindowTwentyOneSlice.block allWellFormed 1742 16 2347 WindowTwentyOneInit.program
    (by decide) (by rfl) (by rfl) (by decide)

private def nine_iteration :
    WindowTwentyOneBinding.Block submissionArtifact .Osaka 2368 WindowTwentyOneLoop.iterationProgram :=
  WindowTwentyOneSlice.block allWellFormed 1758 438 2368 WindowTwentyOneLoop.iterationProgram
    (by decide) (by rfl) (by rfl) (by decide)

private def nine_finish :
    WindowTwentyOneBinding.Block submissionArtifact .Osaka 2831 WindowTwentyOneReturn.program :=
  WindowTwentyOneSlice.block allWellFormed 2196 5 2831 WindowTwentyOneReturn.program
    (by decide) (by rfl) (by rfl) (by decide)

private def nine_zeroReturn :
    WindowTwentyOneBinding.Block submissionArtifact .Osaka 2837 WindowTwentyOneReturn.zeroProgram :=
  WindowTwentyOneSlice.block allWellFormed 2201 7 2837 WindowTwentyOneReturn.zeroProgram
    (by decide) (by rfl) (by rfl) (by decide)

private def fermat_prime : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4777 FermatProgram.primeProgram :=
  WindowTwentyOneSlice.block allWellFormed 3670 14 4777 FermatProgram.primeProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_exponent : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4830 FermatProgram.exponentProgram :=
  WindowTwentyOneSlice.block allWellFormed 3684 9 4830 FermatProgram.exponentProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_result : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4842 FermatProgram.returnProgram :=
  WindowTwentyOneSlice.block allWellFormed 3693 16 4842 FermatProgram.returnProgram (by decide) (by rfl) (by rfl) (by decide)
...
def twentyOnePaths : WindowTwentyOneGasRoute.Paths submissionArtifact .Osaka where
  ...
  hitJump := by
    have h := isValidJumpDest_index 3670 (by rfl)
    exact h
  zeroJump := by
    have h := isValidJumpDest_index 2201 (by rfl)
    exact h
  loopJump := by
    have h := isValidJumpDest_index 1758 (by rfl)
    exact h
  missJump := by
