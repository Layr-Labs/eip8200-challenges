...
private def nine_init :
    WindowTwentyOneBinding.Block submissionArtifact .Osaka 2438 WindowTwentyOneInit.program :=
  WindowTwentyOneSlice.block allWellFormed 1807 16 2438 WindowTwentyOneInit.program
    (by decide) (by rfl)
    (by rw [locations_map_instruction]; rfl) (by decide)
