...
private def fermat_prime : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4738 FermatProgram.primeProgram :=
  WindowTwentyOneSlice.block allWellFormed 3623 14 4738 FermatProgram.primeProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_exponent : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4791 FermatProgram.exponentProgram :=
  WindowTwentyOneSlice.block allWellFormed 3637 9 4791 FermatProgram.exponentProgram (by decide) (by rfl) (by rfl) (by decide)
private def fermat_result : WindowTwentyOneBinding.Block submissionArtifact .Osaka 4803 FermatProgram.returnProgram :=
  WindowTwentyOneSlice.block allWellFormed 3646 16 4803 FermatProgram.returnProgram (by decide) (by rfl) (by rfl) (by decide)
...
def twentyOnePaths : WindowTwentyOneGasRoute.Paths submissionArtifact .Osaka where
  ...
  hitJump := by
    have h := isValidJumpDest_index 3623 (by rfl)
    exact h
  zeroJump := by
