...
theorem run_width_value (template : State) (baseSize exponentSize modulusSize : UInt256)
    ...
    runInstructions widthValueProgram
      (framed template (UInt256.ofNat 1633) ([baseSize, exponentSize, modulusSize] ++ tail)) =
    some (framed template (UInt256.ofNat 1648)
...
theorem run_width (template : State) (baseSize exponentSize modulusSize : UInt256)
  ...
  have hpc : advancePC 3 (UInt256.ofNat 1648) = UInt256.ofNat 1651 := by decide
...
theorem run_hit_tail (template : State) (x y : UInt256) (rest : List UInt256)
    ...
    runInstructions hitTailProgram (framed template (UInt256.ofNat 1651) (x :: y :: rest)) =
...
theorem run_modulus (template : State)
    ...
    runInstructions modulusProgram (framed template (UInt256.ofNat 1657) (value :: rest)) =
    some (framed template (UInt256.ofNat 1660)
...
theorem run_normalize (template : State) (modulus : UInt256)
    ...
    runInstructions normalizeProgram
      (framed template (UInt256.ofNat 1660) (UInt256.ofNat 96 :: modulus :: rest)) =
    some (framed template (UInt256.ofNat 1669)
