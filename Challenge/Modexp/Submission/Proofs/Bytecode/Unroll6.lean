...
def gasSteps_bitCopy6_sym (s : State) (rest : List UInt256)
  ...
  have step2467 := soundW hs (opAt 2438 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2438 3820 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2520)
      (stepW_dup s 3820 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2468 := soundW hs (pushAt 2439 1 1)
    (blockOfW _ (pcFactW s 2439 3821 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2521)
  ...
  have step2469 := soundW hs (opAt 2440 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2440 3823 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2522)
  ...
  have step2470 := soundW hs (pushAt 2441 1 1)
    (blockOfW _ (pcFactW s 2441 3824 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2523)
  ...
  have step2471 := soundW hs (opAt 2442 .SHR)
    (blockOfW _ (pcFactW s 2442 3826 ([(1 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2524)
      (stepW_shr s 3826 ((1 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2472 := soundW hs (opAt 2443 .AND)
    (blockOfW _ (pcFactW s 2443 3827 ([(UInt256.shiftRight byte (1 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2525)
  ...
  have step2473 := soundW hs (opAt 2444 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2444 3828 ([(UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2526)
  ...
  have step2474 := soundW hs (opAt 2445 .MUL)
    (blockOfW _ (pcFactW s 2445 3829 ([Bm1, (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2527)
  ...
  have step2475 := soundW hs (pushAt 2446 1 1)
    (blockOfW _ (pcFactW s 2446 3830 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2528)
  ...
  have step2476 := soundW hs (opAt 2447 .ADD)
    (blockOfW _ (pcFactW s 2447 3832 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2529)
  ...
  have step2477 := soundW hs (opAt 2448 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2448 3833 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2530)
  ...
  have step2478 := soundW hs (opAt 2449 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2449 3834 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2531)
  ...
  have step2479 := soundW hs (opAt 2450 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2450 3835 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2532)
  ...
  have step2480 := soundW hs (opAt 2451 .MULMOD)
    (blockOfW _ (pcFactW s 2451 3836 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2533)
  ...
  have step2481 := soundW hs (opAt 2452 .MULMOD)
    (blockOfW _ (pcFactW s 2452 3837 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2534)
  ...
  have step2482 := soundW hs (opAt 2453 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2453 3838 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2535)
  ...
  have step2483 := soundW hs (opAt 2454 .POP)
    (blockOfW _ (pcFactW s 2454 3839 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2536)
...
theorem gasSteps_bitCopy6_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2467 := blockCostW [opAt 2438 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2438 3820 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2520)
  ...
  have c2468 := blockCostW [pushAt 2439 1 1] 3
    (blockOfW _ (pcFactW s 2439 3821 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2521)
  ...
  have c2469 := blockCostW [opAt 2440 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2440 3823 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2522)
  ...
  have c2470 := blockCostW [pushAt 2441 1 1] 3
    (blockOfW _ (pcFactW s 2441 3824 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2523)
  ...
  have c2471 := blockCostW [opAt 2442 .SHR] 3
    (blockOfW _ (pcFactW s 2442 3826 ([(1 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2524)
  ...
  have c2472 := blockCostW [opAt 2443 .AND] 3
    (blockOfW _ (pcFactW s 2443 3827 ([(UInt256.shiftRight byte (1 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2525)
  ...
  have c2473 := blockCostW [opAt 2444 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2444 3828 ([(UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2526)
  ...
  have c2474 := blockCostW [opAt 2445 .MUL] 5
    (blockOfW _ (pcFactW s 2445 3829 ([Bm1, (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2527)
  ...
  have c2475 := blockCostW [pushAt 2446 1 1] 3
    (blockOfW _ (pcFactW s 2446 3830 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2528)
  ...
  have c2476 := blockCostW [opAt 2447 .ADD] 3
    (blockOfW _ (pcFactW s 2447 3832 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2529)
  ...
  have c2477 := blockCostW [opAt 2448 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2448 3833 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2530)
  ...
  have c2478 := blockCostW [opAt 2449 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2449 3834 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2531)
  ...
  have c2479 := blockCostW [opAt 2450 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2450 3835 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2532)
  ...
  have c2480 := blockCostW [opAt 2451 .MULMOD] 8
    (blockOfW _ (pcFactW s 2451 3836 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2533)
  ...
  have c2481 := blockCostW [opAt 2452 .MULMOD] 8
    (blockOfW _ (pcFactW s 2452 3837 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2534)
  ...
  have c2482 := blockCostW [opAt 2453 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2453 3838 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2535)
      (stepW_swap s 3838 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2483 := blockCostW [opAt 2454 .POP] 2
    (blockOfW _ (pcFactW s 2454 3839 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2536)
