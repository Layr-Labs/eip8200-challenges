...
def gasSteps_bitCopy6_sym (s : State) (rest : List UInt256)
  ...
  have step2467 := soundW hs (opAt 2448 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2448 3820 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2520)
  ...
  have step2468 := soundW hs (pushAt 2449 1 1)
    (blockOfW _ (pcFactW s 2449 3821 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2521)
  ...
  have step2469 := soundW hs (opAt 2450 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2450 3823 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2522)
  ...
  have step2470 := soundW hs (pushAt 2451 1 1)
    (blockOfW _ (pcFactW s 2451 3824 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2523)
  ...
  have step2471 := soundW hs (opAt 2452 .SHR)
    (blockOfW _ (pcFactW s 2452 3826 ([(1 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2524)
  ...
  have step2472 := soundW hs (opAt 2453 .AND)
    (blockOfW _ (pcFactW s 2453 3827 ([(UInt256.shiftRight byte (1 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2525)
  ...
  have step2473 := soundW hs (opAt 2454 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2454 3828 ([(UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2526)
  ...
  have step2474 := soundW hs (opAt 2455 .MUL)
    (blockOfW _ (pcFactW s 2455 3829 ([Bm1, (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2527)
  ...
  have step2475 := soundW hs (pushAt 2456 1 1)
    (blockOfW _ (pcFactW s 2456 3830 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2528)
  ...
  have step2476 := soundW hs (opAt 2457 .ADD)
    (blockOfW _ (pcFactW s 2457 3832 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2529)
  ...
  have step2477 := soundW hs (opAt 2458 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2458 3833 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2530)
  ...
  have step2478 := soundW hs (opAt 2459 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2459 3834 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2531)
  ...
  have step2479 := soundW hs (opAt 2460 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2460 3835 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2532)
  ...
  have step2480 := soundW hs (opAt 2461 .MULMOD)
    (blockOfW _ (pcFactW s 2461 3836 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2533)
  ...
  have step2481 := soundW hs (opAt 2462 .MULMOD)
    (blockOfW _ (pcFactW s 2462 3837 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2534)
  ...
  have step2482 := soundW hs (opAt 2463 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2463 3838 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2535)
  ...
  have step2483 := soundW hs (opAt 2464 .POP)
    (blockOfW _ (pcFactW s 2464 3839 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2536)
