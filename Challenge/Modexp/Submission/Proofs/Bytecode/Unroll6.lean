...
def gasSteps_bitCopy6_sym (s : State) (rest : List UInt256)
  ...
  have step2467 := soundW hs (opAt 2619 (.Dup ⟨7, by decide⟩))
    (blockOfW _ (pcFactW s 2619 3579 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2520)
      (stepW_dup s 3579 7 (by decide) ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (m) (by rfl) (by simp; omega) (by norm_num)))
  have step2468 := soundW hs (pushAt 2620 1 1)
    (blockOfW _ (pcFactW s 2620 3580 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2521)
  ...
  have step2469 := soundW hs (opAt 2621 (.Dup ⟨4, by decide⟩))
    (blockOfW _ (pcFactW s 2621 3582 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2522)
  ...
  have step2470 := soundW hs (pushAt 2622 1 1)
    (blockOfW _ (pcFactW s 2622 3583 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2523)
  ...
  have step2471 := soundW hs (opAt 2623 .SHR)
    (blockOfW _ (pcFactW s 2623 3585 ([(1 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2524)
      (stepW_shr s 3585 ((1 : UInt256)) (byte) ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by simp; omega) (by norm_num)))
  have step2472 := soundW hs (opAt 2624 .AND)
    (blockOfW _ (pcFactW s 2624 3586 ([(UInt256.shiftRight byte (1 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2525)
  ...
  have step2473 := soundW hs (opAt 2625 (.Dup ⟨2, by decide⟩))
    (blockOfW _ (pcFactW s 2625 3587 ([(UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2526)
  ...
  have step2474 := soundW hs (opAt 2626 .MUL)
    (blockOfW _ (pcFactW s 2626 3588 ([Bm1, (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2527)
  ...
  have step2475 := soundW hs (pushAt 2627 1 1)
    (blockOfW _ (pcFactW s 2627 3589 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2528)
  ...
  have step2476 := soundW hs (opAt 2628 .ADD)
    (blockOfW _ (pcFactW s 2628 3591 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2529)
  ...
  have step2477 := soundW hs (opAt 2629 (.Dup ⟨1, by decide⟩))
    (blockOfW _ (pcFactW s 2629 3592 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2530)
  ...
  have step2478 := soundW hs (opAt 2630 (.Dup ⟨8, by decide⟩))
    (blockOfW _ (pcFactW s 2630 3593 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2531)
  ...
  have step2479 := soundW hs (opAt 2631 (.Dup ⟨0, by decide⟩))
    (blockOfW _ (pcFactW s 2631 3594 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2532)
  ...
  have step2480 := soundW hs (opAt 2632 .MULMOD)
    (blockOfW _ (pcFactW s 2632 3595 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2533)
  ...
  have step2481 := soundW hs (opAt 2633 .MULMOD)
    (blockOfW _ (pcFactW s 2633 3596 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2534)
  ...
  have step2482 := soundW hs (opAt 2634 (.Swap ⟨5, by decide⟩))
    (blockOfW _ (pcFactW s 2634 3597 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2535)
  ...
  have step2483 := soundW hs (opAt 2635 .POP)
    (blockOfW _ (pcFactW s 2635 3598 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2536)
...
theorem gasSteps_bitCopy6_sym_cost (s : State) (rest : List UInt256)
  ...
  have c2467 := blockCostW [opAt 2619 (.Dup ⟨7, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2619 3579 ([Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2520)
  ...
  have c2468 := blockCostW [pushAt 2620 1 1] 3
    (blockOfW _ (pcFactW s 2620 3580 ([m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2521)
  ...
  have c2469 := blockCostW [opAt 2621 (.Dup ⟨4, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2621 3582 ([(1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2522)
  ...
  have c2470 := blockCostW [pushAt 2622 1 1] 3
    (blockOfW _ (pcFactW s 2622 3583 ([byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2523)
  ...
  have c2471 := blockCostW [opAt 2623 .SHR] 3
    (blockOfW _ (pcFactW s 2623 3585 ([(1 : UInt256), byte, (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2524)
  ...
  have c2472 := blockCostW [opAt 2624 .AND] 3
    (blockOfW _ (pcFactW s 2624 3586 ([(UInt256.shiftRight byte (1 : UInt256)), (1 : UInt256), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2525)
  ...
  have c2473 := blockCostW [opAt 2625 (.Dup ⟨2, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2625 3587 ([(UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2526)
  ...
  have c2474 := blockCostW [opAt 2626 .MUL] 5
    (blockOfW _ (pcFactW s 2626 3588 ([Bm1, (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2527)
  ...
  have c2475 := blockCostW [pushAt 2627 1 1] 3
    (blockOfW _ (pcFactW s 2627 3589 ([(Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2528)
  ...
  have c2476 := blockCostW [opAt 2628 .ADD] 3
    (blockOfW _ (pcFactW s 2628 3591 ([(1 : UInt256), (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2529)
  ...
  have c2477 := blockCostW [opAt 2629 (.Dup ⟨1, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2629 3592 ([((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2530)
  ...
  have c2478 := blockCostW [opAt 2630 (.Dup ⟨8, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2630 3593 ([m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2531)
  ...
  have c2479 := blockCostW [opAt 2631 (.Dup ⟨0, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2631 3594 ([acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2532)
  ...
  have c2480 := blockCostW [opAt 2632 .MULMOD] 8
    (blockOfW _ (pcFactW s 2632 3595 ([acc, acc, m, ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2533)
  ...
  have c2481 := blockCostW [opAt 2633 .MULMOD] 8
    (blockOfW _ (pcFactW s 2633 3596 ([(UInt256.mulMod acc acc m), ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))), m, Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2534)
  ...
  have c2482 := blockCostW [opAt 2634 (.Swap ⟨5, by decide⟩)] 3
    (blockOfW _ (pcFactW s 2634 3597 ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) (by norm_num) pc2535)
      (stepW_swap s 3597 5 (by decide) ([(UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), Bm1, zero, byte, offset, outerW, acc, base, m] ++ rest) ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by rfl) (by simp; omega) (by norm_num))) hs.fork (by decide) (by rfl) (by rfl)
  have c2483 := blockCostW [opAt 2635 .POP] 2
    (blockOfW _ (pcFactW s 2635 3598 ([acc, Bm1, zero, byte, offset, outerW, (UInt256.mulMod (UInt256.mulMod acc acc m) ((1 : UInt256) + (Bm1 * (UInt256.land (UInt256.shiftRight byte (1 : UInt256)) (1 : UInt256)))) m), base, m] ++ rest) (by norm_num) pc2536)
