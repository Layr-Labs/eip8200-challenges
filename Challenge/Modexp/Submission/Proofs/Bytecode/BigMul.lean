...
def mulToClearPath :
  ...
  [opAt 265 .JUMPDEST, pushAt 266 2 320, opAt 267 (.Dup ⟨5, by decide⟩),
   opAt 268 (.Dup ⟨4, by decide⟩), pushAt 269 2 19, opAt 270 .JUMP]

def mulToCopyPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 271 .JUMPDEST, pushAt 272 2 333, opAt 273 (.Dup ⟨5, by decide⟩),
   opAt 274 (.Dup ⟨2, by decide⟩), pushAt 275 2 4096, pushAt 276 2 58,
   opAt 277 .JUMP]
...
def mulInnerGuardPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 294 .JUMPDEST, pushAt 295 2 256, opAt 296 (.Dup ⟨1, by decide⟩),
   opAt 297 .LT, opAt 298 .ISZERO, pushAt 299 2 413, opAt 300 .JUMPI]
...
def mulInnerToAddPath :
  ...
  [pushAt 301 1 1, opAt 302 (.Dup ⟨2, by decide⟩),
   ...
   pushAt 310 2 4096, opAt 311 (.Dup ⟨11, by decide⟩), pushAt 312 2 104,
   opAt 313 .JUMP]

def mulAddToDoublePath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 314 .JUMPDEST, pushAt 315 2 401, opAt 316 (.Dup ⟨9, by decide⟩),
   opAt 317 (.Dup ⟨9, by decide⟩), pushAt 318 1 1, pushAt 319 2 4096,
   pushAt 320 2 4096, pushAt 321 2 104, opAt 322 .JUMP]

def mulDoubleToNextPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 323 .JUMPDEST, opAt 324 .POP, pushAt 325 1 1, opAt 326 .ADD,
   pushAt 327 2 352, opAt 328 .JUMP]

def mulInnerToOuterPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 332 .JUMPDEST, opAt 333 .POP, opAt 334 .POP, pushAt 335 1 1,
   opAt 336 .ADD, pushAt 337 2 335, opAt 338 .JUMP]
