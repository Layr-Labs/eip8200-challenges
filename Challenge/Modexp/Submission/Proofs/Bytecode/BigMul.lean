...
def mulToClearPath :
  ...
  [opAt 286 .JUMPDEST, pushAt 287 2 336,
   opAt 288 (.Dup ⟨5, by decide⟩), opAt 289 (.Dup ⟨4, by decide⟩),
   pushAt 290 1 58, opAt 291 .JUMP]

def mulToCopyPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 292 .JUMPDEST, pushAt 293 2 348,
   opAt 294 (.Dup ⟨5, by decide⟩), opAt 295 (.Dup ⟨2, by decide⟩),
   pushAt 296 2 4096, pushAt 297 1 90, opAt 298 .JUMP]

def mulSetupPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 299 .JUMPDEST, pushAt 300 0 0]

def mulOuterGuardPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 301 .JUMPDEST, opAt 302 (.Dup ⟨5, by decide⟩),
   opAt 303 (.Dup ⟨1, by decide⟩), opAt 304 .LT, opAt 305 .ISZERO,
   pushAt 306 2 437, opAt 307 .JUMPI]

def mulOuterLoadPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 308 (.Dup ⟨0, by decide⟩), pushAt 309 1 5, opAt 310 .SHL,
   opAt 311 (.Dup ⟨3, by decide⟩), opAt 312 .ADD, opAt 313 .MLOAD,
   pushAt 314 0 0]

def mulInnerGuardPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 315 .JUMPDEST, pushAt 316 2 256,
   opAt 317 (.Dup ⟨1, by decide⟩), opAt 318 .LT, opAt 319 .ISZERO,
   pushAt 320 2 424, opAt 321 .JUMPI]

def mulInnerToAddPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [pushAt 322 1 1, opAt 323 (.Dup ⟨2, by decide⟩),
   opAt 324 (.Dup ⟨2, by decide⟩), opAt 325 .SHR, opAt 326 .AND,
   pushAt 327 2 397, opAt 328 (.Dup ⟨9, by decide⟩),
   opAt 329 (.Dup ⟨9, by decide⟩), opAt 330 (.Dup ⟨3, by decide⟩),
   pushAt 331 2 4096, opAt 332 (.Dup ⟨11, by decide⟩),
   pushAt 333 1 129, opAt 334 .JUMP]

def mulAddToDoublePath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 335 .JUMPDEST, pushAt 336 2 412,
   opAt 337 (.Dup ⟨9, by decide⟩), opAt 338 (.Dup ⟨9, by decide⟩),
   pushAt 339 1 1, pushAt 340 2 4096, opAt 341 (.Dup ⟨0, by decide⟩),
   pushAt 342 1 129, opAt 343 .JUMP]

def mulDoubleToNextPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 344 .JUMPDEST, opAt 345 .POP, pushAt 346 1 1,
   opAt 347 (.Dup ⟨1, by decide⟩), opAt 348 .ADD,
   opAt 349 (.Swap ⟨0, by decide⟩), opAt 350 .POP,
   pushAt 351 2 367, opAt 352 .JUMP]

def mulInnerToOuterPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 353 .JUMPDEST, opAt 354 .POP, opAt 355 .POP,
   pushAt 356 1 1, opAt 357 (.Dup ⟨1, by decide⟩), opAt 358 .ADD,
   opAt 359 (.Swap ⟨0, by decide⟩), opAt 360 .POP,
   pushAt 361 2 350, opAt 362 .JUMP]

def mulOuterExitPath :
    List (Challenge.EvmProof.Stepper.Located
      Artifact.submissionArtifact .Osaka) :=
  [opAt 363 .JUMPDEST, opAt 364 .POP, opAt 365 .POP, opAt 366 .POP,
   opAt 367 .POP, opAt 368 .POP, opAt 369 .POP, opAt 370 .JUMP]

def mulEntry (s : State) (a b out modulus : UInt256) (count : Nat)
    (returnDest : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 327
           stack := [a, b, out, modulus, UInt256.ofNat count,
             returnDest] ++ rest }

def mulAfterClear (s : State) (a b out modulus : UInt256) (count : Nat)
    (returnDest : UInt256) (rest : List UInt256) : State :=
  { s with pc := UInt256.ofNat 336
           stack := [a, b, out, modulus, UInt256.ofNat count,
             returnDest] ++ rest
...
def mulWordAfterAdd (current : State) (word a b out modulus : UInt256)
  ...
  BigHelpers.addReturned inner out (UInt256.ofNat 4096) (mulWordBit word j)
    modulus count (UInt256.ofNat 397)
...
def mulWordAfterDouble (current : State) (word a b out modulus : UInt256)
  ...
  BigHelpers.addReturned afterAdd (UInt256.ofNat 4096) (UInt256.ofNat 4096)
    (UInt256.ofNat 1) modulus count (UInt256.ofNat 412)
    (mulWordRest word a b out modulus count i j returnDest rest)
...
@[simp] private theorem mulPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      ([327,328,331,332,333,335,336,337,340,341,342,345,347,348,349] : List Nat)[i - 286]! := by
...
@[simp] private theorem mulLoopPCs (i : Nat)
    (hi : 301 ≤ i) (hii : i ≤ 321) :
    Artifact.submissionArtifact.instructionPC i =
      ([350,351,352,353,354,355,358,359,360,362,363,364,365,366,367,368,371,372,373,374,377] : List Nat)[i - 301]! := by
  interval_cases i <;> decide

@[simp] private theorem mulInnerPCs (i : Nat)
    (hi : 322 ≤ i) (hii : i ≤ 343) :
    Artifact.submissionArtifact.instructionPC i =
      ([378,380,381,382,383,384,387,388,389,390,393,394,396,397,398,401,402,403,405,408,409,411] : List Nat)[i - 322]! := by
  interval_cases i <;> decide

@[simp] private theorem mulNextPCs (i : Nat)
    (hi : 344 ≤ i) (hii : i ≤ 352) :
    Artifact.submissionArtifact.instructionPC i =
      ([412,413,414,416,417,418,419,420,423] : List Nat)[i - 344]! := by
  interval_cases i <;> decide

@[simp] private theorem mulInnerExitPCs (i : Nat)
    (hi : 353 ≤ i) (hii : i ≤ 362) :
    Artifact.submissionArtifact.instructionPC i =
      ([424,425,426,427,429,430,431,432,433,436] : List Nat)[i - 353]! := by
  interval_cases i <;> decide

@[simp] private theorem mulReturnPCs (i : Nat)
    (hi : 363 ≤ i) (hii : i ≤ 370) :
    Artifact.submissionArtifact.instructionPC i =
      ([437,438,439,440,441,442,443,444] : List Nat)[i - 363]! := by
  interval_cases i <;> decide

private theorem jump335 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 350 = true :=
  Artifact.isValidJumpDest_index 301 (by rfl)

private theorem jump352 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 367 = true :=
  Artifact.isValidJumpDest_index 315 (by rfl)

private theorem jump383 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 397 = true :=
  Artifact.isValidJumpDest_index 335 (by rfl)

private theorem jump401 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 412 = true :=
  Artifact.isValidJumpDest_index 344 (by rfl)

private theorem jump104 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 129 = true :=
  Artifact.isValidJumpDest_index 107 (by rfl)
...
private theorem jump58 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 90 = true :=
  Artifact.isValidJumpDest_index 73 (by rfl)

private theorem jump320 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 336 = true :=
  Artifact.isValidJumpDest_index 292 (by rfl)

private theorem jump333 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 348 = true :=
  Artifact.isValidJumpDest_index 299 (by rfl)

private theorem jump413 :
    Decode.isValidJumpDest Challenge.Modexp.submissionBytecode 424 = true :=
...
theorem run_mulToClear (s : State) (a b out modulus : UInt256) (count : Nat)
    ...
    some (BigHelpers.clearEntry s out count (UInt256.ofNat 336)
      ([a, b, out, modulus, UInt256.ofNat count, returnDest] ++ rest)) := by
  have hc : ∀ n ≤ 12, rest.length + n < 1024 := by omega
  have h19 : (14 : UInt256) = UInt256.ofNat 14 := by decide
  have h320 : (336 : UInt256) = UInt256.ofNat 336 := by decide
  have hvalid : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (14 : UInt256).toNat = true := by
    rw [show (14 : UInt256).toNat = 14 by decide]
    exact jump19
...
theorem run_mulToCopy (s : State) (a b out modulus : UInt256) (count : Nat)
    ...
    some (BigHelpers.copyEntry (mulAfterClear s a b out modulus count
      returnDest rest) (UInt256.ofNat 4096) a count (UInt256.ofNat 348)
      ([a, b, out, modulus, UInt256.ofNat count, returnDest] ++ rest)) := by
  have hc : ∀ n ≤ 12, rest.length + n < 1024 := by omega
  have h58 : (46 : UInt256) = UInt256.ofNat 46 := by decide
  have h333 : (348 : UInt256) = UInt256.ofNat 348 := by decide
...
theorem run_mulOuterFinishGuard (current : State) (a b out modulus : UInt256)
    ...
    some { mulOuterState current a b out modulus count count returnDest rest with
      pc := UInt256.ofNat 437 } := by
  have hc : ∀ n ≤ 10, rest.length + n < 1024 := by omega
  have h426 : (437 : UInt256) = UInt256.ofNat 437 := by decide
  have hzeroFalse : ¬(UInt256.ofNat 0).isZero.toNat = 0 := by decide
  have hvalid : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (437 : UInt256).toNat = true := by
    rw [show (437 : UInt256).toNat = 437 by decide]
    exact jump426
  simp (disch := omega) [mulOuterGuardPath, opAt, pushAt, wfOp,
    Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
...
theorem run_mulInnerFinishGuard (current : State) (a b out modulus : UInt256)
    ...
    some { mulInnerLoop current a b out modulus count i 256 returnDest rest with
      pc := UInt256.ofNat 424 } := by
  have hc : ∀ n ≤ 11, rest.length + n < 1024 := by omega
  have h256Nat : (256 : UInt256).toNat = 256 := by decide
  have h413 : (424 : UInt256) = UInt256.ofNat 424 := by decide
  have hzeroFalse : ¬(UInt256.ofNat 0).isZero.toNat = 0 := by decide
  have hvalid : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (424 : UInt256).toNat = true := by
    rw [show (424 : UInt256).toNat = 424 by decide]
    exact jump413
  simp (disch := omega) [mulInnerGuardPath, opAt, pushAt, wfOp,
    Challenge.EvmProof.Stepper.runLocatedBlock,
    Challenge.EvmProof.Stepper.runLocated, Challenge.EvmProof.Stepper.runInstr,
...
theorem run_mulWordInnerFinishGuard (current : State)
    ...
    some { mulInnerState current word a b out modulus count i 256
      returnDest rest with pc := UInt256.ofNat 424 } := by
  have hc : ∀ n ≤ 11, rest.length + n < 1024 := by omega
  have h256Nat : (256 : UInt256).toNat = 256 := by decide
  have h413 : (424 : UInt256) = UInt256.ofNat 424 := by decide
  have hzeroFalse : ¬(UInt256.ofNat 0).isZero.toNat = 0 := by decide
...
theorem run_mulInnerToOuter (current : State) (a b out modulus : UInt256)
    ...
    Challenge.EvmProof.Stepper.runLocatedBlock mulInnerToOuterPath
      { inner with pc := UInt256.ofNat 424 } =
    some (mulOuterNext inner a b out modulus count i returnDest rest) := by
  dsimp only
  have hc : ∀ n ≤ 11, rest.length + n < 1024 := by omega
  have h335 : (350 : UInt256) = UInt256.ofNat 350 := by decide
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
  have hvalid : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (350 : UInt256).toNat = true := by
    rw [show (350 : UInt256).toNat = 350 by decide]
    exact jump335
...
theorem run_mulInnerToAdd (current : State) (a b out modulus : UInt256)
  ...
  have h383 : (397 : UInt256) = UInt256.ofNat 397 := by decide
  have h4096 : (4096 : UInt256) = UInt256.ofNat 4096 := by decide
  have hvalid : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
...
theorem run_mulAddToDouble (current : State) (a b out modulus : UInt256)
    ...
    let afterAdd := BigHelpers.addReturned inner out (UInt256.ofNat 4096) bit
      modulus count (UInt256.ofNat 397) saved
    Challenge.EvmProof.Stepper.runLocatedBlock mulAddToDoublePath afterAdd =
      some (BigHelpers.addEntry afterAdd (UInt256.ofNat 4096)
        ...
        (UInt256.ofNat 412) saved) := by
  dsimp only
  have hc : ∀ n ≤ 17, rest.length + n < 1024 := by omega
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
  have h104 : (85 : UInt256) = UInt256.ofNat 85 := by decide
  have h401 : (412 : UInt256) = UInt256.ofNat 412 := by decide
  have h4096 : (4096 : UInt256) = UInt256.ofNat 4096 := by decide
  have hvalid : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (85 : UInt256).toNat = true := by
    rw [show (85 : UInt256).toNat = 85 by decide]
...
theorem run_mulDoubleToNext (current : State) (a b out modulus : UInt256)
  ...
  have hc : ∀ n ≤ 17, rest.length + n < 1024 := by omega
  have hone : (1 : UInt256) = UInt256.ofNat 1 := by decide
  have h352 : (367 : UInt256) = UInt256.ofNat 367 := by decide
  have hvalid : Decode.isValidJumpDest Challenge.Modexp.submissionBytecode
      (367 : UInt256).toNat = true := by
    rw [show (367 : UInt256).toNat = 367 by decide]
    exact jump352
...
def gasSteps_mulBitIteration (current : State) (a b out modulus : UInt256)
  ...
  have hadd := BigHelpers.gasSteps_addMaskedMod inner out (UInt256.ofNat 4096)
    bit modulus count (UInt256.ofNat 397) saved
  ...
  have hadd' : Challenge.EvmProof.GasSteps
      (BigHelpers.addEntry inner out (UInt256.ofNat 4096) bit modulus count
        (UInt256.ofNat 397) saved) afterAdd := by
  ...
  have hdouble' : Challenge.EvmProof.GasSteps
      (BigHelpers.addEntry afterAdd (UInt256.ofNat 4096)
        (UInt256.ofNat 4096) (UInt256.ofNat 1) modulus count
        (UInt256.ofNat 412) saved) afterDouble := by
...
def gasSteps_mulInnerFinishSegment (current : State)
    ...
    let inner := mulInnerState current word a b out modulus count i 256
      returnDest rest
    Challenge.EvmProof.GasSteps inner { inner with pc := UInt256.ofNat 424 } := by
  dsimp only
  exact Challenge.EvmProof.Stepper.runLocatedBlock_sound
    Artifact.submissionArtifact .Osaka mulInnerGuardPath
...
def gasSteps_mulInnerExitSegment (current : State)
    ...
    let inner := mulInnerState current word a b out modulus count i 256
      returnDest rest
    Challenge.EvmProof.GasSteps { inner with pc := UInt256.ofNat 424 }
...
theorem mulAfterBitDouble_represents (current : State) (a b : UInt256)
  ...
  have hafterAcc : Limbs.Represents afterAdd.memory 3072 count
    ...
    simpa [afterAdd, mulAfterBitAdd, inner, bitWord, saved, hbitWord] using
      ...
      acc addend modulusValue (UInt256.ofNat 397) saved hbitLe hfit3072
  ...
  have hafterAddend : Limbs.Represents afterAdd.memory 4096 count addend := by
    simpa [afterAdd, mulAfterBitAdd, inner, bitWord, saved, hbitWord] using
      ...
      count addend (UInt256.ofNat 397) saved hfit3072 hfit5120
  ...
  have hafterModulus :
    ...
    simpa [afterAdd, mulAfterBitAdd, inner, bitWord, saved, hbitWord] using
      ...
      count modulusValue (UInt256.ofNat 397) saved hfit3072 hfit5120
  ...
  have hdoubleAddend : Limbs.Represents doubled.memory 4096 count
    ...
    simpa [doubled, mulAfterBitDouble, afterAdd] using
      ...
      addend addend modulusValue (UInt256.ofNat 412) saved (by omega)
  ...
  have hdoubleAcc : Limbs.Represents doubled.memory 3072 count
    ...
    exact BigHelpers.addReturned_preserves_region afterAdd 4096 4096 1 0 3072
      count ((acc + bit * addend) % modulusValue) (UInt256.ofNat 412) saved
  ...
  have hdoubleModulus :
    ...
    exact BigHelpers.addReturned_preserves_region afterAdd 4096 4096 1 0 0
      count modulusValue (UInt256.ofNat 412) saved hfit4096 hfit5120
...
theorem mulWordAfterDouble_preserves_region (current : State)
  ...
  have hafterRep : Limbs.Represents afterAdd.memory ptr count value := by
    simpa [afterAdd, mulWordAfterAdd, inner, bitWord, saved, hbitWord] using
      BigHelpers.addReturned_preserves_region inner 3072 4096 bit 0 ptr
        count value (UInt256.ofNat 397) saved hfit3072 hfit5120 hptrOut
  ...
  simpa [mulWordAfterDouble, afterAdd, saved] using
    BigHelpers.addReturned_preserves_region afterAdd 4096 4096 1 0 ptr
      count value (UInt256.ofNat 412) saved hfit4096 hfit5120 hptrAddend
...
theorem gasSteps_mulBitIteration_cost_potential (current : State)
  ...
  have hadd := BigHelpers.gasSteps_addMaskedMod_cost_potential inner out
    (UInt256.ofNat 4096) bit modulus count (UInt256.ofNat 397) saved
    hsavedCap hcount
  ...
  have hdouble := BigHelpers.gasSteps_addMaskedMod_cost_potential afterAdd
    (UInt256.ofNat 4096) (UInt256.ofNat 4096) (UInt256.ofNat 1) modulus
    count (UInt256.ofNat 412) saved hsavedCap hcount
    (by simpa [afterAdd, mulAfterBitAdd, inner, mulInnerLoop,
      BigHelpers.addReturned] using hcode)
    (by simpa [afterAdd, mulAfterBitAdd, inner, mulInnerLoop,
      BigHelpers.addReturned, State.fork] using hfork)
...
def gasSteps_mulInitialize (s : State) (a b out modulus : UInt256)
  ...
  have hclear := BigHelpers.gasSteps_clear s out count (UInt256.ofNat 336)
    saved (by simp [saved]; omega) hcount hcode hfork hrun hnp (by
      rw [Challenge.EvmProof.Word.word_toNat_ofNat,
        Nat.mod_eq_of_lt (by norm_num : 290 < 2 ^ 256)]
      exact jump320)
  have hclear' : Challenge.EvmProof.GasSteps
      (BigHelpers.clearEntry s out count (UInt256.ofNat 336) saved)
  ...
  have hcopy := BigHelpers.gasSteps_copy
    (mulAfterClear s a b out modulus count returnDest rest)
    (UInt256.ofNat 4096) a count (UInt256.ofNat 348) saved
    ...
    (by simpa [mulAfterClear, State.fork] using hnp) (by
      rw [Challenge.EvmProof.Word.word_toNat_ofNat,
        Nat.mod_eq_of_lt (by norm_num : 302 < 2 ^ 256)]
      exact jump333)
  have hcopy' : Challenge.EvmProof.GasSteps
      (BigHelpers.copyEntry (mulAfterClear s a b out modulus count
        returnDest rest) (UInt256.ofNat 4096) a count (UInt256.ofNat 348) saved)
...
theorem gasSteps_mulInitialize_cost_potential (s : State)
  ...
  have hclear := BigHelpers.gasSteps_clear_cost_potential s out count
    (UInt256.ofNat 336) saved (by simp [saved]; omega) hcount hcode hfork
    hrun hnp (by
      rw [Challenge.EvmProof.Word.word_toNat_ofNat,
        Nat.mod_eq_of_lt (by norm_num : 290 < 2 ^ 256)]
      exact jump320)
