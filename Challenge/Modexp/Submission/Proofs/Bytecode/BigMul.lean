...
@[simp] private theorem mulLoopPCs (i : Nat)
    (hi : 280 ≤ i) (hii : i ≤ 300) :
    Artifact.submissionArtifact.instructionPC i =
      [335,336,337,338,339,340,343,344,345,347,348,349,350,351,352,353,356,357,358,359,362][i - 280]! := by
  interval_cases i <;> decide

@[simp] private theorem mulInnerPCs (i : Nat)
    (hi : 301 ≤ i) (hii : i ≤ 322) :
    Artifact.submissionArtifact.instructionPC i =
      [363,365,366,367,368,369,372,373,374,375,378,379,382,383,384,387,388,389,391,394,397,400][i - 301]! := by
  interval_cases i <;> decide
