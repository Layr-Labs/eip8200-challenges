...
namespace Challenge.Modexp.Submission.Proofs.Bytecode.MonproKNEntryZero
...
theorem run_zero (s : State) (mem : ByteArray) (pa pb n : Nat)
    ...
    runInstructions zeroProgram (cached s mem pa pb dst ret rest) =
      some (cleared s mem pa pb n dst ret rest) := by
  ...
  have hactC : UInt256.ofNat (MachineState.activeWordsAfter s.activeWords.toNat 8224 (32+32*n)) =
      s.activeWords := activeWords_fix s 8224 (32+32*n) (by omega) (by omega) hact
  simp [zeroProgram, entryProgram, runInstructions, Challenge.EvmProof.Stepper.runInstr,
    cached, cleared, mpZeroed, hc6, hc7, hc8, hc9, hc10, h32, h8224, h9344, hs32,
    hsizeN, hcdsN, hactS, hactC, State.activeWordsAfterUInt256,
    Challenge.EvmProof.Word.succ_ofNat_mod, Challenge.EvmProof.Word.ofNat_add_mod,
    Challenge.EvmProof.Word.word_toNat_ofNat]

end Challenge.Modexp.Submission.Proofs.Bytecode.MonproKNEntryZero
