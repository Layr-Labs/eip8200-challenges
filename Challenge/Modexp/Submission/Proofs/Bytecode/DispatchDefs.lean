...
def wordEntryPath :
  ...
  [opAt 921 .JUMPDEST, opAt 922 (.Dup ⟨0, by decide⟩),
   ...
   opAt 946 (.Dup ⟨10, by decide⟩), pushAt 947 2 3013, opAt 948 .JUMP]
...
@[simp] theorem jump3000 :
    Decode.isValidJumpDest submissionBytecode 3013 = true :=
...
def wordRouteEntryState (input : ByteArray) : State :=
  { wordEntryState input with pc := UInt256.ofNat 3013 }
