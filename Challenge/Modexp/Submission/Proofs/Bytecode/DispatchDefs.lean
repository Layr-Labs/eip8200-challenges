...
def wordEntryPath :
  ...
  [opAt 879 .JUMPDEST, opAt 880 (.Dup ⟨0, by decide⟩),
   ...
   opAt 904 (.Dup ⟨10, by decide⟩), pushAt 905 2 3049, opAt 906 .JUMP]
...
@[simp] theorem jump3000 :
    Decode.isValidJumpDest submissionBytecode 3049 = true := by
  have hpc : Artifact.instructionPC 2345 = 3049 := by decide
  simpa only [hpc] using Artifact.isValidJumpDest_index 2345 (by rfl)
...
def wordRouteEntryState (input : ByteArray) : State :=
  { wordEntryState input with pc := UInt256.ofNat 3049 }
