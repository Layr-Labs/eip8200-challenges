...
@[simp] theorem jumpMemo :
  ...
  Artifact.isValidJumpDest_index 4206 (by rfl)
...
@[simp] theorem jump3000 :
  ...
  have hpc : Artifact.instructionPC 569 = 804 := by decide
  simpa only [hpc] using Artifact.isValidJumpDest_index 569 (by rfl)
