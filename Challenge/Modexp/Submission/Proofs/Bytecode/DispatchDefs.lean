...
def zeroSizePath :
  ...
  [opAt 921 .JUMPDEST, opAt 922 (.Dup ⟨0, by decide⟩),
   pushAt 923 2 1230, opAt 924 .JUMPI,
...
def wordEntryPath :
  ...
  [opAt 921 .JUMPDEST, opAt 922 (.Dup ⟨0, by decide⟩),
   ...
   opAt 937 .GT, pushAt 938 2 1261, opAt 939 .JUMPI,
   pushAt 940 2 1260, opAt 941 (.Dup ⟨1, by decide⟩),
   opAt 942 (.Dup ⟨3, by decide⟩), pushAt 943 1 96,
   opAt 944 (.Dup ⟨6, by decide⟩), opAt 945 (.Dup ⟨8, by decide⟩),
   opAt 946 (.Dup ⟨10, by decide⟩), pushAt 947 2 2632, opAt 948 .JUMP]
...
@[simp] theorem dispatchPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      ([1221,1222,1223,1226,1227,1228,1229,1230,1231,1232,1234,1235,1236,1237,1238,1240,1241,1242,1245,1246,1249,1250,1251,1253,1254,1255,1256,1259] : List Nat)[i - 921]! := by
...
@[simp] theorem jump1237 :
    Decode.isValidJumpDest submissionBytecode 1230 = true :=
...
@[simp] theorem jump3000 :
    Decode.isValidJumpDest submissionBytecode 2632 = true :=
  Artifact.isValidJumpDest_index 1832 (by rfl)
...
def wordRouteEntryState (input : ByteArray) : State :=
  { wordEntryState input with pc := UInt256.ofNat 2632 }
