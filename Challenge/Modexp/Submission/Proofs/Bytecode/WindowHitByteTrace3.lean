...
theorem run_byte0_lowPrep (template : State) (base modulus : UInt256)
    ...
    some (nibbleState { template with halt := .Running } (UInt256.ofNat 3284)
...
theorem run_byte0_lowSquare (template : State) (base modulus : UInt256)
    ...
    some (nibbleState { template with halt := .Running } (UInt256.ofNat 3308)
...
theorem run_byte0_lowLookup (template : State) (base modulus : UInt256)
    ...
    runLocatedBlock (lowLookupPath 0)
      (nibbleState { template with halt := .Running } (UInt256.ofNat 3308)
        base modulus nibble byte word pointer accumulator rest) =
    some (nibbleState { template with halt := .Running } (UInt256.ofNat 3319)
      base modulus nibble byte word pointer
