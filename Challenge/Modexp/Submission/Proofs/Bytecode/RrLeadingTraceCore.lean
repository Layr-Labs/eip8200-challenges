...
def jumpProgram : List Instr :=
  [.push ⟨2, by decide⟩ (UInt256.ofNat 791), .op .JUMP]
...
theorem run_copy (template : State) (mem : ByteArray)
  ...
  have hpc :
      (((UInt256.ofNat 2266).succ + UInt256.ofNat 3).succ +
        UInt256.ofNat 3 + UInt256.ofNat 3).succ = UInt256.ofNat 2278 := by
    decide
