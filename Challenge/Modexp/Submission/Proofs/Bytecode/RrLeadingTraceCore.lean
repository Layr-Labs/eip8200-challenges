...
/-- pc 3152..3163: load the established size word and copy CC to RR. -/
...
/-- pc 3142..3181: rejoin the inherited RR head at pc 1548. -/
def jumpProgram : List Instr :=
  [.push ⟨2, by decide⟩ (UInt256.ofNat 1370), .op .JUMP]
