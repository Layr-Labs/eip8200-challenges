...
/-- pc 3079..3090: load the established size word and copy CC to RR. -/
...
/-- pc 3091..3109: four threshold comparisons and their sum. -/
...
/-- pc 3110..3113: rejoin the inherited RR head at pc 1569. -/
def jumpProgram : List Instr :=
  [.push ⟨2, by decide⟩ (UInt256.ofNat 1562), .op .JUMP]
...
theorem run_copy (template : State) (mem : ByteArray)
  ...
  have hpc :
      (((UInt256.ofNat 3054).succ + UInt256.ofNat 3).succ + UInt256.ofNat 3 + UInt256.ofNat 3).succ = UInt256.ofNat 3066 := by
    decide
