...
/-- pc 3214..3232: four threshold comparisons and their sum. -/
...
/-- pc 3233..3267: rejoin the inherited RR head at pc 1625. -/
...
theorem run_copy (template : State) (mem : ByteArray)
  ...
  have hpc :
      (((UInt256.ofNat 2970).succ + UInt256.ofNat 3).succ +
        UInt256.ofNat 3 + UInt256.ofNat 3).succ = UInt256.ofNat 2982 := by
    decide
