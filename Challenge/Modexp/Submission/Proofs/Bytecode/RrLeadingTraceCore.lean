...
/-- pc 3600..3611: load the established size word and copy CC to RR. -/
...
/-- pc 3612..3630: four threshold comparisons and their sum. -/
...
theorem run_copy (template : State) (mem : ByteArray)
  ...
  have hpc :
      (((UInt256.ofNat 3600).succ + UInt256.ofNat 3).succ +
        UInt256.ofNat 3 + UInt256.ofNat 3).succ = UInt256.ofNat 3612 := by
    decide
