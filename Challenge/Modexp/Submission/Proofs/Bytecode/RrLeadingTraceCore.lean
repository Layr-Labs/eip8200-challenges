...
/-- pc 3564..3575: load the established size word and copy CC to RR. -/
...
/-- pc 3576..3594: four threshold comparisons and their sum. -/
...
/-- pc 3595..3598: rejoin the inherited RR head at pc 1569. -/
...
theorem run_copy (template : State) (mem : ByteArray)
  ...
  have hpc :
      (((UInt256.ofNat 3564).succ + UInt256.ofNat 3).succ +
        UInt256.ofNat 3 + UInt256.ofNat 3).succ = UInt256.ofNat 3576 := by
    decide
