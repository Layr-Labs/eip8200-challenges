...
def jumpProgram : List Instr :=
  [.push ⟨2, by decide⟩ (UInt256.ofNat 804), .op .JUMP]
...
theorem run_copy (template : State) (mem : ByteArray)
  ...
  have hpc :
      (((UInt256.ofNat 2009).succ + UInt256.ofNat 3).succ +
        UInt256.ofNat 3 + UInt256.ofNat 3).succ = UInt256.ofNat 2021 := by
    decide
