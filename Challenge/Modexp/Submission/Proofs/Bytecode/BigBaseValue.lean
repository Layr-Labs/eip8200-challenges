...
theorem baseBit_toNat_eq (byte : UInt256) (j : Nat) (hj : j < 8) :
  ...
  have hsame : baseBit byte j = Word.exponentBit byte j := by rfl
  rw [hsame, WordCorrect.exponentBit_eq byte j hj,
    Challenge.EvmProof.Word.word_toNat_ofNat]
  rcases WordCorrect.exponentBitNat_zero_or_one byte j with hbit | hbit
  · simp [hbit]
  · simp [hbit]
...
theorem loadedBaseByte_lt (s : State) (baseOff i : Nat) :
  ...
  unfold loadedBaseByte UInt256.byteAt
  rw [show (0 : UInt256).toNat = 0 by decide]
  rw [if_neg (by omega)]
  rw [Challenge.EvmProof.Word.word_toNat_ofNat]
  have hand :
      ((MachineState.readWord s.executionEnv.calldata (baseOff + i)).toNat >>>
...
theorem initialAccumulator_represents (s : State) (accumulator : UInt256)
  ...
  have h2048 : (2048 : UInt256) = UInt256.ofNat 2048 := by decide
  have h3072 : (3072 : UInt256) = UInt256.ofNat 3072 := by decide
  have hColdEntry : (2126 : UInt256) = UInt256.ofNat 2126 := by decide
  ...
  have hacc : Limbs.Represents
    ...
    simpa [BigBaseLoop.initialAccumulator, helperRest, exit, h0, h1, h2048,
      ...
      BigHelpers.addReturned_represents_mod exit 2048 3072 0 count 1 0 1
        modulusValue (UInt256.ofNat 2126) helperRest (by omega) (by omega)
  ...
  have hbase : Limbs.Represents
    ...
    simpa [BigBaseLoop.initialAccumulator, helperRest, exit, h0, h1, h2048,
      ...
      BigHelpers.addReturned_preserves_region exit 2048 3072 1 0 1024 count
        baseValue (UInt256.ofNat 2126) helperRest (by omega) (by omega)
