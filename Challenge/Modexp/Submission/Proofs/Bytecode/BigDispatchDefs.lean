...
def bigCheckComparePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 472 1 32, opAt 473 (.Dup ⟨3, by decide⟩), opAt 474 .GT]

def bigCheckJumpPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 475 2 695, opAt 476 .JUMPI]
...
def bigTailFramePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 486 .JUMPDEST, pushAt 487 2 1190,
   opAt 488 (.Dup ⟨1, by decide⟩), opAt 489 (.Dup ⟨3, by decide⟩)]

def bigTailArgsPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 490 1 96, opAt 491 (.Dup ⟨6, by decide⟩),
   opAt 492 (.Dup ⟨8, by decide⟩), opAt 493 (.Dup ⟨10, by decide⟩)]

def bigTailJumpPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 494 1 251, opAt 495 .JUMP]
...
def bigCheckedState (input : ByteArray) : State :=
  { Dispatch.wordCheckedState input with pc := UInt256.ofNat 695 }
...
@[simp] theorem bigTailPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      ([695, 696, 699, 700, 701, 703, 704, 705, 706, 708] : List Nat)[i - 486]! := by
  rw [Challenge.Modexp.Submission.Proofs.Bytecode.PCFast.instructionPC_eq_byteLength]
  interval_cases i <;> rfl

theorem jump704 : Decode.isValidJumpDest submissionBytecode 251 = true :=
  Artifact.isValidJumpDest_index 177 (by rfl)

theorem jump1268 : Decode.isValidJumpDest submissionBytecode 695 = true :=
