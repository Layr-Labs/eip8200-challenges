...
def bigCheckComparePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 932 1 32, opAt 933 (.Dup ⟨3, by decide⟩), opAt 934 .GT]

def bigCheckJumpPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 935 2 1264, opAt 936 .JUMPI]
...
def bigTailFramePath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 947 .JUMPDEST, pushAt 948 2 1279,
   opAt 949 (.Dup ⟨1, by decide⟩), opAt 950 (.Dup ⟨3, by decide⟩)]

def bigTailArgsPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 951 1 96, opAt 952 (.Dup ⟨6, by decide⟩),
   opAt 953 (.Dup ⟨8, by decide⟩), opAt 954 (.Dup ⟨10, by decide⟩)]

def bigTailJumpPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [pushAt 955 2 700, opAt 956 .JUMP]
...
@[simp] theorem bigTailPCs (i : Nat)
    ...
    Artifact.submissionArtifact.instructionPC i =
      [1264,1265,1268,1269,1270,1272,1273,1274,1275,1278][i - 947]! := by
...
theorem jump1268 : Decode.isValidJumpDest submissionBytecode 1264 = true :=
  Artifact.isValidJumpDest_index 947 (by rfl)
