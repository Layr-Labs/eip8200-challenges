...
@[simp] theorem guardPCs (i : Nat) (hi : 4241 ≤ i) (hii : i ≤ 4261) :
    Artifact.submissionArtifact.instructionPC i =
      ([5247,5248,5249,5251,5252,5258,5260,5261,5262,5263,5265,5266,5267,5268,
        5270,5271,5272,5275,5276,5277,5280] : List Nat)[i - 4241]! := by
  rw [Challenge.Modexp.Submission.Proofs.Bytecode.PCFast.instructionPC_eq_byteLength]
  interval_cases i <;> rfl

@[simp] theorem answerPCs (i : Nat) (hi : 4381 ≤ i) (hii : i ≤ 4388) :
    Artifact.submissionArtifact.instructionPC i =
      ([5424,5425,5428,5430,5431,5432,5433,5434] : List Nat)[i - 4381]! := by
  rw [Challenge.Modexp.Submission.Proofs.Bytecode.PCFast.instructionPC_eq_byteLength]
  interval_cases i <;> rfl
