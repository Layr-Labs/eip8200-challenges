  ...
  calc
    Artifact.submissionArtifact.instructionPC 463 =
        Artifact.submissionArtifact.instructionPC 462 +
          (YulEvmCompiler.Instr.push 2 2940).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 462 _ (by rfl)
    _ = 556 := by rw [pc485]; rfl
@[simp] theorem pc2414 : Artifact.submissionArtifact.instructionPC 2272 = 2940 := by rfl
@[simp] theorem pc2415 : Artifact.submissionArtifact.instructionPC 2273 = 2941 := by
  calc
    Artifact.submissionArtifact.instructionPC 2273 =
      ...
      instructionPC_succ Artifact.submissionArtifact 2272 _ (by rfl)
    _ = 2941 := by rw [pc2414]; rfl
@[simp] theorem pc2416 : Artifact.submissionArtifact.instructionPC 2274 = 2943 := by
  calc
    Artifact.submissionArtifact.instructionPC 2274 =
        Artifact.submissionArtifact.instructionPC 2273 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2273 _ (by rfl)
    _ = 2943 := by rw [pc2415]; rfl
@[simp] theorem pc2417 : Artifact.submissionArtifact.instructionPC 2275 = 2944 := by
  calc
    ...
    _ = 2944 := by rw [pc2416]; rfl
@[simp] theorem pc2418 : Artifact.submissionArtifact.instructionPC 2276 = 2945 := by
  calc
    ...
    _ = 2945 := by rw [pc2417]; rfl
@[simp] theorem pc2419 : Artifact.submissionArtifact.instructionPC 2277 = 2946 := by
  calc
    ...
    _ = 2946 := by rw [pc2418]; rfl
@[simp] theorem pc2420 : Artifact.submissionArtifact.instructionPC 2278 = 2948 := by
  calc
    Artifact.submissionArtifact.instructionPC 2278 =
        Artifact.submissionArtifact.instructionPC 2277 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2277 _ (by rfl)
    _ = 2948 := by rw [pc2419]; rfl
@[simp] theorem pc2421 : Artifact.submissionArtifact.instructionPC 2279 = 2949 := by
  calc
    ...
    _ = 2949 := by rw [pc2420]; rfl
@[simp] theorem pc2422 : Artifact.submissionArtifact.instructionPC 2280 = 2951 := by
  calc
    ...
    _ = 2951 := by rw [pc2421]; rfl
@[simp] theorem pc2423 : Artifact.submissionArtifact.instructionPC 2281 = 2952 := by
  calc
    ...
    _ = 2952 := by rw [pc2422]; rfl
@[simp] theorem pc2424 : Artifact.submissionArtifact.instructionPC 2282 = 2953 := by
  calc
    ...
    _ = 2953 := by rw [pc2423]; rfl
@[simp] theorem pc2425 : Artifact.submissionArtifact.instructionPC 2283 = 2954 := by
  calc
    ...
    _ = 2954 := by rw [pc2424]; rfl
@[simp] theorem pc2426 : Artifact.submissionArtifact.instructionPC 2284 = 2955 := by
  calc
    ...
    _ = 2955 := by rw [pc2425]; rfl
@[simp] theorem pc2427 : Artifact.submissionArtifact.instructionPC 2285 = 2957 := by
  calc
    Artifact.submissionArtifact.instructionPC 2285 =
        Artifact.submissionArtifact.instructionPC 2284 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2284 _ (by rfl)
    _ = 2957 := by rw [pc2426]; rfl
@[simp] theorem pc2428 : Artifact.submissionArtifact.instructionPC 2286 = 2958 := by
  calc
    ...
    _ = 2958 := by rw [pc2427]; rfl
@[simp] theorem pc2429 : Artifact.submissionArtifact.instructionPC 2287 = 2959 := by
  calc
    ...
    _ = 2959 := by rw [pc2428]; rfl
@[simp] theorem pc2430 : Artifact.submissionArtifact.instructionPC 2288 = 2960 := by
  calc
    ...
    _ = 2960 := by rw [pc2429]; rfl
@[simp] theorem pc2431 : Artifact.submissionArtifact.instructionPC 2289 = 2961 := by
  calc
    ...
    _ = 2961 := by rw [pc2430]; rfl
@[simp] theorem pc2432 : Artifact.submissionArtifact.instructionPC 2290 = 2962 := by
  calc
    ...
    _ = 2962 := by rw [pc2431]; rfl
@[simp] theorem pc2433 : Artifact.submissionArtifact.instructionPC 2291 = 2963 := by
  calc
    Artifact.submissionArtifact.instructionPC 2291 =
        Artifact.submissionArtifact.instructionPC 2290 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MULMOD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2290 _ (by rfl)
    _ = 2963 := by rw [pc2432]; rfl
@[simp] theorem pc2434 : Artifact.submissionArtifact.instructionPC 2292 = 2964 := by
  calc
    ...
    _ = 2964 := by rw [pc2433]; rfl
@[simp] theorem pc2435 : Artifact.submissionArtifact.instructionPC 2293 = 2965 := by
  calc
    ...
    _ = 2965 := by rw [pc2434]; rfl
@[simp] theorem pc2436 : Artifact.submissionArtifact.instructionPC 2294 = 2966 := by
  calc
    Artifact.submissionArtifact.instructionPC 2294 =
        Artifact.submissionArtifact.instructionPC 2293 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 7 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2293 _ (by rfl)
    _ = 2966 := by rw [pc2435]; rfl
@[simp] theorem pc2437 : Artifact.submissionArtifact.instructionPC 2295 = 2968 := by
  calc
    Artifact.submissionArtifact.instructionPC 2295 =
        Artifact.submissionArtifact.instructionPC 2294 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2294 _ (by rfl)
    _ = 2968 := by rw [pc2436]; rfl
@[simp] theorem pc2438 : Artifact.submissionArtifact.instructionPC 2296 = 2969 := by
  calc
    Artifact.submissionArtifact.instructionPC 2296 =
        Artifact.submissionArtifact.instructionPC 2295 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 4 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2295 _ (by rfl)
    _ = 2969 := by rw [pc2437]; rfl
@[simp] theorem pc2439 : Artifact.submissionArtifact.instructionPC 2297 = 2971 := by
  calc
