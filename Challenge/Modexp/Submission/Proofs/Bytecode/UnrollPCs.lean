  ...
  calc
    Artifact.submissionArtifact.instructionPC 463 =
        Artifact.submissionArtifact.instructionPC 462 +
          (YulEvmCompiler.Instr.push 2 2956).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 462 _ (by rfl)
    _ = 556 := by rw [pc485]; rfl
@[simp] theorem pc2414 : Artifact.submissionArtifact.instructionPC 2279 = 2956 := by rfl
@[simp] theorem pc2415 : Artifact.submissionArtifact.instructionPC 2280 = 2957 := by
  calc
    ...
    _ = 2957 := by rw [pc2414]; rfl
@[simp] theorem pc2416 : Artifact.submissionArtifact.instructionPC 2281 = 2959 := by
  calc
    ...
    _ = 2959 := by rw [pc2415]; rfl
@[simp] theorem pc2417 : Artifact.submissionArtifact.instructionPC 2282 = 2960 := by
  calc
    ...
    _ = 2960 := by rw [pc2416]; rfl
@[simp] theorem pc2418 : Artifact.submissionArtifact.instructionPC 2283 = 2961 := by
  calc
    ...
    _ = 2961 := by rw [pc2417]; rfl
@[simp] theorem pc2419 : Artifact.submissionArtifact.instructionPC 2284 = 2962 := by
  calc
    ...
    _ = 2962 := by rw [pc2418]; rfl
@[simp] theorem pc2420 : Artifact.submissionArtifact.instructionPC 2285 = 2964 := by
  calc
    Artifact.submissionArtifact.instructionPC 2285 =
        Artifact.submissionArtifact.instructionPC 2284 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2284 _ (by rfl)
    _ = 2964 := by rw [pc2419]; rfl
@[simp] theorem pc2421 : Artifact.submissionArtifact.instructionPC 2286 = 2965 := by
  calc
    ...
    _ = 2965 := by rw [pc2420]; rfl
@[simp] theorem pc2422 : Artifact.submissionArtifact.instructionPC 2287 = 2967 := by
  calc
    ...
    _ = 2967 := by rw [pc2421]; rfl
@[simp] theorem pc2423 : Artifact.submissionArtifact.instructionPC 2288 = 2968 := by
  calc
    ...
    _ = 2968 := by rw [pc2422]; rfl
@[simp] theorem pc2424 : Artifact.submissionArtifact.instructionPC 2289 = 2969 := by
  calc
    ...
    _ = 2969 := by rw [pc2423]; rfl
@[simp] theorem pc2425 : Artifact.submissionArtifact.instructionPC 2290 = 2970 := by
  calc
    ...
    _ = 2970 := by rw [pc2424]; rfl
@[simp] theorem pc2426 : Artifact.submissionArtifact.instructionPC 2291 = 2971 := by
  calc
    ...
    _ = 2971 := by rw [pc2425]; rfl
@[simp] theorem pc2427 : Artifact.submissionArtifact.instructionPC 2292 = 2973 := by
  calc
    Artifact.submissionArtifact.instructionPC 2292 =
        Artifact.submissionArtifact.instructionPC 2291 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2291 _ (by rfl)
    _ = 2973 := by rw [pc2426]; rfl
@[simp] theorem pc2428 : Artifact.submissionArtifact.instructionPC 2293 = 2974 := by
  calc
    ...
    _ = 2974 := by rw [pc2427]; rfl
@[simp] theorem pc2429 : Artifact.submissionArtifact.instructionPC 2294 = 2975 := by
  calc
    ...
    _ = 2975 := by rw [pc2428]; rfl
@[simp] theorem pc2430 : Artifact.submissionArtifact.instructionPC 2295 = 2976 := by
  calc
    ...
    _ = 2976 := by rw [pc2429]; rfl
@[simp] theorem pc2431 : Artifact.submissionArtifact.instructionPC 2296 = 2977 := by
  calc
    ...
    _ = 2977 := by rw [pc2430]; rfl
@[simp] theorem pc2432 : Artifact.submissionArtifact.instructionPC 2297 = 2978 := by
  calc
    ...
    _ = 2978 := by rw [pc2431]; rfl
@[simp] theorem pc2433 : Artifact.submissionArtifact.instructionPC 2298 = 2979 := by
  calc
    Artifact.submissionArtifact.instructionPC 2298 =
        Artifact.submissionArtifact.instructionPC 2297 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MULMOD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2297 _ (by rfl)
    _ = 2979 := by rw [pc2432]; rfl
@[simp] theorem pc2434 : Artifact.submissionArtifact.instructionPC 2299 = 2980 := by
  calc
    ...
    _ = 2980 := by rw [pc2433]; rfl
@[simp] theorem pc2435 : Artifact.submissionArtifact.instructionPC 2300 = 2981 := by
  calc
    ...
    _ = 2981 := by rw [pc2434]; rfl
@[simp] theorem pc2436 : Artifact.submissionArtifact.instructionPC 2301 = 2982 := by
  calc
    Artifact.submissionArtifact.instructionPC 2301 =
        Artifact.submissionArtifact.instructionPC 2300 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 7 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2300 _ (by rfl)
    _ = 2982 := by rw [pc2435]; rfl
@[simp] theorem pc2437 : Artifact.submissionArtifact.instructionPC 2302 = 2984 := by
  calc
    Artifact.submissionArtifact.instructionPC 2302 =
        Artifact.submissionArtifact.instructionPC 2301 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2301 _ (by rfl)
    _ = 2984 := by rw [pc2436]; rfl
@[simp] theorem pc2438 : Artifact.submissionArtifact.instructionPC 2303 = 2985 := by
  calc
    Artifact.submissionArtifact.instructionPC 2303 =
        Artifact.submissionArtifact.instructionPC 2302 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 4 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2302 _ (by rfl)
    _ = 2985 := by rw [pc2437]; rfl
@[simp] theorem pc2439 : Artifact.submissionArtifact.instructionPC 2304 = 2987 := by
  calc
