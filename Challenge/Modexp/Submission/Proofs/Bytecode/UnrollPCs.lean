  ...
  calc
    Artifact.submissionArtifact.instructionPC 463 =
        Artifact.submissionArtifact.instructionPC 462 +
          (YulEvmCompiler.Instr.push 2 2952).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 462 _ (by rfl)
    _ = 556 := by rw [pc485]; rfl
@[simp] theorem pc2414 : Artifact.submissionArtifact.instructionPC 2277 = 2952 := by rfl
@[simp] theorem pc2415 : Artifact.submissionArtifact.instructionPC 2278 = 2953 := by
  calc
    ...
    _ = 2953 := by rw [pc2414]; rfl
@[simp] theorem pc2416 : Artifact.submissionArtifact.instructionPC 2279 = 2955 := by
  calc
    ...
    _ = 2955 := by rw [pc2415]; rfl
@[simp] theorem pc2417 : Artifact.submissionArtifact.instructionPC 2280 = 2956 := by
  calc
    ...
    _ = 2956 := by rw [pc2416]; rfl
@[simp] theorem pc2418 : Artifact.submissionArtifact.instructionPC 2281 = 2957 := by
  calc
    ...
    _ = 2957 := by rw [pc2417]; rfl
@[simp] theorem pc2419 : Artifact.submissionArtifact.instructionPC 2282 = 2958 := by
  calc
    ...
    _ = 2958 := by rw [pc2418]; rfl
@[simp] theorem pc2420 : Artifact.submissionArtifact.instructionPC 2283 = 2960 := by
  calc
    Artifact.submissionArtifact.instructionPC 2283 =
        Artifact.submissionArtifact.instructionPC 2282 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2282 _ (by rfl)
    _ = 2960 := by rw [pc2419]; rfl
@[simp] theorem pc2421 : Artifact.submissionArtifact.instructionPC 2284 = 2961 := by
  calc
    ...
    _ = 2961 := by rw [pc2420]; rfl
@[simp] theorem pc2422 : Artifact.submissionArtifact.instructionPC 2285 = 2963 := by
  calc
    ...
    _ = 2963 := by rw [pc2421]; rfl
@[simp] theorem pc2423 : Artifact.submissionArtifact.instructionPC 2286 = 2964 := by
  calc
    ...
    _ = 2964 := by rw [pc2422]; rfl
@[simp] theorem pc2424 : Artifact.submissionArtifact.instructionPC 2287 = 2965 := by
  calc
    ...
    _ = 2965 := by rw [pc2423]; rfl
@[simp] theorem pc2425 : Artifact.submissionArtifact.instructionPC 2288 = 2966 := by
  calc
    ...
    _ = 2966 := by rw [pc2424]; rfl
@[simp] theorem pc2426 : Artifact.submissionArtifact.instructionPC 2289 = 2967 := by
  calc
    ...
    _ = 2967 := by rw [pc2425]; rfl
@[simp] theorem pc2427 : Artifact.submissionArtifact.instructionPC 2290 = 2969 := by
  calc
    Artifact.submissionArtifact.instructionPC 2290 =
        Artifact.submissionArtifact.instructionPC 2289 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2289 _ (by rfl)
    _ = 2969 := by rw [pc2426]; rfl
@[simp] theorem pc2428 : Artifact.submissionArtifact.instructionPC 2291 = 2970 := by
  calc
    ...
    _ = 2970 := by rw [pc2427]; rfl
@[simp] theorem pc2429 : Artifact.submissionArtifact.instructionPC 2292 = 2971 := by
  calc
    ...
    _ = 2971 := by rw [pc2428]; rfl
@[simp] theorem pc2430 : Artifact.submissionArtifact.instructionPC 2293 = 2972 := by
  calc
    ...
    _ = 2972 := by rw [pc2429]; rfl
@[simp] theorem pc2431 : Artifact.submissionArtifact.instructionPC 2294 = 2973 := by
  calc
    ...
    _ = 2973 := by rw [pc2430]; rfl
@[simp] theorem pc2432 : Artifact.submissionArtifact.instructionPC 2295 = 2974 := by
  calc
    ...
    _ = 2974 := by rw [pc2431]; rfl
@[simp] theorem pc2433 : Artifact.submissionArtifact.instructionPC 2296 = 2975 := by
  calc
    Artifact.submissionArtifact.instructionPC 2296 =
        Artifact.submissionArtifact.instructionPC 2295 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MULMOD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2295 _ (by rfl)
    _ = 2975 := by rw [pc2432]; rfl
@[simp] theorem pc2434 : Artifact.submissionArtifact.instructionPC 2297 = 2976 := by
  calc
    ...
    _ = 2976 := by rw [pc2433]; rfl
@[simp] theorem pc2435 : Artifact.submissionArtifact.instructionPC 2298 = 2977 := by
  calc
    ...
    _ = 2977 := by rw [pc2434]; rfl
@[simp] theorem pc2436 : Artifact.submissionArtifact.instructionPC 2299 = 2978 := by
  calc
    Artifact.submissionArtifact.instructionPC 2299 =
        Artifact.submissionArtifact.instructionPC 2298 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 7 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2298 _ (by rfl)
    _ = 2978 := by rw [pc2435]; rfl
@[simp] theorem pc2437 : Artifact.submissionArtifact.instructionPC 2300 = 2980 := by
  calc
    Artifact.submissionArtifact.instructionPC 2300 =
        Artifact.submissionArtifact.instructionPC 2299 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2299 _ (by rfl)
    _ = 2980 := by rw [pc2436]; rfl
@[simp] theorem pc2438 : Artifact.submissionArtifact.instructionPC 2301 = 2981 := by
  calc
    Artifact.submissionArtifact.instructionPC 2301 =
        Artifact.submissionArtifact.instructionPC 2300 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 4 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2300 _ (by rfl)
    _ = 2981 := by rw [pc2437]; rfl
@[simp] theorem pc2439 : Artifact.submissionArtifact.instructionPC 2302 = 2983 := by
  calc
