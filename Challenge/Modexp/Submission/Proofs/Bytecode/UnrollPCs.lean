  ...
  calc
    Artifact.submissionArtifact.instructionPC 538 =
        Artifact.submissionArtifact.instructionPC 537 +
          (YulEvmCompiler.Instr.push 2 3076).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 537 _ (by rfl)
    _ = 691 := by rw [pc485]; rfl
@[simp] theorem pc2414 : Artifact.submissionArtifact.instructionPC 2328 = 3076 := by rfl
@[simp] theorem pc2415 : Artifact.submissionArtifact.instructionPC 2329 = 3077 := by
  calc
    ...
    _ = 3077 := by rw [pc2414]; rfl
@[simp] theorem pc2416 : Artifact.submissionArtifact.instructionPC 2330 = 3079 := by
  calc
    ...
    _ = 3079 := by rw [pc2415]; rfl
@[simp] theorem pc2417 : Artifact.submissionArtifact.instructionPC 2331 = 3080 := by
  calc
    ...
    _ = 3080 := by rw [pc2416]; rfl
@[simp] theorem pc2418 : Artifact.submissionArtifact.instructionPC 2332 = 3081 := by
  calc
    ...
    _ = 3081 := by rw [pc2417]; rfl
@[simp] theorem pc2419 : Artifact.submissionArtifact.instructionPC 2333 = 3082 := by
  calc
    ...
    _ = 3082 := by rw [pc2418]; rfl
@[simp] theorem pc2420 : Artifact.submissionArtifact.instructionPC 2334 = 3084 := by
  calc
    Artifact.submissionArtifact.instructionPC 2334 =
        Artifact.submissionArtifact.instructionPC 2333 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2333 _ (by rfl)
    _ = 3084 := by rw [pc2419]; rfl
@[simp] theorem pc2421 : Artifact.submissionArtifact.instructionPC 2335 = 3085 := by
  calc
    ...
    _ = 3085 := by rw [pc2420]; rfl
@[simp] theorem pc2422 : Artifact.submissionArtifact.instructionPC 2336 = 3087 := by
  calc
    ...
    _ = 3087 := by rw [pc2421]; rfl
@[simp] theorem pc2423 : Artifact.submissionArtifact.instructionPC 2337 = 3088 := by
  calc
    ...
    _ = 3088 := by rw [pc2422]; rfl
@[simp] theorem pc2424 : Artifact.submissionArtifact.instructionPC 2338 = 3089 := by
  calc
    ...
    _ = 3089 := by rw [pc2423]; rfl
@[simp] theorem pc2425 : Artifact.submissionArtifact.instructionPC 2339 = 3090 := by
  calc
    ...
    _ = 3090 := by rw [pc2424]; rfl
@[simp] theorem pc2426 : Artifact.submissionArtifact.instructionPC 2340 = 3091 := by
  calc
    ...
    _ = 3091 := by rw [pc2425]; rfl
@[simp] theorem pc2427 : Artifact.submissionArtifact.instructionPC 2341 = 3093 := by
  calc
    Artifact.submissionArtifact.instructionPC 2341 =
        Artifact.submissionArtifact.instructionPC 2340 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2340 _ (by rfl)
    _ = 3093 := by rw [pc2426]; rfl
@[simp] theorem pc2428 : Artifact.submissionArtifact.instructionPC 2342 = 3094 := by
  calc
    ...
    _ = 3094 := by rw [pc2427]; rfl
@[simp] theorem pc2429 : Artifact.submissionArtifact.instructionPC 2343 = 3095 := by
  calc
    ...
    _ = 3095 := by rw [pc2428]; rfl
@[simp] theorem pc2430 : Artifact.submissionArtifact.instructionPC 2344 = 3096 := by
  calc
    ...
    _ = 3096 := by rw [pc2429]; rfl
@[simp] theorem pc2431 : Artifact.submissionArtifact.instructionPC 2345 = 3097 := by
  calc
    ...
    _ = 3097 := by rw [pc2430]; rfl
@[simp] theorem pc2432 : Artifact.submissionArtifact.instructionPC 2346 = 3098 := by
  calc
    ...
    _ = 3098 := by rw [pc2431]; rfl
@[simp] theorem pc2433 : Artifact.submissionArtifact.instructionPC 2347 = 3099 := by
  calc
    Artifact.submissionArtifact.instructionPC 2347 =
        Artifact.submissionArtifact.instructionPC 2346 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MULMOD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2346 _ (by rfl)
    _ = 3099 := by rw [pc2432]; rfl
@[simp] theorem pc2434 : Artifact.submissionArtifact.instructionPC 2348 = 3100 := by
  calc
    ...
    _ = 3100 := by rw [pc2433]; rfl
@[simp] theorem pc2435 : Artifact.submissionArtifact.instructionPC 2349 = 3101 := by
  calc
    ...
    _ = 3101 := by rw [pc2434]; rfl
@[simp] theorem pc2436 : Artifact.submissionArtifact.instructionPC 2350 = 3102 := by
  calc
    Artifact.submissionArtifact.instructionPC 2350 =
        Artifact.submissionArtifact.instructionPC 2349 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 7 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2349 _ (by rfl)
    _ = 3102 := by rw [pc2435]; rfl
@[simp] theorem pc2437 : Artifact.submissionArtifact.instructionPC 2351 = 3104 := by
  calc
    Artifact.submissionArtifact.instructionPC 2351 =
        Artifact.submissionArtifact.instructionPC 2350 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2350 _ (by rfl)
    _ = 3104 := by rw [pc2436]; rfl
@[simp] theorem pc2438 : Artifact.submissionArtifact.instructionPC 2352 = 3105 := by
  calc
    Artifact.submissionArtifact.instructionPC 2352 =
        Artifact.submissionArtifact.instructionPC 2351 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 4 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2351 _ (by rfl)
    _ = 3105 := by rw [pc2437]; rfl
@[simp] theorem pc2439 : Artifact.submissionArtifact.instructionPC 2353 = 3107 := by
  calc
