  ...
  calc
    Artifact.submissionArtifact.instructionPC 538 =
        Artifact.submissionArtifact.instructionPC 537 +
          (YulEvmCompiler.Instr.push 2 3081).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 537 _ (by rfl)
    _ = 691 := by rw [pc485]; rfl
@[simp] theorem pc2414 : Artifact.submissionArtifact.instructionPC 2331 = 3081 := by rfl
@[simp] theorem pc2415 : Artifact.submissionArtifact.instructionPC 2332 = 3082 := by
  calc
    ...
    _ = 3082 := by rw [pc2414]; rfl
@[simp] theorem pc2416 : Artifact.submissionArtifact.instructionPC 2333 = 3084 := by
  calc
    ...
    _ = 3084 := by rw [pc2415]; rfl
@[simp] theorem pc2417 : Artifact.submissionArtifact.instructionPC 2334 = 3085 := by
  calc
    ...
    _ = 3085 := by rw [pc2416]; rfl
@[simp] theorem pc2418 : Artifact.submissionArtifact.instructionPC 2335 = 3086 := by
  calc
    ...
    _ = 3086 := by rw [pc2417]; rfl
@[simp] theorem pc2419 : Artifact.submissionArtifact.instructionPC 2336 = 3087 := by
  calc
    ...
    _ = 3087 := by rw [pc2418]; rfl
@[simp] theorem pc2420 : Artifact.submissionArtifact.instructionPC 2337 = 3089 := by
  calc
    Artifact.submissionArtifact.instructionPC 2337 =
        Artifact.submissionArtifact.instructionPC 2336 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2336 _ (by rfl)
    _ = 3089 := by rw [pc2419]; rfl
@[simp] theorem pc2421 : Artifact.submissionArtifact.instructionPC 2338 = 3090 := by
  calc
    ...
    _ = 3090 := by rw [pc2420]; rfl
@[simp] theorem pc2422 : Artifact.submissionArtifact.instructionPC 2339 = 3092 := by
  calc
    ...
    _ = 3092 := by rw [pc2421]; rfl
@[simp] theorem pc2423 : Artifact.submissionArtifact.instructionPC 2340 = 3093 := by
  calc
    ...
    _ = 3093 := by rw [pc2422]; rfl
@[simp] theorem pc2424 : Artifact.submissionArtifact.instructionPC 2341 = 3094 := by
  calc
    ...
    _ = 3094 := by rw [pc2423]; rfl
@[simp] theorem pc2425 : Artifact.submissionArtifact.instructionPC 2342 = 3095 := by
  calc
    ...
    _ = 3095 := by rw [pc2424]; rfl
@[simp] theorem pc2426 : Artifact.submissionArtifact.instructionPC 2343 = 3096 := by
  calc
    ...
    _ = 3096 := by rw [pc2425]; rfl
@[simp] theorem pc2427 : Artifact.submissionArtifact.instructionPC 2344 = 3098 := by
  calc
    Artifact.submissionArtifact.instructionPC 2344 =
        Artifact.submissionArtifact.instructionPC 2343 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2343 _ (by rfl)
    _ = 3098 := by rw [pc2426]; rfl
@[simp] theorem pc2428 : Artifact.submissionArtifact.instructionPC 2345 = 3099 := by
  calc
    ...
    _ = 3099 := by rw [pc2427]; rfl
@[simp] theorem pc2429 : Artifact.submissionArtifact.instructionPC 2346 = 3100 := by
  calc
    ...
    _ = 3100 := by rw [pc2428]; rfl
@[simp] theorem pc2430 : Artifact.submissionArtifact.instructionPC 2347 = 3101 := by
  calc
    ...
    _ = 3101 := by rw [pc2429]; rfl
@[simp] theorem pc2431 : Artifact.submissionArtifact.instructionPC 2348 = 3102 := by
  calc
    ...
    _ = 3102 := by rw [pc2430]; rfl
@[simp] theorem pc2432 : Artifact.submissionArtifact.instructionPC 2349 = 3103 := by
  calc
    ...
    _ = 3103 := by rw [pc2431]; rfl
@[simp] theorem pc2433 : Artifact.submissionArtifact.instructionPC 2350 = 3104 := by
  calc
    Artifact.submissionArtifact.instructionPC 2350 =
        Artifact.submissionArtifact.instructionPC 2349 +
          (YulEvmCompiler.Instr.op EvmSemantics.Operation.MULMOD).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2349 _ (by rfl)
    _ = 3104 := by rw [pc2432]; rfl
@[simp] theorem pc2434 : Artifact.submissionArtifact.instructionPC 2351 = 3105 := by
  calc
    ...
    _ = 3105 := by rw [pc2433]; rfl
@[simp] theorem pc2435 : Artifact.submissionArtifact.instructionPC 2352 = 3106 := by
  calc
    ...
    _ = 3106 := by rw [pc2434]; rfl
@[simp] theorem pc2436 : Artifact.submissionArtifact.instructionPC 2353 = 3107 := by
  calc
    Artifact.submissionArtifact.instructionPC 2353 =
        Artifact.submissionArtifact.instructionPC 2352 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 7 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2352 _ (by rfl)
    _ = 3107 := by rw [pc2435]; rfl
@[simp] theorem pc2437 : Artifact.submissionArtifact.instructionPC 2354 = 3109 := by
  calc
    Artifact.submissionArtifact.instructionPC 2354 =
        Artifact.submissionArtifact.instructionPC 2353 +
          (YulEvmCompiler.Instr.push 1 1).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2353 _ (by rfl)
    _ = 3109 := by rw [pc2436]; rfl
@[simp] theorem pc2438 : Artifact.submissionArtifact.instructionPC 2355 = 3110 := by
  calc
    Artifact.submissionArtifact.instructionPC 2355 =
        Artifact.submissionArtifact.instructionPC 2354 +
          (YulEvmCompiler.Instr.op (EvmSemantics.Operation.Dup { idx := 4 })).bytes.length :=
      instructionPC_succ Artifact.submissionArtifact 2354 _ (by rfl)
    _ = 3110 := by rw [pc2437]; rfl
@[simp] theorem pc2439 : Artifact.submissionArtifact.instructionPC 2356 = 3112 := by
  calc
