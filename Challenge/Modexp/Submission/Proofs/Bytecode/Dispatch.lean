...
def zeroSizePath :
  ...
  [opAt 921 .JUMPDEST, opAt 922 (.Dup ⟨0, by decide⟩),
   pushAt 923 2 1237, opAt 924 .JUMPI, pushAt 925 0 0, pushAt 926 0 0,
   opAt 927 .RETURN]

def wordEntryPath :
    List (Challenge.EvmProof.Stepper.Located Artifact.submissionArtifact .Osaka) :=
  [opAt 921 .JUMPDEST, opAt 922 (.Dup ⟨0, by decide⟩),
   pushAt 923 2 1237, opAt 924 .JUMPI, opAt 928 .JUMPDEST,
   opAt 929 (.Dup ⟨2, by decide⟩), pushAt 930 1 96, opAt 931 .ADD,
   opAt 932 (.Dup ⟨2, by decide⟩), opAt 933 (.Dup ⟨1, by decide⟩),
   opAt 934 .ADD, pushAt 935 1 32, opAt 936 (.Dup ⟨3, by decide⟩),
   opAt 937 .GT, pushAt 938 2 1268, opAt 939 .JUMPI, pushAt 940 2 1267,
   opAt 941 (.Dup ⟨1, by decide⟩), opAt 942 (.Dup ⟨3, by decide⟩),
   pushAt 943 1 96, opAt 944 (.Dup ⟨6, by decide⟩),
   opAt 945 (.Dup ⟨8, by decide⟩), opAt 946 (.Dup ⟨10, by decide⟩),
   pushAt 947 2 517, opAt 948 .JUMP]
