...
submission control flow, so all helper and loop certificates can share it.
-/

namespace Challenge.Modexp.Submission.Proofs.Limbs
...
end Challenge.Modexp.Submission.Proofs.Limbs
