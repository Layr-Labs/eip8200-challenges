...
namespace Challenge.Modexp.Submission.Proofs.Memo.V1.State
...
theorem answerMemory_read :
    MachineState.readPadded answerMemory 31 1 = Precompile.natToBytes 6 1 := by
  decide +kernel

end Challenge.Modexp.Submission.Proofs.Memo.V1.State
