...
def chunk0Path :
  ...
  [
   ...
   Main.pushAt 1541 32 0,
   Main.pushAt 1542 1 0,
   Main.opAt 1543 (EvmSemantics.Operation.StackMemFlow (EvmSemantics.Operation.StackMemFlowOps.POP)),
   Main.opAt 1544 (EvmSemantics.Operation.StackMemFlow (EvmSemantics.Operation.StackMemFlowOps.POP)),
