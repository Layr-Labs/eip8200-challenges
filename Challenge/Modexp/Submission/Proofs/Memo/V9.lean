...
def gasSteps_match (input : ByteArray) (h : guardDiff Data.checks input = 0) :
    Challenge.EvmProof.GasSteps (Main.trampolineState input 2409) (returnedState input) :=
...
def gasSteps_fallback (input : ByteArray) (h : guardDiff Data.checks input ≠ 0) :
    Challenge.EvmProof.GasSteps (Main.trampolineState input 2409) (Main.trampolineState input 1196) :=
  (((((sound preludePath rfl (run_prelude input) rfl rfl deployAddress_not_precompile).trans
    (sound chunk0Path rfl (run_chunk0 input) rfl rfl deployAddress_not_precompile)).trans
    (sound chunk1Path rfl (run_chunk1 input) rfl rfl deployAddress_not_precompile)).trans
...
def gasSteps_pretest_taken (input : ByteArray) (hw : MachineState.readWord input 94 = UInt256.ofNat 57656776381785232221288722070333642129877090746803087510479986983448338273) :
    Challenge.EvmProof.GasSteps (Main.trampolineState input 2368) (Main.trampolineState input 2624) :=
...
def gasSteps_pretest_notTaken (input : ByteArray) (hw : MachineState.readWord input 94 ≠ UInt256.ofNat 57656776381785232221288722070333642129877090746803087510479986983448338273) :
    Challenge.EvmProof.GasSteps (Main.trampolineState input 2368) (Main.trampolineState input 2409) :=
  (sound pretestPath rfl (run_pretest_prefix input) rfl rfl deployAddress_not_precompile).trans
