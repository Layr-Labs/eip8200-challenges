...
def gasSteps_hit6 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 4) (h : Hit6 input) :
  ...
  (gasSteps_bucket input 4 62 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1321 (by rfl))).trans (V6.gasSteps_match input h)

def gasSteps_miss4 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 4) (hk : ¬ Hit6 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  (gasSteps_bucket input 4 62 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1321 (by rfl))).trans (V6.gasSteps_fallback input hk)
...
def gasSteps_hit5 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 5) (h : Hit5 input) :
  ...
  (gasSteps_bucket input 5 57 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1271 (by rfl))).trans (V5.gasSteps_match input h)

def gasSteps_miss5 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 5) (hk : ¬ Hit5 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  (gasSteps_bucket input 5 57 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1271 (by rfl))).trans (V5.gasSteps_fallback input hk)
...
def gasSteps_hit4 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 6) (h : Hit4 input) :
  ...
  (gasSteps_bucket input 6 54 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1219 (by rfl))).trans (V4.gasSteps_match input h)

def gasSteps_miss6 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 6) (hk : ¬ Hit4 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  (gasSteps_bucket input 6 54 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1219 (by rfl))).trans (V4.gasSteps_fallback input hk)
...
def gasSteps_hit8 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 7) (h : Hit8 input) :
  ...
  (gasSteps_bucket input 7 70 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1426 (by rfl))).trans (V8.gasSteps_match input h)

def gasSteps_miss7 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 7) (hk : ¬ Hit8 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  (gasSteps_bucket input 7 70 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1426 (by rfl))).trans (V8.gasSteps_fallback input hk)
...
def gasSteps_hit9 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 10) (hw : MachineState.readWord input 96 ≠ UInt256.ofNat 73247641362558725300106169323372519318985509881989093824173738694050148637181) (h : Hit9 input) :
  ...
  ((gasSteps_bucket input 10 76 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1477 (by rfl))).trans (V9.gasSteps_pretest_notTaken input hw)).trans (V9.gasSteps_match input h)

def gasSteps_miss10a (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 10) (hw : MachineState.readWord input 96 ≠ UInt256.ofNat 73247641362558725300106169323372519318985509881989093824173738694050148637181) (hk : ¬ Hit9 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  ((gasSteps_bucket input 10 76 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1477 (by rfl))).trans (V9.gasSteps_pretest_notTaken input hw)).trans (V9.gasSteps_fallback input hk)

def gasSteps_hit10 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 10) (hw : MachineState.readWord input 96 = UInt256.ofNat 73247641362558725300106169323372519318985509881989093824173738694050148637181) (h : Hit10 input) :
    Challenge.EvmProof.GasSteps (init input) (V10.State.returnedState input) :=
  ((gasSteps_bucket input 10 76 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1477 (by rfl))).trans (V9.gasSteps_pretest_taken input hw)).trans (V10.gasSteps_match input h)

def gasSteps_miss10b (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 10) (hw : MachineState.readWord input 96 = UInt256.ofNat 73247641362558725300106169323372519318985509881989093824173738694050148637181) (hs : ¬ Hit10 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  ((gasSteps_bucket input 10 76 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1477 (by rfl))).trans (V9.gasSteps_pretest_taken input hw)).trans (V10.gasSteps_fallback input hs)
...
def gasSteps_hit12 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 13) (h : Hit12 input) :
  ...
  (gasSteps_bucket input 13 106 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1678 (by rfl))).trans (V12.gasSteps_match input h)

def gasSteps_miss13 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 13) (hk : ¬ Hit12 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  (gasSteps_bucket input 13 106 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1678 (by rfl))).trans (V12.gasSteps_fallback input hk)
...
def gasSteps_hit11 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 15) (h : Hit11 input) :
  ...
  (gasSteps_bucket input 15 89 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1576 (by rfl))).trans (V11.gasSteps_match input h)

def gasSteps_miss15 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 15) (hk : ¬ Hit11 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  (gasSteps_bucket input 15 89 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1576 (by rfl))).trans (V11.gasSteps_fallback input hk)
...
def gasSteps_hit2 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 20) (hw : MachineState.readWord input 32 ≠ UInt256.ofNat 1) (h : Hit2 input) :
  ...
  ((gasSteps_bucket input 20 48 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1116 (by rfl))).trans (V2.gasSteps_pretest_notTaken input hw)).trans (V2.gasSteps_match input h)
...
def gasSteps_miss20a (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 20) (hw : MachineState.readWord input 32 ≠ UInt256.ofNat 1) (hk : ¬ Hit2 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  ((gasSteps_bucket input 20 48 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1116 (by rfl))).trans (V2.gasSteps_pretest_notTaken input hw)).trans (V2.gasSteps_fallback input hk)
...
def gasSteps_hit3 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 20) (hw : MachineState.readWord input 32 = UInt256.ofNat 1) (h : Hit3 input) :
  ...
  ((gasSteps_bucket input 20 48 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1116 (by rfl))).trans (V2.gasSteps_pretest_taken input hw)).trans (V3.gasSteps_match input hw h)
...
def gasSteps_miss20b (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 20) (hw : MachineState.readWord input 32 = UInt256.ofNat 1) (hs : ¬ Hit3 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  ((gasSteps_bucket input 20 48 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1116 (by rfl))).trans (V2.gasSteps_pretest_taken input hw)).trans (V3.gasSteps_fallback input hw hs)
...
def gasSteps_hit7 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 22) (h : Hit7 input) :
  ...
  (gasSteps_bucket input 22 66 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1374 (by rfl))).trans (V7.gasSteps_match input h)

def gasSteps_miss22 (input : ByteArray) (hsize : input.size < 2 ^ 256) (hr : input.size % 26 = 22) (hk : ¬ Hit7 input) :
    Challenge.EvmProof.GasSteps (init input) (Bytecode.Main.trampolineState input 1196) :=
  (gasSteps_bucket input 22 66 hsize hr (by decide +kernel) (by norm_num)
      (Artifact.isValidJumpDest_index 1374 (by rfl))).trans (V7.gasSteps_fallback input hk)
