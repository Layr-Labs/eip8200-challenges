...
theorem run_check0_jump (input : ByteArray) :
  ...
  exact (Step.runLocated_jumpi_taken check0_jumpLocated rfl (check0JumpState input) 1491 (UInt256.ofNat 1) [UInt256.ofNat input.size] hpc rfl (by simp) Logic.isTrue_one rfl (by norm_num) hjump).trans rfl

theorem run_check0_taken_prefix (input : ByteArray) (h : input.size = 98) :
...
theorem run_check1_jump (input : ByteArray) :
  ...
  exact (Step.runLocated_jumpi_taken check1_jumpLocated rfl (check1JumpState input) 2273 (UInt256.ofNat 1) [UInt256.ofNat input.size] hpc rfl (by simp) Logic.isTrue_one rfl (by norm_num) hjump).trans rfl

theorem run_check1_taken_prefix (input : ByteArray) (h : input.size = 192) :
...
theorem run_check2_jump (input : ByteArray) :
  ...
  exact (Step.runLocated_jumpi_taken check2_jumpLocated rfl (check2JumpState input) 1413 (UInt256.ofNat 1) [UInt256.ofNat input.size] hpc rfl (by simp) Logic.isTrue_one rfl (by norm_num) hjump).trans rfl

theorem run_check2_taken_prefix (input : ByteArray) (h : input.size = 99) :
...
theorem run_check3_jump (input : ByteArray) :
  ...
  exact (Step.runLocated_jumpi_taken check3_jumpLocated rfl (check3JumpState input) 1638 (UInt256.ofNat 1) [UInt256.ofNat input.size] hpc rfl (by simp) Logic.isTrue_one rfl (by norm_num) hjump).trans rfl

theorem run_check3_taken_prefix (input : ByteArray) (h : input.size = 110) :
...
theorem run_check4_jump (input : ByteArray) :
  ...
  exact (Step.runLocated_jumpi_taken check4_jumpLocated rfl (check4JumpState input) 1712 (UInt256.ofNat 1) [UInt256.ofNat input.size] hpc rfl (by simp) Logic.isTrue_one rfl (by norm_num) hjump).trans rfl

theorem run_check4_taken_prefix (input : ByteArray) (h : input.size = 161) :
...
theorem run_check5_jump (input : ByteArray) :
  ...
  exact (Step.runLocated_jumpi_taken check5_jumpLocated rfl (check5JumpState input) 1865 (UInt256.ofNat 1) [UInt256.ofNat input.size] hpc rfl (by simp) Logic.isTrue_one rfl (by norm_num) hjump).trans rfl

theorem run_check5_taken_prefix (input : ByteArray) (h : input.size = 160) :
...
theorem run_check6_jump (input : ByteArray) :
  ...
  exact (Step.runLocated_jumpi_taken check6_jumpLocated rfl (check6JumpState input) 1975 (UInt256.ofNat 1) [UInt256.ofNat input.size] hpc rfl (by simp) Logic.isTrue_one rfl (by norm_num) hjump).trans rfl

theorem run_check6_taken_prefix (input : ByteArray) (h : input.size = 100) :
