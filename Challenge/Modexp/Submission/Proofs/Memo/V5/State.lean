...
namespace Challenge.Modexp.Submission.Proofs.Memo.V5.State
...
theorem answerMemory_read :
    MachineState.readPadded answerMemory 0 32 = Precompile.natToBytes 1 32 := by
  decide +kernel

end Challenge.Modexp.Submission.Proofs.Memo.V5.State
