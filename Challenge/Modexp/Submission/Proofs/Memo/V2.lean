...
def gasSteps_pretest_taken (input : ByteArray) (hw : MachineState.readWord input 32 ≠ UInt256.ofNat 0) :
...
def gasSteps_pretest_notTaken (input : ByteArray) (hw : MachineState.readWord input 32 = UInt256.ofNat 0) :
