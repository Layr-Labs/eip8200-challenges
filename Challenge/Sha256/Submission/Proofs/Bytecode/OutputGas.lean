...
import Challenge.Sha256.Submission.Proofs.Bytecode.Output

set_option warningAsError true
set_option maxRecDepth 100000
set_option maxHeartbeats 0

namespace Challenge.Sha256.Submission.Proofs.Bytecode.OutputGas
...
theorem gasSteps_output_cost_potential (s : State) (offset : UInt256)
  ...
  have valid1413 : Decode.isValidJumpDest submissionBytecode 1413 = true := by decide
  have valid1424 : Decode.isValidJumpDest submissionBytecode 1424 = true := by decide
  have valid1439 : Decode.isValidJumpDest submissionBytecode 1439 = true := by decide
  have valid1453 : Decode.isValidJumpDest submissionBytecode 1453 = true := by decide
  have valid1469 : Decode.isValidJumpDest submissionBytecode 1469 = true := by decide
  have valid1483 : Decode.isValidJumpDest submissionBytecode 1483 = true := by decide
  have valid1498 : Decode.isValidJumpDest submissionBytecode 1498 = true := by decide
  have valid1511 : Decode.isValidJumpDest submissionBytecode 1511 = true := by decide
...
end Challenge.Sha256.Submission.Proofs.Bytecode.OutputGas
