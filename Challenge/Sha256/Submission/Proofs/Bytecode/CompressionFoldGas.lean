...
theorem foldIteration_cost_potential (s : State)
  ...
  have hsetup := blockCost_potential_of_static Compression.foldSetupPath 54
  ...
  have hinc := blockCost_potential_of_static Compression.foldIncrementPath 17
