...
namespace Challenge.Sha256.RouteB.Accessors
...
private theorem run_load (path : List
  ...
  · have hoff : UInt256.ofNat 800 + UInt256.shiftLeft index (UInt256.ofNat 5) =
    ...
    simp [wAtPath, hAtPath, Challenge.RouteB.Stepper.runLocatedBlock,
...
theorem gasSteps_wAt (s : State) (index output returnDest : UInt256)
    ...
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (loadEntry s 279 index output returnDest rest)
...
theorem gasSteps_hAt (s : State) (index output returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (loadEntry s 318 index output returnDest rest)
...
private theorem run_store (path : List
  ...
  · have hoff : UInt256.ofNat 800 + UInt256.shiftLeft index (UInt256.ofNat 5) =
        UInt256.shiftLeft index (UInt256.ofNat 5) + UInt256.ofNat 800 :=
      Challenge.RouteB.Word.word_add_comm _ _
    simp [wSetPath, hSetPath, Challenge.RouteB.Stepper.runLocatedBlock,
      Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
theorem gasSteps_wSet (s : State) (index value returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (storeEntry s 299 index value returnDest rest)
...
theorem gasSteps_hSet (s : State) (index value returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (storeEntry s 338 index value returnDest rest)
...
private theorem run_kAt (s : State) (index output returnDest : UInt256)
    ...
    (hrun : s.halt = .Running)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.Stepper.runLocatedBlock kAtPath
  ...
  have hoff : UInt256.ofNat 32 + UInt256.shiftLeft index (UInt256.ofNat 2) =
    ...
    Challenge.RouteB.Word.word_add_comm _ _
  simp [kAtPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
theorem gasSteps_kAt (s : State) (index output returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (loadEntry s 257 index output returnDest rest)
...
end Challenge.Sha256.RouteB.Accessors
