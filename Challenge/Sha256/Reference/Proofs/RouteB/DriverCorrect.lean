import Challenge.Sha256.Reference.Proofs.RouteB.Driver
import Challenge.Sha256.Reference.Proofs.RouteB.CompressionCorrect
import Challenge.Sha256.Reference.Proofs.RouteB.InitializationCorrect
import Challenge.Sha256.Reference.Proofs.RouteB.PaddedBlockBridge
...
namespace Challenge.Sha256.RouteB.DriverCorrect
...
def ChainRepresents (s : State) (H : Array UInt32) : Prop :=
  ∀ i, i < 8 →
    Compression.hValue s i = Challenge.RouteB.Word.ofUInt32 H[i]!
...
private theorem kOffset_eq (j : Nat) (hj : j < 64) :
  ...
  rw [Challenge.RouteB.Word.shiftLeft_ofNat (by omega) (by decide) (by omega),
    Challenge.RouteB.Word.ofNat_add_ofNat (by omega),
    Challenge.RouteB.Word.word_toNat_ofNat, Nat.mod_eq_of_lt (by omega)]
  omega
...
private theorem readWord_copyHashState (s : State) (addr : Nat)
  ...
  · exact Challenge.RouteB.Memory.readPadded_size _ _ _
  · omega
...
theorem concatWord {a b shift : Nat}
  ...
  rw [Challenge.RouteB.Word.shiftLeft_ofNat ha256 hshift hmul]
...
theorem natToBytesPadded_concat (a b hi lo : Nat) (hb : b < 256 ^ lo) :
  ...
  rw [Challenge.RouteB.Memory.natToBytesPadded_eq_natToBE,
    Challenge.RouteB.Memory.natToBytesPadded_eq_natToBE,
    Challenge.RouteB.Memory.natToBytesPadded_eq_natToBE,
...
theorem shiftUInt32 (x : UInt32) (shift : Nat) (hs : shift ≤ 224) :
    UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x) (UInt256.ofNat shift) =
      UInt256.ofNat (x.toNat * 2 ^ shift) := by
  apply Challenge.RouteB.Word.shiftLeft_ofNat
...
theorem directPackWord (x0 x1 x2 x3 x4 x5 x6 x7 : UInt32) :
    UInt256.lor
      (UInt256.lor
        (UInt256.lor
          (UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x0) (UInt256.ofNat 224))
          (UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x1) (UInt256.ofNat 192)))
        (UInt256.lor
          (UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x2) (UInt256.ofNat 160))
          (UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x3) (UInt256.ofNat 128))))
      (UInt256.lor
        (UInt256.lor
          (UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x4) (UInt256.ofNat 96))
          (UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x5) (UInt256.ofNat 64)))
        (UInt256.lor
          (UInt256.shiftLeft (Challenge.RouteB.Word.ofUInt32 x6) (UInt256.ofNat 32))
          (Challenge.RouteB.Word.ofUInt32 x7))) =
...
theorem digestBytes_eq_emitDigest (s : State) (H : Array UInt32)
    (h : ∀ i, i < 8 →
      Output.hWord s i = Challenge.RouteB.Word.ofUInt32 H[i]!) :
  ...
  rw [directPackWord, Challenge.RouteB.Word.word_toNat_ofNat,
...
end Challenge.Sha256.RouteB.DriverCorrect
