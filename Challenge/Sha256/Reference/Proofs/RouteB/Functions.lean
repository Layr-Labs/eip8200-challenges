...
import Challenge.Sha256.Reference.Proofs.RouteB.Word
...
namespace Challenge.Sha256.RouteB.Functions
...
private theorem run_rotr (s : State) (x : UInt256) (n : Nat)
    ...
    Challenge.RouteB.Stepper.runLocatedBlock rotrPath
      (rotrEntry s x n output returnDest rest) =
        some (unaryReturned s (Word.evmRotr32 x n) returnDest rest) := by
  have hsub := Challenge.RouteB.Word.ofNat_sub_ofNat hn (by norm_num : 32 < 2 ^ 256)
  ...
  simp [rotrPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
    rotrEntry, unaryReturned, Word.evmRotr32, Challenge.RouteB.Word.mask32,
...
theorem gasSteps_rotr (s : State) (x : UInt256) (n : Nat)
    ...
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (rotrEntry s x n output returnDest rest)
...
@[simp] private theorem nextSmallPC (i : Nat) (hi : 212 ≤ i) (hii : i ≤ 250) :
  ...
  exact Challenge.RouteB.Word.succ_ofNat (by omega)
...
private theorem run_ch (s : State) (x y z output returnDest : UInt256)
    ...
    (hrun : s.halt = .Running)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.Stepper.runLocatedBlock chPath
  ...
  have hc7 : rest.length + 7 < 1024 := by omega
  have hc8 : rest.length + 8 < 1024 := by omega
  simp [chPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
private theorem run_maj (s : State) (x y z output returnDest : UInt256)
    ...
    (hrun : s.halt = .Running)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.Stepper.runLocatedBlock majPath
  ...
  simp [majPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
theorem gasSteps_ch (s : State) (x y z output returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (ternaryEntry s 212 x y z output returnDest rest)
...
theorem gasSteps_maj (s : State) (x y z output returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (ternaryEntry s 233 x y z output returnDest rest)
...
private theorem run_ssig0Setup (s : State) (x output returnDest : UInt256)
    ...
    (hcode : s.executionEnv.code = referenceBytecode)
    (hrun : s.halt = .Running) :
    Challenge.RouteB.Stepper.runLocatedBlock ssig0SetupPath
  ...
  simp [ssig0SetupPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
private theorem run_ssig0Middle (s : State) (x output returnDest : UInt256)
    ...
    (hcode : s.executionEnv.code = referenceBytecode)
    (hrun : s.halt = .Running) :
    Challenge.RouteB.Stepper.runLocatedBlock ssig0MiddlePath
  ...
  have hdest : Decode.isValidJumpDest referenceBytecode 4 = true := by decide
  simp [ssig0MiddlePath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
private theorem run_ssig0Finish (s : State) (x output returnDest : UInt256)
    ...
    (hrun : s.halt = .Running)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.Stepper.runLocatedBlock ssig0FinishPath
  ...
  have hc6 : rest.length + 6 < 1024 := by omega
  have hc7 : rest.length + 7 < 1024 := by omega
  simp [ssig0FinishPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
theorem gasSteps_ssig0 (s : State) (x output returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (unaryEntry s 32 x output returnDest rest)
  ...
  have gMiddle : Challenge.RouteB.GasSteps
      (ssig0AfterFirstRotr s x output returnDest rest)
...
private theorem run_ssig1Setup (s : State) (x output returnDest : UInt256)
    ...
    (hcode : s.executionEnv.code = referenceBytecode)
    (hrun : s.halt = .Running) :
    Challenge.RouteB.Stepper.runLocatedBlock ssig1SetupPath
  ...
  have hc9 : rest.length + 9 < 1024 := by omega
  have hdest : Decode.isValidJumpDest referenceBytecode 4 = true := by decide
  simp [ssig1SetupPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
private theorem run_ssig1Middle (s : State) (x output returnDest : UInt256)
    ...
    (hcode : s.executionEnv.code = referenceBytecode)
    (hrun : s.halt = .Running) :
    Challenge.RouteB.Stepper.runLocatedBlock ssig1MiddlePath
  ...
  have hc10 : rest.length + 10 < 1024 := by omega
  have hdest : Decode.isValidJumpDest referenceBytecode 4 = true := by decide
  simp [ssig1MiddlePath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
private theorem run_ssig1Finish (s : State) (x output returnDest : UInt256)
    ...
    (hrun : s.halt = .Running)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.Stepper.runLocatedBlock ssig1FinishPath
  ...
  have hc6 : rest.length + 6 < 1024 := by omega
  have hc7 : rest.length + 7 < 1024 := by omega
  simp [ssig1FinishPath, Challenge.RouteB.Stepper.runLocatedBlock,
    Challenge.RouteB.Stepper.runLocated, Challenge.RouteB.Stepper.runInstr,
...
theorem gasSteps_ssig1 (s : State) (x output returnDest : UInt256)
    ...
    (hnp : Precompile.isPrecompile s.executionEnv.fork
      s.executionEnv.codeAddr = false)
    (hvalid : Decode.isValidJumpDest referenceBytecode returnDest.toNat = true) :
    Challenge.RouteB.GasSteps (unaryEntry s 73 x output returnDest rest)
...
end Challenge.Sha256.RouteB.Functions
