import Challenge.Sha256.Reference.Proofs.RouteB.SpecBridge
...
namespace Challenge.Sha256.RouteB.HashSpecBridge
  ...
  · intro i hleft hright
    ...
    calc
      ...
      _ = (Padding.lengthBytes input)[i] := by
        rw [← Challenge.RouteB.Memory.getD0_eq_getElem _ _ hright]
...
/-- The reusable Route B functional bridge: absorbing the one-pass padded
...
end Challenge.Sha256.RouteB.HashSpecBridge
